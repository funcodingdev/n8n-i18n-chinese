import { I as h, It as ref, S as computed, q as onBeforeUnmount } from "./vue.runtime.esm-bundler-CiTcVoZc.js";
...
import { Ui as sanitizeHtml, cn as useProjectsStore, vt as useCredentialsStore } from "./workflows.store-DgZ4KSQf.js";
...
function useQuickConnect() {
	...
	async function connectToPinecone(quickConnectOption) {
		const { ConnectPopup } = await __vitePreload(async () => {
			const { ConnectPopup } = await import("./dist-Bxc1an7K.js");
			return { ConnectPopup };
		}, []);
