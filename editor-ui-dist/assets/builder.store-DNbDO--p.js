...
import { Oi as isToolMessage$1, ki as isWorkflowUpdatedMessage$1, lt as useRoute, ut as useRouter } from "./src-D7XhL4SE.js";
import { t as useMessage } from "./useMessage-Dk6AIOQm.js";
import { $i as tryToParseNumber, $t as useCanvasStore, Bt as useNDVStore, Lt as useWorkflowsListStore, Qt as useNodeHelpers, Ut as injectWorkflowDocumentStore, Vt as createWorkflowDocumentId, Wt as useWorkflowDocumentStore, Zi as stringSizeInBytes, _r as isDebouncedFunction, at as clearBuilderSession, ct as getBuilderCredits, dt as useAIAssistantHelpers, it as chatWithBuilder, kt as useWorkflowHelpers, na as getNewWorkflow, qr as useSourceControlStore, st as getAiSessions, t as useWorkflowsStore, ut as truncateBuilderMessages } from "./workflows.store-DQQfIwKi.js";
import { t as useToast } from "./useToast-DMjrW7lG.js";
import { Ai as MODAL_CANCEL, Mi as MODAL_CONFIRM, Nl as CODE_WORKFLOW_BUILDER_EXPERIMENT, Ol as AI_BUILDER_TEMPLATE_EXAMPLES_EXPERIMENT, Pi as NPS_SURVEY_MODAL_KEY, Tl as AI_BUILDER_PLAN_MODE_EXPERIMENT, Vl as FOCUSED_NODES_EXPERIMENT, Wl as MERGE_ASK_BUILD_EXPERIMENT, Ws as dedupe, cu as SEVEN_DAYS_IN_MILLIS, dc as isExpression, el as getResourcePermissions, fu as getDebounceTime, iu as DEBOUNCE_TIME, ji as MODAL_CLOSE, lu as SIX_MONTHS_IN_MILLIS, na as LOCAL_STORAGE_BROWSER_NOTIFICATION_METADATA, oi as VIEWS, t as AutoSaveState, uu as THREE_DAYS_IN_MILLIS } from "./constants-Brs44Mbc.js";
import { T as defineStore, h as assert, t as useRootStore } from "./useRootStore-NTSmdx9S.js";
import { Rn as STORES, a as getWorkflowVersionsByIds, en as getFirstAdoptionDate, i as getWorkflowVersion, n as getPublishTimeline, o as updateWorkflowHistoryVersion, ot as updateNpsSurveyState, r as getWorkflowHistory, t as useSettingsStore } from "./settings.store-CrL-o4BC.js";
import { G as useDebounceFn, _ as useLocalStorage } from "./core-CMxey_qZ.js";
...
import { a as BUILDER_ENABLED_VIEWS, r as useChatPanelStateStore, t as useCodeDiff } from "./useCodeDiff-DVRO6qgj.js";
import { n as findPlaceholderDetails, r as formatPlaceholderPath } from "./dist-1UmUUMlk.js";
