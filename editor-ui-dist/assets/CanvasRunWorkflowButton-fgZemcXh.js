...
import { Ji as N8nTooltip_default, gt as N8nLink_default, ln as ElCollapseTransition, no as N8nButton_default, qt as N8nActionDropdown_default, ra as truncateBeforeLast, ro as N8nIcon_default, to as N8nText_default, wt as useRouter } from "./src-BR3WX5fi.js";
import { t as _plugin_vue_export_helper_default } from "./_plugin-vue_export-helper-Da88TEg1.js";
import { c as useExpressionResolveCtx } from "./useWorkflowDocumentRenderData-C2bQrxkh.js";
import { t as ParameterInputList_default } from "./ParameterInputList-Bb5r_K-d.js";
import { t as useToast } from "./useToast-D9a-cCgr.js";
import { As as extractReferencesInNodeExpressions, F as PLACEHOLDER_FILLED_AT_EXECUTION_TIME, Rc as displayParameter, Tn as MANUAL_TRIGGER_NODE_TYPE, Uc as getNodeParameters, Wc as getNodeParametersIssues$1, _l as isResourceLocatorValue, al as nodeAcceptsInputType, bl as NodeConnectionTypes, eu as EXECUTE_WORKFLOW_TRIGGER_NODE_TYPE, fu as v4, hi as VIEWS, mu as require_isEqual, na as WORKFLOW_EXTRACTION_NAME_MODAL_KEY, sd as ExpressionLocalResolveContextSymbol, wl as isExpression } from "./constants-CSBjw1Ht.js";
import { Br as PUSH_NODES_OFFSET, Ht as sortNodesByExecutionOrder, Pt as useWorkflowHelpers, Vt as sanitizeConnections, Wt as injectNDVStore, Yt as useWorkflowExecutionStateStore, _ as useNodeTypesStore, a as injectWorkflowDocumentStore, ar as getTriggerNodeServiceName, dn as useWorkflowsStore, f as getNodeTypeDisplayableCredentials, g as require_uniq, ot as listenForCredentialChanges, r as createWorkflowDocumentId, st as useCredentialsStore, vi as checkExhaustive, vn as useEnvironmentsStore } from "./workflowDocument.store-xeTT7tms.js";
import { f as useUIStore, p as useTelemetry } from "./users.store-DWiPI9j5.js";
import { l as findPlaceholderDetails, u as isPlaceholderValue } from "./builder.store-DKSZicXW.js";
import { h as UpdateNodeGroupCommand, n as useHistoryStore, t as useNodeHelpers } from "./useNodeHelpers-DXraSG6k.js";
import { t as useTemplatesStore } from "./templates.store-Cirtkrtr.js";
import { i as globalLinkActionsEventBus } from "./event-bus-CKxOYmTn.js";
import { t as useClipboard } from "./useClipboard-BhN-FEX9.js";
import { c as isChatNode, r as useSelectionValidation, t as useCanvasOperations, u as useLogsStore } from "./useCanvasOperations-Dte0CMVF.js";
...
import { r as useNodeExecution } from "./VirtualSchema-DEUuOHEb.js";
...
function useWorkflowExtraction() {
	...
	function addReplacementNodeToSelectionGroup(selectionIds, replacementNodeId) {
		...
		if (groupBefore && groupAfter) historyStore.pushCommandToUndo(new UpdateNodeGroupCommand({
			...groupBefore,
			nodeIds: [...groupBefore.nodeIds]
		}, {
			...groupAfter,
			nodeIds: [...groupAfter.nodeIds]
		}, Date.now()));
	}
