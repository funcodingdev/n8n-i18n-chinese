import { $ as openBlock, A as createTextVNode, C as createBaseVNode, Cn as toDisplayString, E as createElementBlock, Gt as unref, It as ref, K as onBeforeMount, N as defineComponent, S as computed, T as createCommentVNode, Ut as toValue, _ as Fragment, bn as normalizeStyle, bt as withCtx, gt as watch, j as createVNode, n as Transition, pt as useTemplateRef, rt as renderList, vn as normalizeClass, w as createBlock } from "./vue.runtime.esm-bundler-CiTcVoZc.js";
import { c as I18nT, s as useI18n } from "./src-w6tdcvn4.js";
import { At as N8nCard_default, F as N8nResizeWrapper_default, Ga as N8nHeading_default, Ja as N8nButton_default, P as N8nSpinner_default, Wi as N8nIconButton_default, Ya as N8nIcon_default, ct as N8nLink_default, gt as useRouter, ht as useRoute, qa as N8nText_default, s as Select_default, v as N8nScrollArea_default, zi as N8nTooltip_default } from "./src-BwN8TeVO.js";
import { t as _plugin_vue_export_helper_default } from "./_plugin-vue_export-helper-Da88TEg1.js";
import { t as useToast } from "./useToast-UJviqZPo.js";
import { Wa as PROVIDER_CREDENTIAL_TYPE_MAP, da as LOCAL_STORAGE_CHAT_HUB_SELECTED_MODEL, ju as EnterpriseEditionFeature, ll as v4, qa as chatHubConversationModelSchema, ua as LOCAL_STORAGE_CHAT_HUB_HAD_CONVERSATION_BEFORE, ui as VIEWS, za as ROLE } from "./constants-BiYlbN9Z.js";
import { gr as shouldIgnoreCanvasShortcut } from "./workflows.store-DgZ4KSQf.js";
import { t as useRootStore } from "./useRootStore-DbgDMM5M.js";
import { t as useSettingsStore } from "./settings.store-DROe9gro.js";
import { _ as useLocalStorage, m as useEventListener, o as useActiveElement, p as useElementSize, v as useMediaQuery } from "./core-BemUAWor.js";
import { Ct as INVITE_USER_MODAL_KEY, f as useUIStore, n as hasPermission, p as useTelemetry, t as useUsersStore, u as hasRole } from "./users.store-CUZkGc51.js";
...
import { c as CHAT_VIEW, d as MOBILE_MEDIA_QUERY, n as CHAT_CONVERSATION_VIEW, t as AGENT_EDITOR_MODAL_KEY } from "./constants-DiNx9_d-.js";
import { a as authorizeDynamicCredential, i as collectChatArtifacts, l as fetchWorkflowExecutionStatus, t as useChatStore, u as revokeDynamicCredential } from "./chat.store-9Y8iLuJj.js";
import { T as unflattenModel, _ as isLlmProvider, c as findOneFromModelsResponse, l as flattenModel } from "./chat.utils-EfWNY7-e.js";
import { t as useResizablePanel } from "./useResizablePanel-Dqj2LHWW.js";
import { i as useChatSession, n as ChatPrompt_default, r as ChatMessage_default, t as ChatGreetings_default } from "./ChatGreetings-B5wj6blt.js";
import { n as useFileDrop } from "./ToolsSelector-De6hnfbw.js";
import { t as ChatMarkdownChunk_default } from "./ChatMarkdownChunk-3UHj0ieK.js";
import { n as useChatCredentials, r as chatHubConversationModelWithCachedDisplayNameSchema, t as ChatLayout_default } from "./ChatLayout-DGsPBfHb.js";
import { n as ModelSelector_default, t as useCustomAgent } from "./useCustomAgent-D2X_5vZf.js";
