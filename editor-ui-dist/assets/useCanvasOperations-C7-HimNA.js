...
import { x as useI18n$1 } from "./_MapCache-B3VhjNx3.js";
import { ji as require_markdown_it_link_attributes } from "./src-Btlck5YT.js";
import { t as _plugin_vue_export_helper_default } from "./_plugin-vue_export-helper-Da88TEg1.js";
import { l as useClipboard, y as useLocalStorage } from "./dist-CmlFwYoT.js";
import { _ as useRouter, g as useRoute } from "./htmlUtils-LDunChtE.js";
import { t as useToast } from "./useToast-9MJyC6NG.js";
import { Ar as doRectsOverlap, Cr as CONFIGURABLE_NODE_SIZE, Dr as HORIZONTAL_NODE_STEP, E as useWorkflowDocumentStore, Er as DEFAULT_VIEWPORT_BOUNDARIES, F as require_uniq, Gt as useWorkflowHelpers, I as isAgentNodeV2, Ir as getNewNodePosition, L as useNodeTypesStore, Mi as isValidNodeConnectionType, Or as PUSH_NODES_OFFSET, Ot as useDataSchema, P as serializeNode, Qt as sanitizeConnections, Rr as getNodesGroupSize, S as createWorkflowDocumentId, Sr as AGENT_NODE_SIZE, Tr as DEFAULT_NODE_SIZE, Vi as CanvasNodeRenderType, Xt as ensureNodePosition, Yt as useTagsStore, _ as disposeWorkflowExecutionStateStore, _r as mapLegacyConnectionsToCanvasConnections, ci as pinDataToExecutionData, dn as useProjectsStore, et as removePreviewToken, gr as mapLegacyConnectionToCanvasConnection, hr as mapCanvasConnectionToLegacyConnection, jr as generateOffsets, lr as createCanvasConnectionHandleString, rn as useNDVStore, t as useWorkflowsStore, u as getExecutionErrorToastConfiguration, vr as parseCanvasConnectionHandleString, vt as useCredentialsStore, w as injectWorkflowDocumentStore, wr as CONFIGURATION_NODE_SIZE, y as useWorkflowExecutionStateStore, zi as CanvasConnectionMode } from "./workflows.store-HMd7zwNZ.js";
import { i as defineStore } from "./constants-Box1qD-P.js";
import { $i as v4, Dr as getNodeParameters, Er as getNodeOutputs, Gr as resolveNodeWebhookId, Ir as isHitlToolType, Mr as getSubworkflowId, Tr as getNodeInputs, Xt as require_cloneDeep, ai as NodeConnectionTypes, br as generateNodesGraph, fi as deepCopy, mi as isObjectEmpty, nn as validateNodeSelectionForGrouping, pi as isCommunityPackageName, tn as validateNodeSelectionForExtraction, wr as getConnectionTypes } from "./src-Bd4giLF5.js";
...
import { $i as LOCAL_STORAGE_LOGS_PANEL_OPEN, Jn as UPDATE_WEBHOOK_ID_NODE_TYPES, Pt as CHAT_TRIGGER_NODE_TYPE, Qi as LOCAL_STORAGE_LOGS_PANEL_DETAILS_PANEL_SUB_NODE, Un as STICKY_NODE_TYPE, Zi as LOCAL_STORAGE_LOGS_PANEL_DETAILS_PANEL, dn as MANUAL_CHAT_TRIGGER_NODE_TYPE, ea as LOCAL_STORAGE_LOGS_SYNC_SELECTION, ja as CANVAS_ZOOMED_VIEW_EXPERIMENT, no as NDV_IN_FOCUS_PANEL_EXPERIMENT, po as EnterpriseEditionFeature } from "./constants-CAglk9RE.js";
...
import { f as isPresent, v as tryToParseNumber } from "./typesUtils-C0qTIOD0.js";
import { o as getNewWorkflowData } from "./workflowsList.store-BOYS60a8.js";
import { t as useBuilderStore } from "./builder.store-Cz9bYEhM.js";
import { _ as useCanvasStore, a as AddNodeGroupCommand, d as RemoveNodeCommand, f as RemoveNodeGroupCommand, h as UpdateNodeGroupCommand, i as AddNodeCommand, l as MoveNodeCommand, m as ReplaceNodeParametersCommand, n as useHistoryStore, p as RenameNodeCommand, r as AddConnectionCommand, t as useNodeHelpers, u as RemoveConnectionCommand } from "./useNodeHelpers-KiDEvhbn.js";
...
import { t as core_default } from "./core-tr17KRUQ.js";
import { a as bash, i as javascript, n as typescript, r as python, t as xml } from "./xml-Uw3-Q0Bn.js";
import { t as VueMarkdown } from "./VueMarkdown-DisaKEwT.js";
import { t as useSetupPanelStore } from "./setupPanel.store-C3MAGUQL.js";
import { t as clearAllNodeResourceLocatorValues } from "./templateTransforms-LJKbrtf3.js";
...
//#endregion
export { useI18n as A, ChatOptionsSymbol as C, MessageWithButtons_default as D, MessageComponentKey as E, useChat as M, useWorkflowNormalization as N, MarkdownRenderer_default as O, shouldBlockUserInput as S, localStorageSessionIdKey as T, LOGS_PANEL_STATE as _, snapshotGroup as a, constructChatWebsocketUrl as b, addTokenUsageData as c, isChatNode as d, parseAiContent as f, LOCAL_STORAGE_PANEL_WIDTH as g, LOCAL_STORAGE_PANEL_HEIGHT as h, deleteGroupWithHistory as i, useOptions as j, Button_default as k, emptyTokenUsageData as l, LOCAL_STORAGE_OVERVIEW_PANEL_WIDTH as m, useAgentNodeCanvasGeometryStore as n, useSelectionValidation as o, useLogsStore as p, useCanvasNodeGroupTelemetry as r, useExperimentalNdvStore as s, useCanvasOperations as t, formatTokenUsageCount as u, LOG_DETAILS_PANEL_STATE as v, ChatSymbol as w, parseBotChatMessageContent as x, chatEventBus as y };
