  ...
  System.register(["./chunk-legacy-Re9CbdfL.js", "./vue.runtime.esm-bundler-legacy--Sn1h8On.js", "./_MapCache-legacy-Bnay2tPV.js", "./src-legacy-7AvQoEFL.js", "./en-legacy-DJK4SpPN.js", "./preload-helper-legacy-CXRjoQ0T.js", "./_plugin-vue_export-helper-legacy-DZMI5HPp.js", "./truncate-legacy-C0REgs6L.js", "./icon-legacy-CVeQu2M4.js", "./overlay-legacy-ChC8zZ3J.js", "./empty-legacy-ZG0-xpne.js", "./useMessage-legacy-6hGlTqPS.js", "./useTelemetry-legacy-DKRvN4mA.js", "./useToast-legacy-DEFFmTH6.js", "./sanitize-html-legacy-B93rGWi4.js", "./CalendarDate-legacy-BUvNgcoo.js", "./path-browserify-legacy-PZw06cM9.js", "./constants-legacy-BbwdWVie.js", "./merge-legacy-I2FBUck9.js", "./_baseOrderBy-legacy-9y2xV7og.js", "./dateformat-legacy-C4HUJTCr.js", "./useDebounce-legacy-BVuvDrP1.js", "./useExternalHooks-legacy-DyFictUx.js", "./useStyles-legacy-E8NPEyeD.js", "./npsSurvey.store-legacy-BRhjpTEy.js", "./cloudPlan.store-legacy-CVrtJ_NL.js", "./templates.store-legacy-x3SOFlkt.js", "./focusPanel.store-legacy-CzF3CLCV.js", "./useWorkflowSaving-legacy-BhH4Tvrd.js", "./executions.store-legacy-7YJcNBbW.js", "./versions.store-legacy-BmO_kk34.js", "./usePageRedirectionHelper-legacy-CnzXGEMw.js", "./FileSaver.min-legacy-D7uxxng5.js", "./useWorkflowActivate-legacy-DGJGaPgu.js", "./utils-legacy-C0ieWKrN.js", "./WorkflowPreview-legacy-BIK8ZuV9.js", "./useIntersectionObserver-legacy-a8ObNv7k.js"], function (_export, _context) {
    ...
    return {
      setters: [function (_chunkLegacy001Js) {
        ...
        WORKFLOW_HISTORY_VERSION_RESTORE = _constantsLegacy00TJs.hs;
        WORKFLOW_HISTORY_PUBLISH_MODAL_KEY = _constantsLegacy00TJs.ms;
      ...
      execute: function () {
        ...
        __vite_style__.textContent = "/* BEM support Func\n -------------------------- */\n/* Transition\n-------------------------- */\n/* Color\n-------------------------- */\n/* Link\n-------------------------- */\n/* Border\n-------------------------- */\n/* Outline\n-------------------------- */\n/* Box shadow\n-------------------------- */\n/* Fill\n-------------------------- */\n/* Typography\n-------------------------- */\n/* z-index\n-------------------------- */\n/* Disable base\n-------------------------- */\n/* Icon\n-------------------------- */\n/* Checkbox\n-------------------------- */\n/* Radio\n-------------------------- */\n/* Select\n-------------------------- */\n/* Alert\n-------------------------- */\n/* MessageBox\n-------------------------- */\n/* Message\n-------------------------- */\n/* Notification\n-------------------------- */\n/* Input\n-------------------------- */\n/* Cascader\n-------------------------- */\n/* Group\n-------------------------- */\n/* Tab\n-------------------------- */\n/* Button\n-------------------------- */\n/* cascader\n-------------------------- */\n/* Switch\n-------------------------- */\n/* Dialog\n-------------------------- */\n/* Table\n-------------------------- */\n/* Pagination\n-------------------------- */\n/* Popup\n-------------------------- */\n/* Popover\n-------------------------- */\n/* Tooltip\n-------------------------- */\n/* Tag\n-------------------------- */\n/* Tree\n-------------------------- */\n/* Dropdown\n-------------------------- */\n/* Badge\n-------------------------- */\n/* Card\n--------------------------*/\n/* Slider\n--------------------------*/\n/* Steps\n--------------------------*/\n/* Menu\n--------------------------*/\n/* Rate\n--------------------------*/\n/* DatePicker\n--------------------------*/\n/* Loading\n--------------------------*/\n/* Scrollbar\n--------------------------*/\n/* Carousel\n--------------------------*/\n/* Collapse\n--------------------------*/\n/* Transfer\n--------------------------*/\n/* Header\n  --------------------------*/\n/* Footer\n--------------------------*/\n/* Main\n--------------------------*/\n/* Timeline\n--------------------------*/\n/* Backtop\n--------------------------*/\n/* Link\n--------------------------*/\n/* Calendar\n--------------------------*/\n/* Form\n-------------------------- */\n/* Avatar\n--------------------------*/\n/* Break-point\n--------------------------*/\n/* Break-points\n -------------------------- */\n/* Scrollbar\n -------------------------- */\n/* Placeholder\n -------------------------- */\n/* BEM\n -------------------------- */\n._item_rk6hj_123 {\n  display: flex;\n  position: relative;\n  align-items: center;\n  justify-content: space-between;\n  border-left: 2px var(--border-style) transparent;\n  border-bottom: var(--border-width) var(--border-style) var(--color--foreground);\n  color: var(--color--text);\n  font-size: var(--font-size--2xs);\n}\n._item_rk6hj_123 p {\n  display: grid;\n  padding: var(--spacing--sm);\n  cursor: pointer;\n  flex: 1 1 auto;\n}\n._item_rk6hj_123 p time {\n  padding: 0 0 var(--spacing--5xs);\n  color: var(--color--text--shade-1);\n  font-size: var(--font-size--sm);\n  font-weight: var(--font-weight--bold);\n}\n._item_rk6hj_123 p span,\n._item_rk6hj_123 p data {\n  justify-self: start;\n  max-width: 160px;\n  white-space: nowrap;\n  overflow: hidden;\n  text-overflow: ellipsis;\n  margin-top: calc(var(--spacing--4xs) * -1);\n  font-size: var(--font-size--2xs);\n}\n._item_rk6hj_123 p ._mainLine_rk6hj_155 {\n  padding: 0 0 var(--spacing--5xs);\n  color: var(--color--text--shade-1);\n  font-size: var(--font-size--sm);\n  font-weight: var(--font-weight--bold);\n}\n._item_rk6hj_123 p ._metaItem_rk6hj_161 {\n  justify-self: start;\n  max-width: 180px;\n  white-space: nowrap;\n  overflow: hidden;\n  text-overflow: ellipsis;\n  margin-top: calc(var(--spacing--4xs) * -1);\n  font-size: var(--font-size--2xs);\n  padding: 0;\n  color: var(--color--text);\n  font-weight: var(--font-weight--regular);\n}\n._item_rk6hj_123 ._tail_rk6hj_173 {\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n}\n._item_rk6hj_123._selected_rk6hj_178 {\n  background-color: var(--color--background);\n  border-left-color: var(--color--primary);\n}\n._item_rk6hj_123._selected_rk6hj_178 p {\n  cursor: default;\n}\n._item_rk6hj_123:hover, ._item_rk6hj_123._actionsVisible_rk6hj_185 {\n  border-left-color: var(--color--foreground--shade-2);\n}\n._actions_rk6hj_185 {\n  display: block;\n  padding: var(--spacing--3xs);\n}\n._publishedBadge_rk6hj_194 {\n  background-color: var(--color--success);\n  color: var(--color--foreground--tint-2);\n}\n._publishedBadge_rk6hj_194 .n8n-text {\n  font-size: var(--font-size--2xs);\n  line-height: var(--line-height--sm);\n}/* BEM support Func\n -------------------------- */\n/* Transition\n-------------------------- */\n/* Color\n-------------------------- */\n/* Link\n-------------------------- */\n/* Border\n-------------------------- */\n/* Outline\n-------------------------- */\n/* Box shadow\n-------------------------- */\n/* Fill\n-------------------------- */\n/* Typography\n-------------------------- */\n/* z-index\n-------------------------- */\n/* Disable base\n-------------------------- */\n/* Icon\n-------------------------- */\n/* Checkbox\n-------------------------- */\n/* Radio\n-------------------------- */\n/* Select\n-------------------------- */\n/* Alert\n-------------------------- */\n/* MessageBox\n-------------------------- */\n/* Message\n-------------------------- */\n/* Notification\n-------------------------- */\n/* Input\n-------------------------- */\n/* Cascader\n-------------------------- */\n/* Group\n-------------------------- */\n/* Tab\n-------------------------- */\n/* Button\n-------------------------- */\n/* cascader\n-------------------------- */\n/* Switch\n-------------------------- */\n/* Dialog\n-------------------------- */\n/* Table\n-------------------------- */\n/* Pagination\n-------------------------- */\n/* Popup\n-------------------------- */\n/* Popover\n-------------------------- */\n/* Tooltip\n-------------------------- */\n/* Tag\n-------------------------- */\n/* Tree\n-------------------------- */\n/* Dropdown\n-------------------------- */\n/* Badge\n-------------------------- */\n/* Card\n--------------------------*/\n/* Slider\n--------------------------*/\n/* Steps\n--------------------------*/\n/* Menu\n--------------------------*/\n/* Rate\n--------------------------*/\n/* DatePicker\n--------------------------*/\n/* Loading\n--------------------------*/\n/* Scrollbar\n--------------------------*/\n/* Carousel\n--------------------------*/\n/* Collapse\n--------------------------*/\n/* Transfer\n--------------------------*/\n/* Header\n  --------------------------*/\n/* Footer\n--------------------------*/\n/* Main\n--------------------------*/\n/* Timeline\n--------------------------*/\n/* Backtop\n--------------------------*/\n/* Link\n--------------------------*/\n/* Calendar\n--------------------------*/\n/* Form\n-------------------------- */\n/* Avatar\n--------------------------*/\n/* Break-point\n--------------------------*/\n/* Break-points\n -------------------------- */\n/* Scrollbar\n -------------------------- */\n/* Placeholder\n -------------------------- */\n/* BEM\n -------------------------- */\n._list_1i94b_123 {\n  position: absolute;\n  left: 0;\n  top: 0;\n  width: 100%;\n  height: 100%;\n  overflow: auto;\n}\n._empty_1i94b_132 {\n  display: flex;\n  position: absolute;\n  height: 100%;\n  padding: 0 25%;\n  justify-content: center;\n  align-items: center;\n  text-align: center;\n  color: var(--color--text);\n  font-size: var(--font-size--sm);\n  line-height: var(--line-height--lg);\n}\n._loader_1i94b_145 {\n  padding: 0 var(--spacing--sm);\n}\n._retention_1i94b_149 {\n  display: grid;\n  padding: var(--spacing--sm);\n  font-size: var(--font-size--2xs);\n  line-height: var(--line-height--lg);\n  text-align: center;\n}/* BEM support Func\n -------------------------- */\n/* Transition\n-------------------------- */\n/* Color\n-------------------------- */\n/* Link\n-------------------------- */\n/* Border\n-------------------------- */\n/* Outline\n-------------------------- */\n/* Box shadow\n-------------------------- */\n/* Fill\n-------------------------- */\n/* Typography\n-------------------------- */\n/* z-index\n-------------------------- */\n/* Disable base\n-------------------------- */\n/* Icon\n-------------------------- */\n/* Checkbox\n-------------------------- */\n/* Radio\n-------------------------- */\n/* Select\n-------------------------- */\n/* Alert\n-------------------------- */\n/* MessageBox\n-------------------------- */\n/* Message\n-------------------------- */\n/* Notification\n-------------------------- */\n/* Input\n-------------------------- */\n/* Cascader\n-------------------------- */\n/* Group\n-------------------------- */\n/* Tab\n-------------------------- */\n/* Button\n-------------------------- */\n/* cascader\n-------------------------- */\n/* Switch\n-------------------------- */\n/* Dialog\n-------------------------- */\n/* Table\n-------------------------- */\n/* Pagination\n-------------------------- */\n/* Popup\n-------------------------- */\n/* Popover\n-------------------------- */\n/* Tooltip\n-------------------------- */\n/* Tag\n-------------------------- */\n/* Tree\n-------------------------- */\n/* Dropdown\n-------------------------- */\n/* Badge\n-------------------------- */\n/* Card\n--------------------------*/\n/* Slider\n--------------------------*/\n/* Steps\n--------------------------*/\n/* Menu\n--------------------------*/\n/* Rate\n--------------------------*/\n/* DatePicker\n--------------------------*/\n/* Loading\n--------------------------*/\n/* Scrollbar\n--------------------------*/\n/* Carousel\n--------------------------*/\n/* Collapse\n--------------------------*/\n/* Transfer\n--------------------------*/\n/* Header\n  --------------------------*/\n/* Footer\n--------------------------*/\n/* Main\n--------------------------*/\n/* Timeline\n--------------------------*/\n/* Backtop\n--------------------------*/\n/* Link\n--------------------------*/\n/* Calendar\n--------------------------*/\n/* Form\n-------------------------- */\n/* Avatar\n--------------------------*/\n/* Break-point\n--------------------------*/\n/* Break-points\n -------------------------- */\n/* Scrollbar\n -------------------------- */\n/* Placeholder\n -------------------------- */\n/* BEM\n -------------------------- */\n._content_zgnmm_123 {\n  position: absolute;\n  display: block;\n  left: 0;\n  top: 0;\n  width: 100%;\n  height: 100%;\n  overflow: auto;\n}\n._info_zgnmm_133 {\n  position: absolute;\n  z-index: 1;\n  top: 0;\n  left: 0;\n  width: 100%;\n}\n._card_zgnmm_141 {\n  padding: var(--spacing--sm) var(--spacing--lg) 0;\n  border: 0;\n  align-items: start;\n}\n._card_zgnmm_141 ._descriptionBox_zgnmm_146 {\n  display: flex;\n  flex-direction: column;\n  min-width: 228px;\n  max-width: 330px;\n  gap: var(--spacing--3xs);\n  margin-top: var(--spacing--3xs);\n  padding: var(--spacing--xs);\n  border: var(--border-width) var(--border-style) var(--color--foreground);\n  border-radius: var(--radius);\n  background-color: var(--color--background--light-3);\n}\n._card_zgnmm_141 ._descriptionBox_zgnmm_146 ._mainLine_zgnmm_158 {\n  overflow: hidden;\n  text-overflow: ellipsis;\n  white-space: nowrap;\n  cursor: default;\n}\n._card_zgnmm_141 ._textOld_zgnmm_164 {\n  display: flex;\n  flex-direction: column;\n  flex: 1 1 auto;\n}\n._card_zgnmm_141 ._textOld_zgnmm_164 p {\n  display: flex;\n  align-items: center;\n  padding: 0;\n  cursor: default;\n}\n._card_zgnmm_141 ._textOld_zgnmm_164 p:first-child {\n  padding-top: var(--spacing--3xs);\n  padding-bottom: var(--spacing--4xs);\n}\n._card_zgnmm_141 ._textOld_zgnmm_164 p:first-child * {\n  margin-top: auto;\n  font-size: var(--font-size--md);\n}\n._card_zgnmm_141 ._textOld_zgnmm_164 p:last-child {\n  padding-top: var(--spacing--3xs);\n}\n._card_zgnmm_141 ._textOld_zgnmm_164 p:last-child * {\n  font-size: var(--font-size--2xs);\n}\n._card_zgnmm_141 ._textOld_zgnmm_164 p ._label_zgnmm_189 {\n  color: var(--color--text--tint-1);\n  padding-right: var(--spacing--4xs);\n}\n._card_zgnmm_141 ._textOld_zgnmm_164 p * {\n  max-width: unset;\n  justify-self: unset;\n  white-space: unset;\n  overflow: hidden;\n  text-overflow: unset;\n  padding: 0;\n  font-size: var(--font-size--sm);\n}/* BEM support Func\n -------------------------- */\n/* Transition\n-------------------------- */\n/* Color\n-------------------------- */\n/* Link\n-------------------------- */\n/* Border\n-------------------------- */\n/* Outline\n-------------------------- */\n/* Box shadow\n-------------------------- */\n/* Fill\n-------------------------- */\n/* Typography\n-------------------------- */\n/* z-index\n-------------------------- */\n/* Disable base\n-------------------------- */\n/* Icon\n-------------------------- */\n/* Checkbox\n-------------------------- */\n/* Radio\n-------------------------- */\n/* Select\n-------------------------- */\n/* Alert\n-------------------------- */\n/* MessageBox\n-------------------------- */\n/* Message\n-------------------------- */\n/* Notification\n-------------------------- */\n/* Input\n-------------------------- */\n/* Cascader\n-------------------------- */\n/* Group\n-------------------------- */\n/* Tab\n-------------------------- */\n/* Button\n-------------------------- */\n/* cascader\n-------------------------- */\n/* Switch\n-------------------------- */\n/* Dialog\n-------------------------- */\n/* Table\n-------------------------- */\n/* Pagination\n-------------------------- */\n/* Popup\n-------------------------- */\n/* Popover\n-------------------------- */\n/* Tooltip\n-------------------------- */\n/* Tag\n-------------------------- */\n/* Tree\n-------------------------- */\n/* Dropdown\n-------------------------- */\n/* Badge\n-------------------------- */\n/* Card\n--------------------------*/\n/* Slider\n--------------------------*/\n/* Steps\n--------------------------*/\n/* Menu\n--------------------------*/\n/* Rate\n--------------------------*/\n/* DatePicker\n--------------------------*/\n/* Loading\n--------------------------*/\n/* Scrollbar\n--------------------------*/\n/* Carousel\n--------------------------*/\n/* Collapse\n--------------------------*/\n/* Transfer\n--------------------------*/\n/* Header\n  --------------------------*/\n/* Footer\n--------------------------*/\n/* Main\n--------------------------*/\n/* Timeline\n--------------------------*/\n/* Backtop\n--------------------------*/\n/* Link\n--------------------------*/\n/* Calendar\n--------------------------*/\n/* Form\n-------------------------- */\n/* Avatar\n--------------------------*/\n/* Break-point\n--------------------------*/\n/* Break-points\n -------------------------- */\n/* Scrollbar\n -------------------------- */\n/* Placeholder\n -------------------------- */\n/* BEM\n -------------------------- */\n._view_ley84_123 {\n  position: relative;\n  display: grid;\n  width: 100%;\n  grid-template-areas: \"header corner\" \"content list\";\n  grid-template-columns: auto 330px;\n  grid-template-rows: 65px auto;\n  background-color: var(--color--background--light-3);\n}\n._header_ley84_133 {\n  grid-area: header;\n  display: flex;\n  align-items: center;\n  padding: 0 var(--spacing--lg);\n  border-bottom: var(--border-width) var(--border-style) var(--color--foreground);\n}\n._corner_ley84_141 {\n  grid-area: corner;\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n  padding: 0 var(--spacing--3xs) 0 var(--spacing--sm);\n  background-color: var(--color--background--light-2er);\n  border-bottom: var(--border-width) var(--border-style) var(--color--foreground);\n  border-left: var(--border-width) var(--border-style) var(--color--foreground);\n}\n._contentComponentWrapper_ley84_152 {\n  grid-area: content;\n  position: relative;\n}\n._listComponentWrapper_ley84_157 {\n  grid-area: list;\n  position: relative;\n}\n._listComponentWrapper_ley84_157::before {\n  content: \"\";\n  display: block;\n  position: absolute;\n  top: 0;\n  bottom: 0;\n  left: 0;\n  width: var(--border-width);\n  background-color: var(--color--foreground);\n}/*$vite$:1*/";
          ...
          setup(__props, {
            ...
            return (_ctx, _cache) => {
              return openBlock(), createElementBlock("li", {
                ...
                _: 1
              }, 8, ["disabled"]), publishedAt.value ? (openBlock(), createElementBlock("time", {
                key: 1,
                datetime: _ctx.item.updatedAt,
                class: normalizeClass(_ctx.$style.metaItem)
              }, toDisplayString(unref(i18n).baseText("workflowHistory.item.publishedAtLabel")) + " " + toDisplayString(publishedAt.value), 11, _hoisted_2$1)) : createCommentVNode("", true), publishedByUserName.value ? (openBlock(), createElementBlock("span", {
                key: 2,
                class: normalizeClass(_ctx.$style.metaItem)
              }, toDisplayString(publishedByUserName.value), 3)) : createCommentVNode("", true)])) : (openBlock(), createElementBlock("p", {
                key: 1,
                onClick: onItemClick
              }, [createBaseVNode("time", {
                datetime: _ctx.item.createdAt
              }, toDisplayString(formattedCreatedAt.value), 9, _hoisted_3), createVNode(unref(N8nTooltip_default), {
                placement: "right-end",
                disabled: authors.value.size < 2 && !isAuthorElementTruncated.value
              }, {
                content: withCtx(() => [createTextVNode(toDisplayString(props.item.authors), 1)]),
              ...
              }, toDisplayString(idLabel.value), 9, _hoisted_4)]))]), createBaseVNode("div", {
                class: normalizeClass(_ctx.$style.tail)
              }, [unref(isDraftPublishEnabled) && props.isVersionActive ? (openBlock(), createBlock(unref(N8nBadge_default), {
                key: 0,
                size: "medium",
                ...
                _: 1
              }, 8, ["class"])) : createCommentVNode("", true), !unref(isDraftPublishEnabled) && props.index === 0 ? (openBlock(), createBlock(unref(N8nBadge_default), {
                key: 1
              }, {
        ...
        item = "_item_rk6hj_123";
        mainLine$1 = "_mainLine_rk6hj_155";
        metaItem = "_metaItem_rk6hj_161";
        tail = "_tail_rk6hj_173";
        selected = "_selected_rk6hj_178";
        actionsVisible = "_actionsVisible_rk6hj_185";
        actions = "_actions_rk6hj_185";
        publishedBadge = "_publishedBadge_rk6hj_194";
        ...
        content = "_content_zgnmm_123";
        info = "_info_zgnmm_133";
        card = "_card_zgnmm_141";
        descriptionBox = "_descriptionBox_zgnmm_146";
        mainLine = "_mainLine_zgnmm_158";
        textOld = "_textOld_zgnmm_164";
        label = "_label_zgnmm_189";
