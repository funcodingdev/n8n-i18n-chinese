...
import { Fn as useToast, Ms as sanitizeHtml, Rn as useMessage, at as useCredentialsStore, oi as useProjectsStore, pr as useTelemetry, s as useWorkflowsStore, t as useUsersStore } from "./users.store-CP49qwNg.js";
import { La as createResultError, Ra as createResultOk } from "./constants-Co4JQRdg.js";
...
function useQuickConnect() {
	...
	async function connectToPinecone(quickConnectOption) {
		const { ConnectPopup } = await __vitePreload(async () => {
			const { ConnectPopup } = await import("./dist-IJYnOmBw.js");
			return { ConnectPopup };
		}, []);
		return await new Promise((resolve) => {
