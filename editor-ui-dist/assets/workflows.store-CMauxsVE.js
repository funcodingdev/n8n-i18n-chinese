const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/workers-ChpvqtOI.js","assets/comlink-CEsIjpgo.js"])))=>i.map(i=>d[i]);
...
import { _ as addNodeTranslation, g as addHeaders, v as i18n, x as useI18n } from "./_MapCache-BtLoUoWY.js";
import { K as isBinary, Mr as truncate } from "./src-DBjgHNsl.js";
import { f as __vitePreload, s as require_memoize, t as require_get } from "./get-ClwL6hdd.js";
import { L as throttledWatch, j as createEventHook, y as useLocalStorage } from "./dist-CmlFwYoT.js";
import { c as sanitizeHtml, g as useRoute } from "./htmlUtils-C28WcRnH.js";
import { a as getActivePinia, i as defineStore } from "./constants-BtZjhKBq.js";
...
import { b as require_isArrayLike, t as require_merge } from "./merge-CDla_bpN.js";
	...
	const loadNodesInformationFromLocalDb = async (nodeInfos) => {
		try {
			const { getNodeType } = await __vitePreload(async () => {
				const { getNodeType } = await import("./workers-ChpvqtOI.js");
				return { getNodeType };
			}, __vite__mapDeps([0,1]));
			const found = [];
			const missing = [];
	...
	const loadNodeTypesFromLocalDb = async () => {
		try {
			const { loadNodeTypes, getAllNodeTypes } = await __vitePreload(async () => {
				const { loadNodeTypes, getAllNodeTypes } = await import("./workers-ChpvqtOI.js");
				return {
					loadNodeTypes,
					getAllNodeTypes
				};
