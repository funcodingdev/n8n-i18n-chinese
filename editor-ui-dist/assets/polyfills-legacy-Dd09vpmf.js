(function() {
	...
	var require_get_iterator_flattenable = /* @__PURE__ */ __commonJSMin(((exports, module) => {
		...
		module.exports = function(obj, stringHandling) {
			...
			return getIteratorDirect$6(anObject$8(method !== void 0 ? call$10(method, obj) : obj));
		};
	}));
	...
	var IteratorProxy$1 = createIteratorProxy$1(function() {
		...
		while (true) {
			if (inner = this.inner) try {
				result = anObject$7(call$9(inner.next, inner.iterator));
				if (!result.done) return result.value;
				this.inner = null;
			} catch (error) {
				iteratorClose$5(iterator, "throw", error);
			}
			result = anObject$7(call$9(this.next, iterator));
