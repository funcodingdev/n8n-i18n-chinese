const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/pushConnection.store-BG1_giST.js","assets/pushConnection.store-yj4i0jEF.js","assets/vue.runtime.esm-bundler-Bs4WIMNP.js","assets/chunk-CC9Q-vWm.js","assets/src-B7RBhJEE.js","assets/get-B4jH38OP.js","assets/_MapCache-CveP8-Y8.js","assets/merge-XG_E66cT.js","assets/expression-runtime-stub-Ctf5Dv5M.js","assets/__vite-browser-external-DLY6DjNi.js","assets/useRootStore-DW1e2yEy.js","assets/lib-D10cRSie.js","assets/assert-dkcf3flH.js","assets/settings.store-CGBV4pQW.js","assets/useDebounce-BVsH9Yn4.js","assets/constants2-JUBWMnBE.js","assets/durations-D_iMA_ix.js"])))=>i.map(i=>d[i]);
...
import { E as useWorkflowDocumentStore, S as createWorkflowDocumentId, Ur as getNodesWithNormalizedPosition, mn as useProjectsStore, n as buildExecutionResponseFromSchema, t as useWorkflowsStore, xt as useCredentialsStore, y as useWorkflowExecutionStateStore } from "./workflows.store-CE9to9ba.js";
...
import { t as isPostMessageOriginAllowed } from "./postMessageUtils-CtVwDRS_.js";
		...
		try {
			...
			if (json && json.command === "openWorkflow") try {
				...
				const { usePushConnectionStore } = await __vitePreload(async () => {
					const { usePushConnectionStore } = await import("./pushConnection.store-BG1_giST.js");
