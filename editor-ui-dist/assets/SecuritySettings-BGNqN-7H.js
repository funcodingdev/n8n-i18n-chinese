...
import { $ as openBlock, A as createTextVNode, C as createBaseVNode, Cn as toDisplayString, E as createElementBlock, Gt as unref, It as ref, N as defineComponent, S as computed, T as createCommentVNode, _ as Fragment, bt as withCtx, c as useCssModule, j as createVNode, vn as normalizeClass, w as createBlock } from "./vue.runtime.esm-bundler-Bs4WIMNP.js";
import { Q as I18nT, Z as useI18n, c as useAsyncState } from "./dist-zd3FSkom.js";
import { Ki as N8nBadge_default, Rt as N8nHeading_default, ao as N8nText_default, at as N8nNotice_default, b as AlertDialog_default, fn as ElSwitch, l as Select_default, oa as N8nTooltip_default, wt as N8nLink_default } from "./src-Y_a_nQpS.js";
import { t as _plugin_vue_export_helper_default } from "./_plugin-vue_export-helper-Da88TEg1.js";
import { t as useToast } from "./useToast-D16zTJZS.js";
import { t as useRootStore } from "./useRootStore-H_HdEClX.js";
import { U as getSecuritySettings, W as updateSecuritySettings, t as useSettingsStore } from "./settings.store-CQqpFn-s.js";
import { Ac as EnterpriseEditionFeature, y as EXECUTION_DATA_REDACTION_ENFORCEMENT_DOCS_URL } from "./constants-BzyjfRY2.js";
import { t as useUsersStore } from "./users.store-BX_EXxZ2.js";
import { t as usePageRedirectionHelper } from "./usePageRedirectionHelper-DKrBERil.js";
import { t as EnterpriseEdition_ee_default } from "./EnterpriseEdition.ee-j1MjcyL_.js";
import { t as useEnvFeatureFlag } from "./useEnvFeatureFlag-BAFoohzI.js";
import "./security-settings-D7NyhI1X.js";
...
var WorkflowReviewsSection_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		...
		async function persist(value) {
			...
			isSaving.value = true;
			try {
				await updateSecuritySettings(rootStore.restApiContext, { workflowReviews: { enabled: value } });
				showToast({
					type: "success",
					title: i18n.baseText(value ? "settings.security.workflowReviews.success.enabled" : "settings.security.workflowReviews.success.disabled"),
					message: ""
				});
			} catch (error) {
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("div", null, [createBaseVNode("div", { class: normalizeClass(unref($style).settingsContainer) }, [createBaseVNode("div", { class: normalizeClass(unref($style).settingsContainerInfo) }, [createVNode(unref(N8nText_default), { bold: true }, {
...
var WorkflowReviewsSection_vue_vue_type_style_index_0_lang_module_default = {
	settingsContainer: "_settingsContainer_1y6f0_2",
	settingsContainerInfo: "_settingsContainerInfo_1y6f0_10",
	settingsContainerAction: "_settingsContainerAction_1y6f0_21"
};
...
var SecuritySettings_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		...
		const isWorkflowReviewsAvailable = computed(() => settingsStore.isEnterpriseFeatureEnabled[EnterpriseEditionFeature.WorkflowReviews] && checkEnvFeatureFlag.value("WORKFLOW_REVIEWS"));
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("div", _hoisted_1, [
				...
				isSecuritySettingsSettled.value && isWorkflowReviewsAvailable.value && unref(state) !== void 0 ? (openBlock(), createElementBlock(Fragment, { key: 2 }, [createBaseVNode("div", { class: normalizeClass(["mb-s", unref($style).headerTitle]) }, [createVNode(unref(N8nHeading_default), {
					tag: "h2",
					size: "large"
				}, {
