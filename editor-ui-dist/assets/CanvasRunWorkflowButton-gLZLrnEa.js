...
import { n as computedAsync } from "./dist-CYNfKCbA.js";
import { t as N8nText_default } from "./N8nText-Cyh6n6lU.js";
import { d as useExpressionResolveCtx } from "./useWorkflowDocumentRenderData-B-5lpech.js";
import { n as truncateBeforeLast } from "./truncate-B0m9bkui.js";
import { t as N8nTooltip_default } from "./N8nTooltip-B3IH6E0U.js";
import { d as isPlaceholderValue, u as findPlaceholderDetails } from "./builder.store-DWNfuX_2.js";
...
import { D as NodeCredentials_default, t as ParameterInputList_default } from "./ParameterInputList-CkmLMVVW.js";
import { B as require_uniq, Ei as checkExhaustive, Et as useCredentialsStore, F as getNodeTypeDisplayableCredentials, H as useNodeTypesStore, O as injectWorkflowDocumentStore, T as createWorkflowDocumentId, Tt as listenForCredentialChanges, Yn as getInactiveCredentials, cn as sortNodesByExecutionOrder, en as useWorkflowHelpers, mn as useEnvironmentsStore, nr as getTriggerNodeServiceName, sn as sanitizeConnections, t as useWorkflowsStore, un as injectNDVStore, y as useWorkflowExecutionStateStore, zr as PUSH_NODES_OFFSET } from "./workflows.store-Dti-Ds2u.js";
import { Ai as getNodeParameters, Ga as EXECUTE_WORKFLOW_TRIGGER_NODE_TYPE, In as extractReferencesInNodeExpressions, Ki as nodeAcceptsInputType, Wa as EXECUTE_WORKFLOW_NODE_TYPE, io as v4, ji as getNodeParametersIssues$1, la as NodeConnectionTypes, oa as isResourceLocatorValue, oo as require_isEqual, pa as isExpression, wi as displayParameter } from "./src-BrbN-vPn.js";
...
import { N as PLACEHOLDER_FILLED_AT_EXECUTION_TIME, _i as WORKFLOW_EXTRACTION_NAME_MODAL_KEY, da as ExpressionLocalResolveContextSymbol, fn as MANUAL_TRIGGER_NODE_TYPE } from "./constants-Bwbcx8Ih.js";
import { n as useUIStore } from "./ui.store-KcYYy7Mp.js";
import { h as UpdateNodeGroupCommand, n as useHistoryStore, t as useNodeHelpers } from "./useNodeHelpers-BMzBNnOh.js";
import { t as useTemplatesStore } from "./templates.store-DQfTF9D9.js";
import { i as globalLinkActionsEventBus } from "./event-bus-CDvComrA.js";
import { t as useClipboard } from "./useClipboard-DwVAOfeD.js";
import { d as isChatNode, i as deleteGroupWithHistory, o as useSelectionValidation, p as useLogsStore, r as useCanvasNodeGroupTelemetry, t as useCanvasOperations } from "./useCanvasOperations-Bi-odKQU.js";
import { t as NodeIcon_default } from "./NodeIcon-BhUbzeyi.js";
import { r as useNodeExecution } from "./VirtualSchema-Ct3FZen7.js";
...
function useWorkflowExtraction() {
	...
	*/
	function computeSubworkflowNodeGroups(extractedNodes) {
		const extractedIds = new Set(extractedNodes.map((node) => node.id));
		const groups = [];
		for (const group of workflowDocumentStore.value.allGroups) {
			if (!group.nodeIds.every((id) => extractedIds.has(id))) continue;
			if (!(extractedIds.size > group.nodeIds.length)) continue;
			groups.push({
	...
	function getNonMainConnectionTargets(nodeName, connections) {
		...
		for (const [type, connectionsByOutputIndex] of Object.entries(nodeConnections)) {
			...
			for (const outputConnections of connectionsByOutputIndex) for (const connection of outputConnections ?? []) targets.push(connection.node);
		}
		return targets;
	}
	function getNodesToRemoveFromParent(extractedNodes, connections) {
		const extractedNodeNames = new Set(extractedNodes.map((node) => node.name));
		const nonMainTargetsByNodeName = new Map(extractedNodes.map((node) => [node.name, getNonMainConnectionTargets(node.name, connections)]));
		const subNodeNames = new Set([...nonMainTargetsByNodeName.entries()].filter(([, targets]) => targets.some((target) => extractedNodeNames.has(target))).map(([nodeName]) => nodeName));
		const preservedNodeNames = new Set([...subNodeNames].filter((nodeName) => (nonMainTargetsByNodeName.get(nodeName) ?? []).some((target) => !extractedNodeNames.has(target))));
		...
		while (didAddPreservedNode) {
			...
			for (const nodeName of subNodeNames) {
				...
				if (!(nonMainTargetsByNodeName.get(nodeName) ?? []).some((target) => preservedNodeNames.has(target))) continue;
	...
	async function replaceParentSelectionWithSubworkflowNode(executeWorkflowNodeData, startId, endId, nodesToRemoveFromParent, rewrittenDownstreamNodes) {
		...
		addReplacementNodeToCanvasGroup(nodesToRemoveFromParent.map((node) => node.id), executeWorkflowNode.id);
		...
		canvasOperations.deleteNodes(nodesToRemoveFromParent.map((x) => x.id), CANVAS_HISTORY_OPTIONS);
	...
	function addReplacementNodeToCanvasGroup(removableNodeIds, replacementNodeId) {
		const affectedGroupIds = (0, import_uniq.default)(removableNodeIds.map((nodeId) => workflowDocumentStore.value.getGroupForNode(nodeId)?.id).filter((id) => id !== void 0));
		...
		if (groupBeforeReplacements.nodeIds.filter((id) => !removableNodeIds.includes(id)).length === 0) {
		...
		if (groupAfterReplacements) historyStore.pushCommandToUndo(new UpdateNodeGroupCommand({
			...groupBeforeReplacements,
			nodeIds: [...groupBeforeReplacements.nodeIds]
		}, {
			...groupAfterReplacements,
			nodeIds: [...groupAfterReplacements.nodeIds]
		}, Date.now()));
	}
	function tryExtractNodesIntoSubworkflow(nodeIds) {
		const result = isSelectionExtractable(expandSelectionWithSubNodes(nodeIds));
		if (!result.valid) {
	...
	async function doExtractNodesIntoSubworkflow(extractionBoundary, extractedNodes, newWorkflowName) {
		...
		const nodesToRemoveFromParent = getNodesToRemoveFromParent(extractedNodes, workflowDocumentStore.value.connectionsBySourceNode);
		...
		const { nodes, variables } = extractReferencesInNodeExpressions(extractedNodes, allNodeNames, startNodeName, start ? [start] : void 0);
		...
		const { nodes: afterNodes, variables: afterVariables } = extractReferencesInNodeExpressions(allAfterEndNodes, allAfterEndNodes.map((x) => x.name).concat(removedParentNodeNames), executeWorkflowNodeName, directAfterEndNodeNames);
		const createdWorkflow = await tryCreateWorkflow(makeSubworkflow(newWorkflowName, extractionBoundary, nodes, workflowDocumentStore.value?.connectionsBySourceNode, variables, afterVariables, startNodeName, returnNodeName));
		if (createdWorkflow === null) return false;
		const executeWorkflowPosition = computeAveragePosition(nodesToRemoveFromParent.length > 0 ? nodesToRemoveFromParent : extractedNodes);
		await replaceParentSelectionWithSubworkflowNode(makeExecuteWorkflowNode(createdWorkflow.id, executeWorkflowNodeName, executeWorkflowPosition, variables), nodesToRemoveFromParent.find((x) => x.name === start)?.id, nodesToRemoveFromParent.find((x) => x.name === end)?.id, nodesToRemoveFromParent, afterNodes);
		return true;
	}
	...
	*/
	async function extractNodesIntoSubworkflow(extractionBoundary, extractedNodes, newWorkflowName) {
		const success = await doExtractNodesIntoSubworkflow(extractionBoundary, extractedNodes, newWorkflowName);
...
//#endregion
//#region src/features/setupPanel/components/TriggerExecuteButton.vue?vue&type=style&index=0&lang.module.scss
var tooltipItem = "_tooltipItem_zuv3i_388";
var shimmer$3 = "_shimmer_zuv3i_1";
var spin$3 = "_spin_zuv3i_1";
var opacityPulse$3 = "_opacityPulse_zuv3i_1";
var popoverIn$3 = "_popoverIn_zuv3i_1";
var fadeIn$3 = "_fadeIn_zuv3i_1";
var collapsibleSlideDown$3 = "_collapsibleSlideDown_zuv3i_1";
var collapsibleSlideUp$3 = "_collapsibleSlideUp_zuv3i_1";
var collapsibleSlideDownBlurred$3 = "_collapsibleSlideDownBlurred_zuv3i_1";
var collapsibleSlideUpBlurred$3 = "_collapsibleSlideUpBlurred_zuv3i_1";
var blurSwapIn$3 = "_blurSwapIn_zuv3i_1";
var blurSwapOut$3 = "_blurSwapOut_zuv3i_1";
var pulseGlow$3 = "_pulseGlow_zuv3i_1";
var pulseGlowDelayed$3 = "_pulseGlowDelayed_zuv3i_1";
var fade$3 = "_fade_zuv3i_1";
var fadeInUp$3 = "_fadeInUp_zuv3i_1";
var fadeInDown$3 = "_fadeInDown_zuv3i_1";
var fadeInLeft$3 = "_fadeInLeft_zuv3i_1";
var fadeInRight$3 = "_fadeInRight_zuv3i_1";
var fadeOut$3 = "_fadeOut_zuv3i_1";
var fadeOutDown$3 = "_fadeOutDown_zuv3i_1";
var fadeOutUp$3 = "_fadeOutUp_zuv3i_1";
var fadeOutLeft$3 = "_fadeOutLeft_zuv3i_1";
var fadeOutRight$3 = "_fadeOutRight_zuv3i_1";
var ping$3 = "_ping_zuv3i_1";
var blinkBackground$3 = "_blinkBackground_zuv3i_1";
var typingBlink$3 = "_typingBlink_zuv3i_1";
var TriggerExecuteButton_vue_vue_type_style_index_0_lang_module_default = {
	tooltipItem,
	shimmer: shimmer$3,
	spin: spin$3,
	"skeleton-pulse": "_skeleton-pulse_zuv3i_1",
...
var container = "_container_1ovq5_388";
var header = "_header_1ovq5_392";
var expanded = "_expanded_1ovq5_404";
var shimmer$2 = "_shimmer_1ovq5_1";
var spin$2 = "_spin_1ovq5_1";
var opacityPulse$2 = "_opacityPulse_1ovq5_1";
var popoverIn$2 = "_popoverIn_1ovq5_1";
var fadeIn$2 = "_fadeIn_1ovq5_1";
var collapsibleSlideDown$2 = "_collapsibleSlideDown_1ovq5_1";
var collapsibleSlideUp$2 = "_collapsibleSlideUp_1ovq5_1";
var collapsibleSlideDownBlurred$2 = "_collapsibleSlideDownBlurred_1ovq5_1";
var collapsibleSlideUpBlurred$2 = "_collapsibleSlideUpBlurred_1ovq5_1";
var blurSwapIn$2 = "_blurSwapIn_1ovq5_1";
var blurSwapOut$2 = "_blurSwapOut_1ovq5_1";
var pulseGlow$2 = "_pulseGlow_1ovq5_1";
var pulseGlowDelayed$2 = "_pulseGlowDelayed_1ovq5_1";
var fade$2 = "_fade_1ovq5_1";
var fadeInUp$2 = "_fadeInUp_1ovq5_1";
var fadeInDown$2 = "_fadeInDown_1ovq5_1";
var fadeInLeft$2 = "_fadeInLeft_1ovq5_1";
var fadeInRight$2 = "_fadeInRight_1ovq5_1";
var fadeOut$2 = "_fadeOut_1ovq5_1";
var fadeOutDown$2 = "_fadeOutDown_1ovq5_1";
var fadeOutUp$2 = "_fadeOutUp_1ovq5_1";
var fadeOutLeft$2 = "_fadeOutLeft_1ovq5_1";
var fadeOutRight$2 = "_fadeOutRight_1ovq5_1";
var ping$2 = "_ping_1ovq5_1";
var blinkBackground$2 = "_blinkBackground_1ovq5_1";
var typingBlink$2 = "_typingBlink_1ovq5_1";
var WebhookUrlPreview_vue_vue_type_style_index_0_lang_module_default = {
	container,
	header,
	"chevron-icon": "_chevron-icon_1ovq5_400",
	expanded,
	"header-label": "_header-label_1ovq5_408",
	"url-list": "_url-list_1ovq5_412",
	"url-row": "_url-row_1ovq5_420",
	"method-badge": "_method-badge_1ovq5_430",
	"url-text": "_url-text_1ovq5_442",
	shimmer: shimmer$2,
	spin: spin$2,
	"skeleton-pulse": "_skeleton-pulse_1ovq5_1",
...
function getNodeCredentialTypes(nodeTypeProvider, node) {
	...
	if (node.credentials) {
		...
		for (const credType of Object.keys(node.credentials)) if (!inactiveTypes.has(credType)) credentialTypes.add(credType);
	}
...
//#endregion
//#region src/features/setupPanel/components/cards/SetupCardBody.vue?vue&type=style&index=0&lang.module.scss
var body = "_body_1pvr2_388";
var credentialContainer = "_credentialContainer_1pvr2_394";
var nodesHint = "_nodesHint_1pvr2_402";
var shimmer$1 = "_shimmer_1pvr2_1";
var spin$1 = "_spin_1pvr2_1";
var opacityPulse$1 = "_opacityPulse_1pvr2_1";
var popoverIn$1 = "_popoverIn_1pvr2_1";
var fadeIn$1 = "_fadeIn_1pvr2_1";
var collapsibleSlideDown$1 = "_collapsibleSlideDown_1pvr2_1";
var collapsibleSlideUp$1 = "_collapsibleSlideUp_1pvr2_1";
var collapsibleSlideDownBlurred$1 = "_collapsibleSlideDownBlurred_1pvr2_1";
var collapsibleSlideUpBlurred$1 = "_collapsibleSlideUpBlurred_1pvr2_1";
var blurSwapIn$1 = "_blurSwapIn_1pvr2_1";
var blurSwapOut$1 = "_blurSwapOut_1pvr2_1";
var pulseGlow$1 = "_pulseGlow_1pvr2_1";
var pulseGlowDelayed$1 = "_pulseGlowDelayed_1pvr2_1";
var fade$1 = "_fade_1pvr2_1";
var fadeInUp$1 = "_fadeInUp_1pvr2_1";
var fadeInDown$1 = "_fadeInDown_1pvr2_1";
var fadeInLeft$1 = "_fadeInLeft_1pvr2_1";
var fadeInRight$1 = "_fadeInRight_1pvr2_1";
var fadeOut$1 = "_fadeOut_1pvr2_1";
var fadeOutDown$1 = "_fadeOutDown_1pvr2_1";
var fadeOutUp$1 = "_fadeOutUp_1pvr2_1";
var fadeOutLeft$1 = "_fadeOutLeft_1pvr2_1";
var fadeOutRight$1 = "_fadeOutRight_1pvr2_1";
var ping$1 = "_ping_1pvr2_1";
var blinkBackground$1 = "_blinkBackground_1pvr2_1";
var typingBlink$1 = "_typingBlink_1pvr2_1";
var SetupCardBody_vue_vue_type_style_index_0_lang_module_default = {
	...
	shimmer: shimmer$1,
	spin: spin$1,
	"skeleton-pulse": "_skeleton-pulse_1pvr2_1",
...
var useWorkflowSetupState = (nodes, options) => {
	...
	*/
	...
	const hasTriggerExecutedSuccessfully = (nodeName) => {
		const runData = useWorkflowExecutionStateStore(createWorkflowDocumentId(workflowsStore.workflowId)).getActiveExecutionRunDataByNodeName(nodeName);
...
var component = "_component_7jyja_388";
var split = "_split_7jyja_394";
var button = "_button_7jyja_394";
var divider = "_divider_7jyja_406";
var chevron = "_chevron_7jyja_411";
var menu = "_menu_7jyja_418";
var menuPopper = "_menuPopper_7jyja_422";
var menuItem = "_menuItem_7jyja_426";
var disabled = "_disabled_7jyja_432";
var menuIcon = "_menuIcon_7jyja_432";
var buttonContent = "_buttonContent_7jyja_436";
var subText = "_subText_7jyja_443";
var shimmer = "_shimmer_7jyja_1";
var spin = "_spin_7jyja_1";
var opacityPulse = "_opacityPulse_7jyja_1";
var popoverIn = "_popoverIn_7jyja_1";
var fadeIn = "_fadeIn_7jyja_1";
var collapsibleSlideDown = "_collapsibleSlideDown_7jyja_1";
var collapsibleSlideUp = "_collapsibleSlideUp_7jyja_1";
var collapsibleSlideDownBlurred = "_collapsibleSlideDownBlurred_7jyja_1";
var collapsibleSlideUpBlurred = "_collapsibleSlideUpBlurred_7jyja_1";
var blurSwapIn = "_blurSwapIn_7jyja_1";
var blurSwapOut = "_blurSwapOut_7jyja_1";
var pulseGlow = "_pulseGlow_7jyja_1";
var pulseGlowDelayed = "_pulseGlowDelayed_7jyja_1";
var fade = "_fade_7jyja_1";
var fadeInUp = "_fadeInUp_7jyja_1";
var fadeInDown = "_fadeInDown_7jyja_1";
var fadeInLeft = "_fadeInLeft_7jyja_1";
var fadeInRight = "_fadeInRight_7jyja_1";
var fadeOut = "_fadeOut_7jyja_1";
var fadeOutDown = "_fadeOutDown_7jyja_1";
var fadeOutUp = "_fadeOutUp_7jyja_1";
var fadeOutLeft = "_fadeOutLeft_7jyja_1";
var fadeOutRight = "_fadeOutRight_7jyja_1";
var ping = "_ping_7jyja_1";
var blinkBackground = "_blinkBackground_7jyja_1";
var typingBlink = "_typingBlink_7jyja_1";
var CanvasRunWorkflowButton_vue_vue_type_style_index_0_lang_module_default = {
	...
	shimmer,
	spin,
	"skeleton-pulse": "_skeleton-pulse_7jyja_1",
	opacityPulse,
	popoverIn,
	fadeIn,
...
//#endregion
export { useWebhookUrls as a, isCardComplete as c, SetupCardSection_default as d, WebhookUrlPreview_default as f, useWorkflowExtraction as h, useNodeGroupSections as i, isHttpRequestNodeType as l, useGlobalLinkActions as m, useWorkflowSetupState as n, useTriggerExecution as o, TriggerExecuteButton_default as p, sectionHasParameters as r, SetupCardBody_default as s, CanvasRunWorkflowButton_default as t, isNodeGroupCard as u };
