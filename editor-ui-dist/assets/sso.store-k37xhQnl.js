...
import { $ as testSamlConfig, Bt as testLdapConnection, G as getOidcConfig, J as initSSO, K as getSamlConfig, Lt as getLdapConfig, Q as testOidcConfig, Rt as getLdapSynchronizations, Vt as updateLdapConfig, X as saveOidcConfig, Z as saveSamlConfig, dr as defineStore, q as getSamlMetadata, t as useRootStore, zt as runLdapSync } from "./useRootStore-BZ6J9jMu.js";
import { yt as AuthenticationMethod } from "./src-D3mf01t5.js";
...
var useSSOStore = defineStore("sso", () => {
	...
	*/
	...
	const isDefaultAuthenticationSaml = computed(() => authenticationMethod.value === AuthenticationMethod.Saml);
	...
	*/
	...
	const isDefaultAuthenticationOidc = computed(() => authenticationMethod.value === AuthenticationMethod.Oidc);
	/**
	* LDAP Configuration
	*/
	const ldap = ref({
