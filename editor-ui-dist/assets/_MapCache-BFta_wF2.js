...
var zh_CN_default = {
	...
	"codeNodeEditor.completer.$tool": "当前正在执行的工具名称。仅在HITL节点中可用",
	...
	"credentialEdit.credentialConfig.dynamicCredentials.infoTip": "启用此凭证以便与工作流解析器一起使用",
	"credentialEdit.credentialConfig.dynamicCredentials.description1": "在工作流设置中需要一个工作流解析器。",
	"credentialEdit.credentialConfig.dynamicCredentials.description2": "在运行时，它使用该解析器根据触发工作流的用户选择凭据。",
	"credentialEdit.credentialConfig.dynamicCredentials.documentation": "文档",
	"credentialEdit.credentialConfig.dynamicCredentials.docsUrl": "抱歉，我无法访问外部链接。请提供您想要翻译的具体文本内容。",
