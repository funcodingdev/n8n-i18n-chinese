...
import { at as useI18n, m as useEventListener, o as useActiveElement, ot as I18nT, p as useElementSize, v as useLocalStorage, y as useMediaQuery } from "./core-D8FH-7X4.js";
...
import { Fn as useToast, Po as INVITE_USER_MODAL_KEY, ci as hasPermission, gi as hasRole, pr as useTelemetry, r as useUIStore, t as useUsersStore, zt as useDocumentTitle } from "./users.store-CP49qwNg.js";
import { Gs as v4, Ni as LOCAL_STORAGE_CHAT_HUB_HAD_CONVERSATION_BEFORE, Pi as LOCAL_STORAGE_CHAT_HUB_SELECTED_MODEL, da as PROVIDER_CREDENTIAL_TYPE_MAP, ma as chatHubConversationModelSchema, oa as ROLE, tl as EnterpriseEditionFeature, zr as VIEWS } from "./constants-Co4JQRdg.js";
...
import { l as shouldIgnoreCanvasShortcut } from "./canvas.utils-MZd7ZOOK.js";
...
import { c as CHAT_VIEW, d as MOBILE_MEDIA_QUERY, n as CHAT_CONVERSATION_VIEW, t as AGENT_EDITOR_MODAL_KEY } from "./constants-DAn60oew.js";
import { a as authorizeDynamicCredential, i as collectChatArtifacts, l as fetchWorkflowExecutionStatus, t as useChatStore, u as revokeDynamicCredential } from "./chat.store-lgK38Y5C.js";
import { T as unflattenModel, _ as isLlmProvider, l as findOneFromModelsResponse, u as flattenModel } from "./fileUtils-B3_VlOCt.js";
...
import { n as useChatCredentials, r as chatHubConversationModelWithCachedDisplayNameSchema, t as ChatLayout_default } from "./ChatLayout-Bh-UrbbW.js";
import { n as ModelSelector_default, t as useCustomAgent } from "./useCustomAgent-DeNklOus.js";
