...
import { M as useLocalStorage, S as useClipboard, yt as useI18n } from "./_MapCache-pm4B1YcD.js";
import { Ci as useRoute, _t as createEventBus, ki as require_markdown_it_link_attributes, wi as useRouter } from "./src-B3wEFHds.js";
import { t as __plugin_vue_export_helper_default } from "./_plugin-vue_export-helper-DltO58Gh.js";
import { An as doRectsOverlap, Bt as useNDVStore, C as useNodeTypesStore, Dn as GRID_SIZE, En as DEFAULT_VIEWPORT_BOUNDARIES, Fr as usePostHog, Gt as useProjectsStore, Ht as useWorkflowState, In as getNewNodePosition, It as useNodeHelpers, Lt as useTelemetry, On as PUSH_NODES_OFFSET, Ot as useTagsStore, R as removePreviewToken, Rn as getNodesGroupSize, Si as ReplaceNodeParametersCommand, Sn as CONFIGURABLE_NODE_SIZE, Sr as useCanvasStore, Tn as DEFAULT_NODE_SIZE, Tt as useWorkflowHelpers, Vt as injectWorkflowState, ai as isValidNodeConnectionType, bi as RemoveNodeCommand, ca as isPresent, ct as useDataSchema, d as isChatNode, di as CanvasNodeRenderType, fi as useHistoryStore, gn as useFocusPanelStore, jn as generateOffsets, jt as useWorkflowDocumentStore, kt as createWorkflowDocumentId, li as CanvasConnectionMode, mi as AddNodeCommand, pa as tryToParseNumber, pi as AddConnectionCommand, r as useUIStore, rt as useCredentialsStore, s as useWorkflowsStore, vi as MoveNodeCommand, wn as CONFIGURATION_NODE_SIZE, ws as useSettingsStore, xi as RenameNodeCommand, xn as useTemplatesStore, xr as useExternalHooks, y as getExecutionErrorToastConfiguration, yi as RemoveConnectionCommand, yr as useToast, zr as v4_default } from "./users.store-Cfyj76Cq.js";
import { Ac as CANVAS_ZOOMED_VIEW_EXPERIMENT, Cr as WEBHOOK_NODE_TYPE, Hi as require__baseUniq, Ni as require_cloneDeep, Nn as MCP_TRIGGER_NODE_TYPE, Rc as NDV_IN_FOCUS_PANEL_EXPERIMENT, Sa as isHitlToolType, Ua as deepCopy, Wa as isCommunityPackageName, Yc as EnterpriseEditionFeature, co as NodeConnectionTypes, da as getNodeInputs, ec as LOCAL_STORAGE_LOGS_PANEL_DETAILS_PANEL, fa as getNodeOutputs, gn as FORM_TRIGGER_NODE_TYPE, hr as STICKY_NODE_TYPE, nc as LOCAL_STORAGE_LOGS_PANEL_OPEN, pa as getNodeParameters, rc as LOCAL_STORAGE_LOGS_SYNC_SELECTION, rs as VIEWS, sa as generateNodesGraph, tc as LOCAL_STORAGE_LOGS_PANEL_DETAILS_PANEL_SUB_NODE, ua as getConnectionTypes, va as getSubworkflowId, xr as UPDATE_WEBHOOK_ID_NODE_TYPES } from "./constants-Da_CaOjC.js";
import { j as defineStore, r as useRootStore } from "./_baseOrderBy-sLFpBNOQ.js";
import { t as useExecutionsStore } from "./executions.store-C1uP3mjd.js";
import { t as usePinnedData } from "./usePinnedData-Bzp4yEO4.js";
import { a as mapLegacyConnectionToCanvasConnection, c as parseCanvasConnectionHandleString, i as mapCanvasConnectionToLegacyConnection, n as createCanvasConnectionHandleString, o as mapLegacyConnectionsToCanvasConnections } from "./canvas.utils-BVvTHoyE.js";
...
import { t as useFoldersStore } from "./folders.store-C98OBIEG.js";
