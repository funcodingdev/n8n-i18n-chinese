    ...
    */
    ...
    return {
      setters: [function (_chunkLegacy001Js) {
        ...
        PopOutWindowKey = _constantsLegacy00TJs.ec;
      ...
      }, function (_xmlLegacy05tJs) {
        bash = _xmlLegacy05tJs.a;
        javascript = _xmlLegacy05tJs.i;
        typescript = _xmlLegacy05tJs.n;
        python = _xmlLegacy05tJs.r;
        xml = _xmlLegacy05tJs.t;
      }, function (_useLogsTreeExpandLegacy06TJs) {
        isPlaceholderLog = _useLogsTreeExpandLegacy06TJs._;
        LogsViewConsumedTokenCountText_default = _useLogsTreeExpandLegacy06TJs.a;
        restoreChatHistory = _useLogsTreeExpandLegacy06TJs.b;
        getDepth = _useLogsTreeExpandLegacy06TJs.f;
        getTotalConsumedTokens = _useLogsTreeExpandLegacy06TJs.g;
        getSubtreeTotalConsumedTokens = _useLogsTreeExpandLegacy06TJs.h;
        LogsViewNodeName_default = _useLogsTreeExpandLegacy06TJs.i;
        findLogEntryRec = _useLogsTreeExpandLegacy06TJs.l;
        getInputKey = _useLogsTreeExpandLegacy06TJs.m;
        useLogsExecutionData = _useLogsTreeExpandLegacy06TJs.n;
        getEntryAtRelativeIndex = _useLogsTreeExpandLegacy06TJs.p;
        LogsOverviewRows_default = _useLogsTreeExpandLegacy06TJs.r;
        extractBotResponse = _useLogsTreeExpandLegacy06TJs.s;
        useLogsTreeExpand = _useLogsTreeExpandLegacy06TJs.t;
        findSelectedLogEntry = _useLogsTreeExpandLegacy06TJs.u;
        isSubNodeLog = _useLogsTreeExpandLegacy06TJs.v;
        processFiles = _useLogsTreeExpandLegacy06TJs.y;
      }, function (_coreLegacy06VJs) {
        core_default = _coreLegacy06VJs.t;
      }],
      execute: function () {
