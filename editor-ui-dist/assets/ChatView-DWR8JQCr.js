const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/es-B7eRVvzT.js","assets/core-D8Mk0l5n.js","assets/chunk-r2Y0G7H8.js","assets/languageModules-BcWbCvrG.js","assets/xml-D7HpP_o1.js"])))=>i.map(i=>d[i]);
import { o as __toESM, t as __commonJSMin } from "./chunk-r2Y0G7H8.js";
import { $ as openBlock, A as createTextVNode, C as createBaseVNode, E as createElementBlock, Ft as ref, Ht as toValue, K as onBeforeMount, N as defineComponent, O as createSlots, S as computed, Sn as toDisplayString, T as createCommentVNode, W as nextTick, Wt as unref, _ as Fragment, _n as normalizeClass, c as useCssModule, gt as watch, h as withModifiers, j as createVNode, n as Transition, pt as useTemplateRef, q as onBeforeUnmount, rt as renderList, w as createBlock, y as Teleport, yn as normalizeStyle, yt as withCtx } from "./vue.runtime.esm-bundler-dg1EVmSK.js";
import { D as useElementSize, F as useScroll, L as useSpeechRecognition, M as useLocalStorage, N as useMediaQuery, O as useEventListener, R as useSpeechSynthesis, b as useActiveElement, bt as I18nT, yt as useI18n } from "./_MapCache-Dq2XPUGI.js";
import { Ct as N8nCard_default, Di as useRouter, Ei as useRoute, Fi as N8nIconButton_default, Gi as N8nButton_default, Hi as N8nHeading_default, Ki as N8nIcon_default, Mi as require_markdown_it_link_attributes, Mt as useDeviceSupport, Pi as Input_default, R as N8nSpinner_default, Ri as truncate, Ui as N8nCallout_default, Wi as N8nText_default, Yi as __vitePreload, i as Select_default, ji as N8nTooltip_default, kt as N8nLoading_default, m as N8nScrollArea_default, yi as N8nLink_default, z as N8nResizeWrapper_default } from "./src-caSpAzoz.js";
import { t as __plugin_vue_export_helper_default } from "./_plugin-vue_export-helper-DltO58Gh.js";
import "./sanitize-html-JHjOJhXQ.js";
import { Fo as INVITE_USER_MODAL_KEY, Qr as v4_default, Tr as useToast, en as useTelemetry, gr as hasPermission, js as useSettingsStore, r as useUIStore, s as useWorkflowsStore, t as useUsersStore, vn as useDocumentTitle, wr as hasRole } from "./users.store-2EsruVYR.js";
import { cl as EnterpriseEditionFeature, fi as chatHubConversationModelSchema, ii as ROLE, li as PROVIDER_CREDENTIAL_TYPE_MAP, nc as LOCAL_STORAGE_CHAT_HUB_SELECTED_MODEL, tc as LOCAL_STORAGE_CHAT_HUB_HAD_CONVERSATION_BEFORE, us as VIEWS } from "./constants-_O8nYJwx.js";
...
import { t as usePageRedirectionHelper } from "./usePageRedirectionHelper-Codao5gm.js";
import { t as useClipboard } from "./useClipboard-CVpuSQWa.js";
import "./nodeIcon-c7bgB_oY.js";
import { l as shouldIgnoreCanvasShortcut } from "./canvas.utils-BvUu3pSa.js";
import { t as VueMarkdown_default } from "./VueMarkdown-QLVLPpKk.js";
...
import { t as usePushConnectionStore } from "./pushConnection.store-BszLNG-V.js";
import { t as useFreeAiCredits } from "./useFreeAiCredits-C7aZYVdV.js";
import "./dist-BBifoajh.js";
import { h as MOBILE_MEDIA_QUERY, l as CHAT_VIEW, n as CHAT_CONVERSATION_VIEW, t as AGENT_EDITOR_MODAL_KEY, y as providerDisplayNames } from "./constants-CrjCGXcB.js";
import { D as fetchWorkflowExecutionStatus, O as revokeDynamicCredential, S as unflattenModel, T as buildChatAttachmentUrl, _ as isRegenerable, b as splitMarkdownIntoChunks, c as findOneFromModelsResponse, g as isLlmProviderModel, h as isLlmProvider, i as collectChatArtifacts, l as flattenModel, m as isEditable, o as enrichMimeTypesWithExtensions, t as useChatStore, v as isWaitingForApproval, w as authorizeDynamicCredential } from "./chat.store-C9QsU0-z.js";
import { t as ChatAgentAvatar_default } from "./ChatAgentAvatar-VgXEe4MH.js";
import { n as ChatFile_default, t as useResizablePanel } from "./useResizablePanel-BNdt91Ej.js";
import { n as useChatCredentials, r as chatHubConversationModelWithCachedDisplayNameSchema, t as ChatLayout_default } from "./ChatLayout-CdK9ibmJ.js";
import { i as ModelSelector_default, n as useFileDrop, r as ToolsSelector_default, t as useCustomAgent } from "./useCustomAgent-Kt16cdFV.js";
...
var ChatMessageActions_default = /* @__PURE__ */ __plugin_vue_export_helper_default(ChatMessageActions_vue_vue_type_script_setup_true_lang_default, [["__cssModules", { "$style": ChatMessageActions_vue_vue_type_style_index_0_lang_module_default }], ["__scopeId", "data-v-ec3f5f08"]]);
	...
	(function webpackUniversalModuleDefinition(root, factory) {
		...
		return (function() {
			...
			function buildHTMLUnbreakable(children, options) {
				const body$1 = buildHTML_makeSpan(["base"], children, options);
				const strut = buildHTML_makeSpan(["strut"]);
				strut.style.height = makeEm(body$1.height + body$1.depth);
				if (body$1.depth) strut.style.verticalAlign = makeEm(-body$1.depth);
				body$1.children.unshift(strut);
				return body$1;
			}
			...
			const makeRow = function(body$1) {
				if (body$1.length === 1) return body$1[0];
				else return new mathMLTree.MathNode("mrow", body$1);
			};
			...
			const htmlBuilder = (grp, options) => {
				...
				const body$1 = buildGroup(base, options.havingCrampedStyle());
				...
				let clearance = accentBelow ? body$1.height + body$1.depth : Math.min(body$1.height, options.fontMetrics().xHeight);
				let accentBody;
				if (!group.isStretchy) {
					let accent$1;
					let width;
			...
			defineFunction({
				...
				handler(_ref, args) {
					...
					return {
						...
						body: ordargument(body$1),
						isCharacterBox: utils.isCharacterBox(body$1)
					};
				},
			...
			function parseCD(parser) {
				...
				return {
					...
					addJot: true,
					rowGaps: [null],
					cols: new Array(body$1[0].length).fill({
						type: "align",
						align: "c",
						pregap: .25,
						postgap: .25
					...
					hLinesBeforeRow: new Array(body$1.length + 1).fill([])
				};
			}
			defineFunction({
				type: "cdlabel",
			...
			defineFunction({
				...
				handler(_ref2, args) {
					...
					const body$1 = parser.parseExpression(true, breakOnTokenText);
					return {
						type: "color",
						mode: parser.mode,
						color,
			...
			defineFunction({
				...
				handler: (context, args) => {
					...
					const body$1 = parser.parseExpression(false);
					--parser.leftrightDepth;
			...
			const _macros = {};
			function defineMacro(name, body$1) {
				_macros[name] = body$1;
			}
			...
			function parseArray(parser, _ref, style) {
				...
				while (true) {
					...
					if (next === "&") {
						...
						endRow();
						if (row.length === 1 && cell.type === "styling" && cell.body[0].body.length === 0 && (body$1.length > 1 || !emptySingleRow)) body$1.pop();
						if (hLinesBeforeRow.length < body$1.length + 1) hLinesBeforeRow.push([]);
						break;
					} else if (next === "\\\\") {
						parser.consume();
						let size;
			...
			const array_htmlBuilder = function(group, options) {
				...
				body$1 = buildCommon.makeSpan(["mtable"], cols);
				if (hlines.length > 0) {
					...
					body$1 = buildCommon.makeVList({
						positionType: "individualShift",
						children: vListElems
					}, options);
				}
				if (tagSpans.length === 0) return buildCommon.makeSpan(["mord"], [body$1], options);
				else {
					...
					return buildCommon.makeFragment([body$1, eqnNumCol]);
				}
			};
			const alignMap = {
				c: "center ",
			...
			defineFunction({
				...
				handler: (_ref, args) => {
					let { parser, funcName } = _ref;
					const body$1 = normalizeArgument(args[0]);
					let func = funcName;
			...
			defineFunction({
				...
				handler: (_ref2, args) => {
					let { parser } = _ref2;
					const body$1 = args[0];
					const isCharacterBox$1 = utils.isCharacterBox(body$1);
					return {
						type: "mclass",
						mode: parser.mode,
						mclass: binrelClass(body$1),
						body: [{
							type: "font",
							mode: parser.mode,
							font: "boldsymbol",
			...
			const horizBrace_htmlBuilder = (grp, options) => {
				...
				const body$1 = buildGroup(group.base, options.havingBaseStyle(src_Style.DISPLAY));
				...
				if (group.isOver) {
					...
					vlist = buildCommon.makeVList({
						positionType: "bottom",
						positionData: body$1.depth + .1 + braceBody.height,
						children: [
							{
								type: "elem",
								elem: braceBody
			...
			defineFunction({
				...
				handler(_ref, args) {
					...
					const body$1 = parser.parseExpression(false, close);
					parser.expect(close);
			...
			defineFunction({
				...
				htmlBuilder(group, options) {
					const body$1 = buildGroup(group.body, options);
			...
			defineFunction({
				...
				handler: (_ref, args) => {
					...
					const body$1 = parser.parseExpression(false, breakOnTokenText);
					return {
						type: "sizing",
						mode: parser.mode,
			...
			defineFunction({
				...
				htmlBuilder(group, options) {
					...
					const body$1 = buildCommon.makeVList({
						positionType: "firstBaseline",
						children: [
							{
								type: "elem",
					...
					if (!group.index) return buildCommon.makeSpan(["mord", "sqrt"], [body$1], options);
						...
						return buildCommon.makeSpan(["mord", "sqrt"], [rootVListWrap, body$1], options);
					}
				},
				mathmlBuilder(group, options) {
					const { body: body$1, index } = group;
					return index ? new mathMLTree.MathNode("mroot", [buildMathML_buildGroup(body$1, options), buildMathML_buildGroup(index, options)]) : new mathMLTree.MathNode("msqrt", [buildMathML_buildGroup(body$1, options)]);
				}
			});
			...
			defineFunction({
				...
				htmlBuilder(group, options) {
					const body$1 = buildGroup(group.body, options);
					const axisHeight = options.fontMetrics().axisHeight;
					const dy = .5 * (body$1.height - axisHeight - (body$1.depth + axisHeight));
					return buildCommon.makeVList({
						positionType: "shift",
						positionData: dy,
						children: [{
			...
			defineFunction({
				...
				htmlBuilder(group, options) {
					...
					for (let i = 0; i < text.length; i++) {
						let c = text[i];
						if (c === "~") c = "\\textasciitilde";
						body$1.push(buildCommon.makeSymbol(c, "Typewriter-Regular", group.mode, newOptions, ["mord", "texttt"]));
					}
					return buildCommon.makeSpan(["mord", "text"].concat(newOptions.sizingClasses(options)), buildCommon.tryCombineChars(body$1), newOptions);
				},
				mathmlBuilder(group, options) {
			...
			class Parser {
				...
				parseExpression(breakOnInfix, breakOnTokenText) {
					...
					if (this.mode === "text") this.formLigatures(body$1);
					return this.handleInfixNodes(body$1);
				}
				handleInfixNodes(body$1) {
					let overIndex = -1;
					let funcName;
					for (let i = 0; i < body$1.length; i++) if (body$1[i].type === "infix") {
						if (overIndex !== -1) throw new src_ParseError("only one infix operator per group", body$1[i].token);
						overIndex = i;
						funcName = body$1[i].replaceWith;
					}
					if (overIndex !== -1 && funcName) {
						let numerNode;
						let denomNode;
						const numerBody = body$1.slice(0, overIndex);
						const denomBody = body$1.slice(overIndex + 1);
				...
				parseAtom(breakOnTokenText) {
					...
					while (true) {
						...
						if (lex.text === "\\limits" || lex.text === "\\nolimits") {
							...
							const body$1 = this.subparse(subsupTokens);
							if (isSub) subscript = {
								type: "ordgroup",
								mode: "math",
								body: body$1
...
function useChatHubMarkdownOptions(codeBlockActionsClassName, tableContainerClassName) {
	...
	async function loadLanguageModules() {
		...
		try {
			asyncImport = {
				status: "inProgress",
				promise: Promise.all([__vitePreload(() => import("./es-B7eRVvzT.js"), __vite__mapDeps([0,1,2])), __vitePreload(() => import("./languageModules-BcWbCvrG.js"), __vite__mapDeps([3,4]))])
			};
...
var ChatMarkdownChunk_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props, { expose: __expose, emit: __emit }) {
		...
		function handleMouseMove(e) {
			const container$4 = e.target instanceof HTMLElement || e.target instanceof SVGElement ? e.target.closest("pre")?.querySelector(`.${styles.codeBlockActions}`) : null;
			hoveredCodeBlockActions.value = container$4 instanceof HTMLElement ? container$4 : null;
		}
...
var ChatMessage_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props, { expose: __expose, emit: __emit }) {
		...
		return (_ctx, _cache) => {
			...
			], 6)) : (openBlock(), createElementBlock(Fragment, { key: 2 }, [createBaseVNode("div", { class: normalizeClass([_ctx.$style.chatMessage, { [_ctx.$style.errorMessage]: __props.message.status === "error" }]) }, [attachments$2.value.length > 0 ? (openBlock(), createElementBlock("div", {
				key: 0,
				class: normalizeClass(_ctx.$style.attachments)
...
var ChatMessage_vue_vue_type_style_index_0_lang_module_default = {
	message: "_message_bz6ov_125",
	markdownContent: "_markdownContent_bz6ov_130",
	codeBlockActions: "_codeBlockActions_bz6ov_137",
	avatar: "_avatar_bz6ov_141",
	compact: "_compact_bz6ov_154",
	content: "_content_bz6ov_160",
	actions: "_actions_bz6ov_166",
	attachments: "_attachments_bz6ov_172",
	chatMessage: "_chatMessage_bz6ov_177",
	editContainer: "_editContainer_bz6ov_180",
	user: "_user_bz6ov_196",
	errorMessage: "_errorMessage_bz6ov_207",
	textarea: "_textarea_bz6ov_239",
	fileInput: "_fileInput_bz6ov_252",
	editFooter: "_editFooter_bz6ov_256",
	editActions: "_editActions_bz6ov_270",
	typingIndicator: "_typingIndicator_bz6ov_276"
};
	...
	setup(__props, { expose: __expose, emit: __emit }) {
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("form", {
				...
				createBaseVNode("div", { class: normalizeClass(_ctx.$style.header) }, [showMissingAgentCallout.value ? (openBlock(), createBlock(unref(N8nCallout_default), {
					key: 0,
					icon: "info",
					theme: "secondary",
					...
					_: 1
				}, 8, ["class"])) : props.showDynamicCredentialsMissingCallout ? (openBlock(), createBlock(unref(N8nCallout_default), {
					key: 2,
					theme: "warning",
					class: normalizeClass(_ctx.$style.callout),
					...
					_: 1
				}, 8, ["class"])) : createCommentVNode("", true), attachments$2.value.length > 0 ? (openBlock(), createElementBlock("div", {
					key: 4,
...
var ChatPrompt_vue_vue_type_style_index_0_lang_module_default = {
	prompt: "_prompt_cpd7c_125",
	callout: "_callout_cpd7c_130",
	closeButton: "_closeButton_cpd7c_136",
	fileInput: "_fileInput_cpd7c_140",
	header: "_header_cpd7c_171",
	footer: "_footer_cpd7c_172",
	toolsButton: "_toolsButton_cpd7c_198",
	iconStack: "_iconStack_cpd7c_203",
	icon: "_icon_cpd7c_203",
	iconOverlap: "_iconOverlap_cpd7c_216",
	iconFallback: "_iconFallback_cpd7c_220",
	actions: "_actions_cpd7c_226",
	attachments: "_attachments_cpd7c_235",
	recording: "_recording_cpd7c_243",
	chatHubPromptRecordingPulse: "_chatHubPromptRecordingPulse_cpd7c_1"
};
...
var ChatSuggestedPrompts_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props, { emit: __emit }) {
		const emit = __emit;
		function getIconName(icon$1) {
			if (icon$1?.type === "emoji") return void 0;
			return icon$1?.value ?? DEFAULT_PROMPT_ICON;
		}
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("div", { class: normalizeClass(_ctx.$style.container) }, [(openBlock(true), createElementBlock(Fragment, null, renderList(__props.prompts, (prompt$1) => {
				return openBlock(), createBlock(unref(N8nButton_default), {
					key: prompt$1.text,
					variant: "outline",
					size: "small",
					icon: getIconName(prompt$1.icon),
					"icon-size": "large",
					class: normalizeClass(_ctx.$style.chip),
					onClick: ($event) => emit("select", prompt$1.text)
				}, createSlots({
					default: withCtx(() => [createTextVNode(" " + toDisplayString(prompt$1.text), 1)]),
					_: 2
				}, [prompt$1.icon?.type === "emoji" ? {
					name: "icon",
					fn: withCtx(() => [createBaseVNode("span", { class: normalizeClass(_ctx.$style.emoji) }, toDisplayString(prompt$1.icon.value), 3)]),
					key: "0"
				} : void 0]), 1032, [
					"icon",
					"class",
...
var ChatSuggestedPrompts_default = /* @__PURE__ */ __plugin_vue_export_helper_default(ChatSuggestedPrompts_vue_vue_type_script_setup_true_lang_default, [["__cssModules", { "$style": ChatSuggestedPrompts_vue_vue_type_style_index_0_lang_module_default }]]);
var ChatGreetings_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props, { emit: __emit }) {
		...
		return (_ctx, _cache) => {
			...
			}, null, 8, ["agent", "class"]), createVNode(unref(N8nHeading_default), {
				tag: "h2",
				size: "xlarge",
...
var ChatGreetings_vue_vue_type_style_index_0_lang_module_default = {
	greetings: "_greetings_1j2nk_125",
	agentCard: "_agentCard_1j2nk_132",
	agentIcon: "_agentIcon_1j2nk_140",
	agentName: "_agentName_1j2nk_150",
	agentDescription: "_agentDescription_1j2nk_158",
	suggestions: "_suggestions_1j2nk_168",
	skeletonName: "_skeletonName_1j2nk_172",
	skeletonDescription: "_skeletonDescription_1j2nk_177",
	skeletonPrompts: "_skeletonPrompts_1j2nk_182",
	skeletonChip: "_skeletonChip_1j2nk_188",
	header: "_header_1j2nk_192",
	inlineIcon: "_inlineIcon_1j2nk_198"
};
...
function useChatArtifacts(container$4, chatMessages) {
...
var ChatView_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		...
		async function onSubmit(message$1, attachments$2) {
			if (!message$1.trim() || isResponding.value || !selectedModel.value || !credentialsForSelectedProvider.value || dynamicCreds.hasDynamicCredentials.value && !dynamicCreds.allAuthenticated.value) return;
			didSubmitInCurrentSession.value = true;
			editingMessageId.value = void 0;
			await chatStore.sendMessage(sessionId.value, message$1, selectedModel.value, credentialsForSelectedProvider.value, attachments$2);
		...
		async function handleRegenerateMessage(message$1) {
			if (isResponding.value || message$1.type !== "ai" || !selectedModel.value || !credentialsForSelectedProvider.value || dynamicCreds.hasDynamicCredentials.value && !dynamicCreds.allAuthenticated.value) return;
		...
		return (_ctx, _cache) => {
			return showWelcomeScreen.value !== void 0 ? (openBlock(), createBlock(ChatLayout_default, {
				...
				class: normalizeClass({
					...
					[_ctx.$style.isAgentNewSession]: isNewSession$1.value && isAgentModel.value,
						...
						default: withCtx(() => [createBaseVNode("div", { class: normalizeClass(_ctx.$style.mainContent) }, [
							...
							createVNode(unref(N8nScrollArea_default), {
								...
								default: withCtx(() => [createBaseVNode("div", {
									...
									"session-id": isNewSession$1.value ? void 0 : sessionId.value,
...
var ChatView_vue_vue_type_style_index_0_lang_module_default = {
	chatLayout: "_chatLayout_f3ehh_125",
	hasArtifact: "_hasArtifact_f3ehh_130",
	mainContent: "_mainContent_f3ehh_130",
	mainContentResizer: "_mainContentResizer_f3ehh_138",
	dynamicCredentialsDrawer: "_dynamicCredentialsDrawer_f3ehh_151",
	artifactViewer: "_artifactViewer_f3ehh_158",
	isResizing: "_isResizing_f3ehh_163",
	scrollArea: "_scrollArea_f3ehh_168",
	scrollable: "_scrollable_f3ehh_173",
	isNewSession: "_isNewSession_f3ehh_182",
	isAgentNewSession: "_isAgentNewSession_f3ehh_185",
	greetingsCentered: "_greetingsCentered_f3ehh_189",
	header: "_header_f3ehh_196",
	messageList: "_messageList_f3ehh_202",
	promptContainer: "_promptContainer_f3ehh_212",
	isMobileDevice: "_isMobileDevice_f3ehh_222",
	isExistingSession: "_isExistingSession_f3ehh_222",
	isMainPanelNarrow: "_isMainPanelNarrow_f3ehh_233",
	scrollToBottomButton: "_scrollToBottomButton_f3ehh_238",
	isDraggingFile: "_isDraggingFile_f3ehh_246",
	dropOverlay: "_dropOverlay_f3ehh_250"
};
