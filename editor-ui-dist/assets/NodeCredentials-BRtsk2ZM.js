...
import { Ja as N8nButton_default, Ti as N8nBadge_default, Tt as N8nOption_default, Ui as Input_default, Ya as N8nIcon_default, Z as ActionPill_default, lt as N8nLink_default, qa as N8nText_default, vt as N8nInputLabel_default, wt as N8nSelect_default, zi as N8nTooltip_default } from "./src-CSWS3PCK.js";
import { t as _plugin_vue_export_helper_default } from "./_plugin-vue_export-helper-Da88TEg1.js";
import { t as useToast } from "./useToast-THYqqSsb.js";
import { Fu as ChatHubToolContextKey, bn as KEEP_AUTH_IN_NDV_FOR_NODES, fu as getResourcePermissions, gi as AI_GATEWAY_TOP_UP_MODAL_KEY } from "./constants-BpExsFUJ.js";
import { $n as getNodeCredentialForSelectedAuthType, Kn as getAllNodeCredentialForAuthType, Kt as injectWorkflowExecutionStateStore, Ut as injectNDVStoreIfProvided, Xn as getMainAuthField, Yn as getAuthTypeForNodeCredential, _ as useNodeTypesStore, a as injectWorkflowDocumentStore, ar as hasProxyAuth, at as useCredentialsStore, cn as useWorkflowsStore, cr as isRequiredCredential, fr as updateNodeAuthType, qn as getAppNameFromCredType, xn as useProjectsStore } from "./workflowDocument.store-B8Lg41Xq.js";
import { h as assert } from "./useRootStore-BLAHyASD.js";
...
import { t as useCredentialOAuth } from "./useCredentialOAuth-Cxu67SRe.js";
import { t as useQuickConnect } from "./useQuickConnect-B3lOk49K.js";
...
import { t as useAiGateway } from "./useAiGateway-Dti5u50C.js";
			...
			return unref(credentialTypesNodeDescriptionDisplayed).length ? (openBlock(), createElementBlock("div", {
				...
				return openBlock(), createElementBlock("div", { key: type.name }, [createVNode(unref(N8nInputLabel_default), {
					...
					default: withCtx(() => [
						...
						}, null, 8, ["model-value"])])) : options.length === 0 && showQuickConnectEmptyState(type) && quickConnectCredentialType.value && !isAiGatewayManagedCredentials(type.name) ? (openBlock(), createElementBlock("div", {
							key: 2,
										...
										default: withCtx(() => [createBaseVNode("div", { class: normalizeClass([
											...
											default: withCtx(() => [createVNode(unref(N8nBadge_default), {
												...
												default: withCtx(() => [createBaseVNode("span", { class: normalizeClass(_ctx.$style.dynamicBadgeText) }, [createVNode(unref(N8nIcon_default), {
													icon: "key-round",
													size: "small"
												}), createTextVNode(" " + toDisplayString(unref(i18n).baseText("credentials.private.badge")), 1)], 2)]),
												_: 1
											})]),
											_: 1
						...
						getSelectedPrivateCredential(type.name) && isDefaultResolver.value ? (openBlock(), createElementBlock("div", {
							key: 5,
							class: normalizeClass(_ctx.$style.noticesContainer)
						}, [isPrivateConnected(type.name) ? (openBlock(), createElementBlock("div", {
							key: 0,
							class: normalizeClass(_ctx.$style.privateConnectedNotice),
							"data-test-id": "node-credential-private-callout"
						}, [createBaseVNode("span", { class: normalizeClass(_ctx.$style.privateNoticeIconBadge) }, [createVNode(unref(N8nIcon_default), {
							icon: "user",
							size: "medium"
						})], 2), createBaseVNode("div", null, [createVNode(unref(N8nText_default), { size: "small" }, {
							default: withCtx(() => [createTextVNode(toDisplayString(unref(i18n).baseText("credentials.private.callout.title")), 1)]),
							_: 1
						}), createBaseVNode("div", { class: normalizeClass(_ctx.$style.privateStatusRow) }, [createVNode(unref(N8nIcon_default), {
							icon: "circle-check",
							color: "success",
							size: "small"
						}), createVNode(unref(N8nText_default), {
							...
							default: withCtx(() => [createTextVNode(toDisplayString(unref(i18n).baseText("credentials.private.callout.connected")), 1)]),
							_: 1
						})], 2)])], 2)) : (openBlock(), createElementBlock("div", {
							key: 1,
							class: normalizeClass(_ctx.$style.privateConnectPrompt),
							"data-test-id": "node-credential-private-callout"
						}, [
							createBaseVNode("span", { class: normalizeClass(_ctx.$style.privateNoticeIconBadge) }, [createVNode(unref(N8nIcon_default), {
								icon: "user",
							...
							createBaseVNode("div", { class: normalizeClass(_ctx.$style.privateConnectText) }, [createVNode(unref(N8nText_default), { bold: "" }, {
								default: withCtx(() => [createTextVNode(toDisplayString(unref(i18n).baseText("credentials.private.callout.connectTitle")), 1)]),
								_: 1
							}), createVNode(unref(N8nText_default), { size: "small" }, {
								default: withCtx(() => [createTextVNode(toDisplayString(getServiceName(type.name) ? unref(i18n).baseText("credentials.private.callout.connectDescription", { interpolate: { service: getServiceName(type.name) } }) : unref(i18n).baseText("credentials.private.callout.connectDescriptionGeneric")), 1)]),
								_: 2
							}, 1024)], 2),
							canConnectPrivateCredential(type.name) ? (openBlock(), createBlock(unref(N8nButton_default), {
								key: 0,
								class: normalizeClass(_ctx.$style.privateConnectButton),
								variant: "outline",
								size: "small",
								label: unref(i18n).baseText("credentials.private.callout.connect"),
...
var NodeCredentials_vue_vue_type_style_index_0_lang_module_default = {
	container: "_container_1i1hi_125",
	selectPopper: "_selectPopper_1i1hi_132",
	newCredential: "_newCredential_1i1hi_135",
	warning: "_warning_1i1hi_144",
	edit: "_edit_1i1hi_150",
	input: "_input_1i1hi_162",
	selectContainer: "_selectContainer_1i1hi_167",
	hasIssues: "_hasIssues_1i1hi_172 _input_1i1hi_162",
	credentialOption: "_credentialOption_1i1hi_177",
	credentialOptionName: "_credentialOptionName_1i1hi_182",
	dynamicIcon: "_dynamicIcon_1i1hi_188",
	selectWithDynamic: "_selectWithDynamic_1i1hi_192",
	dynamicIndicator: "_dynamicIndicator_1i1hi_196",
	dynamicBadgeText: "_dynamicBadgeText_1i1hi_204",
	noticesContainer: "_noticesContainer_1i1hi_213",
	privateStatusRow: "_privateStatusRow_1i1hi_221",
	privateConnectedNotice: "_privateConnectedNotice_1i1hi_228",
	privateNoticeIconBadge: "_privateNoticeIconBadge_1i1hi_237",
	privateConnectPrompt: "_privateConnectPrompt_1i1hi_242",
	privateConnectText: "_privateConnectText_1i1hi_267",
	privateConnectButton: "_privateConnectButton_1i1hi_273",
	quickConnectContainer: "_quickConnectContainer_1i1hi_303",
	setupManuallyContainer: "_setupManuallyContainer_1i1hi_312",
	setupManuallyOr: "_setupManuallyOr_1i1hi_318",
	setupManuallyLink: "_setupManuallyLink_1i1hi_322",
	standardEmptyContainer: "_standardEmptyContainer_1i1hi_329",
	emptySelect: "_emptySelect_1i1hi_336"
};
