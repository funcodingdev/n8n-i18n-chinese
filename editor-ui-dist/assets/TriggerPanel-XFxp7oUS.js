...
import { Di as useRouter, Gi as N8nButton_default, Hi as N8nHeading_default, Ki as N8nIcon_default, U as N8nRadioButtons_default, W as N8nPulse_default, Wi as N8nText_default, bt as createEventBus, ji as N8nTooltip_default, nt as N8nInfoAccordion_default, tt as N8nInfoTip_default, yi as N8nLink_default, z as N8nSpinner_default } from "./src-i9Rem1HJ.js";
import { t as __plugin_vue_export_helper_default } from "./_plugin-vue_export-helper-DltO58Gh.js";
import { Bt as injectWorkflowState, C as waitingNodeTooltip, Ci as CanvasNodeDirtiness, Et as useWorkflowHelpers, Fr as require_FileSaver_min, It as useTelemetry, Jr as injectWorkflowDocumentStore, ea as getTriggerNodeServiceName, f as parseAiContent, hi as isTriggerPanelObject, r as useUIStore, s as useWorkflowsStore, u as formatTokenUsageCount, w as useNodeTypesStore, zt as useNDVStore } from "./users.store-pjk3GVP4.js";
import { Gt as CHAT_TRIGGER_NODE_TYPE, Js as WORKFLOW_SETTINGS_MODAL_KEY, cs as VIEWS, fo as NodeConnectionTypes, gn as FORM_TRIGGER_NODE_TYPE, wr as WEBHOOK_NODE_TYPE, yc as MAX_DISPLAY_DATA_SIZE_LOGS_VIEW } from "./constants-NfpEUugO.js";
import { N as storeToRefs } from "./_baseOrderBy-WW5xCbr3.js";
import { t as CopyInput_default } from "./CopyInput-CJKuoovf.js";
import { i as NodeErrorView_default, r as ViewSubExecution_default, t as RunData_default } from "./RunData-DcZCTGDt.js";
import { t as NDVEmptyState_default } from "./NDVEmptyState-De1_PuhZ.js";
import { n as useNodeType, t as usePinnedData } from "./usePinnedData-DwevAqbC.js";
import { f as require_capitalize } from "./canvas.eventBus-im-no4xr.js";
...
import { r as useNodeDirtiness } from "./useRunWorkflow-C2SzF0cK.js";
import { n as convertToDisplayDateComponents } from "./dateFormatter-Dk94ifWB.js";
import { n as useLogsExecutionData, o as ConsumedTokensDetails_default, r as LogsOverviewRows_default, s as findLogEntryById, t as useLogsTreeExpand, u as getConsumedTokens } from "./useLogsTreeExpand-Dh-vtoTk.js";
import { t as useExecutionData } from "./useExecutionData-CxZtj_0o.js";
import { n as getReferencedData, t as RunDataParsedAiContent_default } from "./RunDataParsedAiContent-DYy9El93.js";
var _hoisted_1$3 = [
	"data-node-name",
	"data-node-placement",
	"onClick"
		...
		return (_ctx, _cache) => {
			...
			return openBlock(), createElementBlock("div", { class: normalizeClass(_ctx.$style.container) }, [createVNode(Transition, {
				...
				default: withCtx(() => [hasIssues.value || hideContent.value ? (openBlock(), createElementBlock("div", _hoisted_1)) : isListeningForEvents.value ? (openBlock(), createElementBlock("div", {
					...
					displayChatButton.value ? (openBlock(), createElementBlock("div", _hoisted_3, [createVNode(unref(N8nButton_default), {
						class: "mb-xl",
					...
					isActivelyPolling.value ? (openBlock(), createElementBlock("div", _hoisted_5, [createVNode(unref(N8nSpinner_default), { type: "ring" })])) : createCommentVNode("", true),
					createBaseVNode("div", { class: normalizeClass(_ctx.$style.action) }, [createBaseVNode("div", {
						...
						default: withCtx(() => [createBaseVNode("span", { textContent: toDisplayString(subheader.value) }, null, 8, _hoisted_6)]),
						_: 1
...
var TriggerPanel_default = /* @__PURE__ */ __plugin_vue_export_helper_default(TriggerPanel_vue_vue_type_script_setup_true_lang_default, [["__cssModules", { "$style": TriggerPanel_vue_vue_type_style_index_0_lang_module_default }], ["__scopeId", "data-v-4f944973"]]);
