;
(function () {
  System.register(["./vue.runtime.esm-bundler-legacy--Sn1h8On.js", "./useTelemetry-legacy-Dj2fHQys.js", "./_baseOrderBy-legacy-DE6my_G3.js"], function (_export, _context) {
    "use strict";

    var computed, reactive, requestLicenseTrial, useSettingsStore, renewLicense, getLicense, activateLicenseKey, registerCommunityEdition, defineStore, useRootStore, DEFAULT_PLAN_NAME, DEFAULT_STATE, useUsageStore;
    return {
      setters: [function (_vueRuntimeEsmBundlerLegacy003Js) {
        computed = _vueRuntimeEsmBundlerLegacy003Js.C;
        reactive = _vueRuntimeEsmBundlerLegacy003Js.Pt;
      }, function (_useTelemetryLegacy00HJs) {
        requestLicenseTrial = _useTelemetryLegacy00HJs.$o;
        useSettingsStore = _useTelemetryLegacy00HJs.Ho;
        renewLicense = _useTelemetryLegacy00HJs.Qo;
        getLicense = _useTelemetryLegacy00HJs.Xo;
        activateLicenseKey = _useTelemetryLegacy00HJs.Yo;
        registerCommunityEdition = _useTelemetryLegacy00HJs.Zo;
