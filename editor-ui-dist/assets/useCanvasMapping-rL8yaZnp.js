...
import { _ as onKeyDown, bt as useI18n, ct as useThrottleFn, dt as watchThrottled, ut as watchOnce, y as onKeyUp } from "./_MapCache-BFpNgXhv.js";
...
import { $n as _sfc_main$3, $t as useNodeHelpers, Ar as useSourceControlStore, As as useSettingsStore, Dn as useTemplatesStore, Er as useStyles, Fn as calculateNodeSize, Ir as useFocusedNodesStore, Jn as NodeId, Ki as getTriggerNodeServiceName, Kn as updateViewportToContainNodes, Nn as GRID_SIZE, Nt as environments_store_default, Qn as _sfc_main$1, Vn as getMousePosition, Xn as Position, Yn as PanelPosition, Zn as _sfc_main$5, aa as useWorkflowDocumentStore, ar as getConnectedEdges, at as useCredentialsStore, ba as isPresent, cr as isMacOs, dn as nodeViewEventBus, dr as wheelDelta, er as _sfc_main$d, fl as isOutsideSelected, fr as TemplateClickSource, gi as CanvasNodeRenderType, hi as CanvasNodeDirtiness, ia as injectWorkflowDocumentStore, in as injectWorkflowState, ir as getBoundsofRects, jn as DEFAULT_NODE_SIZE, kn as CONFIGURATION_NODE_RADIUS, lr as useGetPointerPosition, mi as CanvasConnectionMode, mr as trackTemplatesClick, na as createWorkflowDocumentId, nr as clamp, or as getRectOfNodes, pl as sanitizeHtml, pr as isExtraTemplateLinksExperimentEnabled, qn as MarkerType, r as useUIStore, rn as useNDVStore, rr as getBezierPath, s as useWorkflowsStore, sr as getSmoothStepPath, t as useUsersStore, tr as _sfc_main$f, ui as isValidNodeConnectionType, ur as useVueFlow, w as useNodeTypesStore } from "./users.store-Bu2w-Rub.js";
import { M as TitledList_default } from "./ParameterInputList-DrctfieG.js";
import { Cr as WAIT_NODE_TYPE, Da as isExecutable, Fc as ExpressionLocalResolveContextSymbol, Go as require_isEqual, Gt as CHAT_TRIGGER_NODE_TYPE, Ho as WEBHOOK_NODE_TYPE, I as CUSTOM_API_CALL_KEY, Mc as CanvasNodeHandleKey, Nc as CanvasNodeKey, Nt as AGENT_NODE_TYPE, Oa as isHitlToolType, Pt as AGENT_TOOL_NODE_TYPE, Qn as PRODUCTION_ONLY_TRIGGER_NODE_TYPES, Tt as NODE_CREATOR_OPEN_SOURCES, Vo as WAIT_INDEFINITELY, Wn as NOT_DUPLICATABLE_NODE_TYPES, Za as isCommunityPackageName, _a as getNodeInputs, dr as SIMULATE_TRIGGER_NODE_TYPE, gr as STICKY_NODE_TYPE, hn as FORM_NODE_TYPE, ho as NodeConnectionTypes, is as getResourcePermissions, jc as CanvasKey, ka as isNodeWithWorkflowSelector, ml as CANVAS_EXECUTION_DATA_THROTTLE_DURATION, ms as VIEWS, ua as mapConnectionsByDestination, ur as SIMULATE_NODE_TYPE, va as getNodeOutputs, wa as getSubworkflowId, zo as SEND_AND_WAIT_OPERATION } from "./constants-B8dhY4J-.js";
import { t as useAssistantStore } from "./assistant.store-3Tres37h.js";
import { t as useChatPanelStore } from "./chatPanel.store-QcR0P27J.js";
import { t as usePinnedData } from "./usePinnedData-r8Zix2RN.js";
import { t as getNodeIconSource } from "./nodeIcon-DeauzqEi.js";
import { c as parseCanvasConnectionHandleString, n as createCanvasConnectionHandleString, o as mapLegacyConnectionsToCanvasConnections, r as insertSpacersBetweenEndpoints, s as mapLegacyEndpointsToCanvasConnectionPort, t as checkOverlap } from "./canvas.utils-BbjPIdL6.js";
import { n as useNodeCreatorStore } from "./canvas.eventBus-DI4LH7au.js";
...
import { r as useNodeDirtiness, t as useRunWorkflow } from "./useRunWorkflow-DngvZa95.js";
import { n as injectStrict } from "./useInjectWorkflowId-CRIsu81F.js";
import { t as useCollaborationStore } from "./collaboration.store-CJp70iQu.js";
import { t as NodeSettings_default } from "./NodeSettings-BCKnF22l.js";
...
import { t as NODE_CREATOR_SHORTCUT_COACHMARK_KEY } from "./useNodeCreatorShortcutCoachmark-B6aeE-Vi.js";
...
function useContextMenuItems(targetNodeIds) {
	...
	const targetNodes = computed(() => targetNodeIds.value.map((nodeId) => workflowDocumentStore?.value?.getNodeById(nodeId) ?? null).filter(isPresent));
