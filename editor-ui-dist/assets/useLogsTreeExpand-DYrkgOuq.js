import { $ as openBlock, C as createBaseVNode, E as createElementBlock, Gt as unref, It as ref, N as defineComponent, S as computed, U as mergeProps, Vt as toRef, W as nextTick, _ as Fragment, gt as watch, rt as renderList, w as createBlock, zt as shallowRef } from "./vue.runtime.esm-bundler-CiTcVoZc.js";
import { gt as useRouter } from "./src-BY3LHeey.js";
import { t as _plugin_vue_export_helper_default } from "./_plugin-vue_export-helper-Da88TEg1.js";
import { _ as useWorkflowExecutionStateStore, b as injectWorkflowDocumentStore, k as useNodeHelpers, q as useNodeTypesStore, t as useWorkflowsStore, v as createWorkflowDocumentId } from "./workflows.store-DZfkxcrn.js";
import { t as useToast } from "./useToast-ioerWMiY.js";
import { Pu as LOGS_EXECUTION_DATA_THROTTLE_DURATION, Vo as Workflow } from "./constants-CLQJMg7Y.js";
import { D as useVirtualList, K as useThrottleFn } from "./core-CZJuH52F.js";
import { s as isChatNode } from "./useCanvasOperations-D-gUWMHT.js";
...
import { _ as hasSubExecution, a as copyExecutionData, b as mergeStartData, d as flattenLogEntries, o as createLogTree, t as LogsOverviewRow_default, u as findSubExecutionLocator } from "./LogsOverviewRow-CZaMw-Jx.js";
...
function useLogsExecutionData({ isEnabled, filter } = {}) {
	...
	function resetExecutionData() {
		state.value = void 0;
		useWorkflowExecutionStateStore(workflowDocumentStore.value.documentId).setWorkflowExecutionData(null);
		nodeHelpers.updateNodesExecutionIssues();
		useWorkflowExecutionStateStore(createWorkflowDocumentId(workflowsStore.workflowId)).setChatPartialExecutionDestinationNode(null);
