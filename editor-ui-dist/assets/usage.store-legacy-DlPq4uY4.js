...
(function () {
  System.register(["./vue.runtime.esm-bundler-legacy--Sn1h8On.js", "./useTelemetry-legacy-DnSAoKz5.js", "./_baseOrderBy-legacy-D_9iEaXg.js"], function (_export, _context) {
    ...
    var computed, reactive, registerCommunityEdition, getLicense, useSettingsStore, activateLicenseKey, renewLicense, requestLicenseTrial, defineStore, useRootStore, DEFAULT_PLAN_NAME, DEFAULT_STATE, useUsageStore;
    return {
      setters: [function (_vueRuntimeEsmBundlerLegacy003Js) {
        computed = _vueRuntimeEsmBundlerLegacy003Js.C;
        reactive = _vueRuntimeEsmBundlerLegacy003Js.Pt;
      }, function (_useTelemetryLegacy00HJs) {
        registerCommunityEdition = _useTelemetryLegacy00HJs.$o;
        getLicense = _useTelemetryLegacy00HJs.Qo;
        useSettingsStore = _useTelemetryLegacy00HJs.Wo;
        activateLicenseKey = _useTelemetryLegacy00HJs.Zo;
        renewLicense = _useTelemetryLegacy00HJs.es;
        requestLicenseTrial = _useTelemetryLegacy00HJs.ts;
