...
import { Ai as N8nText_default, Dt as Checkbox_default, Fi as N8nIconButton_default, Ii as N8nButton_default, It as N8nOption_default, J as N8nRadioButtons_default, Li as N8nIcon_default, Pi as Input_default, Pt as N8nSelect_default, S as N8nInlineTextEdit_default, V as Switch_default, jr as N8nTooltip_default } from "./src-Btlck5YT.js";
...
import { tt as UNSUPPORTED_AGENT_NODE_TOOL_OPERATIONS } from "./src-Bd4giLF5.js";
...
import { An as EditorState, On as Compartment, on as EditorView, q as defaultKeymap, r as javascript, tt as history, vn as keymap, yn as lineNumbers } from "./expressions-DIVvUZ0j.js";
import { c as json, l as codeEditorTheme } from "./RunData-D2WbkesM.js";
...
import { c as updateToolRefFromNode, l as updateWorkflowToolRef, r as nodeToMcpServer, s as toolRefToNode } from "./useMcpServerAdapter-BCxPTO-k.js";
import { t as NodeToolSettingsContent_default } from "./NodeToolSettingsContent-BmQR_mRv.js";
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("div", { class: normalizeClass(_ctx.$style.root) }, [
				...
				createBaseVNode("div", {
					...
					ref: jsonContainer,
					class: normalizeClass([_ctx.$style.editorArea, props.readOnly && props.showReadOnlyOverlay && unref(agent_panel_module_default).disabled])
				}, null, 2)
			], 2);
		};
	}
...
var WorkflowToolConfigContent_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props, { expose: __expose, emit: __emit }) {
		...
		*/
		...
		watch([name, description], ([nameValue, descriptionValue]) => {
