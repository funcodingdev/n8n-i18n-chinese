...
import { s as useI18n$1 } from "./src-WRlVBeQs.js";
import { t as _plugin_vue_export_helper_default } from "./_plugin-vue_export-helper-D-F0WtqU.js";
import { l as useClipboard, y as useLocalStorage } from "./dist-BKkqSB6h.js";
import { t as require_markdown_it_link_attributes } from "./markdown-it-link-attributes-BC3Hu7Xj.js";
import { t as useBuilderStore } from "./builder.store-B8p0AL3t.js";
import { t as useMessage } from "./useMessage-CVBZspiQ.js";
import { c as useRoute, l as useRouter } from "./vue-router-DPnGeMd9.js";
import { B as isAgentNodeV2, Br as generateOffsets, D as injectWorkflowDocumentStore, Dr as parseCanvasConnectionHandleString, Er as mapLegacyConnectionsToCanvasConnections, Fr as DEFAULT_VIEWPORT_BOUNDARIES, Gr as getNewNodePosition, Ir as HORIZONTAL_NODE_STEP, Ji as CanvasConnectionMode, Jn as getMainAuthField, L as serializeNode, Lr as PUSH_NODES_OFFSET, Mr as CONFIGURABLE_NODE_SIZE, Nr as CONFIGURATION_NODE_SIZE, Pr as DEFAULT_NODE_SIZE, Pt as useDataSchema, Qt as useWorkflowHelpers, T as createWorkflowDocumentId, Tr as mapLegacyConnectionToCanvasConnection, Un as getAllNodeCredentialForAuthType, V as useNodeTypesStore, Vi as isValidNodeConnectionType, Xi as CanvasNodeRenderType, _ as disposeWorkflowExecutionStateStore, _i as pinDataToExecutionData, an as sanitizeConnections, it as removePreviewToken, jr as AGENT_NODE_SIZE, k as useWorkflowDocumentStore, nn as useTagsStore, or as isRequiredCredential, qr as getNodesGroupSize, rn as ensureNodePosition, t as useWorkflowsStore, u as getExecutionErrorToastConfiguration, un as useNDVStore, vn as useProjectsStore, vr as createCanvasConnectionHandleString, vt as getN8nAgentsNodeName, wr as mapCanvasConnectionToLegacyConnection, wt as useCredentialsStore, y as useWorkflowExecutionStateStore, z as require_uniq, zr as doRectsOverlap } from "./workflows.store-JWtScvRR.js";
import { Br as getNodeParameters, Ei as deepCopy, Gr as getSubworkflowId, Lr as getConnectionTypes, Mr as generateNodesGraph, Oi as isCommunityPackageName, Rr as getNodeInputs, Yr as isHitlToolType, Zt as require_cloneDeep, gi as isResourceLocatorValue, ii as resolveNodeWebhookId, in as validateNodeSelectionForGrouping, ki as isObjectEmpty, ma as v4, rn as validateNodeSelectionForExtraction, yi as NodeConnectionTypes, zr as getNodeOutputs } from "./src-B255AdRt.js";
import { t as core_default } from "./core-D8l50o8u.js";
import { a as python, i as typescript, n as javascript, r as bash, t as xml } from "./xml-AqPLxZQZ.js";
import { cr as defineStore, t as useRootStore } from "./useRootStore-CLEJA2KF.js";
...
import { Bi as LOCAL_STORAGE_LOGS_PANEL_OPEN, Hn as STICKY_NODE_TYPE, Nt as CHAT_TRIGGER_NODE_TYPE, Ri as LOCAL_STORAGE_LOGS_PANEL_DETAILS_PANEL, Vi as LOCAL_STORAGE_LOGS_SYNC_SELECTION, Wa as NDV_IN_FOCUS_PANEL_EXPERIMENT, ai as MODAL_CONFIRM, ba as CANVAS_ZOOMED_VIEW_EXPERIMENT, no as EnterpriseEditionFeature, qn as UPDATE_WEBHOOK_ID_NODE_TYPES, sn as KEEP_AUTH_IN_NDV_FOR_NODES, un as MANUAL_CHAT_TRIGGER_NODE_TYPE, zi as LOCAL_STORAGE_LOGS_PANEL_DETAILS_PANEL_SUB_NODE } from "./constants-CMdL1Kzl.js";
import { a as TELEMETRY_EVENT } from "./src-CRk-YGAD.js";
import { _ as tryToParseNumber, c as isEmpty, d as isPresent } from "./typesUtils-XxdBySCt.js";
import { o as getNewWorkflowData } from "./workflowsList.store-y-0nsqzo.js";
import { n as useUIStore } from "./ui.store-CxHz_b7L.js";
import { _ as useCanvasStore, a as AddNodeGroupCommand, d as RemoveNodeCommand, f as RemoveNodeGroupCommand, h as UpdateNodeGroupCommand, i as AddNodeCommand, l as MoveNodeCommand, m as ReplaceNodeParametersCommand, n as useHistoryStore, p as RenameNodeCommand, r as AddConnectionCommand, t as useNodeHelpers, u as RemoveConnectionCommand } from "./useNodeHelpers-C1FZHNRd.js";
...
import { t as clearAllNodeResourceLocatorValues } from "./templateTransforms-C_6EQPVs.js";
