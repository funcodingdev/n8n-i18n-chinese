const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/es-CNiDGdeC.js","assets/chunk-CC9Q-vWm.js","assets/core-BTh8S9SH.js","assets/languageModules-C_ywkrTN.js","assets/xml-BuazyEkY.js"])))=>i.map(i=>d[i]);
...
import { aa as truncateBeforeLast, lo as N8nButton_default } from "./src-2q8VSXtx.js";
	...
	async function loadLanguageModules() {
		...
		try {
			const promise = Promise.all([__vitePreload(async () => {
				const { default: highlight } = await import("./es-CNiDGdeC.js");
				return { default: highlight };
			}, __vite__mapDeps([0,1,2])).then(({ default: highlight }) => highlight), __vitePreload(() => import("./languageModules-C_ywkrTN.js"), __vite__mapDeps([3,4]))]);
			asyncImport = {
				status: "inProgress",
				promise
			};
