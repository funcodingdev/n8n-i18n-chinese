...
import { i as i18n, s as useI18n } from "./src-8gwOjOcA.js";
...
import { _ as ContextMenuItem_default, g as ContextMenuPortal_default, h as ContextMenuTrigger_default, v as ContextMenuContent_default, y as ContextMenuRoot_default } from "./useWorkflowDocumentRenderData-BcJWDNDU.js";
import { f as useElementHover, k as useWindowSize, n as onClickOutside, p as useElementSize, x as useScroll } from "./core-CxAuVuwP.js";
import { t as ParameterInputList_default, x as setParameterValue } from "./ParameterInputList-BYrP4zuh.js";
import { t as useToast } from "./useToast-BQDD3Gac.js";
import { Ai as INSTANCE_AI_BROWSER_USE_SETUP_MODAL_KEY, Ba as parseOutputDisplayBlocks, Bu as WorkflowDocumentStoreKey, Dc as getNodeParameters, Ga as summarizeJsonValue, Ha as parseStepSummary, Iu as EditorEnabledFeaturesKey, La as formatDebugJson, Lu as ExpressionLocalResolveContextSymbol, Ni as INSTANCE_AI_TOOLS_CONNECTION_MODAL_KEY, Oc as getNodeParametersIssues, Ra as parseInputExtras, Sc as displayParameter, Ua as parseSystemPromptForDisplay, Va as parseOutputExtras, Vu as WorkflowIdKey, Wa as parseUsageSummary, Wc as nodeIssuesToString, cl as isExpression, dl as deepCopy, ji as INSTANCE_AI_COMPUTER_USE_SETUP_MODAL_KEY, za as parseMessageBlocks } from "./constants-U-laJZAl.js";
import { Vt as disposeNDVStore, Wt as useNDVStore, _ as useNodeTypesStore, at as useCredentialsStore, cn as useWorkflowsStore, fn as useExecutionDataStore, i as disposeWorkflowDocumentStore, jr as injectStrict, ln as createExecutionDataId, qn as getAppNameFromCredType, qt as useWorkflowExecutionStateStore, r as createWorkflowDocumentId, s as useWorkflowDocumentStore, xn as useProjectsStore } from "./workflowDocument.store-CIv6hRQx.js";
...
import { a as useWorkflowSaveStore } from "./builder.store-CYjdgG01.js";
import { r as findPlaceholderDetails, t as isRecord$1 } from "./dist-CFw5VhTU.js";
import { t as require_FileSaver_min } from "./FileSaver.min-vCTJCDj3.js";
import { _ as useCanvasStore } from "./useNodeHelpers-CM0PH_Hz.js";
...
import { t as InstanceAiEditorCapabilityKey } from "./useInstanceAiEditorCapability-CtUaHJbA.js";
...
import { r as FreeAiCreditsCallout_default } from "./NodeSettings-BMQl9-Ji.js";
...
import { a as getLatestBuildResult, c as getLatestDeletedDataTableId, d as isAgentEditingWorkflow, f as fetchRunDebug, h as fetchThreads, i as getExecutionResultsByWorkflow, l as getLatestWorkflowSetupResult, m as fetchThreadMessages, n as useInstanceAiStore, o as getLatestBuilderTarget, p as fetchThreadDebugRuns, r as useThread, s as getLatestDataTableResult, t as provideThread, u as getLatestWorkflowUpdateResult } from "./instanceAi.store-O0JNhv2V.js";
import { i as consumePendingFirstMessage, t as buildInstanceAiArtifactCredentialQuestion } from "./useInstanceAiHandoff-BVyPAfQI.js";
import { r as useCredentialTestInBackground, u as isHttpRequestNodeType } from "./CanvasRunWorkflowButton-CeZ5zQzx.js";
import { n as useInstanceAiMcpStore, t as iconForTool } from "./toolIcons-RBlGkHnw.js";
import { t as CreditWarningBanner_default } from "./CreditWarningBanner-Bfa7XvAW.js";
import { t as useSidebarLayout } from "./useSidebarLayout-DtbvYSEb.js";
import { n as LogsPanel_default } from "./useExecutionDebugging-DxBnhiwZ.js";
import { t as useWorkflowInitialization } from "./useWorkflowInitialization-cxG1DV8K.js";
import { t as ChatMarkdownChunk_default } from "./ChatMarkdownChunk-Bp1JIXBE.js";
import { t as MainHeader_default } from "./MainHeader-D4bwL9sH.js";
import { t as NodeView_default } from "./NodeView-Ex_TNLpo.js";
import { i as AttachmentPreview_default, n as InstanceAiViewHeader_default, o as useCreditWarningBanner, r as InstanceAiInput_default, t as WorkflowBuilderUnavailableNotice_default } from "./WorkflowBuilderUnavailableNotice-NRArW9HK.js";
import { n as useSidebarState } from "./instanceAiLayout-BrRQjZTw.js";
import { n as useInstanceAiBrowserUseExperiment, r as useInstanceAiMcpConnectionsExperiment, t as useInstanceAiComputerUseExperiment } from "./instanceAiComputerUse-CZ9XrvGV.js";
import { t as DataTableTable_default } from "./DataTableTable-C014x1vy.js";
...
var ConnectionsCard_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		...
		const baseAddItems = computed(() => {
			const items = [];
			if (isComputerUseEnabled.value) items.push({
				id: "computer-use",
		...
		return (_ctx, _cache) => {
			...
			}, [createBaseVNode("span", null, toDisplayString(unref(i18n).baseText(unref(isComputerUseEnabled) ? "instanceAi.connections.empty.title" : "instanceAi.connections.empty.titleNoComputerUse")), 1), unref(isComputerUseEnabled) ? (openBlock(), createBlock(unref(N8nButton_default), {
				key: 0,
			...
			}, null, 8, ["label", "disabled"])) : createCommentVNode("", true)], 2))], 2)) : createCommentVNode("", true);
		};
	}
});
...
function useInstanceAiWorkflowPreviewExecution(options) {
	...
	async function showExecutionResult(executionResult) {
		...
		if (supersededAgentExecutionId.value !== execution.id) applyAgentExecution(latestAgentExecution.value);
	}
