...
import { r as require_get, y as useRoute } from "./truncate-DVkJizy2.js";
import { D as TitledList_default, E as useNodeCredentialOptions, T as NodeCredentials_default, d as collectParametersByTab, f as collectSettings, h as getNodeSettingsInitialValues, p as createCommonNodeSettings, t as ParameterInputList_default, u as useNodeSettingsParameters, v as nameIsParameter } from "./ParameterInputList-BwNVc2D8.js";
import { n as ElRow, t as ElCol } from "./col-D-e36NYo.js";
import { Bi as COMMUNITY_NODES_INSTALLATION_DOCS_URL, En as useProjectsStore, Fi as useUIStore, Ht as useCredentialsStore, On as ProjectTypes, Pr as RenameNodeCommand, Sn as injectWorkflowState, Tr as useHistoryStore, Ui as COMMUNITY_PACKAGE_INSTALL_MODAL_KEY, Wo as useSettingsStore, a as useNDVStore, at as useNodeTypesStore, bt as removePreviewToken, ki as importCurlEventBus, mn as useWorkflowHelpers, nr as useUsersStore, o as useWorkflowsStore, ot as useActionsGenerator, t as useTelemetry, xn as useNodeHelpers } from "./useTelemetry-BhT0XQHJ.js";
import { t as useToast } from "./useToast-BCcOgf8O.js";
import { Da as deepCopy, Ka as NodeConnectionTypes, L as CUSTOM_API_CALL_KEY, Oa as isCommunityPackageName, Ro as VIEWS, S as NPM_PACKAGE_DOCS_BASE_URL, Vt as CHAT_TRIGGER_NODE_TYPE, Wn as OPEN_URL_PANEL_TRIGGER_NODE_TYPES, Xt as DATA_TABLE_NODES, d as BUILTIN_NODES_DOCS_URL, do as OPEN_AI_API_CREDENTIAL_TYPE, fn as FORM_TRIGGER_NODE_TYPE, kn as MCP_TRIGGER_NODE_TYPE, l as BASE_NODE_SURVEY_URL, p as CUSTOM_NODES_DOCS_URL, qn as PRODUCTION_ONLY_TRIGGER_NODE_TYPES, ra as getNodeParameters, ta as getNodeInputs } from "./constants-CpJ68bS0.js";
import { n as ndvEventBus } from "./assistant.store-DY8PeSCd.js";
import { t as useDebounce } from "./useDebounce-Djl0X-gq.js";
import { t as useExternalHooks } from "./useExternalHooks-3IJ7LStW.js";
import { t as useNodeCreatorStore } from "./nodeCreator.store-BHsLLmRB.js";
...
import { a as useInstallNode, i as useInstalledCommunityPackage, n as CommunityNodeFooter_default, r as ContactAdministratorToInstall_default, t as CommunityNodeUpdateInfo_default } from "./CommunityNodeUpdateInfo-CbQ9nM2o.js";
import { n as NodeExecuteButton_default } from "./VirtualSchema-DjuNdAQS.js";
import { t as useActions } from "./useActions-CZV8590O.js";
