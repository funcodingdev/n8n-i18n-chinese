...
(function () {
  System.register(["./vue.runtime.esm-bundler-legacy--Sn1h8On.js", "./useTelemetry-legacy-yLgrtxmH.js", "./constants-legacy-e6rCvq4v.js", "./_baseOrderBy-legacy-Dt_IoFJy.js"], function (_export, _context) {
    ...
    var computed, ref, reactive, getAdminPanelLoginCode, getCurrentUsage, getCloudUserInfo, useSettingsStore, STORES, hasPermission, getCurrentPlan, DateTime, CLOUD_TRIAL_CHECK_INTERVAL, defineStore, useRootStore, DEFAULT_STATE, DYNAMIC_TRIAL_BANNER_DISMISSED_KEY, useCloudPlanStore;
    return {
      setters: [function (_vueRuntimeEsmBundlerLegacy003Js) {
        ...
        getAdminPanelLoginCode = _useTelemetryLegacy00HJs.Gs;
        getCurrentUsage = _useTelemetryLegacy00HJs.Js;
        getCloudUserInfo = _useTelemetryLegacy00HJs.Ks;
        useSettingsStore = _useTelemetryLegacy00HJs.Wo;
        STORES = _useTelemetryLegacy00HJs.cc;
        hasPermission = _useTelemetryLegacy00HJs.qn;
        getCurrentPlan = _useTelemetryLegacy00HJs.qs;
      }, function (_constantsLegacy00TJs) {
        DateTime = _constantsLegacy00TJs.Wa;
        CLOUD_TRIAL_CHECK_INTERVAL = _constantsLegacy00TJs.yc;
