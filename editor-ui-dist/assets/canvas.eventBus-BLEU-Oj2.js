...
import { It as ref, S as computed, W as nextTick } from "./vue.runtime.esm-bundler-CDDUUZhE.js";
import { s as useI18n } from "./src-Dh32dOY5.js";
import { Ot as createEventBus } from "./src-BVC_ZvSs.js";
import { a as require_toString, o as require__arrayMap, t as require_get } from "./get-D159b5Ls.js";
import { $ as AI_CATEGORY_RETRIEVERS, $t as EMAIL_SEND_NODE_TYPE, At as AI_TRANSFORM_NODE_TYPE, Bt as COMPRESSION_NODE_TYPE, Cr as XML_NODE_TYPE, Cs as require__arrayIncludes, Ct as TRANSFORM_DATA_SUBCATEGORY, Dn as MERGE_NODE_TYPE, Dt as AGGREGATE_NODE_TYPE, Ec as NodeConnectionTypes, El as v4, G as AI_CATEGORY_DOCUMENT_LOADERS, Gt as CRYPTO_NODE_TYPE, J as AI_CATEGORY_LANGUAGE_MODELS, Jn as REMOVE_DUPLICATES_NODE_TYPE, Jt as DATETIME_NODE_TYPE, K as AI_CATEGORY_EMBEDDING, Lt as CHAT_TRIGGER_NODE_TYPE, Ml as require__cacheHas, Nl as require__SetCache, On as MESSAGE_AN_AGENT_NODE_TYPE, Pc as isCommunityPackageName, Q as AI_CATEGORY_OUTPUTPARSER, Qn as SCHEDULE_TRIGGER_NODE_TYPE, Qt as EMAIL_IMAP_NODE_TYPE, Ss as require__arrayIncludesWith, St as TEMPLATE_CATEGORY_AI, Tn as MARKDOWN_NODE_TYPE, U as AI_CATEGORY_AGENTS, Vt as CONVERT_TO_FILE_NODE_TYPE, W as AI_CATEGORY_CHAINS, X as AI_CATEGORY_MEMORY, Xn as RSS_READ_NODE_TYPE, Xt as EDIT_IMAGE_NODE_TYPE, Y as AI_CATEGORY_MCP_NODES, Yo as require__baseFlatten, Z as AI_CATEGORY_OTHER_TOOLS, _r as WEBHOOK_NODE_TYPE, _t as NODE_CREATOR_OPEN_SOURCES, an as EXTRACT_FROM_FILE_NODE_TYPE, bt as REGULAR_NODE_CREATOR_VIEW, cn as FORM_TRIGGER_NODE_TYPE, cs as require__createCompounder, ct as AI_UNCATEGORIZED_CATEGORY, dn as HTML_NODE_TYPE, dt as CORE_NODES_CATEGORY, et as AI_CATEGORY_ROOT_NODES, fl as EVALUATION_TRIGGER_NODE_TYPE, fn as HTTP_REQUEST_NODE_TYPE, ft as FLOWS_CONTROL_SUBCATEGORY, gt as NEW_TOOL_CATEGORIES, hn as IF_NODE_TYPE, ht as HUMAN_IN_THE_LOOP_CATEGORY, ic as isHitlToolType, in as EXECUTE_WORKFLOW_TRIGGER_NODE_TYPE, it as AI_CODE_TOOL_LANGCHAIN_NODE_TYPE, kt as AI_MCP_TOOL_NODE_TYPE, lt as AI_WORKFLOW_TOOL_LANGCHAIN_NODE_TYPE, mt as HITL_SUBCATEGORY, nt as AI_CATEGORY_TOOLS, on as FILTER_NODE_TYPE, or as SPLIT_IN_BATCHES_NODE_TYPE, ot as AI_OTHERS_NODE_CREATOR_VIEW, pt as HELPERS_SUBCATEGORY, qs as getNodeInputs, qt as DATA_TABLE_NODE_TYPE, rt as AI_CATEGORY_VECTOR_STORES, sr as SPLIT_OUT_NODE_TYPE, tr as SET_NODE_TYPE, tt as AI_CATEGORY_TEXT_SPLITTERS, ur as SUMMARIZE_NODE_TYPE, vt as OTHER_TRIGGER_NODES_SUBCATEGORY, wn as MANUAL_TRIGGER_NODE_TYPE, wt as TRIGGER_NODE_CREATOR_VIEW, xn as LIMIT_NODE_TYPE, zt as CODE_NODE_TYPE } from "./constants-DzzWpyjZ.js";
import { E as require__baseUnary, d as require_isArrayLikeObject, r as require__baseRest } from "./merge-CD5c-3ZT.js";
import { B as sortNodeCreateElements, D as flattenCreateElements, E as finalizeItems, Er as parseCanvasConnectionHandleString, F as nodeTypesToCreateElements, H as transformNodeType, I as prepareCommunityNodeDetailsViewStack, Li as CanvasConnectionMode, M as isAINode, O as getAiTemplatesCallout, P as mapToolSubcategoryIcon, R as searchNodes, Ut as useNDVStore, V as subcategorizeItems, _ as useNodeTypesStore, _r as createCanvasConnectionHandleString, a as injectWorkflowDocumentStore, b as useEvaluationStore, er as getThemedValue, j as groupItemsInSections, ji as isVueFlowConnection, r as createWorkflowDocumentId, s as useWorkflowDocumentStore, sn as useWorkflowsStore, tt as require_upperFirst } from "./workflowDocument.store-BQc6YDGi.js";
...
import { n as getNodeIconSource } from "./nodeIcon-Dp_bCX28.js";
import { t as _virtual_node_popularity_data_default } from "./_virtual_node-popularity-data-DfyOlURA.js";
