;
(function () {
  System.register(["./chunk-legacy-Re9CbdfL.js", "./vue.runtime.esm-bundler-legacy--Sn1h8On.js", "./_MapCache-legacy-CIWHOywQ.js", "./truncate-legacy-Dbhp0OXD.js", "./useTelemetry-legacy-CISk46xo.js", "./useToast-legacy-WoZGemxJ.js", "./constants-legacy-DuqvrHPn.js", "./_baseOrderBy-legacy-BoIlqV8l.js", "./useExternalHooks-legacy-DWuo7Sev.js", "./templates.store-legacy-BQe4Y3Vh.js", "./focusPanel.store-legacy-DdtqRk24.js", "./executions.store-legacy-CJJHUxFO.js", "./usePinnedData-legacy-CYTkRpTn.js", "./nodeCreator.store-legacy-D19qq8PN.js", "./useClipboard-legacy-BQj5GP2z.js", "./folders.store-legacy-DpkSoEgT.js"], function (_export, _context) {
    "use strict";

    var __toESM, __commonJS, computed, nextTick, ref, shallowRef, useI18n, useLocalStorage, useRouter, createEventBus, useRoute, v4_default, AddNodeCommand, useProjectsStore, AddConnectionCommand, useUIStore, ReplaceNodeParametersCommand, useCanvasStore, useCredentialsStore, RemoveConnectionCommand, RemoveNodeCommand, RenameNodeCommand, getNodesGroupSize, injectWorkflowState, CanvasConnectionMode, tryToParseNumber, useHistoryStore, useSettingsStore, useDataSchema, useTagsStore, useNDVStore, useNodeTypesStore, getNewNodePosition, isPresent, DEFAULT_VIEWPORT_BOUNDARIES, GRID_SIZE, generateOffsets, usePostHog, MoveNodeCommand, CONFIGURATION_NODE_SIZE, useWorkflowHelpers, useWorkflowsStore, PUSH_NODES_OFFSET, isChatNode, CONFIGURABLE_NODE_SIZE, useTelemetry, getExecutionErrorToastConfiguration, DEFAULT_NODE_SIZE, isValidNodeConnectionType, CanvasNodeRenderType, useNodeHelpers, useToast, getConnectionTypes, LOCAL_STORAGE_LOGS_PANEL_DETAILS_PANEL_SUB_NODE, isCommunityPackageName, deepCopy, VIEWS, NodeConnectionTypes, LOCAL_STORAGE_LOGS_SYNC_SELECTION, require_cloneDeep, generateNodesGraph, UPDATE_WEBHOOK_ID_NODE_TYPES, NDV_IN_FOCUS_PANEL_EXPERIMENT, STICKY_NODE_TYPE, getNodeInputs, FORM_TRIGGER_NODE_TYPE, EnterpriseEditionFeature, require__baseUniq, LOCAL_STORAGE_LOGS_PANEL_OPEN, MCP_TRIGGER_NODE_TYPE, LOCAL_STORAGE_LOGS_PANEL_DETAILS_PANEL, getNodeParameters, getSubworkflowId, getNodeOutputs, CANVAS_ZOOMED_VIEW_EXPERIMENT, WEBHOOK_NODE_TYPE, defineStore, useRootStore, useExternalHooks, useTemplatesStore, useFocusPanelStore, useExecutionsStore, usePinnedData, mapCanvasConnectionToLegacyConnection, parseCanvasConnectionHandleString, mapLegacyConnectionToCanvasConnection, createCanvasConnectionHandleString, mapLegacyConnectionsToCanvasConnections, useNodeCreatorStore, useClipboard, useFoldersStore, chatEventBus, LOCAL_STORAGE_PANEL_HEIGHT, LOCAL_STORAGE_PANEL_WIDTH, LOCAL_STORAGE_OVERVIEW_PANEL_WIDTH, LOGS_PANEL_STATE, LOG_DETAILS_PANEL_STATE, useLogsStore, require_uniq, useExperimentalNdvStore, canvasEventBus, import_cloneDeep, import_uniq;
    ...
    return {
      setters: [function (_chunkLegacy001Js) {
        ...
        ReplaceNodeParametersCommand = _useTelemetryLegacy00HJs.Fr;
        ...
        getNodesGroupSize = _useTelemetryLegacy00HJs.S;
        ...
        DEFAULT_VIEWPORT_BOUNDARIES = _useTelemetryLegacy00HJs.d;
        GRID_SIZE = _useTelemetryLegacy00HJs.f;
        generateOffsets = _useTelemetryLegacy00HJs.h;
        usePostHog = _useTelemetryLegacy00HJs.i;
        MoveNodeCommand = _useTelemetryLegacy00HJs.jr;
        CONFIGURATION_NODE_SIZE = _useTelemetryLegacy00HJs.l;
        ...
        CONFIGURABLE_NODE_SIZE = _useTelemetryLegacy00HJs.s;
        ...
        getConnectionTypes = _constantsLegacy00TJs.$i;
        LOCAL_STORAGE_LOGS_PANEL_DETAILS_PANEL_SUB_NODE = _constantsLegacy00TJs.As;
        isCommunityPackageName = _constantsLegacy00TJs.Da;
        deepCopy = _constantsLegacy00TJs.Ea;
        VIEWS = _constantsLegacy00TJs.Fo;
        NodeConnectionTypes = _constantsLegacy00TJs.Ga;
        LOCAL_STORAGE_LOGS_SYNC_SELECTION = _constantsLegacy00TJs.Ms;
        require_cloneDeep = _constantsLegacy00TJs.Si;
        generateNodesGraph = _constantsLegacy00TJs.Xi;
        UPDATE_WEBHOOK_ID_NODE_TYPES = _constantsLegacy00TJs._r;
        NDV_IN_FOCUS_PANEL_EXPERIMENT = _constantsLegacy00TJs.ac;
        ...
        require__baseUniq = _constantsLegacy00TJs.ji;
        LOCAL_STORAGE_LOGS_PANEL_OPEN = _constantsLegacy00TJs.js;
        MCP_TRIGGER_NODE_TYPE = _constantsLegacy00TJs.kn;
        LOCAL_STORAGE_LOGS_PANEL_DETAILS_PANEL = _constantsLegacy00TJs.ks;
        getNodeParameters = _constantsLegacy00TJs.na;
        getSubworkflowId = _constantsLegacy00TJs.sa;
        getNodeOutputs = _constantsLegacy00TJs.ta;
        CANVAS_ZOOMED_VIEW_EXPERIMENT = _constantsLegacy00TJs.tc;
      ...
      }, function (_focusPanelStoreLegacy01hJs) {
        useFocusPanelStore = _focusPanelStoreLegacy01hJs.t;
      }, function (_executionsStoreLegacy01nJs) {
        ...
        mapCanvasConnectionToLegacyConnection = _nodeCreatorStoreLegacy01tJs.a;
        parseCanvasConnectionHandleString = _nodeCreatorStoreLegacy01tJs.l;
        mapLegacyConnectionToCanvasConnection = _nodeCreatorStoreLegacy01tJs.o;
