import { $n as getFullApiResponse, er as makeRestApiRequest } from "./useRootStore-BtIOvEaj.js";
...
var connectIntegration = async (context, projectId, agentId, type, credentialId, settings, options) => {
...
var disconnectIntegration = async (context, projectId, agentId, type, credentialId, deleteExternalResource) => {
...
var getChatMessages = async (context, projectId, agentId, threadId) => {
	return await makeRestApiRequest(context, "GET", `/projects/${encodeURIComponent(projectId)}/agents/v2/${encodeURIComponent(agentId)}/chat/${encodeURIComponent(threadId)}/messages`);
};
