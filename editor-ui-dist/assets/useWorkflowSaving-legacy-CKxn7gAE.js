;
(function () {
  System.register(["./_MapCache-legacy-CIWHOywQ.js", "./useMessage-legacy-DiNoct2x.js", "./useTelemetry-legacy-CISk46xo.js", "./useToast-legacy-WoZGemxJ.js", "./constants-legacy-DuqvrHPn.js", "./useExternalHooks-legacy-DWuo7Sev.js", "./npsSurvey.store-legacy-DaZ56GaJ.js", "./templates.store-legacy-BQe4Y3Vh.js", "./focusPanel.store-legacy-DdtqRk24.js"], function (_export, _context) {
    "use strict";

    var useI18n, useMessage, useSourceControlStore, useUIStore, useCanvasStore, injectWorkflowState, tryToParseNumber, useNodeTypesStore, useWorkflowHelpers, useWorkflowsStore, useTelemetry, useNodeHelpers, useToast, MODAL_CLOSE, getResourcePermissions, VIEWS, NON_ACTIVATABLE_TRIGGER_NODE_TYPES, MODAL_CANCEL, IS_DRAFT_PUBLISH_ENABLED, PLACEHOLDER_EMPTY_WORKFLOW_ID, MODAL_CONFIRM, useExternalHooks, useNpsSurveyStore, useTemplatesStore, useFocusPanelStore;
    ...
    return {
      setters: [function (_MapCacheLegacy005Js) {
        ...
        MODAL_CLOSE = _constantsLegacy00TJs.$o;
        ...
        MODAL_CANCEL = _constantsLegacy00TJs.Qo;
