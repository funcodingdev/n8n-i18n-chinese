import { I as h, It as ref, S as computed, q as onBeforeUnmount } from "./vue.runtime.esm-bundler-DYHsQBZB.js";
...
import { Et as useCredentialsStore, O as injectWorkflowDocumentStore, bn as useProjectsStore } from "./workflows.store-CQp5NuTc.js";
...
import { T as listAgentsPage, d as getAgent } from "./useAgentApi-BjSqetbH.js";
...
function useQuickConnect() {
	...
	async function connectToPinecone(quickConnectOption) {
		const { ConnectPopup } = await __vitePreload(async () => {
			const { ConnectPopup } = await import("./dist-D_4wuNub.js");
			return { ConnectPopup };
		}, []);
