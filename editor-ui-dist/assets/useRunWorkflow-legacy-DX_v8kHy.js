;
(function () {
  System.register(["./chunk-legacy-Re9CbdfL.js", "./vue.runtime.esm-bundler-legacy--Sn1h8On.js", "./_MapCache-legacy-CIWHOywQ.js", "./truncate-legacy-Dbhp0OXD.js", "./useTelemetry-legacy-CISk46xo.js", "./useToast-legacy-WoZGemxJ.js", "./constants-legacy-DuqvrHPn.js", "./_baseOrderBy-legacy-BoIlqV8l.js", "./useExternalHooks-legacy-DWuo7Sev.js", "./useWorkflowSaving-legacy-CKxn7gAE.js", "./retry-legacy-CTwsGM7o.js", "./executions.store-legacy-CJJHUxFO.js", "./useCanvasOperations-legacy-8UtQ7k1k.js"], function (_export, _context) {
    "use strict";

    var __toESM, computed, ref, watch, useI18n, useLocalStorage, require_get, EnableNodeToggleCommand, CanvasNodeDirtiness, AddNodeCommand, AddConnectionCommand, RemoveConnectionCommand, RemoveNodeCommand, BulkCommand, injectWorkflowState, useDocumentTitle, useHistoryStore, useSettingsStore, displayForm, STORES, useWorkflowHelpers, useWorkflowsStore, useTelemetry, isEmpty, useNodeHelpers, useToast, NodeConnectionTypes, LOCAL_STORAGE_RUN_DATA_WORKER, IN_PROGRESS_EXECUTION_ID, createHeartbeatMessage, CHAT_TRIGGER_NODE_TYPE, createRunExecutionData, generateNodesGraph, SINGLE_WEBHOOK_TRIGGERS, defineStore, useRootStore, useExternalHooks, useWorkflowSaving, retry, useExecutionsStore, useCanvasOperations, useHeartbeat, useReconnectTimer, useWebSocketClient, useEventSourceClient, proxyMarker, createEndpoint, releaseProxy, finalizer, throwMarker, isObject, transferHandlers, proxyCounter, proxyFinalizers, transferCache, worker, runDataWorker, usePushConnectionStore, LOCAL_STORAGE_AGENT_REQUESTS, useAgentRequestStore, import_get;
    ...
    */
    ...
    return {
      setters: [function (_chunkLegacy001Js) {
        ...
        LOCAL_STORAGE_RUN_DATA_WORKER = _constantsLegacy00TJs.Ls;
