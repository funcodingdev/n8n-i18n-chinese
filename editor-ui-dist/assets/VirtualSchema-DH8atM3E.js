...
import { A as useWorkflowDocumentStore, At as generateCodeForPrompt, H as useNodeTypesStore, It as useDataSchema, L as needsAgentInput, Lt as useFlattenSchema, O as injectWorkflowDocumentStore, Vn as executionDataToJson, fn as useNDVStore, mn as useEnvironmentsStore, t as useWorkflowsStore, un as injectNDVStore, v as injectWorkflowExecutionStateStore } from "./workflows.store-CQp5NuTc.js";
import { Ma as AI_TRANSFORM_CODE_GENERATED_FOR_PROMPT, Mn as createResultError, Na as AI_TRANSFORM_JS_CODE, Oa as UserError, ca as DateTime, la as NodeConnectionTypes } from "./src-BrbN-vPn.js";
...
import { $r as FROM_AI_PARAMETERS_MODAL_KEY, Gr as BINARY_DATA_VIEW_MODAL_KEY, N as PLACEHOLDER_FILLED_AT_EXECUTION_TIME, Pt as CHAT_TRIGGER_NODE_TYPE, Xn as WEBHOOK_NODE_TYPE, ao as EnterpriseEditionFeature, fn as MANUAL_TRIGGER_NODE_TYPE, nn as FORM_TRIGGER_NODE_TYPE, oi as MODAL_CONFIRM, w as SCHEMA_PREVIEW_DOCS_URL } from "./constants-Bwbcx8Ih.js";
import { c as isEmpty } from "./typesUtils-BoKZFaOH.js";
...
import { i as Vo, o as fu, r as estree_exports, t as NDVEmptyState_default } from "./NDVEmptyState-CSWdqkSk.js";
...
import { t as useCalloutHelpers } from "./useCalloutHelpers-DprBUkaz.js";
import { n as MappingPill_default, t as useTelemetryContext } from "./useTelemetryContext-RRX_oMp1.js";
...
var VirtualSchemaItem_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	emits: ["click"],
	setup(__props, { emit: __emit }) {
		useCssVars((_ctx) => ({ "v0241c5ec": _ctx.level }));
		const props = __props;
		const i18n = useI18n();
...
var VirtualSchemaItem_default = /* @__PURE__ */ _plugin_vue_export_helper_default(VirtualSchemaItem_vue_vue_type_script_setup_true_lang_default, [["__cssModules", { "$style": VirtualSchemaItem_vue_vue_type_style_index_1_lang_module_default }], ["__scopeId", "data-v-d0887230"]]);
//#endregion
...
function useNodeExecution(node, options = {}) {
	...
	async function stopExecution() {
		if (workflowExecutionStateStore.value.executionWaitingForWebhook) await stopWaitingForWebhook();
		else await stopCurrentExecution();
	}
	return {
		isExecuting,
		isListening,
