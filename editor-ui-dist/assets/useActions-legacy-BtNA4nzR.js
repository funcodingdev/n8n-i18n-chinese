;
(function () {
  System.register(["./vue.runtime.esm-bundler-legacy--Sn1h8On.js", "./_MapCache-legacy-BH2XE3uj.js", "./useTelemetry-legacy-CMfwYwVY.js", "./constants-legacy-8iZaMHMx.js", "./useExternalHooks-legacy-CDDHCmE_.js", "./nodeCreator.store-legacy-BTJiz6t7.js"], function (_export, _context) {
    "use strict";

    var computed, useI18n, sortNodeCreateElements, useCanvasStore, injectWorkflowState, transformNodeType, useNodeTypesStore, useWorkflowsStore, PUSH_NODES_OFFSET, CHAIN_LLM_LANGCHAIN_NODE_TYPE, SCHEDULE_TRIGGER_NODE_TYPE, NO_OP_NODE_TYPE, MANUAL_TRIGGER_NODE_TYPE, OPEN_AI_NODE_MESSAGE_ASSISTANT_TYPE, QA_CHAIN_NODE_TYPE, NodeConnectionTypes, TRIGGER_NODE_CREATOR_VIEW, AGENT_NODE_TYPE, OPEN_AI_NODE_TYPE, OPEN_AI_ASSISTANT_NODE_TYPE, CHAT_TRIGGER_NODE_TYPE, STICKY_NODE_TYPE, AI_CATEGORY_LANGUAGE_MODELS, SPLIT_IN_BATCHES_NODE_TYPE, NODE_CREATOR_OPEN_SOURCES, WEBHOOK_NODE_TYPE, BASIC_CHAIN_NODE_TYPE, useExternalHooks, useNodeCreatorStore, useActions;
    return {
      setters: [function (_vueRuntimeEsmBundlerLegacy003Js) {
        ...
        CHAIN_LLM_LANGCHAIN_NODE_TYPE = _constantsLegacy00TJs.$a;
