...
import { Xr as getNodesWithNormalizedPosition } from "./workflows.store-C0TGOSWn.js";
import { B as getTemplateById, H as getWorkflows, I as getCategories, L as getCollectionById, R as getCollections, V as getWorkflowTemplate, fr as defineStore, lr as STORES, t as useRootStore } from "./useRootStore-B4L7-X8D.js";
...
import { T as TEMPLATES_URLS } from "./constants-DOw6b_w2.js";
import { t as useWorkflowsListStore } from "./workflowsList.store-5H3D_H0z.js";
import { r as getTemplatePathByRole } from "./utils-Dvk0fQMO.js";
import { n as useInstanceAiReady } from "./useInstanceAiAvailability-CHF7uXvr.js";
...
var useTemplatesStore = defineStore(STORES.TEMPLATES, () => {
	...
	const instanceFeatures = computed(() => {
		const features = [];
		if (instanceAiReady.value) features.push("assistant");
		return features;
	});
