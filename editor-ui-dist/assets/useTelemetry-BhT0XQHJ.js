...
const useWorkflowsStore = defineStore(STORES.WORKFLOWS, () => {
	...
	async function updateWorkflowChecksum() {
		setWorkflowChecksum(await calculateWorkflowChecksum(workflow.value));
	}
