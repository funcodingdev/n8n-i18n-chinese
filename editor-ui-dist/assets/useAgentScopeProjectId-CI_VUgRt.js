...
import { c as sanitizeHtml } from "./htmlUtils-LDunChtE.js";
import { t as useToast } from "./useToast-9MJyC6NG.js";
import { dn as useProjectsStore, vt as useCredentialsStore, w as injectWorkflowDocumentStore } from "./workflows.store-HMd7zwNZ.js";
...
import { E as listAgentsPage, d as getAgent } from "./useAgentApi-rxRuPd-J.js";
...
function useQuickConnect() {
	...
	async function connectToPinecone(quickConnectOption) {
		const { ConnectPopup } = await __vitePreload(async () => {
			const { ConnectPopup } = await import("./dist-BNFUsUhw.js");
			return { ConnectPopup };
		}, []);
