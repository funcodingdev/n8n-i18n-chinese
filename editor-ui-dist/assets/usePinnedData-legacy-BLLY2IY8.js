;
(function () {
  System.register(["./vue.runtime.esm-bundler-legacy--Sn1h8On.js", "./_MapCache-legacy-BlV_W1LO.js", "./useTelemetry-legacy-Dj2fHQys.js", "./useToast-legacy-B2w_7aSU.js", "./constants-legacy-wGNoFUi7.js", "./_baseOrderBy-legacy-DE6my_G3.js", "./useExternalHooks-legacy-D4ODACUq.js"], function (_export, _context) {
    "use strict";

    var computed, unref, useI18n, stringSizeInBytes, useDataSchema, useNodeTypesStore, useWorkflowsStore, useTelemetry, toMegaBytes, useToast, MAX_PINNED_DATA_SIZE, PIN_DATA_NODE_TYPES_DENYLIST, jsonParse, MAX_WORKFLOW_SIZE, NodeConnectionTypes, isSubNodeType, getNodeOutputs, jsonStringify, MAX_EXPECTED_REQUEST_SIZE, useRootStore, useExternalHooks;
    ...
    return {
      setters: [function (_vueRuntimeEsmBundlerLegacy003Js) {
        ...
        MAX_PINNED_DATA_SIZE = _constantsLegacy00TJs.Bs;
        PIN_DATA_NODE_TYPES_DENYLIST = _constantsLegacy00TJs.Gn;
        jsonParse = _constantsLegacy00TJs.Oa;
        MAX_WORKFLOW_SIZE = _constantsLegacy00TJs.Vs;
        NodeConnectionTypes = _constantsLegacy00TJs.Wa;
        isSubNodeType = _constantsLegacy00TJs.da;
        getNodeOutputs = _constantsLegacy00TJs.ea;
        jsonStringify = _constantsLegacy00TJs.ka;
        MAX_EXPECTED_REQUEST_SIZE = _constantsLegacy00TJs.zs;
