import { $ as openBlock, A as createTextVNode, C as createBaseVNode, Cn as toDisplayString, E as createElementBlock, Gt as unref, H as mergeModels, It as ref, N as defineComponent, O as createSlots, S as computed, T as createCommentVNode, X as onMounted, bt as withCtx, dt as useModel, gt as watch, it as renderSlot, j as createVNode, p as vShow, vn as normalizeClass, w as createBlock, xt as withDirectives } from "./vue.runtime.esm-bundler-Bs4WIMNP.js";
import { s as useI18n } from "./src-CvPjLYa0.js";
import { Ga as N8nHeading_default, Ja as N8nButton_default, Ka as N8nCallout_default, Ki as N8nActionBox_default, Lt as N8nActionToggle_default, Q as N8nMarkdown_default, Ui as Input_default, Ut as N8nLoading_default, V as N8nPopover_default, W as N8nNotice_default, Y as PreviewTag_default, Ya as N8nIcon_default, b as N8nDataTableServer_default, k as N8nTabs_default, lt as N8nLink_default, qa as N8nText_default, tt as N8nInfoTip_default, vt as N8nInputLabel_default, z as N8nRadioButtons_default, zi as N8nTooltip_default } from "./src-CSWS3PCK.js";
import { t as _plugin_vue_export_helper_default } from "./_plugin-vue_export-helper-Da88TEg1.js";
import { t as useToast } from "./useToast-THYqqSsb.js";
import { Yi as WORKFLOW_DESCRIPTION_MODAL_KEY, fu as getResourcePermissions, ui as VIEWS } from "./constants-BpExsFUJ.js";
...
import { t as router } from "./router-CnKuiIuF.js";
import { i as MCP_ENDPOINT, n as MCP_CONNECT_WORKFLOWS_MODAL_KEY, r as MCP_DOCS_PAGE_URL } from "./mcp.constants-BT39eBzp.js";
import { t as useMcp } from "./useMcp-DEHkCcdG.js";
import { t as useMCPStore } from "./mcp.store-CxFiDpg6.js";
import { t as McpAccessToggle_default } from "./McpAccessToggle-QtL03C_1.js";
import { t as WorkflowLocation_default } from "./WorkflowLocation-xA1P5Fit.js";
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("div", {
				...
				additionalContent: withCtx(() => [createVNode(unref(N8nText_default), {
					...
					}, toDisplayString(unref(i18n).baseText("generic.learnMore").toLowerCase()), 11, _hoisted_4)]),
					_: 1
				})]),
				_: 1
			}, 8, [
...
var container$4 = "_container_heprf_125";
...
var container$2 = "_container_1jg97_125";
...
var WorkflowsTable_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props, { emit: __emit }) {
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("div", null, [props.loading ? (openBlock(), createElementBlock("div", _hoisted_1$2, [createVNode(unref(N8nLoading_default), {
				loading: props.loading,
				variant: "h1",
				class: "mb-l"
...
var header$1 = "_header_l4di3_125";
var truncate = "_truncate_l4di3_191";
var WorkflowsTable_vue_vue_type_style_index_0_lang_module_default = {
	header: header$1,
	"workflow-table": "_workflow-table_l4di3_131",
	"empty-state": "_empty-state_l4di3_141",
	"workflow-cell": "_workflow-cell_l4di3_151",
	"location-cell": "_location-cell_l4di3_158",
	"description-cell": "_description-cell_l4di3_162",
	"description-text": "_description-text_l4di3_173",
	"empty-description": "_empty-description_l4di3_182",
	"table-link": "_table-link_l4di3_187",
	truncate
};
...
var OAuthClientsTable_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props, { emit: __emit }) {
		...
		watch(() => props.clients.length, (length) => {
...
var SettingsMCPView_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		...
		const showRedirectUriWarning = computed(() => canManageMcpInstance.value && mcpStore.mcpAccessEnabled && mcpStore.allowedRedirectUris.length === 0 && !redirectUriWarningDismissed.value);
		...
		const onToggleWorkflowMCPAccess = async (workflowId, isEnabled) => {
			try {
				...
				if (isEnabled) {
					...
					await fetchAvailableWorkflows();
				} else await fetchAvailableWorkflows();
			} catch (error) {
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("div", { class: normalizeClass(_ctx.$style.container) }, [
				...
				}, [createBaseVNode("div", { class: normalizeClass(_ctx.$style.headings) }, [createBaseVNode("div", { class: normalizeClass(_ctx.$style["heading-row"]) }, [createVNode(unref(N8nHeading_default), { size: "2xlarge" }, {
					default: withCtx(() => [createTextVNode(toDisplayString(unref(i18n).baseText("settings.mcp")), 1)]),
					_: 1
				}), createVNode(unref(N8nTooltip_default), { content: unref(i18n).baseText("settings.mcp.preview.tooltip") }, {
					default: withCtx(() => [createVNode(unref(PreviewTag_default), { size: "medium" })]),
					_: 1
				}, 8, ["content"])], 2), withDirectives(createBaseVNode("div", _hoisted_1, [createVNode(unref(N8nText_default), {
					size: "small",
					color: "text-light"
				}, {
				...
				showRedirectUriWarning.value ? (openBlock(), createBlock(unref(N8nCallout_default), {
					key: 0,
					theme: "warning",
					class: normalizeClass(_ctx.$style["redirect-uri-warning"]),
					...
					trailingContent: withCtx(() => [createVNode(unref(N8nButton_default), {
						...
						size: "small",
						iconOnly: "",
						onClick: _cache[1] || (_cache[1] = ($event) => redirectUriWarningDismissed.value = true)
					})]),
					default: withCtx(() => [createTextVNode(toDisplayString(unref(i18n).baseText("settings.mcp.allowedRedirectUris.warning")) + " ", 1)]),
					_: 1
				...
				!unref(mcpStore).mcpAccessEnabled ? (openBlock(), createBlock(MCPEmptyState_default, {
					...
					loading: mcpStatusLoading.value,
					"managed-by-env": unref(mcpStore).mcpManagedByEnv,
					onTurnOnMcp: _cache[2] || (_cache[2] = ($event) => onToggleMCPAccess(true))
				}, null, 8, [
					"disabled",
					"loading",
					"managed-by-env"
				...
				unref(mcpStore).mcpAccessEnabled ? (openBlock(), createElementBlock("div", {
					...
					createBaseVNode("main", null, [selectedTab.value === "workflows" ? (openBlock(), createBlock(WorkflowsTable_default, {
						...
						"onUpdate:tableOptions": _cache[3] || (_cache[3] = ($event) => workflowsTableState.value = $event),
						"data-test-id": "mcp-workflow-table",
						workflows: availableWorkflows.value,
						"total-count": availableWorkflowsTotal.value,
						loading: workflowsLoading.value,
						onRemoveMcpAccess: _cache[4] || (_cache[4] = (workflow) => onToggleWorkflowMCPAccess(workflow.id, false)),
					...
					}, null, 8, ["clients", "loading"])) : selectedTab.value === "settings" ? (openBlock(), createElementBlock("section", {
						key: 2,
						...
						createVNode(unref(N8nInputLabel_default), {
							...
							default: withCtx(() => [createVNode(unref(Input_default), {
								...
								"onUpdate:modelValue": _cache[5] || (_cache[5] = ($event) => redirectUrisInput.value = $event),
								type: "textarea",
								rows: 6,
...
var container = "_container_1nyee_125";
var headings = "_headings_1nyee_143";
var actions = "_actions_1nyee_162";
var SettingsMCPView_vue_vue_type_style_index_0_lang_module_default = {
	container,
	"main-header": "_main-header_1nyee_130",
	headings,
	"heading-row": "_heading-row_1nyee_149",
	"tabs-header": "_tabs-header_1nyee_156",
	actions,
	"redirect-uri-warning": "_redirect-uri-warning_1nyee_167",
	"oauth-settings-content": "_oauth-settings-content_1nyee_171",
	"error-message": "_error-message_1nyee_176",
	"save-button-container": "_save-button-container_1nyee_180"
};
