...
import { $ as openBlock, A as createTextVNode, C as createBaseVNode, Cn as toDisplayString, D as createPropsRestProxy, Dt as getCurrentScope, E as createElementBlock, Et as effectScope, Ft as readonly, Gt as unref, Ht as toRefs$1, I as h, It as ref, K as onBeforeMount, Lt as shallowReactive, Mt as markRaw, N as defineComponent, Nt as onScopeDispose, P as getCurrentInstance, Pt as reactive, R as inject, S as computed, T as createCommentVNode, Tt as customRef, U as mergeProps, Ut as toValue$1, Vt as toRef, W as nextTick, X as onMounted, Z as onUnmounted, _ as Fragment, at as resolveComponent, bn as normalizeStyle, bt as withCtx, ft as useSlots, gt as watch, it as renderSlot, j as createVNode, jt as isRef, lt as useAttrs, ot as resolveDirective, q as onBeforeUnmount, rt as renderList, st as resolveDynamicComponent, tt as provide, vn as normalizeClass, w as createBlock, xt as withDirectives, y as Teleport, z as isMemoSame, zt as shallowRef } from "./vue.runtime.esm-bundler-CiTcVoZc.js";
import { i as i18n, n as addHeaders, r as addNodeTranslation, s as useI18n } from "./src-w6tdcvn4.js";
import { I as isBinary, ht as useRoute, qi as truncate } from "./src-BwN8TeVO.js";
import { a as require_toString, s as require_memoize, t as require_get, u as require_lib } from "./get-CKIAFyM1.js";
import { $s as nodeIssuesToString, A as ALLOWED_HTML_TAGS, At as AI_TRANSFORM_NODE_TYPE, Ds as mapConnectionsByDestination, E as TEMPLATES_NODES_FILTER, Fc as ApplicationError, Fn as NON_ACTIVATABLE_TRIGGER_NODE_TYPES, Fs as getNodeOutputs, Gc as CHAT_TRIGGER_NODE_TYPE, Gs as isHitlToolType, I as CUSTOM_API_CALL_KEY, Is as getNodeParameters, L as DATA_TYPE_ICON_MAP, Mo as require_pick, Ms as displayParameterPath, N as IN_PROGRESS_EXECUTION_ID, Nn as NODE_POSITION_CONFLICT_ALLOWLIST, Ns as getConnectionTypes, P as PLACEHOLDER_FILLED_AT_EXECUTION_TIME, Pc as ExpressionError, Po as require__baseFlatten, Ps as getNodeInputs, Qn as SCHEDULE_TRIGGER_NODE_TYPE, Ro as isAssignmentCollectionValue, Rs as getNodeWebhookUrl, Sn as LIST_LIKE_NODE_OPERATIONS, Ss as createRunExecutionData, Tc as sleep$1, Tl as getResourcePermissions, U as AI_CATEGORY_AGENTS, Uo as Workflow, Ut as CREDENTIAL_ONLY_NODE_PREFIX, Wl as CanvasRenderDataKey, Xl as WorkflowDocumentStoreKey, Xo as require__baseIteratee, Y as AI_CATEGORY_MCP_NODES, Z as AI_CATEGORY_OTHER_TOOLS, _r as WEBHOOK_NODE_TYPE$1, al as SEND_AND_WAIT_OPERATION, cn as FORM_TRIGGER_NODE_TYPE$1, cs as require__baseUniq, dc as isResourceMapperValue$1, dl as require_isEqual, ds as require__baseFindIndex, dt as CORE_NODES_CATEGORY, en as ERROR_TRIGGER_NODE_TYPE$1, fn as HTTP_REQUEST_NODE_TYPE, hc as isExpression, ht as HUMAN_IN_THE_LOOP_CATEGORY, i as DUPLICATE_POSTFFIX, ic as isFilterValue, is as traverseNodeParameters, it as AI_CODE_TOOL_LANGCHAIN_NODE_TYPE, jn as MODULE_ENABLED_NODES, js as displayParameter, ju as EnterpriseEditionFeature, k as ALLOWED_HTML_ATTRIBUTES, ks as getChildNodes, kt as AI_MCP_TOOL_NODE_TYPE, li as MAIN_HEADER_TABS, ll as v4, mc as nodeConnectionTypes, nl as MANUAL_TRIGGER_NODE_TYPE, pc as NodeConnectionTypes, pl as require_keys, ps as isTrimmedNodeExecutionData, q as AI_CATEGORY_HUMAN_IN_THE_LOOP, qo as require__createCompounder, r as DEFAULT_SETTINGS, rt as AI_CATEGORY_VECTOR_STORES, sl as WAIT_INDEFINITELY, ss as splitExpression, uc as isResourceLocatorValue, ui as VIEWS, ut as BETA_NODES, vc as deepCopy, vr as WIKIPEDIA_TOOL_NODE_TYPE, xr as WORKFLOW_TRIGGER_NODE_TYPE, xs as createEmptyRunExecutionData, yt as RECOMMENDED_NODES, z as MAPPING_PARAMS } from "./constants-BiYlbN9Z.js";
...
import { E as getActivePinia, T as defineStore, a as ResponseError, c as makeRestApiRequest, d as request, f as streamRequest, m as axios, s as getFullApiResponse, t as useRootStore } from "./useRootStore-DbgDMM5M.js";
import { C as updateCurrentUserSettings, Pt as getProjectSecretProviderConnectionsByProjectId, Rn as STORES, ct as fetchCommunityNodeTypes, dt as getNodeParameterOptions, ft as getNodeTranslationHeaders, gt as getResourceMapperFields, ht as getResourceLocatorResults, i as getWorkflowVersion, lt as getLocalResourceMapperFields, mt as getNodesInformation, pt as getNodeTypes$1, s as findWebhook, st as fetchCommunityNodeAttributes, t as useSettingsStore, ut as getNodeParameterActionResult } from "./settings.store-DROe9gro.js";
import { Y as watchThrottled, _ as useLocalStorage, k as createEventHook } from "./core-BemUAWor.js";
import { _ as useStorage, f as useUIStore, n as hasPermission, t as useUsersStore, u as hasRole } from "./users.store-CUZkGc51.js";
import { r as require_toNumber } from "./useDebounce-CoPo6zc6.js";
import { C as omit, O as getObjectSizeInKB, T as stringSizeInBytes, a as getNewWorkflow, b as isJsonKeyObject, i as getLastSuccessfulExecution, k as isObject$1, l as getWorkflows, n as useFavoritesStore, r as getExecutionData, t as useWorkflowsListStore, v as isEmpty, w as shorten, x as isPresent } from "./workflowsList.store-CHLmHbKZ.js";
import { t as require__baseOrderBy } from "./_baseOrderBy-B0YMGGOQ.js";
...
//#endregion
export { shouldShowCommunityNodeDetails as $, updateNodeAuthType as $n, wheelDelta as $r, injectNDVStore as $t, serializeNode as A, CANVAS_NODE_GROUP_TYPE as Ai, fieldCannotBeDeleted as An, getNewNodePosition as Ar, escapeMappingString as At, finalizeItems as B, getScrollbarWidth as Bi, getNodeCredentialForSelectedAuthType as Bn, _sfc_main$1 as Br, shouldConvertToExpression as Bt, TOOL_NODE_TYPES_NEED_INPUT as C, isValidNodeConnectionType as Ci, insertDataTableRowApi as Cn, calculateNodeSize as Cr, getAiSessions as Ct, getNodeTypeDisplayableCredentials as D, CANVAS_NODE_GROUP_HANDLE_LEFT as Di, updateDataTableRowsApi as Dn, getGenericHints as Dr, useAIAssistantHelpers as Dt, doesNodeHaveCredentialsToFill as E, isWorkflowListItem as Ei, updateDataTableApi as En, getBounds as Er, truncateBuilderMessages as Et, createEvaluationConfig as F, isCanvasGroupNode as Fi, getAppNameFromNodeName as Fn, MarkerType as Fr, getExpressionErrorMessage as Ft, groupItemsInSections as G, hasOnlyListMode as Gn, getBezierPath as Gr, useWorkflowHelpers as Gt, getAiTemplatesCallout as H, isOutsideSelected as Hi, getThemedValue as Hn, _sfc_main$d as Hr, unwrapExpression as Ht, deleteEvaluationConfig as I, parseCanvasGroupNodeId as Ii, getAuthTypeForNodeCredential as In, NodeId as Ir, getResolvableState as It, mapToolSubcategoryIcon as J, isMatchingField as Jn, getRectOfNodes as Jr, ensureNodePosition as Jt, isAINode as K, hasProxyAuth as Kn, getBoundsofRects as Kr, useAnnotationTagsStore as Kt, listEvaluationConfigs as L, structuralComputed as Li, getMainAuthField as Ln, PanelPosition as Lr, isPairedItemIntermediateNodesError as Lt, useNodeTypesStore as M, CanvasNodeDirtiness as Mi, getActivatableTriggerNodes as Mn, getNodesGroupSize as Mr, getMappedResult as Mt, useActionsGenerator as N, CanvasNodeRenderType as Ni, getAllNodeCredentialForAuthType as Nn, getNodesWithNormalizedPosition as Nr, propertyNameFromExpression as Nt, getParameterDisplayableOptions as O, CANVAS_NODE_GROUP_HANDLE_RIGHT as Oi, uploadCsvFileApi as On, getMidCanvasPosition as Or, useDataSchema as Ot, useEvaluationStore as P, createCanvasGroupNodeId as Pi, getAppNameFromCredType as Pn, updateViewportToContainNodes as Pr, completeExpressionSyntax as Pt, searchNodes as Q, parseResourceMapperFieldName as Qn, useVueFlow as Qr, disposeNDVStore as Qt, updateEvaluationConfig as R, capitalizeFirstLetter as Ri, getNodeAuthFields as Rn, Position as Rr, isTestableExpression as Rt, useWorkflowDocumentStore as S, isValidCredentialResponse as Si, importCsvToDataTableApi as Sn, PUSH_NODES_OFFSET as Sr, generateCodeForPrompt as St, doesNodeHaveAllCredentialsFilled as T, isVueFlowConnection as Ti, renameDataTableColumnApi as Tn, generateOffsets as Tr, replaceCode as Tt, getHumanInTheLoopActions as U, sanitizeHtml as Ui, getTriggerNodeServiceName as Un, _sfc_main$f as Ur, resolveParameter as Ut, flattenCreateElements as V, isEventTargetContainedBy as Vi, getNodeSubtitle as Vn, _sfc_main$3 as Vr, stringifyExpressionResult as Vt, getRootSearchCallouts as W, sanitizeIfString as Wi, hasExpressionMapping as Wn, clamp as Wr, resolveRequiredParameters as Wt, prepareCommunityNodeDetailsViewStack as X, isResourceMapperFieldListStale as Xn, isMacOs as Xr, sanitizeConnections as Xt, nodeTypesToCreateElements as Y, isRequiredCredential as Yn, getSmoothStepPath as Yr, removeWorkflowExecutionData as Yt, removePreviewToken as Z, isValueExpression as Zn, useGetPointerPosition as Zr, sortNodesByExecutionOrder as Zt, injectWorkflowExecutionStateStore as _, isResourceSortableByDate as _i, deleteDataTableRowsApi as _n, injectStrict as _r, listenForCredentialChanges as _t, executionFilterToQueryFilter as a, getPairedItemId as ai, splitName as an, createCanvasConnectionHandleString as ar, getSampleWorkflowByTemplateId as at, disposeWorkflowDocumentStore as b, isString as bi, fetchDataTablesApi as bn, DEFAULT_NODE_SIZE as br, chatWithBuilder as bt, getDefaultExecutionFilters as c, isBinaryLike as ci, useProjectsStore as cn, getMaxNodePortsLabelSize as cr, isFullTemplatesCollection as ct, hasTrimmedRunData as d, isCredentialsResource as di, moveFolderToProject as dn, mapCanvasConnectionToLegacyConnection as dr, require_sortBy as dt, getPinDataSize as ei, useNDVStore as en, getAllCredentials as er, sortNodeCreateElements as et, openFormPopupWindow as f, isDateObject as fi, setWorkflowSharedWith as fn, mapLegacyConnectionToCanvasConnection as fr, capitalCase as ft, disposeWorkflowExecutionStateStore as g, isResourceMapperValue as gi, deleteDataTableColumnApi as gn, shouldIgnoreCanvasShortcut as gr, require__baseSlice as gt, parse as h, isProjectRole as hi, deleteDataTableApi as hn, resolveCanonicalConnection as hr, require_upperFirst as ht, displayForm as i, CHANGE_ACTION as ii, getTruncatedProjectName as in, computeNodeDisplaySize as ir, getRagStarterWorkflowJson as it, require_uniq as j, CanvasConnectionMode as ji, filterTemplateNodes as jn, getNodeViewTab as jr, getMappedExpression as jt, needsAgentInput as k, CANVAS_NODE_GROUP_ID_PREFIX as ki, executionDataToJson as kn, getMousePosition as kr, useFlattenSchema as kt, getExecutionErrorMessage as l, isComponentPublicInstance as li, useSourceControlStore as ln, injectCanvasRenderData as lr, isTemplatesWorkflow as lt, waitingNodeTooltip as m, isFullExecutionResponse as mi, createDataTableApi as mn, parseCanvasConnectionHandleString as mr, require_startCase as mt, buildExecutionResponseFromSchema as n, createExecutionDataId as ni, useEnvironmentsStore as nn, isCredentialOnlyNodeType as nr, transformNodeType as nt, executionRetryMessage as o, checkExhaustive as oi, useAvailableProjectSearch as on, createCanvasConnectionId as or, getTutorialTemplates as ot, unflattenExecutionData as p, isDebouncedFunction as pi, addDataTableColumnApi as pn, mapLegacyConnectionsToCanvasConnections as pr, sublimeSearch as pt, isNodePreviewKey as q, isAuthRelatedParameter as qn, getConnectedEdges as qr, useTagsStore as qt, clearPopupWindowState as r, useExecutionDataStore as ri, ResourceType as rn, checkOverlap as rr, SampleTemplates as rt, findTriggerNodeToAutoSelect as s, isBaseTextKey as si, useRemoteProjectSearch as sn, createEmptyCanvasRenderData as sr, isTutorialTemplateId as st, useWorkflowsStore as t, pinDataToExecutionData as ti, LOCAL_STORAGE_NDV_PANEL_WIDTH as tn, require_toInteger as tr, subcategorizeItems as tt, getExecutionErrorToastConfiguration as u, isCredentialModalState as ui, ProjectTypes as un, insertSpacersBetweenEndpoints as ur, useAiGatewayStore as ut, useWorkflowExecutionStateStore as v, isRouteLocationRaw as vi, downloadDataTableCsvApi as vn, CONFIGURABLE_NODE_SIZE as vr, useCredentialsStore as vt, assignNodeId as w, isVariableResource as wi, moveDataTableColumnApi as wn, doRectsOverlap as wr, getBuilderCredits as wt, injectWorkflowDocumentStore as x, isTriggerPanelObject as xi, getDataTableRowsApi as xn, DEFAULT_VIEWPORT_BOUNDARIES as xr, clearBuilderSession as xt, createWorkflowDocumentId as y, isSharedResource as yi, fetchDataTableGlobalLimitInBytes as yn, CONFIGURATION_NODE_SIZE as yr, chatWithAssistant as yt, filterAndSearchNodes as z, getBannerRowHeight as zi, getNodeAuthOptions as zn, _sfc_main as zr, removeExpressionPrefix as zt };
