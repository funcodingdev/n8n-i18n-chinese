...
import { Ct as N8nSelect_default, Da as N8nText_default, Ei as N8nBadge_default, Oa as N8nButton_default, Tt as N8nOption_default, U as N8nNotice_default, Ui as Input_default, X as ActionPill_default, _t as N8nInputLabel_default, ct as N8nLink_default, ka as N8nIcon_default, zi as N8nTooltip_default } from "./src-DFOx8N22.js";
import { t as _plugin_vue_export_helper_default } from "./_plugin-vue_export-helper-Da88TEg1.js";
import { A as useDynamicCredentials, Gn as getAppNameFromCredType, Jn as getMainAuthField, Wn as getAllNodeCredentialForAuthType, Zn as getNodeCredentialForSelectedAuthType, ar as isRequiredCredential, b as injectWorkflowDocumentStore, k as useNodeHelpers, kt as useCredentialsStore, lr as updateNodeAuthType, nr as hasProxyAuth, q as useNodeTypesStore, qn as getAuthTypeForNodeCredential, t as useWorkflowsStore, un as injectNDVStore, yn as useProjectsStore } from "./workflows.store-Cc2IYz8o.js";
import { t as useToast } from "./useToast-Bp2-vBnv.js";
import { _n as KEEP_AUTH_IN_NDV_FOR_NODES, cl as getResourcePermissions, fi as AI_GATEWAY_TOP_UP_MODAL_KEY } from "./constants-BMUE7W6Y.js";
...
import { t as useCredentialOAuth } from "./useCredentialOAuth-BdXEn8Mu.js";
import { t as useQuickConnect } from "./useQuickConnect-NRTkKRQF.js";
import { t as CredentialIcon_default } from "./CredentialIcon-CT_lRNPD.js";
import { t as useAiGateway } from "./useAiGateway-29keVruQ.js";
			...
			return unref(credentialTypesNodeDescriptionDisplayed).length ? (openBlock(), createElementBlock("div", {
				...
				return openBlock(), createElementBlock("div", { key: type.name }, [createVNode(unref(N8nInputLabel_default), {
					...
					default: withCtx(() => [
						...
						getSelectedPrivateCredential(type.name) ? (openBlock(), createElementBlock("div", {
							key: 5,
							class: normalizeClass(_ctx.$style.noticesContainer)
						}, [getSelectedPrivateCredential(type.name) ? (openBlock(), createBlock(unref(N8nNotice_default), {
							key: 0,
							theme: isPrivateConnected(type.name) ? "info" : "warning",
							"data-test-id": "node-credential-private-callout"
						}, {
							default: withCtx(() => [createBaseVNode("div", { class: normalizeClass(_ctx.$style.privateNoticeContent) }, [createVNode(unref(N8nIcon_default), {
								icon: "user",
								size: "small",
								class: normalizeClass(_ctx.$style.privateNoticeIcon)
							}, null, 8, ["class"]), createBaseVNode("div", null, [createBaseVNode("span", null, toDisplayString(unref(i18n).baseText("credentials.private.callout.title")), 1), createBaseVNode("div", { class: normalizeClass(_ctx.$style.privateStatusRow) }, [isPrivateConnected(type.name) ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [createVNode(unref(N8nIcon_default), {
								icon: "circle-check",
								color: "success",
								size: "small"
								...
								size: "small",
								class: normalizeClass(_ctx.$style.privateNotConnectedText)
							}, {
								default: withCtx(() => [createTextVNode(toDisplayString(unref(i18n).baseText("credentials.private.callout.notConnected")), 1)]),
								_: 1
							}, 8, ["class"]), canConnectPrivateCredential(type.name) ? (openBlock(), createBlock(unref(N8nLink_default), {
								key: 0,
								"data-test-id": "node-credential-private-connect",
								onClick: ($event) => editCredential(type.name)
							}, {
								default: withCtx(() => [createTextVNode(toDisplayString(unref(i18n).baseText("credentials.private.callout.connect")), 1)]),
								_: 1
							}, 8, ["onClick"])) : createCommentVNode("", true)], 64))], 2)])], 2)]),
							_: 2
						}, 1032, ["theme"])) : createCommentVNode("", true)], 2)) : createCommentVNode("", true)
					]),
					_: 2
...
var NodeCredentials_vue_vue_type_style_index_0_lang_module_default = {
	container: "_container_urlis_125",
	selectPopper: "_selectPopper_urlis_132",
	newCredential: "_newCredential_urlis_135",
	warning: "_warning_urlis_144",
	edit: "_edit_urlis_150",
	input: "_input_urlis_162",
	selectContainer: "_selectContainer_urlis_167",
	hasIssues: "_hasIssues_urlis_172 _input_urlis_162",
	credentialOption: "_credentialOption_urlis_177",
	credentialOptionName: "_credentialOptionName_urlis_182",
	dynamicIcon: "_dynamicIcon_urlis_188",
	selectWithDynamic: "_selectWithDynamic_urlis_192",
	dynamicIndicator: "_dynamicIndicator_urlis_196",
	dynamicBadgeText: "_dynamicBadgeText_urlis_204",
	noticesContainer: "_noticesContainer_urlis_212",
	privateStatusRow: "_privateStatusRow_urlis_223",
	privateNotConnectedText: "_privateNotConnectedText_urlis_230",
	privateNoticeContent: "_privateNoticeContent_urlis_234",
	privateNoticeIcon: "_privateNoticeIcon_urlis_239",
	quickConnectContainer: "_quickConnectContainer_urlis_269",
	setupManuallyContainer: "_setupManuallyContainer_urlis_278",
	setupManuallyOr: "_setupManuallyOr_urlis_284",
	setupManuallyLink: "_setupManuallyLink_urlis_288",
	standardEmptyContainer: "_standardEmptyContainer_urlis_295",
	emptySelect: "_emptySelect_urlis_302"
};
