;
(function () {
  System.register(["./_MapCache-legacy-gleHKmVW.js", "./useMessage-legacy-huUrlPKL.js", "./useTelemetry-legacy-DnSAoKz5.js", "./useToast-legacy-Ce_kWqRg.js", "./constants-legacy-BWxkEIkt.js", "./useExternalHooks-legacy-CISqywdp.js", "./npsSurvey.store-legacy-BJ_guQdF.js", "./templates.store-legacy-VhWNRCtn.js", "./focusPanel.store-legacy-dsuRvUzL.js"], function (_export, _context) {
    "use strict";

    var useI18n, useMessage, useSourceControlStore, useUIStore, useCanvasStore, injectWorkflowState, tryToParseNumber, useNodeTypesStore, useWorkflowHelpers, useWorkflowsStore, useTelemetry, useNodeHelpers, useToast, NON_ACTIVATABLE_TRIGGER_NODE_TYPES, VIEWS, calculateWorkflowChecksum, IS_DRAFT_PUBLISH_ENABLED, PLACEHOLDER_EMPTY_WORKFLOW_ID, getResourcePermissions, MODAL_CLOSE, MODAL_CONFIRM, MODAL_CANCEL, useExternalHooks, useNpsSurveyStore, useTemplatesStore, useFocusPanelStore;
    ...
    return {
      setters: [function (_MapCacheLegacy005Js) {
        ...
        NON_ACTIVATABLE_TRIGGER_NODE_TYPES = _constantsLegacy00TJs.Ln;
        ...
        MODAL_CLOSE = _constantsLegacy00TJs.ns;
        MODAL_CONFIRM = _constantsLegacy00TJs.rs;
        MODAL_CANCEL = _constantsLegacy00TJs.ts;
