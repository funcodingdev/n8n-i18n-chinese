;
(function () {
  System.register(["./chunk-legacy-Re9CbdfL.js", "./vue.runtime.esm-bundler-legacy--Sn1h8On.js", "./_MapCache-legacy-BlV_W1LO.js", "./truncate-legacy-DWqu3mV5.js", "./useTelemetry-legacy-Dj2fHQys.js", "./useToast-legacy-B2w_7aSU.js", "./constants-legacy-wGNoFUi7.js", "./_baseOrderBy-legacy-DE6my_G3.js", "./useExternalHooks-legacy-D4ODACUq.js", "./templates.store-legacy-j1BQabOd.js", "./focusPanel.store-legacy-DqvPvBte.js", "./executions.store-legacy-B_20xRRf.js", "./usePinnedData-legacy-BLLY2IY8.js", "./nodeCreator.store-legacy-Lgt5iTBG.js", "./useClipboard-legacy-DkBJZ6it.js", "./folders.store-legacy-DhCwnoHA.js"], function (_export, _context) {
    "use strict";

    var __toESM, __commonJS, computed, nextTick, ref, shallowRef, useI18n, useLocalStorage, useRouter, createEventBus, useRoute, AddNodeCommand, useProjectsStore, AddConnectionCommand, useUIStore, ReplaceNodeParametersCommand, useCanvasStore, useSettingsStore, useCredentialsStore, RemoveConnectionCommand, RemoveNodeCommand, RenameNodeCommand, v4_default, getNodesGroupSize, injectWorkflowState, CanvasConnectionMode, tryToParseNumber, useHistoryStore, useDataSchema, useTagsStore, useNDVStore, useNodeTypesStore, getNewNodePosition, isPresent, DEFAULT_VIEWPORT_BOUNDARIES, GRID_SIZE, generateOffsets, usePostHog, MoveNodeCommand, CONFIGURATION_NODE_SIZE, useWorkflowHelpers, useWorkflowsStore, PUSH_NODES_OFFSET, isChatNode, CONFIGURABLE_NODE_SIZE, useTelemetry, getExecutionErrorToastConfiguration, DEFAULT_NODE_SIZE, isValidNodeConnectionType, CanvasNodeRenderType, useNodeHelpers, useToast, getNodeInputs, require__baseUniq, LOCAL_STORAGE_LOGS_PANEL_OPEN, isCommunityPackageName, LOCAL_STORAGE_LOGS_PANEL_DETAILS_PANEL_SUB_NODE, MCP_TRIGGER_NODE_TYPE, LOCAL_STORAGE_LOGS_SYNC_SELECTION, VIEWS, getConnectionTypes, CANVAS_ZOOMED_VIEW_EXPERIMENT, deepCopy, LOCAL_STORAGE_LOGS_PANEL_DETAILS_PANEL, NodeConnectionTypes, generateNodesGraph, FORM_TRIGGER_NODE_TYPE, getNodeOutputs, EnterpriseEditionFeature, UPDATE_WEBHOOK_ID_NODE_TYPES, NDV_IN_FOCUS_PANEL_EXPERIMENT, getSubworkflowId, getNodeParameters, STICKY_NODE_TYPE, WEBHOOK_NODE_TYPE, require_cloneDeep, defineStore, useRootStore, useExternalHooks, useTemplatesStore, useFocusPanelStore, useExecutionsStore, usePinnedData, mapCanvasConnectionToLegacyConnection, parseCanvasConnectionHandleString, mapLegacyConnectionToCanvasConnection, createCanvasConnectionHandleString, mapLegacyConnectionsToCanvasConnections, useNodeCreatorStore, useClipboard, useFoldersStore, chatEventBus, LOCAL_STORAGE_PANEL_HEIGHT, LOCAL_STORAGE_PANEL_WIDTH, LOCAL_STORAGE_OVERVIEW_PANEL_WIDTH, LOGS_PANEL_STATE, LOG_DETAILS_PANEL_STATE, useLogsStore, require_uniq, useExperimentalNdvStore, canvasEventBus, import_cloneDeep, import_uniq;
    ...
    return {
      setters: [function (_chunkLegacy001Js) {
        ...
        require__baseUniq = _constantsLegacy00TJs.Ai;
        LOCAL_STORAGE_LOGS_PANEL_OPEN = _constantsLegacy00TJs.Ds;
        isCommunityPackageName = _constantsLegacy00TJs.Ea;
        LOCAL_STORAGE_LOGS_PANEL_DETAILS_PANEL_SUB_NODE = _constantsLegacy00TJs.Es;
        MCP_TRIGGER_NODE_TYPE = _constantsLegacy00TJs.On;
        LOCAL_STORAGE_LOGS_SYNC_SELECTION = _constantsLegacy00TJs.Os;
        VIEWS = _constantsLegacy00TJs.Po;
        getConnectionTypes = _constantsLegacy00TJs.Qi;
        CANVAS_ZOOMED_VIEW_EXPERIMENT = _constantsLegacy00TJs.Qs;
        deepCopy = _constantsLegacy00TJs.Ta;
        LOCAL_STORAGE_LOGS_PANEL_DETAILS_PANEL = _constantsLegacy00TJs.Ts;
        NodeConnectionTypes = _constantsLegacy00TJs.Wa;
        generateNodesGraph = _constantsLegacy00TJs.Yi;
        ...
        UPDATE_WEBHOOK_ID_NODE_TYPES = _constantsLegacy00TJs.gr;
        NDV_IN_FOCUS_PANEL_EXPERIMENT = _constantsLegacy00TJs.nc;
        getSubworkflowId = _constantsLegacy00TJs.oa;
        getNodeParameters = _constantsLegacy00TJs.ta;
        STICKY_NODE_TYPE = _constantsLegacy00TJs.ur;
        WEBHOOK_NODE_TYPE = _constantsLegacy00TJs.vr;
        require_cloneDeep = _constantsLegacy00TJs.xi;
