...
import { O as useVirtualList, X as useThrottleFn } from "./core-CxAuVuwP.js";
import { t as useToast } from "./useToast-CknWykz4.js";
import { Kd as LOGS_EXECUTION_DATA_THROTTLE_DURATION, gs as Workflow, od as CANVAS_NODES_GROUPING_EXPERIMENT } from "./constants-BaNoJas_.js";
import { Kt as injectWorkflowExecutionStateStore, _ as useNodeTypesStore, a as injectWorkflowDocumentStore, cn as useWorkflowsStore } from "./workflowDocument.store-w7RlTwH2.js";
import { g as usePostHog } from "./users.store-CHh4wCL_.js";
import { t as useNodeHelpers } from "./useNodeHelpers-DcbNnWGn.js";
import { c as isChatNode } from "./useCanvasOperations-D3dvY0Rs.js";
...
import { a as copyExecutionData, d as flattenLogEntries, o as createLogTree, p as getDefaultCollapsedEntries, t as LogsOverviewRow_default, u as findSubExecutionLocator, v as hasSubExecution, w as isNodeLog, x as mergeStartData } from "./LogsOverviewRow-XBWP4X7G.js";
...
function useLogsExecutionData({ isEnabled, filter } = {}) {
	...
	const isGroupingEnabled = computed(() => posthogStore.isFeatureEnabled(CANVAS_NODES_GROUPING_EXPERIMENT.name));
	const state = ref();
	...
	const entries = computed(() => {
		...
		const nodeGroups = isGroupingEnabled.value ? mergedExecutionData.workflowData.nodeGroups ?? [] : [];
	...
	async function loadSubExecution(logEntry) {
		...
		try {
			...
			if (isGroupingEnabled.value) subWorkflowNodeGroups.value[locator.workflowId] = subExecution.workflowData.nodeGroups ?? [];
		} catch (e) {
