      ...
      execute: function () {
        ...
        NodeCreation_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */defineComponent({
          ...
          setup(__props, {
            ...
            const LazyNodeCreator = defineAsyncComponent(async () => await __vitePreload(() => _context.import("./NodeCreator-legacy-C8IXOLY1.js"), true               ? void 0 : void 0));
            const props = __props;
            const emit = __emit;
