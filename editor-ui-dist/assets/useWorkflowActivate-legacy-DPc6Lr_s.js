;
(function () {
  System.register(["./vue.runtime.esm-bundler-legacy--Sn1h8On.js", "./_MapCache-legacy-BH2XE3uj.js", "./truncate-legacy-D4G74xLD.js", "./useTelemetry-legacy-CMfwYwVY.js", "./useToast-legacy-DHnOnoVM.js", "./constants-legacy-8iZaMHMx.js", "./_baseOrderBy-legacy-Bls-fMH1.js", "./useExternalHooks-legacy-CDDHCmE_.js", "./npsSurvey.store-legacy-BiIILrEG.js", "./useWorkflowSaving-legacy-DzdfQKOS.js"], function (_export, _context) {
    "use strict";

    var ref, useI18n, useRouter, useUIStore, activateWorkflow, deactivateWorkflow, useStorage, useWorkflowHelpers, useWorkflowsStore, useTelemetry, useToast, LOCAL_STORAGE_ACTIVATION_FLAG, calculateWorkflowChecksum, PLACEHOLDER_EMPTY_WORKFLOW_ID, WORKFLOW_ACTIVE_MODAL_KEY, useRootStore, useExternalHooks, useNpsSurveyStore, useWorkflowSaving;
    ...
    function useWorkflowActivate() {
      ...
      const updateWorkflowActivation = async (workflowId, newActiveState, telemetrySource) => {
        ...
        try {
          ...
          if (isCurrentWorkflow) workflowsStore.setWorkflowChecksum(await calculateWorkflowChecksum(workflow));
        } catch (error) {
      ...
      const unpublishWorkflowFromHistory = async workflowId => {
        ...
        try {
          ...
          if (workflowId === workflowsStore.workflowId) workflowsStore.setWorkflowChecksum(await calculateWorkflowChecksum(updatedWorkflow));
    ...
    return {
      setters: [function (_vueRuntimeEsmBundlerLegacy003Js) {
        ...
        LOCAL_STORAGE_ACTIVATION_FLAG = _constantsLegacy00TJs.Ss;
        calculateWorkflowChecksum = _constantsLegacy00TJs._i;
