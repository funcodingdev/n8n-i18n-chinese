const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/es-Ba_ZjsNi.js","assets/chunk-CC9Q-vWm.js","assets/core-DOxLp62L.js","assets/languageModules-Ly8NnZCx.js","assets/xml-QaDfRe_h.js","assets/typescript-DF58u-hL.js"])))=>i.map(i=>d[i]);
...
import { ca as truncateBeforeLast, fo as N8nButton_default } from "./src-DmjM-ErL.js";
import { d as __vitePreload } from "./get-BeCUYAIG.js";
import { t as _plugin_vue_export_helper_default } from "./_plugin-vue_export-helper-Da88TEg1.js";
import { t as VueMarkdown } from "./VueMarkdown-DkG6BUC-.js";
//#region ../../../node_modules/.pnpm/katex@0.16.27/node_modules/katex/dist/katex.js
		...
		return (function() {
			...
			*/
			const toMarkup = function(tagName) {
				...
				let styles = "";
				for (const style in this.style) if (this.style.hasOwnProperty(style)) styles += utils.hyphenate(style) + ":" + this.style[style] + ";";
			...
			defineFunction({
				...
				htmlBuilder: (group, options) => {
					...
					if (hadMiddle) for (let i = 1; i < inner.length; i++) {
						...
						if (isMiddle) inner[i] = delimiter.leftRightDelim(isMiddle.delim, innerHeight, innerDepth, isMiddle.options, group.mode, []);
					}
					let rightDelim;
			...
			*/
			...
			defineFunction({
				...
				htmlBuilder: (group, options) => {
					...
					} else inner = buildCommon.makeSpan(["inner"], [buildGroup(group.body, options)]);
			...
			defineFunctionBuilders({
				...
				htmlBuilder(group, options) {
					...
					if (valueSub) {
						...
						if (!isCharacterBox) subShift = base.depth + newOptions.fontMetrics().subDrop * newOptions.sizeMultiplier / options.sizeMultiplier;
					}
					let minSupShift;
	...
	async function loadLanguageModules() {
		...
		try {
			const promise = Promise.all([__vitePreload(async () => {
				const { default: highlight } = await import("./es-Ba_ZjsNi.js");
				return { default: highlight };
			}, __vite__mapDeps([0,1,2])).then(({ default: highlight }) => highlight), __vitePreload(() => import("./languageModules-Ly8NnZCx.js"), __vite__mapDeps([3,4,5]))]);
			asyncImport = {
				status: "inProgress",
				promise
			};
...
var ChatMarkdownChunk_vue_vue_type_style_index_1_lang_module_default = {
	container: "_container_1ry94_125",
