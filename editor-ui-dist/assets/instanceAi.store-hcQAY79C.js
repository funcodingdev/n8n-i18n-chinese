...
import { $i as v4, C as toAgentTree, Ea as INSTANCE_AI_EPHEMERAL_EVENT_TYPES, Fa as buildUpdateWorkflowSessionGrantKey, Ha as isSafeObjectKey, Na as buildDataTablesSessionGrantKey, Pa as buildRunWorkflowSessionGrantKey, S as stateFromAgentTree, Va as instanceAiEventSchema, b as findAgent, ka as INSTANCE_AI_THREAD_SOURCE_FALLBACK, x as reduceEvent, y as createInitialState } from "./src-JwBmTNgK.js";
import { Qn as makeRestApiRequest, Yn as ResponseError, fr as defineStore, t as useRootStore } from "./useRootStore-BxA0rNgc.js";
...
import { S as isInstanceAiThreadSource, a as INSTANCE_AI_AGENT_BUILDER_TARGET_METADATA_KEY, f as INSTANCE_AI_PENDING_AGENT_METADATA_KEY, o as INSTANCE_AI_AGENT_PREVIEW_SESSION_METADATA_KEY, s as INSTANCE_AI_AGENT_PREVIEW_VIEW_METADATA_KEY } from "./constants-BLqhkQAv.js";
import { a as postCancel, c as postFeedback, i as getInstanceAiCredits, l as postMessage, o as postCancelTask, r as ensureThread, s as postConfirmation, t as useInstanceAiSettingsStore } from "./instanceAiSettings.store-WArv7gGo.js";
...
function shouldRearmRunAfterConfirm(payload) {
	switch (payload.kind) {
		case "approval": return payload.approved === true;
