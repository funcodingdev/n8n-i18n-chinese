...
import { bt as I18nT, h as computedAsync, yt as useI18n } from "./_MapCache-BRSIFZ-8.js";
import { Di as useRouter, Gi as N8nButton_default, Ki as N8nIcon_default, Ui as N8nCallout_default, Wi as N8nText_default, ji as N8nTooltip_default, yi as N8nLink_default } from "./src-CKCAtrpy.js";
import { t as __plugin_vue_export_helper_default } from "./_plugin-vue_export-helper-DltO58Gh.js";
import { $t as useNodeHelpers, Dr as useExternalHooks, Nt as environments_store_default, Pr as require_FileSaver_min, Tr as useToast, Vi as executionDataToJson, dn as nodeViewEventBus, en as useTelemetry, in as injectWorkflowState, jr as useMessage, js as useSettingsStore, lt as useDataSchema, qr as injectWorkflowDocumentStore, r as useUIStore, rn as useNDVStore, s as useWorkflowsStore, st as generateCodeForPrompt, ut as useFlattenSchema, w as useNodeTypesStore, ya as isEmpty } from "./users.store-D86YL4LK.js";
import { As as MODAL_CONFIRM, C as SCHEMA_PREVIEW_DOCS_URL, Ci as require_pick, Cs as FROM_AI_PARAMETERS_MODAL_KEY, Fi as createResultError, Gt as CHAT_TRIGGER_NODE_TYPE, Mn as MANUAL_TRIGGER_NODE_TYPE, P as PLACEHOLDER_FILLED_AT_EXECUTION_TIME, bo as AI_TRANSFORM_JS_CODE, cl as EnterpriseEditionFeature, gn as FORM_TRIGGER_NODE_TYPE, mo as NodeConnectionTypes, po as DateTime, ps as BINARY_DATA_VIEW_MODAL_KEY, qo as ApplicationError, wr as WEBHOOK_NODE_TYPE, xo as AI_TRANSFORM_NODE_TYPE, yo as AI_TRANSFORM_CODE_GENERATED_FOR_PROMPT } from "./constants-bR1gDMyV.js";
import { r as useRootStore } from "./_baseOrderBy-Bnq6lF9G.js";
import { i as Ln, o as gu, r as estree_exports, t as NDVEmptyState_default } from "./NDVEmptyState-C1odqkYI.js";
...
import { t as TextWithHighlights_default } from "./TextWithHighlights-B0uoqVwg.js";
import { t as useCalloutHelpers } from "./useCalloutHelpers-B4VxyxdJ.js";
import { n as MappingPill_default, t as useTelemetryContext } from "./useTelemetryContext-DR2ErcyQ.js";
import { i as useSchemaPreviewStore, t as useRunWorkflow } from "./useRunWorkflow-sKQnjkCu.js";
import { o as needsAgentInput } from "./nodeTransforms-cxYNq6D5.js";
...
var NodeExecuteButton_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props, { emit: __emit }) {
		...
		const workflowsStore = useWorkflowsStore();
		const ndvStore = useNDVStore();
		const { isExecuting, isListening, isListeningForWorkflowEvents, buttonLabel: nodeButtonLabel, buttonIcon: nodeButtonIcon, disabledReason, isTriggerNode, hasIssues, shouldGenerateCode, execute } = useNodeExecution(computed(() => workflowsStore.getNodeByName(props$1.nodeName)), {
			telemetrySource: props$1.telemetrySource,
			executionMode: computed(() => props$1.executionMode),
		...
		const buttonLabel = computed(() => {
			...
			if (props$1.label && !isListening.value && !isListeningForWorkflowEvents.value) return props$1.label;
			return nodeButtonLabel.value;
		});
		const buttonIcon = computed(() => {
			if (props$1.icon) return props$1.icon;
			if (props$1.hideIcon) return void 0;
			return nodeButtonIcon.value;
		});
		const tooltipText = computed(() => {
			if (shouldGenerateCode.value) return i18n.baseText("ndv.execute.generateCodeAndTestNode.description");
			if (disabledHint.value) return disabledHint.value;
			if (props$1.tooltip && !isExecuting.value && testStepButtonPopupCount() < MAX_POPUP_COUNT) return props$1.tooltip;
			return "";
		});
