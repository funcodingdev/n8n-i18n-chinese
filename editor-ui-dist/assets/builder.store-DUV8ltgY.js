...
import { B as useDebounceFn, Z as useI18n, y as useLocalStorage } from "./dist-DOFK-fIm.js";
import { Mt as useRouter, d as useMessage, jt as useRoute, na as isToolMessage$1, ra as isWorkflowUpdatedMessage$1 } from "./src-DmQRaDBt.js";
import { u as require_lib } from "./get-Ult7GPGC.js";
import { t as useToast } from "./useToast-BvIdHb4k.js";
import { Di as isDebouncedFunction, En as useSourceControlStore, Ft as useWorkflowHelpers, It as useRouteWorkflowId, Lt as useWorkflowId, Xt as useWorkflowExecutionStateStore, _t as useAIAssistantHelpers, a as injectWorkflowDocumentStore, dt as clearBuilderSession, fn as useWorkflowsStore, gt as truncateBuilderMessages, mt as getBuilderCredits, pt as getAiSessions, qt as useNDVStore, r as createWorkflowDocumentId, s as useWorkflowDocumentStore, ut as chatWithBuilder, v as useNodeTypesStore } from "./workflowDocument.store-CJmrbFRO.js";
import { T as defineStore, h as assert, t as useRootStore } from "./useRootStore-H_HdEClX.js";
import { Vn as STORES, a as getWorkflowVersionsByIds, i as getWorkflowVersion, n as getPublishTimeline, o as updateWorkflowHistoryVersion, r as getWorkflowHistory, st as updateNpsSurveyState, t as useSettingsStore, tn as getFirstAdoptionDate } from "./settings.store-CQqpFn-s.js";
import { Bi as MODAL_CLOSE, Cd as dedupe, Dl as validateNodeSelectionForGrouping, Lc as SEVEN_DAYS_IN_MILLIS, Mc as DEBOUNCE_TIME, Rc as SIX_MONTHS_IN_MILLIS, Ui as NPS_SURVEY_MODAL_KEY, Vc as getDebounceTime, Vi as MODAL_CONFIRM, Ys as CODE_WORKFLOW_BUILDER_EXPERIMENT, _c as MERGE_ASK_BUILD_EXPERIMENT, fa as LOCAL_STORAGE_BROWSER_NOTIFICATION_METADATA, fs as getResourcePermissions, pi as VIEWS, sc as FOCUSED_NODES_EXPERIMENT, t as AutoSaveState, xd as isExpression, zc as THREE_DAYS_IN_MILLIS, zi as MODAL_CANCEL } from "./constants-BzyjfRY2.js";
import { f as useUIStore, g as usePostHog, p as useTelemetry } from "./users.store-CF55TUDI.js";
import { E as stringSizeInBytes, O as tryToParseNumber, a as getNewWorkflow, t as useWorkflowsListStore } from "./workflowsList.store-DY3toAy4.js";
...
import { a as BUILDER_ENABLED_VIEWS, r as useChatPanelStateStore, t as useCodeDiff } from "./useCodeDiff-S_Y0k1i5.js";
