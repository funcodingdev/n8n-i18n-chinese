...
import { r as require_get, v as useRoute } from "./truncate-BUZ2YJyY.js";
import { Dr as useUsersStore, Gn as useNodeHelpers, Jt as removePreviewToken, Kn as injectWorkflowState, M as useNDVStore, N as useWorkflowsStore, Nt as useNodeTypesStore, O as useTelemetry, Pt as useActionsGenerator, Qn as ProjectTypes, Rn as useWorkflowHelpers, Xn as useProjectsStore, Xr as useHistoryStore, ai as RenameNodeCommand, b as useExternalHooks, da as COMMUNITY_NODES_INSTALLATION_DOCS_URL, ea as importCurlEventBus, gn as useCredentialsStore, hs as useSettingsStore, ma as COMMUNITY_PACKAGE_INSTALL_MODAL_KEY, oa as useUIStore, v as useToast } from "./builder.store-C-r2iW9T.js";
import { D as TitledList_default, E as useNodeCredentialOptions, T as NodeCredentials_default, d as collectParametersByTab, f as collectSettings, h as getNodeSettingsInitialValues, p as createCommonNodeSettings, t as ParameterInputList_default, u as useNodeSettingsParameters, v as nameIsParameter } from "./ParameterInputList-CgEPM5tr.js";
import { n as ElRow, t as ElCol } from "./col-DKcld6rX.js";
import { $i as getNodeParameters, Dn as MCP_TRIGGER_NODE_TYPE, F as CUSTOM_API_CALL_KEY, Gn as PRODUCTION_ONLY_TRIGGER_NODE_TYPES, Hn as OPEN_URL_PANEL_TRIGGER_NODE_TYPES, Jt as DATA_TABLE_NODES, Ro as VIEWS, Ta as isCommunityPackageName, Ua as NodeConnectionTypes, Zi as getNodeInputs, b as NPM_PACKAGE_DOCS_BASE_URL, co as OPEN_AI_API_CREDENTIAL_TYPE, d as CUSTOM_NODES_DOCS_URL, l as BUILTIN_NODES_DOCS_URL, s as BASE_NODE_SURVEY_URL, un as FORM_TRIGGER_NODE_TYPE, wa as deepCopy, zt as CHAT_TRIGGER_NODE_TYPE } from "./constants-CekkLdpD.js";
import { t as useDebounce } from "./useDebounce-BX4EGfl2.js";
import { n as ndvEventBus } from "./assistant.store-CNU7Bx3i.js";
import { t as useNodeCreatorStore } from "./nodeCreator.store-DIuO9eHQ.js";
...
import { a as useInstallNode, i as useInstalledCommunityPackage, n as CommunityNodeFooter_default, r as ContactAdministratorToInstall_default, t as CommunityNodeUpdateInfo_default } from "./CommunityNodeUpdateInfo-CQD_aBEV.js";
