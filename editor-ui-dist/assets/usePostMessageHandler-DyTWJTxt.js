const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/pushConnection.store-BBWbvupz.js","assets/pushConnection.store-Bt16jELv.js","assets/src-B255AdRt.js","assets/chunk-CC9Q-vWm.js","assets/preload-helper-CMc80dNB.js","assets/lib-BC5w3MlX.js","assets/merge-I1kuvuLK.js","assets/isObject-CUkREaNL.js","assets/isSymbol-DAI9oII0.js","assets/expression-runtime-stub-DHA3RX1a.js","assets/__vite-browser-external-CTj19RIp.js","assets/vue.runtime.esm-bundler-DYHsQBZB.js","assets/useRootStore-CLEJA2KF.js","assets/lib-CcMDH-kD.js","assets/assert-BgZvUjbv.js","assets/settings.store-tphV58ve.js","assets/src-WRlVBeQs.js","assets/useDebounce-BffpVo23.js","assets/durations-xVQWCRRO.js"])))=>i.map(i=>d[i]);
...
import { Jr as getNodesWithNormalizedPosition, T as createWorkflowDocumentId, k as useWorkflowDocumentStore, n as buildExecutionResponseFromSchema, t as useWorkflowsStore, vn as useProjectsStore, wt as useCredentialsStore, y as useWorkflowExecutionStateStore } from "./workflows.store-JWtScvRR.js";
...
import { t as isPostMessageOriginAllowed } from "./postMessageUtils-WoXJEvvm.js";
		...
		try {
			...
			if (json && json.command === "openWorkflow") try {
				...
				const { usePushConnectionStore } = await __vitePreload(async () => {
					const { usePushConnectionStore } = await import("./pushConnection.store-BBWbvupz.js");
