...
import { at as useI18n$1, c as useClipboard, v as useLocalStorage } from "./core-Beh0t8_q.js";
import { Ai as require_markdown_it_link_attributes, lt as useRoute, ut as useRouter } from "./src-Dg8CDsvD.js";
import { t as _plugin_vue_export_helper_default } from "./_plugin-vue_export-helper-Da88TEg1.js";
import { $n as DEFAULT_VIEWPORT_BOUNDARIES, $t as createWorkflowDocumentId, An as isValidNodeConnectionType, Fr as pinDataToExecutionData, Gn as RemoveNodeCommand, In as CanvasNodeRenderType, Jt as useTelemetry, Kn as RenameNodeCommand, Kt as useProjectsStore, Ln as useHistoryStore, Mt as useWorkflowHelpers, Pn as CanvasConnectionMode, Pt as useTagsStore, Qn as DEFAULT_NODE_SIZE, Qt as useNDVStore, Rn as AddConnectionCommand, Un as MoveNodeCommand, Wn as RemoveConnectionCommand, Xn as CONFIGURABLE_NODE_SIZE, Yi as isPresent, Zn as CONFIGURATION_NODE_SIZE, Zt as usePostHog, at as useCredentialsStore, b as getExecutionErrorToastConfiguration, cr as getNewNodePosition, d as isChatNode, dn as useCanvasStore, ea as tryToParseNumber, er as PUSH_NODES_OFFSET, ht as useDataSchema, ln as serializeNode, nn as useWorkflowDocumentStore, nr as doRectsOverlap, qn as ReplaceNodeParametersCommand, r as useUIStore, rr as generateOffsets, s as useWorkflowsStore, un as useNodeHelpers, ur as getNodesGroupSize, w as useNodeTypesStore, z as removePreviewToken, zn as AddNodeCommand } from "./users.store-Zd_8U4jS.js";
import { t as useToast } from "./useToast-DG5hVw1V.js";
import { Co as getConnectionTypes, Cs as NodeConnectionTypes, Eo as getNodeParameters, Fo as isHitlToolType, Gi as LOCAL_STORAGE_LOGS_PANEL_DETAILS_PANEL_SUB_NODE, Ja as require_cloneDeep, Ki as LOCAL_STORAGE_LOGS_PANEL_OPEN, Rc as CANVAS_ZOOMED_VIEW_EXPERIMENT, To as getNodeOutputs, Uo as resolveNodeWebhookId, Wi as LOCAL_STORAGE_LOGS_PANEL_DETAILS_PANEL, Xc as NDV_IN_FOCUS_PANEL_EXPERIMENT, Ys as v4, al as EnterpriseEditionFeature, ar as STICKY_NODE_TYPE, bo as generateNodesGraph, dr as UPDATE_WEBHOOK_ID_NODE_TYPES, is as isCommunityPackageName, jo as getSubworkflowId, no as require__baseUniq, qi as LOCAL_STORAGE_LOGS_SYNC_SELECTION, rs as deepCopy, wo as getNodeInputs, zr as VIEWS } from "./constants-c-L9DE1I.js";
...
import { a as mapLegacyConnectionToCanvasConnection, c as parseCanvasConnectionHandleString, i as mapCanvasConnectionToLegacyConnection, n as createCanvasConnectionHandleString, o as mapLegacyConnectionsToCanvasConnections } from "./canvas.utils-jxUtpaL2.js";
...
import { a as bash, i as javascript, n as typescript, r as python, t as xml } from "./xml-BB2TKI4c.js";
import { t as VueMarkdown } from "./VueMarkdown-DFa3NmXI.js";
import { t as useSetupPanelStore } from "./setupPanel.store-YzDbYW6T.js";
import { t as clearAllNodeResourceLocatorValues } from "./templateTransforms-BDgR3Xzi.js";
...
function useUniqueNodeName() {
	...
	*/
	function uniqueNodeName(originalName, extraNames = []) {
		const { canvasNames } = useWorkflowDocumentStore(createWorkflowDocumentId(useWorkflowsStore().workflowId));
...
function useCanvasOperations() {
	...
	const editableWorkflowObject = computed(() => workflowDocumentStore.value ? workflowDocumentStore.value.getSnapshot() : void 0);
