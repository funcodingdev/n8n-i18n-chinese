...
import { Fi as isToolMessage$1, Ii as isWorkflowUpdatedMessage$1, gt as useRouter, ht as useRoute } from "./src-BY3LHeey.js";
import { t as useMessage } from "./useMessage-BPZAmALB.js";
import { Ft as chatWithBuilder, Ht as useAIAssistantHelpers, It as clearBuilderSession, M as useCanvasStore, Rt as getAiSessions, Vt as truncateBuilderMessages, b as injectWorkflowDocumentStore, hn as useNDVStore, k as useNodeHelpers, on as useWorkflowHelpers, t as useWorkflowsStore, v as createWorkflowDocumentId, wi as isDebouncedFunction, wn as useSourceControlStore, x as useWorkflowDocumentStore, zt as getBuilderCredits } from "./workflows.store-DZfkxcrn.js";
import { t as useToast } from "./useToast-ioerWMiY.js";
import { Cl as getResourcePermissions, Fi as MODAL_CONFIRM, Fu as SEVEN_DAYS_IN_MILLIS, Iu as SIX_MONTHS_IN_MILLIS, Li as NPS_SURVEY_MODAL_KEY, Lu as THREE_DAYS_IN_MILLIS, Ni as MODAL_CANCEL, Pi as MODAL_CLOSE, Yl as WorkflowIdKey, _u as MERGE_ASK_BUILD_EXPERIMENT, hc as dedupe, iu as CODE_WORKFLOW_BUILDER_EXPERIMENT, ju as DEBOUNCE_TIME, li as VIEWS, oa as LOCAL_STORAGE_BROWSER_NOTIFICATION_METADATA, pc as isExpression, pu as FOCUSED_NODES_EXPERIMENT, t as AutoSaveState, zu as getDebounceTime } from "./constants-CLQJMg7Y.js";
import { T as defineStore, h as assert, t as useRootStore } from "./useRootStore-BXKn7r8-.js";
import { Rn as STORES, a as getWorkflowVersionsByIds, en as getFirstAdoptionDate, i as getWorkflowVersion, n as getPublishTimeline, o as updateWorkflowHistoryVersion, ot as updateNpsSurveyState, r as getWorkflowHistory, t as useSettingsStore } from "./settings.store-HAN34Lkc.js";
import { G as useDebounceFn, _ as useLocalStorage } from "./core-CZJuH52F.js";
import { f as useUIStore, g as usePostHog, p as useTelemetry } from "./users.store-AINJEAwY.js";
import { D as tryToParseNumber, T as stringSizeInBytes, a as getNewWorkflow, t as useWorkflowsListStore } from "./workflowsList.store-e1f-4AUE.js";
...
import { a as BUILDER_ENABLED_VIEWS, r as useChatPanelStateStore, t as useCodeDiff } from "./useCodeDiff-DbUR4gGR.js";
import { n as findPlaceholderDetails, r as formatPlaceholderPath } from "./dist-BynafEp_.js";
