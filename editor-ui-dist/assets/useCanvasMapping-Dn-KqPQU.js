...
import { _ as onKeyDown, lt as watchOnce, st as useThrottleFn, ut as watchThrottled, y as onKeyUp, yt as useI18n } from "./_MapCache-pm4B1YcD.js";
import { Ci as useRoute, Dt as N8nActionDropdown_default, Hi as N8nButton_default, Mi as N8nIconButton_default, Oi as N8nTooltip_default, P as N8nSticky_default, Ui as N8nIcon_default, V as N8nPopover_default, Vi as N8nText_default, _t as createEventBus, gi as N8nLink_default, kt as useDeviceSupport, wi as useRouter } from "./src-B3wEFHds.js";
import { t as __plugin_vue_export_helper_default } from "./_plugin-vue_export-helper-DltO58Gh.js";
import { $n as getConnectedEdges, Ar as useFocusedNodesStore, Bn as updateViewportToContainNodes, Bt as useNDVStore, C as useNodeTypesStore, Cn as CONFIGURATION_NODE_RADIUS, Dn as GRID_SIZE, Fn as getMousePosition, Gn as _sfc_main$5, Hn as NodeId, It as useNodeHelpers, Jn as _sfc_main$d, Kn as _sfc_main$1, Pt as environments_store_default, Qn as getBoundsofRects, Tn as DEFAULT_NODE_SIZE, Un as PanelPosition, Vi as getTriggerNodeServiceName, Vn as MarkerType, Vt as injectWorkflowState, Wn as Position, Xc as sanitizeHtml, Xn as clamp, Yc as isOutsideSelected, Yn as _sfc_main$f, Zn as getBezierPath, ai as isValidNodeConnectionType, ar as wheelDelta, br as useStyles, ca as isPresent, cr as trackTemplatesClick, di as CanvasNodeRenderType, er as getRectOfNodes, ga as nodeViewEventBus, ir as useVueFlow, jr as useChatPanelStateStore, kn as calculateNodeSize, li as CanvasConnectionMode, nr as isMacOs, or as TemplateClickSource, qn as _sfc_main$3, r as useUIStore, rr as useGetPointerPosition, rt as useCredentialsStore, s as useWorkflowsStore, sr as isExtraTemplateLinksExperimentEnabled, tr as getSmoothStepPath, ui as CanvasNodeDirtiness, wr as useSourceControlStore, ws as useSettingsStore, xn as useTemplatesStore } from "./users.store-Cfyj76Cq.js";
import { j as TitledList_default } from "./ParameterInputList-C24rEYmf.js";
import { Ao as SEND_AND_WAIT_OPERATION, Ca as isNodeWithWorkflowSelector, Gt as CHAT_TRIGGER_NODE_TYPE, I as CUSTOM_API_CALL_KEY, Mo as WAIT_INDEFINITELY, No as WEBHOOK_NODE_TYPE, Nt as AGENT_NODE_TYPE, Po as require_isEqual, Pt as AGENT_TOOL_NODE_TYPE, Sa as isHitlToolType, Sr as WAIT_NODE_TYPE, Tt as NODE_CREATOR_OPEN_SOURCES, Un as NOT_DUPLICATABLE_NODE_TYPES, Wa as isCommunityPackageName, Xc as CANVAS_EXECUTION_DATA_THROTTLE_DURATION, Zn as PRODUCTION_ONLY_TRIGGER_NODE_TYPES, _c as CanvasKey, co as NodeConnectionTypes, da as getNodeInputs, fa as getNodeOutputs, hn as FORM_NODE_TYPE, hr as STICKY_NODE_TYPE, ia as mapConnectionsByDestination, lr as SIMULATE_NODE_TYPE, qo as getResourcePermissions, rs as VIEWS, ur as SIMULATE_TRIGGER_NODE_TYPE, va as getSubworkflowId, vc as CanvasNodeHandleKey, xa as isExecutable, xc as ExpressionLocalResolveContextSymbol, yc as CanvasNodeKey } from "./constants-Da_CaOjC.js";
import { t as useAssistantStore } from "./assistant.store-BINIpHue.js";
import { t as useChatPanelStore } from "./chatPanel.store-niMC_nma.js";
import { t as usePinnedData } from "./usePinnedData-Bzp4yEO4.js";
import { t as getNodeIconSource } from "./nodeIcon-CXujg-pV.js";
import { c as parseCanvasConnectionHandleString, n as createCanvasConnectionHandleString, o as mapLegacyConnectionsToCanvasConnections, r as insertSpacersBetweenEndpoints, s as mapLegacyEndpointsToCanvasConnectionPort, t as checkOverlap } from "./canvas.utils-BVvTHoyE.js";
import { t as useNodeCreatorStore } from "./nodeCreator.store-BzWVn9l7.js";
import { a as useLogsStore, i as useExperimentalNdvStore, t as useCanvasOperations } from "./useCanvasOperations-DOt8fOsU.js";
...
import { r as useNodeDirtiness, t as useRunWorkflow } from "./useRunWorkflow-dTCfA8UQ.js";
import { t as useCollaborationStore } from "./collaboration.store-DnZd9c3G.js";
import { t as NodeSettings_default } from "./NodeSettings-DVn_NO-J.js";
...
var Canvas_default = /* @__PURE__ */ __plugin_vue_export_helper_default(Canvas_vue_vue_type_script_setup_true_lang_default, [["__cssModules", { "$style": Canvas_vue_vue_type_style_index_0_lang_module_default }], ["__scopeId", "data-v-b4ad6171"]]);
