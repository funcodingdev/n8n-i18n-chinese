...
import { Z as useI18n$1, l as useClipboard, y as useLocalStorage } from "./dist-DOFK-fIm.js";
import { Mt as useRouter, jt as useRoute, oo as require_markdown_it_link_attributes } from "./src-DmQRaDBt.js";
import { t as _plugin_vue_export_helper_default } from "./_plugin-vue_export-helper-Da88TEg1.js";
import { t as useToast } from "./useToast-BvIdHb4k.js";
import { Ar as mapLegacyConnectionToCanvasConnection, B as removePreviewToken, Br as DEFAULT_VIEWPORT_BOUNDARIES, Bt as ensureNodePosition, Cr as createCanvasConnectionHandleString, Ft as useWorkflowHelpers, Ht as sanitizeConnections, Ir as AGENT_NODE_SIZE, Jt as disposeWorkflowExecutionStateStore, Ki as CanvasNodeRenderType, Li as isValidNodeConnectionType, Lr as CONFIGURABLE_NODE_SIZE, Mr as parseCanvasConnectionHandleString, Qi as pinDataToExecutionData, Rr as CONFIGURATION_NODE_SIZE, Tn as useProjectsStore, Ur as doRectsOverlap, Vr as PUSH_NODES_OFFSET, Wi as CanvasConnectionMode, Wr as generateOffsets, Xt as useWorkflowExecutionStateStore, Yr as getNewNodePosition, Zr as getNodesGroupSize, _ as isAgentNodeV2, a as injectWorkflowDocumentStore, an as getExecutionErrorToastConfiguration, ct as useCredentialsStore, fn as useWorkflowsStore, g as require_uniq, h as serializeNode, jr as mapLegacyConnectionsToCanvasConnections, kr as mapCanvasConnectionToLegacyConnection, qt as useNDVStore, r as createWorkflowDocumentId, s as useWorkflowDocumentStore, v as useNodeTypesStore, vt as useDataSchema, zr as DEFAULT_NODE_SIZE, zt as useTagsStore } from "./workflowDocument.store-CJmrbFRO.js";
import { T as defineStore, t as useRootStore } from "./useRootStore-H_HdEClX.js";
import { t as useSettingsStore } from "./settings.store-CQqpFn-s.js";
import { Ac as EnterpriseEditionFeature, Au as getNodeInputs, Da as LOCAL_STORAGE_LOGS_PANEL_DETAILS_PANEL_SUB_NODE, Dl as validateNodeSelectionForGrouping, Ea as LOCAL_STORAGE_LOGS_PANEL_DETAILS_PANEL, Ed as isObjectEmpty, El as validateNodeSelectionForExtraction, Lt as CHAT_TRIGGER_NODE_TYPE, Lu as getSubworkflowId, Mu as getNodeParameters, Oa as LOCAL_STORAGE_LOGS_PANEL_OPEN, Td as isCommunityPackageName, Tu as generateNodesGraph, Vu as isHitlToolType, Xu as resolveNodeWebhookId, gr as UPDATE_WEBHOOK_ID_NODE_TYPES, ju as getNodeOutputs, ka as LOCAL_STORAGE_LOGS_SYNC_SELECTION, ku as getConnectionTypes, ld as NodeConnectionTypes, pi as VIEWS, qs as CANVAS_ZOOMED_VIEW_EXPERIMENT, uf as v4, ur as STICKY_NODE_TYPE, wd as deepCopy, wn as MANUAL_CHAT_TRIGGER_NODE_TYPE, xl as require_cloneDeep, yc as NDV_IN_FOCUS_PANEL_EXPERIMENT } from "./constants-BzyjfRY2.js";
import { f as useUIStore, g as usePostHog, p as useTelemetry } from "./users.store-CF55TUDI.js";
import { O as tryToParseNumber, S as isPresent, o as getNewWorkflowData } from "./workflowsList.store-DY3toAy4.js";
import { t as useExternalHooks } from "./useExternalHooks-BvkcAZk6.js";
import { t as useBuilderStore } from "./builder.store-DUV8ltgY.js";
import { _ as useCanvasStore, a as AddNodeGroupCommand, d as RemoveNodeCommand, f as RemoveNodeGroupCommand, h as UpdateNodeGroupCommand, i as AddNodeCommand, l as MoveNodeCommand, m as ReplaceNodeParametersCommand, n as useHistoryStore, p as RenameNodeCommand, r as AddConnectionCommand, t as useNodeHelpers, u as RemoveConnectionCommand } from "./useNodeHelpers-CIPg0H3Y.js";
...
import { t as core_default } from "./core-CaAD8sLr.js";
import { a as bash, i as javascript, n as typescript, r as python, t as xml } from "./xml-BIRtwBD9.js";
import { t as VueMarkdown } from "./VueMarkdown-05zQT1eG.js";
import { t as useSetupPanelStore } from "./setupPanel.store-Dsy4pH7P.js";
import { t as clearAllNodeResourceLocatorValues } from "./templateTransforms-u5VCgz_C.js";
