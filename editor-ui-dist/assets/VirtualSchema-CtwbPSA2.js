...
import { bt as useI18n, h as computedAsync, xt as I18nT } from "./_MapCache-COzuLMdL.js";
import { $i as N8nIcon_default, Mi as N8nTooltip_default, Qi as N8nButton_default, Xi as N8nCallout_default, Zi as N8nText_default, _t as useRouter, lt as N8nLink_default } from "./src-BvUzUaLE.js";
import { t as __plugin_vue_export_helper_default } from "./_plugin-vue_export-helper-DltO58Gh.js";
import { Bn as useMessage, Dt as injectWorkflowState, Ii as executionDataToJson, Ln as useToast, Mt as nodeViewEventBus, Ns as useSettingsStore, Un as require_FileSaver_min, _r as useNDVStore, aa as createWorkflowDocumentId, ca as useWorkflowDocumentStore, cr as environments_store_default, lt as useDataSchema, pr as useTelemetry, r as useUIStore, s as useWorkflowsStore, sa as injectWorkflowDocumentStore, st as generateCodeForPrompt, ur as useNodeHelpers, ut as useFlattenSchema, w as useNodeTypesStore, xa as isEmpty, zn as useExternalHooks } from "./users.store-Qyayth1w.js";
import { C as SCHEMA_PREVIEW_DOCS_URL, Co as AI_TRANSFORM_NODE_TYPE, Fs as MODAL_CONFIRM, Gt as CHAT_TRIGGER_NODE_TYPE, Ii as createResultError, Mn as MANUAL_TRIGGER_NODE_TYPE, Os as FROM_AI_PARAMETERS_MODAL_KEY, P as PLACEHOLDER_FILLED_AT_EXECUTION_TIME, Qo as ApplicationError, So as AI_TRANSFORM_JS_CODE, gn as FORM_TRIGGER_NODE_TYPE, go as NodeConnectionTypes, ho as DateTime, ml as EnterpriseEditionFeature, vs as BINARY_DATA_VIEW_MODAL_KEY, wi as require_pick, wr as WEBHOOK_NODE_TYPE, xo as AI_TRANSFORM_CODE_GENERATED_FOR_PROMPT } from "./constants-CbM6Kczw.js";
import { r as useRootStore } from "./_baseOrderBy-DWejZi4o.js";
import { i as Ln, o as gu, r as estree_exports, t as NDVEmptyState_default } from "./NDVEmptyState-CnRh5qxJ.js";
...
import { t as TextWithHighlights_default } from "./TextWithHighlights-gRKAQIT7.js";
import { t as useCalloutHelpers } from "./useCalloutHelpers-62UFNsl1.js";
import { n as MappingPill_default, t as useTelemetryContext } from "./useTelemetryContext-BW9qfXcG.js";
import { i as useSchemaPreviewStore, t as useRunWorkflow } from "./useRunWorkflow-CeRLv-a6.js";
...
var NodeExecuteButton_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props, { emit: __emit }) {
		...
		const ndvStore = useNDVStore();
		const { isExecuting, isListening, isListeningForWorkflowEvents, buttonLabel: nodeButtonLabel, buttonIcon: nodeButtonIcon, disabledReason, isTriggerNode, hasIssues, shouldGenerateCode, execute } = useNodeExecution(computed(() => workflowDocumentStore?.value?.getNodeByName(props$1.nodeName) ?? null), {
