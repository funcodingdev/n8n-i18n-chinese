...
import { Jt as useTelemetry, Kt as useProjectsStore, at as useCredentialsStore, s as useWorkflowsStore, t as useUsersStore } from "./users.store-Zd_8U4jS.js";
import { s as sanitizeHtml, t as useToast } from "./useToast-DG5hVw1V.js";
import { Ba as createResultError, Va as createResultOk } from "./constants-c-L9DE1I.js";
...
function useQuickConnect() {
	...
	async function connectToPinecone(quickConnectOption) {
		const { ConnectPopup } = await __vitePreload(async () => {
			const { ConnectPopup } = await import("./dist-kQD5Ja-y.js");
			return { ConnectPopup };
		}, []);
		return await new Promise((resolve) => {
