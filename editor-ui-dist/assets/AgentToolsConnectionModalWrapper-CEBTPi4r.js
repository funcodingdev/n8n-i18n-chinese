import { $ as openBlock, It as ref, N as defineComponent, S as computed, Ut as toValue, X as onMounted, gt as watch, tt as provide, w as createBlock } from "./vue.runtime.esm-bundler-DYHsQBZB.js";
import { s as useI18n } from "./src-BDfLLP15.js";
import { l as useRouter } from "./vue-router-CMlLwP0b.js";
import { Ct as useAiGatewayStore, H as useNodeTypesStore, K as filterAndSearchNodes, St as stripToolSuffix, bn as useProjectsStore, nt as isNodePreviewKey, ot as removePreviewToken, t as useWorkflowsStore, tt as isAiGatewayEligibleNode, xn as useSourceControlStore } from "./workflows.store-C0TGOSWn.js";
import { Ci as isCommunityPackageName, Sa as getResourcePermissions, W as INCOMPATIBLE_WORKFLOW_TOOL_BODY_NODE_TYPES, ei as resolveSupportedCredentialActivation, mi as NodeConnectionTypes, ua as v4 } from "./src-B2jBAc9z.js";
...
import { Dr as AGENT_TOOL_CONFIG_MODAL_KEY, n as DEFAULT_NEW_WORKFLOW_NAME } from "./constants-DOw6b_w2.js";
import { a as TELEMETRY_EVENT } from "./src-BfDzHX9f.js";
import { s as getWorkflow } from "./workflowsList.store-5H3D_H0z.js";
import { n as useUIStore } from "./ui.store-CUIioIti.js";
import { n as getNodeIconSource } from "./nodeIcon-D44ROwsS.js";
import { t as useInstallNode } from "./useInstallNode-2NCDn0r7.js";
import { n as SAMPLE_SUBWORKFLOW_TRIGGER_ID, r as SAMPLE_SUBWORKFLOW_WORKFLOW } from "./samples-BLiDvO_7.js";
import { a as getExistingToolNames, i as nodeTypeToNewMcpServer, n as mcpServerToNode, o as nodeTypeToNewToolRef, s as toolRefToNode, t as isMcpRelatedNodeType, u as workflowToNewToolRef } from "./useMcpServerAdapter-BezKIPEP.js";
import { n as toolCategoryForNodeType, r as useAgentToolCatalog, t as hasInputs } from "./useAgentToolCatalog-DsFnUKRC.js";
import { a as TOOL_CONNECTION_CREDITS_LABEL_KEY, o as hasToolConnection } from "./ToolIcon-BFfmu3dS.js";
import { t as ToolsConnectionModal_default } from "./ToolsConnectionModal-CdR6HTfa.js";
