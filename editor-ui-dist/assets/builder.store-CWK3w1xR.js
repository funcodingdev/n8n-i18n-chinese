...
import { f as useMessage, na as isToolMessage$1, ra as isWorkflowUpdatedMessage$1 } from "./src-VmSi6XTE.js";
import { u as require_lib } from "./get-CDmr6v4h.js";
import { V as useDebounceFn, y as useLocalStorage } from "./dist-BkE9aYmt.js";
import { _ as useRouter, g as useRoute } from "./htmlUtils-BQ4vUfog.js";
import { At as useAIAssistantHelpers, Ct as chatWithBuilder, Dt as getBuilderCredits, E as useWorkflowDocumentStore, Ei as isDebouncedFunction, Et as getAiSessions, Jt as useWorkflowHelpers, R as useNodeTypesStore, S as createWorkflowDocumentId, Xt as useWorkflowId, Yt as useRouteWorkflowId, hn as useSourceControlStore, kt as truncateBuilderMessages, on as useNDVStore, t as useWorkflowsStore, w as injectWorkflowDocumentStore, wt as clearBuilderSession, y as useWorkflowExecutionStateStore } from "./workflows.store-Ct6L2UO9.js";
import { a as getWorkflowHistory, bt as updateNpsSurveyState, c as updateWorkflowHistoryVersion, dr as defineStore, hn as getFirstAdoptionDate, i as getPublishTimeline, o as getWorkflowVersion, s as getWorkflowVersionsByIds, t as useRootStore } from "./useRootStore-CDIOxWm8.js";
import { t as STORES } from "./constants2-JUBWMnBE.js";
import { Yt as validateNodeSelectionForGrouping, ai as isExpression, ca as getResourcePermissions, si as dedupe } from "./src-Vot4VemC.js";
...
import { Ea as CODE_WORKFLOW_BUILDER_EXPERIMENT, Fa as FOCUSED_NODES_EXPERIMENT, Ka as MERGE_ASK_BUILD_EXPERIMENT, Pi as LOCAL_STORAGE_BROWSER_NOTIFICATION_METADATA, di as MODAL_CONFIRM, li as MODAL_CANCEL, pi as NPS_SURVEY_MODAL_KEY, t as AutoSaveState, ui as MODAL_CLOSE } from "./constants-nNF8vqjl.js";
import { c as THREE_DAYS_IN_MILLIS, o as SEVEN_DAYS_IN_MILLIS, s as SIX_MONTHS_IN_MILLIS, t as DEBOUNCE_TIME } from "./durations-D_iMA_ix.js";
import { a as BUILDER_ENABLED_VIEWS, r as useChatPanelStateStore, t as useCodeDiff } from "./useCodeDiff-BX4FGXrf.js";
import { t as getDebounceTime } from "./useDebounce-SzXFKOo9.js";
import { g as stringSizeInBytes, v as tryToParseNumber } from "./typesUtils-Bg2s5rO5.js";
import { a as getNewWorkflow, t as useWorkflowsListStore } from "./workflowsList.store-s9e_R4vj.js";
