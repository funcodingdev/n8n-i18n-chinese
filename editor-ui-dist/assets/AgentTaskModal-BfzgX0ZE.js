...
import { Ai as N8nText_default, Ii as N8nButton_default, It as N8nOption_default, Li as N8nIcon_default, Pi as Input_default, Pt as N8nSelect_default, V as Switch_default, jr as N8nTooltip_default, jt as N8nHeading_default, t as MarkdownEditor_default, wt as N8nFormInput_default } from "./src-Btlck5YT.js";
...
import { Z as AGENT_TASK_OBJECTIVE_MAX_LENGTH } from "./src-Bd4giLF5.js";
...
import { I as updateAgentTask, a as createAgentTask, j as runAgentTask, l as deleteAgentTask } from "./useAgentApi-rxRuPd-J.js";
...
var AgentTaskModal_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		...
		const initialCronInvalid = isEditing.value && !getNextScheduleOccurrence(cronExpression.value, rootStore.timezone);
		const cronValidator = { validate: (value) => getNextScheduleOccurrence(typeof value === "string" ? value : "", rootStore.timezone) ? false : { message: i18n.baseText("agents.builder.tasks.validation.cronInvalid") } };
			...
			return openBlock(), createBlock(Modal_default, {
				...
				content: withCtx(() => [createBaseVNode("div", { class: normalizeClass(_ctx.$style.content) }, [
					createBaseVNode("div", { class: normalizeClass(_ctx.$style.field) }, [createVNode(unref(N8nFormInput_default), {
						...
						onValidate: _cache[1] || (_cache[1] = ($event) => nameValid.value = $event)
					}, null, 8, [
						"model-value",
						"label",
						"placeholder",
					...
					createBaseVNode("div", { class: normalizeClass(_ctx.$style.field) }, [
						...
						createBaseVNode("div", { class: normalizeClass(_ctx.$style.scheduleRow) }, [
							...
							frequency.value === "weekly" ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [createVNode(unref(N8nText_default), {
								...
								"onUpdate:modelValue": _cache[2] || (_cache[2] = ($event) => dayOfWeek.value = Number($event))
							}, {
							...
							frequency.value === "monthly" ? (openBlock(), createElementBlock(Fragment, { key: 1 }, [createVNode(unref(N8nText_default), {
								...
								"onUpdate:modelValue": _cache[3] || (_cache[3] = ($event) => dayOfMonth.value = Number($event))
							}, {
							...
							showTime.value ? (openBlock(), createElementBlock(Fragment, { key: 2 }, [createVNode(unref(N8nText_default), {
								...
								"onUpdate:modelValue": _cache[4] || (_cache[4] = ($event) => selectedTime.value = Number($event))
							}, {
							...
							frequency.value === "custom" ? (openBlock(), createBlock(unref(N8nFormInput_default), {
								...
								onValidate: _cache[5] || (_cache[5] = ($event) => cronValid.value = $event)
							}, null, 8, [
								"model-value",
								"placeholder",
								"validators",
