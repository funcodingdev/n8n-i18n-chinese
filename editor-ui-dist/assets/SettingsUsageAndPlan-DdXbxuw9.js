...
import { c as I18nT, i as i18n } from "./src-BBBtAtId.js";
...
import { i as DialogDescription_default } from "./DialogTitle-Dx-CEpRz.js";
...
import { b as COMMUNITY_PLUS_ENROLLMENT_MODAL, n as useUIStore } from "./ui.store-KcYYy7Mp.js";
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("div", _hoisted_1, [createVNode(unref(N8nHeading_default), {
				...
				createVNode(unref(Dialog_default), {
					open: activationSuccessModal.value,
					"onUpdate:open": _cache[4] || (_cache[4] = ($event) => activationSuccessModal.value = $event),
					size: "small",
					header: unref(i18n).baseText("settings.usageAndPlan.license.activation.success.title")
				}, {
					default: withCtx(() => [createVNode(unref(DialogDescription_default), {
						class: normalizeClass(_ctx.$style.activationSuccessDescription),
						"data-test-id": "license-activation-success-dialog"
					}, {
						default: withCtx(() => [createTextVNode(toDisplayString(unref(i18n).baseText("settings.usageAndPlan.license.activation.success.message")), 1)]),
						_: 1
					}, 8, ["class"]), createVNode(unref(DialogFooter_default), null, {
						default: withCtx(() => [createVNode(unref(N8nButton_default), {
							"data-test-id": "license-activation-success-close-button",
							onClick: _cache[3] || (_cache[3] = ($event) => activationSuccessModal.value = false)
						}, {
				...
				createVNode(EulaAcceptanceModal_default, {
					...
					"onUpdate:modelValue": _cache[5] || (_cache[5] = ($event) => eulaModal.value = $event),
...
var center = "_center_r1bp9_388";
var actionBox = "_actionBox_r1bp9_392";
var spacedFlex = "_spacedFlex_r1bp9_396";
var title = "_title_r1bp9_402";
var quota = "_quota_r1bp9_408";
var count = "_count_r1bp9_420";
var buttons = "_buttons_r1bp9_425";
var chart = "_chart_r1bp9_441";
var chartLine = "_chartLine_r1bp9_448";
var chartBar = "_chartBar_r1bp9_458";
var titleTooltip = "_titleTooltip_r1bp9_472";
var dialogButtonsContainer = "_dialogButtonsContainer_r1bp9_478";
var activationSuccessDescription = "_activationSuccessDescription_r1bp9_483";
var shimmer = "_shimmer_r1bp9_1";
var spin = "_spin_r1bp9_1";
var opacityPulse = "_opacityPulse_r1bp9_1";
var popoverIn = "_popoverIn_r1bp9_1";
var fadeIn = "_fadeIn_r1bp9_1";
var collapsibleSlideDown = "_collapsibleSlideDown_r1bp9_1";
var collapsibleSlideUp = "_collapsibleSlideUp_r1bp9_1";
var collapsibleSlideDownBlurred = "_collapsibleSlideDownBlurred_r1bp9_1";
var collapsibleSlideUpBlurred = "_collapsibleSlideUpBlurred_r1bp9_1";
var blurSwapIn = "_blurSwapIn_r1bp9_1";
var blurSwapOut = "_blurSwapOut_r1bp9_1";
var pulseGlow = "_pulseGlow_r1bp9_1";
var pulseGlowDelayed = "_pulseGlowDelayed_r1bp9_1";
var fade = "_fade_r1bp9_1";
var fadeInUp = "_fadeInUp_r1bp9_1";
var fadeInDown = "_fadeInDown_r1bp9_1";
var fadeInLeft = "_fadeInLeft_r1bp9_1";
var fadeInRight = "_fadeInRight_r1bp9_1";
var fadeOut = "_fadeOut_r1bp9_1";
var fadeOutDown = "_fadeOutDown_r1bp9_1";
var fadeOutUp = "_fadeOutUp_r1bp9_1";
var fadeOutLeft = "_fadeOutLeft_r1bp9_1";
var fadeOutRight = "_fadeOutRight_r1bp9_1";
var ping = "_ping_r1bp9_1";
var blinkBackground = "_blinkBackground_r1bp9_1";
var typingBlink = "_typingBlink_r1bp9_1";
var SettingsUsageAndPlan_vue_vue_type_style_index_0_lang_module_default = {
	...
	shimmer,
	spin,
	"skeleton-pulse": "_skeleton-pulse_r1bp9_1",
	opacityPulse,
	popoverIn,
	fadeIn,
...
var SettingsUsageAndPlan_default = /* @__PURE__ */ _plugin_vue_export_helper_default(SettingsUsageAndPlan_vue_vue_type_script_setup_true_lang_default, [["__cssModules", { "$style": SettingsUsageAndPlan_vue_vue_type_style_index_0_lang_module_default }], ["__scopeId", "data-v-5b4a9dd7"]]);
//#endregion
