...
import { $ as openBlock, A as createTextVNode, C as createBaseVNode, E as createElementBlock, Ft as ref, Ht as toValue, I as h, N as defineComponent, Nt as reactive, P as getCurrentInstance, S as computed, Sn as toDisplayString, T as createCommentVNode, W as nextTick, Wt as unref, X as onMounted, _ as Fragment, _n as normalizeClass, bt as withDirectives, ft as useSlots, gt as watch, h as withModifiers, it as renderSlot, j as createVNode, p as vShow, pt as useTemplateRef, q as onBeforeUnmount, rt as renderList, w as createBlock, yn as normalizeStyle, yt as withCtx } from "./vue.runtime.esm-bundler-dg1EVmSK.js";
import { D as useElementSize, G as directiveHooks, J as isObject, K as isClient, P as useResizeObserver, X as notNullish, Y as noop, at as tryOnScopeDispose, bt as useI18n, ct as useThrottleFn, ft as isVue2, g as onClickOutside, h as computedAsync, it as tryOnMounted, q as isIOS, rt as toValue$1, st as useDebounceFn, tt as toRef, xt as I18nT } from "./_MapCache-C80pWp05.js";
import { F as N8nTabs_default, H as N8nRadioButtons_default, K as N8nNotice_default, Li as N8nTooltip_default, Lt as N8nBlockUi_default, Vi as N8nIconButton_default, _t as useRoute, h as N8nInlineTextEdit_default, ia as N8nIcon_default, na as N8nText_default, ra as N8nButton_default, ta as N8nCallout_default, tn as ElCollapseTransition, v as require_get } from "./src-DXhOkTfb.js";
import { t as __plugin_vue_export_helper_default } from "./_plugin-vue_export-helper-DltO58Gh.js";
import { Et as useWorkflowHelpers, Is as useSettingsStore, Kr as useHistoryStore, Ln as useToast, Nt as importCurlEventBus, Ra as COMMUNITY_NODES_INSTALLATION_DOCS_URL, T as useActionsGenerator, Va as COMMUNITY_PACKAGE_INSTALL_MODAL_KEY, at as useCredentialsStore, br as useNDVStore, gr as useTelemetry, jt as ndvEventBus, pr as useNodeHelpers, r as useUIStore, s as useWorkflowsStore, t as useUsersStore, ti as RenameNodeCommand, ua as injectWorkflowDocumentStore, ur as useWorkflowsListStore, w as useNodeTypesStore, xi as ProjectTypes, z as removePreviewToken, zn as useExternalHooks } from "./users.store-bYJP9NEL.js";
import { M as TitledList_default, O as NodeCredentials_default, _ as getNodeSettingsInitialValues, b as nameIsParameter, c as useNodeSettingsParameters, h as createCommonNodeSettings, k as useNodeCredentialOptions, m as collectSettings, p as collectParametersByTab, t as ParameterInputList_default } from "./ParameterInputList-CquLPExM.js";
import { n as ElRow, t as ElCol } from "./col-BqU8F1TK.js";
import { Gt as CHAT_TRIGGER_NODE_TYPE, I as CUSTOM_API_CALL_KEY, Pn as MCP_TRIGGER_NODE_TYPE, Qa as isCommunityPackageName, Qn as PRODUCTION_ONLY_TRIGGER_NODE_TYPES, Ro as OPEN_AI_API_CREDENTIAL_TYPE, Yn as OPEN_URL_PANEL_TRIGGER_NODE_TYPES, Za as deepCopy, ba as getNodeParameters, d as CUSTOM_NODES_DOCS_URL, en as DATA_TABLE_NODES, gn as FORM_TRIGGER_NODE_TYPE, go as NodeConnectionTypes, hs as VIEWS, l as BUILTIN_NODES_DOCS_URL, s as BASE_NODE_SURVEY_URL, va as getNodeInputs, x as NPM_PACKAGE_DOCS_BASE_URL } from "./constants-neq36s1h.js";
...
import { t as useFreeAiCredits } from "./useFreeAiCredits-DwoRtroG.js";
...
var NodeSettings_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props, { emit: __emit }) {
		...
		const credentialSelected = (updateInformation) => {
			...
			const node$1 = workflowDocumentStore?.value?.getNodeByName(updateInformation.name) ?? null;
...
var NodeSettings_default = /* @__PURE__ */ __plugin_vue_export_helper_default(NodeSettings_vue_vue_type_script_setup_true_lang_default, [["__cssModules", { "$style": NodeSettings_vue_vue_type_style_index_0_lang_module_default }], ["__scopeId", "data-v-4a97303a"]]);
