...
var zh_CN_default = {
	...
	"aiAssistant.builder.reviewChanges.button": "审查更改",
	"aiAssistant.builder.reviewChanges.editedNodes": "编辑了 {count} 个节点",
	...
	"settings.secretsProviderConnections.emptyState.heading": "添加外部秘密存储",
	...
	"settings.secretsProviderConnections.modal.scope.info": "选择某个项目将只与该项目共享密钥存储。如果你想与所有项目共享密钥存储，请选择“全局”。",
	...
	"settings.secretsProviderConnections.badge.tooltip.project": "这个秘密存储与 {projectName} 共享。",
	"settings.secretsProviderConnections.badge.tooltip.global": "该秘密存储对本实例的所有项目和用户均可用。",
	...
	"projects.settings.externalSecrets.emptyState.instanceAdmin.noProjectProviders.description": "与该项目共享秘密存储，以便在此处使外部秘密可用。一旦共享，秘密将自动出现，并可以通过凭据中的别名进行引用。",
	"projects.settings.externalSecrets.emptyState.projectAdmin.description": "添加一个秘密存储，并与该项目共享，以便在此处访问外部秘密。一旦共享，秘密将自动出现，并可以通过凭证中的别名进行引用。",
	"projects.settings.externalSecrets.button.addSecretsStore": "添加秘密库",
	"projects.settings.externalSecrets.button.shareSecretsStore": "分享秘密存储",
	...
	"projects.settings.externalSecrets.expand": "扩展外部秘密存储",
	"projects.settings.externalSecrets.collapse": "收起外部秘密存储",
