...
import { Pt as Checkbox_default, Qt as N8nCallout_default, Rt as N8nHeading_default, ao as N8nText_default, at as N8nNotice_default, do as N8nButton_default, fo as N8nIcon_default, mt as N8nLogo_default } from "./src-DmQRaDBt.js";
...
import { t as ScopesSelector_default } from "./ScopesSelector-By2YD3t2.js";
import { a as MCP_SCOPE_GROUPS, r as MCP_DOCS_PAGE_URL } from "./mcp.constants-D-fL2-wC.js";
...
var OAuthConsentView_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		...
		const allowDisabled = computed(() => loading.value || error.value !== null || !clientDetails.value || !redirectUriTrusted.value || hasScopes.value && selectedScopes.value.length === 0);
		...
		return (_ctx, _cache) => {
			...
			return openBlock(), createElementBlock("div", { class: normalizeClass(_ctx.$style.overlay) }, [createBaseVNode("div", { class: normalizeClass(_ctx.$style["consent-dialog"]) }, [
				...
				waitingForRedirect.value ? (openBlock(), createElementBlock("div", {
					...
					hasScopes.value ? (openBlock(), createElementBlock(Fragment, { key: 3 }, [createVNode(ScopesSelector_default, {
						...
						color: "text-light",
						size: "xsmall",
						"data-test-id": "consent-scopes-note"
					}, {
						default: withCtx(() => [createTextVNode(toDisplayString(unref(i18n).baseText("oauth.consentView.scopes.note")), 1)]),
						_: 1
					})], 64)) : !resourceName.value ? (openBlock(), createElementBlock("ul", {
						key: 4,
