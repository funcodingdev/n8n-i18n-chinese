...
import { _ as onKeyDown, _t as I18nT, gt as useI18n, it as useThrottleFn, ot as watchOnce, st as watchThrottled, y as onKeyUp } from "./_MapCache-Blne6VeP.js";
import { Hn as N8nButton_default, T as N8nPopover_default, Vn as N8nText_default, Wn as N8nIcon_default, it as useDeviceSupport, mt as N8nTooltip_default, nt as N8nActionDropdown_default, ut as N8nLink_default, xt as N8nIconButton_default, y as N8nSticky_default } from "./src-K-ysFfvA.js";
import { t as __plugin_vue_export_helper_default } from "./_plugin-vue_export-helper-BwBpWJRZ.js";
import { b as useRouter, n as truncateBeforeLast, x as createEventBus, y as useRoute } from "./truncate-B6V3BCxD.js";
import { D as TitledList_default } from "./ParameterInputList-CWi_zjVm.js";
import { A as _sfc_main$1, B as isMacOs, Bo as v4_default, Cr as CanvasNodeDirtiness, D as PanelPosition, Dn as useSourceControlStore, E as NodeId, F as getBezierPath, Fi as useUIStore, H as useVueFlow, I as getBoundsofRects, L as getConnectedEdges, M as _sfc_main$d, N as _sfc_main$f, O as Position, Oi as nodeViewEventBus, P as clamp, R as getRectOfNodes, Sn as injectWorkflowState, Sr as CanvasConnectionMode, T as MarkerType, Tr as useHistoryStore, U as wheelDelta, V as useGetPointerPosition, Wo as useSettingsStore, a as useNDVStore, at as useNodeTypesStore, bi as isPresent, c as CONFIGURATION_NODE_RADIUS, ei as getTriggerNodeServiceName, f as GRID_SIZE, j as _sfc_main$3, ji as globalLinkActionsEventBus, k as _sfc_main$4, m as calculateNodeSize, o as useWorkflowsStore, p as PUSH_NODES_OFFSET, q as isChatNode, t as useTelemetry, u as DEFAULT_NODE_SIZE, vr as isValidNodeConnectionType, w as updateViewportToContainNodes, wr as CanvasNodeRenderType, xn as useNodeHelpers, y as getMousePosition, yn as environments_store_default, z as getSmoothStepPath } from "./useTelemetry-BptP8y2R.js";
import { o as isOutsideSelected, s as sanitizeHtml, t as useToast } from "./useToast-CgdJyGuK.js";
import { $s as ExpressionLocalResolveContextSymbol, Ji as mapConnectionsByDestination, Ka as NodeConnectionTypes, Ko as EXPERIMENT_TEMPLATES_DATA_QUALITY_KEY, L as CUSTOM_API_CALL_KEY, Oa as isCommunityPackageName, Qs as CanvasNodeKey, Ro as VIEWS, Vt as CHAT_TRIGGER_NODE_TYPE, Xs as CanvasKey, Zs as CanvasNodeHandleKey, _o as require_isEqual, bc as CANVAS_EXECUTION_DATA_THROTTLE_DURATION, bi as extractReferencesInNodeExpressions, ca as getSubworkflowId, da as isExecutable, dn as FORM_NODE_TYPE, dr as STICKY_NODE_TYPE, fa as isNodeWithWorkflowSelector, go as WEBHOOK_NODE_TYPE, hi as parseExtractableSubgraphSelection, ho as WAIT_INDEFINITELY, hs as WORKFLOW_EXTRACTION_NAME_MODAL_KEY, io as EXECUTE_WORKFLOW_TRIGGER_NODE_TYPE, ir as SIMULATE_TRIGGER_NODE_TYPE, ko as getResourcePermissions, mi as buildAdjacencyList, na as getNodeOutputs, po as SEND_AND_WAIT_OPERATION, qn as PRODUCTION_ONLY_TRIGGER_NODE_TYPES, rr as SIMULATE_NODE_TYPE, ta as getNodeInputs, vr as WAIT_NODE_TYPE, wt as NODE_CREATOR_OPEN_SOURCES, zn as NOT_DUPLICATABLE_NODE_TYPES } from "./constants-C1tPaXRr.js";
import { t as useStyles } from "./useStyles-DhM0cpS7.js";
import { t as useChatPanelStore } from "./chatPanel.store-CwEHYw1b.js";
import { a as useTemplatesDataQualityStore, i as trackTemplatesClick, n as TemplateClickSource, r as isExtraTemplateLinksExperimentEnabled, t as useTemplatesStore } from "./templates.store-CAPLISh_.js";
import { r as useNodeDirtiness, t as useRunWorkflow } from "./useRunWorkflow-CY8R_-Sq.js";
import { t as usePinnedData } from "./usePinnedData-wJzUkDWs.js";
import { c as mapLegacyEndpointsToCanvasConnectionPort, i as insertSpacersBetweenEndpoints, l as parseCanvasConnectionHandleString, n as checkOverlap, r as createCanvasConnectionHandleString, s as mapLegacyConnectionsToCanvasConnections, t as useNodeCreatorStore } from "./nodeCreator.store-DP8K6669.js";
import { t as getNodeIconSource } from "./nodeIcon-B2-ppY7G.js";
import { a as useLogsStore, i as useExperimentalNdvStore, t as useCanvasOperations } from "./useCanvasOperations-BEOM4taW.js";
...
import { t as NodeSettings_default } from "./NodeSettings-CQxpqrq8.js";
...
const node = "_node_1yk79_123";
const trigger$1 = "_trigger_1yk79_146";
const configuration = "_configuration_1yk79_149";
const running = "_running_1yk79_152";
const waiting = "_waiting_1yk79_152";
const statusIcons = "_statusIcons_1yk79_155";
const configurable = "_configurable_1yk79_158";
const icon = "_icon_1yk79_158";
const description = "_description_1yk79_161";
const label$6 = "_label_1yk79_174";
const subtitle = "_subtitle_1yk79_177";
const selected$1 = "_selected_1yk79_190";
const success$1 = "_success_1yk79_194";
const warning = "_warning_1yk79_201";
const error = "_error_1yk79_205";
const pinned = "_pinned_1yk79_208";
const disabled = "_disabled_1yk79_215";
const disabledLabel = "_disabledLabel_1yk79_278";
