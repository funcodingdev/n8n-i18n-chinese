...
import { b as useLocalStorage, x as useMediaQuery } from "./dist-CYNfKCbA.js";
...
import { t as PERSONALIZATION_MODAL_KEY } from "./users-utZBYbh9.js";
import { t as useTelemetry } from "./useTelemetry-CgKpOMtU.js";
import { t as VIEWS } from "./views-BVx7SJLW.js";
import { $r as FROM_AI_PARAMETERS_MODAL_KEY, Ci as WORKFLOW_SETTINGS_MODAL_KEY, Gr as BINARY_DATA_VIEW_MODAL_KEY, Hr as ADD_EXECUTION_TO_DATASET_MODAL_KEY, Ji as LOCAL_STORAGE_THEME, Jr as DELETE_SECRETS_PROVIDER_MODAL_KEY, Ki as LOCAL_STORAGE_SIDEBAR_WIDTH, Kr as CHAT_EMBED_MODAL_KEY, Qr as EXTERNAL_SECRETS_PROVIDER_MODAL_KEY, Si as WORKFLOW_PUBLISH_MODAL_KEY, Ur as AI_BUILDER_DIFF_MODAL_KEY, Vr as ABOUT_MODAL_KEY, Wr as AI_GATEWAY_TOP_UP_MODAL_KEY, Xr as EXPERIMENT_TEMPLATE_RECO_V2_KEY, Yr as DUPLICATE_MODAL_KEY, Zr as EXPERIMENT_TEMPLATE_RECO_V3_KEY, _i as WORKFLOW_EXTRACTION_NAME_MODAL_KEY, bi as WORKFLOW_HISTORY_PUBLISH_MODAL_KEY, ci as NPS_SURVEY_MODAL_KEY, di as STOP_MANY_EXECUTIONS_MODAL_KEY, ei as IMPORT_CURL_MODAL_KEY, fi as TRIAL_INTRO_MODAL_KEY, gi as WORKFLOW_DIFF_MODAL_KEY, h as DOCS_DOMAIN, hi as WORKFLOW_DESCRIPTION_MODAL_KEY, ho as WHATS_NEW_MODAL_KEY, li as SECRETS_PROVIDER_CONNECTION_MODAL_KEY, mi as WORKFLOW_ACTIVE_MODAL_KEY, mo as VERSIONS_MODAL_KEY, ni as LOG_STREAM_MODAL_KEY, pi as WORKFLOW_ACTIVATION_CONFLICTING_WEBHOOK_MODAL_KEY, qr as CREDENTIAL_RESOLVER_EDIT_MODAL_KEY, ri as MIGRATE_WORKFLOW_MODAL_KEY, si as NEW_ASSISTANT_SESSION_MODAL, ti as IMPORT_WORKFLOW_URL_MODAL_KEY, ui as SETUP_CREDENTIALS_MODAL_KEY, vi as WORKFLOW_HISTORY_DIFF_MODAL_KEY, wi as WORKFLOW_SHARE_MODAL_KEY, xi as WORKFLOW_HISTORY_VERSION_UNPUBLISH, yi as WORKFLOW_HISTORY_NAME_VERSION_MODAL_KEY } from "./constants-TYJWHLXv.js";
...
function register$2(type, handler) {
...
function registerAll(pushHandlers) {
	for (const type of Object.keys(pushHandlers)) {
		...
		if (handler) register$2(type, handler);
	}
}
function get$1(type) {
...
function modalDefinitionsById(shellDefaults) {
	...
	for (const [key, definition] of getAll$2()) definitions[key] = definition.initialState ?? CLOSED_MODAL_STATE;
	return definitions;
}
/**
...
var useUIStore = defineStore(STORES.UI, () => {
	...
	*/
	watch(() => new Set(getAll$2().keys()), (registered, previouslyRegistered) => {
...
//#endregion
export { COMPANY_TYPE_KEY as $, ROLE_ENGINEERING as $t, COMMUNITY_NODES_RISKS_DOCS_URL as A, MEDIA_INDUSTRY as At, MCP_ACCESS_ACTIONS as B, REPORTED_SOURCE_FRIEND as Bt, API_KEY_SCOPE_GROUPS as C, MARKETING_AUTOMATION_CUSTOMER_COMMUNICATION as Ct, DEFAULT_PROJECT_ICON as D, MARKETING_AUTOMATION_OTHER as Dt, DEBUG_PAYWALL_MODAL_KEY as E, MARKETING_AUTOMATION_LEAD_GENERATION_GOAL as Et, DELETE_FOLDER_MODAL_KEY as F, OTHER_MARKETING_AUTOMATION_GOAL_KEY as Ft, AUTOMATION_BENEFICIARY_SELF as G, REPORTED_SOURCE_OTHER_KEY as Gt, AUTOMATION_BENEFICIARY_KEY as H, REPORTED_SOURCE_KEY as Ht, FOLDER_LIST_ITEM_ACTIONS as I, PERSONAL_COMPANY_TYPE as It, COMPANY_SIZE_100_499 as J, REPORTED_SOURCE_YOUTUBE as Jt, COMPANY_INDUSTRY_EXTENDED_KEY as K, REPORTED_SOURCE_PODCAST as Kt, FOLDER_NAME_ILLEGAL_CHARACTERS_REGEX as L, PHYSICAL_RETAIL_OR_SERVICES as Lt, COMMUNITY_PACKAGE_INSTALL_MODAL_KEY as M, OTHER_COMPANY_INDUSTRY_EXTENDED_KEY as Mt, COMMUNITY_PACKAGE_MANAGE_ACTIONS as N, OTHER_COMPANY_TYPE as Nt, PROJECT_MOVE_RESOURCE_MODAL as O, MARKETING_AUTOMATION_REPORTING as Ot, NPM_KEYWORD_SEARCH_URL as P, OTHER_INDUSTRY_OPTION as Pt, COMPANY_SIZE_PERSONAL_USE as Q, ROLE_DEVOPS as Qt, FOLDER_NAME_ONLY_DOTS_REGEX as R, REAL_ESTATE_OR_CONSTRUCTION as Rt, API_KEY_CREATE_OR_EDIT_MODAL_KEY as S, MARKETING_AUTOMATION_AD_CAMPAIGN as St, CANCELLABLE_EXECUTION_STATUSES as T, MARKETING_AUTOMATION_GOAL_KEY as Tt, AUTOMATION_BENEFICIARY_MY_TEAM as U, REPORTED_SOURCE_LINKEDIN as Ut, MOVE_FOLDER_MODAL_KEY as V, REPORTED_SOURCE_GOOGLE as Vt, AUTOMATION_BENEFICIARY_OTHER_TEAMS as W, REPORTED_SOURCE_OTHER as Wt, COMPANY_SIZE_500_999 as X, ROLE_CUSTOMER_SUPPORT as Xt, COMPANY_SIZE_20_99 as Y, ROLE_BUSINESS_OWNER as Yt, COMPANY_SIZE_KEY as Z, ROLE_DATA_SCIENCE as Zt, SOURCE_CONTROL_PULL_RESULT_MODAL_KEY as _, INVITE_USER_MODAL_KEY as _t, register$1 as a, SAAS_COMPANY_TYPE as an, DEVOPS_AUTOMATION_GOAL_OTHER_KEY as at, COMMUNITY_PLUS_ENROLLMENT_MODAL as b, MANUFACTURING_INDUSTRY as bt, registerAll as c, TELECOMS_INDUSTRY as cn, DEVOPS_MONITORING_AND_ALERTING_GOAL as ct, getAll$2 as d, DIGITAL_AGENCY_COMPANY_TYPE as dt, ROLE_KEY as en, DELETE_USER_MODAL_KEY as et, register$3 as f, ECOMMERCE_COMPANY_TYPE as ft, SOURCE_CONTROL_PULL_MODAL_KEY as g, HEALTHCARE_INDUSTRY as gt, TAGS_MANAGER_MODAL_KEY as h, GOVERNMENT_INDUSTRY as ht, register as i, ROLE_SECURITY as in, DEVOPS_AUTOMATION_GOAL_KEY as it, COMMUNITY_PACKAGE_CONFIRM_MODAL_KEY as j, OTHER_AUTOMATION_GOAL as jt, COMMUNITY_NODES_INSTALLATION_DOCS_URL as k, MARKETING_INDUSTRY as kt, registerResource as l, CREDENTIAL_EDIT_MODAL_KEY as ln, DEVOPS_REPORTING_GOAL as lt, ANNOTATION_TAGS_MANAGER_MODAL_KEY as m, FINANCE_INSURANCE_INDUSTRY as mt, useUIStore as n, ROLE_OTHER_KEY as nn, DEVOPS_AUTOMATION_CLOUD_INFRASTRUCTURE_ORCHESTRATION_GOAL as nt, get$1 as o, SECURITY_INDUSTRY as on, DEVOPS_AUTOMATION_OTHER as ot, assertUniqueRouteNames as p, EDUCATION_TYPE as pt, COMPANY_SIZE_1000_OR_MORE as q, REPORTED_SOURCE_TWITTER as qt, get as r, ROLE_SALES_AND_MARKETING as rn, DEVOPS_AUTOMATION_DATA_SYNCING_GOAL as rt, has as s, SYSTEMS_INTEGRATOR_COMPANY_TYPE as sn, DEVOPS_INCIDENT_RESPONSE_GOAL as st, listenForModalChanges as t, ROLE_OTHER as tn, DEVOPS_AUTOMATION_CI_CD_GOAL as tt, declareAdHocKeyPrefix as u, CREDENTIAL_SELECT_MODAL_KEY as un, DEVOPS_TICKETING_SYSTEMS_INTEGRATIONS_GOAL as ut, SOURCE_CONTROL_PUSH_MODAL_KEY as v, IT_INDUSTRY as vt, READ_SCOPE_ACTIONS as w, MARKETING_AUTOMATION_DATA_SYNCHING as wt, VARIABLE_MODAL_KEY as x, MARKETING_AUTOMATION_ACTIONS as xt, COMMUNITY_PLUS_DOCS_URL as y, LEGAL_INDUSTRY as yt, ILLEGAL_FOLDER_CHARACTERS as z, REPORTED_SOURCE_EVENT as zt };
