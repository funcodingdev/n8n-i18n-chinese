;
(function () {
  System.register(["./vue.runtime.esm-bundler-legacy--Sn1h8On.js", "./useTelemetry-legacy-DnSAoKz5.js", "./useToast-legacy-Ce_kWqRg.js", "./constants-legacy-BWxkEIkt.js", "./_baseOrderBy-legacy-D_9iEaXg.js"], function (_export, _context) {
    "use strict";

    var computed, ref, useUIStore, getWhatsNewSection, useStorage, useSettingsStore, STORES, useUsersStore, getNextVersions, useTelemetry, useToast, jsonParse, LOCAL_STORAGE_DISMISSED_WHATS_NEW_CALLOUT, WHATS_NEW_MODAL_KEY, VERSIONS_MODAL_KEY, LOCAL_STORAGE_READ_WHATS_NEW_ARTICLES, defineStore, useRootStore, SEMVER_REGEX, useVersionsStore;
    return {
      setters: [function (_vueRuntimeEsmBundlerLegacy003Js) {
        ...
        LOCAL_STORAGE_DISMISSED_WHATS_NEW_CALLOUT = _constantsLegacy00TJs.Ds;
        WHATS_NEW_MODAL_KEY = _constantsLegacy00TJs.ds;
        VERSIONS_MODAL_KEY = _constantsLegacy00TJs.us;
        LOCAL_STORAGE_READ_WHATS_NEW_ARTICLES = _constantsLegacy00TJs.zs;
