...
import { $i as v4, Aa as instanceAiAgentAttachmentSchema } from "./src-DVvN4F-B.js";
import { t as useRootStore } from "./useRootStore-Bd5Zf8xA.js";
import { c as INSTANCE_AI_THREAD_VIEW, r as INSTANCE_AI_AGENT_BUILDER_TARGET_METADATA_KEY } from "./constants-1I5Tx-r_.js";
...
function consumePendingHandoffContext(threadId) {
...
async function provisionContextOnlyThread(projectId, context, launch) {
	const threadId = v4();
	try {
		await useInstanceAiStore().syncThread(threadId, projectId, launch);
	} catch {
...
function useInstanceAiHandoff() {
	...
	async function openAgentArtifactThread(attachment, launch) {
...
//#endregion
export { clearPendingAgentAttachment as a, ensurePersonalProjectId as c, stashPendingAgentAttachment as d, useInstanceAiHandoff as f, buildInstanceAiCredentialQuestion as i, getPendingAgentAttachment as l, buildInstanceAiArtifactCredentialQuestion as n, consumePendingFirstMessage as o, buildInstanceAiCredentialHandoffContext as r, consumePendingHandoffContext as s, buildInstanceAiAgentPreviewHandoffContext as t, provisionLaunchedThread as u };
