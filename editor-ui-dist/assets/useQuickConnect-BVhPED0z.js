import { C as computed, It as ref, J as onBeforeUnmount } from "./vue.runtime.esm-bundler-XtMkEjzB.js";
import { yt as useI18n } from "./_MapCache-Bl0j8A0i.js";
import { Gi as __vitePreload } from "./src-DNuWeQoI.js";
import { Er as useMessage, Ir as usePostHog, It as useTelemetry, Wt as useProjectsStore, at as useCredentialsStore, br as useToast, js as useSettingsStore, s as useWorkflowsStore } from "./users.store-CgsgTstk.js";
import { Ai as createResultError, Gc as QUICK_CONNECT_EXPERIMENT, ji as createResultOk, ws as MODAL_CONFIRM } from "./constants-DEPRN4fc.js";
import { d as makeRestApiRequest, r as useRootStore } from "./_baseOrderBy-DCYhjK32.js";
...
function useQuickConnect() {
	...
	async function connectToPinecone(quickConnectOption) {
		const { ConnectPopup } = await __vitePreload(async () => {
			const { ConnectPopup: ConnectPopup$1 } = await import("./dist-Cd7REAvb.js");
		...
		if (quickConnectOption) {
			...
			try {
				if (quickConnectOption.consentText) {
					if (await message.confirm(quickConnectOption.consentText, i18n.baseText("nodeCredentials.quickConnect.connectTo", { interpolate: { provider: connectParams.serviceName } }), {
