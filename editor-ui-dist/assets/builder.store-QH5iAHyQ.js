...
import { Ft as getBuilderCredits, Lt as truncateBuilderMessages, M as useCanvasStore, Mt as clearBuilderSession, Pt as getAiSessions, Rt as useAIAssistantHelpers, b as injectWorkflowDocumentStore, bn as useSourceControlStore, dn as useNDVStore, jt as chatWithBuilder, k as useNodeHelpers, nn as useWorkflowHelpers, t as useWorkflowsStore, v as createWorkflowDocumentId, x as useWorkflowDocumentStore, xi as isDebouncedFunction } from "./workflows.store-yqufO0kS.js";
import { t as useToast } from "./useToast-C1BAsL26.js";
import { Al as WorkflowIdKey, Fi as NPS_SURVEY_MODAL_KEY, Hl as CODE_WORKFLOW_BUILDER_EXPERIMENT, Ll as AI_BUILDER_TEMPLATE_EXAMPLES_EXPERIMENT, Mi as MODAL_CLOSE, Ni as MODAL_CONFIRM, Pl as AI_BUILDER_PLAN_MODE_EXPERIMENT, Su as getDebounceTime, Xl as FOCUSED_NODES_EXPERIMENT, Zs as dedupe, bu as THREE_DAYS_IN_MILLIS, cl as getResourcePermissions, eu as MERGE_ASK_BUILD_EXPERIMENT, ji as MODAL_CANCEL, mu as DEBOUNCE_TIME, ra as LOCAL_STORAGE_BROWSER_NOTIFICATION_METADATA, si as VIEWS, t as AutoSaveState, vc as isExpression, vu as SEVEN_DAYS_IN_MILLIS, yu as SIX_MONTHS_IN_MILLIS } from "./constants-DIP3enMx.js";
import { T as defineStore, h as assert, t as useRootStore } from "./useRootStore-BUCt9XJo.js";
import { Rn as STORES, a as getWorkflowVersionsByIds, en as getFirstAdoptionDate, i as getWorkflowVersion, n as getPublishTimeline, o as updateWorkflowHistoryVersion, ot as updateNpsSurveyState, r as getWorkflowHistory, t as useSettingsStore } from "./settings.store-B-RgkKfn.js";
...
import { E as getNewWorkflow, _ as stringSizeInBytes, t as useWorkflowsListStore, y as tryToParseNumber } from "./workflowsList.store-C7raj-u1.js";
import { t as useExternalHooks } from "./useExternalHooks-w50atkIW.js";
import { a as BUILDER_ENABLED_VIEWS, r as useChatPanelStateStore, t as useCodeDiff } from "./useCodeDiff-C_JzSdNH.js";
import { n as findPlaceholderDetails, r as formatPlaceholderPath } from "./dist-DGef5MHa.js";
