...
import { i as i18n, s as useI18n } from "./src-M_cPVtop.js";
import { A as N8nResizeWrapper_default, Ca as N8nHeading_default, Da as N8nIcon_default, Ea as N8nButton_default, Fi as MessageRating_default, Ii as Input_default, Li as N8nIconButton_default, Mi as N8nTooltip_default, Pt as DropdownMenu_default, Sa as createContext, Ta as N8nText_default, ba as useVModel, ca as CollapsibleContent_default, fa as useId, ft as Checkbox_default, ga as useForwardExpose, ia as RovingFocusGroup_default, jt as N8nActionDropdown_default, la as CollapsibleRoot_default, p as N8nScrollArea_default, ra as RovingFocusItem_default, sa as CollapsibleTrigger_default, ua as Primitive, ut as useRouter, va as useDirection, wa as N8nCallout_default, wt as N8nCard_default, ya as useResizeObserver, yi as N8nBadge_default } from "./src-D7XhL4SE.js";
...
import { t as ParameterInputList_default, x as setParameterValue } from "./ParameterInputList-CkO9ThSB.js";
import { Lt as useWorkflowsListStore, Vt as createWorkflowDocumentId, Wt as useWorkflowDocumentStore, b as useNodeTypesStore, nt as useCredentialsStore, vi as getAppNameFromCredType } from "./workflows.store-DQQfIwKi.js";
import { t as useToast } from "./useToast-DMjrW7lG.js";
import { Ei as INSTANCE_AI_COMPUTER_USE_SETUP_MODAL_KEY, Gs as deepCopy, Ti as INSTANCE_AI_BROWSER_USE_SETUP_MODAL_KEY, bl as WorkflowDocumentStoreKey, dc as isExpression, gl as ExpressionLocalResolveContextSymbol, hs as getNodeParametersIssues, ls as displayParameter, ms as getNodeParameters } from "./constants-Brs44Mbc.js";
import { D as storeToRefs, T as defineStore, t as useRootStore } from "./useRootStore-NTSmdx9S.js";
import { t as useSettingsStore } from "./settings.store-CrL-o4BC.js";
import { O as useWindowSize, b as useScroll, f as useElementHover, p as useElementSize, x as useSessionStorage } from "./core-CMxey_qZ.js";
import { f as useUIStore, p as useTelemetry } from "./users.store-ByD75lsx.js";
import { n as findPlaceholderDetails } from "./dist-1UmUUMlk.js";
import { t as require_FileSaver_min } from "./FileSaver.min--BtyQUOI.js";
import { t as usePageRedirectionHelper } from "./usePageRedirectionHelper-D51lRV1H.js";
...
import { t as NodeCredentials_default } from "./NodeCredentials-CJoElZi5.js";
...
import { t as FreeAiCreditsCallout_default } from "./FreeAiCreditsCallout-BGr8l1IW.js";
import { r as INSTANCE_AI_VIEW } from "./constants-oS_opmZd.js";
import { t as useInstanceAiSettingsStore } from "./instanceAiSettings.store-BgyfpEhy.js";
import { a as fetchThreads, i as fetchThreadMessages, n as useInstanceAiStore, r as useThread, t as provideThread } from "./instanceAi.store-DCn9jPPA.js";
import { c as isHttpRequestNodeType, t as useCredentialTestInBackground } from "./useCredentialTestInBackground-CwwNKno_.js";
import { t as CreditWarningBanner_default } from "./CreditWarningBanner-D6NIeAmF.js";
import { t as useSidebarLayout } from "./useSidebarLayout-CJghfmSt.js";
import { t as ChatMarkdownChunk_default } from "./ChatMarkdownChunk-DretmBA4.js";
import { i as useCreditWarningBanner, n as InstanceAiInput_default, r as AttachmentPreview_default, t as InstanceAiViewHeader_default } from "./InstanceAiViewHeader-Cv1YPD9D.js";
import { n as useSidebarState } from "./instanceAiLayout-CSkPXMWQ.js";
import { t as WorkflowPreview_default } from "./WorkflowPreview-BRkZKmnz.js";
import { t as DataTableTable_default } from "./DataTableTable-BVXPu6fH.js";
...
function getLatestBuilderTarget(node) {
	for (let i = node.children.length - 1; i >= 0; i--) {
		...
		if ((child.kind === "builder" || child.role === "workflow-builder") && child.targetResource?.type === "workflow" && typeof child.targetResource.id === "string") return {
...
function getLatestExecutionId(node) {
	...
	for (let i = node.toolCalls.length - 1; i >= 0; i--) {
		const tc = node.toolCalls[i];
		if (tc.toolName === "executions" && tc.args?.action === "run" && !tc.isLoading && tc.result && typeof tc.result === "object") {
			const result = tc.result;
			if (typeof result.executionId !== "string") continue;
			const buildResult = getLatestBuildResult(node);
			const args = tc.args;
			const workflowId = buildResult?.workflowId ?? (typeof args?.workflowId === "string" ? args.workflowId : void 0);
...
var shimmer$2 = "_shimmer_102cz_365";
var spin$2 = "_spin_102cz_1";
var opacityPulse$2 = "_opacityPulse_102cz_1";
var popoverIn$2 = "_popoverIn_102cz_1";
var fadeIn$2 = "_fadeIn_102cz_1";
var collapsibleSlideDown$2 = "_collapsibleSlideDown_102cz_1";
var collapsibleSlideUp$2 = "_collapsibleSlideUp_102cz_1";
var pulseGlow$2 = "_pulseGlow_102cz_1";
var pulseGlowDelayed$2 = "_pulseGlowDelayed_102cz_1";
var fade$2 = "_fade_102cz_1";
var fadeInUp$2 = "_fadeInUp_102cz_1";
var fadeInDown$2 = "_fadeInDown_102cz_1";
var fadeInLeft$2 = "_fadeInLeft_102cz_1";
var fadeInRight$2 = "_fadeInRight_102cz_1";
var fadeOut$2 = "_fadeOut_102cz_1";
var fadeOutDown$2 = "_fadeOutDown_102cz_1";
var fadeOutUp$2 = "_fadeOutUp_102cz_1";
var fadeOutLeft$2 = "_fadeOutLeft_102cz_1";
var fadeOutRight$2 = "_fadeOutRight_102cz_1";
var blinkBackground$2 = "_blinkBackground_102cz_1";
var typingBlink$2 = "_typingBlink_102cz_1";
...
var PlanReviewPanel_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props, { emit: __emit }) {
		...
		*/
		...
		const primaryActionLabelKey = computed(() => hasFeedback.value ? "instanceAi.planReview.requestChanges" : "instanceAi.planReview.approve");
		const isExpanded = ref(!props.readOnly);
		const titleKey = computed(() => isResolved.value || props.readOnly ? "instanceAi.planReview.titleResolved" : "instanceAi.planReview.title");
				...
				default: withCtx(() => [createVNode(unref(CollapsibleTrigger_default), { "as-child": "" }, {
					...
					default: withCtx(() => [createBaseVNode("div", { class: normalizeClass(_ctx.$style.tasks) }, [(openBlock(true), createElementBlock(Fragment, null, renderList(__props.plannedTasks, (task, idx) => {
						...
						default: withCtx(() => [createVNode(unref(Input_default), {
							...
							default: withCtx(() => [createTextVNode(toDisplayString(unref(i18n).baseText(primaryActionLabelKey.value)), 1)]),
							_: 1
						}, 8, ["disabled"])], 2)]),
						_: 1
					})) : createCommentVNode("", true)]),
...
var PlanReviewPanel_vue_vue_type_style_index_0_lang_module_default = {
	root: "_root_vyaej_125",
	header: "_header_vyaej_134",
	tasks: "_tasks_vyaej_143",
	taskItem: "_taskItem_vyaej_148",
	taskRow: "_taskRow_vyaej_152",
	taskNumber: "_taskNumber_vyaej_159",
	taskTitle: "_taskTitle_vyaej_173",
	taskDetail: "_taskDetail_vyaej_181",
	taskSpec: "_taskSpec_vyaej_186",
	actions: "_actions_vyaej_192"
};
...
var header$6 = "_header_mguwb_138";
...
var InstanceAiPreviewTabBar_vue_vue_type_style_index_0_lang_module_default = {
	header: "_header_ke5ie_149",
	tabList: "_tabList_ke5ie_159",
	scrollfade: "_scrollfade_ke5ie_1",
	tab: "_tab_ke5ie_159",
	label: "_label_ke5ie_198",
	tabsIndicator: "_tabsIndicator_ke5ie_206",
	tabsIndicatorBar: "_tabsIndicatorBar_ke5ie_217",
	contextMenu: "_contextMenu_ke5ie_224",
	contextMenuItem: "_contextMenuItem_ke5ie_234"
};
...
function isFixWithAiError(value) {
	return typeof value === "object" && value !== null && typeof value.nodeName === "string" && typeof value.errorMessage === "string";
}
...
var InstanceAiWorkflowPreview_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props, { expose: __expose, emit: __emit }) {
		...
		function getPreviewIframe() {
			return previewRef.value?.iframeRef ?? null;
		}
		function isMessageFromPreviewIframe(event) {
			if (event.origin !== window.location.origin) return false;
			const iframeWindow = getPreviewIframe()?.contentWindow;
			if (!iframeWindow) return false;
			return event.source === iframeWindow;
		}
		function parseWorkflowFailureErrors(errors) {
		...
		function handleIframeMessage(event) {
			...
			try {
				...
				if (json.command === "n8nReady") emit("iframe-ready");
				else if (json.command === "reportWorkflowFailures") {
					const errors = parseWorkflowFailureErrors(json.errors);
					if (errors.length === 0 || typeof json.workflowId !== "string" || typeof json.executionId !== "string") return;
			...
			return openBlock(), createElementBlock("div", {
				...
				createBaseVNode("div", { class: normalizeClass(_ctx.$style.chatContent) }, [
					...
					createBaseVNode("div", {
						...
						style: normalizeStyle({ bottom: `${scrollButtonBottomOffset.value}px` })
					}, [createVNode(Transition, { name: "scroll-button-fade" }, {
					...
					createBaseVNode("div", {
						...
						createBaseVNode("div", {
							ref: "inputSwap",
							class: normalizeClass(_ctx.$style.inputSwap)
						}, [createVNode(Transition, { name: "input-swap" }, {
				...
				default: withCtx(() => [withDirectives(createBaseVNode("div", {
					...
					default: withCtx(() => [createVNode(unref(TabsRoot_default), {
						...
						]), createBaseVNode("div", { class: normalizeClass(_ctx.$style.previewContent) }, [createVNode(InstanceAiWorkflowPreview_default, {
							ref: "workflowPreview",
...
var InstanceAiThreadView_vue_vue_type_style_index_0_lang_module_default = {
	threadArea: "_threadArea_pxai4_130",
	chatArea: "_chatArea_pxai4_145",
	canvasArea: "_canvasArea_pxai4_155",
	canvasAreaExpanded: "_canvasAreaExpanded_pxai4_181",
	headerTitle: "_headerTitle_pxai4_189",
	activeButton: "_activeButton_pxai4_197",
	reconnecting: "_reconnecting_pxai4_201",
	contentArea: "_contentArea_pxai4_205",
	artifactsPanelEdge: "_artifactsPanelEdge_pxai4_214",
	artifactsPanelSlot: "_artifactsPanelSlot_pxai4_228",
	chatContent: "_chatContent_pxai4_240",
	scrollArea: "_scrollArea_pxai4_248",
	messageList: "_messageList_pxai4_253",
	contentAreaWithPinnedArtifacts: "_contentAreaWithPinnedArtifacts_pxai4_264",
	contentAreaWithoutLayoutTransitions: "_contentAreaWithoutLayoutTransitions_pxai4_268",
	scrollButtonContainer: "_scrollButtonContainer_pxai4_272",
	inputConstraint: "_inputConstraint_pxai4_273",
	builderAgents: "_builderAgents_pxai4_277",
	scrollToBottomButton: "_scrollToBottomButton_pxai4_295",
	inputContainer: "_inputContainer_pxai4_324",
	inputSwap: "_inputSwap_pxai4_353",
	previewPanel: "_previewPanel_pxai4_357",
	previewContent: "_previewContent_pxai4_363",
	previewSlot: "_previewSlot_pxai4_369",
	previewSlotHidden: "_previewSlotHidden_pxai4_374"
};
