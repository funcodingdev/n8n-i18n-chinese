...
import { t as useLoadingService } from "./useLoadingService-D6IH609w.js";
import { Bc as getConnectionTypes, Is as classifyTriggerIdentity, Qd as EnterpriseEditionFeature, Uc as getNodeParameters, Vc as getNodeInputs, Wc as getNodeParametersIssues, bl as NodeConnectionTypes, nl as makeNodeName, ol as nodeIssuesToString, rl as mergeIssues, zc as displayParameterPath } from "./constants-BG93cxLW.js";
import { Jt as injectWorkflowExecutionStateStore, Mi as isString, _ as useNodeTypesStore, a as injectWorkflowDocumentStore, cr as hasProxyAuth, l as assignNodeId, rr as getNodeSubtitle, st as useCredentialsStore } from "./workflowDocument.store-B3DPQ4zt.js";
...
import { n as hasPermission, p as useTelemetry } from "./users.store-ZJJ-bnnb.js";
import { A as isObject } from "./workflowsList.store-BLdfruFZ.js";
...
function groupsAreEqual(a, b) {
	return a.id === b.id && a.name === b.name && a.nodeIds.length === b.nodeIds.length && a.nodeIds.every((nodeId, index) => nodeId === b.nodeIds[index]);
}
