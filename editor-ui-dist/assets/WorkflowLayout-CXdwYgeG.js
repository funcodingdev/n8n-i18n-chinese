...
import { $ as openBlock, $t as hyphenate, A as createTextVNode, C as createBaseVNode, E as createElementBlock, F as guardReactiveProps, Ft as ref, I as h, K as onBeforeMount, N as defineComponent, O as createSlots, Qt as hasOwn, R as inject, S as computed, Sn as toDisplayString, T as createCommentVNode, U as mergeProps, W as nextTick, Wt as unref, X as onMounted, _ as Fragment, _n as normalizeClass, at as resolveComponent, bt as withDirectives, c as useCssModule, en as init_shared_esm_bundler, gt as watch, it as renderSlot, j as createVNode, p as vShow, pt as useTemplateRef, q as onBeforeUnmount, rt as renderList, st as resolveDynamicComponent, tt as provide, vn as normalizeProps, w as createBlock, yn as normalizeStyle, yt as withCtx } from "./vue.runtime.esm-bundler-dg1EVmSK.js";
import { M as useLocalStorage, bt as useI18n, w as useDocumentVisibility, z as useStorage } from "./_MapCache--L8adXi_.js";
import { $i as N8nIcon_default, At as createEventBus, Bt as N8nActionDropdown_default, Gi as DropdownMenuContent_default, H as N8nRadioButtons_default, Hi as DropdownMenuTrigger_default, I as SuggestedActions_default, Ii as N8nIconButton_default, Ji as useForwardExpose, Ki as DropdownMenuRoot_default, Li as AskAssistantButton_default, Mi as N8nTooltip_default, Qi as N8nButton_default, Ti as AskAssistantAvatar_default, Ui as DropdownMenuPortal_default, Ut as N8nBadge_default, Wi as DropdownMenuItem_default, Z as N8nTag_default, Zi as N8nText_default, _t as useRouter, bt as N8nFloatingWindow_default, gt as useRoute, h as N8nInlineTextEdit_default, j as N8nUserStack_default, m as N8nScrollArea_default, n as DropdownMenu_default, na as __vitePreload, qi as Primitive, ut as RouterLink } from "./src-DWsTOZiq.js";
import { t as __plugin_vue_export_helper_default } from "./_plugin-vue_export-helper-DltO58Gh.js";
import "./sanitize-html-JHjOJhXQ.js";
import { Ai as ResourceType, Ar as useSourceControlStore, As as useSettingsStore, E as useEvaluationStore, Er as useStyles, Et as useWorkflowHelpers, Ft as useProjectsStore, Gr as useWorkflowsListStore, Ii as getActivatableTriggerNodes, It as ProjectTypes, Nr as useWorkflowHistoryStore, Pr as require_FileSaver_min, Ra as PROJECT_MOVE_RESOURCE_MODAL, Tr as useToast, aa as useWorkflowDocumentStore, an as useWorkflowState, cn as useBuilderStore, dn as nodeViewEventBus, en as useTelemetry, gr as hasPermission, ia as injectWorkflowDocumentStore, in as injectWorkflowState, jr as useMessage, kt as useTagsStore, ll as getBannerRowHeight, na as createWorkflowDocumentId, nn as telemetry, r as useUIStore, rn as useNDVStore, s as useWorkflowsStore, t as useUsersStore, vn as useDocumentTitle, w as useNodeTypesStore, xn as useWorkflowSaveStore, yn as useWorkflowSaving } from "./users.store-Sw4oHdJA.js";
import "./MainSidebarHeader-Rs5x5voB.js";
import { t as BaseLayout_default } from "./BaseLayout-DhKrLKTx.js";
import { $s as WORKFLOW_PUBLISH_MODAL_KEY, Bc as WorkflowStateKey, Cs as DUPLICATE_MODAL_KEY, Gs as WORKFLOW_DESCRIPTION_MODAL_KEY, Gt as CHAT_TRIGGER_NODE_TYPE, Ic as PopOutWindowKey, Ps as MODAL_CONFIRM, Qs as WORKFLOW_HISTORY_VERSION_UNPUBLISH, Rc as WorkflowDocumentStoreKey, T as TIME_SAVED_DOCS_URL, Uo as v4_default, Vl as WORKFLOW_MENU_ACTIONS, Ws as WORKFLOW_ACTIVE_MODAL_KEY, Ys as WORKFLOW_HISTORY_NAME_VERSION_MODAL_KEY, _ as EVALUATIONS_DOCS_URL, cn as ERROR_TRIGGER_NODE_TYPE, dc as LOCAL_STORAGE_FLOATING_CHAT_WINDOW, ec as WORKFLOW_SETTINGS_MODAL_KEY, g as ERROR_WORKFLOW_DOCS_URL, gr as STICKY_NODE_TYPE, is as getResourcePermissions, ks as IMPORT_WORKFLOW_URL_MODAL_KEY, ml as EnterpriseEditionFeature, ms as VIEWS, o as MAX_WORKFLOW_NAME_LENGTH, pc as LOCAL_STORAGE_HIDE_GITHUB_STAR_BUTTON, ps as MAIN_HEADER_TABS, t as AutoSaveState, tc as WORKFLOW_SHARE_MODAL_KEY, xr as TIME_SAVED_NODE_TYPE, y as N8N_MAIN_GITHUB_REPO_URL, yl as LOADING_ANIMATION_MIN_DURATION } from "./constants-C3KfTTly.js";
...
import { t as useExecutionsStore } from "./executions.store-_7d9ev4e.js";
...
import { t as usePushConnectionStore } from "./pushConnection.store-_XKDoJMI.js";
...
import "./roles.store-KjJMcXe5.js";
...
import { t as sanitizeFilename } from "./dist-Cr8e5O4w.js";
import "./sso.store-C8MipFKD.js";
import { t as router_default } from "./router-v7YxjPPx.js";
import "./insights.store-B7tVaRB_.js";
import "./insights.constants-C04mDAF4.js";
import "./insights.utils-CfQFR8AJ.js";
import { a as MCP_DOCS_PAGE_URL, s as MCP_SETTINGS_VIEW } from "./mcp.constants-CGgceGwF.js";
import "./sourceControl.eventBus-DYVcoqbk.js";
import { i as getLastPublishedVersion, r as generateVersionLabelFromId } from "./utils-iVaT1CR8.js";
...
import { f as groupConversationsByDate, l as flattenModel, t as useChatStore } from "./chat.store-BY9l4tKS.js";
import { t as useProvideWorkflowId } from "./useProvideWorkflowId-BvMsklSG.js";
import { t as LoadingView_default } from "./LoadingView-GxEzDdnM.js";
import "./useSettingsItems-Bs6C2kT6.js";
import { t as ChatAgentAvatar_default } from "./ChatAgentAvatar-CVUEsKPv.js";
...
import { i as usePopOutWindow, n as useWorkflowInitialization, r as LogsPanel_default, t as usePostMessageHandler } from "./usePostMessageHandler-CIDFvutq.js";
...
import { a as useChatSession, n as ChatPrompt_default, r as ChatMessage_default, t as ChatGreetings_default } from "./ChatGreetings-CYfZgnFO.js";
import { n as useFileDrop } from "./ToolsSelector-B8Fj9UNZ.js";
import "./ProjectBreadcrumb-C0gTYKLb.js";
import { t as FolderBreadcrumbs_default } from "./FolderBreadcrumbs-YSyJcBhH.js";
import { t as ConnectionTracker_default } from "./ConnectionTracker-DmiemZDc.js";
import { t as useWorkflowSettingsCache } from "./useWorkflowsCache-DnLPW3B0.js";
import { t as usePushConnection } from "./usePushConnection-Bli3X-9V.js";
...
var CanvasChatSessionDropdown_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props, { emit: __emit }) {
		...
		async function handleOpenChange(open$1) {
			isOpen.value = open$1;
			if (open$1 && !hasFetchedForWorkflow.value) {
		...
		watch(isOpen, (open$1, _oldValue, onCleanup) => {
			const target = portalTarget.value;
			if (!target || !open$1) return;
				...
				default: withCtx(() => [createVNode(unref(DropdownMenuTrigger_default), {
					...
					default: withCtx(() => [createVNode(unref(DropdownMenuContent_default), {
						...
						default: withCtx(() => [isLoading.value ? (openBlock(), createElementBlock("div", {
							...
							_: 1
						})], 2)) : (openBlock(true), createElementBlock(Fragment, { key: 2 }, renderList(groupedSessions.value, (group$2) => {
							return openBlock(), createBlock(unref(DropdownMenuGroup_default), {
								...
								default: withCtx(() => [createVNode(unref(DropdownMenuLabel_default), { class: normalizeClass(_ctx.$style.groupLabel) }, {
									default: withCtx(() => [createTextVNode(toDisplayString(group$2.group), 1)]),
									_: 2
								}, 1032, ["class"]), (openBlock(true), createElementBlock(Fragment, null, renderList(group$2.sessions, (session) => {
...
var CanvasChatSessionDropdown_vue_vue_type_style_index_0_lang_module_default = {
	trigger: "_trigger_1wl1x_125",
	triggerText: "_triggerText_1wl1x_141",
	chevron: "_chevron_1wl1x_147",
	open: "_open_1wl1x_151",
	content: "_content_1wl1x_155",
	slideDown: "_slideDown_1wl1x_1",
	slideUp: "_slideUp_1wl1x_1",
	emptyState: "_emptyState_1wl1x_174",
	group: "_group_1wl1x_179",
	groupLabel: "_groupLabel_1wl1x_183",
	sessionItem: "_sessionItem_1wl1x_191",
	active: "_active_1wl1x_209",
	sessionTitle: "_sessionTitle_1wl1x_213"
};
var CanvasChatSessionDropdown_default = /* @__PURE__ */ __plugin_vue_export_helper_default(CanvasChatSessionDropdown_vue_vue_type_script_setup_true_lang_default, [["__cssModules", { "$style": CanvasChatSessionDropdown_vue_vue_type_style_index_0_lang_module_default }]]);
var CanvasChatHubPanel_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props, { expose: __expose, emit: __emit }) {
		...
		const sessionId = ref(v4_default());
		...
		const { chatMessages, isResponding, isNewSession: isNewSession$1, messagingState, arrivedState, scrollToBottom, loadSession } = useChatSession({
			sessionId,
			scrollableRef
		});
		...
		function handleNewSession() {
			telemetry$1.track("User clicked new chat button", { source: "canvas" });
			sessionId.value = v4_default();
		}
		...
		async function onSubmit(message, attachments) {
			...
			await chatStore.sendMessage(sessionId.value, message, workflowAgent.value, {}, attachments);
		...
		async function handleRegenerateMessage(message) {
			...
			await chatStore.regenerateMessage(sessionId.value, message.id, workflowAgent.value, {});
		}
		...
		async function handleEditMessage(content$1, keptAttachmentIndices, newFiles) {
			...
			await chatStore.editMessage(sessionId.value, editingMessageId.value, content$1, workflowAgent.value, {}, keptAttachmentIndices, newFiles);
			editingMessageId.value = void 0;
		}
		function handleSelectPrompt(prompt$1) {
			if (workflowAgent.value) telemetry$1.track("User clicked chat hub suggested prompt", {
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("div", {
				...
				createVNode(unref(N8nScrollArea_default), {
					...
					}, [unref(isNewSession$1) ? (openBlock(), createElementBlock("div", {
						key: 0,
					...
					}), 128))], 2)), createBaseVNode("div", { class: normalizeClass(_ctx.$style.promptContainer) }, [!unref(arrivedState).bottom && !unref(isNewSession$1) ? (openBlock(), createBlock(unref(N8nIconButton_default), {
						key: 0,
						variant: "subtle",
						icon: "arrow-down",
...
var CanvasChatHubPanel_default = /* @__PURE__ */ __plugin_vue_export_helper_default(CanvasChatHubPanel_vue_vue_type_script_setup_true_lang_default, [["__cssModules", { "$style": CanvasChatHubPanel_vue_vue_type_style_index_0_lang_module_default }]]);
	...
	setup(__props, { emit: __emit }) {
		...
		const sessionChildren = computed(() => {
			...
			for (let i = 0; i < grouped.length; i++) {
				...
				for (const session of group$2.sessions) items.push({
					id: session.id,
					label: session.id,
		...
		async function handleSubMenuToggle(itemId, open$1) {
			if (itemId === "sessions" && open$1 && !hasFetchedForWorkflow.value) {
				hasFetchedForWorkflow.value = true;
				isLoading.value = true;
				try {
					await chatStore.fetchSessions(true, { type: "manual" });
...
var CanvasChatFloatingWindow_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props, { expose: __expose, emit: __emit }) {
		...
		watch(() => canvasChatHubRef.value, async (ref$1) => {
			if (ref$1) {
				await nextTick();
				ref$1.focusInput();
			}
...
var CanvasChatFloatingWindow_default = /* @__PURE__ */ __plugin_vue_export_helper_default(CanvasChatFloatingWindow_vue_vue_type_script_setup_true_lang_default, [["__cssModules", { "$style": CanvasChatFloatingWindow_vue_vue_type_style_index_0_lang_module_default }]]);
var CanvasChatOverlay_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props, { expose: __expose }) {
		...
		const popOutContainer$1 = useTemplateRef("popOutContainer");
		...
		usePopOutWindow({
			title: computed(() => `Chat - ${workflowsStore.workflowName || "Workflow"}`),
			initialWidth: 560,
			initialHeight: 700,
			container: popOutContainer$1,
...
var CanvasChatOverlay_default = /* @__PURE__ */ __plugin_vue_export_helper_default(CanvasChatOverlay_vue_vue_type_script_setup_true_lang_default, [["__cssModules", { "$style": CanvasChatOverlay_vue_vue_type_style_index_0_lang_module_default }]]);
...
var WorkflowProductionChecklist_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		...
		const isErrorWorkflow = computed(() => {
			return props.workflow.nodes.some((node) => node.type === "n8n-nodes-base.errorTrigger" && node.disabled !== true);
		});
		...
		function handlePopoverOpenChange(open$1) {
			if (open$1) {
				isPopoverOpen.value = true;
				onPopoverOpened();
...
var WorkflowHeaderDraftPublishActions_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props, { expose: __expose }) {
		...
		const workflowPublishState = computed(() => {
			...
			const hasChanges = workflowsStore.workflow.versionId !== activeVersion.value?.versionId || uiStore.hasUnsavedWorkflowChanges;
...
var WorkflowDetails_default = /* @__PURE__ */ __plugin_vue_export_helper_default(WorkflowDetails_vue_vue_type_script_setup_true_lang_default, [["__cssModules", { "$style": WorkflowDetails_vue_vue_type_style_index_1_lang_module_default }], ["__scopeId", "data-v-322dd907"]]);
	...
	setup(__props) {
		...
		return (_ctx, _cache) => {
			...
			return openBlock(), createBlock(BaseLayout_default, null, createSlots({
				...
				overlays: withCtx(() => [unref(assistantStore).isFloatingButtonShown ? (openBlock(), createBlock(AskAssistantFloatingButton_default, { key: 0 })) : createCommentVNode("", true), unref(chatHubPanelStore).isFloatingChatEnabled ? (openBlock(), createBlock(CanvasChatOverlay_default, { key: 1 })) : createCommentVNode("", true)]),
