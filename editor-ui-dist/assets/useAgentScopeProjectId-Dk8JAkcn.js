...
import { c as sanitizeHtml } from "./htmlUtils-BREJ7rCe.js";
import { mn as useProjectsStore, w as injectWorkflowDocumentStore, xt as useCredentialsStore } from "./workflows.store-qPELvTeV.js";
...
import { D as listAgentsPage, f as getAgent } from "./useAgentApi-B-rs6uPa.js";
...
function useQuickConnect() {
	...
	async function connectToPinecone(quickConnectOption) {
		const { ConnectPopup } = await __vitePreload(async () => {
			const { ConnectPopup } = await import("./dist-CCQAi1pY.js");
			return { ConnectPopup };
		}, []);
