...
import { $ as openBlock, A as createTextVNode, C as createBaseVNode, E as createElementBlock, F as guardReactiveProps, Ft as ref, H as mergeModels, N as defineComponent, S as computed, Sn as toDisplayString, T as createCommentVNode, Wt as unref, X as onMounted, _ as Fragment, _n as normalizeClass, dt as useModel, j as createVNode, rt as renderList, vn as normalizeProps, w as createBlock, yt as withCtx } from "./vue.runtime.esm-bundler-Bw8GKr4Y.js";
import { c as I18nT, s as useI18n } from "./src-M_cPVtop.js";
import { At as N8nActionToggle_default, Ca as N8nHeading_default, Da as N8nIcon_default, Ea as N8nButton_default, Ii as Input_default, Mi as N8nTooltip_default, R as N8nNotice_default, Ta as N8nText_default, h as N8nDataTableServer_default, jt as N8nActionDropdown_default, kt as Alert_default, nt as N8nLink_default, x as N8nUserInfo_default, zi as N8nActionBox_default } from "./src-D7XhL4SE.js";
...
import { Ma as ROLE, fu as getDebounceTime, iu as DEBOUNCE_TIME, lo as USERS_LIST_SORT_OPTIONS, nu as EnterpriseEditionFeature } from "./constants-Brs44Mbc.js";
import { t as useSettingsStore } from "./settings.store-CrL-o4BC.js";
import { G as useDebounceFn } from "./core-CMxey_qZ.js";
import { St as INVITE_USER_MODAL_KEY, at as DELETE_USER_MODAL_KEY, f as useUIStore, n as hasPermission, t as useUsersStore } from "./users.store-ByD75lsx.js";
...
import { r as formatTimeAgo } from "./dateFormatter-eYz18H4X.js";
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("div", null, [isEditable.value ? (openBlock(), createBlock(unref(N8nActionDropdown_default), {
				...
				activator: withCtx(() => [createBaseVNode("button", {
					...
					default: withCtx(() => [createTextVNode(toDisplayString(roleLabel.value), 1)]),
					_: 1
				...
				_: 1
			}, 8, ["items", "disabled"])) : (openBlock(), createElementBlock("span", _hoisted_2, toDisplayString(roleLabel.value), 1))]);
		};
	}
});
