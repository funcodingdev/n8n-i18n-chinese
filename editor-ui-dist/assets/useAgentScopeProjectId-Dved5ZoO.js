...
import { hn as useProjectsStore, w as injectWorkflowDocumentStore, xt as useCredentialsStore } from "./workflows.store-BSTkwdxQ.js";
...
import { T as listAgentsPage, d as getAgent } from "./useAgentApi-sdUpTCk-.js";
...
function useQuickConnect() {
	...
	async function connectToPinecone(quickConnectOption) {
		const { ConnectPopup } = await __vitePreload(async () => {
			const { ConnectPopup } = await import("./dist-CcsU9FpN.js");
			return { ConnectPopup };
		}, []);
