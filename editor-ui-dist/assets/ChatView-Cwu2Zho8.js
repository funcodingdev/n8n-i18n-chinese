...
import { m as useEventListener, o as useActiveElement, ot as useI18n, p as useElementSize, st as I18nT, v as useLocalStorage, y as useMediaQuery } from "./core-Ia_y23ne.js";
...
import { Qd as EnterpriseEditionFeature, _a as LOCAL_STORAGE_CHAT_HUB_HAD_CONVERSATION_BEFORE, fo as chatHubConversationModelSchema, fu as v4, hi as VIEWS, io as ROLE, lo as PROVIDER_CREDENTIAL_TYPE_MAP, va as LOCAL_STORAGE_CHAT_HUB_SELECTED_MODEL } from "./constants-CSBjw1Ht.js";
import { Pr as shouldIgnoreCanvasShortcut } from "./workflowDocument.store-COBWkqWz.js";
import { t as useRootStore } from "./useRootStore-hyBq4XlJ.js";
import { t as useSettingsStore } from "./settings.store-C5bX9q6f.js";
import { Et as INVITE_USER_MODAL_KEY, f as useUIStore, n as hasPermission, p as useTelemetry, t as useUsersStore, u as hasRole } from "./users.store-UZbGTg0q.js";
...
import { a as authorizeDynamicCredential, i as collectChatArtifacts, l as fetchWorkflowExecutionStatus, t as useChatStore, u as revokeDynamicCredential } from "./chat.store-Bma7mVNl.js";
import { T as unflattenModel, _ as isLlmProvider, c as findOneFromModelsResponse, l as flattenModel } from "./chat.utils-BATiJuk9.js";
...
import { n as useChatCredentials, r as chatHubConversationModelWithCachedDisplayNameSchema, t as ChatLayout_default } from "./ChatLayout-SXB_CwO2.js";
import { n as ModelSelector_default, t as useCustomAgent } from "./useCustomAgent-CIf8MG6J.js";
