import { It as ref, Nt as onScopeDispose, Pt as reactive, S as computed, gt as watch } from "./vue.runtime.esm-bundler-Bs4WIMNP.js";
...
import { an as useEnvironmentsStore, t as useWorkflowsStore, vt as useCredentialsStore } from "./workflows.store-w-uLno6O.js";
import { i as defineStore } from "./constants-DwjrKqNn.js";
import { t as STORES } from "./constants2-D6qsHKVK.js";
import { Ji as OPEN_AI_API_CREDENTIAL_TYPE, fi as deepCopy } from "./src-UnL6BUww.js";
...
import { io as READY_TO_RUN_V2_P3_EXPERIMENT } from "./constants-On-mUxgN.js";
import { t as VIEWS } from "./views-4JHVC4Nc.js";
import { n as useTelemetry, t as usePostHog } from "./posthog.store-BBCCmZh6.js";
...
var useProjectPages = () => {
	...
	return reactive({
		...
		isProjectsSubPage,
		isWorkflowReviewsSubPage: computed(() => route.name === WORKFLOW_REVIEW_REQUESTS_VIEW)
	});
};
//#endregion
...
function useEmptyStateDetection() {
	...
	*/
	const hasKnownInstanceContent = computed(() => foldersStore.totalWorkflowCount > 0 || credentialsStore.allCredentials.length > 0 || environmentsStore.variables.length > 0 || dataTableStore.totalCount > 0);
	/**
	...
	*/
	const isTrulyEmpty = (currentRoute = route) => {
		...
		return hasNoWorkflows && hasNoCredentials && hasNoVariables && hasNoDataTables && isNotInSpecificFolder && isMainWorkflowsPage && !hasSearchQuery && !hasFilters;
	};
	return {
		isTrulyEmpty,
...
//#endregion
//#region src/experiments/readyToRunWorkflowsV2/workflows/ai-workflow-v5.ts
var READY_TO_RUN_WORKFLOW_V5 = {
...
//#endregion
//#region src/experiments/readyToRunWorkflowsV2/workflows/ai-workflow-v6.ts
var READY_TO_RUN_WORKFLOW_V6 = {
	name: "Chat with the news",
...
var useReadyToRunWorkflowsV2Store = defineStore(STORES.EXPERIMENT_READY_TO_RUN_WORKFLOWS_V2, () => {
...
var useReadyToRunStore = defineStore(STORES.READY_TO_RUN, () => {
	...
	watch(() => usersStore.currentUser?.createdAt, () => {
		currentTimeForNewUserCheck.value = Date.now();
	...
	const isNewUser = () => {
		const createdAtMs = getCurrentUserCreatedAtMs();
		if (createdAtMs === void 0) return false;
	...
	const getButtonVisibility = (hasWorkflows, canCreate, readOnlyEnv) => {
		return userCanClaimOpenAiCredits.value && !readOnlyEnv && canCreate && hasWorkflows && isNewUser();
	};
...
//#endregion
export { READY_TO_RUN_AI_WORKFLOW as a, useProjectPages as i, READY_TO_RUN_WORKFLOW_V5 as n, useEmptyStateDetection as r, useReadyToRunStore as t };
