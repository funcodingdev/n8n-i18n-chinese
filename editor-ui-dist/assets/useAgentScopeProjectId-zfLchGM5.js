...
import { d as useMessage, v as sanitizeHtml } from "./src-DmQRaDBt.js";
import { f as __vitePreload } from "./get-Ult7GPGC.js";
import { t as useToast } from "./useToast-BvIdHb4k.js";
import { Tn as useProjectsStore, a as injectWorkflowDocumentStore, ct as useCredentialsStore } from "./workflowDocument.store-CJmrbFRO.js";
...
import { E as listAgentsPage, d as getAgent } from "./useAgentApi-BIFgj2MA.js";
...
function useQuickConnect() {
	...
	async function connectToPinecone(quickConnectOption) {
		const { ConnectPopup } = await __vitePreload(async () => {
			const { ConnectPopup } = await import("./dist-Cmm6t79P.js");
			return { ConnectPopup };
		}, []);
