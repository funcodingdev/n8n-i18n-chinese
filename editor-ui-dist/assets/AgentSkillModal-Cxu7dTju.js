...
import { Ga as N8nHeading_default, Ja as N8nButton_default, Ya as N8nIcon_default, ct as N8nFormInput_default, f as Dialog_default, m as DialogHeader_default, p as DialogTitle_default, qa as N8nText_default, t as MarkdownEditor_default, vt as N8nInputLabel_default, zi as N8nTooltip_default } from "./src-CSWS3PCK.js";
import { t as _plugin_vue_export_helper_default } from "./_plugin-vue_export-helper-Da88TEg1.js";
import { Do as AGENT_SKILL_REFERENCE_CONTENT_MAX_BYTES, To as AGENT_SKILL_INSTRUCTIONS_MAX_LENGTH } from "./constants-BpExsFUJ.js";
import { f as useUIStore } from "./users.store-D_2YlqZ_.js";
import { t as Modal_default } from "./Modal-BiRNIpE3.js";
...
import { t as formatToolNameForDisplay } from "./toolDisplayName-CIAznXnj.js";
...
var AgentSkillViewer_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props, { emit: __emit }) {
		...
		const instructionsError = computed(() => {
			...
			if (value.length > 65536) return i18n.baseText("agents.builder.skills.validation.instructionsMaxLength", { interpolate: { max: String(AGENT_SKILL_INSTRUCTIONS_MAX_LENGTH) } });
			return "";
		});
		const instructionsValid = computed(() => Boolean((props.skill.instructions ?? "").trim()) && !instructionsError.value);
		const referenceBytes = (reference) => new TextEncoder().encode(reference.content).byteLength;
	...
	setup(__props) {
		...
		return (_ctx, _cache) => {
			return openBlock(), createBlock(Modal_default, {
				...
				content: withCtx(() => [createBaseVNode("div", { class: normalizeClass(_ctx.$style.content) }, [createVNode(AgentSkillFileNav_default, {
					skill: skill.value,
