import { $ as openBlock, A as createTextVNode, C as createBaseVNode, Cn as toDisplayString, E as createElementBlock, Gt as unref, It as ref, N as defineComponent, S as computed, T as createCommentVNode, W as nextTick, X as onMounted, _ as Fragment, bn as normalizeStyle, bt as withCtx, gt as watch, h as withModifiers, j as createVNode, n as Transition, q as onBeforeUnmount, rt as renderList, tt as provide, vn as normalizeClass, w as createBlock } from "./vue.runtime.esm-bundler-Bs4WIMNP.js";
import { s as useI18n } from "./src-BbFnYWoQ.js";
import { Ja as N8nButton_default, Ka as N8nCallout_default, L as N8nRecycleScroller_default, Ui as Input_default, V as N8nPopover_default, Vt as DropdownMenu_default, Wi as N8nIconButton_default, Ya as N8nIcon_default, _t as useRouter, gt as useRoute, it as N8nHoverCard_default, jt as N8nCard_default, qa as N8nText_default, qi as truncate, x as N8nBreadcrumbs_default, zi as N8nTooltip_default } from "./src-XWsjz-dU.js";
import { t as _plugin_vue_export_helper_default } from "./_plugin-vue_export-helper-Da88TEg1.js";
import { m as useEventListener, o as useActiveElement } from "./core-CxAuVuwP.js";
import { t as useToast } from "./useToast-CknWykz4.js";
import { Wr as AGENT_BUILDER_VIEW, Xr as AGENT_SESSION_DETAIL_VIEW, di as VIEWS, ed as WorkflowIdKey, gs as Workflow, ii as EXECUTIONS_SECTION_KEY } from "./constants-BaNoJas_.js";
import { Mt as useWorkflowHelpers, _ as useNodeTypesStore, cn as useWorkflowsStore, jr as shouldIgnoreCanvasShortcut, qt as useWorkflowExecutionStateStore, r as createWorkflowDocumentId, xn as useProjectsStore } from "./workflowDocument.store-w7RlTwH2.js";
import { t as useExecutionsStore } from "./executions.store-Ds6eCfaz.js";
import { i as NodeErrorView_default, t as RunData_default } from "./RunData-BeuF63mm.js";
import { x as ChatSymbol } from "./useCanvasOperations-D3dvY0Rs.js";
import { t as VueMarkdown } from "./VueMarkdown-CTYSjyal.js";
import { t as convertToDisplayDate } from "./dateFormatter-DYkOQ7d8.js";
import { d as flattenLogEntries, g as getSubtreeTotalConsumedTokens, o as createLogTree, t as LogsOverviewRow_default, w as isNodeLog } from "./LogsOverviewRow-XBWP4X7G.js";
...
import { m as parseIntegrationActionCard, o as isDelegateSubAgentTool, r as delegateLabel, t as useSubAgentNames, u as resolveSubAgentName } from "./useSubAgentNames-PnCMfC5Y.js";
...
var ToolIoView_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		...
		onMounted(async () => {
			...
			await nodeTypesStore.loadNodeTypesIfNotLoaded();
			if (unmounted) return;
			useWorkflowExecutionStateStore(createWorkflowDocumentId(workflowsStore.workflowId)).setWorkflowExecutionData(synthExecution.value);
		});
		onBeforeUnmount(() => {
			unmounted = true;
			useWorkflowExecutionStateStore(createWorkflowDocumentId(workflowsStore.workflowId)).setWorkflowExecutionData(previousWorkflowExecutionData);
