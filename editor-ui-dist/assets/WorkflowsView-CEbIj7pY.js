...
import { $ as openBlock, A as createTextVNode, C as createBaseVNode, E as createElementBlock, Ft as ref, Mt as onScopeDispose, N as defineComponent, O as createSlots, S as computed, Sn as toDisplayString, T as createCommentVNode, Wt as unref, X as onMounted, Z as onUnmounted, _ as Fragment, _n as normalizeClass, at as resolveComponent, bt as withDirectives, gt as watch, h as withModifiers, it as renderSlot, j as createVNode, m as withKeys, n as Transition, p as vShow, pt as useTemplateRef, q as onBeforeUnmount, rt as renderList, w as createBlock, yn as normalizeStyle, yt as withCtx } from "./vue.runtime.esm-bundler-dg1EVmSK.js";
import { bt as useI18n } from "./_MapCache-C80pWp05.js";
import { Ai as N8nPromptInput_default, Bi as Input_default, Bt as N8nLoading_default, D as N8nBreadcrumbs_default, Dt as N8nOption_default, Et as N8nSelect_default, Li as N8nTooltip_default, P as N8nTags_default, Pt as N8nCard_default, Ui as N8nActionBox_default, Wt as N8nBadge_default, _t as useRoute, bt as Checkbox_default, ea as N8nHeading_default, h as N8nInlineTextEdit_default, ia as N8nIcon_default, jt as createEventBus, na as N8nText_default, nt as N8nInfoTip_default, ra as N8nButton_default, ta as N8nCallout_default, ut as N8nLink_default, vt as useRouter, yt as N8nInputLabel_default, zt as N8nActionToggle_default } from "./src-DXhOkTfb.js";
import { t as __plugin_vue_export_helper_default } from "./_plugin-vue_export-helper-DltO58Gh.js";
import "./sanitize-html-JHjOJhXQ.js";
import { $a as ILLEGAL_FOLDER_CHARACTERS, Bn as useMessage, Fn as trackTemplatesClick, In as useCloudPlanStore, Is as useSettingsStore, Jt as useTemplatesStore, Ln as useToast, Nn as TemplateClickSource, Qa as FOLDER_NAME_ONLY_DOTS_REGEX, Sr as useStorage, Xa as FOLDER_NAME_ILLEGAL_CHARACTERS_REGEX, Ya as FOLDER_LIST_ITEM_ACTIONS, Za as FOLDER_NAME_MAX_LENGTH, ai as ResourceType, ao as COMMUNITY_PLUS_ENROLLMENT_MODAL, ar as useTagsStore, at as useCredentialsStore, di as useSourceControlStore, et as sublimeSearch, gr as useTelemetry, ml as STORES, r as useUIStore, s as useWorkflowsStore, t as useUsersStore, to as CREDENTIAL_EDIT_MODAL_KEY, ui as useProjectsStore, ur as useWorkflowsListStore, w as useNodeTypesStore, xi as ProjectTypes, yr as usePostHog, z as removePreviewToken, zt as useDocumentTitle } from "./users.store-bYJP9NEL.js";
import { $s as WORKFLOW_HISTORY_VERSION_UNPUBLISH, Es as EXPERIMENT_TEMPLATE_RECO_V3_KEY, Fs as MODAL_CONFIRM, Tl as getDebounceTime, Ts as EXPERIMENT_TEMPLATE_RECO_V2_KEY, Zc as CREDENTIALS_APP_SELECTION_EXPERIMENT, _l as DEBOUNCE_TIME, as as getResourcePermissions, dl as TEMPLATE_ONBOARDING_EXPERIMENT, eo as jsonParse, go as NodeConnectionTypes, hs as VIEWS, i as DEFAULT_WORKFLOW_PAGE_SIZE, ml as EnterpriseEditionFeature, nc as WORKFLOW_SHARE_MODAL_KEY, uc as LOCAL_STORAGE_EXPERIMENTAL_DISMISSED_SUGGESTED_WORKFLOWS, ws as DUPLICATE_MODAL_KEY, zo as PROJECT_ROOT } from "./constants-neq36s1h.js";
import "./merge-CyZj1oIp.js";
import { N as storeToRefs, j as defineStore } from "./_baseOrderBy-2EL3KkTw.js";
import { t as useBannersStore } from "./banners.store-CKpLP5cC.js";
import { t as require_dateformat } from "./dateformat-BPRsPKQE.js";
import { n as require_debounce, t as useDebounce } from "./useDebounce-CnJGc_VC.js";
...
import { n as useInstallNode, t as ContactAdministratorToInstall_default } from "./ContactAdministratorToInstall-BJbp5MNw.js";
import "./ProjectIcon-CtM0xS-Y.js";
import { t as ProjectCardBadge_default } from "./ProjectCardBadge-DQoz0cJJ.js";
import { t as useUsageStore } from "./usage.store-omSebc2e.js";
import "./DropdownMenu-BQHHdEM4.js";
import "./EnterpriseEdition.ee-DNWy3XHP.js";
import { t as useDynamicCredentials } from "./useDynamicCredentials-DRUKdpnL.js";
import { t as Draggable_default } from "./Draggable-CPyRg6w8.js";
...
import { t as TimeAgo_default } from "./TimeAgo-_rOupibz.js";
import "./ProjectSharing-DbQOGJlT.js";
import { t as useFoldersStore } from "./folders.store-9rCuieqg.js";
import "./TagsDropdown-VXQr2woF.js";
import { t as WorkflowTagsDropdown_default } from "./WorkflowTagsDropdown-Bwb-C41f.js";
import { t as useInsightsStore } from "./insights.store-CgrT9uMG.js";
import "./insights.constants-BP-1RQcW.js";
import "./insights.utils-C7DClurT.js";
import { t as useMcp } from "./useMcp-Cmgxl1UJ.js";
import { n as usePersonalizedTemplatesV3Store, r as usePersonalizedTemplatesV2Store, t as require_shuffle } from "./shuffle-C005NTbh.js";
import { t as useWorkflowActivate } from "./useWorkflowActivate-D0q0QDn1.js";
import "./values-DrrxCaU7.js";
import { r as useProjectPages, t as useReadyToRunStore } from "./readyToRun.store-DMFQZQY9.js";
import { t as useAITemplatesStarterCollectionStore } from "./aiTemplatesStarterCollection.store-slvsF2bb.js";
import { t as useReadyToRunWorkflowsStore } from "./readyToRunWorkflows.store-B9Onn6Qi.js";
import "./ProjectBreadcrumb-DuaZcD8o.js";
import { t as FolderBreadcrumbs_default } from "./FolderBreadcrumbs-_hdNmbuJ.js";
import { t as useEmptyStateBuilderPromptStore } from "./emptyStateBuilderPrompt.store-DUQ0hjwD.js";
import { t as EmptySharedSectionActionBox_default } from "./EmptySharedSectionActionBox-B-mmwg0H.js";
import { t as ResourcesListLayout_default } from "./ResourcesListLayout-CN9NrOl8.js";
import "./ResourceFiltersDropdown-jbppmxp0.js";
import { n as ReadyToRunButton_default, t as ProjectHeader_default } from "./ProjectHeader-DLJYH9Y0.js";
import { n as useDependencies, t as DependencyPill_default } from "./DependencyPill-Con28UzL.js";
import { t as useMCPStore } from "./mcp.store-2hIsVgtx.js";
import { n as NUMBER_OF_TEMPLATES, r as useRecommendedTemplatesStore, t as RecommendedTemplateCard_default } from "./RecommendedTemplateCard-CTEFCp-b.js";
import { n as verified_default, t as shield_alt_default } from "./shield-alt-DipLYUUV.js";
import { t as InsightsSummary_default } from "./InsightsSummary-CnzDesq1.js";
	...
	setup(__props, { emit: __emit }) {
		...
		async function toggleMCPAccess(enabled) {
			try {
				...
				toast.showError(error$1, locale.baseText("workflowSettings.toggleMCP.error.title"));
				return;
			}
		}
		async function deleteWorkflow() {
			...
			try {
				...
				toast.showError(error$1, locale.baseText("generic.deleteWorkflowError"));
				return;
			}
			toast.showMessage({
		...
		async function archiveWorkflow() {
			...
			try {
				...
				toast.showError(error$1, locale.baseText("generic.archiveWorkflowError"));
				return;
			}
			toast.showMessage({
		...
		async function unarchiveWorkflow() {
			try {
				...
				toast.showError(error$1, locale.baseText("generic.unarchiveWorkflowError"));
				return;
			}
			toast.showMessage({
		...
		return (_ctx, _cache) => {
			return openBlock(), createBlock(unref(N8nCard_default), {
				...
				default: withCtx(() => [createBaseVNode("div", { class: normalizeClass(_ctx.$style.cardDescription) }, [
					...
					withDirectives(createBaseVNode("span", null, [createTextVNode(toDisplayString(unref(locale).baseText("workflows.item.created")) + " " + toDisplayString(formattedCreatedAtDate.value) + " ", 1), props.isMcpEnabled && isAvailableInMCP.value ? (openBlock(), createElementBlock("span", _hoisted_1$6, "|")) : createCommentVNode("", true)], 512), [[vShow, __props.data]]),
...
const cardLink = "_cardLink_z50zt_125";
const cardHeading = "_cardHeading_z50zt_135";
const cardHeadingArchived = "_cardHeadingArchived_z50zt_143";
const cardDescription = "_cardDescription_z50zt_151";
const cardTags = "_cardTags_z50zt_161";
const cardActions = "_cardActions_z50zt_166";
const cardBadge = "_cardBadge_z50zt_177";
const cardArchived = "_cardArchived_z50zt_188";
const dynamicBadgeText = "_dynamicBadgeText_z50zt_202";
const resolverMissingBadge = "_resolverMissingBadge_z50zt_210";
const tooltipContent = "_tooltipContent_z50zt_218";
const publishIndicator = "_publishIndicator_z50zt_224";
const publishIndicatorDot = "_publishIndicatorDot_z50zt_236";
const breadcrumbs = "_breadcrumbs_z50zt_255";
var WorkflowCard_vue_vue_type_style_index_0_lang_module_default = {
	cardLink,
	cardHeading,
	cardHeadingArchived,
	"description-popper": "_description-popper_z50zt_147",
	cardDescription,
	cardTags,
	cardActions,
	cardBadge,
	"with-breadcrumbs": "_with-breadcrumbs_z50zt_181",
	cardArchived,
	"description-cell--mcp": "_description-cell--mcp_z50zt_194",
	dynamicBadgeText,
...
function useAutoScrollOnDrag(options) {
	...
	const step = () => {
		const container$4 = options.container.value;
		if (!container$4 || scrollStep === 0) {
			frameId = void 0;
			return;
		}
		container$4.scrollBy({ top: scrollStep });
	...
	const handlePointerMove = (event) => {
		...
		const { scrollHeight, clientHeight } = container$4;
		if (scrollHeight <= clientHeight) {
			stopScrolling();
			return;
		}
		const rect = container$4.getBoundingClientRect();
	...
	watch([options.isActive, options.container], ([isActive, container$4], _prev, onCleanup) => {
		removeListeners();
		stopScrolling();
		if (isActive && container$4) addListeners();
		onCleanup(() => {
			removeListeners();
			stopScrolling();
		});
...
const useCredentialsAppSelectionStore = defineStore(STORES.EXPERIMENT_CREDENTIALS_APP_SELECTION, () => {
	const posthogStore = usePostHog();
...
function useAppCredentials() {
	...
	const buildAppInfo = (nodeType) => {
		let icon$1;
		let iconDark;
		if (typeof nodeType.icon === "string") icon$1 = nodeType.icon;
		else if (nodeType.icon && typeof nodeType.icon === "object" && "light" in nodeType.icon) {
			icon$1 = nodeType.icon.light;
	...
	const appEntries = computed(() => {
		...
		entries.sort((a, b) => {
			...
			if (a.isBundled && b.isBundled) {
				const hasPopA$1 = a.popularity !== void 0;
				const hasPopB$1 = b.popularity !== void 0;
				if (hasPopA$1 && !hasPopB$1) return -1;
				if (!hasPopA$1 && hasPopB$1) return 1;
				if (hasPopA$1 && hasPopB$1) return (a.popularity ?? 0) - (b.popularity ?? 0);
...
const card = "_card_v7exb_125";
const clickable = "_clickable_v7exb_142";
const connected = "_connected_v7exb_152";
const warning = "_warning_v7exb_163";
const error = "_error_v7exb_174";
const loading = "_loading_v7exb_182";
const skeleton = "_skeleton_v7exb_187";
const skeletonIcon = "_skeletonIcon_v7exb_199";
const skeletonText = "_skeletonText_v7exb_207";
const iconContainer = "_iconContainer_v7exb_215";
const icon = "_icon_v7exb_215";
const connectedBadge = "_connectedBadge_v7exb_235";
const warningBadgeWrapper = "_warningBadgeWrapper_v7exb_248";
const warningBadge = "_warningBadge_v7exb_248";
const badgeIcon = "_badgeIcon_v7exb_262";
const name$1 = "_name_v7exb_272";
const installBadgeWrapper = "_installBadgeWrapper_v7exb_284";
const installBadge = "_installBadge_v7exb_284";
const installBadgeIcon = "_installBadgeIcon_v7exb_301";
var AppSelectionCard_vue_vue_type_style_index_0_lang_module_default = {
	...
	skeleton,
	skeletonIcon,
	"skeleton-pulse": "_skeleton-pulse_v7exb_1",
	skeletonText,
	iconContainer,
	icon,
	connectedBadge,
...
var AppSelectionCard_default = /* @__PURE__ */ __plugin_vue_export_helper_default(AppSelectionCard_vue_vue_type_script_setup_true_lang_default, [["__cssModules", { "$style": AppSelectionCard_vue_vue_type_style_index_0_lang_module_default }]]);
...
var AppSelectionGrid_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props, { emit: __emit }) {
		...
		}), async ({ entries, loading: loading$1 }, oldValue) => {
			if (oldValue && entries !== oldValue.entries) iconsLoaded.value = false;
			if (entries.length > 0 && !loading$1 && !iconsLoaded.value) await preloadIcons(entries);
		}, { immediate: true });
...
var AppSelectionGrid_default = /* @__PURE__ */ __plugin_vue_export_helper_default(AppSelectionGrid_vue_vue_type_script_setup_true_lang_default, [["__cssModules", { "$style": AppSelectionGrid_vue_vue_type_style_index_0_lang_module_default }]]);
...
var AppInstallModal_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props, { emit: __emit }) {
		...
		const usersStore = useUsersStore();
		const nodeTypesStore = useNodeTypesStore();
		const { installNode, loading: loading$1 } = useInstallNode();
		...
		const fetchCommunityNodeData = async () => {
			...
			if (cachedInfo) {
				...
				description$1.value = cachedInfo.description ?? "";
			}
			...
			if (attributes) {
				...
				description$1.value = attributes.description ?? description$1.value;
			}
		};
		const nodeTypeForIcon = computed(() => {
		...
		return (_ctx, _cache) => {
			return openBlock(), createBlock(Modal_default, {
				...
				center: true,
				width: "520px",
				"close-on-click-modal": !unref(loading$1),
				"close-on-press-escape": !unref(loading$1),
				...
				content: withCtx(() => [createBaseVNode("div", { class: normalizeClass(_ctx.$style.content) }, [
					description$1.value ? (openBlock(), createBlock(unref(N8nText_default), {
						key: 0,
						color: "text-base",
						size: "medium",
...
var AppInstallModal_default = /* @__PURE__ */ __plugin_vue_export_helper_default(AppInstallModal_vue_vue_type_script_setup_true_lang_default, [["__cssModules", { "$style": AppInstallModal_vue_vue_type_style_index_0_lang_module_default }]]);
...
var AppSelectionPage_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props, { emit: __emit }) {
		...
		const debouncedTrackSearch = debounce$1(trackSearch, { debounceTime: 500 });
		...
		}), async ({ loading: loading$1, fetched }) => {
			if (!loading$1 && fetched && !hasValidatedOnLoad.value) {
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("div", {
				...
				createVNode(unref(N8nHeading_default), {
					...
					default: withCtx(() => [createTextVNode(toDisplayString(heading$1.value), 1)]),
					_: 1
				}, 8, ["class"]),
				createVNode(unref(N8nText_default), {
...
var AppSelectionPage_default = /* @__PURE__ */ __plugin_vue_export_helper_default(AppSelectionPage_vue_vue_type_script_setup_true_lang_default, [["__cssModules", { "$style": AppSelectionPage_vue_vue_type_style_index_0_lang_module_default }]]);
var EmptyStateLayout_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props, { emit: __emit }) {
		...
		return (_ctx, _cache) => {
			...
			}, null, 8, ["project-id", "parent-folder-id"])], 64)) : unref(showRecommendedTemplatesInline) ? (openBlock(), createElementBlock(Fragment, { key: 2 }, [createVNode(unref(N8nHeading_default), {
				tag: "h1",
				size: "2xlarge",
				bold: "",
...
var WorkflowsView_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		...
		const shouldUseSimplifiedLayout = computed(() => {
			...
			return !loading$1.value && simplifiedLayoutVisible;
		});
		...
		const showStartFromScratchCard = computed(() => {
			return !loading$1.value && !showRecommendedTemplatesInline.value && !readOnlyEnv.value && projectPermissions.value.workflow.create;
		});
		...
		sourceControlStore.$onAction(({ name: name$2, after }) => {
			if (name$2 !== "pullWorkfolder") return;
		...
		const fetchWorkflows = async () => {
			...
			try {
				...
				if (!isCurrent()) return [];
				toast.showError(error$1, i18n.baseText("workflows.list.error.fetching"));
				router.push({
					name: VIEWS.PROJECTS_FOLDERS,
		...
		const createAIStarterWorkflows = async (source) => {
			try {
				...
				toast.showError(error$1, i18n.baseText("workflows.ai.starter.collection.error"));
				return;
			}
		};
		const handleCreateReadyToRunWorkflows = async (source) => {
			try {
				...
				toast.showError(error$1, i18n.baseText("workflows.readyToRunWorkflows.error"));
				return;
			}
		};
		...
		const onWorkflowActiveToggle = async (data) => {
			...
			try {
				...
				toast.showError(error$1, i18n.baseText("workflows.list.error.fetching.one"));
			}
		};
		...
		const getFolderContent = async (folderId) => {
			...
			try {
				const content$3 = await foldersStore.fetchFolderContent(currentProject.value?.id ?? "", folderId);
				return {
					workflowCount: content$3.totalWorkflows,
					subFolderCount: content$3.totalSubFolders
				};
			} catch (error$1) {
				toast.showMessage({
		...
		const moveFolderToProjectRoot = async (id, name$2) => {
			if (!foldersStore.draggedElement) return;
			await moveResourceOnDrop({
				id: foldersStore.draggedElement.id,
				type: foldersStore.draggedElement.type,
		...
		const onBreadcrumbItemClick = (item) => {
			if (item.href) {
				...
				router.push(item.href).then(() => {
					...
					toast.showError(error$1, i18n.baseText("folders.open.error.title"));
				});
			}
		};
		const onBreadCrumbsAction = async (action) => {
			switch (action) {
				...
				case FOLDER_LIST_ITEM_ACTIONS.DELETE:
					...
					const content$3 = await getFolderContent(route.params.folderId);
					await deleteFolder(route.params.folderId, content$3.workflowCount, content$3.subFolderCount);
					break;
		...
		const onFolderCardAction = async (payload) => {
			...
			switch (payload.action) {
				...
				case FOLDER_LIST_ITEM_ACTIONS.CREATE_WORKFLOW:
					...
					break;
				case FOLDER_LIST_ITEM_ACTIONS.DELETE: {
					const content$3 = await getFolderContent(clickedFolder.id);
					await deleteFolder(clickedFolder.id, content$3.workflowCount, content$3.subFolderCount);
					break;
				}
				case FOLDER_LIST_ITEM_ACTIONS.RENAME:
		...
		const createFolder = async (parent, options = { openAfterCreate: false }) => {
			...
			if (promptResponse.action === "confirm") {
				...
				try {
					...
					toast.showError(error$1, i18n.baseText("folders.create.error.title"));
				}
			}
		};
		const renameFolder = async (folderId) => {
			...
			if (promptResponse.action === "confirm") {
				...
				try {
					...
					toast.showError(error$1, i18n.baseText("folders.rename.error.title"));
				}
			}
		};
		...
		const moveFolder = async (payload) => {
			...
			try {
				...
				toast.showError(error$1, i18n.baseText("folders.move.error.title"));
			} finally {
				loading$1.value = false;
			}
		};
		...
		const onWorkflowTransferred = async (payload) => {
			...
			try {
				...
				toast.showError(error$1, i18n.baseText("folders.move.workflow.error.title"));
			} finally {
				loading$1.value = false;
			}
		};
		...
		const onNameSubmit = async (name$2) => {
			if (!currentFolder.value || !currentProject.value) return;
			const newName = name$2.trim();
			if (!newName) {
				toast.showMessage({
...
const templatesContainer = "_templatesContainer_1nl01_125";
const emptyStateCard = "_emptyStateCard_1nl01_145";
const emptyStateCardContent = "_emptyStateCardContent_1nl01_158";
const emptyStateCardIcon = "_emptyStateCardIcon_1nl01_165";
const emptyStateNoTemplates = "_emptyStateNoTemplates_1nl01_172";
const dragging = "_dragging_1nl01_201";
const name = "_name_1nl01_219";
