import { C as computed, It as ref, J as onBeforeUnmount, L as h } from "./vue.runtime.esm-bundler-XtMkEjzB.js";
import { yt as useI18n } from "./_MapCache-DwkzWRqU.js";
import { Yi as __vitePreload } from "./src-GXsra_I5.js";
import { Er as useToast, Hr as usePostHog, It as useTelemetry, Mr as useMessage, Wt as useProjectsStore, at as useCredentialsStore, dl as sanitizeHtml, js as useSettingsStore, s as useWorkflowsStore, t as useUsersStore } from "./users.store-DSeNCs16.js";
import { Ni as createResultError, Os as MODAL_CONFIRM, Pi as createResultOk, Xc as QUICK_CONNECT_EXPERIMENT } from "./constants-DFXtU1Pw.js";
import { d as makeRestApiRequest, r as useRootStore } from "./_baseOrderBy-COGSHfpp.js";
...
function useQuickConnect() {
	...
	async function connectToPinecone(quickConnectOption) {
		const { ConnectPopup } = await __vitePreload(async () => {
			const { ConnectPopup: ConnectPopup$1 } = await import("./dist-DqRRt8a3.js");
