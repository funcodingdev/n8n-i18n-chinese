...
import { c as sanitizeHtml } from "./htmlUtils-BzS-cI7x.js";
import { mn as useProjectsStore, w as injectWorkflowDocumentStore, xt as useCredentialsStore } from "./workflows.store-CGzW8V-x.js";
...
import { T as listAgentsPage, d as getAgent } from "./useAgentApi-CahVEdhT.js";
...
function useQuickConnect() {
	...
	async function connectToPinecone(quickConnectOption) {
		const { ConnectPopup } = await __vitePreload(async () => {
			const { ConnectPopup } = await import("./dist-B-BfFhNv.js");
			return { ConnectPopup };
		}, []);
