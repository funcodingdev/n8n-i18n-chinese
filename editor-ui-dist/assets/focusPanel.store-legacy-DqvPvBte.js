;
(function () {
  System.register(["./chunk-legacy-Re9CbdfL.js", "./vue.runtime.esm-bundler-legacy--Sn1h8On.js", "./_MapCache-legacy-BlV_W1LO.js", "./truncate-legacy-DWqu3mV5.js", "./useTelemetry-legacy-Dj2fHQys.js", "./constants-legacy-wGNoFUi7.js", "./_baseOrderBy-legacy-DE6my_G3.js"], function (_export, _context) {
    "use strict";

    var __toESM, computed, ref, watchOnce, i18n, require_get, useStorage, useNodeTypesStore, useWorkflowsStore, STORES, extractFromAICalls, LOCAL_STORAGE_FOCUS_PANEL, jsonParse, FROM_AI_AUTO_GENERATED_MARKER, PLACEHOLDER_EMPTY_WORKFLOW_ID, defineStore, NODE_DENYLIST, PATH_DENYLIST, PROP_TYPE_DENYLIST, fromAIExtraProps, import_get, DEFAULT_PANEL_WIDTH, DEFAULT_FOCUS_PANEL_DATA, useFocusPanelStore;
    ...
    return {
      setters: [function (_chunkLegacy001Js) {
        ...
        extractFromAICalls = _constantsLegacy00TJs.Ci;
        LOCAL_STORAGE_FOCUS_PANEL = _constantsLegacy00TJs.Cs;
        jsonParse = _constantsLegacy00TJs.Oa;
        FROM_AI_AUTO_GENERATED_MARKER = _constantsLegacy00TJs.io;
