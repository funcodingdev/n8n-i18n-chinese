...
import { t as useLoadingService } from "./useLoadingService-QgQZmjs5.js";
import { t as createEventBus } from "./event-bus-DAq0yaAJ.js";
import { F as useEnvFeatureFlag, Ni as isString, O as assignNodeId, Qn as hasProxyAuth, R as useNodeTypesStore, qn as getNodeSubtitle, v as injectWorkflowExecutionStateStore, w as injectWorkflowDocumentStore, xt as useCredentialsStore } from "./workflows.store-qPELvTeV.js";
import { dr as defineStore } from "./useRootStore-DmWgQ-mr.js";
import { t as STORES } from "./constants2-C4Gtqhrx.js";
import { Fr as getNodeParameters, Ir as getNodeParametersIssues, Jr as makeNodeName, Mr as getConnectionTypes, Nr as getNodeInputs, Qr as nodeIssuesToString, Yr as mergeIssues, jr as displayParameterPath, mi as NodeConnectionTypes, sn as classifyTriggerIdentity } from "./src-CBdY4Anf.js";
...
import { b as isObject } from "./typesUtils-BUgUdJt2.js";
	...
	*/
	...
	function collectPrivateCredentialIssues(node, foundIssues) {
		...
		for (const [credTypeName, details] of Object.entries(node.credentials ?? {})) {
			...
			if (blockingTrigger) {
				let messageKey = "nodeIssues.credentials.privateRequiresIdentityTrigger";
				if (!blockingTrigger.isSystemResolver) messageKey = "nodeIssues.credentials.privateRequiresIdentityExtractor";
				else if (blockingTrigger.formOAuth2Enabled && blockingTrigger.webhookOAuth2Enabled) messageKey = "nodeIssues.credentials.privateRequiresIdentityTriggerWithFormAndWebhook";
				else if (blockingTrigger.formOAuth2Enabled) messageKey = "nodeIssues.credentials.privateRequiresIdentityTriggerWithForm";
				else if (blockingTrigger.webhookOAuth2Enabled) messageKey = "nodeIssues.credentials.privateRequiresIdentityTriggerWithWebhook";
