...
import { Ft as ref, L as hasInjectionContext, Pt as readonly, R as inject, S as computed, gt as watch } from "./vue.runtime.esm-bundler-C6vn67cX.js";
import { s as useI18n } from "./src-WwCUXbmD.js";
import { Fi as isToolMessage$1, Ii as isWorkflowUpdatedMessage$1, gt as useRouter, ht as useRoute } from "./src-DFOx8N22.js";
import { t as useMessage } from "./useMessage-CUOLq_eS.js";
import { Ft as getBuilderCredits, Lt as truncateBuilderMessages, M as useCanvasStore, Mt as clearBuilderSession, Pt as getAiSessions, Rt as useAIAssistantHelpers, b as injectWorkflowDocumentStore, bn as useSourceControlStore, dn as useNDVStore, jt as chatWithBuilder, k as useNodeHelpers, nn as useWorkflowHelpers, t as useWorkflowsStore, v as createWorkflowDocumentId, x as useWorkflowDocumentStore, xi as isDebouncedFunction } from "./workflows.store-Cc2IYz8o.js";
import { t as useToast } from "./useToast-Bp2-vBnv.js";
import { Al as WorkflowIdKey, Fi as NPS_SURVEY_MODAL_KEY, Hl as CODE_WORKFLOW_BUILDER_EXPERIMENT, Ll as AI_BUILDER_TEMPLATE_EXAMPLES_EXPERIMENT, Mi as MODAL_CLOSE, Ni as MODAL_CONFIRM, Pl as AI_BUILDER_PLAN_MODE_EXPERIMENT, Su as getDebounceTime, Xl as FOCUSED_NODES_EXPERIMENT, Zs as dedupe, bu as THREE_DAYS_IN_MILLIS, cl as getResourcePermissions, eu as MERGE_ASK_BUILD_EXPERIMENT, ji as MODAL_CANCEL, mu as DEBOUNCE_TIME, ra as LOCAL_STORAGE_BROWSER_NOTIFICATION_METADATA, si as VIEWS, t as AutoSaveState, vc as isExpression, vu as SEVEN_DAYS_IN_MILLIS, yu as SIX_MONTHS_IN_MILLIS } from "./constants-BMUE7W6Y.js";
import { T as defineStore, h as assert, t as useRootStore } from "./useRootStore-BOF8LYEF.js";
import { Rn as STORES, a as getWorkflowVersionsByIds, en as getFirstAdoptionDate, i as getWorkflowVersion, n as getPublishTimeline, o as updateWorkflowHistoryVersion, ot as updateNpsSurveyState, r as getWorkflowHistory, t as useSettingsStore } from "./settings.store-D_uIyAbF.js";
import { G as useDebounceFn, _ as useLocalStorage } from "./core-nZc0i8VB.js";
import { f as useUIStore, g as usePostHog, p as useTelemetry } from "./users.store-OUM63rct.js";
import { E as getNewWorkflow, _ as stringSizeInBytes, t as useWorkflowsListStore, y as tryToParseNumber } from "./workflowsList.store-8HiamWjt.js";
import { t as useExternalHooks } from "./useExternalHooks-CBvPIVsf.js";
import { a as BUILDER_ENABLED_VIEWS, r as useChatPanelStateStore, t as useCodeDiff } from "./useCodeDiff-19RDfMAk.js";
import { n as findPlaceholderDetails, r as formatPlaceholderPath } from "./dist-DHcbImTe.js";
