...
import { $ as openBlock, $t as hyphenate, A as createTextVNode, C as createBaseVNode, E as createElementBlock, Ft as ref, I as h, K as onBeforeMount, N as defineComponent, O as createSlots, Qt as hasOwn, R as inject, S as computed, Sn as toDisplayString, T as createCommentVNode, W as nextTick, Wt as unref, X as onMounted, _ as Fragment, _n as normalizeClass, at as resolveComponent, bt as withDirectives, c as useCssModule, en as init_shared_esm_bundler, gt as watch, it as renderSlot, j as createVNode, p as vShow, pt as useTemplateRef, q as onBeforeUnmount, rt as renderList, st as resolveDynamicComponent, tt as provide, w as createBlock, yn as normalizeStyle, yt as withCtx } from "./vue.runtime.esm-bundler-dg1EVmSK.js";
import { M as useLocalStorage, w as useDocumentVisibility, yt as useI18n } from "./_MapCache-BRSIFZ-8.js";
import { At as N8nActionDropdown_default, Di as useRouter, Ei as useRoute, Fi as N8nIconButton_default, Gi as N8nButton_default, H as N8nRadioButtons_default, I as SuggestedActions_default, Ii as AskAssistantButton_default, Ki as N8nIcon_default, Nt as N8nBadge_default, Yi as __vitePreload, Z as N8nTag_default, bi as RouterLink, bt as createEventBus, h as N8nInlineTextEdit_default, hi as AskAssistantAvatar_default, j as N8nUserStack_default, ji as N8nTooltip_default } from "./src-CKCAtrpy.js";
import { t as __plugin_vue_export_helper_default } from "./_plugin-vue_export-helper-DltO58Gh.js";
import "./sanitize-html-JHjOJhXQ.js";
import { Ar as useSourceControlStore, E as useEvaluationStore, Er as useStyles, Et as useWorkflowHelpers, Ft as useProjectsStore, Gr as createWorkflowDocumentId, It as ProjectTypes, Jr as useWorkflowDocumentStore, Nr as useWorkflowHistoryStore, Pr as require_FileSaver_min, Ri as ResourceType, Tr as useToast, Wi as getActivatableTriggerNodes, Wr as useWorkflowsListStore, an as useWorkflowState, cl as getBannerRowHeight, cn as useBuilderStore, dn as nodeViewEventBus, en as useTelemetry, gr as hasPermission, in as injectWorkflowState, jr as useMessage, js as useSettingsStore, kt as useTagsStore, nn as telemetry, r as useUIStore, rn as useNDVStore, s as useWorkflowsStore, t as useUsersStore, vn as useDocumentTitle, w as useNodeTypesStore, xn as useWorkflowSaveStore, yn as useWorkflowSaving, za as PROJECT_MOVE_RESOURCE_MODAL } from "./users.store-D86YL4LK.js";
import "./MainSidebarHeader-DEgmGF2J.js";
import { t as BaseLayout_default } from "./BaseLayout-DIJvnrUH.js";
import { As as MODAL_CONFIRM, Bs as WORKFLOW_ACTIVE_MODAL_KEY, Fc as WorkflowStateKey, Gs as WORKFLOW_HISTORY_NAME_VERSION_MODAL_KEY, Js as WORKFLOW_HISTORY_VERSION_UNPUBLISH, Nc as WorkflowDocumentStoreKey, Pc as WorkflowIdKey, Pl as WORKFLOW_MENU_ACTIONS, T as TIME_SAVED_DOCS_URL, Ts as IMPORT_WORKFLOW_URL_MODAL_KEY, Vs as WORKFLOW_DESCRIPTION_MODAL_KEY, Xs as WORKFLOW_SETTINGS_MODAL_KEY, Ys as WORKFLOW_PUBLISH_MODAL_KEY, Zs as WORKFLOW_SHARE_MODAL_KEY, _ as EVALUATIONS_DOCS_URL, cc as LOCAL_STORAGE_HIDE_GITHUB_STAR_BUTTON, cl as EnterpriseEditionFeature, cn as ERROR_TRIGGER_NODE_TYPE, es as getResourcePermissions, g as ERROR_WORKFLOW_DOCS_URL, gr as STICKY_NODE_TYPE, ls as MAIN_HEADER_TABS, o as MAX_WORKFLOW_NAME_LENGTH, pl as LOADING_ANIMATION_MIN_DURATION, t as AutoSaveState, us as VIEWS, xr as TIME_SAVED_NODE_TYPE, y as N8N_MAIN_GITHUB_REPO_URL, ys as DUPLICATE_MODAL_KEY } from "./constants-bR1gDMyV.js";
...
import { t as useExecutionsStore } from "./executions.store-M_BkPQP7.js";
...
import "./roles.store-Cq7MScus.js";
...
import { t as sanitizeFilename } from "./dist-cnDca9TH.js";
import "./sso.store-BW4KmiZ3.js";
import { t as router_default } from "./router-B0xvP57z.js";
import "./insights.store-B1rTg7Me.js";
import "./insights.constants-CYpgnIh7.js";
import "./insights.utils-L_u_wJwk.js";
import { a as MCP_DOCS_PAGE_URL, s as MCP_SETTINGS_VIEW } from "./mcp.constants-CjRVSzvp.js";
import "./sourceControl.eventBus-C2Jsx1Gy.js";
import { i as getLastPublishedVersion, r as generateVersionLabelFromId } from "./utils-DZrfeZek.js";
...
import { t as LoadingView_default } from "./LoadingView-jUGtrcwi.js";
...
import { t as ConnectionTracker_default } from "./ConnectionTracker-CSlnJWuS.js";
import { t as useWorkflowSettingsCache } from "./useWorkflowsCache-DIVIS2jT.js";
import { t as usePushConnection } from "./usePushConnection-DgX19FeD.js";
...
var WorkflowDetails_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		...
		async function handleArchiveWorkflow() {
			...
			try {
				const expectedChecksum = props.id === workflowsStore.workflowId ? workflowDocumentStore?.value?.checksum : void 0;
...
var WorkflowDetails_default = /* @__PURE__ */ __plugin_vue_export_helper_default(WorkflowDetails_vue_vue_type_script_setup_true_lang_default, [["__cssModules", { "$style": WorkflowDetails_vue_vue_type_style_index_1_lang_module_default }], ["__scopeId", "data-v-2a322b9e"]]);
