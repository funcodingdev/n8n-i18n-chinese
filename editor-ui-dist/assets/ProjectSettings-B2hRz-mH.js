...
import { $ as openBlock, A as createTextVNode, C as createBaseVNode, Cn as toDisplayString, E as createElementBlock, F as guardReactiveProps, Gt as unref, H as mergeModels, It as ref, K as onBeforeMount, N as defineComponent, Pt as reactive, S as computed, T as createCommentVNode, U as mergeProps, W as nextTick, X as onMounted, _ as Fragment, bt as withCtx, dt as useModel, gt as watch, h as withModifiers, it as renderSlot, j as createVNode, rt as renderList, vn as normalizeClass, w as createBlock, yn as normalizeProps } from "./vue.runtime.esm-bundler-CDDUUZhE.js";
import { c as I18nT, s as useI18n } from "./src-Dh32dOY5.js";
import { E as N8nUserInfo_default, Ga as N8nHeading_default, It as Alert_default, Ja as N8nButton_default, Ki as N8nActionBox_default, Lt as N8nActionToggle_default, S as N8nIconPicker_default, Ti as N8nBadge_default, Ui as Input_default, Wi as N8nIconButton_default, Ya as N8nIcon_default, _t as useRouter, b as N8nDataTableServer_default, c as SelectItem_default, ct as N8nFormInput_default, lt as N8nLink_default, qa as N8nText_default, s as Select_default, vt as N8nInputLabel_default, w as N8nUserSelect_default, zi as N8nTooltip_default } from "./src-BVC_ZvSs.js";
import { t as _plugin_vue_export_helper_default } from "./_plugin-vue_export-helper-Da88TEg1.js";
import { J as useDebounceFn } from "./core-DOUvgShw.js";
import { t as ElRadio } from "./radio-WsNZMnqu.js";
import { t as ElDialog } from "./dialog-HaGq4ddS.js";
import { t as useToast } from "./useToast-CsW2zDDU.js";
import { $u as DEBOUNCE_TIME, D as APP_MODALS_ELEMENT_ID, Hi as SECRETS_PROVIDER_CONNECTION_MODAL_KEY, Hl as getResourcePermissions, Nc as deepCopy, Za as ROLE, sd as getDebounceTime, u as CUSTOM_ROLES_DOCS_URL, ui as VIEWS } from "./constants-DzzWpyjZ.js";
import { bn as useProjectsStore, vn as useAvailableProjectSearch, xi as isProjectRole } from "./workflowDocument.store-BQc6YDGi.js";
import { t as useSettingsStore } from "./settings.store-DmallR-B.js";
import { A as DEFAULT_PROJECT_ICON, f as useUIStore, l as useRBACStore, p as useTelemetry, t as useUsersStore } from "./users.store-CUxYM5yQ.js";
...
import { n as isIconOrEmoji } from "./ProjectIcon-AzM_0dbf.js";
import { t as ProjectSharing_default } from "./ProjectSharing-C2cJRANj.js";
import { t as useRolesStore } from "./roles.store-DgEnhgxn.js";
import { t as useSecretsProviderConnection } from "./useSecretsProviderConnection.ee-Dr1U32AE.js";
import { t as ProjectHeader_default } from "./ProjectHeader-Dexj6RDE.js";
import { i as UI_VISIBLE_SCOPES, r as TOTAL_PROJECT_PERMISSIONS } from "./projectRoleScopes-DJLkz7eo.js";
import { t as useUserRoleProvisioningStore } from "./userRoleProvisioning.store-Cwrl8BOn.js";
import { t as useSecretsProvidersList } from "./useSecretsProvidersList.ee-DWO1jJwU.js";
...
var ProjectRoleUpgradeDialog_vue_vue_type_style_index_0_lang_module_default = { footer: "_footer_9dvwg_125" };
	...
	setup(__props, { emit: __emit }) {
		...
		const onRoleSelect = (value) => {
			...
			if (role && !role.licensed) {
				closeDropdown();
				if (role.systemRole) emit("show-role-upgrade-dialog");
		...
		const isUnavailableRoleItem = (item) => {
			...
			return openBlock(), createElementBlock("div", {
				...
				createBaseVNode("form", { onSubmit: withModifiers(onSubmit, ["prevent"]) }, [
					...
					canUpdateProject.value ? (openBlock(), createElementBlock(Fragment, { key: 1 }, [
						...
						unref(settingsStore).isOtelCustomSpanAttributesEnabled ? (openBlock(), createElementBlock("fieldset", _hoisted_7, [createBaseVNode("h3", null, [createBaseVNode("label", null, toDisplayString(unref(i18n).baseText("projects.settings.customSpanAttributes.label")), 1)]), createVNode(ProjectSettingsCustomTelemetryTags_default, {
