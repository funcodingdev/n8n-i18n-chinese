;
(function () {
  System.register(["./chunk-legacy-Re9CbdfL.js", "./vue.runtime.esm-bundler-legacy--Sn1h8On.js", "./_MapCache-legacy-CECtqMZe.js", "./src-legacy-Bo7v-Myv.js", "./truncate-legacy-nB2QmutO.js", "./useTelemetry-legacy-CA9g7cV_.js", "./useToast-legacy-fud3e81V.js", "./constants-legacy-B_3qSw5J.js", "./_baseOrderBy-legacy-3SIYDICR.js"], function (_export, _context) {
    "use strict";

    var __toESM, computed, toDisplayString, createElementBlock, unref, ref, h, defineComponent, watch, openBlock, createTextVNode, createBaseVNode, useI18n, isToolMessage, isWorkflowUpdatedMessage, createEventBus, useRoute, stringSizeInBytes, CREDENTIAL_EDIT_MODAL_KEY, useUIStore, useCredentialsStore, getAuthTypeForNodeCredential, getSessionsMetadata, getAiSessions, codeNodeEditorEventBus, injectWorkflowState, chatWithAssistant, useSettingsStore, chatWithBuilder, useAIAssistantHelpers, getMainAuthField, replaceCode, useNDVStore, useNodeTypesStore, STORES, usePostHog, useUsersStore, useWorkflowsStore, getBuilderCredits, useTelemetry, useToast, deepCopy, EDITABLE_CANVAS_VIEWS, VIEWS, PLACEHOLDER_EMPTY_WORKFLOW_ID, require_pick, jsonParse, AI_BUILDER_TEMPLATE_EXAMPLES_EXPERIMENT, DEFAULT_NEW_WORKFLOW_NAME, assert, defineStore, useRootStore, ASSISTANT_ENABLED_VIEWS, BUILDER_ENABLED_VIEWS, import_pick, INFINITE_CREDITS, useBuilderStore, DEFAULT_CHAT_WIDTH, useChatPanelStateStore, ndvEventBus, _hoisted_1, AiUpdatedCodeMessage_vue_vue_type_script_setup_true_lang_default, AiUpdatedCodeMessage_default, READABLE_TYPES, useAssistantStore;
    //#endregion
    ...
    return {
      setters: [function (_chunkLegacy001Js) {
        ...
        AI_BUILDER_TEMPLATE_EXAMPLES_EXPERIMENT = _constantsLegacy00TJs.nc;
        DEFAULT_NEW_WORKFLOW_NAME = _constantsLegacy00TJs.t;
