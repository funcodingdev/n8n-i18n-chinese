...
import { $ as openBlock, A as createTextVNode, C as createBaseVNode, E as createElementBlock, F as guardReactiveProps, Ft as ref, H as mergeModels, K as onBeforeMount, N as defineComponent, Nt as reactive, S as computed, Sn as toDisplayString, T as createCommentVNode, U as mergeProps, W as nextTick, Wt as unref, X as onMounted, _ as Fragment, _n as normalizeClass, dt as useModel, gt as watch, h as withModifiers, it as renderSlot, j as createVNode, rt as renderList, vn as normalizeProps, w as createBlock, yt as withCtx } from "./vue.runtime.esm-bundler-C6vn67cX.js";
import { c as I18nT, s as useI18n } from "./src-WwCUXbmD.js";
import { Da as N8nText_default, E as N8nUserInfo_default, Ei as N8nBadge_default, It as Alert_default, Ki as N8nActionBox_default, Lt as N8nActionToggle_default, Oa as N8nButton_default, S as N8nIconPicker_default, Ta as N8nHeading_default, Ui as Input_default, Wi as N8nIconButton_default, _t as N8nInputLabel_default, b as N8nDataTableServer_default, c as SelectItem_default, ct as N8nLink_default, gt as useRouter, ka as N8nIcon_default, s as Select_default, st as N8nFormInput_default, w as N8nUserSelect_default, zi as N8nTooltip_default } from "./src-DFOx8N22.js";
import { t as _plugin_vue_export_helper_default } from "./_plugin-vue_export-helper-Da88TEg1.js";
import { t as ElRadio } from "./radio-C_ZEQI6z.js";
import { t as ElDialog } from "./dialog-CeFKTjMR.js";
import { Ci as isProjectRole, _n as useAvailableProjectSearch, yn as useProjectsStore } from "./workflows.store-Cc2IYz8o.js";
import { t as useToast } from "./useToast-Bp2-vBnv.js";
import { Li as SECRETS_PROVIDER_CONNECTION_MODAL_KEY, Na as ROLE, Qs as deepCopy, Su as getDebounceTime, cl as getResourcePermissions, l as CUSTOM_ROLES_DOCS_URL, mu as DEBOUNCE_TIME, si as VIEWS } from "./constants-BMUE7W6Y.js";
import { t as useSettingsStore } from "./settings.store-D_uIyAbF.js";
import { G as useDebounceFn } from "./core-nZc0i8VB.js";
import { O as DEFAULT_PROJECT_ICON, f as useUIStore, l as useRBACStore, p as useTelemetry, t as useUsersStore } from "./users.store-OUM63rct.js";
...
import { n as isIconOrEmoji } from "./ProjectIcon-xeMNZzkN.js";
import { t as ProjectSharing_default } from "./ProjectSharing-4mjEPjD_.js";
import { t as useRolesStore } from "./roles.store-Vik6NXwZ.js";
import { t as useSecretsProviderConnection } from "./useSecretsProviderConnection.ee-uUu0C6ux.js";
import { t as ProjectHeader_default } from "./ProjectHeader-Cj87P3kH.js";
import { i as UI_VISIBLE_SCOPES, r as TOTAL_PROJECT_PERMISSIONS } from "./projectRoleScopes-eJMajq63.js";
import { t as useUserRoleProvisioningStore } from "./userRoleProvisioning.store-Dwa84VRt.js";
import { t as useSecretsProvidersList } from "./useSecretsProvidersList.ee-DBj2NymA.js";
...
//#endregion
//#region src/features/collaboration/projects/components/RoleHoverPopover.vue?vue&type=script&setup=true&lang.ts
var RoleHoverPopover_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		...
		const permissionCount = computed(() => props.role.scopes?.filter((scope) => UI_VISIBLE_SCOPES.has(scope)).length ?? 0);
				...
				content: withCtx(() => [createBaseVNode("div", { class: normalizeClass(_ctx.$style.popoverContent) }, [
					...
					createVNode(unref(N8nText_default), {
						...
						default: withCtx(() => [createTextVNode(toDisplayString(unref(i18n).baseText("projects.settings.role.selector.permissionCount", { interpolate: {
							count: String(permissionCount.value),
...
//#endregion
//#region src/features/collaboration/projects/components/ProjectRoleContactAdminModal.vue?vue&type=script&setup=true&lang.ts
		...
		return (_ctx, _cache) => {
			return openBlock(), createBlock(unref(ElDialog), {
				...
				default: withCtx(() => [createBaseVNode("div", { class: normalizeClass(_ctx.$style.content) }, [createVNode(unref(N8nText_default), {
					...
					default: withCtx(() => [
						createTextVNode(toDisplayString(unref(i18n).baseText(bodyKey.value).split("{documentation}")[0]), 1),
						...
						createTextVNode(toDisplayString(unref(i18n).baseText(bodyKey.value).split("{documentation}")[1] || ""), 1)
					]),
					_: 1
				})], 2)]),
				_: 1
...
var ProjectRoleContactAdminModal_vue_vue_type_style_index_0_lang_module_default = { content: "_content_186py_125" };
var ProjectRoleContactAdminModal_default = /* @__PURE__ */ _plugin_vue_export_helper_default(ProjectRoleContactAdminModal_vue_vue_type_script_setup_true_lang_default, [["__cssModules", { "$style": ProjectRoleContactAdminModal_vue_vue_type_style_index_0_lang_module_default }]]);
//#endregion
//#region src/features/collaboration/projects/components/ProjectCustomRolesUpgradeModal.vue?vue&type=script&setup=true&lang.ts
		...
		return (_ctx, _cache) => {
			return openBlock(), createBlock(unref(ElDialog), {
				...
				default: withCtx(() => [createBaseVNode("div", { class: normalizeClass(_ctx.$style.content) }, [createVNode(unref(N8nText_default), {
					...
					default: withCtx(() => [
						createTextVNode(toDisplayString(unref(i18n).baseText("projects.settings.role.upgrade.custom.body").split("{documentation}")[0]), 1),
						createVNode(unref(N8nLink_default), {
							href: unref(CUSTOM_ROLES_DOCS_URL),
							"new-window": true
						}, {
						...
						createTextVNode(toDisplayString(unref(i18n).baseText("projects.settings.role.upgrade.custom.body").split("{documentation}")[1] || ""), 1)
					]),
					_: 1
				})], 2)]),
				_: 1
...
var ProjectCustomRolesUpgradeModal_default = /* @__PURE__ */ _plugin_vue_export_helper_default(ProjectCustomRolesUpgradeModal_vue_vue_type_script_setup_true_lang_default, [["__cssModules", { "$style": ProjectCustomRolesUpgradeModal_vue_vue_type_style_index_0_lang_module_default }]]);
//#endregion
...
var ProjectMembersRoleCell_vue_vue_type_style_index_0_lang_module_default = {
	container: "_container_1ikt5_125",
	searchContainer: "_searchContainer_1ikt5_129",
	searchInput: "_searchInput_1ikt5_133",
	roleSelect: "_roleSelect_1ikt5_141",
	triggerContent: "_triggerContent_1ikt5_151",
	itemLabel: "_itemLabel_1ikt5_160",
	selectItem: "_selectItem_1ikt5_168",
	upgradeBadge: "_upgradeBadge_1ikt5_175",
	sectionLabelContent: "_sectionLabelContent_1ikt5_180",
	sectionUpgradeBadge: "_sectionUpgradeBadge_1ikt5_186",
	addCustomRoleButton: "_addCustomRoleButton_1ikt5_193",
	roleSelectContent: "_roleSelectContent_1ikt5_209"
};
var ProjectMembersRoleCell_default = /* @__PURE__ */ _plugin_vue_export_helper_default(ProjectMembersRoleCell_vue_vue_type_script_setup_true_lang_default, [["__cssModules", { "$style": ProjectMembersRoleCell_vue_vue_type_style_index_0_lang_module_default }]]);
//#endregion
...
var ProjectExternalSecrets_vue_vue_type_style_index_0_lang_module_default = {
	description: "_description_3mc48_125",
	secretProvidersContainer: "_secretProvidersContainer_3mc48_130",
	actionsContainer: "_actionsContainer_3mc48_136",
	searchContainer: "_searchContainer_3mc48_141",
	groupHeaderRow: "_groupHeaderRow_3mc48_146",
	groupHeaderCell: "_groupHeaderCell_3mc48_153",
	secretsCell: "_secretsCell_3mc48_165",
	secretsList: "_secretsList_3mc48_169",
	secretRow: "_secretRow_3mc48_174",
	groupHeaderContent: "_groupHeaderContent_3mc48_189",
	expandButton: "_expandButton_3mc48_198",
	secretName: "_secretName_3mc48_212",
	connectionLink: "_connectionLink_3mc48_219"
};
	...
	setup(__props, { expose: __expose, emit: __emit }) {
		...
		const tagErrors = computed(() => {
			...
			return props.modelValue.map((tag) => {
				...
				if (seen.has(trimmed)) return i18n.baseText("projects.settings.telemetryTags.error.duplicateKey");
				seen.add(trimmed);
				return null;
			});
		});
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("div", null, [
				createVNode(unref(N8nText_default), {
					...
					default: withCtx(() => [createTextVNode(toDisplayString(unref(i18n).baseText("projects.settings.telemetryTags.description")) + " ", 1), createBaseVNode("a", {
						class: normalizeClass(_ctx.$style.docsLink),
						href: "https://docs.n8n.io/hosting/logging-monitoring/opentelemetry/",
						target: "_blank"
					}, [createTextVNode(toDisplayString(unref(i18n).baseText("projects.settings.telemetryTags.docsLink")), 1), createVNode(unref(N8nIcon_default), {
						icon: "arrow-up-right",
						size: "xsmall"
					})], 2)]),
					_: 1
				...
				(openBlock(true), createElementBlock(Fragment, null, renderList(__props.modelValue, (tag, index) => {
					return openBlock(), createElementBlock("div", {
						...
						createVNode(unref(N8nInputLabel_default), {
							label: index === 0 ? unref(i18n).baseText("projects.settings.telemetryTags.key.label") : void 0,
							size: "small"
						}, {
							default: withCtx(() => [createVNode(unref(Input_default), {
								"model-value": tag.key,
								placeholder: unref(i18n).baseText("projects.settings.telemetryTags.key.placeholder"),
								"aria-label": unref(i18n).baseText("projects.settings.telemetryTags.key.label"),
						...
						createVNode(unref(N8nInputLabel_default), {
							label: index === 0 ? unref(i18n).baseText("projects.settings.telemetryTags.value.label") : void 0,
							size: "small"
						}, {
							default: withCtx(() => [createVNode(unref(Input_default), {
								"model-value": tag.value,
								placeholder: unref(i18n).baseText("projects.settings.telemetryTags.value.placeholder"),
								"aria-label": unref(i18n).baseText("projects.settings.telemetryTags.value.label"),
						...
						createVNode(unref(N8nButton_default), {
							...
							size: "small",
							"native-type": "button",
							title: unref(i18n).baseText("projects.settings.telemetryTags.remove"),
							"aria-label": unref(i18n).baseText("projects.settings.telemetryTags.remove"),
				...
				createVNode(unref(N8nButton_default), {
					...
					default: withCtx(() => [createTextVNode(toDisplayString(unref(i18n).baseText("projects.settings.telemetryTags.add")), 1)]),
					_: 1
				})
			]);
		};
...
var ProjectSettingsCustomTelemetryTags_vue_vue_type_style_index_0_lang_module_default = {
	telemetryTagContainer: "_telemetryTagContainer_18p15_125",
	telemetryTagRow: "_telemetryTagRow_18p15_130",
	tagErrorMessage: "_tagErrorMessage_18p15_136",
	docsLink: "_docsLink_18p15_143"
};
...
var ProjectSettings_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		...
		const projectMembersActions = computed(() => {
			if (isProjectRoleProvisioningEnabled.value || isExpressionMappingEnabled.value) return [];
			return [{
		...
		const updateProject = async () => {
			...
			try {
				await projectsStore.updateProject(projectsStore.currentProject.id, {
					...
					...settingsStore.isOtelEnabled ? { customTelemetryTags: formData.value.customTelemetryTags } : {}
				});
				isDirty.value = false;
			} catch (error) {
				showSaveError(error);
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("div", {
				...
				createBaseVNode("form", { onSubmit: withModifiers(onSubmit, ["prevent"]) }, [
					...
					canUpdateProject.value ? (openBlock(), createElementBlock(Fragment, { key: 1 }, [
						createBaseVNode("fieldset", _hoisted_3, [
							...
							createBaseVNode("div", { class: normalizeClass([_ctx.$style.membersInputRow, "mb-s"]) }, [createVNode(unref(N8nUserSelect_default), {
								...
								disabled: isProjectRoleProvisioningEnabled.value || isExpressionMappingEnabled.value,
							...
							isExpressionMappingEnabled.value ? (openBlock(), createElementBlock("div", _hoisted_5, [createVNode(unref(Alert_default), {
								type: "info",
								title: unref(i18n).baseText("settings.provisioningProjectRolesHandledByExpressionMapping.description")
							}, null, 8, ["title"])])) : isProjectRoleProvisioningEnabled.value ? (openBlock(), createElementBlock("div", _hoisted_6, [createVNode(unref(Alert_default), {
								type: "info",
							...
							relationUsers.value.length > 0 ? (openBlock(), createElementBlock("div", {
								...
								"can-edit-role": !isProjectRoleProvisioningEnabled.value && !isExpressionMappingEnabled.value,
						...
						unref(settingsStore).isOtelEnabled ? (openBlock(), createElementBlock("fieldset", _hoisted_7, [createBaseVNode("h3", null, [createBaseVNode("label", null, toDisplayString(unref(i18n).baseText("projects.settings.telemetryTags.label")), 1)]), createVNode(ProjectSettingsCustomTelemetryTags_default, {
							ref_key: "telemetryTagsRef",
							ref: telemetryTagsRef,
							modelValue: formData.value.customTelemetryTags,
							"onUpdate:modelValue": [_cache[6] || (_cache[6] = ($event) => formData.value.customTelemetryTags = $event), onTextInput],
							onValidate: _cache[7] || (_cache[7] = ($event) => isTelemetryTagsValid.value = $event)
						}, null, 8, ["modelValue"])])) : createCommentVNode("", true),
						createBaseVNode("fieldset", null, [
							createBaseVNode("h3", _hoisted_8, toDisplayString(unref(i18n).baseText("projects.settings.danger.title")), 1),
				...
				createVNode(ProjectRoleUpgradeDialog_default, {
					...
					"onUpdate:modelValue": _cache[9] || (_cache[9] = ($event) => upgradeDialogVisible.value = $event),
