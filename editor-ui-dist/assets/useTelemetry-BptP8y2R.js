...
import { M as useMediaQuery, R as useStorage$1, dt as addHeaders, ft as addNodeTranslation, gt as useI18n, j as useLocalStorage, pt as i18n, x as useAsyncState } from "./_MapCache-Blne6VeP.js";
import { B as removeClass, I as addClass, Pt as isClient$1, R as getStyle, S as useGlobalComponentSettings, l as require_memoize, r as require_get, s as require_toString, t as truncate, x as createEventBus, y as useRoute } from "./truncate-B6V3BCxD.js";
import { $i as displayParameterPath, $n as SCHEDULE_TRIGGER_NODE_TYPE, $o as LOG_STREAM_MODAL_KEY, $t as DISCORD_NODE_TYPE, Aa as jsonParse, Ac as MAIN_AUTH_FIELD_NAME, Ao as hasScope$1, B as MAPPING_PARAMS, Bo as CHANGE_PASSWORD_MODAL_KEY, Bt as CALENDLY_TRIGGER_NODE_TYPE, Co as ApplicationError, Cr as WORKFLOW_TRIGGER_NODE_TYPE, Ct as HUMAN_IN_THE_LOOP_CATEGORY, D as TEMPLATES_NODES_FILTER, Da as deepCopy, Dr as ZENDESK_TRIGGER_NODE_TYPE, Dt as RECOMMENDED_NODES, En as MANUAL_CHAT_TRIGGER_NODE_TYPE, Er as ZENDESK_NODE_TYPE, Et as PRE_BUILT_AGENTS_COLLECTION, F as PLACEHOLDER_FILLED_AT_EXECUTION_TIME, Fi as require__baseFindIndex, Fn as NODE_POSITION_CONFLICT_ALLOWLIST, Gn as PAGERDUTY_NODE_TYPE, Go as DUPLICATE_MODAL_KEY, Hs as LOCAL_STORAGE_THEME, Ht as CLEARBIT_NODE_TYPE, I as APPEND_ATTRIBUTION_DEFAULT_PATH, Ic as AI_ASSISTANT_MAX_CONTENT_LENGTH, Ii as isExpression, It as AI_MCP_TOOL_NODE_TYPE, J as NODE_MIN_INPUT_ITEMS_COUNT, Ji as mapConnectionsByDestination, Jo as EXPERIMENT_TEMPLATE_RECO_V3_KEY, Ka as NodeConnectionTypes, Ko as EXPERIMENT_TEMPLATES_DATA_QUALITY_KEY, Kt as CREDENTIAL_ONLY_HTTP_NODE_VERSION, L as CUSTOM_API_CALL_KEY, Lc as AI_NODES_PACKAGE_NAME, Ln as NON_ACTIVATABLE_TRIGGER_NODE_TYPES, Lo as MAIN_HEADER_TABS, Lt as AI_TRANSFORM_NODE_TYPE, Mn as MICROSOFT_TEAMS_NODE_TYPE, Nn as MODULE_ENABLED_NODES, Pa as sleep$1, Qn as SALESFORCE_NODE_TYPE, Qo as IMPORT_WORKFLOW_URL_MODAL_KEY, R as DATA_TYPE_ICON_MAP, Rn as NOTION_TRIGGER_NODE_TYPE, Ro as VIEWS, Rt as BAMBOO_HR_NODE_TYPE, Sa as isResourceLocatorValue, Sn as JIRA_TRIGGER_NODE_TYPE, Sr as WORKABLE_TRIGGER_NODE_TYPE, Tn as LIST_LIKE_NODE_OPERATIONS, Uo as CONFIRM_PASSWORD_MODAL_KEY, Ut as CODE_NODE_TYPE, Vo as CHAT_EMBED_MODAL_KEY, Vt as CHAT_TRIGGER_NODE_TYPE, W as INSECURE_CONNECTION_WARNING, Wa as ExpressionError, Wi as createEmptyRunExecutionData, Wo as CONTACT_PROMPT_MODAL_KEY, X as AI_CATEGORY_AGENTS, Xi as getChildNodes, Xo as FROM_AI_PARAMETERS_MODAL_KEY, Xr as ROLE, Yi as getNodeByName, Yn as QUICKBOOKS_NODE_TYPE, Yo as EXTERNAL_SECRETS_PROVIDER_MODAL_KEY, Zi as generateNodesGraph, Zo as IMPORT_CURL_MODAL_KEY, _i as calculateWorkflowChecksum, _n as HUBSPOT_TRIGGER_NODE_TYPE, _o as require_isEqual, _s as WORKFLOW_HISTORY_VERSION_RESTORE, _t as BETA_NODES, aa as getNodeWebhookUrl, ao as FORM_TRIGGER_NODE_TYPE$1, as as NODE_PINNING_MODAL_KEY, bn as ITEM_LISTS_NODE_TYPE, bs as WORKFLOW_SETTINGS_MODAL_KEY, c as PLACEHOLDER_EMPTY_WORKFLOW_ID, ci as require_pick, cs as PROMPT_MFA_CODE_MODAL_KEY, ct as AI_CATEGORY_TOOLS, dn as FORM_NODE_TYPE, ds as WHATS_NEW_MODAL_KEY, ea as getConnectionTypes, eo as CHAT_TRIGGER_NODE_TYPE$1, er as SEGMENT_NODE_TYPE, es as MFA_SETUP_MODAL_KEY, et as AI_CATEGORY_LANGUAGE_MODELS, fn as FORM_TRIGGER_NODE_TYPE, fs as WORKFLOW_ACTIVATION_CONFLICTING_WEBHOOK_MODAL_KEY, g as DOCS_DOMAIN, ga as mergeIssues, gn as HTTP_REQUEST_NODE_TYPE, go as WEBHOOK_NODE_TYPE$1, gs as WORKFLOW_HISTORY_PUBLISH_MODAL_KEY, ha as makeNodeName, hr as THE_HIVE_TRIGGER_NODE_TYPE, hs as WORKFLOW_EXTRACTION_NAME_MODAL_KEY, i as DUPLICATE_POSTFFIX, ia as getNodeParametersIssues, in as ERROR_TRIGGER_NODE_TYPE, is as NEW_ASSISTANT_SESSION_MODAL, ji as splitExpression, jn as MICROSOFT_EXCEL_NODE_TYPE, ka as isObjectEmpty, ko as getResourcePermissions, ks as LOCAL_STORAGE_EXPERIMENT_OVERRIDES, li as require__baseFlatten, lr as SPREADSHEET_FILE_NODE_TYPE, ls as SETUP_CREDENTIALS_MODAL_KEY, mn as GOOGLE_SHEETS_NODE_TYPE, mo as TRIMMED_TASK_DATA_CONNECTIONS_KEY, mr as TELEGRAM_NODE_TYPE, ms as WORKFLOW_DIFF_MODAL_KEY, mt as AI_SUBCATEGORY, n as DEFAULT_NODETYPE_VERSION, na as getNodeOutputs, nc as WorkflowStateKey, no as EVALUATION_NODE_TYPE, nr as SET_NODE_TYPE, nt as AI_CATEGORY_MEMORY, o as MAX_WORKFLOW_NAME_LENGTH, on as EXECUTE_COMMAND_NODE_TYPE, or as SLACK_NODE_TYPE, os as NPS_SURVEY_MODAL_KEY, ot as AI_CATEGORY_ROOT_NODES, pn as GITHUB_TRIGGER_NODE_TYPE, po as SEND_AND_WAIT_OPERATION, pr as SWITCH_NODE_TYPE, ps as WORKFLOW_ACTIVE_MODAL_KEY, qa as nodeConnectionTypes, qo as EXPERIMENT_TEMPLATE_RECO_V2_KEY, qt as CREDENTIAL_ONLY_NODE_PREFIX, r as DEFAULT_WORKFLOW_PAGE_SIZE, ra as getNodeParameters, rn as EMAIL_SEND_NODE_TYPE, ro as EVALUATION_TRIGGER_NODE_TYPE, rt as AI_CATEGORY_OTHER_TOOLS, sc as EXPERIMENTS_TO_TRACK, sr as SPLIT_IN_BATCHES_NODE_TYPE, ss as PRE_BUILT_AGENTS_MODAL_KEY, t as DEFAULT_NEW_WORKFLOW_NAME, ta as getNodeInputs, tn as ELASTIC_SECURITY_NODE_TYPE, tr as SERVICENOW_NODE_TYPE, uo as MANUAL_TRIGGER_NODE_TYPE, ur as START_NODE_TYPE, us as VERSIONS_MODAL_KEY, vi as Workflow, vn as IF_NODE_TYPE, vr as WAIT_NODE_TYPE, vs as WORKFLOW_HISTORY_VERSION_UNPUBLISH, vt as CORE_NODES_CATEGORY, wr as XERO_NODE_TYPE, xi as require__baseIteratee, xn as JIRA_NODE_TYPE, xr as WOOCOMMERCE_TRIGGER_NODE_TYPE, xs as WORKFLOW_SHARE_MODAL_KEY, yc as EnterpriseEditionFeature, yo as require_keys, yr as WEBHOOK_NODE_TYPE, ys as WORKFLOW_PUBLISH_MODAL_KEY, yt as DEFAULT_SUBCATEGORY, zo as ABOUT_MODAL_KEY } from "./constants-C1tPaXRr.js";
import { n as require__isIterateeCall, o as require_identity, r as require__baseRest, t as require_merge, y as require_isArrayLike } from "./merge-BMIIWfjy.js";
import { C as INSTANCE_VERSION_HEADER, E as N8N_IO_BASE_URL, S as INSTANCE_ID_HEADER, T as BROWSER_ID_STORAGE_KEY, c as get$3, d as post, f as request, h as axios_default, k as defineStore, l as getFullApiResponse, p as streamRequest, r as useRootStore, s as ResponseError, t as require__baseOrderBy, u as makeRestApiRequest, w as NPM_COMMUNITY_NODE_SEARCH_API_URL } from "./_baseOrderBy-LtFDYziM.js";
import { t as require_dateformat } from "./dateformat-CMLc6OKJ.js";
import { r as require_toNumber, t as useDebounce } from "./useDebounce-B5py4jN5.js";
...
function useWorkflowHelpers() {
	...
	async function updateWorkflow({ workflowId, active: active$7 }, partialData = false) {
		...
		if (workflow.activeVersionId !== null) workflowsStore.setWorkflowActive(workflowId);
...
const useWorkflowsStore = defineStore(STORES.WORKFLOWS, () => {
	...
	const nodesWithIssuesCount = computed(() => workflow.value.nodes.filter((node) => {
	...
	async function searchWorkflows({ projectId, query, nodeTypes, tags: tags$7, select: select$1, isArchived }) {
		const filter$1 = {
			projectId,
			query,
			nodeTypes,
	...
	async function archiveWorkflow(id$1) {
		...
		if (id$1 === workflow.value.id) setWorkflowChecksum(await calculateWorkflowChecksum(updatedWorkflow));
	...
	function setWorkflowActive(targetWorkflowId, activeVersion) {
