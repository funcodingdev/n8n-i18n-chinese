import { $ as openBlock, A as createTextVNode, C as createBaseVNode, Cn as toDisplayString, E as createElementBlock, Gt as unref, It as ref, N as defineComponent, O as createSlots, R as inject, S as computed, T as createCommentVNode, U as mergeProps, Ut as toValue, W as nextTick, X as onMounted, _ as Fragment, bt as withCtx, gt as watch, it as renderSlot, j as createVNode, k as createStaticVNode, ot as resolveDirective, q as onBeforeUnmount, rt as renderList, vn as normalizeClass, w as createBlock, xt as withDirectives } from "./vue.runtime.esm-bundler-Bs4WIMNP.js";
import { ot as useI18n } from "./core-C5b2s2m3.js";
import { Et as Checkbox_default, Ji as N8nTooltip_default, Mt as N8nOption_default, Qi as Input_default, Tt as N8nInputLabel_default, f as AlertDialog_default, gt as N8nLink_default, it as ActionPill_default, jt as N8nSelect_default, no as N8nButton_default, qt as N8nActionDropdown_default, ro as N8nIcon_default, to as N8nText_default } from "./src-BR3WX5fi.js";
import { t as _plugin_vue_export_helper_default } from "./_plugin-vue_export-helper-Da88TEg1.js";
import { t as useToast } from "./useToast-D9a-cCgr.js";
import { Bd as N8N_CREDITS_CREDENTIAL_SELECTION_EXPERIMENT, La as LOCAL_STORAGE_SKIP_DISCONNECT_CONFIRM, Ou as getResourcePermissions, ad as ChatHubToolContextKey, xi as AI_GATEWAY_TOP_UP_MODAL_KEY, xn as KEEP_AUTH_IN_NDV_FOR_NODES } from "./constants-CSBjw1Ht.js";
import { $n as getMainAuthField, Gt as injectNDVStoreIfProvided, Jt as injectWorkflowExecutionStateStore, Qn as getAuthTypeForNodeCredential, Xn as getAppNameFromCredType, Yn as getAllNodeCredentialForAuthType, _ as useNodeTypesStore, a as injectWorkflowDocumentStore, cr as hasProxyAuth, dn as useWorkflowsStore, dr as isRequiredCredential, gr as updateNodeAuthType, nr as getNodeCredentialForSelectedAuthType, st as useCredentialsStore, wn as useProjectsStore } from "./workflowDocument.store-xeTT7tms.js";
import { h as assert } from "./useRootStore-hyBq4XlJ.js";
import { f as useUIStore, g as usePostHog, p as useTelemetry, t as useUsersStore } from "./users.store-DWiPI9j5.js";
import { y as isEmpty } from "./workflowsList.store-C_pATVnM.js";
...
import { t as useAiGateway } from "./useAiGateway-BgHjsfax.js";
...
var TitledList_default = /* @__PURE__ */ _plugin_vue_export_helper_default(/* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		return (_ctx, _cache) => {
			...
			return openBlock(), createElementBlock("div", _hoisted_1$2, [createBaseVNode("p", { textContent: toDisplayString(__props.title) }, null, 8, _hoisted_2$1), createBaseVNode("ul", null, [(openBlock(true), createElementBlock(Fragment, null, renderList(__props.items, (item) => {
...
//#endregion
//#region src/features/credentials/components/CredentialPrivateConnectionRow.vue?vue&type=script&setup=true&lang.ts
var CredentialPrivateConnectionRow_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	__name: "CredentialPrivateConnectionRow",
	props: {
		credentialTypeName: {},
		credentialName: {},
		...
		connectedAccountName: { default: void 0 },
		readonly: {
			type: Boolean,
			default: false
		}
	...
	setup(__props, { emit: __emit }) {
		...
		const emit = __emit;
		const i18n = useI18n();
		const connectedActions = computed(() => [...props.canModify ? [{
			id: "modify",
		...
		const statusText = computed(() => {
			if (!props.isConnected) return i18n.baseText("credentials.private.row.notConnected");
			if (props.connectedAccountName) return i18n.baseText("credentials.private.row.connectedAs", { interpolate: { account: props.connectedAccountName } });
		...
		function onDisconnect() {
			if (localStorage.getItem("N8N_SKIP_DISCONNECT_CONFIRM") === "true") {
				emit("disconnect");
				return;
			}
		...
		function onDisconnectConfirm() {
			...
			if (skipDisconnectConfirm.value) localStorage.setItem(LOCAL_STORAGE_SKIP_DISCONNECT_CONFIRM, "true");
			emit("disconnect");
		}
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("div", { class: normalizeClass(_ctx.$style.row) }, [
				createBaseVNode("div", { class: normalizeClass(_ctx.$style.left) }, [createVNode(CredentialIcon_default, {
					"credential-type-name": __props.credentialTypeName,
					size: 20
				}, null, 8, ["credential-type-name"]), createBaseVNode("div", { class: normalizeClass(_ctx.$style.textGroup) }, [createBaseVNode("span", { class: normalizeClass(_ctx.$style.name) }, toDisplayString(__props.credentialName), 3), createBaseVNode("span", { class: normalizeClass(_ctx.$style.status) }, [createVNode(unref(N8nTooltip_default), {
					disabled: !__props.isConnected || !__props.connectedAccountName,
					placement: "top"
				}, {
					content: withCtx(() => [createBaseVNode("span", { class: normalizeClass(_ctx.$style.tooltipAccount) }, toDisplayString(statusText.value), 3)]),
					default: withCtx(() => [createBaseVNode("span", { class: normalizeClass(_ctx.$style.statusText) }, toDisplayString(statusText.value), 3)]),
					_: 1
				}, 8, ["disabled"])], 2)], 2)], 2),
				createBaseVNode("div", { class: normalizeClass(_ctx.$style.right) }, [!__props.isConnected ? (openBlock(), createBlock(unref(N8nTooltip_default), {
					key: 0,
					disabled: __props.canConnect || __props.readonly,
					placement: "top"
				}, {
					content: withCtx(() => [createTextVNode(toDisplayString(unref(i18n).baseText("credentials.private.row.connect.noPermission")), 1)]),
					default: withCtx(() => [createVNode(unref(N8nButton_default), {
						size: "mini",
						variant: "outline",
						label: unref(i18n).baseText("credentials.private.row.connect"),
						disabled: __props.readonly || !__props.canConnect,
						"data-test-id": "node-credential-private-connect",
						onClick: _cache[0] || (_cache[0] = ($event) => emit("connect"))
					}, null, 8, ["label", "disabled"])]),
					_: 1
				}, 8, ["disabled"])) : (openBlock(), createBlock(unref(N8nActionDropdown_default), {
					key: 1,
					items: connectedActions.value,
					placement: "bottom-end",
					disabled: __props.readonly,
					"extra-popper-class": _ctx.$style.connectedDropdown,
					...
					activator: withCtx(() => [createVNode(unref(N8nButton_default), {
						...
						default: withCtx(() => [
							createBaseVNode("span", { class: normalizeClass(_ctx.$style.connectedBadge) }, null, 2),
							createBaseVNode("span", null, toDisplayString(unref(i18n).baseText("credentials.private.row.connected")), 1),
				...
				createVNode(unref(AlertDialog_default), {
					open: disconnectDialogOpen.value,
					title: unref(i18n).baseText("credentials.private.disconnect.dialog.title"),
					description: unref(i18n).baseText("credentials.private.disconnect.dialog.message", { interpolate: { credentialName: __props.credentialName } }),
					"action-label": unref(i18n).baseText("credentials.private.disconnect.dialog.confirm"),
					"action-variant": "destructive",
					"cancel-label": unref(i18n).baseText("generic.cancel"),
					"data-test-id": "node-credential-private-disconnect-dialog",
					"onUpdate:open": _cache[2] || (_cache[2] = ($event) => disconnectDialogOpen.value = $event),
					onAction: onDisconnectConfirm
				}, {
					default: withCtx(() => [createVNode(unref(Checkbox_default), {
						modelValue: skipDisconnectConfirm.value,
						"onUpdate:modelValue": _cache[1] || (_cache[1] = ($event) => skipDisconnectConfirm.value = $event),
						label: unref(i18n).baseText("credentials.private.disconnect.dialog.dontShowAgain"),
...
var CredentialPrivateConnectionRow_vue_vue_type_style_index_0_lang_module_default = {
	row: "_row_11q1a_125",
	left: "_left_11q1a_135",
	textGroup: "_textGroup_11q1a_143",
	name: "_name_11q1a_151",
	status: "_status_11q1a_159",
	statusText: "_statusText_11q1a_168",
	tooltipAccount: "_tooltipAccount_11q1a_175",
	right: "_right_11q1a_182",
	connectedDropdown: "_connectedDropdown_11q1a_186",
	connectedBadge: "_connectedBadge_11q1a_206",
	connectedPulse: "_connectedPulse_11q1a_1"
};
var CredentialPrivateConnectionRow_default = /* @__PURE__ */ _plugin_vue_export_helper_default(CredentialPrivateConnectionRow_vue_vue_type_script_setup_true_lang_default, [["__cssModules", { "$style": CredentialPrivateConnectionRow_vue_vue_type_style_index_0_lang_module_default }]]);
//#endregion
//#region src/experiments/n8nCreditsCredentialSelection/useN8nCreditsCredentialSelectionExperiment.ts
function useN8nCreditsCredentialSelectionExperiment() {
	const posthogStore = usePostHog();
	return { isFeatureEnabled: computed(() => posthogStore.getVariant(N8N_CREDITS_CREDENTIAL_SELECTION_EXPERIMENT.name) === N8N_CREDITS_CREDENTIAL_SELECTION_EXPERIMENT.variant) };
}
//#endregion
//#region src/app/components/AiGatewaySelector.vue?vue&type=script&setup=true&lang.ts
var _hoisted_1$1 = ["aria-label"];
var _hoisted_2 = ["aria-checked", "disabled"];
...
var AiGatewaySelector_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props, { emit: __emit }) {
		...
		const { isFeatureEnabled: shouldShowOwnCredentialFirst } = useN8nCreditsCredentialSelectionExperiment();
		const isBalanceDepleted = computed(() => balance.value !== void 0 && balance.value <= 0);
		const credentialModeOrder = computed(() => shouldShowOwnCredentialFirst.value ? ["own", "gateway"] : ["gateway", "own"]);
		watch(() => props.aiGatewayEnabled, (enabled) => {
			if (enabled) fetchWallet();
		}, { immediate: true });
		watch(() => workflowExecutionStateStore.value.activeExecution, (executionData) => {
		...
		return (_ctx, _cache) => {
			...
			}, [(openBlock(true), createElementBlock(Fragment, null, renderList(credentialModeOrder.value, (mode) => {
				return openBlock(), createElementBlock(Fragment, { key: mode }, [mode === "gateway" ? (openBlock(), createElementBlock("button", {
					key: 0,
					type: "button",
					role: "radio",
					...
					"text",
					"hover-text"
				])) : createCommentVNode("", true)], 10, _hoisted_2)) : (openBlock(), createElementBlock("button", {
					key: 1,
					type: "button",
					role: "radio",
					"aria-checked": !__props.aiGatewayEnabled,
...
var NodeCredentials_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props, { emit: __emit }) {
		...
		function instanceAiCredentialHelp() {
			const openCredential = instanceAiCapability.openCredential;
			if (!instanceAi.value || !openCredential) return void 0;
		...
		const { canOAuthCredentialQuickConnect, hasManualCredentialInputFields, authorize } = useCredentialOAuth();
		...
		function getSelectedPrivateCredential(credentialType) {
		...
		function isPrivateConnected(credentialType) {
			return getSelectedPrivateCredential(credentialType)?.connectedByMe === true;
		}
		function canEditPrivateCredential(credentialType) {
			return getResourcePermissions(getSelectedPrivateCredential(credentialType)?.scopes).credential.update === true;
		}
		function canConnectPrivateCredential(credentialType) {
			return getResourcePermissions(getSelectedPrivateCredential(credentialType)?.scopes).credential.connect === true;
		}
		async function onConnectFromRow(credentialType) {
			const credential = getSelectedPrivateCredential(credentialType);
			if (!credential) return;
			if (await authorize(credential)) credentialsStore.setConnectedByMe(credential.id, true);
		}
		async function onDisconnectFromRow(credentialType) {
			const credential = getSelectedPrivateCredential(credentialType);
			if (!credential) return;
			try {
		...
		const isDefaultResolver = computed(() => {
			...
			return !resolverId || resolverId === "system-n8n";
		});
		...
		watch(() => props.node.parameters, (newValue, oldValue) => {
			if (props.node.name === ndvStore.value?.activeNode?.name && nodeType.value && listeningForAuthChange.value) {
		...
		watch(credentialTypesNodeDescriptionDisplayed, (types) => {
			...
			if (aiGateway.isEnabled.value && !aiGateway.isNodeTypeVersionSupported(node.value.type, node.value.typeVersion)) {
				for (const { type } of types) if (selected.value[type.name]?.__aiGatewayManaged) onAiGatewaySelector(type.name, false, false);
			}
			...
			if (allOptions.length === 0) {
				if (aiGateway.isEnabled.value && isInitialEvaluation && !shouldShowOwnCredentialFirst.value) {
					for (const { type } of types) if (aiGateway.isCredentialTypeSupported(type.name) && aiGateway.isNodeTypeVersionSupported(node.value.type, node.value.typeVersion) && isCurrentActionSupported.value) onAiGatewaySelector(type.name, true, false);
				}
				return;
			}
		...
		function getCredentialFetchScope() {
			const workflowId = workflowDocumentStore?.value.workflowId;
			if (workflowId && !workflowsStore.isNewWorkflow) return { workflowId };
			const projectId = props.projectId ?? projectsStore.currentProject?.id ?? projectsStore.personalProject?.id;
		...
		onMounted(() => {
			...
			if (scope) credentialsStore.fetchAllCredentialsForWorkflow(scope);
		...
		function createNewCredential(credentialType, listenForAuthChange = false, showAuthOptions = false, forceManualMode = false) {
			...
			uiStore.openNewCredential(credentialType, showAuthOptions, forceManualMode, props.projectId, props.suggestedCredentialName, props.node.name, props.node, {
		...
		function onCredentialSelected(credentialType, credentialId, showAuthOptions = false, isUserAction = true) {
			...
			if (isUserAction && !props.standalone) telemetry.track("Node credential assigned", {
				credential_type: credentialType,
				node_type: props.node.type,
		...
		function onAiGatewaySelector(credentialType, enable, isUserAction = true) {
			...
			if (isUserAction) {
				...
				if (!props.standalone && assignedKind) telemetry.track("Node credential assigned", {
					credential_type: credentialType,
					node_type: props.node.type,
					workflow_id: workflowDocumentStore?.value.workflowId,
			...
			if (!props.standalone) aiGateway.saveAfterToggle();
		}
			...
			return unref(credentialTypesNodeDescriptionDisplayed).length ? (openBlock(), createElementBlock("div", {
				...
				return openBlock(), createElementBlock("div", { key: type.name }, [createVNode(unref(N8nInputLabel_default), {
					...
					default: withCtx(() => [
						...
						__props.readonly && !isAiGatewayManagedCredentials(type.name) ? (openBlock(), createElementBlock("div", {
							key: 1,
							class: normalizeClass([_ctx.$style.selectContainer, { [_ctx.$style.inputWithPrivateRow]: getSelectedPrivateCredential(type.name) && isDefaultResolver.value }])
						}, [createVNode(unref(Input_default), {
							"model-value": getSelectedName(type.name),
							disabled: "",
							size: "small",
							"data-test-id": "node-credentials-select"
						}, null, 8, ["model-value"]), isCredentialResolvable(type.name) ? (openBlock(), createElementBlock("div", {
							key: 0,
							class: normalizeClass([_ctx.$style.dynamicIndicator, _ctx.$style.dynamicIndicatorReadonly])
						}, [createVNode(unref(N8nTooltip_default), { placement: "top" }, {
							content: withCtx(() => [createTextVNode(toDisplayString(unref(i18n).baseText("credentials.private.tooltip")), 1)]),
							...
							_: 1
						})], 2)) : createCommentVNode("", true)], 2)) : options.length === 0 && showQuickConnectEmptyState(type) && quickConnectCredentialType.value && !isAiGatewayManagedCredentials(type.name) ? (openBlock(), createElementBlock("div", {
							key: 2,
							...
							class: normalizeClass([getIssues(type.name).length && !__props.hideIssues ? _ctx.$style.hasIssues : _ctx.$style.input, {
								[_ctx.$style.inputWithPrivateRowEditable]: getSelectedPrivateCredential(type.name) && isDefaultResolver.value && canEditPrivateCredential(type.name),
								[_ctx.$style.inputWithPrivateRow]: getSelectedPrivateCredential(type.name) && isDefaultResolver.value && !canEditPrivateCredential(type.name)
							}]),
							"data-test-id": "node-credentials-select"
						}, [
							createBaseVNode("div", { class: normalizeClass(_ctx.$style.selectContainer) }, [createVNode(unref(N8nSelect_default), {
								...
								footer: withCtx(() => [createBaseVNode("button", {
									...
									size: "xsmall",
									icon: "plus"
								}), createTextVNode(" " + toDisplayString(unref(NEW_CREDENTIALS_TEXT)), 1)], 10, _hoisted_1)]),
								default: withCtx(() => [(openBlock(true), createElementBlock(Fragment, null, renderList(options.filter((o) => matches(filter.value, o.name)), (item) => {
									return openBlock(), createBlock(unref(N8nOption_default), {
										...
										default: withCtx(() => [createBaseVNode("div", { class: normalizeClass([
											...
											_: 2
										}, 1024), unref(isPrivateCredentialsEnabled) && item.isResolvable ? (openBlock(), createBlock(unref(N8nTooltip_default), {
											key: 0,
											placement: "top"
										}, {
											content: withCtx(() => [createTextVNode(toDisplayString(unref(i18n).baseText("credentials.private.tooltip")), 1)]),
							...
							selected.value[type.name] && unref(isCredentialExisting)(type) && (!getSelectedPrivateCredential(type.name) || canEditPrivateCredential(type.name)) ? (openBlock(), createElementBlock("div", {
								key: 1,
						...
						getSelectedPrivateCredential(type.name) && isDefaultResolver.value ? (openBlock(), createBlock(CredentialPrivateConnectionRow_default, {
							key: 5,
							"credential-type-name": type.name,
							"credential-name": getServiceName(type.name),
							"is-connected": isPrivateConnected(type.name),
							"connected-account-name": unref(usersStore).currentUser?.email ?? void 0,
							...
							onConnect: ($event) => onConnectFromRow(type.name),
							onModify: ($event) => editCredential(type.name),
							onDisconnect: ($event) => onDisconnectFromRow(type.name)
						}, null, 8, [
							"credential-type-name",
							"credential-name",
							"is-connected",
...
var NodeCredentials_vue_vue_type_style_index_0_lang_module_default = {
	container: "_container_inu0k_125",
	selectPopper: "_selectPopper_inu0k_132",
	newCredential: "_newCredential_inu0k_135",
	warning: "_warning_inu0k_144",
	edit: "_edit_inu0k_150",
	input: "_input_inu0k_162",
	selectContainer: "_selectContainer_inu0k_167",
	inputWithPrivateRow: "_inputWithPrivateRow_inu0k_177",
	inputWithPrivateRowEditable: "_inputWithPrivateRowEditable_inu0k_193",
	hasIssues: "_hasIssues_inu0k_208 _input_inu0k_162",
	credentialOption: "_credentialOption_inu0k_213",
	credentialOptionName: "_credentialOptionName_inu0k_218",
	dynamicIcon: "_dynamicIcon_inu0k_224",
	selectWithDynamic: "_selectWithDynamic_inu0k_228",
	dynamicIndicator: "_dynamicIndicator_inu0k_232",
	dynamicIndicatorReadonly: "_dynamicIndicatorReadonly_inu0k_240",
	quickConnectContainer: "_quickConnectContainer_inu0k_269",
	setupManuallyContainer: "_setupManuallyContainer_inu0k_278",
	setupManuallyOr: "_setupManuallyOr_inu0k_284",
	setupManuallyLink: "_setupManuallyLink_inu0k_288",
	standardEmptyContainer: "_standardEmptyContainer_inu0k_295",
	emptySelect: "_emptySelect_inu0k_302"
};
