const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/workers-oYKNjRqF.js","assets/comlink-BtXgpLdT.js"])))=>i.map(i=>d[i]);
import { o as __toESM, t as __commonJSMin } from "./chunk-CC9Q-vWm.js";
import { $ as openBlock, A as createTextVNode, C as createBaseVNode, Cn as toDisplayString, D as createPropsRestProxy, Dt as getCurrentScope, E as createElementBlock, Et as effectScope, Ft as readonly, Gt as unref, Ht as toRefs$1, I as h, It as ref, K as onBeforeMount, L as hasInjectionContext, Lt as shallowReactive, Mt as markRaw, N as defineComponent, Nt as onScopeDispose, P as getCurrentInstance, Pt as reactive, R as inject, S as computed, T as createCommentVNode, Tt as customRef, U as mergeProps, Ut as toValue$1, Vt as toRef, W as nextTick, X as onMounted, Z as onUnmounted, _ as Fragment, _t as watchEffect, at as resolveComponent, bn as normalizeStyle, bt as withCtx, ft as useSlots, gt as watch, it as renderSlot, j as createVNode, jt as isRef, lt as useAttrs, ot as resolveDirective, q as onBeforeUnmount, rt as renderList, st as resolveDynamicComponent, tt as provide, vn as normalizeClass, w as createBlock, xt as withDirectives, y as Teleport, z as isMemoSame, zt as shallowRef } from "./vue.runtime.esm-bundler-DYHsQBZB.js";
import { i as i18n, n as addHeaders, r as addNodeTranslation, s as useI18n } from "./src-C3h3FWXj.js";
import { t as __vitePreload } from "./preload-helper-CMc80dNB.js";
import { N as createEventHook, b as useLocalStorage, z as throttledWatch } from "./dist-CYNfKCbA.js";
import { t as truncate } from "./truncate-B0m9bkui.js";
import { c as useRoute } from "./vue-router-D2dKRIiV.js";
import { b as require_isArrayLike, t as require_merge } from "./merge-I1kuvuLK.js";
import { $i as isFilterValue, Ai as getNodeParameters, Ci as checkConditions, Da as ExpressionError, Di as getConnectionTypes, Ei as getActiveCredentialTypes, Fr as createEmptyRunExecutionData, Ho as require_memoize, Io as require_get, Ir as createRunExecutionData, Kn as normalizeGroupDescription, Ln as require__baseIteratee, Mi as getNodeWebhookUrl, Nt as getResourcePermissions, Oi as getNodeInputs, On as normalizeNodeShape, Qn as require__baseUniq, Ra as CHAT_TRIGGER_NODE_TYPE, Ti as displayParameterPath, Tn as isAssignmentCollectionValue, Za as MANUAL_TRIGGER_NODE_TYPE, Zn as splitExpression, co as require_keys, di as mapConnectionsByDestination, eo as SEND_AND_WAIT_OPERATION, fa as traverseNodeParameters, ga as deepCopy, io as v4, jn as Workflow, ka as UnexpectedError, ki as getNodeOutputs, la as NodeConnectionTypes, oa as isResourceLocatorValue, oo as require_isEqual, pa as isExpression, pi as getChildNodes, qi as nodeIssuesToString, ro as isIndefiniteWait, sa as isResourceMapperValue$1, tr as require__baseFindIndex, ua as nodeConnectionTypes, ui as resolveVariables, wa as sleep$1, wi as displayParameter, wr as isTrimmedNodeExecutionData, yn as require_pick, zi as isHitlToolType } from "./src-BrbN-vPn.js";
import { c as sanitizeHtml } from "./htmlUtils-BGBfSAfh.js";
import { $n as getFullApiResponse, At as getResourceLocatorResults, Ct as fetchCommunityNodeTypes, Dt as getNodeTranslationHeaders, Et as getNodeParameterOptions, Ot as getNodeTypes$1, St as fetchCommunityNodeAttributes, Tt as getNodeParameterActionResult, Yt as getProjectSecretProviderConnectionsByProjectId, Zn as ResponseError, a as getWorkflowVersion, bt as updateProjectPoolSettings, c as findWebhook, dr as getActivePinia, er as makeRestApiRequest, ir as streamRequest, jt as getResourceMapperFields, kt as getNodesInformation, or as axios, sr as STORES, t as useRootStore, ur as defineStore, vt as getProjectPoolSettings, w as updateCurrentUserSettings, wt as getLocalResourceMapperFields } from "./useRootStore-B-A2Ktsc.js";
...
import { D as TEMPLATES_NODES_FILTER, F as CUSTOM_API_CALL_KEY, Fn as SCHEDULE_TRIGGER_NODE_TYPE, G as AI_CATEGORY_HUMAN_IN_THE_LOOP, I as DATA_TYPE_ICON_MAP, M as IN_PROGRESS_EXECUTION_ID, N as PLACEHOLDER_FILLED_AT_EXECUTION_TIME, Ot as AI_MCP_TOOL_NODE_TYPE, Pa as INLINE_AGENTS_EXPERIMENT, Qn as WORKFLOW_TRIGGER_NODE_TYPE, R as MAPPING_PARAMS, Sn as NON_ACTIVATABLE_TRIGGER_NODE_TYPES, V as AI_CATEGORY_AGENTS, Xn as WEBHOOK_NODE_TYPE$1, Y as AI_CATEGORY_OTHER_TOOLS, Yt as ERROR_TRIGGER_NODE_TYPE$1, Zn as WIKIPEDIA_TOOL_NODE_TYPE, _a as WorkflowDocumentStoreKey, _t as RECOMMENDED_NODES, ao as EnterpriseEditionFeature, bn as NODE_POSITION_CONFLICT_ALLOWLIST, ca as CanvasRenderDataKey, ct as BETA_NODES, ft as HITL_SUBCATEGORY, gn as MESSAGE_AN_AGENT_NODE_TYPE, i as DUPLICATE_POSTFFIX, in as HTTP_REQUEST_NODE_TYPE, kt as AI_TRANSFORM_NODE_TYPE, lt as CORE_NODES_CATEGORY, nn as FORM_TRIGGER_NODE_TYPE$1, nt as AI_CODE_TOOL_LANGCHAIN_NODE_TYPE, pt as HUMAN_IN_THE_LOOP_CATEGORY, q as AI_CATEGORY_MCP_NODES, r as DEFAULT_SETTINGS, tt as AI_CATEGORY_VECTOR_STORES, un as LIST_LIKE_NODE_OPERATIONS, va as WorkflowIdKey, vn as MODULE_ENABLED_NODES, zr as MAIN_HEADER_TABS, zt as CREDENTIAL_ONLY_NODE_PREFIX } from "./constants-Bwbcx8Ih.js";
import { l as TIME } from "./durations-D9OTn4t5.js";
import { i as require_toNumber } from "./useDebounce-BRzd7gd1.js";
import { c as isEmpty, d as isPresent, h as stringSizeInBytes, m as shorten, p as omit, u as isJsonKeyObject, v as getObjectSizeInKB, y as isObject$1 } from "./typesUtils-BoKZFaOH.js";
import { a as getNewWorkflow, i as getLastSuccessfulExecution, l as getWorkflows, n as useFavoritesStore, r as getExecutionData, t as useWorkflowsListStore } from "./workflowsList.store-DR9pamv2.js";
import { T as CANCELLABLE_EXECUTION_STATUSES, n as useUIStore } from "./ui.store-ic9znGOr.js";
import { c as hasRole, t as hasPermission } from "./permissions-YtJsXBgp.js";
import { o as require_startCase, t as useEvaluationStore } from "./evaluation.store-C2cdvohf.js";
import { r as noCase } from "./dist--LvkdHNZ.js";
import { t as require_sortBy } from "./sortBy-BG6UtSCD.js";
import { n as useDocumentTitle } from "./useDocumentTitle-E3LUeduJ.js";
//#region ../@n8n/design-system/src/types/binary.ts
var BINARY_METADATA_KEYS = [
	"data",
	"mimeType",
	"fileType",
	"fileName",
...
var isBinary = (obj) => {
	...
	for (const key of Object.keys(entry)) {
		...
		if (key === "bytes") {
			if (value !== void 0 && typeof value !== "number") return false;
			continue;
		}
		if (!BINARY_METADATA_KEYS.includes(key)) return false;
...
function useExecutingNode() {
	...
	function addExecutingNode(nodeName, sequenceNumber) {
		if (executingNode.value.length > 0 && sequenceNumber <= latestSequenceNumber) return;
		executingNode.value = [nodeName];
		lastAddedExecutingNode.value = nodeName;
		latestSequenceNumber = sequenceNumber;
	}
	function removeExecutingNode(nodeName) {
		if (executingNode.value[0] === nodeName) executingNode.value = [];
	}
...
var CanvasNodeRenderType = /* @__PURE__ */ function(CanvasNodeRenderType) {
	...
	CanvasNodeRenderType["Agent"] = "n8n-nodes-base.messageAnAgent";
...
function useExecutionDataStore(id) {
	return defineStore(getExecutionDataStoreId(id), () => {
		...
		const executionNodeById = computed(() => {
			const kvPairs = (execution.value?.workflowData?.nodes ?? []).map((n) => [n.id, n]);
		...
		const executionIssuesByNodeId = shallowReactive(/* @__PURE__ */ new Map());
		const executionPinDataByNodeId = shallowReactive(/* @__PURE__ */ new Map());
		...
		function computeNodeExecutionIssuesById(nodeId) {
			const node = getExecutionNodeById(nodeId);
			if (!node) return [];
			return computeNodeExecutionIssues(node.name);
		}
		function computeExecutionPinData(nodeId) {
			const node = getExecutionNodeById(nodeId);
			if (!node) return;
		...
		function computeExecutionWaiting(nodeId) {
			...
			if (isIndefiniteWait(waitDate)) return i18n.baseText("node.theNodeIsWaitingIndefinitelyForAnIncomingWebhookCall");
		...
		function applyAddByIdEntry(nodeId) {
			...
			scope.run(() => {
				...
				executionIssuesByNodeId.set(nodeId, structuralComputed(() => computeNodeExecutionIssuesById(nodeId), import_isEqual.default));
				executionPinDataByNodeId.set(nodeId, computed(() => computeExecutionPinData(nodeId)));
			});
...
var AGENT_NODE_SIZE = [320, 128];
var PUSH_NODES_OFFSET = DEFAULT_NODE_SIZE[0] * 2 + 16;
var HORIZONTAL_NODE_STEP = DEFAULT_NODE_SIZE[0] + 128;
...
function snapPositionToGridByCenter(position, [nodeWidth, nodeHeight]) {
	const snappedCenter = [Math.round((position[0] + nodeWidth / 2) / 16) * 16, Math.round((position[1] + nodeHeight / 2) / 16) * 16];
...
function createEmptyCanvasRenderData(overrides = {}) {
	return {
		...
		executionPinDataByNodeName: {},
		executionIssuesByNodeId: shallowReactive(/* @__PURE__ */ new Map()),
		executionPinDataByNodeId: shallowReactive(/* @__PURE__ */ new Map()),
...
function shouldIgnoreCanvasShortcut(el) {
	return ["INPUT", "TEXTAREA"].includes(el.tagName) || el.closest("[contenteditable]") !== null || el.closest("[role=\"dialog\"]") !== null || el.closest(".ignore-key-press-canvas") !== null;
}
//#endregion
...
//#endregion
//#region ../../../node_modules/.pnpm/lodash@4.18.1_patch_hash=81ead1b07fc8efda87bd2724dbd876ab49f4a0aa03f96c3770060b2ea47d9e0b/node_modules/lodash/_createFind.js
...
//#endregion
//#region ../../../node_modules/.pnpm/lodash@4.18.1_patch_hash=81ead1b07fc8efda87bd2724dbd876ab49f4a0aa03f96c3770060b2ea47d9e0b/node_modules/lodash/toFinite.js
...
//#endregion
//#region ../../../node_modules/.pnpm/lodash@4.18.1_patch_hash=81ead1b07fc8efda87bd2724dbd876ab49f4a0aa03f96c3770060b2ea47d9e0b/node_modules/lodash/toInteger.js
...
//#endregion
//#region ../../../node_modules/.pnpm/lodash@4.18.1_patch_hash=81ead1b07fc8efda87bd2724dbd876ab49f4a0aa03f96c3770060b2ea47d9e0b/node_modules/lodash/findLastIndex.js
...
//#endregion
//#region ../../../node_modules/.pnpm/lodash@4.18.1_patch_hash=81ead1b07fc8efda87bd2724dbd876ab49f4a0aa03f96c3770060b2ea47d9e0b/node_modules/lodash/findLast.js
...
async function getUsableCredentials(context, options) {
...
async function disconnectOauthToken(context, id) {
...
*/
async function probeCredential(context, credentialId) {
...
*/
function usesParameterSelectedCredentials(node) {
...
* show) stay removable.
*/
function getAuthModeIndependentCredentials(nodeType) {
	const types = /* @__PURE__ */ new Set();
	for (const credential of nodeType?.credentials ?? []) {
		const { show, hide } = credential.displayOptions ?? {};
		if (![show, hide].some((rules) => rules !== void 0 && ("authentication" in rules || `/authentication` in rules))) types.add(credential.name);
	}
	return types;
}
/**
...
*/
function getInactiveCredentials(node, nodeType) {
	if (!node.credentials) return [];
	const activeTypes = getActiveCredentialTypes(node, nodeType);
	if (!activeTypes) return [];
	const keepRegardlessOfAuthMode = usesParameterSelectedCredentials(node) ? getAuthModeIndependentCredentials(nodeType) : /* @__PURE__ */ new Set();
	return Object.keys(node.credentials).filter((type) => !activeTypes.has(type) && !keepRegardlessOfAuthMode.has(type));
}
...
var useProjectsStore = defineStore(STORES.PROJECTS, () => {
	...
	const currentProjectPoolSettings = ref(null);
	...
	const fetchProjectPoolSettings = async (projectId) => {
		currentProjectPoolSettings.value = null;
		currentProjectPoolSettings.value = await getProjectPoolSettings(rootStore.restApiContext, projectId);
	};
	const updateCurrentProjectPoolSettings = async (projectId, dto) => {
		currentProjectPoolSettings.value = await updateProjectPoolSettings(rootStore.restApiContext, projectId, dto);
	};
...
async function resolveParameterLeaves(parameter, workflowDocumentId, opts) {
	if (Array.isArray(parameter)) return await Promise.all(parameter.map(async (value) => await resolveParameterLeaves(value, workflowDocumentId, opts)));
	if (parameter !== null && typeof parameter === "object") {
		const entries = await Promise.all(Object.entries(parameter).map(async ([name, value]) => [name, await resolveParameterLeaves(value, workflowDocumentId, opts)]));
		return Object.fromEntries(entries);
	}
	try {
		return await resolveParameter(parameter, workflowDocumentId, opts);
	} catch {
		return null;
	}
}
...
var SECRET_REFERENCE = /\$secrets\b/;
/** The only key forms we can read at edit time: `.key`, `['key']`, `["key"]`. */
var LITERAL_KEY_ACCESS = /^\s*(?:\.\s*(?<dotKey>[a-zA-Z_$][\w$]*)|\[\s*(?<quote>['"])(?<quotedKey>[^\\]*?)\k<quote>\s*\])/;
...
*/
var readLiteralKeys = (afterReference) => {
	const keys = [];
	...
	return {
		keys,
		hasUnreadAccess: UNREAD_ACCESS.test(rest)
	};
};
/**
...
*/
var lookUpKeys = (keys, secrets) => {
	let value = secrets;
	for (const key of keys) {
		if (!isObject$1(value)) return "unknown";
...
*/
var getExternalSecretReferenceState = (expression, secrets) => {
	let state = "none";
	for (const { type, text: code } of splitExpression(expression)) {
...
var getExternalSecretPreview = (expression, secrets) => {
	switch (getExternalSecretReferenceState(expression, secrets)) {
		case "known": return {
			text: i18n.baseText("expressionModalInput.evaluatedDuringExecution"),
			exists: true
		};
		case "missing": return {
			text: i18n.baseText("expressionModalInput.secretNotFound"),
			exists: false
		};
		default: return;
	}
...
var scopeKey = (scope) => "workflowId" in scope ? `workflow:${scope.workflowId}` : `project:${scope.projectId}`;
var useCredentialsStore = defineStore(STORES.CREDENTIALS, () => {
	...
	*/
	...
	const usableCredentialsScope = ref(null);
	...
	const allUsableCredentialsByType = computed(() => {
		const byType = {};
		for (const credential of Object.values(usableCredentials.value)) (byType[credential.type] ??= []).push(credential);
		for (const credentials of Object.values(byType)) credentials.sort((a, b) => a.name.localeCompare(b.name));
		return byType;
	});
	...
	const isCredentialTypeTestable = computed(() => {
		return (credentialTypeName) => {
			...
			const nodeTypesStore = useNodeTypesStore();
			return (credentialType.supportedNodes ?? []).some((nodeType) => nodeTypesStore.getNodeVersions(nodeType).some((version) => nodeTypesStore.getNodeType(nodeType, version)?.credentials?.some((credential) => credential.name === credentialTypeName && credential.testedBy)));
		};
	});
	...
	const fetchUsableCredentials = async (options) => {
		const requestedScope = scopeKey(options);
		if (usableCredentialsScope.value && scopeKey(usableCredentialsScope.value) !== requestedScope) clearUsableCredentials();
		const requestId = ++usableCredentialsRequestId;
		const credentials = await getUsableCredentials(rootStore.restApiContext, options);
		setCredentials(credentials);
		if (requestId !== usableCredentialsRequestId) return credentials;
		usableCredentials.value = credentials.reduce((accu, cred) => {
			if (cred.id) accu[cred.id] = cred;
			return accu;
		}, {});
	...
	*/
	const refreshUsableCredentials = async () => {
	...
	*/
	const hasUsableCredentialsForScope = computed(() => {
		return (scope) => hasFetchedUsableCredentials.value && usableCredentialsScope.value !== null && scopeKey(usableCredentialsScope.value) === scopeKey(scope);
	});
	...
	const disconnectOauthToken$1 = async ({ id }) => {
		await disconnectOauthToken(rootStore.restApiContext, id);
	};
	/**
	...
	*/
	const setConnectedByMe = (id, connectedByMe, connectedAccountIdentifier) => {
	...
	const testCredential$1 = async (data) => {
		...
		try {
			...
			if (data.id) credentialTestResults.value.set(data.id, "error");
			throw error;
		}
	};
	...
	const getDedupedCredentialName = async (name) => {
		try {
			return (await getCredentialsNewName(rootStore.restApiContext, name)).name;
		} catch (e) {
			return name;
		}
	};
	...
	return {
		...
		disconnectOauthToken: disconnectOauthToken$1,
		setConnectedByMe,
		upsertCredential,
...
var WALLET_CACHE_TTL_MS = TIME.MINUTE;
/**
...
*/
function createCachedFetch(fetcher, ttlMs) {
	let inFlight = null;
	let cached = null;
	return async function fetch({ force = false } = {}) {
...
function usesFreeCreditsLabel(hasEverToppedUp, balance) {
	return hasEverToppedUp !== true && (balance === void 0 || balance > 0);
}
var useAiGatewayStore = defineStore(STORES.AI_GATEWAY, () => {
	...
	const hasEverToppedUp = ref(void 0);
	const creditsLabelKey = computed(() => usesFreeCreditsLabel(hasEverToppedUp.value, balance.value) ? "generic.freeCredits" : "generic.n8nCredits");
	const usageEntries = ref([]);
	const usageTotal = ref(0);
	const fetchError = ref(null);
	let configFetch = null;
	const fetchWalletData = createCachedFetch(async () => await getGatewayWallet(rootStore.restApiContext), WALLET_CACHE_TTL_MS);
	...
	*/
	function canServeCredentialType(credentialType) {
		return config.value?.providerConfig?.[credentialType] !== void 0;
	}
	/**
	...
	*/
	...
	function hasGatewayManagedCredential(node) {
	...
	*/
	function isActionOptionVisible(node, parameterName, optionValue) {
		if (parameterName !== "resource" && parameterName !== "operation") return true;
		if (!hasGatewayManagedCredential(node)) return true;
		const nodeActions = config.value?.supportedActions?.[node.type] ?? config.value?.supportedActions?.[stripToolSuffix(node.type)];
		if (!nodeActions) return true;
...
//#endregion
//#region src/experiments/inlineAgents/useInlineAgentsExperiment.ts
function useInlineAgentsExperiment() {
	const posthogStore = usePostHog();
	return { isFeatureEnabled: computed(() => posthogStore.isFeatureEnabled(INLINE_AGENTS_EXPERIMENT.name)) };
}
/**
...
*/
function getN8nAgentsNodeName(nodeTypeName) {
	if (nodeTypeName !== "n8n-nodes-base.messageAnAgent") return void 0;
	return usePostHog().isFeatureEnabled(INLINE_AGENTS_EXPERIMENT.name) ? "AI Agent V2" : void 0;
}
//#endregion
...
var AI_GATEWAY_SEARCH_BOOST = 75;
var AI_GATEWAY_BOOST_MIN_QUERY_LENGTH = 3;
var MESSAGE_AN_AGENT_SEARCH_BOOST = 150;
/**
...
*/
function matchesAliasForConnectBoost(query, aliases) {
...
function isAiGatewayEligibleNode(nodeName) {
	...
	].find((n) => aiGatewayStore.isNodeSupported(n));
	if (!supportedName) return false;
	return aiGatewayStore.isNodeTypeVersionSupported(supportedName, getLatestKnownVersion(supportedName));
}
/**
...
* defaulting to 1.
*/
function getLatestKnownVersion(nodeName) {
	const nodeTypesStore = useNodeTypesStore();
...
function getAiGatewaySearchBoosts(query, items) {
	if (query === "" || !useSettingsStore().isAiGatewayEnabled) return {};
	const boosts = {};
	for (const item of items) {
		if (item.type !== "node") continue;
		if (!matchesAliasForConnectBoost(query, item.properties.codex?.alias ?? [])) continue;
...
function searchNodes(searchFilter, items, additionalFactors = {}) {
	...
	const searchResults = sublimeSearch(trimmedFilter, items) || [];
	const aiGatewayBoost = getAiGatewaySearchBoosts(trimmedFilter, searchResults.map(({ item }) => item));
	return reRankSearchResults(searchResults, {
		...additionalFactors,
		aiGatewayBoost,
...
*/
function showsAiGatewaySection(stack) {
	if (!stack || stack.search) return false;
	return stack.connectionType === NodeConnectionTypes.AiLanguageModel || stack.rootView === "Regular" && stack.subcategory === "*" || stack.subcategory === "Other Tools";
}
/**
...
*/
function extractAiGatewaySection(items) {
	const supported = [];
	const rest = [];
	for (const item of items) (item.type === "node" && isAiGatewayEligibleNode(item.properties.name) ? supported : rest).push(item);
...
function applyNodeTags(element) {
	...
	if (agentsNodeName) element.properties.displayName = agentsNodeName;
	...
	if (element.properties.name === "n8n-nodes-base.messageAnAgent") element.properties.tag = {
		preview: true,
		text: i18n.baseText("nodeCreator.nodeItem.earlyPreview")
	};
	else if (RECOMMENDED_NODES.includes(element.properties.name)) element.properties.tag = {
		type: "info",
		...
		element.properties.tag = creditsLabelKey === "generic.freeCredits" ? {
			text: i18n.baseText(creditsLabelKey),
			pill: true
		} : {
			text: i18n.baseText(creditsLabelKey),
			pill: true,
...
function finalizeItems(items) {
	return items.map((item) => item.type !== "node" ? {
		...item,
		uuid: `${item.key}-${v4()}`
	} : {
		...item,
...
var useNodeTypesStore = defineStore(STORES.NODE_TYPES, () => {
	...
	const vettedCommunityNodeTypes = shallowRef(/* @__PURE__ */ new Map());
	const rootStore = useRootStore();
	...
	const loadNodesInformationFromLocalDb = async (nodeInfos) => {
		try {
			const { getNodeType } = await __vitePreload(async () => {
				const { getNodeType } = await import("./workers-oYKNjRqF.js");
				return { getNodeType };
			}, __vite__mapDeps([0,1]));
			const found = [];
			const missing = [];
	...
	const loadNodeTypesFromLocalDb = async () => {
		try {
			const { loadNodeTypes, getAllNodeTypes } = await __vitePreload(async () => {
				const { loadNodeTypes, getAllNodeTypes } = await import("./workers-oYKNjRqF.js");
				return {
					loadNodeTypes,
					getAllNodeTypes
				};
...
function useWorkflowDocumentNodes(deps) {
	...
	function applySetNodes(newNodes) {
		for (const node of newNodes) {
			...
			if (node.position) {
				...
				node.position = isAgentNodeV2(node) ? [snappedPosition[0], node.position[1]] : snappedPosition;
			}
		}
	...
	*/
	function updateNodeProperties(updateInformation, { markDirty = true } = {}) {
		const nodeIndex = nodes.value.findIndex((node) => node.name === updateInformation.name);
		if (nodeIndex !== -1) for (const key of Object.keys(updateInformation.properties)) {
			...
			if (updateNodeAtIndex(nodeIndex, { [key]: property }) && markDirty) onStateDirty.trigger();
		}
	}
...
function useWorkflowDocumentGraph(workflowObject) {
	...
	function checkIfNodeHasChatOrManualChatParent(nodeName) {
		return getParentNodes(nodeName, NodeConnectionTypes.Main).some((parent) => {
			const parentNodeType = workflowObject.value.getNode?.(parent)?.type;
			return parentNodeType === "@n8n/n8n-nodes-langchain.chatTrigger" || parentNodeType === "@n8n/n8n-nodes-langchain.manualChatTrigger";
		});
	}
...
//#endregion
//#region ../../../node_modules/.pnpm/lodash@4.18.1_patch_hash=81ead1b07fc8efda87bd2724dbd876ab49f4a0aa03f96c3770060b2ea47d9e0b/node_modules/lodash/uniq.js
...
function getParameterDisplayableOptions(options, node) {
	...
	return options.filter((option) => {
		if (option.envFeatureFlag && !envFeatureFlag.value(option.envFeatureFlag)) return false;
...
function serializeNode(nodeTypeProvider, node) {
	...
	if (nodeType !== null) {
		...
		const nodeParameters = getNodeParameters(nodeType.properties, nodeParametersInput, isCredentialOnly, false, node, nodeType);
		nodeData.parameters = nodeParameters !== null ? nodeParameters : {};
		if (node.credentials !== void 0 && node.credentials !== null && nodeType.credentials !== void 0) {
			const saveCredentials = {};
			const parameterSelected = usesParameterSelectedCredentials(node);
			const removableCredentialTypes = parameterSelected ? new Set(getInactiveCredentials(node, nodeType)) : /* @__PURE__ */ new Set();
			for (const nodeCredentialTypeName of Object.keys(node.credentials)) {
				if (parameterSelected) {
					if (!removableCredentialTypes.has(nodeCredentialTypeName)) saveCredentials[nodeCredentialTypeName] = node.credentials[nodeCredentialTypeName];
					continue;
				}
				const credentialTypeDescription = nodeType.credentials.filter((c) => displayParameterPath(nodeParametersInput, c, "", node, nodeType)).find((c) => c.name === nodeCredentialTypeName);
				if (credentialTypeDescription === void 0) continue;
				if (!displayParameterPath(nodeParametersInput, credentialTypeDescription, "", node, nodeType)) continue;
		...
		if (node.credentials !== void 0 && node.credentials !== null) nodeData.credentials = node.credentials;
	...
	if (node.onError !== void 0 && node.onError !== null && node.onError !== "stopWorkflow") nodeData.onError = node.onError;
	if (node.notes !== void 0 && node.notes !== null && node.notes !== "") nodeData.notes = node.notes;
	return nodeData;
}
//#endregion
...
*/
function deriveHomeProject(workflow) {
	return workflow.homeProject ?? workflow.shared?.find((share) => share.role === "workflow:owner")?.project ?? null;
}
...
//#endregion
//#region src/features/agents/utils/agentCapabilityActivity.ts
function toolActivityKey(name) {
	return `tool:${name}`;
}
function skillIdActivityKey(id) {
	return `skill:id:${id}`;
}
function skillNameActivityKey(name) {
	return `skill:name:${name}`;
}
function capabilityActivityKeys(capability) {
	if (capability.kind === "tool") return [toolActivityKey(capability.name)];
	if (capability.id !== void 0) return [skillIdActivityKey(capability.id)];
...
var EMPTY_EXECUTION_ISSUES_BY_NODE_ID = /* @__PURE__ */ new Map();
var EMPTY_EXECUTION_PIN_DATA_BY_NODE_ID = /* @__PURE__ */ new Map();
/**
...
function useWorkflowExecutionStateStore(id) {
	return defineStore(getWorkflowExecutionStateStoreId(id), () => {
		...
		*/
		...
		const activeAgentCapabilityCalls = shallowReactive(/* @__PURE__ */ new Map());
		const latestAgentProgressByCapabilityCall = /* @__PURE__ */ new Map();
		const agentCapabilityRemovalTimers = /* @__PURE__ */ new Map();
		...
		function clearAgentNodeProgress(nodeName) {
			for (const [key, call] of activeAgentCapabilityCalls) if (call.nodeName === nodeName) removeAgentCapabilityCall(key);
			for (const [key, call] of latestAgentProgressByCapabilityCall) if (call.nodeName === nodeName) latestAgentProgressByCapabilityCall.delete(key);
		}
		...
		function handleAgentNodeProgress({ data }) {
			...
			if (!call) return;
			const remainingDuration = Math.max(0, 300 - (Date.now() - call.startedAt));
			if (remainingDuration === 0) {
				removeAgentCapabilityCall(callKey);
				return;
			}
			agentCapabilityRemovalTimers.set(callKey, setTimeout(() => removeAgentCapabilityCall(callKey), remainingDuration));
		}
		...
		*/
		...
		function dropRunDataOfReplacedNodes(runData, executedNodes) {
			if (!runData || !executedNodes?.length) return runData;
		...
		const activeExecutionRunData = computed(() => {
			...
			const executionDataStore = useExecutionDataStore(createExecutionDataId(executionId));
			executionDataStore.executionResultDataLastUpdate;
			return dropRunDataOfReplacedNodes(executionDataStore.executionRunData, executionDataStore.execution?.workflowData?.nodes);
		});
...
function hasCancellableExecutions(executions) {
	const cancellableStatuses = new Set(CANCELLABLE_EXECUTION_STATUSES);
...
//#endregion
export { groupItemsInSections as $, createCanvasGroupNodeId as $i, getNodeCredentialForSelectedAuthType as $n, MarkerType as $r, resolveRequiredParameters as $t, useWorkflowDocumentStore as A, isCredentialModalState as Ai, downloadDataTableCsvApi as An, resolveCanonicalConnection as Ar, generateCodeForPrompt as At, require_uniq as B, isString as Bi, uploadCsvFileApi as Bn, calculateNodeSize as Br, getMappedResult as Bt, createExecutionPreviewDocumentId as C, useExecutionDataStore as Ci, moveFolderToProject as Cn, getMaxNodePortsLabelSize as Cr, useAiGatewayStore as Ct, disposeWorkflowDocumentStore as D, isBaseTextKey as Di, deleteDataTableApi as Dn, mapLegacyConnectionToCanvasConnection as Dr, chatWithAssistant as Dt, deriveHomeProject as E, checkExhaustive as Ei, createDataTableApi as En, mapCanvasConnectionToLegacyConnection as Er, useCredentialsStore as Et, getNodeTypeDisplayableCredentials as F, isProjectRole as Fi, insertDataTableRowApi as Fn, CONFIGURATION_NODE_SIZE as Fr, useAIAssistantHelpers as Ft, extractAiGatewaySection as G, isVueFlowConnection as Gi, getAllNodeCredentialForAuthType as Gn, getMidCanvasPosition as Gr, getResolvableState as Gt, useNodeTypesStore as H, isValidCredentialResponse as Hi, fieldCannotBeDeleted as Hn, generateOffsets as Hr, completeExpressionSyntax as Ht, getParameterDisplayableOptions as I, isResourceMapperValue as Ii, moveDataTableColumnApi as In, DEFAULT_NODE_SIZE as Ir, useDataSchema as It, flattenCreateElements as J, CANVAS_NODE_GROUP_HANDLE_RIGHT as Ji, getAuthTypeForNodeCredential as Jn, getNodeViewTab as Jr, removeExpressionPrefix as Jt, filterAndSearchNodes as K, isWorkflowListItem as Ki, getAppNameFromCredType as Kn, getMousePosition as Kr, isPairedItemIntermediateNodesError as Kt, needsAgentInput as L, isResourceSortableByDate as Li, renameDataTableColumnApi as Ln, DEFAULT_VIEWPORT_BOUNDARIES as Lr, useFlattenSchema as Lt, assignNodeId as M, isDateObject as Mi, fetchDataTablesApi as Mn, injectStrict as Mr, getBuilderCredits as Mt, doesNodeHaveAllCredentialsFilled as N, isDebouncedFunction as Ni, getDataTableRowsApi as Nn, AGENT_NODE_SIZE as Nr, replaceCode as Nt, injectWorkflowDocumentStore as O, isBinaryLike as Oi, deleteDataTableColumnApi as On, mapLegacyConnectionsToCanvasConnections as Or, chatWithBuilder as Ot, doesNodeHaveCredentialsToFill as P, isFullExecutionResponse as Pi, importCsvToDataTableApi as Pn, CONFIGURABLE_NODE_SIZE as Pr, truncateBuilderMessages as Pt, getSendAndWaitNodes as Q, CanvasNodeRenderType as Qi, getNodeAuthOptions as Qn, updateViewportToContainNodes as Qr, resolveParameter as Qt, serializeNode as R, isRouteLocationRaw as Ri, updateDataTableApi as Rn, HORIZONTAL_NODE_STEP as Rr, escapeMappingString as Rt, toolActivityKey as S, hasExecutionDataStore as Si, ProjectTypes as Sn, createEmptyCanvasRenderData as Sr, stripToolSuffix as St, createWorkflowDocumentId as T, getPairedItemId as Ti, addDataTableColumnApi as Tn, insertSpacersBetweenEndpoints as Tr, listenForCredentialChanges as Tt, isDataWorkerEnabled as U, isValidNodeConnectionType as Ui, filterTemplateNodes as Un, getBounds as Ur, getExpressionErrorMessage as Ut, isAgentNodeV2 as V, isTriggerPanelObject as Vi, executionDataToJson as Vn, doRectsOverlap as Vr, propertyNameFromExpression as Vt, useActionsGenerator as W, isVariableResource as Wi, getActivatableTriggerNodes as Wn, getGenericHints as Wr, getExternalSecretPreview as Wt, getHumanInTheLoopActions as X, CanvasConnectionMode as Xi, getMainAuthField as Xn, getNodesWithNormalizedPosition as Xr, stringifyExpressionResult as Xt, getAiTemplatesCallout as Y, CANVAS_NODE_GROUP_TYPE as Yi, getInactiveCredentials as Yn, getNodesGroupSize as Yr, shouldConvertToExpression as Yt, getRootSearchCallouts as Z, CanvasNodeDirtiness as Zi, getNodeAuthFields as Zn, snapPositionToGridByCenter as Zr, unwrapExpression as Zt, disposeWorkflowExecutionStateStore as _, wheelDelta as _i, splitName as _n, applyOffset as _r, isTutorialTemplateId as _t, executionFilterToQueryFilter as a, _sfc_main$3 as ai, ensureNodePosition as an, hasProxyAuth as ar, prepareCommunityNodeDetailsViewStack as at, skillIdActivityKey as b, createExecutionDataId as bi, useProjectsStore as bn, createCanvasConnectionHandleString as br, getN8nAgentsNodeName as bt, getDefaultExecutionFilters as c, clamp as ci, sortNodesByExecutionOrder as cn, isRequiredCredential as cr, shouldShowCommunityNodeDetails as ct, hasCancellableExecutions as d, getConnectedEdges as di, injectNDVStoreIfProvided as dn, isValueExpression as dr, subcategorizeItems as dt, isCanvasGroupNode as ea, NodeId as ei, useWorkflowHelpers as en, getNodeSubtitle as er, isAINode as et, hasTrimmedRunData as f, getRectOfNodes as fi, useNDVStore as fn, parseResourceMapperFieldName as fr, transformNodeType as ft, parse as g, useVueFlow as gi, getTruncatedProjectName as gn, isCredentialOnlyNodeType as gr, getTutorialTemplates as gt, waitingNodeTooltip as h, useGetPointerPosition as hi, ResourceType as hn, probeCredential as hr, getSampleWorkflowByTemplateId as ht, displayForm as i, _sfc_main$1 as ii, useTagsStore as in, hasOnlyListMode as ir, nodeTypesToCreateElements as it, TOOL_NODE_TYPES_NEED_INPUT as j, isCredentialsResource as ji, fetchDataTableGlobalLimitInBytes as jn, shouldIgnoreCanvasShortcut as jr, getAiSessions as jt, provideWorkflowDocumentStore as k, isComponentPublicInstance as ki, deleteDataTableRowsApi as kn, parseCanvasConnectionHandleString as kr, clearBuilderSession as kt, getExecutionErrorMessage as l, getBezierPath as li, disposeNDVStore as ln, isResourceMapperFieldListStale as lr, showsAiGatewaySection as lt, unflattenExecutionData as m, isMacOs as mi, useEnvironmentsStore as mn, getAllCredentials as mr, getRagStarterWorkflowJson as mt, buildExecutionResponseFromSchema as n, structuralComputed as na, Position as ni, useWorkflowId as nn, getTriggerNodeServiceName as nr, isNodePreviewKey as nt, executionRetryMessage as o, _sfc_main$d as oi, removeWorkflowExecutionData as on, isAuthRelatedParameter as or, removePreviewToken as ot, openFormPopupWindow as p, getSmoothStepPath as pi, LOCAL_STORAGE_NDV_PANEL_WIDTH as pn, updateNodeAuthType as pr, SampleTemplates as pt, finalizeItems as q, CANVAS_NODE_GROUP_HANDLE_LEFT as qi, getAppNameFromNodeName as qn, getNewNodePosition as qr, isTestableExpression as qt, clearPopupWindowState as r, isBinary as ra, _sfc_main as ri, useAnnotationTagsStore as rn, hasExpressionMapping as rr, mapToolSubcategoryIcon as rt, findTriggerNodeToAutoSelect as s, _sfc_main$f as si, sanitizeConnections as sn, isMatchingField as sr, searchNodes as st, useWorkflowsStore as t, parseCanvasGroupNodeId as ta, PanelPosition as ti, useRouteWorkflowId as tn, getThemedValue as tr, isAiGatewayEligibleNode as tt, getExecutionErrorToastConfiguration as u, getBoundsofRects as ui, injectNDVStore as un, isResourceMapperSchemaIncomplete as ur, sortNodeCreateElements as ut, injectWorkflowExecutionStateStore as v, getPinDataSize as vi, useAvailableProjectSearch as vn, checkOverlap as vr, isFullTemplatesCollection as vt, createExecutionPreviewDocumentVersion as w, CHANGE_ACTION as wi, setWorkflowSharedWith as wn, injectCanvasRenderData as wr, sublimeSearch as wt, skillNameActivityKey as x, disposeExecutionDataStore as xi, useSourceControlStore as xn, createCanvasConnectionId as xr, useInlineAgentsExperiment as xt, useWorkflowExecutionStateStore as y, pinDataToExecutionData as yi, useRemoteProjectSearch as yn, computeNodeDisplaySize as yr, isTemplatesWorkflow as yt, useEnvFeatureFlag as z, isSharedResource as zi, updateDataTableRowsApi as zn, PUSH_NODES_OFFSET as zr, getMappedExpression as zt };
