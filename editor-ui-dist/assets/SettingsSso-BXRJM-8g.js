...
import { $ as openBlock, A as createTextVNode, At as isRef, C as createBaseVNode, E as createElementBlock, Ft as ref, H as mergeModels, N as defineComponent, S as computed, Sn as toDisplayString, T as createCommentVNode, W as nextTick, Wt as unref, X as onMounted, _ as Fragment, _n as normalizeClass, dt as useModel, gt as watch, h as withModifiers, it as renderSlot, j as createVNode, pt as useTemplateRef, q as onBeforeUnmount, rt as renderList, w as createBlock, yt as withCtx } from "./vue.runtime.esm-bundler-Bw8GKr4Y.js";
import { at as useI18n } from "./core-Beh0t8_q.js";
import { Et as N8nCard_default, Ii as N8nActionBox_default, N as N8nRadioButtons_default, Ni as Input_default, bt as N8nOption_default, ct as onBeforeRouteLeave, da as N8nHeading_default, fa as N8nCallout_default, ft as Checkbox_default, ha as N8nIcon_default, ki as N8nTooltip_default, ma as N8nButton_default, pa as N8nText_default, yt as N8nSelect_default } from "./src-Dg8CDsvD.js";
import { t as _plugin_vue_export_helper_default } from "./_plugin-vue_export-helper-Da88TEg1.js";
import { t as useMessage } from "./useMessage-7ZvpkKZ5.js";
import { t as ElDialog } from "./dialog-BbacGLhq.js";
import { Jt as useTelemetry, Kt as useProjectsStore, qr as useRBACStore } from "./users.store-Zd_8U4jS.js";
import { t as useToast } from "./useToast-DG5hVw1V.js";
import "./constants-c-L9DE1I.js";
import { t as useRootStore } from "./useRootStore-CCt5xa74.js";
import { $ as listRoleMappingRules, Q as deleteRoleMappingRule, Z as createRoleMappingRule, et as moveRoleMappingRule, p as getUsers, tt as updateRoleMappingRule } from "./settings.store-CN5kyBJf.js";
...
import { t as CopyInput_default } from "./CopyInput-Czhaic2a.js";
import { Ft as LanguageSupport, Nt as HighlightStyle, Pt as LRLanguage, Xt as syntaxTree, Yt as syntaxHighlighting, _n as keymap, an as EditorView, en as tags, et as history, i as javascriptLanguage, in as Decoration, kn as EditorState, n as parserWithMetaData, nt as historyKeymap, rn as parseMixed, sn as ViewPlugin } from "./expressions-CR_NfPXU.js";
import { r as captureMessage } from "./exports-DytKeQJj.js";
import { t as useRolesStore } from "./roles.store-dTfMugRi.js";
import { n as useSSOStore, t as SupportedProtocols } from "./sso.store-o3qtkZr8.js";
import { t as require_vuedraggable_umd } from "./vuedraggable.umd-B9XCx056.js";
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("div", null, [
				...
				showIdpInfoBox.value ? (openBlock(), createElementBlock("div", {
					...
					}, toDisplayString(unref(i18n).baseText("settings.sso.settings.roleMappingMethod.idp.learnMore")), 11, _hoisted_1$4)]),
					_: 1
...
function getTelemetrySettingValue(roleAssignment, mappingMethod) {
...
function useUserRoleProvisioningForm(protocol) {
	...
	const saveProvisioningConfig = async (isDisablingSso) => {
		...
		const stored = storedValues.value;
		if (effectiveRoleAssignment === stored.roleAssignment && effectiveMappingMethod === stored.mappingMethod && !shouldDeleteProjectRules) return;
		...
		sendTrackingEventForUserProvisioning(getTelemetrySettingValue(effectiveRoleAssignment, effectiveMappingMethod));
	};
...
var SamlSettingsForm_default = /* @__PURE__ */ _plugin_vue_export_helper_default(/* @__PURE__ */ defineComponent({
	...
	setup(__props, { expose: __expose }) {
		...
		const { roleAssignment, mappingMethod, isUserRoleProvisioningChanged, saveProvisioningConfig, roleAssignmentTransition, storedHasProjectRoles, isDroppingProjectRules, revertRoleAssignment } = useUserRoleProvisioningForm(SupportedProtocols.SAML);
		...
		const onSave = async (provisioningChangesConfirmed = false) => {
			try {
				...
				if (mappingMethod.value === "rules_in_n8n") await roleMappingRuleEditorRef.value?.save();
		...
		__expose({
			hasUnsavedChanges: computed(() => isSaveEnabled.value && !isSsoManagedByEnv.value),
			onSave
		});
		onMounted(async () => {
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("div", null, [
				...
				createBaseVNode("div", { class: normalizeClass(_ctx.$style.buttons) }, [!isSsoManagedByEnv.value ? (openBlock(), createBlock(unref(N8nButton_default), {
					key: 0,
...
var OidcSettingsForm_default = /* @__PURE__ */ _plugin_vue_export_helper_default(/* @__PURE__ */ defineComponent({
	...
	setup(__props, { expose: __expose }) {
		...
		const showUserRoleProvisioningDialog = ref(false);
		const { roleAssignment, mappingMethod, isUserRoleProvisioningChanged, saveProvisioningConfig, roleAssignmentTransition, storedHasProjectRoles, isDroppingProjectRules, revertRoleAssignment } = useUserRoleProvisioningForm(SupportedProtocols.OIDC);
		...
		__expose({
			hasUnsavedChanges: computed(() => !cannotSaveOidcSettings.value && !savingForm.value && !isSsoManagedByEnv.value),
			...
			return openBlock(), createElementBlock("div", null, [
				createBaseVNode("div", { class: normalizeClass([_ctx.$style.card, _ctx.$style.firstCard]) }, [
					...
					createBaseVNode("div", { class: normalizeClass(_ctx.$style.group) }, [
						_cache[11] || (_cache[11] = createBaseVNode("label", null, "Redirect URL", -1)),
						...
						_cache[12] || (_cache[12] = createBaseVNode("small", null, "Copy the Redirect URL to configure your OIDC provider ", -1))
					], 2),
					createBaseVNode("div", { class: normalizeClass(_ctx.$style.group) }, [
						_cache[13] || (_cache[13] = createBaseVNode("label", null, "Discovery Endpoint", -1)),
						...
						_cache[14] || (_cache[14] = createBaseVNode("small", null, "Paste here your discovery endpoint", -1))
					], 2),
					createBaseVNode("div", { class: normalizeClass(_ctx.$style.group) }, [
						_cache[15] || (_cache[15] = createBaseVNode("label", null, "Client ID", -1)),
						createVNode(unref(Input_default), {
						...
						_cache[16] || (_cache[16] = createBaseVNode("small", null, "The client ID you received when registering your application with your provider", -1))
					], 2),
					createBaseVNode("div", { class: normalizeClass(_ctx.$style.group) }, [
						_cache[17] || (_cache[17] = createBaseVNode("label", null, "Client Secret", -1)),
						createVNode(unref(Input_default), {
						...
						_cache[18] || (_cache[18] = createBaseVNode("small", null, "The client Secret you received when registering your application with your provider", -1))
					], 2),
					createBaseVNode("div", { class: normalizeClass(_ctx.$style.group) }, [
						_cache[19] || (_cache[19] = createBaseVNode("label", null, "Prompt", -1)),
						...
						_cache[20] || (_cache[20] = createBaseVNode("small", null, "The prompt parameter to use when authenticating with the OIDC provider", -1))
					], 2)
				], 2),
				createBaseVNode("div", { class: normalizeClass(_ctx.$style.card) }, [
					createVNode(UserRoleProvisioningDropdown_default, {
					...
					createBaseVNode("div", { class: normalizeClass(_ctx.$style.group) }, [
						_cache[21] || (_cache[21] = createBaseVNode("label", null, "Authentication Context Class Reference", -1)),
						createVNode(unref(Input_default), {
						...
						_cache[22] || (_cache[22] = createBaseVNode("small", null, "ACR values to include in the authorization request (acr_values parameter), separated by commas in order of preference.", -1))
					], 2)
				], 2),
				createBaseVNode("div", { class: normalizeClass(_ctx.$style.card) }, [createBaseVNode("div", { class: normalizeClass([_ctx.$style.settingsItem, _ctx.$style.settingsItemNoBorder]) }, [createBaseVNode("div", { class: normalizeClass(_ctx.$style.settingsItemLabel) }, [..._cache[23] || (_cache[23] = [createBaseVNode("label", null, "Single sign-on (SSO)", -1), createBaseVNode("small", null, "Allow users to sign in through your identity provider", -1)])], 2), createBaseVNode("div", { class: normalizeClass(_ctx.$style.settingsItemControl) }, [createVNode(unref(N8nSelect_default), {
					"model-value": unref(ssoStore).isOidcLoginEnabled ? "enabled" : "disabled",
					size: "medium",
					"data-test-id": "sso-oidc-toggle",
					disabled: isSsoManagedByEnv.value,
					"onUpdate:modelValue": _cache[9] || (_cache[9] = ($event) => unref(ssoStore).isOidcLoginEnabled = $event === "enabled")
				}, {
				...
				createBaseVNode("div", { class: normalizeClass(_ctx.$style.buttons) }, [!isSsoManagedByEnv.value ? (openBlock(), createBlock(unref(N8nButton_default), {
					...
					onClick: _cache[10] || (_cache[10] = ($event) => onOidcSettingsSave(false))
				}, {
					default: withCtx(() => [createTextVNode(toDisplayString(unref(i18n).baseText("settings.sso.settings.save")), 1)]),
					_: 1
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("div", _hoisted_1, [
				...
				unref(ssoStore).ssoManagedByEnv ? (openBlock(), createBlock(unref(N8nCallout_default), {
					...
					default: withCtx(() => [createTextVNode(toDisplayString(unref(i18n).baseText("settings.sso.settings.envConfigBanner")), 1)]),
					_: 1
				})) : createCommentVNode("", true),
