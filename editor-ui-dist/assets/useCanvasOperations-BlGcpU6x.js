...
import { gt as useI18n, j as useLocalStorage } from "./_MapCache-KSuovqBc.js";
import { b as useRouter, x as createEventBus, y as useRoute } from "./truncate-CsmjEd1C.js";
import { Bo as v4_default, Dr as AddNodeCommand, En as useProjectsStore, Er as AddConnectionCommand, Fi as useUIStore, Fr as ReplaceNodeParametersCommand, Gn as useCanvasStore, Ht as useCredentialsStore, Mr as RemoveConnectionCommand, Nr as RemoveNodeCommand, Pr as RenameNodeCommand, S as getNodesGroupSize, Sn as injectWorkflowState, Sr as CanvasConnectionMode, Ti as tryToParseNumber, Tr as useHistoryStore, Wo as useSettingsStore, Zt as useDataSchema, _n as useTagsStore, a as useNDVStore, at as useNodeTypesStore, b as getNewNodePosition, bi as isPresent, d as DEFAULT_VIEWPORT_BOUNDARIES, f as GRID_SIZE, h as generateOffsets, i as usePostHog, jr as MoveNodeCommand, l as CONFIGURATION_NODE_SIZE, mn as useWorkflowHelpers, o as useWorkflowsStore, p as PUSH_NODES_OFFSET, q as isChatNode, s as CONFIGURABLE_NODE_SIZE, t as useTelemetry, tt as getExecutionErrorToastConfiguration, u as DEFAULT_NODE_SIZE, vr as isValidNodeConnectionType, wr as CanvasNodeRenderType, xn as useNodeHelpers } from "./useTelemetry-Cl1nGv7u.js";
import { t as useToast } from "./useToast-HHn1Uk1h.js";
import { $i as getConnectionTypes, Da as isCommunityPackageName, Ea as deepCopy, Ga as NodeConnectionTypes, Lo as VIEWS, Ms as LOCAL_STORAGE_LOGS_PANEL_DETAILS_PANEL_SUB_NODE, Ns as LOCAL_STORAGE_LOGS_PANEL_OPEN, Ps as LOCAL_STORAGE_LOGS_SYNC_SELECTION, Si as require_cloneDeep, Xi as generateNodesGraph, _c as EnterpriseEditionFeature, _r as UPDATE_WEBHOOK_ID_NODE_TYPES, cc as NDV_IN_FOCUS_PANEL_EXPERIMENT, dr as STICKY_NODE_TYPE, ea as getNodeInputs, fn as FORM_TRIGGER_NODE_TYPE, ic as CANVAS_ZOOMED_VIEW_EXPERIMENT, ji as require__baseUniq, js as LOCAL_STORAGE_LOGS_PANEL_DETAILS_PANEL, kn as MCP_TRIGGER_NODE_TYPE, na as getNodeParameters, sa as getSubworkflowId, ta as getNodeOutputs, yr as WEBHOOK_NODE_TYPE } from "./constants-BpPtFtwh.js";
...
import { a as mapCanvasConnectionToLegacyConnection, l as parseCanvasConnectionHandleString, o as mapLegacyConnectionToCanvasConnection, r as createCanvasConnectionHandleString, s as mapLegacyConnectionsToCanvasConnections, t as useNodeCreatorStore } from "./nodeCreator.store-rHmQtMVf.js";
