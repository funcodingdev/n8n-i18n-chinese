...
import { It as ref, S as computed, W as nextTick } from "./vue.runtime.esm-bundler-CiTcVoZc.js";
import { s as useI18n } from "./src-BGXlCgwM.js";
import { Dt as createEventBus } from "./src-BY3LHeey.js";
import { a as require_toString, o as require__arrayMap, t as require_get } from "./get-CKIAFyM1.js";
import { At as require_upperFirst, Er as parseCanvasConnectionHandleString, Hi as CanvasConnectionMode, Ii as isVueFlowConnection, Y as useEvaluationStore, _t as transformNodeType, b as injectWorkflowDocumentStore, dt as prepareCommunityNodeDetailsViewStack, gt as subcategorizeItems, hn as useNDVStore, ht as sortNodeCreateElements, lt as mapToolSubcategoryIcon, nr as getThemedValue, nt as flattenCreateElements, ot as groupItemsInSections, pt as searchNodes, q as useNodeTypesStore, rt as getAiTemplatesCallout, st as isAINode, t as useWorkflowsStore, tt as finalizeItems, ut as nodeTypesToCreateElements, v as createWorkflowDocumentId, x as useWorkflowDocumentStore, yr as createCanvasConnectionHandleString } from "./workflows.store-DZfkxcrn.js";
import { $ as AI_CATEGORY_TEXT_SPLITTERS, $n as SET_NODE_TYPE, Cn as MARKDOWN_NODE_TYPE, Dt as AI_MCP_TOOL_NODE_TYPE, En as MESSAGE_AN_AGENT_NODE_TYPE, Ft as CHAT_TRIGGER_NODE_TYPE, Go as require__createCompounder, Gt as DATA_TABLE_NODE_TYPE, H as AI_CATEGORY_CHAINS, J as AI_CATEGORY_MEMORY, Jn as RSS_READ_NODE_TYPE, Jt as EDIT_IMAGE_NODE_TYPE, K as AI_CATEGORY_LANGUAGE_MODELS, Kn as REMOVE_DUPLICATES_NODE_TYPE, Kt as DATETIME_NODE_TYPE, Lt as CODE_NODE_TYPE, Mo as require__baseFlatten, Ms as getNodeInputs, Ot as AI_TRANSFORM_NODE_TYPE, Q as AI_CATEGORY_ROOT_NODES, Rt as COMPRESSION_NODE_TYPE, Sn as MANUAL_TRIGGER_NODE_TYPE, St as TRIGGER_NODE_CREATOR_VIEW, Tn as MERGE_NODE_TYPE, Tt as AGGREGATE_NODE_TYPE, U as AI_CATEGORY_DOCUMENT_LOADERS, Us as isHitlToolType, Ut as CRYPTO_NODE_TYPE, V as AI_CATEGORY_AGENTS, W as AI_CATEGORY_EMBEDDING, X as AI_CATEGORY_OUTPUTPARSER, Xn as SCHEDULE_TRIGGER_NODE_TYPE, Xt as EMAIL_IMAP_NODE_TYPE, Y as AI_CATEGORY_OTHER_TOOLS, Z as AI_CATEGORY_RETRIEVERS, Zt as EMAIL_SEND_NODE_TYPE, _c as isCommunityPackageName, ar as SPLIT_OUT_NODE_TYPE, bt as TEMPLATE_CATEGORY_AI, cr as SUMMARIZE_NODE_TYPE, cs as require__arrayIncludes, dc as NodeConnectionTypes, dt as HELPERS_SUBCATEGORY, et as AI_CATEGORY_TOOLS, ft as HITL_SUBCATEGORY, gt as OTHER_TRIGGER_NODES_SUBCATEGORY, hr as WEBHOOK_NODE_TYPE, ht as NODE_CREATOR_OPEN_SOURCES, in as FILTER_NODE_TYPE, ir as SPLIT_IN_BATCHES_NODE_TYPE, it as AI_OTHERS_NODE_CREATOR_VIEW, ln as HTML_NODE_TYPE, lt as CORE_NODES_CATEGORY, ml as require__SetCache, mt as NEW_TOOL_CATEGORIES, nn as EXECUTE_WORKFLOW_TRIGGER_NODE_TYPE, nt as AI_CODE_TOOL_LANGCHAIN_NODE_TYPE, on as FORM_TRIGGER_NODE_TYPE, ot as AI_UNCATEGORIZED_CATEGORY, pl as require__cacheHas, pn as IF_NODE_TYPE, pt as HUMAN_IN_THE_LOOP_CATEGORY, q as AI_CATEGORY_MCP_NODES, qc as EVALUATION_TRIGGER_NODE_TYPE, rn as EXTRACT_FROM_FILE_NODE_TYPE, sl as v4, ss as require__arrayIncludesWith, st as AI_WORKFLOW_TOOL_LANGCHAIN_NODE_TYPE, tt as AI_CATEGORY_VECTOR_STORES, un as HTTP_REQUEST_NODE_TYPE, ut as FLOWS_CONTROL_SUBCATEGORY, vt as REGULAR_NODE_CREATOR_VIEW, xr as XML_NODE_TYPE, xt as TRANSFORM_DATA_SUBCATEGORY, yn as LIMIT_NODE_TYPE, zt as CONVERT_TO_FILE_NODE_TYPE } from "./constants-CLQJMg7Y.js";
import { E as require__baseUnary, d as require_isArrayLikeObject, r as require__baseRest } from "./merge-Bzll_Q9n.js";
...
import { n as getNodeIconSource } from "./nodeIcon-CuCy7Xjv.js";
import { t as _virtual_node_popularity_data_default } from "./_virtual_node-popularity-data-D_OnI2Wg.js";
