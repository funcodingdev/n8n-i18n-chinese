;
(function () {
  System.register(["./vue.runtime.esm-bundler-legacy--Sn1h8On.js", "./useTelemetry-legacy-DKRvN4mA.js", "./useToast-legacy-DEFFmTH6.js", "./constants-legacy-BbwdWVie.js", "./_baseOrderBy-legacy-9y2xV7og.js"], function (_export, _context) {
    "use strict";

    var computed, ref, useUIStore, getWhatsNewSection, useStorage, useSettingsStore, STORES, useUsersStore, getNextVersions, useTelemetry, useToast, jsonParse, LOCAL_STORAGE_READ_WHATS_NEW_ARTICLES, LOCAL_STORAGE_DISMISSED_WHATS_NEW_CALLOUT, VERSIONS_MODAL_KEY, WHATS_NEW_MODAL_KEY, defineStore, useRootStore, SEMVER_REGEX, useVersionsStore;
    return {
      setters: [function (_vueRuntimeEsmBundlerLegacy003Js) {
        ...
        LOCAL_STORAGE_READ_WHATS_NEW_ARTICLES = _constantsLegacy00TJs.Ls;
        LOCAL_STORAGE_DISMISSED_WHATS_NEW_CALLOUT = _constantsLegacy00TJs.Ts;
