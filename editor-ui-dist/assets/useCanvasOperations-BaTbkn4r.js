...
import { at as useI18n$1, c as useClipboard, v as useLocalStorage } from "./core-gptzu9Ct.js";
import { ki as require_markdown_it_link_attributes, lt as useRoute, ut as useRouter } from "./src-Bvr7jqKz.js";
import { t as _plugin_vue_export_helper_default } from "./_plugin-vue_export-helper-Da88TEg1.js";
import { $r as MoveNodeCommand, Br as isValidNodeConnectionType, Dt as injectWorkflowState, Et as useWorkflowHelpers, Ht as useFocusPanelStore, In as useExternalHooks, Jr as AddConnectionCommand, Jt as CONFIGURABLE_NODE_SIZE, Kr as CanvasNodeRenderType, Na as tryToParseNumber, Oa as isPresent, Ot as useWorkflowState, Pn as useToast, Qt as PUSH_NODES_OFFSET, Wr as CanvasConnectionMode, Xt as DEFAULT_NODE_SIZE, Yr as AddNodeCommand, Yt as CONFIGURATION_NODE_SIZE, Zt as DEFAULT_VIEWPORT_BOUNDARIES, _r as useTelemetry, at as useCredentialsStore, b as getExecutionErrorToastConfiguration, br as usePostHog, cn as getNodesGroupSize, d as isChatNode, ei as RemoveConnectionCommand, en as doRectsOverlap, ga as pinDataToExecutionData, hr as useCanvasStore, lt as useDataSchema, mr as useNodeHelpers, ni as RenameNodeCommand, on as getNewNodePosition, pa as useWorkflowDocumentStore, qr as useHistoryStore, qt as useTemplatesStore, r as useUIStore, ri as ReplaceNodeParametersCommand, s as useWorkflowsStore, sr as useTagsStore, ti as RemoveNodeCommand, tn as generateOffsets, ua as createWorkflowDocumentId, ui as useProjectsStore, w as useNodeTypesStore, xr as useNDVStore, z as removePreviewToken } from "./users.store-BCts_jcD.js";
import { Ao as getSubworkflowId, Co as getNodeInputs, Gi as LOCAL_STORAGE_LOGS_PANEL_DETAILS_PANEL_SUB_NODE, Ho as resolveNodeWebhookId, Ic as CANVAS_ZOOMED_VIEW_EXPERIMENT, Jc as NDV_IN_FOCUS_PANEL_EXPERIMENT, Ki as LOCAL_STORAGE_LOGS_PANEL_OPEN, Po as isHitlToolType, So as getConnectionTypes, To as getNodeParameters, Wi as LOCAL_STORAGE_LOGS_PANEL_DETAILS_PANEL, ar as STICKY_NODE_TYPE, dr as UPDATE_WEBHOOK_ID_NODE_TYPES, ns as deepCopy, qa as require_cloneDeep, qi as LOCAL_STORAGE_LOGS_SYNC_SELECTION, qs as v4, rl as EnterpriseEditionFeature, rs as isCommunityPackageName, to as require__baseUniq, wo as getNodeOutputs, xs as NodeConnectionTypes, yo as generateNodesGraph, zr as VIEWS } from "./constants-CjIW4CHX.js";
...
import { a as mapLegacyConnectionToCanvasConnection, c as parseCanvasConnectionHandleString, i as mapCanvasConnectionToLegacyConnection, n as createCanvasConnectionHandleString, o as mapLegacyConnectionsToCanvasConnections } from "./canvas.utils-B_pfSyMu.js";
import { n as useNodeCreatorStore, t as canvasEventBus } from "./canvas.eventBus-EeizHHzF.js";
import { t as core_default } from "./core-BB0pC6_E.js";
import { a as bash, i as javascript, n as typescript, r as python, t as xml } from "./xml-Dqep6fhG.js";
import { t as VueMarkdown } from "./VueMarkdown-dMMaNRP0.js";
import { t as useSetupPanelStore } from "./setupPanel.store-D5H2jDGr.js";
import { t as clearAllNodeResourceLocatorValues } from "./templateTransforms-D42ED_U1.js";
	...
	*/
	function uniqueNodeName(originalName, extraNames = []) {
		...
		if (nsn) {
			...
			unique = originalName;
			while (canvasNames.has(unique) || extraNames.includes(unique)) unique = originalName + index++;
			return unique;
		}
...
function useCanvasOperations() {
	...
	*/
	...
	function resolveNodePosition(node, nodeTypeDescription, options = {}) {
		...
		if (lastInteractedWithNode) {
			...
			const lastInteractedWithNodeObject = workflowDocumentStore.value?.getNodeByName(lastInteractedWithNode.name);
	...
	*/
	...
	async function initializeWorkspace(data) {
		const { workflowDocumentStore: initializedDocumentStore } = await workflowHelpers.initState(data, useWorkflowState());
	...
	*/
	...
	function getNodesToSave(nodes) {
		...
		for (const node of nodes) {
			...
			const pinDataForNode = workflowDocumentStore?.value ? pinDataToExecutionData(workflowDocumentStore.value.pinData)[node.name] : void 0;
	...
	async function openExecution(executionId, nodeId) {
		...
		if (!["manual", "evaluation"].includes(data.mode)) workflowDocumentStore?.value?.setPinData({});
		if (nodeId) {
			const node = workflowDocumentStore?.value?.getNodeById(nodeId);
...
//#endregion
export { useChat as S, MessageWithButtons_default as _, LOCAL_STORAGE_PANEL_HEIGHT as a, useI18n as b, LOG_DETAILS_PANEL_STATE as c, parseBotChatMessageContent as d, shouldBlockUserInput as f, MessageComponentKey as g, localStorageSessionIdKey as h, LOCAL_STORAGE_OVERVIEW_PANEL_WIDTH as i, chatEventBus as l, ChatSymbol as m, useExperimentalNdvStore as n, LOCAL_STORAGE_PANEL_WIDTH as o, ChatOptionsSymbol as p, useLogsStore as r, LOGS_PANEL_STATE as s, useCanvasOperations as t, constructChatWebsocketUrl as u, MarkdownRenderer_default as v, useOptions as x, Button_default as y };
