;
(function () {
  System.register(["./chunk-legacy-Re9CbdfL.js", "./vue.runtime.esm-bundler-legacy--Sn1h8On.js", "./_MapCache-legacy-BH2XE3uj.js", "./truncate-legacy-D4G74xLD.js", "./useTelemetry-legacy-CMfwYwVY.js", "./constants-legacy-8iZaMHMx.js", "./_baseOrderBy-legacy-Bls-fMH1.js"], function (_export, _context) {
    "use strict";

    var __toESM, computed, ref, watchOnce, i18n, require_get, useStorage, useNodeTypesStore, STORES, useWorkflowsStore, jsonParse, LOCAL_STORAGE_FOCUS_PANEL, extractFromAICalls, PLACEHOLDER_EMPTY_WORKFLOW_ID, FROM_AI_AUTO_GENERATED_MARKER, defineStore, NODE_DENYLIST, PATH_DENYLIST, PROP_TYPE_DENYLIST, fromAIExtraProps, import_get, DEFAULT_PANEL_WIDTH, DEFAULT_FOCUS_PANEL_DATA, useFocusPanelStore;
    ...
    return {
      setters: [function (_chunkLegacy001Js) {
        ...
        LOCAL_STORAGE_FOCUS_PANEL = _constantsLegacy00TJs.As;
        extractFromAICalls = _constantsLegacy00TJs.Ti;
        PLACEHOLDER_EMPTY_WORKFLOW_ID = _constantsLegacy00TJs.c;
        FROM_AI_AUTO_GENERATED_MARKER = _constantsLegacy00TJs.oo;
