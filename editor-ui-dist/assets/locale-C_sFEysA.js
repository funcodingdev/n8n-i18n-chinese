const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/en-7x-ZGWrU.js","assets/en-DZv4OqfJ.js"])))=>i.map(i=>d[i]);
import { t as en_default } from "./en-DZv4OqfJ.js";
...
async function use(l) {
	try {
		lang = (await _rolldown_dynamic_import_helper_default(/* @__PURE__ */ Object.assign({ "./lang/en.ts": () => __vitePreload(() => import("./en-7x-ZGWrU.js"), __vite__mapDeps([0,1])) }), `./lang/${l}.ts`, 3)).default;
	} catch (e) {}
}
//#endregion
export { use as n, t };
