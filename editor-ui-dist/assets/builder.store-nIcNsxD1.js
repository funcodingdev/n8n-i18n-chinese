...
import { Fi as isToolMessage$1, Ii as isWorkflowUpdatedMessage$1, _t as useRouter, gt as useRoute } from "./src-XWsjz-dU.js";
import { u as require_lib } from "./get-CDrcd2Fp.js";
import { J as useDebounceFn, v as useLocalStorage } from "./core-CxAuVuwP.js";
import { t as useMessage } from "./useMessage-BbflbOu2.js";
import { t as useToast } from "./useToast-D3sdrngn.js";
import { As as validateNodeSelectionForGrouping, Jd as SIX_MONTHS_IN_MILLIS, Li as MODAL_CANCEL, Od as MERGE_ASK_BUILD_EXPERIMENT, Ri as MODAL_CLOSE, Ud as DEBOUNCE_TIME, Vi as NPS_SURVEY_MODAL_KEY, Yd as THREE_DAYS_IN_MILLIS, Zd as getDebounceTime, bu as getResourcePermissions, di as VIEWS, gl as isExpression, ld as CODE_WORKFLOW_BUILDER_EXPERIMENT, qd as SEVEN_DAYS_IN_MILLIS, t as AutoSaveState, ua as LOCAL_STORAGE_BROWSER_NOTIFICATION_METADATA, vd as FOCUSED_NODES_EXPERIMENT, vl as dedupe, zi as MODAL_CONFIRM } from "./constants-BaNoJas_.js";
import { Mt as useWorkflowHelpers, Nt as useRouteWorkflowId, Pt as useWorkflowId, Si as isDebouncedFunction, Sn as useSourceControlStore, Wt as useNDVStore, _ as useNodeTypesStore, a as injectWorkflowDocumentStore, cn as useWorkflowsStore, ct as clearBuilderSession, dt as getBuilderCredits, mt as useAIAssistantHelpers, pt as truncateBuilderMessages, qt as useWorkflowExecutionStateStore, r as createWorkflowDocumentId, s as useWorkflowDocumentStore, st as chatWithBuilder, ut as getAiSessions } from "./workflowDocument.store-CDujtXUf.js";
import { T as defineStore, h as assert, t as useRootStore } from "./useRootStore-DORNi26-.js";
import { Vn as STORES, a as getWorkflowVersionsByIds, i as getWorkflowVersion, n as getPublishTimeline, o as updateWorkflowHistoryVersion, r as getWorkflowHistory, st as updateNpsSurveyState, t as useSettingsStore, tn as getFirstAdoptionDate } from "./settings.store-BSo6Wkgz.js";
import { f as useUIStore, g as usePostHog, p as useTelemetry } from "./users.store-CHh4wCL_.js";
import { E as stringSizeInBytes, O as tryToParseNumber, a as getNewWorkflow, t as useWorkflowsListStore } from "./workflowsList.store-BfnM1vpV.js";
...
import { a as BUILDER_ENABLED_VIEWS, r as useChatPanelStateStore, t as useCodeDiff } from "./useCodeDiff-vhBzEnPy.js";
