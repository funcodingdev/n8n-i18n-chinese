...
import { $ as openBlock, A as createTextVNode, C as createBaseVNode, Cn as toDisplayString, E as createElementBlock, Gt as unref, N as defineComponent, S as computed, T as createCommentVNode, X as onMounted, _ as Fragment, bt as withCtx, gt as watch, j as createVNode, rt as renderList, vn as normalizeClass, w as createBlock } from "./vue.runtime.esm-bundler-CDDUUZhE.js";
import { s as useI18n } from "./src-Dh32dOY5.js";
import { Ga as N8nHeading_default, Ja as N8nButton_default, Tt as N8nOption_default, Ui as Input_default, Wt as ElSwitch, Ya as N8nIcon_default, et as N8nInputNumber_default, qa as N8nText_default, vt as N8nInputLabel_default, wt as N8nSelect_default } from "./src-BVC_ZvSs.js";
import { t as _plugin_vue_export_helper_default } from "./_plugin-vue_export-helper-Da88TEg1.js";
import { t as useSettingsStore } from "./settings.store-DKCHFcby.js";
import { H as CREDENTIAL_EDIT_MODAL_KEY, f as useUIStore } from "./users.store-B52ADdpG.js";
...
var SandboxSection_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		...
		function handleProviderChange(value) {
			if (value === "n8n-sandbox" || value === "daytona") store.setField("sandboxProvider", value);
		}
			...
			return openBlock(), createElementBlock("div", { class: normalizeClass(_ctx.$style.section) }, [
				...
				createVNode(unref(N8nInputLabel_default), {
					...
					default: withCtx(() => [createVNode(unref(N8nSelect_default), {
						...
						size: "small",
						"onUpdate:modelValue": handleProviderChange
					}, {
						default: withCtx(() => [createVNode(unref(N8nOption_default), {
							value: "n8n-sandbox",
				...
				showN8nSandboxFields.value ? (openBlock(), createBlock(unref(N8nInputLabel_default), {
					...
					default: withCtx(() => [createVNode(unref(N8nSelect_default), {
						...
						_: 1
					}, 8, ["model-value", "placeholder"]), createBaseVNode("p", { class: normalizeClass(_ctx.$style.hint) }, toDisplayString(unref(i18n).baseText("instanceAi.settings.n8nSandbox.serviceUrlHint")), 3)]),
					_: 1
				}, 8, ["label"])) : createCommentVNode("", true),
				showImageField.value ? (openBlock(), createBlock(unref(N8nInputLabel_default), {
					...
					default: withCtx(() => [createVNode(unref(Input_default), {
						...
						size: "small",
						"onUpdate:modelValue": _cache[1] || (_cache[1] = ($event) => unref(store).setField("sandboxImage", $event))
					}, null, 8, ["model-value"])]),
					_: 1
				}, 8, ["label"])) : createCommentVNode("", true),
				createVNode(unref(N8nInputLabel_default), {
					...
					default: withCtx(() => [createVNode(unref(N8nInputNumber_default), {
						...
						min: 0,
						step: 1e4,
						"onUpdate:modelValue": _cache[2] || (_cache[2] = ($event) => unref(store).setField("sandboxTimeout", $event ?? 3e5))
...
var SandboxSection_vue_vue_type_style_index_0_lang_module_default = {
	section: "_section_1wrnl_125",
	numberInput: "_numberInput_1wrnl_131",
	switchRow: "_switchRow_1wrnl_135",
	switchLabel: "_switchLabel_1wrnl_142",
	hint: "_hint_1wrnl_147"
};
			...
			return openBlock(), createElementBlock("div", { class: normalizeClass(_ctx.$style.section) }, [
				...
				createVNode(unref(N8nInputLabel_default), {
					...
					default: withCtx(() => [createVNode(unref(Input_default), {
						...
						"onUpdate:modelValue": _cache[1] || (_cache[1] = ($event) => unref(store).setField("mcpServers", $event))
					}, null, 8, ["model-value", "placeholder"])]),
					_: 1
				}, 8, ["label"])
			], 2);
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("div", {
				...
				isEnabled.value ? (openBlock(), createElementBlock(Fragment, { key: 1 }, [
					...
					isAdmin.value ? (openBlock(), createElementBlock(Fragment, { key: 2 }, [createBaseVNode("div", { class: normalizeClass(_ctx.$style.permissionsHeader) }, [createVNode(unref(N8nHeading_default), {
					...
					isAdmin.value ? (openBlock(), createElementBlock(Fragment, { key: 4 }, [
						!unref(store).isProxyEnabled && !unref(store).isCloudManaged ? (openBlock(), createElementBlock("div", {
							key: 0,
							class: normalizeClass(_ctx.$style.card)
