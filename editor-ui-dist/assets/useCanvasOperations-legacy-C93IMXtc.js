;
(function () {
  System.register(["./chunk-legacy-Re9CbdfL.js", "./vue.runtime.esm-bundler-legacy--Sn1h8On.js", "./_MapCache-legacy-CECtqMZe.js", "./truncate-legacy-nB2QmutO.js", "./useTelemetry-legacy-CA9g7cV_.js", "./useToast-legacy-fud3e81V.js", "./constants-legacy-B_3qSw5J.js", "./_baseOrderBy-legacy-3SIYDICR.js", "./useExternalHooks-legacy-CqVTyuDp.js", "./templates.store-legacy-pG2l2pIW.js", "./focusPanel.store-legacy-BIkGQRYF.js", "./executions.store-legacy-pCJOr0Ul.js", "./usePinnedData-legacy-DFkSTHXJ.js", "./nodeCreator.store-legacy-CWpRRTas.js", "./useClipboard-legacy-obyxsWKt.js", "./folders.store-legacy-Ct3cJLFq.js"], function (_export, _context) {
    "use strict";

    var __toESM, __commonJS, computed, nextTick, ref, shallowRef, useI18n, useLocalStorage, useRouter, createEventBus, useRoute, v4_default, AddNodeCommand, useProjectsStore, AddConnectionCommand, useUIStore, ReplaceNodeParametersCommand, useCanvasStore, useCredentialsStore, RemoveConnectionCommand, RemoveNodeCommand, RenameNodeCommand, getNodesGroupSize, injectWorkflowState, CanvasConnectionMode, tryToParseNumber, useHistoryStore, useSettingsStore, useDataSchema, useTagsStore, useNDVStore, useNodeTypesStore, getNewNodePosition, isPresent, DEFAULT_VIEWPORT_BOUNDARIES, GRID_SIZE, generateOffsets, usePostHog, MoveNodeCommand, CONFIGURATION_NODE_SIZE, useWorkflowHelpers, useWorkflowsStore, PUSH_NODES_OFFSET, isChatNode, CONFIGURABLE_NODE_SIZE, useTelemetry, getExecutionErrorToastConfiguration, DEFAULT_NODE_SIZE, isValidNodeConnectionType, CanvasNodeRenderType, useNodeHelpers, useToast, getConnectionTypes, isCommunityPackageName, deepCopy, NodeConnectionTypes, VIEWS, LOCAL_STORAGE_LOGS_PANEL_DETAILS_PANEL_SUB_NODE, LOCAL_STORAGE_LOGS_PANEL_OPEN, LOCAL_STORAGE_LOGS_SYNC_SELECTION, require_cloneDeep, generateNodesGraph, EnterpriseEditionFeature, UPDATE_WEBHOOK_ID_NODE_TYPES, NDV_IN_FOCUS_PANEL_EXPERIMENT, STICKY_NODE_TYPE, getNodeInputs, FORM_TRIGGER_NODE_TYPE, CANVAS_ZOOMED_VIEW_EXPERIMENT, require__baseUniq, LOCAL_STORAGE_LOGS_PANEL_DETAILS_PANEL, MCP_TRIGGER_NODE_TYPE, getNodeParameters, getSubworkflowId, getNodeOutputs, WEBHOOK_NODE_TYPE, defineStore, useRootStore, useExternalHooks, useTemplatesStore, useFocusPanelStore, useExecutionsStore, usePinnedData, mapCanvasConnectionToLegacyConnection, parseCanvasConnectionHandleString, mapLegacyConnectionToCanvasConnection, createCanvasConnectionHandleString, mapLegacyConnectionsToCanvasConnections, useNodeCreatorStore, useClipboard, useFoldersStore, chatEventBus, LOCAL_STORAGE_PANEL_HEIGHT, LOCAL_STORAGE_PANEL_WIDTH, LOCAL_STORAGE_OVERVIEW_PANEL_WIDTH, LOGS_PANEL_STATE, LOG_DETAILS_PANEL_STATE, useLogsStore, require_uniq, useExperimentalNdvStore, canvasEventBus, import_cloneDeep, import_uniq;
    ...
    return {
      setters: [function (_chunkLegacy001Js) {
        ...
        LOCAL_STORAGE_LOGS_PANEL_DETAILS_PANEL_SUB_NODE = _constantsLegacy00TJs.Ms;
        LOCAL_STORAGE_LOGS_PANEL_OPEN = _constantsLegacy00TJs.Ns;
        LOCAL_STORAGE_LOGS_SYNC_SELECTION = _constantsLegacy00TJs.Ps;
        ...
        NDV_IN_FOCUS_PANEL_EXPERIMENT = _constantsLegacy00TJs.cc;
        ...
        CANVAS_ZOOMED_VIEW_EXPERIMENT = _constantsLegacy00TJs.ic;
        require__baseUniq = _constantsLegacy00TJs.ji;
        LOCAL_STORAGE_LOGS_PANEL_DETAILS_PANEL = _constantsLegacy00TJs.js;
