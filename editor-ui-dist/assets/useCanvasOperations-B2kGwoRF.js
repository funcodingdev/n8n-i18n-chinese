...
import { gt as useI18n, j as useLocalStorage } from "./_MapCache-Yj8N6E8I.js";
import { b as useRouter, x as createEventBus, y as useRoute } from "./truncate-BE376beJ.js";
import { Dr as AddNodeCommand, En as useProjectsStore, Er as AddConnectionCommand, Fi as useUIStore, Fr as ReplaceNodeParametersCommand, Gn as useCanvasStore, Ho as useSettingsStore, Ht as useCredentialsStore, Mr as RemoveConnectionCommand, Nr as RemoveNodeCommand, Pr as RenameNodeCommand, Ro as v4_default, S as getNodesGroupSize, Sn as injectWorkflowState, Sr as CanvasConnectionMode, Ti as tryToParseNumber, Tr as useHistoryStore, Zt as useDataSchema, _n as useTagsStore, a as useNDVStore, at as useNodeTypesStore, b as getNewNodePosition, bi as isPresent, d as DEFAULT_VIEWPORT_BOUNDARIES, f as GRID_SIZE, h as generateOffsets, i as usePostHog, jr as MoveNodeCommand, l as CONFIGURATION_NODE_SIZE, mn as useWorkflowHelpers, o as useWorkflowsStore, p as PUSH_NODES_OFFSET, q as isChatNode, s as CONFIGURABLE_NODE_SIZE, t as useTelemetry, tt as getExecutionErrorToastConfiguration, u as DEFAULT_NODE_SIZE, vr as isValidNodeConnectionType, wr as CanvasNodeRenderType, xn as useNodeHelpers } from "./useTelemetry-3MMgvAsT.js";
import { t as useToast } from "./useToast-dRBi8k5x.js";
import { $i as getNodeInputs, Ai as require__baseUniq, Ds as LOCAL_STORAGE_LOGS_PANEL_OPEN, Ea as isCommunityPackageName, Es as LOCAL_STORAGE_LOGS_PANEL_DETAILS_PANEL_SUB_NODE, On as MCP_TRIGGER_NODE_TYPE, Os as LOCAL_STORAGE_LOGS_SYNC_SELECTION, Po as VIEWS, Qi as getConnectionTypes, Ta as deepCopy, Ts as LOCAL_STORAGE_LOGS_PANEL_DETAILS_PANEL, Wa as NodeConnectionTypes, Yi as generateNodesGraph, Zs as CANVAS_ZOOMED_VIEW_EXPERIMENT, dc as EnterpriseEditionFeature, dn as FORM_TRIGGER_NODE_TYPE, ea as getNodeOutputs, gr as UPDATE_WEBHOOK_ID_NODE_TYPES, oa as getSubworkflowId, ta as getNodeParameters, tc as NDV_IN_FOCUS_PANEL_EXPERIMENT, ur as STICKY_NODE_TYPE, vr as WEBHOOK_NODE_TYPE, xi as require_cloneDeep } from "./constants-DiFLTnfN.js";
...
import { a as mapCanvasConnectionToLegacyConnection, l as parseCanvasConnectionHandleString, o as mapLegacyConnectionToCanvasConnection, r as createCanvasConnectionHandleString, s as mapLegacyConnectionsToCanvasConnections, t as useNodeCreatorStore } from "./nodeCreator.store-BK1EGdAK.js";
