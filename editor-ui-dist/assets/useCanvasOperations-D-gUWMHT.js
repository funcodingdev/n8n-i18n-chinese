...
import { $ as openBlock, A as createTextVNode, C as createBaseVNode, Cn as toDisplayString, E as createElementBlock, Gt as unref, I as h, It as ref, N as defineComponent, R as inject, S as computed, T as createCommentVNode, U as mergeProps, W as nextTick, _ as Fragment, bt as withCtx, it as renderSlot, j as createVNode, jt as isRef, rt as renderList, st as resolveDynamicComponent, vn as normalizeClass, w as createBlock, zt as shallowRef } from "./vue.runtime.esm-bundler-CiTcVoZc.js";
import { s as useI18n$1 } from "./src-BGXlCgwM.js";
import { Bi as require_markdown_it_link_attributes, gt as useRouter, ht as useRoute } from "./src-BY3LHeey.js";
import { t as _plugin_vue_export_helper_default } from "./_plugin-vue_export-helper-Da88TEg1.js";
import { Ar as CONFIGURATION_NODE_SIZE, B as MoveNodeCommand, Cn as useProjectsStore, Cr as mapCanvasConnectionToLegacyConnection, Er as parseCanvasConnectionHandleString, F as AddConnectionCommand, Fr as doRectsOverlap, H as RemoveNodeCommand, Hi as CanvasConnectionMode, I as AddNodeCommand, Ir as generateOffsets, K as require_uniq, M as useCanvasStore, Mr as DEFAULT_VIEWPORT_BOUNDARIES, Nr as PUSH_NODES_OFFSET, Nt as useCredentialsStore, O as serializeNode, P as useHistoryStore, Pi as isValidNodeConnectionType, Tr as mapLegacyConnectionsToCanvasConnections, U as RenameNodeCommand, Ur as getNodesGroupSize, Ut as useDataSchema, V as RemoveConnectionCommand, Vr as getNewNodePosition, W as ReplaceNodeParametersCommand, Wi as CanvasNodeRenderType, _ as useWorkflowExecutionStateStore, b as injectWorkflowDocumentStore, cn as useTagsStore, dn as sanitizeConnections, fi as pinDataToExecutionData, ft as removePreviewToken, g as disposeWorkflowExecutionStateStore, jr as DEFAULT_NODE_SIZE, k as useNodeHelpers, kr as CONFIGURABLE_NODE_SIZE, ln as ensureNodePosition, mn as injectNDVStore, on as useWorkflowHelpers, q as useNodeTypesStore, t as useWorkflowsStore, u as getExecutionErrorToastConfiguration, v as createWorkflowDocumentId, wr as mapLegacyConnectionToCanvasConnection, x as useWorkflowDocumentStore, yr as createCanvasConnectionHandleString } from "./workflows.store-DZfkxcrn.js";
import { t as useToast } from "./useToast-ioerWMiY.js";
import { $o as validateNodeSelectionForExtraction, Ft as CHAT_TRIGGER_NODE_TYPE, Ms as getNodeInputs, Ns as getNodeOutputs, Os as generateNodesGraph, Ps as getNodeParameters, Qs as resolveNodeWebhookId, Us as isHitlToolType, Xo as require_cloneDeep, _c as isCommunityPackageName, ba as LOCAL_STORAGE_LOGS_PANEL_OPEN, dc as NodeConnectionTypes, es as validateNodeSelectionForGrouping, gc as deepCopy, js as getConnectionTypes, ku as EnterpriseEditionFeature, li as VIEWS, nu as CANVAS_ZOOMED_VIEW_EXPERIMENT, pr as UPDATE_WEBHOOK_ID_NODE_TYPES, sl as v4, sr as STICKY_NODE_TYPE, tu as CANVAS_NODES_GROUPING_EXPERIMENT, va as LOCAL_STORAGE_LOGS_PANEL_DETAILS_PANEL, vc as isObjectEmpty, vu as NDV_IN_FOCUS_PANEL_EXPERIMENT, xa as LOCAL_STORAGE_LOGS_SYNC_SELECTION, xn as MANUAL_CHAT_TRIGGER_NODE_TYPE, ya as LOCAL_STORAGE_LOGS_PANEL_DETAILS_PANEL_SUB_NODE, zs as getSubworkflowId } from "./constants-CLQJMg7Y.js";
...
import { _ as useLocalStorage, c as useClipboard } from "./core-CZJuH52F.js";
import { f as useUIStore, g as usePostHog, p as useTelemetry } from "./users.store-AINJEAwY.js";
import { D as tryToParseNumber, o as getNewWorkflowData, x as isPresent } from "./workflowsList.store-e1f-4AUE.js";
import { t as useExternalHooks } from "./useExternalHooks-wezmQolp.js";
import { t as useBuilderStore } from "./builder.store-CL34arwP.js";
...
import { t as core_default } from "./core-luDgwVsC.js";
import { a as bash, i as javascript, n as typescript, r as python, t as xml } from "./xml-BrFE0qvZ.js";
import { t as VueMarkdown } from "./VueMarkdown-Be8BJIR-.js";
import { t as useSetupPanelStore } from "./setupPanel.store-Da71jZaY.js";
import { t as clearAllNodeResourceLocatorValues } from "./templateTransforms-Cw__H8cb.js";
...
function replaceCanvasConnection({ workflowDocumentStore, createConnection, deleteConnection, isConnectionAllowed, isConnectionReplacementAllowedForNodeGroups, connectionToRemove, addBeforeRemoval, addAfterRemoval, trackHistory = false }) {
	...
	if (!isConnectionReplacementAllowedForNodeGroups({
...
function useCanvasNodeGroupOperationGuards() {
	...
	function getConnectionChangeBlockedMessage(group, result) {
		...
		const key = (result.reason === "invalid-subgraph" && result.errors[0] ? MESSAGE_KEY_BY_ERROR_CODE[result.errors[0].errorCode] : void 0) ?? MESSAGE_KEY_BY_REASON[result.reason] ?? FALLBACK_MESSAGE_KEY;
	...
	function tryAutoExtendInvalidGroup({ invalidAffectedGroup, endpointIds, connectionsBySourceNode }) {
		const candidateId = getAutoExtendCandidate({
			failingGroup: invalidAffectedGroup.group,
			endpointIds,
			connectionsBySourceNode
		});
		if (candidateId === void 0) return false;
	...
	function isConnectionReplacementAllowedForNodeGroups({ nodeIds, connectionsToRemove, connectionsToAdd, connectionsBySourceNode, allowAutoExtend = true, blockedTitleKey = BLOCKED_TITLE_KEY.add }) {
		...
		if (allowAutoExtend && tryAutoExtendInvalidGroup({
	...
	function isConnectionChangeAllowedForNodeGroups({ nodeIds, connection, connectionsBySourceNode, action }) {
...
function useCanvasOperations() {
	...
	const { isConnectionChangeAllowedForNodeGroups, isConnectionReplacementAllowedForNodeGroups, isNodeReplacementAllowedForNodeGroups } = useCanvasNodeGroupOperationGuards();
	...
	*/
	function createConnection(connection, { trackHistory = false, keepPristine = false, validateNodeGroups = true } = {}) {
		...
		if (validateNodeGroups && !isConnectionChangeAllowedForNodeGroups({
	...
	*/
	...
	async function addImportedNodesToWorkflow(data, { trackBulk = true, trackHistory = false, viewport = DEFAULT_VIEWPORT_BOUNDARIES, setStateDirty = true, showMaxNodeTypeError = false } = {}) {
		const nodeNameTable = {};
	...
	async function importWorkflowData(workflowData, source, { importTags = true, trackBulk = true, trackHistory = true, viewport, regenerateIds = true, trackEvents = true, setStateDirty = true } = {}) {
		...
		try {
			...
			applyImportedNodeGroups(workflowData.nodeGroups, new Set(importResult.nodes?.map((node) => node.id).filter(isPresent) ?? []), { setStateDirty });
	...
	function applyImportedNodeGroups(nodeGroups, importedNodeIds, { setStateDirty = true } = {}) {
...
//#endregion
export { MessageWithButtons_default as C, useOptions as D, useI18n as E, useChat as O, MessageComponentKey as S, Button_default as T, parseBotChatMessageContent as _, emptyTokenUsageData as a, ChatSymbol as b, parseAiContent as c, LOCAL_STORAGE_PANEL_HEIGHT as d, LOCAL_STORAGE_PANEL_WIDTH as f, constructChatWebsocketUrl as g, chatEventBus as h, addTokenUsageData as i, useLogsStore as l, LOG_DETAILS_PANEL_STATE as m, useSelectionValidation as n, formatTokenUsageCount as o, LOGS_PANEL_STATE as p, useExperimentalNdvStore as r, isChatNode as s, useCanvasOperations as t, LOCAL_STORAGE_OVERVIEW_PANEL_WIDTH as u, shouldBlockUserInput as v, MarkdownRenderer_default as w, localStorageSessionIdKey as x, ChatOptionsSymbol as y };
