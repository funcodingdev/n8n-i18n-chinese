...
import { M as useLocalStorage, S as useClipboard, yt as useI18n } from "./_MapCache-BRoeWkyP.js";
import { Lt as useRoute, Rt as useRouter, Ut as require_markdown_it_link_attributes, Yt as createEventBus } from "./src-BNc_2bHf.js";
import { t as __plugin_vue_export_helper_default } from "./_plugin-vue_export-helper-DltO58Gh.js";
import { $r as CanvasConnectionMode, C as useNodeTypesStore, Cn as PUSH_NODES_OFFSET, En as generateOffsets, Er as usePostHog, It as useNDVStore, Lt as injectWorkflowState, Mt as useNodeHelpers, Nn as getNodesGroupSize, Nt as useTelemetry, Ot as useTagsStore, Rt as useWorkflowState, Sn as GRID_SIZE, Tn as doRectsOverlap, Tt as useWorkflowHelpers, Vt as useProjectsStore, Yr as isValidNodeConnectionType, Zi as isPresent, _n as CONFIGURABLE_NODE_SIZE, _r as useExternalHooks, bn as DEFAULT_NODE_SIZE, ci as MoveNodeCommand, ct as useDataSchema, d as isChatNode, di as RenameNodeCommand, dn as useFocusPanelStore, fi as ReplaceNodeParametersCommand, fs as useSettingsStore, gn as useTemplatesStore, hr as useToast, ii as AddNodeCommand, jn as getNewNodePosition, kr as v4_default, li as RemoveConnectionCommand, na as tryToParseNumber, ni as useHistoryStore, r as useUIStore, ri as AddConnectionCommand, rt as useCredentialsStore, s as useWorkflowsStore, ti as CanvasNodeRenderType, ui as RemoveNodeCommand, vr as useCanvasStore, xn as DEFAULT_VIEWPORT_BOUNDARIES, y as getExecutionErrorToastConfiguration, yn as CONFIGURATION_NODE_SIZE } from "./users.store-Xk7McM6o.js";
import { $a as NodeConnectionTypes, Ei as require_cloneDeep, Fa as isCommunityPackageName, Fi as require__baseUniq, Js as LOCAL_STORAGE_LOGS_PANEL_DETAILS_PANEL_SUB_NODE, Mc as EnterpriseEditionFeature, Pa as deepCopy, Xo as VIEWS, Xs as LOCAL_STORAGE_LOGS_SYNC_SELECTION, Ys as LOCAL_STORAGE_LOGS_PANEL_OPEN, aa as getNodeOutputs, da as getSubworkflowId, ea as generateNodesGraph, ha as isHitlToolType, ia as getNodeInputs, jn as MCP_TRIGGER_NODE_TYPE, mn as FORM_TRIGGER_NODE_TYPE, oa as getNodeParameters, pr as STICKY_NODE_TYPE, qs as LOCAL_STORAGE_LOGS_PANEL_DETAILS_PANEL, ra as getConnectionTypes, wc as NDV_IN_FOCUS_PANEL_EXPERIMENT, xr as WEBHOOK_NODE_TYPE, yc as CANVAS_ZOOMED_VIEW_EXPERIMENT, yr as UPDATE_WEBHOOK_ID_NODE_TYPES } from "./constants-B-_GdCoL.js";
import { A as defineStore, r as useRootStore } from "./_baseOrderBy-Bs_4IhiB.js";
import { t as useExecutionsStore } from "./executions.store-WRuNPJGt.js";
import { t as usePinnedData } from "./usePinnedData-Djdw53o9.js";
import { a as mapLegacyConnectionToCanvasConnection, c as parseCanvasConnectionHandleString, i as mapCanvasConnectionToLegacyConnection, n as createCanvasConnectionHandleString, o as mapLegacyConnectionsToCanvasConnections } from "./canvas.utils-akH8haRX.js";
