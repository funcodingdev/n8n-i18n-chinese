...
import { M as useLocalStorage, S as useClipboard, bt as useI18n } from "./_MapCache-C80pWp05.js";
import { Ri as require_markdown_it_link_attributes, _t as useRoute, vt as useRouter } from "./src-DXhOkTfb.js";
import { t as __plugin_vue_export_helper_default } from "./_plugin-vue_export-helper-DltO58Gh.js";
import { $r as RemoveConnectionCommand, $t as DEFAULT_VIEWPORT_BOUNDARIES, Dt as injectWorkflowState, Ea as isPresent, Et as useWorkflowHelpers, Gr as CanvasNodeRenderType, Is as useSettingsStore, Jr as AddNodeCommand, Jt as useTemplatesStore, Kr as useHistoryStore, Ln as useToast, Ot as useWorkflowState, Qr as MoveNodeCommand, Qt as DEFAULT_NODE_SIZE, Ur as CanvasConnectionMode, Ut as useFocusPanelStore, Yt as CONFIGURABLE_NODE_SIZE, Zt as CONFIGURATION_NODE_SIZE, ar as useTagsStore, at as useCredentialsStore, b as getExecutionErrorToastConfiguration, br as useNDVStore, ca as createWorkflowDocumentId, d as isChatNode, da as useWorkflowDocumentStore, dn as getNodesGroupSize, ei as RemoveNodeCommand, en as GRID_SIZE, gr as useTelemetry, in as generateOffsets, ja as tryToParseNumber, ln as getNewNodePosition, lt as useDataSchema, ma as pinDataToExecutionData, mr as useCanvasStore, ni as ReplaceNodeParametersCommand, pr as useNodeHelpers, qr as AddConnectionCommand, r as useUIStore, rn as doRectsOverlap, s as useWorkflowsStore, ti as RenameNodeCommand, tn as PUSH_NODES_OFFSET, ui as useProjectsStore, w as useNodeTypesStore, yr as usePostHog, z as removePreviewToken, zn as useExternalHooks, zr as isValidNodeConnectionType } from "./users.store-bYJP9NEL.js";
import { Hi as require_cloneDeep, La as resolveNodeWebhookId, Pn as MCP_TRIGGER_NODE_TYPE, Qa as isCommunityPackageName, Sr as UPDATE_WEBHOOK_ID_NODE_TYPES, Ta as getSubworkflowId, Wo as v4_default, Xi as require__baseUniq, Za as deepCopy, _a as getConnectionTypes, _c as LOCAL_STORAGE_LOGS_PANEL_OPEN, al as NDV_IN_FOCUS_PANEL_EXPERIMENT, ba as getNodeParameters, gc as LOCAL_STORAGE_LOGS_PANEL_DETAILS_PANEL_SUB_NODE, gn as FORM_TRIGGER_NODE_TYPE, go as NodeConnectionTypes, gr as STICKY_NODE_TYPE, hc as LOCAL_STORAGE_LOGS_PANEL_DETAILS_PANEL, hs as VIEWS, ka as isHitlToolType, ma as generateNodesGraph, ml as EnterpriseEditionFeature, qc as CANVAS_ZOOMED_VIEW_EXPERIMENT, va as getNodeInputs, vc as LOCAL_STORAGE_LOGS_SYNC_SELECTION, wr as WEBHOOK_NODE_TYPE, ya as getNodeOutputs } from "./constants-neq36s1h.js";
import { j as defineStore, r as useRootStore } from "./_baseOrderBy-2EL3KkTw.js";
import { t as useExecutionsStore } from "./executions.store-CXfJa1PO.js";
import { t as usePinnedData } from "./usePinnedData-D6iG-vVW.js";
import { a as mapLegacyConnectionToCanvasConnection, c as parseCanvasConnectionHandleString, i as mapCanvasConnectionToLegacyConnection, n as createCanvasConnectionHandleString, o as mapLegacyConnectionsToCanvasConnections } from "./canvas.utils-I742fAt-.js";
...
import { t as clearAllNodeResourceLocatorValues } from "./templateTransforms-Bl0C8A0m.js";
