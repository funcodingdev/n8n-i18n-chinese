...
import { t as useLoadingService } from "./useLoadingService-CcH6V2e5.js";
import { t as createEventBus } from "./event-bus-CWhIcyjm.js";
import { $n as hasProxyAuth, F as useEnvFeatureFlag, Jn as getNodeSubtitle, O as assignNodeId, Pi as isString, R as useNodeTypesStore, v as injectWorkflowExecutionStateStore, w as injectWorkflowDocumentStore, xt as useCredentialsStore } from "./workflows.store-BSTkwdxQ.js";
import { Cr as getNodeInputs, Er as getNodeParametersIssues, Hr as nodeIssuesToString, Rr as makeNodeName, Sr as getConnectionTypes, Tr as getNodeParameters, Yt as classifyTriggerIdentity, ii as NodeConnectionTypes, xr as displayParameterPath, zr as mergeIssues } from "./src-JwBmTNgK.js";
...
import { b as isObject } from "./typesUtils-DlQYqvHF.js";
	...
	*/
	...
	function getBlockingTrigger() {
		...
		return triggers.some((trigger) => {
			const { providesN8nIdentity, providesExternalIdentity } = classifyTriggerIdentity(trigger.type, trigger.parameters, { isFormOAuth2Enabled: formOAuth2Enabled });
	...
	function collectPrivateCredentialIssues(node, foundIssues) {
		...
		for (const [credTypeName, details] of Object.entries(node.credentials ?? {})) {
			...
			if (blockingTrigger) {
				let messageKey = "nodeIssues.credentials.privateRequiresIdentityTriggerWithWebhook";
				if (!blockingTrigger.isSystemResolver) messageKey = "nodeIssues.credentials.privateRequiresIdentityExtractor";
				else if (blockingTrigger.formOAuth2Enabled) messageKey = "nodeIssues.credentials.privateRequiresIdentityTriggerWithFormAndWebhook";
