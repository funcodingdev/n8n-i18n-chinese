;
(function () {
  System.register(["./vue.runtime.esm-bundler-legacy--Sn1h8On.js", "./_MapCache-legacy-Bnay2tPV.js", "./src-legacy-7AvQoEFL.js", "./en-legacy-DJK4SpPN.js", "./preload-helper-legacy-CXRjoQ0T.js", "./_plugin-vue_export-helper-legacy-DZMI5HPp.js", "./truncate-legacy-C0REgs6L.js", "./icon-legacy-CVeQu2M4.js", "./date-picker-legacy-B12NkPCv.js", "./overlay-legacy-ChC8zZ3J.js", "./ParameterInputList-legacy-CAIygjJy.js", "./empty-legacy-ZG0-xpne.js", "./useMessage-legacy-6hGlTqPS.js", "./col-legacy-o_uT7haF.js", "./dialog-legacy-QW0it1xZ.js", "./useTelemetry-legacy-DKRvN4mA.js", "./useToast-legacy-DEFFmTH6.js", "./sanitize-html-legacy-B93rGWi4.js", "./CalendarDate-legacy-BUvNgcoo.js", "./path-browserify-legacy-PZw06cM9.js", "./constants-legacy-BbwdWVie.js", "./merge-legacy-I2FBUck9.js", "./assistant.store-legacy-BJMYMBts.js", "./_baseOrderBy-legacy-9y2xV7og.js", "./dateformat-legacy-C4HUJTCr.js", "./useDebounce-legacy-BVuvDrP1.js", "./useExternalHooks-legacy-DyFictUx.js", "./useStyles-legacy-E8NPEyeD.js", "./chatPanel.store-legacy-uYtAzHZb.js", "./npsSurvey.store-legacy-BRhjpTEy.js", "./cloudPlan.store-legacy-CVrtJ_NL.js", "./templates.store-legacy-x3SOFlkt.js", "./focusPanel.store-legacy-CzF3CLCV.js", "./useWorkflowSaving-legacy-BhH4Tvrd.js", "./retry-legacy-CTwsGM7o.js", "./executions.store-legacy-7YJcNBbW.js", "./useRunWorkflow-legacy-CUCSeSme.js", "./usePinnedData-legacy-8Q8a4BA4.js", "./nodeCreator.store-legacy-Dd3CIyb6.js", "./nodeIcon-legacy-sUSRaHU2.js", "./useClipboard-legacy-aZBgERqe.js", "./useCanvasOperations-legacy-DEUo_7ce.js", "./folders.store-legacy-DAIQGD7o.js", "./NodeIcon-legacy-CLRVa0M1.js", "./KeyboardShortcutTooltip-legacy-BOB3Wdid.js", "./useCanvasMapping-legacy-B2pT--u4.js", "./versions.store-legacy-BmO_kk34.js", "./usePageRedirectionHelper-legacy-CnzXGEMw.js", "./dataTable.store-legacy-DkDvn8sK.js", "./isEmpty-legacy-BFh4xeVr.js", "./NDVEmptyState-legacy-CfwfarzX.js", "./exports-legacy-COvxY4M6.js", "./externalSecrets.ee.store-legacy-NFkf1KZl.js", "./uniqBy-legacy-Bapb8m8Z.js", "./semver-legacy-cFkTOgnv.js", "./CommunityNodeUpdateInfo-legacy-ByKIQXB9.js", "./RunDataHtml-legacy-BRE8NZRs.js", "./VueMarkdown-legacy-CDnzdUfl.js", "./Draggable-legacy-Dii4ycdc.js", "./VirtualSchema-legacy-NiMemIqC.js", "./TextWithHighlights-legacy-BkMBE92Y.js", "./useTelemetryContext-legacy-ktLEQDcF.js", "./schemaPreview.store-legacy-CGNkNnpO.js", "./nodeTransforms-legacy-B7RvOC_D.js", "./FileSaver.min-legacy-D7uxxng5.js", "./vue-json-pretty-legacy-DXTjoBRT.js", "./dateFormatter-legacy-Cl5sc2-W.js", "./useExecutionHelpers-legacy-Czsr1u6a.js", "./NodeSettings-legacy-l93qTqaH.js", "./useActions-legacy-DEEhVLyt.js", "./vue-legacy-DYOFx85F.js", "./sourceControl.eventBus-legacy-Deha1EAW.js", "./useKeybindings-legacy-Dbn1A6_0.js", "./useBeforeUnload-legacy-Dtf2rdC_.js", "./aiTemplatesStarterCollection.store-legacy-DftBuwsS.js", "./useExecutionData-legacy-D-4jY2vO.js", "./useExecutionDebugging-legacy-Ise7XmgG.js", "./readyToRunWorkflows.store-legacy-BkGjjruh.js"], function (_export, _context) {
    "use strict";

    var computed, toDisplayString, createElementBlock, createCommentVNode, nextTick, unref, ref, onBeforeUnmount, onActivated, h, createVNode, defineAsyncComponent, defineComponent, createBlock, toRef, mergeProps, onDeactivated, onMounted, Fragment, watch, renderSlot, normalizeStyle, withCtx, useCssModule, openBlock, withModifiers, renderList, createTextVNode, useTemplateRef, provide, onBeforeMount, normalizeClass, createBaseVNode, Suspense, refThrottled, useActiveElement, useI18n, useThrottleFn, N8nCallout_default, N8nInfoTip_default, N8nButton_default, CanvasThinkingPill_default, N8nRadioButtons_default, N8nText_default, N8nIcon_default, N8nInlineTextEdit_default, N8nResizeWrapper_default, useDeviceSupport, N8nKeyboardShortcut_default, N8nIconButton_default, N8nInput_default, __vitePreload, __plugin_vue_export_helper_default, useRouter, onBeforeRouteLeave, createEventBus, useRoute, HtmlEditor_default, SqlEditor_default, CodeNodeEditor_default, isValidParameterOption, ParameterOptions_default, getParameterTypeOption, JsEditor_default, CssEditor_default, formatAsExpression, useResolvedExpression, useNodeSettingsParameters, ExpressionEditorModalInput_default, parseFromExpression, useMessage, htmlEditorEventBus, getSampleWorkflowByTemplateId, getNodesWithNormalizedPosition, useWorkflowState, useSourceControlStore, useProjectsStore, useUIStore, useCanvasStore, useVueFlow, useCredentialsStore, historyBus, nodeViewEventBus, getRectOfNodes, injectWorkflowState, useDocumentTitle, useHistoryStore, useSettingsStore, useTagsStore, useNDVStore, useNodeTypesStore, useEnvironmentsStore, getBounds, hasFocusOnInput, usePostHog, useUsersStore, useWorkflowsStore, isValueExpression, useTelemetry, CanvasNodeRenderType, getNodeViewTab, useNodeHelpers, isFocusableEl, useToast, jsonParse, getResourcePermissions, MANUAL_CHAT_TRIGGER_NODE_TYPE, MAIN_HEADER_TABS, VIEWS, FROM_AI_PARAMETERS_MODAL_KEY, ABOUT_MODAL_KEY, VALID_WORKFLOW_IMPORT_URL_REGEX, AI_TRANSFORM_NODE_TYPE, isResourceLocatorValue, CHAT_TRIGGER_NODE_TYPE, ExpressionLocalResolveContextSymbol, EnterpriseEditionFeature, PLACEHOLDER_EMPTY_WORKFLOW_ID, NDV_UI_OVERHAUL_EXPERIMENT, STICKY_NODE_TYPE, WorkflowStateKey, isTriggerNode, getNodeOutputs, EVALUATION_NODE_TYPE, PRODUCTION_ONLY_TRIGGER_NODE_TYPES, EVALUATION_TRIGGER_NODE_TYPE, NEW_WORKFLOW_ID, HTML_NODE_TYPE, getNodeInputs, MODAL_CONFIRM, START_NODE_TYPE, WORKFLOW_SETTINGS_MODAL_KEY, NODE_CREATOR_OPEN_SOURCES, DRAG_EVENT_DATA_KEY, useBuilderStore, useRootStore, useExternalHooks, useNpsSurveyStore, useFocusPanelStore, useWorkflowSaving, useExecutionsStore, usePushConnectionStore, useAgentRequestStore, useRunWorkflow, useNodeCreatorStore, shouldIgnoreCanvasShortcut, useClipboard, useLogsStore, useExperimentalNdvStore, useParentFolder, canvasEventBus, useCanvasOperations, NodeIcon_default, KeyboardShortcutTooltip_default, ExperimentalCanvasNodeSettings_default, CanvasRunWorkflowButton_default, useGlobalLinkActions, Canvas_default, useContextMenuItems, useExpressionResolveCtx, useCanvasMapping, useWorkflowExtraction, JsonEditor_default, useExternalSecretsStore, NodeExecuteButton_default, useTelemetryContext, needsAgentInput, sourceControlEventBus, useKeybindings, useBeforeUnload, useAITemplatesStarterCollectionStore, useExecutionData, useExecutionDebugging, useReadyToRunWorkflowsStore, __vite_style__, WorkflowCanvas_vue_vue_type_script_setup_true_lang_default, wrapper$2, canvas, WorkflowCanvas_vue_vue_type_style_index_0_lang_module_default, cssModules$4, WorkflowCanvas_default, ExperimentalNodeDetailsDrawer_vue_vue_type_script_setup_true_lang_default, component$1, multipleNodes, multipleNodesActions, multipleNodesAction, ExperimentalNodeDetailsDrawer_vue_vue_type_style_index_0_lang_module_default, cssModules$3, ExperimentalNodeDetailsDrawer_default, ExperimentalFocusPanelHeader_vue_vue_type_script_setup_true_lang_default, component, breadcrumbs, ExperimentalFocusPanelHeader_vue_vue_type_style_index_0_lang_module_default, cssModules$2, ExperimentalFocusPanelHeader_default, FocusPanel_vue_vue_type_script_setup_true_lang_default, wrapper$1, container, content, emptyContent, isNdvInFocusPanelEnabled, emptyText, focusParameterWrapper, iconWrapper, pointerIcon, tabHeader, tabHeaderText, buttonWrapper, parameterDetailsWrapper, parameterOptionsWrapper, noExecutionDataTip, editorContainer, editor, delayedShow, triggerShow, closeButton, heightFull, forceHover, FocusPanel_vue_vue_type_style_index_0_lang_module_default, cssModules$1, FocusPanel_default, CanvasStopCurrentExecutionButton_vue_vue_type_script_setup_true_lang_default, CanvasStopCurrentExecutionButton_default, CanvasStopWaitingForWebhookButton_vue_vue_type_script_setup_true_lang_default, CanvasStopWaitingForWebhookButton_default, _hoisted_1, _hoisted_2, NodeViewUnfinishedWorkflowMessage_vue_vue_type_script_setup_true_lang_default, NodeViewUnfinishedWorkflowMessage_default, CanvasChatButton_vue_vue_type_script_setup_true_lang_default, CanvasChatButton_default, NodeView_vue_vue_type_script_setup_true_lang_default, wrapper, executionButtons, chatButton, setupCredentialsButtonWrapper, readOnlyEnvironmentNotification, thinkingPill, NodeView_vue_vue_type_style_index_0_lang_module_default, cssModules, NodeView_default;
    return {
      setters: [function (_vueRuntimeEsmBundlerLegacy003Js) {
        ...
        MANUAL_CHAT_TRIGGER_NODE_TYPE = _constantsLegacy00TJs.En;
        MAIN_HEADER_TABS = _constantsLegacy00TJs.Fo;
        VIEWS = _constantsLegacy00TJs.Io;
        FROM_AI_PARAMETERS_MODAL_KEY = _constantsLegacy00TJs.Jo;
        ABOUT_MODAL_KEY = _constantsLegacy00TJs.Lo;
        VALID_WORKFLOW_IMPORT_URL_REGEX = _constantsLegacy00TJs.N;
        AI_TRANSFORM_NODE_TYPE = _constantsLegacy00TJs.Qa;
        isResourceLocatorValue = _constantsLegacy00TJs.Sa;
        ...
        NDV_UI_OVERHAUL_EXPERIMENT = _constantsLegacy00TJs.cc;
        STICKY_NODE_TYPE = _constantsLegacy00TJs.dr;
        WorkflowStateKey = _constantsLegacy00TJs.ec;
        isTriggerNode = _constantsLegacy00TJs.ma;
        getNodeOutputs = _constantsLegacy00TJs.na;
        EVALUATION_NODE_TYPE = _constantsLegacy00TJs.no;
        PRODUCTION_ONLY_TRIGGER_NODE_TYPES = _constantsLegacy00TJs.qn;
        EVALUATION_TRIGGER_NODE_TYPE = _constantsLegacy00TJs.ro;
        NEW_WORKFLOW_ID = _constantsLegacy00TJs.s;
        HTML_NODE_TYPE = _constantsLegacy00TJs.so;
        getNodeInputs = _constantsLegacy00TJs.ta;
        MODAL_CONFIRM = _constantsLegacy00TJs.ts;
        START_NODE_TYPE = _constantsLegacy00TJs.ur;
        WORKFLOW_SETTINGS_MODAL_KEY = _constantsLegacy00TJs.vs;
        NODE_CREATOR_OPEN_SOURCES = _constantsLegacy00TJs.wt;
        DRAG_EVENT_DATA_KEY = _constantsLegacy00TJs.z;
      ...
      }, function (_useStylesLegacy015Js) {}, function (_chatPanelStoreLegacy017Js) {}, function (_npsSurveyStoreLegacy01bJs) {
        useNpsSurveyStore = _npsSurveyStoreLegacy01bJs.t;
      }, function (_cloudPlanStoreLegacy01dJs) {}, function (_templatesStoreLegacy01fJs) {}, function (_focusPanelStoreLegacy01hJs) {
        ...
        useAgentRequestStore = _useRunWorkflowLegacy01pJs.n;
        useRunWorkflow = _useRunWorkflowLegacy01pJs.t;
      }, function (_usePinnedDataLegacy01rJs) {}, function (_nodeCreatorStoreLegacy01tJs) {
        useNodeCreatorStore = _nodeCreatorStoreLegacy01tJs.t;
        shouldIgnoreCanvasShortcut = _nodeCreatorStoreLegacy01tJs.u;
      }, function (_nodeIconLegacy01vJs) {}, function (_useClipboardLegacy01xJs) {
        ...
        useParentFolder = _useCanvasOperationsLegacy01zJs.n;
        canvasEventBus = _useCanvasOperationsLegacy01zJs.r;
      ...
      }, function (_useCanvasMappingLegacy01JJs) {
        ExperimentalCanvasNodeSettings_default = _useCanvasMappingLegacy01JJs.c;
        CanvasRunWorkflowButton_default = _useCanvasMappingLegacy01JJs.d;
        useGlobalLinkActions = _useCanvasMappingLegacy01JJs.l;
        Canvas_default = _useCanvasMappingLegacy01JJs.n;
        useContextMenuItems = _useCanvasMappingLegacy01JJs.o;
        useExpressionResolveCtx = _useCanvasMappingLegacy01JJs.s;
        useCanvasMapping = _useCanvasMappingLegacy01JJs.t;
        useWorkflowExtraction = _useCanvasMappingLegacy01JJs.u;
      }, function (_versionsStoreLegacy01LJs) {}, function (_usePageRedirectionHelperLegacy01NJs) {}, function (_dataTableStoreLegacy01RJs) {}, function (_isEmptyLegacy021Js) {
        JsonEditor_default = _isEmptyLegacy021Js.c;
      }, function (_NDVEmptyStateLegacy023Js) {}, function (_exportsLegacy025Js) {}, function (_externalSecretsEeStoreLegacy027Js) {
        useExternalSecretsStore = _externalSecretsEeStoreLegacy027Js.t;
      }, function (_uniqByLegacy029Js) {}, function (_semverLegacy02bJs) {}, function (_CommunityNodeUpdateInfoLegacy02dJs) {}, function (_RunDataHtmlLegacy02nJs) {}, function (_VueMarkdownLegacy02rJs) {}, function (_DraggableLegacy02tJs) {}, function (_VirtualSchemaLegacy02vJs) {
        NodeExecuteButton_default = _VirtualSchemaLegacy02vJs.n;
      }, function (_TextWithHighlightsLegacy02xJs) {}, function (_useTelemetryContextLegacy02zJs) {
        useTelemetryContext = _useTelemetryContextLegacy02zJs.t;
      }, function (_schemaPreviewStoreLegacy02BJs) {}, function (_nodeTransformsLegacy02DJs) {
        needsAgentInput = _nodeTransformsLegacy02DJs.a;
      }, function (_FileSaverMinLegacy02HJs) {}, function (_vueJsonPrettyLegacy02JJs) {}, function (_dateFormatterLegacy02LJs) {}, function (_useExecutionHelpersLegacy02NJs) {}, function (_NodeSettingsLegacy02RJs) {}, function (_useActionsLegacy03tJs) {}, function (_vueLegacy03xJs) {}, function (_sourceControlEventBusLegacy03HJs) {
      ...
      }, function (_aiTemplatesStarterCollectionStoreLegacy04hJs) {
        useAITemplatesStarterCollectionStore = _aiTemplatesStarterCollectionStoreLegacy04hJs.t;
      }, function (_useExecutionDataLegacy04zJs) {
        useExecutionData = _useExecutionDataLegacy04zJs.t;
      }, function (_useExecutionDebuggingLegacy04BJs) {
        useExecutionDebugging = _useExecutionDebuggingLegacy04BJs.t;
      }, function (_readyToRunWorkflowsStoreLegacy04DJs) {
        useReadyToRunWorkflowsStore = _readyToRunWorkflowsStoreLegacy04DJs.t;
      }],
      execute: function () {
        ...
        NodeView_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */defineComponent({
          ...
          __name: "NodeView",
          setup(__props) {
            const LazyNodeCreation = defineAsyncComponent(async () => await __vitePreload(() => _context.import("./NodeCreation-legacy-DLbdKIMq.js"), true               ? void 0 : void 0));
            const LazyNodeDetailsView = defineAsyncComponent(async () => await __vitePreload(() => _context.import("./NodeDetailsView-legacy-DtZu78SY.js"), true               ? void 0 : void 0));
            const LazyNodeDetailsViewV2 = defineAsyncComponent(async () => await __vitePreload(() => _context.import("./NodeDetailsViewV2-legacy-CMTU0i1u.js"), true               ? void 0 : void 0));
            const LazySetupWorkflowCredentialsButton = defineAsyncComponent(async () => await __vitePreload(() => _context.import("./SetupWorkflowCredentialsButton-legacy-Dcik1-w4.js"), true               ? void 0 : void 0));
            const $style = useCssModule();
