const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/es-B2XzFzF2.js","assets/chunk-CC9Q-vWm.js","assets/core-Crvhk0p9.js","assets/languageModules-Csqtcudg.js","assets/xml-C25YAwwQ.js","assets/json-D0asYzzw.js"])))=>i.map(i=>d[i]);
	...
	async function loadLanguageModules() {
		...
		try {
			const promise = Promise.all([__vitePreload(async () => {
				const { default: highlight } = await import("./es-B2XzFzF2.js");
				return { default: highlight };
			}, __vite__mapDeps([0,1,2])).then(({ default: highlight }) => highlight), __vitePreload(() => import("./languageModules-Csqtcudg.js"), __vite__mapDeps([3,4,5]))]);
			asyncImport = {
				status: "inProgress",
				promise
			};
