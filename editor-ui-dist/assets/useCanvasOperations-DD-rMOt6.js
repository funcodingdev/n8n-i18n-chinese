...
import { s as useI18n$1 } from "./src-CvPjLYa0.js";
import { Bi as require_markdown_it_link_attributes, _t as useRouter, gt as useRoute } from "./src-CSWS3PCK.js";
import { t as _plugin_vue_export_helper_default } from "./_plugin-vue_export-helper-Da88TEg1.js";
import { c as useClipboard, v as useLocalStorage } from "./core-CxAuVuwP.js";
import { t as useToast } from "./useToast-THYqqSsb.js";
import { Ca as LOCAL_STORAGE_LOGS_PANEL_DETAILS_PANEL_SUB_NODE, Cn as MANUAL_CHAT_TRIGGER_NODE_TYPE, Cs as validateNodeSelectionForGrouping, Dc as getNodeParameters, Ec as getNodeOutputs, Gc as resolveNodeWebhookId, Ic as isHitlToolType, Ju as CANVAS_ZOOMED_VIEW_EXPERIMENT, Lt as CHAT_TRIGGER_NODE_TYPE, Mc as getSubworkflowId, Sa as LOCAL_STORAGE_LOGS_PANEL_DETAILS_PANEL, Ss as validateNodeSelectionForExtraction, Ta as LOCAL_STORAGE_LOGS_SYNC_SELECTION, Tc as getNodeInputs, Td as EnterpriseEditionFeature, Xl as v4, bc as generateNodesGraph, dl as deepCopy, fl as isCommunityPackageName, hr as UPDATE_WEBHOOK_ID_NODE_TYPES, il as NodeConnectionTypes, lr as STICKY_NODE_TYPE, md as NDV_IN_FOCUS_PANEL_EXPERIMENT, pl as isObjectEmpty, qu as CANVAS_NODES_GROUPING_EXPERIMENT, ui as VIEWS, vs as require_cloneDeep, wa as LOCAL_STORAGE_LOGS_PANEL_OPEN, wc as getConnectionTypes } from "./constants-BpExsFUJ.js";
import { Bi as CanvasNodeRenderType, Dr as mapLegacyConnectionsToCanvasConnections, Er as mapLegacyConnectionToCanvasConnection, Fr as DEFAULT_VIEWPORT_BOUNDARIES, Gt as disposeWorkflowExecutionStateStore, Ir as PUSH_NODES_OFFSET, It as useTagsStore, Ki as pinDataToExecutionData, Kr as getNodesGroupSize, Lt as ensureNodePosition, Mr as CONFIGURABLE_NODE_SIZE, Mt as useWorkflowHelpers, Nr as CONFIGURATION_NODE_SIZE, Or as parseCanvasConnectionHandleString, Pr as DEFAULT_NODE_SIZE, R as removePreviewToken, Ri as CanvasConnectionMode, Rr as doRectsOverlap, Tr as mapCanvasConnectionToLegacyConnection, Wr as getNewNodePosition, Wt as useNDVStore, _ as useNodeTypesStore, a as injectWorkflowDocumentStore, at as useCredentialsStore, cn as useWorkflowsStore, g as require_uniq, h as serializeNode, ht as useDataSchema, ji as isValidNodeConnectionType, nn as getExecutionErrorToastConfiguration, qt as useWorkflowExecutionStateStore, r as createWorkflowDocumentId, s as useWorkflowDocumentStore, xn as useProjectsStore, yr as createCanvasConnectionHandleString, zr as generateOffsets, zt as sanitizeConnections } from "./workflowDocument.store-B8Lg41Xq.js";
import { T as defineStore, t as useRootStore } from "./useRootStore-BLAHyASD.js";
...
import { O as tryToParseNumber, S as isPresent, o as getNewWorkflowData } from "./workflowsList.store-Bm-9RAXi.js";
import { t as useExternalHooks } from "./useExternalHooks-BJ87mufY.js";
import { t as useBuilderStore } from "./builder.store-PMsavVtn.js";
import { _ as useCanvasStore, a as AddNodeGroupCommand, d as RemoveNodeCommand, f as RemoveNodeGroupCommand, h as UpdateNodeGroupCommand, i as AddNodeCommand, l as MoveNodeCommand, m as ReplaceNodeParametersCommand, n as useHistoryStore, p as RenameNodeCommand, r as AddConnectionCommand, t as useNodeHelpers, u as RemoveConnectionCommand } from "./useNodeHelpers-DN73byk0.js";
...
import { t as clearAllNodeResourceLocatorValues } from "./templateTransforms-BghDd86a.js";
