...
import { Ji as N8nTooltip_default, L as N8nTabs_default, Qt as N8nLoading_default, gt as N8nLink_default, no as N8nButton_default, ro as N8nIcon_default, to as N8nText_default } from "./src-BiIlKUZj.js";
...
import { i as refreshReport, n as getReport, t as SeverityTag_default } from "./SeverityTag-DLX1U_CY.js";
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("div", _hoisted_1, [
				createVNode(unref(N8nText_default), {
					...
					default: withCtx(() => [createTextVNode(toDisplayString(unref(i18n).baseText("settings.migrationReport.title", { interpolate: { version: targetVersionDisplay } })), 1)]),
					_: 1
				}),
				createVNode(unref(N8nText_default), {
					tag: "p",
