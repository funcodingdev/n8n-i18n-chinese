import { $ as openBlock, A as createTextVNode, C as createBaseVNode, Cn as toDisplayString, E as createElementBlock, Gt as unref, It as ref, N as defineComponent, S as computed, T as createCommentVNode, X as onMounted, _ as Fragment, bt as withCtx, j as createVNode, q as onBeforeUnmount, rt as renderList, vn as normalizeClass, w as createBlock } from "./vue.runtime.esm-bundler-DYHsQBZB.js";
...
import { n as createFormEventBus, t as N8nFormInputs_default } from "./N8nFormInputs-Cb74H0Qq.js";
...
import { D as ROLE } from "./src-BrbN-vPn.js";
...
import { x as MFA_DOCS_URL } from "./constants-Bwbcx8Ih.js";
...
import { i as PROMPT_MFA_CODE_MODAL_KEY, n as CONFIRM_PASSWORD_MODAL_KEY, r as MFA_SETUP_MODAL_KEY, t as CHANGE_PASSWORD_MODAL_KEY } from "./auth.constants-CHWdQJiE.js";
import { r as promptMfaCodeBus, t as confirmPasswordEventBus } from "./auth.eventBus-gav0UeEI.js";
...
var SettingsPersonalView_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		...
		const isLdapCurrentAuthMethod = computed(() => {
		...
		const isExternalAuthEnabled = computed(() => {
			...
			const isOidcEnabled = ssoStore.isEnterpriseOidcEnabled && ssoStore.isOidcLoginEnabled && currentUser.value?.signInType === "oidc";
		...
		const canConfigureMfa = computed(() => {
			return isMfaFeatureEnabled.value && (isPersonalSecurityEnabled.value || isLdapCurrentAuthMethod.value);
		});
		const isSecuritySectionVisible = computed(() => {
		...
		const currentUserRole = computed(() => {
			...
			const knownRole = knownRoles[globalRoleName];
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("div", {
				...
				createBaseVNode("div", { class: normalizeClass(_ctx.$style.header) }, [createVNode(unref(N8nHeading_default), { size: "2xlarge" }, {
					...
					placement: "bottom",
					disabled: !currentUserRole.value.description
				}, {
					...
					_: 1
				}, 8, ["disabled"])], 2), createVNode(unref(N8nAvatar_default), {
				...
				createBaseVNode("div", null, [
					createBaseVNode("div", _hoisted_1, [createVNode(unref(N8nHeading_default), { size: "large" }, {
					...
					isManagedByEnv.value ? (openBlock(), createBlock(unref(N8nNotice_default), {
						key: 0,
						content: unref(i18n).baseText("settings.personal.managedByEnv"),
				...
				isSecuritySectionVisible.value ? (openBlock(), createElementBlock("div", _hoisted_3, [
					...
					isPersonalSecurityEnabled.value ? (openBlock(), createElementBlock("div", _hoisted_5, [createVNode(unref(N8nInputLabel_default), { label: unref(i18n).baseText("auth.password") }, {
					...
					canConfigureMfa.value ? (openBlock(), createElementBlock("div", _hoisted_6, [
...
var container = "_container_1jq0b_388";
var header = "_header_1jq0b_395";
var user = "_user_1jq0b_404";
var username = "_username_1jq0b_414";
var tooltip = "_tooltip_1jq0b_427";
var disableMfaButton = "_disableMfaButton_1jq0b_431";
var button = "_button_1jq0b_435";
var infoText = "_infoText_1jq0b_442";
var themeSelect = "_themeSelect_1jq0b_447";
var shimmer = "_shimmer_1jq0b_1";
var spin = "_spin_1jq0b_1";
var opacityPulse = "_opacityPulse_1jq0b_1";
var popoverIn = "_popoverIn_1jq0b_1";
var fadeIn = "_fadeIn_1jq0b_1";
var collapsibleSlideDown = "_collapsibleSlideDown_1jq0b_1";
var collapsibleSlideUp = "_collapsibleSlideUp_1jq0b_1";
var collapsibleSlideDownBlurred = "_collapsibleSlideDownBlurred_1jq0b_1";
var collapsibleSlideUpBlurred = "_collapsibleSlideUpBlurred_1jq0b_1";
var blurSwapIn = "_blurSwapIn_1jq0b_1";
var blurSwapOut = "_blurSwapOut_1jq0b_1";
var pulseGlow = "_pulseGlow_1jq0b_1";
var pulseGlowDelayed = "_pulseGlowDelayed_1jq0b_1";
var fade = "_fade_1jq0b_1";
var fadeInUp = "_fadeInUp_1jq0b_1";
var fadeInDown = "_fadeInDown_1jq0b_1";
var fadeInLeft = "_fadeInLeft_1jq0b_1";
var fadeInRight = "_fadeInRight_1jq0b_1";
var fadeOut = "_fadeOut_1jq0b_1";
var fadeOutDown = "_fadeOutDown_1jq0b_1";
var fadeOutUp = "_fadeOutUp_1jq0b_1";
var fadeOutLeft = "_fadeOutLeft_1jq0b_1";
var fadeOutRight = "_fadeOutRight_1jq0b_1";
var ping = "_ping_1jq0b_1";
var blinkBackground = "_blinkBackground_1jq0b_1";
var typingBlink = "_typingBlink_1jq0b_1";
var SettingsPersonalView_vue_vue_type_style_index_0_lang_module_default = {
	...
	shimmer,
	spin,
	"skeleton-pulse": "_skeleton-pulse_1jq0b_1",
	opacityPulse,
	popoverIn,
	fadeIn,
...
var SettingsPersonalView_default = /* @__PURE__ */ _plugin_vue_export_helper_default(SettingsPersonalView_vue_vue_type_script_setup_true_lang_default, [["__cssModules", { "$style": SettingsPersonalView_vue_vue_type_style_index_0_lang_module_default }]]);
//#endregion
