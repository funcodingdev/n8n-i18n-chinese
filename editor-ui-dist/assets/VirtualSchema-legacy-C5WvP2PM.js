;
(function () {
  System.register(["./chunk-legacy-Re9CbdfL.js", "./vue.runtime.esm-bundler-legacy--Sn1h8On.js", "./_MapCache-legacy-BlV_W1LO.js", "./src-legacy-B7xKFZYj.js", "./_plugin-vue_export-helper-legacy-DZMI5HPp.js", "./truncate-legacy-DWqu3mV5.js", "./useMessage-legacy-C_GChh01.js", "./useTelemetry-legacy-Dj2fHQys.js", "./useToast-legacy-B2w_7aSU.js", "./constants-legacy-wGNoFUi7.js", "./_baseOrderBy-legacy-DE6my_G3.js", "./useExternalHooks-legacy-D4ODACUq.js", "./useRunWorkflow-legacy-eQxzT9gd.js", "./usePinnedData-legacy-BLLY2IY8.js", "./NodeIcon-legacy-2D3b9ZNP.js", "./NDVEmptyState-legacy-wK3LvB91.js", "./Draggable-legacy-DqZMRq84.js", "./TextWithHighlights-legacy-BkMBE92Y.js", "./useTelemetryContext-legacy-j5maYWyL.js", "./schemaPreview.store-legacy-M9tzw06r.js", "./nodeTransforms-legacy-BVInh5yk.js"], function (_export, _context) {
    "use strict";

    var __toESM, computed, toDisplayString, withScopeId, createElementBlock, createCommentVNode, nextTick, unref, guardReactiveProps, ref, h, shallowReactive, createVNode, markRaw, defineComponent, createBlock, mergeProps, Fragment, watch, renderSlot, normalizeStyle, withCtx, resolveDynamicComponent, openBlock, withModifiers, renderList, createTextVNode, useCssVars, toHandlers, resolveComponent, useSlots, pushScopeId, resolveDirective, popScopeId, normalizeClass, createBaseVNode, withDirectives, normalizeProps, I18nT, useI18n, computedAsync, N8nButton_default, N8nText_default, N8nIcon_default, N8nTooltip_default, N8nLink_default, __plugin_vue_export_helper_default, useRouter, useMessage, useUIStore, generateCodeForPrompt, useSettingsStore, nodeViewEventBus, useFlattenSchema, injectWorkflowState, executionDataToJson, useDataSchema, useNDVStore, useNodeTypesStore, useWorkflowsStore, useTelemetry, isEmpty, useNodeHelpers, environments_store_default, useToast, MODAL_CONFIRM, CHAT_TRIGGER_NODE_TYPE, SCHEMA_PREVIEW_DOCS_URL, createResultError, MANUAL_TRIGGER_NODE_TYPE, AI_TRANSFORM_CODE_GENERATED_FOR_PROMPT, FROM_AI_PARAMETERS_MODAL_KEY, PLACEHOLDER_FILLED_AT_EXECUTION_TIME, DateTime, NodeConnectionTypes, AI_TRANSFORM_NODE_TYPE, AI_TRANSFORM_JS_CODE, FORM_TRIGGER_NODE_TYPE, EnterpriseEditionFeature, require_pick, WEBHOOK_NODE_TYPE, ApplicationError, useRootStore, useExternalHooks, useRunWorkflow, usePinnedData, NodeIcon_default, Ln, gu, estree_exports, NDVEmptyState_default, Draggable_default, TextWithHighlights_default, MappingPill_default, useTelemetryContext, useSchemaPreviewStore, needsAgentInput, __vite_style__, _hoisted_1$3, _hoisted_2$2, _hoisted_3, _hoisted_4, _hoisted_5, _hoisted_6, VirtualSchemaHeader_vue_vue_type_script_setup_true_lang_default, VirtualSchemaHeader_default, _hoisted_1$2, _hoisted_2$1, VirtualSchemaItem_vue_vue_type_script_setup_true_lang_default, tooltip, VirtualSchemaItem_vue_vue_type_style_index_1_lang_module_default, cssModules, VirtualSchemaItem_default, isIE, script$2, _withId, _hoisted_1$1, VisibilityState, ObserveVisibility, config, regex, style, overflow, scroll, props, supportsPassive, opts, uid, script$2$1, _hoisted_1, _hoisted_2, script$1, script, estimateNumberOfTokens, calculateRemainingTokens, trimParentNodesSchema, trimInputSchemaProperties, getRowIndex, getColumnIndex, NODE_TEST_STEP_POPUP_COUNT_KEY, MAX_POPUP_COUNT, POPUP_UPDATE_DELAY, NodeExecuteButton_vue_vue_type_script_setup_true_lang_default, NodeExecuteButton_default, import_pick, VirtualSchema_vue_vue_type_script_setup_true_lang_default, VirtualSchema_default;
    //#endregion
    ...
    */
    ...
    return {
      setters: [function (_chunkLegacy001Js) {
        ...
        generateCodeForPrompt = _useTelemetryLegacy00HJs.Gt;
        useSettingsStore = _useTelemetryLegacy00HJs.Ho;
        nodeViewEventBus = _useTelemetryLegacy00HJs.Oi;
        useFlattenSchema = _useTelemetryLegacy00HJs.Qt;
        ...
        SCHEMA_PREVIEW_DOCS_URL = _constantsLegacy00TJs.C;
        createResultError = _constantsLegacy00TJs.Ei;
        MANUAL_TRIGGER_NODE_TYPE = _constantsLegacy00TJs.En;
        AI_TRANSFORM_CODE_GENERATED_FOR_PROMPT = _constantsLegacy00TJs.Ja;
        FROM_AI_PARAMETERS_MODAL_KEY = _constantsLegacy00TJs.Ko;
        PLACEHOLDER_FILLED_AT_EXECUTION_TIME = _constantsLegacy00TJs.P;
        ...
        gu = _NDVEmptyStateLegacy023Js.o;
        estree_exports = _NDVEmptyStateLegacy023Js.r;
        NDVEmptyState_default = _NDVEmptyStateLegacy023Js.t;
      }, function (_DraggableLegacy02tJs) {
        Draggable_default = _DraggableLegacy02tJs.t;
      }, function (_TextWithHighlightsLegacy02xJs) {
        TextWithHighlights_default = _TextWithHighlightsLegacy02xJs.t;
      }, function (_useTelemetryContextLegacy02zJs) {
        MappingPill_default = _useTelemetryContextLegacy02zJs.n;
      ...
      execute: function () {
        ...
        _export("t", VirtualSchema_default = /* @__PURE__ */__plugin_vue_export_helper_default(VirtualSchema_vue_vue_type_script_setup_true_lang_default, [["__scopeId", "data-v-9dc0985a"]])); //#endregion
      }
    };
  });
})();