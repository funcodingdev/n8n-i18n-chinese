...
import { M as useLocalStorage, S as useClipboard, yt as useI18n } from "./_MapCache-bZK-mH1x.js";
import { Ei as require_markdown_it_link_attributes, bi as useRoute, mt as createEventBus, xi as useRouter } from "./src-Bv1Pmwk0.js";
import { t as __plugin_vue_export_helper_default } from "./_plugin-vue_export-helper-DltO58Gh.js";
import { An as generateOffsets, Ar as usePostHog, C as useNodeTypesStore, Cn as CONFIGURATION_NODE_SIZE, Dn as PUSH_NODES_OFFSET, En as GRID_SIZE, Fn as getNewNodePosition, It as useNDVStore, Ln as getNodesGroupSize, Lr as v4_default, Lt as injectWorkflowState, Mt as useNodeHelpers, Nt as useTelemetry, Ot as useTagsStore, R as removePreviewToken, Rt as useWorkflowState, Sr as useCanvasStore, Tn as DEFAULT_VIEWPORT_BOUNDARIES, Tt as useWorkflowHelpers, Vt as useProjectsStore, _i as RemoveConnectionCommand, aa as isPresent, bi as ReplaceNodeParametersCommand, bn as useTemplatesStore, ct as useDataSchema, d as isChatNode, di as AddConnectionCommand, fi as AddNodeCommand, fn as useWorkflowDocumentStore, gi as MoveNodeCommand, hn as useFocusPanelStore, kn as doRectsOverlap, li as CanvasNodeRenderType, r as useUIStore, ri as isValidNodeConnectionType, rt as useCredentialsStore, s as useWorkflowsStore, si as CanvasConnectionMode, ua as tryToParseNumber, ui as useHistoryStore, un as createWorkflowDocumentId, vi as RemoveNodeCommand, wn as DEFAULT_NODE_SIZE, xn as CONFIGURABLE_NODE_SIZE, xr as useExternalHooks, xs as useSettingsStore, y as getExecutionErrorToastConfiguration, yi as RenameNodeCommand, yr as useToast } from "./users.store-m21ecfQE.js";
import { $s as LOCAL_STORAGE_LOGS_PANEL_DETAILS_PANEL, Ai as require_cloneDeep, Ba as deepCopy, Gc as EnterpriseEditionFeature, Mn as MCP_TRIGGER_NODE_TYPE, Oc as CANVAS_ZOOMED_VIEW_EXPERIMENT, Pc as NDV_IN_FOCUS_PANEL_EXPERIMENT, Sr as WEBHOOK_NODE_TYPE, Va as isCommunityPackageName, ao as NodeConnectionTypes, br as UPDATE_WEBHOOK_ID_NODE_TYPES, ca as getNodeInputs, ec as LOCAL_STORAGE_LOGS_PANEL_DETAILS_PANEL_SUB_NODE, ha as getSubworkflowId, hn as FORM_TRIGGER_NODE_TYPE, ia as generateNodesGraph, la as getNodeOutputs, mr as STICKY_NODE_TYPE, nc as LOCAL_STORAGE_LOGS_SYNC_SELECTION, ns as VIEWS, sa as getConnectionTypes, tc as LOCAL_STORAGE_LOGS_PANEL_OPEN, ua as getNodeParameters, ya as isHitlToolType, zi as require__baseUniq } from "./constants-DyCBvby_.js";
import { j as defineStore, r as useRootStore } from "./_baseOrderBy-pei3qMdR.js";
import { t as useExecutionsStore } from "./executions.store-c6yugqYs.js";
import { t as usePinnedData } from "./usePinnedData-VT6ATACB.js";
import { a as mapLegacyConnectionToCanvasConnection, c as parseCanvasConnectionHandleString, i as mapCanvasConnectionToLegacyConnection, n as createCanvasConnectionHandleString, o as mapLegacyConnectionsToCanvasConnections } from "./canvas.utils-pgZ5Bbxb.js";
...
import { t as VueMarkdown_default } from "./VueMarkdown-CWbx6dSF.js";
