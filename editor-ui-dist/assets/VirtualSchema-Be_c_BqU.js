...
import { Ja as N8nButton_default, Ka as N8nCallout_default, Ya as N8nIcon_default, ct as N8nLink_default, gt as useRouter, qa as N8nText_default, zi as N8nTooltip_default } from "./src-BY3LHeey.js";
import { t as _plugin_vue_export_helper_default } from "./_plugin-vue_export-helper-Da88TEg1.js";
import { t as useMessage } from "./useMessage-BPZAmALB.js";
import { D as needsAgentInput, Lt as generateCodeForPrompt, Ut as useDataSchema, Wn as executionDataToJson, Wt as useFlattenSchema, _ as useWorkflowExecutionStateStore, _n as useEnvironmentsStore, b as injectWorkflowDocumentStore, k as useNodeHelpers, mn as injectNDVStore, q as useNodeTypesStore, t as useWorkflowsStore, x as useWorkflowDocumentStore } from "./workflows.store-DZfkxcrn.js";
import { t as useToast } from "./useToast-ioerWMiY.js";
import { Fi as MODAL_CONFIRM, Ft as CHAT_TRIGGER_NODE_TYPE, Ho as createResultError, Ic as AI_TRANSFORM_CODE_GENERATED_FOR_PROMPT, Lc as AI_TRANSFORM_JS_CODE, M as PLACEHOLDER_FILLED_AT_EXECUTION_TIME, Nc as ApplicationError, Sn as MANUAL_TRIGGER_NODE_TYPE, Ti as FROM_AI_PARAMETERS_MODAL_KEY, dc as NodeConnectionTypes, hi as BINARY_DATA_VIEW_MODAL_KEY, hr as WEBHOOK_NODE_TYPE, ku as EnterpriseEditionFeature, on as FORM_TRIGGER_NODE_TYPE, uc as DateTime, x as SCHEMA_PREVIEW_DOCS_URL } from "./constants-CLQJMg7Y.js";
...
import { v as isEmpty } from "./workflowsList.store-e1f-4AUE.js";
...
import { i as Vo, o as fu, r as estree_exports, t as NDVEmptyState_default } from "./NDVEmptyState-Ct3zJx-o.js";
import { t as usePinnedData } from "./usePinnedData-DoEQBg-1.js";
import { t as Draggable_default } from "./Draggable-DwXql0Iq.js";
import { t as NodeIcon_default } from "./NodeIcon-CMRS68Ft.js";
import { t as TextWithHighlights_default } from "./TextWithHighlights-9LFNGT5A.js";
import { t as useCalloutHelpers } from "./useCalloutHelpers-B5rVNABw.js";
import { n as MappingPill_default, t as useTelemetryContext } from "./useTelemetryContext-DWpXtTPk.js";
...
async function generateCodeForAiTransform(prompt, path, workflowDocumentId, activeNode, ndvPushRef, retries = 1) {
...
function useNodeExecution(node, options = {}) {
	...
	async function handleCodeGeneration() {
		...
		try {
			...
			const updateInformation = await generateCodeForAiTransform(prompt, `parameters.${AI_TRANSFORM_JS_CODE}`, workflowDocumentStore.value.documentId, ndvStore.value.activeNode, ndvStore.value.pushRef, 5);
