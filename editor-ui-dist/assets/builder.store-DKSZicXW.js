...
import { J as useDebounceFn, ot as useI18n, v as useLocalStorage } from "./core-C5b2s2m3.js";
import { Ct as useRoute, Gi as isWorkflowUpdatedMessage$1, Wi as isToolMessage$1, wt as useRouter } from "./src-BR3WX5fi.js";
import { u as require_lib } from "./get-BXEQ0kDX.js";
import { t as useMessage } from "./useMessage-B-SXT3B3.js";
import { t as useToast } from "./useToast-D9a-cCgr.js";
import { El as dedupe, Gi as NPS_SURVEY_MODAL_KEY, Hi as MODAL_CLOSE, Ou as getResourcePermissions, Rs as validateNodeSelectionForGrouping, Ui as MODAL_CONFIRM, Vi as MODAL_CANCEL, af as SIX_MONTHS_IN_MILLIS, cf as getDebounceTime, ef as DEBOUNCE_TIME, hi as VIEWS, if as SEVEN_DAYS_IN_MILLIS, kd as FOCUSED_NODES_EXPERIMENT, ma as LOCAL_STORAGE_BROWSER_NOTIFICATION_METADATA, of as THREE_DAYS_IN_MILLIS, t as AutoSaveState, wl as isExpression, yd as CODE_WORKFLOW_BUILDER_EXPERIMENT, zd as MERGE_ASK_BUILD_EXPERIMENT } from "./constants-CSBjw1Ht.js";
import { Ft as useRouteWorkflowId, It as useWorkflowId, Kt as useNDVStore, Pt as useWorkflowHelpers, Ti as isDebouncedFunction, Tn as useSourceControlStore, Yt as useWorkflowExecutionStateStore, _ as useNodeTypesStore, a as injectWorkflowDocumentStore, dn as useWorkflowsStore, ft as getAiSessions, gt as useAIAssistantHelpers, ht as truncateBuilderMessages, lt as chatWithBuilder, pt as getBuilderCredits, r as createWorkflowDocumentId, s as useWorkflowDocumentStore, ut as clearBuilderSession } from "./workflowDocument.store-xeTT7tms.js";
import { T as defineStore, h as assert, t as useRootStore } from "./useRootStore-hyBq4XlJ.js";
import { Vn as STORES, a as getWorkflowVersionsByIds, i as getWorkflowVersion, n as getPublishTimeline, o as updateWorkflowHistoryVersion, r as getWorkflowHistory, st as updateNpsSurveyState, t as useSettingsStore, tn as getFirstAdoptionDate } from "./settings.store-C5bX9q6f.js";
import { f as useUIStore, g as usePostHog, p as useTelemetry } from "./users.store-DWiPI9j5.js";
import { E as stringSizeInBytes, O as tryToParseNumber, a as getNewWorkflow, t as useWorkflowsListStore } from "./workflowsList.store-C_pATVnM.js";
...
import { a as BUILDER_ENABLED_VIEWS, r as useChatPanelStateStore, t as useCodeDiff } from "./useCodeDiff-CeBAFZij.js";
