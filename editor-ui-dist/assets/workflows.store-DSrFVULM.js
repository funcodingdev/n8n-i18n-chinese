...
import { $ as openBlock, A as createTextVNode, C as createBaseVNode, Cn as toDisplayString, D as createPropsRestProxy, Dt as getCurrentScope, E as createElementBlock, Et as effectScope, Ft as readonly, Gt as unref, Ht as toRefs$1, I as h, It as ref, K as onBeforeMount, Lt as shallowReactive, Mt as markRaw, N as defineComponent, Nt as onScopeDispose, P as getCurrentInstance, Pt as reactive, R as inject, S as computed, T as createCommentVNode, Tt as customRef, U as mergeProps, Ut as toValue$1, Vt as toRef, W as nextTick, X as onMounted, Z as onUnmounted, _ as Fragment, at as resolveComponent, bn as normalizeStyle, bt as withCtx, cn as isObject$1, en as hyphenate, ft as useSlots, gt as watch, i as createApp, it as renderSlot, j as createVNode, jt as isRef, lt as useAttrs, mn as isString$1, n as Transition$1, ot as resolveDirective, p as vShow, q as onBeforeUnmount, rt as renderList, st as resolveDynamicComponent, tn as init_shared_esm_bundler, tt as provide, vn as normalizeClass, w as createBlock, xt as withDirectives, y as Teleport, z as isMemoSame, zt as shallowRef } from "./vue.runtime.esm-bundler-CiTcVoZc.js";
import { i as i18n, n as addHeaders, r as addNodeTranslation, s as useI18n } from "./src-LyB2u_3c.js";
import { Dt as createEventBus, I as isBinary, Si as isClient$1, _n as useGlobalComponentSettings, fr as addClass, gr as removeClass, ht as useRoute, mr as getStyle, qi as truncate } from "./src-BY3LHeey.js";
import { a as require_toString, s as require_memoize, t as require_get, u as require_lib } from "./get-CKIAFyM1.js";
import { Ao as require_pick, As as displayParameterPath, Cc as sleep$1, Cl as getResourcePermissions, D as ALLOWED_HTML_ATTRIBUTES, Ds as getChildNodes, Dt as AI_MCP_TOOL_NODE_TYPE, F as DATA_TYPE_ICON_MAP, Fs as getNodeParametersIssues, G as AI_CATEGORY_HUMAN_IN_THE_LOOP, Go as require__createCompounder, Hl as CanvasRenderDataKey, Io as isAssignmentCollectionValue, Is as getNodeWebhookUrl, Jl as WorkflowDocumentStoreKey, Jo as require__baseIteratee, Js as mergeIssues, L as MAPPING_PARAMS, M as PLACEHOLDER_FILLED_AT_EXECUTION_TIME, Mc as ExpressionError, Mo as require__baseFlatten, Ms as getNodeInputs, Nc as ApplicationError, Nn as NON_ACTIVATABLE_TRIGGER_NODE_TYPES, Ns as getNodeOutputs, O as ALLOWED_HTML_TAGS, Ot as AI_TRANSFORM_NODE_TYPE, P as CUSTOM_API_CALL_KEY, Ps as getNodeParameters, Qt as ERROR_TRIGGER_NODE_TYPE$1, Ts as mapConnectionsByDestination, Uc as CHAT_TRIGGER_NODE_TYPE, Us as isHitlToolType, V as AI_CATEGORY_AGENTS, Vo as Workflow, Vt as CREDENTIAL_ONLY_NODE_PREFIX, Xn as SCHEDULE_TRIGGER_NODE_TYPE, Y as AI_CATEGORY_OTHER_TOOLS, Zs as nodeIssuesToString, _t as RECOMMENDED_NODES, as as splitExpression, bn as LIST_LIKE_NODE_OPERATIONS, bs as createRunExecutionData, cc as isResourceLocatorValue, ci as MAIN_HEADER_TABS, ct as BETA_NODES, dc as NodeConnectionTypes, dl as require_keys, ds as isTrimmedNodeExecutionData, el as MANUAL_TRIGGER_NODE_TYPE, fc as nodeConnectionTypes, gc as deepCopy, gr as WIKIPEDIA_TOOL_NODE_TYPE, hr as WEBHOOK_NODE_TYPE$1, i as DUPLICATE_POSTFFIX, j as IN_PROGRESS_EXECUTION_ID, jn as NODE_POSITION_CONFLICT_ALLOWLIST, js as getConnectionTypes, kn as MODULE_ENABLED_NODES, ks as displayParameter, ku as EnterpriseEditionFeature, lc as isResourceMapperValue$1, li as VIEWS, ll as require_isEqual, ls as require__baseFindIndex, lt as CORE_NODES_CATEGORY, nc as isFilterValue, ns as traverseNodeParameters, nt as AI_CODE_TOOL_LANGCHAIN_NODE_TYPE, on as FORM_TRIGGER_NODE_TYPE$1, os as require__baseUniq, pc as isExpression, pt as HUMAN_IN_THE_LOOP_CATEGORY, q as AI_CATEGORY_MCP_NODES, qs as makeNodeName, r as DEFAULT_SETTINGS, rl as SEND_AND_WAIT_OPERATION, sl as v4, tl as MANUAL_TRIGGER_NODE_TYPES, tt as AI_CATEGORY_VECTOR_STORES, un as HTTP_REQUEST_NODE_TYPE, w as TEMPLATES_NODES_FILTER, yr as WORKFLOW_TRIGGER_NODE_TYPE, ys as createEmptyRunExecutionData } from "./constants-CLQJMg7Y.js";
import { b as require_isArrayLike, n as require__isIterateeCall, r as require__baseRest, t as require_merge } from "./merge-Bzll_Q9n.js";
import { E as getActivePinia, T as defineStore, a as ResponseError, c as makeRestApiRequest, d as request, f as streamRequest, m as axios, s as getFullApiResponse, t as useRootStore } from "./useRootStore-BXKn7r8-.js";
import { C as updateCurrentUserSettings, Pt as getProjectSecretProviderConnectionsByProjectId, Rn as STORES, ct as fetchCommunityNodeTypes, dt as getNodeParameterOptions, ft as getNodeTranslationHeaders, gt as getResourceMapperFields, ht as getResourceLocatorResults, i as getWorkflowVersion, lt as getLocalResourceMapperFields, mt as getNodesInformation, pt as getNodeTypes$1, s as findWebhook, st as fetchCommunityNodeAttributes, t as useSettingsStore, ut as getNodeParameterActionResult } from "./settings.store-HAN34Lkc.js";
import { _ as useLocalStorage, k as createEventHook } from "./core-CZJuH52F.js";
import { _ as useStorage, f as useUIStore, n as hasPermission, p as useTelemetry, t as useUsersStore, u as hasRole } from "./users.store-AINJEAwY.js";
import { r as require_toNumber } from "./useDebounce-CbVjNudT.js";
import { C as omit, O as getObjectSizeInKB, T as stringSizeInBytes, a as getNewWorkflow, b as isJsonKeyObject, i as getLastSuccessfulExecution, k as isObject$2, l as getWorkflows, n as useFavoritesStore, r as getExecutionData, t as useWorkflowsListStore, v as isEmpty, w as shorten, x as isPresent } from "./workflowsList.store-e1f-4AUE.js";
import { t as require__baseOrderBy } from "./_baseOrderBy-16n3_jad.js";
...
//#endregion
export { updateEvaluationConfig as $, ElLoading as $i, getNodeAuthFields as $n, _sfc_main$d as $r, isTestableExpression as $t, useDynamicCredentials as A, isSharedResource as Ai, deleteDataTableApi as An, CONFIGURATION_NODE_SIZE as Ar, require_upperFirst as At, MoveNodeCommand as B, CANVAS_NODE_GROUP_ID_PREFIX as Bi, renameDataTableColumnApi as Bn, getMousePosition as Br, replaceCode as Bt, doesNodeHaveAllCredentialsFilled as C, isDateObject as Ci, useProjectsStore as Cn, mapCanvasConnectionToLegacyConnection as Cr, isFullTemplatesCollection as Ct, needsAgentInput as D, isResourceMapperValue as Di, setWorkflowSharedWith as Dn, shouldIgnoreCanvasShortcut as Dr, capitalCase as Dt, getParameterDisplayableOptions as E, isProjectRole as Ei, moveFolderToProject as En, parseCanvasConnectionHandleString as Er, require_sortBy as Et, AddConnectionCommand as F, isVariableResource as Fi, fetchDataTablesApi as Fn, doRectsOverlap as Fr, chatWithBuilder as Ft, historyBus as G, isCanvasGroupNode as Gi, fieldCannotBeDeleted as Gn, updateViewportToContainNodes as Gr, escapeMappingString as Gt, RemoveNodeCommand as H, CanvasConnectionMode as Hi, updateDataTableRowsApi as Hn, getNodeViewTab as Hr, useAIAssistantHelpers as Ht, AddNodeCommand as I, isVueFlowConnection as Ii, getDataTableRowsApi as In, generateOffsets as Ir, clearBuilderSession as It, useActionsGenerator as J, getScrollbarWidth as Ji, getAllNodeCredentialForAuthType as Jn, PanelPosition as Jr, propertyNameFromExpression as Jt, require_uniq as K, capitalizeFirstLetter as Ki, filterTemplateNodes as Kn, MarkerType as Kr, getMappedExpression as Kt, BulkCommand as L, isWorkflowListItem as Li, importCsvToDataTableApi as Ln, getBounds as Lr, generateCodeForPrompt as Lt, useCanvasStore as M, isTriggerPanelObject as Mi, deleteDataTableRowsApi as Mn, DEFAULT_VIEWPORT_BOUNDARIES as Mr, listenForCredentialChanges as Mt, useLoadingService as N, isValidCredentialResponse as Ni, downloadDataTableCsvApi as Nn, PUSH_NODES_OFFSET as Nr, useCredentialsStore as Nt, serializeNode as O, isResourceSortableByDate as Oi, addDataTableColumnApi as On, injectStrict as Or, sublimeSearch as Ot, useHistoryStore as P, isValidNodeConnectionType as Pi, fetchDataTableGlobalLimitInBytes as Pn, calculateNodeSize as Pr, chatWithAssistant as Pt, listEvaluationConfigs as Q, sanitizeIfString as Qi, getMainAuthField as Qn, _sfc_main$3 as Qr, isPairedItemIntermediateNodesError as Qt, Command as R, CANVAS_NODE_GROUP_HANDLE_LEFT as Ri, insertDataTableRowApi as Rn, getGenericHints as Rr, getAiSessions as Rt, TOOL_NODE_TYPES_NEED_INPUT as S, isCredentialsResource as Si, useRemoteProjectSearch as Sn, insertSpacersBetweenEndpoints as Sr, isTutorialTemplateId as St, getNodeTypeDisplayableCredentials as T, isFullExecutionResponse as Ti, ProjectTypes as Tn, mapLegacyConnectionsToCanvasConnections as Tr, useAiGatewayStore as Tt, RenameNodeCommand as U, CanvasNodeDirtiness as Ui, uploadCsvFileApi as Un, getNodesGroupSize as Ur, useDataSchema as Ut, RemoveConnectionCommand as V, CANVAS_NODE_GROUP_TYPE as Vi, updateDataTableApi as Vn, getNewNodePosition as Vr, truncateBuilderMessages as Vt, ReplaceNodeParametersCommand as W, CanvasNodeRenderType as Wi, executionDataToJson as Wn, getNodesWithNormalizedPosition as Wr, useFlattenSchema as Wt, createEvaluationConfig as X, isOutsideSelected as Xi, getAppNameFromNodeName as Xn, _sfc_main as Xr, getExpressionErrorMessage as Xt, useEvaluationStore as Y, isEventTargetContainedBy as Yi, getAppNameFromCredType as Yn, Position as Yr, completeExpressionSyntax as Yt, deleteEvaluationConfig as Z, sanitizeHtml as Zi, getAuthTypeForNodeCredential as Zn, _sfc_main$1 as Zr, getResolvableState as Zt, useWorkflowExecutionStateStore as _, checkExhaustive as _i, useEnvironmentsStore as _n, checkOverlap as _r, transformNodeType as _t, executionFilterToQueryFilter as a, getRectOfNodes as ai, resolveRequiredParameters as an, hasOnlyListMode as ar, getRootSearchCallouts as at, injectWorkflowDocumentStore as b, isComponentPublicInstance as bi, splitName as bn, getMaxNodePortsLabelSize as br, getSampleWorkflowByTemplateId as bt, getDefaultExecutionFilters as c, useGetPointerPosition as ci, useTagsStore as cn, isMatchingField as cr, isNodePreviewKey as ct, hasTrimmedRunData as d, getPinDataSize as di, sanitizeConnections as dn, isValueExpression as dr, prepareCommunityNodeDetailsViewStack as dt, _sfc_main$f as ei, removeExpressionPrefix as en, getNodeAuthOptions as er, filterAndSearchNodes as et, openFormPopupWindow as f, pinDataToExecutionData as fi, sortNodesByExecutionOrder as fn, parseResourceMapperFieldName as fr, removePreviewToken as ft, disposeWorkflowExecutionStateStore as g, getPairedItemId as gi, LOCAL_STORAGE_NDV_PANEL_WIDTH as gn, isCredentialOnlyNodeType as gr, subcategorizeItems as gt, parse as h, CHANGE_ACTION as hi, useNDVStore as hn, require_toInteger as hr, sortNodeCreateElements as ht, displayForm as i, getConnectedEdges as ii, resolveParameter as in, hasExpressionMapping as ir, getHumanInTheLoopActions as it, useEnvFeatureFlag as j, isString as ji, deleteDataTableColumnApi as jn, DEFAULT_NODE_SIZE as jr, require__baseSlice as jt, useNodeHelpers as k, isRouteLocationRaw as ki, createDataTableApi as kn, CONFIGURABLE_NODE_SIZE as kr, require_startCase as kt, getExecutionErrorMessage as l, useVueFlow as li, ensureNodePosition as ln, isRequiredCredential as lr, mapToolSubcategoryIcon as lt, waitingNodeTooltip as m, useExecutionDataStore as mi, injectNDVStore as mn, getAllCredentials as mr, shouldShowCommunityNodeDetails as mt, buildExecutionResponseFromSchema as n, getBezierPath as ni, stringifyExpressionResult as nn, getThemedValue as nr, flattenCreateElements as nt, executionRetryMessage as o, getSmoothStepPath as oi, useWorkflowHelpers as on, hasProxyAuth as or, groupItemsInSections as ot, unflattenExecutionData as p, createExecutionDataId as pi, disposeNDVStore as pn, updateNodeAuthType as pr, searchNodes as pt, useNodeTypesStore as q, getBannerRowHeight as qi, getActivatableTriggerNodes as qn, NodeId as qr, getMappedResult as qt, clearPopupWindowState as r, getBoundsofRects as ri, unwrapExpression as rn, getTriggerNodeServiceName as rr, getAiTemplatesCallout as rt, findTriggerNodeToAutoSelect as s, isMacOs as si, useAnnotationTagsStore as sn, isAuthRelatedParameter as sr, isAINode as st, useWorkflowsStore as t, clamp as ti, shouldConvertToExpression as tn, getNodeCredentialForSelectedAuthType as tr, finalizeItems as tt, getExecutionErrorToastConfiguration as u, wheelDelta as ui, removeWorkflowExecutionData as un, isResourceMapperFieldListStale as ur, nodeTypesToCreateElements as ut, createWorkflowDocumentId as v, isBaseTextKey as vi, ResourceType as vn, computeNodeDisplaySize as vr, SampleTemplates as vt, doesNodeHaveCredentialsToFill as w, isDebouncedFunction as wi, useSourceControlStore as wn, mapLegacyConnectionToCanvasConnection as wr, isTemplatesWorkflow as wt, useWorkflowDocumentStore as x, isCredentialModalState as xi, useAvailableProjectSearch as xn, injectCanvasRenderData as xr, getTutorialTemplates as xt, disposeWorkflowDocumentStore as y, isBinaryLike as yi, getTruncatedProjectName as yn, createCanvasConnectionHandleString as yr, getRagStarterWorkflowJson as yt, EnableNodeToggleCommand as z, CANVAS_NODE_GROUP_HANDLE_RIGHT as zi, moveDataTableColumnApi as zn, getMidCanvasPosition as zr, getBuilderCredits as zt };
