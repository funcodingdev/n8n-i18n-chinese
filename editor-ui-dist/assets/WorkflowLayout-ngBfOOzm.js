...
import { $t as hasOwn, C as computed, Cn as toDisplayString, D as createElementBlock, E as createCommentVNode, G as nextTick, Gt as unref, It as ref, J as onBeforeUnmount, L as h, M as createVNode, P as defineComponent, T as createBlock, Z as onMounted, _ as Fragment, _t as watch, at as renderSlot, bn as normalizeStyle, bt as withCtx, c as useCssModule, ct as resolveDynamicComponent, en as hyphenate, et as openBlock, it as renderList, j as createTextVNode, k as createSlots, mt as useTemplateRef, nt as provide, ot as resolveComponent, p as vShow, q as onBeforeMount, tn as init_shared_esm_bundler, v as KeepAlive, vn as normalizeClass, w as createBaseVNode, xt as withDirectives, z as inject } from "./vue.runtime.esm-bundler-XtMkEjzB.js";
import { M as useLocalStorage, w as useDocumentVisibility, yt as useI18n } from "./_MapCache-B254lxCP.js";
import { At as N8nActionDropdown_default, Di as useRouter, Ei as useRoute, Fi as N8nIconButton_default, Gi as N8nButton_default, I as SuggestedActions_default, Ii as AskAssistantButton_default, Ki as N8nIcon_default, L as N8nTag_default, Nt as N8nBadge_default, U as N8nRadioButtons_default, Yi as __vitePreload, bi as RouterLink, bt as createEventBus, h as N8nInlineTextEdit_default, hi as AskAssistantAvatar_default, j as N8nUserStack_default, ji as N8nTooltip_default } from "./src-i9Rem1HJ.js";
import { t as __plugin_vue_export_helper_default } from "./_plugin-vue_export-helper-DltO58Gh.js";
import "./sanitize-html-JHjOJhXQ.js";
import { Bt as injectWorkflowState, Dr as useStyles, E as useEvaluationStore, Er as useToast, Et as useWorkflowHelpers, Fr as require_FileSaver_min, Gr as useWorkflowsListStore, Gt as ProjectTypes, It as useTelemetry, Kr as createWorkflowDocumentId, Mr as useMessage, Pr as useWorkflowHistoryStore, Ri as ResourceType, Rt as telemetry, Sn as useWorkflowSaveStore, Vt as useWorkflowState, Wi as getActivatableTriggerNodes, Wt as useProjectsStore, Yr as useWorkflowDocumentStore, _r as hasPermission, bn as useWorkflowSaving, fn as nodeViewEventBus, jr as useSourceControlStore, js as useSettingsStore, kt as useTagsStore, ln as useBuilderStore, r as useUIStore, s as useWorkflowsStore, sl as getBannerRowHeight, t as useUsersStore, w as useNodeTypesStore, yn as useDocumentTitle, za as PROJECT_MOVE_RESOURCE_MODAL, zt as useNDVStore } from "./users.store-pjk3GVP4.js";
import "./MainSidebarHeader-Bj_OjvUr.js";
import { t as BaseLayout_default } from "./BaseLayout-DRnUeQfL.js";
import { Cs as IMPORT_WORKFLOW_URL_MODAL_KEY, Js as WORKFLOW_SETTINGS_MODAL_KEY, Ks as WORKFLOW_HISTORY_VERSION_UNPUBLISH, Mc as WorkflowIdKey, Nc as WorkflowStateKey, Os as MODAL_CONFIRM, Qo as getResourcePermissions, Rs as WORKFLOW_ACTIVE_MODAL_KEY, T as TIME_SAVED_DOCS_URL, Us as WORKFLOW_HISTORY_NAME_VERSION_MODAL_KEY, Ys as WORKFLOW_SHARE_MODAL_KEY, _ as EVALUATIONS_DOCS_URL, _s as DUPLICATE_MODAL_KEY, al as EnterpriseEditionFeature, cs as VIEWS, g as ERROR_WORKFLOW_DOCS_URL, gr as STICKY_NODE_TYPE, jc as WorkflowDocumentStoreKey, jl as WORKFLOW_MENU_ACTIONS, o as MAX_WORKFLOW_NAME_LENGTH, oc as LOCAL_STORAGE_HIDE_GITHUB_STAR_BUTTON, qs as WORKFLOW_PUBLISH_MODAL_KEY, ss as MAIN_HEADER_TABS, t as AutoSaveState, ul as LOADING_ANIMATION_MIN_DURATION, xr as TIME_SAVED_NODE_TYPE, y as N8N_MAIN_GITHUB_REPO_URL, zs as WORKFLOW_DESCRIPTION_MODAL_KEY } from "./constants-NfpEUugO.js";
...
import { t as useExecutionsStore } from "./executions.store-D__r2Ug5.js";
...
import "./roles.store-BJZHBf92.js";
...
import { t as sanitizeFilename } from "./dist-DoIeVinR.js";
import "./sso.store-CG3awDbz.js";
import { t as router_default } from "./router-BBesFexu.js";
import "./insights.store-B7h3Qky-.js";
import "./insights.constants-BxVIUaI3.js";
import "./insights.utils-DnocAZWw.js";
import { a as MCP_DOCS_PAGE_URL, s as MCP_SETTINGS_VIEW } from "./mcp.constants-C5s8ZF_P.js";
import "./sourceControl.eventBus-BaCT9vRl.js";
import { a as getLastPublishedVersion, r as generateVersionNameFromId } from "./utils-ByDUxpmI.js";
...
import { t as LoadingView_default } from "./LoadingView-BCx6F1Sp.js";
...
import { t as ConnectionTracker_default } from "./ConnectionTracker-JWL9uYCE.js";
import { t as useWorkflowSettingsCache } from "./useWorkflowsCache-CJwuWAWf.js";
import { t as usePushConnection } from "./usePushConnection-DkPkZSP6.js";
...
var WorkflowProductionChecklist_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		...
		const availableActions = computed(() => {
			...
			if (hasPublishedVersion && !suggestedActionSettings.errorWorkflow?.ignored) actions.push({
				id: "errorWorkflow",
...
var WorkflowDetails_default = /* @__PURE__ */ __plugin_vue_export_helper_default(WorkflowDetails_vue_vue_type_script_setup_true_lang_default, [["__cssModules", { "$style": WorkflowDetails_vue_vue_type_style_index_1_lang_module_default }], ["__scopeId", "data-v-9b65eb3a"]]);
