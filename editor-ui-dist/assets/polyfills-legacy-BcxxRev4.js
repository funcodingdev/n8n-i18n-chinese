(function() {
	...
	var IteratorProxy$2 = createIteratorProxy$2(function() {
		...
		while (true) {
			result = anObject$14(call$16(next$1, iterator));
	...
	$$27({
		...
		if (filterWithoutClosingOnEarlyError) return call$16(filterWithoutClosingOnEarlyError, this, predicate);
		return new IteratorProxy$2(getIteratorDirect$10(this), { predicate });
	} });
	...
	var require_function_uncurry_this_accessor = /* @__PURE__ */ __commonJSMin(((exports, module) => {
		...
		module.exports = function(object, key$1, method) {
			try {
				return uncurryThis$16(aCallable$5(Object.getOwnPropertyDescriptor(object, key$1)[method]));
			} catch (error) {}
		};
	}));
	...
	var require_array_buffer_transfer = /* @__PURE__ */ __commonJSMin(((exports, module) => {
		...
		var slice$2 = uncurryThis$15(ArrayBufferPrototype.slice);
		...
		var getInt8 = uncurryThis$15(DataViewPrototype.getInt8);
		var setInt8 = uncurryThis$15(DataViewPrototype.setInt8);
	...
	$$21({
		...
		var result = [];
		iterate$5(getIteratorDirect$6(anObject$8(this)), push$3, {
			that: result,
			IS_RECORD: true
		});
		return result;
	...
	var push$2 = uncurryThis$11([].push);
	var IS_DIGIT = /^\d$/;
	...
	(/* @__PURE__ */ __commonJSMin((() => {
		...
		if (globalThis$15.Uint8Array) $$11({
			target: "Uint8Array",
			proto: true
	...
	if (PolyfilledDOMExceptionPrototype.constructor !== PolyfilledDOMException) {
		if (!IS_PURE$5) defineProperty$3(PolyfilledDOMExceptionPrototype, "constructor", createPropertyDescriptor$2(1, PolyfilledDOMException));
