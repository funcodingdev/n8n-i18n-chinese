import { $ as openBlock, A as createTextVNode, C as createBaseVNode, Cn as toDisplayString, E as createElementBlock, Gt as unref, It as ref, N as defineComponent, S as computed, T as createCommentVNode, U as mergeProps, X as onMounted, _ as Fragment, bt as withCtx, c as useCssModule, gt as watch, j as createVNode, lt as useAttrs, rt as renderList, vn as normalizeClass, w as createBlock } from "./vue.runtime.esm-bundler-CiTcVoZc.js";
import { s as useI18n } from "./src-LyB2u_3c.js";
import { Ga as N8nHeading_default, Ja as N8nButton_default, Ot as N8nCollapsiblePanel_default, Ui as Input_default, Wi as N8nIconButton_default, Ya as N8nIcon_default, qa as N8nText_default, zi as N8nTooltip_default } from "./src-BY3LHeey.js";
import { t as _plugin_vue_export_helper_default } from "./_plugin-vue_export-helper-Da88TEg1.js";
import { k as useNodeHelpers, q as useNodeTypesStore } from "./workflows.store-DSrFVULM.js";
import { t as useToast } from "./useToast-7r31sqLC.js";
import { $r as AGENT_TOOL_CONFIG_MODAL_KEY, Qa as AGENT_BUILDER_HIDDEN_AVAILABLE_TOOL_NODE_TYPES, Za as AGENT_BUILDER_AVAILABLE_AI_UTILITY_TOOL_NODE_TYPES, at as AI_SECTION_RECOMMENDED_TOOLS, dc as NodeConnectionTypes, eo as INCOMPATIBLE_WORKFLOW_TOOL_BODY_NODE_TYPES, ju as DEBOUNCE_TIME, sl as v4, to as SUPPORTED_WORKFLOW_TOOL_TRIGGERS, zc as AI_VENDOR_NODE_TYPES, zu as getDebounceTime } from "./constants-CLQJMg7Y.js";
...
import { s as getWorkflow, t as useWorkflowsListStore } from "./workflowsList.store-e1f-4AUE.js";
...
import { a as getExistingToolNames, i as nodeTypeToNewMcpServer, n as mcpServerToNode, o as nodeTypeToNewToolRef, s as toolRefToNode, t as isMcpRelatedNodeType, u as workflowToNewToolRef } from "./useMcpServerAdapter-E8w8BFxn.js";
	...
	setup(__props) {
		...
		*/
		const availableToolTypes = computed(() => {
			return [...new Set([...nodeTypesStore.visibleNodeTypesByOutputConnectionTypeNames[NodeConnectionTypes.AiTool] ?? [], ...AI_VENDOR_NODE_TYPES])].map((name) => nodeTypesStore.getNodeType(name)).filter((nt) => nt !== null && !nt.hidden && !isHiddenAvailableToolType(nt) && (isAgentProviderNodeType(nt) || !hasInputs(nt))).sort((a, b) => {
		...
		*/
		...
		const filteredAvailableExternalTools = computed(() => filterAvailableToolTypes(availableExternalToolTypes.value));
			...
			return openBlock(), createBlock(Modal_default, {
				...
				content: withCtx(() => [createVNode(unref(Input_default), {
					...
					filteredAvailableWorkflows.value.length > 0 ? (openBlock(), createElementBlock("div", {
						...
						"onUpdate:modelValue": _cache[2] || (_cache[2] = ($event) => isAvailableWorkflowsSectionExpanded.value = $event),
						class: normalizeClass(_ctx.$style.sectionPanel),
						"disable-animation": true
					}, {
						title: withCtx(() => [createVNode(unref(N8nHeading_default), {
					...
					filteredAvailableAiTools.value.length > 0 ? (openBlock(), createElementBlock("div", {
						key: 2,
						class: normalizeClass(_ctx.$style.section)
					}, [createVNode(unref(N8nCollapsiblePanel_default), {
						...
						title: withCtx(() => [createVNode(unref(N8nHeading_default), {
							...
							default: withCtx(() => [createTextVNode(toDisplayString(unref(i18n).baseText("agents.tools.availableAiTools", { interpolate: { count: filteredAvailableAiTools.value.length } })), 1)]),
							_: 1
						})]),
						default: withCtx(() => [createBaseVNode("div", {
							class: normalizeClass(_ctx.$style.toolsList),
							"data-test-id": "agent-tools-available-ai-list"
						}, [(openBlock(true), createElementBlock(Fragment, null, renderList(filteredAvailableAiTools.value, (nodeType) => {
							return openBlock(), createBlock(AgentToolItem_default, {
								key: nodeType.name,
								"node-type": nodeType,
								mode: "available",
					...
					filteredAvailableN8nTools.value.length > 0 ? (openBlock(), createElementBlock("div", {
						key: 3,
						class: normalizeClass(_ctx.$style.section)
					}, [createVNode(unref(N8nCollapsiblePanel_default), {
						...
						title: withCtx(() => [createVNode(unref(N8nHeading_default), {
							...
							default: withCtx(() => [createTextVNode(toDisplayString(unref(i18n).baseText("agents.tools.availableN8nTools", { interpolate: { count: filteredAvailableN8nTools.value.length } })), 1)]),
							_: 1
						})]),
						default: withCtx(() => [createBaseVNode("div", {
							class: normalizeClass(_ctx.$style.toolsList),
							"data-test-id": "agent-tools-available-n8n-list"
						}, [(openBlock(true), createElementBlock(Fragment, null, renderList(filteredAvailableN8nTools.value, (nodeType) => {
							return openBlock(), createBlock(AgentToolItem_default, {
								key: nodeType.name,
								"node-type": nodeType,
								mode: "available",
					...
					filteredAvailableExternalTools.value.length > 0 ? (openBlock(), createElementBlock("div", {
						key: 4,
						class: normalizeClass(_ctx.$style.section)
					}, [createVNode(unref(N8nCollapsiblePanel_default), {
						...
						title: withCtx(() => [createVNode(unref(N8nHeading_default), {
							...
							default: withCtx(() => [createTextVNode(toDisplayString(unref(i18n).baseText("agents.tools.availableExternalTools", { interpolate: { count: filteredAvailableExternalTools.value.length } })), 1)]),
							_: 1
						})]),
						default: withCtx(() => [createBaseVNode("div", {
							class: normalizeClass(_ctx.$style.toolsList),
							"data-test-id": "agent-tools-available-external-list"
						}, [(openBlock(true), createElementBlock(Fragment, null, renderList(filteredAvailableExternalTools.value, (nodeType) => {
							return openBlock(), createBlock(AgentToolItem_default, {
								key: nodeType.name,
								"node-type": nodeType,
								mode: "available",
					...
					filteredConfiguredMcpServers.value.length === 0 && filteredConfiguredTools.value.length === 0 && filteredConfiguredWorkflows.value.length === 0 && filteredAvailableWorkflows.value.length === 0 && filteredAvailableAiTools.value.length === 0 && filteredAvailableN8nTools.value.length === 0 && filteredAvailableExternalTools.value.length === 0 ? (openBlock(), createElementBlock("div", {
						key: 5,
