...
import { Bo as v4_default, t as useTelemetry } from "./useTelemetry-D9a28yOh.js";
import { t as useToast } from "./useToast-DXe0x66s.js";
import { Da as deepCopy, ni as chatHubProviderSchema, ri as emptyChatModelsResponse } from "./constants-BAGpYMn9.js";
import { k as defineStore, p as streamRequest, r as useRootStore, u as makeRestApiRequest } from "./_baseOrderBy-CoMldQdS.js";
import { t as retry } from "./retry-CalJieID.js";
import { c as CHAT_STORE, l as CHAT_VIEW } from "./constants-D2fYduVh.js";
...
const useChatStore = defineStore(CHAT_STORE, () => {
	...
	async function updateSessionModel(sessionId, model, agentName) {
		await updateConversationApi(rootStore.restApiContext, sessionId, { agent: {
			model,
			name: agentName
		} });
...
export { fromStringToModel as a, isLlmProvider as c, stringifyModel as d, unflattenModel as f, flattenModel as i, isLlmProviderModel as l, fetchChatModelsApi as m, filterAndSortAgents as n, getAgentRoute as o, buildChatAttachmentUrl as p, findOneFromModelsResponse as r, groupConversationsByDate as s, useChatStore as t, isMatchedAgent as u };
