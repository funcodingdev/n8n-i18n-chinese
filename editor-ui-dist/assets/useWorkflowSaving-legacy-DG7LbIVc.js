;
(function () {
  System.register(["./_MapCache-legacy-CECtqMZe.js", "./useMessage-legacy-ChiUxBc8.js", "./useTelemetry-legacy-CA9g7cV_.js", "./useToast-legacy-fud3e81V.js", "./constants-legacy-B_3qSw5J.js", "./useExternalHooks-legacy-CqVTyuDp.js", "./npsSurvey.store-legacy-C4BCSgUH.js", "./templates.store-legacy-pG2l2pIW.js", "./focusPanel.store-legacy-BIkGQRYF.js"], function (_export, _context) {
    "use strict";

    var useI18n, useMessage, useSourceControlStore, useUIStore, useCanvasStore, injectWorkflowState, tryToParseNumber, useNodeTypesStore, useWorkflowHelpers, useWorkflowsStore, useTelemetry, useNodeHelpers, useToast, NON_ACTIVATABLE_TRIGGER_NODE_TYPES, VIEWS, getResourcePermissions, IS_DRAFT_PUBLISH_ENABLED, PLACEHOLDER_EMPTY_WORKFLOW_ID, MODAL_CANCEL, MODAL_CONFIRM, MODAL_CLOSE, useExternalHooks, useNpsSurveyStore, useTemplatesStore, useFocusPanelStore;
    ...
    return {
      setters: [function (_MapCacheLegacy005Js) {
        ...
        MODAL_CANCEL = _constantsLegacy00TJs.es;
        MODAL_CONFIRM = _constantsLegacy00TJs.ns;
        MODAL_CLOSE = _constantsLegacy00TJs.ts;
