...
import { bt as I18nT, yt as useI18n } from "./_MapCache-CWW28IIa.js";
import { Bi as N8nText_default, Di as N8nTooltip_default, Hi as N8nIcon_default, Ni as N8nActionBox_default, Ri as N8nHeading_default, Tt as N8nLoading_default, Vi as N8nButton_default, hi as N8nLink_default, kt as N8nBadge_default, wt as N8nActionToggle_default, yt as N8nCard_default } from "./src-KhoUjpIZ.js";
import { t as __plugin_vue_export_helper_default } from "./_plugin-vue_export-helper-DltO58Gh.js";
import "./sanitize-html-JHjOJhXQ.js";
import { Bi as splitName, Wt as useProjectsStore, br as useToast, gc as reloadSecretProviderConnection, js as useSettingsStore, pn as useDocumentTitle, r as useUIStore, si as isDateObject, vr as useRBACStore } from "./users.store-_5IHF4E9.js";
import { Os as SECRETS_PROVIDER_CONNECTION_MODAL_KEY, fs as DELETE_SECRETS_PROVIDER_MODAL_KEY, so as DateTime } from "./constants-BvvNYkkp.js";
...
import { n as isIconOrEmoji, t as ProjectIcon_default } from "./ProjectIcon-CxZChFHd.js";
...
var SecretsProviderConnectionCard_ee_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props, { emit: __emit }) {
		...
		const actionDropdownOptions = computed(() => {
			...
			if (provider.value.state === "connected") options.push({
...
var SettingsSecretsProviders_ee_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		...
		async function handleReload(providerKey) {
			try {
				if (!(await reloadSecretProviderConnection(rootStore.restApiContext, providerKey)).success) {
