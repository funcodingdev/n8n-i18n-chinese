(function() {
	...
	var require_get_iterator_flattenable = /* @__PURE__ */ __commonJSMin(((exports, module) => {
		...
		module.exports = function(obj, stringHandling) {
			...
			return getIteratorDirect$5(anObject$7(method !== void 0 ? call$8(method, obj) : obj));
		};
	}));
	...
	var IteratorProxy$1 = createIteratorProxy$1(function() {
		...
		while (true) {
			if (inner = this.inner) try {
				result = anObject$6(call$7(inner.next, inner.iterator));
				if (!result.done) return result.value;
				this.inner = null;
			} catch (error) {
				iteratorClose$3(iterator, "throw", error);
			}
			result = anObject$6(call$7(this.next, iterator));
	...
	var require_function_apply = /* @__PURE__ */ __commonJSMin(((exports, module) => {
		...
		module.exports = typeof Reflect == "object" && Reflect.apply || (NATIVE_BIND ? call$6.bind(apply$3) : function() {
	...
	var require_parse_json_string = /* @__PURE__ */ __commonJSMin(((exports, module) => {
		...
		var slice$2 = uncurryThis$13("".slice);
	...
	var append = uncurryThis$11(URLSearchParamsPrototype$1.append);
	var $delete = uncurryThis$11(URLSearchParamsPrototype$1["delete"]);
	var forEach = uncurryThis$11(URLSearchParamsPrototype$1.forEach);
	...
	var getAll = uncurryThis$10(URLSearchParamsPrototype.getAll);
	var $has = uncurryThis$10(URLSearchParamsPrototype.has);
