const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/workers-Dr9EnZmI.js","assets/comlink-h1hawfcO.js"])))=>i.map(i=>d[i]);
import { o as __toESM, t as __commonJSMin } from "./chunk-CC9Q-vWm.js";
import { $ as openBlock, A as createTextVNode, C as createBaseVNode, Cn as toDisplayString, D as createPropsRestProxy, Dt as getCurrentScope, E as createElementBlock, Et as effectScope, Ft as readonly, Gt as unref, Ht as toRefs$1, I as h, It as ref, K as onBeforeMount, L as hasInjectionContext, Lt as shallowReactive, Mt as markRaw, N as defineComponent, Nt as onScopeDispose, P as getCurrentInstance, Pt as reactive, R as inject, S as computed, T as createCommentVNode, Tt as customRef, U as mergeProps, Ut as toValue$1, Vt as toRef, W as nextTick, X as onMounted, Z as onUnmounted, _ as Fragment, _t as watchEffect, at as resolveComponent, bn as normalizeStyle, bt as withCtx, ft as useSlots, gt as watch, it as renderSlot, j as createVNode, jt as isRef, lt as useAttrs, ot as resolveDirective, q as onBeforeUnmount, rt as renderList, st as resolveDynamicComponent, tt as provide, vn as normalizeClass, w as createBlock, xt as withDirectives, y as Teleport, z as isMemoSame, zt as shallowRef } from "./vue.runtime.esm-bundler-CDDUUZhE.js";
import { i as i18n, n as addHeaders, r as addNodeTranslation, s as useI18n } from "./src-Dh32dOY5.js";
import { I as isBinary, gt as useRoute, qi as truncate } from "./src-BVC_ZvSs.js";
import { a as require_toString, d as __vitePreload, s as require_memoize, t as require_get, u as require_lib } from "./get-D159b5Ls.js";
import { A as createEventHook, Q as watchThrottled, v as useLocalStorage } from "./core-DOUvgShw.js";
import { $o as isAssignmentCollectionValue, A as ALLOWED_HTML_TAGS, Ac as isExpression, Al as require_keys, At as AI_TRANSFORM_NODE_TYPE, Bc as sleep$1, Bs as mapConnectionsByDestination, Cc as isResourceLocatorValue, Dc as nodeConnectionTypes, E as TEMPLATES_NODES_FILTER, Ec as NodeConnectionTypes, El as v4, Es as isTrimmedNodeExecutionData, Fn as NON_ACTIVATABLE_TRIGGER_NODE_TYPES, Fs as createRunExecutionData, Gs as displayParameterPath, Hl as getResourcePermissions, Hs as getChildNodes, I as CUSTOM_API_CALL_KEY, Js as getNodeOutputs, Ks as getConnectionTypes, L as DATA_TYPE_ICON_MAP, N as IN_PROGRESS_EXECUTION_ID, Nc as deepCopy, Nn as NODE_POSITION_CONFLICT_ALLOWLIST, Ol as require_isEqual, P as PLACEHOLDER_FILLED_AT_EXECUTION_TIME, Ps as createEmptyRunExecutionData, Qc as UnexpectedError, Qn as SCHEDULE_TRIGGER_NODE_TYPE, Sl as SEND_AND_WAIT_OPERATION, Sn as LIST_LIKE_NODE_OPERATIONS, U as AI_CATEGORY_AGENTS, Ut as CREDENTIAL_ONLY_NODE_PREFIX, Ws as displayParameter, Xc as ExpressionError, Y as AI_CATEGORY_MCP_NODES, Yo as require__baseFlatten, Ys as getNodeParameters, Z as AI_CATEGORY_OTHER_TOOLS, Zs as getNodeWebhookUrl, Zu as EnterpriseEditionFeature, _c as isFilterValue, _r as WEBHOOK_NODE_TYPE, bs as splitExpression, cl as CHAT_TRIGGER_NODE_TYPE, cn as FORM_TRIGGER_NODE_TYPE, cs as require__createCompounder, ds as require__baseIteratee, dt as CORE_NODES_CATEGORY, en as ERROR_TRIGGER_NODE_TYPE, fc as nodeIssuesToString, fn as HTTP_REQUEST_NODE_TYPE, gu as WorkflowIdKey, ht as HUMAN_IN_THE_LOOP_CATEGORY, hu as WorkflowDocumentStoreKey, i as DUPLICATE_POSTFFIX, ic as isHitlToolType, is as Workflow, it as AI_CODE_TOOL_LANGCHAIN_NODE_TYPE, jn as MODULE_ENABLED_NODES, k as ALLOWED_HTML_ATTRIBUTES, kc as traverseNodeParameters, kt as AI_MCP_TOOL_NODE_TYPE, li as MAIN_HEADER_TABS, lu as CanvasRenderDataKey, q as AI_CATEGORY_HUMAN_IN_THE_LOOP, qo as require_pick, qs as getNodeInputs, r as DEFAULT_SETTINGS, rt as AI_CATEGORY_VECTOR_STORES, ui as VIEWS, ut as BETA_NODES, vr as WIKIPEDIA_TOOL_NODE_TYPE, wc as isResourceMapperValue$1, wl as WAIT_INDEFINITELY, ws as require__baseFindIndex, xr as WORKFLOW_TRIGGER_NODE_TYPE, xs as require__baseUniq, yl as MANUAL_TRIGGER_NODE_TYPE, yt as RECOMMENDED_NODES, z as MAPPING_PARAMS } from "./constants-DzzWpyjZ.js";
import { b as require_isArrayLike, n as require__isIterateeCall, r as require__baseRest, t as require_merge } from "./merge-CD5c-3ZT.js";
import { E as getActivePinia, T as defineStore, a as ResponseError, c as makeRestApiRequest, d as request, f as streamRequest, m as axios, s as getFullApiResponse, t as useRootStore } from "./useRootStore-C7jLo3fI.js";
import { C as updateCurrentUserSettings, Pt as getProjectSecretProviderConnectionsByProjectId, ct as fetchCommunityNodeTypes, dt as getNodeParameterOptions, ft as getNodeTranslationHeaders, gt as getResourceMapperFields, ht as getResourceLocatorResults, i as getWorkflowVersion, lt as getLocalResourceMapperFields, mt as getNodesInformation, pt as getNodeTypes$1, s as findWebhook, st as fetchCommunityNodeAttributes, t as useSettingsStore, ut as getNodeParameterActionResult, zn as STORES } from "./settings.store-DmallR-B.js";
import { _ as useStorage, f as useUIStore, n as hasPermission, t as useUsersStore, u as hasRole } from "./users.store-CUxYM5yQ.js";
import { r as require_toNumber } from "./useDebounce-CSbnOwIT.js";
import { A as isObject$1, E as stringSizeInBytes, S as isPresent, T as shorten, a as getNewWorkflow, i as getLastSuccessfulExecution, k as getObjectSizeInKB, l as getWorkflows, n as useFavoritesStore, r as getExecutionData, t as useWorkflowsListStore, w as omit, x as isJsonKeyObject, y as isEmpty } from "./workflowsList.store-DBU92DSv.js";
import { t as useDocumentTitle } from "./useDocumentTitle-CCNQZyeI.js";
import { t as require__baseOrderBy } from "./_baseOrderBy-FRytj-an.js";
...
function useExecutionDataStore(id) {
	return defineStore(getExecutionDataStoreId(id), () => {
		...
		*/
		const executionSimulationByNodeName = computed(() => execution.value?.data?.resultData?.simulation ?? {});
...
var EMPTY_EXECUTION_SIMULATION_BY_NODE_NAME = {};
	...
	return defineStore(getWorkflowExecutionStateStoreId(id), () => {
		...
		*/
		const activeExecutionSimulationByNodeName = computed(() => {
			if (typeof activeExecutionId.value === "string") return useExecutionDataStore(createExecutionDataId(activeExecutionId.value)).executionSimulationByNodeName;
			if (typeof displayedExecutionId.value === "string") return useExecutionDataStore(createExecutionDataId(displayedExecutionId.value)).executionSimulationByNodeName;
...
function applyNodeTags(element) {
	...
	if (RECOMMENDED_NODES.includes(element.properties.name)) element.properties.tag = {
	...
	else if (useSettingsStore().isAiGatewayEnabled && useAiGatewayStore().isNodeSupported(element.properties.name)) {
		...
		if (useAiGatewayStore().isNodeTypeVersionSupported(element.properties.name, latestVersion)) element.properties.tag = {
	...
	const loadNodesInformationFromLocalDb = async (nodeInfos) => {
		try {
			const { getNodeType } = await __vitePreload(async () => {
				const { getNodeType } = await import("./workers-Dr9EnZmI.js");
				return { getNodeType };
			}, __vite__mapDeps([0,1]));
			const found = [];
			const missing = [];
	...
	const loadNodeTypesFromLocalDb = async () => {
		try {
			const { loadNodeTypes, getAllNodeTypes } = await __vitePreload(async () => {
				const { loadNodeTypes, getAllNodeTypes } = await import("./workers-Dr9EnZmI.js");
				return {
					loadNodeTypes,
					getAllNodeTypes
				};
...
//#endregion
export { sublimeSearch as $, sanitizeIfString as $i, getNodeSubtitle as $n, _sfc_main$3 as $r, getDefaultExecutionFilters as $t, getRootSearchCallouts as A, isVariableResource as Ai, downloadDataTableCsvApi as An, CONFIGURABLE_NODE_SIZE as Ar, resolveRequiredParameters as At, sortNodeCreateElements as B, createCanvasGroupNodeId as Bi, uploadCsvFileApi as Bn, getMidCanvasPosition as Br, disposeNDVStore as Bt, listEvaluationConfigs as C, isResourceSortableByDate as Ci, moveFolderToProject as Cn, mapCanvasConnectionToLegacyConnection as Cr, isPairedItemIntermediateNodesError as Ct, flattenCreateElements as D, isTriggerPanelObject as Di, deleteDataTableApi as Dn, resolveCanonicalConnection as Dr, stringifyExpressionResult as Dt, finalizeItems as E, isString as Ei, createDataTableApi as En, parseCanvasConnectionHandleString as Er, shouldConvertToExpression as Et, nodeTypesToCreateElements as F, CANVAS_NODE_GROUP_ID_PREFIX as Fi, insertDataTableRowApi as Fn, calculateNodeSize as Fr, useTagsStore as Ft, getSampleWorkflowByTemplateId as G, pinDataToExecutionData as Gi, getAllNodeCredentialForAuthType as Gn, getNodesWithNormalizedPosition as Gr, injectWorkflowExecutionStateStore as Gt, transformNodeType as H, parseCanvasGroupNodeId as Hi, fieldCannotBeDeleted as Hn, getNewNodePosition as Hr, injectNDVStoreIfProvided as Ht, prepareCommunityNodeDetailsViewStack as I, CANVAS_NODE_GROUP_TYPE as Ii, moveDataTableColumnApi as In, doRectsOverlap as Ir, ensureNodePosition as It, isFullTemplatesCollection as J, getBannerRowHeight as Ji, getAuthTypeForNodeCredential as Jn, NodeId as Jr, clearPopupWindowState as Jt, getTutorialTemplates as K, CHANGE_ACTION as Ki, getAppNameFromCredType as Kn, updateViewportToContainNodes as Kr, useWorkflowExecutionStateStore as Kt, removePreviewToken as L, CanvasConnectionMode as Li, renameDataTableColumnApi as Ln, generateOffsets as Lr, removeWorkflowExecutionData as Lt, isAINode as M, isWorkflowListItem as Mi, fetchDataTablesApi as Mn, DEFAULT_NODE_SIZE as Mr, useRouteWorkflowId as Mt, isNodePreviewKey as N, CANVAS_NODE_GROUP_HANDLE_LEFT as Ni, getDataTableRowsApi as Nn, DEFAULT_VIEWPORT_BOUNDARIES as Nr, useWorkflowId as Nt, getAiTemplatesCallout as O, isValidCredentialResponse as Oi, deleteDataTableColumnApi as On, shouldIgnoreCanvasShortcut as Or, unwrapExpression as Ot, mapToolSubcategoryIcon as P, CANVAS_NODE_GROUP_HANDLE_RIGHT as Pi, importCsvToDataTableApi as Pn, PUSH_NODES_OFFSET as Pr, useAnnotationTagsStore as Pt, capitalCase as Q, sanitizeHtml as Qi, getNodeCredentialForSelectedAuthType as Qn, _sfc_main$1 as Qr, findTriggerNodeToAutoSelect as Qt, searchNodes as R, CanvasNodeDirtiness as Ri, updateDataTableApi as Rn, getBounds as Rr, sanitizeConnections as Rt, deleteEvaluationConfig as S, isResourceMapperValue as Si, ProjectTypes as Sn, insertSpacersBetweenEndpoints as Sr, getResolvableState as St, filterAndSearchNodes as T, isSharedResource as Ti, addDataTableColumnApi as Tn, mapLegacyConnectionsToCanvasConnections as Tr, removeExpressionPrefix as Tt, SampleTemplates as U, structuralComputed as Ui, filterTemplateNodes as Un, getNodeViewTab as Ur, useNDVStore as Ut, subcategorizeItems as V, isCanvasGroupNode as Vi, executionDataToJson as Vn, getMousePosition as Vr, injectNDVStore as Vt, getRagStarterWorkflowJson as W, getPinDataSize as Wi, getActivatableTriggerNodes as Wn, getNodesGroupSize as Wr, disposeWorkflowExecutionStateStore as Wt, useAiGatewayStore as X, isEventTargetContainedBy as Xi, getNodeAuthFields as Xn, Position as Xr, executionFilterToQueryFilter as Xt, isTemplatesWorkflow as Y, getScrollbarWidth as Yi, getMainAuthField as Yn, PanelPosition as Yr, displayForm as Yt, require_sortBy as Z, isOutsideSelected as Zi, getNodeAuthOptions as Zn, _sfc_main as Zr, executionRetryMessage as Zt, useNodeTypesStore as _, isCredentialsResource as _i, splitName as _n, createCanvasConnectionHandleString as _r, getMappedExpression as _t, injectWorkflowDocumentStore as a, getConnectedEdges as ai, waitingNodeTooltip as an, isAuthRelatedParameter as ar, chatWithAssistant as at, useEvaluationStore as b, isFullExecutionResponse as bi, useProjectsStore as bn, getMaxNodePortsLabelSize as br, completeExpressionSyntax as bt, TOOL_NODE_TYPES_NEED_INPUT as c, isMacOs as ci, createExecutionDataId as cn, isResourceMapperFieldListStale as cr, generateCodeForPrompt as ct, doesNodeHaveCredentialsToFill as d, wheelDelta as di, useExecutionDataStore as dn, updateNodeAuthType as dr, replaceCode as dt, _sfc_main$d as ei, getExecutionErrorMessage as en, getThemedValue as er, require_startCase as et, getNodeTypeDisplayableCredentials as f, checkExhaustive as fi, getPairedItemId as fn, getAllCredentials as fr, truncateBuilderMessages as ft, require_uniq as g, isCredentialModalState as gi, getTruncatedProjectName as gn, computeNodeDisplaySize as gr, escapeMappingString as gt, serializeNode as h, isComponentPublicInstance as hi, ResourceType as hn, checkOverlap as hr, useFlattenSchema as ht, disposeWorkflowDocumentStore as i, getBoundsofRects as ii, unflattenExecutionData as in, hasProxyAuth as ir, useCredentialsStore as it, groupItemsInSections as j, isVueFlowConnection as ji, fetchDataTableGlobalLimitInBytes as jn, CONFIGURATION_NODE_SIZE as jr, useWorkflowHelpers as jt, getHumanInTheLoopActions as k, isValidNodeConnectionType as ki, deleteDataTableRowsApi as kn, injectStrict as kr, resolveParameter as kt, assignNodeId as l, useGetPointerPosition as li, disposeExecutionDataStore as ln, isValueExpression as lr, getAiSessions as lt, needsAgentInput as m, isBinaryLike as mi, useEnvironmentsStore as mn, isCredentialOnlyNodeType as mr, useDataSchema as mt, createExecutionPreviewDocumentVersion as n, clamp as ni, hasTrimmedRunData as nn, hasExpressionMapping as nr, require__baseSlice as nt, provideWorkflowDocumentStore as o, getRectOfNodes as oi, parse as on, isMatchingField as or, chatWithBuilder as ot, getParameterDisplayableOptions as p, isBaseTextKey as pi, LOCAL_STORAGE_NDV_PANEL_WIDTH as pn, require_toInteger as pr, useAIAssistantHelpers as pt, isTutorialTemplateId as q, capitalizeFirstLetter as qi, getAppNameFromNodeName as qn, MarkerType as qr, buildExecutionResponseFromSchema as qt, createWorkflowDocumentId as r, getBezierPath as ri, openFormPopupWindow as rn, hasOnlyListMode as rr, listenForCredentialChanges as rt, useWorkflowDocumentStore as s, getSmoothStepPath as si, useWorkflowsStore as sn, isRequiredCredential as sr, clearBuilderSession as st, createExecutionPreviewDocumentId as t, _sfc_main$f as ti, getExecutionErrorToastConfiguration as tn, getTriggerNodeServiceName as tr, require_upperFirst as tt, doesNodeHaveAllCredentialsFilled as u, useVueFlow as ui, hasExecutionDataStore as un, parseResourceMapperFieldName as ur, getBuilderCredits as ut, isDataWorkerEnabled as v, isDateObject as vi, useAvailableProjectSearch as vn, createCanvasConnectionId as vr, getMappedResult as vt, updateEvaluationConfig as w, isRouteLocationRaw as wi, setWorkflowSharedWith as wn, mapLegacyConnectionToCanvasConnection as wr, isTestableExpression as wt, createEvaluationConfig as x, isProjectRole as xi, useSourceControlStore as xn, injectCanvasRenderData as xr, getExpressionErrorMessage as xt, useActionsGenerator as y, isDebouncedFunction as yi, useRemoteProjectSearch as yn, createEmptyCanvasRenderData as yr, propertyNameFromExpression as yt, shouldShowCommunityNodeDetails as z, CanvasNodeRenderType as zi, updateDataTableRowsApi as zn, getGenericHints as zr, sortNodesByExecutionOrder as zt };
