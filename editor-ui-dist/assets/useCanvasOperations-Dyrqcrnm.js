...
import { gt as useI18n, j as useLocalStorage } from "./_MapCache-B3wBxKdj.js";
import { b as useRouter, x as createEventBus, y as useRoute } from "./truncate-5E8n_f_n.js";
import { Bo as v4_default, Dr as AddNodeCommand, En as useProjectsStore, Er as AddConnectionCommand, Fi as useUIStore, Fr as ReplaceNodeParametersCommand, Gn as useCanvasStore, Ht as useCredentialsStore, Mr as RemoveConnectionCommand, Nr as RemoveNodeCommand, Pr as RenameNodeCommand, S as getNodesGroupSize, Sn as injectWorkflowState, Sr as CanvasConnectionMode, Ti as tryToParseNumber, Tr as useHistoryStore, Wo as useSettingsStore, Zt as useDataSchema, _n as useTagsStore, a as useNDVStore, at as useNodeTypesStore, b as getNewNodePosition, bi as isPresent, d as DEFAULT_VIEWPORT_BOUNDARIES, f as GRID_SIZE, h as generateOffsets, i as usePostHog, jr as MoveNodeCommand, l as CONFIGURATION_NODE_SIZE, mn as useWorkflowHelpers, o as useWorkflowsStore, p as PUSH_NODES_OFFSET, q as isChatNode, s as CONFIGURABLE_NODE_SIZE, t as useTelemetry, tt as getExecutionErrorToastConfiguration, u as DEFAULT_NODE_SIZE, vr as isValidNodeConnectionType, wr as CanvasNodeRenderType, xn as useNodeHelpers } from "./useTelemetry-DNwFBRX7.js";
import { t as useToast } from "./useToast-CyeeQKoz.js";
import { $i as getConnectionTypes, As as LOCAL_STORAGE_LOGS_PANEL_DETAILS_PANEL_SUB_NODE, Da as isCommunityPackageName, Ea as deepCopy, Fo as VIEWS, Ga as NodeConnectionTypes, Ms as LOCAL_STORAGE_LOGS_SYNC_SELECTION, Si as require_cloneDeep, Xi as generateNodesGraph, _r as UPDATE_WEBHOOK_ID_NODE_TYPES, ac as NDV_IN_FOCUS_PANEL_EXPERIMENT, dr as STICKY_NODE_TYPE, ea as getNodeInputs, fn as FORM_TRIGGER_NODE_TYPE, hc as EnterpriseEditionFeature, ji as require__baseUniq, js as LOCAL_STORAGE_LOGS_PANEL_OPEN, kn as MCP_TRIGGER_NODE_TYPE, ks as LOCAL_STORAGE_LOGS_PANEL_DETAILS_PANEL, na as getNodeParameters, sa as getSubworkflowId, ta as getNodeOutputs, tc as CANVAS_ZOOMED_VIEW_EXPERIMENT, yr as WEBHOOK_NODE_TYPE } from "./constants-ASQneu7i.js";
...
import { a as mapCanvasConnectionToLegacyConnection, l as parseCanvasConnectionHandleString, o as mapLegacyConnectionToCanvasConnection, r as createCanvasConnectionHandleString, s as mapLegacyConnectionsToCanvasConnections, t as useNodeCreatorStore } from "./nodeCreator.store-Dpj0w5xX.js";
