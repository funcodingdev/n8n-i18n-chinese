...
import { An as downloadDataTableCsvApi, Bn as uploadCsvFileApi, Dn as deleteDataTableApi, En as createDataTableApi, Fn as insertDataTableRowApi, In as moveDataTableColumnApi, Ln as renameDataTableColumnApi, Mn as fetchDataTablesApi, Nn as getDataTableRowsApi, On as deleteDataTableColumnApi, Pn as importCsvToDataTableApi, Rn as updateDataTableApi, Tn as addDataTableColumnApi, bn as useProjectsStore, jn as fetchDataTableGlobalLimitInBytes, kn as deleteDataTableRowsApi, zn as updateDataTableRowsApi } from "./workflows.store-C0TGOSWn.js";
...
import { ir as DATA_TABLE_STORE } from "./constants-DOw6b_w2.js";
...
var useDataTableStore = defineStore(DATA_TABLE_STORE, () => {
	...
	const fetchDataTableById = async (dataTableId) => {
		if (!canViewDataTables.value) return null;
		return (await fetchDataTablesApi(rootStore.restApiContext, "", void 0, { id: dataTableId })).data[0] ?? null;
	};
	...
	const insertRow = async (dataTableId, projectId, row) => {
		return (await insertDataTableRowApi(rootStore.restApiContext, dataTableId, row, projectId))[0];
	};
