...
import { Ft as readonly, It as ref, S as computed, gt as watch } from "./vue.runtime.esm-bundler-CDDUUZhE.js";
import { s as useI18n } from "./src-Dh32dOY5.js";
import { Fi as isToolMessage$1, Ii as isWorkflowUpdatedMessage$1, _t as useRouter, gt as useRoute } from "./src-BVC_ZvSs.js";
import { J as useDebounceFn, v as useLocalStorage } from "./core-DOUvgShw.js";
import { t as useMessage } from "./useMessage-GjRAbz4G.js";
import { t as useToast } from "./useToast-CsW2zDDU.js";
import { $u as DEBOUNCE_TIME, Ac as isExpression, Bi as NPS_SURVEY_MODAL_KEY, Hl as getResourcePermissions, Ii as MODAL_CANCEL, Li as MODAL_CLOSE, Mc as dedupe, Pu as FOCUSED_NODES_EXPERIMENT, Ri as MODAL_CONFIRM, Tu as CODE_WORKFLOW_BUILDER_EXPERIMENT, ad as THREE_DAYS_IN_MILLIS, id as SIX_MONTHS_IN_MILLIS, la as LOCAL_STORAGE_BROWSER_NOTIFICATION_METADATA, rd as SEVEN_DAYS_IN_MILLIS, sd as getDebounceTime, t as AutoSaveState, ui as VIEWS, zu as MERGE_ASK_BUILD_EXPERIMENT } from "./constants-DzzWpyjZ.js";
import { Kt as useWorkflowExecutionStateStore, Mt as useRouteWorkflowId, Nt as useWorkflowId, Ut as useNDVStore, a as injectWorkflowDocumentStore, ft as truncateBuilderMessages, jt as useWorkflowHelpers, lt as getAiSessions, ot as chatWithBuilder, pt as useAIAssistantHelpers, r as createWorkflowDocumentId, s as useWorkflowDocumentStore, sn as useWorkflowsStore, st as clearBuilderSession, ut as getBuilderCredits, xn as useSourceControlStore, yi as isDebouncedFunction } from "./workflowDocument.store-BQc6YDGi.js";
import { T as defineStore, h as assert, t as useRootStore } from "./useRootStore-C7jLo3fI.js";
import { a as getWorkflowVersionsByIds, en as getFirstAdoptionDate, i as getWorkflowVersion, n as getPublishTimeline, o as updateWorkflowHistoryVersion, ot as updateNpsSurveyState, r as getWorkflowHistory, t as useSettingsStore, zn as STORES } from "./settings.store-DmallR-B.js";
import { f as useUIStore, g as usePostHog, p as useTelemetry } from "./users.store-CUxYM5yQ.js";
import { E as stringSizeInBytes, O as tryToParseNumber, a as getNewWorkflow, t as useWorkflowsListStore } from "./workflowsList.store-DBU92DSv.js";
...
import { a as BUILDER_ENABLED_VIEWS, r as useChatPanelStateStore, t as useCodeDiff } from "./useCodeDiff-Bny9BSZj.js";
import { i as formatPlaceholderPath, r as findPlaceholderDetails } from "./dist-BXENiK5V.js";
