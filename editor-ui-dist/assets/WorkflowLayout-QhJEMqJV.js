...
import { T as useStorage, at as useI18n, u as useDocumentVisibility, v as useLocalStorage } from "./core-gptzu9Ct.js";
...
import { Bn as require_FileSaver_min, E as useEvaluationStore, Et as useWorkflowHelpers, Fn as useStyles, Kn as sanitizeFilename, Ln as useMessage, Mt as nodeViewEventBus, Ot as useWorkflowState, Pn as useToast, Ps as getBannerRowHeight, Si as ProjectTypes, Vt as useWorkflowSaveStore, Wi as getActivatableTriggerNodes, _r as useTelemetry, ai as ResourceType, di as useFavoritesStore, fa as injectWorkflowDocumentStore, fi as useSourceControlStore, fr as useWorkflowsListStore, kt as useBuilderStore, pa as useWorkflowDocumentStore, pi as hasPermission, r as useUIStore, s as useWorkflowsStore, sr as useTagsStore, t as useUsersStore, ua as createWorkflowDocumentId, ui as useProjectsStore, w as useNodeTypesStore, xr as useNDVStore, yr as telemetry, zn as useWorkflowHistoryStore, zt as useWorkflowSaving } from "./users.store-BCts_jcD.js";
import { t as BaseLayout_default } from "./BaseLayout-XlRozU2t.js";
import { Ac as WorkflowStateKey, Ai as WORKFLOW_SETTINGS_MODAL_KEY, Ec as PopOutWindowKey, Oc as WorkflowDocumentStoreKey, Oi as WORKFLOW_HISTORY_VERSION_UNPUBLISH, Pt as CHAT_TRIGGER_NODE_TYPE, Rr as MAIN_HEADER_TABS, S as TIME_SAVED_DOCS_URL, Ti as WORKFLOW_HISTORY_NAME_VERSION_MODAL_KEY, Ui as LOCAL_STORAGE_HIDE_GITHUB_STAR_BUTTON, Vi as LOCAL_STORAGE_FLOATING_CHAT_WINDOW, Yr as DUPLICATE_MODAL_KEY, bi as WORKFLOW_ACTIVE_MODAL_KEY, bl as WORKFLOW_MENU_ACTIONS, g as N8N_MAIN_GITHUB_REPO_URL, ji as WORKFLOW_SHARE_MODAL_KEY, ki as WORKFLOW_PUBLISH_MODAL_KEY, m as EVALUATIONS_DOCS_URL, p as ERROR_WORKFLOW_DOCS_URL, qs as v4, rl as EnterpriseEditionFeature, sl as LOADING_ANIMATION_MIN_DURATION, t as AutoSaveState, ti as IMPORT_WORKFLOW_URL_MODAL_KEY, uc as getResourcePermissions, xi as WORKFLOW_DESCRIPTION_MODAL_KEY, zr as VIEWS } from "./constants-CjIW4CHX.js";
...
import { t as router } from "./router-z8Jd7m8M.js";
import { a as MCP_SETTINGS_VIEW, r as MCP_DOCS_PAGE_URL } from "./mcp.constants-BkskzDRd.js";
import { n as useMoveResourceToProjectToast, t as LoadingView_default } from "./LoadingView-DRkEzj7s.js";
import { i as getLastPublishedVersion, r as generateVersionLabelFromId } from "./utils-DgM4VIku.js";
...
import { m as groupConversationsByDate, u as flattenModel } from "./fileUtils-C5zYKhVS.js";
...
import { t as AppSidebar_default } from "./AppSidebar-Ck0eJg6f.js";
import { i as usePopOutWindow, n as useWorkflowInitialization, r as LogsPanel_default, t as usePostMessageHandler } from "./usePostMessageHandler-C3UCq0po.js";
import { t as usePushConnection } from "./usePushConnection-D2jtxwHK.js";
import { i as useChatSession, n as ChatPrompt_default, r as ChatMessage_default, t as ChatGreetings_default } from "./ChatGreetings-CaBN104S.js";
import { n as useFileDrop } from "./ToolsSelector-DIcg0ilY.js";
import { t as FolderBreadcrumbs_default } from "./FolderBreadcrumbs-nSwrzl38.js";
import { t as ConnectionTracker_default } from "./ConnectionTracker-DDdGJENs.js";
import { t as useWorkflowSettingsCache } from "./useWorkflowsCache-BAuvh5wL.js";
import "./usePushConnection-COFb0xzn.js";
...
var WorkflowDetails_default = /* @__PURE__ */ _plugin_vue_export_helper_default(WorkflowDetails_vue_vue_type_script_setup_true_lang_default, [["__cssModules", { "$style": WorkflowDetails_vue_vue_type_style_index_1_lang_module_default }], ["__scopeId", "data-v-c7da331f"]]);
//#endregion
