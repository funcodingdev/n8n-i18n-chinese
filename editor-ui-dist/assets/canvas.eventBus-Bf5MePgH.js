...
import { C as require__arrayMap, S as require_toString, bt as createEventBus, v as require_get } from "./src-CKCAtrpy.js";
import { $i as getThemedValue, A as getAiTemplatesCallout, B as searchNodes, Dn as useTemplatesStore, Dr as useExternalHooks, E as useEvaluationStore, H as sortNodeCreateElements, I as mapToolSubcategoryIcon, L as nodeTypesToCreateElements, N as groupItemsInSections, O as finalizeItems, Or as useCanvasStore, P as isAINode, Qr as v4_default, R as prepareCommunityNodeDetailsViewStack, Si as CanvasConnectionMode, U as subcategorizeItems, W as transformNodeType, bi as isVueFlowConnection, en as useTelemetry, js as useSettingsStore, k as flattenCreateElements, ol as STORES, r as useUIStore, rn as useNDVStore, rt as require__createCompounder, s as useWorkflowsStore, tt as require_upperFirst, w as useNodeTypesStore } from "./users.store-D86YL4LK.js";
import { $ as AI_CATEGORY_LANGUAGE_MODELS, $t as CRYPTO_NODE_TYPE, Ar as XML_NODE_TYPE, At as TEMPLATE_CATEGORY_AI, Cn as IF_NODE_TYPE, Ct as HUMAN_IN_THE_LOOP_CATEGORY, Et as OTHER_TRIGGER_NODES_SUBCATEGORY, Fn as MERGE_NODE_TYPE, Ft as AGGREGATE_NODE_TYPE, Go as require__cacheHas, Gt as CHAT_TRIGGER_NODE_TYPE, I as CUSTOM_API_CALL_KEY, It as AI_CODE_NODE_TYPE, J as AI_CATEGORY_AGENTS, Jt as COMPRESSION_NODE_TYPE, Ko as require__SetCache, Mn as MANUAL_TRIGGER_NODE_TYPE, Mt as TRIGGER_NODE_CREATOR_VIEW, Nn as MARKDOWN_NODE_TYPE, Nt as AGENT_NODE_TYPE, Oa as isHitlToolType, Oo as EVALUATION_TRIGGER_NODE_TYPE, Ot as REGULAR_NODE_CREATOR_VIEW, Pt as AGENT_TOOL_NODE_TYPE, Rt as AI_TRANSFORM_NODE_TYPE$1, St as HITL_SUBCATEGORY, Ti as require__baseFlatten, Tt as NODE_CREATOR_OPEN_SOURCES, X as AI_CATEGORY_DOCUMENT_LOADERS, Xa as isCommunityPackageName, Xi as require__arrayIncludesWith, Y as AI_CATEGORY_CHAINS, Yt as CONVERT_TO_FILE_NODE_TYPE, Z as AI_CATEGORY_EMBEDDING, Zi as require__arrayIncludes, _a as getNodeInputs, _r as SUMMARIZE_NODE_TYPE, ar as SCHEDULE_TRIGGER_NODE_TYPE, at as AI_CATEGORY_ROOT_NODES, bn as HTTP_REQUEST_NODE_TYPE, bt as FLOWS_CONTROL_SUBCATEGORY, cr as SET_NODE_TYPE, ct as AI_CATEGORY_VECTOR_STORES, dt as AI_NODE_CREATOR_VIEW, et as AI_CATEGORY_MCP_NODES, fn as EXECUTE_WORKFLOW_TRIGGER_NODE_TYPE, ft as AI_OTHERS_NODE_CREATOR_VIEW, gn as FORM_TRIGGER_NODE_TYPE, gt as AI_WORKFLOW_TOOL_LANGCHAIN_NODE_TYPE, ht as AI_UNCATEGORIZED_CATEGORY, in as EDIT_IMAGE_NODE_TYPE, it as AI_CATEGORY_RETRIEVERS, jt as TRANSFORM_DATA_SUBCATEGORY, kn as LIMIT_NODE_TYPE, lt as AI_CODE_TOOL_LANGCHAIN_NODE_TYPE, mn as FILTER_NODE_TYPE, mo as NodeConnectionTypes, mr as SPLIT_OUT_NODE_TYPE, mt as AI_SUBCATEGORY, nn as DATETIME_NODE_TYPE, on as EMAIL_IMAP_NODE_TYPE, ot as AI_CATEGORY_TEXT_SPLITTERS, pn as EXTRACT_FROM_FILE_NODE_TYPE, pr as SPLIT_IN_BATCHES_NODE_TYPE, pt as AI_SECTION_RECOMMENDED_TOOLS, qt as CODE_NODE_TYPE, rr as RSS_READ_NODE_TYPE, rt as AI_CATEGORY_OUTPUTPARSER, sn as EMAIL_SEND_NODE_TYPE, st as AI_CATEGORY_TOOLS, tn as DATA_TABLE_NODE_TYPE, tr as REMOVE_DUPLICATES_NODE_TYPE, tt as AI_CATEGORY_MEMORY, vt as CORE_NODES_CATEGORY, wr as WEBHOOK_NODE_TYPE, wt as NEW_TOOL_CATEGORIES, xo as AI_TRANSFORM_NODE_TYPE, xt as HELPERS_SUBCATEGORY, yn as HTML_NODE_TYPE, yt as DEFAULT_SUBCATEGORY } from "./constants-bR1gDMyV.js";
import { E as require__baseUnary, d as require_isArrayLikeObject, r as require__baseRest } from "./merge-CIGhcbPZ.js";
import { j as defineStore } from "./_baseOrderBy-Bnq6lF9G.js";
import { t as getNodeIconSource } from "./nodeIcon-CZIVoFoF.js";
import { c as parseCanvasConnectionHandleString, n as createCanvasConnectionHandleString } from "./canvas.utils-BFvfHyWG.js";
