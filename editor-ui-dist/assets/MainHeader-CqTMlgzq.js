...
import { Cn as useProjectsStore, Tn as ProjectTypes, Y as useEvaluationStore, b as injectWorkflowDocumentStore, cn as useTagsStore, mn as injectNDVStore, q as useNodeTypesStore, qi as getBannerRowHeight, qn as getActivatableTriggerNodes, t as useWorkflowsStore, v as createWorkflowDocumentId, vn as ResourceType, wn as useSourceControlStore, x as useWorkflowDocumentStore } from "./workflows.store-DZfkxcrn.js";
import { t as useToast } from "./useToast-ioerWMiY.js";
import { $i as WORKFLOW_HISTORY_VERSION_UNPUBLISH, C as TIME_SAVED_DOCS_URL, Cl as getResourcePermissions, Di as IMPORT_WORKFLOW_URL_MODAL_KEY, Gi as WORKFLOW_ACTIVE_MODAL_KEY, Jl as WorkflowDocumentStoreKey, Ki as WORKFLOW_DESCRIPTION_MODAL_KEY, Ku as WORKFLOW_MENU_ACTIONS, Nu as LOADING_ANIMATION_MIN_DURATION, Xi as WORKFLOW_HISTORY_NAME_VERSION_MODAL_KEY, _ as N8N_MAIN_GITHUB_REPO_URL, _a as LOCAL_STORAGE_HIDE_GITHUB_STAR_BUTTON, ci as MAIN_HEADER_TABS, ea as WORKFLOW_PUBLISH_MODAL_KEY, h as EVALUATIONS_DOCS_URL, ku as EnterpriseEditionFeature, li as VIEWS, m as ERROR_WORKFLOW_DOCS_URL, na as WORKFLOW_SHARE_MODAL_KEY, t as AutoSaveState, ta as WORKFLOW_SETTINGS_MODAL_KEY, ui as WORKFLOW_HISTORY_PUBLISH_TIMELINE_TAB, xi as DUPLICATE_MODAL_KEY, yc as jsonParse } from "./constants-CLQJMg7Y.js";
...
import { _ as useLocalStorage, u as useDocumentVisibility } from "./core-CZJuH52F.js";
import { f as useUIStore, h as telemetry, n as hasPermission, p as useTelemetry, t as useUsersStore } from "./users.store-AINJEAwY.js";
...
import { a as useWorkflowSaveStore, c as useWorkflowHistoryStore, o as useWorkflowId, r as useWorkflowSaving } from "./builder.store-CL34arwP.js";
import { a as sanitizeFilename } from "./dist-BynafEp_.js";
...
import { t as router } from "./router-Bn-PxcpJ.js";
import { a as MCP_SETTINGS_VIEW, r as MCP_DOCS_PAGE_URL } from "./mcp.constants-BeeqHqc-.js";
import { t as useMoveResourceToProjectToast } from "./useMoveResourceToProjectToast-C4DJ4M_4.js";
import { i as getLastPublishedVersion, r as generateVersionLabelFromId } from "./utils-CRZL9Awf.js";
...
import { t as usePushConnection } from "./usePushConnection-DlP_1Q9T.js";
import { t as FolderBreadcrumbs_default } from "./FolderBreadcrumbs-DYXlxry6.js";
import { t as ConnectionTracker_default } from "./ConnectionTracker-DRomjgam.js";
import { t as useWorkflowEvaluationState } from "./useWorkflowEvaluationState-CDg-8fNB.js";
import "./usePushConnection-B2bW7eEv.js";
