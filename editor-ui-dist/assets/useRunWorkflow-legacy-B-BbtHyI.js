;
(function () {
  System.register(["./chunk-legacy-Re9CbdfL.js", "./vue.runtime.esm-bundler-legacy--Sn1h8On.js", "./_MapCache-legacy-CECtqMZe.js", "./truncate-legacy-nB2QmutO.js", "./useTelemetry-legacy-CA9g7cV_.js", "./useToast-legacy-fud3e81V.js", "./constants-legacy-B_3qSw5J.js", "./_baseOrderBy-legacy-3SIYDICR.js", "./useExternalHooks-legacy-CqVTyuDp.js", "./useWorkflowSaving-legacy-DG7LbIVc.js", "./retry-legacy-CTwsGM7o.js", "./executions.store-legacy-pCJOr0Ul.js", "./useCanvasOperations-legacy-C93IMXtc.js"], function (_export, _context) {
    "use strict";

    var __toESM, computed, ref, watch, useI18n, useLocalStorage, require_get, EnableNodeToggleCommand, CanvasNodeDirtiness, AddNodeCommand, AddConnectionCommand, RemoveConnectionCommand, RemoveNodeCommand, BulkCommand, injectWorkflowState, useDocumentTitle, useHistoryStore, useSettingsStore, displayForm, STORES, useWorkflowHelpers, useWorkflowsStore, useTelemetry, isEmpty, useNodeHelpers, useToast, NodeConnectionTypes, IN_PROGRESS_EXECUTION_ID, createHeartbeatMessage, CHAT_TRIGGER_NODE_TYPE, createRunExecutionData, generateNodesGraph, SINGLE_WEBHOOK_TRIGGERS, LOCAL_STORAGE_RUN_DATA_WORKER, defineStore, useRootStore, useExternalHooks, useWorkflowSaving, retry, useExecutionsStore, useCanvasOperations, useHeartbeat, useReconnectTimer, useWebSocketClient, useEventSourceClient, proxyMarker, createEndpoint, releaseProxy, finalizer, throwMarker, isObject, transferHandlers, proxyCounter, proxyFinalizers, transferCache, worker, runDataWorker, usePushConnectionStore, LOCAL_STORAGE_AGENT_REQUESTS, useAgentRequestStore, import_get;
    ...
    */
    ...
    return {
      setters: [function (_chunkLegacy001Js) {
        ...
        IN_PROGRESS_EXECUTION_ID = _constantsLegacy00TJs.P;
        createHeartbeatMessage = _constantsLegacy00TJs.Qr;
        ...
        SINGLE_WEBHOOK_TRIGGERS = _constantsLegacy00TJs.ar;
        LOCAL_STORAGE_RUN_DATA_WORKER = _constantsLegacy00TJs.zs;
      ...
      }, function (_retryLegacy01lJs) {
        retry = _retryLegacy01lJs.t;
