...
import { $ as openBlock, A as createTextVNode, C as createBaseVNode, E as createElementBlock, Ft as ref, Ht as toValue, I as h, N as defineComponent, S as computed, Sn as toDisplayString, T as createCommentVNode, Wt as unref, X as onMounted, _ as Fragment, _n as normalizeClass, bt as withDirectives, ft as useSlots, gt as watch, it as renderSlot, j as createVNode, p as vShow, pt as useTemplateRef, q as onBeforeUnmount, rt as renderList, w as createBlock, yn as normalizeStyle, yt as withCtx } from "./vue.runtime.esm-bundler-Bw8GKr4Y.js";
import { F as isObject, H as toRef, I as noop, K as tryOnScopeDispose, M as directiveHooks, N as isClient, P as isIOS, W as toValue$1, at as useI18n, b as useResizeObserver$1, n as onClickOutside$1, ot as I18nT, p as useElementSize$1, t as computedAsync } from "./core-gptzu9Ct.js";
import { $i as N8nIcon_default, E as N8nTabs_default, N as N8nRadioButtons_default, Ni as N8nIconButton_default, Oi as N8nTooltip_default, Ot as N8nBlockUi_default, Qi as N8nButton_default, R as N8nNotice_default, Xi as N8nCallout_default, Zi as N8nText_default, h as N8nInlineTextEdit_default, lt as useRoute, qt as ElCollapseTransition } from "./src-Bvr7jqKz.js";
import { t as require_get } from "./get-Den8eczo.js";
import { t as _plugin_vue_export_helper_default } from "./_plugin-vue_export-helper-Da88TEg1.js";
import "./_MapCache-Cl68hVFF.js";
import { Et as useWorkflowHelpers, In as useExternalHooks, Nt as importCurlEventBus, Pn as useToast, Si as ProjectTypes, T as useActionsGenerator, Va as COMMUNITY_NODES_INSTALLATION_DOCS_URL, Wa as COMMUNITY_PACKAGE_INSTALL_MODAL_KEY, _r as useTelemetry, at as useCredentialsStore, fa as injectWorkflowDocumentStore, fr as useWorkflowsListStore, jt as ndvEventBus, mr as useNodeHelpers, ni as RenameNodeCommand, qr as useHistoryStore, r as useUIStore, s as useWorkflowsStore, t as useUsersStore, w as useNodeTypesStore, xr as useNDVStore, z as removePreviewToken } from "./users.store-BCts_jcD.js";
import { D as NodeCredentials_default, O as useNodeCredentialOptions, f as collectParametersByTab, g as getNodeSettingsInitialValues, j as TitledList_default, m as createCommonNodeSettings, p as collectSettings, s as useNodeSettingsParameters, t as ParameterInputList_default, y as nameIsParameter } from "./ParameterInputList-KlqkNB_Y.js";
import { n as ElRow, t as ElCol } from "./col-CIE8ZYQt.js";
import { Cn as MCP_TRIGGER_NODE_TYPE, Co as getNodeInputs, N as CUSTOM_API_CALL_KEY, Pt as CHAT_TRIGGER_NODE_TYPE, Rn as OPEN_URL_PANEL_TRIGGER_NODE_TYPES, To as getNodeParameters, Ut as DATA_TABLE_NODES, Vn as PRODUCTION_ONLY_TRIGGER_NODE_TYPES, an as FORM_TRIGGER_NODE_TYPE, c as CUSTOM_NODES_DOCS_URL, i as BASE_NODE_SURVEY_URL, ns as deepCopy, o as BUILTIN_NODES_DOCS_URL, rs as isCommunityPackageName, v as NPM_PACKAGE_DOCS_BASE_URL, xs as NodeConnectionTypes, zr as VIEWS } from "./constants-CjIW4CHX.js";
import { t as useSettingsStore } from "./settings.store-BOIB94F8.js";
import { t as useDebounce } from "./useDebounce-e3LbKupr.js";
import { t as useDataTableStore } from "./dataTable.store-BmHi2-yw.js";
import { t as useClipboard } from "./useClipboard-Ds9n9yq9.js";
import { n as getNodeIconSource } from "./nodeIcon-gnzyxTjI.js";
...
import { t as useQuickConnect } from "./useQuickConnect-BxXF15-n.js";
...
import { t as useFreeAiCredits } from "./useFreeAiCredits-DLn3XtFi.js";
import { i as QuickConnectBanner_default, n as CommunityNodeFooter_default, r as useInstalledCommunityPackage, t as CommunityNodeUpdateInfo_default } from "./CommunityNodeUpdateInfo-BD2xhb5u.js";
...
var NodeSettings_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props, { emit: __emit }) {
		...
		const initialHasExecutionData = !!initialNode && !!workflowsStore.getWorkflowRunData?.[initialNode.name]?.length;
		const openPanel = ref(props.readOnly && initialHasExecutionData ? "output" : "params");
		...
		const currentWorkflow = computed(() => workflowsListStore.getWorkflowById(workflowsStore.workflowId));
		...
		const nodeSettings = computed(() => createCommonNodeSettings(isToolNode.value || isModelNode.value, i18n.baseText.bind(i18n)));
		...
		watch(node, (newNode, oldNode) => {
			setNodeValues();
			if (newNode?.name !== oldNode?.name && props.readOnly) openPanel.value = !!newNode && !!workflowsStore.getWorkflowRunData?.[newNode.name]?.length ? "output" : "params";
		});
		onMounted(async () => {
				...
				node.value && nodeValid.value ? (openBlock(), createElementBlock("div", {
					...
					withDirectives(createBaseVNode("div", null, [
						...
						nodeValuesInitialized.value ? (openBlock(), createBlock(ParameterInputList_default, {
							...
							}, null, 8, ["text", "class"])) : createCommentVNode("", true), !__props.isEmbeddedInCanvas && !isDemoPreview.value ? (openBlock(), createBlock(NodeCredentials_default, {
								key: 1,
								node: node.value,
								readonly: isReadOnly.value,
								"show-all": true,
...
var NodeSettings_default = /* @__PURE__ */ _plugin_vue_export_helper_default(NodeSettings_vue_vue_type_script_setup_true_lang_default, [["__cssModules", { "$style": NodeSettings_vue_vue_type_style_index_0_lang_module_default }], ["__scopeId", "data-v-871e56cf"]]);
//#endregion
