...
import { $ as openBlock, A as createTextVNode, C as createBaseVNode, Cn as toDisplayString, E as createElementBlock, Gt as unref, I as h, It as ref, N as defineComponent, S as computed, T as createCommentVNode, Ut as toValue, X as onMounted, _ as Fragment, bn as normalizeStyle, bt as withCtx, ft as useSlots, gt as watch, it as renderSlot, j as createVNode, p as vShow, pt as useTemplateRef, q as onBeforeUnmount, rt as renderList, vn as normalizeClass, w as createBlock, xt as withDirectives } from "./vue.runtime.esm-bundler-Bs4WIMNP.js";
import { c as I18nT, s as useI18n } from "./src-CvPjLYa0.js";
import { Ja as N8nButton_default, Ka as N8nCallout_default, Pt as N8nBlockUi_default, W as N8nNotice_default, Wi as N8nIconButton_default, Ya as N8nIcon_default, en as ElCollapseTransition, gt as useRoute, k as N8nTabs_default, qa as N8nText_default, y as N8nInlineTextEdit_default, z as N8nRadioButtons_default, zi as N8nTooltip_default } from "./src-CSWS3PCK.js";
import { t as require_get } from "./get-CDrcd2Fp.js";
import { t as _plugin_vue_export_helper_default } from "./_plugin-vue_export-helper-Da88TEg1.js";
import "./_MapCache-Cwo_kzI3.js";
import { F as isObject, H as toRef, I as noop, K as tryOnScopeDispose, M as directiveHooks, N as isClient, P as isIOS, W as toValue$1, b as useResizeObserver$1, n as onClickOutside$1, p as useElementSize$1, t as computedAsync } from "./core-CxAuVuwP.js";
import { f as collectParametersByTab, g as getNodeSettingsInitialValues, m as createCommonNodeSettings, p as collectSettings, s as useNodeSettingsParameters, t as ParameterInputList_default, y as nameIsParameter } from "./ParameterInputList-DOSBnRaZ.js";
import { n as ElRow, t as ElCol } from "./col-D_Uw1pu3.js";
import { t as useToast } from "./useToast-THYqqSsb.js";
import { Dc as getNodeParameters, En as MCP_TRIGGER_NODE_TYPE, Gn as PRODUCTION_ONLY_TRIGGER_NODE_TYPES, Hn as OPEN_URL_PANEL_TRIGGER_NODE_TYPES, I as CUSTOM_API_CALL_KEY, Kt as DATA_TABLE_NODES, Lt as CHAT_TRIGGER_NODE_TYPE, Tc as getNodeInputs, a as BASE_NODE_SURVEY_URL, cn as FORM_TRIGGER_NODE_TYPE, dl as deepCopy, fl as isCommunityPackageName, il as NodeConnectionTypes, l as CUSTOM_NODES_DOCS_URL, s as BUILTIN_NODES_DOCS_URL, ui as VIEWS, x as NPM_PACKAGE_DOCS_BASE_URL } from "./constants-BpExsFUJ.js";
import { Cn as ProjectTypes, Ht as injectNDVStore, Mt as useWorkflowHelpers, Pt as useWorkflowId, R as removePreviewToken, _ as useNodeTypesStore, a as injectWorkflowDocumentStore, at as useCredentialsStore, y as useActionsGenerator } from "./workflowDocument.store-B8Lg41Xq.js";
import { t as useSettingsStore } from "./settings.store-Bzrrgc0p.js";
import { D as COMMUNITY_PACKAGE_INSTALL_MODAL_KEY, f as useUIStore, p as useTelemetry, t as useUsersStore, w as COMMUNITY_NODES_INSTALLATION_DOCS_URL } from "./users.store-D_2YlqZ_.js";
import { t as useDebounce } from "./useDebounce-CmtJy2cP.js";
import { t as useWorkflowsListStore } from "./workflowsList.store-Bm-9RAXi.js";
import { t as useExternalHooks } from "./useExternalHooks-BJ87mufY.js";
import { n as ndvEventBus } from "./useCodeDiff-CP4M3zOS.js";
import { n as useHistoryStore, p as RenameNodeCommand, t as useNodeHelpers } from "./useNodeHelpers-DN73byk0.js";
...
import { a as TitledList_default, n as useNodeCredentialOptions, t as NodeCredentials_default } from "./NodeCredentials-BRtsk2ZM.js";
import { n as useNodeIconSource, t as NodeIcon_default } from "./NodeIcon-C-JlFM-D.js";
import { n as NodeExecuteButton_default } from "./VirtualSchema-DSRWr9J2.js";
import { t as useFreeAiCredits } from "./useFreeAiCredits-CrIImSXn.js";
import { i as QuickConnectBanner_default, n as CommunityNodeFooter_default, r as useInstalledCommunityPackage, t as CommunityNodeUpdateInfo_default } from "./CommunityNodeUpdateInfo-BhDGlDAd.js";
import { t as useActions } from "./useActions-CktHTFZY.js";
...
var NodeSettings_default = /* @__PURE__ */ _plugin_vue_export_helper_default(NodeSettings_vue_vue_type_script_setup_true_lang_default, [["__cssModules", { "$style": NodeSettings_vue_vue_type_style_index_0_lang_module_default }], ["__scopeId", "data-v-51cd0f8f"]]);
//#endregion
