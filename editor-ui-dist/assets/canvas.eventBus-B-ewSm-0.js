...
import { Ft as ref, S as computed, W as nextTick } from "./vue.runtime.esm-bundler-C6vn67cX.js";
import { s as useI18n } from "./src-WwCUXbmD.js";
import { Ot as createEventBus } from "./src-DFOx8N22.js";
import { a as require_toString, o as require__arrayMap, t as require_get } from "./get-G8yCCFQ6.js";
import { $ as getAiTemplatesCallout, Et as require_upperFirst, Fi as CanvasConnectionMode, Ni as isVueFlowConnection, Q as flattenCreateElements, Qn as getThemedValue, Y as useEvaluationStore, Z as finalizeItems, Zr as createCanvasConnectionHandleString, at as mapToolSubcategoryIcon, b as injectWorkflowDocumentStore, dn as useNDVStore, dt as sortNodeCreateElements, ft as subcategorizeItems, ii as parseCanvasConnectionHandleString, lt as searchNodes, nt as groupItemsInSections, ot as nodeTypesToCreateElements, pt as transformNodeType, q as useNodeTypesStore, rt as isAINode, st as prepareCommunityNodeDetailsViewStack, t as useWorkflowsStore, v as createWorkflowDocumentId, x as useWorkflowDocumentStore } from "./workflows.store-Cc2IYz8o.js";
import { $ as AI_CATEGORY_TOOLS, $s as isCommunityPackageName, As as isHitlToolType, B as AI_CATEGORY_AGENTS, Dt as AI_TRANSFORM_NODE_TYPE, Et as AI_MCP_TOOL_NODE_TYPE, Fo as require__createCompounder, G as AI_CATEGORY_LANGUAGE_MODELS, Gc as v4, Gn as REMOVE_DUPLICATES_NODE_TYPE, Gt as DATETIME_NODE_TYPE, H as AI_CATEGORY_DOCUMENT_LOADERS, Ht as CRYPTO_NODE_TYPE, It as CODE_NODE_TYPE, J as AI_CATEGORY_OTHER_TOOLS, K as AI_CATEGORY_MCP_NODES, Lt as COMPRESSION_NODE_TYPE, Mc as EVALUATION_TRIGGER_NODE_TYPE, Pt as CHAT_TRIGGER_NODE_TYPE, Q as AI_CATEGORY_TEXT_SPLITTERS, Qc as require__SetCache, Qn as SET_NODE_TYPE, Qo as require__arrayIncludes, Rt as CONVERT_TO_FILE_NODE_TYPE, Sn as MARKDOWN_NODE_TYPE, So as require__baseFlatten, Tn as MESSAGE_AN_AGENT_NODE_TYPE, U as AI_CATEGORY_EMBEDDING, V as AI_CATEGORY_CHAINS, Wt as DATA_TABLE_NODE_TYPE, X as AI_CATEGORY_RETRIEVERS, Xt as EMAIL_SEND_NODE_TYPE, Y as AI_CATEGORY_OUTPUTPARSER, Yn as SCHEDULE_TRIGGER_NODE_TYPE, Yt as EMAIL_IMAP_NODE_TYPE, Z as AI_CATEGORY_ROOT_NODES, Zc as require__cacheHas, Zo as require__arrayIncludesWith, _t as REGULAR_NODE_CREATOR_VIEW, an as FORM_TRIGGER_NODE_TYPE, at as AI_UNCATEGORIZED_CATEGORY, br as XML_NODE_TYPE, bt as TRANSFORM_DATA_SUBCATEGORY, cn as HTML_NODE_TYPE, ct as CORE_NODES_CATEGORY, dt as HITL_SUBCATEGORY, et as AI_CATEGORY_VECTOR_STORES, fn as IF_NODE_TYPE, ft as HUMAN_IN_THE_LOOP_CATEGORY, gc as NodeConnectionTypes, ht as OTHER_TRIGGER_NODES_SUBCATEGORY, ir as SPLIT_OUT_NODE_TYPE, ln as HTTP_REQUEST_NODE_TYPE, lt as FLOWS_CONTROL_SUBCATEGORY, mr as WEBHOOK_NODE_TYPE, mt as NODE_CREATOR_OPEN_SOURCES, nn as EXTRACT_FROM_FILE_NODE_TYPE, ot as AI_WORKFLOW_TOOL_LANGCHAIN_NODE_TYPE, pt as NEW_TOOL_CATEGORIES, q as AI_CATEGORY_MEMORY, qn as RSS_READ_NODE_TYPE, qt as EDIT_IMAGE_NODE_TYPE, rn as FILTER_NODE_TYPE, rr as SPLIT_IN_BATCHES_NODE_TYPE, rt as AI_OTHERS_NODE_CREATOR_VIEW, sr as SUMMARIZE_NODE_TYPE, tn as EXECUTE_WORKFLOW_TRIGGER_NODE_TYPE, tt as AI_CODE_TOOL_LANGCHAIN_NODE_TYPE, ut as HELPERS_SUBCATEGORY, vn as LIMIT_NODE_TYPE, wn as MERGE_NODE_TYPE, wt as AGGREGATE_NODE_TYPE, xn as MANUAL_TRIGGER_NODE_TYPE, xt as TRIGGER_NODE_CREATOR_VIEW, ys as getNodeInputs, yt as TEMPLATE_CATEGORY_AI } from "./constants-BMUE7W6Y.js";
import { E as require__baseUnary, d as require_isArrayLikeObject, r as require__baseRest } from "./merge-Dxq-OM4r.js";
import { T as defineStore } from "./useRootStore-BOF8LYEF.js";
...
import { n as getNodeIconSource } from "./nodeIcon-OIlgWClq.js";
