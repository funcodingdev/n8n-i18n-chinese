...
(function () {
  System.register(["./vue.runtime.esm-bundler-legacy--Sn1h8On.js", "./useTelemetry-legacy-CMfwYwVY.js", "./constants-legacy-8iZaMHMx.js", "./_baseOrderBy-legacy-Bls-fMH1.js"], function (_export, _context) {
    ...
    var computed, ref, createProjectRole, deleteProjectRole, updateProjectRole, getRoles, getRoleBySlug, PROJECT_OWNER_ROLE_SLUG, defineStore, useRootStore, useRolesStore;
    return {
      setters: [function (_vueRuntimeEsmBundlerLegacy003Js) {
        computed = _vueRuntimeEsmBundlerLegacy003Js.C;
        ref = _vueRuntimeEsmBundlerLegacy003Js.It;
      }, function (_useTelemetryLegacy00HJs) {
        createProjectRole = _useTelemetryLegacy00HJs.ds;
        deleteProjectRole = _useTelemetryLegacy00HJs.fs;
        updateProjectRole = _useTelemetryLegacy00HJs.hs;
        getRoles = _useTelemetryLegacy00HJs.ms;
        getRoleBySlug = _useTelemetryLegacy00HJs.ps;
      }, function (_constantsLegacy00TJs) {
        PROJECT_OWNER_ROLE_SLUG = _constantsLegacy00TJs.jo;
