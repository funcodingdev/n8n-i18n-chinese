const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/es-CXDaOaTK.js","assets/core-XmFv11t6.js","assets/chunk-r2Y0G7H8.js","assets/languageModules-BuE9f-Dd.js","assets/xml-BMqNMrYo.js"])))=>i.map(i=>d[i]);
import { o as __toESM, t as __commonJSMin } from "./chunk-r2Y0G7H8.js";
import { C as computed, Cn as toDisplayString, D as createElementBlock, E as createCommentVNode, G as nextTick, Gt as unref, It as ref, J as onBeforeUnmount, M as createVNode, P as defineComponent, T as createBlock, _ as Fragment, _t as watch, b as Teleport, bn as normalizeStyle, bt as withCtx, c as useCssModule, et as openBlock, h as withModifiers, it as renderList, j as createTextVNode, mt as useTemplateRef, n as Transition, q as onBeforeMount, vn as normalizeClass, w as createBaseVNode } from "./vue.runtime.esm-bundler-XtMkEjzB.js";
import { F as useScroll, L as useSpeechRecognition, M as useLocalStorage, N as useMediaQuery, R as useSpeechSynthesis, bt as I18nT, yt as useI18n } from "./_MapCache-0tqKZ63u.js";
import { Ii as N8nHeading_default, Li as N8nCallout_default, Mi as truncate, Oi as Input_default, Ri as N8nText_default, Ti as require_markdown_it_link_attributes, Tt as useDeviceSupport, Vi as N8nIcon_default, Wi as __vitePreload, bi as useRouter, fi as N8nLink_default, gt as N8nCard_default, ki as N8nIconButton_default, s as N8nScrollArea_default, wi as N8nTooltip_default, yi as useRoute, zi as N8nButton_default } from "./src-y1U2VbqR.js";
import { t as __plugin_vue_export_helper_default } from "./_plugin-vue_export-helper-DltO58Gh.js";
import "./sanitize-html-DjneYy0u.js";
import { cn as useDocumentTitle, gr as useToast, hs as useSettingsStore, jr as v4_default, mr as hasRole, or as hasPermission, r as useUIStore, s as useWorkflowsStore, t as useUsersStore, yo as INVITE_USER_MODAL_KEY } from "./users.store-ACeMu33y.js";
import { $r as ROLE, Bc as EnterpriseEditionFeature, Gs as LOCAL_STORAGE_CHAT_HUB_SELECTED_TOOLS, Si as INodesSchema, Us as LOCAL_STORAGE_CHAT_HUB_HAD_CONVERSATION_BEFORE, Ws as LOCAL_STORAGE_CHAT_HUB_SELECTED_MODEL, ii as chatHubConversationModelSchema, ni as PROVIDER_CREDENTIAL_TYPE_MAP, ts as VIEWS } from "./constants-Cf-1GDJg.js";
...
import { t as usePageRedirectionHelper } from "./usePageRedirectionHelper-CZRAKr2A.js";
import { t as useClipboard } from "./useClipboard-CqJB6UAE.js";
import "./nodeIcon-BEBhQ4Ga.js";
import { t as VueMarkdown_default } from "./VueMarkdown-BAtN2bel.js";
import { t as CredentialIcon_default } from "./CredentialIcon-C4H2PStn.js";
import "./NodeIcon-CxAnFHRw.js";
import { t as usePushConnectionStore } from "./pushConnection.store-B3bwHrSo.js";
import { t as useFreeAiCredits } from "./useFreeAiCredits-DQrOWqoO.js";
import "./dist-Cpx_JWJl.js";
import { _ as TOOLS_SELECTOR_MODAL_KEY, h as MOBILE_MEDIA_QUERY, l as CHAT_VIEW, n as CHAT_CONVERSATION_VIEW, t as AGENT_EDITOR_MODAL_KEY, v as providerDisplayNames } from "./constants-Yls1RScR.js";
import { a as findOneFromModelsResponse, b as buildChatAttachmentUrl, d as isEditable, f as isLlmProvider, g as splitMarkdownIntoChunks, m as isRegenerable, p as isLlmProviderModel, r as createMimeTypes, t as useChatStore, v as unflattenModel } from "./chat.store-QQOycjaf.js";
import { t as ChatAgentAvatar_default } from "./ChatAgentAvatar-CTfoNRC7.js";
import { t as ChatFile_default } from "./ChatFile-BrXecLHH.js";
import { n as useChatCredentials, r as chatHubConversationModelWithCachedDisplayNameSchema, t as ChatLayout_default } from "./ChatLayout-DVakA6nA.js";
import { n as ToolsSelector_default, r as ModelSelector_default, t as useCustomAgent } from "./useCustomAgent-D-hyYdyh.js";
...
var ChatMessageActions_default = /* @__PURE__ */ __plugin_vue_export_helper_default(ChatMessageActions_vue_vue_type_script_setup_true_lang_default, [["__cssModules", { "$style": ChatMessageActions_vue_vue_type_style_index_0_lang_module_default }], ["__scopeId", "data-v-f2e85e25"]]);
			...
			class Parser {
				...
				parseSymbol() {
					...
					if (match) for (let i = 0; i < match[0].length; i++) {
						...
						const command = unicodeAccents[accent$1][this.mode] || unicodeAccents[accent$1].text;
						if (!command) throw new src_ParseError("Accent " + accent$1 + " unsupported in " + this.mode + " mode", nucleus);
						symbol = {
							type: "accent",
							mode: this.mode,
							loc: SourceLocation.range(nucleus),
...
function useChatHubMarkdownOptions(codeBlockActionsClassName, tableContainerClassName) {
	...
	async function loadLanguageModules() {
		...
		try {
			asyncImport = {
				status: "inProgress",
				promise: Promise.all([__vitePreload(() => import("./es-CXDaOaTK.js"), __vite__mapDeps([0,1,2])), __vitePreload(() => import("./languageModules-BuE9f-Dd.js"), __vite__mapDeps([3,4]))])
			};
...
var ChatMarkdownChunk_vue_vue_type_style_index_0_lang_module_default = {
	chatMessageMarkdown: "_chatMessageMarkdown_wsqgd_125",
	codeBlockActions: "_codeBlockActions_wsqgd_237",
	tableContainer: "_tableContainer_wsqgd_307"
};
...
var ChatMessage_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props, { expose: __expose, emit: __emit }) {
		...
		const messageContent = computed(() => __props.message.content);
		const markdownChunkRefs = ref([]);
		const activeCodeBlockTeleport = computed(() => {
			for (const chunkRef of markdownChunkRefs.value) if (chunkRef?.hoveredCodeBlockActions) {
		...
		const messageChunks = computed(() => {
			if (__props.message.status === "error" && !__props.message.content) return [i18n.baseText("chatHub.message.error.unknown")];
			return splitMarkdownIntoChunks(__props.message.content).filter((chunk) => chunk.trim() !== "");
		});
		...
		return (_ctx, _cache) => {
			return !hideMessage.value ? (openBlock(), createElementBlock("div", {
			...
			}), 128))], 2)) : createCommentVNode("", true), __props.message.type === "human" ? (openBlock(), createElementBlock("div", _hoisted_2, toDisplayString(__props.message.content), 1)) : (openBlock(), createElementBlock("div", {
				key: 2,
				...
				return openBlock(), createBlock(ChatMarkdownChunk_default, {
					key: index,
					ref_for: true,
					ref: (el) => markdownChunkRefs.value[index] = el,
					source: chunk
				}, null, 8, ["source"]);
			}), 128)), activeCodeBlockTeleport.value ? (openBlock(), createBlock(Teleport, {
				key: 0,
				to: activeCodeBlockTeleport.value.target
			}, [createVNode(CopyButton_default, { content: activeCodeBlockTeleport.value.content }, null, 8, ["content"])], 8, ["to"])) : createCommentVNode("", true)], 2))], 2), __props.message.status === "running" ? (openBlock(), createBlock(ChatTypingIndicator_default, {
				key: 0,
			...
			]))], 64))], 2)], 14, _hoisted_1$1)) : createCommentVNode("", true);
		};
	}
});
var ChatMessage_vue_vue_type_style_index_0_lang_module_default = {
	message: "_message_m51bt_125",
	markdownContent: "_markdownContent_m51bt_130",
	codeBlockActions: "_codeBlockActions_m51bt_137",
	avatar: "_avatar_m51bt_141",
	compact: "_compact_m51bt_154",
	content: "_content_m51bt_159",
	actions: "_actions_m51bt_165",
	attachments: "_attachments_m51bt_171",
	chatMessage: "_chatMessage_m51bt_176",
	user: "_user_m51bt_189",
	errorMessage: "_errorMessage_m51bt_199",
	editContainer: "_editContainer_m51bt_226",
	textarea: "_textarea_m51bt_241",
	fileInput: "_fileInput_m51bt_254",
	editFooter: "_editFooter_m51bt_258",
	editActions: "_editActions_m51bt_264",
	typingIndicator: "_typingIndicator_m51bt_270"
};
...
var ChatView_vue_vue_type_style_index_0_lang_module_default = {
	chatLayout: "_chatLayout_km18p_125",
	scrollArea: "_scrollArea_km18p_129",
	scrollable: "_scrollable_km18p_134",
	isNewSession: "_isNewSession_km18p_143",
	header: "_header_km18p_147",
	messageList: "_messageList_km18p_153",
	isMobileDevice: "_isMobileDevice_km18p_165",
	promptContainer: "_promptContainer_km18p_169",
	isExistingSession: "_isExistingSession_km18p_173",
	prompt: "_prompt_km18p_169",
	scrollToBottomButton: "_scrollToBottomButton_km18p_191",
	isDraggingFile: "_isDraggingFile_km18p_199",
	dropOverlay: "_dropOverlay_km18p_203"
};
