...
import { Zn as ResponseError, sr as STORES, t as useRootStore, ur as defineStore } from "./useRootStore-B-A2Ktsc.js";
...
import { c as getWorkflowWriteLock, t as useWorkflowsListStore } from "./workflowsList.store-DR9pamv2.js";
...
var useCollaborationStore = defineStore(STORES.COLLABORATION, () => {
	...
	*/
	...
	const startLockStatePolling = (workflowId) => {
		if (lockStatePollingSuspended) return;
		stopLockStatePolling();
