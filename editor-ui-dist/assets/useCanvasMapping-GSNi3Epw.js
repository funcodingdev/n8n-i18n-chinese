...
import { _ as onKeyDown, lt as watchOnce, st as useThrottleFn, ut as watchThrottled, y as onKeyUp, yt as useI18n } from "./_MapCache-BBTLzXgM.js";
import { At as N8nActionDropdown_default, Di as useRouter, Ei as useRoute, Fi as N8nIconButton_default, G as N8nPopover_default, Gi as N8nButton_default, Ki as N8nIcon_default, Mt as useDeviceSupport, R as N8nSticky_default, Wi as N8nText_default, bt as createEventBus, ji as N8nTooltip_default, yi as N8nLink_default } from "./src-BITqouBc.js";
import { t as __plugin_vue_export_helper_default } from "./_plugin-vue_export-helper-DltO58Gh.js";
import { $n as _sfc_main$1, An as CONFIGURATION_NODE_RADIUS, Bt as injectWorkflowState, Ci as CanvasNodeDirtiness, Dr as useStyles, Ft as useNodeHelpers, Hn as getMousePosition, In as calculateNodeSize, Jn as MarkerType, Jr as injectWorkflowDocumentStore, Kr as createWorkflowDocumentId, Lr as useFocusedNodesStore, Mn as DEFAULT_NODE_SIZE, Nt as environments_store_default, On as useTemplatesStore, Pn as GRID_SIZE, Qn as _sfc_main$5, Si as CanvasConnectionMode, Xn as PanelPosition, Yn as NodeId, Yr as useWorkflowDocumentStore, Zn as Position, ar as getBoundsofRects, at as useCredentialsStore, cr as getSmoothStepPath, dl as sanitizeHtml, dr as useVueFlow, ea as getTriggerNodeServiceName, er as _sfc_main$3, fn as nodeViewEventBus, fr as wheelDelta, hr as trackTemplatesClick, ir as getBezierPath, jr as useSourceControlStore, js as useSettingsStore, lr as isMacOs, mr as isExtraTemplateLinksExperimentEnabled, nr as _sfc_main$f, or as getConnectedEdges, pr as TemplateClickSource, qn as updateViewportToContainNodes, r as useUIStore, rr as clamp, s as useWorkflowsStore, sr as getRectOfNodes, t as useUsersStore, tr as _sfc_main$d, ul as isOutsideSelected, ur as useGetPointerPosition, vi as isValidNodeConnectionType, w as useNodeTypesStore, wi as CanvasNodeRenderType, xa as isPresent, zt as useNDVStore } from "./users.store-BPj3XTmq.js";
import { M as TitledList_default } from "./ParameterInputList-DM1D7R4G.js";
import { Cr as WAIT_NODE_TYPE, Da as isNodeWithWorkflowSelector, Ea as isHitlToolType, Ec as CanvasNodeKey, Fo as SEND_AND_WAIT_OPERATION, Gt as CHAT_TRIGGER_NODE_TYPE, I as CUSTOM_API_CALL_KEY, Ja as isCommunityPackageName, Lo as WAIT_INDEFINITELY, Nt as AGENT_NODE_TYPE, Oc as ExpressionLocalResolveContextSymbol, Pt as AGENT_TOOL_NODE_TYPE, Qn as PRODUCTION_ONLY_TRIGGER_NODE_TYPES, Qo as getResourcePermissions, Ro as WEBHOOK_NODE_TYPE, Sa as getSubworkflowId, Ta as isExecutable, Tc as CanvasNodeHandleKey, Tt as NODE_CREATOR_OPEN_SOURCES, Wn as NOT_DUPLICATABLE_NODE_TYPES, ca as mapConnectionsByDestination, cs as VIEWS, dr as SIMULATE_TRIGGER_NODE_TYPE, fo as NodeConnectionTypes, ga as getNodeOutputs, gr as STICKY_NODE_TYPE, ha as getNodeInputs, hn as FORM_NODE_TYPE, ol as CANVAS_EXECUTION_DATA_THROTTLE_DURATION, ur as SIMULATE_NODE_TYPE, wc as CanvasKey, zo as require_isEqual } from "./constants-CBEYCjLn.js";
import { t as useAssistantStore } from "./assistant.store-LdlH3WUn.js";
import { t as useChatPanelStore } from "./chatPanel.store-D1ORbh3l.js";
import { t as usePinnedData } from "./usePinnedData-DQ8vywD3.js";
import { t as getNodeIconSource } from "./nodeIcon-CzAlSpGu.js";
import { c as parseCanvasConnectionHandleString, n as createCanvasConnectionHandleString, o as mapLegacyConnectionsToCanvasConnections, r as insertSpacersBetweenEndpoints, s as mapLegacyEndpointsToCanvasConnectionPort, t as checkOverlap } from "./canvas.utils-CjCJ8R_v.js";
import { n as useNodeCreatorStore } from "./canvas.eventBus-kPSHTKdE.js";
...
import { r as useNodeDirtiness, t as useRunWorkflow } from "./useRunWorkflow-gqN-Mw6J.js";
import { t as useCollaborationStore } from "./collaboration.store-KWYjj5lF.js";
import { t as NodeSettings_default } from "./NodeSettings-edCVBIMs.js";
...
import { t as NODE_CREATOR_SHORTCUT_COACHMARK_KEY } from "./useNodeCreatorShortcutCoachmark-nHpSNDJQ.js";
...
function useContextMenuItems(targetNodeIds) {
	...
	const hasPinData = (node$1) => {
		return !!(workflowsStore.workflowId ? useWorkflowDocumentStore(createWorkflowDocumentId(workflowsStore.workflowId)) : void 0)?.pinData?.[node$1.name];
	};
	...
	return computed(() => {
		...
		const aiActions = [!onlyStickies && focusedNodesStore.isFeatureEnabled && {
...
var Canvas_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props, { expose: __expose, emit: __emit }) {
		...
		function onNodeClick({ event, node: node$1 }) {
			if (chatPanelStore.isOpen && focusedNodesStore.isFeatureEnabled) focusedNodesStore.confirmNodes([node$1.id], "canvas_selection");
...
var Canvas_default = /* @__PURE__ */ __plugin_vue_export_helper_default(Canvas_vue_vue_type_script_setup_true_lang_default, [["__cssModules", { "$style": Canvas_vue_vue_type_style_index_0_lang_module_default }], ["__scopeId", "data-v-6746c5ff"]]);
