...
import { $ as openBlock, $t as hyphenate, A as createTextVNode, At as isRef, Bt as toRef, C as createBaseVNode, D as createPropsRestProxy, E as createElementBlock, Et as getCurrentScope, Ft as ref, Ht as toValue$1, I as h, It as shallowReactive, K as onBeforeMount, Mt as onScopeDispose, N as defineComponent, Nt as reactive, P as getCurrentInstance, Pt as readonly, R as inject, Rt as shallowRef, S as computed, Sn as toDisplayString, T as createCommentVNode, Tt as effectScope, U as mergeProps, Vt as toRefs$1, W as nextTick, Wt as unref, X as onMounted, Z as onUnmounted, _ as Fragment, _n as normalizeClass, at as resolveComponent, bt as withDirectives, en as init_shared_esm_bundler, ft as useSlots, gt as watch, i as createApp, it as renderSlot, j as createVNode, jt as markRaw, lt as useAttrs, n as Transition$1, ot as resolveDirective, p as vShow, pn as isString$1, q as onBeforeUnmount, rt as renderList, sn as isObject$1, st as resolveDynamicComponent, tt as provide, w as createBlock, wt as customRef, y as Teleport, yn as normalizeStyle, yt as withCtx, z as isMemoSame } from "./vue.runtime.esm-bundler-C6vn67cX.js";
import { i as i18n, n as addHeaders, r as addNodeTranslation, s as useI18n } from "./src-WwCUXbmD.js";
import { Ci as isClient$1, I as isBinary, Ot as createEventBus, _r as removeClass, hr as getStyle, ht as useRoute, pr as addClass, qi as truncate, vn as useGlobalComponentSettings } from "./src-DFOx8N22.js";
import { a as require_toString, s as require_memoize, t as require_get, u as require_lib } from "./get-G8yCCFQ6.js";
import { $c as ApplicationError, $o as require__baseFindIndex, A as IN_PROGRESS_EXECUTION_ID, An as NODE_POSITION_CONFLICT_ALLOWLIST, As as isHitlToolType, B as AI_CATEGORY_AGENTS, Bt as CREDENTIAL_ONLY_NODE_PREFIX, C as TEMPLATES_NODES_FILTER, Cl as CanvasRenderDataKey, Cs as getNodeWebhookUrl, D as ALLOWED_HTML_TAGS, Dt as AI_TRANSFORM_NODE_TYPE, E as ALLOWED_HTML_ATTRIBUTES, Ec as BINARY_MODE_SEPARATE, Eo as isAssignmentCollectionValue, Et as AI_MCP_TOOL_NODE_TYPE, Fo as require__createCompounder, Fs as mergeIssues, Gc as v4, Hs as isFilterValue, I as MAPPING_PARAMS, J as AI_CATEGORY_OTHER_TOOLS, Js as isResourceLocatorValue, K as AI_CATEGORY_MCP_NODES, Ko as traverseNodeParameters, Mn as NON_ACTIVATABLE_TRIGGER_NODE_TYPES, N as CUSTOM_API_CALL_KEY, Oc as CHAT_TRIGGER_NODE_TYPE, On as MODULE_ENABLED_NODES, P as DATA_TYPE_ICON_MAP, Ps as makeNodeName, Qs as deepCopy, Rc as MANUAL_TRIGGER_NODE_TYPE, Ro as require__baseIteratee, So as require__baseFlatten, Ss as getNodeParametersIssues, Vc as SEND_AND_WAIT_OPERATION, W as AI_CATEGORY_HUMAN_IN_THE_LOOP, Xo as require__baseUniq, Yc as require_keys, Yn as SCHEDULE_TRIGGER_NODE_TYPE, Yo as splitExpression, Ys as isResourceMapperValue$1, Zt as ERROR_TRIGGER_NODE_TYPE$1, _c as nodeConnectionTypes, _s as displayParameterPath, ac as sleep$1, an as FORM_TRIGGER_NODE_TYPE$1, bo as require_pick, bs as getNodeOutputs, cl as getResourcePermissions, ct as CORE_NODES_CATEGORY, et as AI_CATEGORY_VECTOR_STORES, ft as HUMAN_IN_THE_LOOP_CATEGORY, fu as EnterpriseEditionFeature, gc as NodeConnectionTypes, gs as displayParameter, gt as RECOMMENDED_NODES, hr as WIKIPEDIA_TOOL_NODE_TYPE, j as PLACEHOLDER_FILLED_AT_EXECUTION_TIME, jo as Workflow, kl as WorkflowDocumentStoreKey, ln as HTTP_REQUEST_NODE_TYPE, ls as createEmptyRunExecutionData, mc as ExpressionError, mr as WEBHOOK_NODE_TYPE$1, ms as getChildNodes, oi as MAIN_HEADER_TABS, ps as mapConnectionsByDestination, qc as require_isEqual, r as DUPLICATE_POSTFFIX, si as VIEWS, st as BETA_NODES, ts as isTrimmedNodeExecutionData, tt as AI_CODE_TOOL_LANGCHAIN_NODE_TYPE, us as createRunExecutionData, vc as isExpression, vr as WORKFLOW_TRIGGER_NODE_TYPE, vs as getConnectionTypes, xs as getNodeParameters, yn as LIST_LIKE_NODE_OPERATIONS, ys as getNodeInputs, zc as MANUAL_TRIGGER_NODE_TYPES } from "./constants-BMUE7W6Y.js";
import { b as require_isArrayLike, n as require__isIterateeCall, r as require__baseRest, t as require_merge } from "./merge-Dxq-OM4r.js";
import { E as getActivePinia, T as defineStore, a as ResponseError, c as makeRestApiRequest, d as request, f as streamRequest, m as axios, s as getFullApiResponse, t as useRootStore } from "./useRootStore-BOF8LYEF.js";
import { C as updateCurrentUserSettings, Pt as getProjectSecretProviderConnectionsByProjectId, Rn as STORES, ct as fetchCommunityNodeTypes, dt as getNodeParameterOptions, ft as getNodeTranslationHeaders, gt as getResourceMapperFields, ht as getResourceLocatorResults, i as getWorkflowVersion, lt as getLocalResourceMapperFields, mt as getNodesInformation, pt as getNodeTypes$1, s as findWebhook, st as fetchCommunityNodeAttributes, t as useSettingsStore, ut as getNodeParameterActionResult } from "./settings.store-D_uIyAbF.js";
import { _ as useLocalStorage, k as createEventHook } from "./core-nZc0i8VB.js";
import { _ as useStorage, f as useUIStore, n as hasPermission, p as useTelemetry, t as useUsersStore, u as hasRole } from "./users.store-OUM63rct.js";
import { r as require_toNumber } from "./useDebounce-g_bJ4r2W.js";
import { E as getNewWorkflow, T as getLastSuccessfulExecution, _ as stringSizeInBytes, b as getObjectSizeInKB, f as isJsonKeyObject, g as shorten, h as omit, k as getWorkflows, n as useFavoritesStore, p as isPresent, t as useWorkflowsListStore, u as isEmpty, w as getExecutionData, x as isObject$2 } from "./workflowsList.store-8HiamWjt.js";
import { t as require__baseOrderBy } from "./_baseOrderBy-Bq0EI169.js";
...
var vLoading = {
	...
	updated(el, binding) {
		...
		if (binding.oldValue !== binding.value) if (binding.value && !binding.oldValue) createInstance(el, binding);
			...
			if (isObject$1(binding.value)) updateOptions(binding.value, instance.options);
...
function injectNDVStore() {
	...
	return computed(() => injected?.value?.documentId ? useNDVStore(injected.value.documentId) : fallback.value);
}
//#endregion
...
function isValidConnectionEntry(connection) {
	if (!isObject$2(connection)) return false;
...
function sanitizeConnections(connections, validNodeNames) {
	if (!isObject$2(connections)) return {};
	const sanitized = {};
	...
	for (const nodeName of Object.keys(connections)) {
		...
		if (!isObject$2(nodeConnections)) continue;
...
function useWorkflowDocumentNodes(deps) {
	...
	*/
	...
	function setNodeParameters(updateInformation, append) {
		...
		if (updateNodeAtIndex(nodeIndex, { parameters: !!append && isObject$2(updateInformation.value) ? {
			...parameters,
...
function useNodeHelpers() {
	...
	function isCustomApiCallSelected(nodeValues) {
		...
		if (!isObject$2(parameters)) return false;
	...
	*/
	...
	function workflowHasIncompatibleTrigger() {
		return workflowDocumentStore.value.workflowTriggerNodes.some((trigger) => !trigger.disabled && !MANUAL_TRIGGER_NODE_TYPES.includes(trigger.type));
	}
	function collectPrivateCredentialIssues(node, foundIssues) {
		...
		for (const [credTypeName, details] of Object.entries(node.credentials ?? {})) {
			...
			if (!credential.connectedByMe) foundIssues[credTypeName] = [i18n.baseText("nodeIssues.credentials.privateNotConnected", { interpolate: { name: credential.name } })];
			else if (incompatibleTrigger) foundIssues[credTypeName] = [i18n.baseText("nodeIssues.credentials.privateRequiresManualTrigger")];
		}
	}
...
var useWorkflowsStore = defineStore(STORES.WORKFLOWS, () => {
	...
	*/
	...
	const currentExecutionStateStore = computed(() => useWorkflowExecutionStateStore(createWorkflowDocumentId(workflowId.value)));
...
//#endregion
export { getAiTemplatesCallout as $, getTriggerNodeServiceName as $n, injectCanvasRenderData as $r, unwrapExpression as $t, useDynamicCredentials as A, isValidCredentialResponse as Ai, fetchDataTableGlobalLimitInBytes as An, MarkerType as Ar, chatWithAssistant as At, MoveNodeCommand as B, getScrollbarWidth as Bi, executionDataToJson as Bn, getBezierPath as Br, useFlattenSchema as Bt, doesNodeHaveAllCredentialsFilled as C, isProjectRole as Ci, setWorkflowSharedWith as Cn, getMousePosition as Cr, capitalCase as Ct, needsAgentInput as D, isSharedResource as Di, deleteDataTableColumnApi as Dn, getNodesWithNormalizedPosition as Dr, require__baseSlice as Dt, getParameterDisplayableOptions as E, isRouteLocationRaw as Ei, deleteDataTableApi as En, getNodesGroupSize as Er, require_upperFirst as Et, AddConnectionCommand as F, CanvasConnectionMode as Fi, moveDataTableColumnApi as Fn, _sfc_main$1 as Fr, getBuilderCredits as Ft, historyBus as G, ElLoading as Gi, getAppNameFromCredType as Gn, isMacOs as Gr, completeExpressionSyntax as Gt, RemoveNodeCommand as H, isOutsideSelected as Hi, filterTemplateNodes as Hn, getConnectedEdges as Hr, getMappedExpression as Ht, AddNodeCommand as I, CanvasNodeDirtiness as Ii, renameDataTableColumnApi as In, _sfc_main$3 as Ir, replaceCode as It, useActionsGenerator as J, getMainAuthField as Jn, wheelDelta as Jr, isPairedItemIntermediateNodesError as Jt, require_uniq as K, getAppNameFromNodeName as Kn, useGetPointerPosition as Kr, getExpressionErrorMessage as Kt, BulkCommand as L, CanvasNodeRenderType as Li, updateDataTableApi as Ln, _sfc_main$d as Lr, truncateBuilderMessages as Lt, useCanvasStore as M, isVariableResource as Mi, getDataTableRowsApi as Mn, PanelPosition as Mr, clearBuilderSession as Mt, useLoadingService as N, isVueFlowConnection as Ni, importCsvToDataTableApi as Nn, Position as Nr, generateCodeForPrompt as Nt, serializeNode as O, isString as Oi, deleteDataTableRowsApi as On, snapPositionToGrid as Or, listenForCredentialChanges as Ot, useHistoryStore as P, isWorkflowListItem as Pi, insertDataTableRowApi as Pn, _sfc_main as Pr, getAiSessions as Pt, flattenCreateElements as Q, getThemedValue as Qn, getMaxNodePortsLabelSize as Qr, stringifyExpressionResult as Qt, Command as R, capitalizeFirstLetter as Ri, updateDataTableRowsApi as Rn, _sfc_main$f as Rr, useAIAssistantHelpers as Rt, TOOL_NODE_TYPES_NEED_INPUT as S, isFullExecutionResponse as Si, moveFolderToProject as Sn, getMidCanvasPosition as Sr, require_sortBy as St, getNodeTypeDisplayableCredentials as T, isResourceSortableByDate as Ti, createDataTableApi as Tn, getNodeViewTab as Tr, require_startCase as Tt, RenameNodeCommand as U, sanitizeHtml as Ui, getActivatableTriggerNodes as Un, getRectOfNodes as Ur, getMappedResult as Ut, RemoveConnectionCommand as V, isEventTargetContainedBy as Vi, fieldCannotBeDeleted as Vn, getBoundsofRects as Vr, escapeMappingString as Vt, ReplaceNodeParametersCommand as W, sanitizeIfString as Wi, getAllNodeCredentialForAuthType as Wn, getSmoothStepPath as Wr, propertyNameFromExpression as Wt, filterAndSearchNodes as X, getNodeAuthOptions as Xn, checkOverlap as Xr, removeExpressionPrefix as Xt, useEvaluationStore as Y, getNodeAuthFields as Yn, isCredentialOnlyNodeType as Yr, isTestableExpression as Yt, finalizeItems as Z, getNodeCredentialForSelectedAuthType as Zn, createCanvasConnectionHandleString as Zr, shouldConvertToExpression as Zt, useWorkflowExecutionStateStore as _, isComponentPublicInstance as _i, useAvailableProjectSearch as _n, calculateNodeSize as _r, getTutorialTemplates as _t, executionFilterToQueryFilter as a, shouldIgnoreCanvasShortcut as ai, ensureNodePosition as an, isRequiredCredential as ar, mapToolSubcategoryIcon as at, injectWorkflowDocumentStore as b, isDateObject as bi, useSourceControlStore as bn, getBounds as br, isTemplatesWorkflow as bt, getDefaultExecutionFilters as c, getPinDataSize as ci, sortNodesByExecutionOrder as cn, parseResourceMapperFieldName as cr, removePreviewToken as ct, hasTrimmedRunData as d, useExecutionDataStore as di, useNDVStore as dn, require_toInteger as dr, sortNodeCreateElements as dt, insertSpacersBetweenEndpoints as ei, resolveParameter as en, hasExpressionMapping as er, getHumanInTheLoopActions as et, openFormPopupWindow as f, CHANGE_ACTION as fi, LOCAL_STORAGE_NDV_PANEL_WIDTH as fn, CONFIGURABLE_NODE_SIZE as fr, subcategorizeItems as ft, disposeWorkflowExecutionStateStore as g, isBinaryLike as gi, splitName as gn, PUSH_NODES_OFFSET as gr, getSampleWorkflowByTemplateId as gt, parse as h, isBaseTextKey as hi, getTruncatedProjectName as hn, DEFAULT_VIEWPORT_BOUNDARIES as hr, getRagStarterWorkflowJson as ht, displayForm as i, parseCanvasConnectionHandleString as ii, useTagsStore as in, isMatchingField as ir, isNodePreviewKey as it, useEnvFeatureFlag as j, isValidNodeConnectionType as ji, fetchDataTablesApi as jn, NodeId as jr, chatWithBuilder as jt, useNodeHelpers as k, isTriggerPanelObject as ki, downloadDataTableCsvApi as kn, updateViewportToContainNodes as kr, useCredentialsStore as kt, getExecutionErrorMessage as l, pinDataToExecutionData as li, disposeNDVStore as ln, updateNodeAuthType as lr, searchNodes as lt, waitingNodeTooltip as m, checkExhaustive as mi, ResourceType as mn, DEFAULT_NODE_SIZE as mr, SampleTemplates as mt, buildExecutionResponseFromSchema as n, mapLegacyConnectionToCanvasConnection as ni, useWorkflowHelpers as nn, hasProxyAuth as nr, groupItemsInSections as nt, executionRetryMessage as o, injectStrict as oi, removeWorkflowExecutionData as on, isResourceMapperFieldListStale as or, nodeTypesToCreateElements as ot, unflattenExecutionData as p, getPairedItemId as pi, useEnvironmentsStore as pn, CONFIGURATION_NODE_SIZE as pr, transformNodeType as pt, useNodeTypesStore as q, getAuthTypeForNodeCredential as qn, useVueFlow as qr, getResolvableState as qt, clearPopupWindowState as r, mapLegacyConnectionsToCanvasConnections as ri, useAnnotationTagsStore as rn, isAuthRelatedParameter as rr, isAINode as rt, findTriggerNodeToAutoSelect as s, DEFAULT_SETTINGS as si, sanitizeConnections as sn, isValueExpression as sr, prepareCommunityNodeDetailsViewStack as st, useWorkflowsStore as t, mapCanvasConnectionToLegacyConnection as ti, resolveRequiredParameters as tn, hasOnlyListMode as tr, getRootSearchCallouts as tt, getExecutionErrorToastConfiguration as u, createExecutionDataId as ui, injectNDVStore as un, getAllCredentials as ur, shouldShowCommunityNodeDetails as ut, createWorkflowDocumentId as v, isCredentialModalState as vi, useRemoteProjectSearch as vn, doRectsOverlap as vr, isTutorialTemplateId as vt, doesNodeHaveCredentialsToFill as w, isResourceMapperValue as wi, addDataTableColumnApi as wn, getNewNodePosition as wr, sublimeSearch as wt, useWorkflowDocumentStore as x, isDebouncedFunction as xi, ProjectTypes as xn, getGenericHints as xr, useAiGatewayStore as xt, disposeWorkflowDocumentStore as y, isCredentialsResource as yi, useProjectsStore as yn, generateOffsets as yr, isFullTemplatesCollection as yt, EnableNodeToggleCommand as z, getBannerRowHeight as zi, uploadCsvFileApi as zn, clamp as zr, useDataSchema as zt };
