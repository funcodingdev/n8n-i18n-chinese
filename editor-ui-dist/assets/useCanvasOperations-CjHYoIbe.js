...
import { C as computed, Cn as toDisplayString, D as createElementBlock, E as createCommentVNode, G as nextTick, Gt as unref, It as ref, M as createVNode, P as defineComponent, T as createBlock, W as mergeProps, _ as Fragment, at as renderSlot, bt as withCtx, ct as resolveDynamicComponent, et as openBlock, it as renderList, j as createTextVNode, jt as isRef, vn as normalizeClass, w as createBaseVNode, z as inject, zt as shallowRef } from "./vue.runtime.esm-bundler-XtMkEjzB.js";
import { M as useLocalStorage, S as useClipboard, yt as useI18n } from "./_MapCache-B254lxCP.js";
import { Di as useRouter, Ei as useRoute, Mi as require_markdown_it_link_attributes } from "./src-i9Rem1HJ.js";
import { t as __plugin_vue_export_helper_default } from "./_plugin-vue_export-helper-DltO58Gh.js";
import { Bt as injectWorkflowState, Cn as useFocusPanelStore, Di as AddNodeCommand, Ea as tryToParseNumber, Ei as AddConnectionCommand, Er as useToast, Et as useWorkflowHelpers, Fi as ReplaceNodeParametersCommand, Fn as PUSH_NODES_OFFSET, Ft as useNodeHelpers, Gn as getNodesGroupSize, Hr as usePostHog, It as useTelemetry, Kr as createWorkflowDocumentId, Ln as doRectsOverlap, Mi as RemoveConnectionCommand, Mn as DEFAULT_NODE_SIZE, Ni as RemoveNodeCommand, Nn as DEFAULT_VIEWPORT_BOUNDARIES, On as useTemplatesStore, Or as useExternalHooks, Pi as RenameNodeCommand, Pn as GRID_SIZE, Qr as v4_default, Rn as generateOffsets, Si as CanvasConnectionMode, Ti as useHistoryStore, Un as getNewNodePosition, Vt as useWorkflowState, Wt as useProjectsStore, Yr as useWorkflowDocumentStore, Zr as pinDataToExecutionData, at as useCredentialsStore, b as getExecutionErrorToastConfiguration, d as isChatNode, ji as MoveNodeCommand, jn as CONFIGURATION_NODE_SIZE, js as useSettingsStore, kn as CONFIGURABLE_NODE_SIZE, kr as useCanvasStore, kt as useTagsStore, lt as useDataSchema, r as useUIStore, s as useWorkflowsStore, vi as isValidNodeConnectionType, w as useNodeTypesStore, wi as CanvasNodeRenderType, xa as isPresent, z as removePreviewToken, zt as useNDVStore } from "./users.store-pjk3GVP4.js";
import { Ea as isHitlToolType, Ja as isCommunityPackageName, Jc as NDV_IN_FOCUS_PANEL_EXPERIMENT, Pn as MCP_TRIGGER_NODE_TYPE, Rc as CANVAS_ZOOMED_VIEW_EXPERIMENT, Sa as getSubworkflowId, Sr as UPDATE_WEBHOOK_ID_NODE_TYPES, _a as getNodeParameters, al as EnterpriseEditionFeature, cc as LOCAL_STORAGE_LOGS_PANEL_DETAILS_PANEL_SUB_NODE, cs as VIEWS, da as generateNodesGraph, fo as NodeConnectionTypes, ga as getNodeOutputs, gn as FORM_TRIGGER_NODE_TYPE, gr as STICKY_NODE_TYPE, ha as getNodeInputs, lc as LOCAL_STORAGE_LOGS_PANEL_OPEN, ma as getConnectionTypes, qa as deepCopy, qi as require__baseUniq, sc as LOCAL_STORAGE_LOGS_PANEL_DETAILS_PANEL, uc as LOCAL_STORAGE_LOGS_SYNC_SELECTION, wr as WEBHOOK_NODE_TYPE, zi as require_cloneDeep } from "./constants-NfpEUugO.js";
import { j as defineStore, r as useRootStore } from "./_baseOrderBy-WW5xCbr3.js";
import { t as useExecutionsStore } from "./executions.store-D__r2Ug5.js";
import { t as usePinnedData } from "./usePinnedData-DwevAqbC.js";
import { a as mapLegacyConnectionToCanvasConnection, c as parseCanvasConnectionHandleString, i as mapCanvasConnectionToLegacyConnection, n as createCanvasConnectionHandleString, o as mapLegacyConnectionsToCanvasConnections } from "./canvas.utils-Fh6fe87k.js";
import { n as useNodeCreatorStore, t as canvasEventBus } from "./canvas.eventBus-im-no4xr.js";
import { t as core_default } from "./core-DtHcbiEh.js";
import { a as bash, i as javascript, n as typescript, r as python, t as xml } from "./xml-DMSvkJ3u.js";
...
export { useChat as C, useOptions as S, MessageComponentKey as _, LOCAL_STORAGE_OVERVIEW_PANEL_WIDTH as a, Button_default as b, LOGS_PANEL_STATE as c, constructChatWebsocketUrl as d, parseBotChatMessageContent as f, localStorageSessionIdKey as g, ChatSymbol as h, useLogsStore as i, LOG_DETAILS_PANEL_STATE as l, ChatOptionsSymbol as m, useParentFolder as n, LOCAL_STORAGE_PANEL_HEIGHT as o, shouldBlockUserInput as p, useExperimentalNdvStore as r, LOCAL_STORAGE_PANEL_WIDTH as s, useCanvasOperations as t, chatEventBus as u, MessageWithButtons_default as v, useI18n$1 as x, MarkdownRenderer_default as y };
