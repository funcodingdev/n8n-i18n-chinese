...
import { $ as openBlock, A as createTextVNode, C as createBaseVNode, Cn as toDisplayString, E as createElementBlock, Gt as unref, I as h, It as ref, N as defineComponent, R as inject, S as computed, T as createCommentVNode, U as mergeProps, Ut as toValue, W as nextTick, _ as Fragment, bt as withCtx, it as renderSlot, j as createVNode, jt as isRef, rt as renderList, st as resolveDynamicComponent, vn as normalizeClass, w as createBlock, zt as shallowRef } from "./vue.runtime.esm-bundler-Bs4WIMNP.js";
import { x as useI18n$1 } from "./_MapCache-B3sL8ZR7.js";
import { so as require_markdown_it_link_attributes, t as core_default } from "./src-VmSi6XTE.js";
import { t as _plugin_vue_export_helper_default } from "./_plugin-vue_export-helper-Da88TEg1.js";
import { l as useClipboard, y as useLocalStorage } from "./dist-BkE9aYmt.js";
import { _ as useRouter, g as useRoute } from "./htmlUtils-BQ4vUfog.js";
import { n as python, t as typescript } from "./typescript-DF58u-hL.js";
import { $t as ensureNodePosition, Ar as DEFAULT_VIEWPORT_BOUNDARIES, Br as getNewNodePosition, Dr as CONFIGURABLE_NODE_SIZE, E as useWorkflowDocumentStore, Er as AGENT_NODE_SIZE, Fr as generateOffsets, Gi as CanvasNodeRenderType, Hr as getNodesGroupSize, I as require_uniq, Ii as isValidNodeConnectionType, Jt as useWorkflowHelpers, L as isAgentNodeV2, Mr as PUSH_NODES_OFFSET, Or as CONFIGURATION_NODE_SIZE, P as serializeNode, Pr as doRectsOverlap, Qt as useTagsStore, R as useNodeTypesStore, S as createWorkflowDocumentId, Sr as parseCanvasConnectionHandleString, Ui as CanvasConnectionMode, Un as getMainAuthField, _ as disposeWorkflowExecutionStateStore, br as mapLegacyConnectionToCanvasConnection, fi as pinDataToExecutionData, ht as getN8nAgentsNodeName, jr as HORIZONTAL_NODE_STEP, jt as useDataSchema, kr as DEFAULT_NODE_SIZE, mn as useProjectsStore, on as useNDVStore, pr as createCanvasConnectionHandleString, t as useWorkflowsStore, tn as sanitizeConnections, tr as isRequiredCredential, tt as removePreviewToken, u as getExecutionErrorToastConfiguration, w as injectWorkflowDocumentStore, xr as mapLegacyConnectionsToCanvasConnections, xt as useCredentialsStore, y as useWorkflowExecutionStateStore, yr as mapCanvasConnectionToLegacyConnection, zn as getAllNodeCredentialForAuthType } from "./workflows.store-Ct6L2UO9.js";
import { dr as defineStore, t as useRootStore } from "./useRootStore-CDIOxWm8.js";
import { Br as resolveNodeWebhookId, Dr as getSubworkflowId, Jt as validateNodeSelectionForExtraction, Qr as isResourceLocatorValue, Sr as getNodeParameters, Ut as require_cloneDeep, Xi as v4, Yt as validateNodeSelectionForGrouping, br as getNodeInputs, ci as deepCopy, di as isObjectEmpty, hr as generateNodesGraph, jr as isHitlToolType, ti as NodeConnectionTypes, ui as isCommunityPackageName, xr as getNodeOutputs, yr as getConnectionTypes } from "./src-Vot4VemC.js";
...
import { Ja as NDV_IN_FOCUS_PANEL_EXPERIMENT, Ji as LOCAL_STORAGE_LOGS_PANEL_OPEN, Ki as LOCAL_STORAGE_LOGS_PANEL_DETAILS_PANEL, Kn as UPDATE_WEBHOOK_ID_NODE_TYPES, Mt as CHAT_TRIGGER_NODE_TYPE, Vn as STICKY_NODE_TYPE, Yi as LOCAL_STORAGE_LOGS_SYNC_SELECTION, ln as MANUAL_CHAT_TRIGGER_NODE_TYPE, on as KEEP_AUTH_IN_NDV_FOR_NODES, oo as EnterpriseEditionFeature, qi as LOCAL_STORAGE_LOGS_PANEL_DETAILS_PANEL_SUB_NODE, wa as CANVAS_ZOOMED_VIEW_EXPERIMENT } from "./constants-nNF8vqjl.js";
import { n as TELEMETRY_EVENT } from "./src-BK4W2oeU.js";
import { f as isPresent, l as isEmpty, v as tryToParseNumber } from "./typesUtils-Bg2s5rO5.js";
import { o as getNewWorkflowData } from "./workflowsList.store-s9e_R4vj.js";
import { n as useUIStore } from "./ui.store-R3eNGF28.js";
import { t as useBuilderStore } from "./builder.store-CWK3w1xR.js";
import { _ as useCanvasStore, a as AddNodeGroupCommand, d as RemoveNodeCommand, f as RemoveNodeGroupCommand, h as UpdateNodeGroupCommand, i as AddNodeCommand, l as MoveNodeCommand, m as ReplaceNodeParametersCommand, n as useHistoryStore, p as RenameNodeCommand, r as AddConnectionCommand, t as useNodeHelpers, u as RemoveConnectionCommand } from "./useNodeHelpers-pmj88hou.js";
...
import { n as javascript, r as bash, t as xml } from "./xml-QaDfRe_h.js";
import { t as VueMarkdown } from "./VueMarkdown-Cd71b9fS.js";
import { t as useSetupPanelStore } from "./setupPanel.store-BF6Rf2xs.js";
import { t as clearAllNodeResourceLocatorValues } from "./templateTransforms-qJNLSmPW.js";
...
var useAgentNodeCanvasGeometryStore = defineStore("agentNodeCanvasGeometry", () => {
	const nodeHeightsByCanvas = /* @__PURE__ */ new Map();
	...
	function setNodeHeight(canvasId, nodeId, height) {
		...
		if (!heightsByNode) {
			heightsByNode = /* @__PURE__ */ new Map();
...
//#endregion
export { useI18n as A, ChatOptionsSymbol as C, MessageWithButtons_default as D, MessageComponentKey as E, useWorkflowNormalization as F, useChat as M, getAutoSelectedCredential as N, MarkdownRenderer_default as O, useNodeCredentialOptions as P, shouldBlockUserInput as S, localStorageSessionIdKey as T, LOGS_PANEL_STATE as _, snapshotGroup as a, constructChatWebsocketUrl as b, addTokenUsageData as c, isChatNode as d, parseAiContent as f, LOCAL_STORAGE_PANEL_WIDTH as g, LOCAL_STORAGE_PANEL_HEIGHT as h, deleteGroupWithHistory as i, useOptions as j, Button_default as k, emptyTokenUsageData as l, LOCAL_STORAGE_OVERVIEW_PANEL_WIDTH as m, useAgentNodeCanvasGeometryStore as n, useSelectionValidation as o, useLogsStore as p, useCanvasNodeGroupTelemetry as r, useExperimentalNdvStore as s, useCanvasOperations as t, formatTokenUsageCount as u, LOG_DETAILS_PANEL_STATE as v, ChatSymbol as w, parseBotChatMessageContent as x, chatEventBus as y };
