...
import { D as NodeCredentials_default, f as collectParametersByTab, m as createCommonNodeSettings, t as ParameterInputList_default, x as setParameterValue } from "./ParameterInputList-CTxyGxqB.js";
import { C as disposeWorkflowDocumentStore, E as useWorkflowDocumentStore, R as useNodeTypesStore, S as createWorkflowDocumentId, hn as useProjectsStore, in as disposeNDVStore, ln as useEnvironmentsStore, sn as useNDVStore, xt as useCredentialsStore } from "./workflows.store-CV9fQhc2.js";
import { t as N8nTabs_default } from "./N8nTabs-D1Q6GI32.js";
import { $r as isINodePropertyOptions, Er as getNodeParametersIssues, Mr as isDefaultNodeName, Rr as makeNodeName, Tr as getNodeParameters, di as deepCopy } from "./src-JwBmTNgK.js";
import { t as useSettingsStore } from "./settings.store-DtdxCj3f.js";
import { la as ExpressionLocalResolveContextSymbol, ma as WorkflowDocumentStoreKey, pa as ToolConfigCredentialSelectedKey, sa as ChatHubToolContextKey } from "./constants-BP1FOJvU.js";
...
var NodeToolSettingsContent_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props, { expose: __expose, emit: __emit }) {
		...
		*/
		...
		const toolWorkflowStore = useWorkflowDocumentStore(createWorkflowDocumentId("node-tool-workflow"));
		const workflowDocumentStore = computed(() => toolWorkflowStore);
		watch(node, (currentNode) => {
			if (currentNode) toolWorkflowStore.setNodes([currentNode]);
		}, { immediate: true });
