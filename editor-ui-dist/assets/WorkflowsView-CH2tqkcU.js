...
import { Fn as useToast, Ja as FOLDER_NAME_ONLY_DOTS_REGEX, Jt as useTemplatesStore, Ka as FOLDER_LIST_ITEM_ACTIONS, Nn as trackTemplatesClick, Pn as useCloudPlanStore, Rn as useMessage, Ya as ILLEGAL_FOLDER_CHARACTERS, Za as CREDENTIAL_EDIT_MODAL_KEY, _i as ProjectTypes, at as useCredentialsStore, cr as useWorkflowsListStore, gr as usePostHog, jn as TemplateClickSource, oi as useProjectsStore, pr as useTelemetry, qa as FOLDER_NAME_ILLEGAL_CHARACTERS_REGEX, r as useUIStore, rr as useTagsStore, s as useWorkflowsStore, si as useSourceControlStore, t as useUsersStore, ti as ResourceType, to as COMMUNITY_PLUS_ENROLLMENT_MODAL, tt as sublimeSearch, w as useNodeTypesStore, yr as useStorage, z as removePreviewToken, zt as useDocumentTitle } from "./users.store-CP49qwNg.js";
import { Ei as WORKFLOW_HISTORY_VERSION_UNPUBLISH, Li as LOCAL_STORAGE_EXPERIMENTAL_DISMISSED_SUGGESTED_WORKFLOWS, Qc as TEMPLATE_ONBOARDING_EXPERIMENT, Rc as CREDENTIALS_APP_SELECTION_EXPERIMENT, Xr as EXPERIMENT_TEMPLATE_RECO_V2_KEY, Yr as DUPLICATE_MODAL_KEY, Zr as EXPERIMENT_TEMPLATE_RECO_V3_KEY, cc as getResourcePermissions, dl as getDebounceTime, ki as WORKFLOW_SHARE_MODAL_KEY, rl as DEBOUNCE_TIME, rs as jsonParse, tl as EnterpriseEditionFeature, ys as NodeConnectionTypes, zr as VIEWS } from "./constants-Co4JQRdg.js";
import { D as storeToRefs, T as defineStore } from "./useRootStore-3wVnX35v.js";
...
import { n as require_debounce, t as useDebounce } from "./useDebounce-C4gWawzB.js";
import { t as Modal_default } from "./Modal-DTyMIXTA.js";
import { n as useInstallNode, t as ContactAdministratorToInstall_default } from "./ContactAdministratorToInstall-BX-4H_ON.js";
import { t as ProjectCardBadge_default } from "./ProjectCardBadge-CHZwKSAC.js";
import { t as useUsageStore } from "./usage.store-uUBA4pVb.js";
...
import { t as TimeAgo_default } from "./TimeAgo-DTGoHe1v.js";
import { t as useFoldersStore } from "./folders.store-DH8W__fj.js";
import { t as WorkflowTagsDropdown_default } from "./WorkflowTagsDropdown-BDyRH60Z.js";
import { t as useInsightsStore } from "./insights.store-Dtc3RAPq.js";
import { t as useMcp } from "./useMcp--EOmwfsv.js";
import { n as usePersonalizedTemplatesV3Store, r as usePersonalizedTemplatesV2Store, t as require_shuffle } from "./shuffle-D2-E4Iit.js";
import { t as useWorkflowActivate } from "./useWorkflowActivate-BrK8QBQZ.js";
import { r as useProjectPages, t as useReadyToRunStore } from "./readyToRun.store-BR_TZuxY.js";
...
import { t as FolderBreadcrumbs_default } from "./FolderBreadcrumbs-BbLnEESg.js";
import { t as useEmptyStateBuilderPromptStore } from "./emptyStateBuilderPrompt.store-Dpf4m5aX.js";
import { t as EmptySharedSectionActionBox_default } from "./EmptySharedSectionActionBox-DtQiiA5v.js";
import { t as ResourcesListLayout_default } from "./ResourcesListLayout-DhCZsGqb.js";
import { n as ReadyToRunButton_default, t as ProjectHeader_default } from "./ProjectHeader-DysKOMps.js";
import { n as useDependencies, t as DependencyPill_default } from "./DependencyPill-0fDzcEri.js";
import { t as useMCPStore } from "./mcp.store-D0NJrLVg.js";
import { n as useRecommendedTemplatesStore, t as RecommendedTemplateCard_default } from "./RecommendedTemplateCard--vaJwjKV.js";
import { n as verified_default, t as shield_alt_default } from "./shield-alt-B8zkcKyV.js";
import { t as InsightsSummary_default } from "./InsightsSummary-CocV4CcV.js";
