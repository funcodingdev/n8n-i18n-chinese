import { Qt as INSTANCE_AI_THREAD_SOURCES } from "./src-C4KdskeD.js";
...
var NODE_CHIP_REMOVAL_KEYS = new Set([
	"Delete",
	"Backspace",
	"x"
]);
function isNodeChipRemovalKey(key) {
