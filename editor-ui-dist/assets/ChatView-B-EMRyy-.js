const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/es-BctzLrT5.js","assets/core-CKCNqU8h.js","assets/chunk-6z4oVpB-.js","assets/languageModules-FLPk4yY4.js","assets/xml-ByhzxXn2.js"])))=>i.map(i=>d[i]);
...
import { I as useSpeechRecognition, L as useSpeechSynthesis, M as useMediaQuery, P as useScroll, _t as I18nT, gt as useI18n, j as useLocalStorage } from "./_MapCache-B3wBxKdj.js";
...
import { Bo as v4_default, Fi as useUIStore, Tn as useDocumentTitle, nr as useUsersStore } from "./useTelemetry-DNwFBRX7.js";
...
import { $r as PROVIDER_CREDENTIAL_TYPE_MAP, Fo as VIEWS, Ss as LOCAL_STORAGE_CHAT_HUB_SELECTED_TOOLS, gi as INodesSchema, xs as LOCAL_STORAGE_CHAT_HUB_SELECTED_MODEL } from "./constants-ASQneu7i.js";
...
import { c as isLlmProvider, f as unflattenModel, l as isLlmProviderModel, p as buildChatAttachmentUrl, r as findOneFromModelsResponse, t as useChatStore } from "./chat.store-CdDrRp9q.js";
import "./fileUtils-BIVczUdz.js";
import { n as ModelSelector_default, t as ToolsSelector_default } from "./ToolsSelector-BTHYMPDq.js";
import { t as ChatAgentAvatar_default } from "./ChatAgentAvatar-DrNMWLDT.js";
import { i as chatHubConversationModelWithCachedDisplayNameSchema, n as ChatLayout_default, r as useChatCredentials, t as ChatSidebarOpener_default } from "./ChatSidebarOpener-BJe5giB3.js";
import { t as useChatHubSidebarState } from "./useChatHubSidebarState-mGCTw1Yn.js";
...
function useChatHubMarkdownOptions() {
	...
	async function loadLanguageModules() {
		...
		try {
			asyncImport = {
				status: "inProgress",
				promise: Promise.all([__vitePreload(() => import("./es-BctzLrT5.js"), __vite__mapDeps([0,1,2])), __vitePreload(() => import("./languageModules-FLPk4yY4.js"), __vite__mapDeps([3,4]))])
			};
