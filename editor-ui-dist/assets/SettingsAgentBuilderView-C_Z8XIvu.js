import { $ as openBlock, A as createTextVNode, C as createBaseVNode, Cn as toDisplayString, E as createElementBlock, Gt as unref, It as ref, N as defineComponent, S as computed, T as createCommentVNode, X as onMounted, bt as withCtx, gt as watch, j as createVNode, vn as normalizeClass } from "./vue.runtime.esm-bundler-DYHsQBZB.js";
...
import { a as sanitizeModelId, c as useAgentProjectId, o as useModelCatalog, s as useAgentModelCredentials, t as AgentModelSelector_default } from "./AgentModelSelector-CJJLXxQZ.js";
...
import { B as AGENT_BUILDER_DEFAULT_MODEL, no as isAgentModelProvider } from "./src-JwBmTNgK.js";
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("div", { class: normalizeClass(_ctx.$style.section) }, [
				...
				showCustomPicker.value ? (openBlock(), createElementBlock("div", {
					...
					"bound-credential-id": boundCredentialId.value,
