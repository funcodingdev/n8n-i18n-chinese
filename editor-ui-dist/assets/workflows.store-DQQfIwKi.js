...
import { $ as openBlock, $t as hyphenate, A as createTextVNode, At as isRef, Bt as toRef, C as createBaseVNode, D as createPropsRestProxy, E as createElementBlock, Et as getCurrentScope, Ft as ref, Ht as toValue$1, I as h, It as shallowReactive, K as onBeforeMount, Mt as onScopeDispose, N as defineComponent, Nt as reactive, P as getCurrentInstance, Pt as readonly, R as inject, Rt as shallowRef, S as computed, Sn as toDisplayString, T as createCommentVNode, Tt as effectScope, U as mergeProps, Vt as toRefs$1, W as nextTick, Wt as unref, X as onMounted, Z as onUnmounted, _ as Fragment, _n as normalizeClass, at as resolveComponent, bt as withDirectives, en as init_shared_esm_bundler, ft as useSlots, gt as watch, i as createApp, it as renderSlot, j as createVNode, jt as markRaw, lt as useAttrs, n as Transition$1, ot as resolveDirective, p as vShow, pn as isString$1, q as onBeforeUnmount, rt as renderList, sn as isObject$2, st as resolveDynamicComponent, tt as provide, w as createBlock, wt as customRef, y as Teleport, yn as normalizeStyle, yt as withCtx, z as isMemoSame } from "./vue.runtime.esm-bundler-Bw8GKr4Y.js";
import { i as i18n, n as addHeaders, r as addNodeTranslation, s as useI18n } from "./src-M_cPVtop.js";
import { Bi as truncate, cr as getStyle, dn as useGlobalComponentSettings, gi as isClient$1, j as isBinary, lt as useRoute, or as addClass, ur as removeClass, xt as createEventBus } from "./src-D7XhL4SE.js";
import { a as require_toString, s as require_memoize, t as require_get, u as require_lib } from "./get-Den8eczo.js";
import { A as IN_PROGRESS_EXECUTION_ID, An as NODE_POSITION_CONFLICT_ALLOWLIST, B as AI_CATEGORY_AGENTS, Bt as CREDENTIAL_ONLY_NODE_PREFIX, C as TEMPLATES_NODES_FILTER, Cs as isHitlToolType, D as ALLOWED_HTML_TAGS, Ds as makeNodeName, Dt as AI_TRANSFORM_NODE_TYPE, E as ALLOWED_HTML_ATTRIBUTES, Et as AI_MCP_TOOL_NODE_TYPE, Fs as isFilterValue, Gc as ApplicationError, Gs as deepCopy, Ho as splitExpression, Hs as isResourceMapperValue$1, I as MAPPING_PARAMS, J as AI_CATEGORY_OTHER_TOOLS, Jo as isTrimmedNodeExecutionData, Js as jsonParse, K as AI_CATEGORY_MCP_NODES, Ko as require__baseFindIndex, Lc as v4, Mn as NON_ACTIVATABLE_TRIGGER_NODE_TYPES, N as CUSTOM_API_CALL_KEY, Nc as SEND_AND_WAIT_OPERATION, On as MODULE_ENABLED_NODES, Oo as require__createCompounder, Os as mergeIssues, P as DATA_TYPE_ICON_MAP, Qs as sleep$1, Uo as require__baseUniq, Vc as require_keys, Vs as isResourceLocatorValue, W as AI_CATEGORY_HUMAN_IN_THE_LOOP, Yn as SCHEDULE_TRIGGER_NODE_TYPE, Zt as ERROR_TRIGGER_NODE_TYPE$1, ai as MAIN_HEADER_TABS, an as FORM_TRIGGER_NODE_TYPE$1, bl as WorkflowDocumentStoreKey, ct as CORE_NODES_CATEGORY, dc as isExpression, ds as getConnectionTypes, el as getResourcePermissions, et as AI_CATEGORY_VECTOR_STORES, fs as getNodeInputs, ft as HUMAN_IN_THE_LOOP_CATEGORY, gs as getNodeWebhookUrl, gt as RECOMMENDED_NODES, ho as require__baseFlatten, hr as WIKIPEDIA_TOOL_NODE_TYPE, hs as getNodeParametersIssues, j as PLACEHOLDER_FILLED_AT_EXECUTION_TIME, jc as MANUAL_TRIGGER_NODE_TYPE, jo as require__baseIteratee, lc as NodeConnectionTypes, ln as HTTP_REQUEST_NODE_TYPE, ls as displayParameter, ml as CanvasRenderDataKey, mr as WEBHOOK_NODE_TYPE$1, ms as getNodeParameters, ns as createEmptyRunExecutionData, nu as EnterpriseEditionFeature, oi as VIEWS, os as mapConnectionsByDestination, po as require_pick, ps as getNodeOutputs, r as DUPLICATE_POSTFFIX, rs as createRunExecutionData, sc as ExpressionError, ss as getChildNodes, st as BETA_NODES, tt as AI_CODE_TOOL_LANGCHAIN_NODE_TYPE, uc as nodeConnectionTypes, us as displayParameterPath, vr as WORKFLOW_TRIGGER_NODE_TYPE, wo as Workflow, xc as CHAT_TRIGGER_NODE_TYPE, yc as BINARY_MODE_SEPARATE, yn as LIST_LIKE_NODE_OPERATIONS, yo as isAssignmentCollectionValue, zc as require_isEqual, zo as traverseNodeParameters } from "./constants-Brs44Mbc.js";
import { b as require_isArrayLike, n as require__isIterateeCall, r as require__baseRest, t as require_merge } from "./merge-ClIuBZpC.js";
import { E as getActivePinia, T as defineStore, a as ResponseError, c as makeRestApiRequest, d as request, f as streamRequest, m as axios, s as getFullApiResponse, t as useRootStore } from "./useRootStore-NTSmdx9S.js";
import { C as updateCurrentUserSettings, Pt as getProjectSecretProviderConnectionsByProjectId, Rn as STORES, ct as fetchCommunityNodeTypes, dt as getNodeParameterOptions, ft as getNodeTranslationHeaders, gt as getResourceMapperFields, ht as getResourceLocatorResults, i as getWorkflowVersion, lt as getLocalResourceMapperFields, mt as getNodesInformation, pt as getNodeTypes$1, s as findWebhook, st as fetchCommunityNodeAttributes, t as useSettingsStore, ut as getNodeParameterActionResult } from "./settings.store-CrL-o4BC.js";
import { _ as useLocalStorage, k as createEventHook } from "./core-CMxey_qZ.js";
import { _ as useStorage, f as useUIStore, n as hasPermission, p as useTelemetry, t as useUsersStore, u as hasRole } from "./users.store-ByD75lsx.js";
import { r as require_toNumber } from "./useDebounce-BeI9fzpX.js";
import { t as require_dateformat } from "./dateformat-9ZHpj92n.js";
import { t as require__baseOrderBy } from "./_baseOrderBy-C4Rullvn.js";
...
function useWorkflowDocumentNodeGroups() {
	...
	function applyUpsertGroup(group, action, { markDirty = true } = {}) {
...
var DEFAULT_NDV_STORE_ID = createWorkflowDocumentId("default");
...
function defineNDVStore(id, useCurrentWorkflowDocument = false) {
	return defineStore(getNDVStoreId(id), () => {
		...
		const workflowsStore = useWorkflowsStore();
		const workflowDocumentStore = computed(() => useWorkflowDocumentStore(useCurrentWorkflowDocument ? createWorkflowDocumentId(workflowsStore.workflowId) : id));
		...
		const ndvInputDataWithPinnedData = computed(() => {
			...
			return ndvInputNodeName.value ? workflowDocumentStore.value.pinnedDataByNodeName?.[ndvInputNodeName.value] ?? data : data;
		});
...
function useNDVStore(idOrPinia) {
	const pinia = typeof idOrPinia === "string" ? void 0 : idOrPinia;
	const isExplicitStoreId = typeof idOrPinia === "string";
	return defineNDVStore(isExplicitStoreId ? idOrPinia : DEFAULT_NDV_STORE_ID, !isExplicitStoreId)(pinia);
}
...
async function resolveParameter(parameter, workflowDocumentId, opts_ = {}) {
	...
	const ndvActiveNode = "localResolve" in opts_ && opts_.localResolve ? workflowDocumentStore.getNodeByName(opts_.nodeName) : useNDVStore().activeNode;
...
var startTestRun = async (context, workflowId, options) => {
	return await request({
		...
		data: options?.concurrency !== void 0 ? { concurrency: options.concurrency } : void 0
	});
};
...
function createWorkflowExecutionStateId(workflowId) {
	return workflowId;
}
/**
	...
	return defineStore(getWorkflowExecutionStateStoreId(id), () => {
		...
		*/
		const activeExecution = computed(() => {
			...
			if (typeof activeExecutionId.value === "string") return useExecutionDataStore(createExecutionDataId(activeExecutionId.value)).execution;
			if (typeof displayedExecutionId.value === "string") return useExecutionDataStore(createExecutionDataId(displayedExecutionId.value)).execution;
			return null;
		});
		/**
		...
		*/
		function setActiveExecution(execution) {
			if (execution === null) {
				setPendingExecution(null);
				clearDisplayedExecution();
				return;
			}
			if (execution.id === "__IN_PROGRESS__") {
				setPendingExecution(execution);
				setActiveExecutionId(null);
				useExecutionDataStore(createExecutionDataId(IN_PROGRESS_EXECUTION_ID)).setExecution(execution);
				return;
			}
			trackExecutionId(execution.id);
			useExecutionDataStore(createExecutionDataId(execution.id)).setExecution(execution);
...
var useWorkflowsStore = defineStore(STORES.WORKFLOWS, () => {
	...
	*/
	...
	const currentExecutionStateStore = computed(() => useWorkflowExecutionStateStore(createWorkflowExecutionStateId(workflowId.value)));
	const currentWorkflowExecutions = computed({
		get: () => currentExecutionStateStore.value.currentWorkflowExecutions,
	...
	const workflowExecutionData = computed(() => {
		...
		return currentExecutionStateStore.value.activeExecution;
	});
	const lastSuccessfulExecution = computed(() => currentExecutionStateStore.value.lastSuccessfulExecution);
	const workflowExecutionStartedData = computed(() => currentExecutionStateStore.value.activeExecutionStartedData);
	const workflowExecutionResultDataLastUpdate = computed(() => currentExecutionStateStore.value.activeExecutionResultDataLastUpdate);
	const workflowExecutionPairedItemMappings = computed(() => currentExecutionStateStore.value.activeExecutionPairedItemMappings);
	...
	const chatMessages = computed(() => currentExecutionStateStore.value.chatMessages);
	...
	*/
	...
	const readonlyActiveExecutionId = computed(() => currentExecutionStateStore.value.activeExecutionId);
	const readonlyPreviousExecutionId = computed(() => currentExecutionStateStore.value.previousExecutionId);
	...
	async function fetchLastSuccessfulExecution() {
		...
		try {
			...
			currentExecutionStateStore.value.setLastSuccessfulExecution(await getLastSuccessfulExecution(rootStore.restApiContext, workflowId.value));
		} catch (e) {}
	}
	...
	function setWorkflowExecutionData(execution) {
...
//#endregion
export { require_upperFirst as $, tryToParseNumber as $i, checkOverlap as $n, deleteDataTableApi as $r, useCanvasStore as $t, isAINode as A, isAuthRelatedParameter as Ai, getNodesWithNormalizedPosition as An, isWorkflowListItem as Ar, useAnnotationTagsStore as At, transformNodeType as B, clearJsonKey as Bi, _sfc_main$d as Bn, ResourceType as Br, useNDVStore as Bt, filterAndSearchNodes as C, getNodeAuthOptions as Ci, getBounds as Cn, isSharedResource as Cr, removeExpressionPrefix as Ct, getHumanInTheLoopActions as D, hasExpressionMapping as Di, getNewNodePosition as Dn, isValidNodeConnectionType as Dr, resolveParameter as Dt, getAiTemplatesCallout as E, getTriggerNodeServiceName as Ei, getMousePosition as En, isValidCredentialResponse as Er, unwrapExpression as Et, removePreviewToken as F, parseResourceMapperFieldName as Fi, PanelPosition as Fn, getPinDataSize as Fr, sortNodesByExecutionOrder as Ft, isTutorialTemplateId as G, isBlurrableEl as Gi, getConnectedEdges as Gn, useProjectsStore as Gr, TOOL_NODE_TYPES_NEED_INPUT as Gt, getRagStarterWorkflowJson as H, convertToDisplayDate as Hi, clamp as Hn, splitName as Hr, disposeWorkflowDocumentStore as Ht, searchNodes as I, updateNodeAuthType as Ii, Position as In, pinDataToExecutionData as Ir, getPairedItemId as It, useAiGatewayStore as J, isPresent as Ji, isMacOs as Jn, ProjectTypes as Jr, getNodeTypeDisplayableCredentials as Jt, isFullTemplatesCollection as K, isEmpty as Ki, getRectOfNodes as Kn, useFavoritesStore as Kr, doesNodeHaveAllCredentialsFilled as Kt, shouldShowCommunityNodeDetails as L, getAllCredentials as Li, _sfc_main as Ln, CHANGE_ACTION as Lr, useWorkflowsListStore as Lt, mapToolSubcategoryIcon as M, isRequiredCredential as Mi, updateViewportToContainNodes as Mn, CanvasNodeDirtiness as Mr, ensureNodePosition as Mt, nodeTypesToCreateElements as N, isResourceMapperFieldListStale as Ni, MarkerType as Nn, CanvasNodeRenderType as Nr, removeWorkflowExecutionData as Nt, getRootSearchCallouts as O, hasOnlyListMode as Oi, getNodeViewTab as On, isVariableResource as Or, resolveRequiredParameters as Ot, prepareCommunityNodeDetailsViewStack as P, isValueExpression as Pi, NodeId as Pn, DEFAULT_SETTINGS as Pr, sanitizeConnections as Pt, require_startCase as Q, toMegaBytes as Qi, isCredentialOnlyNodeType as Qn, createDataTableApi as Qr, useNodeHelpers as Qt, sortNodeCreateElements as R, parse as Ri, _sfc_main$1 as Rn, LOCAL_STORAGE_NDV_PANEL_WIDTH as Rr, disposeNDVStore as Rt, useEvaluationStore as S, getNodeAuthFields as Si, generateOffsets as Sn, isRouteLocationRaw as Sr, isTestableExpression as St, flattenCreateElements as T, getThemedValue as Ti, getMidCanvasPosition as Tn, isTriggerPanelObject as Tr, stringifyExpressionResult as Tt, getSampleWorkflowByTemplateId as U, convertToHumanReadableDate as Ui, getBezierPath as Un, useAvailableProjectSearch as Ur, injectWorkflowDocumentStore as Ut, SampleTemplates as V, convertPath as Vi, _sfc_main$f as Vn, getTruncatedProjectName as Vr, createWorkflowDocumentId as Vt, getTutorialTemplates as W, hasFocusOnInput as Wi, getBoundsofRects as Wn, useRemoteProjectSearch as Wr, useWorkflowDocumentStore as Wt, capitalCase as X, shorten as Xi, useVueFlow as Xn, setWorkflowSharedWith as Xr, needsAgentInput as Xt, require_sortBy as Y, isSelectableEl as Yi, useGetPointerPosition as Yn, moveFolderToProject as Yr, getParameterDisplayableOptions as Yt, sublimeSearch as Z, stringSizeInBytes as Zi, wheelDelta as Zn, addDataTableColumnApi as Zr, serializeNode as Zt, openFormPopupWindow as _, getAllNodeCredentialForAuthType as _i, DEFAULT_NODE_SIZE as _n, isDebouncedFunction as _r, propertyNameFromExpression as _t, createExecutionDataId as a, getWorkflowsAndFolders as aa, getDataTableRowsApi as ai, Command as an, mapLegacyConnectionToCanvasConnection as ar, clearBuilderSession as at, useNodeTypesStore as b, getAuthTypeForNodeCredential as bi, calculateNodeSize as bn, isResourceMapperValue as br, getResolvableState as bt, clearPopupWindowState as c, getScrollbarWidth as ca, moveDataTableColumnApi as ci, RemoveConnectionCommand as cn, shouldIgnoreCanvasShortcut as cr, getBuilderCredits as ct, executionRetryMessage as d, sanitizeHtml as da, updateDataTableRowsApi as di, ReplaceNodeParametersCommand as dn, isBaseTextKey as dr, useAIAssistantHelpers as dt, omitKey as ea, deleteDataTableColumnApi as ei, useLoadingService as en, createCanvasConnectionHandleString as er, require__baseSlice as et, findTriggerNodeToAutoSelect as f, sanitizeIfString as fa, uploadCsvFileApi as fi, historyBus as fn, isBinaryLike as fr, useDataSchema as ft, hasTrimmedRunData as g, getActivatableTriggerNodes as gi, CONFIGURATION_NODE_SIZE as gn, isDateObject as gr, getMappedResult as gt, getExecutionErrorToastConfiguration as h, filterTemplateNodes as hi, CONFIGURABLE_NODE_SIZE as hn, isCredentialsResource as hr, getMappedExpression as ht, useWorkflowExecutionStateStore as i, getWorkflowWriteLock as ia, fetchDataTablesApi as ii, BulkCommand as in, mapCanvasConnectionToLegacyConnection as ir, chatWithBuilder as it, isNodePreviewKey as j, isMatchingField as ji, snapPositionToGrid as jn, CanvasConnectionMode as jr, useTagsStore as jt, groupItemsInSections as k, hasProxyAuth as ki, getNodesGroupSize as kn, isVueFlowConnection as kr, useWorkflowHelpers as kt, displayForm as l, isEventTargetContainedBy as la, renameDataTableColumnApi as li, RemoveNodeCommand as ln, injectStrict as lr, replaceCode as lt, getExecutionErrorMessage as m, fieldCannotBeDeleted as mi, require_toInteger as mn, isCredentialModalState as mr, escapeMappingString as mt, createWorkflowExecutionStateId as n, getNewWorkflow as na, downloadDataTableCsvApi as ni, AddConnectionCommand as nn, injectCanvasRenderData as nr, useCredentialsStore as nt, useExecutionDataStore as o, capitalizeFirstLetter as oa, importCsvToDataTableApi as oi, EnableNodeToggleCommand as on, mapLegacyConnectionsToCanvasConnections as or, generateCodeForPrompt as ot, getDefaultExecutionFilters as p, ElLoading as pa, executionDataToJson as pi, require_uniq as pn, isComponentPublicInstance as pr, useFlattenSchema as pt, isTemplatesWorkflow as q, isFocusableEl as qi, getSmoothStepPath as qn, useSourceControlStore as qr, doesNodeHaveCredentialsToFill as qt, disposeWorkflowExecutionStateStore as r, getWorkflow as ra, fetchDataTableGlobalLimitInBytes as ri, AddNodeCommand as rn, insertSpacersBetweenEndpoints as rr, chatWithAssistant as rt, buildExecutionResponseFromSchema as s, getBannerRowHeight as sa, insertDataTableRowApi as si, MoveNodeCommand as sn, parseCanvasConnectionHandleString as sr, getAiSessions as st, useWorkflowsStore as t, searchInObject as ta, deleteDataTableRowsApi as ti, useHistoryStore as tn, getMaxNodePortsLabelSize as tr, listenForCredentialChanges as tt, executionFilterToQueryFilter as u, isOutsideSelected as ua, updateDataTableApi as ui, RenameNodeCommand as un, checkExhaustive as ur, truncateBuilderMessages as ut, unflattenExecutionData as v, getAppNameFromCredType as vi, DEFAULT_VIEWPORT_BOUNDARIES as vn, isFullExecutionResponse as vr, completeExpressionSyntax as vt, finalizeItems as w, getNodeCredentialForSelectedAuthType as wi, getGenericHints as wn, isString as wr, shouldConvertToExpression as wt, useActionsGenerator as x, getMainAuthField as xi, doRectsOverlap as xn, isResourceSortableByDate as xr, isPairedItemIntermediateNodesError as xt, waitingNodeTooltip as y, getAppNameFromNodeName as yi, PUSH_NODES_OFFSET as yn, isProjectRole as yr, getExpressionErrorMessage as yt, subcategorizeItems as z, abbreviateNumber as zi, _sfc_main$3 as zn, useEnvironmentsStore as zr, injectNDVStore as zt };
