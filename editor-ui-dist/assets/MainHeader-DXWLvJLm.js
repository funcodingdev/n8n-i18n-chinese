...
import { u as useDocumentVisibility, v as useLocalStorage } from "./core-DOUvgShw.js";
import { t as useMessage } from "./useMessage-GjRAbz4G.js";
import { t as useToast } from "./useToast-CsW2zDDU.js";
import { $i as WORKFLOW_HISTORY_NAME_VERSION_MODAL_KEY, Ci as DUPLICATE_MODAL_KEY, Hl as getResourcePermissions, Ic as jsonParse, Ji as WORKFLOW_ACTIVE_MODAL_KEY, T as TIME_SAVED_DOCS_URL, Yi as WORKFLOW_DESCRIPTION_MODAL_KEY, Zu as EnterpriseEditionFeature, aa as WORKFLOW_SHARE_MODAL_KEY, di as WORKFLOW_HISTORY_PUBLISH_TIMELINE_TAB, h as EVALUATIONS_DOCS_URL, hu as WorkflowDocumentStoreKey, ia as WORKFLOW_SETTINGS_MODAL_KEY, ki as IMPORT_WORKFLOW_URL_MODAL_KEY, li as MAIN_HEADER_TABS, m as ERROR_WORKFLOW_DOCS_URL, md as WORKFLOW_MENU_ACTIONS, na as WORKFLOW_HISTORY_VERSION_UNPUBLISH, ra as WORKFLOW_PUBLISH_MODAL_KEY, t as AutoSaveState, td as LOADING_ANIMATION_MIN_DURATION, ui as VIEWS, xa as LOCAL_STORAGE_HIDE_GITHUB_STAR_BUTTON, y as N8N_MAIN_GITHUB_REPO_URL } from "./constants-DzzWpyjZ.js";
import { Ft as useTagsStore, Ht as injectNDVStoreIfProvided, Ji as getBannerRowHeight, Nt as useWorkflowId, Sn as ProjectTypes, Wn as getActivatableTriggerNodes, _ as useNodeTypesStore, a as injectWorkflowDocumentStore, b as useEvaluationStore, bn as useProjectsStore, hn as ResourceType, r as createWorkflowDocumentId, s as useWorkflowDocumentStore, sn as useWorkflowsStore, xn as useSourceControlStore } from "./workflowDocument.store-BQc6YDGi.js";
...
import { f as useUIStore, h as telemetry, n as hasPermission, p as useTelemetry, t as useUsersStore } from "./users.store-CUxYM5yQ.js";
...
import { a as useWorkflowSaveStore, r as useWorkflowSaving, s as useWorkflowHistoryStore } from "./builder.store-DR2iv2rX.js";
import { o as sanitizeFilename } from "./dist-BXENiK5V.js";
...
import { t as useMoveResourceToProjectToast } from "./useMoveResourceToProjectToast-Td1xj_YD.js";
import { i as getLastPublishedVersion, r as generateVersionLabelFromId } from "./utils-DgY3uHRW.js";
...
import { t as usePushConnection } from "./usePushConnection-BNtougim.js";
import { t as FolderBreadcrumbs_default } from "./FolderBreadcrumbs-MZX4DE0k.js";
import { t as ConnectionTracker_default } from "./ConnectionTracker-TD3Jx2bH.js";
import { t as useWorkflowEvaluationState } from "./useWorkflowEvaluationState-InZWEBbe.js";
import "./usePushConnection-DbbkbnyT.js";
...
var WorkflowDetails_default = /* @__PURE__ */ _plugin_vue_export_helper_default(WorkflowDetails_vue_vue_type_script_setup_true_lang_default, [["__cssModules", { "$style": WorkflowDetails_vue_vue_type_style_index_1_lang_module_default }], ["__scopeId", "data-v-48015d35"]]);
//#endregion
