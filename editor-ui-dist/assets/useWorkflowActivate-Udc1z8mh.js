...
import { A as useWorkflowDocumentStore, T as createWorkflowDocumentId, nn as useWorkflowId, t as useWorkflowsStore } from "./workflows.store-C0TGOSWn.js";
...
import { fi as WORKFLOW_ACTIVATION_CONFLICTING_WEBHOOK_MODAL_KEY, pi as WORKFLOW_ACTIVE_MODAL_KEY } from "./constants-DOw6b_w2.js";
...
function useWorkflowActivate() {
	...
	const publishWorkflow = async (workflowId, versionId, options) => {
		...
		try {
			...
			if (useSettingsStore().isWorkflowPublicationServiceEnabled) workflowDocumentStore.setPublicationStatus({ status: "publishing" });
