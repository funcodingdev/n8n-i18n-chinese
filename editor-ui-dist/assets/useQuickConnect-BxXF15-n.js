...
import { Ln as useMessage, Pn as useToast, Rs as sanitizeHtml, _r as useTelemetry, at as useCredentialsStore, s as useWorkflowsStore, t as useUsersStore, ui as useProjectsStore } from "./users.store-BCts_jcD.js";
import { Ba as createResultOk, za as createResultError } from "./constants-CjIW4CHX.js";
...
function useQuickConnect() {
	...
	async function connectToPinecone(quickConnectOption) {
		const { ConnectPopup } = await __vitePreload(async () => {
			const { ConnectPopup } = await import("./dist-BotTacND.js");
			return { ConnectPopup };
		}, []);
		return await new Promise((resolve) => {
