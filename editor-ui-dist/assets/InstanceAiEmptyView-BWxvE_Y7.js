import { $ as openBlock, A as createTextVNode, C as createBaseVNode, Cn as toDisplayString, E as createElementBlock, F as guardReactiveProps, Gt as unref, Ht as toRefs, It as ref, N as defineComponent, P as getCurrentInstance, Pt as reactive, S as computed, St as withMemo, T as createCommentVNode, U as mergeProps, W as nextTick, X as onMounted, Z as onUnmounted, _ as Fragment, bn as normalizeStyle, bt as withCtx, dt as useModel, gt as watch, h as withModifiers, it as renderSlot, j as createVNode, jt as isRef, m as withKeys, n as Transition, q as onBeforeUnmount, rt as renderList, st as resolveDynamicComponent, vn as normalizeClass, w as createBlock, yn as normalizeProps, yt as watchSyncEffect } from "./vue.runtime.esm-bundler-CiTcVoZc.js";
...
import { Cn as useProjectsStore } from "./workflows.store-DZfkxcrn.js";
import { t as useToast } from "./useToast-ioerWMiY.js";
import { gu as INSTANCE_AI_WORKFLOW_PREVIEW_SUGGESTIONS_EXPERIMENT, hu as INSTANCE_AI_PROMPT_SUGGESTIONS_V2_EXPERIMENT, mu as INSTANCE_AI_PROACTIVE_AGENT_EXPERIMENT, sl as v4 } from "./constants-CLQJMg7Y.js";
import { D as storeToRefs, t as useRootStore } from "./useRootStore-BXKn7r8-.js";
import { p as useElementSize } from "./core-CZJuH52F.js";
import { g as usePostHog, p as useTelemetry } from "./users.store-AINJEAwY.js";
...
import { n as INSTANCE_AI_THREAD_VIEW } from "./constants-bS4UZMUy.js";
import { t as useInstanceAiSettingsStore } from "./instanceAiSettings.store-D4rgSO1H.js";
import { n as useInstanceAiStore } from "./instanceAi.store-BLdBgjfY.js";
import { t as CreditWarningBanner_default } from "./CreditWarningBanner-72fWgEYq.js";
import { a as useCreditWarningBanner, n as InstanceAiViewHeader_default, o as INSTANCE_AI_EMPTY_STATE_SUGGESTIONS, r as InstanceAiInput_default, t as WorkflowBuilderUnavailableNotice_default } from "./WorkflowBuilderUnavailableNotice-BWp8Km09.js";
	...
	setup(__props) {
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("div", { class: normalizeClass(_ctx.$style.chatArea) }, [createVNode(InstanceAiViewHeader_default), createBaseVNode("div", { class: normalizeClass(_ctx.$style.contentArea) }, [showProactiveStarter.value ? (openBlock(), createElementBlock("div", {
				...
				createBaseVNode("div", { class: normalizeClass(_ctx.$style.centeredInput) }, [
					unref(creditBanner).visible.value ? (openBlock(), createBlock(CreditWarningBanner_default, {
						key: 0,
						"credits-remaining": unref(store).creditsRemaining,
						"credits-quota": unref(store).creditsQuota,
...
var InstanceAiEmptyView_vue_vue_type_style_index_0_lang_module_default = {
	inputFooter: "_inputFooter_16rfm_125",
	chatArea: "_chatArea_16rfm_138",
	contentArea: "_contentArea_16rfm_148",
	emptyLayout: "_emptyLayout_16rfm_155",
	centeredInput: "_centeredInput_16rfm_165",
	workflowPreview: "_workflowPreview_16rfm_173",
	proactiveLayout: "_proactiveLayout_16rfm_178",
	proactiveMessageList: "_proactiveMessageList_16rfm_185",
	proactiveInput: "_proactiveInput_16rfm_196"
};
