import { It as ref, Lt as shallowReactive, Pt as reactive, R as inject, S as computed, Wt as triggerRef, gt as watch, tt as provide } from "./vue.runtime.esm-bundler-DYHsQBZB.js";
import { s as useI18n } from "./src-WRlVBeQs.js";
import { C as reduceEvent, Ja as buildDataTablesSessionGrantKey, S as findAgent, T as toAgentTree, Va as INSTANCE_AI_EPHEMERAL_EVENT_TYPES, Wa as INSTANCE_AI_THREAD_SOURCE_FALLBACK, Xa as buildUpdateWorkflowSessionGrantKey, Ya as buildRunWorkflowSessionGrantKey, ma as v4, no as instanceAiEventSchema, ro as isSafeObjectKey, w as stateFromAgentTree, x as createInitialState } from "./src-B255AdRt.js";
import { Qn as makeRestApiRequest, Yn as ResponseError, cr as defineStore, t as useRootStore } from "./useRootStore-CLEJA2KF.js";
import { t as useTelemetry } from "./useTelemetry-2P8aHE7m.js";
import { n as useToast } from "./useToast-DyQykTBp.js";
import { n as redactTelemetryText, t as redactTelemetryProperties } from "./src-CRk-YGAD.js";
...
import { S as isInstanceAiThreadSource, a as INSTANCE_AI_AGENT_BUILDER_TARGET_METADATA_KEY, f as INSTANCE_AI_PENDING_AGENT_METADATA_KEY, o as INSTANCE_AI_AGENT_PREVIEW_SESSION_METADATA_KEY, s as INSTANCE_AI_AGENT_PREVIEW_VIEW_METADATA_KEY } from "./constants-CM4MaaDd.js";
import { a as postCancel, c as postFeedback, i as getInstanceAiCredits, l as postMessage, o as postCancelTask, r as ensureThread, s as postConfirmation, t as useInstanceAiSettingsStore } from "./instanceAiSettings.store-Bc5cb3Uq.js";
	...
	*/
	...
	function startCreditsPushListener() {
		...
		removeCreditsPushListener = usePushConnectionStore().addEventListener((message) => {
			...
			if (message.data.quotaLocked !== void 0) quotaLocked.value = message.data.quotaLocked;
...
//#endregion
export { fetchThreads as S, isAgentEditingAgent as _, getAgentPreviewSessionFromThreadMetadata as a, fetchThreadDebugRuns as b, getExecutionResultsByWorkflow as c, getLatestBuildResult as d, getLatestBuilderTarget as f, getLatestWorkflowUpdateResult as g, getLatestWorkflowSetupResult as h, getAgentBuilderTargetFromThreadMetadata as i, getLatestAgentBuilderTarget as l, getLatestDeletedDataTableId as m, useInstanceAiStore as n, getAgentPreviewViewFromThreadMetadata as o, getLatestDataTableResult as p, useThread as r, getPendingAgentTargetFromThreadMetadata as s, provideThread as t, getLatestAgentConfigMutation as u, isAgentEditingWorkflow as v, fetchThreadMessages as x, fetchRunDebug as y };
