...
import { $ as openBlock, A as createTextVNode, C as createBaseVNode, Cn as toDisplayString, E as createElementBlock, Gt as unref, It as ref, N as defineComponent, S as computed, T as createCommentVNode, X as onMounted, _ as Fragment, bt as withCtx, j as createVNode, m as withKeys, rt as renderList, vn as normalizeClass, w as createBlock } from "./vue.runtime.esm-bundler-DYHsQBZB.js";
...
import { n as ElRadioGroup, t as ElRadio } from "./radio-DXuAnIKj.js";
...
import { Ct as dataTableColumnNameSchema, li as DATA_TABLE_SYSTEM_COLUMNS } from "./src-BrbN-vPn.js";
import { t as useTelemetry } from "./useTelemetry-CgKpOMtU.js";
import { n as useToast } from "./useToast-Cc_wtr1y.js";
import { ir as DATA_TABLE_DETAILS, mr as PROJECT_DATA_TABLES } from "./constants-Bwbcx8Ih.js";
...
var AddDataTableModal_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		...
		const validateColumnName = (columnName) => {
			if (DATA_TABLE_SYSTEM_COLUMNS.some((sc) => sc.toLowerCase() === columnName.toLowerCase())) return i18n.baseText("dataTable.import.systemColumnName", { interpolate: { columnName } });
		...
		const deriveNameFromFileName = (fileName) => {
			return fileName.replace(/\.csv$/i, "").replace(/[^a-zA-Z0-9]+/g, " ").trim().slice(0, 128).trim();
		};
		const handleFileChange = async (uploadFile) => {
			...
			try {
				...
				if (selectedFile.value === file && !dataTableName.value) dataTableName.value = suggested;
			} catch {
				if (selectedFile.value === file && !dataTableName.value) dataTableName.value = baseName;
			}
		};
...
var header = "_header_1nvll_388";
var content = "_content_1nvll_392";
var selectionContent = "_selectionContent_1nvll_397";
var radioGroup = "_radioGroup_1nvll_403";
var uploadSection = "_uploadSection_1nvll_435";
var uploadingMessage = "_uploadingMessage_1nvll_441";
var importContent = "_importContent_1nvll_447";
var successNotice = "_successNotice_1nvll_453";
var columnHeaders = "_columnHeaders_1nvll_462";
var columnHeaderLabel = "_columnHeaderLabel_1nvll_470";
var columnsContainer = "_columnsContainer_1nvll_476";
var columnItem = "_columnItem_1nvll_485";
var columnCheckboxWrapper = "_columnCheckboxWrapper_1nvll_492";
var columnInputWrapper = "_columnInputWrapper_1nvll_499";
var columnTypeWrapper = "_columnTypeWrapper_1nvll_505";
var inputError = "_inputError_1nvll_518";
var columnErrorMessage = "_columnErrorMessage_1nvll_525";
var footer = "_footer_1nvll_531";
var fileSelectedContainer = "_fileSelectedContainer_1nvll_538";
var uploadDemo = "_uploadDemo_1nvll_545";
var uploadIcon = "_uploadIcon_1nvll_571";
var fileName = "_fileName_1nvll_575";
var shimmer = "_shimmer_1nvll_1";
var spin = "_spin_1nvll_1";
var opacityPulse = "_opacityPulse_1nvll_1";
var popoverIn = "_popoverIn_1nvll_1";
var fadeIn = "_fadeIn_1nvll_1";
var collapsibleSlideDown = "_collapsibleSlideDown_1nvll_1";
var collapsibleSlideUp = "_collapsibleSlideUp_1nvll_1";
var collapsibleSlideDownBlurred = "_collapsibleSlideDownBlurred_1nvll_1";
var collapsibleSlideUpBlurred = "_collapsibleSlideUpBlurred_1nvll_1";
var blurSwapIn = "_blurSwapIn_1nvll_1";
var blurSwapOut = "_blurSwapOut_1nvll_1";
var pulseGlow = "_pulseGlow_1nvll_1";
var pulseGlowDelayed = "_pulseGlowDelayed_1nvll_1";
var fade = "_fade_1nvll_1";
var fadeInUp = "_fadeInUp_1nvll_1";
var fadeInDown = "_fadeInDown_1nvll_1";
var fadeInLeft = "_fadeInLeft_1nvll_1";
var fadeInRight = "_fadeInRight_1nvll_1";
var fadeOut = "_fadeOut_1nvll_1";
var fadeOutDown = "_fadeOutDown_1nvll_1";
var fadeOutUp = "_fadeOutUp_1nvll_1";
var fadeOutLeft = "_fadeOutLeft_1nvll_1";
var fadeOutRight = "_fadeOutRight_1nvll_1";
var ping = "_ping_1nvll_1";
var blinkBackground = "_blinkBackground_1nvll_1";
var typingBlink = "_typingBlink_1nvll_1";
var AddDataTableModal_vue_vue_type_style_index_0_lang_module_default = {
	...
	shimmer,
	spin,
	"skeleton-pulse": "_skeleton-pulse_1nvll_1",
	opacityPulse,
	popoverIn,
	fadeIn,
