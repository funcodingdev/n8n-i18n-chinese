;
(function () {
  System.register(["./chunk-legacy-Re9CbdfL.js", "./vue.runtime.esm-bundler-legacy--Sn1h8On.js", "./_MapCache-legacy-MxDNiCoP.js", "./truncate-legacy-BmpPclhB.js", "./useTelemetry-legacy-yLgrtxmH.js", "./constants-legacy-e6rCvq4v.js", "./_baseOrderBy-legacy-Dt_IoFJy.js"], function (_export, _context) {
    "use strict";

    var __toESM, computed, ref, watchOnce, i18n, require_get, useStorage, useNodeTypesStore, STORES, useWorkflowsStore, FROM_AI_AUTO_GENERATED_MARKER, PLACEHOLDER_EMPTY_WORKFLOW_ID, jsonParse, LOCAL_STORAGE_FOCUS_PANEL, extractFromAICalls, defineStore, NODE_DENYLIST, PATH_DENYLIST, PROP_TYPE_DENYLIST, fromAIExtraProps, import_get, DEFAULT_PANEL_WIDTH, DEFAULT_FOCUS_PANEL_DATA, useFocusPanelStore;
    ...
    return {
      setters: [function (_chunkLegacy001Js) {
        ...
        LOCAL_STORAGE_FOCUS_PANEL = _constantsLegacy00TJs.ks;
