const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/es-CV8MLJc_.js","assets/chunk-CC9Q-vWm.js","assets/core-DW0KLzcX.js","assets/languageModules-V_Rt9Hhb.js","assets/xml-BIRtwBD9.js"])))=>i.map(i=>d[i]);
...
import { ca as truncateBeforeLast, do as N8nButton_default } from "./src-Y_a_nQpS.js";
	...
	async function loadLanguageModules() {
		...
		try {
			const promise = Promise.all([__vitePreload(async () => {
				const { default: highlight } = await import("./es-CV8MLJc_.js");
				return { default: highlight };
			}, __vite__mapDeps([0,1,2])).then(({ default: highlight }) => highlight), __vitePreload(() => import("./languageModules-V_Rt9Hhb.js"), __vite__mapDeps([3,4]))]);
			asyncImport = {
				status: "inProgress",
				promise
			};
