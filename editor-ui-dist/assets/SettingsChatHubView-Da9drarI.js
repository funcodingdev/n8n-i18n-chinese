import { $ as openBlock, A as createTextVNode, C as createBaseVNode, Cn as toDisplayString, E as createElementBlock, Gt as unref, It as ref, N as defineComponent, S as computed, T as createCommentVNode, X as onMounted, _ as Fragment, bt as withCtx, gt as watch, j as createVNode, rt as renderList, vn as normalizeClass, w as createBlock } from "./vue.runtime.esm-bundler-CDDUUZhE.js";
...
import { Nc as deepCopy, lo as chatHubVectorStoreProviderSchema, no as PROVIDER_CREDENTIAL_TYPE_MAP, oo as chatHubLLMProviderSchema, ro as VECTOR_STORE_PROVIDER_CREDENTIAL_TYPE_MAP, wu as CHAT_HUB_SEMANTIC_SEARCH_EXPERIMENT } from "./constants-DzzWpyjZ.js";
import { it as useCredentialsStore } from "./workflowDocument.store-BQc6YDGi.js";
import { D as storeToRefs, t as useRootStore } from "./useRootStore-C7jLo3fI.js";
import { t as useSettingsStore } from "./settings.store-DmallR-B.js";
import { f as useUIStore, g as usePostHog, p as useTelemetry, t as useUsersStore } from "./users.store-CUxYM5yQ.js";
...
import { t as CredentialPicker_default } from "./CredentialPicker-LEEoVA9R.js";
import { d as updateSemanticSearchSettingsApi, n as DEFAULT_SEMANTIC_SEARCH_SETTINGS, r as EMBEDDINGS_NODE_TYPE_MAP, t as useChatStore } from "./chat.store-fYSf6B2o.js";
