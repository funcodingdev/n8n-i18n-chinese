...
import { Qr as getNodesWithNormalizedPosition } from "./workflowDocument.store-CJmrbFRO.js";
import { T as defineStore, t as useRootStore } from "./useRootStore-H_HdEClX.js";
import { Bn as getWorkflows, Fn as getCollectionById, In as getCollections, Pn as getCategories, Rn as getTemplateById, Vn as STORES, t as useSettingsStore, zn as getWorkflowTemplate } from "./settings.store-CQqpFn-s.js";
import { E as TEMPLATES_URLS } from "./constants-BzyjfRY2.js";
...
import { r as getTemplatePathByRole } from "./utils-C3XoKXLx.js";
...
var useTemplatesStore = defineStore(STORES.TEMPLATES, () => {
	...
	const instanceFeatures = computed(() => {
		const features = [];
		if (instanceAiAvailable.value) features.push("assistant");
		return features;
	});
	const websiteTemplateRepositoryParameters = computed(() => {
		...
		if (instanceFeatures.value.length > 0) defaultParameters.utm_instance_features = instanceFeatures.value.join(",");
