;
(function () {
  System.register(["./_MapCache-legacy-Bnay2tPV.js", "./useMessage-legacy-6hGlTqPS.js", "./useTelemetry-legacy-DKRvN4mA.js", "./useToast-legacy-DEFFmTH6.js", "./constants-legacy-BbwdWVie.js", "./useExternalHooks-legacy-DyFictUx.js", "./npsSurvey.store-legacy-BRhjpTEy.js", "./templates.store-legacy-x3SOFlkt.js", "./focusPanel.store-legacy-CzF3CLCV.js"], function (_export, _context) {
    "use strict";

    var useI18n, useMessage, useSourceControlStore, useUIStore, useCanvasStore, injectWorkflowState, tryToParseNumber, useNodeTypesStore, useWorkflowHelpers, useWorkflowsStore, useTelemetry, useNodeHelpers, useToast, MODAL_CANCEL, getResourcePermissions, VIEWS, NON_ACTIVATABLE_TRIGGER_NODE_TYPES, calculateWorkflowChecksum, IS_DRAFT_PUBLISH_ENABLED, PLACEHOLDER_EMPTY_WORKFLOW_ID, MODAL_CLOSE, MODAL_CONFIRM, useExternalHooks, useNpsSurveyStore, useTemplatesStore, useFocusPanelStore;
    ...
    return {
      setters: [function (_MapCacheLegacy005Js) {
        ...
        MODAL_CANCEL = _constantsLegacy00TJs.$o;
        ...
        MODAL_CLOSE = _constantsLegacy00TJs.es;
