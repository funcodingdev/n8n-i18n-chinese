...
import { Cn as useProjectsStore, Nt as useCredentialsStore, Zi as sanitizeHtml } from "./workflows.store-DZfkxcrn.js";
...
function useQuickConnect() {
	...
	async function connectToPinecone(quickConnectOption) {
		const { ConnectPopup } = await __vitePreload(async () => {
			const { ConnectPopup } = await import("./dist-BfL2QKy_.js");
			return { ConnectPopup };
		}, []);
