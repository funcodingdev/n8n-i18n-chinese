...
import { Ai as N8nText_default, At as N8nEmptyState_default, C as N8nDataTableServer_default, D as N8nUserSelect_default, Et as N8nInputLabel_default, Fi as N8nIconButton_default, Ii as N8nButton_default, Li as N8nIcon_default, Pi as Input_default, T as N8nIconPicker_default, Xt as N8nActionToggle_default, jt as N8nHeading_default, k as N8nUserInfo_default, qt as Alert_default, wt as N8nFormInput_default } from "./src-TtOAzrsZ.js";
...
import { dn as useProjectsStore, ln as useAvailableProjectSearch, wi as isProjectRole } from "./workflows.store-YK4BoC2f.js";
import { b as ROLE, da as getResourcePermissions, fi as deepCopy } from "./src-DVvN4F-B.js";
...
import { _i as SECRETS_PROVIDER_CONNECTION_MODAL_KEY, k as APP_MODALS_ELEMENT_ID } from "./constants-CQOOvzhs.js";
import { t as DEBOUNCE_TIME } from "./durations-CNO5pC2_.js";
import { t as VIEWS } from "./views-4JHVC4Nc.js";
import { n as useTelemetry, o as useUIStore, y as DEFAULT_PROJECT_ICON } from "./posthog.store-jf7EASbZ.js";
...
import { t as RoleSelectDropdown_default } from "./RoleSelectDropdown-DQZxJOQA.js";
...
var ProjectSettings_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		...
		const shouldFetchAllUsers = computed(() => hasPermission(["rbac"], { rbac: { scope: "user:list" } }) || canUpdateProject.value);
					...
					canUpdateProject.value ? (openBlock(), createElementBlock(Fragment, { key: 1 }, [
						createBaseVNode("fieldset", _hoisted_3, [
							...
							relationUsers.value.length > 0 ? (openBlock(), createElementBlock("div", {
								...
								"can-edit-role": !rolesManaged.value,
