...
import { $ as openBlock, C as createBaseVNode, Cn as toDisplayString, E as createElementBlock, Gt as unref, N as defineComponent, T as createCommentVNode, it as renderSlot, vn as normalizeClass, w as createBlock } from "./vue.runtime.esm-bundler-Bs4WIMNP.js";
import { ro as N8nIcon_default } from "./src-BR3WX5fi.js";
import { t as _plugin_vue_export_helper_default } from "./_plugin-vue_export-helper-Da88TEg1.js";
//#region ../../../node_modules/.pnpm/prettier@3.6.2/node_modules/prettier/standalone.mjs
var Fu$1 = Object.create;
var pt$1 = Object.defineProperty;
var pu$1 = Object.getOwnPropertyDescriptor;
var du$1 = Object.getOwnPropertyNames;
var mu$1 = Object.getPrototypeOf, Eu$1 = Object.prototype.hasOwnProperty;
var er = (e) => {
	throw TypeError(e);
};
var Cu$1 = (e, t) => () => (t || e((t = { exports: {} }).exports, t), t.exports), dt$1 = (e, t) => {
	for (var r in t) pt$1(e, r, {
		get: t[r],
		enumerable: !0
	});
}, hu$1 = (e, t, r, n) => {
	if (t && typeof t == "object" || typeof t == "function") for (let u of du$1(t)) !Eu$1.call(e, u) && u !== r && pt$1(e, u, {
		get: () => t[u],
		enumerable: !(n = pu$1(t, u)) || n.enumerable
	});
	return e;
};
var gu$1 = (e, t, r) => (r = e != null ? Fu$1(mu$1(e)) : {}, hu$1(t || !e || !e.__esModule ? pt$1(r, "default", {
	value: e,
	enumerable: !0
}) : r, e));
var yu$1 = (e, t, r) => t.has(e) || er("Cannot " + r);
var tr = (e, t, r) => t.has(e) ? er("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, r);
var fe$1 = (e, t, r) => (yu$1(e, t, "access private method"), r);
var Pn$1 = Cu$1((Mt) => {
	"use strict";
	...
	function ho(e, t, r) {
		...
		if (F) for (let d = 0; d <= F; d++) {
			let m = d + s;
			if (!a) f[m] = !0;
			else if (d === 0) f[m] = [a, t[m - 1].length - a + 1];
			else if (d === F) f[m] = [0, D];
			else f[m] = [0, t[m - d].length];
		}
	...
	function go(e, t, r = {}) {
		let u = Co(!1), { start: i, end: s, markerLines: a } = ho(t, e.split(On), r), c = t.start && typeof t.start.column == "number", D = String(s).length, l = e.split(On, s).slice(i, s).map((F, f) => {
...
var W = "string", Y$2 = "array", j$2 = "cursor", N$1 = "indent", O$1 = "align", P$1 = "trim", B = "group", k$1 = "fill", _ = "if-break", v$2 = "indent-if-break", L = "line-suffix", I = "line-suffix-boundary", g = "line", S$1 = "label", w$1 = "break-parent", Ue$2 = new Set([
	j$2,
	N$1,
	O$1,
	P$1,
...
function _u$1(e) {
	...
	if (Array.isArray(e)) return Y$2;
	if (!e) return;
	let { type: t } = e;
	if (Ue$2.has(t)) return t;
}
var M = _u$1;
var xu$1 = (e) => new Intl.ListFormat("en-US", { type: "disjunction" }).format(e);
function wu$1(e) {
...
Expected it to be 'string' or 'object'.`;
	...
	let n = xu$1([...Ue$2].map((u) => `'${u}'`));
	return `Unexpected doc.type '${e.type}'.
Expected it to be ${n}.`;
}
var ht$1 = class extends Error {
	name = "InvalidDocError";
	constructor(t) {
		super(wu$1(t)), this.doc = t;
	}
}, q = ht$1;
var ir$1 = {};
function bu$1(e, t, r, n) {
	let u = [e];
	for (; u.length > 0;) {
		let o = u.pop();
		if (o === ir$1) {
		...
		if ((t == null ? void 0 : t(o)) !== !1) switch (i) {
			case Y$2:
			case k$1: {
				let s = i === Y$2 ? o : o.parts;
				for (let c = s.length - 1; c >= 0; --c) u.push(s[c]);
				break;
			}
			case _:
...
function ku$1(e) {
	if (e.type === B && e.break || e.type === g && e.hard || e.type === w$1) return !0;
}
function Dr$1(e) {
	return Ve$1(e, ku$1, !1);
}
function sr$1(e) {
	if (e.length > 0) {
		let t = y(!1, e, -1);
...
function cr$1(e) {
	...
	function n(o) {
		if (o.type === w$1 && sr$1(r), o.type === B) {
			if (r.push(o), t.has(o)) return !1;
			t.add(o);
		}
	}
	function u(o) {
		o.type === B && r.pop().break && sr$1(r);
	}
	le$2(e, n, u, !0);
}
function Su$1(e) {
...
function ar$1(e) {
	for (e = [...e]; e.length >= 2 && y(!1, e, -2).type === g && y(!1, e, -1).type === w$1;) e.length -= 2;
	if (e.length > 0) {
		let t = we$1(y(!1, e, -1));
		e[e.length - 1] = t;
	}
...
function we$1(e) {
	switch (M(e)) {
		...
		case _: return {
			...e,
			breakContents: we$1(e.breakContents),
			flatContents: we$1(e.flatContents)
		};
		case k$1: return {
			...e,
			parts: ar$1(e.parts)
		};
		case Y$2: return ar$1(e);
		case W: return or$1(e);
		case O$1:
		case j$2:
		case P$1:
		case I:
...
function Nu$1(e) {
	return be$1(e, (t) => Tu$1(t));
}
function lr$1(e, t = We$1) {
	return be$1(e, (r) => typeof r == "string" ? ke$1(t, r.split(`
`)) : r);
}
function Ou$1(e) {
...
var gt$1 = () => {}, K$2 = gt$1, yt$1 = gt$1, pr$1 = gt$1;
function ie$1(e) {
	return K$2(e), {
		type: N$1,
		contents: e
...
function At$2(e, t = {}) {
	return K$2(e), yt$1(t.expandedStates, !0), {
		type: B,
		id: t.id,
		contents: e,
		break: !!t.shouldBreak,
...
function dr(e) {
	return oe$2(Number.NEGATIVE_INFINITY, e);
}
function mr$1(e) {
	return oe$2({ type: "root" }, e);
}
function Er$1(e) {
	return oe$2(-1, e);
}
...
var Ar$1 = { type: I }, pe$1 = { type: w$1 }, Br$1 = { type: P$1 }, Te$2 = {
	type: g,
	hard: !0
}, Bt$1 = {
	type: g,
	...
	type: g,
	soft: !0
}, z$1 = [Te$2, pe$1], We$1 = [Bt$1, pe$1], X$1 = { type: j$2 };
function ke$1(e, t) {
	K$2(e), yt$1(t);
	let r = [];
...
function Ge$1(e, t, r) {
	...
	let n = e;
	if (t > 0) {
		for (let u = 0; u < Math.floor(t / r); ++u) n = ie$1(n);
		n = oe$2(t % r, n), n = oe$2(Number.NEGATIVE_INFINITY, n);
	}
	return n;
}
function xr$1(e, t) {
...
function Q$1(e) {
	...
	if (Array.isArray(e)) {
		let r = [];
		for (let n of e) if (Array.isArray(n)) r.push(...Q$1(n));
		else {
			let u = Q$1(n);
			u !== "" && r.push(u);
		}
	...
	return e.type === _ ? {
		...e,
		breakContents: Q$1(e.breakContents),
		flatContents: Q$1(e.flatContents)
	} : e.type === B ? {
		...e,
		contents: Q$1(e.contents),
		expandedStates: (t = e.expandedStates) == null ? void 0 : t.map(Q$1)
	} : e.type === k$1 ? {
		type: "fill",
		parts: e.parts.map(Q$1)
	} : e.contents ? {
		...e,
		contents: Q$1(e.contents)
	} : e;
...
function wr$1(e) {
	...
	function n(o, i, s) {
		...
		if (o.type === g) {
			let D = ((a = s == null ? void 0 : s[i + 1]) == null ? void 0 : a.type) === w$1;
		...
		if (o.type === w$1) return ((c = s == null ? void 0 : s[i - 1]) == null ? void 0 : c.type) === g && s[i - 1].hard ? void 0 : "breakParent";
		if (o.type === P$1) return "trim";
		if (o.type === N$1) return "indent(" + n(o.contents) + ")";
		if (o.type === O$1) return o.n === Number.NEGATIVE_INFINITY ? "dedentToRoot(" + n(o.contents) + ")" : o.n < 0 ? "dedent(" + n(o.contents) + ")" : o.n.type === "root" ? "markAsRoot(" + n(o.contents) + ")" : "align(" + JSON.stringify(o.n) + ", " + n(o.contents) + ")";
		...
		if (o.type === k$1) return `fill([${o.parts.map((D) => n(D)).join(", ")}])`;
		if (o.type === L) return "lineSuffix(" + n(o.contents) + ")";
		if (o.type === I) return "lineSuffixBoundary";
		if (o.type === S$1) return `label(${JSON.stringify(o.label)}, ${n(o.contents)})`;
		if (o.type === j$2) return "cursor";
...
var br$1 = () => /[#*0-9]\uFE0F?\u20E3|[\xA9\xAE\u203C\u2049\u2122\u2139\u2194-\u2199\u21A9\u21AA\u231A\u231B\u2328\u23CF\u23ED-\u23EF\u23F1\u23F2\u23F8-\u23FA\u24C2\u25AA\u25AB\u25B6\u25C0\u25FB\u25FC\u25FE\u2600-\u2604\u260E\u2611\u2614\u2615\u2618\u2620\u2622\u2623\u2626\u262A\u262E\u262F\u2638-\u263A\u2640\u2642\u2648-\u2653\u265F\u2660\u2663\u2665\u2666\u2668\u267B\u267E\u267F\u2692\u2694-\u2697\u2699\u269B\u269C\u26A0\u26A7\u26AA\u26B0\u26B1\u26BD\u26BE\u26C4\u26C8\u26CF\u26D1\u26E9\u26F0-\u26F5\u26F7\u26F8\u26FA\u2702\u2708\u2709\u270F\u2712\u2714\u2716\u271D\u2721\u2733\u2734\u2744\u2747\u2757\u2763\u27A1\u2934\u2935\u2B05-\u2B07\u2B1B\u2B1C\u2B55\u3030\u303D\u3297\u3299]\uFE0F?|[\u261D\u270C\u270D](?:\uD83C[\uDFFB-\uDFFF]|\uFE0F)?|[\u270A\u270B](?:\uD83C[\uDFFB-\uDFFF])?|[\u23E9-\u23EC\u23F0\u23F3\u25FD\u2693\u26A1\u26AB\u26C5\u26CE\u26D4\u26EA\u26FD\u2705\u2728\u274C\u274E\u2753-\u2755\u2795-\u2797\u27B0\u27BF\u2B50]|\u26D3\uFE0F?(?:\u200D\uD83D\uDCA5)?|\u26F9(?:\uD83C[\uDFFB-\uDFFF]|\uFE0F)?(?:\u200D[\u2640\u2642]\uFE0F?)?|\u2764\uFE0F?(?:\u200D(?:\uD83D\uDD25|\uD83E\uDE79))?|\uD83C(?:[\uDC04\uDD70\uDD71\uDD7E\uDD7F\uDE02\uDE37\uDF21\uDF24-\uDF2C\uDF36\uDF7D\uDF96\uDF97\uDF99-\uDF9B\uDF9E\uDF9F\uDFCD\uDFCE\uDFD4-\uDFDF\uDFF5\uDFF7]\uFE0F?|[\uDF85\uDFC2\uDFC7](?:\uD83C[\uDFFB-\uDFFF])?|[\uDFC4\uDFCA](?:\uD83C[\uDFFB-\uDFFF])?(?:\u200D[\u2640\u2642]\uFE0F?)?|[\uDFCB\uDFCC](?:\uD83C[\uDFFB-\uDFFF]|\uFE0F)?(?:\u200D[\u2640\u2642]\uFE0F?)?|[\uDCCF\uDD8E\uDD91-\uDD9A\uDE01\uDE1A\uDE2F\uDE32-\uDE36\uDE38-\uDE3A\uDE50\uDE51\uDF00-\uDF20\uDF2D-\uDF35\uDF37-\uDF43\uDF45-\uDF4A\uDF4C-\uDF7C\uDF7E-\uDF84\uDF86-\uDF93\uDFA0-\uDFC1\uDFC5\uDFC6\uDFC8\uDFC9\uDFCF-\uDFD3\uDFE0-\uDFF0\uDFF8-\uDFFF]|\uDDE6\uD83C[\uDDE8-\uDDEC\uDDEE\uDDF1\uDDF2\uDDF4\uDDF6-\uDDFA\uDDFC\uDDFD\uDDFF]|\uDDE7\uD83C[\uDDE6\uDDE7\uDDE9-\uDDEF\uDDF1-\uDDF4\uDDF6-\uDDF9\uDDFB\uDDFC\uDDFE\uDDFF]|\uDDE8\uD83C[\uDDE6\uDDE8\uDDE9\uDDEB-\uDDEE\uDDF0-\uDDF7\uDDFA-\uDDFF]|\uDDE9\uD83C[\uDDEA\uDDEC\uDDEF\uDDF0\uDDF2\uDDF4\uDDFF]|\uDDEA\uD83C[\uDDE6\uDDE8\uDDEA\uDDEC\uDDED\uDDF7-\uDDFA]|\uDDEB\uD83C[\uDDEE-\uDDF0\uDDF2\uDDF4\uDDF7]|\uDDEC\uD83C[\uDDE6\uDDE7\uDDE9-\uDDEE\uDDF1-\uDDF3\uDDF5-\uDDFA\uDDFC\uDDFE]|\uDDED\uD83C[\uDDF0\uDDF2\uDDF3\uDDF7\uDDF9\uDDFA]|\uDDEE\uD83C[\uDDE8-\uDDEA\uDDF1-\uDDF4\uDDF6-\uDDF9]|\uDDEF\uD83C[\uDDEA\uDDF2\uDDF4\uDDF5]|\uDDF0\uD83C[\uDDEA\uDDEC-\uDDEE\uDDF2\uDDF3\uDDF5\uDDF7\uDDFC\uDDFE\uDDFF]|\uDDF1\uD83C[\uDDE6-\uDDE8\uDDEE\uDDF0\uDDF7-\uDDFB\uDDFE]|\uDDF2\uD83C[\uDDE6\uDDE8-\uDDED\uDDF0-\uDDFF]|\uDDF3\uD83C[\uDDE6\uDDE8\uDDEA-\uDDEC\uDDEE\uDDF1\uDDF4\uDDF5\uDDF7\uDDFA\uDDFF]|\uDDF4\uD83C\uDDF2|\uDDF5\uD83C[\uDDE6\uDDEA-\uDDED\uDDF0-\uDDF3\uDDF7-\uDDF9\uDDFC\uDDFE]|\uDDF6\uD83C\uDDE6|\uDDF7\uD83C[\uDDEA\uDDF4\uDDF8\uDDFA\uDDFC]|\uDDF8\uD83C[\uDDE6-\uDDEA\uDDEC-\uDDF4\uDDF7-\uDDF9\uDDFB\uDDFD-\uDDFF]|\uDDF9\uD83C[\uDDE6\uDDE8\uDDE9\uDDEB-\uDDED\uDDEF-\uDDF4\uDDF7\uDDF9\uDDFB\uDDFC\uDDFF]|\uDDFA\uD83C[\uDDE6\uDDEC\uDDF2\uDDF3\uDDF8\uDDFE\uDDFF]|\uDDFB\uD83C[\uDDE6\uDDE8\uDDEA\uDDEC\uDDEE\uDDF3\uDDFA]|\uDDFC\uD83C[\uDDEB\uDDF8]|\uDDFD\uD83C\uDDF0|\uDDFE\uD83C[\uDDEA\uDDF9]|\uDDFF\uD83C[\uDDE6\uDDF2\uDDFC]|\uDF44(?:\u200D\uD83D\uDFEB)?|\uDF4B(?:\u200D\uD83D\uDFE9)?|\uDFC3(?:\uD83C[\uDFFB-\uDFFF])?(?:\u200D(?:[\u2640\u2642]\uFE0F?(?:\u200D\u27A1\uFE0F?)?|\u27A1\uFE0F?))?|\uDFF3\uFE0F?(?:\u200D(?:\u26A7\uFE0F?|\uD83C\uDF08))?|\uDFF4(?:\u200D\u2620\uFE0F?|\uDB40\uDC67\uDB40\uDC62\uDB40(?:\uDC65\uDB40\uDC6E\uDB40\uDC67|\uDC73\uDB40\uDC63\uDB40\uDC74|\uDC77\uDB40\uDC6C\uDB40\uDC73)\uDB40\uDC7F)?)|\uD83D(?:[\uDC3F\uDCFD\uDD49\uDD4A\uDD6F\uDD70\uDD73\uDD76-\uDD79\uDD87\uDD8A-\uDD8D\uDDA5\uDDA8\uDDB1\uDDB2\uDDBC\uDDC2-\uDDC4\uDDD1-\uDDD3\uDDDC-\uDDDE\uDDE1\uDDE3\uDDE8\uDDEF\uDDF3\uDDFA\uDECB\uDECD-\uDECF\uDEE0-\uDEE5\uDEE9\uDEF0\uDEF3]\uFE0F?|[\uDC42\uDC43\uDC46-\uDC50\uDC66\uDC67\uDC6B-\uDC6D\uDC72\uDC74-\uDC76\uDC78\uDC7C\uDC83\uDC85\uDC8F\uDC91\uDCAA\uDD7A\uDD95\uDD96\uDE4C\uDE4F\uDEC0\uDECC](?:\uD83C[\uDFFB-\uDFFF])?|[\uDC6E\uDC70\uDC71\uDC73\uDC77\uDC81\uDC82\uDC86\uDC87\uDE45-\uDE47\uDE4B\uDE4D\uDE4E\uDEA3\uDEB4\uDEB5](?:\uD83C[\uDFFB-\uDFFF])?(?:\u200D[\u2640\u2642]\uFE0F?)?|[\uDD74\uDD90](?:\uD83C[\uDFFB-\uDFFF]|\uFE0F)?|[\uDC00-\uDC07\uDC09-\uDC14\uDC16-\uDC25\uDC27-\uDC3A\uDC3C-\uDC3E\uDC40\uDC44\uDC45\uDC51-\uDC65\uDC6A\uDC79-\uDC7B\uDC7D-\uDC80\uDC84\uDC88-\uDC8E\uDC90\uDC92-\uDCA9\uDCAB-\uDCFC\uDCFF-\uDD3D\uDD4B-\uDD4E\uDD50-\uDD67\uDDA4\uDDFB-\uDE2D\uDE2F-\uDE34\uDE37-\uDE41\uDE43\uDE44\uDE48-\uDE4A\uDE80-\uDEA2\uDEA4-\uDEB3\uDEB7-\uDEBF\uDEC1-\uDEC5\uDED0-\uDED2\uDED5-\uDED7\uDEDC-\uDEDF\uDEEB\uDEEC\uDEF4-\uDEFC\uDFE0-\uDFEB\uDFF0]|\uDC08(?:\u200D\u2B1B)?|\uDC15(?:\u200D\uD83E\uDDBA)?|\uDC26(?:\u200D(?:\u2B1B|\uD83D\uDD25))?|\uDC3B(?:\u200D\u2744\uFE0F?)?|\uDC41\uFE0F?(?:\u200D\uD83D\uDDE8\uFE0F?)?|\uDC68(?:\u200D(?:[\u2695\u2696\u2708]\uFE0F?|\u2764\uFE0F?\u200D\uD83D(?:\uDC8B\u200D\uD83D)?\uDC68|\uD83C[\uDF3E\uDF73\uDF7C\uDF93\uDFA4\uDFA8\uDFEB\uDFED]|\uD83D(?:[\uDC68\uDC69]\u200D\uD83D(?:\uDC66(?:\u200D\uD83D\uDC66)?|\uDC67(?:\u200D\uD83D[\uDC66\uDC67])?)|[\uDCBB\uDCBC\uDD27\uDD2C\uDE80\uDE92]|\uDC66(?:\u200D\uD83D\uDC66)?|\uDC67(?:\u200D\uD83D[\uDC66\uDC67])?)|\uD83E(?:[\uDDAF\uDDBC\uDDBD](?:\u200D\u27A1\uFE0F?)?|[\uDDB0-\uDDB3]))|\uD83C(?:\uDFFB(?:\u200D(?:[\u2695\u2696\u2708]\uFE0F?|\u2764\uFE0F?\u200D\uD83D(?:\uDC8B\u200D\uD83D)?\uDC68\uD83C[\uDFFB-\uDFFF]|\uD83C[\uDF3E\uDF73\uDF7C\uDF93\uDFA4\uDFA8\uDFEB\uDFED]|\uD83D[\uDCBB\uDCBC\uDD27\uDD2C\uDE80\uDE92]|\uD83E(?:[\uDDAF\uDDBC\uDDBD](?:\u200D\u27A1\uFE0F?)?|[\uDDB0-\uDDB3]|\uDD1D\u200D\uD83D\uDC68\uD83C[\uDFFC-\uDFFF])))?|\uDFFC(?:\u200D(?:[\u2695\u2696\u2708]\uFE0F?|\u2764\uFE0F?\u200D\uD83D(?:\uDC8B\u200D\uD83D)?\uDC68\uD83C[\uDFFB-\uDFFF]|\uD83C[\uDF3E\uDF73\uDF7C\uDF93\uDFA4\uDFA8\uDFEB\uDFED]|\uD83D[\uDCBB\uDCBC\uDD27\uDD2C\uDE80\uDE92]|\uD83E(?:[\uDDAF\uDDBC\uDDBD](?:\u200D\u27A1\uFE0F?)?|[\uDDB0-\uDDB3]|\uDD1D\u200D\uD83D\uDC68\uD83C[\uDFFB\uDFFD-\uDFFF])))?|\uDFFD(?:\u200D(?:[\u2695\u2696\u2708]\uFE0F?|\u2764\uFE0F?\u200D\uD83D(?:\uDC8B\u200D\uD83D)?\uDC68\uD83C[\uDFFB-\uDFFF]|\uD83C[\uDF3E\uDF73\uDF7C\uDF93\uDFA4\uDFA8\uDFEB\uDFED]|\uD83D[\uDCBB\uDCBC\uDD27\uDD2C\uDE80\uDE92]|\uD83E(?:[\uDDAF\uDDBC\uDDBD](?:\u200D\u27A1\uFE0F?)?|[\uDDB0-\uDDB3]|\uDD1D\u200D\uD83D\uDC68\uD83C[\uDFFB\uDFFC\uDFFE\uDFFF])))?|\uDFFE(?:\u200D(?:[\u2695\u2696\u2708]\uFE0F?|\u2764\uFE0F?\u200D\uD83D(?:\uDC8B\u200D\uD83D)?\uDC68\uD83C[\uDFFB-\uDFFF]|\uD83C[\uDF3E\uDF73\uDF7C\uDF93\uDFA4\uDFA8\uDFEB\uDFED]|\uD83D[\uDCBB\uDCBC\uDD27\uDD2C\uDE80\uDE92]|\uD83E(?:[\uDDAF\uDDBC\uDDBD](?:\u200D\u27A1\uFE0F?)?|[\uDDB0-\uDDB3]|\uDD1D\u200D\uD83D\uDC68\uD83C[\uDFFB-\uDFFD\uDFFF])))?|\uDFFF(?:\u200D(?:[\u2695\u2696\u2708]\uFE0F?|\u2764\uFE0F?\u200D\uD83D(?:\uDC8B\u200D\uD83D)?\uDC68\uD83C[\uDFFB-\uDFFF]|\uD83C[\uDF3E\uDF73\uDF7C\uDF93\uDFA4\uDFA8\uDFEB\uDFED]|\uD83D[\uDCBB\uDCBC\uDD27\uDD2C\uDE80\uDE92]|\uD83E(?:[\uDDAF\uDDBC\uDDBD](?:\u200D\u27A1\uFE0F?)?|[\uDDB0-\uDDB3]|\uDD1D\u200D\uD83D\uDC68\uD83C[\uDFFB-\uDFFE])))?))?|\uDC69(?:\u200D(?:[\u2695\u2696\u2708]\uFE0F?|\u2764\uFE0F?\u200D\uD83D(?:\uDC8B\u200D\uD83D)?[\uDC68\uDC69]|\uD83C[\uDF3E\uDF73\uDF7C\uDF93\uDFA4\uDFA8\uDFEB\uDFED]|\uD83D(?:[\uDCBB\uDCBC\uDD27\uDD2C\uDE80\uDE92]|\uDC66(?:\u200D\uD83D\uDC66)?|\uDC67(?:\u200D\uD83D[\uDC66\uDC67])?|\uDC69\u200D\uD83D(?:\uDC66(?:\u200D\uD83D\uDC66)?|\uDC67(?:\u200D\uD83D[\uDC66\uDC67])?))|\uD83E(?:[\uDDAF\uDDBC\uDDBD](?:\u200D\u27A1\uFE0F?)?|[\uDDB0-\uDDB3]))|\uD83C(?:\uDFFB(?:\u200D(?:[\u2695\u2696\u2708]\uFE0F?|\u2764\uFE0F?\u200D\uD83D(?:[\uDC68\uDC69]|\uDC8B\u200D\uD83D[\uDC68\uDC69])\uD83C[\uDFFB-\uDFFF]|\uD83C[\uDF3E\uDF73\uDF7C\uDF93\uDFA4\uDFA8\uDFEB\uDFED]|\uD83D[\uDCBB\uDCBC\uDD27\uDD2C\uDE80\uDE92]|\uD83E(?:[\uDDAF\uDDBC\uDDBD](?:\u200D\u27A1\uFE0F?)?|[\uDDB0-\uDDB3]|\uDD1D\u200D\uD83D[\uDC68\uDC69]\uD83C[\uDFFC-\uDFFF])))?|\uDFFC(?:\u200D(?:[\u2695\u2696\u2708]\uFE0F?|\u2764\uFE0F?\u200D\uD83D(?:[\uDC68\uDC69]|\uDC8B\u200D\uD83D[\uDC68\uDC69])\uD83C[\uDFFB-\uDFFF]|\uD83C[\uDF3E\uDF73\uDF7C\uDF93\uDFA4\uDFA8\uDFEB\uDFED]|\uD83D[\uDCBB\uDCBC\uDD27\uDD2C\uDE80\uDE92]|\uD83E(?:[\uDDAF\uDDBC\uDDBD](?:\u200D\u27A1\uFE0F?)?|[\uDDB0-\uDDB3]|\uDD1D\u200D\uD83D[\uDC68\uDC69]\uD83C[\uDFFB\uDFFD-\uDFFF])))?|\uDFFD(?:\u200D(?:[\u2695\u2696\u2708]\uFE0F?|\u2764\uFE0F?\u200D\uD83D(?:[\uDC68\uDC69]|\uDC8B\u200D\uD83D[\uDC68\uDC69])\uD83C[\uDFFB-\uDFFF]|\uD83C[\uDF3E\uDF73\uDF7C\uDF93\uDFA4\uDFA8\uDFEB\uDFED]|\uD83D[\uDCBB\uDCBC\uDD27\uDD2C\uDE80\uDE92]|\uD83E(?:[\uDDAF\uDDBC\uDDBD](?:\u200D\u27A1\uFE0F?)?|[\uDDB0-\uDDB3]|\uDD1D\u200D\uD83D[\uDC68\uDC69]\uD83C[\uDFFB\uDFFC\uDFFE\uDFFF])))?|\uDFFE(?:\u200D(?:[\u2695\u2696\u2708]\uFE0F?|\u2764\uFE0F?\u200D\uD83D(?:[\uDC68\uDC69]|\uDC8B\u200D\uD83D[\uDC68\uDC69])\uD83C[\uDFFB-\uDFFF]|\uD83C[\uDF3E\uDF73\uDF7C\uDF93\uDFA4\uDFA8\uDFEB\uDFED]|\uD83D[\uDCBB\uDCBC\uDD27\uDD2C\uDE80\uDE92]|\uD83E(?:[\uDDAF\uDDBC\uDDBD](?:\u200D\u27A1\uFE0F?)?|[\uDDB0-\uDDB3]|\uDD1D\u200D\uD83D[\uDC68\uDC69]\uD83C[\uDFFB-\uDFFD\uDFFF])))?|\uDFFF(?:\u200D(?:[\u2695\u2696\u2708]\uFE0F?|\u2764\uFE0F?\u200D\uD83D(?:[\uDC68\uDC69]|\uDC8B\u200D\uD83D[\uDC68\uDC69])\uD83C[\uDFFB-\uDFFF]|\uD83C[\uDF3E\uDF73\uDF7C\uDF93\uDFA4\uDFA8\uDFEB\uDFED]|\uD83D[\uDCBB\uDCBC\uDD27\uDD2C\uDE80\uDE92]|\uD83E(?:[\uDDAF\uDDBC\uDDBD](?:\u200D\u27A1\uFE0F?)?|[\uDDB0-\uDDB3]|\uDD1D\u200D\uD83D[\uDC68\uDC69]\uD83C[\uDFFB-\uDFFE])))?))?|\uDC6F(?:\u200D[\u2640\u2642]\uFE0F?)?|\uDD75(?:\uD83C[\uDFFB-\uDFFF]|\uFE0F)?(?:\u200D[\u2640\u2642]\uFE0F?)?|\uDE2E(?:\u200D\uD83D\uDCA8)?|\uDE35(?:\u200D\uD83D\uDCAB)?|\uDE36(?:\u200D\uD83C\uDF2B\uFE0F?)?|\uDE42(?:\u200D[\u2194\u2195]\uFE0F?)?|\uDEB6(?:\uD83C[\uDFFB-\uDFFF])?(?:\u200D(?:[\u2640\u2642]\uFE0F?(?:\u200D\u27A1\uFE0F?)?|\u27A1\uFE0F?))?)|\uD83E(?:[\uDD0C\uDD0F\uDD18-\uDD1F\uDD30-\uDD34\uDD36\uDD77\uDDB5\uDDB6\uDDBB\uDDD2\uDDD3\uDDD5\uDEC3-\uDEC5\uDEF0\uDEF2-\uDEF8](?:\uD83C[\uDFFB-\uDFFF])?|[\uDD26\uDD35\uDD37-\uDD39\uDD3D\uDD3E\uDDB8\uDDB9\uDDCD\uDDCF\uDDD4\uDDD6-\uDDDD](?:\uD83C[\uDFFB-\uDFFF])?(?:\u200D[\u2640\u2642]\uFE0F?)?|[\uDDDE\uDDDF](?:\u200D[\u2640\u2642]\uFE0F?)?|[\uDD0D\uDD0E\uDD10-\uDD17\uDD20-\uDD25\uDD27-\uDD2F\uDD3A\uDD3F-\uDD45\uDD47-\uDD76\uDD78-\uDDB4\uDDB7\uDDBA\uDDBC-\uDDCC\uDDD0\uDDE0-\uDDFF\uDE70-\uDE7C\uDE80-\uDE89\uDE8F-\uDEC2\uDEC6\uDECE-\uDEDC\uDEDF-\uDEE9]|\uDD3C(?:\u200D[\u2640\u2642]\uFE0F?|\uD83C[\uDFFB-\uDFFF])?|\uDDCE(?:\uD83C[\uDFFB-\uDFFF])?(?:\u200D(?:[\u2640\u2642]\uFE0F?(?:\u200D\u27A1\uFE0F?)?|\u27A1\uFE0F?))?|\uDDD1(?:\u200D(?:[\u2695\u2696\u2708]\uFE0F?|\uD83C[\uDF3E\uDF73\uDF7C\uDF84\uDF93\uDFA4\uDFA8\uDFEB\uDFED]|\uD83D[\uDCBB\uDCBC\uDD27\uDD2C\uDE80\uDE92]|\uD83E(?:[\uDDAF\uDDBC\uDDBD](?:\u200D\u27A1\uFE0F?)?|[\uDDB0-\uDDB3]|\uDD1D\u200D\uD83E\uDDD1|\uDDD1\u200D\uD83E\uDDD2(?:\u200D\uD83E\uDDD2)?|\uDDD2(?:\u200D\uD83E\uDDD2)?))|\uD83C(?:\uDFFB(?:\u200D(?:[\u2695\u2696\u2708]\uFE0F?|\u2764\uFE0F?\u200D(?:\uD83D\uDC8B\u200D)?\uD83E\uDDD1\uD83C[\uDFFC-\uDFFF]|\uD83C[\uDF3E\uDF73\uDF7C\uDF84\uDF93\uDFA4\uDFA8\uDFEB\uDFED]|\uD83D[\uDCBB\uDCBC\uDD27\uDD2C\uDE80\uDE92]|\uD83E(?:[\uDDAF\uDDBC\uDDBD](?:\u200D\u27A1\uFE0F?)?|[\uDDB0-\uDDB3]|\uDD1D\u200D\uD83E\uDDD1\uD83C[\uDFFB-\uDFFF])))?|\uDFFC(?:\u200D(?:[\u2695\u2696\u2708]\uFE0F?|\u2764\uFE0F?\u200D(?:\uD83D\uDC8B\u200D)?\uD83E\uDDD1\uD83C[\uDFFB\uDFFD-\uDFFF]|\uD83C[\uDF3E\uDF73\uDF7C\uDF84\uDF93\uDFA4\uDFA8\uDFEB\uDFED]|\uD83D[\uDCBB\uDCBC\uDD27\uDD2C\uDE80\uDE92]|\uD83E(?:[\uDDAF\uDDBC\uDDBD](?:\u200D\u27A1\uFE0F?)?|[\uDDB0-\uDDB3]|\uDD1D\u200D\uD83E\uDDD1\uD83C[\uDFFB-\uDFFF])))?|\uDFFD(?:\u200D(?:[\u2695\u2696\u2708]\uFE0F?|\u2764\uFE0F?\u200D(?:\uD83D\uDC8B\u200D)?\uD83E\uDDD1\uD83C[\uDFFB\uDFFC\uDFFE\uDFFF]|\uD83C[\uDF3E\uDF73\uDF7C\uDF84\uDF93\uDFA4\uDFA8\uDFEB\uDFED]|\uD83D[\uDCBB\uDCBC\uDD27\uDD2C\uDE80\uDE92]|\uD83E(?:[\uDDAF\uDDBC\uDDBD](?:\u200D\u27A1\uFE0F?)?|[\uDDB0-\uDDB3]|\uDD1D\u200D\uD83E\uDDD1\uD83C[\uDFFB-\uDFFF])))?|\uDFFE(?:\u200D(?:[\u2695\u2696\u2708]\uFE0F?|\u2764\uFE0F?\u200D(?:\uD83D\uDC8B\u200D)?\uD83E\uDDD1\uD83C[\uDFFB-\uDFFD\uDFFF]|\uD83C[\uDF3E\uDF73\uDF7C\uDF84\uDF93\uDFA4\uDFA8\uDFEB\uDFED]|\uD83D[\uDCBB\uDCBC\uDD27\uDD2C\uDE80\uDE92]|\uD83E(?:[\uDDAF\uDDBC\uDDBD](?:\u200D\u27A1\uFE0F?)?|[\uDDB0-\uDDB3]|\uDD1D\u200D\uD83E\uDDD1\uD83C[\uDFFB-\uDFFF])))?|\uDFFF(?:\u200D(?:[\u2695\u2696\u2708]\uFE0F?|\u2764\uFE0F?\u200D(?:\uD83D\uDC8B\u200D)?\uD83E\uDDD1\uD83C[\uDFFB-\uDFFE]|\uD83C[\uDF3E\uDF73\uDF7C\uDF84\uDF93\uDFA4\uDFA8\uDFEB\uDFED]|\uD83D[\uDCBB\uDCBC\uDD27\uDD2C\uDE80\uDE92]|\uD83E(?:[\uDDAF\uDDBC\uDDBD](?:\u200D\u27A1\uFE0F?)?|[\uDDB0-\uDDB3]|\uDD1D\u200D\uD83E\uDDD1\uD83C[\uDFFB-\uDFFF])))?))?|\uDEF1(?:\uD83C(?:\uDFFB(?:\u200D\uD83E\uDEF2\uD83C[\uDFFC-\uDFFF])?|\uDFFC(?:\u200D\uD83E\uDEF2\uD83C[\uDFFB\uDFFD-\uDFFF])?|\uDFFD(?:\u200D\uD83E\uDEF2\uD83C[\uDFFB\uDFFC\uDFFE\uDFFF])?|\uDFFE(?:\u200D\uD83E\uDEF2\uD83C[\uDFFB-\uDFFD\uDFFF])?|\uDFFF(?:\u200D\uD83E\uDEF2\uD83C[\uDFFB-\uDFFE])?))?)/g;
function kr$1(e) {
...
var Tr = (e) => !(kr$1(e) || Sr$1(e));
var Pu$1 = /[^\x20-\x7F]/u;
function vu$1(e) {
	if (!e) return 0;
	if (!Pu$1.test(e)) return e.length;
	e = e.replace(br$1(), "  ");
	let t = 0;
	for (let r of e) {
...
var Ne$1 = vu$1;
var R$1 = Symbol("MODE_BREAK"), H$1 = Symbol("MODE_FLAT"), de$1 = Symbol("cursor"), _t$1 = Symbol("DOC_FILL_PRINTED_LENGTH");
function Nr$1() {
	return {
		value: "",
		length: 0,
...
function Lu$1(e, t) {
	return xt$1(e, { type: "indent" }, t);
}
function Iu$1(e, t, r) {
	return t === Number.NEGATIVE_INFINITY ? e.root || Nr$1() : t < 0 ? xt$1(e, { type: "dedent" }, r) : t ? t.type === "root" ? {
		...e,
		root: e
	} : xt$1(e, {
...
function xt$1(e, t, r) {
	...
	for (let f of n) switch (f.type) {
		...
		case "numberAlign":
			i += 1, s += f.n;
			break;
		default: throw new Error(`Unexpected type '${f.type}'`);
	}
	return l(), {
		...e,
		value: u,
...
function wt$2(e) {
	...
	if (t > 0 || r > 0) for (e.length = n + 1; r-- > 0;) e.push(de$1);
	return t;
}
function Ke$1(e, t, r, n, u, o) {
	...
	for (; r >= 0;) {
		...
		switch (p) {
			...
			case Y$2:
			case k$1: {
				let l = p === Y$2 ? D : D.parts, F = D[_t$1] ?? 0;
			...
			case B: {
				...
				let l = D.break ? R$1 : c, F = D.expandedStates && l === R$1 ? y(!1, D.expandedStates, -1) : D.contents;
				s.push({
					mode: l,
					doc: F
				});
			...
			case _: {
				let F = (D.groupId ? u[D.groupId] || H$1 : c) === R$1 ? D.breakContents : D.flatContents;
				F && s.push({
					mode: c,
					doc: F
				});
...
function me$1(e, t) {
	let r = {}, n = t.printWidth, u = xe$1(t.endOfLine), o = 0, i = [{
		ind: Nr$1(),
		mode: R$1,
		doc: e
	}], s = [], a = !1, c = [], D = 0;
	for (cr$1(e); i.length > 0;) {
...
`, u) : f;
			...
			case B:
				switch (F) {
					...
					case R$1: {
						...
						if (!f.break && Ke$1(d, i, m, C, r)) i.push(d);
				...
				break;
			case k$1: {
				let d = n - o, m = f[_t$1] ?? 0, { parts: C } = f, E = C.length - m;
				if (E === 0) break;
			...
			case v$2: {
				...
				if (d === R$1) {
					let m = f.type === _ ? f.breakContents : f.negate ? f.contents : ie$1(f.contents);
					m && i.push({
						ind: l,
						mode: F,
						doc: m
				...
				if (d === H$1) {
					let m = f.type === _ ? f.flatContents : f.negate ? ie$1(f.contents) : f.contents;
					m && i.push({
						ind: l,
						mode: F,
						doc: m
			...
			case g:
				switch (F) {
					...
					case R$1:
						...
						f.literal ? l.root ? (s.push(u, l.root.value), o = l.root.length) : (s.push(u), o = 0) : (o -= wt$2(s), s.push(u + l.value), o = l.length);
						break;
				}
				break;
			case S$1:
				...
				break;
			case w$1: break;
			default: throw new q(f);
		}
		i.length === 0 && c.length > 0 && (i.push(...c.reverse()), c.length = 0);
	}
	let p = s.indexOf(de$1);
	if (p !== -1) {
		let l = s.indexOf(de$1, p + 1);
		if (l === -1) return { formatted: s.filter((m) => m !== de$1).join("") };
...
function Ru$1(e, t, r = 0) {
	let n = 0;
	for (let u = r; u < e.length; ++u) e[u] === "	" ? n = n + t - n % t : n++;
	return n;
}
var Ee$1 = Ru$1;
var Z, kt$2, ze$1, bt$2 = class {
	constructor(t) {
		tr(this, Z);
		this.stack = [t];
	}
	...
	get ancestors() {
		return [...fe$1(this, Z, ze$1).call(this)];
	}
	getName() {
	...
	getNode(t = 0) {
		let r = fe$1(this, Z, kt$2).call(this, t);
	...
	callParent(t, r = 0) {
		let n = fe$1(this, Z, kt$2).call(this, r + 1), u = this.stack.splice(n + 1);
		try {
			return t(this);
		} finally {
			this.stack.push(...u);
	...
	findAncestor(t) {
		for (let r of fe$1(this, Z, ze$1).call(this)) if (t(r)) return r;
	}
	hasAncestor(t) {
		for (let r of fe$1(this, Z, ze$1).call(this)) if (t(r)) return !0;
		return !1;
	}
};
Z = /* @__PURE__ */ new WeakSet(), kt$2 = function(t) {
	let { stack: r } = this;
...
var Or$1 = bt$2;
var Pr$1 = new Proxy(() => {}, { get: () => Pr$1 }), Oe$2 = Pr$1;
function Yu$1(e) {
	return e !== null && typeof e == "object";
}
var vr$1 = Yu$1;
function* Ce$1(e, t) {
	let { getVisitorKeys: r, filter: n = () => !0 } = t, u = (o) => vr$1(o) && n(o);
	for (let o of r(e)) {
		let i = e[o];
...
function* Lr$1(e, t) {
	...
	for (let n = 0; n < r.length; n++) {
		let u = r[n];
		for (let o of Ce$1(u, t)) yield o, r.push(o);
	}
}
function Ir$1(e, t) {
	return Ce$1(e, t).next().done;
}
function he$1(e) {
	return (t, r, n) => {
...
var Rr$1 = he$1(/\s/u), T = he$1(" 	"), He$1 = he$1(",; 	"), Je$1 = he$1(/[^\n\r]/u);
function ju$1(e, t, r) {
...
var Yr$2 = new Set([
	...
	"precedingNode",
	"followingNode"
]), $u$1 = (e) => Object.keys(e).filter((t) => !Yr$2.has(t));
function Wu$1(e) {
	return e ? (t) => e(t, Yr$2) : $u$1;
}
var J = Wu$1;
function Mu$1(e) {
...
function St$2(e, t) {
	(e.comments ?? (e.comments = [])).push(t), t.printed = !1, t.nodeDescription = Mu$1(e);
}
function se(e, t) {
	t.leading = !0, t.trailing = !1, St$2(e, t);
}
function ee$1(e, t, r) {
	t.leading = !1, t.trailing = !1, r && (t.marker = r), St$2(e, t);
}
function ae$2(e, t) {
	t.leading = !1, t.trailing = !0, St$2(e, t);
}
var Tt$2 = /* @__PURE__ */ new WeakMap();
function Xe(e, t) {
	if (Tt$2.has(e)) return Tt$2.get(e);
	let { printer: { getCommentChildNodes: r, canAttachComment: n, getVisitorKeys: u }, locStart: o, locEnd: i } = t;
	if (!n) return [];
	let s = ((r == null ? void 0 : r(e, t)) ?? [...Ce$1(e, { getVisitorKeys: J(u) })]).flatMap((a) => n(a) ? [a] : Xe(a, t));
	return s.sort((a, c) => o(a) - o(c) || i(a) - i(c)), Tt$2.set(e, s), s;
}
function Ur$1(e, t, r, n) {
	let { locStart: u, locEnd: o } = r, i = u(t), s = o(t), a = Xe(e, r), c, D, p = 0, l = a.length;
	for (; p < l;) {
		let F = p + l >> 1, f = a[F], d = u(f), m = o(f);
		if (d <= i && s <= m) return Ur$1(f, t, r, f);
		if (m <= i) {
			c = f, p = F + 1;
			continue;
		}
...
function Vr$1(e, t) {
	let { comments: r } = e;
	if (delete e.comments, !qe$1(r) || !t.printer.canAttachComment) return;
	let n = [], { printer: { experimentalFeatures: { avoidAstMutation: u = !1 } = {}, handleComments: o = {} }, originalText: i } = t, { ownLine: s = Nt$2, endOfLine: a = Nt$2, remaining: c = Nt$2 } = o, D = r.map((p, l) => ({
		...Ur$1(e, p, t),
		comment: p,
		text: i,
		options: t,
	...
	for (let [p, l] of D.entries()) {
		...
		if (u ? A = [l] : (F.enclosingNode = d, F.precedingNode = f, F.followingNode = m, A = [
			F,
			C,
			E,
			h,
			x
		]), Gu$1(C, E, D, p)) F.placement = "ownLine", s(...A) || (m ? se(m, F) : f ? ae$2(f, F) : d ? ee$1(d, F) : ee$1(h, F));
		else if (Ku$1(C, E, D, p)) F.placement = "endOfLine", a(...A) || (f ? ae$2(f, F) : m ? se(m, F) : d ? ee$1(d, F) : ee$1(h, F));
		else if (F.placement = "remaining", !c(...A)) if (f && m) {
			let $ = n.length;
			$ > 0 && n[$ - 1].followingNode !== m && jr$1(n, E), n.push(l);
		} else f ? ae$2(f, F) : m ? se(m, F) : d ? ee$1(d, F) : ee$1(h, F);
	}
	if (jr$1(n, t), !u) for (let p of r) delete p.precedingNode, delete p.enclosingNode, delete p.followingNode;
}
var $r$1 = (e) => !/[\S\n\u2028\u2029]/u.test(e);
function Gu$1(e, t, r, n) {
	let { comment: u, precedingNode: o } = r[n], { locStart: i, locEnd: s } = t, a = i(u);
	if (o) for (let c = n - 1; c >= 0; c--) {
		let { comment: D, precedingNode: p } = r[c];
		if (p !== o || !$r$1(e.slice(s(D), a))) break;
		a = i(D);
	}
	return G$2(e, a, { backwards: !0 });
}
function Ku$1(e, t, r, n) {
	...
	if (o) for (let c = n + 1; c < r.length; c++) {
		...
		if (p !== o || !$r$1(e.slice(a, i(D)))) break;
		a = s(D);
	}
	return G$2(e, a);
}
...
function zu$1(e, t) {
	let r = t - 1;
	r = T(e, r, { backwards: !0 }), r = U$1(e, r, { backwards: !0 }), r = T(e, r, { backwards: !0 });
	let n = U$1(e, r, { backwards: !0 });
	return r !== n;
}
var Pe$1 = zu$1;
function Wr$2(e, t) {
...
function Hu$1(e, t) {
	var D;
	let r = e.node, n = [Wr$2(e, t)], { printer: u, originalText: o, locStart: i, locEnd: s } = t;
	if ((D = u.isBlockComment) == null ? void 0 : D.call(u, r)) {
		let p = G$2(o, s(r)) ? G$2(o, i(r), { backwards: !0 }) ? z$1 : Me$2 : " ";
		n.push(p);
	} else n.push(z$1);
	let c = U$1(o, T(o, s(r)));
	return c !== !1 && G$2(o, c) && n.push(z$1), n;
}
function Ju$1(e, t, r) {
	var c;
	let n = e.node, u = Wr$2(e, t), { printer: o, originalText: i, locStart: s } = t, a = (c = o.isBlockComment) == null ? void 0 : c.call(o, n);
	if (r != null && r.hasLineSuffix && !(r != null && r.isBlock) || G$2(i, s(n), { backwards: !0 })) return {
		doc: Se$1([
			z$1,
			Pe$1(i, s(n)) ? z$1 : "",
			u
...
function qu$1(e, t) {
	...
	return e.each(() => {
		...
		c ? o.push(Hu$1(e, t)) : D && (s = Ju$1(e, t, s), i.push(s.doc));
	}, "comments"), {
		leading: o,
		trailing: i
	};
...
function Mr$1(e, t, r) {
	let { leading: n, trailing: u } = qu$1(e, r);
	return !n && !u ? t : Fe$2(t, (o) => [
		n,
		o,
		u
	]);
...
var Kr$2 = Xu$1;
var ve$2 = class extends Error {
	name = "ConfigError";
}, Le$2 = class extends Error {
...
function Qe$1({ plugins: e = [], showDeprecated: t = !1 } = {}) {
	let r = e.flatMap((u) => u.languages ?? []), n = [];
	for (let u of Zu$1(Object.assign({}, ...e.map(({ options: o }) => o), zr$2))) !t && u.deprecated || (Array.isArray(u.choices) && (t || (u.choices = u.choices.filter((o) => !o.deprecated)), u.name === "parser" && (u.choices = [...u.choices, ...Qu$1(u.choices, r, e)])), u.pluginDefaults = Object.fromEntries(e.filter((o) => {
		var i;
...
var Jr$2, qr$1, Xr$2, Qr$2, Zr$2, to$1 = ((Jr$2 = globalThis.Deno) == null ? void 0 : Jr$2.build.os) === "windows" || ((Xr$2 = (qr$1 = globalThis.navigator) == null ? void 0 : qr$1.platform) == null ? void 0 : Xr$2.startsWith("Win")) || ((Zr$2 = (Qr$2 = globalThis.process) == null ? void 0 : Qr$2.platform) == null ? void 0 : Zr$2.startsWith("win")) || !1;
function en$1(e) {
	if (e = e instanceof URL ? e : new URL(e), e.protocol !== "file:") throw new TypeError(`URL must be a file URL: received "${e.protocol}"`);
	return e;
}
function ro$1(e) {
	return e = en$1(e), decodeURIComponent(e.pathname.replace(/%(?![0-9A-Fa-f]{2})/g, "%25"));
}
function no$1(e) {
	e = en$1(e);
...
function tn$1(e) {
	return to$1 ? no$1(e) : ro$1(e);
}
var rn$1 = tn$1;
var uo$1 = (e) => String(e).split(/[/\\]/u).pop();
function nn$1(e, t) {
	if (!t) return;
	let r = uo$1(t).toLowerCase();
...
function io$1(e, t) {
	let r = Hr$2(!1, e.plugins).flatMap((u) => u.languages ?? []), n = oo$1(r, t.language) ?? nn$1(r, t.physicalFile) ?? nn$1(r, t.file) ?? un$1(r, t.physicalFile) ?? un$1(r, t.file) ?? (t.physicalFile, void 0);
...
var re$1 = {
	...
	value(e) {
		...
		if (Array.isArray(e)) return `[${e.map((r) => re$1.value(r)).join(", ")}]`;
		let t = Object.keys(e);
		return t.length === 0 ? "{}" : `{ ${t.map((r) => `${re$1.key(r)}: ${re$1.value(e[r])}`).join(", ")} }`;
	},
	pair: ({ key: e, value: t }) => re$1.value({ [e]: t })
};
var sn$1 = new Proxy(String, { get: () => sn$1 }), V$1 = sn$1;
var an$1 = (e, t, { descriptor: r }) => {
	let n = [`${V$1.yellow(typeof e == "string" ? r.key(e) : r.pair(e))} is deprecated`];
	return t && n.push(`we now treat it as ${V$1.blue(typeof t == "string" ? r.key(t) : r.pair(t))}`), n.join("; ") + ".";
};
var Ze$1 = Symbol.for("vnopts.VALUE_NOT_EXIST"), ge$2 = Symbol.for("vnopts.VALUE_UNCHANGED");
var Dn$1 = " ".repeat(2), fn$1 = (e, t, r) => {
	let { text: n, list: u } = r.normalizeExpectedResult(r.schemas[e].expected(r)), o = [];
	return n && o.push(cn$1(e, t, n, r.descriptor)), u && o.push([cn$1(e, t, u.title, r.descriptor)].concat(u.values.map((i) => ln$1(i, r.loggerPrintWidth))).join(`
`)), Fn$1(o, r.loggerPrintWidth);
};
function cn$1(e, t, r, n) {
	return [
		`Invalid ${V$1.red(n.key(e))} value.`,
		`Expected ${V$1.blue(r)},`,
		`but received ${t === Ze$1 ? V$1.gray("nothing") : V$1.red(n.value(t))}.`
	].join(" ");
}
function ln$1({ text: e, list: t }, r) {
	let n = [];
	return e && n.push(`- ${V$1.blue(e)}`), t && n.push([`- ${V$1.blue(t.title)}:`].concat(t.values.map((u) => ln$1(u, r - Dn$1.length).replace(/^|\n/g, `$&${Dn$1}`))).join(`
`)), Fn$1(n, r);
}
function Fn$1(e, t) {
...
function vt$2(e, t) {
	...
	let i, s, a, c, D = 0, p = 0;
	for (; D < n;) pn$1[D] = e.charCodeAt(o + D), Pt$1[D] = ++D;
	for (; p < u;) for (i = t.charCodeAt(o + p), a = p++, s = p, D = 0; D < n; D++) c = i === pn$1[D] ? a : a + 1, a = Pt$1[D], s = Pt$1[D] = a > s ? c > s ? s + 1 : c : c > a ? a + 1 : c;
	return s;
}
var et$1 = (e, t, { descriptor: r, logger: n, schemas: u }) => {
	let o = [`Ignored unknown option ${V$1.yellow(r.pair({
		key: e,
		value: t
	}))}.`], i = Object.keys(u).sort().find((s) => vt$2(e, s) < 3);
	i && o.push(`Did you mean ${V$1.blue(r.key(i))}?`), n.warn(o.join(" "));
};
var so$1 = [
	"default",
	"expected",
...
function ao$1(e, t) {
	...
	for (let u of so$1) u in t && (n[u] = Do$1(t[u], r, b$1.prototype[u].length));
	return n;
}
var b$1 = class {
	static create(t) {
...
var nt = class extends b$1 {
	...
	redirect(t, r) {
		...
		for (let o of t) {
			...
			"remain" in i && n.push(i.remain), u.push(...i.redirect.map(dn$1));
		}
...
function dn$1({ from: e, to: t }) {
	return {
		from: [e],
		to: t
	};
}
var ut$1 = class extends b$1 {
	expected() {
...
function It$2(e) {
	...
	let { text: t, list: r } = e;
	return co$1((t || r) !== void 0, "Unexpected `expected` result, there should be at least one field."), r ? {
		text: t,
		list: {
			title: r.title,
			values: r.values.map(It$2)
		}
	} : { text: t };
}
function Rt$1(e, t) {
...
function jt$1(e, t) {
	let r = ot$1(typeof e == "object" && "redirect" in e ? e.redirect : e, t);
	return r.length === 0 ? {
		remain: t,
		redirect: r
...
var it$1 = class extends b$1 {
	constructor(t) {
		super(t), this._choices = Cn$1(t.choices.map((r) => r && typeof r == "object" ? r : { value: r }), "value");
	}
	expected({ descriptor: t }) {
		let r = Array.from(this._choices.keys()).map((i) => this._choices.get(i)).filter(({ hidden: i }) => !i).map((i) => i.value).sort(An$1).map(t.value), n = r.slice(0, -2), u = r.slice(-2);
		return {
...
var _n$1 = re$1, xn$1 = et$1, wn = fn$1, bn$1 = an$1;
var Dt$2 = class {
	constructor(t, r) {
		let { logger: n = console, loggerPrintWidth: u = 80, descriptor: o = _n$1, unknown: i = xn$1, invalid: s = wn, deprecated: a = bn$1, missing: c = () => !1, required: D = () => !1, preprocess: p = (F) => F, postprocess: l = () => ge$2 } = r || {};
		this._utils = {
			descriptor: o,
			logger: n || { warn: () => {} },
			loggerPrintWidth: u,
			schemas: En$1(t, "name"),
			normalizeDefaultResult: Lt$2,
			normalizeExpectedResult: It$2,
			normalizeDeprecatedResult: Yt$1,
			normalizeForwardResult: ot$1,
			normalizeRedirectResult: jt$1,
			normalizeValidateResult: Rt$1
		}, this._unknownHandler = i, this._invalidHandler = Bn$1(s), this._deprecatedHandler = a, this._identifyMissing = (F, f) => !(F in f) || c(F, f), this._identifyRequired = D, this._preprocess = p, this._postprocess = l, this.cleanHistory();
	}
	cleanHistory() {
		this._hasDeprecationWarned = hn$1();
	}
	normalize(t) {
		...
		for (let i of Object.keys(this._utils.schemas)) {
			...
			if (!(i in r)) {
				let a = Lt$2(s.default(this._utils));
		...
		for (let i of Object.keys(this._utils.schemas)) {
			...
			c !== ge$2 && (this._applyValidation(c, i, s), r[i] = c);
		}
	...
	_applyNormalization(t, r) {
		...
		for (let i of u) {
			...
			let c = ({ from: F, to: f }) => {
				...
				let d = Yt$1(s.deprecated(F, this._utils), a, !0);
			...
			ot$1(s.forward(a, this._utils), a).forEach(c);
			let l = jt$1(s.redirect(a, this._utils), a);
	...
	_applyRequiredCheck(t) {
		for (let r of Object.keys(this._utils.schemas)) if (this._identifyMissing(r, t) && this._identifyRequired(r)) throw this._invalidHandler(r, Ze$1, this._utils);
	}
	_partitionOptionKeys(t) {
		let [r, n] = gn$1(Object.keys(t).filter((u) => !this._identifyMissing(u, t)), (u) => u in this._utils.schemas);
		return {
			knownKeys: r,
			unknownKeys: n
		};
	...
	_applyValidation(t, r, n) {
		let u = Rt$1(n.validate(t, this._utils), t);
...
var Ut$1;
function lo$1(e, t, { logger: r = !1, isCLI: n = !1, passThrough: u = !1, FlagSchema: o, descriptor: i } = {}) {
	if (n) {
	...
	D && Ut$1 && (c._hasDeprecationWarned = Ut$1);
	let p = c.normalize(e);
	return D && (Ut$1 = c._hasDeprecationWarned), p;
}
function Fo$1(e, { isCLI: t, FlagSchema: r }) {
	let n = [];
	t && n.push(rt$1.create({ name: "_" }));
	for (let u of e) n.push(po$1(u, {
		isCLI: t,
		optionInfos: e,
		FlagSchema: r
	})), u.alias && t && n.push(tt$1.create({
		name: u.alias,
		sourceName: u.name
	}));
	return n;
}
function po$1(e, { isCLI: t, optionInfos: r, FlagSchema: n }) {
	let { name: u } = e, o = { name: u }, i, s = {};
	switch (e.type) {
		case "int":
			i = at$1, t && (o.preprocess = Number);
			break;
		case "string":
			i = Ie$1;
			break;
		case "choice":
			i = it$1, o.choices = e.choices.map((a) => a != null && a.redirect ? {
				...a,
				redirect: { to: {
					key: e.name,
					value: a.redirect
	...
	if (e.exception ? o.validate = (a, c, D) => e.exception(a) || c.validate(a, D) : o.validate = (a, c, D) => a === void 0 || c.validate(a, D), e.redirect && (s.redirect = (a) => a ? { to: typeof e.redirect == "string" ? e.redirect : {
...
function $t$1(e, t) {
	...
	let r = Vt$1(!1, e, (u) => u.parsers && Object.prototype.hasOwnProperty.call(u.parsers, t));
	if (r) return r;
	let n = `Couldn't resolve parser "${t}".`;
	throw n += " Plugins must be explicitly added to the standalone bundle.", new ve$2(n);
}
function Sn$1(e, t) {
	if (!t) throw new Error("astFormat is required.");
	let r = Vt$1(!1, e, (u) => u.printers && Object.prototype.hasOwnProperty.call(u.printers, t));
	if (r) return r;
	let n = `Couldn't find plugin for AST format "${t}".`;
	throw n += " Plugins must be explicitly added to the standalone bundle.", new ve$2(n);
}
function Re$2({ plugins: e, parser: t }) {
	return Wt$1($t$1(e, t), t);
}
function Wt$1(e, t) {
	let r = e.parsers[t];
...
async function Eo$1(e, t = {}) {
	var p;
	let r = { ...e };
	if (!r.parser) if (r.filepath) {
		if (r.parser = on$1(r, { physicalFile: r.filepath }), !r.parser) throw new Le$2(`No parser could be inferred for file "${r.filepath}".`);
	} else throw new Le$2("No parser and no file path given, couldn't infer a parser.");
	let n = Qe$1({
		plugins: e.plugins,
		showDeprecated: !0
	}).options, u = {
	...
	}, o = $t$1(r.plugins, r.parser), i = await Wt$1(o, r.parser);
	r.astFormat = i.astFormat, r.locEnd = i.locEnd, r.locStart = i.locStart;
	let s = (p = o.printers) != null && p[i.astFormat] ? o : Sn$1(r.plugins, i.astFormat);
	r.printer = await Tn$1(s, i.astFormat);
	...
	return r.parser === "json" && (r.trailingComma = "none"), kn$1(r, n, {
		passThrough: Object.keys(Nn$1),
		...t
	});
}
var ne$1 = Eo$1;
var vn$1 = gu$1(Pn$1(), 1);
async function yo$1(e, t) {
	let r = await Re$2(t), n = r.preprocess ? r.preprocess(e, t) : e;
	t.originalText = n;
	let u;
	try {
...
async function Bo$1(e, t, r, n) {
	let u = await ne$1({
		...
		rangeStart: void 0,
		rangeEnd: void 0
	}, { passThrough: !0 }), { ast: o } = await De$2(e, u);
	return $e$1(await n(o, u));
}
function _o$1(e, t) {
...
async function Ye$1(e, t) {
	({ast: e} = await Gt$1(e, t));
	let r = /* @__PURE__ */ new Map(), n = new Or$1(e), u = Kr$2(t), o = /* @__PURE__ */ new Map();
	await Ln$1(n, s, t, Ye$1, o);
	let i = await Rn$1(n, t, s, void 0, o);
	if (Gr$2(t), t.cursorOffset >= 0) {
		if (t.nodeAfterCursor && !t.nodeBeforeCursor) return [X$1, i];
		if (t.nodeBeforeCursor && !t.nodeAfterCursor) return [i, X$1];
	}
	return i;
	function s(c, D) {
	...
	function a(c) {
		...
		let l = Rn$1(n, t, s, c, o);
		return p && r.set(D, l), l;
	}
}
function Rn$1(e, t, r, n, u) {
	var a;
	let { node: o } = e, { printer: i } = t, s;
	switch ((a = i.hasPrettierIgnore) != null && a.call(i, e) ? s = In$1(e, t) : u.has(o) ? s = u.get(o) : s = i.print(e, t, r, n), o) {
		case t.cursorNode:
			s = Fe$2(s, (c) => [
				X$1,
				c,
	...
	return i.printComment && (!i.willPrintOwnComments || !i.willPrintOwnComments(e, t)) && (s = Mr$1(e, s, t)), s;
}
async function Gt$1(e, t) {
	let r = e.comments ?? [];
	t[Symbol.for("comments")] = r, t[Symbol.for("printedComments")] = /* @__PURE__ */ new Set(), Vr$1(e, t);
...
var ko$1 = ({ parser: e }) => e === "json" || e === "json5" || e === "jsonc" || e === "json-stringify";
function So$1(e, t) {
	let r = [e.node, ...e.parentNodes], n = new Set([t.node, ...t.parentNodes]);
	return r.find((u) => $n$1.has(u.type) && n.has(u));
}
function Un$1(e) {
	let t = jn$1(!1, e, (r) => r.type !== "Program" && r.type !== "File");
	return t === -1 ? e : e.slice(0, t + 1);
}
function To$1(e, t, { locStart: r, locEnd: n }) {
	...
	let i = r(e.node);
	for (let a of Un$1(t.parentNodes)) if (r(a) >= i) o = a;
	else break;
	let s = n(t.node);
	for (let a of Un$1(e.parentNodes)) {
		if (n(a) <= s) u = a;
		else break;
		if (u === o) break;
	}
...
function Vn$1(e, t, r) {
	...
	switch (e.parser) {
		...
		case "oxc":
		case "oxc-ts":
		case "__babel_estree": return No$1(t.type, r == null ? void 0 : r.type);
		case "json":
		case "json5":
		case "jsonc":
		case "json-stringify": return $n$1.has(t.type);
		case "graphql": return Oo$1.has(t.kind);
...
function Wn$1(e, t, r) {
	...
	let c = zt$1(r, n, t, (F, f) => Vn$1(t, F, f), [], "rangeStart"), D = a ? c : zt$1(r, u, t, (F) => Vn$1(t, F), [], "rangeEnd");
	if (!c || !D) return {
		rangeStart: 0,
		rangeEnd: 0
	};
	...
	if (ko$1(t)) {
		let F = So$1(c, D);
		p = F, l = F;
	} else ({startNode: p, endNode: l} = To$1(c, D, t));
	return {
		rangeStart: Math.min(o(p), o(l)),
		rangeEnd: Math.max(i(p), i(l))
	};
}
var zn$1 = "﻿", Mn$1 = Symbol("cursor");
async function Hn$1(e, t, r = 0) {
	if (!e || e.trim().length === 0) return {
		formatted: "",
		cursorOffset: -1,
		comments: []
	};
	let { ast: n, text: u } = await De$2(e, t);
	t.cursorOffset >= 0 && (t = {
		...t,
		...Kt$1(n, t)
	});
	let o = await Ye$1(n, t, r);
	r > 0 && (o = Ge$1([z$1, o], r, t.tabWidth));
	let i = me$1(o, t);
	if (r > 0) {
		let a = i.formatted.trim();
		i.cursorNodeStart !== void 0 && (i.cursorNodeStart -= i.formatted.indexOf(a), i.cursorNodeStart < 0 && (i.cursorNodeStart = 0, i.cursorNodeText = i.cursorNodeText.trimStart()), i.cursorNodeStart + i.cursorNodeText.length > a.length && (i.cursorNodeText = i.cursorNodeText.trimEnd())), i.formatted = a + xe$1(t.endOfLine);
	}
	...
	if (t.cursorOffset >= 0) {
		...
		let F = c.split("");
		F.splice(l, 0, Mn$1);
		let d = Et$2(F, p.split("")), m = D;
		for (let C of d) if (C.removed) {
			if (C.value.includes(Mn$1)) break;
		} else m += C.count;
		return {
			formatted: i.formatted,
			cursorOffset: m,
...
async function Po$1(e, t) {
	let { ast: r, text: n } = await De$2(e, t), { rangeStart: u, rangeEnd: o } = Wn$1(n, t, r), i = n.slice(u, o), s = Math.min(u, n.lastIndexOf(`
`, u) + 1), a = n.slice(s, u).match(/^\s*/u)[0], c = Ee$1(a, t.tabWidth), D = await Hn$1(i, {
		...t,
		rangeStart: 0,
...
function Gn$1(e, t) {
	...
	return r = Ht$1(e, r, -1), n = Ht$1(e, n, 0), u = Ht$1(e, u, e.length), {
		...t,
		cursorOffset: r,
		rangeStart: n,
		rangeEnd: u
...
function Jn$1(e, t) {
	let { cursorOffset: r, rangeStart: n, rangeEnd: u, endOfLine: o } = Gn$1(e, t), i = e.charAt(0) === zn$1;
	if (i && (e = e.slice(1), r--, n--, u--), o === "auto" && (o = nr$1(e)), e.includes("\r")) {
		let s = (a) => Ct$2(e.slice(0, Math.max(a, 0)), `\r
`);
		r -= s(r), n -= s(n), u -= s(u), e = ur$1(e);
	}
	return {
		hasBOM: i,
		text: e,
...
async function vo$1(e, t) {
	var n;
	let r = await Re$2(t);
	return (n = r.hasIgnorePragma) == null ? void 0 : n.call(r, e);
}
async function Jt$1(e, t) {
	let { hasBOM: r, text: n, options: u } = Jn$1(e, await ne$1(t));
	if (u.rangeStart >= u.rangeEnd && n !== "" || u.requirePragma && !await Kn$1(n, u) || u.checkIgnorePragma && await vo$1(n, u)) return {
		formatted: e,
		cursorOffset: t.cursorOffset,
		comments: []
	};
	let o;
	return u.rangeStart > 0 || u.rangeEnd < n.length ? o = await Po$1(n, u) : (!u.requirePragma && u.insertPragma && u.printer.insertPragma && !await Kn$1(n, u) && (n = u.printer.insertPragma(n)), o = await Hn$1(n, u)), r && (o.formatted = zn$1 + o.formatted, o.cursorOffset >= 0 && o.cursorOffset++), o;
}
async function qn$1(e, t, r) {
	let { text: n, options: u } = Jn$1(e, await ne$1(t)), o = await De$2(n, u);
	return r && (r.preprocessForPrint && (o.ast = await Gt$1(o.ast, u)), r.massage && (o.ast = Yn$1(o.ast, u))), o;
}
async function Xn$1(e, t) {
	t = await ne$1(t);
	return me$1(await Ye$1(e, t), t);
}
async function Qn$1(e, t) {
	let { formatted: n } = await Jt$1(wr$1(e), {
		...t,
...
async function Zn$1(e, t) {
	t = await ne$1(t);
	let { ast: r } = await De$2(e, t);
	return t.cursorOffset >= 0 && (t = {
		...t,
		...Kt$1(r, t)
	}), Ye$1(r, t);
}
async function eu$1(e, t) {
	return me$1(e, await ne$1(t));
}
var qt$1 = {};
dt$1(qt$1, {
	builders: () => Io$1,
...
var Io$1 = {
	...
	literalline: We$1,
	group: At$2,
	conditionalGroup: Cr$1,
	fill: hr$1,
	lineSuffix: Se$1,
	lineSuffixBoundary: Ar$1,
	cursor: X$1,
	breakParent: pe$1,
	ifBreak: gr$1,
	trim: Br$1,
	...
	indentIfBreak: yr$1,
	align: oe$2,
	addAlignmentToDoc: Ge$1,
	markAsRoot: mr$1,
	dedentToRoot: dr,
	dedent: Er$1,
	hardlineWithoutBreakParent: Te$2,
	literallineWithoutBreakParent: Bt$1,
	label: xr$1,
	concat: (e) => e
}, Ro$1 = { printDocToString: me$1 }, Yo$1 = {
	willBreak: Dr$1,
	traverseDoc: le$2,
	findInDoc: Ve$1,
	mapDoc: be$1,
	removeLines: fr$1,
	stripTrailingHardline: $e$1,
	replaceEndOfLine: lr$1,
	canBreak: Fr$1
};
var tu$1 = "3.6.2";
var Qt$1 = {};
dt$1(Qt$1, {
	addDanglingComment: () => ee$1,
	addLeadingComment: () => se,
	addTrailingComment: () => ae$2,
	getAlignmentSize: () => Ee$1,
	getIndentSize: () => ru$1,
	getMaxContinuousCount: () => nu$1,
	getNextNonSpaceNonCommentCharacter: () => uu$1,
	getNextNonSpaceNonCommentCharacterIndex: () => Xo$1,
	getPreferredQuote: () => iu$1,
	getStringWidth: () => Ne$1,
	hasNewline: () => G$2,
	hasNewlineInRange: () => su$1,
	hasSpaces: () => au$1,
	isNextLineEmpty: () => ti$2,
	isNextLineEmptyAfterIndex: () => ct$1,
	isPreviousLineEmpty: () => Zo$1,
	makeString: () => Du$1,
	skip: () => he$1,
	skipEverythingButNewLine: () => Je$1,
	skipInlineComment: () => ye$1,
	skipNewline: () => U$1,
	skipSpaces: () => T,
	skipToLineEnd: () => He$1,
...
var ye$1 = jo$1;
function Uo$1(e, t) {
	return t === !1 ? !1 : e.charAt(t) === "/" && e.charAt(t + 1) === "/" ? Je$1(e, t) : t;
}
var Ae = Uo$1;
function Vo$2(e, t) {
	let r = null, n = t;
	for (; n !== r;) r = n, n = T(e, n), n = ye$1(e, n), n = Ae(e, n), n = U$1(e, n);
	return n;
}
var je$1 = Vo$2;
function $o$1(e, t) {
	let r = null, n = t;
	for (; n !== r;) r = n, n = He$1(e, n), n = ye$1(e, n), n = T(e, n);
	return n = Ae(e, n), n = U$1(e, n), n !== !1 && G$2(e, n);
}
var ct$1 = $o$1;
function Wo$1(e, t) {
	let r = e.lastIndexOf(`
`);
	return r === -1 ? 0 : Ee$1(e.slice(r + 1).match(/^[\t ]*/u)[0], t);
}
var ru$1 = Wo$1;
function Xt$1(e) {
...
function Mo$1(e, t) {
	let r = e.match(new RegExp(`(${Xt$1(t)})+`, "gu"));
...
var ft$1 = "'", ou = "\"";
function Ko$1(e, t) {
	let r = t === !0 || t === ft$1 ? ft$1 : ou, n = r === ft$1 ? ou : ft$1, u = 0, o = 0;
...
function Jo$1(e, t, r) {
	let n = t === "\"" ? "'" : "\"";
	return t + te$1(!1, e, /\\(.)|(["'])/gsu, (i, s, a) => s === n ? s : a === t ? "\\" + a : a || (r && /^[^\n\r"'0-7\\bfnrt-vx\u2028\u2029]$/u.test(s) ? s : "\\" + s)) + t;
}
var Du$1 = Jo$1;
function qo$1(e, t, r) {
	return je$1(e, r(t));
...
function Xo$1(e, t) {
	return arguments.length === 2 || typeof t == "number" ? je$1(e, t) : qo$1(...arguments);
}
function Qo$1(e, t, r) {
	return Pe$1(e, r(t));
}
function Zo$1(e, t) {
	return arguments.length === 2 || typeof t == "number" ? Pe$1(e, t) : Qo$1(...arguments);
}
function ei$2(e, t, r) {
	return ct$1(e, r(t));
}
function ti$2(e, t) {
	return arguments.length === 2 || typeof t == "number" ? ct$1(e, t) : ei$2(...arguments);
}
function ce$1(e, t = 1) {
	return async (...r) => {
...
async function ri$2(e, t) {
	return await fu$1(e, t) === e;
}
var ni$2 = ce$1(Qe$1, 0), ui$2 = {
	parse: ce$1(qn$1),
	formatAST: ce$1(Xn$1),
	formatDoc: ce$1(Qn$1),
	printToDoc: ce$1(Zn$1),
	printDocToString: ce$1(eu$1)
};
//#endregion
//#region ../../../node_modules/.pnpm/prettier@3.6.2/node_modules/prettier/plugins/babel.mjs
var Ti$1 = Object.create;
var _e$1 = Object.defineProperty;
var bi$1 = Object.getOwnPropertyDescriptor;
var Ai$1 = Object.getOwnPropertyNames;
var Si$1 = Object.getPrototypeOf, Ei$1 = Object.prototype.hasOwnProperty;
var Ci$1 = (a, t) => () => (t || a((t = { exports: {} }).exports, t), t.exports), Ue$1 = (a, t) => {
	for (var e in t) _e$1(a, e, {
		get: t[e],
		enumerable: !0
	});
}, wi$1 = (a, t, e, s) => {
	if (t && typeof t == "object" || typeof t == "function") for (let i of Ai$1(t)) !Ei$1.call(a, i) && i !== e && _e$1(a, i, {
		get: () => t[i],
		enumerable: !(s = bi$1(t, i)) || s.enumerable
	});
	return a;
};
var ls$1 = (a, t, e) => (e = a != null ? Ti$1(Si$1(a)) : {}, wi$1(t || !a || !a.__esModule ? _e$1(e, "default", {
	value: a,
	enumerable: !0
}) : e, a));
var Tt$1 = Ci$1((Pe) => {
	...
	var hs = "BABEL_PARSER_SOURCETYPE_MODULE_REQUIRED", Ni = {
	...
	}, Se = (a) => a.type === "UpdateExpression" ? cs.UpdateExpression[`${a.prefix}`] : cs[a.type], ki = {
...
- Did you mean \`import { "${a}" as foo }\`?`,
		...
		InvalidLhsOptionalChaining: ({ ancestor: a }) => `Invalid optional chaining in the left-hand side of ${Se(a)}.`,
		...
		PipeUnparenthesizedBody: ({ type: a }) => `Hack-style pipe body cannot be an unparenthesized ${Se({ type: a })}; please wrap it in parentheses.`
	}, {
	...
	function Fi({ toMessage: a, code: t, reasonCode: e, syntaxPlugin: s }) {
		...
		return function r(n, o) {
			let l = /* @__PURE__ */ new SyntaxError();
			...
			}), ps(l, "details", o), Object.defineProperty(l, "message", {
				configurable: !0,
				get() {
	...
	function F(a, t) {
		...
		for (let s of Object.keys(a)) {
			let i = a[s], r = typeof i == "string" ? { message: () => i } : typeof i == "function" ? { message: i } : i, { message: n } = r, o = Ii(r, Oi);
			e[s] = Fi(Object.assign({
	...
	C.template = new X("`", !0);
	var T = !0, m = !0, je = !0, ce = !0, V = !0, ji = !0, we = class {
		constructor(t, e = {}) {
	...
	function P(a, t = {}) {
		var e, s, i, r;
		return ++de, ut.push(a), ft.push((e = t.binop) != null ? e : -1), dt.push((s = t.beforeExpr) != null ? s : !1), mt.push((i = t.startsExpr) != null ? i : !1), yt.push((r = t.prefix) != null ? r : !1), _.push(new we(a, t)), de;
	}
	function b(a, t = {}) {
		var e, s, i, r;
		return ++de, pt.set(a, de), ut.push(a), ft.push((e = t.binop) != null ? e : -1), dt.push((s = t.beforeExpr) != null ? s : !1), mt.push((i = t.startsExpr) != null ? i : !1), yt.push((r = t.prefix) != null ? r : !1), _.push(new we("name", t)), de;
	}
	var $i = {
		bracketL: P("[", {
			beforeExpr: T,
	...
	function U(a) {
		return a < 65 ? a === 36 : a <= 90 ? !0 : a < 97 ? a === 95 : a <= 122 ? !0 : a <= 65535 ? a >= 170 && Qi.test(String.fromCharCode(a)) : He(a, ws);
	}
	function Z(a) {
		return a < 48 ? a === 36 : a < 58 ? !0 : a < 65 ? !1 : a <= 90 ? !0 : a < 97 ? a === 95 : a <= 122 ? !0 : a <= 65535 ? a >= 170 && Zi.test(String.fromCharCode(a)) : He(a, ws) || He(a, er);
	}
	var gt = {
		keyword: [
			"break",
	...
	}, tr = new Set(gt.keyword), sr = new Set(gt.strict), ir = new Set(gt.strictBind);
	function Is(a, t) {
	...
	var ur = /\*?\s*@((?:no)?flow)\b/, fr = (a) => class extends a {
		...
		flowParseDeclareModule(e) {
			...
			let r = null, n = !1;
			return i.forEach((o) => {
				hr(o) ? (r === "CommonJS" && this.raise(g.AmbiguousDeclareModuleKind, o), r = "ES") : o.type === "DeclareModuleExports" && (n && this.raise(g.DuplicateDeclareModuleExports, o), r === "ES" && this.raise(g.AmbiguousDeclareModuleKind, o), r = "CommonJS", n = !0);
		...
		flowParseObjectType({ allowStatic: e, allowExact: s, allowSpread: i, allowProto: r, allowInexact: n }) {
			...
			let h, c, u = !1;
			for (s && this.match(6) ? (this.expect(6), h = 9, c = !0) : (this.expect(5), h = 8, c = !1), l.exact = c; !this.match(h);) {
				let d = !1, x = null, A = null, N = this.startNode();
				...
				if (this.eat(0)) x != null && this.unexpected(x), this.eat(0) ? (S && this.unexpected(S.loc.start), l.internalSlots.push(this.flowParseObjectTypeInternalSlot(N, d))) : l.indexers.push(this.flowParseObjectTypeIndexer(N, d, S));
					...
					let I = "init";
					if (this.isContextual(99) || this.isContextual(104)) Es(this.lookahead().type) && (I = this.state.value, this.next());
					let W = this.flowParseObjectTypeProperty(N, d, x, S, I, i, n ?? !c);
					W === null ? (u = !0, A = this.state.lastTokStartLoc) : l.properties.push(W);
				}
		...
		flowParseFunctionTypeParam(e) {
			let s = null, i = !1, r = null, n = this.startNode(), o = this.lookahead(), l = this.state.type === 78;
			return o.type === 14 || o.type === 17 ? (l && !e && this.raise(g.ThisParamMustBeFirst, n), s = this.parseIdentifier(l), this.eat(17) && (i = !0, l && this.raise(g.ThisParamMayNotBeOptional, n)), r = this.flowParseTypeInitialiser()) : r = this.flowParseType(), n.name = s, n.optional = i, n.typeAnnotation = r, this.finishNode(n, "FunctionTypeParam");
		}
		...
		getArrowLikeExpressions(e, s) {
			...
			return s ? (r.forEach((n) => this.finishArrowValidation(n)), [r, []]) : pr(r, (n) => n.params.every((o) => this.isAssignable(o, !0)));
		}
		...
		parseImportSpecifierLocal(e, s, i) {
			s.local = ds(e) ? this.flowParseRestrictedIdentifier(!0, !0) : this.parseIdentifier(), e.specifiers.push(this.finishImportSpecifier(s, i));
		}
		...
		parseImportSpecifier(e, s, i, r, n) {
			...
			if (this.isContextual(93) && !this.isLookaheadContextual("as")) {
				...
				if (l !== null && M(this.state.type)) e.imported = this.parseIdentifier(!0), e.importKind = l;
				else {
					if (s) throw this.raise(p.ImportBindingIsString, e, { importName: o.value });
					e.imported = o, e.importKind = null;
				}
				this.eatContextual(93) ? e.local = this.parseIdentifier() : (h = !0, e.local = this.cloneIdentifier(e.imported));
			}
			let c = ds(e);
			return i && c && this.raise(g.ImportTypeShorthandOnlyInPureImport, e), (i || c) && this.checkReservedType(e.local.name, e.local.loc.start, !0), h && !i && !c && this.checkReservedWord(e.local.name, e.loc.start, !0, !0), this.finishImportSpecifier(e, "ImportSpecifier");
		}
		parseBindingAtom() {
			switch (this.state.type) {
		...
		parseSubscript(e, s, i, r) {
			if (this.match(18) && this.isLookaheadToken_lt()) {
				...
				let n = this.startNodeAt(s);
				n.callee = e;
				let o = this.tryParse(() => (n.typeArguments = this.flowParseTypeParameterInstantiationCallOrNew(), this.expect(10), n.arguments = super.parseCallExpressionArguments(11), r.optionalChainMember && (n.optional = !1), this.finishCallExpression(n, r.optionalChainMember)));
		...
		flowEnumMembers({ enumName: e, explicitType: s }) {
			...
			for (; !this.match(8);) {
				...
				if (c === "") continue;
				/^[a-z]/.test(c) && this.raise(g.EnumInvalidMemberName, l, {
					memberName: c,
					suggestion: c[0].toUpperCase() + c.slice(1),
					enumName: e
				}), i.has(c) && this.raise(g.EnumDuplicateMemberName, l, {
					memberName: c,
					enumName: e
				}), i.add(c);
				let u = {
		...
		flowEnumBody(e, s) {
			...
			switch (e.hasUnknownMembers = l, n) {
				...
				default: {
					...
					if (!u && !f && c >= d) {
						for (let x of o.defaultedMembers) this.flowEnumErrorBooleanMemberNotInitialized(x.loc.start, {
							enumName: i,
							memberName: x.id.name
						});
						return e.members = o.booleanMembers, this.expect(8), this.finishNode(e, "EnumBooleanBody");
					} else if (!c && !f && u >= d) {
						for (let x of o.defaultedMembers) this.flowEnumErrorNumberMemberNotInitialized(x.loc.start, {
							enumName: i,
							memberName: x.id.name
						});
			...
			for (;;) {
				...
				switch (i) {
					...
					case 38:
						...
						break;
					default: ee(i) ? (e += this.input.slice(s, this.state.pos), e += this.jsxReadNewLine(!0), s = this.state.pos) : ++this.state.pos;
				}
			}
		}
		jsxReadNewLine(e) {
...
`) : i = String.fromCharCode(s), ++this.state.curLine, this.state.lineStart = this.state.pos, i;
		...
		jsxReadString(e) {
			...
			for (;;) {
				...
				if (r === e) break;
				r === 38 ? (s += this.input.slice(i, this.state.pos), s += this.jsxReadEntity(), i = this.state.pos) : ee(r) ? (s += this.input.slice(i, this.state.pos), s += this.jsxReadNewLine(!1), i = this.state.pos) : ++this.state.pos;
			}
		...
		jsxParseAttributeValue() {
			let e;
			switch (this.state.type) {
				case 5: return e = this.startNode(), this.setContext(C.brace), this.next(), e = this.jsxParseExpressionContainer(e, C.j_oTag), e.expression.type === "JSXEmptyExpression" && this.raise(J.AttributeIsEmpty, e), e;
				case 143:
				case 134: return this.parseExprAtom();
				default: throw this.raise(J.UnsupportedJsxValue, this.state.startLoc);
			}
		}
		...
		updateContext(e) {
			...
			if (i === 56 && e === 143) s.splice(-2, 2, C.j_cTag), this.state.canStartJSXElement = !1;
	...
	var Qe = class extends Ye {
		...
		constructor() {
			this.flags = 1024, this.startIndex = void 0, this.curLine = void 0, this.lineStart = void 0, this.startLoc = void 0, this.endLoc = void 0, this.errors = [], this.potentialArrowAt = -1, this.noArrowAt = [], this.noArrowParamsConversionAt = [], this.topicContext = {
				...
				maxTopicIndex: null
			}, this.labels = [], this.commentsLen = 0, this.commentStack = [], this.pos = 0, this.type = 140, this.value = null, this.start = 0, this.end = 0, this.lastTokEndLoc = null, this.lastTokStartLoc = null, this.context = [C.brace], this.firstInvalidTemplateEscapePos = null, this.strictErrors = /* @__PURE__ */ new Map(), this.tokensLength = 0;
		}
		get strict() {
		...
		init({ strictMode: t, sourceType: e, startIndex: s, startLine: i, startColumn: r }) {
			this.strict = t === !1 ? !1 : t === !0 ? !0 : e === "module", this.startIndex = s, this.curLine = i, this.lineStart = -r, this.startLoc = this.endLoc = new B(i, r, s);
		}
		...
		for (;;) {
			...
			if (d === 92) {
				...
				x.ch === null && !c ? c = {
					...
					lineStart: s,
					curLine: i
				} : h += x.ch, {pos: e, lineStart: s, curLine: i} = x, u = e;
...
`);
			...
			case 120: {
				let h;
				return {code: h, pos: t} = et(a, t, e, s, 2, !1, n, r), o(h === null ? null : String.fromCharCode(h));
			}
			case 117: {
				let h;
	...
	function et(a, t, e, s, i, r, n, o) {
		let l = t, h;
		return {n: h, pos: t} = Ds(a, t, e, s, 16, i, r, !1, o, !n), h === null && (n ? o.invalidEscapeSequence(l, e, s) : t = l - 1), {
			code: h,
			pos: t
		};
	}
	function Ds(a, t, e, s, i, r, n, o, l, h) {
		let c = t, u = i === 16 ? ys.hex : ys.decBinOct, f = i === 16 ? Ae.hex : i === 10 ? Ae.dec : i === 8 ? Ae.oct : Ae.bin, d = !1, x = 0;
		for (let A = 0, N = r ?? Infinity; A < N; ++A) {
			...
			if (S >= 97 ? I = S - 97 + 10 : S >= 65 ? I = S - 65 + 10 : Pr(S) ? I = S - 48 : I = Infinity, I >= i) {
				if (I <= 9 && h) return {
					n: null,
					pos: t
				};
	...
	var br = new Set([
		...
		constructor(t, e) {
			super(), this.isLookahead = void 0, this.tokens = [], this.errorHandlers_readInt = {
				invalidDigit: (s, i, r, n) => this.optionFlags & 2048 ? (this.raise(p.InvalidDigit, pe(s, i, r), { radix: n }), !0) : !1,
			...
			}), this.state = new Ze(), this.state.init(t), this.input = e, this.length = e.length, this.comments = [], this.isLookahead = !1;
		}
		pushToken(t) {
			...
			e: for (; this.state.pos < this.length;) {
				...
				switch (s) {
					...
					case 47:
						...
						break;
					default: if (mr(s)) ++this.state.pos;
		...
		readInt(t, e, s = !1, i = !0) {
			let { n: r, pos: n } = Ds(this.input, this.state.pos, this.state.lineStart, this.state.curLine, t, e, s, i, this.errorHandlers_readInt, !1);
		...
		readNumber(t) {
			let e = this.state.pos, s = this.state.curPosition(), i = !1, r = !1, n = !1, o = !1;
			...
			if (h === 46 && !o && (++this.state.pos, this.readInt(10), i = !0, h = this.input.charCodeAt(this.state.pos)), (h === 69 || h === 101) && !o && (h = this.input.charCodeAt(++this.state.pos), (h === 43 || h === 45) && ++this.state.pos, this.readInt(10) === null && this.raise(p.InvalidOrMissingExponent, s), i = !0, n = !0, h = this.input.charCodeAt(this.state.pos)), h === 110 && ((i || l) && this.raise(p.InvalidBigIntLiteral, s), ++this.state.pos, r = !0), h === 109) {
		...
		raise(t, e, s = {}) {
			let r = t(e instanceof B ? e : e.loc.start, s);
	...
	var Nr = (a) => class extends a {
		...
		tsParseModifiers({ allowedModifiers: e, disallowedModifiers: s, stopOnStartOfClassStaticBlock: i, errorTemplate: r = y.InvalidModifierOnTypeMember }, n) {
			...
			for (;;) {
				...
				if (!c) break;
				gs(c) ? n.accessibility ? this.raise(y.DuplicateAccessibilityModifier, h, { modifier: c }) : (o(h, c, c, "override"), o(h, c, c, "static"), o(h, c, c, "readonly"), n.accessibility = c) : Ir(c) ? (n[c] && this.raise(y.DuplicateModifier, h, { modifier: c }), n[c] = !0, o(h, c, "in", "out")) : (hasOwnProperty.call(n, c) ? this.raise(y.DuplicateModifier, h, { modifier: c }) : (o(h, c, "static", "readonly"), o(h, c, "static", "override"), o(h, c, "override", "readonly"), o(h, c, "abstract", "override"), l(h, c, "declare", "override"), l(h, c, "static", "abstract")), n[c] = !0), s != null && s.includes(c) && this.raise(r, h, { modifier: c });
			}
		}
		...
		tsParseTupleElementType() {
			...
			if (c === 58) r = !0, o = !1, n = this.parseIdentifier(!0), this.expect(14), l = this.tsParseType();
			else if (c === 63) {
				o = !0;
				let u = this.state.value, f = this.tsParseNonArrayType();
				this.lookaheadCharCode() === 58 ? (r = !0, n = this.createIdentifier(this.startNodeAt(i), u), this.expect(17), this.expect(14), l = this.tsParseType()) : (r = !1, l = f, this.expect(17));
		...
		tsParseTypeOrTypePredicateAnnotation(e) {
			return this.tsInType(() => {
				...
				if (r && this.match(78)) {
					...
					return l.type === "TSThisType" ? (i.parameterName = l, i.asserts = !0, i.typeAnnotation = null, l = this.finishNode(i, "TSTypePredicate")) : (this.resetStartLocationFromNode(l, i), l.asserts = !0), s.typeAnnotation = l, this.finishNode(s, "TSTypeAnnotation");
				}
		...
		tsTryParseDeclare(e) {
			...
			return this.tsInAmbientContext(() => {
				switch (s) {
					...
					case 107:
						if (this.hasPlugin("explicitResourceManagement") && this.isUsing()) return this.raise(y.InvalidModifierOnUsingDeclaration, this.state.startLoc, "declare"), e.declare = !0, this.parseVarStatement(e, "using", !0);
						break;
					case 96:
						if (this.hasPlugin("explicitResourceManagement") && this.isAwaitUsing()) return this.raise(y.InvalidModifierOnAwaitUsingDeclaration, this.state.startLoc, "declare"), e.declare = !0, this.next(), this.parseVarStatement(e, "await using", !0);
						break;
					case 129: {
						let i = this.tsParseInterfaceDeclaration(e, { declare: !0 });
						if (i) return i;
					}
					default: if (w(s)) return this.tsParseDeclaration(e, this.state.value, !0, null);
				}
			});
		}
			...
			switch (s.name) {
				...
				case "global":
					if (this.match(5)) {
						...
						let r = e;
						return r.kind = "global", e.global = !0, r.id = s, r.body = this.tsParseModuleBlock(), this.scope.exit(), this.prodParam.exit(), this.finishNode(r, "TSModuleDeclaration");
					}
					break;
		...
		isValidLVal(e, s, i) {
			switch (e) {
				...
				case "TSAsExpression":
				case "TSSatisfiesExpression":
				case "TSTypeAssertion": return (i !== 64 || !s) && ["expression", !0];
				default: return super.isValidLVal(e, s, i);
			}
		}
		parseBindingAtom() {
		...
		tsParseAbstractDeclaration(e, s) {
			...
			if (this.isContextual(129)) {
				if (!this.hasFollowingLineBreak()) return e.abstract = !0, this.raise(y.NonClassMethodPropertyHasAbstractModifier, e), this.tsParseInterfaceDeclaration(e);
		...
		parseTypeOnlyImportExportSpecifier(e, s, i) {
			let r = s ? "imported" : "local", n = s ? "local" : "exported", o = e[r], l, h = !1, c = !0, u = o.loc.start;
			if (this.isContextual(93)) {
				let d = this.parseIdentifier();
				if (this.isContextual(93)) {
					let x = this.parseIdentifier();
					M(this.state.type) ? (h = !0, o = d, l = s ? this.parseIdentifier() : this.parseModuleExportName(), c = !1) : (l = x, c = !1);
				} else M(this.state.type) ? (c = !1, l = s ? this.parseIdentifier() : this.parseModuleExportName()) : (h = !0, o = d);
			} else M(this.state.type) && (h = !0, s ? (o = this.parseIdentifier(!0), this.isContextual(93) || this.checkReservedWord(o.name, o.loc.start, !0, !0)) : o = this.parseModuleExportName());
	...
	function kr(a) {
		...
		return t && e.type !== "StringLiteral" && (e.type !== "TemplateLiteral" || e.expressions.length > 0) ? !1 : Rs(a.object);
	}
	function vr(a, t) {
		var e;
		let { type: s } = a;
	...
	function Rs(a) {
		return a.type === "Identifier" ? !0 : a.type !== "MemberExpression" || a.computed ? !1 : Rs(a.object);
	}
	var Ts = F`placeholders`({
		ClassNameIsRequired: "A class name is required.",
		UnexpectedSpace: "Unexpected space in placeholder."
	}), Dr = (a) => class extends a {
		parsePlaceholder(e) {
			if (this.match(133)) {
				let s = this.startNode();
	...
	function Or(a) {
		...
		if (a.has("asyncDoExpressions") && !a.has("doExpressions")) {
			let s = /* @__PURE__ */ new Error("'asyncDoExpressions' requires 'doExpressions', please add 'doExpressions' to parser plugins.");
	...
	var _s = {
		...
		v8intrinsic: Mr,
		placeholders: Dr
	}, Fr = Object.keys(_s), ht = class extends lt {
		checkProto(t, e, s, i) {
		...
		parseCallExpressionArguments(t, e, s, i) {
			let r = [], n = !0, o = this.state.inFSharpPipelineDirectBody;
		...
		testTopicReferenceConfiguration(t, e, s) {
			switch (t) {
				case "hack": return this.hasPlugin(["pipelineOperator", { topicToken: H(s) }]);
		...
		parseParenAndDistinguishExpression(t) {
			...
			let n = this.state.startLoc, o = [], l = new te(), h = !0, c, u;
			for (; !this.match(11);) {
				if (h) h = !1;
...
`),
		...
		parseObjectLike(t, e, s, i) {
			...
			for (l.properties = [], this.next(); !this.match(t);) {
				...
				let c;
				e ? c = this.parseBindingProperty() : (c = this.parsePropertyDefinition(i), n = this.checkProto(c, s, n, i)), s && !this.isObjectProperty(c) && c.type !== "SpreadElement" && this.raise(p.InvalidRecordProperty, c), c.shorthand && this.addExtra(c, "shorthand", !0), l.properties.push(c);
			}
		...
		parsePropertyDefinition(t) {
			...
			if (this.parsePropertyName(s, t), !o && !l && this.maybeAsyncOrAccessorProp(s)) {
				...
				c === "async" && !this.hasPrecedingLineBreak() && (i = !0, this.resetPreviousNodeTrailingComments(h), o = this.eat(55), this.parsePropertyName(s)), (c === "get" || c === "set") && (r = !0, this.resetPreviousNodeTrailingComments(h), s.kind = c, this.match(55) && (o = !0, this.raise(p.AccessorIsGenerator, this.state.curPosition(), { kind: c }), this.next()), this.parsePropertyName(s));
			}
		...
		parseObjectProperty(t, e, s, i) {
			if (t.shorthand = !1, this.eat(14)) return t.value = s ? this.parseMaybeDefault(this.state.startLoc) : this.parseMaybeAssignAllowIn(i), this.finishObjectProperty(t);
	...
	var ct = class extends ht {
		...
		parseForStatement(t) {
			...
			let s = this.isContextual(100);
			{
				...
				if (this.match(74) || this.match(75) || c) {
					...
					l ? (f = "await using", this.recordAwaitIfAllowed() || this.raise(p.AwaitUsingNotInAsyncContext, this.state.startLoc), this.next()) : f = this.state.value, this.next(), this.parseVar(u, !0, f);
			...
			let i = this.isContextual(95), r = new te(), n = this.parseExpression(!0, r), o = this.isContextual(102);
		...
		parseBlockOrModuleBlockBody(t, e, s, i, r) {
			let n = this.state.strict, o = !1, l = !1;
			for (; !this.match(i);) {
		...
		parseFunction(t, e = 0) {
			...
			return this.state.maybeInArrowParameters = !1, this.scope.enter(514), this.prodParam.enter(Ce(n, t.generator)), i || (t.id = this.parseFunctionId()), this.parseFunctionParams(t, !1), this.withSmartMixTopicForbiddingContext(() => {
		...
		parseClassMemberWithIsStatic(t, e, s, i) {
			...
			if (this.parsePostMemberNameModifiers(u), this.isClassMethod()) {
				...
				let S = this.isNonstaticConstructor(r), I = !1;
				S && (r.kind = "constructor", s.hadConstructor && !this.hasPlugin("typescript") && this.raise(p.DuplicateConstructor, d), S && this.hasPlugin("typescript") && e.override && this.raise(p.OverrideOnConstructor, d), s.hadConstructor = !0, I = s.hadSuperClass), this.pushClassMethod(t, r, !1, !1, S, I);
				...
				this.parseClassElementName(c), this.parsePostMemberNameModifiers(u), I ? this.pushClassPrivateMethod(t, n, S, !0) : (this.isNonstaticConstructor(r) && this.raise(p.ConstructorIsAsync, r.key), this.pushClassMethod(t, r, S, !0, !1, !1));
			} else if ((x === "get" || x === "set") && !(this.match(55) && this.isLineTerminator())) {
				this.resetPreviousNodeTrailingComments(d), c.kind = x;
				let S = this.match(139);
				this.parseClassElementName(r), S ? this.pushClassPrivateMethod(t, n, !1, !1) : (this.isNonstaticConstructor(r) && this.raise(p.ConstructorIsAccessor, r.key), this.pushClassMethod(t, r, !1, !1, !1, !1)), this.checkGetterSetterParams(r);
		...
		parseExport(t, e) {
			let s = this.parseMaybeImportPhase(t, !0), i = this.maybeParseExportDefaultSpecifier(t, s), r = !i || this.eat(12), n = r && this.eatExportStar(t), o = n && this.maybeParseExportNamespaceSpecifier(t), l = r && (!o || this.eat(12)), h = i || n;
			if (n && !o) {
		...
		shouldParseExportDeclaration() {
			let { type: t } = this.state;
			if (t === 26 && (this.expectOnePlugin(["decorators", "decorators-legacy"]), this.hasPlugin("decorators"))) return this.getPluginOption("decorators", "decoratorsBeforeExport") === !0 && this.raise(p.DecoratorBeforeExport, this.state.startLoc), !0;
			if (this.hasPlugin("explicitResourceManagement")) {
				if (this.isUsing()) return this.raise(p.UsingDeclarationExport, this.state.startLoc), !0;
				if (this.isAwaitUsing()) return this.raise(p.UsingDeclarationExport, this.state.startLoc), !0;
			}
		...
		maybeParseImportAttributes(t) {
			...
			} else this.isContextual(94) && !this.hasPrecedingLineBreak() ? (!this.hasPlugin("deprecatedImportAssert") && !this.hasPlugin("importAssertions") && this.raise(p.ImportAttributesUseAssert, this.state.startLoc), this.hasPlugin("importAssertions") || this.addExtra(t, "deprecatedAssertSyntax", !0), this.next(), e = this.parseImportAttributes()) : e = [];
...
var Mt$1 = {};
Ue$1(Mt$1, { parsers: () => ja$1 });
var vt$1 = {};
Ue$1(vt$1, {
	__babel_estree: () => Ma$1,
	__js_expression: () => La$1,
	__ts_expression: () => Da$1,
	__vue_event_binding: () => ka$1,
	__vue_expression: () => La$1,
	__vue_ts_event_binding: () => va$1,
	__vue_ts_expression: () => Da$1,
	babel: () => ka$1,
	"babel-flow": () => Pi$1,
	"babel-ts": () => va$1
});
var Fe$1 = ls$1(Tt$1(), 1);
function ve$1(a) {
	return (t, e, s) => {
...
var Vs$1 = Hr$1;
function Kr$1(a, t) {
	return t === !1 ? !1 : a.charAt(t) === "/" && a.charAt(t + 1) === "/" ? js$1(a, t) : t;
}
var qs = Kr$1;
function Wr$1(a, t) {
	let e = null, s = t;
	for (; s !== e;) e = s, s = Us$1(a, s), s = $s$1(a, s), s = qs(a, s), s = Vs$1(a, s);
	return s;
}
var zs$1 = Wr$1;
function Jr$1(a) {
...
function ia$1(a) {
	return At$1.has(a) || At$1.set(a, G$1(a) && a.value[0] === "*" && /@(?:type|satisfies)\b/u.test(a.value)), At$1.get(a);
}
var Xs$1 = ia$1;
function ra$1(a) {
	if (!G$1(a)) return !1;
...
var St$1 = /* @__PURE__ */ new WeakMap();
function aa$1(a) {
	return St$1.has(a) || St$1.set(a, ra$1(a)), St$1.get(a);
}
var Et$1 = aa$1;
function na$1(a) {
	...
	for (let e = a.length - 1; e >= 0; e--) {
		let s = a[e];
		if (t && k(s) === v$1(t) && Et$1(s) && Et$1(t) && (a.splice(e + 1, 1), s.value += "*//*" + t.value, s.range = [v$1(s), k(t)]), !bt$1(s) && !G$1(s)) throw new TypeError(`Unknown comment type: "${s.type}".`);
		t = s;
	}
}
var Gs = na$1;
var ge$1 = null;
function Te$1(a) {
	if (ge$1 !== null && typeof ge$1.property) {
		let t = ge$1;
		return ge$1 = Te$1.prototype = null, t;
	}
	return ge$1 = Te$1.prototype = a ?? Object.create(null), new Te$1();
}
var oa$1 = 10;
for (let a = 0; a <= oa$1; a++) Te$1();
function Ct$1(a) {
	return Te$1(a);
}
function la$1(a, t = "type") {
	Ct$1(a);
	function e(s) {
		let i = s[t], r = a[i];
...
function wt$1(a, t) {
	...
	if (Array.isArray(a)) {
		for (let s = 0; s < a.length; s++) a[s] = wt$1(a[s], t);
		return a;
	}
	let e = Zs$1(a);
	for (let s = 0; s < e.length; s++) a[e[s]] = wt$1(a[e[s]], t);
	return t(a) || a;
}
var ei$1 = wt$1;
ae$1([
...
function ca$1(a, t) {
	...
	a = ei$1(a, (l) => {
		switch (l.type) {
			case "ParenthesizedExpression": {
				let { expression: h } = l, c = v$1(l);
				if (h.type === "TypeCastExpression") return h.range = [c, k(l)], h;
				let u = !1;
				if (!r) {
					if (!n) {
						n = [];
						for (let d of i) Xs$1(d) && n.push(k(d));
					}
					let f = Ks$1(!1, n, (d) => d <= c);
			...
			case "LogicalExpression":
				if (si$1(l)) return It$1(l);
				break;
			case "TemplateLiteral":
				if (l.expressions.length !== l.quasis.length - 1) throw new Error("Malformed template literal.");
				break;
			case "TemplateElement":
				if (e === "flow" || e === "hermes" || e === "espree" || e === "typescript" || r) l.range = [v$1(l) + 1, k(l) - (l.tail ? 1 : 2)];
				break;
			case "VariableDeclaration": {
				let h = Ws(!1, l.declarations, -1);
				h != null && h.init && s[k(h)] !== ";" && (l.range = [v$1(l), k(h)]);
				break;
			}
			case "TSParenthesizedType": return l.typeAnnotation;
			case "TSTypeParameter":
				ti$1(l);
				break;
			case "TopicReference":
			...
			case "TSMappedType":
				if (!l.constraint && !l.key) {
					let { name: h, constraint: c } = ti$1(l.typeParameter);
					l.constraint = c, l.key = h, delete l.typeParameter;
				}
				break;
			case "TSEnumDeclaration":
				if (!l.body) {
					let h = k(l.id), { members: c } = l;
					l.body = {
						type: "TSEnumBody",
						members: c,
						range: [h + Js({
							originalText: s,
							[Symbol.for("comments")]: i
						}, h, c[0] ? v$1(c[0]) : k(l)).indexOf("{"), k(l)]
					}, delete l.members;
				}
				break;
			case "ImportExpression":
...
function It$1(a) {
	return si$1(a) ? It$1({
		...
		left: It$1({
			...
			left: a.left,
			right: a.right.left,
			range: [v$1(a.left), k(a.right.left)]
		}),
		right: a.right.right,
		range: [v$1(a), k(a)]
	}) : a;
...
var De$1 = pa$1;
var ri$1 = "Unexpected parseExpression() input: ";
function ua$1(a) {
	...
	let o = ` (${i}:${r})`;
	return t.endsWith(o) && (t = t.slice(0, -o.length)), t.startsWith(ri$1) && (t = t.slice(ri$1.length)), De$1(t, {
		loc: { start: {
			line: i,
			column: r + 1
		} },
...
function li$1(a) {
	let t = `
`;
	a = ne(!1, a.replace(ma$1, "").replace(da$1, ""), ga$1, "$1");
	let e = "";
	for (; e !== a;) e = a, a = ne(!1, a, Pa$1, `${t}$1 $2${t}`);
	a = a.replace(ai$1, "").trimEnd();
	let s = Object.create(null), i = ne(!1, a, ni$1, "").replace(ai$1, "").trimEnd(), r;
	for (; r = ni$1.exec(a);) {
		let n = ne(!1, r[2], xa$1, "");
...
var hi$1 = ["noformat", "noprettier"], ci$1 = ["format", "prettier"];
function pi$1(a) {
	let t = Le$1(a);
	t && (a = a.slice(t.length + 1));
	let { pragmas: s, comments: i } = li$1(oi$1(a));
	return {
		shebang: t,
		text: a,
		pragmas: s,
...
function ui$1(a) {
	let { pragmas: t } = pi$1(a);
	return ci$1.some((e) => Object.prototype.hasOwnProperty.call(t, e));
}
function fi$1(a) {
	let { pragmas: t } = pi$1(a);
	return hi$1.some((e) => Object.prototype.hasOwnProperty.call(t, e));
}
function ba$1(a) {
	return a = typeof a == "function" ? { parse: a } : a, {
		astFormat: "estree",
		hasPragma: ui$1,
		hasIgnorePragma: fi$1,
		locStart: v$1,
		locEnd: k,
		...a
	};
...
var Y$1 = ba$1;
var Nt$1 = "module", kt$1 = "script";
function di$1(a) {
	if (typeof a == "string") {
		if (a = a.toLowerCase(), /\.(?:mjs|mts)$/iu.test(a)) return Nt$1;
		if (/\.(?:cjs|cts)$/iu.test(a)) return kt$1;
	}
}
function Aa$1(a, t) {
...
var oe$1 = (a) => Y$1(Ia$1(a)), Sa$1 = {
	...
	tokens: !1,
	ranges: !1
}, mi$1 = "v8intrinsic", yi$1 = [["pipelineOperator", {
	proposal: "hack",
	topicToken: "%"
}], ["pipelineOperator", { proposal: "fsharp" }]], j$1 = (a, t = Sa$1) => ({
	...t,
	plugins: [...t.plugins, ...a]
}), Ea$1 = /@(?:no)?flow\b/u;
function Ca$1(a, t) {
	...
	let s = zs$1(a, 0);
	return s !== !1 && (a = a.slice(0, s)), Ea$1.test(a);
}
function wa$1(a, t, e) {
	let s = a(t, e), i = s.errors.find((r) => !Na$1.has(r.reasonCode));
	if (i) throw i;
	return s;
}
function Ia$1({ isExpression: a = !1, optionsCombinations: t }) {
	return (e, s = {}) => {
		let { filepath: i } = s;
		if (typeof i != "string" && (i = void 0), (s.parser === "babel" || s.parser === "__babel_estree") && Ca$1(e, i)) return s.parser = "babel-flow", Pi$1.parse(e, s);
		let r = t, n = s.__babelSourceType ?? di$1(i);
		n === kt$1 && (r = r.map((c) => ({
			...c,
			sourceType: n
		})));
		let o = /%[A-Z]/u.test(e);
		e.includes("|>") ? r = (o ? [...yi$1, mi$1] : yi$1).flatMap((u) => r.map((f) => j$1([u], f))) : o && (r = r.map((c) => j$1([mi$1], c)));
		let l = a ? Fe$1.parseExpression : Fe$1.parse, h;
		try {
			h = Hs$1(r.map((c) => () => wa$1(l, e, c)));
		} catch ({ errors: [c] }) {
			throw Me$1(c);
		}
		return a && (h = Oe$1(h, {
...
]), xi$1 = [j$1(["jsx"])], ka$1 = oe$1({ optionsCombinations: xi$1 }), va$1 = oe$1({ optionsCombinations: [j$1(["jsx", "typescript"]), j$1(["typescript"])] }), La$1 = oe$1({
	isExpression: !0,
	optionsCombinations: [j$1(["jsx"])]
}), Da$1 = oe$1({
	isExpression: !0,
	optionsCombinations: [j$1(["typescript"])]
}), Pi$1 = oe$1({ optionsCombinations: [j$1([
	"jsx",
	["flow", { all: !0 }],
	"flowComments"
])] }), Ma$1 = oe$1({ optionsCombinations: xi$1.map((a) => j$1(["estree"], a)) });
var Dt$1 = {};
Ue$1(Dt$1, {
	json: () => Ba$1,
	"json-stringify": () => Ua$1,
...
function Re$1(a, t = {}) {
	...
	if (!e && Lt$1(i.comments)) throw K$1(i.comments[0], "Comment");
	return i = Oe$1(i, {
		type: "JsonRoot",
		text: a
	}), i.node.type === "File" ? delete i.node : le$1(i.node), i;
}
function K$1(a, t) {
	...
	return De$1(`${t} is not allowed in JSON.`, { loc: {
		start: e,
		end: s
	} });
}
function le$1(a) {
	switch (a.type) {
		case "ArrayExpression":
			for (let t of a.elements) t !== null && le$1(t);
			return;
		case "ObjectExpression":
			for (let t of a.properties) le$1(t);
			return;
		case "ObjectProperty":
			if (a.computed) throw K$1(a.key, "Computed key");
			if (a.shorthand) throw K$1(a.key, "Shorthand property");
			a.key.type !== "Identifier" && le$1(a.key), le$1(a.value);
			return;
		case "UnaryExpression": {
			let { operator: t, argument: e } = a;
			if (t !== "+" && t !== "-") throw K$1(a, `Operator '${a.operator}'`);
			if (e.type === "NumericLiteral" || e.type === "Identifier" && (e.name === "Infinity" || e.name === "NaN")) return;
			throw K$1(e, `Operator '${t}' before '${e.type}'`);
		}
		case "Identifier":
			if (a.name !== "Infinity" && a.name !== "NaN" && a.name !== "undefined") throw K$1(a, `Identifier '${a.name}'`);
			return;
		case "TemplateLiteral":
			if (Lt$1(a.expressions)) throw K$1(a.expressions[0], "'TemplateLiteral' with expression");
			for (let t of a.quasis) le$1(t);
			return;
		case "NullLiteral":
		case "BooleanLiteral":
		case "NumericLiteral":
...
var Ba$1 = Y$1({
	...
	hasPragma: () => !0,
	hasIgnorePragma: () => !1
}), Ra$1 = Y$1((a) => Re$1(a)), _a$1 = Y$1((a) => Re$1(a, { allowEmpty: !0 })), Ua$1 = Y$1({
	parse: (a) => Re$1(a, { allowComments: !1 }),
...
var Vo$1 = Mt$1;
//#endregion
//#region ../../../node_modules/.pnpm/prettier@3.6.2/node_modules/prettier/plugins/estree.mjs
var estree_exports = /* @__PURE__ */ __exportAll({
	default: () => Nx,
	languages: () => Tm,
	options: () => Ha,
	printers: () => dm
...
var $s = to;
function* ro(e, t) {
	let { getVisitorKeys: r, filter: n = () => !0 } = t, s = (u) => $s(u) && n(u);
	for (let u of r(e)) {
		let i = e[u];
...
]), U = R(["ArrayExpression"]), ue = R(["ObjectExpression"]);
function fu(e) {
...
function _n(e) {
	return w(e) && e.callee.type === "Identifier" && [
		"async",
		"inject",
		"fakeAsync",
		"waitForAsync"
...
function Pt(e, t) {
	...
	} else if ((r.length === 2 || r.length === 3) && (r[0].type === "TemplateLiteral" || K(r[0])) && Oo(e.callee)) return r[2] && !ye(r[2]) ? !1 : (r.length === 2 ? Rt(r[1]) : ko(r[1]) && Q(r[1]).length <= 1) || _n(r[1]);
	return !1;
}
...
function ir(e, t) {
	...
	if (d(e)) return !1;
	let n = r * _o;
	if (e.type === "ThisExpression" || e.type === "Identifier" && e.name.length <= n || Rn(e) && !d(e.argument)) return !0;
...
function _r(e, t) {
	return (e.type === "TemplateLiteral" && cu(e) || e.type === "TaggedTemplateExpression" && cu(e.quasi)) && !ee(t, j(e), { backwards: !0 });
}
function Mr(e) {
	if (!d(e)) return !1;
...
`)) && e.expressions.every(r);
	...
	return G(e) ? we(e.object, t) && we(e.property, t) : e.type === "UnaryExpression" && Mo.has(e.operator) || e.type === "UpdateExpression" ? we(e.argument, t) : !1;
}
function du(e) {
	return e;
}
...
function pe(e, t) {
	switch (e.type) {
		...
		case "LogicalExpression":
		case "AssignmentExpression":
		case "NGPipeExpression": return pe(e.left, t);
		case "MemberExpression":
		case "OptionalMemberExpression": return pe(e.object, t);
		case "TaggedTemplateExpression": return e.tag.type === "FunctionExpression" ? !1 : pe(e.tag, t);
		case "CallExpression":
		case "OptionalCallExpression": return e.callee.type === "FunctionExpression" ? !1 : pe(e.callee, t);
		case "ConditionalExpression": return pe(e.test, t);
		case "UpdateExpression": return !e.prefix && pe(e.argument, t);
		case "BindExpression": return e.object && pe(e.object, t);
		case "SequenceExpression": return pe(e.expressions[0], t);
		...
		case "SatisfiesExpression": return pe(e.expression, t);
		default: return t(e);
	}
}
var lu = {
...
var xe = R([
	...
	"AsConstExpression",
	"SatisfiesExpression"
]), Oe = R(["TSUnionType", "UnionTypeAnnotation"]), qt = R(["TSIntersectionType", "IntersectionTypeAnnotation"]), Je = R(["TSConditionalType", "ConditionalTypeAnnotation"]);
var jo = new Set([
	"range",
	"raw",
	"comments",
...
function Su(e, t) {
	...
	e.type === "JSXAttribute" && e.name.name === "css" && e.value.type === "JSXExpressionContainer" && e.value.expression.type === "TemplateLiteral" && Wt(t.value.expression), e.type === "JSXAttribute" && ((n = e.value) == null ? void 0 : n.type) === "Literal" && /["']|&quot;|&apos;/u.test(e.value.value) && (t.value.value = X(!1, e.value.value, /["']|&quot;|&apos;/gu, "\""));
...
var Bu = Su;
var Ne = "string", ge = "array", it = "cursor", $e = "indent", Ke = "align", Qe = "trim", fe = "group", _e = "fill", he = "if-break", ze = "indent-if-break", Ze = "line-suffix", Ge = "line-suffix-boundary", oe = "line", Se = "label", Me = "break-parent", jr = new Set([
	it,
	$e,
	Ke,
	Qe,
...
function wu(e) {
	...
	return pr(e, (r) => {
		switch (Be(r)) {
			...
			case Ge:
			case oe:
			case Me: return t = !1, !1;
		}
	}), t;
}
var Wn = () => {}, et = Wn, Un = Wn, Ou = Wn;
function D(e) {
	return et(e), {
		type: $e,
		contents: e
...
function l(e, t = {}) {
	return et(e), Un(t.expandedStates, !0), {
		type: fe,
		id: t.id,
		contents: e,
		break: !!t.shouldBreak,
...
`);
	return [
		"/*",
		b(F, t.map((r, n) => n === 0 ? r.trimEnd() : " " + (n < t.length - 1 ? r.trim() : r.trimStart()))),
		"*/"
	];
}
var ts = {};
...
function Qn({ comment: e, precedingNode: t, enclosingNode: r, followingNode: n, text: s }) {
	...
	if (t === r.consequent && n === r.alternate) {
		...
		if (j(e) < i || r.alternate.type === "BlockStatement") return t.type === "BlockStatement" ? (z(t, e), !0) : Ru(e, s) && !ie(s, j(t), j(e)) ? (z(t, e), !0) : (Pe(r, e), !0);
	}
	return n.type === "BlockStatement" ? (It(n, e), !0) : n.type === "IfStatement" ? (Kn(n.consequent, e), !0) : r.consequent === n ? (De(n, e), !0) : !1;
}
function zn({ comment: e, precedingNode: t, enclosingNode: r, followingNode: n, text: s }) {
	return (r == null ? void 0 : r.type) !== "WhileStatement" || !n ? !1 : ke(s, P(e)) === ")" ? (z(t, e), !0) : n.type === "BlockStatement" ? (It(n, e), !0) : r.body === n ? (De(n, e), !0) : !1;
}
function Ju({ comment: e, precedingNode: t, enclosingNode: r, followingNode: n }) {
	return (r == null ? void 0 : r.type) !== "TryStatement" && (r == null ? void 0 : r.type) !== "CatchClause" || !n ? !1 : r.type === "CatchClause" && t ? (z(t, e), !0) : n.type === "BlockStatement" ? (It(n, e), !0) : n.type === "TryStatement" ? (Kn(n.finalizer, e), !0) : n.type === "CatchClause" ? (Kn(n.body, e), !0) : !1;
}
...
function ip({ comment: e, enclosingNode: t, followingNode: r, options: n }) {
	return !n.experimentalTernaries || !((t == null ? void 0 : t.type) === "ConditionalExpression" || Je(t)) ? !1 : (r == null ? void 0 : r.type) === "ConditionalExpression" || Je(r) ? (Pe(t, e), !0) : !1;
}
function Nu({ comment: e, precedingNode: t, enclosingNode: r, followingNode: n, text: s, options: u }) {
	let i = t && !ie(s, P(t), j(e));
	return (!t || !i) && ((r == null ? void 0 : r.type) === "ConditionalExpression" || Je(r)) && n ? u.experimentalTernaries && r.alternate === n && !(te(e) && !ie(u.originalText, j(e), P(e))) ? (Pe(r, e), !0) : (De(n, e), !0) : !1;
}
function ap({ comment: e, precedingNode: t, enclosingNode: r }) {
	return Te(r) && r.shorthand && r.key === t && r.value.type === "AssignmentPattern" ? (z(r.value.left, e), !0) : !1;
}
var op = new Set([
	"ClassDeclaration",
	"ClassExpression",
...
function Gu({ comment: e, precedingNode: t, enclosingNode: r, followingNode: n }) {
	if (op.has(r == null ? void 0 : r.type)) {
		if (O(r.decorators) && (n == null ? void 0 : n.type) !== "Decorator") return z(v(!1, r.decorators, -1), e), !0;
		...
		if (n) {
			...
			for (let s of [
				...
				"extends",
				"mixins"
			]) if (r[s] && n === r[s][0]) return t && (t === r.id || t === r.typeParameters || t === r.superClass) ? z(t, e) : Pe(r, e, s), !0;
		}
	}
	return !1;
}
...
function qu({ comment: e, precedingNode: t, enclosingNode: r, text: n }) {
	return r && t && ke(n, P(e)) === "(" && (r.type === "Property" || r.type === "TSDeclareMethod" || r.type === "TSAbstractMethodDefinition") && t.type === "Identifier" && r.key === t && ke(n, P(t)) !== ":" ? (z(t, e), !0) : (t == null ? void 0 : t.type) === "Decorator" && pp.has(r == null ? void 0 : r.type) && (At(e) || e.placement === "ownLine") ? (z(t, e), !0) : !1;
}
var cp = new Set([
	"FunctionDeclaration",
	"FunctionExpression",
...
function yp({ comment: e, enclosingNode: t, text: r }) {
	return ke(r, P(e)) !== ")" ? !1 : t && (Vu(t) && Q(t).length === 0 || yt(t) && le(t).length === 0) ? (Pe(t, e), !0) : ((t == null ? void 0 : t.type) === "MethodDefinition" || (t == null ? void 0 : t.type) === "TSAbstractMethodDefinition") && Q(t.value).length === 0 ? (Pe(t.value, e), !0) : !1;
}
...
function Ep({ comment: e, precedingNode: t, enclosingNode: r, followingNode: n }) {
	return Oe(r) ? (or(e) && (n.prettierIgnore = !0, e.unignore = !0), t ? (z(t, e), !0) : !1) : (Oe(n) && or(e) && (n.types[0].prettierIgnore = !0, e.unignore = !0), !1);
}
...
function es({ comment: e, enclosingNode: t, ast: r, isLastComment: n }) {
	var s;
	return ((s = r == null ? void 0 : r.body) == null ? void 0 : s.length) === 0 ? (n ? Pe(r, e) : De(r, e), !0) : (t == null ? void 0 : t.type) === "Program" && t.body.length === 0 && !O(t.directives) ? (n ? Pe(t, e) : De(t, e), !0) : !1;
}
function Cp({ comment: e, enclosingNode: t }) {
	return (t == null ? void 0 : t.type) === "ForInStatement" || (t == null ? void 0 : t.type) === "ForOfStatement" ? (De(t, e), !0) : !1;
}
function Xu({ comment: e, precedingNode: t, enclosingNode: r, text: n }) {
	if ((r == null ? void 0 : r.type) === "ImportSpecifier" || (r == null ? void 0 : r.type) === "ExportSpecifier") return De(r, e), !0;
...
function xp({ comment: e, enclosingNode: t, followingNode: r }) {
	return dp.has(t == null ? void 0 : t.type) && r && (Tp.has(r.type) || te(e)) ? (De(r, e), !0) : !1;
}
function hp({ comment: e, enclosingNode: t, followingNode: r, text: n }) {
	return !r && ((t == null ? void 0 : t.type) === "TSMethodSignature" || (t == null ? void 0 : t.type) === "TSDeclareFunction" || (t == null ? void 0 : t.type) === "TSAbstractMethodDefinition") && ke(n, P(e)) === ";" ? (z(t, e), !0) : !1;
}
function Yu({ comment: e, enclosingNode: t, followingNode: r }) {
	if (or(e) && (t == null ? void 0 : t.type) === "TSMappedType" && r === t.key) return t.prettierIgnore = !0, e.unignore = !0, !0;
}
...
function gp({ comment: e, enclosingNode: t, followingNode: r }) {
	return !t || t.type !== "SwitchCase" || t.test || !r || r !== t.consequent[0] ? !1 : (r.type === "BlockStatement" && At(e) ? It(r, e) : Pe(t, e), !0);
}
function Sp({ comment: e, precedingNode: t, enclosingNode: r, followingNode: n }) {
	return Oe(t) && ((r.type === "TSArrayType" || r.type === "ArrayTypeAnnotation") && !n || qt(r)) ? (z(v(!1, t.types, -1), e), !0) : !1;
}
function Bp({ comment: e, enclosingNode: t, precedingNode: r, followingNode: n }) {
	if (((t == null ? void 0 : t.type) === "ObjectPattern" || (t == null ? void 0 : t.type) === "ArrayPattern") && (n == null ? void 0 : n.type) === "TSTypeAnnotation") return r ? z(r, e) : Pe(t, e), !0;
}
function bp({ comment: e, precedingNode: t, enclosingNode: r, followingNode: n, text: s }) {
	return !n && (r == null ? void 0 : r.type) === "UnaryExpression" && ((t == null ? void 0 : t.type) === "LogicalExpression" || (t == null ? void 0 : t.type) === "BinaryExpression") && ie(s, j(r.argument), j(t.right)) && Ru(e, s) && !ie(s, j(t.right), j(e)) ? (z(t.right, e), !0) : !1;
}
var Vu = R([
	"ArrowFunctionExpression",
	"FunctionExpression",
...
function Lp(e, { parser: t }) {
	if (t === "flow" || t === "hermes" || t === "babel-flow") return e = X(!1, e, /[\s(]/gu, ""), e === "" || e === "/*" || e === "/*::";
}
function $u(e) {
	switch (e) {
		case "cr": return "\r";
...
function Op(e, t, r) {
	return t === Number.NEGATIVE_INFINITY ? e.root || Ku() : t < 0 ? ss(e, { type: "dedent" }, r) : t ? t.type === "root" ? {
		...e,
		root: e
	} : ss(e, {
		type: typeof t == "string" ? "stringAlign" : "numberAlign",
	...
	for (; r >= 0;) {
		...
		switch (f) {
			...
			case _e: {
				...
				for (let c = y.length - 1; c >= C; c--) a.push({
					mode: p,
					doc: y[c]
				});
				break;
			...
			case fe: {
				...
				let y = m.break ? Ie : p, C = m.expandedStates && y === Ie ? v(!1, m.expandedStates, -1) : m.contents;
				a.push({
					mode: y,
					doc: C
				});
...
function is(e, t) {
	let r = {}, n = t.printWidth, s = $u(t.endOfLine), u = 0, i = [{
		ind: Ku(),
		mode: Ie,
		doc: e
	}], a = [], o = !1, p = [], m = 0;
...
`, s) : c;
			...
			case ge:
				for (let A = c.length - 1; A >= 0; A--) i.push({
					ind: y,
					mode: C,
					doc: c[A]
				});
			...
			case _e: {
				...
				}, [], A, p.length > 0, r, !0) ? i.push(Z, k, J) : q ? i.push(Z, W, J) : i.push(Z, W, I);
				break;
			}
			case he:
			case ze: {
...
function Zu(e, t, r) {
	...
	return i && (ie(t.originalText, P(s.typeArguments ?? s.typeParameters ?? s.tag), j(i)) ? u = E : u = " "), at(n.label && {
		tagged: !0,
		...n.label
	}, [
		r("tag"),
...
function Wp({ parent: e }) {
	...
	switch (t.type) {
		case "MemberExpression": return Yr(t.object) || ri(t);
		case "CallExpression": return Yr(t.callee) || t.callee.type === "MemberExpression" && (t.callee.object.type === "MemberExpression" && (Yr(t.callee.object.object) || ri(t.callee.object)) || t.callee.object.type === "CallExpression" && Yr(t.callee.object.callee));
...
`), C = y.length, c = u[a], A = C > 2 && y[0].trim() === "" && y[1].trim() === "", T = C > 2 && y[C - 1].trim() === "" && y[C - 2].trim() === "", B = y.every((_) => /^\s*(?:#[^\n\r]*)?$/u.test(_));
		...
		let g = null;
		B ? g = Hp(y) : g = await e(f, { parser: "graphql" }), g ? (g = Ur(g, !1), !p && A && i.push(""), i.push(g), !m && T && i.push("")) : !p && !m && A && i.push(""), c && i.push(c);
	}
	return [
		"`",
		D([F, b(F, i)]),
...
async function ui(e, t, r, n, s) {
	...
	let a = (B) => `PRETTIER_HTML_PLACEHOLDER_${B}_${i}_IN_JS`, o = u.quasis.map((B, g, _) => g === _.length - 1 ? B.value.cooked : B.value.cooked + a(g)).join(""), p = Yt(n, r), m = new RegExp(a(String.raw`(\d+)`), "gu"), f = 0, C = ft(await t(o, {
		...
		for (let M = 0; M < _.length; M++) {
			let J = _[M];
			if (M % 2 === 0) {
				J && (J = as(J), s.__embeddedInHtml && (J = X(!1, J, /<\/(?=script\b)/giu, String.raw`<\/`)), g.push(J));
				continue;
			}
			let I = Number(J);
			g.push(p[I]);
...
async function ec(e, t, r) {
	let { node: n } = r, s = X(!1, n.quasis[0].value.raw, /((?:\\\\)*)\\`/gu, (o, p) => "\\".repeat(p.length / 2) + "`"), u = tc(s), i = u !== "";
...
`;
	...
	let n = Object.create(null), s = X(!1, e, ci, "").replace(pi, "").trimEnd(), u;
	for (; u = ci.exec(e);) {
		let i = X(!1, u[2], oc, "");
...
function di(e) {
	let { shebang: t, text: r, pragmas: n, comments: s } = mc(e), u = Di(r), i = Fi({
		pragmas: {
			[Ci]: "",
			...n
		},
...
function ls(e, t) {
	...
	if (r.type === "ObjectExpression") {
		...
		if (c && c.type !== "SequenceExpression" && c.type !== "AssignmentExpression" && pe(c, (A) => A === r)) return !0;
	}
	switch (s.type) {
		...
		case "ClassExpression":
			...
			break;
		case "ExportDefaultDeclaration": return xi(e, t) || r.type === "SequenceExpression";
		case "Decorator":
			if (n === "expression" && !Ac(r)) return !0;
			break;
		case "TypeAnnotation":
			if (e.match(void 0, void 0, (c, A) => A === "returnType" && c.type === "ArrowFunctionExpression") && Ec(r)) return !0;
			break;
		case "BinaryExpression":
			if (n === "left" && (s.operator === "in" || s.operator === "instanceof") && r.type === "UnaryExpression") return !0;
			break;
		case "VariableDeclarator":
			if (n === "init" && e.match(void 0, void 0, (c, A) => A === "declarations" && c.type === "VariableDeclaration", (c, A) => A === "left" && c.type === "ForInStatement")) return !0;
			break;
	}
	switch (r.type) {
		...
		case "LogicalExpression": switch (s.type) {
			...
			case "AsExpression":
			case "AsConstExpression":
			case "SatisfiesExpression": return !xe(r);
			case "ConditionalExpression": return xe(r) || fu(r);
			case "CallExpression":
			case "NewExpression":
			case "OptionalCallExpression": return n === "callee";
			case "ClassExpression":
			...
			case "OptionalMemberExpression": return n === "object";
			case "AssignmentExpression":
			case "AssignmentPattern": return n === "left" && (r.type === "TSTypeAssertion" || xe(r));
			...
			case "BinaryExpression": {
				...
				return g > T || n === "right" && g === T || g === T && !ar(B, c) ? !0 : g < T && c === "%" ? B === "+" || B === "-" : !!Tu(B);
			}
			default: return !1;
		}
		...
		case "TSFunctionType": if (e.match((c) => c.type === "TSFunctionType", (c, A) => A === "typeAnnotation" && c.type === "TSTypeAnnotation", (c, A) => A === "returnType" && c.type === "ArrowFunctionExpression")) return !0;
		case "TSConditionalType":
		case "TSConstructorType":
		case "ConditionalTypeAnnotation":
			if (n === "extendsType" && Je(r) && s.type === r.type || n === "checkType" && Je(s)) return !0;
		...
		case "TSUnionType":
		case "TSIntersectionType": if ((Oe(s) || qt(s)) && s.types.length > 1 && (!r.types || r.types.length > 1)) return !0;
		...
		case "FunctionTypeAnnotation": {
			...
			if (e.match(void 0, (A, T) => T === "typeAnnotation" && A.type === "TypeAnnotation", (A, T) => T === "returnType" && A.type === "ArrowFunctionExpression") || e.match(void 0, (A, T) => T === "typeAnnotation" && A.type === "TypePredicate", (A, T) => T === "typeAnnotation" && A.type === "TypeAnnotation", (A, T) => T === "returnType" && A.type === "ArrowFunctionExpression")) return !0;
		...
		case "AssignmentExpression": return !((n === "init" || n === "update") && s.type === "ForStatement" || n === "expression" && r.left.type !== "ObjectPattern" && s.type === "ExpressionStatement" || n === "key" && s.type === "TSPropertySignature" || s.type === "AssignmentExpression" || n === "expressions" && s.type === "SequenceExpression" && e.match(void 0, void 0, (c, A) => (A === "init" || A === "update") && c.type === "ForStatement") || n === "value" && s.type === "Property" && e.match(void 0, void 0, (c, A) => A === "properties" && c.type === "ObjectPattern") || s.type === "NGChainedExpression" || n === "node" && s.type === "JsExpressionRoot");
		...
		case "ArrowFunctionExpression": switch (s.type) {
			case "BinaryExpression": return s.operator !== "|>" || ((y = r.extra) == null ? void 0 : y.parenthesized);
			case "NewExpression":
			case "CallExpression":
			case "OptionalCallExpression": return n === "callee";
			case "MemberExpression":
		...
		case "OptionalCallExpression":
		case "CallExpression":
		case "MemberExpression": if (Cc(e)) return !0;
		case "TaggedTemplateExpression":
		case "TSNonNullExpression":
			...
			return !1;
		case "BindExpression": return n === "callee" && (s.type === "BindExpression" || s.type === "NewExpression") || n === "object" && G(s);
		case "NGPipeExpression": return !(s.type === "NGRoot" || s.type === "NGMicrosyntaxExpression" || s.type === "ObjectProperty" && !((C = r.extra) != null && C.parenthesized) || U(s) || n === "arguments" && w(s) || n === "right" && s.type === "NGPipeExpression" || n === "property" && s.type === "MemberExpression" || s.type === "AssignmentExpression");
		case "JSXFragment":
		case "JSXElement": return n === "callee" || n === "left" && s.type === "BinaryExpression" && s.operator === "<" || !U(s) && s.type !== "ArrowFunctionExpression" && s.type !== "AssignmentExpression" && s.type !== "AssignmentPattern" && s.type !== "BinaryExpression" && s.type !== "NewExpression" && s.type !== "ConditionalExpression" && s.type !== "ExpressionStatement" && s.type !== "JsExpressionRoot" && s.type !== "JSXAttribute" && s.type !== "JSXElement" && s.type !== "JSXExpressionContainer" && s.type !== "JSXFragment" && s.type !== "LogicalExpression" && !w(s) && !Te(s) && s.type !== "ReturnStatement" && s.type !== "ThrowStatement" && s.type !== "TypeCastExpression" && s.type !== "VariableDeclarator" && s.type !== "YieldExpression";
		case "TSInstantiationExpression": return n === "object" && G(s);
	}
	return !1;
}
var fc = R([
...
function xi(e, t) {
	...
	return r.type === "FunctionExpression" || r.type === "ClassExpression" ? n.type === "ExportDefaultDeclaration" || !ls(e, t) : !Jt(r) || n.type !== "ExportDefaultDeclaration" && ls(e, t) ? !1 : e.call(() => xi(e, t), ...Lr(r));
}
function Cc(e) {
...
function ms(e) {
	return e.type === "Identifier" ? !0 : G(e) ? !e.computed && !e.optional && e.property.type === "Identifier" && ms(e.object) : !1;
}
function Ac(e) {
...
function dc(e, t) {
	let r = t - 1;
	r = Ye(e, r, { backwards: !0 }), r = He(e, r, { backwards: !0 }), r = Ye(e, r, { backwards: !0 });
...
function N(e, t, r = {}) {
	...
	let { indent: s = !1, marker: u, filter: i = Tc } = r, a = [];
	if (e.each(({ node: p }) => {
...
function gc(e, t, r) {
	...
	n.children = n.children.map((k) => Nc(k) ? {
		type: "JSXText",
		value: " ",
		raw: " "
	} : k);
	...
	if (((J = t.cursorNode) == null ? void 0 : J.type) === "JSXText" && n.children.includes(t.cursorNode) ? B = [
		mr,
		B,
		mr
	] : ((I = t.nodeBeforeCursor) == null ? void 0 : I.type) === "JSXText" && n.children.includes(t.nodeBeforeCursor) ? B = [mr, B] : ((q = t.nodeAfterCursor) == null ? void 0 : q.type) === "JSXText" && n.children.includes(t.nodeAfterCursor) && (B = [B, mr]), m) return B;
	let g = l([
		s,
		D([F, B]),
		F,
...
function bi(e, t, r) {
	...
	if (n.type.startsWith("JSX")) switch (n.type) {
		case "JSXAttribute": return kc(e, t, r);
		case "JSXIdentifier": return n.name;
		case "JSXNamespacedName": return b(":", [r("namespace"), r("name")]);
		case "JSXMemberExpression": return b(".", [r("object"), r("property")]);
		case "JSXSpreadAttribute":
		case "JSXSpreadChild": return Rc(e, t, r);
		case "JSXExpressionContainer": return Ic(e, t, r);
		case "JSXFragment":
		case "JSXElement": return vc(e, t, r);
		case "JSXOpeningElement": return Lc(e, t, r);
		case "JSXClosingElement": return _c(e, t, r);
		case "JSXOpeningFragment":
		case "JSXClosingFragment": return Mc(e, t);
		case "JSXEmptyExpression": return jc(e, t);
...
function $r(e, t, r) {
	var M;
	let { node: n, parent: s, grandparent: u, key: i } = e, a = i !== "body" && (s.type === "IfStatement" || s.type === "WhileStatement" || s.type === "SwitchStatement" || s.type === "DoWhileStatement"), o = n.operator === "|>" && ((M = e.root.extra) == null ? void 0 : M.__isUsingHackPipeline), p = As(e, t, r, !1, a);
	if (a) return p;
	if (o) return l(p);
...
function As(e, t, r, n, s) {
	...
	if (!Fe(u)) return [l(r())];
	let i = [];
	ar(u.operator, u.left.operator) ? i = e.call((g) => As(g, t, r, !0, s), "left") : i.push(l(r("left")));
	let a = Ht(u), o = (u.operator === "|>" || u.type === "NGPipeExpression" || Wc(e, t)) && !de(t.originalText, u.right), m = !d(u.right, h.Leading, Gr) && de(t.originalText, u.right), f = u.type === "NGPipeExpression" ? "|" : u.operator, y = u.type === "NGPipeExpression" && u.arguments.length > 0 ? l(D([
		E,
		": ",
		b([x, ": "], e.map(() => be(2, l(r())), "arguments"))
	])) : "", C;
	if (a) C = [f, de(t.originalText, u.right) ? D([
		x,
		r("right"),
		y
	]) : [
		...
		let _ = f === "|>" && ((B = e.root.extra) == null ? void 0 : B.__isUsingHackPipeline) ? e.call((M) => As(M, t, r, !0, s), "right") : r("right");
...
function Ht(e) {
	return e.type !== "LogicalExpression" ? !1 : !!(ue(e.right) && e.right.properties.length > 0 || U(e.right) && e.right.elements.length > 0 || Y(e.right));
}
...
function Li(e, t, r) {
	...
	if (n.type.startsWith("NG")) switch (n.type) {
		case "NGRoot": return [r("node"), d(n.node) ? " //" + Ve(n.node)[0].value.trimEnd() : ""];
		case "NGPipeExpression": return $r(e, t, r);
		case "NGChainedExpression": return l(b([";", x], e.map(() => Yc(e) ? r() : [
			"(",
			r(),
			")"
		], "expressions")));
		case "NGEmptyExpression": return "";
		case "NGMicrosyntax": return e.map(() => [e.isFirst ? "" : Ii(e) ? " " : [";", x], r()], "body");
...
function Hc(e, t, r) {
	...
	if (n.type === "TSImportType" && s.length === 1 && (s[0].type === "TSLiteralType" && K(s[0].literal) || K(s[0])) && !d(s[0])) return l([
		"(",
		...a,
		S(o),
		")"
...
function Dr(e, t = !1) {
	return ue(e) && (e.properties.length > 0 || d(e)) || U(e) && (e.elements.length > 0 || d(e)) || e.type === "TSTypeAssertion" && Dr(e.expression) || xe(e) && Dr(e.expression) || e.type === "FunctionExpression" || e.type === "ArrowFunctionExpression" && (!e.returnType || !e.returnType.typeAnnotation || e.returnType.typeAnnotation.type !== "TSTypeReference" || Qc(e.body)) && (e.body.type === "BlockStatement" || e.body.type === "ArrowFunctionExpression" && Dr(e.body, !0) || ue(e.body) || U(e.body) || !t && (w(e.body) || e.body.type === "ConditionalExpression") || Y(e.body)) || e.type === "DoExpression" || e.type === "ModuleExpression";
}
function Vc(e, t, r) {
	var u, i;
	let n = v(!1, e, -1);
...
function $c(e) {
	...
	let [t, r] = e;
	return t.type === "ModuleExpression" && zc(r) ? !0 : !d(t) && (t.type === "FunctionExpression" || t.type === "ArrowFunctionExpression" && t.body.type === "BlockStatement") && r.type !== "FunctionExpression" && r.type !== "ArrowFunctionExpression" && r.type !== "ConditionalExpression" && ji(r) && !Dr(r);
}
function ji(e) {
	...
	return yt(e) && le(e).length > 1 ? !1 : Fe(e) ? we(e.left, 1) && we(e.right, 1) : Jn(e) || we(e);
}
function Kc(e) {
...
function zc(e) {
	...
	let [t] = e.properties;
	return Te(t) ? !t.computed && (t.key.type === "Identifier" && t.key.name === "type" || K(t.key) && t.key.value === "type") && K(t.value) && t.value.value === "module" : !1;
}
var Lt = Hc;
...
function xs(e, t, r) {
	...
	return s.computed ? !s.property || ye(s.property) ? [
		u,
		"[",
		n,
		"]"
...
function Ji(e, t, r) {
	...
	function i() {
		...
		}), e.call(i, "object")) : L.type === "TSNonNullExpression" ? (s.unshift({
			node: L,
			printed: Ee(e, "!", t)
		}), e.call(i, "expression")) : s.unshift({
			node: L,
			printed: r()
		});
	}
	...
	for (; m < s.length; ++m) {
		...
		(w(s[m].node) || s[m].node.type === "ImportExpression") && (f = !0), p.push(s[m]), d(s[m].node, h.Trailing) && (o.push(p), p = [], f = !1);
	}
	p.length > 0 && o.push(p);
	function y(L) {
	...
	function T(L) {
		...
		return L.length > 0 && v(!1, L, -1).needsParens ? [
			"(",
			...se,
			")"
		] : se;
	...
	if (o.length <= M && !I && !o.some((L) => v(!1, L, -1).hasTrailingEmptyLine)) return vr(e) ? _ : l(_);
	let q = v(!1, o[A ? 1 : 0], -1).node, k = !w(q) && u(q), W = [
		T(o[0]),
		A ? o.slice(1, 2).map(T) : "",
		k ? F : "",
		B(o.slice(A ? 2 : 1))
	...
	function Z() {
		let L = v(!1, v(!1, o, -1), -1).node, se = v(!1, g, -1);
		return w(L) && re(se) && ne.slice(0, -1).some((Ae) => Ae.arguments.some(Rt));
	}
	let lt;
	return I || ne.length > 2 && ne.some((L) => !L.arguments.every((se) => we(se))) || g.slice(0, -1).some(re) || Z() ? lt = l(W) : lt = [re(_) || k ? Ce : "", tt([_, W])], at({ memberChain: !0 }, lt);
}
var Ni = Ji;
function Qr(e, t, r) {
	var m;
	...
	if (o || el(e) || Pt(n, e.parent)) {
		...
		if (Gt(e, () => {
			f.push(r());
		}), !(o && (m = f[0].label) != null && m.embed)) return [
			s ? "new " : "",
			Gi(e, r),
			i,
			rt(e, t, r),
...
function el(e) {
	...
	let r = le(t);
	return t.callee.name === "require" ? r.length === 1 && K(r[0]) || r.length > 1 : t.callee.name === "define" && e.parent.type === "ExpressionStatement" ? r.length === 1 || r.length === 2 && r[0].type === "ArrayExpression" || r.length === 3 && K(r[0]) && r[1].type === "ArrayExpression" : !1;
}
...
function rl(e, t, r, n) {
	...
	switch (s.type) {
		...
		case "ClassExpression": return O(s.decorators);
	}
	if (n) return !1;
	let u = s, i = [];
...
function Yi(e, t, r, n = !1) {
	...
	if (w(s)) {
		...
		let o = le(s);
		return !(o.length === 0 || o.length === 1 && ir(o[0], t)) || cl(s, r) ? !1 : e.call(u, "callee");
	}
...
function Ue(e, t, r, n, s) {
	...
	if (i.length === 0) return [
		a,
		"(",
		N(e, t, { filter: (c) => ke(t.originalText, P(c)) === ")" }),
		")"
	];
	...
	return m && y ? [
		...
		...f,
		")"
	] : (Or(o) || Eu(o) || o.type === "TypeAlias" || o.type === "UnionTypeAnnotation" || o.type === "IntersectionTypeAnnotation" || o.type === "FunctionTypeAnnotation" && o.returnType === u) && i.length === 1 && i[0].name === null && u.this !== i[0] && i[0].typeAnnotation && u.typeParameters === null && Nt(i[0].typeAnnotation) && !u.rest ? t.arrowParens === "always" || u.type === "HookTypeAnnotation" ? [
		"(",
		...f,
		")"
	] : f : [
...
function en(e, t, r) {
	...
	return l(e.map(({ isFirst: s, previous: u, node: i, index: a }) => {
		...
		if (s) return o;
		let p = Re(i), m = Re(u);
		return m && p ? [" & ", n ? D(o) : o] : !m && !p || de(t.originalText, i) ? t.experimentalOperatorPosition === "start" ? D([
			x,
			"& ",
			o
		]) : D([
...
function Kt(e, t, r) {
	...
	if (o.length === 0) s.push(xl(e, t, u, i));
		...
		let p = v(!1, o, -1), m = (p == null ? void 0 : p.type) !== "RestElement" && !n.inexact, f = p === null, y = Symbol("array"), C = !t.__inJestEach && o.length > 1 && o.every((T, B, g) => {
		...
		s.push(l([
			...
			D([
				E,
				c ? gl(e, t, r, A) : [hl(e, t, r, a, n.inexact), A],
				N(e, t)
			]),
			E,
			i
...
function Ts(e, t) {
	return U(e) && e.elements.length > 1 && e.elements.every((r) => r && (ye(r) || Rn(r) && !d(r.argument)) && !d(r, h.Trailing | h.Line, (n) => !ee(t.originalText, j(n), { backwards: !0 })));
}
...
function zi(e, t) {
	return t.parser === "json" || t.parser === "jsonc" || !K(e.key) || ut(ae(e.key), t).slice(1, -1) !== e.key.value ? !1 : !!(Qi(e.key.value) && !(t.parser === "babel-ts" && e.type === "ClassProperty" || (t.parser === "typescript" || t.parser === "oxc-ts") && e.type === "PropertyDefinition") || Zi(e.key.value) && String(Number(e.key.value)) === e.key.value && e.type !== "ImportAttribute" && (t.parser === "babel" || t.parser === "acorn" || t.parser === "oxc" || t.parser === "espree" || t.parser === "meriyah" || t.parser === "__babel_estree"));
}
function Pl(e, t) {
	let { key: r } = e.node;
...
function En(e, t, r, n) {
	...
	if ((s.type === "FunctionDeclaration" || s.type === "FunctionExpression") && n != null && n.expandLastArg) {
		let { parent: m } = e;
		w(m) && (le(m).length > 1 || Q(s).every((f) => f.type === "Identifier" && !f.typeAnnotation)) && (u = !0);
	}
	let i = [
		$(e),
		s.async ? "async " : "",
		...
		s.id ? r("id") : ""
	], a = Ue(e, t, r, u), o = Qt(e, r), p = ct(s, o);
...
function Fn(e, t, r) {
	let { node: n } = e, s = Ue(e, t, r), u = Qt(e, r), i = Hi(n), a = ct(n, u), o = [rt(e, t, r), l([i ? l(s, { shouldBreak: !0 }) : a ? l(s) : s, u])];
...
function ea(e, t, r) {
	...
	if (n.argument) {
		...
		Ll(t, n.argument) ? o = [
			...
			F,
			")"
		] : (Fe(n.argument) || t.experimentalTernaries && n.argument.type === "ConditionalExpression" && (n.argument.consequent.type === "ConditionalExpression" || n.argument.alternate.type === "ConditionalExpression")) && (o = l([
			S("("),
			D([E, o]),
			E,
			S(")")
...
function Ll(e, t) {
	if (de(e.originalText, t) || d(t, h.Leading, (r) => ie(e.originalText, j(r), P(r))) && !Y(t)) return !0;
	if (Jt(t)) {
		let r = t, n;
...
function sa(e, t, r, n = {}) {
	...
	let m = !de(t.originalText, p) && (wl(p) || _l(p, u, t) || !a && na(p)), f = e.key === "callee" && yt(e.parent), y = Symbol("arrow-chain"), C = Ml(e, n, {
		signatureDocs: s,
		shouldBreak: a
	}), c = !1, A = !1, T = !1;
	return o && (f || n.assignmentLayout) && (A = !0, T = !d(e.node, h.Leading & h.Line), c = n.assignmentLayout === "chain-tail-arrow-chain" || f && !m), u = vl(e, t, n, {
		bodyDoc: u,
		bodyComments: i,
		functionBody: p,
...
function _l(e, t, r) {
	var n, s;
	return U(e) || ue(e) || e.type === "ArrowFunctionExpression" || e.type === "DoExpression" || e.type === "BlockStatement" || Y(e) || ((n = t.label) == null ? void 0 : n.hug) !== !1 && (((s = t.label) == null ? void 0 : s.embed) || _r(e, r.originalText));
}
function Ml(e, t, { signatureDocs: r, shouldBreak: n }) {
	if (r.length === 1) return r[0];
	let { parent: s, key: u } = e;
	return u !== "callee" && yt(s) || Fe(s) ? l([
		r[0],
		" =>",
		D([x, b([" =>", x], r.slice(1))])
	], { shouldBreak: n }) : u === "callee" && yt(s) || t.assignmentLayout ? l(b([" =>", x], r), { shouldBreak: n }) : l(D(b([" =>", x], r)), { shouldBreak: n });
}
...
function Fr(e, t, r, n) {
	let { node: s } = e, u = [], i = ua(!1, s[n], (a) => a.type !== "EmptyStatement");
...
function Rl(e, t, r) {
	...
	if (!s && !u && !i) return "";
	let a = [];
	return s && (a.push(Fr(e, t, r, "directives")), (u || i) && (a.push(F), me(v(!1, n.directives, -1), t) && a.push(F))), u && a.push(Fr(e, t, r, "body")), i && a.push(N(e, t)), a;
}
function Jl(e) {
...
function wt(e, t, r, n) {
	...
	if (s[n].length === 0 || !i && (u || s[n].length === 1 && (s[n][0].type === "NullableTypeAnnotation" || Ss(s[n][0])))) return [
		"<",
		b(", ", e.map(r, n)),
		Gl(e, t),
		">"
...
function xn(e, t, r) {
	let { node: n } = e, s = [
		...
		Vt(e),
		"class"
	], u = d(n.id, h.Trailing) || d(n.typeParameters, h.Trailing) || d(n.superClass) || O(n.extends) || O(n.mixins) || O(n.implements), i = [], a = [];
...
function Wl(e, t, r) {
	...
	return s.type === "AssignmentExpression" ? l(S([
		"(",
		D([E, n]),
		E,
		")"
...
function ca(e, t, r) {
	...
	}, "body"), d(n, h.Dangling) && s.push(N(e, t)), [
		"{",
		s.length > 0 ? [D([F, s]), F] : "",
		"}"
	];
...
function Aa(e, t) {
	let { node: r } = e;
	switch (r.type) {
		case "RegExpLiteral": return Fa(r);
		case "BigIntLiteral": return Sn(r.extra.raw);
		case "NumericLiteral": return Ft(r.extra.raw);
		case "StringLiteral": return ve(ut(r.extra.raw, t));
		case "NullLiteral": return "null";
		case "BooleanLiteral": return String(r.value);
		case "DirectiveLiteral": return Ca(r.extra.raw, t);
		case "Literal": {
...
function ha(e, t, r) {
	...
	if (O(n.specifiers)) {
		...
		}, "specifiers"), s.push(b(", ", u)), i.length > 0 && (u.length > 0 && s.push(", "), i.length > 1 || u.length > 0 || n.specifiers.some((o) => d(o)) ? s.push(l([
			"{",
...
function ga(e, t) {
	return e.type !== "ImportDeclaration" || O(e.specifiers) || e.importKind === "type" ? !0 : Ar(t, j(e), j(e.source)).trimEnd().endsWith("from");
}
function Ql(e, t) {
	var n, s;
...
function Ba(e, t, r) {
	...
	return s === "ExportNamespaceSpecifier" || s === "ImportNamespaceSpecifier" ? m = "*" : o && (m = r(i)), p && !zl(n) && (f = r(a)), [
		ws(s === "ImportSpecifier" ? n.importKind : n.exportKind, !1),
		m,
		m && f ? " as " : "",
		f
	];
...
function gt(e, t, r) {
	...
	let o = a.flatMap((I) => e.map(({ node: q }) => ({
		node: q,
		printed: r(),
		loc: j(q)
	}), I));
	...
	if (s.inexact || s.hasUnknownMembers) {
		...
		if (d(s, h.Dangling)) {
			...
			I = [
				N(e, t),
				q || ee(t.originalText, P(v(!1, Ve(s), -1))) ? F : x,
				"..."
			];
		} else I = ["..."];
		B.push([...T, ...I]);
	}
	let g = (J = v(!1, o, -1)) == null ? void 0 : J.node, _ = !(s.inexact || s.hasUnknownMembers || g && (g.type === "RestElement" || (g.type === "TSPropertySignature" || g.type === "TSCallSignatureDeclaration" || g.type === "TSMethodSignature" || g.type === "TSConstructSignatureDeclaration" || g.type === "TSIndexSignature") && d(g, h.PrettierIgnore)) || e.match(void 0, (I, q) => I.type === "TSImportType" && q === "options")), M;
	if (B.length === 0) {
		if (!d(s, h.Dangling)) return [
			c,
			A,
			H(e, r)
		];
...
function ba(e, t, r) {
	let { node: n } = e, s = n.type === "ConditionalExpression", u = s ? "consequent" : "trueType", i = s ? "alternate" : "falseType", a = s ? ["test"] : ["checkType", "extendsType"], o = n[u], p = n[i], m = [], f = !1, { parent: y } = e, C = y.type === n.type && a.some((W) => y[W] === n), c = y.type === n.type && !C, A, T, B = 0;
	do
	...
	if (s && (Y(n[a[0]]) || Y(o) || Y(p) || Zl(_))) {
		...
		let W = (Z) => [
			...
			E,
			S(")")
		], ne = (Z) => Z.type === "NullLiteral" || Z.type === "Literal" && Z.value === null || Z.type === "Identifier" && Z.name === "undefined";
		m.push(" ? ", ne(o) ? r(u) : W(r(u)), " : ", p.type === n.type || ne(p) ? r(i) : W(r(i)));
	} else {
		let W = (Z) => t.useTabs ? D(r(Z)) : be(2, r(Z)), ne = [
			x,
			"? ",
			o.type === n.type ? S("", "(") : "",
			W(u),
	...
	let M = [
		...
		i,
		...a
	].some((W) => d(n[W], (ne) => te(ne) && ie(t.originalText, j(ne), P(ne)))), J = (W) => y === g ? l(W, { shouldBreak: M }) : M ? [W, Ce] : W, I = !f && (G(y) || y.type === "NGPipeExpression" && y.left === n) && !y.computed, q = rm(e), k = J([
		em(e, t, r),
		c ? m : D(m),
		s && I && !q ? E : ""
	]);
...
function sm(e, t, r, n) {
	return [
		...
		Ve(t),
		Ve(r)
	].flat().some((u) => te(u) && ie(n.originalText, j(u), P(u)));
}
var um = new Map([
	["AssignmentExpression", "right"],
	["VariableDeclarator", "init"],
...
function zt(e, t, r, n) {
	...
	let Gs = Symbol("test"), Va = Symbol("consequent"), dr = Symbol("test-and-consequent"), qs = l([u ? [Ms(r("test")), s.test.type === "ConditionalExpression" ? Ce : ""] : [
		...
		Ns,
		Ka
	]), Qa = Js ? l([qs, _ ? Tr : S(Tr, l(Tr, { id: Va }), { groupId: Gs })], { id: dr }) : [qs, Tr], wn = r(o), Ws = nt ? S(wn, Jr(Ms(wn)), { groupId: dr }) : wn, tr = [
		Qa,
		er.length > 0 ? [D([F, er]), F] : g ? F : nt ? S(x, " ", { groupId: dr }) : x,
		":",
		g ? " " : M ? Js ? S(Ae, S(_ || nt ? " " : Ae, " "), { groupId: dr }) : S(Ae, " ") : " ",
		g ? Ws : l([D(Ws), Z && !nt ? E : ""]),
		L && !lt ? E : "",
		Ot ? Ce : ""
	];
...
function Pa(e, t, r, n) {
	...
	switch (s.type) {
		...
		case "File": return Ea(e, t, r) ?? r("program");
		case "EmptyStatement": return "";
		case "ExpressionStatement": return Da(e, t, r);
		case "ChainExpression": return r("expression");
		case "ParenthesizedExpression": return !d(s.expression) && (ue(s.expression) || U(s.expression)) ? [
			"(",
			r("expression"),
			")"
		] : l([
		...
		case "VariableDeclarator": return Ui(e, t, r);
		case "BinaryExpression":
		case "LogicalExpression": return $r(e, t, r);
		...
		case "OptionalMemberExpression":
		case "MemberExpression": return Ri(e, t, r);
		case "MetaProperty": return [
			r("meta"),
			".",
			r("property")
		];
		case "BindExpression": return s.object && i.push(r("object")), i.push(l(D([E, Kr(e, t, r)]))), i;
		...
		case "RestElement": return yn(e, r);
		case "FunctionDeclaration":
		case "FunctionExpression": return En(e, t, r, n);
		case "ArrowFunctionExpression": return sa(e, t, r, n);
		...
		case "ExportDefaultDeclaration":
		case "ExportNamedDeclaration":
		case "ExportAllDeclaration": return Bn(e, t, r);
		case "ImportDeclaration": return da(e, t, r);
		case "ImportSpecifier":
		case "ExportSpecifier":
		case "ImportNamespaceSpecifier":
		case "ExportNamespaceSpecifier":
		case "ImportDefaultSpecifier":
		case "ExportDefaultSpecifier": return Ba(e, t, r);
		case "ImportAttribute": return Dn(e, t, r);
		case "Program":
		case "BlockStatement":
		case "StaticBlock": return An(e, t, r);
		case "ClassBody": return ca(e, t, r);
		case "ThrowStatement": return ra(e, t, r);
		case "ReturnStatement": return ta(e, t, r);
		case "NewExpression":
		case "ImportExpression":
		case "OptionalCallExpression":
		case "CallExpression": return Qr(e, t, r);
		case "ObjectExpression":
		case "ObjectPattern": return gt(e, t, r);
		case "Property": return bt(s) ? Er(e, t, r) : Dn(e, t, r);
		case "ObjectProperty": return Dn(e, t, r);
		case "ObjectMethod": return Er(e, t, r);
		case "Decorator": return ["@", r("expression")];
		case "ArrayExpression":
		case "ArrayPattern": return Kt(e, t, r);
		...
		case "ConditionalExpression": return zt(e, t, r, n);
		case "VariableDeclaration": {
			...
			return a.length === 1 && !d(s.declarations[0]) ? f = a[0] : a.length > 0 && (f = D(a[0])), i = [
				$(e),
				s.kind,
				f ? [" ", f] : "",
				D(a.slice(1).map((y) => [
		...
		case "IfStatement": {
			let a = Et(s.consequent, r("consequent")), o = l([
				"if (",
				l([D([E, r("test")]), E]),
				")",
				a
		...
		case "ForStatement": {
			...
			return !s.init && !s.test && !s.update ? [p, l(["for (;;)", a])] : [p, l([
				"for (",
				l([D([
					E,
					r("init"),
		...
		case "CatchClause":
			if (s.param) {
				let a = d(s.param, (p) => !te(p) || p.leading && ee(t.originalText, P(p)) || p.trailing && ee(t.originalText, j(p), { backwards: !0 })), o = r("param");
				return [
					"catch ",
					a ? [
						"(",
		...
		case "SwitchStatement": return [
			...
			" {",
			s.cases.length > 0 ? D([F, b(F, e.map(({ node: a, isLast: o }) => [r(), !o && me(a, t) ? F : ""], "cases"))]) : "",
			F,
			"}"
		];
		case "SwitchCase": {
		...
		case "ClassDeclaration":
		case "ClassExpression": return xn(e, t, r);
		case "ClassMethod":
		case "ClassPrivateMethod":
		...
		case "AccessorProperty": return gn(e, t, r);
		case "TemplateElement": return ve(s.value.raw);
		case "TemplateLiteral": return Wr(e, t, r);
		case "TaggedTemplateExpression": return Zu(e, t, r);
...
function am(e, t, r) {
	...
	if (n.rest && (s = [...s, n.rest]), s.length === 0) return [
		"(",
		N(e, t, { filter: (i) => ke(t.originalText, P(i)) === ")" }),
		")"
	];
	let u = [];
	return pm(e, (i, a) => {
...
function Oa(e, t, r) {
	let { node: n } = e, s = ["hook"];
	n.id && s.push(" ", r("id"));
	let u = Ue(e, t, r, !1, !0), i = Qt(e, r), a = ct(n, i);
...
function Ja(e, t, r) {
	...
	switch (n.type) {
		...
		case "ComponentTypeAnnotation": return ka(e, t, r);
		case "ComponentParameter": return Ia(e, t, r);
		case "ComponentTypeParameter": return La(e, t, r);
		case "HookDeclaration": return Oa(e, t, r);
		case "DeclareHook": return _a(e, t, r);
		case "HookTypeAnnotation": return Ma(e, t, r);
		case "DeclareClass": return xn(e, t, r);
		...
		case "DeclareExportAllDeclaration": return Bn(e, t, r);
		case "DeclareOpaqueType":
		case "OpaqueType": return Vi(e, t, r);
		case "DeclareTypeAlias":
		case "TypeAlias": return Zr(e, t, r);
		case "IntersectionTypeAnnotation": return en(e, t, r);
		case "UnionTypeAnnotation": return tn(e, t, r);
		case "ConditionalTypeAnnotation": return zt(e, t, r);
		case "InferTypeAnnotation": return sn(e, t, r);
		case "FunctionTypeAnnotation": return rn(e, t, r);
		case "TupleTypeAnnotation": return Kt(e, t, r);
		case "TupleTypeLabeledElement": return an(e, t, r);
		case "TupleTypeSpreadElement": return un(e, t, r);
		case "GenericTypeAnnotation": return [r("id"), wt(e, t, r, "typeParameters")];
		case "IndexedAccessType":
		case "OptionalIndexedAccessType": return nn(e, t, r);
		case "TypeAnnotation": return on(e, t, r);
		case "TypeParameter": return Tn(e, t, r);
		case "TypeofTypeAnnotation": return cn(e, r);
		case "ExistsTypeAnnotation": return "*";
		case "ArrayTypeAnnotation": return pn(r);
		case "DeclareEnum":
		case "EnumDeclaration": return In(e, r);
		case "EnumBooleanBody":
		case "EnumNumberBody":
		case "EnumBigIntBody":
		case "EnumStringBody":
		case "EnumSymbolBody": return [n.type === "EnumSymbolBody" || n.explicitType ? `of ${n.type.slice(4, -4).toLowerCase()} ` : "", Pn(e, t, r)];
		case "EnumBooleanMember":
		case "EnumNumberMember":
		case "EnumBigIntMember":
		case "EnumStringMember":
		case "EnumDefaultedMember": return kn(e, r);
		...
		case "InterfaceTypeAnnotation": return Ln(e, t, r);
		...
		case "ObjectTypeMappedTypeProperty": return ja(e, t, r);
		...
		case "ObjectTypeAnnotation": return gt(e, t, r);
		...
		case "ObjectTypeSpreadProperty": return yn(e, r);
		...
		case "StringLiteralTypeAnnotation": return ve(ut(ae(n), t));
		case "NumberLiteralTypeAnnotation": return Ft(ae(n));
		case "BigIntLiteralTypeAnnotation": return Sn(ae(n));
		...
		case "TypePredicate": return ln(e, r);
		...
		case "TypeParameterInstantiation": return wt(e, t, r, "params");
		...
		case "AsExpression":
		case "AsConstExpression":
		case "SatisfiesExpression": return bn(e, t, r);
	}
}
function Na(e, t, r) {
	var i;
	...
	switch (n.type) {
		...
		case "TSTypeAssertion": {
			let a = !(U(n.expression) || ue(n.expression)), o = l([
				"<",
				D([E, r("typeAnnotation")]),
				E,
				">"
			]), p = [
				S("("),
		...
		case "TSDeclareFunction": return En(e, t, r);
		case "TSExportAssignment": return [
			"export = ",
			r("expression"),
			s
		];
		case "TSModuleBlock": return An(e, t, r);
		case "TSInterfaceBody":
		case "TSTypeLiteral": return gt(e, t, r);
		case "TSTypeAliasDeclaration": return Zr(e, t, r);
		...
		case "TSAbstractAccessorProperty":
		case "TSAbstractPropertyDefinition": return gn(e, t, r);
		case "TSInterfaceHeritage":
		case "TSClassImplements":
		case "TSExpressionWithTypeArguments":
		case "TSInstantiationExpression": return [r("expression"), r(n.typeArguments ? "typeArguments" : "typeParameters")];
		case "TSTemplateLiteralType": return Wr(e, t, r);
		case "TSNamedTupleMember": return an(e, t, r);
		case "TSRestType": return un(e, t, r);
		case "TSOptionalType": return [r("typeAnnotation"), "?"];
		case "TSInterfaceDeclaration": return Ln(e, t, r);
		case "TSTypeParameterDeclaration":
		case "TSTypeParameterInstantiation": return wt(e, t, r, "params");
		case "TSTypeParameter": return Tn(e, t, r);
		case "TSAsExpression":
		case "TSSatisfiesExpression": return bn(e, t, r);
		case "TSArrayType": return pn(r);
		...
		case "TSTypeQuery": return cn(e, r);
		case "TSIndexSignature": {
			let a = n.parameters.length > 1 ? S(ce(t) ? "," : "") : "", o = l([
				D([E, b([", ", E], e.map(r, "parameters"))]),
				a,
				E
		...
		case "TSTypePredicate": return ln(e, r);
		...
		case "TSIndexedAccessType": return nn(e, t, r);
		case "TSTypeOperator": return [
			n.operator,
			" ",
			r("typeAnnotation")
		];
		case "TSMappedType": return Ra(e, t, r);
		case "TSMethodSignature": {
			let a = n.kind && n.kind !== "method" ? `${n.kind} ` : "";
			u.push($t(n), a, n.computed ? "[" : "", r("key"), n.computed ? "]" : "", V(e));
			let o = Ue(e, t, r, !1, !0), p = n.returnType ? "returnType" : "typeAnnotation", m = n[p], f = m ? H(e, r, p) : "", y = ct(n, f);
		...
		case "TSEnumDeclaration": return In(e, r);
		case "TSEnumBody": return Pn(e, t, r);
		case "TSEnumMember": return kn(e, r);
		...
		case "TSConditionalType": return zt(e, t, r);
		case "TSInferType": return sn(e, t, r);
		case "TSIntersectionType": return en(e, t, r);
		case "TSUnionType": return tn(e, t, r);
		case "TSFunctionType":
		case "TSCallSignatureDeclaration":
		case "TSConstructorType":
		case "TSConstructSignatureDeclaration": return rn(e, t, r);
		case "TSTupleType": return Kt(e, t, r);
		case "TSTypeReference": return [r("typeName"), wt(e, t, r, n.typeArguments ? "typeArguments" : "typeParameters")];
		case "TSTypeAnnotation": return on(e, t, r);
		case "TSEmptyBodyFunctionExpression": return Fn(e, t, r);
		case "TSJSDocAllType": return "*";
		case "TSJSDocUnknownType": return "?";
		case "TSJSDocNullableType": return Bs(e, r, "?");
		case "TSJSDocNonNullableType": return Bs(e, r, "!");
...
function Fm(e, t, r) {
	...
	switch (n.type) {
		...
		case "NumericLiteral": return Xa(e) ? JSON.stringify(String(n.value)) : JSON.stringify(n.value);
		case "Identifier": return Xa(e) ? JSON.stringify(n.name) : n.name;
...
var NDVEmptyState_vue_vue_type_style_index_0_lang_module_default = {
	empty: "_empty_1ls5r_2",
	title: "_title_1ls5r_13",
	actions: "_actions_1ls5r_21",
	description: "_description_1ls5r_25",
	wide: "_wide_1ls5r_32"
};
var NDVEmptyState_default = /* @__PURE__ */ _plugin_vue_export_helper_default(NDVEmptyState_vue_vue_type_script_setup_true_lang_default, [["__cssModules", { "$style": NDVEmptyState_vue_vue_type_style_index_0_lang_module_default }]]);
//#endregion
export { cu$1 as a, Vo$1 as i, Nx as n, fu$1 as o, estree_exports as r, NDVEmptyState_default as t };
