;
(function () {
  System.register(["./chunk-legacy-Re9CbdfL.js", "./vue.runtime.esm-bundler-legacy--Sn1h8On.js", "./_MapCache-legacy-BH2XE3uj.js", "./src-legacy-B1x3MtI4.js", "./_plugin-vue_export-helper-legacy-DZMI5HPp.js", "./truncate-legacy-D4G74xLD.js", "./useMessage-legacy-BVhJ9mJi.js", "./useTelemetry-legacy-CMfwYwVY.js", "./useToast-legacy-DHnOnoVM.js", "./constants-legacy-8iZaMHMx.js", "./_baseOrderBy-legacy-Bls-fMH1.js", "./useDebounce-legacy-10Dbxu_b.js", "./cloudPlan.store-legacy-CEK8KIVd.js", "./useWorkflowSaving-legacy-DzdfQKOS.js", "./executions.store-legacy-CXtma6rH.js", "./useRunWorkflow-legacy-Dump6bie.js", "./useCanvasOperations-legacy-DxrVUT4V.js", "./folders.store-legacy-DJrFkFJV.js", "./NodeIcon-legacy-sx-yHw-D.js", "./usePageRedirectionHelper-legacy-D_zw1zhe.js", "./dataTable.store-legacy-BRb3lT3Y.js", "./uniqBy-legacy-Domt9vuU.js", "./ProjectIcon-legacy-B4jeWa5m.js", "./CredentialIcon-legacy-ChsiY_QH.js", "./FileSaver.min-legacy-D7uxxng5.js", "./sortByProperty-legacy-Cr1t4fIx.js", "./useRecentResources-legacy-Dewya4fr.js"], function (_export, _context) {
    "use strict";

    var __toESM, computed, toDisplayString, createElementBlock, createCommentVNode, unref, ref, createVNode, defineComponent, createBlock, openBlock, createTextVNode, normalizeClass, createBaseVNode, useI18n, updatedIconSet, N8nIcon_default, useDeviceSupport, N8nKeyboardShortcut_default, __plugin_vue_export_helper_default, useRouter, useRoute, useMessage, useSourceControlStore, useProjectsStore, useUIStore, useCredentialsStore, nodeViewEventBus, ProjectTypes, executionRetryMessage, useSettingsStore, useTagsStore, useNodeTypesStore, usePostHog, useWorkflowHelpers, useWorkflowsStore, useActionsGenerator, useTelemetry, useToast, DUPLICATE_MODAL_KEY, DATA_TABLE_VIEW, DATA_TABLE_DETAILS, IMPORT_WORKFLOW_URL_MODAL_KEY, VIEWS, isResourceLocatorValue, PROJECT_DATA_TABLES, WORKFLOW_SETTINGS_MODAL_KEY, WHATS_NEW_MODAL_KEY, getResourcePermissions, COMMAND_BAR_EXPERIMENT, MODAL_CONFIRM, EXECUTE_WORKFLOW_NODE_TYPE, EnterpriseEditionFeature, ABOUT_MODAL_KEY, useRootStore, require_debounce, useCloudPlanStore, useWorkflowSaving, useExecutionsStore, useRunWorkflow, canvasEventBus, useCanvasOperations, useFoldersStore, NodeIcon_default, usePageRedirectionHelper, useDataTableStore, require_uniqBy, isIconOrEmoji, ProjectIcon_default, CredentialIcon_default, require_FileSaver_min, sortByProperty, useRecentResources, __vite_style__, CommandBarItemTitle_vue_vue_type_script_setup_true_lang_default, container, title, suffix, action, shortcut, CommandBarItemTitle_vue_vue_type_style_index_0_lang_module_default, cssModules, CommandBarItemTitle_default, ITEM_ID$7, import_FileSaver_min, import_uniqBy, ITEM_ID$6, import_debounce$2, ITEM_ID$5, import_debounce$1, ITEM_ID$4, import_debounce, ITEM_ID$3, isIconName, isProjectIcon, useGlobalEntityCreation, ITEM_ID$2, ITEM_ID$1, EXTERNAL_LINKS, BASE_FORUM_URL, REPORT_TEMPLATE, ITEM_ID;
    ...
    function useWorkflowCommands() {
      ...
      const canvasActions = computed(() => [...(hasPermission("update") && !isArchived.value ? [...(!isWorkflowSaving.value ? [{
        ...
        id: ITEM_ID$6.UNPUBLISH_WORKFLOW,
      ...
      const workflowCommands = computed(() => {
        return [...canvasActions.value, ...subworkflowCommands.value, ...exportCommands.value, ...importCommands.value, ...lifecycleCommands.value];
      });
      return {
    ...
    return {
      setters: [function (_chunkLegacy001Js) {
        ...
        WHATS_NEW_MODAL_KEY = _constantsLegacy00TJs.ds;
        getResourcePermissions = _constantsLegacy00TJs.ko;
        COMMAND_BAR_EXPERIMENT = _constantsLegacy00TJs.oc;
        MODAL_CONFIRM = _constantsLegacy00TJs.rs;
        EXECUTE_WORKFLOW_NODE_TYPE = _constantsLegacy00TJs.sn;
      ...
      }, function (_sortByPropertyLegacy031Js) {
        sortByProperty = _sortByPropertyLegacy031Js.t;
      ...
      execute: function () {
        ...
        _export("i", useGlobalEntityCreation = () => {
