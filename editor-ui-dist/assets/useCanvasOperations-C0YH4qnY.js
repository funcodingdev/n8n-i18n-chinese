...
import { $ as openBlock, A as createTextVNode, C as createBaseVNode, Cn as toDisplayString, E as createElementBlock, Gt as unref, I as h, It as ref, Lt as shallowReactive, N as defineComponent, R as inject, S as computed, T as createCommentVNode, U as mergeProps, Ut as toValue, W as nextTick, _ as Fragment, bt as withCtx, it as renderSlot, j as createVNode, jt as isRef, rt as renderList, st as resolveDynamicComponent, vn as normalizeClass, w as createBlock, zt as shallowRef } from "./vue.runtime.esm-bundler-DYHsQBZB.js";
import { s as useI18n$1 } from "./src-CQvTTRwX.js";
import { t as _plugin_vue_export_helper_default } from "./_plugin-vue_export-helper-D-F0WtqU.js";
import { b as useLocalStorage, u as useClipboard } from "./dist-CYNfKCbA.js";
import { t as require_markdown_it_link_attributes } from "./markdown-it-link-attributes-BC3Hu7Xj.js";
import { t as useBuilderStore } from "./builder.store-6WojTPsK.js";
import { t as useMessage } from "./useMessage-CMftD8l5.js";
import { c as useRoute, l as useRouter } from "./vue-router-D2dKRIiV.js";
import { A as useWorkflowDocumentStore, B as require_uniq, Dr as mapLegacyConnectionToCanvasConnection, Er as mapCanvasConnectionToLegacyConnection, Et as useCredentialsStore, Fr as CONFIGURATION_NODE_SIZE, Gn as getAllNodeCredentialForAuthType, H as useNodeTypesStore, Hr as generateOffsets, Ir as DEFAULT_NODE_SIZE, It as useDataSchema, Lr as DEFAULT_VIEWPORT_BOUNDARIES, Nr as AGENT_NODE_SIZE, O as injectWorkflowDocumentStore, Or as mapLegacyConnectionsToCanvasConnections, Pr as CONFIGURABLE_NODE_SIZE, Qi as CanvasNodeRenderType, R as serializeNode, Rr as HORIZONTAL_NODE_STEP, T as createWorkflowDocumentId, Ui as isValidNodeConnectionType, V as isAgentNodeV2, Vr as doRectsOverlap, Xi as CanvasConnectionMode, Xn as getMainAuthField, Yr as getNodesGroupSize, _ as disposeWorkflowExecutionStateStore, an as ensureNodePosition, bn as useProjectsStore, br as createCanvasConnectionHandleString, bt as getN8nAgentsNodeName, cr as isRequiredCredential, en as useWorkflowHelpers, fn as useNDVStore, in as useTagsStore, kr as parseCanvasConnectionHandleString, ot as removePreviewToken, qr as getNewNodePosition, sn as sanitizeConnections, t as useWorkflowsStore, u as getExecutionErrorToastConfiguration, y as useWorkflowExecutionStateStore, yi as pinDataToExecutionData, zr as PUSH_NODES_OFFSET } from "./workflows.store-_MPWe6Xf.js";
import { Ai as getNodeParameters, Bn as require_cloneDeep, Di as getConnectionTypes, Fi as getSubworkflowId, Ji as resolveNodeWebhookId, Jn as validateNodeSelectionForGrouping, Oi as getNodeInputs, Si as generateNodesGraph, ga as deepCopy, io as v4, ki as getNodeOutputs, la as NodeConnectionTypes, oa as isResourceLocatorValue, qn as validateNodeSelectionForExtraction, va as isCommunityPackageName, ya as isObjectEmpty, zi as isHitlToolType } from "./src-BU1EKX6o.js";
import { t as core_default } from "./core-C21C6IN1.js";
import { a as python, i as typescript, n as javascript, r as bash, t as xml } from "./xml-D0CEdhn0.js";
import { t as useRootStore, ur as defineStore } from "./useRootStore-CmulcDGX.js";
...
import { Bi as LOCAL_STORAGE_LOGS_PANEL_DETAILS_PANEL_SUB_NODE, Hi as LOCAL_STORAGE_LOGS_SYNC_SELECTION, Jn as UPDATE_WEBHOOK_ID_NODE_TYPES, Ka as NDV_IN_FOCUS_PANEL_EXPERIMENT, Pt as CHAT_TRIGGER_NODE_TYPE, Sa as CANVAS_ZOOMED_VIEW_EXPERIMENT, Un as STICKY_NODE_TYPE, Vi as LOCAL_STORAGE_LOGS_PANEL_OPEN, ao as EnterpriseEditionFeature, cn as KEEP_AUTH_IN_NDV_FOR_NODES, dn as MANUAL_CHAT_TRIGGER_NODE_TYPE, oi as MODAL_CONFIRM, zi as LOCAL_STORAGE_LOGS_PANEL_DETAILS_PANEL } from "./constants-C8twx5N6.js";
import { a as TELEMETRY_EVENT } from "./src-D80xHxpb.js";
import { _ as tryToParseNumber, c as isEmpty, d as isPresent } from "./typesUtils-lG1HjQxo.js";
import { o as getNewWorkflowData } from "./workflowsList.store-DIyk87Dd.js";
import { n as useUIStore } from "./ui.store-D_IPOI8H.js";
import { _ as useCanvasStore, a as AddNodeGroupCommand, d as RemoveNodeCommand, f as RemoveNodeGroupCommand, h as UpdateNodeGroupCommand, i as AddNodeCommand, l as MoveNodeCommand, m as ReplaceNodeParametersCommand, n as useHistoryStore, p as RenameNodeCommand, r as AddConnectionCommand, t as useNodeHelpers, u as RemoveConnectionCommand } from "./useNodeHelpers-B3hb3sJI.js";
...
import { t as VueMarkdown } from "./VueMarkdown-B5W_Annd.js";
import { t as useSetupPanelStore } from "./setupPanel.store-DBJUvkZx.js";
import { t as clearAllNodeResourceLocatorValues } from "./templateTransforms-b3knlMl2.js";
...
//#endregion
//#region src/app/stores/aiSimulatedExecutions.store.ts
/**
...
*/
var MAX_TRACKED_EXECUTIONS = 25;
var useAiSimulatedExecutionsStore = defineStore("aiSimulatedExecutions", () => {
	const simulatedNodesByExecutionId = ref(/* @__PURE__ */ new Map());
	function markSimulatedNodes(executionId, nodeNames) {
	...
	function isSimulatedNodeOutput(executionId, nodeName) {
...
//#endregion
//#region src/app/composables/useAiSimulatedDataGuard.ts
/**
...
*/
function useAiSimulatedDataGuard() {
	...
	async function confirmAdoption() {
		return await message.confirm(i18n.baseText("ndv.pinData.aiSimulated.confirm.description"), i18n.baseText("ndv.pinData.aiSimulated.confirm.title"), {
			type: "warning",
...
function useNodeCredentialOptions(node, nodeType, overrideCredType, displayAllOptions = false) {
	...
	const credentialTypesNodeDescriptions = computed(() => credentialsStore.getCredentialTypesNodeDescriptions(toValue(overrideCredType), toValue(nodeType)));
	...
	function getCredentialOptions(types) {
		...
		if (toValue(node)?.type === "n8n-nodes-base.httpRequest") options = options.filter((option) => !option.isManaged);
		return options;
	}
	function displayCredentials(credentialTypeDescription) {
		...
		return nodeHelpers.displayParameter(nodeValue.parameters, credentialTypeDescription, "", nodeValue);
	}
	function showMixedCredentials(credentialType) {
		const nodeValue = toValue(node);
		if (!nodeValue || hasOverride.value) return false;
	...
	function isMainAuthCredential(credentialType) {
		const authFieldName = mainNodeAuthField.value?.name;
		return authFieldName !== void 0 && credentialType.displayOptions?.show?.[authFieldName] !== void 0;
	}
	function shouldShowRelatedCredentials(credentialType) {
		/**
		...
		*/
		return showMixedCredentials(credentialType) || toValue(displayAllOptions) && isMainAuthCredential(credentialType);
	}
	function getAllRelatedCredentialTypes(credentialType) {
		if (hasOverride.value || !shouldShowRelatedCredentials(credentialType)) return [credentialType.name];
		const authFieldName = mainNodeAuthField.value?.name;
		if (!authFieldName) return [credentialType.name];
		return getAllNodeCredentialForAuthType(toValue(nodeType), authFieldName).map((cred) => cred.name);
	}
...
//#endregion
//#region src/features/credentials/credentials.utils.ts
/**
* For a node with no credentials set, pick the most recently updated usable
* credential across its displayed credential types.
*/
function getAutoSelectedCredential(node, overrideCredType = "") {
	if (!isEmpty(node.credentials ?? {})) return void 0;
	const { credentialTypesNodeDescriptionDisplayed } = useNodeCredentialOptions(node, useNodeTypesStore().getNodeType(node.type, node.typeVersion), overrideCredType);
	const allOptions = credentialTypesNodeDescriptionDisplayed.value.flatMap((type) => type.options);
	if (allOptions.length === 0) return void 0;
...
//#endregion
//#region ../@n8n/chat/src/components/MessageWithButtons.vue?vue&type=style&index=0&lang.module.scss
var buttons = "_buttons_10a9e_388";
var shimmer = "_shimmer_10a9e_1";
var spin = "_spin_10a9e_1";
var opacityPulse = "_opacityPulse_10a9e_1";
var popoverIn = "_popoverIn_10a9e_1";
var fadeIn = "_fadeIn_10a9e_1";
var collapsibleSlideDown = "_collapsibleSlideDown_10a9e_1";
var collapsibleSlideUp = "_collapsibleSlideUp_10a9e_1";
var collapsibleSlideDownBlurred = "_collapsibleSlideDownBlurred_10a9e_1";
var collapsibleSlideUpBlurred = "_collapsibleSlideUpBlurred_10a9e_1";
var blurSwapIn = "_blurSwapIn_10a9e_1";
var blurSwapOut = "_blurSwapOut_10a9e_1";
var pulseGlow = "_pulseGlow_10a9e_1";
var pulseGlowDelayed = "_pulseGlowDelayed_10a9e_1";
var fade = "_fade_10a9e_1";
var fadeInUp = "_fadeInUp_10a9e_1";
var fadeInDown = "_fadeInDown_10a9e_1";
var fadeInLeft = "_fadeInLeft_10a9e_1";
var fadeInRight = "_fadeInRight_10a9e_1";
var fadeOut = "_fadeOut_10a9e_1";
var fadeOutDown = "_fadeOutDown_10a9e_1";
var fadeOutUp = "_fadeOutUp_10a9e_1";
var fadeOutLeft = "_fadeOutLeft_10a9e_1";
var fadeOutRight = "_fadeOutRight_10a9e_1";
var ping = "_ping_10a9e_1";
var blinkBackground = "_blinkBackground_10a9e_1";
var typingBlink = "_typingBlink_10a9e_1";
var MessageWithButtons_vue_vue_type_style_index_0_lang_module_default = {
	buttons,
	shimmer,
	spin,
	"skeleton-pulse": "_skeleton-pulse_10a9e_1",
	opacityPulse,
	popoverIn,
	fadeIn,
...
var CHAT_NODE_MESSAGE_TYPE = "message";
var CHAT_NODE_MESSAGE_WITH_BUTTONS_TYPE = "with-buttons";
var CHAT_NODE_ERROR_TYPE = "error";
...
function parseBotChatMessageContent(message) {
	...
	try {
		...
		else if (parsed.type === CHAT_NODE_MESSAGE_TYPE) chatMessage = {
			id,
			sender: "bot",
			text: parsed.text
		};
		else if (parsed.type === CHAT_NODE_ERROR_TYPE) chatMessage = {
			id,
			sender: "bot",
			text: parsed.message
		};
...
function useSelectionValidation() {
	...
	*/
	function resolveGroupableNodeIds(nodeIds) {
		...
		if (expandedIds.filter((id) => store?.getNodeById(id)?.type !== "n8n-nodes-base.stickyNote").length < 2) return null;
...
//#endregion
//#region src/features/workflows/canvas/nodeGroups.utils.ts
...
*/
function deleteGroupWithHistory(group, workflowDocumentStore, historyStore) {
...
//#endregion
//#region src/features/agents/agentNodeCanvasGeometry.store.ts
var useAgentNodeCanvasGeometryStore = defineStore("agentNodeCanvasGeometry", () => {
	const nodeHeightsByCanvas = shallowReactive(/* @__PURE__ */ new Map());
	const pendingCenterYByCanvas = /* @__PURE__ */ new Map();
	function setNodeHeight(canvasId, nodeId, height) {
		let heightsByNode = nodeHeightsByCanvas.get(canvasId);
		if (!heightsByNode) {
			heightsByNode = shallowReactive(/* @__PURE__ */ new Map());
			nodeHeightsByCanvas.set(canvasId, heightsByNode);
		}
		heightsByNode.set(nodeId, height);
	}
	function getNodeHeight(canvasId, nodeId) {
		return nodeHeightsByCanvas.get(canvasId)?.get(nodeId);
	}
	function setPendingCenterY(canvasId, nodeId, centerY) {
		let centerYByNode = pendingCenterYByCanvas.get(canvasId);
		if (!centerYByNode) {
			centerYByNode = /* @__PURE__ */ new Map();
			pendingCenterYByCanvas.set(canvasId, centerYByNode);
		}
		centerYByNode.set(nodeId, centerY);
	}
	function consumePendingCenterY(canvasId, nodeId) {
...
*/
function getPlacementNodeWidth(node, nodeTypeDescription) {
	if (isAgentNodeV2(node)) return AGENT_NODE_SIZE[0];
	const { inputs } = nodeTypeDescription;
	const hasNonMainInput = Array.isArray(inputs) && getConnectionTypes(inputs).some((input) => input !== NodeConnectionTypes.Main);
	if (typeof inputs === "string" || hasNonMainInput) return CONFIGURABLE_NODE_SIZE[0];
...
function useCanvasOperations() {
	...
	*/
	...
	async function toggleNodesPinned(ids, source, { trackHistory = true, trackBulk = true } = {}) {
		...
		if (nextStatePinned) {
			const displayedExecutionId = useWorkflowExecutionStateStore(workflowDocumentStore.value.documentId).activeExecution?.id;
			if (pinnableNodesWithPinnedData.some(({ node, pinnedData }) => !pinnedData.hasData.value && aiSimulatedDataGuard.isSimulatedNodeOutput(displayedExecutionId, node.name)) && !await aiSimulatedDataGuard.confirmAdoption()) return;
		}
		if (trackHistory && trackBulk) historyStore.startRecordingUndo();
	...
	async function addNodes(nodes, { viewport, ...options } = {}) {
		...
		for (const [index, nodeAddData] of nodesWithTypeVersion.entries()) {
			...
			insertPosition = [lastAddedNode.position[0] + getPlacementNodeWidth(lastAddedNode, nodeTypeDescription) + 128, lastAddedNode.position[1]];
		}
	...
	*/
	...
	function addNode(node, nodeTypeDescription, options = {}) {
		...
		if (isAgentNodeV2(nodeData) && !options.keepPristine) agentNodeCanvasGeometryStore.setPendingCenterY(workflowDocumentStore.value.workflowId, nodeData.id, nodeData.position[1] + AGENT_NODE_SIZE[1] / 2);
	...
	*/
	function autoSelectNodeCredentials(nodes) {
		const autoSelected = nodes.flatMap((node) => {
			if (node.type === "n8n-nodes-base.httpRequest" || node.type === "n8n-nodes-base.httpRequestTool") return [];
		...
		const single = autoSelected.length === 1 ? autoSelected[0] : void 0;
		toast.showMessage({
			type: "info",
			title: i18n.baseText("nodeView.showMessage.credentialsAutoAdded.title"),
			message: single ? i18n.baseText("nodeView.showMessage.credentialsAutoAdded.message.single", { interpolate: {
				credentialName: single.credentialName,
	...
	function trackAddDefaultNode(nodeData, options, nextView) {
		...
		if (nodeData.type === "n8n-nodes-base.messageAnAgent") trackAddAgentNode(nodeData);
	}
	function trackAddAgentNode(nodeData) {
		const { agentSource, agentId } = nodeData.parameters ?? {};
		telemetry.track(TELEMETRY_EVENT.AGENTS.USER_ADDED_AGENT_NODE, {
			agent_source: agentSource === "inline" || agentSource === "referenced" ? agentSource : void 0,
			agent_id: isResourceLocatorValue(agentId) && typeof agentId.value === "string" && agentId.value !== "" ? agentId.value : void 0,
			workflow_id: workflowDocumentStore.value.workflowId,
			node_id: nodeData.id,
			node_version: nodeData.typeVersion
		});
	...
	*/
	function resolveNodeData(node, nodeTypeDescription, options = {}) {
		...
		const name = node.name ?? getN8nAgentsNodeName(nodeTypeDescription.name) ?? nodeHelpers.getDefaultNodeName(node) ?? nodeTypeDescription.defaults.name;
		...
		if (lastInteractedWithNode.value) {
			...
			if (newNodeInsertPosition) {
				...
				if (lastInteractedWithNodeConnection) {
					...
					const shiftMargin = HORIZONTAL_NODE_STEP + (isNewNodeConfigurable ? CONFIGURABLE_NODE_SIZE[0] - DEFAULT_NODE_SIZE[0] : 0);
				...
				if (outputTypes.length > 0 && outputTypes.every((outputName) => outputName !== NodeConnectionTypes.Main)) {
					...
					if (isAgentNodeV2(lastInteractedWithNodeObject)) pushOffset += AGENT_NODE_SIZE[0] - DEFAULT_NODE_SIZE[0];
					else if (lastInteractedWithNodeInputTypes.find((input) => input !== NodeConnectionTypes.Main)) pushOffset += 140;
					const sourceNodeHeight = (isAgentNodeV2(lastInteractedWithNodeObject) ? agentNodeCanvasGeometryStore.getNodeHeight(workflowDocumentStore.value.workflowId, lastInteractedWithNodeObject.id) : void 0) ?? (isAgentNodeV2(lastInteractedWithNodeObject) ? AGENT_NODE_SIZE[1] : DEFAULT_NODE_SIZE[1]);
					const targetNodeHeight = isAgentNodeV2(node) ? AGENT_NODE_SIZE[1] : nodeSize[1];
					const centeredY = lastInteractedWithNode.value.position[1] + (sourceNodeHeight - targetNodeHeight) / 2;
					position = [lastInteractedWithNode.value.position[0] + pushOffset, centeredY + yOffset];
					if (lastInteractedWithNodeConnection) position = [position[0], centeredY];
				}
			}
		}
	...
	*/
	function getNodesToShift(insertPosition, sourceNodeName, nodeSize = DEFAULT_NODE_SIZE) {
		...
		for (const sticky of stickyNodes) {
			...
			if (associatedWithMovedNode) if (insertX + nodeSize[0] > stickyLeftEdge + 2 * HORIZONTAL_NODE_STEP / 3) stickiesToMoveAndStretch.push(sticky);
	...
	*/
	function shiftDownstreamNodesPosition(sourceNodeName, margin, { trackHistory = false, nodeSize = DEFAULT_NODE_SIZE }) {
		...
		if (isAgentNodeV2(sourceNode)) insertOffset += AGENT_NODE_SIZE[0] - DEFAULT_NODE_SIZE[0];
		const insertPosition = [sourceNode.position[0] + insertOffset, sourceNode.position[1]];
...
//#endregion
export { useI18n as A, ChatOptionsSymbol as C, MessageWithButtons_default as D, MessageComponentKey as E, useWorkflowNormalization as F, useAiSimulatedDataGuard as I, useAiSimulatedExecutionsStore as L, useChat as M, getAutoSelectedCredential as N, MarkdownRenderer_default as O, useNodeCredentialOptions as P, shouldBlockUserInput as S, localStorageSessionIdKey as T, LOGS_PANEL_STATE as _, snapshotGroup as a, constructChatWebsocketUrl as b, addTokenUsageData as c, isChatNode as d, parseAiContent as f, LOCAL_STORAGE_PANEL_WIDTH as g, LOCAL_STORAGE_PANEL_HEIGHT as h, deleteGroupWithHistory as i, useOptions as j, Button_default as k, emptyTokenUsageData as l, LOCAL_STORAGE_OVERVIEW_PANEL_WIDTH as m, useAgentNodeCanvasGeometryStore as n, useSelectionValidation as o, useLogsStore as p, useCanvasNodeGroupTelemetry as r, useExperimentalNdvStore as s, useCanvasOperations as t, formatTokenUsageCount as u, LOG_DETAILS_PANEL_STATE as v, ChatSymbol as w, parseBotChatMessageContent as x, chatEventBus as y };
