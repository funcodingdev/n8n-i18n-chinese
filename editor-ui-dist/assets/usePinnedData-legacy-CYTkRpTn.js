;
(function () {
  System.register(["./vue.runtime.esm-bundler-legacy--Sn1h8On.js", "./_MapCache-legacy-CIWHOywQ.js", "./useTelemetry-legacy-CISk46xo.js", "./useToast-legacy-WoZGemxJ.js", "./constants-legacy-DuqvrHPn.js", "./_baseOrderBy-legacy-BoIlqV8l.js", "./useExternalHooks-legacy-DWuo7Sev.js"], function (_export, _context) {
    "use strict";

    var computed, unref, useI18n, stringSizeInBytes, useDataSchema, useNodeTypesStore, useWorkflowsStore, useTelemetry, toMegaBytes, useToast, jsonStringify, NodeConnectionTypes, MAX_WORKFLOW_SIZE, PIN_DATA_NODE_TYPES_DENYLIST, MAX_EXPECTED_REQUEST_SIZE, MAX_PINNED_DATA_SIZE, isSubNodeType, jsonParse, getNodeOutputs, useRootStore, useExternalHooks;
    ...
    return {
      setters: [function (_vueRuntimeEsmBundlerLegacy003Js) {
        ...
        jsonStringify = _constantsLegacy00TJs.Aa;
        NodeConnectionTypes = _constantsLegacy00TJs.Ga;
        MAX_WORKFLOW_SIZE = _constantsLegacy00TJs.Gs;
        PIN_DATA_NODE_TYPES_DENYLIST = _constantsLegacy00TJs.Kn;
        MAX_EXPECTED_REQUEST_SIZE = _constantsLegacy00TJs.Us;
        MAX_PINNED_DATA_SIZE = _constantsLegacy00TJs.Ws;
        isSubNodeType = _constantsLegacy00TJs.fa;
