...
import { s as useI18n$1 } from "./src-M_cPVtop.js";
import { Ni as require_markdown_it_link_attributes, lt as useRoute, ut as useRouter } from "./src-D7XhL4SE.js";
import { t as _plugin_vue_export_helper_default } from "./_plugin-vue_export-helper-Da88TEg1.js";
import { $i as tryToParseNumber, $t as useCanvasStore, Bt as useNDVStore, Dn as getNewNodePosition, Dr as isValidNodeConnectionType, F as removePreviewToken, Gr as useProjectsStore, Ir as pinDataToExecutionData, Ji as isPresent, Mt as ensureNodePosition, Nr as CanvasNodeRenderType, Pt as sanitizeConnections, Qt as useNodeHelpers, Sn as generateOffsets, Ut as injectWorkflowDocumentStore, Zt as serializeNode, _n as DEFAULT_NODE_SIZE, ar as mapLegacyConnectionToCanvasConnection, b as useNodeTypesStore, cn as RemoveConnectionCommand, dn as ReplaceNodeParametersCommand, er as createCanvasConnectionHandleString, ft as useDataSchema, gn as CONFIGURATION_NODE_SIZE, h as getExecutionErrorToastConfiguration, hn as CONFIGURABLE_NODE_SIZE, ir as mapCanvasConnectionToLegacyConnection, jr as CanvasConnectionMode, jt as useTagsStore, kn as getNodesGroupSize, kt as useWorkflowHelpers, ln as RemoveNodeCommand, nn as AddConnectionCommand, nt as useCredentialsStore, or as mapLegacyConnectionsToCanvasConnections, pn as require_uniq, rn as AddNodeCommand, sn as MoveNodeCommand, sr as parseCanvasConnectionHandleString, t as useWorkflowsStore, tn as useHistoryStore, un as RenameNodeCommand, vn as DEFAULT_VIEWPORT_BOUNDARIES, xn as doRectsOverlap, yn as PUSH_NODES_OFFSET } from "./workflows.store-DQQfIwKi.js";
import { t as useToast } from "./useToast-DMjrW7lG.js";
import { Cs as isHitlToolType, Gl as NDV_IN_FOCUS_PANEL_EXPERIMENT, Gs as deepCopy, Ks as isCommunityPackageName, Lc as v4, No as require_cloneDeep, Pt as CHAT_TRIGGER_NODE_TYPE, bn as MANUAL_CHAT_TRIGGER_NODE_TYPE, cs as generateNodesGraph, ds as getConnectionTypes, fr as UPDATE_WEBHOOK_ID_NODE_TYPES, fs as getNodeInputs, ga as LOCAL_STORAGE_LOGS_SYNC_SELECTION, ha as LOCAL_STORAGE_LOGS_PANEL_OPEN, jl as CANVAS_ZOOMED_VIEW_EXPERIMENT, js as resolveNodeWebhookId, lc as NodeConnectionTypes, ma as LOCAL_STORAGE_LOGS_PANEL_DETAILS_PANEL_SUB_NODE, ms as getNodeParameters, nu as EnterpriseEditionFeature, oi as VIEWS, or as STICKY_NODE_TYPE, pa as LOCAL_STORAGE_LOGS_PANEL_DETAILS_PANEL, ps as getNodeOutputs, qs as isObjectEmpty, ys as getSubworkflowId } from "./constants-Brs44Mbc.js";
...
import { _ as useLocalStorage, c as useClipboard } from "./core-CMxey_qZ.js";
import { f as useUIStore, g as usePostHog, p as useTelemetry } from "./users.store-ByD75lsx.js";
...
import { t as VueMarkdown } from "./VueMarkdown-BkxyUHjQ.js";
import { t as useSetupPanelStore } from "./setupPanel.store-CNAhMYki.js";
import { t as clearAllNodeResourceLocatorValues } from "./templateTransforms-Cy9jBQHB.js";
