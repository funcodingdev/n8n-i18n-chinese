...
import { $n as makeRestApiRequest, Bn as sendConfirmationEmail, C as updateCurrentUser, D as updateOtherUserSettings, E as updateGlobalRole, Ft as updateEnforceMfa, It as verifyMfaCode, Mt as disableMfa, Nt as enableMfa, O as validatePasswordToken, Pt as getMfaQR, S as submitPersonalizationSurvey, T as updateCurrentUserSettings, Y as oidcLogout, _ as login, b as sendForgotPasswordEmail, cr as BROWSER_ID_STORAGE_KEY, dr as defineStore, er as post, f as changePassword, g as getUsers, h as getPasswordResetLink, jt as canEnableMFA, k as validateSignupToken, m as generateInviteLink, p as deleteUser, r as STORES, t as useRootStore, v as loginCurrentUser, w as updateCurrentUserPassword, x as setupOwner, y as logout } from "./useRootStore-BSEpDaXx.js";
...
var useUsersStore = defineStore(STORES.USERS, () => {
	...
	const logout$1 = async (options) => {
		...
		else await logout(rootStore.restApiContext);
		unsetCurrentUser();
