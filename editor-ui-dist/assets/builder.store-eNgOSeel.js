...
import { At as useAIAssistantHelpers, Ct as chatWithBuilder, Di as isDebouncedFunction, Dt as getBuilderCredits, E as useWorkflowDocumentStore, Et as getAiSessions, R as useNodeTypesStore, S as createWorkflowDocumentId, Xt as useRouteWorkflowId, Yt as useWorkflowHelpers, Zt as useWorkflowId, gn as useSourceControlStore, kt as truncateBuilderMessages, sn as useNDVStore, t as useWorkflowsStore, w as injectWorkflowDocumentStore, wt as clearBuilderSession, y as useWorkflowExecutionStateStore } from "./workflows.store-CV9fQhc2.js";
import { Qt as validateNodeSelectionForGrouping, ci as isExpression, da as getResourcePermissions, ui as dedupe } from "./src-JwBmTNgK.js";
import { a as getWorkflowVersion, fr as defineStore, i as getWorkflowHistory, lr as STORES, mn as getFirstAdoptionDate, o as getWorkflowVersionsByIds, r as getPublishTimeline, s as updateWorkflowHistoryVersion, t as useRootStore, yt as updateNpsSurveyState } from "./useRootStore-BxA0rNgc.js";
...
import { Aa as FOCUSED_NODES_EXPERIMENT, Ei as LOCAL_STORAGE_BROWSER_NOTIFICATION_METADATA, Va as MERGE_ASK_BUILD_EXPERIMENT, ai as MODAL_CONFIRM, ca as EditorEnabledFeaturesKey, ii as MODAL_CLOSE, ri as MODAL_CANCEL, si as NPS_SURVEY_MODAL_KEY, t as AutoSaveState, xa as CODE_WORKFLOW_BUILDER_EXPERIMENT } from "./constants-BP1FOJvU.js";
import { c as THREE_DAYS_IN_MILLIS, o as SEVEN_DAYS_IN_MILLIS, s as SIX_MONTHS_IN_MILLIS, t as DEBOUNCE_TIME } from "./durations-nXrTS7zD.js";
import { a as BUILDER_ENABLED_VIEWS, r as useChatPanelStateStore, t as useCodeDiff } from "./useCodeDiff-C2D7sERr.js";
import { t as getDebounceTime } from "./useDebounce-Bcd_ZnT1.js";
import { g as stringSizeInBytes, v as tryToParseNumber } from "./typesUtils-DlQYqvHF.js";
import { a as getNewWorkflow, t as useWorkflowsListStore } from "./workflowsList.store-6Bsu-Vve.js";
