...
import { $ as openBlock, A as createTextVNode, C as createBaseVNode, Cn as toDisplayString, E as createElementBlock, Ft as readonly, Gt as unref, It as ref, K as onBeforeMount, N as defineComponent, O as createSlots, R as inject, S as computed, T as createCommentVNode, Ut as toValue, W as nextTick, X as onMounted, _ as Fragment, bt as withCtx, c as useCssModule, gt as watch, h as withModifiers, j as createVNode, jt as isRef, p as vShow, pt as useTemplateRef, q as onBeforeUnmount, rt as renderList, vn as normalizeClass, w as createBlock, xt as withDirectives } from "./vue.runtime.esm-bundler-Bs4WIMNP.js";
import { S as I18nT, x as useI18n } from "./_MapCache-B3sL8ZR7.js";
import { A as N8nUserStack_default, At as Checkbox_default, Gi as N8nBadge_default, H as N8nSwitch_default, Ot as N8nLink_default, Pt as N8nHeading_default, W as SuggestedActions_default, Z as N8nRadioButtons_default, _ as Dialog_default, b as DialogDescription_default, do as N8nIconButton_default, et as N8nPopover_default, f as useMessage, fo as N8nButton_default, g as DialogFooter_default, k as N8nUserSelect_default, kt as N8nInputLabel_default, oa as N8nTooltip_default, oo as N8nText_default, po as N8nIcon_default, q as N8nSpinner_default, rn as N8nActionDropdown_default, sn as DropdownMenuItem_default, uo as Input_default, v as DialogTitle_default, w as N8nInlineTextEdit_default, y as DialogHeader_default } from "./src-VmSi6XTE.js";
import { t as _plugin_vue_export_helper_default } from "./_plugin-vue_export-helper-Da88TEg1.js";
import { d as useDocumentVisibility, y as useLocalStorage } from "./dist-BkE9aYmt.js";
import { t as router } from "./router-BD36tLsP.js";
import { t as createEventBus } from "./event-bus-DAq0yaAJ.js";
import { _ as useRouter, g as useRoute } from "./htmlUtils-BQ4vUfog.js";
import { E as useWorkflowDocumentStore, Qt as useTagsStore, R as useNodeTypesStore, Rn as getActivatableTriggerNodes, S as createWorkflowDocumentId, Xt as useWorkflowId, an as injectNDVStoreIfProvided, gn as ProjectTypes, hn as useSourceControlStore, ln as ResourceType, mn as useProjectsStore, t as useWorkflowsStore, w as injectWorkflowDocumentStore } from "./workflows.store-Ct6L2UO9.js";
import { Xn as ResponseError, dr as defineStore, t as useRootStore } from "./useRootStore-CDIOxWm8.js";
import { ca as getResourcePermissions, fi as jsonParse } from "./src-Vot4VemC.js";
...
import { Ai as WORKFLOW_SETTINGS_MODAL_KEY, Ir as MAIN_HEADER_TABS, Lr as WORKFLOW_HISTORY_PUBLISH_TIMELINE_TAB, Oi as WORKFLOW_HISTORY_VERSION_UNPUBLISH, T as TIME_SAVED_DOCS_URL, Ti as WORKFLOW_HISTORY_NAME_VERSION_MODAL_KEY, Yr as DUPLICATE_MODAL_KEY, _ as EVALUATIONS_DOCS_URL, aa as LOCAL_STORAGE_WORKFLOW_REVIEW_SUBMITTED_DIALOG_HIDDEN, bi as WORKFLOW_ACTIVE_MODAL_KEY, g as ERROR_WORKFLOW_DOCS_URL, ia as LOCAL_STORAGE_WORKFLOW_REVIEW_REQUIRED_BY_WORKFLOW, ji as WORKFLOW_SHARE_MODAL_KEY, ki as WORKFLOW_PUBLISH_MODAL_KEY, oo as EnterpriseEditionFeature, po as WORKFLOW_MENU_ACTIONS, ra as LOCAL_STORAGE_WORKFLOW_REVIEW_PUBLISH_CHOICE_HIDDEN, t as AutoSaveState, ti as IMPORT_WORKFLOW_URL_MODAL_KEY, xi as WORKFLOW_DESCRIPTION_MODAL_KEY, ya as WorkflowDocumentStoreKey } from "./constants-nNF8vqjl.js";
...
import { t as useEvaluationStore } from "./evaluation.store-Vgv3PaQs.js";
import { t as useDocumentTitle } from "./useDocumentTitle-Cxa3XNW1.js";
import { a as useWorkflowSaveStore, r as useWorkflowSaving, s as useWorkflowHistoryStore } from "./builder.store-CWK3w1xR.js";
...
import { t as useDocumentVisibility$1 } from "./useDocumentVisibility-Y3jgmCXX.js";
...
import { l as MCP_SETTINGS_VIEW, o as MCP_DOCS_PAGE_URL } from "./mcp.constants-BJlPhUHg.js";
import { t as useWorkflowReviewsFeature } from "./useWorkflowReviewsFeature-CB7xSHl9.js";
import { n as WORKFLOW_REVIEW_REQUESTS_VIEW, t as REVIEW_INBOX_QUERY_PARAM } from "./constants-C4PnEM9C.js";
import { n as useMoveResourceToProjectToast, t as WorkflowVersionForm_default } from "./WorkflowVersionForm-DeS3mP0M.js";
import { n as telemetry } from "./telemetry-BDTpP0el.js";
import { i as getLastPublishedVersion, r as generateVersionLabelFromId } from "./utils-D0oFeT3H.js";
...
import { t as usePushConnection } from "./usePushConnection-BT81xW6I.js";
import { t as FolderBreadcrumbs_default } from "./FolderBreadcrumbs-dGHX95UB.js";
import { t as ConnectionTracker_default } from "./ConnectionTracker-fF6ybeVg.js";
import { t as useWorkflowEvaluationState } from "./useWorkflowEvaluationState-CJdWWXFM.js";
import { c as fetchWorkflowReviewRequests, i as fetchEligibleReviewers, l as updateWorkflowReviewRequestVersion, n as createWorkflowReviewRequest, t as formatUserDisplayName } from "./formatUserDisplayName-BGNMdV3C.js";
import "./usePushConnection-BQ1hn-qc.js";
	...
	setup(__props, { expose: __expose }) {
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("div", { class: normalizeClass([unref($style).group]) }, [
				...
				!__props.isNewWorkflow ? (openBlock(), createBlock(WorkflowProductionChecklist_default, {
					key: 0,
		...
		const submit = async () => {
			...
			try {
				...
				const reviewRequest = await createWorkflowReviewRequest(rootStore.restApiContext, {
					...
					reviewerUserIds: reviewerId ? [reviewerId] : void 0
				});
				if (props.workflowId !== workflowId) return;
...
var WorkflowSubmitForReviewDialog_vue_vue_type_style_index_0_lang_module_default = {
	form: "_form_1bu4s_125",
	step: "_step_1bu4s_132"
};
...
var WorkflowUpdateReviewDialog_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props, { emit: __emit }) {
		...
		const isSubmitDisabled = computed(() => isSubmitting.value || !props.canSubmit || versionName.value.trim().length === 0);
		watch(() => props.open, (isOpen) => {
			...
			return openBlock(), createBlock(unref(Dialog_default), {
				...
				default: withCtx(() => [
					...
					createVNode(WorkflowVersionForm_default, {
						...
						description: unref(versionDescription),
						"onUpdate:description": _cache[1] || (_cache[1] = ($event) => isRef(versionDescription) ? versionDescription.value = $event : null),
						class: normalizeClass(_ctx.$style.versionForm),
						disabled: isSubmitting.value,
					...
					createVNode(unref(DialogFooter_default), { "data-test-id": "workflow-update-review-dialog" }, {
...
var WorkflowUpdateReviewDialog_vue_vue_type_style_index_0_lang_module_default = {
	description: "_description_1uff5_125",
	versionForm: "_versionForm_1uff5_130"
};
...
var WorkflowHeaderDraftPublishActions_vue_vue_type_style_index_0_lang_module_default = {
	container: "_container_45uey_126",
	activeVersionIndicator: "_activeVersionIndicator_45uey_130",
	icon: "_icon_45uey_134",
	reviewStatusBannerSlot: "_reviewStatusBannerSlot_45uey_144",
	publishButtonWrapper: "_publishButtonWrapper_45uey_150",
	buttonGroup: "_buttonGroup_45uey_155",
	groupButtonLeft: "_groupButtonLeft_45uey_161",
	groupButtonRight: "_groupButtonRight_45uey_173",
	indicatorDot: "_indicatorDot_45uey_183",
	publishingSpinner: "_publishingSpinner_45uey_191",
	indicatorPublished: "_indicatorPublished_45uey_195",
	indicatorPublishedText: "_indicatorPublishedText_45uey_199",
	indicatorChanges: "_indicatorChanges_45uey_203",
	indicatorIssues: "_indicatorIssues_45uey_207",
	indicatorPartial: "_indicatorPartial_45uey_211",
	flex: "_flex_45uey_215"
};
...
var container$1 = "_container_1o6de_125";
var closeNodeViewDiscovery = "_closeNodeViewDiscovery_1o6de_151";
var WorkflowDetails_vue_vue_type_style_index_1_lang_module_default = {
	container: container$1,
	"path-separator": "_path-separator_1o6de_136",
	closeNodeViewDiscovery,
	"header-controls": "_header-controls_1o6de_158"
};
	...
	setup(__props) {
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("div", { class: normalizeClass(_ctx.$style.container) }, [createBaseVNode("div", { class: normalizeClass({
				...
				"is-archived",
				"description"
			])) : createCommentVNode("", true)], 2), [[vShow, !hideMenuBar.value && !unref(settingsStore).isCanvasOnly]]), onWorkflowPage.value ? (openBlock(), createBlock(TabBar_default, {
				key: 0,
...
var MainHeader_vue_vue_type_style_index_0_lang_module_default = {
	container: "_container_1m50o_125",
	"main-header": "_main-header_1m50o_132",
	"canvas-only": "_canvas-only_1m50o_140",
	"top-menu": "_top-menu_1m50o_146"
};
