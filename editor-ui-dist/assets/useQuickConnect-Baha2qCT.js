...
import { ia as sanitizeHtml, st as useCredentialsStore, wn as useProjectsStore } from "./workflowDocument.store-COBWkqWz.js";
...
function useQuickConnect() {
	...
	async function connectToPinecone(quickConnectOption) {
		const { ConnectPopup } = await __vitePreload(async () => {
			const { ConnectPopup } = await import("./dist-B7PsRa3w.js");
			return { ConnectPopup };
		}, []);
