...
import { D as useElementSize, M as useLocalStorage, N as useMediaQuery, O as useEventListener, b as useActiveElement, bt as useI18n, xt as I18nT } from "./_MapCache-BLQlsGfT.js";
...
import { As as useSettingsStore, Po as INVITE_USER_MODAL_KEY, Tr as useToast, en as useTelemetry, gr as hasPermission, r as useUIStore, t as useUsersStore, vn as useDocumentTitle, wr as hasRole } from "./users.store-YX3xGXV-.js";
import { Uo as v4_default, ac as LOCAL_STORAGE_CHAT_HUB_HAD_CONVERSATION_BEFORE, fi as chatHubConversationModelSchema, ii as ROLE, li as PROVIDER_CREDENTIAL_TYPE_MAP, ml as EnterpriseEditionFeature, ms as VIEWS, oc as LOCAL_STORAGE_CHAT_HUB_SELECTED_MODEL } from "./constants-sixw52iU.js";
...
import { l as shouldIgnoreCanvasShortcut } from "./canvas.utils-NT0VdpQR.js";
...
import { O as fetchWorkflowExecutionStatus, S as unflattenModel, c as findOneFromModelsResponse, h as isLlmProvider, i as collectChatArtifacts, k as revokeDynamicCredential, l as flattenModel, t as useChatStore, w as authorizeDynamicCredential } from "./chat.store-0z3fyyh2.js";
import "./ChatAgentAvatar-8eanPlKw.js";
import { t as useResizablePanel } from "./useResizablePanel-CpDc54nE.js";
import { a as useChatSession, i as ChatMarkdownChunk_default, n as ChatPrompt_default, r as ChatMessage_default, t as ChatGreetings_default } from "./ChatGreetings-BuMZahes.js";
import { n as useFileDrop } from "./ToolsSelector-DApA8DpC.js";
import { n as useChatCredentials, r as chatHubConversationModelWithCachedDisplayNameSchema, t as ChatLayout_default } from "./ChatLayout-DQD1UbWX.js";
import { n as ModelSelector_default, t as useCustomAgent } from "./useCustomAgent-3k-VXhpt.js";
