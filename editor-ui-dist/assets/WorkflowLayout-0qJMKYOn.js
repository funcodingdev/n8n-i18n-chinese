...
import { T as useStorage, at as useI18n, u as useDocumentVisibility, v as useLocalStorage } from "./core-DJhPBFhT.js";
import { Bi as DropdownMenuItem_default, D as SuggestedActions_default, Di as N8nTooltip_default, Ft as N8nBadge_default, Hi as DropdownMenuRoot_default, Ki as Primitive, Mi as N8nIconButton_default, Mt as N8nActionDropdown_default, N as N8nRadioButtons_default, Ni as AskAssistantButton_default, Qi as N8nIcon_default, Ri as DropdownMenuTrigger_default, S as N8nUserStack_default, Vi as DropdownMenuContent_default, W as N8nTag_default, Xi as N8nText_default, Zi as N8nButton_default, ct as useRoute, ft as N8nFloatingWindow_default, gi as AskAssistantAvatar_default, h as N8nInlineTextEdit_default, lt as useRouter, m as N8nScrollArea_default, n as DropdownMenu_default, nt as RouterLink, qi as useForwardExpose, xt as createEventBus, zi as DropdownMenuPortal_default } from "./src-DJ-D-s3W.js";
import { d as __vitePreload } from "./get-CG189dWu.js";
import { t as _plugin_vue_export_helper_default } from "./_plugin-vue_export-helper-Da88TEg1.js";
import { Bn as require_FileSaver_min, Ds as getBannerRowHeight, Dt as useWorkflowState, E as useEvaluationStore, Fn as useStyles, Li as getActivatableTriggerNodes, Ln as useMessage, Ot as useBuilderStore, Pn as useToast, Rt as useDocumentTitle, Tt as useWorkflowHelpers, Vt as useWorkflowSaveStore, aa as injectWorkflowDocumentStore, ai as useProjectsStore, ei as ResourceType, fr as useTelemetry, gi as ProjectTypes, gr as useNDVStore, jt as nodeViewEventBus, mr as telemetry, nr as useTagsStore, oa as useWorkflowDocumentStore, oi as useSourceControlStore, r as useUIStore, ra as createWorkflowDocumentId, s as useWorkflowsStore, si as hasPermission, sr as useWorkflowsListStore, t as useUsersStore, w as useNodeTypesStore, zn as useWorkflowHistoryStore, zt as useWorkflowSaving } from "./users.store-Cuk0qvvE.js";
import { t as BaseLayout_default } from "./BaseLayout-p2241o7s.js";
import { As as WORKFLOW_DESCRIPTION_MODAL_KEY, Bo as getResourcePermissions, Bs as WORKFLOW_SHARE_MODAL_KEY, Cc as WorkflowDocumentStoreKey, Eo as v4, Ls as WORKFLOW_HISTORY_VERSION_UNPUBLISH, Ps as WORKFLOW_HISTORY_NAME_VERSION_MODAL_KEY, Pt as CHAT_TRIGGER_NODE_TYPE, Qc as EnterpriseEditionFeature, Qo as VIEWS, Qs as LOCAL_STORAGE_HIDE_GITHUB_STAR_BUTTON, Rs as WORKFLOW_PUBLISH_MODAL_KEY, S as TIME_SAVED_DOCS_URL, Tc as WorkflowStateKey, Xs as LOCAL_STORAGE_FLOATING_CHAT_WINDOW, Zo as MAIN_HEADER_TABS, g as N8N_MAIN_GITHUB_REPO_URL, hl as WORKFLOW_MENU_ACTIONS, ks as WORKFLOW_ACTIVE_MODAL_KEY, m as EVALUATIONS_DOCS_URL, nl as LOADING_ANIMATION_MIN_DURATION, p as ERROR_WORKFLOW_DOCS_URL, ps as IMPORT_WORKFLOW_URL_MODAL_KEY, ss as DUPLICATE_MODAL_KEY, t as AutoSaveState, xc as PopOutWindowKey, zs as WORKFLOW_SETTINGS_MODAL_KEY } from "./constants-fJx0oi9Z.js";
...
import { t as sanitizeFilename } from "./dist-C3UBjw65.js";
import { t as router } from "./router-CFHCG0XJ.js";
import { a as MCP_SETTINGS_VIEW, r as MCP_DOCS_PAGE_URL } from "./mcp.constants-wGBP5oh4.js";
import { n as useMoveResourceToProjectToast, t as LoadingView_default } from "./LoadingView-Yxa6rjhU.js";
import { i as getLastPublishedVersion, r as generateVersionLabelFromId } from "./utils-8TuiMq2E.js";
...
import { t as useChatStore } from "./chat.store-Dplb9e9b.js";
import { m as groupConversationsByDate, u as flattenModel } from "./fileUtils-RuusO0Y2.js";
import { t as useProvideWorkflowId } from "./useProvideWorkflowId-yu5cu_aG.js";
import { t as ChatAgentAvatar_default } from "./ChatAgentAvatar-CsCNxyJc.js";
import { t as AppSidebar_default } from "./AppSidebar-xmT-RfsS.js";
import { i as usePopOutWindow, n as useWorkflowInitialization, r as LogsPanel_default, t as usePostMessageHandler } from "./usePostMessageHandler-CU6vsuZ8.js";
import { t as usePushConnection } from "./usePushConnection-TGKvadlx.js";
import { i as useChatSession, n as ChatPrompt_default, r as ChatMessage_default, t as ChatGreetings_default } from "./ChatGreetings-Btsibs4q.js";
import { n as useFileDrop } from "./ToolsSelector-DK644SNy.js";
import { t as FolderBreadcrumbs_default } from "./FolderBreadcrumbs-BOj9yvoB.js";
import { t as ConnectionTracker_default } from "./ConnectionTracker-EUngkxZV.js";
import { t as useWorkflowSettingsCache } from "./useWorkflowsCache-D-Y9xwzt.js";
import "./usePushConnection-BwWJE9Pp.js";
...
var CanvasChatHubPanel_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props, { expose: __expose, emit: __emit }) {
		...
		async function handleEditMessage(content, keptAttachmentIndices, newFiles) {
			...
			await chatStore.editMessage(sessionId.value, editingMessageId.value, content, workflowAgent.value, {}, keptAttachmentIndices, newFiles);
			editingMessageId.value = void 0;
		}
...
var WorkflowDetails_default = /* @__PURE__ */ _plugin_vue_export_helper_default(WorkflowDetails_vue_vue_type_script_setup_true_lang_default, [["__cssModules", { "$style": WorkflowDetails_vue_vue_type_style_index_1_lang_module_default }], ["__scopeId", "data-v-1891d7fe"]]);
//#endregion
