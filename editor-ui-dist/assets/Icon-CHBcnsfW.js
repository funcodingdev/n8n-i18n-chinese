const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/node-icons-anAlH59F.js","assets/vue.runtime.esm-bundler-DYHsQBZB.js","assets/chunk-CC9Q-vWm.js"])))=>i.map(i=>d[i]);
		...
		watch(() => props.icon, async (icon) => {
			if (typeof icon === "string" && icon.startsWith("node:") && !nodeIconSetRef.value) {
				const { nodeIconSet } = await __vitePreload(async () => {
					const { nodeIconSet } = await import("./node-icons-anAlH59F.js");
					return { nodeIconSet };
