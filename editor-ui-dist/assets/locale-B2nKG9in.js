const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/en-Puo6t9Bp.js","assets/en-7Bn4ULMw.js"])))=>i.map(i=>d[i]);
import { t as en_default } from "./en-7Bn4ULMw.js";
...
async function use(l) {
	try {
		lang = (await _rolldown_dynamic_import_helper_default(/* @__PURE__ */ Object.assign({ "./lang/en.ts": () => __vitePreload(() => import("./en-Puo6t9Bp.js"), __vite__mapDeps([0,1])) }), `./lang/${l}.ts`, 3)).default;
	} catch (e) {}
}
//#endregion
export { use as n, t };
