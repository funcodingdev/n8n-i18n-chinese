...
import { Bn as useMessage, Is as useSettingsStore, Ln as useToast, at as useCredentialsStore, bl as sanitizeHtml, gr as useTelemetry, s as useWorkflowsStore, t as useUsersStore, ui as useProjectsStore } from "./users.store-bYJP9NEL.js";
import { Fs as MODAL_CONFIRM, Ii as createResultError, Li as createResultOk } from "./constants-neq36s1h.js";
...
function useQuickConnect() {
	...
	async function connectToPinecone(quickConnectOption) {
		const { ConnectPopup } = await __vitePreload(async () => {
			const { ConnectPopup: ConnectPopup$1 } = await import("./dist-B6PvWO4O.js");
