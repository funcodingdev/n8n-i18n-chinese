import { $ as openBlock, A as createTextVNode, C as createBaseVNode, Cn as toDisplayString, E as createElementBlock, Gt as unref, It as ref, N as defineComponent, S as computed, T as createCommentVNode, X as onMounted, bt as withCtx, j as createVNode, ot as resolveDirective, vn as normalizeClass, w as createBlock, xt as withDirectives } from "./vue.runtime.esm-bundler-CiTcVoZc.js";
import { s as useI18n } from "./src-w6tdcvn4.js";
import { Ga as N8nHeading_default, Ja as N8nButton_default, Q as N8nLogo_default, U as N8nNotice_default, Ya as N8nIcon_default, qa as N8nText_default } from "./src-BwN8TeVO.js";
...
import { r as MCP_DOCS_PAGE_URL } from "./mcp.constants-CjQrAkKt.js";
			...
			return openBlock(), createElementBlock("div", { class: normalizeClass(_ctx.$style.overlay) }, [createBaseVNode("div", { class: normalizeClass(_ctx.$style["consent-dialog"]) }, [
				...
				waitingForRedirect.value ? (openBlock(), createElementBlock("div", {
					...
					resourceName.value ? (openBlock(), createBlock(unref(N8nText_default), {
						...
						default: withCtx(() => [createTextVNode(toDisplayString(unref(i18n).baseText("oauth.consentView.descriptionWithWorkflow", { interpolate: { clientName: clentDetails.value?.clientName ?? "" } })), 1)]),
						_: 1
				...
				}, [errorMessage.value ? (openBlock(), createBlock(unref(N8nNotice_default), {
					key: 0,
					theme: "danger",
...
var overlay = "_overlay_k3net_125";
var header = "_header_k3net_151";
var logo = "_logo_k3net_157";
var n8n = "_n8n_k3net_166";
var content = "_content_k3net_171";
var success = "_success_k3net_178";
var footer = "_footer_k3net_210";
