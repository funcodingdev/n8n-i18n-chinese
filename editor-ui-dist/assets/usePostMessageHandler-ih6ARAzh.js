const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/pushConnection.store-DR6KUCkg.js","assets/pushConnection.store-7W9UKn7j.js","assets/vue.runtime.esm-bundler-Bs4WIMNP.js","assets/chunk-CC9Q-vWm.js","assets/src-CZLzAGVt.js","assets/get-BeCUYAIG.js","assets/_MapCache-D_HoWCyo.js","assets/merge-DOO4qqEw.js","assets/expression-runtime-stub-Ctf5Dv5M.js","assets/__vite-browser-external-DLY6DjNi.js","assets/useRootStore-BSEpDaXx.js","assets/lib-D10cRSie.js","assets/assert-dkcf3flH.js","assets/settings.store-C7bZgKnf.js","assets/useDebounce-NImUtbkS.js","assets/constants2-JUBWMnBE.js","assets/durations-D_iMA_ix.js"])))=>i.map(i=>d[i]);
...
import { E as useWorkflowDocumentStore, S as createWorkflowDocumentId, Ur as getNodesWithNormalizedPosition, mn as useProjectsStore, n as buildExecutionResponseFromSchema, t as useWorkflowsStore, xt as useCredentialsStore, y as useWorkflowExecutionStateStore } from "./workflows.store-CGzW8V-x.js";
...
import { t as isPostMessageOriginAllowed } from "./postMessageUtils-Dq-5rrTA.js";
		...
		try {
			...
			if (json && json.command === "openWorkflow") try {
				...
				const { usePushConnectionStore } = await __vitePreload(async () => {
					const { usePushConnectionStore } = await import("./pushConnection.store-DR6KUCkg.js");
