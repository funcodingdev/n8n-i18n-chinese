...
import { $ as openBlock, A as createTextVNode, Bt as toRaw, C as createBaseVNode, Cn as toDisplayString, E as createElementBlock, Gt as unref, It as ref, N as defineComponent, S as computed, T as createCommentVNode, _ as Fragment, bt as withCtx, gt as watch, j as createVNode, p as vShow, rt as renderList, vn as normalizeClass, w as createBlock, xt as withDirectives } from "./vue.runtime.esm-bundler-CiTcVoZc.js";
import { s as useI18n } from "./src-LyB2u_3c.js";
import { E as N8nUserInfo_default, Ga as N8nHeading_default, Ht as N8nLoading_default, Ja as N8nButton_default, St as TableBase_default, Ui as Input_default, d as DialogFooter_default, f as Dialog_default, gt as useRouter, ht as useRoute, k as N8nTabs_default, lt as RouterLink, m as DialogHeader_default, p as DialogTitle_default, qa as N8nText_default, st as N8nFormInput_default, zi as N8nTooltip_default } from "./src-BY3LHeey.js";
import { t as _plugin_vue_export_helper_default } from "./_plugin-vue_export-helper-Da88TEg1.js";
import { t as useMessage } from "./useMessage-CtYCtxhp.js";
import { Et as require_sortBy } from "./workflows.store-DSrFVULM.js";
import { t as useToast } from "./useToast-7r31sqLC.js";
import { Fi as MODAL_CONFIRM, li as VIEWS, ll as require_isEqual } from "./constants-CLQJMg7Y.js";
...
import { a as normalizeCoupledScopes, n as SCOPE_TYPES, t as SCOPES } from "./projectRoleScopes-BfOUIK1p.js";
//#region src/features/project-roles/RoleProjectMembersModal.vue?vue&type=script&setup=true&lang.ts
...
//#endregion
//#region src/features/project-roles/RoleAssignmentsTab.vue?vue&type=script&setup=true&lang.ts
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("div", { class: normalizeClass(["pb-xl", _ctx.$style.container]) }, [
				...
				createBaseVNode("div", { class: normalizeClass(["mb-xl", _ctx.$style.headerContainer]) }, [createBaseVNode("div", { class: normalizeClass(_ctx.$style.headingContainer) }, [createVNode(unref(N8nHeading_default), {
					...
					default: withCtx(() => [__props.roleSlug ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
						_cache[12] || (_cache[12] = createTextVNode("Role \"", -1)),
						createVNode(unref(N8nTooltip_default), {
							content: unref(form).displayName,
							placement: "bottom"
						}, {
							default: withCtx(() => [createBaseVNode("span", null, toDisplayString(unref(form).displayName), 1)]),
							_: 1
						}, 8, ["content"]),
						_cache[13] || (_cache[13] = createTextVNode("\"", -1))
					], 64)) : (openBlock(), createElementBlock(Fragment, { key: 1 }, [createTextVNode(toDisplayString(unref(i18n).baseText("projectRoles.newRole")), 1)], 64))]),
					_: 1
				}, 8, ["class"])], 2), initialState.value && !isReadOnly.value && !unref(isLoading) ? (openBlock(), createElementBlock("div", {
					key: 0,
...
var ProjectRoleView_vue_vue_type_style_index_0_lang_module_default = {
	container: "_container_qjp8b_2",
	cardContainer: "_cardContainer_qjp8b_9",
	card: "_card_qjp8b_9",
	cardTitle: "_cardTitle_qjp8b_28",
	backButton: "_backButton_qjp8b_32",
	headerContainer: "_headerContainer_qjp8b_38",
	headingContainer: "_headingContainer_qjp8b_45",
	heading: "_heading_qjp8b_45",
	headerActions: "_headerActions_qjp8b_55",
	formContainer: "_formContainer_qjp8b_61",
	presetsContainer: "_presetsContainer_qjp8b_65",
	checkbox: "_checkbox_qjp8b_70",
	assignmentsLink: "_assignmentsLink_qjp8b_78"
};
