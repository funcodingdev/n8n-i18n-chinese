...
import { r as require_get, y as useRoute } from "./truncate-6F0Ti6Sn.js";
import { D as TitledList_default, E as useNodeCredentialOptions, T as NodeCredentials_default, d as collectParametersByTab, f as collectSettings, h as getNodeSettingsInitialValues, p as createCommonNodeSettings, t as ParameterInputList_default, u as useNodeSettingsParameters, v as nameIsParameter } from "./ParameterInputList-C_JK6ow1.js";
import { n as ElRow, t as ElCol } from "./col-LaDq_ckW.js";
import { $o as useSettingsStore, An as injectWorkflowState, In as ProjectTypes, Mt as removePreviewToken, Pn as useProjectsStore, Pr as useHistoryStore, Qi as COMMUNITY_PACKAGE_INSTALL_MODAL_KEY, Ri as importCurlEventBus, Sn as useWorkflowHelpers, Ur as RenameNodeCommand, Wi as useUIStore, Yi as COMMUNITY_NODES_INSTALLATION_DOCS_URL, _ as useNDVStore, _t as useNodeTypesStore, dr as useUsersStore, en as useCredentialsStore, i as useExternalHooks, kn as useNodeHelpers, n as useToast, p as useTelemetry, v as useWorkflowsStore, vt as useActionsGenerator } from "./builder.store-DCWSVZoF.js";
import { Da as deepCopy, Ka as NodeConnectionTypes, L as CUSTOM_API_CALL_KEY, Oa as isCommunityPackageName, S as NPM_PACKAGE_DOCS_BASE_URL, Vo as VIEWS, Vt as CHAT_TRIGGER_NODE_TYPE, Wn as OPEN_URL_PANEL_TRIGGER_NODE_TYPES, Xt as DATA_TABLE_NODES, d as BUILTIN_NODES_DOCS_URL, do as OPEN_AI_API_CREDENTIAL_TYPE, ea as getNodeInputs, fn as FORM_TRIGGER_NODE_TYPE, kn as MCP_TRIGGER_NODE_TYPE, l as BASE_NODE_SURVEY_URL, na as getNodeParameters, p as CUSTOM_NODES_DOCS_URL, qn as PRODUCTION_ONLY_TRIGGER_NODE_TYPES } from "./constants-BBSiouwN.js";
import { t as useDebounce } from "./useDebounce-CTd0bHCG.js";
import { n as ndvEventBus } from "./assistant.store-DHlIYRx0.js";
import { t as useNodeCreatorStore } from "./nodeCreator.store-BdUvppHE.js";
...
import { a as useInstallNode, i as useInstalledCommunityPackage, n as CommunityNodeFooter_default, r as ContactAdministratorToInstall_default, t as CommunityNodeUpdateInfo_default } from "./CommunityNodeUpdateInfo-Djnvm-Sl.js";
