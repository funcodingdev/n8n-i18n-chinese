    ...
    */
    ...
    return {
      setters: [function (_chunkLegacy001Js) {
        ...
        PopOutWindowKey = _constantsLegacy00TJs.Xs;
        ...
        LOCAL_STORAGE_PANEL_WIDTH = _useCanvasOperationsLegacy01zJs.c;
        chatEventBus = _useCanvasOperationsLegacy01zJs.d;
        useExperimentalNdvStore = _useCanvasOperationsLegacy01zJs.i;
        LOGS_PANEL_STATE = _useCanvasOperationsLegacy01zJs.l;
        LOCAL_STORAGE_OVERVIEW_PANEL_WIDTH = _useCanvasOperationsLegacy01zJs.o;
        canvasEventBus = _useCanvasOperationsLegacy01zJs.r;
        LOCAL_STORAGE_PANEL_HEIGHT = _useCanvasOperationsLegacy01zJs.s;
        useCanvasOperations = _useCanvasOperationsLegacy01zJs.t;
        LOG_DETAILS_PANEL_STATE = _useCanvasOperationsLegacy01zJs.u;
        ...
        RunDataItemCount_default = _isEmptyLegacy021Js.r;
      ...
      }, function (_fileUtilsLegacy03pJs) {
        convertFileToBinaryData = _fileUtilsLegacy03pJs.t;
      ...
      }, function (_useLogsTreeExpandLegacy06VJs) {
        isPlaceholderLog = _useLogsTreeExpandLegacy06VJs._;
        LogsViewConsumedTokenCountText_default = _useLogsTreeExpandLegacy06VJs.a;
        restoreChatHistory = _useLogsTreeExpandLegacy06VJs.b;
        getDepth = _useLogsTreeExpandLegacy06VJs.f;
        getTotalConsumedTokens = _useLogsTreeExpandLegacy06VJs.g;
        getSubtreeTotalConsumedTokens = _useLogsTreeExpandLegacy06VJs.h;
        LogsViewNodeName_default = _useLogsTreeExpandLegacy06VJs.i;
        findLogEntryRec = _useLogsTreeExpandLegacy06VJs.l;
        getInputKey = _useLogsTreeExpandLegacy06VJs.m;
        useLogsExecutionData = _useLogsTreeExpandLegacy06VJs.n;
        getEntryAtRelativeIndex = _useLogsTreeExpandLegacy06VJs.p;
        LogsOverviewRows_default = _useLogsTreeExpandLegacy06VJs.r;
        extractBotResponse = _useLogsTreeExpandLegacy06VJs.s;
        useLogsTreeExpand = _useLogsTreeExpandLegacy06VJs.t;
        findSelectedLogEntry = _useLogsTreeExpandLegacy06VJs.u;
        isSubNodeLog = _useLogsTreeExpandLegacy06VJs.v;
        processFiles = _useLogsTreeExpandLegacy06VJs.y;
      }, function (_coreLegacy06XJs) {
        core_default = _coreLegacy06XJs.t;
      }],
      execute: function () {
