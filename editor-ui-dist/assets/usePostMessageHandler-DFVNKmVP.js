...
import { E as useWorkflowDocumentStore, S as createWorkflowDocumentId, Wr as getNodesWithNormalizedPosition, hn as useProjectsStore, n as buildExecutionResponseFromSchema, t as useWorkflowsStore, xt as useCredentialsStore, y as useWorkflowExecutionStateStore } from "./workflows.store-Dju5360D.js";
...
import { t as isPostMessageOriginAllowed } from "./postMessageUtils-DNoBmtgh.js";
		...
		try {
			...
			if (json && json.command === "openWorkflow") try {
				...
				const { usePushConnectionStore } = await __vitePreload(async () => {
					const { usePushConnectionStore } = await import("./pushConnection.store-CIoCKWeV.js");
