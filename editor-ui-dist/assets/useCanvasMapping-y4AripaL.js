...
import { _ as onKeyDown, lt as watchOnce, st as useThrottleFn, ut as watchThrottled, y as onKeyUp, yt as useI18n } from "./_MapCache-BRSIFZ-8.js";
import { At as N8nActionDropdown_default, Di as useRouter, Ei as useRoute, Fi as N8nIconButton_default, Gi as N8nButton_default, Ki as N8nIcon_default, L as N8nSticky_default, Mt as useDeviceSupport, W as N8nPopover_default, Wi as N8nText_default, bt as createEventBus, ji as N8nTooltip_default, yi as N8nLink_default } from "./src-CKCAtrpy.js";
import { t as __plugin_vue_export_helper_default } from "./_plugin-vue_export-helper-DltO58Gh.js";
import { $n as _sfc_main$3, $t as useNodeHelpers, Ar as useSourceControlStore, Ci as CanvasNodeDirtiness, Dn as useTemplatesStore, Er as useStyles, Fn as calculateNodeSize, Gr as createWorkflowDocumentId, Ir as useFocusedNodesStore, Jn as NodeId, Jr as useWorkflowDocumentStore, Kn as updateViewportToContainNodes, Nn as GRID_SIZE, Nt as environments_store_default, Qn as _sfc_main$1, Si as CanvasConnectionMode, Vn as getMousePosition, Xn as Position, Yn as PanelPosition, Zn as _sfc_main$5, ar as getConnectedEdges, at as useCredentialsStore, cr as isMacOs, dl as isOutsideSelected, dn as nodeViewEventBus, dr as wheelDelta, ea as getTriggerNodeServiceName, er as _sfc_main$d, fl as sanitizeHtml, fr as TemplateClickSource, in as injectWorkflowState, ir as getBoundsofRects, jn as DEFAULT_NODE_SIZE, js as useSettingsStore, kn as CONFIGURATION_NODE_RADIUS, lr as useGetPointerPosition, mr as trackTemplatesClick, nr as clamp, or as getRectOfNodes, pr as isExtraTemplateLinksExperimentEnabled, qn as MarkerType, qr as injectWorkflowDocumentStore, r as useUIStore, rn as useNDVStore, rr as getBezierPath, s as useWorkflowsStore, sr as getSmoothStepPath, t as useUsersStore, tr as _sfc_main$f, ur as useVueFlow, vi as isValidNodeConnectionType, w as useNodeTypesStore, wi as CanvasNodeRenderType, xa as isPresent } from "./users.store-D86YL4LK.js";
import { M as TitledList_default } from "./ParameterInputList-D2jDIpu7.js";
import { Ac as ExpressionLocalResolveContextSymbol, Bo as WEBHOOK_NODE_TYPE, Cr as WAIT_NODE_TYPE, Da as isExecutable, Dc as CanvasNodeHandleKey, Ec as CanvasKey, Gt as CHAT_TRIGGER_NODE_TYPE, I as CUSTOM_API_CALL_KEY, Lo as SEND_AND_WAIT_OPERATION, Nt as AGENT_NODE_TYPE, Oa as isHitlToolType, Oc as CanvasNodeKey, Pt as AGENT_TOOL_NODE_TYPE, Qn as PRODUCTION_ONLY_TRIGGER_NODE_TYPES, Tt as NODE_CREATOR_OPEN_SOURCES, Vo as require_isEqual, Wn as NOT_DUPLICATABLE_NODE_TYPES, Xa as isCommunityPackageName, _a as getNodeInputs, dr as SIMULATE_TRIGGER_NODE_TYPE, es as getResourcePermissions, gr as STICKY_NODE_TYPE, hn as FORM_NODE_TYPE, ka as isNodeWithWorkflowSelector, ll as CANVAS_EXECUTION_DATA_THROTTLE_DURATION, mo as NodeConnectionTypes, ua as mapConnectionsByDestination, ur as SIMULATE_NODE_TYPE, us as VIEWS, va as getNodeOutputs, wa as getSubworkflowId, zo as WAIT_INDEFINITELY } from "./constants-bR1gDMyV.js";
import { t as useAssistantStore } from "./assistant.store-VgdEjZtb.js";
import { t as useChatPanelStore } from "./chatPanel.store-Cbb_CAVO.js";
import { t as usePinnedData } from "./usePinnedData-Nwk6oEMR.js";
import { t as getNodeIconSource } from "./nodeIcon-CZIVoFoF.js";
import { c as parseCanvasConnectionHandleString, n as createCanvasConnectionHandleString, o as mapLegacyConnectionsToCanvasConnections, r as insertSpacersBetweenEndpoints, s as mapLegacyEndpointsToCanvasConnectionPort, t as checkOverlap } from "./canvas.utils-BFvfHyWG.js";
import { n as useNodeCreatorStore } from "./canvas.eventBus-Bf5MePgH.js";
...
import { r as useNodeDirtiness, t as useRunWorkflow } from "./useRunWorkflow-sKQnjkCu.js";
import { t as useCollaborationStore } from "./collaboration.store-DkO5PHzQ.js";
import { t as NodeSettings_default } from "./NodeSettings-CiVU_rRj.js";
...
import { t as NODE_CREATOR_SHORTCUT_COACHMARK_KEY } from "./useNodeCreatorShortcutCoachmark-De0wYFgO.js";
