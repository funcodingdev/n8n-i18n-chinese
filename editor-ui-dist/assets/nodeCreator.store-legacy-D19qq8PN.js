;
(function () {
  System.register(["./chunk-legacy-Re9CbdfL.js", "./vue.runtime.esm-bundler-legacy--Sn1h8On.js", "./_MapCache-legacy-CIWHOywQ.js", "./truncate-legacy-Dbhp0OXD.js", "./useTelemetry-legacy-CISk46xo.js", "./constants-legacy-DuqvrHPn.js", "./merge-legacy-CzJLk6Lz.js", "./_baseOrderBy-legacy-BoIlqV8l.js", "./useExternalHooks-legacy-DWuo7Sev.js", "./templates.store-legacy-BQe4Y3Vh.js", "./nodeIcon-legacy-BpAppslE.js"], function (_export, _context) {
    "use strict";

    var __toESM, __commonJS, computed, nextTick, ref, useI18n, useRouter, require__arrayMap, require_get, require_toString, useRoute, getThemedValue, getSampleWorkflowByTemplateId, v4_default, require__createCompounder, sortNodeCreateElements, useProjectsStore, SampleTemplates, useUIStore, useCanvasStore, isPrebuiltAgentTemplateId, isTutorialTemplateId, getPrebuiltAgents, require_upperFirst, CanvasConnectionMode, transformNodeType, useSettingsStore, updateCurrentUserSettings, isAINode, useNDVStore, useNodeTypesStore, isVueFlowConnection, STORES, getAiTemplatesCallout, isValidCanvasConnectionMode, groupItemsInSections, usePostHog, getTutorialTemplates, getRagStarterWorkflowJson, finalizeItems, getPreBuiltAgentsCalloutWithDivider, useUsersStore, useWorkflowsStore, useEvaluationStore, useTelemetry, flattenCreateElements, isValidNodeConnectionType, subcategorizeItems, searchNodes, prepareCommunityNodeDetailsViewStack, AI_CATEGORY_EMBEDDING, SCHEDULE_TRIGGER_NODE_TYPE, MERGE_NODE_TYPE, TEMPLATE_CATEGORY_AI, HUMAN_IN_THE_LOOP_CATEGORY, isCommunityPackageName, MANUAL_TRIGGER_NODE_TYPE, VIEWS, AI_CODE_NODE_TYPE, NodeConnectionTypes, CONVERT_TO_FILE_NODE_TYPE, NODE_MIN_INPUT_ITEMS_COUNT, CUSTOM_API_CALL_KEY, AI_TRANSFORM_NODE_TYPE$1, require__arrayIncludesWith, TRIGGER_NODE_CREATOR_VIEW, require__arrayIncludes, MARKDOWN_NODE_TYPE, REGULAR_NODE_CREATOR_VIEW, AGGREGATE_NODE_TYPE, AI_CATEGORY_DOCUMENT_LOADERS, DATETIME_NODE_TYPE, HITL_SUBCATEGORY, XML_NODE_TYPE, OTHER_TRIGGER_NODES_SUBCATEGORY, CODE_NODE_TYPE, CHAT_TRIGGER_NODE_TYPE, COMPRESSION_NODE_TYPE, AI_CATEGORY_AGENTS, REMOVE_DUPLICATES_NODE_TYPE, CRYPTO_NODE_TYPE, AI_CATEGORY_CHAINS, AI_TRANSFORM_NODE_TYPE, RSS_READ_NODE_TYPE, DATA_TABLE_NODE_TYPE, AI_CATEGORY_RETRIEVERS, require__cacheHas, FLOWS_CONTROL_SUBCATEGORY, PRE_BUILT_AGENTS_EXPERIMENT, EXECUTE_WORKFLOW_TRIGGER_NODE_TYPE, SPLIT_OUT_NODE_TYPE, AI_CATEGORY_TOOLS, getNodeInputs, EDIT_IMAGE_NODE_TYPE, AI_CATEGORY_LANGUAGE_MODELS, FORM_TRIGGER_NODE_TYPE, SUMMARIZE_NODE_TYPE, AI_NODE_CREATOR_VIEW, HTTP_REQUEST_NODE_TYPE, AI_WORKFLOW_TOOL_LANGCHAIN_NODE_TYPE, HTML_NODE_TYPE, AI_UNCATEGORIZED_CATEGORY, PRE_BUILT_AGENTS_MODAL_KEY, AI_CATEGORY_OUTPUTPARSER, TRANSFORM_DATA_SUBCATEGORY, require__baseFlatten, EXTRACT_FROM_FILE_NODE_TYPE, AI_CATEGORY_VECTOR_STORES, AI_SUBCATEGORY, EMAIL_IMAP_NODE_TYPE, EVALUATION_TRIGGER_NODE_TYPE, SET_NODE_TYPE, AI_CATEGORY_MEMORY, AI_CATEGORY_ROOT_NODES, AI_OTHERS_NODE_CREATOR_VIEW, EMAIL_SEND_NODE_TYPE, SPLIT_IN_BATCHES_NODE_TYPE, AI_CATEGORY_TEXT_SPLITTERS, AI_CATEGORY_MCP_NODES, FILTER_NODE_TYPE, AI_CODE_TOOL_LANGCHAIN_NODE_TYPE, IF_NODE_TYPE, CORE_NODES_CATEGORY, LIMIT_NODE_TYPE, NODE_CREATOR_OPEN_SOURCES, require__SetCache, HELPERS_SUBCATEGORY, WEBHOOK_NODE_TYPE, DEFAULT_SUBCATEGORY, require__baseUnary, require__baseRest, require_isArrayLikeObject, defineStore, useRootStore, useExternalHooks, useTemplatesStore, getNodeIconSource, require__baseDifference, require_difference, require_capitalize, require_camelCase, import_camelCase, KEYBOARD_ID_ATTR, WATCHED_KEYS, useKeyboardNavigation, __virtual_node_popularity_data_default, import_difference, nodePopularityMap, useViewStacks, import_get, useNodeCreatorStore;
    //#endregion
    ...
    function RegularView(nodes) {
      const i18n = useI18n();
      const popularItemsSubcategory = [SET_NODE_TYPE, CODE_NODE_TYPE, DATA_TABLE_NODE_TYPE, DATETIME_NODE_TYPE, AI_TRANSFORM_NODE_TYPE$1];
        ...
        items: [{
          ...
          properties: {
            ...
            sections: [{
              key: "popular",
              title: i18n.baseText("nodeCreator.sectionNames.popular"),
              items: [HTTP_REQUEST_NODE_TYPE, WEBHOOK_NODE_TYPE, CODE_NODE_TYPE, DATA_TABLE_NODE_TYPE]
            }]
          }
        }, {
          type: "subcategory",
    ...
    */
    ...
    return {
      setters: [function (_chunkLegacy001Js) {
        ...
        require__createCompounder = _useTelemetryLegacy00HJs.Bt;
        sortNodeCreateElements = _useTelemetryLegacy00HJs.Ct;
        ...
        getPrebuiltAgents = _useTelemetryLegacy00HJs.Ot;
        ...
        updateCurrentUserSettings = _useTelemetryLegacy00HJs.Xo;
        isAINode = _useTelemetryLegacy00HJs._t;
        useNDVStore = _useTelemetryLegacy00HJs.a;
        useNodeTypesStore = _useTelemetryLegacy00HJs.at;
        isVueFlowConnection = _useTelemetryLegacy00HJs.br;
        STORES = _useTelemetryLegacy00HJs.cc;
        getAiTemplatesCallout = _useTelemetryLegacy00HJs.ft;
        isValidCanvasConnectionMode = _useTelemetryLegacy00HJs.gr;
        groupItemsInSections = _useTelemetryLegacy00HJs.gt;
        usePostHog = _useTelemetryLegacy00HJs.i;
        getTutorialTemplates = _useTelemetryLegacy00HJs.jt;
        getRagStarterWorkflowJson = _useTelemetryLegacy00HJs.kt;
        finalizeItems = _useTelemetryLegacy00HJs.lt;
        getPreBuiltAgentsCalloutWithDivider = _useTelemetryLegacy00HJs.mt;
        ...
        subcategorizeItems = _useTelemetryLegacy00HJs.wt;
        searchNodes = _useTelemetryLegacy00HJs.xt;
        prepareCommunityNodeDetailsViewStack = _useTelemetryLegacy00HJs.yt;
      }, function (_constantsLegacy00TJs) {
        AI_CATEGORY_EMBEDDING = _constantsLegacy00TJs.$;
        SCHEDULE_TRIGGER_NODE_TYPE = _constantsLegacy00TJs.$n;
        MERGE_NODE_TYPE = _constantsLegacy00TJs.An;
        TEMPLATE_CATEGORY_AI = _constantsLegacy00TJs.At;
        HUMAN_IN_THE_LOOP_CATEGORY = _constantsLegacy00TJs.Ct;
        isCommunityPackageName = _constantsLegacy00TJs.Da;
        MANUAL_TRIGGER_NODE_TYPE = _constantsLegacy00TJs.Dn;
        VIEWS = _constantsLegacy00TJs.Fo;
        AI_CODE_NODE_TYPE = _constantsLegacy00TJs.Ft;
        NodeConnectionTypes = _constantsLegacy00TJs.Ga;
        CONVERT_TO_FILE_NODE_TYPE = _constantsLegacy00TJs.Gt;
        NODE_MIN_INPUT_ITEMS_COUNT = _constantsLegacy00TJs.J;
        CUSTOM_API_CALL_KEY = _constantsLegacy00TJs.L;
        AI_TRANSFORM_NODE_TYPE$1 = _constantsLegacy00TJs.Lt;
        require__arrayIncludesWith = _constantsLegacy00TJs.Mi;
        TRIGGER_NODE_CREATOR_VIEW = _constantsLegacy00TJs.Mt;
        require__arrayIncludes = _constantsLegacy00TJs.Ni;
        MARKDOWN_NODE_TYPE = _constantsLegacy00TJs.On;
        REGULAR_NODE_CREATOR_VIEW = _constantsLegacy00TJs.Ot;
        AGGREGATE_NODE_TYPE = _constantsLegacy00TJs.Pt;
        AI_CATEGORY_DOCUMENT_LOADERS = _constantsLegacy00TJs.Q;
        DATETIME_NODE_TYPE = _constantsLegacy00TJs.Qt;
        HITL_SUBCATEGORY = _constantsLegacy00TJs.St;
        XML_NODE_TYPE = _constantsLegacy00TJs.Tr;
        OTHER_TRIGGER_NODES_SUBCATEGORY = _constantsLegacy00TJs.Tt;
        CODE_NODE_TYPE = _constantsLegacy00TJs.Ut;
        CHAT_TRIGGER_NODE_TYPE = _constantsLegacy00TJs.Vt;
        COMPRESSION_NODE_TYPE = _constantsLegacy00TJs.Wt;
        AI_CATEGORY_AGENTS = _constantsLegacy00TJs.X;
        REMOVE_DUPLICATES_NODE_TYPE = _constantsLegacy00TJs.Xn;
        CRYPTO_NODE_TYPE = _constantsLegacy00TJs.Yt;
        AI_CATEGORY_CHAINS = _constantsLegacy00TJs.Z;
        AI_TRANSFORM_NODE_TYPE = _constantsLegacy00TJs.Za;
        RSS_READ_NODE_TYPE = _constantsLegacy00TJs.Zn;
        DATA_TABLE_NODE_TYPE = _constantsLegacy00TJs.Zt;
        AI_CATEGORY_RETRIEVERS = _constantsLegacy00TJs.at;
        require__cacheHas = _constantsLegacy00TJs.bo;
        FLOWS_CONTROL_SUBCATEGORY = _constantsLegacy00TJs.bt;
        PRE_BUILT_AGENTS_EXPERIMENT = _constantsLegacy00TJs.cc;
        EXECUTE_WORKFLOW_TRIGGER_NODE_TYPE = _constantsLegacy00TJs.cn;
        SPLIT_OUT_NODE_TYPE = _constantsLegacy00TJs.cr;
        AI_CATEGORY_TOOLS = _constantsLegacy00TJs.ct;
        getNodeInputs = _constantsLegacy00TJs.ea;
        EDIT_IMAGE_NODE_TYPE = _constantsLegacy00TJs.en;
        AI_CATEGORY_LANGUAGE_MODELS = _constantsLegacy00TJs.et;
        FORM_TRIGGER_NODE_TYPE = _constantsLegacy00TJs.fn;
        SUMMARIZE_NODE_TYPE = _constantsLegacy00TJs.fr;
        AI_NODE_CREATOR_VIEW = _constantsLegacy00TJs.ft;
        HTTP_REQUEST_NODE_TYPE = _constantsLegacy00TJs.gn;
        AI_WORKFLOW_TOOL_LANGCHAIN_NODE_TYPE = _constantsLegacy00TJs.gt;
        HTML_NODE_TYPE = _constantsLegacy00TJs.hn;
        AI_UNCATEGORIZED_CATEGORY = _constantsLegacy00TJs.ht;
        PRE_BUILT_AGENTS_MODAL_KEY = _constantsLegacy00TJs.is;
        AI_CATEGORY_OUTPUTPARSER = _constantsLegacy00TJs.it;
        TRANSFORM_DATA_SUBCATEGORY = _constantsLegacy00TJs.jt;
        require__baseFlatten = _constantsLegacy00TJs.li;
        EXTRACT_FROM_FILE_NODE_TYPE = _constantsLegacy00TJs.ln;
        AI_CATEGORY_VECTOR_STORES = _constantsLegacy00TJs.lt;
        AI_SUBCATEGORY = _constantsLegacy00TJs.mt;
        EMAIL_IMAP_NODE_TYPE = _constantsLegacy00TJs.nn;
        EVALUATION_TRIGGER_NODE_TYPE = _constantsLegacy00TJs.no;
        SET_NODE_TYPE = _constantsLegacy00TJs.nr;
        AI_CATEGORY_MEMORY = _constantsLegacy00TJs.nt;
        AI_CATEGORY_ROOT_NODES = _constantsLegacy00TJs.ot;
        AI_OTHERS_NODE_CREATOR_VIEW = _constantsLegacy00TJs.pt;
        EMAIL_SEND_NODE_TYPE = _constantsLegacy00TJs.rn;
        SPLIT_IN_BATCHES_NODE_TYPE = _constantsLegacy00TJs.sr;
        AI_CATEGORY_TEXT_SPLITTERS = _constantsLegacy00TJs.st;
        AI_CATEGORY_MCP_NODES = _constantsLegacy00TJs.tt;
        FILTER_NODE_TYPE = _constantsLegacy00TJs.un;
        AI_CODE_TOOL_LANGCHAIN_NODE_TYPE = _constantsLegacy00TJs.ut;
        IF_NODE_TYPE = _constantsLegacy00TJs.vn;
        CORE_NODES_CATEGORY = _constantsLegacy00TJs.vt;
        LIMIT_NODE_TYPE = _constantsLegacy00TJs.wn;
        NODE_CREATOR_OPEN_SOURCES = _constantsLegacy00TJs.wt;
        require__SetCache = _constantsLegacy00TJs.xo;
        HELPERS_SUBCATEGORY = _constantsLegacy00TJs.xt;
        WEBHOOK_NODE_TYPE = _constantsLegacy00TJs.yr;
        DEFAULT_SUBCATEGORY = _constantsLegacy00TJs.yt;
      }, function (_mergeLegacy00VJs) {
        require__baseUnary = _mergeLegacy00VJs.T;
        require__baseRest = _mergeLegacy00VJs.r;
        require_isArrayLikeObject = _mergeLegacy00VJs.u;
        ...
        _export("d", useViewStacks = defineStore("nodeCreatorViewStacks", () => {
          ...
          const activeStackItems = computed(() => {
            ...
            if (stack.search && searchBaseItems.value) {
              ...
              const searchResults = finalizeItems(searchNodes(stack.search || "", searchBase, {
          ...
          const globalSearchItemsDiff = computed(() => {
            ...
            let globalSearchResult = finalizeItems(searchNodes(stack.search || "", filteredNodes, {
              popularity: nodePopularityMap
            }));
