...
import { Y as useThrottleFn, at as useI18n } from "./core-DJhPBFhT.js";
import { A as N8nResizeWrapper_default, Di as N8nTooltip_default, Pt as useDeviceSupport, Qi as N8nIcon_default, Xi as N8nText_default, xt as createEventBus } from "./src-DJ-D-s3W.js";
import { t as _plugin_vue_export_helper_default } from "./_plugin-vue_export-helper-Da88TEg1.js";
import { At as ndvEventBus, Fn as useStyles, Ft as dataPinningEventBus, In as useExternalHooks, Ln as useMessage, aa as injectWorkflowDocumentStore, fr as useTelemetry, gr as useNDVStore, jt as nodeViewEventBus, lr as useNodeHelpers, r as useUIStore, s as useWorkflowsStore, vr as useStorage, w as useNodeTypesStore } from "./users.store-Cuk0qvvE.js";
import { o as InputPanel_default } from "./ParameterInputList-B0I42Abk.js";
import { t as ElDialog } from "./dialog-BmTZay0C.js";
import { Qt as EXECUTABLE_TRIGGER_NODE_TYPES, Ra as jsonParse, eo as NodeConnectionTypes, i as BASE_NODE_SURVEY_URL, ra as getNodeOutputs, rc as LOCAL_STORAGE_MAIN_PANEL_RELATIVE_WIDTH, w as APP_MODALS_ELEMENT_ID } from "./constants-fJx0oi9Z.js";
...
import { n as OutputPanel_default, r as NDVFloatingNodes_default, t as TriggerPanel_default } from "./TriggerPanel-DXlz14La.js";
	...
	setup(__props, { emit: __emit }) {
		...
		const parentNode = computed(() => {
			for (const parent of parentNodes.value) {
				if (workflowDocumentStore?.value?.pinData?.[parent.name]) return parent;
