...
import { i as COMPUTER_USE_CONNECTION_TYPE, t as BROWSER_USE_CONNECTION_TYPE } from "./constants-D5OEjQEP.js";
import { t as useInstanceAiSettingsStore } from "./instanceAiSettings.store-BcRbd84j.js";
import { i as TOOL_CONNECTION_CREDENTIAL_ADAPTER_KEY, o as hasToolConnection } from "./ToolIcon-BbwTPlls.js";
import { n as McpDetailBody_default, r as DefaultDetailBody_default, t as ToolsConnectionModal_default } from "./ToolsConnectionModal-iVwNcZMR.js";
import { t as McpRegistrySuggestionFooter_default } from "./McpRegistrySuggestionFooter-CYkUghtV.js";
import { n as useInstanceAiMcpConnectionsExperiment, t as useInstanceAiComputerUseExperiment } from "./instanceAiComputerUse-z1uPnbCg.js";
...
import { i as useInstanceAiBrowserUseTelemetry } from "./useExtensionDirectConnect-2feIiQCQ.js";
import { t as useMcpServerConnect } from "./useMcpServerConnect-CSE11ZR6.js";
import { t as BrowserUseSetupContent_default } from "./BrowserUseSetupContent-DCduHdC7.js";
import { t as ComputerUseSetupContent_default } from "./ComputerUseSetupContent-Z_pIH1kv.js";
	...
	setup(__props) {
		...
		provide(TOOL_CONNECTION_CREDENTIAL_ADAPTER_KEY, createCredentialAdapter((authType, item, credentialTypes) => {
			(async () => {
				...
				showConnectedServer(await connectServer({
					slug: server.slug,
		...
		async function handleConnect(item) {
			...
			if (server && credentialType) showConnectedServer(await connectServer({
				slug: server.slug,
				credentialType
			}));
		}
		return (_ctx, _cache) => {
			return openBlock(), createBlock(ToolsConnectionModal_default, {
				...
				"suggestion-footer": withCtx(() => [createVNode(McpRegistrySuggestionFooter_default, {
					prompt: unref(i18n).baseText("instanceAi.connections.modal.suggestion.prompt"),
					action: unref(i18n).baseText("instanceAi.connections.modal.suggestion.action")
