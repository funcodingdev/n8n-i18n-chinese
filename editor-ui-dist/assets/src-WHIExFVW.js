import { $n as ZodReadonly, Gn as ZodArray, Jn as ZodLazy, Kn as ZodCatch, Qn as ZodOptional, Xn as ZodNullable, Yn as ZodNonOptional, Zn as ZodObject, ar as boolean, cr as object, dr as union, er as ZodRecord, fr as unknown, ir as array, lr as record, nr as ZodUnion, or as literal, qn as ZodDefault, rr as _enum, sr as number, tr as ZodType, ur as string } from "./src-JwBmTNgK.js";
...
var INSTANCE_TELEMETRY = defineTelemetryEvents({
	INSTANCE_STARTED: {
	...
	INSTANCE_REFUSED_DURABLE_POLLERS: {
		...
		properties: object({
			workflow_ids: array(string()).describe("Active workflows whose published version failed the trigger node id check"),
			deleted_cursor_rows: number().describe("How many poller_state rows of the offending workflows were deleted")
		})
	}
});
//#endregion
