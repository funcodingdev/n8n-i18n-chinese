...
import { $ as openBlock, A as createTextVNode, Bt as toRef, C as createBaseVNode, E as createElementBlock, Ft as ref, N as defineComponent, Rt as shallowRef, S as computed, Sn as toDisplayString, T as createCommentVNode, U as mergeProps, W as nextTick, Wt as unref, _ as Fragment, _n as normalizeClass, gt as watch, h as withModifiers, j as createVNode, pt as useTemplateRef, rt as renderList, w as createBlock, yn as normalizeStyle, yt as withCtx } from "./vue.runtime.esm-bundler-dg1EVmSK.js";
import { H as useVirtualList, V as useTimestamp, bt as useI18n, ct as useThrottleFn, m as require_isArray, xt as I18nT } from "./_MapCache-BFpNgXhv.js";
import { $i as N8nIcon_default, Ii as N8nIconButton_default, Mi as N8nTooltip_default, Qi as N8nButton_default, Zi as N8nText_default, _t as useRouter, v as require_get } from "./src-C1Fv__jy.js";
import { t as __plugin_vue_export_helper_default } from "./_plugin-vue_export-helper-DltO58Gh.js";
import { $t as useNodeHelpers, Tr as useToast, c as addTokenUsageData, d as isChatNode, in as injectWorkflowState, l as emptyTokenUsageData, s as useWorkflowsStore, tt as require_upperFirst, u as formatTokenUsageCount, ua as parse, w as useNodeTypesStore } from "./users.store-Bu2w-Rub.js";
import { Gt as CHAT_TRIGGER_NODE_TYPE, Jo as require__baseKeys, Ko as require__getTag, Li as parseErrorMetadata, Pi as Workflow, Uo as v4_default, ho as NodeConnectionTypes, jn as MANUAL_CHAT_TRIGGER_NODE_TYPE, oa as createEmptyRunExecutionData, sa as createRunExecutionData, yl as LOGS_EXECUTION_DATA_THROTTLE_DURATION, yo as AGENT_LANGCHAIN_NODE_TYPE } from "./constants-B8dhY4J-.js";
import { A as require_isArguments, S as require__isPrototype, b as require_isArrayLike, k as require_isBuffer, w as require_isTypedArray } from "./merge-B2S5Sbon.js";
import { w as TOOL_EXECUTOR_NODE_NAME } from "./_baseOrderBy-BvZrFzTC.js";
import { t as NodeIcon_default } from "./NodeIcon-DJtG-u9g.js";
import { t as useRunWorkflow } from "./useRunWorkflow-DngvZa95.js";
import { a as toTime, i as toDayMonth } from "./dateFormatter-CpP8aweo.js";
import { t as useChatHubPanelStore } from "./chatHubPanel.store-DC1Qavvq.js";
import { t as AnimatedSpinner_default } from "./AnimatedSpinner-39OaIjP3.js";
...
function useLogsExecutionData({ isEnabled, filter } = {}) {
	...
	const hasChat = computed(() => {
		if (chatHubPanelStore.isFloatingChatEnabled) {
			if (workflowsStore.workflow.nodes.some((node) => node.type === "@n8n/n8n-nodes-langchain.chatTrigger" && node.parameters?.availableInChat === true)) return false;
		}
		return [Object.values(workflow.value?.nodes ?? {}), workflowsStore.workflow.nodes].some((nodes) => nodes.some(isChatNode));
	});
...
export { restoreChatHistory as _, LogsViewConsumedTokenCountText_default as a, findLogEntryRec as c, getDepth as d, getEntryAtRelativeIndex as f, isSubNodeLog as g, isPlaceholderLog as h, LogsViewNodeName_default as i, findSelectedLogEntry as l, getTotalConsumedTokens as m, useLogsExecutionData as n, ConsumedTokensDetails_default as o, getSubtreeTotalConsumedTokens as p, LogsOverviewRows_default as r, findLogEntryById as s, useLogsTreeExpand as t, getConsumedTokens as u };
