const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/workers-DCKZajG6.js","assets/comlink-FqvHZGnu.js"])))=>i.map(i=>d[i]);
...
import { _ as addNodeTranslation, g as addHeaders, v as i18n, x as useI18n } from "./_MapCache-aHDyP5Mf.js";
import { ia as truncate, q as isBinary } from "./src-BPgPnOl4.js";
import { d as __vitePreload, s as require_memoize, t as require_get } from "./get-RRgzF5vD.js";
import { M as createEventHook, R as throttledWatch, y as useLocalStorage } from "./dist-BkE9aYmt.js";
import { c as sanitizeHtml, g as useRoute } from "./htmlUtils-BREJ7rCe.js";
...
import { Ar as displayParameter, Bn as isTrimmedNodeExecutionData, Dr as getChildNodes, Fr as getNodeParameters, Ft as require_pick, Jt as Workflow, Lr as getNodeWebhookUrl, Mi as ExpressionError, Mr as getConnectionTypes, Nr as getNodeInputs, Pi as UnexpectedError, Pr as getNodeOutputs, Qn as createRunExecutionData, Qr as nodeIssuesToString, Tr as mapConnectionsByDestination, Ui as CHAT_TRIGGER_NODE_TYPE, Vt as isAssignmentCollectionValue, Wr as isHitlToolType, Wt as normalizeNodeShape, Zn as createEmptyRunExecutionData, _i as traverseNodeParameters, _n as require__baseFindIndex, aa as SEND_AND_WAIT_OPERATION, cn as normalizeGroupDescription, da as require_isEqual, di as isResourceLocatorValue, fi as isResourceMapperValue$1, hi as nodeConnectionTypes, ii as isFilterValue, jr as displayParameterPath, ki as sleep$1, kr as checkConditions, la as v4, mi as NodeConnectionTypes, mn as require__baseUniq, na as MANUAL_TRIGGER_NODE_TYPE, pa as require_keys, pn as splitExpression, sa as WAIT_INDEFINITELY, tn as require__baseIteratee, vi as isExpression, wr as resolveVariables, xa as getResourcePermissions, xi as deepCopy } from "./src-CBdY4Anf.js";
import { b as require_isArrayLike, t as require_merge } from "./merge-BFzQnTDU.js";
...
import { Ca as WorkflowIdKey, D as TEMPLATES_NODES_FILTER, Dt as AI_MCP_TOOL_NODE_TYPE, F as CUSTOM_API_CALL_KEY, G as AI_CATEGORY_HUMAN_IN_THE_LOOP, I as DATA_TYPE_ICON_MAP, Jt as ERROR_TRIGGER_NODE_TYPE$1, Lr as MAIN_HEADER_TABS, M as IN_PROGRESS_EXECUTION_ID, N as PLACEHOLDER_FILLED_AT_EXECUTION_TIME, Ot as AI_TRANSFORM_NODE_TYPE, Pn as SCHEDULE_TRIGGER_NODE_TYPE, R as MAPPING_PARAMS, Rt as CREDENTIAL_ONLY_NODE_PREFIX, Sa as WorkflowDocumentStoreKey, V as AI_CATEGORY_AGENTS, Va as INLINE_AGENTS_EXPERIMENT, Xn as WIKIPEDIA_TOOL_NODE_TYPE, Y as AI_CATEGORY_OTHER_TOOLS, Yn as WEBHOOK_NODE_TYPE$1, Zn as WORKFLOW_TRIGGER_NODE_TYPE, _n as MODULE_ENABLED_NODES, _t as RECOMMENDED_NODES, ct as BETA_NODES, do as EnterpriseEditionFeature, ft as HITL_SUBCATEGORY, ga as CanvasRenderDataKey, hn as MESSAGE_AN_AGENT_NODE_TYPE, i as DUPLICATE_POSTFFIX, ln as LIST_LIKE_NODE_OPERATIONS, lt as CORE_NODES_CATEGORY, nt as AI_CODE_TOOL_LANGCHAIN_NODE_TYPE, pt as HUMAN_IN_THE_LOOP_CATEGORY, q as AI_CATEGORY_MCP_NODES, r as DEFAULT_SETTINGS, rn as HTTP_REQUEST_NODE_TYPE, tn as FORM_TRIGGER_NODE_TYPE$1, tt as AI_CATEGORY_VECTOR_STORES, xn as NON_ACTIVATABLE_TRIGGER_NODE_TYPES, yn as NODE_POSITION_CONFLICT_ALLOWLIST } from "./constants-Bgf3Pq_r.js";
import { i as require_toNumber } from "./useDebounce-Cc58bOKS.js";
import { b as isObject$1, d as isJsonKeyObject, f as isPresent, g as stringSizeInBytes, h as shorten, l as isEmpty, m as omit, y as getObjectSizeInKB } from "./typesUtils-BUgUdJt2.js";
import { a as getNewWorkflow, i as getLastSuccessfulExecution, l as getWorkflows, n as useFavoritesStore, r as getExecutionData, t as useWorkflowsListStore } from "./workflowsList.store-CeHst9VC.js";
import { $t as CANCELLABLE_EXECUTION_STATUSES, n as useUIStore } from "./ui.store-BHVXHgyY.js";
import { c as hasRole, t as hasPermission } from "./permissions-DjpH8d0Q.js";
import { o as require_startCase, t as useEvaluationStore } from "./evaluation.store-C27rZCjs.js";
import { n as noCase } from "./dist-DG7MC1Nr.js";
import { t as require_sortBy } from "./sortBy-Bf44Gwgu.js";
	...
	const loadNodesInformationFromLocalDb = async (nodeInfos) => {
		try {
			const { getNodeType } = await __vitePreload(async () => {
				const { getNodeType } = await import("./workers-DCKZajG6.js");
				return { getNodeType };
			}, __vite__mapDeps([0,1]));
			const found = [];
			const missing = [];
	...
	const loadNodeTypesFromLocalDb = async () => {
		try {
			const { loadNodeTypes, getAllNodeTypes } = await __vitePreload(async () => {
				const { loadNodeTypes, getAllNodeTypes } = await import("./workers-DCKZajG6.js");
				return {
					loadNodeTypes,
					getAllNodeTypes
				};
