...
import { $t as useRouteWorkflowId, At as getBuilderCredits, D as injectWorkflowDocumentStore, Dt as clearBuilderSession, Et as chatWithBuilder, Mt as truncateBuilderMessages, Nt as useAIAssistantHelpers, Qt as useWorkflowHelpers, T as createWorkflowDocumentId, V as useNodeTypesStore, en as useWorkflowId, ji as isDebouncedFunction, k as useWorkflowDocumentStore, kt as getAiSessions, t as useWorkflowsStore, un as useNDVStore, y as useWorkflowExecutionStateStore, yn as useSourceControlStore } from "./workflows.store-JWtScvRR.js";
import { Ci as isExpression, Ea as getResourcePermissions, Ti as dedupe, in as validateNodeSelectionForGrouping } from "./src-B255AdRt.js";
import { a as getWorkflowVersion, ar as STORES, cr as defineStore, i as getWorkflowHistory, mn as getFirstAdoptionDate, o as getWorkflowVersionsByIds, r as getPublishTimeline, s as updateWorkflowHistoryVersion, t as useRootStore, yt as updateNpsSurveyState } from "./useRootStore-CLEJA2KF.js";
...
import { Ei as LOCAL_STORAGE_BROWSER_NOTIFICATION_METADATA, Sa as CODE_WORKFLOW_BUILDER_EXPERIMENT, Ua as MERGE_ASK_BUILD_EXPERIMENT, ai as MODAL_CONFIRM, ca as EditorEnabledFeaturesKey, ii as MODAL_CLOSE, ja as FOCUSED_NODES_EXPERIMENT, ri as MODAL_CANCEL, si as NPS_SURVEY_MODAL_KEY, t as AutoSaveState } from "./constants-CMdL1Kzl.js";
...
import { a as BUILDER_ENABLED_VIEWS, r as useChatPanelStateStore, t as useCodeDiff } from "./useCodeDiff-ByjDXvfS.js";
import { t as getDebounceTime } from "./useDebounce-BffpVo23.js";
import { _ as tryToParseNumber, h as stringSizeInBytes } from "./typesUtils-XxdBySCt.js";
import { a as getNewWorkflow, t as useWorkflowsListStore } from "./workflowsList.store-y-0nsqzo.js";
