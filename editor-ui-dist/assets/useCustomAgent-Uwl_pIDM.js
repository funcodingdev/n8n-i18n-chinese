import { $ as openBlock, A as createTextVNode, C as createBaseVNode, E as createElementBlock, Ft as ref, Ht as toValue, N as defineComponent, S as computed, Sn as toDisplayString, T as createCommentVNode, Wt as unref, X as onMounted, _ as Fragment, _n as normalizeClass, gt as watch, h as withModifiers, j as createVNode, pt as useTemplateRef, rt as renderList, w as createBlock, yn as normalizeStyle, yt as withCtx } from "./vue.runtime.esm-bundler-dg1EVmSK.js";
import { yt as useI18n } from "./_MapCache-BRSIFZ-8.js";
import { Fi as N8nIconButton_default, Gi as N8nButton_default, Ki as N8nIcon_default, Wi as N8nText_default, ji as N8nTooltip_default, n as DropdownMenu_default, zi as truncateBeforeLast$1 } from "./src-CKCAtrpy.js";
import { t as __plugin_vue_export_helper_default } from "./_plugin-vue_export-helper-DltO58Gh.js";
import { Ft as useProjectsStore, at as useCredentialsStore, en as useTelemetry, js as useSettingsStore, r as useUIStore, w as useNodeTypesStore } from "./users.store-D86YL4LK.js";
import { es as getResourcePermissions, li as PROVIDER_CREDENTIAL_TYPE_MAP, pi as chatHubLLMProviderSchema } from "./constants-bR1gDMyV.js";
import { t as NodeIcon_default } from "./NodeIcon-0TqcYO8t.js";
import { n as truncateBeforeLast } from "./dist-cnDca9TH.js";
import { _ as TOOLS_MANAGER_MODAL_KEY, d as LLM_AGGREGATORS, f as MAX_AGENT_NAME_CHARS, g as NEW_AGENT_MENU_ID, i as CHAT_MODEL_BY_ID_SELECTOR_MODAL_KEY, m as MAX_FLATTENED_SEARCH_RESULTS_PER_PROVIDER, p as MAX_AGENT_NAME_CHARS_MENU, r as CHAT_CREDENTIAL_SELECTOR_MODAL_KEY, v as TOOL_SETTINGS_MODAL_KEY, y as providerDisplayNames } from "./constants-CrjCGXcB.js";
import { C as workflowAgentDefaultIcon, a as createFakeAgent, g as isLlmProviderModel, l as flattenModel, p as isAllowedModel, t as useChatStore, u as fromStringToModel, x as stringifyModel, y as personalAgentDefaultIcon } from "./chat.store--01BHvRB.js";
...
export { ModelSelector_default as i, useFileDrop as n, ToolsSelector_default as r, useCustomAgent as t };
