import { $ as openBlock, A as createTextVNode, C as createBaseVNode, Cn as toDisplayString, E as createElementBlock, Gt as unref, It as ref, N as defineComponent, S as computed, X as onMounted, _ as Fragment, bt as withCtx, j as createVNode, q as onBeforeUnmount, vn as normalizeClass, w as createBlock } from "./vue.runtime.esm-bundler-Bs4WIMNP.js";
import { s as useI18n } from "./src-CvPjLYa0.js";
import { Ga as N8nHeading_default, Ja as N8nButton_default, Ya as N8nIcon_default, qa as N8nText_default } from "./src-CSWS3PCK.js";
	...
	setup(__props) {
		...
		return (_ctx, _cache) => {
			return openBlock(), createBlock(Modal_default, {
				...
				content: withCtx(() => [createBaseVNode("div", { class: normalizeClass(_ctx.$style.body) }, [createBaseVNode("div", { class: normalizeClass(_ctx.$style.header) }, [createVNode(unref(N8nHeading_default), {
					tag: "h2",
					size: "large",
					...
					_: 1
				}, 8, ["class"])], 2), isConnected.value ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [createBaseVNode("div", { class: normalizeClass(_ctx.$style.statusRow) }, [createBaseVNode("span", { class: normalizeClass([_ctx.$style.statusDot, _ctx.$style.statusDotConnected]) }, null, 2), createVNode(unref(N8nText_default), {
					size: "small",
					bold: true
				}, {
					...
					_: 1
				}, 8, ["class"])], 64)) : (openBlock(), createElementBlock(Fragment, { key: 1 }, [
...
var BrowserUseSetupModal_vue_vue_type_style_index_0_lang_module_default = {
	body: "_body_1ggal_125",
	header: "_header_1ggal_132",
	title: "_title_1ggal_139",
	description: "_description_1ggal_144",
	step: "_step_1ggal_149",
	statusRow: "_statusRow_1ggal_159",
	statusDot: "_statusDot_1ggal_165",
	statusDotConnected: "_statusDotConnected_1ggal_172",
	waitingRow: "_waitingRow_1ggal_176"
};
