...
import { T as useStorage, at as useI18n, u as useDocumentVisibility, v as useLocalStorage } from "./core-Beh0t8_q.js";
import { Bi as DropdownMenuTrigger_default, Ct as createEventBus, D as SuggestedActions_default, Fi as AskAssistantButton_default, Hi as DropdownMenuItem_default, Lt as N8nBadge_default, N as N8nRadioButtons_default, Pi as N8nIconButton_default, Pt as N8nActionDropdown_default, S as N8nUserStack_default, Ui as DropdownMenuContent_default, Vi as DropdownMenuPortal_default, W as N8nTag_default, Wi as DropdownMenuRoot_default, aa as useForwardExpose, h as N8nInlineTextEdit_default, ha as N8nIcon_default, ki as N8nTooltip_default, lt as useRoute, m as N8nScrollArea_default, ma as N8nButton_default, mt as N8nFloatingWindow_default, n as DropdownMenu_default, pa as N8nText_default, rt as RouterLink, ta as Primitive, ut as useRouter, vi as AskAssistantAvatar_default } from "./src-Dg8CDsvD.js";
import { d as __vitePreload } from "./get-Den8eczo.js";
import { t as _plugin_vue_export_helper_default } from "./_plugin-vue_export-helper-Da88TEg1.js";
import { t as useMessage } from "./useMessage-7ZvpkKZ5.js";
import { $t as createWorkflowDocumentId, Br as hasPermission, E as useEvaluationStore, Jt as useTelemetry, Kt as useProjectsStore, Pt as useTagsStore, Qt as useNDVStore, Vt as ResourceType, Xt as telemetry, Yr as ProjectTypes, _i as getActivatableTriggerNodes, nn as useWorkflowDocumentStore, qt as useFavoritesStore, r as useUIStore, s as useWorkflowsStore, t as useUsersStore, tn as injectWorkflowDocumentStore, w as useNodeTypesStore, zr as useSourceControlStore, zt as useWorkflowsListStore } from "./users.store-Zd_8U4jS.js";
import { r as getBannerRowHeight, t as useToast } from "./useToast-DG5hVw1V.js";
import { t as BaseLayout_default } from "./BaseLayout-iVpWi2e3.js";
import { Ac as WorkflowDocumentStoreKey, Ai as WORKFLOW_SETTINGS_MODAL_KEY, Mc as WorkflowStateKey, Oc as PopOutWindowKey, Oi as WORKFLOW_HISTORY_VERSION_UNPUBLISH, Pt as CHAT_TRIGGER_NODE_TYPE, Rr as MAIN_HEADER_TABS, S as TIME_SAVED_DOCS_URL, Sl as WORKFLOW_MENU_ACTIONS, Ti as WORKFLOW_HISTORY_NAME_VERSION_MODAL_KEY, Ui as LOCAL_STORAGE_HIDE_GITHUB_STAR_BUTTON, Vi as LOCAL_STORAGE_FLOATING_CHAT_WINDOW, Yr as DUPLICATE_MODAL_KEY, Ys as v4, al as EnterpriseEditionFeature, bi as WORKFLOW_ACTIVE_MODAL_KEY, fc as getResourcePermissions, g as N8N_MAIN_GITHUB_REPO_URL, ji as WORKFLOW_SHARE_MODAL_KEY, ki as WORKFLOW_PUBLISH_MODAL_KEY, ll as LOADING_ANIMATION_MIN_DURATION, m as EVALUATIONS_DOCS_URL, p as ERROR_WORKFLOW_DOCS_URL, t as AutoSaveState, ti as IMPORT_WORKFLOW_URL_MODAL_KEY, xi as WORKFLOW_DESCRIPTION_MODAL_KEY, zr as VIEWS } from "./constants-c-L9DE1I.js";
...
import { a as useWorkflowSaveStore, r as useWorkflowSaving, s as useWorkflowHistoryStore, t as useBuilderStore } from "./builder.store--RObr6z7.js";
import { s as sanitizeFilename } from "./dist-HucXAqjn.js";
...
import { t as router } from "./router-BqCGDXb2.js";
import { a as MCP_SETTINGS_VIEW, r as MCP_DOCS_PAGE_URL } from "./mcp.constants-BvipDsLY.js";
import { n as useMoveResourceToProjectToast, t as LoadingView_default } from "./LoadingView-DDRlCuVA.js";
import { i as getLastPublishedVersion, r as generateVersionLabelFromId } from "./utils-Bp-tXovI.js";
...
import { t as useChatStore } from "./chat.store-zhPptH2L.js";
import { m as groupConversationsByDate, u as flattenModel } from "./fileUtils-D3CGjcG6.js";
import { t as ChatAgentAvatar_default } from "./ChatAgentAvatar-BHWUuxEr.js";
import { t as AppSidebar_default } from "./AppSidebar-D03DDtzF.js";
import { i as usePopOutWindow, n as useWorkflowInitialization, r as LogsPanel_default, t as usePostMessageHandler } from "./usePostMessageHandler-gwwm7VL7.js";
import { t as usePushConnection } from "./usePushConnection-B1iohWrD.js";
import { i as useChatSession, n as ChatPrompt_default, r as ChatMessage_default, t as ChatGreetings_default } from "./ChatGreetings-DSLqIpKv.js";
import { n as useFileDrop } from "./ToolsSelector-BfDQ8hro.js";
import { t as FolderBreadcrumbs_default } from "./FolderBreadcrumbs-C7NOahEc.js";
import { t as ConnectionTracker_default } from "./ConnectionTracker-XTo2UI-b.js";
import { t as useWorkflowSettingsCache } from "./useWorkflowsCache-CD64SBUU.js";
import "./usePushConnection-BEbMPNhg.js";
...
var WorkflowProductionChecklist_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		...
		const hasErrorWorkflow = computed(() => {
			return !!(workflowDocumentStore?.value?.settings?.errorWorkflow ?? props.workflow.settings?.errorWorkflow);
		});
		...
		const hasTimeSaved = computed(() => {
			return (workflowDocumentStore?.value?.settings?.timeSavedPerExecution ?? props.workflow.settings?.timeSavedPerExecution) !== void 0 || hasSavedTimeNodes.value;
		});
		...
		const availableActions = computed(() => {
			...
			function getMcpAction() {
				...
				return {
					...
					completed: workflowDocumentStore?.value?.settings?.availableInMCP ?? props.workflow.settings?.availableInMCP ?? false
				};
			}
		});
...
var WorkflowDetails_default = /* @__PURE__ */ _plugin_vue_export_helper_default(WorkflowDetails_vue_vue_type_script_setup_true_lang_default, [["__cssModules", { "$style": WorkflowDetails_vue_vue_type_style_index_1_lang_module_default }], ["__scopeId", "data-v-9aae060a"]]);
//#endregion
