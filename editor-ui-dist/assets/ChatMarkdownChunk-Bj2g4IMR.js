const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/es-CLChqX-A.js","assets/chunk-CC9Q-vWm.js","assets/core-C7jwVm-w.js","assets/languageModules-BgeMiJoF.js","assets/xml-Dqep6fhG.js"])))=>i.map(i=>d[i]);
...
import { Li as truncateBeforeLast, Qi as N8nButton_default, ki as require_markdown_it_link_attributes } from "./src-Bvr7jqKz.js";
...
function useChatHubMarkdownOptions(codeBlockActionsClassName, tableContainerClassName, footnoteRefClassName) {
	...
	async function loadLanguageModules() {
		...
		try {
			asyncImport = {
				status: "inProgress",
				promise: Promise.all([__vitePreload(() => import("./es-CLChqX-A.js"), __vite__mapDeps([0,1,2])), __vitePreload(() => import("./languageModules-BgeMiJoF.js"), __vite__mapDeps([3,4]))])
			};
