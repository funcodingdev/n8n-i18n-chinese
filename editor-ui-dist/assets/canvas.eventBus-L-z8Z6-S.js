...
import { Ot as createEventBus } from "./src-XWsjz-dU.js";
import { a as require_toString, o as require__arrayMap, t as require_get } from "./get-CDrcd2Fp.js";
import { $ as AI_CATEGORY_RETRIEVERS, $t as EMAIL_SEND_NODE_TYPE, At as AI_TRANSFORM_NODE_TYPE, Bt as COMPRESSION_NODE_TYPE, Cr as XML_NODE_TYPE, Ct as TRANSFORM_DATA_SUBCATEGORY, Dn as MERGE_NODE_TYPE, Dt as AGGREGATE_NODE_TYPE, Fs as require__arrayIncludesWith, G as AI_CATEGORY_DOCUMENT_LOADERS, Gl as EVALUATION_TRIGGER_NODE_TYPE, Gt as CRYPTO_NODE_TYPE, Is as require__arrayIncludes, J as AI_CATEGORY_LANGUAGE_MODELS, Jn as REMOVE_DUPLICATES_NODE_TYPE, Jt as DATETIME_NODE_TYPE, K as AI_CATEGORY_EMBEDDING, Lt as CHAT_TRIGGER_NODE_TYPE, Nc as getNodeInputs, On as MESSAGE_AN_AGENT_NODE_TYPE, Q as AI_CATEGORY_OUTPUTPARSER, Qn as SCHEDULE_TRIGGER_NODE_TYPE, Qt as EMAIL_IMAP_NODE_TYPE, St as TEMPLATE_CATEGORY_AI, Tn as MARKDOWN_NODE_TYPE, U as AI_CATEGORY_AGENTS, Vt as CONVERT_TO_FILE_NODE_TYPE, W as AI_CATEGORY_CHAINS, Wc as isHitlToolType, X as AI_CATEGORY_MEMORY, Xn as RSS_READ_NODE_TYPE, Xt as EDIT_IMAGE_NODE_TYPE, Y as AI_CATEGORY_MCP_NODES, Z as AI_CATEGORY_OTHER_TOOLS, _r as WEBHOOK_NODE_TYPE, _t as NODE_CREATOR_OPEN_SOURCES, an as EXTRACT_FROM_FILE_NODE_TYPE, bl as isCommunityPackageName, bs as require__createCompounder, bt as REGULAR_NODE_CREATOR_VIEW, cn as FORM_TRIGGER_NODE_TYPE, ct as AI_UNCATEGORIZED_CATEGORY, dn as HTML_NODE_TYPE, dt as CORE_NODES_CATEGORY, du as require__SetCache, et as AI_CATEGORY_ROOT_NODES, fl as NodeConnectionTypes, fn as HTTP_REQUEST_NODE_TYPE, ft as FLOWS_CONTROL_SUBCATEGORY, gt as NEW_TOOL_CATEGORIES, hn as IF_NODE_TYPE, ht as HUMAN_IN_THE_LOOP_CATEGORY, in as EXECUTE_WORKFLOW_TRIGGER_NODE_TYPE, it as AI_CODE_TOOL_LANGCHAIN_NODE_TYPE, iu as v4, kt as AI_MCP_TOOL_NODE_TYPE, lt as AI_WORKFLOW_TOOL_LANGCHAIN_NODE_TYPE, mt as HITL_SUBCATEGORY, nt as AI_CATEGORY_TOOLS, on as FILTER_NODE_TYPE, or as SPLIT_IN_BATCHES_NODE_TYPE, ot as AI_OTHERS_NODE_CREATOR_VIEW, pt as HELPERS_SUBCATEGORY, qt as DATA_TABLE_NODE_TYPE, rt as AI_CATEGORY_VECTOR_STORES, sr as SPLIT_OUT_NODE_TYPE, ss as require__baseFlatten, tr as SET_NODE_TYPE, tt as AI_CATEGORY_TEXT_SPLITTERS, ur as SUMMARIZE_NODE_TYPE, uu as require__cacheHas, vt as OTHER_TRIGGER_NODES_SUBCATEGORY, wn as MANUAL_TRIGGER_NODE_TYPE, wt as TRIGGER_NODE_CREATOR_VIEW, xn as LIMIT_NODE_TYPE, zt as CODE_NODE_TYPE } from "./constants-DDbk7QLF.js";
import { E as require__baseUnary, d as require_isArrayLikeObject, r as require__baseRest } from "./merge-pQs2xbBu.js";
import { D as flattenCreateElements, E as finalizeItems, F as mapToolSubcategoryIcon, H as subcategorizeItems, I as nodeTypesToCreateElements, L as prepareCommunityNodeDetailsViewStack, M as groupItemsInSections, N as isAINode, Nt as useRouteWorkflowId, O as getAiTemplatesCallout, Pi as isVueFlowConnection, U as transformNodeType, V as sortNodeCreateElements, Wt as useNDVStore, _ as useNodeTypesStore, a as injectWorkflowDocumentStore, b as useEvaluationStore, br as createCanvasConnectionHandleString, j as getSendAndWaitNodes, kr as parseCanvasConnectionHandleString, nt as require_upperFirst, r as createWorkflowDocumentId, s as useWorkflowDocumentStore, tr as getThemedValue, z as searchNodes, zi as CanvasConnectionMode } from "./workflowDocument.store-nzq6GHzt.js";
...
import { n as getNodeIconSource } from "./nodeIcon-1pnsHOKB.js";
import { t as _virtual_node_popularity_data_default } from "./_virtual_node-popularity-data-DlE78DWU.js";
