...
import { r as require_get, y as useRoute } from "./truncate-5E8n_f_n.js";
import { D as TitledList_default, E as useNodeCredentialOptions, T as NodeCredentials_default, d as collectParametersByTab, f as collectSettings, h as getNodeSettingsInitialValues, p as createCommonNodeSettings, t as ParameterInputList_default, u as useNodeSettingsParameters, v as nameIsParameter } from "./ParameterInputList-DYfVSClu.js";
import { n as ElRow, t as ElCol } from "./col-C2LnQArX.js";
import { Bi as COMMUNITY_NODES_INSTALLATION_DOCS_URL, En as useProjectsStore, Fi as useUIStore, Ht as useCredentialsStore, On as ProjectTypes, Pr as RenameNodeCommand, Sn as injectWorkflowState, Tr as useHistoryStore, Ui as COMMUNITY_PACKAGE_INSTALL_MODAL_KEY, Wo as useSettingsStore, a as useNDVStore, at as useNodeTypesStore, bt as removePreviewToken, ki as importCurlEventBus, mn as useWorkflowHelpers, nr as useUsersStore, o as useWorkflowsStore, ot as useActionsGenerator, t as useTelemetry, xn as useNodeHelpers } from "./useTelemetry-DNwFBRX7.js";
import { t as useToast } from "./useToast-CyeeQKoz.js";
import { Da as isCommunityPackageName, Ea as deepCopy, Fo as VIEWS, Ga as NodeConnectionTypes, L as CUSTOM_API_CALL_KEY, S as NPM_PACKAGE_DOCS_BASE_URL, Vt as CHAT_TRIGGER_NODE_TYPE, Wn as OPEN_URL_PANEL_TRIGGER_NODE_TYPES, Xt as DATA_TABLE_NODES, d as BUILTIN_NODES_DOCS_URL, ea as getNodeInputs, fn as FORM_TRIGGER_NODE_TYPE, kn as MCP_TRIGGER_NODE_TYPE, l as BASE_NODE_SURVEY_URL, na as getNodeParameters, p as CUSTOM_NODES_DOCS_URL, qn as PRODUCTION_ONLY_TRIGGER_NODE_TYPES, uo as OPEN_AI_API_CREDENTIAL_TYPE } from "./constants-ASQneu7i.js";
import { n as ndvEventBus } from "./assistant.store-jCKFL1BA.js";
import { t as useDebounce } from "./useDebounce-B6sO5jq1.js";
import { t as useExternalHooks } from "./useExternalHooks-CpxhaYt5.js";
import { t as useNodeCreatorStore } from "./nodeCreator.store-Dpj0w5xX.js";
...
import { a as useInstallNode, i as useInstalledCommunityPackage, n as CommunityNodeFooter_default, r as ContactAdministratorToInstall_default, t as CommunityNodeUpdateInfo_default } from "./CommunityNodeUpdateInfo-DvuGSlKu.js";
import { n as NodeExecuteButton_default } from "./VirtualSchema-BL8nidxl.js";
import { t as useActions } from "./useActions-D7fZW0Xs.js";
