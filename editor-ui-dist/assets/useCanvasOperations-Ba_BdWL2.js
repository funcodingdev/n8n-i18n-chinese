...
import { M as useLocalStorage, S as useClipboard, yt as useI18n } from "./_MapCache-QsspBGu3.js";
import { Ti as require_markdown_it_link_attributes, bi as useRouter, pt as createEventBus, yi as useRoute } from "./src-BEm78MRO.js";
import { t as __plugin_vue_export_helper_default } from "./_plugin-vue_export-helper-DltO58Gh.js";
import { $i as isPresent, C as useNodeTypesStore, Cn as GRID_SIZE, Dn as generateOffsets, Dr as usePostHog, En as doRectsOverlap, It as useNDVStore, Lt as injectWorkflowState, Mn as getNewNodePosition, Mt as useNodeHelpers, Nt as useTelemetry, Ot as useTagsStore, Pn as getNodesGroupSize, Rt as useWorkflowState, Sn as DEFAULT_VIEWPORT_BOUNDARIES, Tt as useWorkflowHelpers, Vt as useProjectsStore, Zr as isValidNodeConnectionType, _n as useTemplatesStore, ai as AddConnectionCommand, bn as CONFIGURATION_NODE_SIZE, ct as useDataSchema, d as isChatNode, di as RemoveConnectionCommand, fi as RemoveNodeCommand, fn as useFocusPanelStore, gr as useToast, hs as useSettingsStore, ia as tryToParseNumber, ii as useHistoryStore, jr as v4_default, mi as ReplaceNodeParametersCommand, oi as AddNodeCommand, pi as RenameNodeCommand, r as useUIStore, ri as CanvasNodeRenderType, rt as useCredentialsStore, s as useWorkflowsStore, ti as CanvasConnectionMode, ui as MoveNodeCommand, vn as CONFIGURABLE_NODE_SIZE, vr as useExternalHooks, wn as PUSH_NODES_OFFSET, xn as DEFAULT_NODE_SIZE, y as getExecutionErrorToastConfiguration, yr as useCanvasStore } from "./users.store-DL0zLgIY.js";
import { $s as LOCAL_STORAGE_LOGS_PANEL_DETAILS_PANEL_SUB_NODE, Ba as isCommunityPackageName, Bc as EnterpriseEditionFeature, Mn as MCP_TRIGGER_NODE_TYPE, Qs as LOCAL_STORAGE_LOGS_PANEL_DETAILS_PANEL, Ri as require__baseUniq, Sr as WEBHOOK_NODE_TYPE, Tc as CANVAS_ZOOMED_VIEW_EXPERIMENT, br as UPDATE_WEBHOOK_ID_NODE_TYPES, ca as getNodeOutputs, ec as LOCAL_STORAGE_LOGS_PANEL_OPEN, hn as FORM_TRIGGER_NODE_TYPE, io as NodeConnectionTypes, jc as NDV_IN_FOCUS_PANEL_EXPERIMENT, ki as require_cloneDeep, la as getNodeParameters, ma as getSubworkflowId, mr as STICKY_NODE_TYPE, oa as getConnectionTypes, ra as generateNodesGraph, sa as getNodeInputs, tc as LOCAL_STORAGE_LOGS_SYNC_SELECTION, ts as VIEWS, va as isHitlToolType, za as deepCopy } from "./constants-DHjkuIny.js";
import { A as defineStore, r as useRootStore } from "./_baseOrderBy-DJiV7OMR.js";
import { t as useExecutionsStore } from "./executions.store-CNXJjQR3.js";
import { t as usePinnedData } from "./usePinnedData-C4-QbumM.js";
import { a as mapLegacyConnectionToCanvasConnection, c as parseCanvasConnectionHandleString, i as mapCanvasConnectionToLegacyConnection, n as createCanvasConnectionHandleString, o as mapLegacyConnectionsToCanvasConnections } from "./canvas.utils-CNSSOCqc.js";
