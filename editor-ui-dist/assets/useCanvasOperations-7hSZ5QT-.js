...
import { s as useI18n$1 } from "./src-ChH4gKEU.js";
...
import { t as useBuilderStore } from "./builder.store-D5peTY4Z.js";
import { c as useRouter, s as useRoute } from "./vue-router-Dl3cOHxO.js";
import { $t as useTagsStore, Ar as DEFAULT_NODE_SIZE, Bn as getAllNodeCredentialForAuthType, Cr as parseCanvasConnectionHandleString, Dr as AGENT_NODE_SIZE, E as useWorkflowDocumentStore, Fr as doRectsOverlap, I as require_uniq, Ir as generateOffsets, Ki as CanvasNodeRenderType, L as isAgentNodeV2, Li as isValidNodeConnectionType, Mr as HORIZONTAL_NODE_STEP, Nr as PUSH_NODES_OFFSET, Or as CONFIGURABLE_NODE_SIZE, P as serializeNode, R as useNodeTypesStore, S as createWorkflowDocumentId, Sr as mapLegacyConnectionsToCanvasConnections, Ur as getNodesGroupSize, Vr as getNewNodePosition, Wi as CanvasConnectionMode, Wn as getMainAuthField, Yt as useWorkflowHelpers, _ as disposeWorkflowExecutionStateStore, br as mapCanvasConnectionToLegacyConnection, en as ensureNodePosition, hn as useProjectsStore, ht as getN8nAgentsNodeName, jr as DEFAULT_VIEWPORT_BOUNDARIES, jt as useDataSchema, kr as CONFIGURATION_NODE_SIZE, mr as createCanvasConnectionHandleString, nn as sanitizeConnections, nr as isRequiredCredential, pi as pinDataToExecutionData, sn as useNDVStore, t as useWorkflowsStore, tt as removePreviewToken, u as getExecutionErrorToastConfiguration, w as injectWorkflowDocumentStore, xr as mapLegacyConnectionToCanvasConnection, xt as useCredentialsStore, y as useWorkflowExecutionStateStore } from "./workflows.store-BSTkwdxQ.js";
import { $i as v4, Ar as getSubworkflowId, Cr as getNodeInputs, Kt as require_cloneDeep, Pr as isHitlToolType, Qt as validateNodeSelectionForGrouping, Sr as getConnectionTypes, Tr as getNodeParameters, Ur as resolveNodeWebhookId, Zt as validateNodeSelectionForExtraction, di as deepCopy, ii as NodeConnectionTypes, mi as isObjectEmpty, pi as isCommunityPackageName, ti as isResourceLocatorValue, vr as generateNodesGraph, wr as getNodeOutputs } from "./src-JwBmTNgK.js";
import { t as core_default } from "./core-DzQ0sTSt.js";
import { a as python, i as typescript, n as javascript, r as bash, t as xml } from "./xml-C25YAwwQ.js";
...
import { Bi as LOCAL_STORAGE_LOGS_PANEL_OPEN, Ha as NDV_IN_FOCUS_PANEL_EXPERIMENT, Kn as UPDATE_WEBHOOK_ID_NODE_TYPES, Mt as CHAT_TRIGGER_NODE_TYPE, Ri as LOCAL_STORAGE_LOGS_PANEL_DETAILS_PANEL, Vi as LOCAL_STORAGE_LOGS_SYNC_SELECTION, Vn as STICKY_NODE_TYPE, eo as EnterpriseEditionFeature, ln as MANUAL_CHAT_TRIGGER_NODE_TYPE, on as KEEP_AUTH_IN_NDV_FOR_NODES, ya as CANVAS_ZOOMED_VIEW_EXPERIMENT, zi as LOCAL_STORAGE_LOGS_PANEL_DETAILS_PANEL_SUB_NODE } from "./constants-BP1FOJvU.js";
import { n as TELEMETRY_EVENT } from "./src-WHIExFVW.js";
import { f as isPresent, l as isEmpty, v as tryToParseNumber } from "./typesUtils-DlQYqvHF.js";
import { o as getNewWorkflowData } from "./workflowsList.store-6Bsu-Vve.js";
import { n as useUIStore } from "./ui.store-CNq-Lj0o.js";
import { _ as useCanvasStore, a as AddNodeGroupCommand, d as RemoveNodeCommand, f as RemoveNodeGroupCommand, h as UpdateNodeGroupCommand, i as AddNodeCommand, l as MoveNodeCommand, m as ReplaceNodeParametersCommand, n as useHistoryStore, p as RenameNodeCommand, r as AddConnectionCommand, t as useNodeHelpers, u as RemoveConnectionCommand } from "./useNodeHelpers-DaHWBv30.js";
...
import { t as clearAllNodeResourceLocatorValues } from "./templateTransforms--BFD5EwZ.js";
