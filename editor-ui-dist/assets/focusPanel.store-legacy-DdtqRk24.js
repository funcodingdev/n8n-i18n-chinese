;
(function () {
  System.register(["./chunk-legacy-Re9CbdfL.js", "./vue.runtime.esm-bundler-legacy--Sn1h8On.js", "./_MapCache-legacy-CIWHOywQ.js", "./truncate-legacy-Dbhp0OXD.js", "./useTelemetry-legacy-CISk46xo.js", "./constants-legacy-DuqvrHPn.js", "./_baseOrderBy-legacy-BoIlqV8l.js"], function (_export, _context) {
    "use strict";

    var __toESM, computed, ref, watchOnce, i18n, require_get, useStorage, useNodeTypesStore, STORES, useWorkflowsStore, LOCAL_STORAGE_FOCUS_PANEL, FROM_AI_AUTO_GENERATED_MARKER, PLACEHOLDER_EMPTY_WORKFLOW_ID, jsonParse, extractFromAICalls, defineStore, NODE_DENYLIST, PATH_DENYLIST, PROP_TYPE_DENYLIST, fromAIExtraProps, import_get, DEFAULT_PANEL_WIDTH, DEFAULT_FOCUS_PANEL_DATA, useFocusPanelStore;
    ...
    return {
      setters: [function (_chunkLegacy001Js) {
        ...
        LOCAL_STORAGE_FOCUS_PANEL = _constantsLegacy00TJs.Ds;
        FROM_AI_AUTO_GENERATED_MARKER = _constantsLegacy00TJs.ao;
        PLACEHOLDER_EMPTY_WORKFLOW_ID = _constantsLegacy00TJs.c;
        jsonParse = _constantsLegacy00TJs.ka;
        extractFromAICalls = _constantsLegacy00TJs.wi;
