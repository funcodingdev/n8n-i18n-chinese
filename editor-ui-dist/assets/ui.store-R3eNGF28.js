...
import { o as require_identity } from "./merge-rwCtQYS_.js";
import { t as useSettingsStore } from "./settings.store-JwowxuW0.js";
import { t as PERSONALIZATION_MODAL_KEY } from "./users-r3p6UIfW.js";
import { t as useTelemetry } from "./useTelemetry-CZKoOy4G.js";
import { t as VIEWS } from "./views-Cm6YRZ1u.js";
import { $i as LOCAL_STORAGE_SIDEBAR_WIDTH, $r as FROM_AI_PARAMETERS_MODAL_KEY, Ai as WORKFLOW_SETTINGS_MODAL_KEY, Br as AGENT_CONFIRMATION_MODAL_KEY, Ci as WORKFLOW_EXTRACTION_NAME_MODAL_KEY, Di as WORKFLOW_HISTORY_VERSION_RESTORE, Ei as WORKFLOW_HISTORY_PUBLISH_MODAL_KEY, Gr as CHAT_EMBED_MODAL_KEY, Hr as AI_GATEWAY_TOP_UP_MODAL_KEY, Jr as DELETE_SECRETS_PROVIDER_MODAL_KEY, Kr as CONFIRM_PASSWORD_MODAL_KEY, Oi as WORKFLOW_HISTORY_VERSION_UNPUBLISH, Qr as EXTERNAL_SECRETS_PROVIDER_MODAL_KEY, Rr as ABOUT_MODAL_KEY, Si as WORKFLOW_DIFF_MODAL_KEY, Ti as WORKFLOW_HISTORY_NAME_VERSION_MODAL_KEY, Ur as BINARY_DATA_VIEW_MODAL_KEY, Vr as AI_BUILDER_DIFF_MODAL_KEY, Wr as CHANGE_PASSWORD_MODAL_KEY, Xr as EXPERIMENT_TEMPLATE_RECO_V2_KEY, Yr as DUPLICATE_MODAL_KEY, Zr as EXPERIMENT_TEMPLATE_RECO_V3_KEY, _i as STOP_MANY_EXECUTIONS_MODAL_KEY, _o as WHATS_NEW_MODAL_KEY, ai as INSTANCE_AI_TOOLS_CONNECTION_MODAL_KEY, bi as WORKFLOW_ACTIVE_MODAL_KEY, ci as MIGRATE_WORKFLOW_MODAL_KEY, ei as IMPORT_CURL_MODAL_KEY, fi as NEW_ASSISTANT_SESSION_MODAL, gi as SETUP_CREDENTIALS_MODAL_KEY, go as VERSIONS_MODAL_KEY, hi as SECRETS_PROVIDER_CONNECTION_MODAL_KEY, ii as INSTANCE_AI_CREDENTIAL_SETUP_MODAL_KEY, ji as WORKFLOW_SHARE_MODAL_KEY, ki as WORKFLOW_PUBLISH_MODAL_KEY, m as DOCS_DOMAIN, mi as PROMPT_MFA_CODE_MODAL_KEY, oi as LOG_STREAM_MODAL_KEY, pi as NPS_SURVEY_MODAL_KEY, qr as CREDENTIAL_RESOLVER_EDIT_MODAL_KEY, si as MFA_SETUP_MODAL_KEY, ta as LOCAL_STORAGE_THEME, ti as IMPORT_WORKFLOW_URL_MODAL_KEY, vi as TRIAL_INTRO_MODAL_KEY, wi as WORKFLOW_HISTORY_DIFF_MODAL_KEY, xi as WORKFLOW_DESCRIPTION_MODAL_KEY, yi as WORKFLOW_ACTIVATION_CONFLICTING_WEBHOOK_MODAL_KEY, zr as ADD_EXECUTION_TO_DATASET_MODAL_KEY } from "./constants-nNF8vqjl.js";
