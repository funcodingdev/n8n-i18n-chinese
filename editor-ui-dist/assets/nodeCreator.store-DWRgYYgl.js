...
import { m as require_get, v as require_toString, y as require__arrayMap } from "./src-DNuWeQoI.js";
import { $i as getThemedValue, A as getAiTemplatesCallout, B as searchNodes, Cr as useCanvasStore, E as useEvaluationStore, H as sortNodeCreateElements, I as mapToolSubcategoryIcon, It as useTelemetry, L as nodeTypesToCreateElements, N as groupItemsInSections, O as finalizeItems, P as isAINode, Qc as STORES, Qr as v4_default, R as prepareCommunityNodeDetailsViewStack, Si as CanvasConnectionMode, Sn as useTemplatesStore, Sr as useExternalHooks, U as subcategorizeItems, W as transformNodeType, bi as isVueFlowConnection, js as useSettingsStore, k as flattenCreateElements, r as useUIStore, rt as require__createCompounder, s as useWorkflowsStore, tt as require_upperFirst, w as useNodeTypesStore, zt as useNDVStore } from "./users.store-CgsgTstk.js";
import { $ as AI_CATEGORY_LANGUAGE_MODELS, $t as CRYPTO_NODE_TYPE, Ar as XML_NODE_TYPE, At as TEMPLATE_CATEGORY_AI, Bo as require__SetCache, Cn as IF_NODE_TYPE, Ct as HUMAN_IN_THE_LOOP_CATEGORY, Et as OTHER_TRIGGER_NODES_SUBCATEGORY, Fn as MERGE_NODE_TYPE, Ft as AGGREGATE_NODE_TYPE, Gi as require__arrayIncludes, Gt as CHAT_TRIGGER_NODE_TYPE, I as CUSTOM_API_CALL_KEY, It as AI_CODE_NODE_TYPE, J as AI_CATEGORY_AGENTS, Jt as COMPRESSION_NODE_TYPE, Mn as MANUAL_TRIGGER_NODE_TYPE, Mt as TRIGGER_NODE_CREATOR_VIEW, Nn as MARKDOWN_NODE_TYPE, Nt as AGENT_NODE_TYPE, Ot as REGULAR_NODE_CREATOR_VIEW, Pt as AGENT_TOOL_NODE_TYPE, Rt as AI_TRANSFORM_NODE_TYPE$1, Sa as isHitlToolType, So as EVALUATION_TRIGGER_NODE_TYPE, St as HITL_SUBCATEGORY, Tt as NODE_CREATOR_OPEN_SOURCES, Wa as isCommunityPackageName, Wi as require__arrayIncludesWith, X as AI_CATEGORY_DOCUMENT_LOADERS, Y as AI_CATEGORY_CHAINS, Yt as CONVERT_TO_FILE_NODE_TYPE, Z as AI_CATEGORY_EMBEDDING, _r as SUMMARIZE_NODE_TYPE, ar as SCHEDULE_TRIGGER_NODE_TYPE, at as AI_CATEGORY_ROOT_NODES, bi as require__baseFlatten, bn as HTTP_REQUEST_NODE_TYPE, bt as FLOWS_CONTROL_SUBCATEGORY, co as NodeConnectionTypes, cr as SET_NODE_TYPE, ct as AI_CATEGORY_VECTOR_STORES, da as getNodeInputs, dt as AI_NODE_CREATOR_VIEW, et as AI_CATEGORY_MCP_NODES, fn as EXECUTE_WORKFLOW_TRIGGER_NODE_TYPE, ft as AI_OTHERS_NODE_CREATOR_VIEW, gn as FORM_TRIGGER_NODE_TYPE, gt as AI_WORKFLOW_TOOL_LANGCHAIN_NODE_TYPE, ho as AI_TRANSFORM_NODE_TYPE, ht as AI_UNCATEGORIZED_CATEGORY, in as EDIT_IMAGE_NODE_TYPE, it as AI_CATEGORY_RETRIEVERS, jt as TRANSFORM_DATA_SUBCATEGORY, kn as LIMIT_NODE_TYPE, lt as AI_CODE_TOOL_LANGCHAIN_NODE_TYPE, mn as FILTER_NODE_TYPE, mr as SPLIT_OUT_NODE_TYPE, mt as AI_SUBCATEGORY, nn as DATETIME_NODE_TYPE, on as EMAIL_IMAP_NODE_TYPE, ot as AI_CATEGORY_TEXT_SPLITTERS, pn as EXTRACT_FROM_FILE_NODE_TYPE, pr as SPLIT_IN_BATCHES_NODE_TYPE, pt as AI_SECTION_RECOMMENDED_TOOLS, qt as CODE_NODE_TYPE, rr as RSS_READ_NODE_TYPE, rt as AI_CATEGORY_OUTPUTPARSER, sn as EMAIL_SEND_NODE_TYPE, st as AI_CATEGORY_TOOLS, tn as DATA_TABLE_NODE_TYPE, tr as REMOVE_DUPLICATES_NODE_TYPE, tt as AI_CATEGORY_MEMORY, vt as CORE_NODES_CATEGORY, wr as WEBHOOK_NODE_TYPE, wt as NEW_TOOL_CATEGORIES, xt as HELPERS_SUBCATEGORY, yn as HTML_NODE_TYPE, yt as DEFAULT_SUBCATEGORY, zo as require__cacheHas } from "./constants-DEPRN4fc.js";
import { T as require__baseUnary, r as require__baseRest, u as require_isArrayLikeObject } from "./merge-Ce71GKIY.js";
import { j as defineStore } from "./_baseOrderBy-DCYhjK32.js";
import { t as getNodeIconSource } from "./nodeIcon-CApkz_zp.js";
import { c as parseCanvasConnectionHandleString, n as createCanvasConnectionHandleString } from "./canvas.utils-BwcAweXC.js";
