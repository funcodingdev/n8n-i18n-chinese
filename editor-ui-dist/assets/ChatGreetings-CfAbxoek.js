const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/es-B7InvePJ.js","assets/core-D8Mk0l5n.js","assets/chunk-r2Y0G7H8.js","assets/languageModules-DplJUtQQ.js","assets/xml-D7HpP_o1.js"])))=>i.map(i=>d[i]);
import { o as __toESM, t as __commonJSMin } from "./chunk-r2Y0G7H8.js";
import { $ as openBlock, A as createTextVNode, C as createBaseVNode, E as createElementBlock, Ft as ref, K as onBeforeMount, N as defineComponent, O as createSlots, S as computed, Sn as toDisplayString, T as createCommentVNode, W as nextTick, Wt as unref, _ as Fragment, _n as normalizeClass, c as useCssModule, gt as watch, h as withModifiers, it as renderSlot, j as createVNode, pt as useTemplateRef, q as onBeforeUnmount, rt as renderList, w as createBlock, y as Teleport, yn as normalizeStyle, yt as withCtx } from "./vue.runtime.esm-bundler-dg1EVmSK.js";
import { D as useElementSize, F as useScroll, L as useSpeechRecognition, R as useSpeechSynthesis, bt as useI18n, xt as I18nT } from "./_MapCache-BFpNgXhv.js";
import { $i as N8nIcon_default, Bi as truncateBeforeLast, Fi as Input_default, Ht as useDeviceSupport, Ii as N8nIconButton_default, Mi as N8nTooltip_default, Ni as require_markdown_it_link_attributes, Qi as N8nButton_default, Xi as N8nCallout_default, Yi as N8nHeading_default, Zi as N8nText_default, _t as useRouter, lt as N8nLink_default, na as __vitePreload, zi as truncate, zt as N8nLoading_default } from "./src-C1Fv__jy.js";
import { t as __plugin_vue_export_helper_default } from "./_plugin-vue_export-helper-DltO58Gh.js";
import { Tr as useToast, s as useWorkflowsStore } from "./users.store-Bu2w-Rub.js";
...
import { t as VueMarkdown_default } from "./VueMarkdown-WU114Puo.js";
import { t as usePushConnectionStore } from "./pushConnection.store-CQ3MEvdF.js";
import { y as providerDisplayNames } from "./constants-CsI9wULx.js";
import { S as unflattenModel, T as buildChatAttachmentUrl, _ as isRegenerable, b as splitMarkdownIntoChunks, g as isLlmProviderModel, m as isEditable, o as enrichMimeTypesWithExtensions, t as useChatStore, v as isWaitingForApproval } from "./chat.store-Ct2zal59.js";
import { t as ChatAgentAvatar_default } from "./ChatAgentAvatar-E53_fHiq.js";
import { n as ChatFile_default } from "./useResizablePanel-pb4mL1eK.js";
import { t as ToolsSelector_default } from "./ToolsSelector-C_iPbPtY.js";
function useChatPushHandler() {
	...
	function handleStreamChunk(event) {
		const { sessionId, messageId, sequenceNumber, content: content$1 } = event.data;
	...
	(function webpackUniversalModuleDefinition(root, factory) {
		...
		return (function() {
			...
			function defineFunction(_ref) {
				let { type, names, props, handler, htmlBuilder: htmlBuilder$1, mathmlBuilder: mathmlBuilder$1 } = _ref;
				const data = {
					type,
				...
				if (type) {
					if (htmlBuilder$1) _htmlGroupBuilders[type] = htmlBuilder$1;
					if (mathmlBuilder$1) _mathmlGroupBuilders[type] = mathmlBuilder$1;
				}
			}
			function defineFunctionBuilders(_ref2) {
				let { type, htmlBuilder: htmlBuilder$1, mathmlBuilder: mathmlBuilder$1 } = _ref2;
				defineFunction({
					type,
					names: [],
					props: { numArgs: 0 },
...
var require_dist = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	function handleMathInHtml(state, mathType, mathMarkup, mathRegex) {
		...
		for (let index = tokens.length - 1; index >= 0; index--) {
			...
			const content$1 = currentToken.content;
			for (const match of content$1.matchAll(mathRegex)) {
	...
	function default_1(md, options) {
		...
		const inlineRenderer = (tokens, idx) => {
			const content$1 = tokens[idx].content;
			return katexInline(content$1.length > 2 && content$1[0] === "`" && content$1[content$1.length - 1] === "`" ? content$1.slice(1, -1) : content$1);
		};
...
function useChatHubMarkdownOptions(codeBlockActionsClassName, tableContainerClassName, footnoteRefClassName) {
	...
	async function loadLanguageModules() {
		...
		try {
			asyncImport = {
				status: "inProgress",
				promise: Promise.all([__vitePreload(() => import("./es-B7InvePJ.js"), __vite__mapDeps([0,1,2])), __vitePreload(() => import("./languageModules-DplJUtQQ.js"), __vite__mapDeps([3,4]))])
			};
...
var ChatMarkdownChunk_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props, { expose: __expose, emit: __emit }) {
		...
		const markdown = useChatHubMarkdownOptions(styles.codeBlockActions, styles.tableContainer, __props.footnoteStyle === "pill" ? styles.footnoteRef : null);
...
var ChatMarkdownChunk_vue_vue_type_style_index_0_lang_module_default = {
	container: "_container_g63zs_125",
	chatMessageMarkdown: "_chatMessageMarkdown_g63zs_133",
	codeBlockActions: "_codeBlockActions_g63zs_245",
	singlePre: "_singlePre_g63zs_261",
	footnoteRef: "_footnoteRef_g63zs_320",
	tableContainer: "_tableContainer_g63zs_333",
	command: "_command_g63zs_421"
};
	...
	setup(__props, { expose: __expose, emit: __emit }) {
		...
		const activeCodeBlockTeleport = computed(() => {
			...
			for (const chunkRef of refs) if (chunkRef?.hoveredCodeBlockActions) {
				const content$1 = chunkRef.getHoveredCodeBlockContent();
				if (content$1) return {
		...
		const messageChunks = computed(() => __props.message.content.flatMap((chunk, index, arr) => {
			...
			return splitMarkdownIntoChunks(chunk.content).flatMap((content$1) => content$1.trim() === "" ? [] : [{
				type: "text",
				content: content$1
			}]);
		}));
...
var ChatPromptCallouts_default = /* @__PURE__ */ __plugin_vue_export_helper_default(ChatPromptCallouts_vue_vue_type_script_setup_true_lang_default, [["__cssModules", { "$style": ChatPromptCallouts_vue_vue_type_style_index_0_lang_module_default }]]);
...
var ChatPromptCompact_default = /* @__PURE__ */ __plugin_vue_export_helper_default(ChatPromptCompact_vue_vue_type_script_setup_true_lang_default, [["__cssModules", { "$style": ChatPromptCompact_vue_vue_type_style_index_0_lang_module_default }]]);
...
var ChatPromptFull_default = /* @__PURE__ */ __plugin_vue_export_helper_default(ChatPromptFull_vue_vue_type_script_setup_true_lang_default, [["__cssModules", { "$style": ChatPromptFull_vue_vue_type_style_index_0_lang_module_default }]]);
	...
	setup(__props, { expose: __expose, emit: __emit }) {
		...
		return (_ctx, _cache) => {
			return __props.compact ? (openBlock(), createBlock(ChatPromptCompact_default, {
				...
				"onUpdate:message": _cache[4] || (_cache[4] = ($event) => message$1.value = $event),
				attachments: attachments$2.value,
				...
				"callout-visible": calloutVisible$1.value,
				...
				ref: activePromptRef,
				message: message$1.value,
				"onUpdate:message": _cache[9] || (_cache[9] = ($event) => message$1.value = $event),
				attachments: attachments$2.value,
				placeholder: placeholder.value,
				"messaging-state": __props.messagingState,
				"accepted-mime-types": acceptedMimeTypes.value,
...
export { useChatSession as a, ChatMarkdownChunk_default as i, ChatPrompt_default as n, ChatMessage_default as r, ChatGreetings_default as t };
