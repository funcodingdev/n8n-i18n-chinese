  ...
  System.register(["./vue.runtime.esm-bundler-legacy--Sn1h8On.js", "./_MapCache-legacy-BH2XE3uj.js", "./src-legacy-B1x3MtI4.js", "./en-legacy-DJK4SpPN.js", "./preload-helper-legacy-CXRjoQ0T.js", "./_plugin-vue_export-helper-legacy-DZMI5HPp.js", "./truncate-legacy-D4G74xLD.js", "./icon-legacy-CyrYWyfC.js", "./overlay-legacy-5JS5pAPM.js", "./empty-legacy-ZG0-xpne.js", "./dialog-legacy-FFzlWFNQ.js", "./useTelemetry-legacy-CMfwYwVY.js", "./useToast-legacy-DHnOnoVM.js", "./sanitize-html-legacy-B93rGWi4.js", "./CalendarDate-legacy-BUvNgcoo.js", "./path-browserify-legacy-PZw06cM9.js", "./constants-legacy-8iZaMHMx.js", "./merge-legacy-DCgXpGSH.js", "./_baseOrderBy-legacy-Bls-fMH1.js", "./dateformat-legacy-C4HUJTCr.js", "./useDebounce-legacy-10Dbxu_b.js", "./useExternalHooks-legacy-CDDHCmE_.js", "./useStyles-legacy-E8NPEyeD.js", "./cloudPlan.store-legacy-CEK8KIVd.js", "./versions.store-legacy-Bu2f8-xh.js", "./usePageRedirectionHelper-legacy-D_zw1zhe.js", "./usage.store-legacy-BAe9a00a.js"], function (_export, _context) {
    ...
    return {
      ...
      execute: function () {
          ...
          setup(__props) {
            ...
            return (_ctx, _cache) => {
              return openBlock(), createElementBlock("div", _hoisted_1, [createVNode(unref(N8nHeading_default), {
                ...
                _: 1
              }), _cache[4] || (_cache[4] = createBaseVNode("br", null, null, -1)), unref(usageStore).activeWorkflowTriggersLimit > 0 ? (openBlock(), createBlock(unref(N8nInfoTip_default), {
                key: 1
              }, {
                default: withCtx(() => [createTextVNode(toDisplayString(unref(i18n).baseText("settings.usageAndPlan.activeWorkflows.overcountWarning")), 1)]),
                _: 1
              })) : createCommentVNode("", true), createBaseVNode("div", {
        ...
        _export("default", SettingsUsageAndPlan_default = /* @__PURE__ */__plugin_vue_export_helper_default(SettingsUsageAndPlan_vue_vue_type_script_setup_true_lang_default, [["__cssModules", cssModules], ["__scopeId", "data-v-d7e297cf"]])); //#endregion
      }
    };
  });
})();