...
import { b as useRouter, c as require__arrayMap, r as require_get, s as require_toString, y as useRoute } from "./truncate-CsmjEd1C.js";
import { $r as getThemedValue, At as getSampleWorkflowByTemplateId, Bo as v4_default, Bt as require__createCompounder, Ct as sortNodeCreateElements, En as useProjectsStore, Et as SampleTemplates, Fi as useUIStore, Gn as useCanvasStore, Mt as isPrebuiltAgentTemplateId, Nt as isTutorialTemplateId, Ot as getPrebuiltAgents, Rt as require_upperFirst, Sr as CanvasConnectionMode, Tt as transformNodeType, Wo as useSettingsStore, Xo as updateCurrentUserSettings, _t as isAINode, a as useNDVStore, at as useNodeTypesStore, br as isVueFlowConnection, cc as STORES, ft as getAiTemplatesCallout, gr as isValidCanvasConnectionMode, gt as groupItemsInSections, i as usePostHog, jt as getTutorialTemplates, kt as getRagStarterWorkflowJson, lt as finalizeItems, mt as getPreBuiltAgentsCalloutWithDivider, nr as useUsersStore, o as useWorkflowsStore, st as useEvaluationStore, t as useTelemetry, ut as flattenCreateElements, vr as isValidNodeConnectionType, wt as subcategorizeItems, xt as searchNodes, yt as prepareCommunityNodeDetailsViewStack } from "./useTelemetry-Cl1nGv7u.js";
import { $ as AI_CATEGORY_EMBEDDING, $n as SCHEDULE_TRIGGER_NODE_TYPE, An as MERGE_NODE_TYPE, At as TEMPLATE_CATEGORY_AI, Ct as HUMAN_IN_THE_LOOP_CATEGORY, Da as isCommunityPackageName, Dn as MANUAL_TRIGGER_NODE_TYPE, Ft as AI_CODE_NODE_TYPE, Ga as NodeConnectionTypes, Gt as CONVERT_TO_FILE_NODE_TYPE, J as NODE_MIN_INPUT_ITEMS_COUNT, L as CUSTOM_API_CALL_KEY, Lo as VIEWS, Lt as AI_TRANSFORM_NODE_TYPE$1, Mi as require__arrayIncludesWith, Mt as TRIGGER_NODE_CREATOR_VIEW, Ni as require__arrayIncludes, On as MARKDOWN_NODE_TYPE, Ot as REGULAR_NODE_CREATOR_VIEW, Pt as AGGREGATE_NODE_TYPE, Q as AI_CATEGORY_DOCUMENT_LOADERS, Qt as DATETIME_NODE_TYPE, St as HITL_SUBCATEGORY, Tr as XML_NODE_TYPE, Tt as OTHER_TRIGGER_NODES_SUBCATEGORY, Ut as CODE_NODE_TYPE, Vt as CHAT_TRIGGER_NODE_TYPE, Wt as COMPRESSION_NODE_TYPE, X as AI_CATEGORY_AGENTS, Xn as REMOVE_DUPLICATES_NODE_TYPE, Yt as CRYPTO_NODE_TYPE, Z as AI_CATEGORY_CHAINS, Za as AI_TRANSFORM_NODE_TYPE, Zn as RSS_READ_NODE_TYPE, Zt as DATA_TABLE_NODE_TYPE, at as AI_CATEGORY_RETRIEVERS, bo as require__cacheHas, bt as FLOWS_CONTROL_SUBCATEGORY, cn as EXECUTE_WORKFLOW_TRIGGER_NODE_TYPE, cr as SPLIT_OUT_NODE_TYPE, ct as AI_CATEGORY_TOOLS, ea as getNodeInputs, en as EDIT_IMAGE_NODE_TYPE, et as AI_CATEGORY_LANGUAGE_MODELS, fn as FORM_TRIGGER_NODE_TYPE, fr as SUMMARIZE_NODE_TYPE, ft as AI_NODE_CREATOR_VIEW, gn as HTTP_REQUEST_NODE_TYPE, gt as AI_WORKFLOW_TOOL_LANGCHAIN_NODE_TYPE, hn as HTML_NODE_TYPE, ht as AI_UNCATEGORIZED_CATEGORY, it as AI_CATEGORY_OUTPUTPARSER, jt as TRANSFORM_DATA_SUBCATEGORY, li as require__baseFlatten, ln as EXTRACT_FROM_FILE_NODE_TYPE, lt as AI_CATEGORY_VECTOR_STORES, mt as AI_SUBCATEGORY, nn as EMAIL_IMAP_NODE_TYPE, no as EVALUATION_TRIGGER_NODE_TYPE, nr as SET_NODE_TYPE, nt as AI_CATEGORY_MEMORY, os as PRE_BUILT_AGENTS_MODAL_KEY, ot as AI_CATEGORY_ROOT_NODES, pt as AI_OTHERS_NODE_CREATOR_VIEW, rn as EMAIL_SEND_NODE_TYPE, sr as SPLIT_IN_BATCHES_NODE_TYPE, st as AI_CATEGORY_TEXT_SPLITTERS, tt as AI_CATEGORY_MCP_NODES, uc as PRE_BUILT_AGENTS_EXPERIMENT, un as FILTER_NODE_TYPE, ut as AI_CODE_TOOL_LANGCHAIN_NODE_TYPE, vn as IF_NODE_TYPE, vt as CORE_NODES_CATEGORY, wn as LIMIT_NODE_TYPE, wt as NODE_CREATOR_OPEN_SOURCES, xo as require__SetCache, xt as HELPERS_SUBCATEGORY, yr as WEBHOOK_NODE_TYPE, yt as DEFAULT_SUBCATEGORY } from "./constants-BpPtFtwh.js";
import { T as require__baseUnary, r as require__baseRest, u as require_isArrayLikeObject } from "./merge-R4sXNnHR.js";
...
import { t as useTemplatesStore } from "./templates.store-Do-Jr6IE.js";
