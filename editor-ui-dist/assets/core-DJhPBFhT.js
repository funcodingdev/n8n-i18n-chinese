...
var zh_CN_default = {
	...
	"experiments.resourceCenter.templateCard.useNow": "▶︎ 运行工作流",
	...
	"aiGateway.credentialMode.creditsShort": "{count} 积分",
	...
	"settings.provisioningConfirmDialog.breakingChangeDescription.firstSentence.partOne": "您的SSO提供商将控制n8n中的所有用户角色。",
	"settings.provisioningConfirmDialog.breakingChangeDescription.firstSentence.partOne.withProjectRoles": "您的SSO提供商将控制n8n中的所有用户和项目角色。",
	"settings.provisioningConfirmDialog.breakingChangeDescription.firstSentence.partTwo": "未由您的SSO提供者分配的角色将默认为全球:member。",
	"settings.provisioningConfirmDialog.breakingChangeDescription.secondLine": "<b>启用之前：</b> 请下载并查看您当前的访问设置，以确保您的单点登录提供商配置正确。",
	"settings.provisioningConfirmDialog.disable.description": "您正在将实例角色管理从SSO切换回n8n。",
	"settings.provisioningConfirmDialog.enable.checkbox": "我已经下载并审核了CSV导出。我的SSO提供者已正确配置，以控制该n8n实例上的用户角色。",
	"settings.provisioningConfirmDialog.disable.checkbox": "我确认不再从我的 SSO 提供商那里配置用户角色。",
	...
	"workflows.dependencies.tooltip": "1 个依赖项 | {count} 个依赖项",
	"workflows.dependencies.tooltip.workflow": "此工作流引用的资源",
	"workflows.dependencies.tooltip.credential": "引用此凭证的资源",
	"workflows.dependencies.tooltip.dataTable": "引用此数据表的资源",
	...
	"settings.n8nConnect.usage.col.credits": "致谢",
	"settings.n8nConnect.usage.empty": "未找到使用记录。",
	"settings.n8nConnect.usage.loadMore": "加载更多",
	"settings.n8nConnect.credits.title": "致谢",
	"settings.n8nConnect.credits.remaining": "{remaining} / {quota} 剩余积分",
	"settings.n8nConnect.credits.quota": "信用总额",
	"settings.n8nConnect.credits.topUp": "充值积分",
	"settings.n8nConnect.usage.refresh.tooltip": "刷新使用记录",
	"settings.instanceAi": "实例 AI",
	"settings.instanceAi.description": "配置实例 AI 代理、模型、内存和权限。",
	...
	"instanceAi.gatewayConfirmation.alwaysAllow": "始终允许",
	"instanceAi.gatewayConfirmation.alwaysDeny": "始终拒绝",
