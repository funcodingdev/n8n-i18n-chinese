...
(function () {
  System.register(["./chunk-legacy-Re9CbdfL.js", "./dateformat-legacy-C4HUJTCr.js"], function (_export, _context) {
    ...
    var __toESM, require_dateformat, import_dateformat, getLastPublishedByUser, generateVersionName, formatTimestamp;
    return {
      ...
      execute: function () {
        ...
        _export("r", getLastPublishedByUser = workflowPublishHistory => {
