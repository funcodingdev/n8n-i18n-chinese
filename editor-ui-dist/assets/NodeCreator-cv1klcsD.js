...
import { _t as i18n, bt as useI18n, g as onClickOutside } from "./_MapCache-COzuLMdL.js";
import { $i as N8nIcon_default, Ii as N8nIconButton_default, J as N8nNodeCreatorNode_default, K as N8nNotice_default, Mi as N8nTooltip_default, Qi as N8nButton_default, Xi as N8nCallout_default, Zi as N8nText_default, lt as N8nLink_default, q as N8nNodeIcon_default, tt as N8nInfoTip_default, zt as N8nLoading_default } from "./src-BvUzUaLE.js";
import { t as __plugin_vue_export_helper_default } from "./_plugin-vue_export-helper-DltO58Gh.js";
import "./sanitize-html-JHjOJhXQ.js";
import { D as filterAndSearchNodes, F as isNodePreviewKey, Fa as COMMUNITY_NODES_INSTALLATION_DOCS_URL, M as getRootSearchCallouts, Qt as DEFAULT_NODE_SIZE, R as prepareCommunityNodeDetailsViewStack, T as useActionsGenerator, V as shouldShowCommunityNodeDetails, W as transformNodeType, at as useCredentialsStore, j as getHumanInTheLoopActions, k as flattenCreateElements, ln as getNewNodePosition, pr as useTelemetry, r as useUIStore, s as useWorkflowsStore, t as useUsersStore, w as useNodeTypesStore, z as removePreviewToken, zn as useExternalHooks } from "./users.store-Qyayth1w.js";
import { Ct as HUMAN_IN_THE_LOOP_CATEGORY, I as CUSTOM_API_CALL_KEY, Jn as OPEN_AI_NODE_TYPE, Mt as TRIGGER_NODE_CREATOR_VIEW, Ot as REGULAR_NODE_CREATOR_VIEW, Qa as isCommunityPackageName, R as DRAG_EVENT_DATA_KEY, St as HITL_SUBCATEGORY, Zt as CREDENTIAL_ONLY_NODE_PREFIX, bn as HTTP_REQUEST_NODE_TYPE, dt as AI_NODE_CREATOR_VIEW, ft as AI_OTHERS_NODE_CREATOR_VIEW, ht as AI_UNCATEGORIZED_CATEGORY, kt as REQUEST_NODE_FORM_URL, qn as OPEN_AI_NODE_MESSAGE_ASSISTANT_TYPE, ut as AI_EVALUATION, wr as WEBHOOK_NODE_TYPE, yt as DEFAULT_SUBCATEGORY } from "./constants-CbM6Kczw.js";
...
import { t as useDebounce } from "./useDebounce-DzkgMLTI.js";
...
import { n as captureException } from "./exports-BmCtHb0z.js";
import "./communityNodes.store-DzK_5GQj.js";
import { n as useNodeType } from "./usePinnedData-D0I3IPdg.js";
import { t as getNodeIconSource } from "./nodeIcon-B4FMjHPj.js";
import "./canvas.utils-wNLuSy5w.js";
import { a as useKeyboardNavigation, c as HitlToolView, d as require_camelCase, l as RegularView, n as useNodeCreatorStore, o as AINodesView, r as useViewStacks, s as AIView, u as TriggerView } from "./canvas.eventBus-BeMGLVv1.js";
...
import { t as useQuickConnect } from "./useQuickConnect-DVxmyy9h.js";
...
import { i as QuickConnectBanner_default, n as CommunityNodeFooter_default, r as useInstalledCommunityPackage, t as CommunityNodeUpdateInfo_default } from "./CommunityNodeUpdateInfo-CRDBjMfp.js";
import { t as useActions } from "./useActions-DVSNuxYh.js";
...
var SlideTransition_default = /* @__PURE__ */ __plugin_vue_export_helper_default(_sfc_main$1, [["render", _sfc_render$1], ["__scopeId", "data-v-ffd9b1ff"]]);
...
var ActionsMode_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props, { emit: __emit }) {
		...
		const { getQuickConnectOptionByPackageName } = useQuickConnect();
		const quickConnect = computed(() => {
			const items$1 = useViewStacks().activeViewStack.items;
			if (!communityNodeDetails.value && items$1?.length) return getQuickConnectOptionByPackageName(items$1[0].key);
			return null;
		});
		...
		return (_ctx, _cache) => {
			...
			return openBlock(), createElementBlock("div", { class: normalizeClass({
				...
				}, [createVNode(QuickConnectBanner_default, { text: quickConnect.value.text }, null, 8, ["text"])], 2)) : createCommentVNode("", true),
	...
	setup(__props) {
		...
		const onInstall = async () => {
			if (isAdminOrOwner.value && activeViewStack.communityNodeDetails && !communityNodeDetails?.installed) {
				const { key, packageName: packageName$1 } = activeViewStack.communityNodeDetails;
...
var NodesListPanel_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		...
		const viewStackTitle = computed(() => {
			if (nodeCreatorStore.openingContext === "replacement") return i18n$1.baseText("nodeCreator.replaceNode.title");
