...
*/
function useInstanceAiReady() {
	const settingsStore = useSettingsStore();
	const available = useInstanceAiAvailable();
	return computed(() => available.value && settingsStore.moduleSettings["instance-ai"]?.setupCompleted === true);
}
//#endregion
export { canMessageInstanceAi as i, useInstanceAiReady as n, canManageInstanceAi as r, useInstanceAiAvailable as t };
