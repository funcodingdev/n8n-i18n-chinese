...
import { at as useI18n$1, c as useClipboard, v as useLocalStorage } from "./core-D8FH-7X4.js";
import { ki as require_markdown_it_link_attributes, lt as useRoute, ut as useRouter } from "./src-DT4BbAhc.js";
import { t as _plugin_vue_export_helper_default } from "./_plugin-vue_export-helper-Da88TEg1.js";
import { $r as ReplaceNodeParametersCommand, $t as PUSH_NODES_OFFSET, Br as CanvasConnectionMode, Da as tryToParseNumber, Dt as injectWorkflowState, Et as useWorkflowHelpers, Fn as useToast, Gr as AddNodeCommand, Hr as CanvasNodeRenderType, Ir as isValidNodeConnectionType, Jt as useTemplatesStore, Ln as useExternalHooks, Ot as useWorkflowState, Qr as RenameNodeCommand, Qt as DEFAULT_VIEWPORT_BOUNDARIES, Sa as isPresent, Ur as useHistoryStore, Ut as useFocusPanelStore, Wr as AddConnectionCommand, Xr as RemoveConnectionCommand, Xt as CONFIGURATION_NODE_SIZE, Yr as MoveNodeCommand, Yt as CONFIGURABLE_NODE_SIZE, Zr as RemoveNodeCommand, Zt as DEFAULT_NODE_SIZE, _r as useNDVStore, at as useCredentialsStore, b as getExecutionErrorToastConfiguration, d as isChatNode, dr as useCanvasStore, gr as usePostHog, ia as createWorkflowDocumentId, ln as getNodesGroupSize, lt as useDataSchema, nn as generateOffsets, oi as useProjectsStore, pr as useTelemetry, r as useUIStore, rr as useTagsStore, s as useWorkflowsStore, sa as useWorkflowDocumentStore, sn as getNewNodePosition, tn as doRectsOverlap, ua as pinDataToExecutionData, ur as useNodeHelpers, w as useNodeTypesStore, z as removePreviewToken } from "./users.store-CP49qwNg.js";
import { $a as require__baseUniq, Bo as resolveNodeWebhookId, Co as getNodeParameters, Ga as require_cloneDeep, Gi as LOCAL_STORAGE_LOGS_SYNC_SELECTION, Gs as v4, Hi as LOCAL_STORAGE_LOGS_PANEL_DETAILS_PANEL, Kc as NDV_IN_FOCUS_PANEL_EXPERIMENT, Mo as isHitlToolType, Oo as getSubworkflowId, Pc as CANVAS_ZOOMED_VIEW_EXPERIMENT, So as getNodeOutputs, Ui as LOCAL_STORAGE_LOGS_PANEL_DETAILS_PANEL_SUB_NODE, Wi as LOCAL_STORAGE_LOGS_PANEL_OPEN, _o as generateNodesGraph, ar as STICKY_NODE_TYPE, bo as getConnectionTypes, dr as UPDATE_WEBHOOK_ID_NODE_TYPES, es as deepCopy, tl as EnterpriseEditionFeature, ts as isCommunityPackageName, xo as getNodeInputs, ys as NodeConnectionTypes, zr as VIEWS } from "./constants-Co4JQRdg.js";
...
import { a as mapLegacyConnectionToCanvasConnection, c as parseCanvasConnectionHandleString, i as mapCanvasConnectionToLegacyConnection, n as createCanvasConnectionHandleString, o as mapLegacyConnectionsToCanvasConnections } from "./canvas.utils-MZd7ZOOK.js";
import { n as useNodeCreatorStore, t as canvasEventBus } from "./canvas.eventBus-Cw38_3R9.js";
import { t as core_default } from "./core-Ca1ZPwNT.js";
import { a as bash, i as javascript, n as typescript, r as python, t as xml } from "./xml-CzZgMrom.js";
import { t as VueMarkdown } from "./VueMarkdown-Dg2oZq2w.js";
import { t as useSetupPanelStore } from "./setupPanel.store-Bt-Nt6IM.js";
import { t as clearAllNodeResourceLocatorValues } from "./templateTransforms-CDoCHvHa.js";
