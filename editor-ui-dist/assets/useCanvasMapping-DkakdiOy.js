...
import { _ as onKeyDown, _t as I18nT, gt as useI18n, it as useThrottleFn, ot as watchOnce, st as watchThrottled, y as onKeyUp } from "./_MapCache-WB-ZLHq4.js";
import { Hn as N8nButton_default, T as N8nPopover_default, Vn as N8nText_default, Wn as N8nIcon_default, it as useDeviceSupport, mt as N8nTooltip_default, nt as N8nActionDropdown_default, ut as N8nLink_default, xt as N8nIconButton_default, y as N8nSticky_default } from "./src-aOeokM-B.js";
import { t as __plugin_vue_export_helper_default } from "./_plugin-vue_export-helper-BwBpWJRZ.js";
import { b as useRouter, n as truncateBeforeLast, x as createEventBus, y as useRoute } from "./truncate-D51dJrpW.js";
import { D as TitledList_default } from "./ParameterInputList-BLIv5PeJ.js";
import { A as _sfc_main$1, B as isMacOs, Bo as v4_default, Cr as CanvasNodeDirtiness, D as PanelPosition, Dn as useSourceControlStore, E as NodeId, F as getBezierPath, Fi as useUIStore, H as useVueFlow, I as getBoundsofRects, L as getConnectedEdges, M as _sfc_main$d, N as _sfc_main$f, O as Position, Oi as nodeViewEventBus, P as clamp, R as getRectOfNodes, Sn as injectWorkflowState, Sr as CanvasConnectionMode, T as MarkerType, Tr as useHistoryStore, U as wheelDelta, V as useGetPointerPosition, Wo as useSettingsStore, a as useNDVStore, at as useNodeTypesStore, bi as isPresent, c as CONFIGURATION_NODE_RADIUS, ei as getTriggerNodeServiceName, f as GRID_SIZE, j as _sfc_main$3, ji as globalLinkActionsEventBus, k as _sfc_main$4, m as calculateNodeSize, o as useWorkflowsStore, p as PUSH_NODES_OFFSET, q as isChatNode, t as useTelemetry, u as DEFAULT_NODE_SIZE, vr as isValidNodeConnectionType, w as updateViewportToContainNodes, wr as CanvasNodeRenderType, xn as useNodeHelpers, y as getMousePosition, yn as environments_store_default, z as getSmoothStepPath } from "./useTelemetry-fX8cvQe2.js";
import { o as isOutsideSelected, s as sanitizeHtml, t as useToast } from "./useToast-DhtBVxde.js";
import { Da as isCommunityPackageName, Ga as NodeConnectionTypes, Go as EXPERIMENT_TEMPLATES_DATA_QUALITY_KEY, L as CUSTOM_API_CALL_KEY, Lo as VIEWS, Oo as getResourcePermissions, Qs as ExpressionLocalResolveContextSymbol, Vt as CHAT_TRIGGER_NODE_TYPE, Xs as CanvasNodeHandleKey, Ys as CanvasKey, Zs as CanvasNodeKey, da as isNodeWithWorkflowSelector, dn as FORM_NODE_TYPE, dr as STICKY_NODE_TYPE, ea as getNodeInputs, fo as SEND_AND_WAIT_OPERATION, go as require_isEqual, hi as parseExtractableSubgraphSelection, ho as WEBHOOK_NODE_TYPE, ir as SIMULATE_TRIGGER_NODE_TYPE, mi as buildAdjacencyList, mo as WAIT_INDEFINITELY, ms as WORKFLOW_EXTRACTION_NAME_MODAL_KEY, qi as mapConnectionsByDestination, qn as PRODUCTION_ONLY_TRIGGER_NODE_TYPES, ro as EXECUTE_WORKFLOW_TRIGGER_NODE_TYPE, rr as SIMULATE_NODE_TYPE, sa as getSubworkflowId, ta as getNodeOutputs, ua as isExecutable, vc as CANVAS_EXECUTION_DATA_THROTTLE_DURATION, vr as WAIT_NODE_TYPE, wt as NODE_CREATOR_OPEN_SOURCES, yi as extractReferencesInNodeExpressions, zn as NOT_DUPLICATABLE_NODE_TYPES } from "./constants-0OA-5Cg4.js";
import { t as useStyles } from "./useStyles-DhM0cpS7.js";
import { t as useChatPanelStore } from "./chatPanel.store-D90XLg9I.js";
import { a as useTemplatesDataQualityStore, i as trackTemplatesClick, n as TemplateClickSource, r as isExtraTemplateLinksExperimentEnabled, t as useTemplatesStore } from "./templates.store-BGBUfU11.js";
import { r as useNodeDirtiness, t as useRunWorkflow } from "./useRunWorkflow-CuS_q4Fe.js";
import { t as usePinnedData } from "./usePinnedData-DMOnPYse.js";
import { c as mapLegacyEndpointsToCanvasConnectionPort, i as insertSpacersBetweenEndpoints, l as parseCanvasConnectionHandleString, n as checkOverlap, r as createCanvasConnectionHandleString, s as mapLegacyConnectionsToCanvasConnections, t as useNodeCreatorStore } from "./nodeCreator.store-DfAjRvxz.js";
import { t as getNodeIconSource } from "./nodeIcon-CMJv_dmQ.js";
import { a as useLogsStore, i as useExperimentalNdvStore, t as useCanvasOperations } from "./useCanvasOperations-YULAapmT.js";
...
import { t as NodeSettings_default } from "./NodeSettings-tuR1-_it.js";
