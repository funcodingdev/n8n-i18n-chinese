import { Ta as GLOBAL_CUSTOM_ROLE_SCOPE_GROUPS } from "./src-B2jBAc9z.js";
...
var MANDATORY_INSTANCE_SCOPES = GLOBAL_CUSTOM_ROLE_SCOPE_GROUPS.user.View;
/** Unions in the mandatory scopes (see `isOptionMandatory`) on top of an already-filtered scope list. */
function withMandatoryInstanceScopes(scopes) {
...
function findSubordinateOption(option, groupOptions) {
	const subordinateKey = Object.keys(SUPERSEDED_BY).find((key) => SUPERSEDED_BY[key] === option.key && groupOptions.some((o) => o.key === key));
	return subordinateKey ? groupOptions.find((o) => o.key === subordinateKey) : void 0;
}
/**
...
//#endregion
export { countGrantedInstancePermissions as a, isOptionMandatory as c, withMandatoryInstanceScopes as d, TOTAL_INSTANCE_PERMISSIONS as i, resolveOptionState as l, INSTANCE_SCOPE_GROUP_LIST as n, getEscalationWarningKey as o, SUPERSEDED_BY as r, isOptionImplied as s, ALL_INSTANCE_SCOPES as t, toggleOptionInGroup as u };
