...
import { $ as openBlock, A as createTextVNode, C as createBaseVNode, E as createElementBlock, Ft as ref, N as defineComponent, O as createSlots, S as computed, Sn as toDisplayString, T as createCommentVNode, W as nextTick, Wt as unref, X as onMounted, _n as normalizeClass, ft as useSlots, gt as watch, it as renderSlot, j as createVNode, q as onBeforeUnmount, w as createBlock, yn as normalizeStyle, yt as withCtx } from "./vue.runtime.esm-bundler-C6vn67cX.js";
import { s as useI18n } from "./src-WwCUXbmD.js";
import { Bt as useDeviceSupport, Da as N8nText_default, F as N8nResizeWrapper_default, Ot as createEventBus, ka as N8nIcon_default, zi as N8nTooltip_default } from "./src-DFOx8N22.js";
import { t as _plugin_vue_export_helper_default } from "./_plugin-vue_export-helper-Da88TEg1.js";
import { a as InputPanel_default } from "./ParameterInputList-CLhNpHq2.js";
import { t as useMessage } from "./useMessage-CUOLq_eS.js";
import { t as ElDialog } from "./dialog-CeFKTjMR.js";
import { _ as useWorkflowExecutionStateStore, b as injectWorkflowDocumentStore, k as useNodeHelpers, q as useNodeTypesStore, t as useWorkflowsStore, un as injectNDVStore } from "./workflows.store-Cc2IYz8o.js";
import { Qt as EXECUTABLE_TRIGGER_NODE_TYPES, bs as getNodeOutputs, gc as NodeConnectionTypes, i as BASE_NODE_SURVEY_URL, tc as jsonParse, va as LOCAL_STORAGE_MAIN_PANEL_RELATIVE_WIDTH, w as APP_MODALS_ELEMENT_ID } from "./constants-BMUE7W6Y.js";
import { K as useThrottleFn } from "./core-nZc0i8VB.js";
import { _ as useStorage, f as useUIStore, p as useTelemetry } from "./users.store-OUM63rct.js";
...
import { a as dataPinningEventBus, t as nodeViewEventBus } from "./event-bus-Bp9YvPxG.js";
...
import { n as OutputPanel_default, r as NDVFloatingNodes_default, t as TriggerPanel_default } from "./TriggerPanel-B01r_4TB.js";
...
var dataPanel = "_dataPanel_6rjea_125";
var inputPanel = "_inputPanel_6rjea_134 _dataPanel_6rjea_125";
var outputPanel = "_outputPanel_6rjea_142 _dataPanel_6rjea_125";
var mainPanel = "_mainPanel_6rjea_150";
var draggable = "_draggable_6rjea_154";
var mainPanelInner = "_mainPanelInner_6rjea_158";
var dragging = "_dragging_6rjea_165";
var dragButtonContainer = "_dragButtonContainer_6rjea_178";
var visible = "_visible_6rjea_194";
...
var NDVDraggablePanels_default = /* @__PURE__ */ _plugin_vue_export_helper_default(NDVDraggablePanels_vue_vue_type_script_setup_true_lang_default, [["__cssModules", { "$style": NDVDraggablePanels_vue_vue_type_style_index_0_lang_module_default }]]);
//#endregion
...
var NodeDetailsView_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props, { emit: __emit }) {
		...
		const showTriggerWaitingWarning = computed(() => triggerWaitingWarningEnabled.value && !!activeNodeType.value && !activeNodeType.value.group.includes("trigger") && workflowExecutionStateStore.value.isWorkflowRunning && workflowExecutionStateStore.value.executionWaitingForWebhook);
		...
		const parentNodes = computed(() => {
			if (activeNode.value) return workflowDocumentStore.value.getParentNodesByDepth(activeNode.value.name, 1) ?? [];
			return [];
		});
		const parentNode = computed(() => {
			for (const parent of parentNodes.value) {
				if (workflowDocumentStore?.value?.pinnedDataByNodeName?.[parent.name]) return parent;
		...
		const blockUi = computed(() => workflowExecutionStateStore.value.isWorkflowRunning || isExecutionWaitingForWebhook.value);
		...
		const onNodeExecute = () => {
			setTimeout(() => {
				if (!activeNode.value || !workflowExecutionStateStore.value.isWorkflowRunning) return;
		...
		return (_ctx, _cache) => {
			return openBlock(), createBlock(unref(ElDialog), {
				id: "ndv",
				"model-value": (!!activeNode.value || __props.renaming) && !isActiveStickyNode.value,
				"before-close": close,
				"show-close": false,
				...
				default: withCtx(() => [createVNode(unref(N8nTooltip_default), {
					...
					_: 1
				}, 8, ["visible", "disabled"]), activeNode.value ? (openBlock(), createElementBlock("div", _hoisted_1, [createBaseVNode("div", {
					class: normalizeClass(_ctx.$style.modalBackground),
					onClick: close
				}, null, 2), (openBlock(), createBlock(NDVDraggablePanels_default, {
					key: activeNode.value.name,
...
var NodeDetailsView_default = /* @__PURE__ */ _plugin_vue_export_helper_default(NodeDetailsView_vue_vue_type_script_setup_true_lang_default, [["__cssModules", { "$style": NodeDetailsView_vue_vue_type_style_index_1_lang_module_default }]]);
//#endregion
