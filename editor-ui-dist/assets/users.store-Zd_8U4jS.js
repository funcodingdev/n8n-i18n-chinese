...
import { $ as openBlock, $t as hyphenate, A as createTextVNode, At as isRef, Bt as toRef, C as createBaseVNode, D as createPropsRestProxy, E as createElementBlock, Et as getCurrentScope, Ft as ref, Ht as toValue$1, I as h, K as onBeforeMount, Mt as onScopeDispose, N as defineComponent, Nt as reactive, P as getCurrentInstance, Pt as readonly, R as inject, Rt as shallowRef, S as computed, Sn as toDisplayString, T as createCommentVNode, Tt as effectScope, U as mergeProps, Vt as toRefs$1, W as nextTick, Wt as unref, X as onMounted, Z as onUnmounted, _ as Fragment, _n as normalizeClass, at as resolveComponent, bt as withDirectives, en as init_shared_esm_bundler, ft as useSlots, gt as watch, i as createApp, it as renderSlot, j as createVNode, jt as markRaw, lt as useAttrs, n as Transition$1, ot as resolveDirective, p as vShow, pn as isString$1, q as onBeforeUnmount, rt as renderList, sn as isObject$2, st as resolveDynamicComponent, tt as provide, w as createBlock, wt as customRef, y as Teleport, yn as normalizeStyle, yt as withCtx, z as isMemoSame } from "./vue.runtime.esm-bundler-Bw8GKr4Y.js";
import { A as createEventHook, T as useStorage$1, at as useI18n, et as addHeaders, nt as i18n, s as useAsyncState, tt as addNodeTranslation, v as useLocalStorage, y as useMediaQuery } from "./core-Beh0t8_q.js";
import { Ct as createEventBus, Li as truncate, cr as removeClass, dn as useGlobalComponentSettings, ir as addClass, j as isBinary, lt as useRoute, mi as isClient$1, or as getStyle } from "./src-Dg8CDsvD.js";
import { a as require_toString, s as require_memoize, t as require_get } from "./get-Den8eczo.js";
import { $i as LOCAL_STORAGE_THEME, $o as isResourceLocatorValue, $r as FROM_AI_PARAMETERS_MODAL_KEY, $s as require_keys, $t as EXECUTE_COMMAND_NODE_TYPE, Aa as require__baseFlatten, Ac as WorkflowDocumentStoreKey, Ai as WORKFLOW_SETTINGS_MODAL_KEY, At as CALENDLY_TRIGGER_NODE_TYPE, B as AI_CATEGORY_AGENTS, Bi as LOCAL_STORAGE_EXPERIMENT_OVERRIDES, Bo as mergeIssues, Br as ABOUT_MODAL_KEY, Bt as CREDENTIAL_ONLY_NODE_PREFIX, C as TEMPLATES_NODES_FILTER, Ci as WORKFLOW_EXTRACTION_NAME_MODAL_KEY, Co as getConnectionTypes, Cs as NodeConnectionTypes, Di as WORKFLOW_HISTORY_VERSION_RESTORE, Dn as MODULE_ENABLED_NODES, Do as getNodeParametersIssues, Dt as AI_TRANSFORM_NODE_TYPE, Ei as WORKFLOW_HISTORY_PUBLISH_MODAL_KEY, En as MICROSOFT_TEAMS_NODE_TYPE, Eo as getNodeParameters, Et as AI_MCP_TOOL_NODE_TYPE, Fo as isHitlToolType, Ft as CLEARBIT_NODE_TYPE, Gc as EXPERIMENTS_TO_TRACK, Gr as CHAT_EMBED_MODAL_KEY, Gs as SEND_AND_WAIT_OPERATION, Hr as AI_GATEWAY_TOP_UP_MODAL_KEY, I as MAPPING_PARAMS, It as CODE_NODE_TYPE, J as AI_CATEGORY_OTHER_TOOLS, Jn as SCHEDULE_TRIGGER_NODE_TYPE, Jr as DELETE_SECRETS_PROVIDER_MODAL_KEY, Jt as ELASTIC_SECURITY_NODE_TYPE, Ka as require__baseIteratee, Kr as CONFIRM_PASSWORD_MODAL_KEY, Ks as TRIMMED_TASK_DATA_CONNECTIONS_KEY, Ls as EVALUATION_TRIGGER_NODE_TYPE, Mn as NOTION_TRIGGER_NODE_TYPE, Ms as BINARY_MODE_SEPARATE, N as CUSTOM_API_CALL_KEY, Oa as require_pick, Oi as WORKFLOW_HISTORY_VERSION_UNPUBLISH, Oo as getNodeWebhookUrl, Ot as BAMBOO_HR_NODE_TYPE, P as DATA_TYPE_ICON_MAP, Pa as isAssignmentCollectionValue, Ps as CHAT_TRIGGER_NODE_TYPE, Pt as CHAT_TRIGGER_NODE_TYPE$1, Qa as traverseNodeParameters, Qi as LOCAL_STORAGE_SIDEBAR_WIDTH, Qr as EXTERNAL_SECRETS_PROVIDER_MODAL_KEY, Rr as MAIN_HEADER_TABS, Si as WORKFLOW_DIFF_MODAL_KEY, So as displayParameterPath, Ti as WORKFLOW_HISTORY_NAME_VERSION_MODAL_KEY, Tn as MICROSOFT_EXCEL_NODE_TYPE, To as getNodeOutputs, Ts as isExpression, Ua as require__createCompounder, Un as QUICKBOOKS_NODE_TYPE, Ur as BINARY_DATA_VIEW_MODAL_KEY, Us as MANUAL_TRIGGER_NODE_TYPE, Vr as AI_BUILDER_DIFF_MODAL_KEY, W as AI_CATEGORY_HUMAN_IN_THE_LOOP, Wr as CHANGE_PASSWORD_MODAL_KEY, Xn as SERVICENOW_NODE_TYPE, Xr as EXPERIMENT_TEMPLATE_RECO_V2_KEY, Xt as EMAIL_SEND_NODE_TYPE, Yn as SEGMENT_NODE_TYPE, Yr as DUPLICATE_MODAL_KEY, Ys as v4, Zn as SET_NODE_TYPE, Zr as EXPERIMENT_TEMPLATE_RECO_V3_KEY, Zs as require_isEqual, Zt as ERROR_TRIGGER_NODE_TYPE, _i as VERSIONS_MODAL_KEY, _o as mapConnectionsByDestination, _r as WORKFLOW_TRIGGER_NODE_TYPE, al as EnterpriseEditionFeature, an as FORM_TRIGGER_NODE_TYPE$1, ao as require__baseFindIndex, as as isObjectEmpty, bi as WORKFLOW_ACTIVE_MODAL_KEY, bn as MANUAL_CHAT_TRIGGER_NODE_TYPE, bo as generateNodesGraph, br as ZENDESK_NODE_TYPE, ca as ROLE, ct as CORE_NODES_CATEGORY, di as NEW_ASSISTANT_SESSION_MODAL, dn as HUBSPOT_TRIGGER_NODE_TYPE, ei as IMPORT_CURL_MODAL_KEY, es as isResourceMapperValue$1, et as AI_CATEGORY_VECTOR_STORES, f as DOCS_DOMAIN, fc as getResourcePermissions, fi as NPS_SURVEY_MODAL_KEY, fn as IF_NODE_TYPE, ft as HUMAN_IN_THE_LOOP_CATEGORY, gi as STOP_MANY_EXECUTIONS_MODAL_KEY, gn as JIRA_TRIGGER_NODE_TYPE, gr as WORKABLE_TRIGGER_NODE_TYPE, gt as RECOMMENDED_NODES, hi as SETUP_CREDENTIALS_MODAL_KEY, hn as JIRA_NODE_TYPE, hr as WOOCOMMERCE_TRIGGER_NODE_TYPE, ii as INSTANCE_AI_CREDENTIAL_SETUP_MODAL_KEY, ir as SPREADSHEET_FILE_NODE_TYPE, j as PLACEHOLDER_FILLED_AT_EXECUTION_TIME, ji as WORKFLOW_SHARE_MODAL_KEY, jn as NON_ACTIVATABLE_TRIGGER_NODE_TYPES, ki as WORKFLOW_PUBLISH_MODAL_KEY, kn as NODE_POSITION_CONFLICT_ALLOWLIST, ln as HTTP_REQUEST_NODE_TYPE, lr as THE_HIVE_TRIGGER_NODE_TYPE, mi as SECRETS_PROVIDER_CONNECTION_MODAL_KEY, mn as ITEM_LISTS_NODE_TYPE, mo as createRunExecutionData, mr as WIKIPEDIA_TOOL_NODE_TYPE, oi as LOG_STREAM_MODAL_KEY, on as GITHUB_TRIGGER_NODE_TYPE, os as jsonParse, pc as hasScope$1, pi as PROMPT_MFA_CODE_MODAL_KEY, po as createEmptyRunExecutionData, pr as WEBHOOK_NODE_TYPE, qn as SALESFORCE_NODE_TYPE, qo as isFilterValue, qr as CREDENTIAL_RESOLVER_EDIT_MODAL_KEY, r as DUPLICATE_POSTFFIX, rc as ApplicationError, rs as deepCopy, si as MFA_SETUP_MODAL_KEY, sn as GOOGLE_SHEETS_NODE_TYPE, sr as SWITCH_NODE_TYPE, st as BETA_NODES, ti as IMPORT_WORKFLOW_URL_MODAL_KEY, to as splitExpression, tr as SLACK_NODE_TYPE, tt as AI_CODE_TOOL_LANGCHAIN_NODE_TYPE, us as sleep$1, vi as WHATS_NEW_MODAL_KEY, vo as getNodeByName, vr as XERO_NODE_TYPE, wi as WORKFLOW_HISTORY_DIFF_MODAL_KEY, wo as getNodeInputs, ws as nodeConnectionTypes, xi as WORKFLOW_DESCRIPTION_MODAL_KEY, xo as displayParameter, xr as ZENDESK_TRIGGER_NODE_TYPE, xs as ExpressionError, yi as WORKFLOW_ACTIVATION_CONFLICTING_WEBHOOK_MODAL_KEY, yn as LIST_LIKE_NODE_OPERATIONS, yo as getChildNodes, za as Workflow, zn as PAGERDUTY_NODE_TYPE, zo as makeNodeName, zr as VIEWS } from "./constants-c-L9DE1I.js";
import { b as require_isArrayLike, n as require__isIterateeCall, o as require_identity, r as require__baseRest, t as require_merge } from "./merge-yNpRmDfK.js";
import { E as getActivePinia, S as BROWSER_ID_STORAGE_KEY, T as defineStore, a as ResponseError, c as makeRestApiRequest, d as request, f as streamRequest, m as axios, s as getFullApiResponse, t as useRootStore, u as post } from "./useRootStore-CCt5xa74.js";
import { C as updateGlobalRole, E as validateSignupToken, In as STORES, Nt as getProjectSecretProviderConnectionsByProjectId, S as updateCurrentUserSettings, Sn as sendConfirmationEmail, T as validatePasswordToken, _ as sendForgotPasswordEmail, _t as disableMfa, b as updateCurrentUser, bt as updateEnforceMfa, ct as getLocalResourceMapperFields, d as generateInviteLink, dt as getNodeTranslationHeaders, f as getPasswordResetLink, ft as getNodeTypes$1, g as logout, gt as canEnableMFA, h as loginCurrentUser, ht as getResourceMapperFields, l as changePassword, lt as getNodeParameterActionResult, m as login, mt as getResourceLocatorResults, o as findWebhook, ot as fetchCommunityNodeAttributes, p as getUsers, pt as getNodesInformation, r as getWorkflowVersion, st as fetchCommunityNodeTypes, t as useSettingsStore, u as deleteUser, ut as getNodeParameterOptions, v as setupOwner, vt as enableMfa, w as updateOtherUserSettings, x as updateCurrentUserPassword, xt as verifyMfaCode, y as submitPersonalizationSurvey, yt as getMfaQR } from "./settings.store-CN5kyBJf.js";
import { t as require_dateformat } from "./dateformat-Cm5TT0Ok.js";
import { r as require_toNumber, t as useDebounce } from "./useDebounce-Ccny4Tl9.js";
import { t as require__baseOrderBy } from "./_baseOrderBy-BJNpzIOa.js";
//#region ../../../node_modules/.pnpm/element-plus@2.4.3_patch_hash=3bc4ea0a42ad52c6bbc3d06c12c2963d55b57d6b5b8d436e46e7fd8ff_6ee25ac3afe262da12a5490787fff33d/node_modules/element-plus/es/components/loading/src/loading.mjs
...
//#endregion
//#region ../../../node_modules/.pnpm/element-plus@2.4.3_patch_hash=3bc4ea0a42ad52c6bbc3d06c12c2963d55b57d6b5b8d436e46e7fd8ff_6ee25ac3afe262da12a5490787fff33d/node_modules/element-plus/es/components/loading/src/service.mjs
...
//#endregion
//#region ../../../node_modules/.pnpm/element-plus@2.4.3_patch_hash=3bc4ea0a42ad52c6bbc3d06c12c2963d55b57d6b5b8d436e46e7fd8ff_6ee25ac3afe262da12a5490787fff33d/node_modules/element-plus/es/components/loading/src/directive.mjs
init_shared_esm_bundler();
...
//#endregion
//#region ../../../node_modules/.pnpm/element-plus@2.4.3_patch_hash=3bc4ea0a42ad52c6bbc3d06c12c2963d55b57d6b5b8d436e46e7fd8ff_6ee25ac3afe262da12a5490787fff33d/node_modules/element-plus/es/components/loading/index.mjs
var ElLoading = {
	install(app) {
	...
	setup(__props) {
		...
		return (_ctx, _cache) => {
			...
			return openBlock(), createElementBlock("div", null, [
				...
				}, toDisplayString(unref(i18n).baseText("node.executionError.openNode")), 9, _hoisted_2$3)
			]);
		};
	}
});
...
var parse = (text, reviver) => {
	...
	let value = input[0];
	if (typeof value === object$1 && value) {
		const lazy = [];
...
var useSourceControlStore = defineStore("sourceControl", () => {
	...
	const makePreferencesAction = (action) => async (preferences) => {
		setPreferences(await action(rootStore.restApiContext, preferences));
	};
...
function useWorkflowDocumentPinData() {
	const pinData = ref({});
	...
	function applyRenamePinDataNode(oldName, newName) {
		...
		Object.values(pinData.value).flatMap((executionData) => executionData.flatMap((nodeExecution) => Array.isArray(nodeExecution.pairedItem) ? nodeExecution.pairedItem : [nodeExecution.pairedItem])).forEach((pairedItem) => {
...
function useWorkflowDocumentNodes(deps) {
	...
	*/
	...
	function applySetNodes(nodes) {
		...
		for (const node of nodes) deps.nodeMetadata.initPristineNodeMetadata(node.name);
	}
	...
	function applyRemoveNode(node) {
		...
		if (idx !== -1) workflowsStore.workflow.nodes = [...workflowsStore.workflow.nodes.slice(0, idx), ...workflowsStore.workflow.nodes.slice(idx + 1)];
		deps.syncWorkflowObject(workflowsStore.workflow.nodes);
	...
	const allNodes = computed(() => workflowsStore.allNodes);
	const nodesByName = computed(() => workflowsStore.nodesByName);
	...
	function setNodeParameters(updateInformation, append) {
		const nodeIndex = workflowsStore.workflow.nodes.findIndex((node) => node.name === updateInformation.name);
	...
	function setLastNodeParameters(updateInformation) {
		const latestNode = (0, import_findLast.default)(workflowsStore.workflow.nodes, (node) => node.type === updateInformation.key);
	...
	function setNodeValue(updateInformation) {
		...
		if (changed && ![
			...
			"notes",
			"notesInFlow"
		].includes(updateInformation.key)) deps.nodeMetadata.touchParametersLastUpdatedAt(workflowsStore.workflow.nodes[nodeIndex].name);
	}
	...
	function setNodeIssue(nodeIssueData) {
		const nodeIndex = workflowsStore.workflow.nodes.findIndex((node) => node.name === nodeIssueData.node);
...
function useWorkflowDocumentConnections(deps) {
	...
	function applyRemoveConnection(data) {
		...
		for (const index in connections) if (connections[index].node === destinationData.node && connections[index].type === destinationData.type && connections[index].index === destinationData.index) connections.splice(Number.parseInt(index, 10), 1);
		deps.syncWorkflowObject(workflowsStore.workflow.connections);
		onConnectionsChange.trigger({
			action: CHANGE_ACTION.DELETE,
			payload: { connection: data.connection }
	...
	const connectionsBySourceNode = computed(() => workflowsStore.connectionsBySourceNode);
	const connectionsByDestinationNode = computed(() => workflowsStore.connectionsByDestinationNode);
...
function useWorkflowDocumentWorkflowObject(deps) {
	...
	function syncWorkflowObjectId(id) {
...
function useNodeHelpers() {
	...
	*/
	function getForeignCredentialsIfSharingEnabled(credentials) {
		...
		const usedCredentials = useWorkflowDocumentStore(createWorkflowDocumentId(workflowsStore.workflowId)).usedCredentials;
	...
	function updateNodeInputIssues(node) {
		...
		if (!nodeType) return;
		const nodeInputIssues = getNodeInputIssues(workflowDocumentStore.value.getSnapshot(), node, nodeType);
	...
	function getNodeCredentialIssues(node, nodeType) {
		...
		if (hasProxyAuth(node) && authentication === "predefinedCredentialType" && nodeCredentialType !== "" && node.credentials !== void 0) {
			...
			const isCredentialUsedInWorkflow = workflowDocumentStore.usedCredentials?.[node.credentials?.[nodeCredentialType]?.id];
		...
		for (const credentialTypeDescription of localNodeType.credentials) {
			...
			if (!node.credentials?.[credentialTypeDescription.name]) {
				...
				if (nameMatches.length === 0) {
					if (!workflowDocumentStore.usedCredentials?.[selectedCredentials.id] && !hasPermission(["rbac"], { rbac: { scope: "credential:read" } })) foundIssues[credentialTypeDescription.name] = [i18n.baseText("nodeIssues.credentials.doNotExist", { interpolate: {
						name: selectedCredentials.name,
						type: credentialDisplayName
	...
	return defineStore(getWorkflowDocumentStoreId(id), () => {
		...
		function getSnapshot() {
			return {
				...
				pinData: workflowDocumentPinData.pinData.value,
...
*/
function disposeWorkflowDocumentStore(id) {
...
var useNDVStore = defineStore(STORES.NDV, () => {
	...
	const ndvInputDataWithPinnedData = computed(() => {
		...
		return ndvInputNodeName.value ? workflowDocumentStore.value.pinData?.[ndvInputNodeName.value] ?? data : data;
	});
	...
	const ndvNodeInputNumber = computed(() => {
		const returnData = {};
		const activeNodeConections = (workflowDocumentStore.value.connectionsByDestinationNode[activeNode.value?.name || ""] ?? {}).main;
	...
	const isInputParentOfActiveNode = computed(() => {
		...
		return workflowDocumentStore.value.getParentNodes(activeNode.value.name, NodeConnectionTypes.Main, 1)?.includes(inputNodeName) ?? false;
	});
	...
	const updateNodeParameterIssues = (issues) => {
		...
		if (node?.id) workflowDocumentStore.value.updateNodeById(node.id, { issues: {
			...node.issues,
			...issues
		} });
	};
...
var useProjectsStore = defineStore(STORES.PROJECTS, () => {
	...
	const updateProject$1 = async (id, projectData) => {
		...
		if (nm !== void 0) useFavoritesStore().renameFavorite(id, "project", nm);
	};
...
var createTagsStore = (id) => {
	...
	return defineStore(id, () => {
		...
		const deleteTagById = async (id) => {
			...
			if (deleted) {
				deleteTag(id);
				if (workflowsStore.workflowId) useWorkflowDocumentStore(createWorkflowDocumentId(workflowsStore.workflowId)).removeTag(id);
			}
			return deleted;
		};
		return {
...
async function resolveParameter(parameter, opts = {}) {
	...
	const workflowsStore = useWorkflowsStore();
	const workflowDocumentStore = useWorkflowDocumentStore(createWorkflowDocumentId(workflowsStore.workflowId));
	return await resolveParameterImpl(parameter, workflowDocumentStore.getSnapshot(), workflowDocumentStore.connectionsBySourceNode, useEnvironmentsStore().variablesAsObject, useNDVStore().activeNode, workflowsStore.workflowExecutionData, workflowDocumentStore.getPinDataSnapshot(), opts);
}
function resolveParameterImpl(parameter, workflowObject, connections, envVars, ndvActiveNode, executionData, pinData, opts = {}) {
...
async function resolveRequiredParameters(currentParameter, parameters, opts = {}) {
	...
	const resolvedEntries = await Promise.all(entries.map(async ([name, parameter]) => {
		if (loadOptionsDependsOn.has(name)) return [name, await resolveParameter(parameter, opts)];
		else try {
			return [name, await resolveParameter(parameter, opts)];
		} catch (error) {
			return [name, null];
		}
	}));
...
function executeData(connections, parentNodes, currentNode, inputName, runIndex, parentRunIndex) {
	const workflowsStore = useWorkflowsStore();
	return executeDataImpl(connections, parentNodes, currentNode, inputName, runIndex, useWorkflowDocumentStore(createWorkflowDocumentId(workflowsStore.workflowId)).getPinDataSnapshot(), workflowsStore.getWorkflowRunData, parentRunIndex);
}
...
function useWorkflowHelpers() {
	...
	*/
	...
	async function checkConflictingWebhooks(workflowId) {
		let data;
		if (uiStore.stateIsDirty) data = useWorkflowDocumentStore(createWorkflowDocumentId(workflowsStore.workflowId)).serialize();
...
var getExpressionErrorMessage = (error, nodeHasRunData = false) => {
	...
	if (isInvalidPairedItemError(error) || isNoPairedItemError(error)) {
		const nodeCause = error.context.nodeCause;
		if (!!useWorkflowDocumentStore(createWorkflowDocumentId(useWorkflowsStore().workflowId)).pinData?.[nodeCause]) return i18n.baseText("expressionModalInput.pairedItemInvalidPinnedError", { interpolate: { node: nodeCause } });
	}
...
var stringifyExpressionResult = (result, nodeHasRunData = false) => {
	if (!result.ok) {
...
function useDataSchema() {
	...
	function getInputDataWithPinned(node, runIndex = 0, outputIndex = 0) {
		if (!node) return [];
		const pinnedData = useWorkflowDocumentStore(createWorkflowDocumentId(useWorkflowsStore().workflowId)).getNodePinData(node.name)?.map((item) => item.json);
	...
	*/
	function getNodesSchemas(workflowId, nodeNames, excludeValues) {
		...
		for (const name of nodeNames) {
			...
			if (!node) continue;
			if (workflowDocumentStore.pinData?.[node.name]) pinnedNodeNames.push(node.name);
...
//#endregion
//#region ../../@n8n/utils/src/search/reRankSearchResults.ts
...
//#endregion
//#region ../../@n8n/utils/src/search/sublimeSearch.ts
...
function applyNodeTags(element) {
	...
	else if (useSettingsStore().isAiGatewayEnabled && useAiGatewayStore().isNodeSupported(element.properties.name)) element.properties.tag = {
...
var filterAndSearchNodes = (mergedNodes, search, isAgentSubcategory) => {
...
var startTestRun = async (context, workflowId) => {
...
var useNodeTypesStore = defineStore(STORES.NODE_TYPES, () => {
	...
	const getNodeTypes = async () => {
		const nodeTypes = await getNodeTypes$1(rootStore.baseUrl);
...
function isChatNode(node) {
	return [CHAT_TRIGGER_NODE_TYPE$1, MANUAL_CHAT_TRIGGER_NODE_TYPE].includes(node.type);
}
//#endregion
...
var useWorkflowsStore = defineStore(STORES.WORKFLOWS, () => {
	...
	const isNewWorkflow = computed(() => {
		...
		return !workflowsListStore.getWorkflowById(workflow.value.id)?.id;
	});
	...
	*/
	...
	const workflowExecutionTriggerNodeName = computed(() => {
		...
		return Object.keys(workflowExecutionData.value?.data?.resultData.runData ?? {}).find((name) => workflowTriggerNodes.value.some((node) => node.name === name));
	});
	...
	*/
	...
	function getExecutionDataById(id) {
	...
	function getNodeTypes() {
		return {
			...
			getByNameAndVersion: (nodeType, version) => {
				const nodeTypeDescription = nodeTypesStore.getNodeType(nodeType, version) ?? nodeTypesStore.communityNodeType(nodeType)?.nodeDescription ?? null;
	...
	*/
	...
	function createWorkflowObject(nodes, connections, copyData) {
		...
		let id = workflow.value.id;
		if (id && !workflowsListStore.getWorkflowById(id)?.id) id = void 0;
	...
	function setWorkflowActiveVersion(version) {
		...
		const wfId = workflow.value.id;
		if (wfId) useWorkflowDocumentStore(createWorkflowDocumentId(wfId)).setActiveVersion(deepCopy(version));
	}
	...
	function assignCredentialToMatchingNodes(data) {
		...
		workflow.value.nodes.forEach((node) => {
			...
			if (credentialDescription.displayOptions && !nodeHelpers.displayParameter(node.parameters, credentialDescription, "", node)) return;
			node.credentials ??= {};
			node.credentials[data.type] = data.credentials;
			updatedNodesCount++;
		});
	...
	function setWorkflowActive(targetWorkflowId, activeVersion, clearDirtyState) {
		...
		if (targetWorkflowId === workflow.value.id && clearDirtyState) uiStore.markStateClean();
	}
	...
	function renameNodeSelectedAndExecution(nameData) {
		...
		Object.values(workflowExecutionData.value?.data?.resultData.pinData ?? {}).flatMap((executionData) => executionData.flatMap((nodeExecution) => Array.isArray(nodeExecution.pairedItem) ? nodeExecution.pairedItem : [nodeExecution.pairedItem])).forEach((pairedItem) => {
	...
	async function trackNodeExecution(pushData) {
		...
		if (pushData.data.error) {
			...
			telemetry.track("Manual exec errored", {
				...
				node_id: node?.id,
				node_graph_string: JSON.stringify(generateNodesGraph(useWorkflowDocumentStore(createWorkflowDocumentId(workflowId.value)).serialize(), workflowHelpers.getNodeTypes(), { isCloudDeployment: settingsStore.isCloudDeployment }).nodeGraph)
			});
		}
	}
	...
	function updateNodeExecutionStatus(pushData) {
		if (!workflowExecutionData.value?.data) {
			console.warn("[workflows.store] updateNodeExecutionStatus called without execution data; ignoring.");
			return;
		}
		const { nodeName, data } = pushData;
		const isNodeWaiting = data.executionStatus === "waiting";
		if (!getNodeByName$1(nodeName)) return;
		...
		if (isNodeWaiting) {
			tasksData.push(data);
			workflowExecutionResultDataLastUpdate.value = Date.now();
			if (data.metadata?.resumeFormUrl) openFormPopupWindow(data.metadata.resumeFormUrl);
		} else {
		...
		if (!workflowExecutionData.value.data.redactionInfo?.isRedacted && data.data) for (const connectionType of Object.keys(data.data)) {
...
var useUIStore = defineStore(STORES.UI, () => {
	...
	*/
	...
	const lastInteractedWithNode = computed(() => {
		if (lastInteractedWithNodeId.value) return workflowDocumentStore.value.getNodeById(lastInteractedWithNodeId.value) ?? null;
		return null;
	});
	...
	*/
	...
	const openExistingCredential = (id) => {
	...
	const openNewCredential = (type, showAuthOptions = false, forceManualMode = false, projectId, suggestedName, nodeName) => {
...
//#endregion
export { require_sortBy as $, DEVOPS_REPORTING_GOAL as $a, toMegaBytes as $i, DEFAULT_VIEWPORT_BOUNDARIES as $n, TELECOMS_INDUSTRY as $o, createDataTableApi as $r, createWorkflowDocumentId as $t, getAiTemplatesCallout as A, ANNOTATION_TAGS_MANAGER_MODAL_KEY as Aa, hasProxyAuth as Ai, isValidNodeConnectionType as An, REPORTED_SOURCE_EVENT as Ao, useVueFlow as Ar, resolveParameter as At, searchNodes as B, COMPANY_SIZE_500_999 as Ba, abbreviateNumber as Bi, BulkCommand as Bn, ROLE_BUSINESS_OWNER as Bo, hasPermission as Br, useEnvironmentsStore as Bt, waitingNodeTooltip as C, MOVE_FOLDER_MODAL_KEY as Ca, getNodeAuthFields as Ci, isResourceSortableByDate as Cn, OTHER_COMPANY_TYPE as Co, getBezierPath as Cr, getResolvableState as Ct, filterAndSearchNodes as D, COMMUNITY_PLUS_DOCS_URL as Da, getTriggerNodeServiceName as Di, isTriggerPanelObject as Dn, PERSONAL_COMPANY_TYPE as Do, getSmoothStepPath as Dr, shouldConvertToExpression as Dt, useEvaluationStore as E, VARIABLE_MODAL_KEY as Ea, getThemedValue as Ei, isString as En, PERSONALIZATION_MODAL_KEY as Eo, getRectOfNodes as Er, removeExpressionPrefix as Et, isNodePreviewKey as F, AUTOMATION_BENEFICIARY_SELF as Fa, isValueExpression as Fi, CanvasNodeDirtiness as Fn, REPORTED_SOURCE_OTHER as Fo, pinDataToExecutionData as Fr, removeWorkflowExecutionData as Ft, SampleTemplates as G, DEVOPS_AUTOMATION_CI_CD_GOAL as Ga, hasFocusOnInput as Gi, RemoveNodeCommand as Gn, ROLE_KEY as Go, shouldEnableMfa as Gr, useRemoteProjectSearch as Gt, sortNodeCreateElements as H, COMPANY_SIZE_PERSONAL_USE as Ha, convertPath as Hi, EnableNodeToggleCommand as Hn, ROLE_DATA_SCIENCE as Ho, isEnterpriseFeatureEnabled as Hr, getTruncatedProjectName as Ht, mapToolSubcategoryIcon as I, COMPANY_INDUSTRY_EXTENDED_KEY as Ia, parseResourceMapperFieldName as Ii, CanvasNodeRenderType as In, REPORTED_SOURCE_OTHER_KEY as Io, CHANGE_ACTION as Ir, sortNodesByExecutionOrder as It, getTutorialTemplates as J, DEVOPS_AUTOMATION_GOAL_KEY as Ja, isFocusableEl as Ji, historyBus as Jn, ROLE_SALES_AND_MARKETING as Jo, hasRole as Jr, useTelemetry as Jt, getRagStarterWorkflowJson as K, DEVOPS_AUTOMATION_CLOUD_INFRASTRUCTURE_ORCHESTRATION_GOAL as Ka, isBlurrableEl as Ki, RenameNodeCommand as Kn, ROLE_OTHER as Ko, hasScope as Kr, useProjectsStore as Kt, nodeTypesToCreateElements as L, COMPANY_SIZE_1000_OR_MORE as La, updateNodeAuthType as Li, useHistoryStore as Ln, REPORTED_SOURCE_PODCAST as Lo, LOCAL_STORAGE_NDV_PANEL_WIDTH as Lr, getPairedItemId as Lt, getRootSearchCallouts as M, AUTOMATION_BENEFICIARY_KEY as Ma, isMatchingField as Mi, isVueFlowConnection as Mn, REPORTED_SOURCE_GOOGLE as Mo, isCredentialOnlyNodeType as Mr, useWorkflowHelpers as Mt, groupItemsInSections as N, AUTOMATION_BENEFICIARY_MY_TEAM as Na, isRequiredCredential as Ni, isWorkflowListItem as Nn, REPORTED_SOURCE_KEY as No, DEFAULT_SETTINGS as Nr, useAnnotationTagsStore as Nt, finalizeItems as O, COMMUNITY_PLUS_ENROLLMENT_MODAL as Oa, hasExpressionMapping as Oi, isValidCanvasConnectionMode as On, PHYSICAL_RETAIL_OR_SERVICES as Oo, isMacOs as Or, stringifyExpressionResult as Ot, isAINode as P, AUTOMATION_BENEFICIARY_OTHER_TEAMS as Pa, isResourceMapperFieldListStale as Pi, CanvasConnectionMode as Pn, REPORTED_SOURCE_LINKEDIN as Po, getPinDataSize as Pr, useTagsStore as Pt, useAiGatewayStore as Q, DEVOPS_MONITORING_AND_ALERTING_GOAL as Qa, stringSizeInBytes as Qi, DEFAULT_NODE_SIZE as Qn, SYSTEMS_INTEGRATOR_COMPANY_TYPE as Qo, addDataTableColumnApi as Qr, useNDVStore as Qt, prepareCommunityNodeDetailsViewStack as R, COMPANY_SIZE_100_499 as Ra, getAllCredentials as Ri, AddConnectionCommand as Rn, REPORTED_SOURCE_TWITTER as Ro, useStorage as Rr, getPairedItemsMapping as Rt, unflattenExecutionData as S, ILLEGAL_FOLDER_CHARACTERS as Sa, getMainAuthField as Si, isResourceMapperValue as Sn, OTHER_COMPANY_INDUSTRY_EXTENDED_KEY as So, clamp as Sr, getExpressionErrorMessage as St, useActionsGenerator as T, CREDENTIAL_SELECT_MODAL_KEY as Ta, getNodeCredentialForSelectedAuthType as Ti, isSharedResource as Tn, OTHER_MARKETING_AUTOMATION_GOAL_KEY as To, getConnectedEdges as Tr, isTestableExpression as Tt, subcategorizeItems as U, COMPANY_TYPE_KEY as Ua, convertToDisplayDate as Ui, MoveNodeCommand as Un, ROLE_DEVOPS as Uo, isDefaultUser as Ur, splitName as Ut, shouldShowCommunityNodeDetails as V, COMPANY_SIZE_KEY as Va, clearJsonKey as Vi, Command as Vn, ROLE_CUSTOMER_SUPPORT as Vo, isGuest as Vr, ResourceType as Vt, transformNodeType as W, DELETE_USER_MODAL_KEY as Wa, convertToHumanReadableDate as Wi, RemoveConnectionCommand as Wn, ROLE_ENGINEERING as Wo, isAuthenticated as Wr, useAvailableProjectSearch as Wt, isFullTemplatesCollection as X, DEVOPS_AUTOMATION_OTHER as Xa, isSelectableEl as Xi, CONFIGURABLE_NODE_SIZE as Xn, SAAS_COMPANY_TYPE as Xo, moveFolderToProject as Xr, telemetry as Xt, isTutorialTemplateId as Y, DEVOPS_AUTOMATION_GOAL_OTHER_KEY as Ya, isPresent as Yi, require_toInteger as Yn, ROLE_SECURITY as Yo, ProjectTypes as Yr, TelemetryPlugin as Yt, isTemplatesWorkflow as Z, DEVOPS_INCIDENT_RESPONSE_GOAL as Za, shorten as Zi, CONFIGURATION_NODE_SIZE as Zn, SECURITY_INDUSTRY as Zo, setWorkflowSharedWith as Zr, usePostHog as Zt, executionRetryMessage as _, SOURCE_CONTROL_PUSH_MODAL_KEY as _a, getActivatableTriggerNodes as _i, isCredentialsResource as _n, MARKETING_AUTOMATION_OTHER as _o, _sfc_main as _r, escapeMappingString as _t, register as a, getWorkflowWriteLock as aa, fetchDataTablesApi as ai, doesNodeHaveCredentialsToFill as an, GOVERNMENT_INDUSTRY as ao, getGenericHints as ar, useCredentialsStore as at, getExecutionErrorToastConfiguration as b, FOLDER_NAME_ILLEGAL_CHARACTERS_REGEX as ba, getAppNameFromNodeName as bi, isFullExecutionResponse as bn, MEDIA_INDUSTRY as bo, _sfc_main$d as br, propertyNameFromExpression as bt, addTokenUsageData as c, COMMUNITY_NODES_INSTALLATION_DOCS_URL as ca, insertDataTableRowApi as ci, needsAgentInput as cn, IT_INDUSTRY as co, getNewNodePosition as cr, clearBuilderSession as ct, isChatNode as d, COMMUNITY_PACKAGE_INSTALL_MODAL_KEY as da, updateDataTableApi as di, useCanvasStore as dn, MARKETING_AUTOMATION_ACTIONS as do, getNodesWithNormalizedPosition as dr, getBuilderCredits as dt, tryToParseNumber as ea, deleteDataTableApi as ei, disposeWorkflowDocumentStore as en, DEVOPS_TICKETING_SYSTEMS_INTEGRATIONS_GOAL as eo, PUSH_NODES_OFFSET as er, ElLoading as es, capitalCase as et, parseAiContent as f, COMMUNITY_PACKAGE_MANAGE_ACTIONS as fa, updateDataTableRowsApi as fi, useLoadingService as fn, MARKETING_AUTOMATION_AD_CAMPAIGN as fo, updateViewportToContainNodes as fr, replaceCode as ft, executionFilterToQueryFilter as g, SOURCE_CONTROL_PULL_RESULT_MODAL_KEY as ga, filterTemplateNodes as gi, isCredentialModalState as gn, MARKETING_AUTOMATION_LEAD_GENERATION_GOAL as go, Position as gr, useFlattenSchema as gt, displayForm as h, SOURCE_CONTROL_PULL_MODAL_KEY as ha, fieldCannotBeDeleted as hi, isComponentPublicInstance as hn, MARKETING_AUTOMATION_GOAL_KEY as ho, PanelPosition as hr, useDataSchema as ht, getAll as i, getWorkflow as ia, fetchDataTableGlobalLimitInBytes as ii, doesNodeHaveAllCredentialsFilled as in, FINANCE_INSURANCE_INDUSTRY as io, getBounds as ir, listenForCredentialChanges as it, getHumanInTheLoopActions as j, TAGS_MANAGER_MODAL_KEY as ja, isAuthRelatedParameter as ji, isVariableResource as jn, REPORTED_SOURCE_FRIEND as jo, wheelDelta as jr, resolveRequiredParameters as jt, flattenCreateElements as k, DEBUG_PAYWALL_MODAL_KEY as ka, hasOnlyListMode as ki, isValidCredentialResponse as kn, REAL_ESTATE_OR_CONSTRUCTION as ko, useGetPointerPosition as kr, unwrapExpression as kt, emptyTokenUsageData as l, COMMUNITY_NODES_RISKS_DOCS_URL as la, moveDataTableColumnApi as li, serializeNode as ln, LEGAL_INDUSTRY as lo, getNodeViewTab as lr, generateCodeForPrompt as lt, clearPopupWindowState as m, PROJECT_MOVE_RESOURCE_MODAL as ma, executionDataToJson as mi, isBinaryLike as mn, MARKETING_AUTOMATION_DATA_SYNCHING as mo, NodeId as mr, useAIAssistantHelpers as mt, listenForModalChanges as n, searchInObject as na, deleteDataTableRowsApi as ni, useWorkflowDocumentStore as nn, ECOMMERCE_COMPANY_TYPE as no, doRectsOverlap as nr, require_upperFirst as nt, subscribe as o, getWorkflowsAndFolders as oa, getDataTableRowsApi as oi, getNodeTypeDisplayableCredentials as on, HEALTHCARE_INDUSTRY as oo, getMidCanvasPosition as or, chatWithAssistant as ot, buildExecutionResponseFromSchema as p, NPM_KEYWORD_SEARCH_URL as pa, uploadCsvFileApi as pi, isBaseTextKey as pn, MARKETING_AUTOMATION_CUSTOMER_COMMUNICATION as po, MarkerType as pr, truncateBuilderMessages as pt, getSampleWorkflowByTemplateId as q, DEVOPS_AUTOMATION_DATA_SYNCING_GOAL as qa, isEmpty as qi, ReplaceNodeParametersCommand as qn, ROLE_OTHER_KEY as qo, useRBACStore as qr, useFavoritesStore as qt, useUIStore as r, getNewWorkflow as ra, downloadDataTableCsvApi as ri, TOOL_NODE_TYPES_NEED_INPUT as rn, EDUCATION_TYPE as ro, generateOffsets as rr, require__baseSlice as rt, useWorkflowsStore as s, API_KEY_CREATE_OR_EDIT_MODAL_KEY as sa, importCsvToDataTableApi as si, getParameterDisplayableOptions as sn, INVITE_USER_MODAL_KEY as so, getMousePosition as sr, chatWithBuilder as st, useUsersStore as t, omitKey as ta, deleteDataTableColumnApi as ti, injectWorkflowDocumentStore as tn, DIGITAL_AGENCY_COMPANY_TYPE as to, calculateNodeSize as tr, sublimeSearch as tt, formatTokenUsageCount as u, COMMUNITY_PACKAGE_CONFIRM_MODAL_KEY as ua, renameDataTableColumnApi as ui, useNodeHelpers as un, MANUFACTURING_INDUSTRY as uo, getNodesGroupSize as ur, getAiSessions as ut, getDefaultExecutionFilters as v, DELETE_FOLDER_MODAL_KEY as va, getAllNodeCredentialForAuthType as vi, isDateObject as vn, MARKETING_AUTOMATION_REPORTING as vo, _sfc_main$1 as vr, getMappedExpression as vt, useNodeTypesStore as w, CREDENTIAL_EDIT_MODAL_KEY as wa, getNodeAuthOptions as wi, isRouteLocationRaw as wn, OTHER_INDUSTRY_OPTION as wo, getBoundsofRects as wr, isPairedItemIntermediateNodesError as wt, hasTrimmedRunData as x, FOLDER_NAME_ONLY_DOTS_REGEX as xa, getAuthTypeForNodeCredential as xi, isProjectRole as xn, OTHER_AUTOMATION_GOAL as xo, _sfc_main$f as xr, completeExpressionSyntax as xt, getExecutionErrorMessage as y, FOLDER_LIST_ITEM_ACTIONS as ya, getAppNameFromCredType as yi, isDebouncedFunction as yn, MARKETING_INDUSTRY as yo, _sfc_main$3 as yr, getMappedResult as yt, removePreviewToken as z, COMPANY_SIZE_20_99 as za, parse as zi, AddNodeCommand as zn, REPORTED_SOURCE_YOUTUBE as zo, useSourceControlStore as zr, useWorkflowsListStore as zt };
