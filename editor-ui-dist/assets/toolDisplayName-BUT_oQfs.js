...
var BUILDER_TOOL_TRANSLATION_KEYS = {
...
function getToolNameTranslationKey(toolName) {
	...
	if (trimmed in BUILDER_TOOL_TRANSLATION_KEYS) return BUILDER_TOOL_TRANSLATION_KEYS[trimmed];
	return WEB_SEARCH_TOOL_NAME_PATTERN.test(trimmed) ? WEB_SEARCH_TOOL_NAME_KEY : void 0;
}
function resolveToolNameForDisplay(toolName, i18n) {
...
//#endregion
export { getToolNameTranslationKey as n, resolveToolNameForDisplay as r, formatToolNameForDisplay as t };
