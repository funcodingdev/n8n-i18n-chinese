...
import { H as useVirtualList, V as useTimestamp, bt as useI18n, ct as useThrottleFn, m as require_isArray, xt as I18nT } from "./_MapCache-C80pWp05.js";
import { Li as N8nTooltip_default, Vi as N8nIconButton_default, ia as N8nIcon_default, na as N8nText_default, ra as N8nButton_default, v as require_get, vt as useRouter } from "./src-DXhOkTfb.js";
import { t as __plugin_vue_export_helper_default } from "./_plugin-vue_export-helper-DltO58Gh.js";
import { Dt as injectWorkflowState, Ln as useToast, c as addTokenUsageData, ca as createWorkflowDocumentId, d as isChatNode, da as useWorkflowDocumentStore, l as emptyTokenUsageData, pr as useNodeHelpers, s as useWorkflowsStore, tt as require_upperFirst, u as formatTokenUsageCount, w as useNodeTypesStore } from "./users.store-bYJP9NEL.js";
import { Fi as Workflow, Gt as CHAT_TRIGGER_NODE_TYPE, Ri as parseErrorMetadata, Wo as v4_default, Yo as require__baseKeys, bl as LOGS_EXECUTION_DATA_THROTTLE_DURATION, bo as AGENT_LANGCHAIN_NODE_TYPE, ca as createRunExecutionData, go as NodeConnectionTypes, jn as MANUAL_CHAT_TRIGGER_NODE_TYPE, qo as require__getTag, sa as createEmptyRunExecutionData } from "./constants-neq36s1h.js";
import { A as require_isArguments, S as require__isPrototype, b as require_isArrayLike, k as require_isBuffer, w as require_isTypedArray } from "./merge-CyZj1oIp.js";
import { w as TOOL_EXECUTOR_NODE_NAME } from "./_baseOrderBy-2EL3KkTw.js";
...
function restoreChatHistory(workflowExecutionData, emptyText, redactedText) {
	...
	if (isRedacted) {
		...
		if (redactedText) messages.push({
			text: redactedText,
			sender: "bot",
			id: workflowExecutionData.id ?? v4_default()
		});
		return messages;
	}
