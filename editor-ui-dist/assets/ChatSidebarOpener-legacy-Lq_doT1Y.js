;
(function () {
  System.register(["./vue.runtime.esm-bundler-legacy--Sn1h8On.js", "./_MapCache-legacy-CECtqMZe.js", "./src-legacy-Bo7v-Myv.js", "./_plugin-vue_export-helper-legacy-DZMI5HPp.js", "./truncate-legacy-nB2QmutO.js", "./useTelemetry-legacy-CA9g7cV_.js", "./constants-legacy-B_3qSw5J.js", "./constants-legacy-DjFSod4r.js", "./chat.store-legacy-CKc1_r14.js", "./useChatHubSidebarState-legacy-CF1Z7Qm1.js"], function (_export, _context) {
    "use strict";

    var computed, createElementBlock, createCommentVNode, unref, ref, defineComponent, createBlock, watch, renderSlot, openBlock, normalizeClass, useEventListener, useMediaQuery, useI18n, useLocalStorage, useDeviceSupport, N8nIconButton_default, __plugin_vue_export_helper_default, useRouter, useProjectsStore, useUIStore, useCredentialsStore, useSettingsStore, PROVIDER_CREDENTIAL_TYPE_MAP, objectType, recordType, stringType, LOCAL_STORAGE_CHAT_HUB_CREDENTIALS, chatHubConversationModelSchema, nullType, chatHubProviderSchema, CHAT_VIEW, MOBILE_MEDIA_QUERY, isLlmProvider, isLlmProviderModel, useChatHubSidebarState, __vite_style__, credentialsMapSchema, chatHubConversationModelWithCachedDisplayNameSchema, ChatLayout_vue_vue_type_script_setup_true_lang_default, component, isMobileDevice, ChatLayout_vue_vue_type_style_index_0_lang_module_default, cssModules, ChatLayout_default, ChatSidebarOpener_vue_vue_type_script_setup_true_lang_default, ChatSidebarOpener_default;
    //#endregion
    ...
    */
    ...
    return {
      setters: [function (_vueRuntimeEsmBundlerLegacy003Js) {
        ...
        objectType = _constantsLegacy00TJs.Mo;
        recordType = _constantsLegacy00TJs.No;
        stringType = _constantsLegacy00TJs.Po;
        LOCAL_STORAGE_CHAT_HUB_CREDENTIALS = _constantsLegacy00TJs.Ss;
        chatHubConversationModelSchema = _constantsLegacy00TJs.ei;
        nullType = _constantsLegacy00TJs.jo;
