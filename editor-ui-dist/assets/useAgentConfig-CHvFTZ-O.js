...
import { fo as N8nButton_default, n as MarkdownEditor_default, oa as N8nTooltip_default, on as DropdownMenu_default, oo as N8nText_default, po as N8nIcon_default } from "./src--aGbEXN2.js";
...
import { G as NATIVE_WEB_SEARCH_DEFAULTS_BY_PROVIDER, J as resolvePromptCaching, K as NATIVE_WEB_SEARCH_PROVIDER_TOOLS, W as ANTHROPIC_NATIVE_WEB_SEARCH_PROVIDER_TOOLS, q as PROVIDER_CAPABILITIES, qa as isAgentModelProvider } from "./src-B7RBhJEE.js";
import { t as useUsersStore } from "./users.store-DGmNQxfO.js";
import { n as useToast } from "./useToast-l0SD6t_F.js";
import { Cr as AGENT_SUB_AGENTS_MODAL_KEY, Er as AGENT_TOOL_CONFIG_MODAL_KEY, Sr as AGENT_SKILL_MODAL_KEY, Tr as AGENT_TOOLS_MODAL_KEY, wr as AGENT_TASK_MODAL_KEY } from "./constants-Cre_5Rj2.js";
...
import { N as updateAgentConfig, a as createAgentSkill, h as getAgentTasks, p as getAgentConfig } from "./useAgentApi-1fzw2S0o.js";
import { a as sanitizeModelId, c as useAgentProjectId, n as modelToString, o as useModelCatalog, r as parseModelString, s as useAgentModelCredentials, t as AgentModelSelector_default } from "./AgentModelSelector-By4082Cl.js";
import "./menuItemId-CG3zCaVM.js";
import { r as useProjectAgentsList } from "./useProjectAgentsList-CVBuvxms.js";
import { n as mcpServerToNode, s as toolRefToNode } from "./useMcpServerAdapter-xx_oyavE.js";
...
function useAgentCapabilitiesActions(deps) {
	const { localConfig, agent, projectId, agentId, connectedTriggers, scheduleConfigUpdate, scheduleSkillSave, localSkills, supportsToolApproval, ensureAgentPersisted, telemetry } = deps;
...
//#endregion
export { AgentInfoPanel_default as a, withWebSearchConfig as c, AgentCapabilitiesSection_default as i, agent_panel_module_default as l, agentsEventBus as n, getNativeWebSearchArgs as o, useAgentCapabilitiesActions as r, getWebSearchMethod as s, useAgentConfig as t };
