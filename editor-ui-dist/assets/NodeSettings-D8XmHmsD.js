...
import { F as isObject, H as toRef, I as noop, K as tryOnScopeDispose, M as directiveHooks, N as isClient, P as isIOS, W as toValue$1, at as useI18n, b as useResizeObserver$1, n as onClickOutside$1, ot as I18nT, p as useElementSize$1, t as computedAsync } from "./core-Beh0t8_q.js";
import { E as N8nTabs_default, Jt as ElCollapseTransition, N as N8nRadioButtons_default, Pi as N8nIconButton_default, R as N8nNotice_default, fa as N8nCallout_default, h as N8nInlineTextEdit_default, ha as N8nIcon_default, ki as N8nTooltip_default, kt as N8nBlockUi_default, lt as useRoute, ma as N8nButton_default, pa as N8nText_default } from "./src-Dg8CDsvD.js";
import { t as require_get } from "./get-Den8eczo.js";
import { t as _plugin_vue_export_helper_default } from "./_plugin-vue_export-helper-Da88TEg1.js";
import "./_MapCache-Cl68hVFF.js";
import { D as NodeCredentials_default, O as useNodeCredentialOptions, f as collectParametersByTab, g as getNodeSettingsInitialValues, j as TitledList_default, m as createCommonNodeSettings, p as collectSettings, s as useNodeSettingsParameters, t as ParameterInputList_default, y as nameIsParameter } from "./ParameterInputList-B-4yT3YP.js";
import { n as ElRow, t as ElCol } from "./col-CGC6S1dm.js";
import { Jt as useTelemetry, Kn as RenameNodeCommand, Ln as useHistoryStore, Mt as useWorkflowHelpers, Qt as useNDVStore, T as useActionsGenerator, Yr as ProjectTypes, at as useCredentialsStore, ca as COMMUNITY_NODES_INSTALLATION_DOCS_URL, da as COMMUNITY_PACKAGE_INSTALL_MODAL_KEY, r as useUIStore, s as useWorkflowsStore, t as useUsersStore, tn as injectWorkflowDocumentStore, un as useNodeHelpers, w as useNodeTypesStore, z as removePreviewToken, zt as useWorkflowsListStore } from "./users.store-Zd_8U4jS.js";
import { t as useToast } from "./useToast-DG5hVw1V.js";
import { Cn as MCP_TRIGGER_NODE_TYPE, Cs as NodeConnectionTypes, Eo as getNodeParameters, N as CUSTOM_API_CALL_KEY, Pt as CHAT_TRIGGER_NODE_TYPE, Rn as OPEN_URL_PANEL_TRIGGER_NODE_TYPES, Ut as DATA_TABLE_NODES, Vn as PRODUCTION_ONLY_TRIGGER_NODE_TYPES, an as FORM_TRIGGER_NODE_TYPE, c as CUSTOM_NODES_DOCS_URL, i as BASE_NODE_SURVEY_URL, is as isCommunityPackageName, o as BUILTIN_NODES_DOCS_URL, rs as deepCopy, v as NPM_PACKAGE_DOCS_BASE_URL, wo as getNodeInputs, zr as VIEWS } from "./constants-c-L9DE1I.js";
...
import { n as useNodeIconSource, t as NodeIcon_default } from "./NodeIcon-wV2T6osR.js";
import { n as NodeExecuteButton_default } from "./VirtualSchema-MJKRJSnU.js";
import { t as useFreeAiCredits } from "./useFreeAiCredits-4nZAclck.js";
...
var NDVSubConnections_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props, { expose: __expose, emit: __emit }) {
		...
		const ndvStore = useNDVStore();
		const workflowObjectAccessors = computed(() => workflowDocumentStore?.value ? workflowDocumentStore.value.getSnapshot() : void 0);
...
var NodeSettings_default = /* @__PURE__ */ _plugin_vue_export_helper_default(NodeSettings_vue_vue_type_script_setup_true_lang_default, [["__cssModules", { "$style": NodeSettings_vue_vue_type_style_index_0_lang_module_default }], ["__scopeId", "data-v-53f00789"]]);
//#endregion
