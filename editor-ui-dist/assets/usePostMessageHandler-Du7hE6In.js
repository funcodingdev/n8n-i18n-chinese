const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/pushConnection.store-cGFKzU3X.js","assets/pushConnection.store-Dlp0q1u3.js","assets/vue.runtime.esm-bundler-Bs4WIMNP.js","assets/chunk-CC9Q-vWm.js","assets/constants-DDbk7QLF.js","assets/get-CDrcd2Fp.js","assets/_MapCache-Cwo_kzI3.js","assets/merge-pQs2xbBu.js","assets/expression-runtime-stub-D02gUA55.js","assets/__vite-browser-external-Byz2CIkm.js","assets/useRootStore-Cls9JR4X.js","assets/settings.store-D5e-Y58h.js"])))=>i.map(i=>d[i]);
...
import { Jr as getNodesWithNormalizedPosition, Jt as buildExecutionResponseFromSchema, at as useCredentialsStore, cn as useWorkflowsStore, qt as useWorkflowExecutionStateStore, r as createWorkflowDocumentId, s as useWorkflowDocumentStore, xn as useProjectsStore } from "./workflowDocument.store-nzq6GHzt.js";
		...
		try {
			...
			if (json && json.command === "openWorkflow") try {
				...
				const { usePushConnectionStore } = await __vitePreload(async () => {
					const { usePushConnectionStore } = await import("./pushConnection.store-cGFKzU3X.js");
