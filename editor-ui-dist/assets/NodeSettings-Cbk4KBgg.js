...
import { $ as openBlock, A as createTextVNode, C as createBaseVNode, Cn as toDisplayString, Dt as getCurrentScope, E as createElementBlock, Ft as readonly, Gt as unref, I as h, It as ref, N as defineComponent, Nt as onScopeDispose, O as createSlots, R as inject, S as computed, T as createCommentVNode, Tt as customRef, Ut as toValue$1, Vt as toRef$1, X as onMounted, _ as Fragment, bn as normalizeStyle, bt as withCtx, gt as watch, it as renderSlot, j as createVNode, p as vShow, pt as useTemplateRef, q as onBeforeUnmount, rt as renderList, vn as normalizeClass, w as createBlock, xt as withDirectives } from "./vue.runtime.esm-bundler-DYHsQBZB.js";
import { c as I18nT, s as useI18n } from "./src-C3h3FWXj.js";
import { F as N8nBlockUi_default } from "./RunData-IjtQEKZN.js";
...
import { C as useResizeObserver$1, n as computedAsync } from "./dist-CYNfKCbA.js";
...
import { n as ElRow, t as ElCol } from "./col-CTkqxmg_.js";
import { t as ElCollapseTransition } from "./collapse-transition-NFwITJcM.js";
...
import { f as parseModelString, h as useModelCatalog, n as useAgentCapabilitiesActions, o as AgentInfoPanel_default, r as AgentCapabilitiesSection_default, t as agentsEventBus } from "./agents.eventBus-CR5p-dlQ.js";
...
import { A as TitledList_default, D as NodeCredentials_default, F as SectionHeader_default, f as collectParametersByTab, g as getNodeSettingsInitialValues, m as createCommonNodeSettings, p as collectSettings, s as useNodeSettingsParameters, t as ParameterInputList_default, y as nameIsParameter } from "./ParameterInputList-Bg6aiD9a.js";
import { Hn as N8nSegmentControl_default } from "./expressions-0XjpaZkH.js";
import { Et as useCredentialsStore, H as useNodeTypesStore, O as injectWorkflowDocumentStore, S as toolActivityKey, Sn as ProjectTypes, V as isAgentNodeV2, W as useActionsGenerator, b as skillIdActivityKey, en as useWorkflowHelpers, nn as useWorkflowId, ot as removePreviewToken, t as useWorkflowsStore, un as injectNDVStore, x as skillNameActivityKey } from "./workflows.store-CQp5NuTc.js";
import { t as N8nTabs_default } from "./N8nTabs-DNFT7sve.js";
import { Ai as getNodeParameters, Io as require_get, Oi as getNodeInputs, To as isAgentModelProvider, Wn as nodeNameToToolName, ga as deepCopy, la as NodeConnectionTypes, rt as sanitizeAgentToolName, va as isCommunityPackageName } from "./src-BrbN-vPn.js";
import { t as MarkdownEditor_default } from "./MarkdownEditor-CCKo9S27.js";
...
import { An as PRODUCTION_ONLY_TRIGGER_NODE_TYPES, Ar as AGENT_VIEW, F as CUSTOM_API_CALL_KEY, Ht as DATA_TABLE_NODES, On as OPEN_URL_PANEL_TRIGGER_NODE_TYPES, Pt as CHAT_TRIGGER_NODE_TYPE, S as NPM_PACKAGE_DOCS_BASE_URL, _r as AGENT_BUILDER_VIEW, a as BASE_NODE_SURVEY_URL, d as CUSTOM_NODES_DOCS_URL, mn as MCP_TRIGGER_NODE_TYPE, nn as FORM_TRIGGER_NODE_TYPE, s as BUILTIN_NODES_DOCS_URL } from "./constants-Bwbcx8Ih.js";
import { n as ndvEventBus } from "./useCodeDiff-eqer-jSH.js";
import { n as useDebounce } from "./useDebounce-BRzd7gd1.js";
import { t as useWorkflowsListStore } from "./workflowsList.store-DR9pamv2.js";
import { M as COMMUNITY_PACKAGE_INSTALL_MODAL_KEY, k as COMMUNITY_NODES_INSTALLATION_DOCS_URL, n as useUIStore } from "./ui.store-ic9znGOr.js";
import { n as useHistoryStore, p as RenameNodeCommand, t as useNodeHelpers } from "./useNodeHelpers-B7gC71EA.js";
import { t as useExternalHooks } from "./useExternalHooks-DrCWk8Mh.js";
import { n as importCurlEventBus } from "./event-bus-CDvComrA.js";
import { t as useDataTableStore } from "./dataTable.store-DlM0vKBx.js";
import { t as useClipboard } from "./useClipboard-DwVAOfeD.js";
import { P as useNodeCredentialOptions } from "./useCanvasOperations-Bb1O1ttk.js";
...
import { i as useQuickConnect, t as useAgentScopeProjectId } from "./useAgentScopeProjectId-XkQFIaiw.js";
import { t as CredentialIcon_default } from "./CredentialIcon-BL0rQ5Ik.js";
import { t as NodeIcon_default } from "./NodeIcon-CxhE4yyI.js";
import { n as NodeExecuteButton_default, r as useNodeExecution } from "./VirtualSchema-DH8atM3E.js";
import { d as getAgent } from "./useAgentApi-BjSqetbH.js";
import { t as useFreeAiCredits } from "./useFreeAiCredits-COZOzaxm.js";
import { i as QuickConnectBanner_default, n as CommunityNodeFooter_default, r as useInstalledCommunityPackage, t as CommunityNodeUpdateInfo_default } from "./CommunityNodeUpdateInfo-Bv9N4mz3.js";
import { o as getProviderCredentialTypes } from "./menuItemId-mM_YT4rJ.js";
import { t as formatToolNameForDisplay } from "./toolDisplayName-BUT_oQfs.js";
import { n as AgentChipButton_default } from "./agentSkill-DqojGIh6.js";
import { t as generateNanoId } from "./generate-nano-id-CPyThSEf.js";
import { t as useAgentConfig } from "./useAgentConfig-B9NdhMOr.js";
import { t as useAgentReturnContextStore } from "./agentReturnContext.store-Ds80tsAK.js";
import { t as AgentPersonalisationIcon_default } from "./AgentPersonalisationIcon-Bqg0h_P0.js";
import { t as useActions } from "./useActions-DuHmmfUL.js";
		...
		return (_ctx, _cache) => {
			return showCallout.value && !showSuccess.value ? (openBlock(), createBlock(unref(N8nCallout_default), {
				...
				default: withCtx(() => [createVNode(unref(N8nText_default), { size: "small" }, {
					default: withCtx(() => [createTextVNode(toDisplayString(unref(i18n).baseText("freeAi.credits.callout.success.title", { interpolate: { credits: unref(aiCreditsQuota) } })), 1)]),
					_: 1
				})]),
				_: 1
...
var _hoisted_5$1 = ["data-node-name"];
...
var container = "_container_1qr33_405";
var connections = "_connections_1qr33_413";
var connectionType = "_connectionType_1qr33_426";
var connectionLabel = "_connectionLabel_1qr33_433";
var hasIssues = "_hasIssues_1qr33_439";
var connectedNodesWrapper = "_connectedNodesWrapper_1qr33_443";
var plusButton = "_plusButton_1qr33_451";
var connectedNodesWrapperExpanded = "_connectedNodesWrapperExpanded_1qr33_469";
var connectedNodesMultiple = "_connectedNodesMultiple_1qr33_475";
var connectedNode = "_connectedNode_1qr33_443";
var connectedNodes = "_connectedNodes_1qr33_443";
var nodeWrapper = "_nodeWrapper_1qr33_514";
var shimmer$8 = "_shimmer_1qr33_1";
var spin$8 = "_spin_1qr33_1";
var opacityPulse$8 = "_opacityPulse_1qr33_1";
var popoverIn$8 = "_popoverIn_1qr33_1";
var fadeIn$8 = "_fadeIn_1qr33_1";
var collapsibleSlideDown$8 = "_collapsibleSlideDown_1qr33_1";
var collapsibleSlideUp$8 = "_collapsibleSlideUp_1qr33_1";
var collapsibleSlideDownBlurred$8 = "_collapsibleSlideDownBlurred_1qr33_1";
var collapsibleSlideUpBlurred$8 = "_collapsibleSlideUpBlurred_1qr33_1";
var blurSwapIn$8 = "_blurSwapIn_1qr33_1";
var blurSwapOut$8 = "_blurSwapOut_1qr33_1";
var pulseGlow$8 = "_pulseGlow_1qr33_1";
var pulseGlowDelayed$8 = "_pulseGlowDelayed_1qr33_1";
var fade$8 = "_fade_1qr33_1";
var fadeInUp$8 = "_fadeInUp_1qr33_1";
var fadeInDown$8 = "_fadeInDown_1qr33_1";
var fadeInLeft$8 = "_fadeInLeft_1qr33_1";
var fadeInRight$8 = "_fadeInRight_1qr33_1";
var fadeOut$8 = "_fadeOut_1qr33_1";
var fadeOutDown$8 = "_fadeOutDown_1qr33_1";
var fadeOutUp$8 = "_fadeOutUp_1qr33_1";
var fadeOutLeft$8 = "_fadeOutLeft_1qr33_1";
var fadeOutRight$8 = "_fadeOutRight_1qr33_1";
var ping$8 = "_ping_1qr33_1";
var blinkBackground$8 = "_blinkBackground_1qr33_1";
var typingBlink$8 = "_typingBlink_1qr33_1";
var NDVSubConnections_vue_vue_type_style_index_0_lang_module_default = {
	...
	plusButton,
	"horizontal-shake": "_horizontal-shake_1qr33_1",
	...
	shimmer: shimmer$8,
	spin: spin$8,
	"skeleton-pulse": "_skeleton-pulse_1qr33_1",
...
var NodeSettingsHeader_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props, { emit: __emit }) {
		...
		const i18n = useI18n();
		const workflowDocumentStore = injectWorkflowDocumentStore();
		const { isExecuting, stopExecution } = useNodeExecution(computed(() => workflowDocumentStore.value.getNodeByName(props.nodeName) ?? null));
		const emit = __emit;
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("div", { class: normalizeClass(_ctx.$style.header) }, [
				!__props.hideTabs ? (openBlock(), createBlock(NodeSettingsTabs_default, {
					key: 0,
				...
				!__props.hideExecute && unref(isExecuting) ? (openBlock(), createBlock(unref(N8nIconButton_default), {
					key: 1,
					"data-test-id": "ndv-stop-execution-button",
					variant: "subtle",
					icon: "square",
					size: "small",
					class: normalizeClass(_ctx.$style.stop),
					title: unref(i18n).baseText("nodeView.stopCurrentExecution"),
					onClick: unref(stopExecution)
				}, null, 8, [
					"class",
					"title",
					"onClick"
				])) : createCommentVNode("", true),
				!__props.hideExecute ? (openBlock(), createBlock(NodeExecuteButton_default, {
					key: 2,
...
var header$1 = "_header_6hv6l_388";
var tabs = "_tabs_6hv6l_398";
var stop = "_stop_6hv6l_406";
var shimmer$7 = "_shimmer_6hv6l_1";
var spin$7 = "_spin_6hv6l_1";
var opacityPulse$7 = "_opacityPulse_6hv6l_1";
var popoverIn$7 = "_popoverIn_6hv6l_1";
var fadeIn$7 = "_fadeIn_6hv6l_1";
var collapsibleSlideDown$7 = "_collapsibleSlideDown_6hv6l_1";
var collapsibleSlideUp$7 = "_collapsibleSlideUp_6hv6l_1";
var collapsibleSlideDownBlurred$7 = "_collapsibleSlideDownBlurred_6hv6l_1";
var collapsibleSlideUpBlurred$7 = "_collapsibleSlideUpBlurred_6hv6l_1";
var blurSwapIn$7 = "_blurSwapIn_6hv6l_1";
var blurSwapOut$7 = "_blurSwapOut_6hv6l_1";
var pulseGlow$7 = "_pulseGlow_6hv6l_1";
var pulseGlowDelayed$7 = "_pulseGlowDelayed_6hv6l_1";
var fade$7 = "_fade_6hv6l_1";
var fadeInUp$7 = "_fadeInUp_6hv6l_1";
var fadeInDown$7 = "_fadeInDown_6hv6l_1";
var fadeInLeft$7 = "_fadeInLeft_6hv6l_1";
var fadeInRight$7 = "_fadeInRight_6hv6l_1";
var fadeOut$7 = "_fadeOut_6hv6l_1";
var fadeOutDown$7 = "_fadeOutDown_6hv6l_1";
var fadeOutUp$7 = "_fadeOutUp_6hv6l_1";
var fadeOutLeft$7 = "_fadeOutLeft_6hv6l_1";
var fadeOutRight$7 = "_fadeOutRight_6hv6l_1";
var ping$7 = "_ping_6hv6l_1";
var blinkBackground$7 = "_blinkBackground_6hv6l_1";
var typingBlink$7 = "_typingBlink_6hv6l_1";
var NodeSettingsHeader_vue_vue_type_style_index_0_lang_module_default = {
	...
	shimmer: shimmer$7,
	spin: spin$7,
	"skeleton-pulse": "_skeleton-pulse_6hv6l_1",
			...
			return webhooksNode.value.length && unref(visibleWebhookUrls).length > 0 ? (openBlock(), createElementBlock("div", _hoisted_1$4, [createBaseVNode("div", {
				...
				default: withCtx(() => [!isMinimized.value ? (openBlock(), createElementBlock("div", _hoisted_3$1, [!isProductionOnly.value ? (openBlock(), createElementBlock("div", _hoisted_4$1, [createVNode(unref(ElRow), null, {
					...
					return openBlock(), createBlock(unref(N8nTooltip_default), {
						...
						default: withCtx(() => [item.isMethodVisible ? (openBlock(), createElementBlock("div", _hoisted_5, [createBaseVNode("div", _hoisted_6, [createBaseVNode("div", _hoisted_7, [createTextVNode(toDisplayString(item.httpMethod), 1), _cache[2] || (_cache[2] = createBaseVNode("br", null, null, -1))])]), createBaseVNode("div", _hoisted_8, [createBaseVNode("div", {
...
//#endregion
//#region src/features/ndv/agents/components/AgentNdvInlineControls.vue?vue&type=style&index=0&lang.module.scss
var inlineControls = "_inlineControls_187kp_388";
var field = "_field_187kp_396";
var markdownEditor = "_markdownEditor_187kp_403";
var shimmer$6 = "_shimmer_187kp_1";
var spin$6 = "_spin_187kp_1";
var opacityPulse$6 = "_opacityPulse_187kp_1";
var popoverIn$6 = "_popoverIn_187kp_1";
var fadeIn$6 = "_fadeIn_187kp_1";
var collapsibleSlideDown$6 = "_collapsibleSlideDown_187kp_1";
var collapsibleSlideUp$6 = "_collapsibleSlideUp_187kp_1";
var collapsibleSlideDownBlurred$6 = "_collapsibleSlideDownBlurred_187kp_1";
var collapsibleSlideUpBlurred$6 = "_collapsibleSlideUpBlurred_187kp_1";
var blurSwapIn$6 = "_blurSwapIn_187kp_1";
var blurSwapOut$6 = "_blurSwapOut_187kp_1";
var pulseGlow$6 = "_pulseGlow_187kp_1";
var pulseGlowDelayed$6 = "_pulseGlowDelayed_187kp_1";
var fade$6 = "_fade_187kp_1";
var fadeInUp$6 = "_fadeInUp_187kp_1";
var fadeInDown$6 = "_fadeInDown_187kp_1";
var fadeInLeft$6 = "_fadeInLeft_187kp_1";
var fadeInRight$6 = "_fadeInRight_187kp_1";
var fadeOut$6 = "_fadeOut_187kp_1";
var fadeOutDown$6 = "_fadeOutDown_187kp_1";
var fadeOutUp$6 = "_fadeOutUp_187kp_1";
var fadeOutLeft$6 = "_fadeOutLeft_187kp_1";
var fadeOutRight$6 = "_fadeOutRight_187kp_1";
var ping$6 = "_ping_187kp_1";
var blinkBackground$6 = "_blinkBackground_187kp_1";
var typingBlink$6 = "_typingBlink_187kp_1";
var AgentNdvInlineControls_vue_vue_type_style_index_0_lang_module_default = {
	...
	shimmer: shimmer$6,
	spin: spin$6,
	"skeleton-pulse": "_skeleton-pulse_187kp_1",
...
function individualToolChip(tool, index) {
	const activityName = tool.type === "workflow" ? sanitizeAgentToolName(tool.name) : tool.type === "node" ? nodeNameToToolName(tool.name) : tool.name;
	return {
...
var CanvasNodeAgentChips_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	props: {
		...
		activeCapabilityKeys: { default: () => /* @__PURE__ */ new Set() }
	},
	setup(__props) {
		const props = __props;
		const i18n = useI18n();
		...
		const isChipActive = (chip) => (chip.activityKeys ?? []).some((key) => props.activeCapabilityKeys.has(key));
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("div", {
				...
				return openBlock(), createElementBlock("span", {
					key: chip.key,
					class: normalizeClass([_ctx.$style.chipWrapper, { [_ctx.$style.running]: isChipActive(chip) }])
					...
					key: "0"
				} : void 0]), 1032, ["icon", "aria-busy"])], 2);
			}), 128)), overflowChips.value.length && __props.isReadOnly ? (openBlock(), createElementBlock("span", {
				key: 0,
				class: normalizeClass([_ctx.$style.chipWrapper, { [_ctx.$style.running]: isOverflowActive.value }])
			}, [createVNode(AgentChipButton_default, {
				clickable: false,
				"aria-busy": isOverflowActive.value,
				...
				_: 1
			}, 8, ["aria-busy"])], 2)) : overflowChips.value.length ? (openBlock(), createBlock(unref(N8nActionDropdown_default), {
				key: 1,
				...
				activator: withCtx(() => [createBaseVNode("span", { class: normalizeClass([_ctx.$style.chipWrapper, { [_ctx.$style.running]: isOverflowActive.value }]) }, [createVNode(AgentChipButton_default, { "aria-busy": isOverflowActive.value }, {
					default: withCtx(() => [createTextVNode(toDisplayString(unref(i18n).baseText("agentNode.card.moreChips", { interpolate: { count: overflowChips.value.length } })), 1)]),
					_: 1
				}, 8, ["aria-busy"])], 2)]),
				_: 1
...
//#endregion
//#region src/features/workflows/canvas/components/elements/nodes/render-types/parts/CanvasNodeAgentChips.vue?vue&type=style&index=0&lang.module.scss
var chips = "_chips_i71jx_388";
var nodeIcon = "_nodeIcon_i71jx_394";
var chipWrapper = "_chipWrapper_i71jx_398";
var running = "_running_i71jx_406";
var shimmer$5 = "_shimmer_i71jx_1";
var spin$5 = "_spin_i71jx_1";
var opacityPulse$5 = "_opacityPulse_i71jx_1";
var popoverIn$5 = "_popoverIn_i71jx_1";
var fadeIn$5 = "_fadeIn_i71jx_1";
var collapsibleSlideDown$5 = "_collapsibleSlideDown_i71jx_1";
var collapsibleSlideUp$5 = "_collapsibleSlideUp_i71jx_1";
var collapsibleSlideDownBlurred$5 = "_collapsibleSlideDownBlurred_i71jx_1";
var collapsibleSlideUpBlurred$5 = "_collapsibleSlideUpBlurred_i71jx_1";
var blurSwapIn$5 = "_blurSwapIn_i71jx_1";
var blurSwapOut$5 = "_blurSwapOut_i71jx_1";
var pulseGlow$5 = "_pulseGlow_i71jx_1";
var pulseGlowDelayed$5 = "_pulseGlowDelayed_i71jx_1";
var fade$5 = "_fade_i71jx_1";
var fadeInUp$5 = "_fadeInUp_i71jx_1";
var fadeInDown$5 = "_fadeInDown_i71jx_1";
var fadeInLeft$5 = "_fadeInLeft_i71jx_1";
var fadeInRight$5 = "_fadeInRight_i71jx_1";
var fadeOut$5 = "_fadeOut_i71jx_1";
var fadeOutDown$5 = "_fadeOutDown_i71jx_1";
var fadeOutUp$5 = "_fadeOutUp_i71jx_1";
var fadeOutLeft$5 = "_fadeOutLeft_i71jx_1";
var fadeOutRight$5 = "_fadeOutRight_i71jx_1";
var ping$5 = "_ping_i71jx_1";
var blinkBackground$5 = "_blinkBackground_i71jx_1";
var typingBlink$5 = "_typingBlink_i71jx_1";
var CanvasNodeAgentChips_vue_vue_type_style_index_0_lang_module_default = {
	chips,
	nodeIcon,
	chipWrapper,
	running,
	"border-rotate": "_border-rotate_i71jx_1",
	shimmer: shimmer$5,
	spin: spin$5,
	"skeleton-pulse": "_skeleton-pulse_i71jx_1",
	...
	setup(__props) {
		...
		*/
		...
		const modelCredentialType = computed(() => {
			...
			return provider && isAgentModelProvider(provider) ? getProviderCredentialTypes(provider)[0] : null;
		});
...
//#endregion
//#region src/features/ndv/agents/components/AgentNdvReferencedSummary.vue?vue&type=style&index=0&lang.module.scss
var header = "_header_ceukg_388";
var summary = "_summary_ceukg_394";
var editButton = "_editButton_ceukg_402";
var config = "_config_ceukg_408";
var configContent = "_configContent_ceukg_417";
var unavailable = "_unavailable_ceukg_450";
var identityRow = "_identityRow_ceukg_454";
var modelRow = "_modelRow_ceukg_460";
var instructions = "_instructions_ceukg_466";
var shimmer$4 = "_shimmer_ceukg_1";
var spin$4 = "_spin_ceukg_1";
var opacityPulse$4 = "_opacityPulse_ceukg_1";
var popoverIn$4 = "_popoverIn_ceukg_1";
var fadeIn$4 = "_fadeIn_ceukg_1";
var collapsibleSlideDown$4 = "_collapsibleSlideDown_ceukg_1";
var collapsibleSlideUp$4 = "_collapsibleSlideUp_ceukg_1";
var collapsibleSlideDownBlurred$4 = "_collapsibleSlideDownBlurred_ceukg_1";
var collapsibleSlideUpBlurred$4 = "_collapsibleSlideUpBlurred_ceukg_1";
var blurSwapIn$4 = "_blurSwapIn_ceukg_1";
var blurSwapOut$4 = "_blurSwapOut_ceukg_1";
var pulseGlow$4 = "_pulseGlow_ceukg_1";
var pulseGlowDelayed$4 = "_pulseGlowDelayed_ceukg_1";
var fade$4 = "_fade_ceukg_1";
var fadeInUp$4 = "_fadeInUp_ceukg_1";
var fadeInDown$4 = "_fadeInDown_ceukg_1";
var fadeInLeft$4 = "_fadeInLeft_ceukg_1";
var fadeInRight$4 = "_fadeInRight_ceukg_1";
var fadeOut$4 = "_fadeOut_ceukg_1";
var fadeOutDown$4 = "_fadeOutDown_ceukg_1";
var fadeOutUp$4 = "_fadeOutUp_ceukg_1";
var fadeOutLeft$4 = "_fadeOutLeft_ceukg_1";
var fadeOutRight$4 = "_fadeOutRight_ceukg_1";
var ping$4 = "_ping_ceukg_1";
var blinkBackground$4 = "_blinkBackground_ceukg_1";
var typingBlink$4 = "_typingBlink_ceukg_1";
var AgentNdvReferencedSummary_vue_vue_type_style_index_0_lang_module_default = {
	...
	shimmer: shimmer$4,
	spin: spin$4,
	"skeleton-pulse": "_skeleton-pulse_ceukg_1",
...
var component$1 = "_component_cc0i6_388";
var title = "_title_cc0i6_392";
var disabled = "_disabled_cc0i6_400";
var titleText = "_titleText_cc0i6_404";
var subTitleText = "_subTitleText_cc0i6_416";
var tabsContainer = "_tabsContainer_cc0i6_425";
var shimmer$3 = "_shimmer_cc0i6_1";
var spin$3 = "_spin_cc0i6_1";
var opacityPulse$3 = "_opacityPulse_cc0i6_1";
var popoverIn$3 = "_popoverIn_cc0i6_1";
var fadeIn$3 = "_fadeIn_cc0i6_1";
var collapsibleSlideDown$3 = "_collapsibleSlideDown_cc0i6_1";
var collapsibleSlideUp$3 = "_collapsibleSlideUp_cc0i6_1";
var collapsibleSlideDownBlurred$3 = "_collapsibleSlideDownBlurred_cc0i6_1";
var collapsibleSlideUpBlurred$3 = "_collapsibleSlideUpBlurred_cc0i6_1";
var blurSwapIn$3 = "_blurSwapIn_cc0i6_1";
var blurSwapOut$3 = "_blurSwapOut_cc0i6_1";
var pulseGlow$3 = "_pulseGlow_cc0i6_1";
var pulseGlowDelayed$3 = "_pulseGlowDelayed_cc0i6_1";
var fade$3 = "_fade_cc0i6_1";
var fadeInUp$3 = "_fadeInUp_cc0i6_1";
var fadeInDown$3 = "_fadeInDown_cc0i6_1";
var fadeInLeft$3 = "_fadeInLeft_cc0i6_1";
var fadeInRight$3 = "_fadeInRight_cc0i6_1";
var fadeOut$3 = "_fadeOut_cc0i6_1";
var fadeOutDown$3 = "_fadeOutDown_cc0i6_1";
var fadeOutUp$3 = "_fadeOutUp_cc0i6_1";
var fadeOutLeft$3 = "_fadeOutLeft_cc0i6_1";
var fadeOutRight$3 = "_fadeOutRight_cc0i6_1";
var ping$3 = "_ping_cc0i6_1";
var blinkBackground$3 = "_blinkBackground_cc0i6_1";
var typingBlink$3 = "_typingBlink_cc0i6_1";
var ExperimentalEmbeddedNdvHeader_vue_vue_type_style_index_0_lang_module_default = {
	...
	shimmer: shimmer$3,
	spin: spin$3,
	"skeleton-pulse": "_skeleton-pulse_cc0i6_1",
...
var component = "_component_1nv4p_388";
var label = "_label_1nv4p_392";
var option = "_option_1nv4p_397";
var selected = "_selected_1nv4p_404";
var optionText = "_optionText_1nv4p_408";
var shimmer$2 = "_shimmer_1nv4p_1";
var spin$2 = "_spin_1nv4p_1";
var opacityPulse$2 = "_opacityPulse_1nv4p_1";
var popoverIn$2 = "_popoverIn_1nv4p_1";
var fadeIn$2 = "_fadeIn_1nv4p_1";
var collapsibleSlideDown$2 = "_collapsibleSlideDown_1nv4p_1";
var collapsibleSlideUp$2 = "_collapsibleSlideUp_1nv4p_1";
var collapsibleSlideDownBlurred$2 = "_collapsibleSlideDownBlurred_1nv4p_1";
var collapsibleSlideUpBlurred$2 = "_collapsibleSlideUpBlurred_1nv4p_1";
var blurSwapIn$2 = "_blurSwapIn_1nv4p_1";
var blurSwapOut$2 = "_blurSwapOut_1nv4p_1";
var pulseGlow$2 = "_pulseGlow_1nv4p_1";
var pulseGlowDelayed$2 = "_pulseGlowDelayed_1nv4p_1";
var fade$2 = "_fade_1nv4p_1";
var fadeInUp$2 = "_fadeInUp_1nv4p_1";
var fadeInDown$2 = "_fadeInDown_1nv4p_1";
var fadeInLeft$2 = "_fadeInLeft_1nv4p_1";
var fadeInRight$2 = "_fadeInRight_1nv4p_1";
var fadeOut$2 = "_fadeOut_1nv4p_1";
var fadeOutDown$2 = "_fadeOutDown_1nv4p_1";
var fadeOutUp$2 = "_fadeOutUp_1nv4p_1";
var fadeOutLeft$2 = "_fadeOutLeft_1nv4p_1";
var fadeOutRight$2 = "_fadeOutRight_1nv4p_1";
var ping$2 = "_ping_1nv4p_1";
var blinkBackground$2 = "_blinkBackground_1nv4p_1";
var typingBlink$2 = "_typingBlink_1nv4p_1";
var NodeActionsList_vue_vue_type_style_index_0_lang_module_default = {
	...
	shimmer: shimmer$2,
	spin: spin$2,
	"skeleton-pulse": "_skeleton-pulse_1nv4p_1",
...
var communityNodeActionsContainer = "_communityNodeActionsContainer_du31n_388";
var nodeIsNotValid = "_nodeIsNotValid_du31n_393";
var warningIcon = "_warningIcon_du31n_404";
var descriptionContainer = "_descriptionContainer_du31n_409";
var shimmer$1 = "_shimmer_du31n_1";
var spin$1 = "_spin_du31n_1";
var opacityPulse$1 = "_opacityPulse_du31n_1";
var popoverIn$1 = "_popoverIn_du31n_1";
var fadeIn$1 = "_fadeIn_du31n_1";
var collapsibleSlideDown$1 = "_collapsibleSlideDown_du31n_1";
var collapsibleSlideUp$1 = "_collapsibleSlideUp_du31n_1";
var collapsibleSlideDownBlurred$1 = "_collapsibleSlideDownBlurred_du31n_1";
var collapsibleSlideUpBlurred$1 = "_collapsibleSlideUpBlurred_du31n_1";
var blurSwapIn$1 = "_blurSwapIn_du31n_1";
var blurSwapOut$1 = "_blurSwapOut_du31n_1";
var pulseGlow$1 = "_pulseGlow_du31n_1";
var pulseGlowDelayed$1 = "_pulseGlowDelayed_du31n_1";
var fade$1 = "_fade_du31n_1";
var fadeInUp$1 = "_fadeInUp_du31n_1";
var fadeInDown$1 = "_fadeInDown_du31n_1";
var fadeInLeft$1 = "_fadeInLeft_du31n_1";
var fadeInRight$1 = "_fadeInRight_du31n_1";
var fadeOut$1 = "_fadeOut_du31n_1";
var fadeOutDown$1 = "_fadeOutDown_du31n_1";
var fadeOutUp$1 = "_fadeOutUp_du31n_1";
var fadeOutLeft$1 = "_fadeOutLeft_du31n_1";
var fadeOutRight$1 = "_fadeOutRight_du31n_1";
var ping$1 = "_ping_du31n_1";
var blinkBackground$1 = "_blinkBackground_du31n_1";
var typingBlink$1 = "_typingBlink_du31n_1";
var NodeSettingsInvalidNodeWarning_vue_vue_type_style_index_0_lang_module_default = {
	...
	shimmer: shimmer$1,
	spin: spin$1,
	"skeleton-pulse": "_skeleton-pulse_du31n_1",
...
var NodeSettings_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props, { emit: __emit }) {
		...
		const featureRequestUrl = computed(() => {
			if (!nodeType.value || settingsStore.isCanvasOnly) return "";
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("div", {
				...
				__props.isEmbeddedInCanvas && node.value ? (openBlock(), createBlock(ExperimentalEmbeddedNdvHeader_default, {
					...
					"include-credential",
					"has-credential-issue"
				])) : node.value && nodeValid.value ? (openBlock(), createBlock(NodeSettingsHeader_default, {
					key: 1,
					"selected-tab": openPanel.value,
				...
				node.value && nodeValid.value ? (openBlock(), createElementBlock("div", {
					...
					withDirectives(createBaseVNode("div", null, [
						...
						showNoParametersNotice.value ? (openBlock(), createElementBlock("div", _hoisted_2, [createVNode(unref(N8nText_default), null, {
							default: withCtx(() => [createTextVNode(toDisplayString(unref(i18n).baseText("nodeSettings.thisNodeDoesNotHaveAnyParameters")), 1)]),
							_: 1
						})])) : createCommentVNode("", true),
						unref(nodeHelpers).isCustomApiCallSelected(nodeValues.value) ? (openBlock(), createElementBlock("div", _hoisted_3, [createVNode(unref(N8nNotice_default), { content: unref(i18n).baseText("nodeSettings.useTheHttpRequestNode", { interpolate: { nodeTypeDisplayName: nodeType.value?.displayName ?? "" } }) }, null, 8, ["content"])])) : createCommentVNode("", true)
					...
					withDirectives(createBaseVNode("div", null, [
						...
						createBaseVNode("div", _hoisted_4, [createTextVNode(toDisplayString(unref(i18n).baseText("nodeSettings.nodeVersion", { interpolate: {
					...
					featureRequestUrl.value && !__props.isEmbeddedInCanvas ? (openBlock(), createElementBlock("div", {
						key: 3,
...
var featureRequest = "_featureRequest_1lba0_388";
var quickConnectBanner = "_quickConnectBanner_1lba0_402";
var uiBlocker = "_uiBlocker_1lba0_406";
var shimmer = "_shimmer_1lba0_1";
var spin = "_spin_1lba0_1";
var opacityPulse = "_opacityPulse_1lba0_1";
var popoverIn = "_popoverIn_1lba0_1";
var fadeIn = "_fadeIn_1lba0_1";
var collapsibleSlideDown = "_collapsibleSlideDown_1lba0_1";
var collapsibleSlideUp = "_collapsibleSlideUp_1lba0_1";
var collapsibleSlideDownBlurred = "_collapsibleSlideDownBlurred_1lba0_1";
var collapsibleSlideUpBlurred = "_collapsibleSlideUpBlurred_1lba0_1";
var blurSwapIn = "_blurSwapIn_1lba0_1";
var blurSwapOut = "_blurSwapOut_1lba0_1";
var pulseGlow = "_pulseGlow_1lba0_1";
var pulseGlowDelayed = "_pulseGlowDelayed_1lba0_1";
var fade = "_fade_1lba0_1";
var fadeInUp = "_fadeInUp_1lba0_1";
var fadeInDown = "_fadeInDown_1lba0_1";
var fadeInLeft = "_fadeInLeft_1lba0_1";
var fadeInRight = "_fadeInRight_1lba0_1";
var fadeOut = "_fadeOut_1lba0_1";
var fadeOutDown = "_fadeOutDown_1lba0_1";
var fadeOutUp = "_fadeOutUp_1lba0_1";
var fadeOutLeft = "_fadeOutLeft_1lba0_1";
var fadeOutRight = "_fadeOutRight_1lba0_1";
var ping = "_ping_1lba0_1";
var blinkBackground = "_blinkBackground_1lba0_1";
var typingBlink = "_typingBlink_1lba0_1";
var NodeSettings_vue_vue_type_style_index_0_lang_module_default = {
	...
	shimmer,
	spin,
	"skeleton-pulse": "_skeleton-pulse_1lba0_1",
	opacityPulse,
	popoverIn,
	fadeIn,
...
var NodeSettings_default = /* @__PURE__ */ _plugin_vue_export_helper_default(NodeSettings_vue_vue_type_script_setup_true_lang_default, [["__cssModules", { "$style": NodeSettings_vue_vue_type_style_index_0_lang_module_default }], ["__scopeId", "data-v-b1ffd11b"]]);
//#endregion
