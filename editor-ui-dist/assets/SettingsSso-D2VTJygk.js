...
import { Ln as useMessage, Pn as useToast, _r as useTelemetry, bi as useRBACStore, ui as useProjectsStore } from "./users.store-BCts_jcD.js";
import { t as ElDialog } from "./dialog-B9l44z-m.js";
import "./constants-CjIW4CHX.js";
import { t as useRootStore } from "./useRootStore-D8wbz-kO.js";
import { $ as listRoleMappingRules, Q as deleteRoleMappingRule, Z as createRoleMappingRule, et as moveRoleMappingRule, p as getUsers, tt as updateRoleMappingRule } from "./settings.store-BOIB94F8.js";
...
import { Ft as LanguageSupport, Nt as HighlightStyle, Pt as LRLanguage, Xt as syntaxTree, Yt as syntaxHighlighting, _n as keymap, an as EditorView, en as tags, et as history, i as javascriptLanguage, in as Decoration, kn as EditorState, n as parserWithMetaData, nt as historyKeymap, rn as parseMixed, sn as ViewPlugin } from "./expressions-Ah0d53bx.js";
import { r as captureMessage } from "./exports-CZt8e6vg.js";
import { t as useEnvFeatureFlag } from "./useEnvFeatureFlag-BRPsuP17.js";
import { t as useRolesStore } from "./roles.store-ClUzy3vo.js";
import { n as useSSOStore, t as SupportedProtocols } from "./sso.store-DMLlc3i6.js";
	...
	setup(__props, { emit: __emit }) {
		...
		return (_ctx, _cache) => {
			return openBlock(), createBlock(unref(ElDialog), {
				...
				default: withCtx(() => [!isSwitchingToManual.value ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
					...
					_: 1
				})])], 64)), createBaseVNode("div", _hoisted_8, [createVNode(unref(N8nCard_default), { class: normalizeClass(_ctx.$style.card) }, {
...
var SamlSettingsForm_default = /* @__PURE__ */ _plugin_vue_export_helper_default(/* @__PURE__ */ defineComponent({
	...
	setup(__props, { expose: __expose }) {
		...
		const { roleAssignment, mappingMethod, formValue: userRoleProvisioning, isUserRoleProvisioningChanged, saveProvisioningConfig, roleAssignmentTransition, storedHasProjectRoles, revertRoleAssignment } = useUserRoleProvisioningForm(SupportedProtocols.SAML);
...
var OidcSettingsForm_default = /* @__PURE__ */ _plugin_vue_export_helper_default(/* @__PURE__ */ defineComponent({
	...
	setup(__props, { expose: __expose }) {
		...
		const showUserRoleProvisioningDialog = ref(false);
		const { roleAssignment, mappingMethod, formValue: userRoleProvisioning, isUserRoleProvisioningChanged, saveProvisioningConfig, roleAssignmentTransition, storedHasProjectRoles, revertRoleAssignment } = useUserRoleProvisioningForm(SupportedProtocols.OIDC);
		...
		__expose({
			hasUnsavedChanges: computed(() => !cannotSaveOidcSettings.value && !savingForm.value && !isOverrideActive.value),
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("div", null, [
				createBaseVNode("div", { class: normalizeClass([_ctx.$style.card, _ctx.$style.firstCard]) }, [
					...
					createBaseVNode("div", { class: normalizeClass(_ctx.$style.group) }, [
						...
						createVNode(unref(Input_default), {
							...
							disabled: isOverrideActive.value,
							type: "text",
				...
				createBaseVNode("div", { class: normalizeClass(_ctx.$style.buttons) }, [!isOverrideActive.value ? (openBlock(), createBlock(unref(N8nButton_default), {
					key: 0,
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("div", _hoisted_1, [
				...
				unref(ssoStore).ssoManagedByEnv ? (openBlock(), createBlock(unref(N8nCallout_default), {
					...
					default: withCtx(() => [createTextVNode(toDisplayString(unref(i18n).baseText("settings.sso.settings.oidc.overrideBanner")), 1)]),
					_: 1
