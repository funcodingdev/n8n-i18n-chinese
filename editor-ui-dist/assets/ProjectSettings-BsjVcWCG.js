...
import { C as computed, Cn as toDisplayString, D as createElementBlock, E as createCommentVNode, G as nextTick, Gt as unref, I as guardReactiveProps, It as ref, M as createVNode, P as defineComponent, Pt as reactive, T as createBlock, U as mergeModels, W as mergeProps, Z as onMounted, _ as Fragment, _t as watch, at as renderSlot, bt as withCtx, et as openBlock, ft as useModel, h as withModifiers, it as renderList, j as createTextVNode, q as onBeforeMount, vn as normalizeClass, w as createBaseVNode, yn as normalizeProps } from "./vue.runtime.esm-bundler-XtMkEjzB.js";
import { bt as I18nT, ot as useDebounceFn, yt as useI18n } from "./_MapCache-Bl0j8A0i.js";
import { Ai as Input_default, Bi as N8nText_default, Ci as useRouter, Di as N8nTooltip_default, E as N8nUserSelect_default, Hi as N8nIcon_default, Ni as N8nActionBox_default, O as N8nUserInfo_default, Ri as N8nHeading_default, Vi as N8nButton_default, a as SelectItem_default, at as N8nInputLabel_default, hi as N8nLink_default, i as Select_default, it as N8nFormInput_default, ji as N8nIconButton_default, kt as N8nBadge_default, p as N8nDataTableServer_default, w as N8nIconPicker_default, wt as N8nActionToggle_default } from "./src-DNuWeQoI.js";
import { t as __plugin_vue_export_helper_default } from "./_plugin-vue_export-helper-DltO58Gh.js";
import "./sanitize-html-JHjOJhXQ.js";
import { It as useTelemetry, Wt as useProjectsStore, br as useToast, js as useSettingsStore, li as isProjectRole, pn as useDocumentTitle, r as useUIStore, t as useUsersStore, ur as useCloudPlanStore } from "./users.store-CgsgTstk.js";
import { t as ElRadio } from "./radio-BGZtJLb6.js";
import { t as ElDialog } from "./dialog-GNTdOb7x.js";
import { t as Alert_default } from "./Alert-CH9l52C5.js";
import { Os as SECRETS_PROVIDER_CONNECTION_MODAL_KEY, Ua as deepCopy, dl as getDebounceTime, f as CUSTOM_ROLES_DOCS_URL, is as VIEWS, ni as ROLE, rl as DEBOUNCE_TIME } from "./constants-DEPRN4fc.js";
...
import { t as usePageRedirectionHelper } from "./usePageRedirectionHelper-z-UqKyIw.js";
import "./folders.store-Bmhcjh89.js";
import { n as isIconOrEmoji } from "./ProjectIcon-BxNw0fpD.js";
import "./orderBy-uSE8PELb.js";
import { t as ProjectSharing_default } from "./ProjectSharing-BUJH_m5d.js";
import { t as useRolesStore } from "./roles.store-B6yW8Sl2.js";
import { t as useSecretsProviderConnection } from "./useSecretsProviderConnection.ee-CDXkXNlu.js";
import "./readyToRun.store-DygHrsIe.js";
import { t as ProjectHeader_default } from "./ProjectHeader-nY0Vppbx.js";
import { i as UI_VISIBLE_SCOPES, r as TOTAL_PROJECT_PERMISSIONS } from "./projectRoleScopes-bCpjOiDl.js";
import { t as useUserRoleProvisioningStore } from "./userRoleProvisioning.store-83Lr1oU7.js";
import { t as useSecretsProvidersList } from "./useSecretsProvidersList.ee-Cz8BBAON.js";
...
var ProjectExternalSecrets_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props, { expose: __expose }) {
		...
		const sortedConnections = computed(() => [...projectSecretConnections.value].sort((a, b) => b.secretsCount - a.secretsCount));
		...
		watch(() => projectsStore.currentProjectId, async (newProjectId) => {
			if (newProjectId && showExternalSecretsSection.value) await fetchProjectSecretConnections();
		}, { immediate: true });
		onMounted(async () => {
		...
		return (_ctx, _cache) => {
			return showExternalSecretsSection.value ? (openBlock(), createElementBlock("fieldset", _hoisted_1$1, [createBaseVNode("h3", _hoisted_2$1, [createBaseVNode("label", _hoisted_3$1, toDisplayString(unref(i18n).baseText("projects.settings.externalSecrets")), 1)]), emptyStateConfig.value ? (openBlock(), createBlock(unref(N8nActionBox_default), {
				...
				_: 1
			}, 8, ["class", "data-test-id"])) : projectSecretConnections.value.length > 0 ? (openBlock(), createElementBlock("div", {
				key: 1,
				...
				_: 1
			}, 8, ["modelValue", "placeholder"])], 2), createVNode(unref(N8nDataTableServer_default), {
...
var ProjectExternalSecrets_vue_vue_type_style_index_0_lang_module_default = {
	externalSecretsEmpty: "_externalSecretsEmpty_18bvm_125",
	description: "_description_18bvm_129",
	secretProvidersContainer: "_secretProvidersContainer_18bvm_134",
	searchContainer: "_searchContainer_18bvm_140",
	groupHeaderRow: "_groupHeaderRow_18bvm_145",
	groupHeaderCell: "_groupHeaderCell_18bvm_152",
	secretsCell: "_secretsCell_18bvm_164",
	secretsList: "_secretsList_18bvm_168",
	secretRow: "_secretRow_18bvm_173",
	groupHeaderContent: "_groupHeaderContent_18bvm_188",
	expandButton: "_expandButton_18bvm_197",
	secretName: "_secretName_18bvm_211",
	connectionLink: "_connectionLink_18bvm_218"
};
