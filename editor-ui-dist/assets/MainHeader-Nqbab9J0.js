...
import { $ as openBlock, $t as hasOwn, A as createTextVNode, C as createBaseVNode, Cn as toDisplayString, E as createElementBlock, Gt as unref, I as h, It as ref, K as onBeforeMount, N as defineComponent, R as inject, S as computed, T as createCommentVNode, Ut as toValue, W as nextTick, X as onMounted, _ as Fragment, bn as normalizeStyle, bt as withCtx, c as useCssModule, en as hyphenate, gt as watch, it as renderSlot, j as createVNode, p as vShow, pt as useTemplateRef, q as onBeforeUnmount, rt as renderList, st as resolveDynamicComponent, tn as init_shared_esm_bundler, vn as normalizeClass, w as createBlock, xt as withDirectives } from "./vue.runtime.esm-bundler-Bs4WIMNP.js";
import { ot as useI18n, u as useDocumentVisibility, v as useLocalStorage } from "./core-Ia_y23ne.js";
import { $i as N8nIconButton_default, B as SuggestedActions_default, Ct as useRoute, D as N8nUserStack_default, Ft as createEventBus, H as N8nSpinner_default, Ji as N8nTooltip_default, K as N8nRadioButtons_default, Pi as N8nBadge_default, _t as RouterLink, no as N8nButton_default, qt as N8nActionDropdown_default, ro as N8nIcon_default, rt as N8nTag_default, wt as useRouter, x as N8nInlineTextEdit_default } from "./src-C2myqZYv.js";
...
import { $i as WORKFLOW_ACTIVE_MODAL_KEY, Al as jsonParse, E as TIME_SAVED_DOCS_URL, Ea as LOCAL_STORAGE_HIDE_GITHUB_STAR_BUTTON, Oi as DUPLICATE_MODAL_KEY, Ou as getResourcePermissions, Pi as IMPORT_WORKFLOW_URL_MODAL_KEY, Qd as EnterpriseEditionFeature, b as N8N_MAIN_GITHUB_REPO_URL, ca as WORKFLOW_PUBLISH_MODAL_KEY, ea as WORKFLOW_DESCRIPTION_MODAL_KEY, g as EVALUATIONS_DOCS_URL, gi as WORKFLOW_HISTORY_PUBLISH_TIMELINE_TAB, h as ERROR_WORKFLOW_DOCS_URL, hf as WORKFLOW_MENU_ACTIONS, hi as VIEWS, ia as WORKFLOW_HISTORY_NAME_VERSION_MODAL_KEY, la as WORKFLOW_SETTINGS_MODAL_KEY, mi as MAIN_HEADER_TABS, nf as LOADING_ANIMATION_MIN_DURATION, sa as WORKFLOW_HISTORY_VERSION_UNPUBLISH, t as AutoSaveState, ua as WORKFLOW_SHARE_MODAL_KEY, ud as WorkflowDocumentStoreKey } from "./constants-CSBjw1Ht.js";
import { $i as getBannerRowHeight, En as ProjectTypes, Gt as injectNDVStoreIfProvided, It as useWorkflowId, Jn as getActivatableTriggerNodes, Rt as useTagsStore, Tn as useSourceControlStore, _ as useNodeTypesStore, a as injectWorkflowDocumentStore, b as useEvaluationStore, dn as useWorkflowsStore, r as createWorkflowDocumentId, s as useWorkflowDocumentStore, wn as useProjectsStore, yn as ResourceType } from "./workflowDocument.store-COBWkqWz.js";
...
import { f as useUIStore, h as telemetry, n as hasPermission, p as useTelemetry, t as useUsersStore } from "./users.store-UZbGTg0q.js";
...
import { a as useWorkflowSaveStore, r as useWorkflowSaving, s as useWorkflowHistoryStore } from "./builder.store-Dr8ivSqs.js";
...
import { t as useDocumentVisibility$1 } from "./useDocumentVisibility-rQfAAWLX.js";
...
import { t as router } from "./router-Bwq5EejY.js";
import { a as MCP_SETTINGS_VIEW, r as MCP_DOCS_PAGE_URL } from "./mcp.constants-CTihj9EH.js";
import { t as useMoveResourceToProjectToast } from "./useMoveResourceToProjectToast-DHSutUkI.js";
import { i as getLastPublishedVersion, r as generateVersionLabelFromId } from "./utils-CNE4flpV.js";
...
import { t as usePushConnection } from "./usePushConnection-Cy8KEcUF.js";
import { t as FolderBreadcrumbs_default } from "./FolderBreadcrumbs-BmIyj6Xx.js";
import { t as ConnectionTracker_default } from "./ConnectionTracker-9-esLCiI.js";
import { t as useWorkflowEvaluationState } from "./useWorkflowEvaluationState-DRLObrPa.js";
import "./usePushConnection-CnzRZpF3.js";
			...
			return openBlock(), createElementBlock("div", { class: normalizeClass(_ctx.$style.container) }, [
				...
				!shouldHidePublishButton.value ? (openBlock(), createElementBlock("div", {
					...
					content: withCtx(() => [createBaseVNode("div", null, [
						publishButtonConfig.value.tooltip ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [createTextVNode(toDisplayString(publishButtonConfig.value.tooltip) + " ", 1), _cache[0] || (_cache[0] = createBaseVNode("br", null, null, -1))], 64)) : createCommentVNode("", true),
						...
						publicationFailures.value.length > 0 ? (openBlock(), createElementBlock(Fragment, { key: 2 }, [
							...
							(openBlock(true), createElementBlock(Fragment, null, renderList(publicationFailures.value, (failure) => {
								return openBlock(), createElementBlock("span", { key: failure.nodeId }, [createTextVNode(toDisplayString(failure.nodeName), 1), _cache[2] || (_cache[2] = createBaseVNode("br", null, null, -1))]);
							}), 128))
						], 64)) : createCommentVNode("", true)
					])]),
