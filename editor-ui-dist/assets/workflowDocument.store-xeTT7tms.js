const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/workers-BNUEX0Bh.js","assets/comlink-DseSdP9Z.js"])))=>i.map(i=>d[i]);
...
import { $ as watchThrottled, A as createEventHook, nt as addNodeTranslation, ot as useI18n, rt as i18n, tt as addHeaders, v as useLocalStorage } from "./core-C5b2s2m3.js";
import { Ct as useRoute, W as isBinary, na as truncate } from "./src-BR3WX5fi.js";
import { a as require_toString, d as __vitePreload, s as require_memoize, t as require_get, u as require_lib } from "./get-BXEQ0kDX.js";
import { $n as SCHEDULE_TRIGGER_NODE_TYPE, A as ALLOWED_HTML_ATTRIBUTES, At as AI_MCP_TOOL_NODE_TYPE, B as MAPPING_PARAMS, Bc as getConnectionTypes, Cl as traverseNodeParameters, Cn as LIST_LIKE_NODE_OPERATIONS, D as TEMPLATES_NODES_FILTER, Dl as deepCopy, Ec as createRunExecutionData, F as PLACEHOLDER_FILLED_AT_EXECUTION_TIME, Fc as getChildNodes, Gc as getNodeWebhookUrl, Gs as require__baseFindIndex, Hc as getNodeOutputs, Hs as require__baseUniq, In as NON_ACTIVATABLE_TRIGGER_NODE_TYPES, J as AI_CATEGORY_HUMAN_IN_THE_LOOP, L as CUSTOM_API_CALL_KEY, Lc as checkConditions, Ll as ExpressionError, Mc as resolveVariables, Mn as MODULE_ENABLED_NODES, Nc as mapConnectionsByDestination, Os as require__createCompounder, Ou as getResourcePermissions, P as IN_PROGRESS_EXECUTION_ID, Pl as sleep$1, Pn as NODE_POSITION_CONFLICT_ALLOWLIST, Q as AI_CATEGORY_OTHER_TOOLS, Qc as isHitlToolType, Qd as EnterpriseEditionFeature, R as DATA_TYPE_ICON_MAP, Rc as displayParameter, Sr as WORKFLOW_TRIGGER_NODE_TYPE, Tc as createEmptyRunExecutionData, Uc as getNodeParameters, Vc as getNodeInputs, Vs as splitExpression, W as AI_CATEGORY_AGENTS, Wt as CREDENTIAL_ONLY_NODE_PREFIX, X as AI_CATEGORY_MCP_NODES, Yl as CHAT_TRIGGER_NODE_TYPE, _l as isResourceLocatorValue, at as AI_CODE_TOOL_LANGCHAIN_NODE_TYPE, bl as NodeConnectionTypes, bt as RECOMMENDED_NODES, cu as SEND_AND_WAIT_OPERATION, dd as WorkflowIdKey, dl as isFilterValue, dt as BETA_NODES, ft as CORE_NODES_CATEGORY, fu as v4, gt as HUMAN_IN_THE_LOOP_CATEGORY, gu as require_keys, hi as VIEWS, hs as require__baseFlatten, ht as HITL_SUBCATEGORY, i as DUPLICATE_POSTFFIX, id as CanvasRenderDataKey, it as AI_CATEGORY_VECTOR_STORES, j as ALLOWED_HTML_TAGS, js as require__baseIteratee, jt as AI_TRANSFORM_NODE_TYPE, ln as FORM_TRIGGER_NODE_TYPE, mc as isTrimmedNodeExecutionData, mi as MAIN_HEADER_TABS, mu as require_isEqual, ol as nodeIssuesToString, ou as MANUAL_TRIGGER_NODE_TYPE, pn as HTTP_REQUEST_NODE_TYPE, ps as require_pick, r as DEFAULT_SETTINGS, tn as ERROR_TRIGGER_NODE_TYPE, ud as WorkflowDocumentStoreKey, uu as WAIT_INDEFINITELY, vl as isResourceMapperValue$1, vr as WEBHOOK_NODE_TYPE, wl as isExpression, ws as Workflow, xl as nodeConnectionTypes, yr as WIKIPEDIA_TOOL_NODE_TYPE, ys as isAssignmentCollectionValue, zc as displayParameterPath, zl as UnexpectedError } from "./constants-CSBjw1Ht.js";
import { b as require_isArrayLike, n as require__isIterateeCall, r as require__baseRest, t as require_merge } from "./merge-CFboPyjf.js";
import { E as getActivePinia, T as defineStore, a as ResponseError, c as makeRestApiRequest, d as request, f as streamRequest, m as axios, s as getFullApiResponse, t as useRootStore } from "./useRootStore-hyBq4XlJ.js";
import { C as updateCurrentUserSettings, Ft as getProjectSecretProviderConnectionsByProjectId, Vn as STORES, _t as getResourceMapperFields, ct as fetchCommunityNodeAttributes, dt as getNodeParameterActionResult, ft as getNodeParameterOptions, gt as getResourceLocatorResults, ht as getNodesInformation, i as getWorkflowVersion, lt as fetchCommunityNodeTypes, mt as getNodeTypes$1, pt as getNodeTranslationHeaders, s as findWebhook, t as useSettingsStore, ut as getLocalResourceMapperFields } from "./settings.store-C5bX9q6f.js";
import { _ as useStorage, f as useUIStore, n as hasPermission, q as CANCELLABLE_EXECUTION_STATUSES, t as useUsersStore, u as hasRole } from "./users.store-DWiPI9j5.js";
import { r as require_toNumber } from "./useDebounce-DTqDXiDI.js";
import { A as isObject$1, E as stringSizeInBytes, S as isPresent, T as shorten, a as getNewWorkflow, i as getLastSuccessfulExecution, k as getObjectSizeInKB, l as getWorkflows, n as useFavoritesStore, r as getExecutionData, t as useWorkflowsListStore, w as omit, x as isJsonKeyObject, y as isEmpty } from "./workflowsList.store-C_pATVnM.js";
import { t as useDocumentTitle } from "./useDocumentTitle-BaE0TfJz.js";
import { t as require__baseOrderBy } from "./_baseOrderBy-C5IGnJzy.js";
	...
	const loadNodesInformationFromLocalDb = async (nodeInfos) => {
		try {
			const { getNodeType } = await __vitePreload(async () => {
				const { getNodeType } = await import("./workers-BNUEX0Bh.js");
				return { getNodeType };
			}, __vite__mapDeps([0,1]));
			const found = [];
			const missing = [];
	...
	const loadNodeTypesFromLocalDb = async () => {
		try {
			const { loadNodeTypes, getAllNodeTypes } = await __vitePreload(async () => {
				const { loadNodeTypes, getAllNodeTypes } = await import("./workers-BNUEX0Bh.js");
				return {
					loadNodeTypes,
					getAllNodeTypes
				};
...
//#endregion
export { useAiGatewayStore as $, getBannerRowHeight as $i, getMainAuthField as $n, MarkerType as $r, executionFilterToQueryFilter as $t, getHumanInTheLoopActions as A, isRouteLocationRaw as Ai, createDataTableApi as An, mapLegacyConnectionToCanvasConnection as Ar, stringifyExpressionResult as At, searchNodes as B, CANVAS_NODE_GROUP_HANDLE_RIGHT as Bi, moveDataTableColumnApi as Bn, PUSH_NODES_OFFSET as Br, removeWorkflowExecutionData as Bt, listEvaluationConfigs as C, isCredentialsResource as Ci, useRemoteProjectSearch as Cn, createCanvasConnectionHandleString as Cr, completeExpressionSyntax as Ct, finalizeItems as D, isProjectRole as Di, moveFolderToProject as Dn, injectCanvasRenderData as Dr, isTestableExpression as Dt, filterAndSearchNodes as E, isFullExecutionResponse as Ei, ProjectTypes as En, getMaxNodePortsLabelSize as Er, isPairedItemIntermediateNodesError as Et, isNodePreviewKey as F, isValidNodeConnectionType as Fi, fetchDataTableGlobalLimitInBytes as Fn, injectStrict as Fr, useRouteWorkflowId as Ft, transformNodeType as G, createCanvasGroupNodeId as Gi, executionDataToJson as Gn, getGenericHints as Gr, injectNDVStoreIfProvided as Gt, showsAiGatewaySection as H, CanvasConnectionMode as Hi, updateDataTableApi as Hn, doRectsOverlap as Hr, sortNodesByExecutionOrder as Ht, mapToolSubcategoryIcon as I, isVariableResource as Ii, fetchDataTablesApi as In, CONFIGURABLE_NODE_SIZE as Ir, useWorkflowId as It, getSampleWorkflowByTemplateId as J, structuralComputed as Ji, getActivatableTriggerNodes as Jn, getNewNodePosition as Jr, injectWorkflowExecutionStateStore as Jt, SampleTemplates as K, isCanvasGroupNode as Ki, fieldCannotBeDeleted as Kn, getMidCanvasPosition as Kr, useNDVStore as Kt, nodeTypesToCreateElements as L, isVueFlowConnection as Li, getDataTableRowsApi as Ln, CONFIGURATION_NODE_SIZE as Lr, useAnnotationTagsStore as Lt, getSendAndWaitNodes as M, isString as Mi, deleteDataTableColumnApi as Mn, parseCanvasConnectionHandleString as Mr, resolveParameter as Mt, groupItemsInSections as N, isTriggerPanelObject as Ni, deleteDataTableRowsApi as Nn, resolveCanonicalConnection as Nr, resolveRequiredParameters as Nt, flattenCreateElements as O, isResourceMapperValue as Oi, setWorkflowSharedWith as On, insertSpacersBetweenEndpoints as Or, removeExpressionPrefix as Ot, isAINode as P, isValidCredentialResponse as Pi, downloadDataTableCsvApi as Pn, shouldIgnoreCanvasShortcut as Pr, useWorkflowHelpers as Pt, isTemplatesWorkflow as Q, capitalizeFirstLetter as Qi, getAuthTypeForNodeCredential as Qn, updateViewportToContainNodes as Qr, displayForm as Qt, prepareCommunityNodeDetailsViewStack as R, isWorkflowListItem as Ri, importCsvToDataTableApi as Rn, DEFAULT_NODE_SIZE as Rr, useTagsStore as Rt, deleteEvaluationConfig as S, isCredentialModalState as Si, useAvailableProjectSearch as Sn, computeNodeDisplaySize as Sr, propertyNameFromExpression as St, extractAiGatewaySection as T, isDebouncedFunction as Ti, useSourceControlStore as Tn, createEmptyCanvasRenderData as Tr, getResolvableState as Tt, sortNodeCreateElements as U, CanvasNodeDirtiness as Ui, updateDataTableRowsApi as Un, generateOffsets as Ur, disposeNDVStore as Ut, shouldShowCommunityNodeDetails as V, CANVAS_NODE_GROUP_TYPE as Vi, renameDataTableColumnApi as Vn, calculateNodeSize as Vr, sanitizeConnections as Vt, subcategorizeItems as W, CanvasNodeRenderType as Wi, uploadCsvFileApi as Wn, getBounds as Wr, injectNDVStore as Wt, isTutorialTemplateId as X, pinDataToExecutionData as Xi, getAppNameFromCredType as Xn, getNodesGroupSize as Xr, buildExecutionResponseFromSchema as Xt, getTutorialTemplates as Y, getPinDataSize as Yi, getAllNodeCredentialForAuthType as Yn, getNodeViewTab as Yr, useWorkflowExecutionStateStore as Yt, isFullTemplatesCollection as Z, CHANGE_ACTION as Zi, getAppNameFromNodeName as Zn, getNodesWithNormalizedPosition as Zr, clearPopupWindowState as Zt, useNodeTypesStore as _, wheelDelta as _i, LOCAL_STORAGE_NDV_PANEL_WIDTH as _n, getAllCredentials as _r, useDataSchema as _t, injectWorkflowDocumentStore as a, sanitizeIfString as aa, _sfc_main$3 as ai, hasCancellableExecutions as an, getTriggerNodeServiceName as ar, require__baseSlice as at, useEvaluationStore as b, isBinaryLike as bi, getTruncatedProjectName as bn, applyOffset as br, getMappedExpression as bt, TOOL_NODE_TYPES_NEED_INPUT as c, clamp as ci, unflattenExecutionData as cn, hasProxyAuth as cr, chatWithAssistant as ct, doesNodeHaveCredentialsToFill as d, getConnectedEdges as di, useWorkflowsStore as dn, isRequiredCredential as dr, generateCodeForPrompt as dt, getScrollbarWidth as ea, NodeId as ei, executionRetryMessage as en, getNodeAuthFields as er, require_sortBy as et, getNodeTypeDisplayableCredentials as f, getRectOfNodes as fi, createExecutionDataId as fn, isResourceMapperFieldListStale as fr, getAiSessions as ft, require_uniq as g, useVueFlow as gi, getPairedItemId as gn, updateNodeAuthType as gr, useAIAssistantHelpers as gt, serializeNode as h, useGetPointerPosition as hi, useExecutionDataStore as hn, parseResourceMapperFieldName as hr, truncateBuilderMessages as ht, disposeWorkflowDocumentStore as i, sanitizeHtml as ia, _sfc_main$1 as ii, getExecutionErrorToastConfiguration as in, getThemedValue as ir, require_upperFirst as it, getRootSearchCallouts as j, isSharedResource as ji, deleteDataTableApi as jn, mapLegacyConnectionsToCanvasConnections as jr, unwrapExpression as jt, getAiTemplatesCallout as k, isResourceSortableByDate as ki, addDataTableColumnApi as kn, mapCanvasConnectionToLegacyConnection as kr, shouldConvertToExpression as kt, assignNodeId as l, getBezierPath as li, waitingNodeTooltip as ln, isAuthRelatedParameter as lr, chatWithBuilder as lt, needsAgentInput as m, isMacOs as mi, hasExecutionDataStore as mn, isValueExpression as mr, replaceCode as mt, createExecutionPreviewDocumentVersion as n, isOutsideSelected as na, Position as ni, getDefaultExecutionFilters as nn, getNodeCredentialForSelectedAuthType as nr, sublimeSearch as nt, provideWorkflowDocumentStore as o, _sfc_main$d as oi, hasTrimmedRunData as on, hasExpressionMapping as or, listenForCredentialChanges as ot, getParameterDisplayableOptions as p, getSmoothStepPath as pi, disposeExecutionDataStore as pn, isResourceMapperSchemaIncomplete as pr, getBuilderCredits as pt, getRagStarterWorkflowJson as q, parseCanvasGroupNodeId as qi, filterTemplateNodes as qn, getMousePosition as qr, disposeWorkflowExecutionStateStore as qt, createWorkflowDocumentId as r, openSafeUrl as ra, _sfc_main as ri, getExecutionErrorMessage as rn, getNodeSubtitle as rr, require_startCase as rt, useWorkflowDocumentStore as s, _sfc_main$f as si, openFormPopupWindow as sn, hasOnlyListMode as sr, useCredentialsStore as st, createExecutionPreviewDocumentId as t, isEventTargetContainedBy as ta, PanelPosition as ti, findTriggerNodeToAutoSelect as tn, getNodeAuthOptions as tr, capitalCase as tt, doesNodeHaveAllCredentialsFilled as u, getBoundsofRects as ui, parse as un, isMatchingField as ur, clearBuilderSession as ut, isDataWorkerEnabled as v, checkExhaustive as vi, useEnvironmentsStore as vn, require_toInteger as vr, useFlattenSchema as vt, updateEvaluationConfig as w, isDateObject as wi, useProjectsStore as wn, createCanvasConnectionId as wr, getExpressionErrorMessage as wt, createEvaluationConfig as x, isComponentPublicInstance as xi, splitName as xn, checkOverlap as xr, getMappedResult as xt, useActionsGenerator as y, isBaseTextKey as yi, ResourceType as yn, isCredentialOnlyNodeType as yr, escapeMappingString as yt, removePreviewToken as z, CANVAS_NODE_GROUP_HANDLE_LEFT as zi, insertDataTableRowApi as zn, DEFAULT_VIEWPORT_BOUNDARIES as zr, ensureNodePosition as zt };
