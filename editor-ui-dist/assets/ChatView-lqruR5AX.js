...
import { D as useElementSize, M as useLocalStorage, N as useMediaQuery, O as useEventListener, b as useActiveElement, bt as useI18n, xt as I18nT } from "./_MapCache-BFpNgXhv.js";
...
import { As as useSettingsStore, Po as INVITE_USER_MODAL_KEY, Tr as useToast, en as useTelemetry, gr as hasPermission, r as useUIStore, t as useUsersStore, vn as useDocumentTitle, wr as hasRole } from "./users.store-Bu2w-Rub.js";
import { Uo as v4_default, ac as LOCAL_STORAGE_CHAT_HUB_HAD_CONVERSATION_BEFORE, fi as chatHubConversationModelSchema, ii as ROLE, li as PROVIDER_CREDENTIAL_TYPE_MAP, ms as VIEWS, oc as LOCAL_STORAGE_CHAT_HUB_SELECTED_MODEL, pl as EnterpriseEditionFeature } from "./constants-B8dhY4J-.js";
...
import { l as shouldIgnoreCanvasShortcut } from "./canvas.utils-BbjPIdL6.js";
...
import { O as fetchWorkflowExecutionStatus, S as unflattenModel, c as findOneFromModelsResponse, h as isLlmProvider, i as collectChatArtifacts, k as revokeDynamicCredential, l as flattenModel, t as useChatStore, w as authorizeDynamicCredential } from "./chat.store-Ct2zal59.js";
import "./ChatAgentAvatar-E53_fHiq.js";
import { t as useResizablePanel } from "./useResizablePanel-pb4mL1eK.js";
import { a as useChatSession, i as ChatMarkdownChunk_default, n as ChatPrompt_default, r as ChatMessage_default, t as ChatGreetings_default } from "./ChatGreetings-CfAbxoek.js";
import { n as useFileDrop } from "./ToolsSelector-C_iPbPtY.js";
import { n as useChatCredentials, r as chatHubConversationModelWithCachedDisplayNameSchema, t as ChatLayout_default } from "./ChatLayout-C8cWgeux.js";
import { n as ModelSelector_default, t as useCustomAgent } from "./useCustomAgent-CzSbvgG0.js";
