...
import { Jt as INSTANCE_AI_CATALOG_PROVIDERS, on as deriveInstanceAiSetupState, wi as displayParameter } from "./src-BrbN-vPn.js";
...
import { n as deriveInstanceAiConfiguration, t as useInstanceAiSettingsStore } from "./instanceAiSettings.store-BbR4Z44G.js";
...
var InstanceAiOnboardingWizard_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props, { emit: __emit }) {
		...
		function focusDialogInsteadOfFirstField(event) {
			event.preventDefault();
		...
		return (_ctx, _cache) => {
			return openBlock(), createBlock(unref(Dialog_default), {
				...
				onOpenAutoFocus: focusDialogInsteadOfFirstField
			}, {
						...
						createBaseVNode("div", { class: normalizeClass(_ctx.$style.fields) }, [
							...
							createVNode(unref(N8nInputLabel_default), {
								...
								default: withCtx(() => [modelOptions.value.length && !modelNameLocked.value ? (openBlock(), createBlock(unref(N8nSelect_default), {
									...
									class: "ph-no-capture",
									disabled: modelNameLocked.value || readOnly.value,
