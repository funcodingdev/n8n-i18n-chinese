...
import { Ft as useProjectsStore, Tr as useToast, Vr as usePostHog, at as useCredentialsStore, en as useTelemetry, fl as sanitizeHtml, jr as useMessage, js as useSettingsStore, s as useWorkflowsStore, t as useUsersStore } from "./users.store-2EsruVYR.js";
import { $c as QUICK_CONNECT_EXPERIMENT, As as MODAL_CONFIRM, Fi as createResultError, Ii as createResultOk } from "./constants-_O8nYJwx.js";
import { d as makeRestApiRequest, r as useRootStore } from "./_baseOrderBy-V792pLeL.js";
...
function useQuickConnect() {
	...
	async function connectToPinecone(quickConnectOption) {
		const { ConnectPopup } = await __vitePreload(async () => {
			const { ConnectPopup: ConnectPopup$1 } = await import("./dist-CcUVDQkq.js");
