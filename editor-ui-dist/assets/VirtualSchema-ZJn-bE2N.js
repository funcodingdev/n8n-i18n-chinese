...
import { $ as openBlock, A as createTextVNode, C as createBaseVNode, Cn as toDisplayString, Ct as withScopeId, E as createElementBlock, F as guardReactiveProps, Gt as unref, I as h, It as ref, Lt as shallowReactive, Mt as markRaw, N as defineComponent, S as computed, T as createCommentVNode, U as mergeProps, Ut as toValue, W as nextTick, _ as Fragment, at as resolveComponent, bn as normalizeStyle, bt as withCtx, ct as toHandlers, et as popScopeId, ft as useSlots, gt as watch, h as withModifiers, it as renderSlot, j as createVNode, l as useCssVars, nt as pushScopeId, ot as resolveDirective, rt as renderList, st as resolveDynamicComponent, vn as normalizeClass, w as createBlock, xt as withDirectives, yn as normalizeProps } from "./vue.runtime.esm-bundler-Bs4WIMNP.js";
import { S as I18nT, x as useI18n } from "./_MapCache-B3VhjNx3.js";
import { Ai as N8nText_default, Ii as N8nButton_default, Li as N8nIcon_default, Tt as N8nLink_default, Wt as N8nCallout_default, d as useMessage, jr as N8nTooltip_default } from "./src-TtOAzrsZ.js";
...
import { E as useWorkflowDocumentStore, L as useNodeTypesStore, Mn as executionDataToJson, N as needsAgentInput, Ot as useDataSchema, St as generateCodeForPrompt, an as useEnvironmentsStore, kt as useFlattenSchema, rn as useNDVStore, t as useWorkflowsStore, tn as injectNDVStore, v as injectWorkflowExecutionStateStore, w as injectWorkflowDocumentStore } from "./workflows.store-YK4BoC2f.js";
import { Ci as UserError, Di as AI_TRANSFORM_CODE_GENERATED_FOR_PROMPT, Ht as createResultError, Oi as AI_TRANSFORM_JS_CODE, ai as NodeConnectionTypes, ii as DateTime } from "./src-DVvN4F-B.js";
...
import { Kr as BINARY_DATA_VIEW_MODAL_KEY, P as PLACEHOLDER_FILLED_AT_EXECUTION_TIME, Pt as CHAT_TRIGGER_NODE_TYPE, T as SCHEMA_PREVIEW_DOCS_URL, Xn as WEBHOOK_NODE_TYPE, fn as MANUAL_TRIGGER_NODE_TYPE, ni as FROM_AI_PARAMETERS_MODAL_KEY, nn as FORM_TRIGGER_NODE_TYPE, pi as MODAL_CONFIRM, po as EnterpriseEditionFeature } from "./constants-CQOOvzhs.js";
import { n as useTelemetry, o as useUIStore } from "./posthog.store-jf7EASbZ.js";
import { l as isEmpty } from "./typesUtils-DuFnSWAt.js";
...
import { i as Vo, o as fu, r as estree_exports, t as NDVEmptyState_default } from "./NDVEmptyState-BSjOxJIG.js";
...
import { n as MappingPill_default, t as useTelemetryContext } from "./useTelemetryContext-CmkjBRlf.js";
...
var VirtualSchemaHeader_default = /* @__PURE__ */ _plugin_vue_export_helper_default(/* @__PURE__ */ defineComponent({
...
var VirtualSchemaItem_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	emits: ["click"],
	setup(__props, { emit: __emit }) {
		useCssVars((_ctx) => ({ "v5648ddfc": _ctx.level }));
		const props = __props;
		const i18n = useI18n();
		...
		function viewBinaryData() {
			useUIStore().openModalWithData({
				...
				data: { binaryData: props.binaryData }
			});
		}
		const emit = __emit;
		return (_ctx, _cache) => {
			...
			return openBlock(), createElementBlock("div", {
				...
				props.binaryData && !__props.preview ? (openBlock(), createElementBlock("div", _hoisted_3, [createBaseVNode("div", {
...
var VirtualSchemaItem_default = /* @__PURE__ */ _plugin_vue_export_helper_default(VirtualSchemaItem_vue_vue_type_script_setup_true_lang_default, [["__cssModules", { "$style": VirtualSchemaItem_vue_vue_type_style_index_1_lang_module_default }], ["__scopeId", "data-v-dce75660"]]);
//#endregion
//#region ../../../node_modules/.pnpm/vue-resize@2.0.0-alpha.1_vue@3.5.26_typescript@6.0.2_/node_modules/vue-resize/dist/vue-resize.esm.js
...
popScopeId();
script$3.render = /* @__PURE__ */ _withId((_ctx, _cache, $props, $setup, $data, $options) => {
	return openBlock(), createBlock("div", _hoisted_1$1);
});
script$3.__scopeId = "data-v-b329ee4c";
script$3.__file = "src/components/ResizeObserver.vue";
//#endregion
//#region ../../../node_modules/.pnpm/vue-observe-visibility@2.0.0-alpha.1_vue@3.5.26_typescript@6.0.2_/node_modules/vue-observe-visibility/dist/vue-observe-visibility.esm.js
...
//#endregion
//#region ../../../node_modules/.pnpm/vue-virtual-scroller@2.0.0-beta.8_vue@3.5.26_typescript@6.0.2_/node_modules/vue-virtual-scroller/dist/vue-virtual-scroller.esm.js
...
var script$2 = {
	...
	components: { ResizeObserver: script$3 },
	...
	methods: {
		...
		scrollToItem(index) {
			...
			else scroll = Math.floor(index / gridItems) * this.itemSize;
...
var script$1 = {
	...
	components: { RecycleScroller: script$2 },
	provide() {
...
function getParentNodes(workflowDocumentId, activeNode) {
	const workflowDocumentStore = useWorkflowDocumentStore(workflowDocumentId);
	if (!activeNode) return [];
	return workflowDocumentStore.getParentNodesByDepth(activeNode.name).filter(({ name }, i, nodes) => {
		return name !== activeNode.name && nodes.findIndex((node) => node.name === name) === i;
	}).map((n) => workflowDocumentStore.getNodeByName(n.name)).filter((n) => n !== null);
}
function getSchemas(workflowDocumentId, activeNode) {
...
async function generateCodeForAiTransform(prompt, path, workflowDocumentId, activeNode, ndvPushRef, isAiCodeGenerationEnabled, retries = 1) {
	...
	if (isAiCodeGenerationEnabled) {
		...
		value = code;
	} else throw new UserError("AI code generation is not enabled");
	if (value === void 0) return;
	return {
		name: path,
		value: await fu(String(value), {
			parser: "babel",
			plugins: [Vo, estree_exports]
		})
	};
}
...
function createTextContext(style) {
...
//#endregion
//#region src/app/composables/useNodeExecution.ts
/**
...
*/
function useNodeExecution(node, options = {}) {
	const { telemetrySource = "setupPanel", executionMode = "inclusive", source = "SetupPanel.ExecuteNodeButton" } = options;
	...
	const nodeType = computed(() => nodeRef.value ? nodeTypesStore.getNodeType(nodeRef.value.type, nodeRef.value.typeVersion) : null);
	const isTriggerNode = computed(() => nodeRef.value ? nodeTypesStore.isTriggerNode(nodeRef.value.type) : false);
	...
	const isChatChild = computed(() => nodeRef.value ? workflowDocumentStore.value.checkIfNodeHasChatParent(nodeRef.value.name) : false);
	...
	const isNodeRunning = computed(() => {
		if (!workflowExecutionStateStore.value.isWorkflowRunning || codeGenerationInProgress.value) return false;
		const triggeredNode = workflowExecutionStateStore.value.activeExecutionExecutedNode;
		return workflowExecutionStateStore.value.executingNode.isNodeExecuting(nodeRef.value?.name ?? "") || triggeredNode === nodeRef.value?.name;
	});
	const isListening = computed(() => {
		...
		return !!nodeRef.value && !nodeRef.value.disabled && isTriggerNode.value && waitingOnWebhook && (!executedNode || executedNode === nodeRef.value.name);
	});
	const isListeningForWorkflowEvents = computed(() => isNodeRunning.value && isTriggerNode.value && !isScheduleTrigger.value && !isManualTriggerNode.value);
	const isExecuting = computed(() => codeGenerationInProgress.value || isNodeRunning.value && !isListening.value && !isListeningForWorkflowEvents.value);
	const hasIssues = computed(() => Boolean(nodeRef.value?.issues && (nodeRef.value.issues.parameters || nodeRef.value.issues.credentials)));
	const disabledReason = computed(() => {
		if (isListening.value) return "";
		if (codeGenerationInProgress.value) return i18n.baseText("ndv.execute.generatingCode");
		if (nodeRef.value?.disabled) return i18n.baseText("ndv.execute.nodeIsDisabled");
		if (isTriggerNode.value && hasIssues.value) return i18n.baseText("ndv.execute.requiredFieldsMissing");
		if (workflowExecutionStateStore.value.isWorkflowRunning && !isNodeRunning.value) return i18n.baseText("ndv.execute.workflowAlreadyRunning");
		return "";
	});
	const buttonLabel = computed(() => {
		if (isListening.value || isListeningForWorkflowEvents.value) return i18n.baseText("ndv.execute.stopListening");
		if (shouldGenerateCode.value) return i18n.baseText("ndv.execute.generateCodeAndTestNode.description");
		if (isChatNode.value) return i18n.baseText("chat.open");
	...
	const shouldGenerateCode = computed(() => {
		if (nodeRef.value?.type !== "n8n-nodes-base.aiTransform") return false;
		if (!nodeRef.value?.parameters?.instructions) return false;
		if (!nodeRef.value?.parameters?.jsCode) return true;
		if (nodeRef.value?.parameters["codeGeneratedForPrompt"] && (nodeRef.value?.parameters?.instructions).trim() !== (nodeRef.value?.parameters?.["codeGeneratedForPrompt"]).trim()) return true;
		return false;
	});
	...
	async function handleCodeGeneration() {
		...
		try {
			toast.showMessage({
				...
				message: i18n.baseText("ndv.execute.generateCode.message", { interpolate: { nodeName: nodeRef.value.name } }),
				type: "success"
			});
			const prompt = nodeRef.value.parameters?.instructions;
			const updateInformation = await generateCodeForAiTransform(prompt, `parameters.${AI_TRANSFORM_JS_CODE}`, workflowDocumentStore.value.documentId, ndvStore.value.activeNode, ndvStore.value.pushRef, askAi.value, 5);
			...
			telemetry.trackAiTransform("generationFinished", ndvStore.value.pushRef, {
				prompt: nodeRef.value?.parameters?.instructions,
				code: "",
				hasError: true
			});
			toast.showMessage({
	...
	function chatTriggerHasInputData() {
		if (!nodeRef.value) return false;
		const startNode = workflowDocumentStore.value.getStartNode(nodeRef.value.name);
		if (!startNode || startNode.type !== "@n8n/n8n-nodes-langchain.chatTrigger") return false;
	...
	async function execute() {
		...
		if (shouldGenerateCode.value) {
			if (!await handleCodeGeneration()) return "cancelled";
		}
		...
		if (pinnedData.hasData.value) {
			...
			if (shouldUnpinAndExecute) pinnedData.unsetData("unpin-and-execute-modal");
		}
	...
	async function stopExecution() {
		if (isListening.value) await stopWaitingForWebhook();
		else if (isListeningForWorkflowEvents.value) await stopCurrentExecution();
	}
	return {
		isExecuting,
		isListening,
...
var NodeExecuteButton_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props, { emit: __emit }) {
		...
		const { isExecuting, isListening, isListeningForWorkflowEvents, buttonLabel: nodeButtonLabel, buttonIcon: nodeButtonIcon, disabledReason, isTriggerNode, hasIssues, shouldGenerateCode, execute } = useNodeExecution(computed(() => workflowDocumentStore?.value?.getNodeByName(props.nodeName) ?? null), {
		...
		const disabledHint = computed(() => {
			if (isTriggerNode.value && hasIssues.value) {
				...
				if (activeNode && activeNode.name !== props.nodeName) return i18n.baseText("ndv.execute.fixPrevious");
			}
		...
		const tooltipText = computed(() => {
			...
			if (props.tooltip && !isExecuting.value && testStepButtonPopupCount() < MAX_POPUP_COUNT) return props.tooltip;
			return "";
		});
		...
		return (_ctx, _cache) => {
			return openBlock(), createBlock(unref(N8nTooltip_default), {
				...
				default: withCtx(() => [createVNode(unref(N8nButton_default), mergeProps(_ctx.$attrs, {
					loading: unref(isExecuting) && __props.showLoadingSpinner,
					disabled: __props.disabled || !!disabledHint.value || unref(isExecuting) && !__props.showLoadingSpinner,
					...
					title: !unref(isTriggerNode) && !tooltipText.value ? unref(i18n).baseText("ndv.execute.testNode.description") : "",
...
var VirtualSchema_default = /* @__PURE__ */ _plugin_vue_export_helper_default(/* @__PURE__ */ defineComponent({
	...
	setup(__props, { emit: __emit }) {
		...
		const getNodeSchema = async (fullNode, connectedNode) => {
			...
			const pinData = rawPinData ? executionDataToJson(rawPinData) : void 0;
			const isNodeExecuted = (pinData ? pinData.length > 0 : false) || hasNodeExecuted(connectedNode.name);
			const previewExecutionData = !isNodeExecuted && props.previewExecution ? props.previewExecution.data : void 0;
			...
			const connectedOutputsWithData = connectedOutputIndexes.map((outputIndex) => ({
				outputIndex,
				runIndex: getLastRunIndexWithData(fullNode.name, outputIndex, props.connectionType, previewExecutionData)
			})).filter(({ runIndex }) => runIndex !== -1);
			let filteredOutputsWithData = connectedOutputsWithData;
			if (props.outputIndex !== void 0 && connectedOutputIndexes.length > 1 && connectedOutputIndexes.includes(props.outputIndex)) filteredOutputsWithData = connectedOutputsWithData.filter(({ outputIndex }) => outputIndex === props.outputIndex);
			const nodeData = filteredOutputsWithData.map(({ outputIndex, runIndex }) => {
				return getNodeInputData(fullNode, runIndex, outputIndex, props.paneType, props.connectionType, previewExecutionData);
			}).flat();
		...
		const nodesSchemas = asyncComputed(async () => {
			const result = [];
			const search = props.search;
		...
		const flattenedNodes = computed(() => flattenMultipleSchemas(nodesSchemas.value, nodeAdditionalInfo, props.truncateLimit));
		...
		*/
		...
		const items = computed(() => {
			...
			if (isDebugging.value || props.paneType === "output") {
				...
				if (props.node?.type === "n8n-nodes-base.merge" && props.paneType === "output" && props.data && props.data.length > 1) allItems = [{
		...
		watch(() => Boolean(props.search), (hasSearch) => {
			if (hasSearch) {
...
}), [["__scopeId", "data-v-e7b115ca"]]);
//#endregion
export { getParentNodes as a, script as c, generateCodeForAiTransform as i, script$1 as l, NodeExecuteButton_default as n, getTextareaCursorPosition as o, useNodeExecution as r, getUpdatedTextareaValue as s, VirtualSchema_default as t };
