...
import { At as isRef, Bt as toRef$1, Et as getCurrentScope, Ft as ref, I as h, Mt as onScopeDispose, N as defineComponent, Nt as reactive, P as getCurrentInstance, Pt as readonly, R as inject, Rt as shallowRef, S as computed, Tt as effectScope, Vt as toRefs$1, W as nextTick, Wt as unref, X as onMounted, Z as onUnmounted, _ as Fragment, _t as watchEffect, b as Text, gt as watch, j as createVNode, tt as provide, wt as customRef } from "./vue.runtime.esm-bundler-dg1EVmSK.js";
...
var zh_CN_default = {
	...
	"instanceAi.memory.title": "工作记忆",
	"instanceAi.memory.placeholder": "暂无工作记忆内容",
	"instanceAi.memory.save": "保存",
	"instanceAi.memory.resetToTemplate": "重置为模板",
	...
	"instanceAi.debug.threads.context": "上下文",
	"instanceAi.debug.threads.workingMemory": "工作记忆（用户范围）",
	...
	"instanceAi.planReview.approve": "批准并继续",
	...
	"instanceAi.emptyState.title": "n8n 智能体",
...
export { refDebounced as $, useFileDialog as A, useTimeoutPoll as B, useCssVar as C, useElementSize as D, useElementHover as E, useScroll as F, directiveHooks as G, useVirtualList as H, useSessionStorage as I, isObject$3 as J, isClient as K, useSpeechRecognition as L, useLocalStorage as M, useMediaQuery as N, useEventListener as O, useResizeObserver as P, reactivePick as Q, useSpeechSynthesis as R, useClipboard as S, useElementBounding as T, createEventHook as U, useTimestamp as V, createInjectionState as W, notNullish as X, noop as Y, reactiveOmit as Z, onKeyDown as _, i18n as _t, require__getNative as a, tryOnScopeDispose as at, useActiveElement as b, useI18n as bt, require_isObject as c, useThrottleFn as ct, require__Symbol as d, watchThrottled as dt, refThrottled as et, require__root as f, isVue2 as ft, onClickOutside as g, addNodeTranslation as gt, computedAsync as h, addHeaders as ht, require_eq as i, tryOnMounted as it, useIntersectionObserver as j, useFavicon as k, require_isObjectLike as l, watchDebounced as lt, require_isArray as m, addCredentialTranslation as mt, require__Map as n, toRefs as nt, require__toSource as o, until as ot, require__freeGlobal as p, set as pt, isIOS as q, require__ListCache as r, toValue as rt, require_isFunction as s, useDebounceFn as st, require__MapCache as t, toRef as tt, require__baseGetTag as u, watchOnce as ut, onKeyStroke as v, i18nInstance as vt, useDocumentVisibility as w, useAsyncState as x, I18nT as xt, onKeyUp as y, setLanguage as yt, useStorage as z };
