...
var zh_CN_default = {
	...
	"aiAssistant.reducedHelp.chat.notice": "您选择不共享实际数据值。因此，AI 的响应将较少准确且缺乏上下文感知。",
	...
	"settings.secretsProviderConnections.buttons.addSecretsStore": "添加秘密存储",
	"settings.secretsProviderConnections.description": "通过连接外部秘密存储，在多个环境中管理凭据。在您的保险库中保留敏感凭据信息以增加安全性。您可以在中了解更多信息。",
	...
	"settings.secretsProviderConnections.modal.connectionName": "秘密存储名称",
	...
	"settings.secretsProviderConnections.modal.testConnection.success.title": "连接成功",
	"settings.secretsProviderConnections.modal.testConnection.success.description": "成功连接到 {providerName}",
	...
	"settings.secretsProviderConnections.modal.testConnection.error": "连接不成功，请检查您的 {providerName} 设置",
	"settings.secretsProviderConnections.modal.testConnection.error.serviceDisabled": "连接不成功。无法访问提供者。",
	"settings.secretsProviderConnections.modal.validation.connectionName.required": "秘密存储名称是必填项。请输入一个唯一的秘密存储名称。",
	"settings.secretsProviderConnections.modal.validation.connectionName.format": "秘密存储名称只能包含小写字母、数字和连字符（例如，“aws-production”）",
	...
	"settings.secretsProviderConnections.delete.description.oneSecret": "1 个秘密",
	"settings.secretsProviderConnections.delete.description.secrets": "{count} 个秘密",
	...
	"projects.settings.role.contactAdmin.body": "您可以分配系统角色，但自定义角色需要由实例管理员首先创建。与您的实例管理员分享文档，以便设置自定义角色。",
	"projects.settings.role.contactAdmin.bodyWithRoles": "您可以分配现有的自定义角色，但只有实例管理员可以创建新的角色。如果您需要新的自定义角色，请联系实例管理员。请在 {documentation} 中了解更多信息。",
	"projects.settings.role.upgrade.custom.title": "升级到企业版",
	"projects.settings.role.upgrade.custom.body": "为了创建和管理自定义角色，您需要将您的计划升级到企业选项。有关详细信息，请参阅文档。",
	...
	"projects.settings.externalSecrets.button.addSecretsStore": "添加秘密存储",
	...
	"projects.settings.externalSecrets.table.header.provider": "秘密存储",
	...
	"setupPanel.everythingConfigured.message": "所有凭据均已配置完成。",
