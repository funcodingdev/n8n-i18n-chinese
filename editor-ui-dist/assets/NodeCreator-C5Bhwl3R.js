...
import { $ as openBlock, A as createTextVNode, C as createBaseVNode, E as createElementBlock, F as guardReactiveProps, Ft as ref, N as defineComponent, Nt as reactive, O as createSlots, S as computed, Sn as toDisplayString, T as createCommentVNode, U as mergeProps, Vt as toRefs, Wt as unref, X as onMounted, Z as onUnmounted, _ as Fragment, _n as normalizeClass, bt as withDirectives, c as useCssModule, gt as watch, h as withModifiers, it as renderSlot, j as createVNode, k as createStaticVNode, n as Transition, ot as resolveDirective, p as vShow, q as onBeforeUnmount, rt as renderList, vn as normalizeProps, w as createBlock, xt as withMemo, yn as normalizeStyle, yt as withCtx } from "./vue.runtime.esm-bundler-C6vn67cX.js";
import { i as i18n, s as useI18n } from "./src-WwCUXbmD.js";
import { Da as N8nText_default, Ea as N8nCallout_default, G as N8nNodeCreatorNode_default, Oa as N8nButton_default, U as N8nNotice_default, Ut as N8nLoading_default, W as N8nNodeIcon_default, Wi as N8nIconButton_default, ct as N8nLink_default, et as N8nInfoTip_default, ka as N8nIcon_default, zi as N8nTooltip_default } from "./src-DFOx8N22.js";
import { t as _plugin_vue_export_helper_default } from "./_plugin-vue_export-helper-Da88TEg1.js";
import { J as useActionsGenerator, Q as flattenCreateElements, X as filterAndSearchNodes, b as injectWorkflowDocumentStore, ct as removePreviewToken, et as getHumanInTheLoopActions, it as isNodePreviewKey, kt as useCredentialsStore, mr as DEFAULT_NODE_SIZE, pt as transformNodeType, q as useNodeTypesStore, st as prepareCommunityNodeDetailsViewStack, tt as getRootSearchCallouts, ut as shouldShowCommunityNodeDetails, wr as getNewNodePosition } from "./workflows.store-Cc2IYz8o.js";
import { $s as isCommunityPackageName, F as DRAG_EVENT_DATA_KEY, Ln as OPEN_AI_NODE_MESSAGE_ASSISTANT_TYPE, N as CUSTOM_API_CALL_KEY, _t as REGULAR_NODE_CREATOR_VIEW, at as AI_UNCATEGORIZED_CATEGORY, ft as HUMAN_IN_THE_LOOP_CATEGORY, ln as HTTP_REQUEST_NODE_TYPE, nt as AI_EVALUATION, rt as AI_OTHERS_NODE_CREATOR_VIEW, vt as REQUEST_NODE_FORM_URL, xt as TRIGGER_NODE_CREATOR_VIEW } from "./constants-BMUE7W6Y.js";
import { t as useSettingsStore } from "./settings.store-D_uIyAbF.js";
import { t as useBannersStore } from "./banners.store-wg7tVm9v.js";
import { n as onClickOutside } from "./core-nZc0i8VB.js";
import { S as COMMUNITY_NODES_INSTALLATION_DOCS_URL, f as useUIStore, p as useTelemetry, t as useUsersStore } from "./users.store-OUM63rct.js";
import { t as useDebounce } from "./useDebounce-g_bJ4r2W.js";
...
import { n as captureException } from "./exports-CPk7_Qvp.js";
import { n as useNodeType } from "./usePinnedData-y7rLf6O_.js";
import { n as getNodeIconSource, t as getNodeIconSize } from "./nodeIcon-OIlgWClq.js";
import { a as AINodesView, c as RegularView, i as useKeyboardNavigation, l as TriggerView, n as useNodeCreatorStore, o as AIView, r as useViewStacks, s as HitlToolView, u as require_camelCase } from "./canvas.eventBus-B-ewSm-0.js";
...
import { i as QuickConnectBanner_default, n as CommunityNodeFooter_default, r as useInstalledCommunityPackage, t as CommunityNodeUpdateInfo_default } from "./CommunityNodeUpdateInfo-CkgW84cy.js";
import { t as useActions } from "./useActions-NFjxv7x5.js";
