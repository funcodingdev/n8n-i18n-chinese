...
import { Ai as N8nText_default, B as N8nSwitch_default, D as N8nUserSelect_default, Dt as Checkbox_default, Et as N8nInputLabel_default, Fi as N8nIconButton_default, H as SuggestedActions_default, Ii as N8nButton_default, J as N8nRadioButtons_default, Li as N8nIcon_default, O as N8nUserStack_default, Pi as Input_default, S as N8nInlineTextEdit_default, W as N8nSpinner_default, Zt as N8nActionDropdown_default, _r as N8nBadge_default, d as useMessage, ft as N8nTag_default, h as Dialog_default, jr as N8nTooltip_default, m as DialogFooter_default, tn as DropdownMenuItem_default, v as DialogDescription_default } from "./src-BoizZDiU.js";
import { f as __vitePreload } from "./get-BQc30k0X.js";
import { t as _plugin_vue_export_helper_default } from "./_plugin-vue_export-helper-Da88TEg1.js";
import { d as useDocumentVisibility, y as useLocalStorage } from "./dist-CmlFwYoT.js";
import { _ as useRouter, g as useRoute, n as getBannerRowHeight, u as RouterLink } from "./htmlUtils-DDeXXqh8.js";
import { t as useToast } from "./useToast-BtUJ9CH0.js";
import { t as createEventBus } from "./event-bus-DAq0yaAJ.js";
import { E as useWorkflowDocumentStore, Fn as getActivatableTriggerNodes, L as useNodeTypesStore, S as createWorkflowDocumentId, Yt as useTagsStore, dn as useProjectsStore, fn as useSourceControlStore, nn as injectNDVStoreIfProvided, on as ResourceType, pn as ProjectTypes, qt as useWorkflowId, t as useWorkflowsStore, w as injectWorkflowDocumentStore } from "./workflows.store-w-uLno6O.js";
import { i as defineStore } from "./constants-DwjrKqNn.js";
import { da as getResourcePermissions, hi as jsonParse } from "./src-UnL6BUww.js";
...
import { Br as WORKFLOW_HISTORY_PUBLISH_TIMELINE_TAB, Ci as WORKFLOW_ACTIVE_MODAL_KEY, D as TIME_SAVED_DOCS_URL, Ea as WorkflowDocumentStoreKey, Mi as WORKFLOW_PUBLISH_MODAL_KEY, Ni as WORKFLOW_SETTINGS_MODAL_KEY, Oi as WORKFLOW_HISTORY_NAME_VERSION_MODAL_KEY, Pi as WORKFLOW_SHARE_MODAL_KEY, Qr as DUPLICATE_MODAL_KEY, Xi as LOCAL_STORAGE_HIDE_GITHUB_STAR_BUTTON, _ as EVALUATIONS_DOCS_URL, bo as WORKFLOW_MENU_ACTIONS, da as LOCAL_STORAGE_WORKFLOW_REVIEW_REQUIRED_BY_WORKFLOW, fa as LOCAL_STORAGE_WORKFLOW_REVIEW_SUBMITTED_DIALOG_HIDDEN, g as ERROR_WORKFLOW_DOCS_URL, ii as IMPORT_WORKFLOW_URL_MODAL_KEY, ji as WORKFLOW_HISTORY_VERSION_UNPUBLISH, po as EnterpriseEditionFeature, t as AutoSaveState, ua as LOCAL_STORAGE_WORKFLOW_REVIEW_PUBLISH_CHOICE_HIDDEN, wi as WORKFLOW_DESCRIPTION_MODAL_KEY, x as N8N_MAIN_GITHUB_REPO_URL, zr as MAIN_HEADER_TABS } from "./constants-On-mUxgN.js";
import { i as LOADING_ANIMATION_MIN_DURATION } from "./durations-CNO5pC2_.js";
import { t as VIEWS } from "./views-4JHVC4Nc.js";
import { i as telemetry, n as useTelemetry, o as useUIStore } from "./posthog.store-BBCCmZh6.js";
import { n as useDebounce, r as require_debounce } from "./useDebounce-b_3g4H4E.js";
import { t as router } from "./router-zg6gcwK6.js";
...
import { t as useEvaluationStore } from "./evaluation.store-DoZWiJ7L.js";
import { t as useDocumentTitle } from "./useDocumentTitle-Ckzr_ePs.js";
import { a as useWorkflowSaveStore, r as useWorkflowSaving, s as useWorkflowHistoryStore } from "./builder.store-BjzfOzXx.js";
...
import { t as useDocumentVisibility$1 } from "./useDocumentVisibility-e3HFvZp0.js";
...
import { i as MCP_DOCS_PAGE_URL, s as MCP_SETTINGS_VIEW } from "./mcp.constants-xCSEOKYW.js";
import { t as useWorkflowReviewsFeature } from "./useWorkflowReviewsFeature-BbXYIY77.js";
import { t as useMoveResourceToProjectToast } from "./useMoveResourceToProjectToast-CmpJMpbk.js";
import { i as getLastPublishedVersion, r as generateVersionLabelFromId } from "./utils-ClTlp48F.js";
...
import { t as usePushConnection } from "./usePushConnection-FPMl0kFr.js";
import { t as FolderBreadcrumbs_default } from "./FolderBreadcrumbs-B0hn0v-L.js";
import { t as ConnectionTracker_default } from "./ConnectionTracker-Dwqc_s4d.js";
import { t as useWorkflowEvaluationState } from "./useWorkflowEvaluationState-CIDQgdwz.js";
import { a as fetchWorkflowReviewRequests, n as fetchEligibleReviewers, o as updateWorkflowReviewRequestVersion, t as createWorkflowReviewRequest } from "./workflowReviews.api-B5_msAB4.js";
import "./usePushConnection-DB3L6rJk.js";
...
var useWorkflowReviewStatusStore = defineStore("workflowReviewStatus", () => {
	const rootStore = useRootStore();
	const openReviewByWorkflowId = ref({});
...
var WorkflowPublishChoiceDialog_vue_vue_type_style_index_0_lang_module_default = {
	description: "_description_171v5_125",
	footer: "_footer_171v5_130",
	actions: "_actions_171v5_135",
	dontShowAgain: "_dontShowAgain_171v5_140"
};
	...
	setup(__props, { emit: __emit }) {
		...
		const submit = async () => {
			...
			try {
				...
				reviewStatusStore.fetchStatus(props.workflowId);
				emit("update:open", false);
				emit("submitted");
			} catch (error) {
...
var WorkflowUpdateReviewDialog_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props, { emit: __emit }) {
		...
		const resolveOpenReviewRequestId = async () => {
		...
		return (_ctx, _cache) => {
			return openBlock(), createBlock(unref(Dialog_default), {
				...
				default: withCtx(() => [createVNode(unref(DialogDescription_default), { class: normalizeClass(_ctx.$style.description) }, {
					default: withCtx(() => [createTextVNode(toDisplayString(unref(i18n).baseText("workflowReviews.updateReview.description")), 1)]),
					_: 1
...
var WorkflowHeaderDraftPublishActions_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props, { expose: __expose }) {
		...
		useWorkflowReviewStatusSync(() => props.isNewWorkflow ? void 0 : props.id);
		const collaborationStore = useCollaborationStore();
		...
		const showWorkflowReviewRequiredToggle = computed(() => isWorkflowReviewsEnabled.value && !props.isNewWorkflow);
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("div", { class: normalizeClass(_ctx.$style.container) }, [
				...
				!shouldHidePublishButton.value ? (openBlock(), createElementBlock("div", {
					...
					width: showWorkflowReviewRequiredToggle.value ? "230px" : void 0,
					...
					_: 2
				}, [showWorkflowReviewRequiredToggle.value ? {
					name: "footer",
				...
				unref(isWorkflowReviewsEnabled) ? (openBlock(), createElementBlock(Fragment, { key: 3 }, [
					...
					createVNode(WorkflowReviewSubmittedDialog_default, {
...
var WorkflowHeaderDraftPublishActions_vue_vue_type_style_index_0_lang_module_default = {
	container: "_container_1ivr7_125",
	activeVersionIndicator: "_activeVersionIndicator_1ivr7_129",
	icon: "_icon_1ivr7_133",
	publishButtonWrapper: "_publishButtonWrapper_1ivr7_137",
	buttonGroup: "_buttonGroup_1ivr7_143",
	groupButtonLeft: "_groupButtonLeft_1ivr7_149",
	groupButtonRight: "_groupButtonRight_1ivr7_161",
	indicatorDot: "_indicatorDot_1ivr7_171",
	publishingSpinner: "_publishingSpinner_1ivr7_179",
	indicatorPublished: "_indicatorPublished_1ivr7_183",
	indicatorPublishedText: "_indicatorPublishedText_1ivr7_187",
	indicatorChanges: "_indicatorChanges_1ivr7_191",
	indicatorIssues: "_indicatorIssues_1ivr7_195",
	indicatorPartial: "_indicatorPartial_1ivr7_199",
	flex: "_flex_1ivr7_203"
};
