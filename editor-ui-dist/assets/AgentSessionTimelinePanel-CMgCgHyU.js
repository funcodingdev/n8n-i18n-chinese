import { $ as openBlock, A as createTextVNode, C as createBaseVNode, Cn as toDisplayString, E as createElementBlock, Gt as unref, It as ref, N as defineComponent, Pt as reactive, S as computed, T as createCommentVNode, W as nextTick, X as onMounted, _ as Fragment, bn as normalizeStyle, bt as withCtx, gt as watch, h as withModifiers, j as createVNode, n as Transition, q as onBeforeUnmount, rt as renderList, st as resolveDynamicComponent, tt as provide, vn as normalizeClass, w as createBlock, zt as shallowRef } from "./vue.runtime.esm-bundler-Bs4WIMNP.js";
import { x as useI18n } from "./_MapCache-D_HoWCyo.js";
import { Ct as N8nHoverCard_default, Gt as N8nCard_default, Jt as N8nCallout_default, X as N8nRecycleScroller_default, do as N8nIconButton_default, et as N8nPopover_default, fo as N8nButton_default, oa as N8nTooltip_default, oo as N8nText_default, po as N8nIcon_default, sa as truncate, uo as Input_default } from "./src-DmjM-ErL.js";
import { t as _plugin_vue_export_helper_default } from "./_plugin-vue_export-helper-Da88TEg1.js";
import { d as useDocumentVisibility, h as useEventListener, s as useActiveElement } from "./dist-BkE9aYmt.js";
import { _ as useRouter } from "./htmlUtils-BzS-cI7x.js";
import { C as disposeWorkflowDocumentStore, E as useWorkflowDocumentStore, Jt as useWorkflowHelpers, R as useNodeTypesStore, S as createWorkflowDocumentId, _ as disposeWorkflowExecutionStateStore, gi as useExecutionDataStore, hi as hasExecutionDataStore, mi as disposeExecutionDataStore, on as useNDVStore, pi as createExecutionDataId, rn as disposeNDVStore, t as useWorkflowsStore, wr as shouldIgnoreCanvasShortcut, y as useWorkflowExecutionStateStore } from "./workflows.store-CGzW8V-x.js";
import { t as useRootStore } from "./useRootStore-BSEpDaXx.js";
import { H as richMessageSchema, Nt as Workflow, Va as SUB_AGENT_TASK_DIFFICULTIES, Xa as enumType, eo as objectType, no as stringType } from "./src-CZLzAGVt.js";
import { t as VIEWS } from "./views-Cm6YRZ1u.js";
import { n as useToast } from "./useToast-DLNv8iBz.js";
import { ba as WorkflowIdKey, ya as WorkflowDocumentStoreKey } from "./constants-BqyeOg5z.js";
import { o as formatBytes } from "./typesUtils-CmYYhzbj.js";
import { t as useExecutionsStore } from "./executions.store-DWRCKgrx.js";
import { i as NodeErrorView_default, t as RunData_default } from "./RunData-By3xMl6J.js";
import { w as ChatSymbol } from "./useCanvasOperations-BBRn3NFh.js";
...
import { r as useProjectAgentsList } from "./useProjectAgentsList-AA15uIdl.js";
import { n as getToolNameTranslationKey, r as resolveToolNameForDisplay, t as formatToolNameForDisplay } from "./toolDisplayName-HIlOArGF.js";
import { d as flattenLogEntries, g as getSubtreeTotalConsumedTokens, o as createLogTree, t as LogsOverviewRow_default, w as isNodeLog } from "./LogsOverviewRow-D8lli1UQ.js";
import { n as useAgentSessionsStore } from "./thread-title-DPsaRHB3.js";
	...
	setup(__props) {
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("div", {
				...
				], 10, _hoisted_1$6)) : item.imageSrc ? (openBlock(), createElementBlock("a", {
					key: 1,
					href: item.href,
					target: "_blank",
				...
				}, null, 42, _hoisted_3$3)], 10, _hoisted_2$5)) : (openBlock(), createBlock(resolveDynamicComponent(item.href ? "a" : "span"), {
					key: 2,
					href: item.href,
...
function timelineItemSearchText(item, labelForKey) {
	...
	if (item.kind === "tool" && item.isUserFeedback) parts.push(labelForKey("user-feedback"));
	parts.push(item.content, item.toolName, item.workflowName, item.nodeDisplayName, item.subAgentName, searchableValueText(item.toolInput), searchableValueText(item.toolOutput));
...
function flattenExecutionsToTimelineItems(executions) {
	const items = [];
	const suspendedToolCallIds = /* @__PURE__ */ new Set();
	for (const exec of executions) {
		...
		for (const event of timelineEvents(exec)) if (event.type === "text") {
			...
			const isUserFeedback = !isWorkflow && !isNode && event.toolCallId !== void 0 && suspendedToolCallIds.has(event.toolCallId);
			items.push({
	...
	setup(__props, { emit: __emit }) {
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("div", {
				...
				}, toDisplayString(infoText.value), 11, _hoisted_1$3)) : (openBlock(), createElementBlock("span", _hoisted_2$2, toDisplayString(infoText.value), 1)), attachmentChip.value ? (openBlock(), createBlock(unref(N8nTooltip_default), {
					key: 2,
...
var SessionTimelineRow_vue_vue_type_style_index_0_lang_module_default = {
	row: "_row_o7eov_126",
	selected: "_selected_o7eov_141",
	info: "_info_o7eov_145",
	workflowLink: "_workflowLink_o7eov_162",
	attachmentChip: "_attachmentChip_o7eov_167",
	time: "_time_o7eov_184"
};
	...
	setup(__props, { emit: __emit }) {
		...
		function labelForKey(key) {
			switch (key) {
				...
				case "user-feedback": return i18n.baseText("agentSessions.timeline.userFeedback");
				default: return key;
			}
		}
		const rows = computed(() => {
...
var WorkflowExecutionLogViewer_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		...
		let unmounted = false;
		onMounted(async () => {
			previousWorkflowExecutionData = useWorkflowExecutionStateStore(createWorkflowDocumentId(workflowsStore.workflowId)).activeExecution;
			try {
				...
				if (!result) errorMessage.value = i18n.baseText("agentSessions.workflowLog.unavailable");
					...
					useWorkflowExecutionStateStore(createWorkflowDocumentId(workflowsStore.workflowId)).setWorkflowExecutionData(result);
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("div", { class: normalizeClass(_ctx.$style.root) }, [loading.value ? (openBlock(), createElementBlock("div", {
				...
				selectedNode.value ? (openBlock(), createElementBlock("div", {
					key: 1,
					...
					!isTriggerSelected.value && inputBinding.value ? (openBlock(), createElementBlock("div", {
						...
						"workflow-execution": selectedNode.value.execution,
						"pane-type": "input",
						"display-mode": "schema",
...
var ToolIoView_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		...
		const documentStore = shallowRef(scopedDocumentStore);
		...
		onBeforeUnmount(() => {
			unmounted = true;
			if (hasExecutionDataStore(executionDataId)) disposeExecutionDataStore(useExecutionDataStore(executionDataId));
		...
		*/
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("div", { class: normalizeClass(_ctx.$style.panel) }, [__props.item ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [createBaseVNode("div", { class: normalizeClass(_ctx.$style.header) }, [createBaseVNode("div", { class: normalizeClass(_ctx.$style.headerTitle) }, [createVNode(unref(N8nIcon_default), {
				...
				"node-parameters",
				"success"
			])], 64)) : __props.item.kind === "agent" && agentStructuredContent.value !== void 0 ? (openBlock(), createElementBlock("div", {
				key: 3,
				class: normalizeClass(_ctx.$style.codeBlock)
			}, [createBaseVNode("div", { class: normalizeClass(_ctx.$style.codeBlockCopy) }, [createVNode(unref(N8nTooltip_default), { content: copiedBlock.value === "agent-output" ? unref(i18n).baseText("generic.copied") : unref(i18n).baseText("generic.copy") }, {
				default: withCtx(() => [createVNode(unref(N8nButton_default), {
					variant: "outline",
					size: "small",
					"icon-only": "",
					icon: copiedBlock.value === "agent-output" ? "check" : "copy",
					"aria-label": copiedBlock.value === "agent-output" ? unref(i18n).baseText("generic.copied") : unref(i18n).baseText("generic.copy"),
					onClick: _cache[4] || (_cache[4] = ($event) => copyJsonBlock("agent-output", agentStructuredContent.value))
				}, null, 8, ["icon", "aria-label"])]),
				_: 1
			}, 8, ["content"])], 2), createBaseVNode("pre", {
				class: normalizeClass(_ctx.$style.json),
				innerHTML: highlightJson(agentStructuredContent.value)
			}, null, 10, _hoisted_5)], 2)) : __props.item.kind === "user" || __props.item.kind === "agent" ? (openBlock(), createElementBlock(Fragment, { key: 4 }, [userAttachments.value.length > 0 && __props.projectId && __props.agentId ? (openBlock(), createBlock(AgentChatMessageAttachments_default, {
				key: 0,
...
//#endregion
export { formatDelegateError as a, isFailedDelegateOutput as c, resolveSubAgentName as d, cardChoiceLabel as f, parseN8nChatActionInput as h, SUB_AGENT_DIFFICULTY_I18N_KEY as i, parseDelegateOutput as l, n8nChatResumeValueSchema as m, useSubAgentNames as n, getDelegateDifficultySummary as o, isAwaitingCard as p, AgentChatMessageAttachments_default as r, isDelegateSubAgentTool as s, AgentSessionTimelinePanel_default as t, resolveSubAgentIdForDisplay as u };
