import { $ as openBlock, E as createElementBlock, Gt as unref, It as ref, N as defineComponent, S as computed, T as createCommentVNode, bt as withCtx, gt as watch, j as createVNode, vn as normalizeClass, w as createBlock } from "./vue.runtime.esm-bundler-CDDUUZhE.js";
import { s as useI18n } from "./src-Dh32dOY5.js";
import { Ja as N8nButton_default, Wi as N8nIconButton_default, zi as N8nTooltip_default } from "./src-BVC_ZvSs.js";
...
import { at as useCredentialsStore, it as listenForCredentialChanges, xn as useProjectsStore } from "./workflowDocument.store-Bqkdd6CP.js";
import { h as assert } from "./useRootStore-Crb5JJ4G.js";
import { d as listenForModalChanges, f as useUIStore } from "./users.store-B52ADdpG.js";
...
var CredentialPicker_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props, { emit: __emit }) {
		...
		const createNewCredential = () => {
			uiStore.openNewCredential(props.credentialType, true, false, props.projectId, props.suggestedCredentialName, void 0, void 0, { closeOnSave: true });
