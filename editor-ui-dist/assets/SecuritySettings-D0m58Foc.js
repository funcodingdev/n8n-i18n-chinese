...
import { $ as openBlock, A as createTextVNode, C as createBaseVNode, Cn as toDisplayString, E as createElementBlock, Gt as unref, It as ref, N as defineComponent, S as computed, T as createCommentVNode, _ as Fragment, bt as withCtx, c as useCssModule, j as createVNode, vn as normalizeClass, w as createBlock } from "./vue.runtime.esm-bundler-DYHsQBZB.js";
import { c as I18nT, s as useI18n } from "./src-C3h3FWXj.js";
import { t as _plugin_vue_export_helper_default } from "./_plugin-vue_export-helper-D-F0WtqU.js";
import { l as useAsyncState } from "./dist-CYNfKCbA.js";
import { t as N8nText_default } from "./N8nText-Cyh6n6lU.js";
import { t as Select_default } from "./Select-BLEE5rqL.js";
...
import { t as AlertDialog_default } from "./AlertDialog-B19G_-hO.js";
import { nt as updateSecuritySettings, t as useRootStore, tt as getSecuritySettings } from "./useRootStore-B-A2Ktsc.js";
...
import { ao as EnterpriseEditionFeature, b as EXECUTION_DATA_REDACTION_ENFORCEMENT_DOCS_URL } from "./constants-Bwbcx8Ih.js";
import { t as EnterpriseEdition_ee_default } from "./EnterpriseEdition.ee-WDzFKXFQ.js";
	...
	setup(__props) {
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("div", null, [
				createBaseVNode("div", { class: normalizeClass(["mb-s", unref($style).headerTitle]) }, [createVNode(unref(N8nHeading_default), {
					tag: "h2",
					size: "large"
				}, {
					...
					default: withCtx(() => [createTextVNode(toDisplayString(unref(i18n).baseText("settings.security.dataRedaction.description")), 1)]),
					_: 1
				})], 2),
...
var DataRedactionSection_vue_vue_type_style_index_0_lang_module_default = {
	headerTitle: "_headerTitle_5xits_2",
	settingsSection: "_settingsSection_5xits_8",
	settingsContainer: "_settingsContainer_5xits_15",
	settingsContainerInfo: "_settingsContainerInfo_5xits_23",
	settingsContainerAction: "_settingsContainerAction_5xits_34",
	settingsCountRow: "_settingsCountRow_5xits_42"
};
...
//#endregion
//#region src/features/settings/security/WorkflowReviewsSection.vue?vue&type=script&setup=true&lang.ts
var WorkflowReviewsSection_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	__name: "WorkflowReviewsSection",
	props: {
	...
	setup(__props) {
		...
		async function persist(value) {
			...
			isSaving.value = true;
			try {
				const response = await updateSecuritySettings(rootStore.restApiContext, { workflowReviews: { enabled: value } });
				...
				showToast({
					type: "success",
					title: i18n.baseText(`settings.security.workflowReviews.success.${enabled.value ? "enabled" : "disabled"}`),
					message: ""
				});
			} catch (error) {
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("div", null, [createBaseVNode("div", { class: normalizeClass(unref($style).settingsContainer) }, [createBaseVNode("div", { class: normalizeClass(unref($style).settingsContainerInfo) }, [createBaseVNode("div", { class: normalizeClass(unref($style).titleRow) }, [createVNode(unref(N8nText_default), { bold: true }, {
				default: withCtx(() => [createTextVNode(toDisplayString(unref(i18n).baseText("settings.security.workflowReviews.enable.title")), 1)]),
				_: 1
			}), createVNode(unref(PreviewTag_default), {
				size: "small",
				"data-test-id": "security-workflow-reviews-preview-tag"
			})], 2), createVNode(unref(N8nText_default), {
				size: "small",
				color: "text-light"
			}, {
				default: withCtx(() => [createTextVNode(toDisplayString(unref(i18n).baseText("settings.security.workflowReviews.enable.description")), 1)]),
				_: 1
			})], 2), createBaseVNode("div", { class: normalizeClass(unref($style).settingsContainerAction) }, [createVNode(unref(ElSwitch), {
				modelValue: toggleValue.value,
				"onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => toggleValue.value = $event),
				size: "large",
				disabled: __props.managedByEnv || isSaving.value,
				"data-test-id": "security-workflow-reviews-toggle"
			}, null, 8, ["modelValue", "disabled"])], 2)], 2), createVNode(unref(AlertDialog_default), {
				open: showDisableDialog.value,
				title: unref(i18n).baseText("settings.security.workflowReviews.confirmDisable.headline"),
				description: unref(i18n).baseText("settings.security.workflowReviews.confirmDisable.message"),
				onAction: confirmDisable,
				onCancel: _cache[1] || (_cache[1] = ($event) => showDisableDialog.value = false),
				"onUpdate:open": _cache[2] || (_cache[2] = ($event) => showDisableDialog.value = $event)
			}, null, 8, [
				"open",
				"title",
				"description"
...
var WorkflowReviewsSection_vue_vue_type_style_index_0_lang_module_default = {
	settingsContainer: "_settingsContainer_1x4da_2",
	settingsContainerInfo: "_settingsContainerInfo_1x4da_10",
	titleRow: "_titleRow_1x4da_21",
	settingsContainerAction: "_settingsContainerAction_1x4da_27"
};
var WorkflowReviewsSection_default = /* @__PURE__ */ _plugin_vue_export_helper_default(WorkflowReviewsSection_vue_vue_type_script_setup_true_lang_default, [["__cssModules", { "$style": WorkflowReviewsSection_vue_vue_type_style_index_0_lang_module_default }]]);
//#endregion
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("div", _hoisted_1, [
				...
				createBaseVNode("div", { class: normalizeClass(unref($style).settingsSection) }, [createBaseVNode("div", { class: normalizeClass(unref($style).settingsContainer) }, [createBaseVNode("div", { class: normalizeClass(unref($style).settingsContainerInfo) }, [createVNode(unref(N8nText_default), { bold: true }, {
					...
					default: withCtx(() => [createTextVNode(toDisplayString(unref(i18n).baseText("settings.personal.mfa.enforce.description")), 1)]),
					_: 1
				...
				createBaseVNode("div", { class: normalizeClass(["mb-s", unref($style).headerTitle]) }, [createVNode(unref(N8nHeading_default), {
					...
					default: withCtx(() => [createTextVNode(toDisplayString(unref(i18n).baseText("settings.security.personalSpace.description")), 1)]),
					_: 1
				})], 2),
				createBaseVNode("div", { class: normalizeClass([unref($style).settingsSection, "mb-s"]) }, [createBaseVNode("div", { class: normalizeClass(unref($style).settingsContainer) }, [createBaseVNode("div", { class: normalizeClass(unref($style).settingsContainerInfo) }, [createVNode(unref(N8nText_default), { bold: true }, {
				...
				isSecuritySettingsSettled.value && unref(isWorkflowReviewsAvailable) && unref(state) !== void 0 ? (openBlock(), createElementBlock(Fragment, { key: 2 }, [createBaseVNode("div", { class: normalizeClass(["mb-s", unref($style).headerTitle]) }, [createVNode(unref(N8nHeading_default), {
					tag: "h2",
					size: "large"
				}, {
					default: withCtx(() => [createTextVNode(toDisplayString(unref(i18n).baseText("settings.security.workflowReviews.title")), 1)]),
					_: 1
				}), createVNode(unref(N8nText_default), {
					size: "small",
					color: "text-base"
				}, {
					default: withCtx(() => [createTextVNode(toDisplayString(unref(i18n).baseText("settings.security.workflowReviews.description")), 1)]),
					_: 1
				})], 2), createBaseVNode("div", { class: normalizeClass(unref($style).settingsSection) }, [createVNode(WorkflowReviewsSection_default, {
					"initial-enabled": unref(state).workflowReviewsEnabled,
					"managed-by-env": isManagedByEnv.value
				}, null, 8, ["initial-enabled", "managed-by-env"])], 2)], 64)) : createCommentVNode("", true),
				createVNode(unref(AlertDialog_default), {
