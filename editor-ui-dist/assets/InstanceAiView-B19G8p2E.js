...
import { $ as openBlock, A as createTextVNode, Bt as toRef, C as createBaseVNode, E as createElementBlock, F as guardReactiveProps, Ft as ref, N as defineComponent, O as createSlots, Q as onUpdated, R as inject, S as computed, Sn as toDisplayString, T as createCommentVNode, U as mergeProps, Vt as toRefs, W as nextTick, Wt as unref, X as onMounted, Z as onUnmounted, _ as Fragment, _n as normalizeClass, at as resolveComponent, bt as withDirectives, c as useCssModule, f as vModelText, gt as watch, h as withModifiers, it as renderSlot, j as createVNode, m as withKeys, n as Transition, p as vShow, pt as useTemplateRef, q as onBeforeUnmount, r as TransitionGroup, rt as renderList, tt as provide, vn as normalizeProps, w as createBlock, yn as normalizeStyle, yt as withCtx } from "./vue.runtime.esm-bundler-Bw8GKr4Y.js";
import { C as useSpeechRecognition, J as useDebounceFn, at as useI18n, f as useElementHover, k as useWindowSize, n as onClickOutside, v as useLocalStorage, x as useScroll } from "./core-Beh0t8_q.js";
import { $i as CollapsibleContent_default, A as N8nResizeWrapper_default, Et as N8nCard_default, Gi as MenuPortal_default, Ji as MenuRoot_default, Ki as MenuContent_default, Lt as N8nBadge_default, Mi as MessageRating_default, Ni as Input_default, Pi as N8nIconButton_default, Pt as N8nActionDropdown_default, Qi as CollapsibleTrigger_default, Xi as RovingFocusItem_default, Yi as MenuAnchor_default, Zi as RovingFocusGroup_default, aa as useForwardExpose, ca as useResizeObserver, da as N8nHeading_default, ea as CollapsibleRoot_default, fa as N8nCallout_default, ft as Checkbox_default, ha as N8nIcon_default, ia as useForwardPropsEmits, ki as N8nTooltip_default, la as useVModel, lt as useRoute, m as N8nScrollArea_default, ma as N8nButton_default, n as DropdownMenu_default, na as Presence_default, nt as N8nLink_default, oa as useEmitAsProps, pa as N8nText_default, qi as MenuItem_default, ra as useId, sa as useDirection, ta as Primitive, ua as createContext, ut as useRouter } from "./src-Dg8CDsvD.js";
import { t as _plugin_vue_export_helper_default } from "./_plugin-vue_export-helper-Da88TEg1.js";
import { D as NodeCredentials_default, t as ParameterInputList_default } from "./ParameterInputList-B-4yT3YP.js";
import { $t as createWorkflowDocumentId, Jt as useTelemetry, Si as getMainAuthField, at as useCredentialsStore, ia as getWorkflow, nn as useWorkflowDocumentStore, r as useUIStore, s as useWorkflowsStore, un as useNodeHelpers, w as useNodeTypesStore, yi as getAppNameFromCredType, zr as useSourceControlStore, zt as useWorkflowsListStore } from "./users.store-Zd_8U4jS.js";
import { t as useToast } from "./useToast-DG5hVw1V.js";
import { $o as isResourceLocatorValue, Cs as NodeConnectionTypes, Dc as ExpressionLocalResolveContextSymbol, Eo as getNodeParameters, ni as INSTANCE_AI_BROWSER_USE_SETUP_MODAL_KEY, ri as INSTANCE_AI_COMPUTER_USE_SETUP_MODAL_KEY, xo as displayParameter } from "./constants-c-L9DE1I.js";
import { T as defineStore, t as useRootStore } from "./useRootStore-CCt5xa74.js";
import { a as isPlaceholderString, i as hasPlaceholderDeep } from "./dist-HucXAqjn.js";
...
import { i as NEW_CONVERSATION_TITLE, n as INSTANCE_AI_THREAD_VIEW, r as INSTANCE_AI_VIEW, t as INSTANCE_AI_SETTINGS_VIEW } from "./constants-CIsx9X_8.js";
import { t as useExpressionResolveCtx } from "./useExpressionResolveCtx-DxbTVeWL.js";
import { p as getRelativeDate, t as convertFileToBinaryData } from "./fileUtils-D3CGjcG6.js";
import { t as useInstanceAiSettingsStore } from "./instanceAiSettings.store-DE43JR-C.js";
import { a as fetchThreads, i as fetchThreadMessages, n as CreditsSettingsDropdown_default, r as useInstanceAiStore, t as CreditWarningBanner_default } from "./CreditWarningBanner-CVOgz0dd.js";
import { r as getNodeParametersIssues } from "./setupPanel.utils-BZuuX5uZ.js";
import { t as ChatFile_default } from "./ChatFile-gdOiuMOw.js";
import { t as ChatMarkdownChunk_default } from "./ChatMarkdownChunk-DCSHmbEu.js";
import { t as WorkflowPreview_default } from "./WorkflowPreview-BtcN3Omh.js";
import { t as DataTableTable_default } from "./DataTableTable-RIP8A0O1.js";
...
//#endregion
//#region ../../../node_modules/.pnpm/reka-ui@2.5.0_typescript@6.0.2_vue@3.5.26_typescript@6.0.2_/node_modules/reka-ui/dist/Tabs/TabsContent.js
...
function useCanvasPreview({ store, route, workflowExecutions }) {
	...
	const debouncedSavePreviewState = useDebounceFn((tabId) => {
		...
		if (!threadId) return;
		store.updateThreadMetadata(threadId, { activePreviewTab: tabId ?? null });
	}, 500);
	...
	const allArtifactTabs = computed(() => {
		...
		for (const entry of store.producedArtifacts.values()) if (entry.type === "workflow" || entry.type === "data-table") {
	...
	watch(() => route.params.threadId, (threadId, oldThreadId) => {
...
function useEventRelay({ workflowExecutions, activeWorkflowId, getBufferedEvents, clearEventLog, relay }) {
	...
	watch(() => workflowExecutions.value, (executions) => {
		...
		for (const [wfId, entry] of executions) {
			...
			if (prevExecId !== void 0 && prevExecId !== entry.executionId) relayedCount.delete(wfId);
			...
			if (isFinished && (prev === "running" || prev === void 0) && isActive) {
		...
		function enhanceResourceLinks() {
			...
			for (const link of allLinks) {
				...
				if (resourceMatch) {
					...
					const registryEntry = type === "data-table" ? [...store.resourceNameIndex.values()].find((r) => r.type === "data-table" && r.id === id) : void 0;
...
var TimelineStepButton_vue_vue_type_style_index_0_lang_module_default = {
	block: "_block_64p43_125",
	ellipsis: "_ellipsis_64p43_139",
	shimmer: "_shimmer_64p43_146"
};
...
var ArtifactCard_vue_vue_type_style_index_0_lang_module_default = {
	card: "_card_j9uy2_125",
	cardArchived: "_cardArchived_j9uy2_134",
	archivedBadge: "_archivedBadge_j9uy2_138",
	icon: "_icon_j9uy2_147",
	name: "_name_j9uy2_152",
	metadata: "_metadata_j9uy2_161"
};
...
var AgentTimeline_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		...
		function resolveArtifactName(artifact) {
			return store.producedArtifacts.get(artifact.resourceId)?.name ?? artifact.name;
		}
				...
				return openBlock(), createElementBlock(Fragment, { key: idx }, [entry.type === "text" ? (openBlock(), createBlock(unref(N8nText_default), {
					...
					!props.visibleEntries ? (openBlock(true), createElementBlock(Fragment, { key: 1 }, renderList(unref(extractArtifacts)(childrenById.value[entry.agentId]), (artifact) => {
						return openBlock(), createBlock(ArtifactCard_default, {
							...
							archived: unref(store).producedArtifacts.get(artifact.resourceId)?.archived,
...
var AgentActivityTree_vue_vue_type_style_index_0_lang_module_default = {
	reasoningTrigger: "_reasoningTrigger_64ktj_125",
	artifactCard: "_artifactCard_64ktj_130",
	reasoningContent: "_reasoningContent_64ktj_138"
};
...
var userMessage = "_userMessage_p6wck_125";
var userAttachments = "_userAttachments_p6wck_132";
var userBubble = "_userBubble_p6wck_139";
var assistantWrapper = "_assistantWrapper_p6wck_148";
var actionBtn = "_actionBtn_p6wck_154";
var statusIndicator = "_statusIndicator_p6wck_171";
var statusDot$1 = "_statusDot_p6wck_181";
var pulse$1 = "_pulse_p6wck_1";
var blinkingCursor = "_blinkingCursor_p6wck_205";
var runLevelError = "_runLevelError_p6wck_222";
var runLevelErrorDetails = "_runLevelErrorDetails_p6wck_228";
var errorDetailsSummary = "_errorDetailsSummary_p6wck_240";
var feedbackSuccess = "_feedbackSuccess_p6wck_249";
var debugJson = "_debugJson_p6wck_255";
var InstanceAiMessage_vue_vue_type_style_index_0_lang_module_default = {
	...
	actionBtn,
	statusIndicator,
	"status-fade-in": "_status-fade-in_p6wck_1",
	statusDot: statusDot$1,
	pulse: pulse$1,
	blinkingCursor,
	"cursor-blink": "_cursor-blink_p6wck_1",
	runLevelError,
...
var InstanceAiThreadList_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		...
		function handleNewThread() {
			...
			store.newThread();
			router.push({ name: INSTANCE_AI_VIEW });
		}
		...
		return (_ctx, _cache) => {
			...
			return openBlock(), createElementBlock("div", {
				...
				icon: "plus",
				size: "medium"
			})], 2), createTextVNode(" " + toDisplayString(unref(i18n).baseText("instanceAi.thread.new")), 1)], 2), createVNode(unref(N8nScrollArea_default), { class: normalizeClass(_ctx.$style.threadList) }, {
...
var InstanceAiThreadList_vue_vue_type_style_index_0_lang_module_default = {
	container: "_container_ybzmv_125",
	newChatButton: "_newChatButton_ybzmv_132",
	newChatIcon: "_newChatIcon_ybzmv_150",
	threadList: "_threadList_ybzmv_161",
	group: "_group_ybzmv_167",
	groupLabel: "_groupLabel_ybzmv_171",
	threadItem: "_threadItem_ybzmv_179",
	active: "_active_ybzmv_189",
	threadLink: "_threadLink_ybzmv_193",
	threadIcon: "_threadIcon_ybzmv_215",
	threadTitle: "_threadTitle_ybzmv_220",
	actionDropdown: "_actionDropdown_ybzmv_229",
	actionTrigger: "_actionTrigger_ybzmv_240",
	renameContainer: "_renameContainer_ybzmv_245",
	renameInput: "_renameInput_ybzmv_250",
	empty: "_empty_ybzmv_267"
};
...
var InstanceAiArtifactsPanel_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		...
		const artifacts = computed(() => {
			const result = [];
			for (const entry of store.producedArtifacts.values()) if (entry.type === "workflow" || entry.type === "data-table") result.push(entry);
			return result;
		});
...
var InstanceAiStatusBar_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		...
		const activity = computed(() => {
			if (store.isAwaitingConfirmation) return { label: i18n.baseText("instanceAi.statusBar.waitingForInput") };
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("div", null, [createVNode(Transition, { name: "status-bar" }, {
				default: withCtx(() => [isVisible.value && activity.value ? (openBlock(), createElementBlock("div", {
					key: 0,
					class: normalizeClass([_ctx.$style.bar, { [_ctx.$style.muted]: unref(store).isAwaitingConfirmation }]),
					"data-test-id": "instance-ai-status-bar"
				}, [
					unref(store).isAwaitingConfirmation ? (openBlock(), createBlock(unref(N8nIcon_default), {
						key: 0,
					...
					!unref(store).isAwaitingConfirmation ? (openBlock(), createElementBlock(Fragment, { key: 4 }, [createBaseVNode("span", { class: normalizeClass(_ctx.$style.separator) }, "·", 2), createBaseVNode("span", { class: normalizeClass(_ctx.$style.elapsed) }, toDisplayString(formattedElapsed.value), 3)], 64)) : createCommentVNode("", true)
				], 2)) : createCommentVNode("", true)]),
				_: 1
			})]);
		};
...
var InstanceAiStatusBar_vue_vue_type_style_index_0_lang_module_default = {
	bar: "_bar_g3m47_125",
	muted: "_muted_g3m47_135",
	label: "_label_g3m47_138",
	glyph: "_glyph_g3m47_143",
	dot: "_dot_g3m47_148",
	pulse: "_pulse_g3m47_1",
	separator: "_separator_g3m47_170",
	detail: "_detail_g3m47_174",
	elapsed: "_elapsed_g3m47_178"
};
...
var DomainAccessApproval_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		...
		return (_ctx, _cache) => {
			return !resolved.value ? (openBlock(), createElementBlock("div", _hoisted_1$2, [createBaseVNode("div", { class: normalizeClass(_ctx.$style.body) }, [createVNode(unref(N8nText_default), {
				tag: "div",
				size: "medium",
				bold: ""
			}, {
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("div", { class: normalizeClass(_ctx.$style.root) }, [createBaseVNode("div", { class: normalizeClass(_ctx.$style.body) }, [createVNode(unref(N8nText_default), {
				...
				default: withCtx(() => [
					...
					denyPrimary.value ? (openBlock(), createBlock(unref(N8nButton_default), {
						key: 0,
						variant: "outline",
						size: "medium",
...
function isParamValueSet(val) {
	...
	if (isResourceLocatorValue(val)) return val.value !== "" && val.value !== null && val.value !== void 0 && !isPlaceholderString(val.value);
	return true;
}
...
*/
function shouldUseCredentialIcon(card) {
...
function useCredentialGroupSelection(cards, testCredentialInBackground, projectId) {
	...
	function findCardForGroup(credentialType, groupKey) {
		return cards.value.find((c) => c.credentialType === credentialType && c.nodes[0] && credGroupKey(c.nodes[0]) === groupKey);
	}
	function shouldShowAuthOptions(card) {
		const setupNode = card?.nodes[0]?.node;
		if (!setupNode) return false;
		const mainAuthField = getMainAuthField(nodeTypesStore.getNodeType(setupNode.type, setupNode.typeVersion));
		return mainAuthField !== null && Array.isArray(mainAuthField.options) && mainAuthField.options.length > 0;
	}
	function openNewCredentialForSection(credentialType, groupKey) {
		...
		uiStore.openNewCredential(credentialType, showAuthOptions, false, projectId, void 0, nodeName);
	}
	return {
		credGroupSelections,
...
function useSetupCards(setupRequests, getCardCredentialId, isCredentialTypeTestable) {
	...
	*/
	function hasRenderableParamIssue(req) {
		...
		const tracked = trackedParamNames.value.get(req.node.name) ?? new Set(Object.keys(req.parameterIssues ?? {}));
		...
		for (const prop of nodeType.properties) {
			...
			if (!displayParameter(node.parameters, prop, node, nodeType)) continue;
			return true;
		}
		return false;
	}
	...
	function isCardComplete(card) {
		...
		if (cardHasParamWork(card)) for (const req of card.nodes) {
			...
			if (storeNode) {
				...
				if (tracked) {
					for (const paramName of tracked) if (hasPlaceholderDeep(storeNode.parameters[paramName])) return false;
				}
			}
		}
...
function isOriginalValuePlaceholder(req, paramName) {
...
function useSetupCardParameters(cards, trackedParamNames, cardHasParamWork) {
	...
	function onParameterValueChanged(card, parameterData) {
		...
		workflowDocumentStore.value.setNodeParameters({
			name: nodeName,
			value: { [paramName]: parameterData.value }
		}, true);
	}
...
var InstanceAiWorkflowSetup_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		...
		const { paramValues: _paramValues, getCardSimpleParameters, onParameterValueChanged, buildNodeParameters } = useSetupCardParameters(cards, trackedParamNames, cardHasParamWork);
		...
		const { isSubmitted, isDeferred, isPartial, isApplying, applyError, handleApply, handleContinue, handleLater, handleTestTrigger, onCredentialSelected } = useSetupActions({
		...
		onUnmounted(() => {
			...
			stopDeleteListener();
			stopCreateListener();
			if (previousWorkflow) useWorkflowDocumentStore(createWorkflowDocumentId(previousWorkflow.id)).hydrate(previousWorkflow);
		});
		onMounted(async () => {
			...
			try {
				...
				for (const node of workflowData.nodes ?? []) {
					...
					node.parameters = getNodeParameters(nodeType.properties, node.parameters, true, false, node, nodeType) ?? {};
				}
				previousWorkflow = { ...workflowsStore.workflow };
				useWorkflowDocumentStore(createWorkflowDocumentId(workflowData.id)).hydrate(workflowData);
			} catch (error) {
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("div", null, [!isStoreReady.value ? (openBlock(), createElementBlock("div", {
				key: 0,
				class: normalizeClass(_ctx.$style.submitted)
			}, [createVNode(unref(N8nIcon_default), {
				icon: "spinner",
			...
			}, null, 8, ["class"]), createBaseVNode("span", null, toDisplayString(unref(i18n).baseText("instanceAi.workflowSetup.loading")), 1)], 2)) : !unref(isSubmitted) && !unref(isApplying) ? (openBlock(), createElementBlock(Fragment, { key: 1 }, [unref(allPreResolved) && !showFullWizard.value ? (openBlock(), createElementBlock("div", {
				key: 0,
				...
				createBaseVNode("div", { class: normalizeClass(_ctx.$style.confirmSummary) }, [createVNode(unref(N8nText_default), {
					...
					}, [unref(shouldUseCredentialIcon)(card) ? (openBlock(), createBlock(CredentialIcon_default, {
						key: 0,
						"credential-type-name": card.credentialType,
						size: 14
					}, null, 8, ["credential-type-name"])) : (openBlock(), createBlock(NodeIcon_default, {
						key: 1,
						"node-type": getCardNodeType(card),
						size: 14
					}, null, 8, ["node-type"])), createVNode(unref(N8nText_default), { size: "small" }, {
				...
				createBaseVNode("header", { class: normalizeClass(_ctx.$style.header) }, [
					unref(shouldUseCredentialIcon)(currentCard.value) ? (openBlock(), createBlock(CredentialIcon_default, {
						key: 0,
						"credential-type-name": currentCard.value.credentialType,
						size: 16
					}, null, 8, ["credential-type-name"])) : (openBlock(), createBlock(NodeIcon_default, {
						key: 1,
						"node-type": getCardNodeType(currentCard.value),
						size: 16
					}, null, 8, ["node-type"])),
					createVNode(unref(N8nText_default), {
						class: normalizeClass(_ctx.$style.title),
					...
					unref(getCredTestIcon)(currentCard.value) === "spinner" ? (openBlock(), createBlock(unref(N8nIcon_default), {
						...
						size: "small",
						class: normalizeClass(_ctx.$style.loading)
					}, null, 8, ["class"])) : unref(getCredTestIcon)(currentCard.value) === "check" && !unref(cardHasParamWork)(currentCard.value) ? (openBlock(), createBlock(unref(N8nIcon_default), {
						key: 3,
				...
				}, null, 8, ["label"]))], 2)) : createCommentVNode("", true), unref(cardHasParamWork)(currentCard.value) && unref(getCardSimpleParameters)(currentCard.value).length > 0 ? (openBlock(), createBlock(ParameterInputList_default, {
					key: 1,
				...
				createVNode(ConfirmationFooter_default, { layout: "row-between" }, {
					default: withCtx(() => [createBaseVNode("div", { class: normalizeClass(_ctx.$style.footerNav) }, [
						...
						currentCard.value.isTestable && currentCard.value.isTrigger && currentCard.value.isFirstTrigger ? (openBlock(), createBlock(unref(N8nButton_default), {
							...
							onClick: _cache[4] || (_cache[4] = ($event) => unref(handleTestTrigger)(currentCard.value.nodes.find((n) => n.isTrigger).node.name))
						}, null, 8, [
							"class",
							"label",
							"disabled"
				...
				currentDisplayCard.value.group.parentCard ? (openBlock(), createBlock(unref(ExpressionContextProvider), {
					...
					default: withCtx(() => [createBaseVNode("div", { class: normalizeClass(_ctx.$style.content) }, [currentDisplayCard.value.group.parentCard.credentialType && isStoreReady.value && unref(isFirstCardInCredGroup)(currentDisplayCard.value.group.parentCard) ? (openBlock(), createElementBlock("div", {
						...
						standalone: "",
						"hide-issues": "",
						onCredentialSelected: _cache[5] || (_cache[5] = ($event) => unref(onCredentialSelected)(currentDisplayCard.value.group.parentCard, $event))
					}, null, 8, [
						"node",
						"override-cred-type",
						"project-id"
						...
						key: 1,
						label: unref(i18n).baseText("instanceAi.credential.setupButton"),
						onClick: _cache[6] || (_cache[6] = ($event) => unref(openNewCredentialForSection)(currentDisplayCard.value.group.parentCard.credentialType, currentDisplayCard.value.group.parentCard.nodes[0] ? unref(credGroupKey)(currentDisplayCard.value.group.parentCard.nodes[0]) : currentDisplayCard.value.group.parentCard.credentialType))
						...
						onValueChanged: _cache[7] || (_cache[7] = ($event) => unref(onParameterValueChanged)(currentDisplayCard.value.group.parentCard, $event))
					}, null, 8, [
						"parameters",
						"node-values",
						"node"
				...
				createVNode(ConfirmationFooter_default, { layout: "row-between" }, {
					default: withCtx(() => [createBaseVNode("div", { class: normalizeClass(_ctx.$style.footerNav) }, [
						...
						unref(getGroupPrimaryTriggerCard)(currentDisplayCard.value.group)?.isTestable && unref(getGroupPrimaryTriggerCard)(currentDisplayCard.value.group)?.isTrigger ? (openBlock(), createBlock(unref(N8nButton_default), {
							...
							"data-test-id": "instance-ai-workflow-setup-test-trigger",
							onClick: _cache[8] || (_cache[8] = ($event) => unref(handleTestTrigger)(unref(getGroupPrimaryTriggerCard)(currentDisplayCard.value.group).nodes.find((n) => n.isTrigger).node.name))
						}, null, 8, [
							"class",
							"label",
							"disabled"
...
var InstanceAiWorkflowPreview_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props, { expose: __expose, emit: __emit }) {
		...
		async function pollExecutionUntilDone(executionId) {
			if (executionId !== props.executionId) return;
			if (instanceAiStore.isStreaming) postStreamAttempts = 0;
			else {
				postStreamAttempts++;
			...
			try {
				...
				if (execution?.finished === true) {
					previewRef.value?.reloadExecution?.();
					return;
				}
			} catch {}
			pollTimer = setTimeout(() => {
				pollExecutionUntilDone(executionId);
			}, POLL_INTERVAL_MS);
		}
		watch(() => props.executionId, (execId) => {
			stopPolling();
			if (execId) pollTimer = setTimeout(() => {
				pollExecutionUntilDone(execId);
			}, POLL_INTERVAL_MS);
		});
...
var InstanceAiView_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		...
		onMounted(() => {
			store.loadThreads().then((loaded) => {
				if (!loaded || !props.threadId) return;
				if (!store.threads.some((t) => t.id === props.threadId)) router.replace({ name: INSTANCE_AI_VIEW });
				else if (props.threadId !== store.currentThreadId) store.switchThread(props.threadId);
			});
			store.fetchCredits();
		...
		watch(() => settingsStore.isLocalGatewayDisabled, (disabled) => {
			if (disabled) settingsStore.stopGatewayPushListener();
			else {
				settingsStore.startGatewayPushListener();
				settingsStore.fetchGatewayStatus();
			}
		...
		watch(() => props.threadId, (threadId) => {
			...
			if (store.threads.some((t) => t.id === threadId)) store.switchThread(threadId);
		}, { immediate: true });
		...
		function handleSubmit(message, attachments) {
			...
			store.sendMessage(message, attachments, rootStore.pushRef).then(() => {
				if (shouldUpdateRoute && store.threads.some((t) => t.id === threadId)) router.replace({
					name: INSTANCE_AI_THREAD_VIEW,
					params: { threadId }
				});
			});
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("div", {
				...
				!unref(sidebarCollapsed) ? (openBlock(), createBlock(unref(N8nResizeWrapper_default), {
					key: 0,
				...
				createBaseVNode("div", { class: normalizeClass(_ctx.$style.chatArea) }, [
					createBaseVNode("div", { class: normalizeClass(_ctx.$style.header) }, [
						createVNode(unref(N8nButton_default), {
							icon: unref(sidebarCollapsed) ? "list" : "panel-left",
							variant: "ghost",
							size: "medium",
							"data-test-id": "instance-ai-sidebar-toggle",
							"icon-only": !unref(sidebarCollapsed),
							onClick: toggleSidebarCollapse
						}, {
							default: withCtx(() => [unref(sidebarCollapsed) ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [createTextVNode(toDisplayString(unref(i18n).baseText("instanceAi.sidebar.threads")), 1)], 64)) : createCommentVNode("", true)]),
							_: 1
						}, 8, ["icon", "icon-only"]),
						createVNode(unref(N8nHeading_default), {
							tag: "h2",
				...
				withDirectives(createVNode(unref(N8nResizeWrapper_default), {
					...
					default: withCtx(() => [createVNode(unref(TabsRoot_default), {
						...
						"onUpdate:modelValue": _cache[10] || (_cache[10] = ($event) => unref(preview).activeTabId.value = $event),
						...
						default: withCtx(() => [createVNode(InstanceAiPreviewTabBar_default, {
							...
							onClose: _cache[9] || (_cache[9] = ($event) => unref(preview).closePreview())
						}, null, 8, ["tabs", "active-tab-id"]), (openBlock(true), createElementBlock(Fragment, null, renderList(unref(preview).allArtifactTabs.value, (tab) => {
							return openBlock(), createBlock(unref(TabsContent_default), {
								key: tab.id,
								value: tab.id,
								class: normalizeClass(_ctx.$style.previewContent)
							}, {
								default: withCtx(() => [unref(preview).activeWorkflowId.value ? (openBlock(), createBlock(InstanceAiWorkflowPreview_default, {
									key: 0,
									ref_for: true,
									ref: "workflowPreview",
...
var InstanceAiView_vue_vue_type_style_index_0_lang_module_default = {
	container: "_container_dmiw8_125",
	sidebar: "_sidebar_dmiw8_135",
	readOnlyBanner: "_readOnlyBanner_dmiw8_144",
	chatArea: "_chatArea_dmiw8_148",
	canvasArea: "_canvasArea_dmiw8_158",
	header: "_header_dmiw8_184",
	headerTitle: "_headerTitle_dmiw8_193",
	headerActions: "_headerActions_dmiw8_201",
	settingsButton: "_settingsButton_dmiw8_208",
	activeButton: "_activeButton_dmiw8_212",
	reconnecting: "_reconnecting_dmiw8_216",
	contentArea: "_contentArea_dmiw8_220",
	chatContent: "_chatContent_dmiw8_227",
	emptyLayout: "_emptyLayout_dmiw8_235",
	centeredInput: "_centeredInput_dmiw8_245",
	scrollArea: "_scrollArea_dmiw8_250",
	messageList: "_messageList_dmiw8_255",
	builderAgents: "_builderAgents_dmiw8_264",
	scrollButtonContainer: "_scrollButtonContainer_dmiw8_271",
	scrollToBottomButton: "_scrollToBottomButton_dmiw8_281",
	inputContainer: "_inputContainer_dmiw8_292",
	inputConstraint: "_inputConstraint_dmiw8_306",
	previewPanel: "_previewPanel_dmiw8_311",
	previewContent: "_previewContent_dmiw8_317"
};
