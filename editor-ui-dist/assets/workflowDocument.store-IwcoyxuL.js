const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/workers-Bn7rLace.js","assets/comlink-h1hawfcO.js"])))=>i.map(i=>d[i]);
...
import { i as i18n, n as addHeaders, r as addNodeTranslation, s as useI18n } from "./src-C9iGirh9.js";
import { I as isBinary, gt as useRoute, qi as truncate } from "./src-CSWS3PCK.js";
...
import { $s as isTrimmedNodeExecutionData, A as ALLOWED_HTML_TAGS, As as require__baseFindIndex, At as AI_TRANSFORM_NODE_TYPE, Bu as WorkflowDocumentStoreKey, Cc as displayParameterPath, Cl as UnexpectedError, Dc as getNodeParameters, Ds as require__baseUniq, E as TEMPLATES_NODES_FILTER, Ec as getNodeOutputs, Es as splitExpression, Fn as NON_ACTIVATABLE_TRIGGER_NODE_TYPES, I as CUSTOM_API_CALL_KEY, Ic as isHitlToolType, Jl as WAIT_INDEFINITELY, Kl as SEND_AND_WAIT_OPERATION, L as DATA_TYPE_ICON_MAP, N as IN_PROGRESS_EXECUTION_ID, Nl as CHAT_TRIGGER_NODE_TYPE, Nn as NODE_POSITION_CONFLICT_ALLOWLIST, P as PLACEHOLDER_FILLED_AT_EXECUTION_TIME, Pu as CanvasRenderDataKey, Ql as require_isEqual, Qn as SCHEDULE_TRIGGER_NODE_TYPE, Qo as require_pick, Sc as displayParameter, Sn as LIST_LIKE_NODE_OPERATIONS, Tc as getNodeInputs, Td as EnterpriseEditionFeature, U as AI_CATEGORY_AGENTS, Ut as CREDENTIAL_ONLY_NODE_PREFIX, Vu as WorkflowIdKey, Wc as nodeIssuesToString, Wl as MANUAL_TRIGGER_NODE_TYPE, Xl as v4, Y as AI_CATEGORY_MCP_NODES, Yc as isFilterValue, Z as AI_CATEGORY_OTHER_TOOLS, _c as mapConnectionsByDestination, _r as WEBHOOK_NODE_TYPE, al as nodeConnectionTypes, cl as isExpression, cn as FORM_TRIGGER_NODE_TYPE, dc as createRunExecutionData, dl as deepCopy, dt as CORE_NODES_CATEGORY, en as ERROR_TRIGGER_NODE_TYPE, es as require__baseFlatten, eu as require_keys, fn as HTTP_REQUEST_NODE_TYPE, fu as getResourcePermissions, gc as resolveVariables, gs as require__baseIteratee, ht as HUMAN_IN_THE_LOOP_CATEGORY, i as DUPLICATE_POSTFFIX, il as NodeConnectionTypes, is as isAssignmentCollectionValue, it as AI_CODE_TOOL_LANGCHAIN_NODE_TYPE, jn as MODULE_ENABLED_NODES, k as ALLOWED_HTML_ATTRIBUTES, kc as getNodeWebhookUrl, kt as AI_MCP_TOOL_NODE_TYPE, li as MAIN_HEADER_TABS, ls as Workflow, mt as HITL_SUBCATEGORY, nl as isResourceMapperValue$1, ps as require__createCompounder, q as AI_CATEGORY_HUMAN_IN_THE_LOOP, r as DEFAULT_SETTINGS, rt as AI_CATEGORY_VECTOR_STORES, sl as traverseNodeParameters, tl as isResourceLocatorValue, uc as createEmptyRunExecutionData, ui as VIEWS, ut as BETA_NODES, vl as sleep$1, vr as WIKIPEDIA_TOOL_NODE_TYPE, wc as getConnectionTypes, xc as checkConditions, xl as ExpressionError, xr as WORKFLOW_TRIGGER_NODE_TYPE, yc as getChildNodes, yt as RECOMMENDED_NODES, z as MAPPING_PARAMS } from "./constants-ZSgQBvyG.js";
...
import { E as getActivePinia, T as defineStore, a as ResponseError, c as makeRestApiRequest, d as request, f as streamRequest, m as axios, s as getFullApiResponse, t as useRootStore } from "./useRootStore-BH7aCkdu.js";
import { Bn as STORES, C as updateCurrentUserSettings, Ft as getProjectSecretProviderConnectionsByProjectId, _t as getResourceMapperFields, ct as fetchCommunityNodeAttributes, dt as getNodeParameterActionResult, ft as getNodeParameterOptions, gt as getResourceLocatorResults, ht as getNodesInformation, i as getWorkflowVersion, lt as fetchCommunityNodeTypes, mt as getNodeTypes$1, pt as getNodeTranslationHeaders, s as findWebhook, t as useSettingsStore, ut as getLocalResourceMapperFields } from "./settings.store-fzkHYqQC.js";
import { _ as useStorage, f as useUIStore, n as hasPermission, t as useUsersStore, u as hasRole } from "./users.store-DlXqF6lz.js";
import { r as require_toNumber } from "./useDebounce-DGsXgzXs.js";
import { A as isObject$1, E as stringSizeInBytes, S as isPresent, T as shorten, a as getNewWorkflow, i as getLastSuccessfulExecution, k as getObjectSizeInKB, l as getWorkflows, n as useFavoritesStore, r as getExecutionData, t as useWorkflowsListStore, w as omit, x as isJsonKeyObject, y as isEmpty } from "./workflowsList.store-BEFzaCFi.js";
import { t as useDocumentTitle } from "./useDocumentTitle-CSw5LcXz.js";
import { t as require__baseOrderBy } from "./_baseOrderBy-B0KlWEmS.js";
	...
	const loadNodesInformationFromLocalDb = async (nodeInfos) => {
		try {
			const { getNodeType } = await __vitePreload(async () => {
				const { getNodeType } = await import("./workers-Bn7rLace.js");
				return { getNodeType };
			}, __vite__mapDeps([0,1]));
			const found = [];
			const missing = [];
	...
	const loadNodeTypesFromLocalDb = async () => {
		try {
			const { loadNodeTypes, getAllNodeTypes } = await __vitePreload(async () => {
				const { loadNodeTypes, getAllNodeTypes } = await import("./workers-Bn7rLace.js");
				return {
					loadNodeTypes,
					getAllNodeTypes
				};
...
//#endregion
export { capitalCase as $, openSafeUrl as $i, getNodeCredentialForSelectedAuthType as $n, _sfc_main as $r, findTriggerNodeToAutoSelect as $t, getRootSearchCallouts as A, isValidCredentialResponse as Ai, deleteDataTableRowsApi as An, shouldIgnoreCanvasShortcut as Ar, resolveParameter as At, shouldShowCommunityNodeDetails as B, CanvasNodeRenderType as Bi, updateDataTableRowsApi as Bn, getBounds as Br, sortNodesByExecutionOrder as Bt, listEvaluationConfigs as C, isProjectRole as Ci, ProjectTypes as Cn, injectCanvasRenderData as Cr, getResolvableState as Ct, flattenCreateElements as D, isSharedResource as Di, createDataTableApi as Dn, mapLegacyConnectionsToCanvasConnections as Dr, shouldConvertToExpression as Dt, finalizeItems as E, isRouteLocationRaw as Ei, addDataTableColumnApi as En, mapLegacyConnectionToCanvasConnection as Er, removeExpressionPrefix as Et, mapToolSubcategoryIcon as F, CANVAS_NODE_GROUP_HANDLE_LEFT as Fi, importCsvToDataTableApi as Fn, DEFAULT_VIEWPORT_BOUNDARIES as Fr, useAnnotationTagsStore as Ft, getRagStarterWorkflowJson as G, getPinDataSize as Gi, getActivatableTriggerNodes as Gn, getNodeViewTab as Gr, disposeWorkflowExecutionStateStore as Gt, subcategorizeItems as H, isCanvasGroupNode as Hi, executionDataToJson as Hn, getMidCanvasPosition as Hr, injectNDVStore as Ht, nodeTypesToCreateElements as I, CANVAS_NODE_GROUP_HANDLE_RIGHT as Ii, insertDataTableRowApi as In, PUSH_NODES_OFFSET as Ir, useTagsStore as It, isTutorialTemplateId as J, capitalizeFirstLetter as Ji, getAppNameFromNodeName as Jn, updateViewportToContainNodes as Jr, buildExecutionResponseFromSchema as Jt, getSampleWorkflowByTemplateId as K, pinDataToExecutionData as Ki, getAllNodeCredentialForAuthType as Kn, getNodesGroupSize as Kr, injectWorkflowExecutionStateStore as Kt, prepareCommunityNodeDetailsViewStack as L, CANVAS_NODE_GROUP_TYPE as Li, moveDataTableColumnApi as Ln, calculateNodeSize as Lr, ensureNodePosition as Lt, groupItemsInSections as M, isVariableResource as Mi, fetchDataTableGlobalLimitInBytes as Mn, CONFIGURABLE_NODE_SIZE as Mr, useWorkflowHelpers as Mt, isAINode as N, isVueFlowConnection as Ni, fetchDataTablesApi as Nn, CONFIGURATION_NODE_SIZE as Nr, useRouteWorkflowId as Nt, getAiTemplatesCallout as O, isString as Oi, deleteDataTableApi as On, parseCanvasConnectionHandleString as Or, stringifyExpressionResult as Ot, isNodePreviewKey as P, isWorkflowListItem as Pi, getDataTableRowsApi as Pn, DEFAULT_NODE_SIZE as Pr, useWorkflowId as Pt, require_sortBy as Q, isOutsideSelected as Qi, getNodeAuthOptions as Qn, Position as Qr, executionRetryMessage as Qt, removePreviewToken as R, CanvasConnectionMode as Ri, renameDataTableColumnApi as Rn, doRectsOverlap as Rr, removeWorkflowExecutionData as Rt, deleteEvaluationConfig as S, isFullExecutionResponse as Si, useSourceControlStore as Sn, getMaxNodePortsLabelSize as Sr, getExpressionErrorMessage as St, filterAndSearchNodes as T, isResourceSortableByDate as Ti, setWorkflowSharedWith as Tn, mapCanvasConnectionToLegacyConnection as Tr, isTestableExpression as Tt, transformNodeType as U, parseCanvasGroupNodeId as Ui, fieldCannotBeDeleted as Un, getMousePosition as Ur, injectNDVStoreIfProvided as Ut, sortNodeCreateElements as V, createCanvasGroupNodeId as Vi, uploadCsvFileApi as Vn, getGenericHints as Vr, disposeNDVStore as Vt, SampleTemplates as W, structuralComputed as Wi, filterTemplateNodes as Wn, getNewNodePosition as Wr, useNDVStore as Wt, isTemplatesWorkflow as X, getScrollbarWidth as Xi, getMainAuthField as Xn, NodeId as Xr, displayForm as Xt, isFullTemplatesCollection as Y, getBannerRowHeight as Yi, getAuthTypeForNodeCredential as Yn, MarkerType as Yr, clearPopupWindowState as Yt, useAiGatewayStore as Z, isEventTargetContainedBy as Zi, getNodeAuthFields as Zn, PanelPosition as Zr, executionFilterToQueryFilter as Zt, useNodeTypesStore as _, isComponentPublicInstance as _i, getTruncatedProjectName as _n, checkOverlap as _r, escapeMappingString as _t, injectWorkflowDocumentStore as a, getBezierPath as ai, unflattenExecutionData as an, hasProxyAuth as ar, useCredentialsStore as at, useEvaluationStore as b, isDateObject as bi, useRemoteProjectSearch as bn, createCanvasConnectionId as br, propertyNameFromExpression as bt, TOOL_NODE_TYPES_NEED_INPUT as c, getRectOfNodes as ci, useWorkflowsStore as cn, isRequiredCredential as cr, clearBuilderSession as ct, doesNodeHaveCredentialsToFill as d, useGetPointerPosition as di, hasExecutionDataStore as dn, parseResourceMapperFieldName as dr, getBuilderCredits as dt, sanitizeHtml as ea, _sfc_main$1 as ei, getDefaultExecutionFilters as en, getNodeSubtitle as er, sublimeSearch as et, getNodeTypeDisplayableCredentials as f, useVueFlow as fi, useExecutionDataStore as fn, updateNodeAuthType as fr, replaceCode as ft, require_uniq as g, isBinaryLike as gi, ResourceType as gn, applyOffset as gr, useFlattenSchema as gt, serializeNode as h, isBaseTextKey as hi, useEnvironmentsStore as hn, isCredentialOnlyNodeType as hr, useDataSchema as ht, disposeWorkflowDocumentStore as i, clamp as ii, openFormPopupWindow as in, hasOnlyListMode as ir, listenForCredentialChanges as it, getSendAndWaitNodes as j, isValidNodeConnectionType as ji, downloadDataTableCsvApi as jn, injectStrict as jr, resolveRequiredParameters as jt, getHumanInTheLoopActions as k, isTriggerPanelObject as ki, deleteDataTableColumnApi as kn, resolveCanonicalConnection as kr, unwrapExpression as kt, assignNodeId as l, getSmoothStepPath as li, createExecutionDataId as ln, isResourceMapperFieldListStale as lr, generateCodeForPrompt as lt, needsAgentInput as m, checkExhaustive as mi, LOCAL_STORAGE_NDV_PANEL_WIDTH as mn, require_toInteger as mr, useAIAssistantHelpers as mt, createExecutionPreviewDocumentVersion as n, _sfc_main$d as ni, getExecutionErrorToastConfiguration as nn, getTriggerNodeServiceName as nr, require_upperFirst as nt, provideWorkflowDocumentStore as o, getBoundsofRects as oi, waitingNodeTooltip as on, isAuthRelatedParameter as or, chatWithAssistant as ot, getParameterDisplayableOptions as p, wheelDelta as pi, getPairedItemId as pn, getAllCredentials as pr, truncateBuilderMessages as pt, getTutorialTemplates as q, CHANGE_ACTION as qi, getAppNameFromCredType as qn, getNodesWithNormalizedPosition as qr, useWorkflowExecutionStateStore as qt, createWorkflowDocumentId as r, _sfc_main$f as ri, hasTrimmedRunData as rn, hasExpressionMapping as rr, require__baseSlice as rt, useWorkflowDocumentStore as s, getConnectedEdges as si, parse as sn, isMatchingField as sr, chatWithBuilder as st, createExecutionPreviewDocumentId as t, sanitizeIfString as ta, _sfc_main$3 as ti, getExecutionErrorMessage as tn, getThemedValue as tr, require_startCase as tt, doesNodeHaveAllCredentialsFilled as u, isMacOs as ui, disposeExecutionDataStore as un, isValueExpression as ur, getAiSessions as ut, isDataWorkerEnabled as v, isCredentialModalState as vi, splitName as vn, computeNodeDisplaySize as vr, getMappedExpression as vt, updateEvaluationConfig as w, isResourceMapperValue as wi, moveFolderToProject as wn, insertSpacersBetweenEndpoints as wr, isPairedItemIntermediateNodesError as wt, createEvaluationConfig as x, isDebouncedFunction as xi, useProjectsStore as xn, createEmptyCanvasRenderData as xr, completeExpressionSyntax as xt, useActionsGenerator as y, isCredentialsResource as yi, useAvailableProjectSearch as yn, createCanvasConnectionHandleString as yr, getMappedResult as yt, searchNodes as z, CanvasNodeDirtiness as zi, updateDataTableApi as zn, generateOffsets as zr, sanitizeConnections as zt };
