import { $ as openBlock, A as createTextVNode, C as createBaseVNode, Cn as toDisplayString, E as createElementBlock, Gt as unref, It as ref, N as defineComponent, S as computed, T as createCommentVNode, W as nextTick, X as onMounted, _ as Fragment, bn as normalizeStyle, bt as withCtx, gt as watch, h as withModifiers, j as createVNode, n as Transition, q as onBeforeUnmount, rt as renderList, tt as provide, vn as normalizeClass, w as createBlock, zt as shallowRef } from "./vue.runtime.esm-bundler-Bs4WIMNP.js";
import { x as useI18n } from "./_MapCache-B3VhjNx3.js";
import { Ai as N8nText_default, Fi as N8nIconButton_default, Ii as N8nButton_default, Li as N8nIcon_default, Mr as truncate, Pi as Input_default, Vt as N8nCard_default, Wt as N8nCallout_default, X as N8nPopover_default, bt as N8nHoverCard_default, jr as N8nTooltip_default, q as N8nRecycleScroller_default } from "./src-TtOAzrsZ.js";
import { t as _plugin_vue_export_helper_default } from "./_plugin-vue_export-helper-Da88TEg1.js";
import { h as useEventListener, s as useActiveElement } from "./dist-CmlFwYoT.js";
import { _ as useRouter } from "./htmlUtils-LDunChtE.js";
import { t as useToast } from "./useToast-9MJyC6NG.js";
import { C as disposeWorkflowDocumentStore, E as useWorkflowDocumentStore, Gt as useWorkflowHelpers, L as useNodeTypesStore, S as createWorkflowDocumentId, _ as disposeWorkflowExecutionStateStore, br as shouldIgnoreCanvasShortcut, di as hasExecutionDataStore, en as disposeNDVStore, fi as useExecutionDataStore, li as createExecutionDataId, rn as useNDVStore, t as useWorkflowsStore, ui as disposeExecutionDataStore, y as useWorkflowExecutionStateStore } from "./workflows.store-YK4BoC2f.js";
import { Ba as stringType, Pa as enumType, Ra as objectType, V as richMessageSchema, Vt as Workflow, ot as SUB_AGENT_TASK_DIFFICULTIES } from "./src-DVvN4F-B.js";
import { Da as WorkflowIdKey, Ea as WorkflowDocumentStoreKey } from "./constants-CQOOvzhs.js";
import { t as VIEWS } from "./views-4JHVC4Nc.js";
import { t as useExecutionsStore } from "./executions.store-Dfaao2P_.js";
import { i as NodeErrorView_default, t as RunData_default } from "./RunData-2YKI3I0m.js";
import { w as ChatSymbol } from "./useCanvasOperations-eLvd2_n7.js";
import { t as VueMarkdown } from "./VueMarkdown-C2CjH3q7.js";
import { t as convertToDisplayDate } from "./dateFormatter-CFY0wz7i.js";
import { r as useProjectAgentsList } from "./useProjectAgentsList-Bm1jB1Vw.js";
import { n as getToolNameTranslationKey, r as resolveToolNameForDisplay, t as formatToolNameForDisplay } from "./toolDisplayName-DyKoXXXp.js";
import { d as flattenLogEntries, g as getSubtreeTotalConsumedTokens, o as createLogTree, t as LogsOverviewRow_default, w as isNodeLog } from "./LogsOverviewRow-CpqgtdAD.js";
import { n as useAgentSessionsStore } from "./thread-title-7kV31CAe.js";
	...
	setup(__props, { emit: __emit }) {
		...
		*/
		...
		return (_ctx, _cache) => {
			...
			}, null, 10, _hoisted_5)], 2)) : __props.item.kind === "user" || __props.item.kind === "agent" ? (openBlock(), createBlock(unref(VueMarkdown), {
				key: 4,
...
//#endregion
export { getDelegateDifficultySummary as a, parseDelegateOutput as c, cardChoiceLabel as d, isAwaitingCard as f, formatDelegateError as i, resolveSubAgentIdForDisplay as l, parseN8nChatActionInput as m, useSubAgentNames as n, isDelegateSubAgentTool as o, n8nChatResumeValueSchema as p, SUB_AGENT_DIFFICULTY_I18N_KEY as r, isFailedDelegateOutput as s, AgentSessionTimelinePanel_default as t, resolveSubAgentName as u };
