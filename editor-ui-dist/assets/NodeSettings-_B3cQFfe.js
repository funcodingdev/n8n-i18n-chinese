...
import { Da as N8nIcon_default, Dt as N8nBlockUi_default, Ea as N8nButton_default, Jt as ElCollapseTransition, Li as N8nIconButton_default, Mi as N8nTooltip_default, N as N8nRadioButtons_default, R as N8nNotice_default, Ta as N8nText_default, lt as useRoute, m as N8nInlineTextEdit_default, w as N8nTabs_default, wa as N8nCallout_default } from "./src-D7XhL4SE.js";
import { t as require_get } from "./get-Den8eczo.js";
import { t as _plugin_vue_export_helper_default } from "./_plugin-vue_export-helper-Da88TEg1.js";
import "./_MapCache-Cl68hVFF.js";
import { f as collectParametersByTab, g as getNodeSettingsInitialValues, m as createCommonNodeSettings, p as collectSettings, s as useNodeSettingsParameters, t as ParameterInputList_default, y as nameIsParameter } from "./ParameterInputList-CkO9ThSB.js";
import { n as ElRow, t as ElCol } from "./col-BWcZm8Hk.js";
import { F as removePreviewToken, Jr as ProjectTypes, Lt as useWorkflowsListStore, Qt as useNodeHelpers, Ut as injectWorkflowDocumentStore, b as useNodeTypesStore, kt as useWorkflowHelpers, nt as useCredentialsStore, tn as useHistoryStore, un as RenameNodeCommand, x as useActionsGenerator, zt as injectNDVStore } from "./workflows.store-DQQfIwKi.js";
import { t as useToast } from "./useToast-DMjrW7lG.js";
import { Cn as MCP_TRIGGER_NODE_TYPE, Gs as deepCopy, Hn as PRODUCTION_ONLY_TRIGGER_NODE_TYPES, Ks as isCommunityPackageName, N as CUSTOM_API_CALL_KEY, Pt as CHAT_TRIGGER_NODE_TYPE, Ut as DATA_TABLE_NODES, an as FORM_TRIGGER_NODE_TYPE, c as CUSTOM_NODES_DOCS_URL, fs as getNodeInputs, i as BASE_NODE_SURVEY_URL, lc as NodeConnectionTypes, ms as getNodeParameters, o as BUILTIN_NODES_DOCS_URL, oi as VIEWS, v as NPM_PACKAGE_DOCS_BASE_URL, zn as OPEN_URL_PANEL_TRIGGER_NODE_TYPES } from "./constants-Brs44Mbc.js";
import { t as useSettingsStore } from "./settings.store-CrL-o4BC.js";
import { F as noop, M as isClient, N as isIOS, P as isObject, U as tryOnScopeDispose, V as toValue$1, j as directiveHooks, n as onClickOutside$1, p as useElementSize$1, t as computedAsync, y as useResizeObserver$1, z as toRef } from "./core-CMxey_qZ.js";
import { S as COMMUNITY_NODES_INSTALLATION_DOCS_URL, T as COMMUNITY_PACKAGE_INSTALL_MODAL_KEY, f as useUIStore, p as useTelemetry, t as useUsersStore } from "./users.store-ByD75lsx.js";
...
import { a as TitledList_default, n as useNodeCredentialOptions, t as NodeCredentials_default } from "./NodeCredentials-CJoElZi5.js";
import { n as useNodeIconSource, t as NodeIcon_default } from "./NodeIcon-CH2behsF.js";
...
var NodeSettings_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props, { emit: __emit }) {
		...
		const nodeSettings = computed(() => createCommonNodeSettings(isToolNode.value || isModelNode.value, i18n.baseText.bind(i18n), settingsStore.isOtelEnabled));
...
var NodeSettings_default = /* @__PURE__ */ _plugin_vue_export_helper_default(NodeSettings_vue_vue_type_script_setup_true_lang_default, [["__cssModules", { "$style": NodeSettings_vue_vue_type_style_index_0_lang_module_default }], ["__scopeId", "data-v-a298b8e2"]]);
//#endregion
export { useNodeDocsUrl as n, NodeSettings_default as t };
