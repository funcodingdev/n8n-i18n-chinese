...
import { _t as I18nT, gt as useI18n } from "./_MapCache-CAfqzBzS.js";
import { Hn as N8nButton_default, Vn as N8nText_default, Wn as N8nIcon_default, at as N8nBadge_default, et as N8nActionToggle_default, mt as N8nTooltip_default, tt as N8nLoading_default, ut as N8nLink_default, zn as N8nHeading_default } from "./src-BaIgRfnQ.js";
...
import { Fi as useUIStore, Go as getWorkflowHistory, Ko as getWorkflowVersion, Ro as getNewWorkflow, Wo as useSettingsStore, nr as useUsersStore, o as useWorkflowsStore, r as telemetry } from "./useTelemetry-D9a28yOh.js";
...
import { Do as getResourcePermissions, Io as VIEWS, a as IS_DRAFT_PUBLISH_ENABLED, gs as WORKFLOW_HISTORY_VERSION_UNPUBLISH, hs as WORKFLOW_HISTORY_VERSION_RESTORE, ms as WORKFLOW_HISTORY_PUBLISH_MODAL_KEY } from "./constants-BAGpYMn9.js";
...
import { r as getLastPublishedByUser, t as formatTimestamp } from "./utils-cTcIgo5c.js";
import { t as WorkflowPreview_default } from "./WorkflowPreview-DkLve6Kw.js";
	...
	setup(__props, { emit: __emit }) {
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("li", {
				...
				publishedAt.value ? (openBlock(), createElementBlock("time", {
					key: 1,
					datetime: _ctx.item.updatedAt,
					class: normalizeClass(_ctx.$style.metaItem)
				}, toDisplayString(unref(i18n).baseText("workflowHistory.item.publishedAtLabel")) + " " + toDisplayString(publishedAt.value), 11, _hoisted_2$1)) : createCommentVNode("", true),
				publishedByUserName.value ? (openBlock(), createElementBlock("span", {
					key: 2,
					class: normalizeClass(_ctx.$style.metaItem)
				}, toDisplayString(publishedByUserName.value), 3)) : createCommentVNode("", true)
			])) : (openBlock(), createElementBlock("p", {
				key: 1,
				onClick: onItemClick
			}, [
				createBaseVNode("time", { datetime: _ctx.item.createdAt }, toDisplayString(formattedCreatedAt.value), 9, _hoisted_3),
				createVNode(unref(N8nTooltip_default), {
					placement: "right-end",
					disabled: authors.value.size < 2 && !isAuthorElementTruncated.value
				}, {
				...
				createBaseVNode("data", { value: _ctx.item.versionId }, toDisplayString(idLabel.value), 9, _hoisted_4)
