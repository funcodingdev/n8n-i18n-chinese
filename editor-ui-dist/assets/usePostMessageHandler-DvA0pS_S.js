const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/pushConnection.store-BqLlsi3d.js","assets/pushConnection.store-D7spuuIH.js","assets/vue.runtime.esm-bundler-Bs4WIMNP.js","assets/chunk-CC9Q-vWm.js","assets/constants-BzyjfRY2.js","assets/get-Ult7GPGC.js","assets/_MapCache-Crx6I_bI.js","assets/merge-B4bcFBd8.js","assets/expression-runtime-stub-D02gUA55.js","assets/__vite-browser-external-B_jc8yR2.js","assets/useRootStore-H_HdEClX.js","assets/settings.store-CQqpFn-s.js"])))=>i.map(i=>d[i]);
...
import { Qr as getNodesWithNormalizedPosition, Tn as useProjectsStore, Xt as useWorkflowExecutionStateStore, Zt as buildExecutionResponseFromSchema, ct as useCredentialsStore, fn as useWorkflowsStore, r as createWorkflowDocumentId, s as useWorkflowDocumentStore } from "./workflowDocument.store-CJmrbFRO.js";
		...
		try {
			...
			if (json && json.command === "openWorkflow") try {
				...
				const { usePushConnectionStore } = await __vitePreload(async () => {
					const { usePushConnectionStore } = await import("./pushConnection.store-BqLlsi3d.js");
