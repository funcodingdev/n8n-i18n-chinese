...
import { Ln as useMessage, Pn as useToast, ai as useProjectsStore, fr as useTelemetry, it as useCredentialsStore, js as sanitizeHtml, s as useWorkflowsStore, t as useUsersStore } from "./users.store-Cuk0qvvE.js";
import { vi as createResultError, yi as createResultOk } from "./constants-fJx0oi9Z.js";
...
function useQuickConnect() {
	...
	async function connectToPinecone(quickConnectOption) {
		const { ConnectPopup } = await __vitePreload(async () => {
			const { ConnectPopup } = await import("./dist-DIiWyr-5.js");
			return { ConnectPopup };
		}, []);
		return await new Promise((resolve) => {
