...
import { o as onBeforeRouteLeave } from "./vue-router-D2dKRIiV.js";
import { Ft as LanguageSupport, Hn as N8nSegmentControl_default, Nt as HighlightStyle, Pt as LRLanguage, Xt as syntaxTree, Yt as syntaxHighlighting, _n as keymap, an as EditorView, en as tags, et as history, i as javascriptLanguage, in as Decoration, kn as EditorState, n as parserWithMetaData, nt as historyKeymap, rn as parseMixed, sn as ViewPlugin } from "./expressions-0XjpaZkH.js";
import { bn as useProjectsStore } from "./workflows.store-CQp5NuTc.js";
import { D as ROLE, t as BLOCK_ACCESS_ASSIGNMENT } from "./src-BrbN-vPn.js";
import { s as openSafeUrl } from "./htmlUtils-BGBfSAfh.js";
import { dt as createRoleMappingRule, ft as deleteRoleMappingRule, h as getUsers, ht as updateRoleMappingRule, mt as moveRoleMappingRule, pt as listRoleMappingRules, t as useRootStore } from "./useRootStore-B-A2Ktsc.js";
...
import { r as captureMessage } from "./exports--dBPRWqj.js";
...
import { n as useSSOStore, t as SupportedProtocols } from "./sso.store-Q0PTJtMp.js";
import { n as CustomRolesUpgradeModal_default, t as RoleSelectDropdown_default } from "./RoleSelectDropdown-CM77RSrC.js";
import { a as countGrantedInstancePermissions, i as TOTAL_INSTANCE_PERMISSIONS } from "./instanceRoleScopes-zU6jWx5h.js";
import { t as useUserRoleProvisioningStore } from "./userRoleProvisioning.store-K1xQ_aUS.js";
	...
	setup(__props, { expose: __expose }) {
		...
		const onTest = async () => {
			try {
				...
				if (typeof window !== "undefined") openSafeUrl(url);
			} catch (error) {
				toast.showError(error, "error");
			}
		};
