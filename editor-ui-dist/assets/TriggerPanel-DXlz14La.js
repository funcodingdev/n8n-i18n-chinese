...
import { Di as N8nTooltip_default, J as N8nInfoTip_default, Ji as N8nHeading_default, N as N8nRadioButtons_default, P as N8nPulse_default, Qi as N8nIcon_default, Xi as N8nText_default, Y as N8nInfoAccordion_default, Zi as N8nButton_default, k as N8nSpinner_default, lt as useRouter, tt as N8nLink_default, xt as createEventBus } from "./src-DJ-D-s3W.js";
import { t as _plugin_vue_export_helper_default } from "./_plugin-vue_export-helper-Da88TEg1.js";
import { Bn as require_FileSaver_min, Br as CanvasNodeDirtiness, C as waitingNodeTooltip, Et as injectWorkflowState, Mr as isTriggerPanelObject, Tt as useWorkflowHelpers, aa as injectWorkflowDocumentStore, f as parseAiContent, fr as useTelemetry, gr as useNDVStore, qi as getTriggerNodeServiceName, r as useUIStore, s as useWorkflowsStore, u as formatTokenUsageCount, w as useNodeTypesStore } from "./users.store-Cuk0qvvE.js";
import { Pt as CHAT_TRIGGER_NODE_TYPE, Qo as VIEWS, an as FORM_TRIGGER_NODE_TYPE, dc as MAX_DISPLAY_DATA_SIZE_LOGS_VIEW, eo as NodeConnectionTypes, zs as WORKFLOW_SETTINGS_MODAL_KEY } from "./constants-fJx0oi9Z.js";
import { D as storeToRefs } from "./useRootStore-udEbvQrW.js";
import { t as CopyInput_default } from "./CopyInput-CPoB4qNk.js";
import { a as RedactedDataState_default, i as NodeErrorView_default, o as useExecutionRedaction, r as ViewSubExecution_default, t as RunData_default } from "./RunData-BqGShMz2.js";
import { t as NDVEmptyState_default } from "./NDVEmptyState-rEhPpRSr.js";
import { n as useNodeType, t as usePinnedData } from "./usePinnedData-CBzO8giC.js";
import { f as require_capitalize } from "./canvas.eventBus-DUGzZAkM.js";
...
import { r as useNodeDirtiness } from "./useRunWorkflow-jL9CrG_z.js";
import { t as useInjectWorkflowId } from "./useInjectWorkflowId-BS9o5Ug7.js";
import { n as convertToDisplayDateComponents } from "./dateFormatter-BDa68qTU.js";
import { n as useLogsExecutionData, o as ConsumedTokensDetails_default, r as LogsOverviewRows_default, s as findLogEntryById, t as useLogsTreeExpand, u as getConsumedTokens } from "./useLogsTreeExpand-BMw_HXmi.js";
import { t as useExecutionData } from "./useExecutionData-D6Lj0n_U.js";
import { n as getReferencedData, t as RunDataParsedAiContent_default } from "./RunDataParsedAiContent-B_tUJhED.js";
		...
		return (_ctx, _cache) => {
			...
			return openBlock(), createBlock(RunData_default, {
				...
				"node-waiting": withCtx(() => [createVNode(NDVEmptyState_default, {
					...
					default: withCtx(() => [withDirectives(createBaseVNode("span", null, null, 512), [[_directive_n8n_html, unref(waitingNodeTooltip)(node.value, __props.workflowObject, runTaskData.value?.metadata)]])]),
					_: 1
				}, 8, ["title"])]),
...
var TriggerPanel_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props, { emit: __emit }) {
		...
		const hideContent = computed(() => {
			...
			if (node.value) {
				const hideContentValue = workflowsStore.workflowObject.expression.getSimpleParameterValue(node.value, hideContent, "internal", {});
...
var TriggerPanel_default = /* @__PURE__ */ _plugin_vue_export_helper_default(TriggerPanel_vue_vue_type_script_setup_true_lang_default, [["__cssModules", { "$style": TriggerPanel_vue_vue_type_style_index_0_lang_module_default }], ["__scopeId", "data-v-a90f8008"]]);
//#endregion
