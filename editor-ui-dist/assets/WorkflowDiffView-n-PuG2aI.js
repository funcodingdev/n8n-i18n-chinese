...
import { $ as openBlock, A as createTextVNode, C as createBaseVNode, Cn as toDisplayString, E as createElementBlock, F as guardReactiveProps, Gt as unref, It as ref, N as defineComponent, Nt as onScopeDispose, O as createSlots, S as computed, T as createCommentVNode, U as mergeProps, Ut as toValue, X as onMounted, _ as Fragment, _t as watchEffect, bn as normalizeStyle, bt as withCtx, c as useCssModule, gt as watch, h as withModifiers, it as renderSlot, j as createVNode, jt as isRef, l as useCssVars, rt as renderList, vn as normalizeClass, w as createBlock, yn as normalizeProps, zt as shallowRef } from "./vue.runtime.esm-bundler-CiTcVoZc.js";
import { s as useI18n } from "./src-LyB2u_3c.js";
import { Dt as createEventBus, F as N8nResizeWrapper_default, Ga as N8nHeading_default, Ja as N8nButton_default, Qt as ElDropdownMenu, R as N8nRadioButtons_default, Wi as N8nIconButton_default, Xt as ElDropdown, Zt as ElDropdownItem, qa as N8nText_default, vt as Checkbox_default } from "./src-BY3LHeey.js";
import { t as _plugin_vue_export_helper_default } from "./_plugin-vue_export-helper-Da88TEg1.js";
import { a as CanvasNode_default, c as CanvasEdge_default, n as useCanvasMapping, r as Canvas_default, t as useWorkflowDocumentRenderData, u as CanvasBackground_default } from "./useWorkflowDocumentRenderData-Dz2RRML3.js";
import { $r as _sfc_main$d, b as injectWorkflowDocumentStore, li as useVueFlow, q as useNodeTypesStore, un as removeWorkflowExecutionData, v as createWorkflowDocumentId, x as useWorkflowDocumentStore, y as disposeWorkflowDocumentStore } from "./workflows.store-DSrFVULM.js";
import { t as useToast } from "./useToast-7r31sqLC.js";
import { Oo as NodeDiffStatus, ko as compareWorkflowsNodes } from "./constants-CLQJMg7Y.js";
import { t as useRootStore } from "./useRootStore-BXKn7r8-.js";
import { A as createInjectionState, k as createEventHook } from "./core-CZJuH52F.js";
import { f as useUIStore, h as telemetry } from "./users.store-AINJEAwY.js";
...
var WorkflowDiffEmptyState_vue_vue_type_style_index_0_lang_module_default = { emptyState: "_emptyState_1ns07_125" };
...
var NodeDiff_vue_vue_type_style_index_0_lang_module_default = { codeDiff: "_codeDiff_1fqmj_126" };
...
var WorkflowDiffAside_vue_vue_type_style_index_0_lang_module_default = {
	workflowDiffAside: "_workflowDiffAside_pzi06_125",
	asideHeader: "_asideHeader_pzi06_134",
	nodeTitle: "_nodeTitle_pzi06_142"
};
...
var WorkflowDiffContent_vue_vue_type_style_index_0_lang_module_default = {
	...
	sourceBadge: "_sourceBadge_p1w5q_146 _sourceBadge_1jo27_3",
	emptyWorkflow: "_emptyWorkflow_p1w5q_150",
	deleted: "_deleted_p1w5q_159 _deleted_1jo27_20",
	added: "_added_p1w5q_163 _added_1jo27_21",
	equal: "_equal_p1w5q_167 _equal_1jo27_111",
	modified: "_modified_p1w5q_171 _modified_1jo27_22",
	"edge-deleted": "_edge-deleted_p1w5q_176 _edge-deleted_1jo27_148",
	"edge-added": "_edge-added_p1w5q_180 _edge-added_1jo27_153",
	"edge-equal": "_edge-equal_p1w5q_184 _edge-equal_1jo27_158"
};
...
var WorkflowDiffNodeItem_vue_vue_type_style_index_0_lang_module_default = { nodeName: "_nodeName_1ibfh_148" };
...
function createWorkflowDiff(workflowRef, workflowNodes, workflowConnections, workflowObjectRef, renderData) {
...
function createDiffRenderData(workflowRef, side) {
	const renderData = shallowRef({
		nodeInputsByNodeId: /* @__PURE__ */ new Map(),
		nodeOutputsByNodeId: /* @__PURE__ */ new Map(),
		pinnedDataByNodeName: {},
		executionIssuesByNodeName: /* @__PURE__ */ new Map()
	});
...
var useWorkflowDiff = (sourceWorkflow, targetWorkflow) => {
	...
	const nodeTypesStore = useNodeTypesStore();
	const sourceRefs = createWorkflowRefs(sourceWorkflow, workflowDocumentStore.value.createWorkflowObject);
	const targetRefs = createWorkflowRefs(targetWorkflow, workflowDocumentStore.value.createWorkflowObject);
	const { renderData: sourceRenderData, dispose: disposeSource } = createDiffRenderData(sourceRefs.workflowRef, "source");
	const { renderData: targetRenderData, dispose: disposeTarget } = createDiffRenderData(targetRefs.workflowRef, "target");
	const sourceDiff = createWorkflowDiff(sourceRefs.workflowRef, sourceRefs.workflowNodes, sourceRefs.workflowConnections, sourceRefs.workflowObjectRef, sourceRenderData);
	const targetDiff = createWorkflowDiff(targetRefs.workflowRef, targetRefs.workflowNodes, targetRefs.workflowConnections, targetRefs.workflowObjectRef, targetRenderData);
	onScopeDispose(() => {
		disposeSource();
		disposeTarget();
	});
...
var WorkflowDiffView_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props, { emit: __emit }) {
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("div", { class: normalizeClass(unref($style).workflowDiffViewContainer) }, [createBaseVNode("div", { class: normalizeClass(unref($style).header) }, [createBaseVNode("div", { class: normalizeClass(unref($style).headerLeft) }, [
...
var WorkflowDiffView_vue_vue_type_style_index_0_lang_module_default = {
	workflowDiffViewContainer: "_workflowDiffViewContainer_avju5_125",
	tabs: "_tabs_avju5_131",
	popper: "_popper_avju5_141",
	changes: "_changes_avju5_148",
	separator: "_separator_avju5_155",
	circleBadge: "_circleBadge_avju5_164",
	dropdownContent: "_dropdownContent_avju5_178",
	noNumberDiff: "_noNumberDiff_avju5_190",
	header: "_header_avju5_199",
	navigationButton: "_navigationButton_avju5_206",
	backButton: "_backButton_avju5_209",
	headerLeft: "_headerLeft_avju5_213",
	headerRight: "_headerRight_avju5_214"
};
