const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/workers-CuoEW4vt.js","assets/comlink-h1hawfcO.js"])))=>i.map(i=>d[i]);
...
import { i as i18n, n as addHeaders, r as addNodeTranslation, s as useI18n } from "./src-CvPjLYa0.js";
...
import { E as getActivePinia, T as defineStore, a as ResponseError, c as makeRestApiRequest, d as request, f as streamRequest, m as axios, s as getFullApiResponse, t as useRootStore } from "./useRootStore-BLAHyASD.js";
import { Bn as STORES, C as updateCurrentUserSettings, Ft as getProjectSecretProviderConnectionsByProjectId, _t as getResourceMapperFields, ct as fetchCommunityNodeAttributes, dt as getNodeParameterActionResult, ft as getNodeParameterOptions, gt as getResourceLocatorResults, ht as getNodesInformation, i as getWorkflowVersion, lt as fetchCommunityNodeTypes, mt as getNodeTypes$1, pt as getNodeTranslationHeaders, s as findWebhook, t as useSettingsStore, ut as getLocalResourceMapperFields } from "./settings.store-Bzrrgc0p.js";
import { _ as useStorage, f as useUIStore, n as hasPermission, t as useUsersStore, u as hasRole } from "./users.store-D_2YlqZ_.js";
import { r as require_toNumber } from "./useDebounce-CmtJy2cP.js";
import { A as isObject$1, E as stringSizeInBytes, S as isPresent, T as shorten, a as getNewWorkflow, i as getLastSuccessfulExecution, k as getObjectSizeInKB, l as getWorkflows, n as useFavoritesStore, r as getExecutionData, t as useWorkflowsListStore, w as omit, x as isJsonKeyObject, y as isEmpty } from "./workflowsList.store-Bm-9RAXi.js";
import { t as useDocumentTitle } from "./useDocumentTitle-Cd6twt1Y.js";
import { t as require__baseOrderBy } from "./_baseOrderBy-vsEjfixH.js";
	...
	const loadNodesInformationFromLocalDb = async (nodeInfos) => {
		try {
			const { getNodeType } = await __vitePreload(async () => {
				const { getNodeType } = await import("./workers-CuoEW4vt.js");
				return { getNodeType };
			}, __vite__mapDeps([0,1]));
			const found = [];
			const missing = [];
	...
	const loadNodeTypesFromLocalDb = async () => {
		try {
			const { loadNodeTypes, getAllNodeTypes } = await __vitePreload(async () => {
				const { loadNodeTypes, getAllNodeTypes } = await import("./workers-CuoEW4vt.js");
				return {
					loadNodeTypes,
					getAllNodeTypes
				};
