;
(function () {
  System.register(["./vue.runtime.esm-bundler-legacy--Sn1h8On.js", "./_MapCache-legacy-CECtqMZe.js", "./useTelemetry-legacy-CA9g7cV_.js", "./constants-legacy-B_3qSw5J.js", "./useExternalHooks-legacy-CqVTyuDp.js", "./nodeCreator.store-legacy-CWpRRTas.js"], function (_export, _context) {
    "use strict";

    var computed, useI18n, sortNodeCreateElements, useCanvasStore, injectWorkflowState, transformNodeType, useNodeTypesStore, useWorkflowsStore, PUSH_NODES_OFFSET, SCHEDULE_TRIGGER_NODE_TYPE, NO_OP_NODE_TYPE, MANUAL_TRIGGER_NODE_TYPE, NodeConnectionTypes, OPEN_AI_NODE_MESSAGE_ASSISTANT_TYPE, QA_CHAIN_NODE_TYPE, TRIGGER_NODE_CREATOR_VIEW, AGENT_NODE_TYPE, CHAIN_LLM_LANGCHAIN_NODE_TYPE, OPEN_AI_NODE_TYPE, OPEN_AI_ASSISTANT_NODE_TYPE, CHAT_TRIGGER_NODE_TYPE, STICKY_NODE_TYPE, AI_CATEGORY_LANGUAGE_MODELS, SPLIT_IN_BATCHES_NODE_TYPE, NODE_CREATOR_OPEN_SOURCES, WEBHOOK_NODE_TYPE, BASIC_CHAIN_NODE_TYPE, useExternalHooks, useNodeCreatorStore, useActions;
    return {
      setters: [function (_vueRuntimeEsmBundlerLegacy003Js) {
        ...
        NO_OP_NODE_TYPE = _constantsLegacy00TJs.Bn;
        ...
        QA_CHAIN_NODE_TYPE = _constantsLegacy00TJs.Jn;
        TRIGGER_NODE_CREATOR_VIEW = _constantsLegacy00TJs.Mt;
        AGENT_NODE_TYPE = _constantsLegacy00TJs.Nt;
        CHAIN_LLM_LANGCHAIN_NODE_TYPE = _constantsLegacy00TJs.Qa;
        OPEN_AI_NODE_TYPE = _constantsLegacy00TJs.Un;
        OPEN_AI_ASSISTANT_NODE_TYPE = _constantsLegacy00TJs.Vn;
        ...
        BASIC_CHAIN_NODE_TYPE = _constantsLegacy00TJs.zt;
