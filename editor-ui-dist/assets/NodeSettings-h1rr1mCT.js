...
import { f as collectParametersByTab, g as getNodeSettingsInitialValues, m as createCommonNodeSettings, p as collectSettings, s as useNodeSettingsParameters, t as ParameterInputList_default, y as nameIsParameter } from "./ParameterInputList-92PWw_66.js";
import { n as ElRow, t as ElCol } from "./col-Dti7TcCx.js";
import { t as useToast } from "./useToast-UJviqZPo.js";
import { En as MCP_TRIGGER_NODE_TYPE, Gn as PRODUCTION_ONLY_TRIGGER_NODE_TYPES, Hn as OPEN_URL_PANEL_TRIGGER_NODE_TYPES, I as CUSTOM_API_CALL_KEY, Is as getNodeParameters, Kt as DATA_TABLE_NODES, Lt as CHAT_TRIGGER_NODE_TYPE, Ps as getNodeInputs, a as BASE_NODE_SURVEY_URL, cn as FORM_TRIGGER_NODE_TYPE, l as CUSTOM_NODES_DOCS_URL, pc as NodeConnectionTypes, s as BUILTIN_NODES_DOCS_URL, ui as VIEWS, vc as deepCopy, x as NPM_PACKAGE_DOCS_BASE_URL, yc as isCommunityPackageName } from "./constants-BiYlbN9Z.js";
import { $t as injectNDVStore, Gt as useWorkflowHelpers, M as useNodeTypesStore, N as useActionsGenerator, Z as removePreviewToken, un as ProjectTypes, vt as useCredentialsStore, x as injectWorkflowDocumentStore } from "./workflows.store-DgZ4KSQf.js";
import { t as useSettingsStore } from "./settings.store-DROe9gro.js";
import { F as noop, M as isClient, N as isIOS, P as isObject, U as tryOnScopeDispose, V as toValue$1, j as directiveHooks, n as onClickOutside$1, p as useElementSize$1, t as computedAsync, y as useResizeObserver$1, z as toRef } from "./core-BemUAWor.js";
import { S as COMMUNITY_NODES_INSTALLATION_DOCS_URL, T as COMMUNITY_PACKAGE_INSTALL_MODAL_KEY, f as useUIStore, p as useTelemetry, t as useUsersStore } from "./users.store-CUZkGc51.js";
import { t as useDebounce } from "./useDebounce-CoPo6zc6.js";
...
import { o as useWorkflowId } from "./builder.store-CDTOjwn3.js";
import { d as RenameNodeCommand, n as useHistoryStore, t as useNodeHelpers } from "./useNodeHelpers-Bs3WVmfe.js";
...
import { a as TitledList_default, n as useNodeCredentialOptions, t as NodeCredentials_default } from "./NodeCredentials-DhDO36l5.js";
import { n as useNodeIconSource, t as NodeIcon_default } from "./NodeIcon-BAxmPUnf2.js";
...
import { t as useFreeAiCredits } from "./useFreeAiCredits-PpEaIryh.js";
import { i as QuickConnectBanner_default, n as CommunityNodeFooter_default, r as useInstalledCommunityPackage, t as CommunityNodeUpdateInfo_default } from "./CommunityNodeUpdateInfo-C5mHpRhB.js";
import { t as useActions } from "./useActions-Bzw2uNTy.js";
			...
			return openBlock(), createElementBlock("div", {
				...
				node.value && nodeValid.value ? (openBlock(), createElementBlock("div", {
					...
					openPanel.value === "credential" ? (openBlock(), createBlock(NodeCredentials_default, {
						...
						"hide-ask-assistant": !unref(aiAssistant),
...
var NodeSettings_default = /* @__PURE__ */ _plugin_vue_export_helper_default(NodeSettings_vue_vue_type_script_setup_true_lang_default, [["__cssModules", { "$style": NodeSettings_vue_vue_type_style_index_0_lang_module_default }], ["__scopeId", "data-v-77da03f9"]]);
//#endregion
