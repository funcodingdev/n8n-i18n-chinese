...
import { o as useEditorContext, r as useWorkflowSaving, t as useBuilderStore } from "./builder.store-B8p0AL3t.js";
import { D as injectWorkflowDocumentStore, Qt as useWorkflowHelpers, T as createWorkflowDocumentId, V as useNodeTypesStore, Vi as isValidNodeConnectionType, dt as SampleTemplates, er as getTriggerNodeServiceName, g as parse, ht as isTutorialTemplateId, k as useWorkflowDocumentStore, l as getExecutionErrorMessage, p as openFormPopupWindow, r as clearPopupWindowState, t as useWorkflowsStore, u as getExecutionErrorToastConfiguration, vi as createExecutionDataId, wt as useCredentialsStore, xi as useExecutionDataStore, y as useWorkflowExecutionStateStore } from "./workflows.store-JWtScvRR.js";
import { $i as EVALUATION_TRIGGER_NODE_TYPE, Kn as createRunExecutionData, Mr as generateNodesGraph, Oi as isCommunityPackageName, da as TRIMMED_TASK_DATA_CONNECTIONS_KEY } from "./src-B255AdRt.js";
import { cr as defineStore, t as useRootStore, vt as sendGetWorkerStatus } from "./useRootStore-CLEJA2KF.js";
...
import { Si as WORKFLOW_SETTINGS_MODAL_KEY } from "./constants-CMdL1Kzl.js";
import { t as useWorkflowsListStore } from "./workflowsList.store-y-0nsqzo.js";
import { i as get, n as useUIStore } from "./ui.store-CxHz_b7L.js";
...
import { i as globalLinkActionsEventBus, o as codeNodeEditorEventBus } from "./event-bus-a2R-CWx4.js";
...
import { t as useActivationError } from "./useActivationError-DAQxUJJx.js";
import { t as useReadyToRunStore } from "./readyToRun.store-qrDXdttN.js";
...
//#endregion
//#region ../../@n8n/utils/src/create-event-queue.ts
/**
...
function usePushConnection({ router }) {
	...
	*/
	async function processEvent(event) {
		...
		const moduleHandler = get(event.type);
		if (moduleHandler) return await moduleHandler(event, options);
		switch (event.type) {
