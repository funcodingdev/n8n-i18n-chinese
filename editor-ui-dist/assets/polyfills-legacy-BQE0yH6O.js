(function() {
	...
	var require_array_buffer_byte_length = /* @__PURE__ */ __commonJSMin(((exports, module) => {
		...
		var ArrayBuffer$2 = globalThis$20.ArrayBuffer;
	...
	var require_array_buffer_is_detached = /* @__PURE__ */ __commonJSMin(((exports, module) => {
		...
		var DataView$2 = globalThis$19.DataView;
	...
	var require_array_buffer_transfer = /* @__PURE__ */ __commonJSMin(((exports, module) => {
		...
		var structuredClone = globalThis$18.structuredClone;
		var ArrayBuffer$1 = globalThis$18.ArrayBuffer;
		var DataView$1 = globalThis$18.DataView;
		var min$1 = Math.min;
		var ArrayBufferPrototype = ArrayBuffer$1.prototype;
		var DataViewPrototype = DataView$1.prototype;
		var slice$2 = uncurryThis$9(ArrayBufferPrototype.slice);
	...
	var require_array_buffer_view_core = /* @__PURE__ */ __commonJSMin(((exports, module) => {
		...
		var Int8Array$1 = globalThis$17.Int8Array;
		var Int8ArrayPrototype = Int8Array$1 && Int8Array$1.prototype;
		var Uint8ClampedArray = globalThis$17.Uint8ClampedArray;
		...
		var NATIVE_ARRAY_BUFFER_VIEWS = NATIVE_ARRAY_BUFFER && !!setPrototypeOf$1 && classof$2(globalThis$17.opera) !== "Opera";
		...
		var getTypedArrayConstructor$1 = function(it) {
			...
			return state && hasOwn$7(state, TYPED_ARRAY_CONSTRUCTOR) ? state[TYPED_ARRAY_CONSTRUCTOR] : getTypedArrayConstructor$1(proto);
		};
		...
		var aTypedArrayConstructor = function(C) {
			if (isCallable$4(C) && (!setPrototypeOf$1 || isPrototypeOf$1(TypedArray, C))) return C;
			throw new TypeError$2(tryToString(C) + " is not a typed array constructor");
		};
		var exportTypedArrayMethod$1 = function(KEY, property, forced, options) {
			if (!DESCRIPTORS$1) return;
			if (forced) for (var ARRAY in TypedArrayConstructorsList) {
				var TypedArrayConstructor = globalThis$17[ARRAY];
		...
		var exportTypedArrayStaticMethod = function(KEY, property, forced) {
			...
			if (setPrototypeOf$1) {
				if (forced) for (ARRAY in TypedArrayConstructorsList) {
					TypedArrayConstructor = globalThis$17[ARRAY];
		...
		for (NAME in TypedArrayConstructorsList) {
			Constructor = globalThis$17[NAME];
		...
		if (!NATIVE_ARRAY_BUFFER_VIEWS || !isCallable$4(TypedArray) || TypedArray === Function.prototype) {
			...
			if (NATIVE_ARRAY_BUFFER_VIEWS) {
				for (NAME in TypedArrayConstructorsList) if (globalThis$17[NAME]) setPrototypeOf$1(globalThis$17[NAME], TypedArray);
			}
		}
		if (!NATIVE_ARRAY_BUFFER_VIEWS || !TypedArrayPrototype || TypedArrayPrototype === ObjectPrototype) {
			TypedArrayPrototype = TypedArray.prototype;
			if (NATIVE_ARRAY_BUFFER_VIEWS) {
				for (NAME in TypedArrayConstructorsList) if (globalThis$17[NAME]) setPrototypeOf$1(globalThis$17[NAME].prototype, TypedArrayPrototype);
			}
		}
		...
		if (DESCRIPTORS$1 && !hasOwn$7(TypedArrayPrototype, TO_STRING_TAG$1)) {
			...
			for (NAME in TypedArrayConstructorsList) if (globalThis$17[NAME]) createNonEnumerableProperty$2(globalThis$17[NAME], TYPED_ARRAY_TAG, NAME);
		}
		module.exports = {
	...
	var JSON$1 = globalThis$16.JSON;
	var Number = globalThis$16.Number;
	var SyntaxError$3 = globalThis$16.SyntaxError;
	...
	var internalize = function(holder, name, reviver, node) {
		...
		if (isObject$1(val)) {
			...
			if (nodeIsArray) {
				...
				for (i = 0; i < len; i++) {
					P = keys$2[i];
					internalizeProperty(val, P, internalize(val, P, reviver, hasOwn$5(nodes, P) ? nodes[P] : void 0));
				}
			}
		}
