...
import { at as useI18n, ot as I18nT, t as computedAsync } from "./core-gptzu9Ct.js";
import { $i as N8nIcon_default, Oi as N8nTooltip_default, Qi as N8nButton_default, Xi as N8nCallout_default, Zi as N8nText_default, nt as N8nLink_default, ut as useRouter } from "./src-Bvr7jqKz.js";
import { t as _plugin_vue_export_helper_default } from "./_plugin-vue_export-helper-Da88TEg1.js";
import { Bn as require_FileSaver_min, Dt as injectWorkflowState, Ea as isEmpty, In as useExternalHooks, Ln as useMessage, Pn as useToast, Vi as executionDataToJson, _r as useTelemetry, fa as injectWorkflowDocumentStore, lt as useDataSchema, mr as useNodeHelpers, pa as useWorkflowDocumentStore, pr as useEnvironmentsStore, r as useUIStore, s as useWorkflowsStore, st as generateCodeForPrompt, ua as createWorkflowDocumentId, ut as useFlattenSchema, w as useNodeTypesStore, xr as useNDVStore } from "./users.store-BCts_jcD.js";
import { $r as FROM_AI_PARAMETERS_MODAL_KEY, Da as require_pick, Ds as AI_TRANSFORM_JS_CODE, Es as AI_TRANSFORM_CODE_GENERATED_FOR_PROMPT, Pt as CHAT_TRIGGER_NODE_TYPE, Ur as BINARY_DATA_VIEW_MODAL_KEY, an as FORM_TRIGGER_NODE_TYPE, b as SCHEMA_PREVIEW_DOCS_URL, bs as DateTime, j as PLACEHOLDER_FILLED_AT_EXECUTION_TIME, pr as WEBHOOK_NODE_TYPE, rl as EnterpriseEditionFeature, tc as ApplicationError, ui as MODAL_CONFIRM, xn as MANUAL_TRIGGER_NODE_TYPE, xs as NodeConnectionTypes, za as createResultError } from "./constants-CjIW4CHX.js";
import { t as useRootStore } from "./useRootStore-D8wbz-kO.js";
import { t as useSettingsStore } from "./settings.store-BOIB94F8.js";
import { i as Ln, o as gu, r as estree_exports, t as NDVEmptyState_default } from "./NDVEmptyState-C70RQSP_.js";
import { t as usePinnedData } from "./usePinnedData-C1P7cKhF.js";
import { o as needsAgentInput } from "./nodeTransforms-CE4tovsK.js";
import { t as Draggable_default } from "./Draggable-C2yfg7qY.js";
import { t as NodeIcon_default } from "./NodeIcon-cyZY3dVv.js";
import { t as TextWithHighlights_default } from "./TextWithHighlights-CsamT1Pd.js";
import { t as useCalloutHelpers } from "./useCalloutHelpers-p-fLQ2NM.js";
import { n as MappingPill_default, t as useTelemetryContext } from "./useTelemetryContext-Da7DXLZD.js";
...
async function generateCodeForAiTransform(prompt, path, retries = 1) {
...
function useNodeExecution(node, options = {}) {
	...
	const isChatChild = computed(() => nodeRef.value ? workflowsStore.checkIfNodeHasChatParent(nodeRef.value.name) : false);
	...
	async function handleCodeGeneration() {
		...
		try {
			...
			const updateInformation = await generateCodeForAiTransform(prompt, `parameters.${AI_TRANSFORM_JS_CODE}`, 5);
