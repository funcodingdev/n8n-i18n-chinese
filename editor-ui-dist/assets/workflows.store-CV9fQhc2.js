const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/workers-DsqhEZ0Q.js","assets/comlink-CyTgoqJ2.js"])))=>i.map(i=>d[i]);
...
import { i as i18n, n as addHeaders, r as addNodeTranslation, s as useI18n } from "./src-CNBJaijc.js";
...
import { $i as v4, At as isAssignmentCollectionValue, Bn as createRunExecutionData, Cr as getNodeInputs, Dr as getNodeWebhookUrl, Hr as nodeIssuesToString, It as Workflow, Jr as isFilterValue, Ki as MANUAL_TRIGGER_NODE_TYPE, Ni as CHAT_TRIGGER_NODE_TYPE, Nt as normalizeNodeShape, On as isTrimmedNodeExecutionData, Pr as isHitlToolType, Si as ExpressionError, Sr as getConnectionTypes, Tr as getNodeParameters, Ut as require__baseIteratee, Xt as normalizeGroupDescription, Yi as SEND_AND_WAIT_OPERATION, Zi as WAIT_INDEFINITELY, _r as getChildNodes, ai as nodeConnectionTypes, an as require__baseFindIndex, br as displayParameter, ci as isExpression, da as getResourcePermissions, di as deepCopy, fo as require_get, hr as mapConnectionsByDestination, ii as NodeConnectionTypes, mr as resolveVariables, ni as isResourceMapperValue$1, nn as require__baseUniq, ra as require_keys, si as traverseNodeParameters, ta as require_isEqual, ti as isResourceLocatorValue, tn as splitExpression, vo as require_memoize, wi as UnexpectedError, wr as getNodeOutputs, wt as require_pick, xr as displayParameterPath, yi as sleep$1, yr as checkConditions, zn as createEmptyRunExecutionData } from "./src-JwBmTNgK.js";
...
import { B as AI_CATEGORY_AGENTS, Dt as AI_TRANSFORM_NODE_TYPE, E as TEMPLATES_NODES_FILTER, Et as AI_MCP_TOOL_NODE_TYPE, F as DATA_TYPE_ICON_MAP, J as AI_CATEGORY_OTHER_TOOLS, Jn as WEBHOOK_NODE_TYPE$1, K as AI_CATEGORY_MCP_NODES, L as MAPPING_PARAMS, Lt as CREDENTIAL_ONLY_NODE_PREFIX, M as PLACEHOLDER_FILLED_AT_EXECUTION_TIME, Nn as SCHEDULE_TRIGGER_NODE_TYPE, P as CUSTOM_API_CALL_KEY, Rr as MAIN_HEADER_TABS, W as AI_CATEGORY_HUMAN_IN_THE_LOOP, Xn as WORKFLOW_TRIGGER_NODE_TYPE, Yn as WIKIPEDIA_TOOL_NODE_TYPE, bn as NON_ACTIVATABLE_TRIGGER_NODE_TYPES, cn as LIST_LIKE_NODE_OPERATIONS, ct as CORE_NODES_CATEGORY, dt as HITL_SUBCATEGORY, en as FORM_TRIGGER_NODE_TYPE$1, eo as EnterpriseEditionFeature, et as AI_CATEGORY_VECTOR_STORES, ft as HUMAN_IN_THE_LOOP_CATEGORY, gn as MODULE_ENABLED_NODES, gt as RECOMMENDED_NODES, ha as WorkflowIdKey, i as DUPLICATE_POSTFFIX, j as IN_PROGRESS_EXECUTION_ID, ja as INLINE_AGENTS_EXPERIMENT, ma as WorkflowDocumentStoreKey, mn as MESSAGE_AN_AGENT_NODE_TYPE, nn as HTTP_REQUEST_NODE_TYPE, oa as CanvasRenderDataKey, qt as ERROR_TRIGGER_NODE_TYPE$1, r as DEFAULT_SETTINGS, st as BETA_NODES, tt as AI_CODE_TOOL_LANGCHAIN_NODE_TYPE, vn as NODE_POSITION_CONFLICT_ALLOWLIST } from "./constants-BP1FOJvU.js";
import { i as require_toNumber } from "./useDebounce-Bcd_ZnT1.js";
import { b as isObject$1, d as isJsonKeyObject, f as isPresent, g as stringSizeInBytes, h as shorten, l as isEmpty, m as omit, y as getObjectSizeInKB } from "./typesUtils-DlQYqvHF.js";
import { a as getNewWorkflow, i as getLastSuccessfulExecution, l as getWorkflows, n as useFavoritesStore, r as getExecutionData, t as useWorkflowsListStore } from "./workflowsList.store-6Bsu-Vve.js";
import { n as useUIStore, x as CANCELLABLE_EXECUTION_STATUSES } from "./ui.store-BnC6HBDo.js";
import { c as hasRole, t as hasPermission } from "./permissions-3EgiVXws.js";
import { o as require_startCase, t as useEvaluationStore } from "./evaluation.store-Dx8YO1MC.js";
import { n as noCase } from "./dist-v_zj-Ul9.js";
import { t as require_sortBy } from "./sortBy-DnOfhIxL.js";
	...
	const loadNodesInformationFromLocalDb = async (nodeInfos) => {
		try {
			const { getNodeType } = await __vitePreload(async () => {
				const { getNodeType } = await import("./workers-DsqhEZ0Q.js");
				return { getNodeType };
			}, __vite__mapDeps([0,1]));
			const found = [];
			const missing = [];
	...
	const loadNodeTypesFromLocalDb = async () => {
		try {
			const { loadNodeTypes, getAllNodeTypes } = await __vitePreload(async () => {
				const { loadNodeTypes, getAllNodeTypes } = await import("./workers-DsqhEZ0Q.js");
				return {
					loadNodeTypes,
					getAllNodeTypes
				};
...
//#endregion
export { nodeTypesToCreateElements as $, hasProxyAuth as $n, _sfc_main$3 as $r, useTagsStore as $t, doesNodeHaveCredentialsToFill as A, isResourceMapperValue as Ai, insertDataTableRowApi as An, DEFAULT_NODE_SIZE as Ar, useAIAssistantHelpers as At, useActionsGenerator as B, isWorkflowListItem as Bi, getAllNodeCredentialForAuthType as Bn, getMousePosition as Br, getResolvableState as Bt, disposeWorkflowDocumentStore as C, isComponentPublicInstance as Ci, deleteDataTableColumnApi as Cn, parseCanvasConnectionHandleString as Cr, chatWithBuilder as Ct, TOOL_NODE_TYPES_NEED_INPUT as D, isDebouncedFunction as Di, fetchDataTablesApi as Dn, AGENT_NODE_SIZE as Dr, getBuilderCredits as Dt, useWorkflowDocumentStore as E, isDateObject as Ei, fetchDataTableGlobalLimitInBytes as En, injectStrict as Er, getAiSessions as Et, useEnvFeatureFlag as F, isTriggerPanelObject as Fi, uploadCsvFileApi as Fn, doRectsOverlap as Fr, getMappedResult as Ft, getAiTemplatesCallout as G, CanvasNodeDirtiness as Gi, getNodeAuthFields as Gn, snapPositionToGridByCenter as Gr, stringifyExpressionResult as Gt, filterAndSearchNodes as H, CANVAS_NODE_GROUP_HANDLE_RIGHT as Hi, getAppNameFromNodeName as Hn, getNodeViewTab as Hr, isTestableExpression as Ht, require_uniq as I, isValidCredentialResponse as Ii, executionDataToJson as In, generateOffsets as Ir, propertyNameFromExpression as It, getSendAndWaitNodes as J, isCanvasGroupNode as Ji, getNodeSubtitle as Jn, NodeId as Jr, resolveRequiredParameters as Jt, getHumanInTheLoopActions as K, CanvasNodeRenderType as Ki, getNodeAuthOptions as Kn, updateViewportToContainNodes as Kr, unwrapExpression as Kt, isAgentNodeV2 as L, isValidNodeConnectionType as Li, fieldCannotBeDeleted as Ln, getBounds as Lr, completeExpressionSyntax as Lt, getParameterDisplayableOptions as M, isRouteLocationRaw as Mi, renameDataTableColumnApi as Mn, HORIZONTAL_NODE_STEP as Mr, useFlattenSchema as Mt, needsAgentInput as N, isSharedResource as Ni, updateDataTableApi as Nn, PUSH_NODES_OFFSET as Nr, escapeMappingString as Nt, assignNodeId as O, isFullExecutionResponse as Oi, getDataTableRowsApi as On, CONFIGURABLE_NODE_SIZE as Or, replaceCode as Ot, serializeNode as P, isString as Pi, updateDataTableRowsApi as Pn, calculateNodeSize as Pr, getMappedExpression as Pt, mapToolSubcategoryIcon as Q, hasOnlyListMode as Qn, _sfc_main$1 as Qr, useAnnotationTagsStore as Qt, useNodeTypesStore as R, isVariableResource as Ri, filterTemplateNodes as Rn, getGenericHints as Rr, getExpressionErrorMessage as Rt, createWorkflowDocumentId as S, isBinaryLike as Si, deleteDataTableApi as Sn, mapLegacyConnectionsToCanvasConnections as Sr, chatWithAssistant as St, provideWorkflowDocumentStore as T, isCredentialsResource as Ti, downloadDataTableCsvApi as Tn, shouldIgnoreCanvasShortcut as Tr, generateCodeForPrompt as Tt, finalizeItems as U, CANVAS_NODE_GROUP_TYPE as Ui, getAuthTypeForNodeCredential as Un, getNodesGroupSize as Ur, removeExpressionPrefix as Ut, extractAiGatewaySection as V, CANVAS_NODE_GROUP_HANDLE_LEFT as Vi, getAppNameFromCredType as Vn, getNewNodePosition as Vr, isPairedItemIntermediateNodesError as Vt, flattenCreateElements as W, CanvasConnectionMode as Wi, getMainAuthField as Wn, getNodesWithNormalizedPosition as Wr, shouldConvertToExpression as Wt, isAINode as X, structuralComputed as Xi, getTriggerNodeServiceName as Xn, Position as Xr, useRouteWorkflowId as Xt, groupItemsInSections as Y, parseCanvasGroupNodeId as Yi, getThemedValue as Yn, PanelPosition as Yr, useWorkflowHelpers as Yt, isNodePreviewKey as Z, isBinary as Zi, hasExpressionMapping as Zn, _sfc_main as Zr, useWorkflowId as Zt, disposeWorkflowExecutionStateStore as _, useExecutionDataStore as _i, ProjectTypes as _n, getMaxNodePortsLabelSize as _r, stripToolSuffix as _t, executionFilterToQueryFilter as a, getConnectedEdges as ai, injectNDVStore as an, isValueExpression as ar, sortNodeCreateElements as at, createExecutionPreviewDocumentId as b, checkExhaustive as bi, addDataTableColumnApi as bn, mapCanvasConnectionToLegacyConnection as br, listenForCredentialChanges as bt, getDefaultExecutionFilters as c, isMacOs as ci, LOCAL_STORAGE_NDV_PANEL_WIDTH as cn, getAllCredentials as cr, SampleTemplates as ct, hasCancellableExecutions as d, wheelDelta as di, getTruncatedProjectName as dn, applyOffset as dr, getTutorialTemplates as dt, _sfc_main$d as ei, ensureNodePosition as en, isAuthRelatedParameter as er, prepareCommunityNodeDetailsViewStack as et, hasTrimmedRunData as f, getPinDataSize as fi, splitName as fn, checkOverlap as fr, isTutorialTemplateId as ft, parse as g, hasExecutionDataStore as gi, useSourceControlStore as gn, createEmptyCanvasRenderData as gr, useInlineAgentsExperiment as gt, waitingNodeTooltip as h, disposeExecutionDataStore as hi, useProjectsStore as hn, createCanvasConnectionId as hr, getN8nAgentsNodeName as ht, displayForm as i, getBoundsofRects as ii, disposeNDVStore as in, isResourceMapperSchemaIncomplete as ir, showsAiGatewaySection as it, getNodeTypeDisplayableCredentials as j, isResourceSortableByDate as ji, moveDataTableColumnApi as jn, DEFAULT_VIEWPORT_BOUNDARIES as jr, useDataSchema as jt, doesNodeHaveAllCredentialsFilled as k, isProjectRole as ki, importCsvToDataTableApi as kn, CONFIGURATION_NODE_SIZE as kr, truncateBuilderMessages as kt, getExecutionErrorMessage as l, useGetPointerPosition as li, useEnvironmentsStore as ln, probeCredential as lr, getRagStarterWorkflowJson as lt, unflattenExecutionData as m, createExecutionDataId as mi, useRemoteProjectSearch as mn, createCanvasConnectionHandleString as mr, isTemplatesWorkflow as mt, buildExecutionResponseFromSchema as n, clamp as ni, sanitizeConnections as nn, isRequiredCredential as nr, searchNodes as nt, executionRetryMessage as o, getRectOfNodes as oi, injectNDVStoreIfProvided as on, parseResourceMapperFieldName as or, subcategorizeItems as ot, openFormPopupWindow as p, pinDataToExecutionData as pi, useAvailableProjectSearch as pn, computeNodeDisplaySize as pr, isFullTemplatesCollection as pt, getRootSearchCallouts as q, createCanvasGroupNodeId as qi, getNodeCredentialForSelectedAuthType as qn, MarkerType as qr, resolveParameter as qt, clearPopupWindowState as r, getBezierPath as ri, sortNodesByExecutionOrder as rn, isResourceMapperFieldListStale as rr, shouldShowCommunityNodeDetails as rt, findTriggerNodeToAutoSelect as s, getSmoothStepPath as si, useNDVStore as sn, updateNodeAuthType as sr, transformNodeType as st, useWorkflowsStore as t, _sfc_main$f as ti, removeWorkflowExecutionData as tn, isMatchingField as tr, removePreviewToken as tt, getExecutionErrorToastConfiguration as u, useVueFlow as ui, ResourceType as un, isCredentialOnlyNodeType as ur, getSampleWorkflowByTemplateId as ut, injectWorkflowExecutionStateStore as v, CHANGE_ACTION as vi, moveFolderToProject as vn, injectCanvasRenderData as vr, useAiGatewayStore as vt, injectWorkflowDocumentStore as w, isCredentialModalState as wi, deleteDataTableRowsApi as wn, resolveCanonicalConnection as wr, clearBuilderSession as wt, createExecutionPreviewDocumentVersion as x, isBaseTextKey as xi, createDataTableApi as xn, mapLegacyConnectionToCanvasConnection as xr, useCredentialsStore as xt, useWorkflowExecutionStateStore as y, getPairedItemId as yi, setWorkflowSharedWith as yn, insertSpacersBetweenEndpoints as yr, sublimeSearch as yt, isDataWorkerEnabled as z, isVueFlowConnection as zi, getActivatableTriggerNodes as zn, getMidCanvasPosition as zr, getExternalSecretPreview as zt };
