...
import { n as N8nToggle_default, t as N8nToggleGroup_default } from "./N8nToggleGroup-BlpHWY1u.js";
...
var IconPicker_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		...
		async function loadIconData() {
			...
			try {
				lucideData.value = (await __vitePreload(() => import("./lucideIconData-B57gOXDr.js"), [])).lucideIcons;
		...
		async function loadEmojiData() {
			...
			try {
				rawEmojiSections.value = (await __vitePreload(() => import("./emojiData-B582hSHx.js"), [])).emojiSections;
