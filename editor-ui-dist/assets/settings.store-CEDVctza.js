...
import { Xi as EXECUTE_WORKFLOW_NODE_TYPE, pt as AuthenticationMethod } from "./src-B2jBAc9z.js";
import { $ as getModuleSettings, Qn as makeRestApiRequest, U as testHealthEndpoint, et as getSettings, fr as defineStore, lr as STORES, pn as sessionStarted, qn as updateAiUsageSettings, t as useRootStore } from "./useRootStore-B4L7-X8D.js";
...
var useSettingsStore = defineStore(STORES.SETTINGS, () => {
	...
	*/
	...
	const isSubworkflowConversionDisabled = computed(() => isExecuteWorkflowNodeExcluded.value || isNodeTypeExcluded("n8n-nodes-base.executeWorkflowTrigger"));
...
//#endregion
export { require_es5 as n, useSettingsStore as t };
