...
import { Wi as isVariableResource, bn as useProjectsStore, mn as useEnvironmentsStore, xn as useSourceControlStore } from "./workflows.store-CQp5NuTc.js";
...
import { n as useUIStore, x as VARIABLE_MODAL_KEY } from "./ui.store-ic9znGOr.js";
import { n as useDocumentTitle } from "./useDocumentTitle-E3LUeduJ.js";
import { t as useClipboard } from "./useClipboard-DwVAOfeD.js";
import { i as useProjectPages } from "./readyToRun.store-DDfA1G4R.js";
...
import { t as require_pickBy } from "./pickBy-Dphlimgq.js";
...
var VariablesUsageBadge_default = /* @__PURE__ */ _plugin_vue_export_helper_default(/* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		...
		return (_ctx, _cache) => {
			...
			return openBlock(), createBlock(ResourcesListLayout_default, {
				...
				name: "preamble",
				fn: withCtx(() => [createVNode(unref(N8nEmptyState_default), mergeProps({ class: "mb-m" }, unavailableNoticeProps.value), null, 16)]),
				key: "0"
			} : void 0, !isFeatureEnabled.value || isFeatureEnabled.value && !canCreateVariables.value ? {
				name: "empty",
				fn: withCtx(() => [!isFeatureEnabled.value ? (openBlock(), createBlock(unref(N8nEmptyState_default), normalizeProps(mergeProps({ key: 0 }, unavailableNoticeProps.value)), null, 16)) : !canCreateVariables.value ? (openBlock(), createBlock(unref(N8nEmptyState_default), {
					key: 1,
...
var optionContent = "_optionContent_lh4oq_388";
var menuItemEmoji = "_menuItemEmoji_lh4oq_394";
var globalOption = "_globalOption_lh4oq_399";
var shimmer = "_shimmer_lh4oq_1";
var spin = "_spin_lh4oq_1";
var opacityPulse = "_opacityPulse_lh4oq_1";
var popoverIn = "_popoverIn_lh4oq_1";
var fadeIn = "_fadeIn_lh4oq_1";
var collapsibleSlideDown = "_collapsibleSlideDown_lh4oq_1";
var collapsibleSlideUp = "_collapsibleSlideUp_lh4oq_1";
var collapsibleSlideDownBlurred = "_collapsibleSlideDownBlurred_lh4oq_1";
var collapsibleSlideUpBlurred = "_collapsibleSlideUpBlurred_lh4oq_1";
var blurSwapIn = "_blurSwapIn_lh4oq_1";
var blurSwapOut = "_blurSwapOut_lh4oq_1";
var pulseGlow = "_pulseGlow_lh4oq_1";
var pulseGlowDelayed = "_pulseGlowDelayed_lh4oq_1";
var fade = "_fade_lh4oq_1";
var fadeInUp = "_fadeInUp_lh4oq_1";
var fadeInDown = "_fadeInDown_lh4oq_1";
var fadeInLeft = "_fadeInLeft_lh4oq_1";
var fadeInRight = "_fadeInRight_lh4oq_1";
var fadeOut = "_fadeOut_lh4oq_1";
var fadeOutDown = "_fadeOutDown_lh4oq_1";
var fadeOutUp = "_fadeOutUp_lh4oq_1";
var fadeOutLeft = "_fadeOutLeft_lh4oq_1";
var fadeOutRight = "_fadeOutRight_lh4oq_1";
var ping = "_ping_lh4oq_1";
var blinkBackground = "_blinkBackground_lh4oq_1";
var typingBlink = "_typingBlink_lh4oq_1";
var ProjectVariables_vue_vue_type_style_index_1_lang_module_default = {
	...
	shimmer,
	spin,
	"skeleton-pulse": "_skeleton-pulse_lh4oq_1",
	opacityPulse,
	popoverIn,
	fadeIn,
...
var ProjectVariables_default = /* @__PURE__ */ _plugin_vue_export_helper_default(ProjectVariables_vue_vue_type_script_setup_true_lang_default, [["__cssModules", { "$style": ProjectVariables_vue_vue_type_style_index_1_lang_module_default }], ["__scopeId", "data-v-340a9983"]]);
//#endregion
