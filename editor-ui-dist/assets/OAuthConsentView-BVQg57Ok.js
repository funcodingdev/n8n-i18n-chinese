...
import { t as ScopesSelector_default } from "./ScopesSelector-grEe1b4M.js";
import { c as MCP_SCOPE_GROUPS } from "./mcp.constants-CtGlan57.js";
import { n as getClientBrand } from "./clients.utils-CRRqDZhO.js";
	...
	setup(__props) {
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("div", { class: normalizeClass(_ctx.$style.overlay) }, [createBaseVNode("div", { class: normalizeClass(_ctx.$style["consent-dialog"]) }, [
				...
				}, [!error.value && !clientDetails.value?.isFirstParty && clientDetails.value?.redirectUri ? (openBlock(), createBlock(unref(N8nCallout_default), {
					key: 0,
					theme: "warning",
