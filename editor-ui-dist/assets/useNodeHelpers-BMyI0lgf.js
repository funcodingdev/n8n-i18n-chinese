...
import { t as useLoadingService } from "./useLoadingService-DML3DvsZ.js";
import { t as createEventBus } from "./event-bus-CWhIcyjm.js";
import { Bi as isString, Et as useCredentialsStore, H as useNodeTypesStore, M as assignNodeId, O as injectWorkflowDocumentStore, ar as hasProxyAuth, er as getNodeSubtitle, v as injectWorkflowExecutionStateStore, z as useEnvFeatureFlag } from "./workflows.store-B9qpOmLv.js";
import { Ar as displayParameterPath, Fr as getNodeParameters, Ir as getNodeParametersIssues, Jr as makeNodeName, Mr as getConnectionTypes, Nr as getNodeInputs, Qr as nodeIssuesToString, Yr as mergeIssues, mi as NodeConnectionTypes, rn as classifyTriggerIdentity } from "./src-B2jBAc9z.js";
...
import { y as isObject } from "./typesUtils-erN5xbTj.js";
	...
	*/
	...
	function getBlockingTrigger() {
		...
		return triggers.some((trigger) => {
			const { providesN8nIdentity, providesExternalIdentity } = classifyTriggerIdentity(trigger.type, trigger.parameters, { isChatOAuth2Enabled: envFeatureFlag.value("CHAT_TRIGGER_OAUTH2") });
			return isSystemResolver ? !providesN8nIdentity : !providesExternalIdentity;
		}) ? { isSystemResolver } : null;
	}
	function collectPrivateCredentialIssues(node, foundIssues) {
		...
		for (const [credTypeName, details] of Object.entries(node.credentials ?? {})) {
			...
			if (blockingTrigger) {
				const messageKey = blockingTrigger.isSystemResolver ? "nodeIssues.credentials.privateRequiresIdentityTriggerWithFormAndWebhook" : "nodeIssues.credentials.privateRequiresIdentityExtractor";
