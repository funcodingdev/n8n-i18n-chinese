;
(function () {
  System.register(["./chunk-legacy-Re9CbdfL.js", "./vue.runtime.esm-bundler-legacy--Sn1h8On.js", "./_MapCache-legacy-BH2XE3uj.js", "./truncate-legacy-D4G74xLD.js", "./useTelemetry-legacy-CMfwYwVY.js", "./useToast-legacy-DHnOnoVM.js", "./constants-legacy-8iZaMHMx.js", "./_baseOrderBy-legacy-Bls-fMH1.js", "./useExternalHooks-legacy-CDDHCmE_.js", "./useWorkflowSaving-legacy-DzdfQKOS.js", "./retry-legacy-CTwsGM7o.js", "./executions.store-legacy-CXtma6rH.js", "./useCanvasOperations-legacy-DxrVUT4V.js"], function (_export, _context) {
    "use strict";

    var __toESM, computed, ref, watch, useI18n, useLocalStorage, require_get, EnableNodeToggleCommand, CanvasNodeDirtiness, AddNodeCommand, AddConnectionCommand, RemoveConnectionCommand, RemoveNodeCommand, BulkCommand, injectWorkflowState, useDocumentTitle, useHistoryStore, useSettingsStore, displayForm, STORES, useWorkflowHelpers, useWorkflowsStore, useTelemetry, isEmpty, useNodeHelpers, useToast, LOCAL_STORAGE_RUN_DATA_WORKER, createRunExecutionData, NodeConnectionTypes, IN_PROGRESS_EXECUTION_ID, createHeartbeatMessage, CHAT_TRIGGER_NODE_TYPE, generateNodesGraph, SINGLE_WEBHOOK_TRIGGERS, defineStore, useRootStore, useExternalHooks, useWorkflowSaving, retry, useExecutionsStore, useCanvasOperations, useHeartbeat, useReconnectTimer, useWebSocketClient, useEventSourceClient, proxyMarker, createEndpoint, releaseProxy, finalizer, throwMarker, isObject, transferHandlers, proxyCounter, proxyFinalizers, transferCache, worker, runDataWorker, usePushConnectionStore, LOCAL_STORAGE_AGENT_REQUESTS, useAgentRequestStore, import_get;
    ...
    */
    ...
    return {
      setters: [function (_chunkLegacy001Js) {
        ...
        LOCAL_STORAGE_RUN_DATA_WORKER = _constantsLegacy00TJs.Bs;
