...
import { ft as isToolMessage, pt as isWorkflowUpdatedMessage } from "./src-K-ysFfvA.js";
import { x as createEventBus, y as useRoute } from "./truncate-B6V3BCxD.js";
import { Ci as stringSizeInBytes, Do as CREDENTIAL_EDIT_MODAL_KEY, Fi as useUIStore, Ht as useCredentialsStore, Jr as getAuthTypeForNodeCredential, Jt as getSessionsMetadata, Kt as getAiSessions, Ni as codeNodeEditorEventBus, Sn as injectWorkflowState, Ut as chatWithAssistant, Wo as useSettingsStore, Wt as chatWithBuilder, Xt as useAIAssistantHelpers, Yr as getMainAuthField, Yt as replaceCode, a as useNDVStore, at as useNodeTypesStore, cc as STORES, i as usePostHog, nr as useUsersStore, o as useWorkflowsStore, qt as getBuilderCredits, t as useTelemetry } from "./useTelemetry-BptP8y2R.js";
import { t as useToast } from "./useToast-CgdJyGuK.js";
import { Aa as jsonParse, Da as deepCopy, Io as EDITABLE_CANVAS_VIEWS, Ro as VIEWS, c as PLACEHOLDER_EMPTY_WORKFLOW_ID, ci as require_pick, rc as AI_BUILDER_TEMPLATE_EXAMPLES_EXPERIMENT, t as DEFAULT_NEW_WORKFLOW_NAME } from "./constants-C1tPaXRr.js";
import { g as assert, k as defineStore, r as useRootStore } from "./_baseOrderBy-LtFDYziM.js";
