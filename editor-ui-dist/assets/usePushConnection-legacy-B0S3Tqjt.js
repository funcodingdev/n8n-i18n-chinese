;
(function () {
  System.register(["./vue.runtime.esm-bundler-legacy--Sn1h8On.js", "./_MapCache-legacy-CECtqMZe.js", "./useTelemetry-legacy-CA9g7cV_.js", "./useToast-legacy-fud3e81V.js", "./constants-legacy-B_3qSw5J.js", "./assistant.store-legacy-BPYcEf5X.js", "./_baseOrderBy-legacy-3SIYDICR.js", "./useExternalHooks-legacy-CqVTyuDp.js", "./useWorkflowSaving-legacy-DG7LbIVc.js", "./useRunWorkflow-legacy-B-BbtHyI.js", "./banners.store-legacy-Dg2M3sFe.js", "./schemaPreview.store-legacy-DQbhoQDA.js", "./aiTemplatesStarterCollection.store-legacy-L0CneupP.js", "./readyToRun.store-legacy-CL14Fipx.js"], function (_export, _context) {
    "use strict";

    var ref, useI18n, SampleTemplates, useUIStore, useCredentialsStore, getWorkflowVersion, isPrebuiltAgentTemplateId, codeNodeEditorEventBus, isTutorialTemplateId, injectWorkflowState, useDocumentTitle, useSettingsStore, clearPopupWindowState, useNodeTypesStore, getTriggerNodeServiceName, getExecutionErrorMessage, globalLinkActionsEventBus, useWorkflowHelpers, useWorkflowsStore, useTelemetry, getExecutionErrorToastConfiguration, parse, isValidNodeConnectionType, useNodeHelpers, sendGetWorkerStatus, useToast, isCommunityPackageName, createRunExecutionData, generateNodesGraph, EVALUATION_TRIGGER_NODE_TYPE, TRIMMED_TASK_DATA_CONNECTIONS_KEY, WORKFLOW_SETTINGS_MODAL_KEY, useBuilderStore, useAssistantStore, defineStore, useRootStore, useExternalHooks, useWorkflowSaving, usePushConnectionStore, useRunWorkflow, useBannersStore, useSchemaPreviewStore, useAITemplatesStarterCollectionStore, useReadyToRunStore, WORKER_HISTORY_LENGTH, STALE_SECONDS, useOrchestrationStore;
    ...
    */
    ...
    async function workflowActivated({
      ...
      if (workflowIsBeingViewed && activeVersionIsSet) {
        const activeVersion = await getWorkflowVersion(rootStore.restApiContext, workflowId, activeVersionId);
        workflowsStore.setWorkflowActive(workflowId, activeVersion, false);
        if (!uiStore.stateIsDirty) await workflowsStore.updateWorkflowChecksum();
      }
