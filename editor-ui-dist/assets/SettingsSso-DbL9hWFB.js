...
import { $ as openBlock, A as createTextVNode, At as isRef, C as createBaseVNode, E as createElementBlock, Ft as ref, H as mergeModels, N as defineComponent, S as computed, Sn as toDisplayString, T as createCommentVNode, Wt as unref, X as onMounted, _ as Fragment, _n as normalizeClass, bt as withDirectives, dt as useModel, gt as watch, h as withModifiers, j as createVNode, ot as resolveDirective, pt as useTemplateRef, rt as renderList, w as createBlock, yt as withCtx } from "./vue.runtime.esm-bundler-Bw8GKr4Y.js";
import { at as useI18n } from "./core-DJhPBFhT.js";
import { J as N8nInfoTip_default, Ji as N8nHeading_default, N as N8nRadioButtons_default, Pi as N8nActionBox_default, Qi as N8nIcon_default, Xi as N8nText_default, Zi as N8nButton_default, _t as N8nSelect_default, dt as Checkbox_default, ji as Input_default, st as onBeforeRouteLeave, vt as N8nOption_default, wt as N8nCard_default } from "./src-DJ-D-s3W.js";
import { t as _plugin_vue_export_helper_default } from "./_plugin-vue_export-helper-Da88TEg1.js";
import { Ln as useMessage, Pn as useToast, Rt as useDocumentTitle, fr as useTelemetry, mi as useRBACStore } from "./users.store-Cuk0qvvE.js";
import { t as ElDialog } from "./dialog-BmTZay0C.js";
import "./constants-fJx0oi9Z.js";
import { t as useRootStore } from "./useRootStore-udEbvQrW.js";
import { p as getUsers } from "./settings.store-CnuErby1.js";
...
import { n as useSSOStore, t as SupportedProtocols } from "./sso.store-Ueqej0zi.js";
...
var UserRoleProvisioningDropdown_default = /* @__PURE__ */ _plugin_vue_export_helper_default(UserRoleProvisioningDropdown_vue_vue_type_script_setup_true_lang_default, [["__cssModules", { "$style": UserRoleProvisioningDropdown_vue_vue_type_style_index_0_lang_module_default }]]);
//#endregion
...
function useUserRoleProvisioningForm(protocol) {
	...
	const getProvisioningConfigFromFormValue = (formValue) => {
		if (formValue === "instance_role") return {
			scopesProvisionInstanceRole: true,
			scopesProvisionProjectRoles: false
		};
		else if (formValue === "instance_and_project_roles") return {
			scopesProvisionInstanceRole: true,
...
var buttons = "_buttons_1blmf_134";
var group = "_group_1blmf_143";
var checkboxGroup = "_checkboxGroup_1blmf_159";
var actionBox$1 = "_actionBox_1blmf_163";
var footer = "_footer_1blmf_167";
...
var SamlSettingsForm_default = /* @__PURE__ */ _plugin_vue_export_helper_default(SamlSettingsForm_vue_vue_type_script_setup_true_lang_default, [["__cssModules", { "$style": sso_form_module_scss_vue_type_style_index_0_src_true_lang_module_default }]]);
	...
	setup(__props) {
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("div", _hoisted_1, [
				...
				}, [_cache[2] || (_cache[2] = createBaseVNode("label", null, "Select Authentication Protocol", -1)), createBaseVNode("div", null, [createVNode(unref(N8nSelect_default), {
					filterable: "",
				...
				unref(ssoStore).isEnterpriseSamlEnabled && authProtocol.value === unref(SupportedProtocols).SAML ? (openBlock(), createElementBlock("div", _hoisted_3, [createVNode(SamlSettingsForm_default, { ref: "samlForm" }, null, 512)])) : createCommentVNode("", true),
				unref(ssoStore).isEnterpriseOidcEnabled && authProtocol.value === unref(SupportedProtocols).OIDC ? (openBlock(), createElementBlock("div", _hoisted_4, [createVNode(OidcSettingsForm_default, { ref: "oidcForm" }, null, 512)])) : createCommentVNode("", true),
...
var SettingsSso_vue_vue_type_style_index_1_lang_module_default = {
	heading: "_heading_18pwa_125",
	actionBox: "_actionBox_18pwa_129",
	dialogFooter: "_dialogFooter_18pwa_133"
};
