...
import { $ as openBlock, A as createTextVNode, C as createBaseVNode, Cn as toDisplayString, E as createElementBlock, Gt as unref, It as ref, N as defineComponent, S as computed, T as createCommentVNode, X as onMounted, _ as Fragment, bt as withCtx, gt as watch, h as withModifiers, j as createVNode, p as vShow, rt as renderList, vn as normalizeClass, w as createBlock, xt as withDirectives } from "./vue.runtime.esm-bundler-CDDUUZhE.js";
import { s as useI18n } from "./src-Dh32dOY5.js";
import { Ja as N8nButton_default, Ki as N8nActionBox_default, Lt as N8nActionToggle_default, Ti as N8nBadge_default, Tt as N8nOption_default, Ya as N8nIcon_default, _t as useRouter, gt as useRoute, jt as N8nCard_default, qa as N8nText_default, vt as N8nInputLabel_default, wt as N8nSelect_default, yt as Checkbox_default, zi as N8nTooltip_default } from "./src-BVC_ZvSs.js";
import { t as _plugin_vue_export_helper_default } from "./_plugin-vue_export-helper-Da88TEg1.js";
import { t as useMessage } from "./useMessage-GjRAbz4G.js";
import { t as useToast } from "./useToast-CsW2zDDU.js";
import { Hl as getResourcePermissions, Zu as EnterpriseEditionFeature, ui as VIEWS } from "./constants-DzzWpyjZ.js";
import { _ as useNodeTypesStore, _i as isCredentialsResource, bn as useProjectsStore, hn as ResourceType, it as useCredentialsStore, mn as useEnvironmentsStore, xn as useSourceControlStore } from "./workflowDocument.store-BQc6YDGi.js";
import { t as useSettingsStore } from "./settings.store-DmallR-B.js";
import { U as CREDENTIAL_SELECT_MODAL_KEY, d as listenForModalChanges, f as useUIStore, j as PROJECT_MOVE_RESOURCE_MODAL, p as useTelemetry, t as useUsersStore } from "./users.store-CUxYM5yQ.js";
...
import { t as useInstanceAiCredentialHelp } from "./useInstanceAiCredentialHelp-BtLyttiZ.js";
import { t as useInsightsStore } from "./insights.store-ChcOnBja.js";
import { i as useProjectPages } from "./readyToRun.store-DmhGLP4T.js";
...
import { t as require_pickBy } from "./pickBy-CHo7KMes.js";
...
var CredentialCard_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props, { emit: __emit }) {
		...
		const isPrivateUnconnected = computed(() => isPrivateCredentialsEnabled.value && props.data.isResolvable === true && props.data.connectedByMe === false && credentialPermissions.value.update === true);
			...
			return openBlock(), createBlock(unref(N8nCard_default), {
				...
				header: withCtx(() => [createVNode(unref(N8nText_default), {
					...
					default: withCtx(() => [
						...
						unref(isPrivateCredentialsEnabled) && __props.data.isResolvable ? (openBlock(), createBlock(unref(N8nTooltip_default), {
							key: 2,
							placement: "top"
						}, {
							content: withCtx(() => [createBaseVNode("div", { class: normalizeClass(_ctx.$style.tooltipContent) }, [createBaseVNode("strong", null, toDisplayString(unref(locale).baseText("credentials.private.tooltipTitle")), 1), createBaseVNode("span", null, toDisplayString(unref(locale).baseText("credentials.private.tooltip")), 1)], 2)]),
...
var CredentialCard_vue_vue_type_style_index_0_lang_module_default = {
	cardLink: "_cardLink_qugpx_125",
	cardHeading: "_cardHeading_qugpx_135",
	cardDescription: "_cardDescription_qugpx_142",
	cardActions: "_cardActions_qugpx_149",
	dynamicBadgeText: "_dynamicBadgeText_qugpx_160",
	tooltipContent: "_tooltipContent_qugpx_169",
	cardBadge: "_cardBadge_qugpx_185"
};
