const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/pushConnection.store-DrEeyO9o.js","assets/pushConnection.store-_mvOXqWi.js","assets/vue.runtime.esm-bundler-Bs4WIMNP.js","assets/chunk-CC9Q-vWm.js","assets/src-CBdY4Anf.js","assets/get-RRgzF5vD.js","assets/_MapCache-aHDyP5Mf.js","assets/merge-BFzQnTDU.js","assets/expression-runtime-stub-D0JX5CsF.js","assets/__vite-browser-external-DLY6DjNi.js","assets/useRootStore-DmWgQ-mr.js","assets/lib-D10cRSie.js","assets/assert-Cfjx80o8.js","assets/settings.store-BDHsgqqf.js","assets/useDebounce-Cc58bOKS.js","assets/constants2-C4Gtqhrx.js","assets/durations-CAil8xsz.js","assets/settings.store-DzBUtpSv.js"])))=>i.map(i=>d[i]);
...
import { E as useWorkflowDocumentStore, S as createWorkflowDocumentId, Ur as getNodesWithNormalizedPosition, mn as useProjectsStore, n as buildExecutionResponseFromSchema, t as useWorkflowsStore, xt as useCredentialsStore, y as useWorkflowExecutionStateStore } from "./workflows.store-qPELvTeV.js";
...
import { t as isPostMessageOriginAllowed } from "./postMessageUtils-CO09tPQ6.js";
		...
		try {
			...
			if (json && json.command === "openWorkflow") try {
				...
				const { usePushConnectionStore } = await __vitePreload(async () => {
					const { usePushConnectionStore } = await import("./pushConnection.store-DrEeyO9o.js");
