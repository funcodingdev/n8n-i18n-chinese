;
(function () {
  System.register(["./vue.runtime.esm-bundler-legacy--Sn1h8On.js", "./_MapCache-legacy-By9GzIrR.js", "./useTelemetry-legacy-D11VqDwV.js", "./constants-legacy-CylJU6xq.js", "./useExternalHooks-legacy-DY4QJM8_.js", "./nodeCreator.store-legacy-_54soaLc.js"], function (_export, _context) {
    "use strict";

    var computed, useI18n, sortNodeCreateElements, useCanvasStore, injectWorkflowState, transformNodeType, useNodeTypesStore, useWorkflowsStore, PUSH_NODES_OFFSET, AI_CATEGORY_LANGUAGE_MODELS, OPEN_AI_ASSISTANT_NODE_TYPE, CHAT_TRIGGER_NODE_TYPE, NODE_CREATOR_OPEN_SOURCES, MANUAL_TRIGGER_NODE_TYPE, OPEN_AI_NODE_TYPE, AGENT_NODE_TYPE, SCHEDULE_TRIGGER_NODE_TYPE, BASIC_CHAIN_NODE_TYPE, OPEN_AI_NODE_MESSAGE_ASSISTANT_TYPE, NodeConnectionTypes, CHAIN_LLM_LANGCHAIN_NODE_TYPE, TRIGGER_NODE_CREATOR_VIEW, SPLIT_IN_BATCHES_NODE_TYPE, QA_CHAIN_NODE_TYPE, STICKY_NODE_TYPE, WEBHOOK_NODE_TYPE, NO_OP_NODE_TYPE, useExternalHooks, useNodeCreatorStore, useActions;
    return {
      setters: [function (_vueRuntimeEsmBundlerLegacy003Js) {
        ...
        OPEN_AI_ASSISTANT_NODE_TYPE = _constantsLegacy00TJs.Bn;
