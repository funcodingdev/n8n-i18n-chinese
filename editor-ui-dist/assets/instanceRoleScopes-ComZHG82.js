import { Ca as GLOBAL_CUSTOM_ROLE_SCOPE_GROUPS } from "./src-7oOw7OxE.js";
...
function findSubordinateOption(option, groupOptions) {
	const subordinateKey = Object.keys(SUPERSEDED_BY).find((key) => SUPERSEDED_BY[key] === option.key);
...
//#endregion
export { countGrantedInstancePermissions as a, resolveOptionState as c, TOTAL_INSTANCE_PERMISSIONS as i, toggleOptionInGroup as l, INSTANCE_SCOPE_GROUP_LIST as n, getEscalationWarningKey as o, SUPERSEDED_BY as r, isOptionImplied as s, ALL_INSTANCE_SCOPES as t };
