;
(function () {
  System.register(["./useTelemetry-legacy-Dj2fHQys.js", "./constants-legacy-wGNoFUi7.js"], function (_export, _context) {
    "use strict";
    ...
    */
    ...
    return {
      setters: [function (_useTelemetryLegacy00HJs) {
        ...
        AI_MCP_TOOL_NODE_TYPE = _constantsLegacy00TJs.Ft;
        displayParameter = _constantsLegacy00TJs.Xi;
        AI_CODE_TOOL_LANGCHAIN_NODE_TYPE = _constantsLegacy00TJs.lt;
        getNodeParameters = _constantsLegacy00TJs.ta;
        traverseNodeParameters = _constantsLegacy00TJs.wi;
        WIKIPEDIA_TOOL_NODE_TYPE = _constantsLegacy00TJs.yr;
      }],
      execute: function () {}
    };
  });
