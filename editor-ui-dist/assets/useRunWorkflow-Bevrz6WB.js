...
import { M as useLocalStorage, yt as useI18n } from "./_MapCache-BRoeWkyP.js";
import { f as require_get } from "./src-BNc_2bHf.js";
import { Lt as injectWorkflowState, Mt as useNodeHelpers, Nt as useTelemetry, Tt as useWorkflowHelpers, Yi as isEmpty, _r as useExternalHooks, ai as BulkCommand, cn as useDocumentTitle, ei as CanvasNodeDirtiness, fs as useSettingsStore, hr as useToast, ii as AddNodeCommand, li as RemoveConnectionCommand, ln as useWorkflowSaving, m as displayForm, ni as useHistoryStore, ri as AddConnectionCommand, s as useWorkflowsStore, si as EnableNodeToggleCommand, ui as RemoveNodeCommand } from "./users.store-Xk7McM6o.js";
import { $a as NodeConnectionTypes, $n as RESPOND_TO_WEBHOOK_NODE_TYPE, Ht as CHAT_TOOL_NODE_TYPE, Ji as createRunExecutionData, M as IN_PROGRESS_EXECUTION_ID, Mi as createResultOk, Ut as CHAT_TRIGGER_NODE_TYPE, Vt as CHAT_NODE_TYPE, ea as generateNodesGraph, ji as createResultError, oo as BINARY_MODE_COMBINED } from "./constants-B-_GdCoL.js";
import { A as defineStore, p as request, r as useRootStore } from "./_baseOrderBy-Bs_4IhiB.js";
...
import { t as retry } from "./retry-B3ViF53D.js";
	...
	async function runWorkflow(options) {
		...
		try {
			...
			if (options.triggerNode === chatTriggerNode?.name && chatTriggerNodeOptions?.responseMode === "responseNodes") {
				if (!workflowData.nodes.filter((node) => !node.disabled && (node.type === "@n8n/n8n-nodes-langchain.chat" || node.type === "@n8n/n8n-nodes-langchain.chatTool" || node.type === "n8n-nodes-base.respondToWebhook"))?.length) toast.showMessage({
