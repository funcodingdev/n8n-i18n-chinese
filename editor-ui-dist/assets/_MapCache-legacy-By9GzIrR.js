      ...
      execute: function () {
        ...
        */
        ...
        zh_CN_default = {
          ...
          "chatHub.agent.card.badge.n8nWorkflow": "n8n 工作流",
          "chatHub.agent.card.badge.customAgent": "自定义代理",
          ...
          "chatHub.agents.title": "自定义代理",
          "chatHub.agents.description": "使用 n8n 工作流代理或创建具有特定指令和行为的自定义 AI 代理。",
          "chatHub.agents.button.newAgent": "新代理人",
          "chatHub.agents.search.placeholder": "搜索",
          "chatHub.agents.filter.all": "全部",
          "chatHub.agents.filter.customAgents": "自定义代理",
          "chatHub.agents.filter.n8nWorkflows": "n8n 工作流",
          "chatHub.agents.sort.updatedAt": "按最后更新时间排序",
          "chatHub.agents.sort.createdAt": "按创建时间排序",
          "chatHub.agents.empty.noAgents": "没有可用的代理。创建您的第一个自定义代理以开始。",
          ...
          "chatHub.sidebar.link.customAgents": "自定义代理",
          ...
          "settings.mcp.workflows.table.empty.description": "在每个工作流的设置中启用 MCP 访问，以便在这里查看它们。",
