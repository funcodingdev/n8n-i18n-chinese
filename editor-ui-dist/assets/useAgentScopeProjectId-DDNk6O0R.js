...
import { Et as useCredentialsStore, O as injectWorkflowDocumentStore, bn as useProjectsStore } from "./workflows.store-C0TGOSWn.js";
...
import { T as listAgentsPage, d as getAgent } from "./useAgentApi-C6kFPtBY.js";
...
function useQuickConnect() {
	...
	async function connectToPinecone(quickConnectOption) {
		const { ConnectPopup } = await __vitePreload(async () => {
			const { ConnectPopup } = await import("./dist-Ck202Mxy.js");
			return { ConnectPopup };
		}, []);
