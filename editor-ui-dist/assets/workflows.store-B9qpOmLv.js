const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/workers-C5G6JM1o.js","assets/comlink-BYGvqRui.js"])))=>i.map(i=>d[i]);
...
import { i as i18n, n as addHeaders, r as addNodeTranslation, s as useI18n } from "./src-CYuJrkB5.js";
...
import { b as require_isArrayLike, t as require_merge } from "./merge-DTabss4r.js";
import { Ai as sleep$1, Ao as require_memoize, Ar as displayParameterPath, Cr as resolveVariables, Er as getChildNodes, Fi as UnexpectedError, Fr as getNodeParameters, Jn as createEmptyRunExecutionData, Ln as isTrimmedNodeExecutionData, Lr as getNodeWebhookUrl, Mr as getConnectionTypes, Mt as require_pick, Ni as ExpressionError, Nr as getNodeInputs, Or as checkConditions, Pr as getNodeOutputs, Qr as nodeIssuesToString, Rt as isAssignmentCollectionValue, Sa as getResourcePermissions, Vt as normalizeNodeShape, Wi as CHAT_TRIGGER_NODE_TYPE, Wr as isHitlToolType, Wt as Workflow, Yn as createRunExecutionData, Zt as require__baseIteratee, _i as traverseNodeParameters, an as normalizeGroupDescription, ca as WAIT_INDEFINITELY, di as isResourceLocatorValue, dn as require__baseUniq, fa as require_isEqual, fi as isResourceMapperValue$1, hi as nodeConnectionTypes, ii as isFilterValue, jr as getActiveCredentialTypes, kr as displayParameter, ma as require_keys, mi as NodeConnectionTypes, mn as require__baseFindIndex, oa as SEND_AND_WAIT_OPERATION, ra as MANUAL_TRIGGER_NODE_TYPE, ua as v4, un as splitExpression, vi as isExpression, wo as require_get, wr as mapConnectionsByDestination, xi as deepCopy } from "./src-B2jBAc9z.js";
import { c as sanitizeHtml } from "./htmlUtils-B4dfkzSm.js";
import { Ct as getNodeParameterActionResult, Dt as getNodesInformation, Et as getNodeTypes$1, Ot as getResourceLocatorResults, Qn as makeRestApiRequest, St as getLocalResourceMapperFields, Tt as getNodeTranslationHeaders, Yn as ResponseError, Zn as getFullApiResponse, a as getWorkflowVersion, bt as fetchCommunityNodeAttributes, c as findWebhook, fr as defineStore, ir as axios, kt as getResourceMapperFields, lr as STORES, nr as streamRequest, pr as getActivePinia, qt as getProjectSecretProviderConnectionsByProjectId, t as useRootStore, w as updateCurrentUserSettings, wt as getNodeParameterOptions, xt as fetchCommunityNodeTypes } from "./useRootStore-B4L7-X8D.js";
...
import { D as TEMPLATES_NODES_FILTER, Dt as AI_MCP_TOOL_NODE_TYPE, F as CUSTOM_API_CALL_KEY, G as AI_CATEGORY_HUMAN_IN_THE_LOOP, I as DATA_TYPE_ICON_MAP, Jt as ERROR_TRIGGER_NODE_TYPE$1, M as IN_PROGRESS_EXECUTION_ID, Ma as INLINE_AGENTS_EXPERIMENT, N as PLACEHOLDER_FILLED_AT_EXECUTION_TIME, Ot as AI_TRANSFORM_NODE_TYPE, Pn as SCHEDULE_TRIGGER_NODE_TYPE, R as MAPPING_PARAMS, Rr as MAIN_HEADER_TABS, Rt as CREDENTIAL_ONLY_NODE_PREFIX, V as AI_CATEGORY_AGENTS, Xn as WIKIPEDIA_TOOL_NODE_TYPE, Y as AI_CATEGORY_OTHER_TOOLS, Yn as WEBHOOK_NODE_TYPE$1, Zn as WORKFLOW_TRIGGER_NODE_TYPE, _n as MODULE_ENABLED_NODES, _t as RECOMMENDED_NODES, ct as BETA_NODES, ft as HITL_SUBCATEGORY, ga as WorkflowIdKey, ha as WorkflowDocumentStoreKey, hn as MESSAGE_AN_AGENT_NODE_TYPE, i as DUPLICATE_POSTFFIX, ln as LIST_LIKE_NODE_OPERATIONS, lt as CORE_NODES_CATEGORY, nt as AI_CODE_TOOL_LANGCHAIN_NODE_TYPE, oa as CanvasRenderDataKey, pt as HUMAN_IN_THE_LOOP_CATEGORY, q as AI_CATEGORY_MCP_NODES, r as DEFAULT_SETTINGS, rn as HTTP_REQUEST_NODE_TYPE, ro as EnterpriseEditionFeature, tn as FORM_TRIGGER_NODE_TYPE$1, tt as AI_CATEGORY_VECTOR_STORES, xn as NON_ACTIVATABLE_TRIGGER_NODE_TYPES, yn as NODE_POSITION_CONFLICT_ALLOWLIST } from "./constants-DOw6b_w2.js";
import { l as TIME } from "./durations-xVQWCRRO.js";
import { i as require_toNumber } from "./useDebounce-C8k0g3s4.js";
import { c as isEmpty, d as isPresent, h as stringSizeInBytes, m as shorten, p as omit, u as isJsonKeyObject, v as getObjectSizeInKB, y as isObject$1 } from "./typesUtils-erN5xbTj.js";
import { a as getNewWorkflow, i as getLastSuccessfulExecution, l as getWorkflows, n as useFavoritesStore, r as getExecutionData, t as useWorkflowsListStore } from "./workflowsList.store-5H3D_H0z.js";
import { C as CANCELLABLE_EXECUTION_STATUSES, n as useUIStore } from "./ui.store-Ba5vGKex.js";
import { c as hasRole, t as hasPermission } from "./permissions-mmrrpFFJ.js";
import { o as require_startCase, t as useEvaluationStore } from "./evaluation.store-f-PNgRBZ.js";
import { n as noCase } from "./dist-dUcNVZjh.js";
import { t as require_sortBy } from "./sortBy-DipEZO3r.js";
	...
	const loadNodesInformationFromLocalDb = async (nodeInfos) => {
		try {
			const { getNodeType } = await __vitePreload(async () => {
				const { getNodeType } = await import("./workers-C5G6JM1o.js");
				return { getNodeType };
			}, __vite__mapDeps([0,1]));
			const found = [];
			const missing = [];
	...
	const loadNodeTypesFromLocalDb = async () => {
		try {
			const { loadNodeTypes, getAllNodeTypes } = await __vitePreload(async () => {
				const { loadNodeTypes, getAllNodeTypes } = await import("./workers-C5G6JM1o.js");
				return {
					loadNodeTypes,
					getAllNodeTypes
				};
