;
(function () {
  System.register(["./vue.runtime.esm-bundler-legacy--Sn1h8On.js", "./_MapCache-legacy-gleHKmVW.js", "./useTelemetry-legacy-DnSAoKz5.js", "./useToast-legacy-Ce_kWqRg.js", "./constants-legacy-BWxkEIkt.js", "./_baseOrderBy-legacy-D_9iEaXg.js", "./useExternalHooks-legacy-CISqywdp.js"], function (_export, _context) {
    "use strict";

    var computed, unref, useI18n, stringSizeInBytes, useDataSchema, useNodeTypesStore, useWorkflowsStore, useTelemetry, toMegaBytes, useToast, jsonParse, MAX_PINNED_DATA_SIZE, NodeConnectionTypes, PIN_DATA_NODE_TYPES_DENYLIST, MAX_WORKFLOW_SIZE, jsonStringify, getNodeOutputs, isSubNodeType, MAX_EXPECTED_REQUEST_SIZE, useRootStore, useExternalHooks;
    ...
    return {
      setters: [function (_vueRuntimeEsmBundlerLegacy003Js) {
        ...
        MAX_PINNED_DATA_SIZE = _constantsLegacy00TJs.Js;
        NodeConnectionTypes = _constantsLegacy00TJs.Ka;
        PIN_DATA_NODE_TYPES_DENYLIST = _constantsLegacy00TJs.Kn;
        MAX_WORKFLOW_SIZE = _constantsLegacy00TJs.Ys;
        jsonStringify = _constantsLegacy00TJs.ja;
        getNodeOutputs = _constantsLegacy00TJs.na;
        isSubNodeType = _constantsLegacy00TJs.pa;
        MAX_EXPECTED_REQUEST_SIZE = _constantsLegacy00TJs.qs;
