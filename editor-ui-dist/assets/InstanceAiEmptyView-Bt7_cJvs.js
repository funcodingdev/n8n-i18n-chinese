...
import { n as useChatInputAutoFocus } from "./N8nChatInput-D2k_CXfi.js";
...
import { bn as useProjectsStore } from "./workflows.store-Dti-Ds2u.js";
...
import { io as v4 } from "./src-BrbN-vPn.js";
import { t as isIconOrEmoji } from "./types-BozgK3KO.js";
import { fr as storeToRefs, sr as STORES, t as useRootStore, ur as defineStore, z as getInstanceAiExamples } from "./useRootStore-B-A2Ktsc.js";
...
import { Ba as INSTANCE_AI_PERSONALIZED_PROMPT_SUGGESTIONS_EXPERIMENT, Ha as INSTANCE_AI_PROMPT_SUGGESTIONS_V2_EXPERIMENT, Ra as INSTANCE_AI_FREE_NUDGE_EXPERIMENT, Ua as INSTANCE_AI_SPLIT_EMPTY_STATE_EXPERIMENT, Va as INSTANCE_AI_PROACTIVE_AGENT_EXPERIMENT, Wa as INSTANCE_AI_TEMPLATE_EXAMPLES_EXPERIMENT, ht as NODE_CREATOR_OPEN_SOURCES } from "./constants-Bwbcx8Ih.js";
...
import { a as trackTemplatesClick, n as getExperimentTelemetryPayload, t as TemplateClickSource } from "./utils-BSOWYVGG.js";
...
import { S as isInstanceAiThreadSource, g as INSTANCE_AI_THREAD_VIEW, h as INSTANCE_AI_SOURCE_QUERY, p as INSTANCE_AI_PROJECT_ID_QUERY } from "./constants-D5OEjQEP.js";
import { t as useInstanceAiSettingsStore } from "./instanceAiSettings.store-BbR4Z44G.js";
import { a as countAttachedNodes, n as useInstanceAiStore } from "./instanceAi.store-B4NJFK-a.js";
import { t as CreditWarningBanner_default } from "./CreditWarningBanner-DAV87wFI.js";
import { a as useInstanceAiPromptSuggestionsTelemetry, n as InstanceAiViewHeader_default, o as useCreditWarningBanner, r as InstanceAiInput_default, t as WorkflowBuilderUnavailableNotice_default } from "./WorkflowBuilderUnavailableNotice-Br_y0JYp.js";
...
var InstanceAiEmptyView_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		...
		function restoreDraftAfterFailedSubmit(message, restoreDraft) {
			nextTick(() => {
				if (!restoreDraft?.()) chatInputRef.value?.setTextIfEmpty(message);
				chatInputRef.value?.focus();
			});
		}
		async function handleSubmit(message, attachments, restoreDraft) {
			...
			if (!await store.getOrCreateRuntime(threadId, selectedProject.value).sendMessage(finalMessage, attachments, rootStore.pushRef)) {
				isStartingThread.value = false;
				restoreDraftAfterFailedSubmit(message, restoreDraft);
