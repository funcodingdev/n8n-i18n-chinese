...
import { gt as useI18n, j as useLocalStorage } from "./_MapCache-CAfqzBzS.js";
import { b as useRouter, x as createEventBus, y as useRoute } from "./truncate-Expo7HS3.js";
import { Bo as v4_default, Dr as AddNodeCommand, En as useProjectsStore, Er as AddConnectionCommand, Fi as useUIStore, Fr as ReplaceNodeParametersCommand, Gn as useCanvasStore, Ht as useCredentialsStore, Mr as RemoveConnectionCommand, Nr as RemoveNodeCommand, Pr as RenameNodeCommand, S as getNodesGroupSize, Sn as injectWorkflowState, Sr as CanvasConnectionMode, Ti as tryToParseNumber, Tr as useHistoryStore, Wo as useSettingsStore, Zt as useDataSchema, _n as useTagsStore, a as useNDVStore, at as useNodeTypesStore, b as getNewNodePosition, bi as isPresent, d as DEFAULT_VIEWPORT_BOUNDARIES, f as GRID_SIZE, h as generateOffsets, i as usePostHog, jr as MoveNodeCommand, l as CONFIGURATION_NODE_SIZE, mn as useWorkflowHelpers, o as useWorkflowsStore, p as PUSH_NODES_OFFSET, q as isChatNode, s as CONFIGURABLE_NODE_SIZE, t as useTelemetry, tt as getExecutionErrorToastConfiguration, u as DEFAULT_NODE_SIZE, vr as isValidNodeConnectionType, wr as CanvasNodeRenderType, xn as useNodeHelpers } from "./useTelemetry-D9a28yOh.js";
import { t as useToast } from "./useToast-DXe0x66s.js";
import { As as LOCAL_STORAGE_LOGS_PANEL_DETAILS_PANEL, Ci as require_cloneDeep, Da as deepCopy, Io as VIEWS, Ka as NodeConnectionTypes, Mi as require__baseUniq, Ms as LOCAL_STORAGE_LOGS_PANEL_OPEN, Ns as LOCAL_STORAGE_LOGS_SYNC_SELECTION, Oa as isCommunityPackageName, Zi as generateNodesGraph, _c as EnterpriseEditionFeature, _r as UPDATE_WEBHOOK_ID_NODE_TYPES, ca as getSubworkflowId, dr as STICKY_NODE_TYPE, ea as getConnectionTypes, fn as FORM_TRIGGER_NODE_TYPE, js as LOCAL_STORAGE_LOGS_PANEL_DETAILS_PANEL_SUB_NODE, kn as MCP_TRIGGER_NODE_TYPE, na as getNodeOutputs, ra as getNodeParameters, rc as CANVAS_ZOOMED_VIEW_EXPERIMENT, sc as NDV_IN_FOCUS_PANEL_EXPERIMENT, ta as getNodeInputs, yr as WEBHOOK_NODE_TYPE } from "./constants-BAGpYMn9.js";
...
import { a as mapCanvasConnectionToLegacyConnection, l as parseCanvasConnectionHandleString, o as mapLegacyConnectionToCanvasConnection, r as createCanvasConnectionHandleString, s as mapLegacyConnectionsToCanvasConnections, t as useNodeCreatorStore } from "./nodeCreator.store-D_-f2TyB.js";
