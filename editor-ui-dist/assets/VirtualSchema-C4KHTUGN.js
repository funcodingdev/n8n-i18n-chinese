...
import { C as computed, Cn as toDisplayString, Ct as withScopeId, D as createElementBlock, E as createCommentVNode, G as nextTick, Gt as unref, I as guardReactiveProps, It as ref, L as h, Lt as shallowReactive, M as createVNode, Mt as markRaw, P as defineComponent, T as createBlock, Ut as toValue, W as mergeProps, _ as Fragment, _t as watch, at as renderSlot, bn as normalizeStyle, bt as withCtx, ct as resolveDynamicComponent, et as openBlock, h as withModifiers, it as renderList, j as createTextVNode, l as useCssVars, lt as toHandlers, ot as resolveComponent, pt as useSlots, rt as pushScopeId, st as resolveDirective, tt as popScopeId, vn as normalizeClass, w as createBaseVNode, xt as withDirectives, yn as normalizeProps } from "./vue.runtime.esm-bundler-XtMkEjzB.js";
import { bt as I18nT, h as computedAsync, yt as useI18n } from "./_MapCache-DwkzWRqU.js";
import { Di as useRouter, Gi as N8nButton_default, Ki as N8nIcon_default, Ui as N8nCallout_default, Wi as N8nText_default, ji as N8nTooltip_default, yi as N8nLink_default } from "./src-GXsra_I5.js";
import { t as __plugin_vue_export_helper_default } from "./_plugin-vue_export-helper-DltO58Gh.js";
import { Bt as injectWorkflowState, Er as useToast, Fr as require_FileSaver_min, Ft as useNodeHelpers, It as useTelemetry, Jr as injectWorkflowDocumentStore, Mr as useMessage, Nt as environments_store_default, Or as useExternalHooks, Vi as executionDataToJson, fn as nodeViewEventBus, js as useSettingsStore, lt as useDataSchema, r as useUIStore, s as useWorkflowsStore, st as generateCodeForPrompt, ut as useFlattenSchema, w as useNodeTypesStore, ya as isEmpty, zt as useNDVStore } from "./users.store-DSeNCs16.js";
import { C as SCHEMA_PREVIEW_DOCS_URL, Go as ApplicationError, Gt as CHAT_TRIGGER_NODE_TYPE, Mn as MANUAL_TRIGGER_NODE_TYPE, Ni as createResultError, Os as MODAL_CONFIRM, P as PLACEHOLDER_FILLED_AT_EXECUTION_TIME, _o as AI_TRANSFORM_CODE_GENERATED_FOR_PROMPT, al as EnterpriseEditionFeature, do as DateTime, ds as BINARY_DATA_VIEW_MODAL_KEY, fo as NodeConnectionTypes, gn as FORM_TRIGGER_NODE_TYPE, vo as AI_TRANSFORM_JS_CODE, wr as WEBHOOK_NODE_TYPE, xi as require_pick, xs as FROM_AI_PARAMETERS_MODAL_KEY, yo as AI_TRANSFORM_NODE_TYPE } from "./constants-DFXtU1Pw.js";
import { r as useRootStore } from "./_baseOrderBy-COGSHfpp.js";
import { i as Ln, o as gu, r as estree_exports, t as NDVEmptyState_default } from "./NDVEmptyState-DBcaOHDZ.js";
...
import { t as TextWithHighlights_default } from "./TextWithHighlights-BDR8iVWT.js";
import { t as useCalloutHelpers } from "./useCalloutHelpers-CCKtBG3s.js";
import { n as MappingPill_default, t as useTelemetryContext } from "./useTelemetryContext-Crb1oPM1.js";
import { i as useSchemaPreviewStore, t as useRunWorkflow } from "./useRunWorkflow-DjJ0mX2w.js";
import { o as needsAgentInput } from "./nodeTransforms-CCNM4SLN.js";
