...
import { $ as openBlock, A as createTextVNode, C as createBaseVNode, Cn as toDisplayString, E as createElementBlock, Gt as unref, It as ref, N as defineComponent, S as computed, T as createCommentVNode, _ as Fragment, bt as withCtx, gt as watch, j as createVNode, p as vShow, rt as renderList, vn as normalizeClass, w as createBlock, xt as withDirectives } from "./vue.runtime.esm-bundler-Bs4WIMNP.js";
import { J as useDebounceFn, ot as useI18n } from "./core-C5b2s2m3.js";
import { $a as N8nHeading_default, $i as N8nIconButton_default, $t as ElSwitch, Ji as N8nTooltip_default, Qi as Input_default, no as N8nButton_default, ro as N8nIcon_default, to as N8nText_default, x as N8nInlineTextEdit_default } from "./src-BR3WX5fi.js";
import { t as _plugin_vue_export_helper_default } from "./_plugin-vue_export-helper-Da88TEg1.js";
import { t as useMessage } from "./useMessage-B-SXT3B3.js";
import { t as useToast } from "./useToast-D9a-cCgr.js";
import { bl as NodeConnectionTypes, cf as getDebounceTime, co as CHAT_USER_BLOCKED_CHAT_HUB_TOOL_TYPES, ef as DEBOUNCE_TIME, fu as v4, so as ALWAYS_BLOCKED_CHAT_HUB_TOOL_TYPES } from "./constants-CSBjw1Ht.js";
import { _ as useNodeTypesStore } from "./workflowDocument.store-xeTT7tms.js";
import { u as hasRole } from "./users.store-DWiPI9j5.js";
...
import { t as NodeToolSettingsContent_default } from "./NodeToolSettingsContent-BNeLMq8i.js";
...
var ToolsManagerModal_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		...
		const availableToolTypes = computed(() => {
			return (nodeTypesStore.visibleNodeTypesByOutputConnectionTypeNames[NodeConnectionTypes.AiTool] ?? []).map((name) => nodeTypesStore.getNodeType(name)).filter((nodeType) => nodeType !== null && !excludedToolTypes.value.includes(nodeType.name) && !hasInputs(nodeType)).sort((a, b) => {
