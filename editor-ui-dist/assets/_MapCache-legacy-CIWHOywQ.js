      ...
      execute: function () {
        ...
        */
        ...
        zh_CN_default = {
          ...
          "activationModal.workflowPublished": "工作流程已发布",
          ...
          "banners.workflowAutoDeactivated.message": "由于多次执行崩溃，此工作流已自动禁用。请检查并在准备好后重新激活它。",
          ...
          "chatHub.agent.credentialsMissing": "凭据缺失",
          ...
          "chatHub.agents.delete.confirm.message": "您确认要删除这个代理吗？",
          ...
          "chatHub.agents.empty.noAgents": "没有可用的代理。创建您的第一个自定义代理以开始使用。",
          ...
          "chatHub.chat.prompt.callout.selectModel.new": "请 {link} 以开始对话。",
          "chatHub.chat.prompt.callout.selectModel.new.link": "选择一个模型",
          "chatHub.chat.prompt.callout.selectModel.existing": "请 {link} 以继续对话。",
          "chatHub.chat.prompt.callout.selectModel.existing.link": "重新选择模型",
          "chatHub.chat.prompt.callout.setCredentials.new": "请 {link} 联系 {provider} 开始对话",
          "chatHub.chat.prompt.callout.setCredentials.new.link": "设置凭据",
          "chatHub.chat.prompt.callout.setCredentials.existing": "请 {link} 以继续与 {provider} 的对话。",
          "chatHub.chat.prompt.callout.setCredentials.existing.link": "设置凭据",
          "chatHub.chat.prompt.button.attach": "附件",
          ...
          "chatHub.chat.prompt.placeholder.withModel": "信息 {model}...",
          ...
          "workflow.description.placeholder": "描述这个工作流的目的和功能。",
          "workflow.description.placeholder.mcp": "为了帮助MCP客户了解何时使用此工作流，请添加一个简短的工作流描述，说明它的功能。",
          ...
          "mcp.productionChecklist.workflow.description": "允许MCP客户端访问这个工作流程",
          ...
          "nodeCredentials.deleteCredential.permissionDenied": "您当前的角色不允许您删除凭证。",
          ...
          "nodeWebhooks.showMessage.testWebhookUrl": "此节点仅支持生产环境的网络钩子。",
          ...
          "oauth.consentView.heading": "{clientName} 想要访问您的 n8n 实例",
          ...
          "oauth.consentView.action.executeWorkflows": "代表您执行工作流程",
          "oauth.consentView.readMore": "阅读更多 <a href='{docsUrl}' target='_blank'>这里</a>",
          "oauth.consentView.error.deny": "拒绝访问错误",
          "oauth.consentView.error.allow": "错误，无法允许访问",
          ...
          "projectRoles.dataTable:read.tooltip": "查看数据表的结构（列、名称）以及查看元数据",
          ...
          "settings.mcp.toggle.disabled.notice": "让像 Claude、Lovable 和其他 AI 工具的 MCP 客户发现并执行你的 n8n 工作流。",
          ...
          "settings.mcp.oAuthClients.revoke.success.title": "访问已被撤销",
          "settings.mcp.oAuthClients.revoke.success.message": "客户 {name} 的访问权限已被撤销。",
          "settings.mcp.oAuthClients.revoke.error": "撤销客户端访问时出现错误",
          "settings.mcp.oAuthClients.table.empty.title": "没有连接的OAuth客户端",
          "settings.mcp.refresh.tooltip": "刷新列表",
          "settings.mcp.workflowsTable.workflow": "工作流",
          "settings.chatHub": "聊天",
          "settings.chatHub.providers.fetching.error": "获取聊天服务提供商设置时出错",
          "settings.chatHub.providers.updated.success": "聊天提供者设置已更新",
          "settings.chatHub.providers.updated.error": "更新聊天提供者设置时出错",
          "settings.chatHub.providers.table.provider": "供应商",
          "settings.chatHub.providers.table.models": "模型",
          "settings.chatHub.providers.table.createdAt": "创建的",
          "settings.chatHub.providers.table.updatedAt": "最后编辑时间",
          ...
          "settings.chatHub.providers.table.empty.title": "未配置聊天服务提供商",
          "settings.chatHub.providers.table.empty.description": "配置聊天服务提供商以限制可用的模型和凭据。",
          ...
          "settings.chatHub.providers.modal.edit.enabled.tooltip": "当禁用时，该提供商的模型将在聊天中不可用。",
          ...
          "settings.chatHub.providers.modal.edit.limitModels.tooltip": "启用后，仅可选定的模型将在聊天中可用。",
          ...
          "settings.chatHub.providers.table.models.more": "和 {count} 个其他人",
          "settings.goBack": "返回",
          ...
          "settings.personal.role.tooltip.chatUser": "仅限访问聊天功能",
          ...
          "settings.users.userRoleUpdated.confirm.message": "你确定要将用户更改为 {role} 吗？这将撤销他们当前的项目角色。",
          ...
          "settings.users.table.row.role.description.chatUser": "可以使用聊天，但无法创建或查看工作流或访问其他功能。",
          ...
          "settings.provisioningConfirmDialog.disable.title": "仅在 n8n 中管理用户角色的配置",
          "settings.provisioningConfirmDialog.breakingChangeDescription.firstSentence.partOne": "您的单点登录供应商将控制 n8n 中的所有用户角色。",
          "settings.provisioningConfirmDialog.breakingChangeDescription.firstSentence.partOne.withProjectRoles": "您的单点登录提供商将控制 n8n 中所有用户和项目角色。",
          "settings.provisioningConfirmDialog.breakingChangeDescription.firstSentence.partTwo": "未由您的SSO提供者分配的角色将默认为全球:成员。",
          "settings.provisioningConfirmDialog.breakingChangeDescription.secondLine": "<b>启用之前：</b> 下载并查看您当前的访问设置，确保您的单点登录（SSO）提供商配置正确。",
          "settings.provisioningConfirmDialog.disable.description": "您正在将实例角色管理从单点登录（SSO）切换回 n8n。",
          "settings.provisioningConfirmDialog.enable.checkbox": "我已经下载并审核了CSV导出文件。我的SSO提供商已正确配置以控制此n8n实例上的用户角色。",
          "settings.provisioningConfirmDialog.disable.checkbox": "我确认我不再希望从我的SSO提供商处分配用户角色。",
          ...
          "settings.provisioningInstanceRolesHandledBySsoProvider.description": "用户管理和实例角色由您的SSO提供商控制。请联系您的n8n实例所有者或管理员以进行更改。",
          ...
          "settings.migrationReport.description": "您已有 {compatibleCount} 个工作流与版本 2.0.0 兼容，您的总工作流数量为 {totalCount}。请查看下面的详细信息，以了解并解决任何兼容性问题。了解有关我们所有重大更改的更多信息。",
          ...
          "settings.migrationReport.workflowTooltip.critical": "受影响的工作流在更新后会中断。您需要更新或替换受影响的节点。",
          "settings.migrationReport.workflowTooltip.medium": "工作流仍然可以运行，但可能会产生不正确的结果。在更新之前请审查和测试。",
          "settings.migrationReport.workflowTooltip.low": "行为在特定情况下可能会略有变化。大多数工作流将按预期继续运行。",
          "settings.migrationReport.instanceTooltip.critical": "此问题可能会阻止实例在更新后启动或正常工作。在继续之前必须修复。",
          "settings.migrationReport.instanceTooltip.medium": "这可能会影响性能、兼容性或连接的服务。如果与您的设置相关，请进行检查和修复。",
          ...
          "settings.migrationReport.emptyInstanceIssues.description": "您的实例与 2.0.0 版本完全兼容。您可以开始使用了！",
          "settings.migrationReport.documentation": "文档",
          "settings.migrationReport.workflowsCount": "{count} 工作流 | {count} 个工作流",
          "settings.migrationReport.detail.affectedTag": "{count} 受到影响",
          ...
          "settings.migrationReport.detail.table.deactivated": "已禁用",
          ...
          "settings.migrationReport.detail.table.never": "永远不",
          ...
          "workflowSettings.timeSavedPerExecution.tab.fixed": "固定的",
          "workflowSettings.timeSavedPerExecution.tab.conditional": "条件",
          "workflowSettings.timeSavedPerExecution.noNodesDetected": "未检测到已保存的节点",
          "workflowSettings.timeSavedPerExecution.noNodesDetected.hint": "添加一个或多个时间节省节点以动态计算节省的时间",
          "workflowSettings.timeSavedPerExecution.nodesDetected": "当前设置的有效节点已节省 {count} 次时间",
          ...
          "workflowSettings.timeSavedPerExecution.fixedTabWarning": "有一个或多个 {link} 动态计算这个工作流节省的时间。虽然您的工作流配置了固定的节省时间值，但这些节点将被忽略。",
          ...
          "workflowHistory.item.publishedAtLabel": "发布：",
          "workflowHistory.item.actions.restore": "恢复此版本",
          "workflowHistory.item.actions.publish": "发布此版本",
          "workflowHistory.item.actions.unpublish": "取消发布工作流程",
          ...
          "workflowHistory.action.unpublish.modal.description": "这将阻止所有生产环境对该工作流的执行，直到你再次发布。",
          "workflowHistory.action.unpublish.modal.button.unpublish": "撤销发布",
          "workflowHistory.button.tooltip.empty": "此工作流当前没有历史记录可供查看。完成第一次保存后，您将可以查看以前的版本",
          "workflowHistory.button.tooltip": "工作流历史记录以查看和恢复您工作流的先前版本",
          ...
          "workflows.item.published": "已发布",
          "workflows.item.notPublished": "未发布",
          ...
          "workflows.autodeactivated": "工作流自动停用",
          ...
          "workflows.publishModal.lastPublished": "最后由 {author} 在 {date} 的 {time} 发布。",
          ...
          "dataTable.upload.uploading": "正在上传和处理 CSV 文件…",
          "dataTable.upload.selectFile": "等待选择文件...",
          "dataTable.upload.dropOrClick": "将文件拖到这里或点击上传",
          "dataTable.upload.csvOnly": "仅支持 CSV 文件",
          "dataTable.upload.hasHeaders": "我的CSV文件包含标题行",
          "dataTable.upload.uploadButton": "上传 CSV",
          "dataTable.upload.success": "'{fileName}' 上传成功。我们找到了 {columnCount} 列和 {rowCount} 行 | '{fileName}' 上传成功。我们找到了 {columnCount} 列和 {rowCount} 行",
          "dataTable.upload.error": "上传 CSV 文件时出错。",
          "dataTable.import.columnsFound": "找到的列",
          "dataTable.import.columnName": "列名",
          "dataTable.import.columnsDescription": "查看并调整从您的CSV文件检测到的列名和类型",
          ...
          "dataTable.import.invalidColumnName": "只允许字母、非前导数字和下划线。",
          ...
          "dataTable.search.dateSearchInfo": "日期搜索使用 UTC 格式，而表格则显示您所在时区的日期。",
          "settings.ldap": "LDAP",
          ...
          "settings.ldap.form.enforceEmailUniqueness.tooltip": "如果多个LDAP账户使用相同的邮箱，将防止登录，从而阻止账户关联攻击。",
          ...
          "settings.sso.settings.userRoleProvisioning.help": "从您的 SSO 提供商管理实例和项目角色。",
          ...
          "settings.sso.settings.save.testConnection.title": "测试和激活 SAML 单点登录 (SSO)",
          "settings.sso.settings.save.testConnection.message": "您即将通过 SAML 激活单点登录 (SSO)。在继续之前，请先测试您的 SAML SSO 设置。",
          "settings.sso.settings.save.testConnection.test": "测试设置",
          "settings.sso.settings.save.confirmTestConnection.title": "确认连接测试成功",
          "settings.sso.settings.save.confirmTestConnection.message": "连接测试成功了吗？确认通过 SAML 激活 SSO。",
          ...
          "settings.sso.confirmMessage.beforeSaveForm.message": "如果您这样做，所有 {protocol} 用户将被转换为电子邮件用户。",
          ...
          "communityPlusModal.features.execution.description": "搜索和整理过去的工作流执行记录，以便于审查。",
          ...
          "insights.banner.queueMode.warning": "我们发现并修复了一个问题，即队列模式用户的洞察执行计数被重复计算。",
          "insights.banner.queueMode.warning.link.text": "了解更多",
          "insights.banner.queueMode.warning.link.url": "抱歉，我无法处理链接内容。请提供具体的文本，我将为您进行翻译。",
