import { $ as openBlock, A as createTextVNode, C as createBaseVNode, E as createElementBlock, Ft as ref, N as defineComponent, S as computed, Sn as toDisplayString, T as createCommentVNode, Wt as unref, X as onMounted, _ as Fragment, _n as normalizeClass, bt as withDirectives, j as createVNode, ot as resolveDirective, rt as renderList, st as resolveDynamicComponent, w as createBlock, yt as withCtx } from "./vue.runtime.esm-bundler-Bw8GKr4Y.js";
import { at as useI18n } from "./core-Beh0t8_q.js";
import { Pi as N8nIconButton_default, da as N8nHeading_default, ha as N8nIcon_default, pa as N8nText_default } from "./src-Dg8CDsvD.js";
...
var ComputerUseSetupContent_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		...
		const browserAutomationHint = computed(() => i18n.baseText("instanceAi.welcomeModal.gateway.browserAutomationHint", { interpolate: { url: CHROME_EXTENSION_URL } }));
		...
		return (_ctx, _cache) => {
			...
			return openBlock(), createElementBlock("div", { class: normalizeClass(_ctx.$style.body) }, [createBaseVNode("div", { class: normalizeClass(_ctx.$style.header) }, [createVNode(unref(N8nHeading_default), {
				...
				_: 1
			}, 8, ["class"])], 2), unref(store).isGatewayConnected ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [createBaseVNode("div", { class: normalizeClass(_ctx.$style.connectedBlock) }, [
			...
			], 2), withDirectives(createVNode(unref(N8nText_default), {
				color: "text-light",
				class: normalizeClass(_ctx.$style.browserHint)
			}, null, 8, ["class"]), [[_directive_n8n_html, browserAutomationHint.value]])], 64)) : (openBlock(), createElementBlock(Fragment, { key: 1 }, [
				...
				createBaseVNode("div", { class: normalizeClass(_ctx.$style.commandCard) }, [createBaseVNode("div", { class: normalizeClass(_ctx.$style.commandRow) }, [createBaseVNode("code", {
					...
					"class",
					"aria-label"
				])], 2), createBaseVNode("div", { class: normalizeClass(_ctx.$style.waitingRow) }, [createVNode(unref(N8nIcon_default), {
					icon: "spinner",
					color: "primary",
					spin: "",
					size: "small"
				...
				withDirectives(createVNode(unref(N8nText_default), {
					color: "text-light",
					class: normalizeClass(_ctx.$style.browserHint)
				}, null, 8, ["class"]), [[_directive_n8n_html, browserAutomationHint.value]])
			], 64))], 2);
		};
	}
});
var ComputerUseSetupContent_vue_vue_type_style_index_0_lang_module_default = {
	body: "_body_di8ei_125",
	header: "_header_di8ei_132",
	title: "_title_di8ei_139",
	textBlock: "_textBlock_di8ei_144",
	osTabs: "_osTabs_di8ei_154",
	osTab: "_osTab_di8ei_154",
	osTabActive: "_osTabActive_di8ei_179",
	osTabIcon: "_osTabIcon_di8ei_185",
	commandCard: "_commandCard_di8ei_190",
	commandRow: "_commandRow_di8ei_196",
	commandText: "_commandText_di8ei_205",
	commandTextFaded: "_commandTextFaded_di8ei_220",
	copyButton: "_copyButton_di8ei_224",
	connectedBlock: "_connectedBlock_di8ei_229",
	statusRow: "_statusRow_di8ei_238",
	statusDot: "_statusDot_di8ei_244",
	statusDotConnected: "_statusDotConnected_di8ei_251",
	directoryRow: "_directoryRow_di8ei_255",
	toolCategories: "_toolCategories_di8ei_259",
	categoryPill: "_categoryPill_di8ei_266",
	categoryPillDisabled: "_categoryPillDisabled_di8ei_278",
	categorySublabel: "_categorySublabel_di8ei_282",
	browserHint: "_browserHint_di8ei_286",
	waitingRow: "_waitingRow_di8ei_291",
	instructions: "_instructions_di8ei_301"
};
...
//#endregion
export { CHROME_EXTENSION_URL as n, ComputerUseSetupContent_default as t };
