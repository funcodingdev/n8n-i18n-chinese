...
import { Ja as createInitialState, Mu as buildRunWorkflowSessionGrantKey, Nu as instanceAiEventSchema, Pu as isSafeObjectKey, Qa as toAgentTree, Xa as reduceEvent, Ya as findAgent, Za as stateFromAgentTree, iu as v4 } from "./constants-DDbk7QLF.js";
import { T as defineStore, a as ResponseError, c as makeRestApiRequest, t as useRootStore } from "./useRootStore-Cls9JR4X.js";
import "./settings.store-D5e-Y58h.js";
...
import "./constants-CQrNYC-p.js";
import { a as postCancelTask, c as postMessage, i as postCancel, n as ensureThread, o as postConfirmation, r as getInstanceAiCredits, s as postFeedback, t as useInstanceAiSettingsStore } from "./instanceAiSettings.store-CT4Yx18z.js";
...
function createThreadRuntime(threadId, hooks, initialProjectId) {
	...
	const { producedArtifacts, resourceNameIndex, linkableResourceNameIndex } = useResourceRegistry(() => messages.value, (id) => workflowsListStore.getWorkflowById(id)?.name, () => archivedWorkflowIds.value);
