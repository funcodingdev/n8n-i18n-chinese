(function() {
	...
	var reduceWithoutClosingOnEarlyError = !FAILS_ON_INITIAL_UNDEFINED && iteratorHelperWithoutClosingOnEarlyError$4("reduce", $TypeError$11);
	$$30({
		target: "Iterator",
		proto: true,
		real: true,
	...
	$$28({
		...
		try {
			...
			iteratorClose$12(this, "throw", error);
		}
		if (someWithoutClosingOnEarlyError) return call$15(someWithoutClosingOnEarlyError, this, predicate);
	...
	$$27({
		...
		if (forEachWithoutClosingOnEarlyError) return call$14(forEachWithoutClosingOnEarlyError, this, fn);
	...
	var require_iterator_close_all = /* @__PURE__ */ __commonJSMin(((exports, module) => {
		...
		module.exports = function(iters, kind, value) {
			for (var i = iters.length - 1; i >= 0; i--) {
				...
				try {
					value = iteratorClose$10(iters[i].iterator, kind, value);
				} catch (error) {
					kind = "throw";
					value = error;
				}
			...
			return defineBuiltIns(create$3(IteratorPrototype$1), {
				...
				"return": function() {
					...
					if (IS_ITERATOR) {
						...
						return returnMethod ? call$13(returnMethod, iterator) : createIterResultObject(void 0, true);
					}
					if (state.inner) try {
						iteratorClose$9(state.inner.iterator, NORMAL);
					} catch (error) {
						return iteratorClose$9(iterator, THROW, error);
					}
	...
	var mapWithoutClosingOnEarlyError = !IS_PURE$7 && !MAP_WITHOUT_THROWING_ON_INVALID_ITERATOR && iteratorHelperWithoutClosingOnEarlyError$3("map", TypeError);
	...
	$$26({
		...
		return new IteratorProxy$3(getIteratorDirect$8(this), { mapper });
	} });
	...
	var IteratorProxy$2 = createIteratorProxy$2(function() {
		...
		while (true) {
			result = anObject$9(call$11(next$1, iterator));
	...
	$$24({
		...
		return new IteratorProxy$2(getIteratorDirect$7(this), { predicate });
	} });
	...
	var require_function_uncurry_this_accessor = /* @__PURE__ */ __commonJSMin(((exports, module) => {
		...
		module.exports = function(object, key$1, method) {
			try {
				return uncurryThis$14(aCallable$3(Object.getOwnPropertyDescriptor(object, key$1)[method]));
			} catch (error) {}
		};
	}));
	...
	(/* @__PURE__ */ __commonJSMin((() => {
		...
		if (globalThis$16.Uint8Array) $$10({
			target: "Uint8Array",
			proto: true
	...
	var require_regexp_flags_detection = /* @__PURE__ */ __commonJSMin(((exports, module) => {
		...
		var RegExp$1 = globalThis$12.RegExp;
	...
	var require_regexp_get_flags = /* @__PURE__ */ __commonJSMin(((exports, module) => {
		...
		module.exports = regExpFlagsDetection.correct ? function(it) {
			...
			return !regExpFlagsDetection.correct && isPrototypeOf$1(RegExpPrototype, it) && !hasOwn$7(it, "flags") ? call$4(regExpFlagsGetterImplementation, it) : it.flags;
		};
	}));
	...
	var Object$1 = globalThis$11.Object;
	var Array$1 = globalThis$11.Array;
	var Date = globalThis$11.Date;
	var Error$1 = globalThis$11.Error;
	var TypeError$1 = globalThis$11.TypeError;
	var PerformanceMark = globalThis$11.PerformanceMark;
	...
	var thisNumberValue = uncurryThis$3(1.1.valueOf);
	...
	var checkBasicSemantic = function(structuredCloneImplementation) {
		return !fails$3(function() {
			var set1 = new globalThis$11.Set([7]);
	...
	var checkNewErrorsCloningSemantic = function(structuredCloneImplementation) {
		return !fails$3(function() {
			var test$1 = structuredCloneImplementation(new globalThis$11.AggregateError([1], PERFORMANCE_MARK, { cause: 3 }));
			return test$1.name !== "AggregateError" || test$1.errors[0] !== 1 || test$1.message !== PERFORMANCE_MARK || test$1.cause !== 3;
		});
	};
	var nativeStructuredClone = globalThis$11.structuredClone;
	...
	var createDataTransfer = function() {
		var dataTransfer;
		try {
			dataTransfer = new globalThis$11.DataTransfer();
		} catch (error) {
			try {
				dataTransfer = new globalThis$11.ClipboardEvent("").clipboardData;
			} catch (error2) {}
		}
	...
	var cloneBuffer = function(value, map, $type) {
		...
		if (type === "SharedArrayBuffer") if (nativeRestrictedStructuredClone) clone$3 = nativeRestrictedStructuredClone(value);
			...
			var DataView$3 = globalThis$11.DataView;
	...
	var structuredCloneInternal = function(value, map) {
		...
		switch (type) {
			...
			case "Error":
				...
				if (hasOwn$6(value, "cause")) createNonEnumerableProperty$2(cloned, "cause", structuredCloneInternal(value.cause, map));
	...
	var tryToTransfer = function(rawTransfer, map) {
		...
		while (i < length) {
			...
			if (PROPER_STRUCTURED_CLONE_TRANSFER) transferred = nativeStructuredClone(value, { transfer: [value] });
				...
				case "ImageBitmap":
					C = globalThis$11.OffscreenCanvas;
	...
	var JSON$1 = globalThis$10.JSON;
	var Number = globalThis$10.Number;
	var SyntaxError$1 = globalThis$10.SyntaxError;
	...
	var internalize = function(holder, name, reviver, node) {
		...
		if (isObject(val)) {
			...
			if (nodeIsArray) {
				...
				len = lengthOfArrayLike(keys$2);
				for (i = 0; i < len; i++) {
					P = keys$2[i];
					internalizeProperty(val, P, internalize(val, P, reviver, hasOwn$4(nodes, P) ? nodes[P] : void 0));
				}
			}
		}
