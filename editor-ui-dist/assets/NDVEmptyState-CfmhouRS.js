...
import { $ as openBlock, C as createBaseVNode, E as createElementBlock, N as defineComponent, Sn as toDisplayString, T as createCommentVNode, Wt as unref, _n as normalizeClass, it as renderSlot, w as createBlock } from "./vue.runtime.esm-bundler-Bw8GKr4Y.js";
import { ha as N8nIcon_default } from "./src-Dg8CDsvD.js";
...
var $n$1 = At$2((Ct) => {
	...
	Ct.default = To;
	var In = (kn(), vu$1(Tn$1)), Hn = vo(Pn$1(), !0);
	function Wn(e) {
	...
	function Oo(e) {
		if (e) return Zt ??= (0, Hn.createColors)(!0), Zt;
		return bo;
	}
	var Yn = !1;
	function So(e) {
	...
	function No(e, t, r) {
		let n = Object.assign({
			column: 0,
			line: -1
		}, e.start), o = Object.assign({}, n, e.end), { linesAbove: u = 2, linesBelow: i = 3 } = r || {}, s = n.line, a = n.column, D = o.line, l = o.column, d = Math.max(s - (u + 1), 0), f = Math.min(t.length, D + i);
		s === -1 && (d = 0), D === -1 && (f = t.length);
		let p = D - s, c = {};
		if (p) for (let F = 0; F <= p; F++) {
			let m = F + s;
			if (!a) c[m] = !0;
			else if (F === 0) c[m] = [a, t[m - 1].length - a + 1];
			else if (F === p) c[m] = [0, l];
			else c[m] = [0, t[m - F].length];
		}
	...
	function Mn(e, t, r = {}) {
		let n = (r.highlightCode || r.forceColor) && (0, In.shouldHighlight)(r), o = Oo(r.forceColor), u = So(o), i = (F, m) => n ? F(m) : m, { start: a, end: D, markerLines: l } = No(t, e.split(jn), r), d = t.start && typeof t.start.column == "number", f = String(D).length, c = (n ? (0, In.default)(e, r) : e).split(jn, D).slice(a, D).map((F, m) => {
 ...
 `,
						...
						v,
						i(u.marker, "^").repeat($)
					].join(""), C && r.message && (k += " " + i(u.message, r.message));
				}
				return [
					i(u.marker, ">"),
					i(u.gutter, w),
...
${c}`), n ? o.reset(c) : c;
	...
	function To(e, t, r, n = {}) {
		...
		return r = Math.max(r, 0), Mn(e, { start: {
			column: r,
			line: t
		} }, n);
	}
...
Z.prototype = {
	diff: function(t, r) {
		...
		var f = (n = o.timeout) !== null && n !== void 0 ? n : Infinity, p = Date.now() + f, c = [{
			oldPos: -1,
			lastComponent: void 0
		}], F = this.extractCommon(c[0], r, t, 0);
		if (c[0].oldPos + 1 >= D && F + 1 >= a) return s([{
			value: this.join(r),
			count: r.length
		}]);
		var m = -Infinity, E = Infinity;
		function A() {
			for (var h = Math.max(m, -l); h <= Math.min(E, l); h += 2) {
				...
				if (!yt || $ && k.oldPos + 1 < v.oldPos ? C = i.addToPath(v, !0, void 0, 0) : C = i.addToPath(k, void 0, !0, 1), F = i.extractCommon(C, r, t, h), C.oldPos + 1 >= D && F + 1 >= a) return s(Su$1(i, C.lastComponent, r, t, i.useLongestToken));
...
function Or$2(e) {
	...
	function n(u, i, s) {
		...
		if (u.type === B$1) {
			let l = ((a = s == null ? void 0 : s[i + 1]) == null ? void 0 : a.type) === b$1;
		...
		if (u.type === b$1) return ((D = s == null ? void 0 : s[i - 1]) == null ? void 0 : D.type) === B$1 && s[i - 1].hard ? void 0 : "breakParent";
...
function et$1(e, t, r, n, o, u) {
	...
	for (; r >= 0;) {
		...
		let { mode: D, doc: l } = s.pop(), d = G$1(l);
		switch (d) {
			case U$1:
				a.push(l), r -= Oe$2(l);
				break;
			...
			case S: {
				let f = d === W ? l : l.parts;
				for (let p = f.length - 1; p >= 0; p--) s.push({
					mode: D,
					doc: f[p]
				});
				break;
			...
			case x$1: {
				...
				let f = l.break ? H$1 : D, p = l.expandedStates && f === H$1 ? y(!1, l.expandedStates, -1) : l.contents;
				s.push({
					mode: f,
					doc: p
				});
			...
			case _: {
				let p = (l.groupId ? o[l.groupId] || J : D) === H$1 ? l.breakContents : l.flatContents;
				p && s.push({
					mode: D,
					doc: p
				});
...
` ? ne$1(!1, c, `
`, o) : c;
				s.push(F), i.length > 0 && (u += Oe$2(F));
				break;
			}
			case W:
				for (let F = c.length - 1; F >= 0; F--) i.push({
					ind: f,
					mode: p,
					doc: c[F]
				});
			...
			case x$1:
				switch (p) {
					...
					case H$1: {
						...
						if (!c.break && et$1(F, i, m, E, r)) i.push(F);
			...
			case S: {
				...
				}, [], F, D.length > 0, r, !0) ? i.push($, k, w) : C ? i.push($, v, w) : i.push($, v, h);
				break;
			}
			case _:
			case R$1: {
			...
			case B$1:
				switch (p) {
					...
					case H$1:
						...
						c.literal ? f.root ? (s.push(o, f.root.value), u = f.root.length) : (s.push(o), u = 0) : (u -= Ot$1(s), s.push(o + f.value), u = f.length);
						break;
				}
				break;
			case N$1:
	...
	let d = s.indexOf(Te$2);
	if (d !== -1) {
		let f = s.indexOf(Te$2, d + 1), p = s.slice(0, d).join(""), c = s.slice(d + 1, f).join(""), F = s.slice(f + 1).join("");
		return {
			formatted: p + c + F,
...
function ut$1(e, t) {
	...
	return s.sort((a, D) => u(a) - u(D) || i(a) - i(D)), Pt$1.set(e, s), s;
}
function qr$2(e, t, r, n) {
	let { locStart: o, locEnd: u } = r, i = o(t), s = u(t), a = ut$1(e, r), D, l, d = 0, f = a.length;
	for (; d < f;) {
		let p = d + f >> 1, c = a[p], F = o(c), m = u(c);
		if (F <= i && s <= m) return qr$2(c, t, r, c);
		if (m <= i) {
			D = c, d = p + 1;
			continue;
		}
	...
	if ((n == null ? void 0 : n.type) === "TemplateLiteral") {
		...
		D && Rt$1(p, D, r) !== c && (D = null), l && Rt$1(p, l, r) !== c && (l = null);
	}
	return {
		enclosingNode: n,
		precedingNode: D,
...
function Jr$2(e, t) {
	...
	let n = [], { locStart: o, locEnd: u, printer: { experimentalFeatures: { avoidAstMutation: i = !1 } = {}, handleComments: s = {} }, originalText: a } = t, { ownLine: D = It$1, endOfLine: l = It$1, remaining: d = It$1 } = s, f = r.map((p, c) => ({
		...qr$2(e, p, t),
		comment: p,
		text: a,
		options: t,
	...
	for (let [p, c] of f.entries()) {
		...
		let v;
		if (i ? v = [c] : (F.enclosingNode = E, F.precedingNode = m, F.followingNode = A, v = [
			F,
			w,
			h,
			C,
			k
		]), ro$1(w, h, f, p)) F.placement = "ownLine", D(...v) || (A ? ue(A, F) : m ? oe$1(m, F) : E ? re$2(E, F) : re$2(C, F));
		else if (no$1(w, h, f, p)) F.placement = "endOfLine", l(...v) || (m ? oe$1(m, F) : A ? ue(A, F) : E ? re$2(E, F) : re$2(C, F));
		else if (F.placement = "remaining", !d(...v)) if (m && A) {
			let $ = n.length;
			$ > 0 && n[$ - 1].followingNode !== A && Kr$2(n, h), n.push(c);
		} else m ? oe$1(m, F) : A ? ue(A, F) : E ? re$2(E, F) : re$2(C, F);
	}
...
function ro$1(e, t, r, n) {
	...
	if (u) for (let D = n - 1; D >= 0; D--) {
		...
		if (d !== u || !Xr$2(e.slice(s(l), a))) break;
		a = i(l);
	}
...
function no$1(e, t, r, n) {
	...
	if (u) for (let D = n + 1; D < r.length; D++) {
		...
		if (d !== u || !Xr$2(e.slice(a, i(l)))) break;
		a = s(l);
	}
	return V$2(e, a);
}
...
function oo$1(e, t) {
	...
	if ((l = o.isBlockComment) == null ? void 0 : l.call(o, r)) {
		let d = V$2(u, s(r)) ? V$2(u, i(r), { backwards: !0 }) ? q$1 : Ke$1 : " ";
		n.push(d);
	} else n.push(q$1);
	let D = M$1(u, T(u, s(r)));
	return D !== !1 && V$2(u, D) && n.push(q$1), n;
}
function io$1(e, t, r) {
	var D;
	let n = e.node, o = Zr$1(e, t), { printer: u, originalText: i, locStart: s } = t, a = (D = u.isBlockComment) == null ? void 0 : D.call(u, n);
...
function so$1(e, t) {
	...
	return e.each(() => {
		...
		D ? u.push(oo$1(e, t)) : l && (s = io$1(e, t, s), i.push(s.doc));
	}, "comments"), {
		leading: u,
		trailing: i
	};
...
function Ht$1(e, t) {
	...
	let i, s, a, D, l = 0, d = 0;
	for (; l < n;) dn$1[l] = e.charCodeAt(u + l), jt$1[l] = ++l;
	for (; d < o;) for (i = t.charCodeAt(u + d), a = d++, s = d, l = 0; l < n; l++) D = i === dn$1[l] ? a : a + 1, a = jt$1[l], s = jt$1[l] = a > s ? D > s ? s + 1 : D : D > a ? a + 1 : D;
	return s;
}
...
var Et$2 = class {
	constructor(t, r) {
		let { logger: n = console, loggerPrintWidth: o = 80, descriptor: u = wn$1, unknown: i = xn$1, invalid: s = _n$1, deprecated: a = vn$1, missing: D = () => !1, required: l = () => !1, preprocess: d = (p) => p, postprocess: f = () => he$1 } = r || {};
		this._utils = {
			descriptor: u,
			logger: n || { warn: () => {} },
			loggerPrintWidth: o,
		...
		}, this._unknownHandler = i, this._invalidHandler = Bn$1(s), this._deprecatedHandler = a, this._identifyMissing = (p, c) => !(p in c) || D(p, c), this._identifyRequired = l, this._preprocess = d, this._postprocess = f, this.cleanHistory();
	}
	cleanHistory() {
	...
	normalize(t) {
		...
		for (let i of Object.keys(this._utils.schemas)) {
			...
			D !== he$1 && (this._applyValidation(D, i, s), r[i] = D);
		}
	...
	_applyNormalization(t, r) {
		...
		for (let i of o) {
			...
			let D = ({ from: p, to: c }) => {
				...
				let F = Ut$1(s.deprecated(p, this._utils), a, !0);
				if (F !== !1) if (F === !0) this._hasDeprecationWarned(i) || this._utils.logger.warn(this._deprecatedHandler(i, c, this._utils));
...
function go$1(e, t, { logger: r = !1, isCLI: n = !1, passThrough: o = !1, FlagSchema: u, descriptor: i } = {}) {
	...
	l && Gt$1 && (D._hasDeprecationWarned = Gt$1);
	let d = D.normalize(e);
	return l && (Gt$1 = D._hasDeprecationWarned), d;
}
...
function Ao$1(e, { isCLI: t, optionInfos: r, FlagSchema: n }) {
	...
	if (e.exception ? u.validate = (a, D, l) => e.exception(a) || D.validate(a, l) : u.validate = (a, D, l) => a === void 0 || D.validate(a, l), e.redirect && (s.redirect = (a) => a ? { to: typeof e.redirect == "string" ? e.redirect : {
...
async function wo$1(e, t = {}) {
	...
	let s = (d = u.printers) != null && d[i.astFormat] ? u : On$1(r.plugins, i.astFormat);
...
async function Un$1(e, t, r, n, o) {
	...
	let D = X$1(i.getVisitorKeys ?? a), l = [];
	p();
	let d = e.stack;
...
function Gn$1(e, t, r, n, o) {
	...
	return (a = i.hasPrettierIgnore) != null && a.call(i, e) ? s = zn$1(e, t) : o.has(u) ? s = o.get(u) : s = i.print(e, t, r, n), u === t.cursorNode && (s = Qe$1(s, (D) => [
		ve$1,
		D,
		ve$1
...
function er$1(e, t, r, n, o = [], u) {
	...
	if (!(t > D || t < a || u === "rangeEnd" && t === a || u === "rangeStart" && t === D)) {
		for (let l of ut$1(e, r)) {
			let d = er$1(l, t, r, n, [e, ...o], u);
			if (d) return d;
		}
		if (!n || n(e, o[0])) return {
			node: e,
...
function eu$1(e, t, r) {
	...
	let D = er$1(r, n, t, (p, c) => Zn$1(t, p, c), [], "rangeStart"), l = a ? D : er$1(r, o, t, (p) => Zn$1(t, p), [], "rangeEnd");
	if (!D || !l) return {
		rangeStart: 0,
		rangeEnd: 0
	};
	...
	if (Ho$1(t)) {
		let p = Wo$1(D, l);
		d = p, f = p;
	} else ({startNode: d, endNode: f} = Mo$1(D, l, t));
	return {
...
async function ou$1(e, t, r = 0) {
	...
	if (t.cursorOffset >= 0) {
		let a, D, l, d, f;
		if (t.cursorNode && i.cursorNodeText ? (a = t.locStart(t.cursorNode), D = o.slice(a, t.locEnd(t.cursorNode)), l = t.cursorOffset - a, d = i.cursorNodeStart, f = i.cursorNodeText) : (a = 0, D = o, l = t.cursorOffset, d = 0, f = i.formatted), D === f) return {
...
`, o) + 1), a = n.slice(s, o).match(/^\s*/u)[0], D = me$1(a, t.tabWidth), l = await ou$1(i, {
		...t,
		rangeStart: 0,
		rangeEnd: Number.POSITIVE_INFINITY,
		cursorOffset: t.cursorOffset > o && t.cursorOffset <= u ? t.cursorOffset - o : -1,
		endOfLine: "lf"
	}, D), d = l.formatted.trimEnd(), { cursorOffset: f } = t;
...
var At$1 = Hs$1((xe) => {
	...
	var Lt = "BABEL_PARSER_SOURCETYPE_MODULE_REQUIRED", Xs = {
	...
	}, Ce = (a) => a.type === "UpdateExpression" ? Dt.UpdateExpression[`${a.prefix}`] : Dt[a.type], Gs = {
...
- Did you mean \`import { "${a}" as foo }\`?`,
		...
		InvalidLhsBinding: ({ ancestor: a }) => `Binding invalid left-hand side in ${Ce(a)}.`,
		InvalidLhsOptionalChaining: ({ ancestor: a }) => `Invalid optional chaining in the left-hand side of ${Ce(a)}.`,
		...
		PipeUnparenthesizedBody: ({ type: a }) => `Hack-style pipe body cannot be an unparenthesized ${Ce({ type: a })}; please wrap it in parentheses.`,
	...
	function si(a) {
		...
		return function s(i, r) {
			...
			return Object.assign(n, e, {
				loc: i,
				pos: i.index
			}), "missingPlugin" in r && Object.assign(n, { missingPlugin: r.missingPlugin }), Mt(n, "clone", function(h = {}) {
				var c;
				let { line: l, column: u, index: f } = (c = h.loc) != null ? c : i;
				return s(new F(l, u, f), Object.assign({}, r, h.details));
			}), Mt(n, "details", r), Object.defineProperty(n, "message", {
				configurable: !0,
				get() {
	...
	function j(a, t) {
		...
		for (let s of Object.keys(a)) {
			let i = a[s], r = typeof i == "string" ? { message: () => i } : typeof i == "function" ? { message: i } : i, { message: n } = r, o = Ht(r, ti);
			e[s] = si(Object.assign({
	...
	C.template = new X("`", !0);
	var b = !0, m = !0, $e = !0, he = !0, q = !0, ai = !0, ke = class {
		constructor(t, e = {}) {
	...
	function P(a, t = {}) {
		var e, s, i, r;
		return ++ue, ft.push(a), dt.push((e = t.binop) != null ? e : -1), mt.push((s = t.beforeExpr) != null ? s : !1), yt.push((i = t.startsExpr) != null ? i : !1), xt.push((r = t.prefix) != null ? r : !1), U.push(new ke(a, t)), ue;
	}
	function T(a, t = {}) {
		var e, s, i, r;
		return ++ue, ut.set(a, ue), ft.push(a), dt.push((e = t.binop) != null ? e : -1), mt.push((s = t.beforeExpr) != null ? s : !1), yt.push((i = t.startsExpr) != null ? i : !1), xt.push((r = t.prefix) != null ? r : !1), U.push(new ke("name", t)), ue;
	}
	var ni = {
		bracketL: P("[", {
			beforeExpr: b,
	...
	function _(a) {
		return a < 65 ? a === 36 : a <= 90 ? !0 : a < 97 ? a === 95 : a <= 122 ? !0 : a <= 65535 ? a >= 170 && xi.test(String.fromCharCode(a)) : We(a, Xt);
	}
	function Q(a) {
		return a < 48 ? a === 36 : a < 58 ? !0 : a < 65 ? !1 : a <= 90 ? !0 : a < 97 ? a === 95 : a <= 122 ? !0 : a <= 65535 ? a >= 170 && Pi.test(String.fromCharCode(a)) : We(a, Xt) || We(a, gi);
	}
	var Tt = {
		keyword: [
			"break",
	...
	}, Ti = new Set(Tt.keyword), bi = new Set(Tt.strict), Ai = new Set(Tt.strictBind);
	function Gt(a, t) {
		...
		for (;;) {
			...
			if (d === 92) {
				...
				y.ch === null && !l ? l = {
					...
					lineStart: s,
					curLine: i
				} : c += y.ch, {pos: e, lineStart: s, curLine: i} = y, u = e;
...
`);
			...
			case 120: {
				let c;
				return {code: c, pos: t} = Ze(a, t, e, s, 2, !1, n, r), o(c === null ? null : String.fromCharCode(c));
			}
			case 117: {
				let c;
	...
	function Ze(a, t, e, s, i, r, n, o) {
		let h = t, c;
		return {n: c, pos: t} = ss(a, t, e, s, 16, i, r, !1, o, !n), c === null && (n ? o.invalidEscapeSequence(h, e, s) : t = h - 1), {
			code: c,
			pos: t
		};
	}
	function ss(a, t, e, s, i, r, n, o, h, c) {
		let l = t, u = i === 16 ? Rt.hex : Rt.decBinOct, f = i === 16 ? we.hex : i === 10 ? we.dec : i === 8 ? we.oct : we.bin, d = !1, y = 0;
		for (let E = 0, L = r ?? Infinity; E < L; ++E) {
			...
			if (S >= 97 ? I = S - 97 + 10 : S >= 65 ? I = S - 65 + 10 : ki(S) ? I = S - 48 : I = Infinity, I >= i) {
				if (I <= 9 && c) return {
					n: null,
					pos: t
				};
	...
	function is(a, t, e, s, i, r) {
		...
		if (n === 123) {
			if (++t, {code: o, pos: t} = Ze(a, t, e, s, a.indexOf("}", t) - t, !0, i, r), ++t, o !== null && o > 1114111) if (i) r.invalidCodePoint(t, e, s);
			else return {
				code: null,
				pos: t
			};
	...
	var Di = new Set([
		...
		constructor(t, e) {
			super(), this.isLookahead = void 0, this.tokens = [], this.errorHandlers_readInt = {
				invalidDigit: (s, i, r, n) => this.options.errorRecovery ? (this.raise(p.InvalidDigit, ce(s, i, r), { radix: n }), !0) : !1,
			...
			}), this.state = new Qe(), this.state.init(t), this.input = e, this.length = e.length, this.comments = [], this.isLookahead = !1;
		}
		pushToken(t) {
			...
			e: for (; this.state.pos < this.length;) {
				...
				switch (s) {
					...
					case 47:
						...
						break;
					default: if (Ni(s)) ++this.state.pos;
		...
		readInt(t, e, s = !1, i = !0) {
			let { n: r, pos: n } = ss(this.input, this.state.pos, this.state.lineStart, this.state.curLine, t, e, s, i, this.errorHandlers_readInt, !1);
		...
		readRadixNumber(t) {
			...
			i ?? this.raise(p.InvalidDigit, v(e, 2), { radix: t });
		...
		readNumber(t) {
			...
			if (l === 46 && !h && (++this.state.pos, this.readInt(10), i = !0, l = this.input.charCodeAt(this.state.pos)), (l === 69 || l === 101) && !h && (l = this.input.charCodeAt(++this.state.pos), (l === 43 || l === 45) && ++this.state.pos, this.readInt(10) === null && this.raise(p.InvalidOrMissingExponent, s), i = !0, o = !0, l = this.input.charCodeAt(this.state.pos)), l === 110 && ((i || c) && this.raise(p.InvalidBigIntLiteral, s), ++this.state.pos, r = !0), l === 109 && (this.expectPlugin("decimal", this.state.curPosition()), (o || c) && this.raise(p.InvalidDecimal, s), ++this.state.pos, n = !0), _(this.codePointAtPos(this.state.pos))) throw this.raise(p.NumberIdentifier, this.state.curPosition());
		...
		raise(t, e, s = {}) {
			let r = t(e instanceof F ? e : e.loc.start, s);
	...
	var Vi = /\*?\s*@((?:no)?flow)\b/, qi = (a) => class extends a {
		...
		flowParseDeclareModule(e) {
			...
			let r = null, n = !1;
			return i.forEach((o) => {
				_i(o) ? (r === "CommonJS" && this.raise(g.AmbiguousDeclareModuleKind, o), r = "ES") : o.type === "DeclareModuleExports" && (n && this.raise(g.DuplicateDeclareModuleExports, o), r === "ES" && this.raise(g.AmbiguousDeclareModuleKind, o), r = "CommonJS", n = !0);
		...
		flowParseObjectType({ allowStatic: e, allowExact: s, allowSpread: i, allowProto: r, allowInexact: n }) {
			...
			let c, l, u = !1;
			for (s && this.match(6) ? (this.expect(6), c = 9, l = !0) : (this.expect(5), c = 8, l = !1), h.exact = l; !this.match(c);) {
				let d = !1, y = null, E = null, L = this.startNode();
				if (r && this.isContextual(118)) {
					let I = this.lookahead();
					I.type !== 14 && I.type !== 17 && (this.next(), y = this.state.startLoc, e = !1);
				}
				...
				if (this.eat(0)) y != null && this.unexpected(y), this.eat(0) ? (S && this.unexpected(S.loc.start), h.internalSlots.push(this.flowParseObjectTypeInternalSlot(L, d))) : h.indexers.push(this.flowParseObjectTypeIndexer(L, d, S));
					...
					let I = "init";
					if (this.isContextual(99) || this.isContextual(104)) Wt(this.lookahead().type) && (I = this.state.value, this.next());
					let Ae = this.flowParseObjectTypeProperty(L, d, y, S, I, i, n ?? !l);
					Ae === null ? (u = !0, E = this.state.lastTokStartLoc) : h.properties.push(Ae);
				}
		...
		parseImportSpecifierLocal(e, s, i) {
			s.local = _t(e) ? this.flowParseRestrictedIdentifier(!0, !0) : this.parseIdentifier(), e.specifiers.push(this.finishImportSpecifier(s, i));
		}
		...
		parseImportSpecifier(e, s, i, r, n) {
			...
			if (this.isContextual(93) && !this.isLookaheadContextual("as")) {
				...
				this.eatContextual(93) ? e.local = this.parseIdentifier() : (c = !0, e.local = $(e.imported));
			}
			let l = _t(e);
			return i && l && this.raise(g.ImportTypeShorthandOnlyInPureImport, e), (i || l) && this.checkReservedType(e.local.name, e.local.loc.start, !0), c && !i && !l && this.checkReservedWord(e.local.name, e.loc.start, !0, !0), this.finishImportSpecifier(e, "ImportSpecifier");
		}
		parseBindingAtom() {
			switch (this.state.type) {
		...
		flowEnumMembers({ enumName: e, explicitType: s }) {
			...
			for (; !this.match(8);) {
				...
				if (l === "") continue;
				/^[a-z]/.test(l) && this.raise(g.EnumInvalidMemberName, h, {
					memberName: l,
					suggestion: l[0].toUpperCase() + l.slice(1),
					enumName: e
				}), i.has(l) && this.raise(g.EnumDuplicateMemberName, h, {
					memberName: l,
					enumName: e
				}), i.add(l);
				let u = {
			...
			for (;;) {
				...
				switch (i) {
					...
					case 38:
						...
						break;
					default: fe(i) ? (e += this.input.slice(s, this.state.pos), e += this.jsxReadNewLine(!0), s = this.state.pos) : ++this.state.pos;
				}
			}
		}
		jsxReadNewLine(e) {
...
`) : i = String.fromCharCode(s), ++this.state.curLine, this.state.lineStart = this.state.pos, i;
		...
		jsxReadString(e) {
			...
			for (;;) {
				...
				let r = this.input.charCodeAt(this.state.pos);
				if (r === e) break;
				r === 38 ? (s += this.input.slice(i, this.state.pos), s += this.jsxReadEntity(), i = this.state.pos) : fe(r) ? (s += this.input.slice(i, this.state.pos), s += this.jsxReadNewLine(!1), i = this.state.pos) : ++this.state.pos;
			}
		...
		jsxParseAttributeValue() {
			let e;
			switch (this.state.type) {
				case 5: return e = this.startNode(), this.setContext(C.brace), this.next(), e = this.jsxParseExpressionContainer(e, C.j_oTag), e.expression.type === "JSXEmptyExpression" && this.raise(W.AttributeIsEmpty, e), e;
				case 142:
				case 133: return this.parseExprAtom();
				default: throw this.raise(W.UnsupportedJsxValue, this.state.startLoc);
			}
		}
	...
	var Gi = (a) => class extends a {
		...
		tsParseModifiers({ allowedModifiers: e, disallowedModifiers: s, stopOnStartOfClassStaticBlock: i, errorTemplate: r = x.InvalidModifierOnTypeMember }, n) {
			...
			for (;;) {
				...
				if (!l) break;
				$t(l) ? n.accessibility ? this.raise(x.DuplicateAccessibilityModifier, c, { modifier: l }) : (o(c, l, l, "override"), o(c, l, l, "static"), o(c, l, l, "readonly"), n.accessibility = l) : Xi(l) ? (n[l] && this.raise(x.DuplicateModifier, c, { modifier: l }), n[l] = !0, o(c, l, "in", "out")) : (hasOwnProperty.call(n, l) ? this.raise(x.DuplicateModifier, c, { modifier: l }) : (o(c, l, "static", "readonly"), o(c, l, "static", "override"), o(c, l, "override", "readonly"), o(c, l, "abstract", "override"), h(c, l, "declare", "override"), h(c, l, "static", "abstract")), n[l] = !0), s != null && s.includes(l) && this.raise(r, c, { modifier: l });
			}
		}
		...
		tsParseTupleElementType() {
			...
			if (c === 58) i = !0, n = !1, r = this.parseIdentifier(!0), this.expect(14), o = this.tsParseType();
				...
				this.lookaheadCharCode() === 58 ? (i = !0, r = this.createIdentifier(this.startNodeAt(l), u), this.expect(17), this.expect(14), o = this.tsParseType()) : (i = !1, o = f, this.expect(17));
			} else o = this.tsParseType(), n = this.eat(17), i = this.eat(14);
			if (i) {
				let l;
				r ? (l = this.startNodeAtNode(r), l.optional = n, l.label = r, l.elementType = o, this.eat(17) && (l.optional = !0, this.raise(x.TupleOptionalAfterType, this.state.lastTokStartLoc))) : (l = this.startNodeAtNode(o), l.optional = n, this.raise(x.InvalidTupleMemberLabel, o), l.label = o, l.elementType = this.tsParseType()), o = this.finishNode(l, "TSNamedTupleMember");
			} else if (n) {
		...
		tsCheckTypeAnnotationForReadOnly(e) {
			switch (e.typeAnnotation.type) {
				...
				default: this.raise(x.UnexpectedReadonly, e);
			}
		}
		tsParseInferType() {
			let e = this.startNode();
		...
		tsParseInterfaceDeclaration(e, s = {}) {
			...
			this.expectContextual(129), s.declare && (e.declare = !0), w(this.state.type) ? (e.id = this.parseIdentifier(), this.checkIdentifier(e.id, 130)) : (e.id = null, this.raise(x.MissingInterfaceName, this.state.startLoc)), e.typeParameters = this.tsTryParseTypeParameters(this.tsParseInOutConstModifiers), this.eat(81) && (e.extends = this.tsParseHeritageClause("extends"));
			let i = this.startNode();
			...
			if (this.match(47) || this.match(51)) {
				let o, h = this.tsTryParseAndCatch(() => {
					...
					if (!i && this.eat(10)) {
						...
						return f.callee = e, f.arguments = this.parseCallExpressionArguments(11, !1), this.tsCheckForInvalidTypeCasts(f.arguments), f.typeParameters = c, r.optionalChainMember && (f.optional = n), this.finishCallExpression(f, r.optionalChainMember);
					}
		...
		parseTypeOnlyImportExportSpecifier(e, s, i) {
			let r = s ? "imported" : "local", n = s ? "local" : "exported", o = e[r], h, c = !1, l = !0, u = o.loc.start;
			if (this.isContextual(93)) {
				let d = this.parseIdentifier();
				if (this.isContextual(93)) {
					let y = this.parseIdentifier();
					M(this.state.type) ? (c = !0, o = d, h = s ? this.parseIdentifier() : this.parseModuleExportName(), l = !1) : (h = y, l = !1);
				} else M(this.state.type) ? (l = !1, h = s ? this.parseIdentifier() : this.parseModuleExportName()) : (c = !0, o = d);
			} else M(this.state.type) && (c = !0, s ? (o = this.parseIdentifier(!0), this.isContextual(93) || this.checkReservedWord(o.name, o.loc.start, !0, !0)) : o = this.parseModuleExportName());
	...
	var ct = class extends lt {
		...
		parseAsyncArrowFromCallExpression(t, e) {
			var s;
			return this.resetPreviousNodeTrailingComments(e), this.expect(19), this.parseArrowExpression(t, e.arguments, !0, (s = e.extra) == null ? void 0 : s.trailingCommaLoc), e.innerComments && ye(t, e.innerComments), e.callee.trailingComments && ye(t, e.callee.trailingComments), t;
		}
		parseNoCallExpr() {
			let t = this.state.startLoc;
		...
		testTopicReferenceConfiguration(t, e, s) {
			switch (t) {
				case "hack": return this.hasPlugin(["pipelineOperator", { topicToken: K(s) }]);
		...
		parseParenAndDistinguishExpression(t) {
			...
			let n = this.state.startLoc, o = [], h = new Z(), c = !0, l, u;
			for (; !this.match(11);) {
				if (c) c = !1;
...
`),
		...
		parseObjectLike(t, e, s, i) {
			...
			for (h.properties = [], this.next(); !this.match(t);) {
				...
				let l;
				e ? l = this.parseBindingProperty() : (l = this.parsePropertyDefinition(i), this.checkProto(l, s, n, i)), s && !this.isObjectProperty(l) && l.type !== "SpreadElement" && this.raise(p.InvalidRecordProperty, l), l.shorthand && this.addExtra(l, "shorthand", !0), h.properties.push(l);
			}
		...
		parsePropertyDefinition(t) {
			...
			if (this.parsePropertyName(s, t), !o && !h && this.maybeAsyncOrAccessorProp(s)) {
				...
				l === "async" && !this.hasPrecedingLineBreak() && (i = !0, this.resetPreviousNodeTrailingComments(c), o = this.eat(55), this.parsePropertyName(s)), (l === "get" || l === "set") && (r = !0, this.resetPreviousNodeTrailingComments(c), s.kind = l, this.match(55) && (o = !0, this.raise(p.AccessorIsGenerator, this.state.curPosition(), { kind: l }), this.next()), this.parsePropertyName(s));
			}
		...
		parseObjectProperty(t, e, s, i) {
			...
			if (!t.computed && t.key.type === "Identifier") {
				if (this.checkReservedWord(t.key.name, t.key.loc.start, !0, !1), s) t.value = this.parseMaybeDefault(e, $(t.key));
		...
		parseFunctionBody(t, e, s = !1) {
			...
			if (this.expressionScope.enter(rs()), i) t.body = this.parseMaybeAssign(), this.checkParams(t, !1, e, !1);
			else {
		...
		for (let e = 0; e < a.length; e++) {
			...
			if (typeof i == "number") {
				...
				if (ve(i)) {
					...
					let f, d, y, E;
					i === 24 ? (d = h - 1, y = v(r.end, -1), f = o === null ? null : o.slice(1, -1), E = new O({
						type: R(22),
						value: "`",
						start: d,
						end: h,
						startLoc: y,
						endLoc: r.end
					})) : (d = h - 2, y = v(r.end, -2), f = o === null ? null : o.slice(1, -2), E = new O({
						type: R(23),
						value: "${",
						start: d,
						end: h,
	...
	var pt = class extends ct {
		...
		startsUsingForOf() {
			...
			if (t === 102 && !e) return !1;
			if (w(t) && !this.hasFollowingLineBreak()) return this.expectPlugin("explicitResourceManagement"), !0;
		}
		startsAwaitUsing() {
		...
		parseStatementContent(t, e) {
			...
			switch (s) {
				...
				case 82: {
					...
					let l;
					return s === 83 ? (l = this.parseImport(i), l.type === "ImportDeclaration" && (!l.importKind || l.importKind === "value") && (this.sawUnambiguousESM = !0)) : (l = this.parseExport(i, e), (l.type === "ExportNamedDeclaration" && (!l.exportKind || l.exportKind === "value") || l.type === "ExportAllDeclaration" && (!l.exportKind || l.exportKind === "value") || l.type === "ExportDefaultDeclaration") && (this.sawUnambiguousESM = !0)), this.assertModuleNodeAllowed(l), l;
				}
		...
		parseForStatement(t) {
			...
			let i = this.isContextual(95), r = new Z(), n = this.parseExpression(!0, r), o = this.isContextual(102);
			...
			for (; !this.match(i);) {
				...
				if (e && !h) {
					if (this.isValidDirective(c)) {
						...
						e.push(l), !o && l.value.value === "use strict" && (o = !0, this.setStrict(!0));
						continue;
					}
		...
		parseFunction(t, e = 0) {
			...
			return this.state.maybeInArrowParameters = !1, this.scope.enter(2), this.prodParam.enter(Ne(n, t.generator)), i || (t.id = this.parseFunctionId()), this.parseFunctionParams(t, !1), this.withSmartMixTopicForbiddingContext(() => {
		...
		parseClassMemberWithIsStatic(t, e, s, i) {
			...
			if (this.parsePostMemberNameModifiers(u), this.isClassMethod()) {
				...
				this.parseClassElementName(l), this.parsePostMemberNameModifiers(u), I ? this.pushClassPrivateMethod(t, n, S, !0) : (this.isNonstaticConstructor(r) && this.raise(p.ConstructorIsAsync, r.key), this.pushClassMethod(t, r, S, !0, !1, !1));
		...
		isExportDefaultSpecifier() {
			...
			if (w(t)) {
				...
				if ((t === 130 || t === 129) && !this.state.containsEsc) {
					...
					if (w(i) && i !== 98 || i === 5) return this.expectOnePlugin(["flow", "typescript"]), !1;
				}
			...
			if (e) {
				...
				if (s) {
					...
					if (this.checkDuplicateExports(o, c), !i && o.local) {
						let { local: l } = o;
						l.type !== "Identifier" ? this.raise(p.ExportBindingIsString, o, {
							localName: l.value,
							exportName: c
						}) : (this.checkReservedWord(l.name, l.loc.start, !0, !1), this.scope.checkLocalExport(l));
					}
				}
		...
		parseImportSpecifier(t, e, s, i, r) {
			if (this.eatContextual(93)) t.local = this.parseIdentifier();
				...
				this.checkReservedWord(n.name, t.loc.start, !0, !0), t.local || (t.local = $(n));
			}
...
function Jr$1({ isExpression: a = !1, optionsCombinations: t }) {
	return (e, s = {}) => {
		...
		let n = /%[A-Z]/u.test(e);
		e.includes("|>") ? i = (n ? [...vs, ks$1] : vs).flatMap((l) => i.map((u) => V$1([l], u))) : n && (i = i.map((c) => V$1([ks$1], c)));
	...
	for (; r >= 0;) {
		...
		switch (D) {
			...
			case le: {
				...
				let y = m.break ? Se : c, C = m.expandedStates && y === Se ? O(!1, m.expandedStates, -1) : m.contents;
				a.push({
					mode: y,
					doc: C
				});
...
`, s) : p;
			...
			case Pe: {
				...
				}, [], A, c.length > 0, r, !0) ? i.push(Fe, h, _) : j ? i.push(Fe, W, _) : i.push(Fe, W, J);
				break;
			}
			case xe:
			case He: {
...
async function Bp(e, t, r) {
	let { node: n } = r, s = n.quasis.map((m) => m.value.raw), u = 0, c = bp(await e(s.reduce((m, D, y) => y === 0 ? D : m + "@prettier-placeholder-" + u++ + "-id" + D, ""), { parser: "scss" }), Gt(r, t));
...
async function $u(e, t, r, n, s) {
	let { node: u } = n, i = ss;
	ss = ss + 1 >>> 0;
	let a = (S) => `PRETTIER_HTML_PLACEHOLDER_${S}_${i}_IN_JS`, o = u.quasis.map((S, B, _) => B === _.length - 1 ? S.value.cooked : S.value.cooked + a(B)).join(""), c = Gt(n, r), m = new RegExp(a(String.raw`(\d+)`), "gu"), D = 0, C = mt(await t(o, {
		parser: e,
		__onHtmlRoot(S) {
			D = S.children.length;
		}
...
function cc(e, t, r) {
	...
	if (((j = t.cursorNode) == null ? void 0 : j.type) === "JSXText" && n.children.includes(t.cursorNode) && (S = [
		Un,
		S,
		Un
	]), m) return S;
...
function Yr(e, t, r) {
	var J;
	let { node: n, parent: s, grandparent: u, key: i } = e, a = i !== "body" && (s.type === "IfStatement" || s.type === "WhileStatement" || s.type === "SwitchStatement" || s.type === "DoWhileStatement"), o = n.operator === "|>" && ((J = e.root.extra) == null ? void 0 : J.__isUsingHackPipeline), c = ys(e, r, t, !1, a);
	if (a) return c;
	if (o) return l(c);
	...
	if (!C) return B;
	return l([B, At(O(!1, c, -1), { groupId: S })]);
}
...
function Pi(e, t, r) {
	...
	function a(I) {
		...
		}), I.call((ee) => a(ee), "object")) : G.type === "TSNonNullExpression" ? (u.unshift({
			node: G,
			printed: ye(I, "!", t)
		}), I.call((ee) => a(ee), "expression")) : u.unshift({
			node: G,
			printed: r()
		});
	}
	...
	function S(I) {
		...
		return I.length > 0 && O(!1, I, -1).needsParens ? [
			"(",
			...G,
			")"
		] : G;
	...
	let Fe = O(!1, c[T ? 1 : 0], -1).node, H = !L(Fe) && i(Fe), ue = [
		S(c[0]),
		T ? c.slice(1, 2).map(S) : "",
		H ? F : "",
		B(c.slice(T ? 2 : 1))
	...
	function It() {
		let I = O(!1, O(!1, c, -1), -1).node, G = O(!1, _, -1);
...
function Vr(e, t, r) {
	...
	if (o || Rc(e) || St(n, e.parent)) {
		...
		if (Rt(e, () => {
			D.push(r());
		}), !(o && (m = D[0].label) != null && m.embed)) return [
			s ? "new " : "",
			Ii(e, r),
			i,
			Qe(e, t, r),
...
function Yt(e, t, r) {
	...
	if (o.length === 0) s.push(il(e, t, u, i));
		...
		let c = O(!1, o, -1), m = (c == null ? void 0 : c.type) !== "RestElement" && !n.inexact, D = c === null, y = Symbol("array"), C = !t.__inJestEach && o.length > 1 && o.every((T, S, B) => {
...
function $i(e, t, r, n = {}) {
	...
	let m = !Oe(t.originalText, c) && (Vi(c) || Fl(c, u, t) || !a && Hi(c)), D = e.key === "callee" && lt(e.parent), y = Symbol("arrow-chain"), C = Cl(e, n, {
		signatureDocs: s,
		shouldBreak: a
	}), p, A = !1;
	return o && (D || n.assignmentLayout) && (A = !0, p = n.assignmentLayout === "chain-tail-arrow-chain" || D && !m), u = Al(e, t, n, {
		bodyDoc: u,
		bodyComments: i,
		functionBody: c,
...
function Ea(e, t, r) {
	...
	return s === "ExportNamespaceSpecifier" || s === "ImportNamespaceSpecifier" ? m = "*" : o && (m = r(i)), c && !jl(n) && (D = r(a)), [
...
function dt(e, t, r) {
	...
	let o = a.flatMap((h) => e.map(({ node: W }) => ({
		node: W,
		printed: r(),
		loc: R(W)
	}), h));
	...
	let B = (j = O(!1, o, -1)) == null ? void 0 : j.node, _ = !(s.inexact || s.hasUnknownMembers || B && (B.type === "RestElement" || (B.type === "TSPropertySignature" || B.type === "TSCallSignatureDeclaration" || B.type === "TSMethodSignature" || B.type === "TSConstructSignatureDeclaration") && d(B, g.PrettierIgnore))), J;
	if (S.length === 0) {
...
function Fa(e, t, r) {
	let { node: n } = e, s = n.type === "ConditionalExpression", u = s ? "consequent" : "trueType", i = s ? "alternate" : "falseType", a = s ? ["test"] : ["checkType", "extendsType"], o = n[u], c = n[i], m = [], D = !1, { parent: y } = e, C = y.type === n.type && a.some((H) => y[H] === n), p = y.type === n.type && !C, A, T, S = 0;
	do
	...
	if (s && (X(n[a[0]]) || X(o) || X(c) || vl(_))) {
		...
		let H = (Z) => t.useTabs ? f(r(Z)) : he(2, r(Z)), ue = [
			x,
			"? ",
			o.type === n.type ? b("", "(") : "",
			H(u),
	...
	let J = [
		...
		i,
		...a
	].some((H) => d(n[H], (ue) => re(ue) && de(t.originalText, R(ue), k(ue)))), j = (H) => y === B ? l(H, { shouldBreak: J }) : J ? [H, Ee] : H, h = !D && (q(y) || y.type === "NGPipeExpression" && y.left === n) && !y.computed, W = Jl(e), Fe = j([
		Ml(e, t, r),
		p ? m : f(m),
		s && h && !W ? E : ""
	]);
...
function Vt(e, t, r, n) {
	...
	let vs = Symbol("test"), Ma = Symbol("consequent"), Fr = Symbol("test-and-consequent"), Ms = l([u ? [Ls(r("test")), s.test.type === "ConditionalExpression" ? Ee : ""] : [
		r("checkType"),
		" ",
		"extends",
		" ",
		...
		js,
		Ja
	]), qa = xt ? l([Ms, _ ? Cr : b(Cr, l(Cr, { id: Ma }), { groupId: vs })], { id: Fr }) : [Ms, Cr], kn = r(o), Rs = qe ? b(kn, Mr(Ls(kn)), { groupId: Fr }) : kn, zt = [
		qa,
		Kt.length > 0 ? [f([F, Kt]), F] : B ? F : qe ? b(x, " ", { groupId: Fr }) : x,
		":",
		B ? " " : J ? xt ? b(G, b(_ || qe ? " " : G, " "), { groupId: Fr }) : b(G, " ") : " ",
		B ? Rs : l([f(Rs), Z && !qe ? E : ""]),
		$t && !It ? E : "",
		ee ? Ee : ""
	];
...
function Ca(e, t, r, n) {
	...
	switch (s.type) {
		...
		case "VariableDeclaration": {
			...
			return a.length === 1 && !d(s.declarations[0]) ? D = a[0] : a.length > 0 && (D = f(a[0])), i = [
				$(e),
				s.kind,
				D ? [" ", D] : "",
				f(a.slice(1).map((y) => [
...
function ka(e, t, r) {
	...
	switch (n.type) {
		...
		case "TSMethodSignature": {
			...
			let o = Je(e, r, t, !1, !0), c = n.returnType ? "returnType" : "typeAnnotation", m = n[c], D = m ? Y(e, r, c) : "", y = ot(n, D);
