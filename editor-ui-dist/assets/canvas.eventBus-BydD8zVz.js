...
import { At as createEventBus, C as require__arrayMap, S as require_toString, v as require_get } from "./src-DWsTOZiq.js";
import { A as getAiTemplatesCallout, As as useSettingsStore, B as searchNodes, Dn as useTemplatesStore, Dr as useExternalHooks, E as useEvaluationStore, Gi as getThemedValue, H as sortNodeCreateElements, I as mapToolSubcategoryIcon, L as nodeTypesToCreateElements, N as groupItemsInSections, O as finalizeItems, Or as useCanvasStore, P as isAINode, R as prepareCommunityNodeDetailsViewStack, U as subcategorizeItems, W as transformNodeType, aa as useWorkflowDocumentStore, en as useTelemetry, fi as isVueFlowConnection, k as flattenCreateElements, mi as CanvasConnectionMode, na as createWorkflowDocumentId, r as useUIStore, rn as useNDVStore, rt as require__createCompounder, s as useWorkflowsStore, sl as STORES, tt as require_upperFirst, w as useNodeTypesStore } from "./users.store-Sw4oHdJA.js";
import { $ as AI_CATEGORY_LANGUAGE_MODELS, $t as CRYPTO_NODE_TYPE, Ao as EVALUATION_TRIGGER_NODE_TYPE, Ar as XML_NODE_TYPE, At as TEMPLATE_CATEGORY_AI, Cn as IF_NODE_TYPE, Ct as HUMAN_IN_THE_LOOP_CATEGORY, Et as OTHER_TRIGGER_NODES_SUBCATEGORY, Fn as MERGE_NODE_TYPE, Ft as AGGREGATE_NODE_TYPE, Gt as CHAT_TRIGGER_NODE_TYPE, I as CUSTOM_API_CALL_KEY, It as AI_CODE_NODE_TYPE, J as AI_CATEGORY_AGENTS, Jt as COMPRESSION_NODE_TYPE, Mn as MANUAL_TRIGGER_NODE_TYPE, Mt as TRIGGER_NODE_CREATOR_VIEW, Nn as MARKDOWN_NODE_TYPE, Nt as AGENT_NODE_TYPE, Oa as isHitlToolType, Ot as REGULAR_NODE_CREATOR_VIEW, Pt as AGENT_TOOL_NODE_TYPE, Rt as AI_TRANSFORM_NODE_TYPE$1, So as AI_TRANSFORM_NODE_TYPE, St as HITL_SUBCATEGORY, Ti as require__baseFlatten, Tt as NODE_CREATOR_OPEN_SOURCES, Uo as v4_default, X as AI_CATEGORY_DOCUMENT_LOADERS, Xi as require__arrayIncludesWith, Xo as require__SetCache, Y as AI_CATEGORY_CHAINS, Yo as require__cacheHas, Yt as CONVERT_TO_FILE_NODE_TYPE, Z as AI_CATEGORY_EMBEDDING, Za as isCommunityPackageName, Zi as require__arrayIncludes, _a as getNodeInputs, _r as SUMMARIZE_NODE_TYPE, ar as SCHEDULE_TRIGGER_NODE_TYPE, at as AI_CATEGORY_ROOT_NODES, bn as HTTP_REQUEST_NODE_TYPE, bt as FLOWS_CONTROL_SUBCATEGORY, cr as SET_NODE_TYPE, ct as AI_CATEGORY_VECTOR_STORES, dt as AI_NODE_CREATOR_VIEW, et as AI_CATEGORY_MCP_NODES, fn as EXECUTE_WORKFLOW_TRIGGER_NODE_TYPE, ft as AI_OTHERS_NODE_CREATOR_VIEW, gn as FORM_TRIGGER_NODE_TYPE, gt as AI_WORKFLOW_TOOL_LANGCHAIN_NODE_TYPE, ho as NodeConnectionTypes, ht as AI_UNCATEGORIZED_CATEGORY, in as EDIT_IMAGE_NODE_TYPE, it as AI_CATEGORY_RETRIEVERS, jt as TRANSFORM_DATA_SUBCATEGORY, kn as LIMIT_NODE_TYPE, lt as AI_CODE_TOOL_LANGCHAIN_NODE_TYPE, mn as FILTER_NODE_TYPE, mr as SPLIT_OUT_NODE_TYPE, mt as AI_SUBCATEGORY, nn as DATETIME_NODE_TYPE, on as EMAIL_IMAP_NODE_TYPE, ot as AI_CATEGORY_TEXT_SPLITTERS, pn as EXTRACT_FROM_FILE_NODE_TYPE, pr as SPLIT_IN_BATCHES_NODE_TYPE, pt as AI_SECTION_RECOMMENDED_TOOLS, qt as CODE_NODE_TYPE, rr as RSS_READ_NODE_TYPE, rt as AI_CATEGORY_OUTPUTPARSER, sn as EMAIL_SEND_NODE_TYPE, st as AI_CATEGORY_TOOLS, tn as DATA_TABLE_NODE_TYPE, tr as REMOVE_DUPLICATES_NODE_TYPE, tt as AI_CATEGORY_MEMORY, vt as CORE_NODES_CATEGORY, wr as WEBHOOK_NODE_TYPE, wt as NEW_TOOL_CATEGORIES, xt as HELPERS_SUBCATEGORY, yn as HTML_NODE_TYPE, yt as DEFAULT_SUBCATEGORY } from "./constants-C3KfTTly.js";
import { E as require__baseUnary, d as require_isArrayLikeObject, r as require__baseRest } from "./merge-DjxP3JHE.js";
import { j as defineStore } from "./_baseOrderBy-BACeL77R.js";
import { t as getNodeIconSource } from "./nodeIcon-IyeWTxCP.js";
import { c as parseCanvasConnectionHandleString, n as createCanvasConnectionHandleString } from "./canvas.utils-CkJ5V5RF.js";
