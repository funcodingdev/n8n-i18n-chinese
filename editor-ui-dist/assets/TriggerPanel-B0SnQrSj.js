...
import { $ as openBlock, A as createTextVNode, C as createBaseVNode, E as createElementBlock, Ft as ref, N as defineComponent, O as createSlots, Rt as shallowRef, S as computed, Sn as toDisplayString, T as createCommentVNode, Wt as unref, X as onMounted, _ as Fragment, _n as normalizeClass, bt as withDirectives, gt as watch, h as withModifiers, j as createVNode, n as Transition, ot as resolveDirective, p as vShow, q as onBeforeUnmount, rt as renderList, w as createBlock, yt as withCtx } from "./vue.runtime.esm-bundler-C6vn67cX.js";
import { c as I18nT, s as useI18n } from "./src-WwCUXbmD.js";
import { Da as N8nText_default, Oa as N8nButton_default, Ot as createEventBus, P as N8nSpinner_default, R as N8nRadioButtons_default, Ta as N8nHeading_default, ct as N8nLink_default, et as N8nInfoTip_default, gt as useRouter, ka as N8nIcon_default, tt as N8nInfoAccordion_default, z as N8nPulse_default, zi as N8nTooltip_default } from "./src-DFOx8N22.js";
import { t as _plugin_vue_export_helper_default } from "./_plugin-vue_export-helper-Da88TEg1.js";
import { $n as getTriggerNodeServiceName, Ii as CanvasNodeDirtiness, _ as useWorkflowExecutionStateStore, b as injectWorkflowDocumentStore, ki as isTriggerPanelObject, m as waitingNodeTooltip, nn as useWorkflowHelpers, q as useNodeTypesStore, t as useWorkflowsStore, un as injectNDVStore } from "./workflows.store-yqufO0kS.js";
import { $i as WORKFLOW_SETTINGS_MODAL_KEY, Da as MAX_DISPLAY_DATA_SIZE_LOGS_VIEW, Pt as CHAT_TRIGGER_NODE_TYPE, an as FORM_TRIGGER_NODE_TYPE, gc as NodeConnectionTypes, si as VIEWS } from "./constants-DIP3enMx.js";
...
import { i as NodeErrorView_default, r as ViewSubExecution_default, t as RunData_default } from "./RunData-RWXTZCZp.js";
import { n as useNodeType, t as usePinnedData } from "./usePinnedData-ByFyaVA_.js";
import { d as require_capitalize } from "./canvas.eventBus-ReVTmxIX.js";
import { a as formatTokenUsageCount, s as parseAiContent } from "./useCanvasOperations-vffmsanv.js";
import { t as injectWorkflowState } from "./useWorkflowState-Bz-qZGRx.js";
import { n as useExecutionRedaction, t as RedactedDataState_default } from "./RedactedDataState-ClZZegXb.js";
...
import { r as useNodeDirtiness } from "./useRunWorkflow-D4KaSOsp.js";
import { t as useInjectWorkflowId } from "./useInjectWorkflowId-DfNnKMN4.js";
import { n as convertToDisplayDateComponents } from "./dateFormatter-H9GithRB.js";
import { f as getConsumedTokens, i as ConsumedTokensDetails_default, s as findLogEntryById } from "./LogsOverviewRow-wmilDRUd.js";
...
import { n as getReferencedData, t as RunDataParsedAiContent_default } from "./RunDataParsedAiContent-DxnCvRNW.js";
...
var OutputPanel_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props, { emit: __emit }) {
		...
		const hasAiMetadata = computed(() => {
			...
			if (node.value) {
				const resultData = workflowDocumentStore.value.getParentNodes(node.value.name, "ALL_NON_MAIN").map(workflowsStore.getWorkflowResultDataByNodeName);
...
var OutputPanel_vue_vue_type_style_index_0_lang_module_default = {
	runData: "_runData_14t5v_130",
	runDataV2: "_runDataV2_14t5v_134",
	outputTypeSelect: "_outputTypeSelect_14t5v_138",
	titleSection: "_titleSection_14t5v_143",
	titleSectionV2: "_titleSectionV2_14t5v_151",
	title: "_title_14t5v_143",
	titleV2: "_titleV2_14t5v_163",
	noOutputData: "_noOutputData_14t5v_168",
	link: "_link_14t5v_178",
	spinner: "_spinner_14t5v_185"
};
	...
	setup(__props, { emit: __emit }) {
		...
		return (_ctx, _cache) => {
			...
			return openBlock(), createElementBlock("div", { class: normalizeClass(_ctx.$style.container) }, [createVNode(Transition, {
				...
				default: withCtx(() => [hasIssues.value || hideContent.value ? (openBlock(), createElementBlock("div", _hoisted_1)) : isListeningForEvents.value ? (openBlock(), createElementBlock("div", {
					key: "listening",
...
var TriggerPanel_default = /* @__PURE__ */ _plugin_vue_export_helper_default(TriggerPanel_vue_vue_type_script_setup_true_lang_default, [["__cssModules", { "$style": TriggerPanel_vue_vue_type_style_index_0_lang_module_default }], ["__scopeId", "data-v-01ecdf55"]]);
//#endregion
