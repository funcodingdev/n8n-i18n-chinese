const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/es-DGBIxrpD.js","assets/chunk-CC9Q-vWm.js","assets/core-CNaHbrd8.js","assets/languageModules-6xKNTpaw.js","assets/xml-CT7Es5BQ.js"])))=>i.map(i=>d[i]);
...
import { Ii as N8nButton_default, Nr as truncateBeforeLast } from "./src-BoizZDiU.js";
	...
	async function loadLanguageModules() {
		...
		try {
			const promise = Promise.all([__vitePreload(async () => {
				const { default: highlight } = await import("./es-DGBIxrpD.js");
				return { default: highlight };
			}, __vite__mapDeps([0,1,2])).then(({ default: highlight }) => highlight), __vitePreload(() => import("./languageModules-6xKNTpaw.js"), __vite__mapDeps([3,4]))]);
			asyncImport = {
				status: "inProgress",
				promise
			};
