...
import { M as useMediaQuery, R as useStorage$1, dt as addHeaders, ft as addNodeTranslation, gt as useI18n, j as useLocalStorage, pt as i18n, x as useAsyncState } from "./_MapCache-B3wBxKdj.js";
import { B as removeClass, I as addClass, Pt as isClient$1, R as getStyle, S as useGlobalComponentSettings, l as require_memoize, r as require_get, s as require_toString, t as truncate, x as createEventBus, y as useRoute } from "./truncate-5E8n_f_n.js";
import { $a as CHAT_TRIGGER_NODE_TYPE$1, $i as getConnectionTypes, $n as SCHEDULE_TRIGGER_NODE_TYPE, $t as DISCORD_NODE_TYPE, Ai as splitExpression, B as MAPPING_PARAMS, Bo as CONFIRM_PASSWORD_MODAL_KEY, Bt as CALENDLY_TRIGGER_NODE_TYPE, Cr as WORKFLOW_TRIGGER_NODE_TYPE, Ct as HUMAN_IN_THE_LOOP_CATEGORY, D as TEMPLATES_NODES_FILTER, Do as hasScope$1, Dr as ZENDESK_TRIGGER_NODE_TYPE, Dt as RECOMMENDED_NODES, Ea as deepCopy, Ec as MAIN_AUTH_FIELD_NAME, En as MANUAL_CHAT_TRIGGER_NODE_TYPE, Eo as getResourcePermissions, Er as ZENDESK_NODE_TYPE, Es as LOCAL_STORAGE_EXPERIMENT_OVERRIDES, Et as PRE_BUILT_AGENTS_COLLECTION, F as PLACEHOLDER_FILLED_AT_EXECUTION_TIME, Fi as isExpression, Fn as NODE_POSITION_CONFLICT_ALLOWLIST, Fo as VIEWS, Ga as NodeConnectionTypes, Gn as PAGERDUTY_NODE_TYPE, Go as EXPERIMENT_TEMPLATE_RECO_V3_KEY, Ho as DUPLICATE_MODAL_KEY, Ht as CLEARBIT_NODE_TYPE, I as APPEND_ATTRIBUTION_DEFAULT_PATH, Io as ABOUT_MODAL_KEY, It as AI_MCP_TOOL_NODE_TYPE, J as NODE_MIN_INPUT_ITEMS_COUNT, Ji as getNodeByName, Jo as IMPORT_CURL_MODAL_KEY, Ka as nodeConnectionTypes, Ko as EXTERNAL_SECRETS_PROVIDER_MODAL_KEY, Kt as CREDENTIAL_ONLY_HTTP_NODE_VERSION, L as CUSTOM_API_CALL_KEY, Ln as NON_ACTIVATABLE_TRIGGER_NODE_TYPES, Lo as CHANGE_PASSWORD_MODAL_KEY, Lt as AI_TRANSFORM_NODE_TYPE, Mc as AI_ASSISTANT_MAX_CONTENT_LENGTH, Mn as MICROSOFT_TEAMS_NODE_TYPE, Na as sleep$1, Nc as AI_NODES_PACKAGE_NAME, Nn as MODULE_ENABLED_NODES, Oa as isObjectEmpty, Pi as require__baseFindIndex, Po as MAIN_HEADER_TABS, Qi as displayParameterPath, Qn as SALESFORCE_NODE_TYPE, Qs as WorkflowStateKey, R as DATA_TYPE_ICON_MAP, Rn as NOTION_TRIGGER_NODE_TYPE, Ro as CHAT_EMBED_MODAL_KEY, Rs as LOCAL_STORAGE_THEME, Rt as BAMBOO_HR_NODE_TYPE, Sn as JIRA_TRIGGER_NODE_TYPE, So as ApplicationError, Sr as WORKABLE_TRIGGER_NODE_TYPE, Tn as LIST_LIKE_NODE_OPERATIONS, Ua as ExpressionError, Ui as createEmptyRunExecutionData, Uo as EXPERIMENT_TEMPLATES_DATA_QUALITY_KEY, Ut as CODE_NODE_TYPE, Vo as CONTACT_PROMPT_MODAL_KEY, Vt as CHAT_TRIGGER_NODE_TYPE, W as INSECURE_CONNECTION_WARNING, Wo as EXPERIMENT_TEMPLATE_RECO_V2_KEY, X as AI_CATEGORY_AGENTS, Xi as generateNodesGraph, Xo as LOG_STREAM_MODAL_KEY, Xr as ROLE, Yi as getChildNodes, Yn as QUICKBOOKS_NODE_TYPE, Yo as IMPORT_WORKFLOW_URL_MODAL_KEY, Zo as MFA_SETUP_MODAL_KEY, _i as Workflow, _n as HUBSPOT_TRIGGER_NODE_TYPE, _s as WORKFLOW_SETTINGS_MODAL_KEY, _t as BETA_NODES, as as PROMPT_MFA_CODE_MODAL_KEY, bi as require__baseIteratee, bn as ITEM_LISTS_NODE_TYPE, c as PLACEHOLDER_EMPTY_WORKFLOW_ID, ci as require_pick, cs as WHATS_NEW_MODAL_KEY, ct as AI_CATEGORY_TOOLS, dn as FORM_NODE_TYPE, ds as WORKFLOW_DIFF_MODAL_KEY, ea as getNodeInputs, er as SEGMENT_NODE_TYPE, et as AI_CATEGORY_LANGUAGE_MODELS, fn as FORM_TRIGGER_NODE_TYPE, fo as SEND_AND_WAIT_OPERATION, fs as WORKFLOW_EXTRACTION_NAME_MODAL_KEY, g as DOCS_DOMAIN, gn as HTTP_REQUEST_NODE_TYPE, go as require_isEqual, gs as WORKFLOW_PUBLISH_MODAL_KEY, ha as mergeIssues, hc as EnterpriseEditionFeature, ho as WEBHOOK_NODE_TYPE$1, hr as THE_HIVE_TRIGGER_NODE_TYPE, hs as WORKFLOW_HISTORY_VERSION_UNPUBLISH, i as DUPLICATE_POSTFFIX, ia as getNodeWebhookUrl, in as ERROR_TRIGGER_NODE_TYPE, io as FORM_TRIGGER_NODE_TYPE$1, is as PRE_BUILT_AGENTS_MODAL_KEY, jn as MICROSOFT_EXCEL_NODE_TYPE, ka as jsonParse, li as require__baseFlatten, lo as MANUAL_TRIGGER_NODE_TYPE, lr as SPREADSHEET_FILE_NODE_TYPE, ls as WORKFLOW_ACTIVATION_CONFLICTING_WEBHOOK_MODAL_KEY, ma as makeNodeName, mn as GOOGLE_SHEETS_NODE_TYPE, mr as TELEGRAM_NODE_TYPE, ms as WORKFLOW_HISTORY_VERSION_RESTORE, mt as AI_SUBCATEGORY, n as DEFAULT_NODETYPE_VERSION, na as getNodeParameters, no as EVALUATION_TRIGGER_NODE_TYPE, nr as SET_NODE_TYPE, ns as NODE_PINNING_MODAL_KEY, nt as AI_CATEGORY_MEMORY, o as MAX_WORKFLOW_NAME_LENGTH, on as EXECUTE_COMMAND_NODE_TYPE, or as SLACK_NODE_TYPE, os as SETUP_CREDENTIALS_MODAL_KEY, ot as AI_CATEGORY_ROOT_NODES, pn as GITHUB_TRIGGER_NODE_TYPE, po as TRIMMED_TASK_DATA_CONNECTIONS_KEY, pr as SWITCH_NODE_TYPE, ps as WORKFLOW_HISTORY_PUBLISH_MODAL_KEY, qi as mapConnectionsByDestination, qo as FROM_AI_PARAMETERS_MODAL_KEY, qt as CREDENTIAL_ONLY_NODE_PREFIX, r as DEFAULT_WORKFLOW_PAGE_SIZE, ra as getNodeParametersIssues, rc as EXPERIMENTS_TO_TRACK, rn as EMAIL_SEND_NODE_TYPE, rs as NPS_SURVEY_MODAL_KEY, rt as AI_CATEGORY_OTHER_TOOLS, sr as SPLIT_IN_BATCHES_NODE_TYPE, ss as VERSIONS_MODAL_KEY, t as DEFAULT_NEW_WORKFLOW_NAME, ta as getNodeOutputs, tn as ELASTIC_SECURITY_NODE_TYPE, to as EVALUATION_NODE_TYPE, tr as SERVICENOW_NODE_TYPE, ts as NEW_ASSISTANT_SESSION_MODAL, ur as START_NODE_TYPE, us as WORKFLOW_ACTIVE_MODAL_KEY, vn as IF_NODE_TYPE, vo as require_keys, vr as WAIT_NODE_TYPE, vs as WORKFLOW_SHARE_MODAL_KEY, vt as CORE_NODES_CATEGORY, wr as XERO_NODE_TYPE, xa as isResourceLocatorValue, xn as JIRA_NODE_TYPE, xr as WOOCOMMERCE_TRIGGER_NODE_TYPE, yr as WEBHOOK_NODE_TYPE, yt as DEFAULT_SUBCATEGORY } from "./constants-ASQneu7i.js";
import { n as require__isIterateeCall, o as require_identity, r as require__baseRest, t as require_merge, y as require_isArrayLike } from "./merge-D31ghcsp.js";
import { C as INSTANCE_VERSION_HEADER, E as N8N_IO_BASE_URL, S as INSTANCE_ID_HEADER, T as BROWSER_ID_STORAGE_KEY, c as get$3, d as post, f as request, h as axios_default, k as defineStore, l as getFullApiResponse, p as streamRequest, r as useRootStore, s as ResponseError, t as require__baseOrderBy, u as makeRestApiRequest, w as NPM_COMMUNITY_NODE_SEARCH_API_URL } from "./_baseOrderBy-Um45iusw.js";
import { t as require_dateformat } from "./dateformat-CMLc6OKJ.js";
import { r as require_toNumber, t as useDebounce } from "./useDebounce-B6sO5jq1.js";
...
const useWorkflowsStore = defineStore(STORES.WORKFLOWS, () => {
	...
	async function saveWorkflowDescription(id$1, description) {
		let currentVersionId = "";
		const isCurrentWorkflow = id$1 === workflow.value.id;
		if (isCurrentWorkflow) currentVersionId = workflow.value.versionId;
		else {
			const cached = workflowsById.value[id$1];
