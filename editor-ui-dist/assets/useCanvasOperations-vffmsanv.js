...
import { $ as openBlock, A as createTextVNode, At as isRef, C as createBaseVNode, E as createElementBlock, Ft as ref, N as defineComponent, R as inject, Rt as shallowRef, S as computed, Sn as toDisplayString, T as createCommentVNode, U as mergeProps, W as nextTick, Wt as unref, _ as Fragment, _n as normalizeClass, it as renderSlot, j as createVNode, rt as renderList, st as resolveDynamicComponent, w as createBlock, yt as withCtx } from "./vue.runtime.esm-bundler-C6vn67cX.js";
import { s as useI18n$1 } from "./src-WwCUXbmD.js";
import { Bi as require_markdown_it_link_attributes, gt as useRouter, ht as useRoute } from "./src-DFOx8N22.js";
import { t as _plugin_vue_export_helper_default } from "./_plugin-vue_export-helper-Da88TEg1.js";
import { B as MoveNodeCommand, Er as getNodesGroupSize, F as AddConnectionCommand, Fi as CanvasConnectionMode, H as RemoveNodeCommand, I as AddNodeCommand, K as require_uniq, Li as CanvasNodeRenderType, M as useCanvasStore, O as serializeNode, P as useHistoryStore, U as RenameNodeCommand, V as RemoveConnectionCommand, W as ReplaceNodeParametersCommand, Zr as createCanvasConnectionHandleString, _ as useWorkflowExecutionStateStore, an as ensureNodePosition, b as injectWorkflowDocumentStore, ct as removePreviewToken, fr as CONFIGURABLE_NODE_SIZE, gr as PUSH_NODES_OFFSET, hr as DEFAULT_VIEWPORT_BOUNDARIES, ii as parseCanvasConnectionHandleString, in as useTagsStore, ji as isValidNodeConnectionType, k as useNodeHelpers, kt as useCredentialsStore, li as pinDataToExecutionData, mr as DEFAULT_NODE_SIZE, ni as mapLegacyConnectionToCanvasConnection, nn as useWorkflowHelpers, pr as CONFIGURATION_NODE_SIZE, q as useNodeTypesStore, ri as mapLegacyConnectionsToCanvasConnections, sn as sanitizeConnections, t as useWorkflowsStore, ti as mapCanvasConnectionToLegacyConnection, u as getExecutionErrorToastConfiguration, un as injectNDVStore, v as createWorkflowDocumentId, vr as doRectsOverlap, wr as getNewNodePosition, yn as useProjectsStore, yr as generateOffsets, zt as useDataSchema } from "./workflows.store-yqufO0kS.js";
import { t as useToast } from "./useToast-C1BAsL26.js";
import { $s as isCommunityPackageName, As as isHitlToolType, Bl as CANVAS_ZOOMED_VIEW_EXPERIMENT, Bo as require_cloneDeep, Es as getSubworkflowId, Gc as v4, Pt as CHAT_TRIGGER_NODE_TYPE, Qs as deepCopy, Rs as resolveNodeWebhookId, _a as LOCAL_STORAGE_LOGS_SYNC_SELECTION, bn as MANUAL_CHAT_TRIGGER_NODE_TYPE, bs as getNodeOutputs, ec as isObjectEmpty, fr as UPDATE_WEBHOOK_ID_NODE_TYPES, fu as EnterpriseEditionFeature, ga as LOCAL_STORAGE_LOGS_PANEL_OPEN, gc as NodeConnectionTypes, ha as LOCAL_STORAGE_LOGS_PANEL_DETAILS_PANEL_SUB_NODE, hs as generateNodesGraph, ma as LOCAL_STORAGE_LOGS_PANEL_DETAILS_PANEL, or as STICKY_NODE_TYPE, si as VIEWS, tu as NDV_IN_FOCUS_PANEL_EXPERIMENT, vs as getConnectionTypes, xs as getNodeParameters, ys as getNodeInputs } from "./constants-DIP3enMx.js";
...
import { _ as useLocalStorage, c as useClipboard } from "./core-nZc0i8VB.js";
import { f as useUIStore, g as usePostHog, p as useTelemetry } from "./users.store-0wV1ayWS.js";
import { p as isPresent, y as tryToParseNumber } from "./workflowsList.store-C7raj-u1.js";
...
import { t as useExecutionsStore } from "./executions.store-FLppR9SZ.js";
...
import { t as clearAllNodeResourceLocatorValues } from "./templateTransforms-RbM7Oq8Y.js";
...
function useCanvasOperations() {
	...
	*/
	...
	function replaceNodeConnections(previousId, newId, { trackHistory = false, trackBulk = true, replaceInputs = true, replaceOutputs = true } = {}) {
		...
		const connectionPairs = [...workflowDocumentStore.value.getConnectionsBetweenNodes(inputNodeNames, [previousNode.name]) ?? [], ...workflowDocumentStore.value.getConnectionsBetweenNodes([previousNode.name], outputNodeNames) ?? []];
		if (trackHistory && trackBulk) historyStore.startRecordingUndo();
	...
	*/
	...
	function createConnectionToLastInteractedWithNode(node, options = {}) {
		...
		if (lastInteractedWithNodeConnection) {
			...
			if (workflowDocumentStore.value.getNodeById(lastInteractedWithNodeConnection.target)) createConnection({
				source: node.id,
				sourceHandle: createCanvasConnectionHandleString({
					mode: CanvasConnectionMode.Input,
					type: NodeConnectionTypes.Main,
	...
	*/
	function resetWorkspace() {
		...
		if (useWorkflowExecutionStateStore(createWorkflowDocumentId(workflowsStore.workflowId)).executionWaitingForWebhook) try {
	...
	*/
	...
	async function importTemplate({ name, workflow }) {
		...
		const workflowData = await workflowState.getNewWorkflowData(name, projectsStore.currentProjectId);
		workflowDocumentStore.value.setName(workflowData.name);
	}
...
//#endregion
export { MarkdownRenderer_default as C, useChat as D, useOptions as E, MessageWithButtons_default as S, useI18n as T, shouldBlockUserInput as _, formatTokenUsageCount as a, localStorageSessionIdKey as b, useLogsStore as c, LOCAL_STORAGE_PANEL_WIDTH as d, LOGS_PANEL_STATE as f, parseBotChatMessageContent as g, constructChatWebsocketUrl as h, emptyTokenUsageData as i, LOCAL_STORAGE_OVERVIEW_PANEL_WIDTH as l, chatEventBus as m, useExperimentalNdvStore as n, isChatNode as o, LOG_DETAILS_PANEL_STATE as p, addTokenUsageData as r, parseAiContent as s, useCanvasOperations as t, LOCAL_STORAGE_PANEL_HEIGHT as u, ChatOptionsSymbol as v, Button_default as w, MessageComponentKey as x, ChatSymbol as y };
