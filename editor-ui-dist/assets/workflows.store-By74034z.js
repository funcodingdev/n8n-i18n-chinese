const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/workers-DRakgHY6.js","assets/comlink-_cJ6__tx.js"])))=>i.map(i=>d[i]);
...
import { _ as addNodeTranslation, g as addHeaders, v as i18n, x as useI18n } from "./_MapCache-DTYzu2mo.js";
import { Y as isBinary, sa as truncate } from "./src-CH7oGKAF.js";
import { d as __vitePreload, s as require_memoize, t as require_get } from "./get-B0Da33mp.js";
import { M as createEventHook, R as throttledWatch, y as useLocalStorage } from "./dist-BkE9aYmt.js";
import { c as sanitizeHtml, g as useRoute } from "./htmlUtils-BvbMD63z.js";
...
import { b as require_isArrayLike, t as require_merge } from "./merge-endNRxhm.js";
	...
	const loadNodesInformationFromLocalDb = async (nodeInfos) => {
		try {
			const { getNodeType } = await __vitePreload(async () => {
				const { getNodeType } = await import("./workers-DRakgHY6.js");
				return { getNodeType };
			}, __vite__mapDeps([0,1]));
			const found = [];
			const missing = [];
	...
	const loadNodeTypesFromLocalDb = async () => {
		try {
			const { loadNodeTypes, getAllNodeTypes } = await __vitePreload(async () => {
				const { loadNodeTypes, getAllNodeTypes } = await import("./workers-DRakgHY6.js");
				return {
					loadNodeTypes,
					getAllNodeTypes
				};
