import { Et as effectScope, It as ref, Lt as shallowReactive, Pt as reactive, R as inject, S as computed, Wt as triggerRef, gt as watch, tt as provide } from "./vue.runtime.esm-bundler-DYHsQBZB.js";
import { s as useI18n } from "./src-BBBtAtId.js";
import { $t as INSTANCE_AI_THREAD_SOURCE_FALLBACK, C as findAgent, E as toAgentTree, Gn as isRecord, S as createInitialState, T as stateFromAgentTree, Yt as INSTANCE_AI_EPHEMERAL_EVENT_TYPES, an as buildUpdateWorkflowSessionGrantKey, di as mapConnectionsByDestination, dn as instanceAiEventSchema, fi as getParentNodes, in as buildRunWorkflowSessionGrantKey, io as v4, pi as getChildNodes, pn as isSafeObjectKey, rn as buildDataTablesSessionGrantKey, w as reduceEvent } from "./src-BrbN-vPn.js";
import { Zn as ResponseError, er as makeRestApiRequest, t as useRootStore, ur as defineStore } from "./useRootStore-B-A2Ktsc.js";
import { t as useTelemetry } from "./useTelemetry-CgKpOMtU.js";
import { n as useToast } from "./useToast-Cc_wtr1y.js";
import { n as redactTelemetryText, t as redactTelemetryProperties } from "./src-BmGqsjIb.js";
import { t as useWorkflowsListStore } from "./workflowsList.store-DR9pamv2.js";
import { S as isInstanceAiThreadSource, a as INSTANCE_AI_AGENT_BUILDER_TARGET_METADATA_KEY, f as INSTANCE_AI_PENDING_AGENT_METADATA_KEY, o as INSTANCE_AI_AGENT_PREVIEW_SESSION_METADATA_KEY, s as INSTANCE_AI_AGENT_PREVIEW_VIEW_METADATA_KEY } from "./constants-D5OEjQEP.js";
import { a as postCancel, c as postFeedback, i as getInstanceAiCredits, l as postMessage, o as postCancelTask, r as ensureThread, s as postConfirmation, t as useInstanceAiSettingsStore } from "./instanceAiSettings.store-BbR4Z44G.js";
...
*/
function useResourceRegistry(messages, workflowNameLookup, archivedWorkflowIds, agentBuilderTarget, pendingAgentTarget) {
...
function collectPendingConfirmations(node, messageId, resolved, out) {
	for (const tc of node.toolCalls) if (tc.confirmation && tc.isLoading && tc.confirmationStatus !== "approved" && tc.confirmationStatus !== "denied" && !resolved.has(tc.confirmation.requestId) && !tc.confirmation.expired && tc.confirmation.inputType !== "plan-review" && !tc.confirmation.mcpConnectRequest) out.push({
		toolCall: tc,
		agentNode: node,
		messageId
	});
...
function createThreadRuntime(threadId, hooks, initialProjectId) {
	...
	*/
	...
	watch(pendingConfirmations, async (items) => {
		...
		for (const item of items) {
			...
			const key = buildAlwaysAllowKey(item.toolCall.toolName, item.toolCall.args ?? {}, conf.workflowId);
	...
	*/
	...
	function trackUserMessageSent(isFirstMessage) {
		...
		const actionSource = isInstanceAiThreadSource(rawSource) ? rawSource : INSTANCE_AI_THREAD_SOURCE_FALLBACK;
	...
	*/
	...
	async function syncThread(threadId, projectId, launch) {
		...
		threads.value.unshift({
			...
			metadata: result.thread.metadata ?? void 0
		});
	}
	/**
...
//#endregion
export { fetchThreadDebugRuns as C, persistPendingAgent as E, fetchRunDebug as S, fetchThreads as T, getLatestDeletedDataTableId as _, countAttachedNodes as a, isAgentEditingAgent as b, getAgentPreviewSessionFromThreadMetadata as c, getExecutionResultsByWorkflow as d, getLatestAgentBuilderTarget as f, getLatestDataTableResult as g, getLatestBuilderTarget as h, buildNodesAttachment as i, getAgentPreviewViewFromThreadMetadata as l, getLatestBuildResult as m, useInstanceAiStore as n, mergeNodeSets as o, getLatestAgentConfigMutation as p, useThread as r, getAgentBuilderTargetFromThreadMetadata as s, provideThread as t, getPendingAgentTargetFromThreadMetadata as u, getLatestWorkflowSetupResult as v, fetchThreadMessages as w, isAgentEditingWorkflow as x, getLatestWorkflowUpdateResult as y };
