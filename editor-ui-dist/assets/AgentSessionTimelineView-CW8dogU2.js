import { $ as openBlock, A as createTextVNode, C as createBaseVNode, Cn as toDisplayString, E as createElementBlock, Gt as unref, It as ref, N as defineComponent, S as computed, T as createCommentVNode, W as nextTick, X as onMounted, _ as Fragment, bn as normalizeStyle, bt as withCtx, gt as watch, h as withModifiers, j as createVNode, n as Transition, q as onBeforeUnmount, rt as renderList, tt as provide, vn as normalizeClass, w as createBlock } from "./vue.runtime.esm-bundler-CDDUUZhE.js";
...
import { m as useEventListener, o as useActiveElement } from "./core-DOUvgShw.js";
import { t as useToast } from "./useToast-CsW2zDDU.js";
import { Wr as AGENT_BUILDER_VIEW, Yr as AGENT_SESSION_DETAIL_VIEW, gu as WorkflowIdKey, is as Workflow, ri as EXECUTIONS_SECTION_KEY, ui as VIEWS } from "./constants-DzzWpyjZ.js";
import { Kt as useWorkflowExecutionStateStore, Or as shouldIgnoreCanvasShortcut, _ as useNodeTypesStore, bn as useProjectsStore, jt as useWorkflowHelpers, r as createWorkflowDocumentId, sn as useWorkflowsStore } from "./workflowDocument.store-BQc6YDGi.js";
import { s as truncate } from "./dist-BXENiK5V.js";
import { t as useExecutionsStore } from "./executions.store-2yTBeGkU.js";
import { i as NodeErrorView_default, t as RunData_default } from "./RunData-DWU8fxmZ.js";
import { x as ChatSymbol } from "./useCanvasOperations-BWewjGNJ.js";
import { t as VueMarkdown } from "./VueMarkdown-D5iaZbjL.js";
import { t as convertToDisplayDate } from "./dateFormatter-6KJLF3uT.js";
import { d as flattenLogEntries, h as getSubtreeTotalConsumedTokens, o as createLogTree, t as LogsOverviewRow_default } from "./LogsOverviewRow-CyGcbSgu.js";
...
import { a as delegateLabel, c as isDelegateSubAgentTool, f as resolveSubAgentName, g as parseIntegrationActionCard, n as getToolNameTranslationKey, r as useSubAgentNames, t as formatToolNameForDisplay } from "./toolDisplayName-CDhdllEq.js";
...
function timelineItemSearchText(item, labelForKey) {
	...
	parts.push(item.content, item.toolName, item.workflowName, item.nodeDisplayName, item.subAgentName);
