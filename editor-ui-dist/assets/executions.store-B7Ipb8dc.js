...
import { a as executionFilterToQueryFilter, bn as useProjectsStore, c as getDefaultExecutionFilters, m as unflattenExecutionData } from "./workflows.store-C0TGOSWn.js";
	...
	*/
	...
	async function fetchExecutions(filter = executionsFilters.value, lastId, firstId) {
		...
		try {
			...
			if (isLoadMore) hasMoreExecutions.value = isFullPage;
			else if (!isFullPage) hasMoreExecutions.value = false;
