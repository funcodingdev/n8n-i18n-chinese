...
(function () {
  System.register(["./vue.runtime.esm-bundler-legacy--Sn1h8On.js", "./useTelemetry-legacy-DKRvN4mA.js", "./_baseOrderBy-legacy-9y2xV7og.js"], function (_export, _context) {
    ...
    var computed, ref, getApiKeys, getApiKeyScopes, createApiKey, deleteApiKey, STORES, updateApiKey, defineStore, useRootStore, useApiKeysStore;
    return {
      setters: [function (_vueRuntimeEsmBundlerLegacy003Js) {
        computed = _vueRuntimeEsmBundlerLegacy003Js.C;
        ref = _vueRuntimeEsmBundlerLegacy003Js.It;
      }, function (_useTelemetryLegacy00HJs) {
        getApiKeys = _useTelemetryLegacy00HJs.$s;
        getApiKeyScopes = _useTelemetryLegacy00HJs.Qs;
        createApiKey = _useTelemetryLegacy00HJs.Xs;
        deleteApiKey = _useTelemetryLegacy00HJs.Zs;
        STORES = _useTelemetryLegacy00HJs.cc;
        updateApiKey = _useTelemetryLegacy00HJs.ec;
