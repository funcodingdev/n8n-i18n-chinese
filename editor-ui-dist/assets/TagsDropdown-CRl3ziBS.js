import { $ as openBlock, C as createBaseVNode, Cn as toDisplayString, E as createElementBlock, Gt as unref, It as ref, N as defineComponent, S as computed, T as createCommentVNode, W as nextTick, X as onMounted, _ as Fragment, bt as withCtx, gt as watch, h as withModifiers, j as createVNode, q as onBeforeUnmount, rt as renderList, vn as normalizeClass, w as createBlock } from "./vue.runtime.esm-bundler-CDDUUZhE.js";
import { s as useI18n } from "./src-Dh32dOY5.js";
import { Tt as N8nOption_default, Ya as N8nIcon_default, wt as N8nSelect_default } from "./src-BVC_ZvSs.js";
import { n as onClickOutside } from "./core-DOUvgShw.js";
import { t as useToast } from "./useToast-Nt5eA7S4.js";
import { Dl as v4 } from "./constants-Xm8Zfd-h.js";
	...
	setup(__props, { emit: __emit }) {
		...
		async function onCreate() {
			...
			try {
				...
				showError(error, i18n.baseText("tagsDropdown.showError.title"), { message: i18n.baseText("tagsDropdown.showError.message", { interpolate: { name } }) });
			}
		}
