...
import { D as ROLE, bi as BROWSER_ID_STORAGE_KEY } from "./src-BrbN-vPn.js";
import { C as updateCurrentUserPassword, D as validatePasswordToken, E as updateOtherUserSettings, Ft as getMfaQR, It as updateEnforceMfa, J as oidcLogout, Lt as verifyMfaCode, Mt as canEnableMFA, Nt as disableMfa, O as validateSignupToken, Pt as enableMfa, S as updateCurrentUser, T as updateGlobalRole, Vn as sendConfirmationEmail, Zn as ResponseError, _ as loginCurrentUser, b as setupOwner, d as changePassword, er as makeRestApiRequest, f as deleteUser, g as login, h as getUsers, m as getPasswordResetLink, p as generateInviteLink, sr as STORES, t as useRootStore, tr as post, ur as defineStore, v as logout, w as updateCurrentUserSettings, x as submitPersonalizationSurvey, y as sendForgotPasswordEmail } from "./useRootStore-B-A2Ktsc.js";
...
var _isSessionAlreadyInvalid = (error) => error instanceof ResponseError && error.httpStatusCode === 401;
var useUsersStore = defineStore(STORES.USERS, () => {
	...
	const logout$1 = async (options) => {
		...
		if (options?.viaOidc) try {
			({redirectUrl} = await oidcLogout(rootStore.restApiContext));
		} catch {
