...
import { L as useNodeTypesStore, Or as PUSH_NODES_OFFSET, et as removePreviewToken, it as sortNodeCreateElements, ot as transformNodeType, pi as CHANGE_ACTION, w as injectWorkflowDocumentStore } from "./workflows.store-w-uLno6O.js";
import { Ni as CHAIN_LLM_LANGCHAIN_NODE_TYPE, ai as NodeConnectionTypes } from "./src-UnL6BUww.js";
import { At as BASIC_CHAIN_NODE_TYPE, Ct as TRIGGER_NODE_CREATOR_VIEW, Dn as OPEN_AI_NODE_TYPE, En as OPEN_AI_NODE_MESSAGE_ASSISTANT_TYPE, Fn as SCHEDULE_TRIGGER_NODE_TYPE, Pt as CHAT_TRIGGER_NODE_TYPE, Tn as OPEN_AI_ASSISTANT_NODE_TYPE, Un as STICKY_NODE_TYPE, Vn as SPLIT_IN_BATCHES_NODE_TYPE, Xn as WEBHOOK_NODE_TYPE, fn as MANUAL_TRIGGER_NODE_TYPE, gn as MESSAGE_AN_AGENT_NODE_TYPE, gt as NODE_CREATOR_OPEN_SOURCES, jn as QA_CHAIN_NODE_TYPE, q as AI_CATEGORY_LANGUAGE_MODELS, wn as NO_OP_NODE_TYPE, wt as AGENT_NODE_TYPE } from "./constants-On-mUxgN.js";
...
var useActions = () => {
	...
	*/
	function getConnectionTriggerNode() {
		if (nodeCreatorStore.openingContext === "replacement") return void 0;
		const nodeId = uiStore.lastInteractedWithNodeId;
		const node = nodeId ? workflowDocumentStore.value.getNodeById(nodeId) : void 0;
		return node && nodeTypesStore.isTriggerNode(node.type) ? node : void 0;
	}
	function getAddedNodesAndConnections(addedNodes) {
		...
		if (shouldPrependLLMChain(addedNodes) || !isConnectingToExistingTrigger && shouldPrependChatTrigger(addedNodes)) {
