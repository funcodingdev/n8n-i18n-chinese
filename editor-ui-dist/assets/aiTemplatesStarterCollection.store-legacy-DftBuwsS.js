;
(function () {
  System.register(["./vue.runtime.esm-bundler-legacy--Sn1h8On.js", "./_MapCache-legacy-Bnay2tPV.js", "./useTelemetry-legacy-DKRvN4mA.js", "./constants-legacy-BbwdWVie.js", "./_baseOrderBy-legacy-9y2xV7og.js", "./folders.store-legacy-DAIQGD7o.js"], function (_export, _context) {
    "use strict";

    var computed, useI18n, useLocalStorage, useSettingsStore, STORES, usePostHog, useWorkflowsStore, useTelemetry, TEMPLATE_ONBOARDING_EXPERIMENT, defineStore, useFoldersStore, AGENT_WITH_MEMORY, AGENT_WITH_TOOLS, AGENT_WITH_KNOWLEDGE, LOCAL_STORAGE_SETTING_KEY, useAITemplatesStarterCollectionStore;
    return {
      ...
      execute: function () {
        ...
        LOCAL_STORAGE_SETTING_KEY = "N8N_AI_TEMPLATES_STARTER_COLLECTION_CALL_OUT_DISMISSED";
        _export("t", useAITemplatesStarterCollectionStore = defineStore(STORES.AI_TEMPLATES_STARTER_COLLECTION, () => {
