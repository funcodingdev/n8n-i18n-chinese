...
var zh_CN_default = {
	...
	"settings.secretsProviderConnections.modal.title.create": "添加外部密钥连接",
	"settings.secretsProviderConnections.modal.title.edit": "编辑连接",
	"settings.secretsProviderConnections.modal.items.connection": "连接",
	"settings.secretsProviderConnections.modal.providerKey": "提供者密钥",
	"settings.secretsProviderConnections.modal.connectionName": "连接名称",
	"settings.secretsProviderConnections.modal.providerType": "外部秘密提供者",
	"settings.secretsProviderConnections.modal.testConnection": "测试连接",
	"settings.secretsProviderConnections.modal.save": "保存",
	"settings.secretsProviderConnections.modal.saving": "保存中...",
	"settings.secretsProviderConnections.modal.saved": "已保存",
	"settings.secretsProviderConnections.modal.unsavedChanges": "您有未保存的更改。您确定要关闭吗？",
	"settings.secretsProviderConnections.modal.error.invalidCredentials": "凭证无效。请检查您的设置。",
	"settings.secretsProviderConnections.modal.error.insufficientPermissions": "您没有权限执行此操作。",
	"settings.secretsProviderConnections.modal.success.created": "连接成功创建",
	"settings.secretsProviderConnections.modal.success.updated": "连接成功更新",
	"settings.secretsProviderConnections.modal.testConnection.success": "连接测试成功",
	...
	"settings.secretsProviderConnections.modal.connectionName.error": "必须提供秘密存储名称。请输入一个唯一的秘密存储名称。",
	...
	"settings.secretsProviderConnections.modal.connectionName.placeholder": "请输入您秘密存储的唯一名称。这一名称之后无法更改。",
