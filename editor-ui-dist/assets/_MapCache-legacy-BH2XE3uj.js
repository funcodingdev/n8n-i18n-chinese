      ...
      execute: function () {
        ...
        */
        ...
        zh_CN_default = {
          ...
          "settings.mcp.oAuthClients.table.empty.title": "没有连接的 OAuth 客户端",
          ...
          "workflowSettings.timeSavedPerExecution.fixedTabWarning": "有一个或多个 {link} 动态计算此工作流节省的时间。当您的工作流配置为固定的节省时间值时，这些节点将被忽略。",
