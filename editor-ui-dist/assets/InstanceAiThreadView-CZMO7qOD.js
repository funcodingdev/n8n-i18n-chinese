...
import { $ as openBlock, A as createTextVNode, Bt as toRef, C as createBaseVNode, E as createElementBlock, Ft as ref, N as defineComponent, Nt as reactive, O as createSlots, Q as onUpdated, R as inject, Rt as shallowRef, S as computed, Sn as toDisplayString, T as createCommentVNode, U as mergeProps, Vt as toRefs, W as nextTick, Wt as unref, X as onMounted, Z as onUnmounted, _ as Fragment, _n as normalizeClass, bt as withDirectives, c as useCssModule, gt as watch, h as withModifiers, it as renderSlot, j as createVNode, m as withKeys, n as Transition, p as vShow, pt as useTemplateRef, q as onBeforeUnmount, r as TransitionGroup, rt as renderList, tt as provide, w as createBlock, yn as normalizeStyle, yt as withCtx } from "./vue.runtime.esm-bundler-C6vn67cX.js";
import { i as i18n, s as useI18n } from "./src-WwCUXbmD.js";
import { Ca as useVModel, Da as N8nText_default, Ea as N8nCallout_default, Ei as N8nBadge_default, F as N8nResizeWrapper_default, Hi as MessageRating_default, Oa as N8nButton_default, Rt as N8nActionDropdown_default, Sa as useResizeObserver, Ta as N8nHeading_default, Ui as Input_default, Vt as DropdownMenu_default, Wi as N8nIconButton_default, _a as useId, da as RovingFocusItem_default, fa as RovingFocusGroup_default, ga as Primitive, gt as useRouter, ha as CollapsibleRoot_default, jt as N8nCard_default, ka as N8nIcon_default, ma as CollapsibleContent_default, pa as CollapsibleTrigger_default, v as N8nScrollArea_default, vt as Checkbox_default, wa as createContext, xa as useDirection, ya as useForwardExpose, zi as N8nTooltip_default } from "./src-DFOx8N22.js";
import { t as _plugin_vue_export_helper_default } from "./_plugin-vue_export-helper-Da88TEg1.js";
import { d as ContextMenuTrigger_default, f as ContextMenuPortal_default, h as ContextMenuRoot_default, m as ContextMenuContent_default, p as ContextMenuItem_default } from "./useWorkflowDocumentRenderData-BxITby5B.js";
import { t as ParameterInputList_default, x as setParameterValue } from "./ParameterInputList-DInDNaWF.js";
import { Gn as getAppNameFromCredType, M as useCanvasStore, _ as useWorkflowExecutionStateStore, di as useExecutionDataStore, kt as useCredentialsStore, oi as injectStrict, q as useNodeTypesStore, ui as createExecutionDataId, v as createWorkflowDocumentId, x as useWorkflowDocumentStore } from "./workflows.store-yqufO0kS.js";
import { t as useToast } from "./useToast-C1BAsL26.js";
import { Al as WorkflowIdKey, Di as INSTANCE_AI_COMPUTER_USE_SETUP_MODAL_KEY, Ei as INSTANCE_AI_BROWSER_USE_SETUP_MODAL_KEY, El as ExpressionLocalResolveContextSymbol, Qs as deepCopy, Ss as getNodeParametersIssues, Tl as EditorExternalReadOnlyKey, gs as displayParameter, jl as WorkflowStateKey, kl as WorkflowDocumentStoreKey, vc as isExpression, xs as getNodeParameters } from "./constants-DIP3enMx.js";
import { D as storeToRefs, T as defineStore, t as useRootStore } from "./useRootStore-BUCt9XJo.js";
import { t as useSettingsStore } from "./settings.store-B-RgkKfn.js";
import { O as useWindowSize, b as useScroll, f as useElementHover, p as useElementSize, x as useSessionStorage } from "./core-nZc0i8VB.js";
import { f as useUIStore, p as useTelemetry } from "./users.store-0wV1ayWS.js";
import { a as useWorkflowSaveStore } from "./builder.store-QH5iAHyQ.js";
import { n as findPlaceholderDetails } from "./dist-DGef5MHa.js";
import { t as require_FileSaver_min } from "./FileSaver.min-CDRDQmqK.js";
import { t as usePageRedirectionHelper } from "./usePageRedirectionHelper-DjgfuK-2.js";
...
import { n as useWorkflowState } from "./useWorkflowState-Bz-qZGRx.js";
import { t as CredentialIcon_default } from "./CredentialIcon-DV1T7inQ.js";
import { t as NodeCredentials_default } from "./NodeCredentials-B9dJe9EE.js";
...
import { r as FreeAiCreditsCallout_default } from "./NodeSettings-BU5-LTAf.js";
import { r as INSTANCE_AI_VIEW } from "./constants-DlgrjQNI.js";
import { r as useCredentialTestInBackground, u as isHttpRequestNodeType } from "./CanvasRunWorkflowButton-Drk_BNov.js";
import { t as useInstanceAiSettingsStore } from "./instanceAiSettings.store-DIf0Z16i.js";
import { a as getLatestBuilderTarget, c as getLatestExecutionId, d as fetchThreads, i as getLatestBuildResult, l as getLatestWorkflowSetupResult, n as useInstanceAiStore, o as getLatestDataTableResult, r as useThread, s as getLatestDeletedDataTableId, t as provideThread, u as fetchThreadMessages } from "./instanceAi.store-tjSOKw_O.js";
import { t as CreditWarningBanner_default } from "./CreditWarningBanner-DOIqDYjI.js";
import { t as useSidebarLayout } from "./useSidebarLayout-55qwUs-S.js";
import { n as LogsPanel_default, t as useWorkflowInitialization } from "./useWorkflowInitialization-C2AEPshh.js";
import { t as ChatMarkdownChunk_default } from "./ChatMarkdownChunk-C4gzEC2_.js";
import { t as MainHeader_default } from "./MainHeader-Bv_DEF4B.js";
import { t as NodeView_default } from "./NodeView-KB5wBxW7.js";
import { i as useCreditWarningBanner, n as InstanceAiInput_default, r as AttachmentPreview_default, t as InstanceAiViewHeader_default } from "./InstanceAiViewHeader-CCmwvTsn.js";
import { n as useSidebarState } from "./instanceAiLayout-BAmvIFA5.js";
import { t as DataTableTable_default } from "./DataTableTable-DdLJnYZd.js";
...
function useCanvasPreview({ thread, threadId, workflowExecutions }) {
	...
	*/
	...
	watch([activeWorkflowId, computed(() => {
		for (let i = thread.messages.length - 1; i >= 0; i--) {
			const msg = thread.messages[i];
			if (msg.agentTree) {
		...
		if ((workflowExecutions?.value.get(wfId))?.status === "running") {
			activeExecutionId.value = null;
			return;
		}
		activeExecutionId.value = execResult?.workflowId === wfId ? execResult.executionId : null;
	}, { immediate: true });
	if (workflowExecutions) watch(workflowExecutions, (execs) => {
		const wfId = activeWorkflowId.value;
		if (!wfId) return;
		if (execs.get(wfId)?.status === "running") activeExecutionId.value = null;
	});
	watch(() => latestBuildResult.value?.toolCallId, (newToolCallId, oldToolCallId) => {
		if (oldToolCallId && newToolCallId && newToolCallId !== oldToolCallId) activeExecutionId.value = null;
	});
	return {
		activeTabId,
		allArtifactTabs,
...
var collapsibleSlideDown$4 = "_collapsibleSlideDown_hpmkw_1";
var collapsibleSlideUp$4 = "_collapsibleSlideUp_hpmkw_1";
var shimmer$4 = "_shimmer_hpmkw_1";
var spin$4 = "_spin_hpmkw_1";
var opacityPulse$4 = "_opacityPulse_hpmkw_1";
var popoverIn$4 = "_popoverIn_hpmkw_1";
var fadeIn$4 = "_fadeIn_hpmkw_1";
var pulseGlow$4 = "_pulseGlow_hpmkw_1";
var pulseGlowDelayed$4 = "_pulseGlowDelayed_hpmkw_1";
var fade$4 = "_fade_hpmkw_1";
var fadeInUp$4 = "_fadeInUp_hpmkw_1";
var fadeInDown$4 = "_fadeInDown_hpmkw_1";
var fadeInLeft$4 = "_fadeInLeft_hpmkw_1";
var fadeInRight$4 = "_fadeInRight_hpmkw_1";
var fadeOut$4 = "_fadeOut_hpmkw_1";
var fadeOutDown$4 = "_fadeOutDown_hpmkw_1";
var fadeOutUp$4 = "_fadeOutUp_hpmkw_1";
var fadeOutLeft$4 = "_fadeOutLeft_hpmkw_1";
var fadeOutRight$4 = "_fadeOutRight_hpmkw_1";
var blinkBackground$4 = "_blinkBackground_hpmkw_1";
var typingBlink$4 = "_typingBlink_hpmkw_1";
...
var block = "_block_102cz_335";
var ellipsis = "_ellipsis_102cz_358";
var shimmer$3 = "_shimmer_102cz_365";
var spin$3 = "_spin_102cz_1";
var opacityPulse$3 = "_opacityPulse_102cz_1";
var popoverIn$3 = "_popoverIn_102cz_1";
var fadeIn$3 = "_fadeIn_102cz_1";
var collapsibleSlideDown$3 = "_collapsibleSlideDown_102cz_1";
var collapsibleSlideUp$3 = "_collapsibleSlideUp_102cz_1";
var pulseGlow$3 = "_pulseGlow_102cz_1";
var pulseGlowDelayed$3 = "_pulseGlowDelayed_102cz_1";
var fade$3 = "_fade_102cz_1";
var fadeInUp$3 = "_fadeInUp_102cz_1";
var fadeInDown$3 = "_fadeInDown_102cz_1";
var fadeInLeft$3 = "_fadeInLeft_102cz_1";
var fadeInRight$3 = "_fadeInRight_102cz_1";
var fadeOut$3 = "_fadeOut_102cz_1";
var fadeOutDown$3 = "_fadeOutDown_102cz_1";
var fadeOutUp$3 = "_fadeOutUp_102cz_1";
var fadeOutLeft$3 = "_fadeOutLeft_102cz_1";
var fadeOutRight$3 = "_fadeOutRight_102cz_1";
var blinkBackground$3 = "_blinkBackground_102cz_1";
var typingBlink$3 = "_typingBlink_102cz_1";
var TimelineStepButton_vue_vue_type_style_index_0_lang_module_default = {
	block,
	ellipsis,
	shimmer: shimmer$3,
	spin: spin$3,
	"skeleton-pulse": "_skeleton-pulse_102cz_1",
	...
	setup(__props) {
		...
		*/
		...
		return (_ctx, _cache) => {
			...
			}, null, 10, _hoisted_1$14), isTruncated.value ? (openBlock(), createElementBlock("div", {
				key: 0,
...
var ToolResultRenderer_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		...
		function extractMcpContent(result) {
			...
			if (isRecord(result) && "content" in result && Array.isArray(result.content)) return normalizeContentItems(result.content);
			if (isRecord(result) && result.type === "content" && Array.isArray(result.value)) return normalizeContentItems(result.value);
			return null;
		}
...
var AnsweredQuestions_vue_vue_type_style_index_0_lang_module_default = {
	wrapper: "_wrapper_1mwrl_125",
	userBubble: "_userBubble_1mwrl_131",
	answerItem: "_answerItem_1mwrl_140",
	question: "_question_1mwrl_149",
	skipped: "_skipped_1mwrl_153"
};
...
var root$3 = "_root_1tiqc_335";
var expiredHint = "_expiredHint_1tiqc_344";
var header$8 = "_header_1tiqc_349";
var headerCollapsed = "_headerCollapsed_1tiqc_359";
var headerTitleGroup = "_headerTitleGroup_1tiqc_363";
var headerChevron = "_headerChevron_1tiqc_370";
var headerChevronOpen = "_headerChevronOpen_1tiqc_377";
var headerStatus = "_headerStatus_1tiqc_381";
var loadingState$1 = "_loadingState_1tiqc_388";
var loadingIcon = "_loadingIcon_1tiqc_396";
var spin$2 = "_spin_1tiqc_1";
var tasks = "_tasks_1tiqc_405";
var footerActions$1 = "_footerActions_1tiqc_411";
var taskItem = "_taskItem_1tiqc_416";
var taskRow = "_taskRow_1tiqc_420";
var taskNumber = "_taskNumber_1tiqc_433";
var taskTitle = "_taskTitle_1tiqc_447";
var taskTitleGroup = "_taskTitleGroup_1tiqc_454";
var taskChevron = "_taskChevron_1tiqc_462";
var taskChevronOpen = "_taskChevronOpen_1tiqc_469";
var taskDetail = "_taskDetail_1tiqc_473";
var taskSpec = "_taskSpec_1tiqc_478";
var shimmer$2 = "_shimmer_1tiqc_1";
var opacityPulse$2 = "_opacityPulse_1tiqc_1";
var popoverIn$2 = "_popoverIn_1tiqc_1";
var fadeIn$2 = "_fadeIn_1tiqc_1";
var collapsibleSlideDown$2 = "_collapsibleSlideDown_1tiqc_1";
var collapsibleSlideUp$2 = "_collapsibleSlideUp_1tiqc_1";
var pulseGlow$2 = "_pulseGlow_1tiqc_1";
var pulseGlowDelayed$2 = "_pulseGlowDelayed_1tiqc_1";
var fade$2 = "_fade_1tiqc_1";
var fadeInUp$2 = "_fadeInUp_1tiqc_1";
var fadeInDown$2 = "_fadeInDown_1tiqc_1";
var fadeInLeft$2 = "_fadeInLeft_1tiqc_1";
var fadeInRight$2 = "_fadeInRight_1tiqc_1";
var fadeOut$2 = "_fadeOut_1tiqc_1";
var fadeOutDown$2 = "_fadeOutDown_1tiqc_1";
var fadeOutUp$2 = "_fadeOutUp_1tiqc_1";
var fadeOutLeft$2 = "_fadeOutLeft_1tiqc_1";
var fadeOutRight$2 = "_fadeOutRight_1tiqc_1";
var blinkBackground$2 = "_blinkBackground_1tiqc_1";
var typingBlink$2 = "_typingBlink_1tiqc_1";
var PlanReviewPanel_vue_vue_type_style_index_0_lang_module_default = {
	...
	taskSpec,
	shimmer: shimmer$2,
	"skeleton-pulse": "_skeleton-pulse_1tiqc_1",
	...
	setup(__props) {
		...
		*  handle revision loops where multiple submit-plan calls exist. */
		const plannerConfirmation = computed(() => {
			const onOrchestrator = props.agentNode.toolCalls.find((tc) => tc.confirmation?.inputType === "plan-review");
		...
		*  and shows the planner's step list above the card. */
		const hasPlannerChild = computed(() => props.agentNode.children.some((c) => c.role === "planner"));
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("div", { class: normalizeClass(_ctx.$style.timeline) }, [(openBlock(true), createElementBlock(Fragment, null, renderList(timelineEntries.value, (entry, idx) => {
				return openBlock(), createElementBlock(Fragment, { key: idx }, [entry.type === "text" ? (openBlock(), createBlock(unref(N8nText_default), {
					...
					"is-loading",
					"tool-call-id"
				])) : toolCallsById.value[entry.toolCallId].renderHint === "builder" ? (openBlock(), createElementBlock(Fragment, { key: 2 }, [], 64)) : toolCallsById.value[entry.toolCallId].renderHint === "data-table" ? (openBlock(), createElementBlock(Fragment, { key: 3 }, [], 64)) : toolCallsById.value[entry.toolCallId].renderHint === "eval-setup" ? (openBlock(), createElementBlock(Fragment, { key: 4 }, [], 64)) : toolCallsById.value[entry.toolCallId].confirmation?.inputType === "plan-review" && !hasPlannerChild.value ? (openBlock(), createBlock(PlanReviewPanel_default, {
					...
					childrenById.value[entry.agentId].role === "planner" && (plannerConfirmation.value || props.agentNode.planItems?.length || props.agentNode.tasks?.tasks?.length) ? (openBlock(), createBlock(PlanReviewPanel_default, {
						...
						status: plannerConfirmation.value ? getPlanReviewStatus(plannerConfirmation.value) : "pending",
						updating: !!plannerConfirmation.value && isPlanReviewUpdating(plannerConfirmation.value),
						"read-only": !!plannerConfirmation.value && isPlanCardReadOnly(plannerConfirmation.value),
						expired: plannerConfirmation.value?.confirmation?.expired,
						onApprove: _cache[0] || (_cache[0] = ($event) => plannerConfirmation.value && handlePlanApprove(plannerConfirmation.value)),
						onAskForEdits: _cache[1] || (_cache[1] = ($event) => plannerConfirmation.value && handlePlanAskForEdits(plannerConfirmation.value)),
						onDeny: _cache[2] || (_cache[2] = ($event) => plannerConfirmation.value && handlePlanDeny(plannerConfirmation.value))
					}, null, 8, [
						"planned-tasks",
						"loading",
						"status",
...
var userMessage = "_userMessage_ujcnj_335";
var userAttachments = "_userAttachments_ujcnj_343";
var userBubble = "_userBubble_ujcnj_350";
var assistantWrapper = "_assistantWrapper_ujcnj_359";
var actionBtn = "_actionBtn_ujcnj_365";
var statusIndicator = "_statusIndicator_ujcnj_382";
var statusDot$1 = "_statusDot_ujcnj_392";
var opacityPulse$1 = "_opacityPulse_ujcnj_1";
var blinkingCursor = "_blinkingCursor_ujcnj_415";
var runLevelError = "_runLevelError_ujcnj_432";
var runLevelErrorDetails = "_runLevelErrorDetails_ujcnj_438";
var errorDetailsSummary = "_errorDetailsSummary_ujcnj_450";
var feedbackSuccess = "_feedbackSuccess_ujcnj_459";
var debugJson = "_debugJson_ujcnj_465";
var shimmer$1 = "_shimmer_ujcnj_1";
var spin$1 = "_spin_ujcnj_1";
var popoverIn$1 = "_popoverIn_ujcnj_1";
var fadeIn$1 = "_fadeIn_ujcnj_1";
var collapsibleSlideDown$1 = "_collapsibleSlideDown_ujcnj_1";
var collapsibleSlideUp$1 = "_collapsibleSlideUp_ujcnj_1";
var pulseGlow$1 = "_pulseGlow_ujcnj_1";
var pulseGlowDelayed$1 = "_pulseGlowDelayed_ujcnj_1";
var fade$1 = "_fade_ujcnj_1";
var fadeInUp$1 = "_fadeInUp_ujcnj_1";
var fadeInDown$1 = "_fadeInDown_ujcnj_1";
var fadeInLeft$1 = "_fadeInLeft_ujcnj_1";
var fadeInRight$1 = "_fadeInRight_ujcnj_1";
var fadeOut$1 = "_fadeOut_ujcnj_1";
var fadeOutDown$1 = "_fadeOutDown_ujcnj_1";
var fadeOutUp$1 = "_fadeOutUp_ujcnj_1";
var fadeOutLeft$1 = "_fadeOutLeft_ujcnj_1";
var fadeOutRight$1 = "_fadeOutRight_ujcnj_1";
var blinkBackground$1 = "_blinkBackground_ujcnj_1";
var typingBlink$1 = "_typingBlink_ujcnj_1";
var InstanceAiMessage_vue_vue_type_style_index_0_lang_module_default = {
	...
	actionBtn,
	statusIndicator,
	"status-fade-in": "_status-fade-in_ujcnj_1",
	statusDot: statusDot$1,
	opacityPulse: opacityPulse$1,
	blinkingCursor,
	"cursor-blink": "_cursor-blink_ujcnj_1",
	runLevelError,
	...
	shimmer: shimmer$1,
	spin: spin$1,
	"skeleton-pulse": "_skeleton-pulse_ujcnj_1",
			...
			return openBlock(), createElementBlock("div", { class: normalizeClass(_ctx.$style.panel) }, [
				...
				activeTab.value === "events" ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
					...
					createBaseVNode("div", {
						...
						}, toDisplayString(formatJson(entry.event)), 3)) : createCommentVNode("", true)], 10, _hoisted_2$5);
					}), 128))], 2)
...
var header$7 = "_header_mguwb_138";
	...
	setup(__props) {
		...
		return (_ctx, _cache) => {
			return isVisible.value ? (openBlock(), createElementBlock("div", {
				...
				onSelect: openModal
			}, null, 8, ["items", "portal-target"])], 2)) : createCommentVNode("", true)], 2), connections.value.length > 0 ? (openBlock(), createElementBlock("div", {
				key: 0,
...
var ConnectionsCard_vue_vue_type_style_index_0_lang_module_default = {
	section: "_section_z5j92_125",
	header: "_header_z5j92_141",
	sectionTitle: "_sectionTitle_z5j92_150",
	headerActions: "_headerActions_z5j92_154",
	list: "_list_z5j92_160",
	empty: "_empty_z5j92_165",
	emptyIcon: "_emptyIcon_z5j92_178"
};
...
var InstanceAiArtifactsPanel_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props, { emit: __emit }) {
		...
		const pinButtonLabel = computed(() => i18n.baseText(props.isPinned ? "instanceAi.artifactsPanel.unpinPanel" : "instanceAi.artifactsPanel.pinPanel"));
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("aside", {
				...
				createBaseVNode("div", { class: normalizeClass(_ctx.$style.section) }, [createBaseVNode("div", { class: normalizeClass(_ctx.$style.sectionHeader) }, [createVNode(unref(N8nHeading_default), {
					...
					_: 1
				}, 8, ["class"]), props.isPinningAvailable ? (openBlock(), createBlock(unref(N8nTooltip_default), {
					key: 0,
					content: pinButtonLabel.value,
					placement: "left",
					...
					default: withCtx(() => [createVNode(unref(N8nIconButton_default), {
						...
						size: "small",
						"icon-size": "medium",
						"aria-label": pinButtonLabel.value,
						"aria-pressed": props.isPinned,
						class: normalizeClass([_ctx.$style.pinButton, { [_ctx.$style.pinButtonPinned]: props.isPinned }]),
						"data-test-id": "instance-ai-artifacts-sidebar-pin",
						onClick: _cache[0] || (_cache[0] = ($event) => emit("togglePinned"))
					}, null, 8, [
						"aria-label",
						"aria-pressed",
						"class"
					...
					_: 1
				}, 8, ["content", "show-after"])) : createCommentVNode("", true)], 2), artifacts.value.length > 0 ? (openBlock(), createElementBlock("div", {
					key: 0,
...
var InstanceAiArtifactsPanel_vue_vue_type_style_index_0_lang_module_default = {
	panel: "_panel_gsnmj_125",
	group: "_group_gsnmj_134",
	section: "_section_gsnmj_142",
	sectionHeader: "_sectionHeader_gsnmj_160",
	sectionTitle: "_sectionTitle_gsnmj_169",
	pinButton: "_pinButton_gsnmj_173",
	pinButtonPinned: "_pinButtonPinned_gsnmj_180",
	artifactList: "_artifactList_gsnmj_189",
	artifactRow: "_artifactRow_gsnmj_194",
	artifactIconWrap: "_artifactIconWrap_gsnmj_214",
	artifactIcon: "_artifactIcon_gsnmj_214",
	artifactName: "_artifactName_gsnmj_225",
	artifactRowArchived: "_artifactRowArchived_gsnmj_236",
	archivedBadge: "_archivedBadge_gsnmj_243",
	emptyState: "_emptyState_gsnmj_253",
	taskList: "_taskList_gsnmj_264",
	task: "_task_gsnmj_264",
	doneTask: "_doneTask_gsnmj_279",
	failedTask: "_failedTask_gsnmj_284",
	cancelledTask: "_cancelledTask_gsnmj_288",
	taskDescription: "_taskDescription_gsnmj_292",
	todoIcon: "_todoIcon_gsnmj_301",
	inProgressIcon: "_inProgressIcon_gsnmj_305",
	doneIcon: "_doneIcon_gsnmj_309",
	failedIcon: "_failedIcon_gsnmj_316",
	cancelledIcon: "_cancelledIcon_gsnmj_320"
};
			...
			return openBlock(), createBlock(ConfirmationFooter_default, {
				...
				default: withCtx(() => [createBaseVNode("div", {
					...
					return openBlock(), createElementBlock("button", {
						...
						option.withArrow !== false ? (openBlock(), createBlock(unref(N8nIcon_default), {
							key: 0,
...
var ApprovalOptionList_vue_vue_type_style_index_0_lang_module_default = {
	list: "_list_11bcz_125",
	footer: "_footer_11bcz_131",
	row: "_row_11bcz_135",
	highlighted: "_highlighted_11bcz_151",
	trailingIcon: "_trailingIcon_11bcz_154",
	rowDestructive: "_rowDestructive_11bcz_158",
	leadingIcon: "_leadingIcon_11bcz_162",
	label: "_label_11bcz_175",
	labelStrong: "_labelStrong_11bcz_184",
	labelMuted: "_labelMuted_11bcz_188"
};
...
var WorkflowSetupSectionBody_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		...
		const workflowDocumentStore = computed(() => useWorkflowDocumentStore(createWorkflowDocumentId(ctx.workflowId.value ?? "instance-ai-workflow-setup", props.section.id)));
...
var InstanceAiConfirmationPanel_vue_vue_type_style_index_0_lang_module_default = {
	confirmation: "_confirmation_1sdv9_125",
	root: "_root_1sdv9_130",
	floatingRoot: "_floatingRoot_1sdv9_137",
	items: "_items_1sdv9_142",
	item: "_item_1sdv9_142",
	approvalRow: "_approvalRow_1sdv9_151",
	approvalRowBody: "_approvalRowBody_1sdv9_159",
	textInputRow: "_textInputRow_1sdv9_165",
	continueRow: "_continueRow_1sdv9_172",
	textCard: "_textCard_1sdv9_178"
};
...
var WorkflowCanvasHostBody_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props, { expose: __expose, emit: __emit }) {
		...
		const { isLoading, initializeData, initializeWorkflow, cleanup } = useWorkflowInitialization(workflowState);
...
var WorkflowCanvasHost_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props, { expose: __expose, emit: __emit }) {
		...
		provide(WorkflowStateKey, useWorkflowState());
		...
		return (_ctx, _cache) => {
			...
			}, null, 8, ["workflow-id", "refresh-key"]);
		};
	}
});
//#endregion
...
var InstanceAiWorkflowPreview_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props, { expose: __expose, emit: __emit }) {
		...
		function nodeIsEditingWorkflow(node, workflowId) {
			if (node.role === "workflow-builder" && node.status === "active" && node.targetResource?.type === "workflow" && node.targetResource.id === workflowId) return true;
			for (const tc of node.toolCalls) {
				if (!tc.isLoading) continue;
				if (!WORKFLOW_EDITING_TOOLS.has(tc.toolName)) continue;
				if (tc.args?.workflowId === workflowId) return true;
			}
			for (const child of node.children) if (nodeIsEditingWorkflow(child, workflowId)) return true;
			return false;
		}
		provide(EditorExternalReadOnlyKey, computed(() => {
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("div", { class: normalizeClass(_ctx.$style.content) }, [createVNode(WorkflowCanvasHost_default, {
				...
				"workflow-id": __props.workflowId,
				"refresh-key": __props.refreshKey
			}, null, 8, ["workflow-id", "refresh-key"])], 2);
		};
	}
});
...
var InstanceAiThreadView_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		...
		function revealArtifactsPanel() {
			if (!canShowArtifactsPanel.value || isArtifactsPanelEffectivelyPinned.value || preview.isPreviewVisible.value) return;
			isArtifactsPanelRevealed.value = true;
		}
		function hideArtifactsPanel(event) {
		...
		const isArtifactsPanelPinningAvailable = computed(() => availableWidthForPinnedArtifactsPanel.value >= MIN_AVAILABLE_WIDTH_FOR_PINNED_ARTIFACTS_PANEL);
		const isArtifactsPanelEffectivelyPinned = computed(() => isArtifactsPanelPinningAvailable.value && isArtifactsPanelPinned.value);
		const canShowArtifactsPanel = computed(() => thread.hasMessages || Boolean(props.threadId) && thread.isHydratingThread);
		const showArtifactsPanelEdge = computed(() => canShowArtifactsPanel.value && !preview.isPreviewVisible.value && !isArtifactsPanelEffectivelyPinned.value);
		const showArtifactsPanel = computed(() => canShowArtifactsPanel.value && !preview.isPreviewVisible.value && (isArtifactsPanelEffectivelyPinned.value || isArtifactsPanelRevealed.value));
		const reserveArtifactsPanelLayout = computed(() => showArtifactsPanel.value && isArtifactsPanelEffectivelyPinned.value);
		...
		watch(isArtifactsPanelPinningAvailable, (isAvailable) => {
			if (!isAvailable) isArtifactsPanelRevealed.value = false;
		});
		watch(canShowArtifactsPanel, (canShow) => {
			if (!canShow) isArtifactsPanelRevealed.value = false;
		});
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("div", {
				...
				}, null, 8, ["class"])) : createCommentVNode("", true), createVNode(unref(N8nTooltip_default), {
				...
				showArtifactsPanelEdge.value ? (openBlock(), createElementBlock("div", {
					key: 0,
					class: normalizeClass(_ctx.$style.artifactsPanelEdge),
					role: "button",
					tabindex: "0",
					"aria-label": unref(i18n).baseText("instanceAi.artifactsPanel.showPanel"),
					"data-test-id": "instance-ai-artifacts-sidebar-edge",
					onClick: revealArtifactsPanel,
					onMouseenter: revealArtifactsPanel,
					onFocusin: revealArtifactsPanel,
					onKeydown: [withKeys(withModifiers(revealArtifactsPanel, ["prevent"]), ["enter"]), withKeys(withModifiers(revealArtifactsPanel, ["prevent"]), ["space"])]
				...
				createVNode(Transition, {
					...
					default: withCtx(() => [showArtifactsPanel.value ? (openBlock(), createElementBlock("div", {
						key: 0,
						class: normalizeClass(_ctx.$style.artifactsPanelSlot),
						"data-test-id": "instance-ai-artifacts-sidebar-slot",
						onMouseenter: revealArtifactsPanel,
						onMouseleave: _cache[4] || (_cache[4] = ($event) => hideArtifactsPanel()),
						onFocusin: revealArtifactsPanel,
						onFocusout: hideArtifactsPanel
					}, [createVNode(InstanceAiArtifactsPanel_default, {
						"is-pinned": isArtifactsPanelEffectivelyPinned.value,
						"is-pinning-available": isArtifactsPanelPinningAvailable.value,
						onTogglePinned: toggleArtifactsPanelPinned
					}, null, 8, ["is-pinned", "is-pinning-available"])], 34)) : createCommentVNode("", true)]),
					_: 1
				}, 8, ["name", "css"]),
				...
				default: withCtx(() => [withDirectives(createBaseVNode("div", {
					...
					onResizestart: _cache[7] || (_cache[7] = ($event) => isResizingPreview.value = true),
					onResizeend: _cache[8] || (_cache[8] = ($event) => isResizingPreview.value = false)
				}, {
					default: withCtx(() => [createVNode(unref(TabsRoot_default), {
						modelValue: unref(preview).activeTabId.value,
						"onUpdate:modelValue": _cache[6] || (_cache[6] = ($event) => unref(preview).activeTabId.value = $event),
...
var InstanceAiThreadView_vue_vue_type_style_index_0_lang_module_default = {
	threadArea: "_threadArea_1b0x3_130",
	chatArea: "_chatArea_1b0x3_140",
	canvasArea: "_canvasArea_1b0x3_150",
	canvasAreaExpanded: "_canvasAreaExpanded_1b0x3_176",
	headerTitle: "_headerTitle_1b0x3_184",
	activeButton: "_activeButton_1b0x3_192",
	reconnecting: "_reconnecting_1b0x3_196",
	contentArea: "_contentArea_1b0x3_200",
	artifactsPanelEdge: "_artifactsPanelEdge_1b0x3_209",
	artifactsPanelSlot: "_artifactsPanelSlot_1b0x3_223",
	chatContent: "_chatContent_1b0x3_235",
	scrollArea: "_scrollArea_1b0x3_243",
	scrollContent: "_scrollContent_1b0x3_248",
	messageList: "_messageList_1b0x3_255",
	contentAreaWithPinnedArtifacts: "_contentAreaWithPinnedArtifacts_1b0x3_266",
	contentAreaWithoutLayoutTransitions: "_contentAreaWithoutLayoutTransitions_1b0x3_270",
	scrollButtonContainer: "_scrollButtonContainer_1b0x3_274",
	inputConstraint: "_inputConstraint_1b0x3_275",
	builderAgents: "_builderAgents_1b0x3_279",
	inputDock: "_inputDock_1b0x3_286",
	scrollToBottomButton: "_scrollToBottomButton_1b0x3_302",
	inputContainer: "_inputContainer_1b0x3_331",
	inputSwap: "_inputSwap_1b0x3_355",
	previewPanel: "_previewPanel_1b0x3_359",
	previewContent: "_previewContent_1b0x3_365",
	previewSlot: "_previewSlot_1b0x3_371",
	previewSlotHidden: "_previewSlotHidden_1b0x3_376"
};
