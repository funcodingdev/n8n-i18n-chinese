...
import { $ as openBlock, A as createTextVNode, C as createBaseVNode, Cn as toDisplayString, E as createElementBlock, Gt as unref, H as mergeModels, It as ref, N as defineComponent, S as computed, T as createCommentVNode, _ as Fragment, bt as withCtx, dt as useModel, gt as watch, it as renderSlot, j as createVNode, vn as normalizeClass, w as createBlock } from "./vue.runtime.esm-bundler-DYHsQBZB.js";
...
function useRoleEditorForm({ roleSlug, viewRoute, defaultScopes, filterScopes, ensureScopes, fetchError }) {
	...
	const formScopes = (scopes) => ensureScopes ? ensureScopes(sanitizeScopes(scopes)) : sanitizeScopes(scopes);
	const defaultForm = () => ({
		displayName: "",
		description: "",
