import { $ as openBlock, A as createTextVNode, C as createBaseVNode, Cn as toDisplayString, E as createElementBlock, Gt as unref, It as ref, N as defineComponent, S as computed, T as createCommentVNode, X as onMounted, bt as withCtx, gt as watch, it as renderSlot, j as createVNode, p as vShow, q as onBeforeUnmount, tt as provide, vn as normalizeClass, w as createBlock, xt as withDirectives, zt as shallowRef } from "./vue.runtime.esm-bundler-Bs4WIMNP.js";
import { x as useI18n } from "./_MapCache-DHdz8CdO.js";
import { Ai as N8nText_default, z as N8nTabs_default } from "./src-BoizZDiU.js";
import { t as _plugin_vue_export_helper_default } from "./_plugin-vue_export-helper-Da88TEg1.js";
import { A as NodeCredentials_default, C as setParameterValue, g as createCommonNodeSettings, m as collectParametersByTab } from "./ParameterInputWrapper-zRoIJ6YL.js";
import { C as disposeWorkflowDocumentStore, E as useWorkflowDocumentStore, L as useNodeTypesStore, S as createWorkflowDocumentId, an as useEnvironmentsStore, dn as useProjectsStore, en as disposeNDVStore, rn as useNDVStore, vt as useCredentialsStore } from "./workflows.store-w-uLno6O.js";
import { Br as makeNodeName, Dr as getNodeParameters, Or as getNodeParametersIssues, Pr as isDefaultNodeName, ei as isINodePropertyOptions, fi as deepCopy } from "./src-UnL6BUww.js";
import { t as useSettingsStore } from "./settings.store-BJ21y3qH.js";
import "./settings.store-BSz3sTvi.js";
import { Ca as ExpressionLocalResolveContextSymbol, Ea as WorkflowDocumentStoreKey, xa as ChatHubToolContextKey } from "./constants-On-mUxgN.js";
	...
	setup(__props, { expose: __expose, emit: __emit }) {
		...
		*/
		...
		onMounted(async () => {
			...
			if (projectId) await Promise.all([credentialsStore.fetchCredentialTypes(false), credentialsStore.fetchAllCredentialsForWorkflow({ projectId })]);
		});
		onBeforeUnmount(() => {
