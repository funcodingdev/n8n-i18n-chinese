...
import { t as useLoadingService } from "./useLoadingService-BMo0jIuP.js";
import { Bd as EnterpriseEditionFeature, Fc as getNodeParameters, Ic as getNodeParametersIssues, Jc as makeNodeName, Mc as getConnectionTypes, Nc as getNodeInputs, Os as classifyTriggerIdentity, Qc as nodeIssuesToString, Yc as mergeIssues, fl as NodeConnectionTypes, jc as displayParameterPath } from "./constants-DDbk7QLF.js";
import { Kt as injectWorkflowExecutionStateStore, _ as useNodeTypesStore, a as injectWorkflowDocumentStore, ar as hasProxyAuth, at as useCredentialsStore, er as getNodeSubtitle, ki as isString, l as assignNodeId } from "./workflowDocument.store-nzq6GHzt.js";
...
import { n as hasPermission, p as useTelemetry } from "./users.store-C8AeNcFl.js";
import { A as isObject } from "./workflowsList.store-Ci-FEnCL.js";
...
function useNodeHelpers() {
	...
	*/
	...
	function workflowHasIncompatibleTrigger() {
		...
		return !triggers.some((trigger) => classifyTriggerIdentity(trigger.type, trigger.parameters).providesN8nIdentity);
	}
	function collectPrivateCredentialIssues(node, foundIssues) {
		...
		for (const [credTypeName, details] of Object.entries(node.credentials ?? {})) {
			...
			if (incompatibleTrigger) foundIssues[credTypeName] = [i18n.baseText("nodeIssues.credentials.privateRequiresManualTrigger")];
		}
	}
