...
import { _ as onKeyDown, bt as useI18n, ct as useThrottleFn, dt as watchThrottled, ut as watchOnce, y as onKeyUp } from "./_MapCache-C80pWp05.js";
import { L as N8nSticky_default, Li as N8nTooltip_default, Ut as useDeviceSupport, Vi as N8nIconButton_default, Vt as N8nActionDropdown_default, W as N8nPopover_default, _t as useRoute, ia as N8nIcon_default, jt as createEventBus, na as N8nText_default, ra as N8nButton_default, ut as N8nLink_default, vt as useRouter } from "./src-DXhOkTfb.js";
import { t as __plugin_vue_export_helper_default } from "./_plugin-vue_export-helper-DltO58Gh.js";
import { An as useGetPointerPosition, Cn as clamp, Dn as getRectOfNodes, Dt as injectWorkflowState, Ea as isPresent, En as getConnectedEdges, Fn as trackTemplatesClick, Gr as CanvasNodeRenderType, Is as useSettingsStore, Jt as useTemplatesStore, Kn as useFocusedNodesStore, Mn as wheelDelta, Mt as nodeViewEventBus, Nn as TemplateClickSource, On as getSmoothStepPath, Pn as isExtraTemplateLinksExperimentEnabled, Qi as getTriggerNodeServiceName, Qt as DEFAULT_NODE_SIZE, Rn as useStyles, Sn as _sfc_main$f, Tn as getBoundsofRects, Ur as CanvasConnectionMode, Wr as CanvasNodeDirtiness, Xt as CONFIGURATION_NODE_RADIUS, _n as Position, at as useCredentialsStore, bl as sanitizeHtml, bn as _sfc_main$3, br as useNDVStore, ca as createWorkflowDocumentId, cn as getMousePosition, da as useWorkflowDocumentStore, di as useSourceControlStore, dr as environments_store_default, en as GRID_SIZE, gn as PanelPosition, hn as NodeId, jn as useVueFlow, kn as isMacOs, mn as MarkerType, nn as calculateNodeSize, pn as updateViewportToContainNodes, pr as useNodeHelpers, r as useUIStore, s as useWorkflowsStore, t as useUsersStore, ua as injectWorkflowDocumentStore, vn as _sfc_main$5, w as useNodeTypesStore, wn as getBezierPath, xn as _sfc_main$d, yl as isOutsideSelected, yn as _sfc_main$1, zr as isValidNodeConnectionType } from "./users.store-bYJP9NEL.js";
import { M as TitledList_default } from "./ParameterInputList-CquLPExM.js";
import { Aa as isNodeWithWorkflowSelector, Bo as SEND_AND_WAIT_OPERATION, Cr as WAIT_NODE_TYPE, Gt as CHAT_TRIGGER_NODE_TYPE, Ho as WAIT_INDEFINITELY, I as CUSTOM_API_CALL_KEY, Ic as ExpressionLocalResolveContextSymbol, Ko as require_isEqual, Mc as CanvasKey, Nc as CanvasNodeHandleKey, Nt as AGENT_NODE_TYPE, Oa as isExecutable, Pc as CanvasNodeKey, Pt as AGENT_TOOL_NODE_TYPE, Qa as isCommunityPackageName, Qn as PRODUCTION_ONLY_TRIGGER_NODE_TYPES, Ta as getSubworkflowId, Tt as NODE_CREATOR_OPEN_SOURCES, Uo as WEBHOOK_NODE_TYPE, Wn as NOT_DUPLICATABLE_NODE_TYPES, as as getResourcePermissions, da as mapConnectionsByDestination, dr as SIMULATE_TRIGGER_NODE_TYPE, go as NodeConnectionTypes, gr as STICKY_NODE_TYPE, hl as CANVAS_EXECUTION_DATA_THROTTLE_DURATION, hn as FORM_NODE_TYPE, hs as VIEWS, ka as isHitlToolType, ur as SIMULATE_NODE_TYPE, va as getNodeInputs, ya as getNodeOutputs } from "./constants-neq36s1h.js";
import { t as useAssistantStore } from "./assistant.store-Hv2aiFHq.js";
import { t as useChatPanelStore } from "./chatPanel.store-CNq_-Rf2.js";
import { t as usePinnedData } from "./usePinnedData-D6iG-vVW.js";
import { t as getNodeIconSource } from "./nodeIcon-DVYiuXDq.js";
import { c as parseCanvasConnectionHandleString, n as createCanvasConnectionHandleString, o as mapLegacyConnectionsToCanvasConnections, r as insertSpacersBetweenEndpoints, s as mapLegacyEndpointsToCanvasConnectionPort, t as checkOverlap } from "./canvas.utils-I742fAt-.js";
import { n as useNodeCreatorStore } from "./canvas.eventBus-CHyag3df.js";
...
import { r as useNodeDirtiness, t as useRunWorkflow } from "./useRunWorkflow-BgxUvcZG.js";
import { n as injectStrict } from "./useInjectWorkflowId-Bt4qbudX.js";
import { t as useCollaborationStore } from "./collaboration.store-BHVxfZAc.js";
import { t as NodeSettings_default } from "./NodeSettings-DxccuMUV.js";
...
import { t as NODE_CREATOR_SHORTCUT_COACHMARK_KEY } from "./useNodeCreatorShortcutCoachmark-CTjg1BZJ.js";
