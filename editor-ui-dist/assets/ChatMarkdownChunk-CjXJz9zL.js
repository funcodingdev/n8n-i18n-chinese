const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/es-Bt7Ow9o4.js","assets/chunk-CC9Q-vWm.js","assets/core-B8Vg4UCA.js","assets/languageModules-DOFqRJVS.js","assets/xml-Uw3-Q0Bn.js"])))=>i.map(i=>d[i]);
...
import { Ii as N8nButton_default, Nr as truncateBeforeLast } from "./src-B_5ZxXqL.js";
	...
	async function loadLanguageModules() {
		...
		try {
			const promise = Promise.all([__vitePreload(async () => {
				const { default: highlight } = await import("./es-Bt7Ow9o4.js");
				return { default: highlight };
			}, __vite__mapDeps([0,1,2])).then(({ default: highlight }) => highlight), __vitePreload(() => import("./languageModules-DOFqRJVS.js"), __vite__mapDeps([3,4]))]);
			asyncImport = {
				status: "inProgress",
				promise
			};
