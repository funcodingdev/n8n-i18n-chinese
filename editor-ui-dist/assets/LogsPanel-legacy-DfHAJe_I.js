    ...
    */
    ...
    return {
      setters: [function (_chunkLegacy001Js) {
        ...
        PopOutWindowKey = _constantsLegacy00TJs.Ks;
      ...
      }, function (_ChatFileLegacy05bJs) {
        ChatFile_default = _ChatFileLegacy05bJs.t;
      }, function (_xmlLegacy05rJs) {
        bash = _xmlLegacy05rJs.a;
        javascript = _xmlLegacy05rJs.i;
        typescript = _xmlLegacy05rJs.n;
        python = _xmlLegacy05rJs.r;
        xml = _xmlLegacy05rJs.t;
      }, function (_useLogsTreeExpandLegacy06RJs) {
        isPlaceholderLog = _useLogsTreeExpandLegacy06RJs._;
        LogsViewConsumedTokenCountText_default = _useLogsTreeExpandLegacy06RJs.a;
        restoreChatHistory = _useLogsTreeExpandLegacy06RJs.b;
        getDepth = _useLogsTreeExpandLegacy06RJs.f;
        getTotalConsumedTokens = _useLogsTreeExpandLegacy06RJs.g;
        getSubtreeTotalConsumedTokens = _useLogsTreeExpandLegacy06RJs.h;
        LogsViewNodeName_default = _useLogsTreeExpandLegacy06RJs.i;
        findLogEntryRec = _useLogsTreeExpandLegacy06RJs.l;
        getInputKey = _useLogsTreeExpandLegacy06RJs.m;
        useLogsExecutionData = _useLogsTreeExpandLegacy06RJs.n;
        getEntryAtRelativeIndex = _useLogsTreeExpandLegacy06RJs.p;
        LogsOverviewRows_default = _useLogsTreeExpandLegacy06RJs.r;
        extractBotResponse = _useLogsTreeExpandLegacy06RJs.s;
        useLogsTreeExpand = _useLogsTreeExpandLegacy06RJs.t;
        findSelectedLogEntry = _useLogsTreeExpandLegacy06RJs.u;
        isSubNodeLog = _useLogsTreeExpandLegacy06RJs.v;
        processFiles = _useLogsTreeExpandLegacy06RJs.y;
      }, function (_coreLegacy06TJs) {
        core_default = _coreLegacy06TJs.t;
      }],
      execute: function () {
