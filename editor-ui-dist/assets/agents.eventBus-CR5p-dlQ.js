import { $ as openBlock, A as createTextVNode, C as createBaseVNode, Cn as toDisplayString, E as createElementBlock, Gt as unref, It as ref, N as defineComponent, S as computed, T as createCommentVNode, Ut as toValue, X as onMounted, _ as Fragment, bt as withCtx, gt as watch, it as renderSlot, j as createVNode, pt as useTemplateRef, q as onBeforeUnmount, rt as renderList, vn as normalizeClass, w as createBlock } from "./vue.runtime.esm-bundler-DYHsQBZB.js";
...
import { Ct as useAiGatewayStore, Et as useCredentialsStore, H as useNodeTypesStore, bn as useProjectsStore } from "./workflows.store-CQp5NuTc.js";
import { $ as NATIVE_WEB_SEARCH_DEFAULTS_BY_PROVIDER, Gt as AI_GATEWAY_MANAGED_TAG, Nt as getResourcePermissions, Q as ANTHROPIC_NATIVE_WEB_SEARCH_PROVIDER_TOOLS, So as AGENT_MODEL_PROVIDERS, To as isAgentModelProvider, et as NATIVE_WEB_SEARCH_PROVIDER_TOOLS, nt as resolvePromptCaching, tt as PROVIDER_CAPABILITIES, wo as AGENT_MODEL_STRING_REGEX } from "./src-BrbN-vPn.js";
...
import { Dr as AGENT_TOOLS_MODAL_KEY, Ei as LOCAL_STORAGE_AGENT_MODEL_CREDENTIALS, Er as AGENT_TASK_MODAL_KEY, Or as AGENT_TOOL_CONFIG_MODAL_KEY, Tr as AGENT_SUB_AGENTS_MODAL_KEY, wr as AGENT_SKILL_MODAL_KEY } from "./constants-Bwbcx8Ih.js";
...
import { a as createAgentSkill, h as getAgentTasks, v as getModelCatalog, y as getProviderModels } from "./useAgentApi-BjSqetbH.js";
...
import { a as workflowToolTriggerLabel, c as toolRefToNode, n as mcpServerToNode } from "./useMcpServerAdapter-BFbM7B-M.js";
		...
		*/
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("div", {
				...
				showDeploymentName.value ? (openBlock(), createElementBlock("div", {
					key: 2,
					class: normalizeClass([_ctx.$style.field]),
...
//#endregion
export { agent_panel_module_default as _, isWarningIssue as a, getNativeWebSearchArgs as c, modelToString as d, parseModelString as f, useAgentModelCredentials as g, useModelCatalog as h, hasBlockingIssues as i, getWebSearchMethod as l, sanitizeModelId as m, useAgentCapabilitiesActions as n, AgentInfoPanel_default as o, parseProvider as p, AgentCapabilitiesSection_default as r, AgentModelSelector_default as s, agentsEventBus as t, withWebSearchConfig as u, useAgentProjectId as v };
