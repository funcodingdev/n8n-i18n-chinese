...
import { at as getRoleAssignments, ct as getRoleProjectMembers, it as deleteRole, lt as getRoles, ot as getRoleBySlug, rt as createRole, st as getRoleMembers, t as useRootStore, ur as defineStore, ut as updateRole } from "./useRootStore-B-A2Ktsc.js";
import { t as useSettingsStore } from "./settings.store-DqAeFsjh.js";
//#region ../@n8n/stores/src/roles.store.ts
...
var useRolesStore = defineStore("roles", () => {
	...
	const deleteRole$1 = async (slug, reassignRoleSlug) => {
		return await deleteRole(rootStore.restApiContext, slug, reassignRoleSlug);
	};
