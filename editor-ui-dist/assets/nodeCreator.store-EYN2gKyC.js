...
import { d as require_get, g as require__arrayMap, h as require_toString } from "./src-wu1DeT-q.js";
import { $ as require_upperFirst, $r as isVueFlowConnection, C as useNodeTypesStore, D as finalizeItems, F as mapToolSubcategoryIcon, H as subcategorizeItems, I as nodeTypesToCreateElements, It as useNDVStore, L as prepareCommunityNodeDetailsViewStack, M as groupItemsInSections, Mi as getThemedValue, N as isAINode, Nt as useTelemetry, O as flattenCreateElements, T as useEvaluationStore, U as transformNodeType, V as sortNodeCreateElements, _n as useTemplatesStore, hs as useSettingsStore, jc as STORES, jr as v4_default, k as getAiTemplatesCallout, r as useUIStore, s as useWorkflowsStore, ti as CanvasConnectionMode, tt as require__createCompounder, vr as useExternalHooks, yr as useCanvasStore, z as searchNodes } from "./users.store-3JSNDD0x.js";
import { $ as AI_CATEGORY_MCP_NODES, $n as REMOVE_DUPLICATES_NODE_TYPE, An as MANUAL_TRIGGER_NODE_TYPE, At as TRANSFORM_DATA_SUBCATEGORY, Ba as isCommunityPackageName, Bi as require__arrayIncludes, Ct as NEW_TOOL_CATEGORIES, Dn as LIMIT_NODE_TYPE, Dt as REGULAR_NODE_CREATOR_VIEW, F as CUSTOM_API_CALL_KEY, Ft as AI_CODE_NODE_TYPE, Io as require__cacheHas, J as AI_CATEGORY_CHAINS, Jt as CONVERT_TO_FILE_NODE_TYPE, Kt as CODE_NODE_TYPE, Lo as require__SetCache, Lt as AI_TRANSFORM_NODE_TYPE$1, Mt as AGENT_NODE_TYPE, Nn as MERGE_NODE_TYPE, Nt as AGENT_TOOL_NODE_TYPE, Or as XML_NODE_TYPE, Pt as AGGREGATE_NODE_TYPE, Q as AI_CATEGORY_LANGUAGE_MODELS, Qt as CRYPTO_NODE_TYPE, Sr as WEBHOOK_NODE_TYPE, St as HUMAN_IN_THE_LOOP_CATEGORY, Tt as OTHER_TRIGGER_NODES_SUBCATEGORY, Wt as CHAT_TRIGGER_NODE_TYPE, X as AI_CATEGORY_EMBEDDING, Y as AI_CATEGORY_DOCUMENT_LOADERS, _o as EVALUATION_TRIGGER_NODE_TYPE, _t as CORE_NODES_CATEGORY, an as EMAIL_IMAP_NODE_TYPE, at as AI_CATEGORY_TEXT_SPLITTERS, bt as HELPERS_SUBCATEGORY, ct as AI_CODE_TOOL_LANGCHAIN_NODE_TYPE, dn as EXECUTE_WORKFLOW_TRIGGER_NODE_TYPE, dr as SPLIT_IN_BATCHES_NODE_TYPE, dt as AI_OTHERS_NODE_CREATOR_VIEW, en as DATA_TABLE_NODE_TYPE, et as AI_CATEGORY_MEMORY, fn as EXTRACT_FROM_FILE_NODE_TYPE, fr as SPLIT_OUT_NODE_TYPE, ft as AI_SECTION_RECOMMENDED_TOOLS, hn as FORM_TRIGGER_NODE_TYPE, hr as SUMMARIZE_NODE_TYPE, ht as AI_WORKFLOW_TOOL_LANGCHAIN_NODE_TYPE, io as NodeConnectionTypes, it as AI_CATEGORY_ROOT_NODES, jn as MARKDOWN_NODE_TYPE, jt as TRIGGER_NODE_CREATOR_VIEW, kt as TEMPLATE_CATEGORY_AI, mi as require__baseFlatten, mt as AI_UNCATEGORIZED_CATEGORY, nt as AI_CATEGORY_OUTPUTPARSER, on as EMAIL_SEND_NODE_TYPE, or as SET_NODE_TYPE, ot as AI_CATEGORY_TOOLS, pn as FILTER_NODE_TYPE, pt as AI_SUBCATEGORY, q as AI_CATEGORY_AGENTS, qt as COMPRESSION_NODE_TYPE, rn as EDIT_IMAGE_NODE_TYPE, rr as SCHEDULE_TRIGGER_NODE_TYPE, rt as AI_CATEGORY_RETRIEVERS, sa as getNodeInputs, st as AI_CATEGORY_VECTOR_STORES, tn as DATETIME_NODE_TYPE, tr as RSS_READ_NODE_TYPE, uo as AI_TRANSFORM_NODE_TYPE, ut as AI_NODE_CREATOR_VIEW, va as isHitlToolType, vn as HTML_NODE_TYPE, vt as DEFAULT_SUBCATEGORY, wt as NODE_CREATOR_OPEN_SOURCES, xn as IF_NODE_TYPE, xt as HITL_SUBCATEGORY, yn as HTTP_REQUEST_NODE_TYPE, yt as FLOWS_CONTROL_SUBCATEGORY, zi as require__arrayIncludesWith } from "./constants-BxuLnwsr.js";
import { T as require__baseUnary, r as require__baseRest, u as require_isArrayLikeObject } from "./merge-DfoBmFWu.js";
import { A as defineStore } from "./_baseOrderBy-Bum33Aot.js";
import { t as getNodeIconSource } from "./nodeIcon-DljzfVJF.js";
import { c as parseCanvasConnectionHandleString, n as createCanvasConnectionHandleString } from "./canvas.utils-D8qyRd7D.js";
