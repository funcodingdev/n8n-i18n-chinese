import { $ as openBlock, A as createTextVNode, C as createBaseVNode, E as createElementBlock, Ft as ref, N as defineComponent, S as computed, Sn as toDisplayString, T as createCommentVNode, Wt as unref, _ as Fragment, _n as normalizeClass, j as createVNode, pt as useTemplateRef, rt as renderList, w as createBlock, yt as withCtx } from "./vue.runtime.esm-bundler-C6vn67cX.js";
import { s as useI18n } from "./src-WwCUXbmD.js";
import { Da as N8nText_default, Ji as truncateBeforeLast, Oa as N8nButton_default, Vt as DropdownMenu_default, ka as N8nIcon_default, zi as N8nTooltip_default } from "./src-DFOx8N22.js";
import { t as _plugin_vue_export_helper_default } from "./_plugin-vue_export-helper-Da88TEg1.js";
import { kt as useCredentialsStore, yn as useProjectsStore } from "./workflows.store-Cc2IYz8o.js";
import { Ha as chatHubLLMProviderSchema, Ra as PROVIDER_CREDENTIAL_TYPE_MAP, cl as getResourcePermissions } from "./constants-BMUE7W6Y.js";
...
import { s as truncateBeforeLast$1 } from "./dist-DHcbImTe.js";
import { f as NEW_AGENT_MENU_ID, h as providerDisplayNames, i as CHAT_MODEL_BY_ID_SELECTOR_MODAL_KEY, r as CHAT_CREDENTIAL_SELECTOR_MODAL_KEY, u as LLM_AGGREGATORS } from "./constants-Cet-q9NP.js";
import { E as workflowAgentDefaultIcon, S as personalAgentDefaultIcon, i as createFakeAgent, l as flattenModel, m as isAllowedModel, u as fromStringToModel, v as isLlmProviderModel, w as stringifyModel } from "./chat.utils-BfKO1YXg.js";
		...
		return (_ctx, _cache) => {
			return openBlock(), createBlock(unref(DropdownMenu_default), {
				...
				trigger: withCtx(() => [createVNode(unref(N8nButton_default), {
					...
					class: normalizeClass([_ctx.$style.dropdownButton, __props.horizontal && _ctx.$style.dropdownButtonHorizontal]),
					text: __props.text,
					size: "large",
					...
					default: withCtx(() => [
						...
						createBaseVNode("div", { class: normalizeClass([_ctx.$style.selected, __props.horizontal && _ctx.$style.selectedHorizontal]) }, [createVNode(unref(N8nText_default), null, {
							default: withCtx(() => [createTextVNode(toDisplayString(unref(truncateBeforeLast$1)(selectedLabel.value, unref(30))), 1)]),
							_: 1
						}), credentialsName.value ? (openBlock(), createBlock(unref(N8nText_default), {
							key: 0,
							size: __props.horizontal ? "small" : "xsmall",
							color: "text-light",
							"data-test-id": "chat-model-selector-credential"
						}, {
							default: withCtx(() => [createTextVNode(toDisplayString(unref(truncateBeforeLast$1)(credentialsName.value, unref(30))), 1)]),
							_: 1
						}, 8, ["size"])) : isCredentialsMissing.value ? (openBlock(), createBlock(unref(N8nText_default), {
							key: 1,
							size: "xsmall",
							color: "danger"
						}, {
						...
						createVNode(unref(N8nIcon_default), {
							class: normalizeClass(__props.horizontal && _ctx.$style.chevronHorizontal),
							icon: "chevron-down",
							size: "medium"
						}, null, 8, ["class"])
					]),
				...
				"item-trailing": withCtx(({ item, ui }) => [item.data?.description ? (openBlock(), createBlock(unref(N8nTooltip_default), {
					key: 0,
					content: unref(truncateBeforeLast$1)(item.data.description, 200, 0),
					class: normalizeClass(ui.class),
...
var ModelSelector_vue_vue_type_style_index_0_lang_module_default = {
	component: "_component_1bimx_125",
	dropdownButton: "_dropdownButton_1bimx_130",
	credentialsMissingIcon: "_credentialsMissingIcon_1bimx_140",
	selected: "_selected_1bimx_145",
	dropdownButtonHorizontal: "_dropdownButtonHorizontal_1bimx_152",
	selectedHorizontal: "_selectedHorizontal_1bimx_170",
	chevronHorizontal: "_chevronHorizontal_1bimx_184",
	icon: "_icon_1bimx_189",
	infoIcon: "_infoIcon_1bimx_194",
	menuIcon: "_menuIcon_1bimx_195",
	avatarIcon: "_avatarIcon_1bimx_203",
	tooltip: "_tooltip_1bimx_207",
	flattenedLabel: "_flattenedLabel_1bimx_212",
	separator: "_separator_1bimx_221"
};
var ModelSelector_default = /* @__PURE__ */ _plugin_vue_export_helper_default(ModelSelector_vue_vue_type_script_setup_true_lang_default, [["__cssModules", { "$style": ModelSelector_vue_vue_type_style_index_0_lang_module_default }]]);
//#endregion
export { ModelSelector_default as t };
