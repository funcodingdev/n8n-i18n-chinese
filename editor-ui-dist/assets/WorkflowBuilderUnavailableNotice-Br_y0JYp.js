...
import { V as until, r as onClickOutside } from "./dist-CYNfKCbA.js";
...
import { nn as base64EncodedSize } from "./src-BrbN-vPn.js";
...
import { n as useUIStore, t as listenForModalChanges } from "./ui.store-KcYYy7Mp.js";
import { t as convertFileToBinaryData } from "./fileUtils-DWvnRRxs.js";
import { _ as INSTANCE_AI_TOOLS_CONNECTION_MODAL_KEY, c as INSTANCE_AI_BROWSER_USE_SETUP_MODAL_KEY, l as INSTANCE_AI_COMPUTER_USE_SETUP_MODAL_KEY } from "./constants-D5OEjQEP.js";
import { t as useInstanceAiSettingsStore } from "./instanceAiSettings.store-BbR4Z44G.js";
import { n as useInstanceAiStore, o as mergeNodeSets } from "./instanceAi.store-B4NJFK-a.js";
import { n as CreditsSettingsDropdown_default } from "./CreditWarningBanner-DAV87wFI.js";
...
import { i as useInstanceAiBrowserUseTelemetry, r as useExtensionDirectConnect, t as beginConnectFlow } from "./useExtensionDirectConnect-De8LA5Az.js";
...
var InstanceAiInput_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props, { expose: __expose, emit: __emit }) {
		...
		function submitComposerMessage(message, attachments) {
			...
			emitSubmittedMessage(message, attachments, submittedFiles.length > 0 || submittedResources.length > 0 ? () => restoreSubmittedDraft(message, submittedFiles, submittedResources) : void 0);
			resetDraftComposer();
		}
				...
				createVNode(ChatInputBase_default, {
					...
					attachments: withCtx(() => [
						props.isPlanEditMode ? (openBlock(), createElementBlock("div", {
							...
							_: 1
						}, 8, ["text"])], 10, _hoisted_2)) : createCommentVNode("", true),
