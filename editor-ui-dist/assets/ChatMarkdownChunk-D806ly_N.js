const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/es-Ba_ZjsNi.js","assets/chunk-CC9Q-vWm.js","assets/core-DOxLp62L.js","assets/languageModules-Dc0x84N2.js","assets/xml-QaDfRe_h.js","assets/typescript-DF58u-hL.js"])))=>i.map(i=>d[i]);
...
import { ca as truncateBeforeLast, fo as N8nButton_default } from "./src-CH7oGKAF.js";
...
function useChatHubMarkdownOptions(codeBlockActionsClassName, tableContainerClassName, footnoteRefClassName) {
	...
	async function loadLanguageModules() {
		...
		try {
			...
			}, __vite__mapDeps([0,1,2])).then(({ default: highlight }) => highlight), __vitePreload(() => import("./languageModules-Dc0x84N2.js"), __vite__mapDeps([3,4,5]))]);
			asyncImport = {
				status: "inProgress",
				promise
			};
