const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/workers-D2OeRFGA.js","assets/comlink-_cJ6__tx.js"])))=>i.map(i=>d[i]);
...
import { _ as addNodeTranslation, g as addHeaders, v as i18n, x as useI18n } from "./_MapCache-CveP8-Y8.js";
import { Y as isBinary, sa as truncate } from "./src--aGbEXN2.js";
import { d as __vitePreload, s as require_memoize, t as require_get } from "./get-B4jH38OP.js";
import { M as createEventHook, R as throttledWatch, y as useLocalStorage } from "./dist-BkE9aYmt.js";
import { c as sanitizeHtml, g as useRoute } from "./htmlUtils-DqBTo106.js";
import { $n as makeRestApiRequest, At as getResourceMapperFields, Ct as getLocalResourceMapperFields, Dt as getNodeTypes$1, Et as getNodeTranslationHeaders, Jt as getProjectSecretProviderConnectionsByProjectId, Ot as getNodesInformation, Qn as getFullApiResponse, St as fetchCommunityNodeTypes, T as updateCurrentUserSettings, Tt as getNodeParameterOptions, Xn as ResponseError, dr as defineStore, fr as getActivePinia, ir as axios, kt as getResourceLocatorResults, l as findWebhook, nr as streamRequest, o as getWorkflowVersion, t as useRootStore, wt as getNodeParameterActionResult, xt as fetchCommunityNodeAttributes } from "./useRootStore-DW1e2yEy.js";
import { t as STORES } from "./constants2-JUBWMnBE.js";
import { $r as isResourceMapperValue$1, $t as require__baseUniq, Ai as CHAT_TRIGGER_NODE_TYPE, At as normalizeNodeShape, Bt as require__baseIteratee, Dt as isAssignmentCollectionValue, Gr as isFilterValue, In as createEmptyRunExecutionData, Ji as WAIT_INDEFINITELY, Ki as SEND_AND_WAIT_OPERATION, Ln as createRunExecutionData, Nt as Workflow, Qi as require_isEqual, Qr as isResourceLocatorValue, Qt as splitExpression, Sr as getNodeParameters, Tn as isTrimmedNodeExecutionData, Ui as MANUAL_TRIGGER_NODE_TYPE, Xi as v4, _r as displayParameter, ai as isExpression, br as getNodeInputs, ca as getResourcePermissions, ci as deepCopy, dr as resolveVariables, ea as require_keys, fr as mapConnectionsByDestination, gi as sleep$1, gr as checkConditions, ii as traverseNodeParameters, jr as isHitlToolType, mr as getChildNodes, ni as nodeConnectionTypes, nn as require__baseFindIndex, qt as normalizeGroupDescription, ti as NodeConnectionTypes, vr as displayParameterPath, wr as getNodeWebhookUrl, xi as UnexpectedError, xr as getNodeOutputs, xt as require_pick, yi as ExpressionError, yr as getConnectionTypes, zr as nodeIssuesToString } from "./src-B7RBhJEE.js";
import { b as require_isArrayLike, t as require_merge } from "./merge-XG_E66cT.js";
...
import { B as AI_CATEGORY_AGENTS, Dt as AI_TRANSFORM_NODE_TYPE, E as TEMPLATES_NODES_FILTER, Et as AI_MCP_TOOL_NODE_TYPE, F as DATA_TYPE_ICON_MAP, Ia as INLINE_AGENTS_EXPERIMENT, Ir as MAIN_HEADER_TABS, J as AI_CATEGORY_OTHER_TOOLS, Jn as WEBHOOK_NODE_TYPE$1, K as AI_CATEGORY_MCP_NODES, L as MAPPING_PARAMS, Lt as CREDENTIAL_ONLY_NODE_PREFIX, M as PLACEHOLDER_FILLED_AT_EXECUTION_TIME, Nn as SCHEDULE_TRIGGER_NODE_TYPE, P as CUSTOM_API_CALL_KEY, W as AI_CATEGORY_HUMAN_IN_THE_LOOP, Xn as WORKFLOW_TRIGGER_NODE_TYPE, Yn as WIKIPEDIA_TOOL_NODE_TYPE, ba as WorkflowIdKey, bn as NON_ACTIVATABLE_TRIGGER_NODE_TYPES, cn as LIST_LIKE_NODE_OPERATIONS, ct as CORE_NODES_CATEGORY, dt as HITL_SUBCATEGORY, en as FORM_TRIGGER_NODE_TYPE$1, et as AI_CATEGORY_VECTOR_STORES, ft as HUMAN_IN_THE_LOOP_CATEGORY, gn as MODULE_ENABLED_NODES, gt as RECOMMENDED_NODES, i as DUPLICATE_POSTFFIX, j as IN_PROGRESS_EXECUTION_ID, mn as MESSAGE_AN_AGENT_NODE_TYPE, nn as HTTP_REQUEST_NODE_TYPE, oo as EnterpriseEditionFeature, pa as CanvasRenderDataKey, qt as ERROR_TRIGGER_NODE_TYPE$1, r as DEFAULT_SETTINGS, st as BETA_NODES, tt as AI_CODE_TOOL_LANGCHAIN_NODE_TYPE, vn as NODE_POSITION_CONFLICT_ALLOWLIST, ya as WorkflowDocumentStoreKey } from "./constants-Cre_5Rj2.js";
import { i as require_toNumber } from "./useDebounce-BVsH9Yn4.js";
import { b as isObject$1, d as isJsonKeyObject, f as isPresent, g as stringSizeInBytes, h as shorten, l as isEmpty, m as omit, y as getObjectSizeInKB } from "./typesUtils-mY3b-8gF.js";
import { a as getNewWorkflow, i as getLastSuccessfulExecution, l as getWorkflows, n as useFavoritesStore, r as getExecutionData, t as useWorkflowsListStore } from "./workflowsList.store-Dw99AODt.js";
import { $t as CANCELLABLE_EXECUTION_STATUSES, n as useUIStore } from "./ui.store-C_NmBxp1.js";
import { c as hasRole, t as hasPermission } from "./permissions-Cc6Ig7cb.js";
import { o as require_startCase, t as useEvaluationStore } from "./evaluation.store-CDYiGu-d.js";
import { n as noCase } from "./dist-DHSLgU2f.js";
import { t as require_sortBy } from "./sortBy-DWuWpNjq.js";
	...
	const loadNodesInformationFromLocalDb = async (nodeInfos) => {
		try {
			const { getNodeType } = await __vitePreload(async () => {
				const { getNodeType } = await import("./workers-D2OeRFGA.js");
				return { getNodeType };
			}, __vite__mapDeps([0,1]));
			const found = [];
			const missing = [];
	...
	const loadNodeTypesFromLocalDb = async () => {
		try {
			const { loadNodeTypes, getAllNodeTypes } = await __vitePreload(async () => {
				const { loadNodeTypes, getAllNodeTypes } = await import("./workers-D2OeRFGA.js");
				return {
					loadNodeTypes,
					getAllNodeTypes
				};
...
//#endregion
export { nodeTypesToCreateElements as $, isAuthRelatedParameter as $n, _sfc_main$d as $r, ensureNodePosition as $t, doesNodeHaveCredentialsToFill as A, isResourceSortableByDate as Ai, moveDataTableColumnApi as An, DEFAULT_VIEWPORT_BOUNDARIES as Ar, useAIAssistantHelpers as At, useActionsGenerator as B, CANVAS_NODE_GROUP_HANDLE_LEFT as Bi, getAppNameFromCredType as Bn, getNewNodePosition as Br, isPairedItemIntermediateNodesError as Bt, disposeWorkflowDocumentStore as C, isCredentialModalState as Ci, deleteDataTableRowsApi as Cn, resolveCanonicalConnection as Cr, chatWithBuilder as Ct, TOOL_NODE_TYPES_NEED_INPUT as D, isFullExecutionResponse as Di, getDataTableRowsApi as Dn, CONFIGURABLE_NODE_SIZE as Dr, getBuilderCredits as Dt, useWorkflowDocumentStore as E, isDebouncedFunction as Ei, fetchDataTablesApi as En, AGENT_NODE_SIZE as Er, getAiSessions as Et, useEnvFeatureFlag as F, isValidCredentialResponse as Fi, executionDataToJson as Fn, generateOffsets as Fr, getMappedResult as Ft, getAiTemplatesCallout as G, CanvasNodeRenderType as Gi, getNodeAuthOptions as Gn, updateViewportToContainNodes as Gr, unwrapExpression as Gt, filterAndSearchNodes as H, CANVAS_NODE_GROUP_TYPE as Hi, getAuthTypeForNodeCredential as Hn, getNodesGroupSize as Hr, removeExpressionPrefix as Ht, require_uniq as I, isValidNodeConnectionType as Ii, fieldCannotBeDeleted as In, getBounds as Ir, propertyNameFromExpression as It, getSendAndWaitNodes as J, parseCanvasGroupNodeId as Ji, getThemedValue as Jn, PanelPosition as Jr, useWorkflowHelpers as Jt, getHumanInTheLoopActions as K, createCanvasGroupNodeId as Ki, getNodeCredentialForSelectedAuthType as Kn, MarkerType as Kr, resolveParameter as Kt, isAgentNodeV2 as L, isVariableResource as Li, filterTemplateNodes as Ln, getGenericHints as Lr, completeExpressionSyntax as Lt, getParameterDisplayableOptions as M, isSharedResource as Mi, updateDataTableApi as Mn, PUSH_NODES_OFFSET as Mr, useFlattenSchema as Mt, needsAgentInput as N, isString as Ni, updateDataTableRowsApi as Nn, calculateNodeSize as Nr, escapeMappingString as Nt, assignNodeId as O, isProjectRole as Oi, importCsvToDataTableApi as On, CONFIGURATION_NODE_SIZE as Or, replaceCode as Ot, serializeNode as P, isTriggerPanelObject as Pi, uploadCsvFileApi as Pn, doRectsOverlap as Pr, getMappedExpression as Pt, mapToolSubcategoryIcon as Q, hasProxyAuth as Qn, _sfc_main$3 as Qr, useTagsStore as Qt, useNodeTypesStore as R, isVueFlowConnection as Ri, getActivatableTriggerNodes as Rn, getMidCanvasPosition as Rr, getExpressionErrorMessage as Rt, createWorkflowDocumentId as S, isComponentPublicInstance as Si, deleteDataTableColumnApi as Sn, parseCanvasConnectionHandleString as Sr, chatWithAssistant as St, provideWorkflowDocumentStore as T, isDateObject as Ti, fetchDataTableGlobalLimitInBytes as Tn, injectStrict as Tr, generateCodeForPrompt as Tt, finalizeItems as U, CanvasConnectionMode as Ui, getMainAuthField as Un, getNodesWithNormalizedPosition as Ur, shouldConvertToExpression as Ut, extractAiGatewaySection as V, CANVAS_NODE_GROUP_HANDLE_RIGHT as Vi, getAppNameFromNodeName as Vn, getNodeViewTab as Vr, isTestableExpression as Vt, flattenCreateElements as W, CanvasNodeDirtiness as Wi, getNodeAuthFields as Wn, snapPositionToGridByCenter as Wr, stringifyExpressionResult as Wt, isAINode as X, hasExpressionMapping as Xn, _sfc_main as Xr, useWorkflowId as Xt, groupItemsInSections as Y, structuralComputed as Yi, getTriggerNodeServiceName as Yn, Position as Yr, useRouteWorkflowId as Yt, isNodePreviewKey as Z, hasOnlyListMode as Zn, _sfc_main$1 as Zr, useAnnotationTagsStore as Zt, disposeWorkflowExecutionStateStore as _, CHANGE_ACTION as _i, moveFolderToProject as _n, injectCanvasRenderData as _r, stripToolSuffix as _t, executionFilterToQueryFilter as a, getRectOfNodes as ai, injectNDVStoreIfProvided as an, parseResourceMapperFieldName as ar, sortNodeCreateElements as at, createExecutionPreviewDocumentId as b, isBaseTextKey as bi, createDataTableApi as bn, mapLegacyConnectionToCanvasConnection as br, listenForCredentialChanges as bt, getDefaultExecutionFilters as c, useGetPointerPosition as ci, useEnvironmentsStore as cn, probeCredential as cr, SampleTemplates as ct, hasCancellableExecutions as d, getPinDataSize as di, splitName as dn, checkOverlap as dr, getTutorialTemplates as dt, _sfc_main$f as ei, removeWorkflowExecutionData as en, isMatchingField as er, prepareCommunityNodeDetailsViewStack as et, hasTrimmedRunData as f, pinDataToExecutionData as fi, useAvailableProjectSearch as fn, computeNodeDisplaySize as fr, isTutorialTemplateId as ft, parse as g, useExecutionDataStore as gi, ProjectTypes as gn, getMaxNodePortsLabelSize as gr, useInlineAgentsExperiment as gt, waitingNodeTooltip as h, hasExecutionDataStore as hi, useSourceControlStore as hn, createEmptyCanvasRenderData as hr, getN8nAgentsNodeName as ht, displayForm as i, getConnectedEdges as ii, injectNDVStore as in, isValueExpression as ir, showsAiGatewaySection as it, getNodeTypeDisplayableCredentials as j, isRouteLocationRaw as ji, renameDataTableColumnApi as jn, HORIZONTAL_NODE_STEP as jr, useDataSchema as jt, doesNodeHaveAllCredentialsFilled as k, isResourceMapperValue as ki, insertDataTableRowApi as kn, DEFAULT_NODE_SIZE as kr, truncateBuilderMessages as kt, getExecutionErrorMessage as l, useVueFlow as li, ResourceType as ln, isCredentialOnlyNodeType as lr, getRagStarterWorkflowJson as lt, unflattenExecutionData as m, disposeExecutionDataStore as mi, useProjectsStore as mn, createCanvasConnectionId as mr, isTemplatesWorkflow as mt, buildExecutionResponseFromSchema as n, getBezierPath as ni, sortNodesByExecutionOrder as nn, isResourceMapperFieldListStale as nr, searchNodes as nt, executionRetryMessage as o, getSmoothStepPath as oi, useNDVStore as on, updateNodeAuthType as or, subcategorizeItems as ot, openFormPopupWindow as p, createExecutionDataId as pi, useRemoteProjectSearch as pn, createCanvasConnectionHandleString as pr, isFullTemplatesCollection as pt, getRootSearchCallouts as q, isCanvasGroupNode as qi, getNodeSubtitle as qn, NodeId as qr, resolveRequiredParameters as qt, clearPopupWindowState as r, getBoundsofRects as ri, disposeNDVStore as rn, isResourceMapperSchemaIncomplete as rr, shouldShowCommunityNodeDetails as rt, findTriggerNodeToAutoSelect as s, isMacOs as si, LOCAL_STORAGE_NDV_PANEL_WIDTH as sn, getAllCredentials as sr, transformNodeType as st, useWorkflowsStore as t, clamp as ti, sanitizeConnections as tn, isRequiredCredential as tr, removePreviewToken as tt, getExecutionErrorToastConfiguration as u, wheelDelta as ui, getTruncatedProjectName as un, applyOffset as ur, getSampleWorkflowByTemplateId as ut, injectWorkflowExecutionStateStore as v, getPairedItemId as vi, setWorkflowSharedWith as vn, insertSpacersBetweenEndpoints as vr, useAiGatewayStore as vt, injectWorkflowDocumentStore as w, isCredentialsResource as wi, downloadDataTableCsvApi as wn, shouldIgnoreCanvasShortcut as wr, clearBuilderSession as wt, createExecutionPreviewDocumentVersion as x, isBinaryLike as xi, deleteDataTableApi as xn, mapLegacyConnectionsToCanvasConnections as xr, useCredentialsStore as xt, useWorkflowExecutionStateStore as y, checkExhaustive as yi, addDataTableColumnApi as yn, mapCanvasConnectionToLegacyConnection as yr, sublimeSearch as yt, isDataWorkerEnabled as z, isWorkflowListItem as zi, getAllNodeCredentialForAuthType as zn, getMousePosition as zr, getResolvableState as zt };
