      ...
      execute: function () {
        ...
        */
        ...
        zh_CN_default = {
          ...
          "resourceLocator.workflow.inactive.tooltip": "必须在使用之前发布",
          ...
          "settings.mcp.workflows.table.empty.title": "没有连接的工作流",
          "settings.mcp.workflows.table.empty.button.label": "查找工作流程",
          ...
          "settings.mcp.connectWorkflows": "连接工作流",
          "settings.mcp.connectWorkflows.modalTitle": "启用工作流 MCP 访问权限",
          "settings.mcp.connectWorkflows.notice": "已发布并具有 webhook、表单、调度或聊天触发器节点的工作流程可以启用 MCP 访问。",
          "settings.mcp.connectWorkflows.input.placeholder": "搜索要连接的工作流",
          "settings.mcp.connectWorkflows.confirm.label": "连接",
          "settings.mcp.connectWorkflows.error": "获取可用工作流时出错",
          "settings.mcp.connectWorkflows.emptyState": "未找到工作流",
