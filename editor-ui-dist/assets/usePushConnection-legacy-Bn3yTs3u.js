;
(function () {
  System.register(["./vue.runtime.esm-bundler-legacy--Sn1h8On.js", "./_MapCache-legacy-Bnay2tPV.js", "./useTelemetry-legacy-DKRvN4mA.js", "./useToast-legacy-DEFFmTH6.js", "./constants-legacy-BbwdWVie.js", "./assistant.store-legacy-BJMYMBts.js", "./_baseOrderBy-legacy-9y2xV7og.js", "./useExternalHooks-legacy-DyFictUx.js", "./useWorkflowSaving-legacy-BhH4Tvrd.js", "./useRunWorkflow-legacy-CUCSeSme.js", "./banners.store-legacy-0wz0CZhC.js", "./schemaPreview.store-legacy-CGNkNnpO.js", "./aiTemplatesStarterCollection.store-legacy-DftBuwsS.js", "./readyToRun.store-legacy-BKzH-AwK.js"], function (_export, _context) {
    "use strict";

    var ref, useI18n, SampleTemplates, useUIStore, useCredentialsStore, isPrebuiltAgentTemplateId, codeNodeEditorEventBus, isTutorialTemplateId, injectWorkflowState, useDocumentTitle, useSettingsStore, clearPopupWindowState, useNodeTypesStore, getTriggerNodeServiceName, getExecutionErrorMessage, globalLinkActionsEventBus, useWorkflowHelpers, useWorkflowsStore, useTelemetry, getExecutionErrorToastConfiguration, parse, isValidNodeConnectionType, useNodeHelpers, sendGetWorkerStatus, useToast, createRunExecutionData, isCommunityPackageName, generateNodesGraph, TRIMMED_TASK_DATA_CONNECTIONS_KEY, EVALUATION_TRIGGER_NODE_TYPE, WORKFLOW_SETTINGS_MODAL_KEY, useBuilderStore, useAssistantStore, defineStore, useRootStore, useExternalHooks, useWorkflowSaving, usePushConnectionStore, useRunWorkflow, useBannersStore, useSchemaPreviewStore, useAITemplatesStarterCollectionStore, useReadyToRunStore, WORKER_HISTORY_LENGTH, STALE_SECONDS, useOrchestrationStore;
    ...
    */
    ...
    return {
      setters: [function (_vueRuntimeEsmBundlerLegacy003Js) {
        ...
        TRIMMED_TASK_DATA_CONNECTIONS_KEY = _constantsLegacy00TJs.mo;
