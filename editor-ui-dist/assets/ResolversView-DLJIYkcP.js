...
import { $ as openBlock, A as createTextVNode, C as createBaseVNode, Cn as toDisplayString, E as createElementBlock, Gt as unref, N as defineComponent, S as computed, T as createCommentVNode, X as onMounted, _ as Fragment, bt as withCtx, h as withModifiers, j as createVNode, rt as renderList, vn as normalizeClass, w as createBlock } from "./vue.runtime.esm-bundler-CDDUUZhE.js";
import { s as useI18n } from "./src-Dh32dOY5.js";
import { Ga as N8nHeading_default, Ja as N8nButton_default, Ki as N8nActionBox_default, Lt as N8nActionToggle_default, Ya as N8nIcon_default, jt as N8nCard_default, lt as N8nLink_default, o as Loading_default, qa as N8nText_default } from "./src-BVC_ZvSs.js";
...
import { t as useCredentialResolvers } from "./useCredentialResolvers-CNaEy3Ys.js";
			...
			return openBlock(), createElementBlock("div", { class: normalizeClass(_ctx.$style.container) }, [createBaseVNode("div", { class: normalizeClass(["mb-xl", _ctx.$style.headerContainer]) }, [createBaseVNode("div", { class: normalizeClass(_ctx.$style.headerTitle) }, [createVNode(unref(N8nHeading_default), {
				...
				description: withCtx(() => [
					...
					createVNode(unref(N8nHeading_default), {
						...
						default: withCtx(() => [..._cache[0] || (_cache[0] = [createTextVNode(" Resolve private credentials from user identity ", -1)])]),
						_: 1
					}),
