import { Mt as useRouter } from "./src-DmQRaDBt.js";
...
import { Es as instanceAiAgentAttachmentSchema, uf as v4 } from "./constants-BzyjfRY2.js";
...
function useInstanceAiHandoff() {
	...
	async function openAgentArtifactThread(attachment) {
	...
	async function openThreadWithContext(projectId, context, options) {
		if (handoffInFlight) return false;
		handoffInFlight = true;
		try {
