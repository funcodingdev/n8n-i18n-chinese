;
(function () {
  System.register(["./vue.runtime.esm-bundler-legacy--Sn1h8On.js", "./useTelemetry-legacy-CMfwYwVY.js", "./_baseOrderBy-legacy-Bls-fMH1.js"], function (_export, _context) {
    "use strict";

    var computed, ref, runLdapSync, getLdapSynchronizations, updateLdapConfig, getSamlConfig, saveOidcConfig, getOidcConfig, saveSamlConfig, getSamlMetadata, initSSO, UserManagementAuthenticationMethod, testSamlConfig, testLdapConnection, getLdapConfig, defineStore, useRootStore, SupportedProtocols, useSSOStore;
    return {
      setters: [function (_vueRuntimeEsmBundlerLegacy003Js) {
        computed = _vueRuntimeEsmBundlerLegacy003Js.C;
        ref = _vueRuntimeEsmBundlerLegacy003Js.It;
      }, function (_useTelemetryLegacy00HJs) {
        runLdapSync = _useTelemetryLegacy00HJs.Cs;
        getLdapSynchronizations = _useTelemetryLegacy00HJs.Ss;
        updateLdapConfig = _useTelemetryLegacy00HJs.Ts;
        getSamlConfig = _useTelemetryLegacy00HJs.as;
        saveOidcConfig = _useTelemetryLegacy00HJs.cs;
        getOidcConfig = _useTelemetryLegacy00HJs.is;
        saveSamlConfig = _useTelemetryLegacy00HJs.ls;
        getSamlMetadata = _useTelemetryLegacy00HJs.os;
        initSSO = _useTelemetryLegacy00HJs.ss;
        UserManagementAuthenticationMethod = _useTelemetryLegacy00HJs.tc;
        testSamlConfig = _useTelemetryLegacy00HJs.us;
        testLdapConnection = _useTelemetryLegacy00HJs.ws;
        getLdapConfig = _useTelemetryLegacy00HJs.xs;
