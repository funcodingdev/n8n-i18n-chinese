...
import { $u as WorkflowDocumentStoreKey, Ai as IMPORT_WORKFLOW_URL_MODAL_KEY, Gd as LOADING_ANIMATION_MIN_DURATION, Sa as LOCAL_STORAGE_HIDE_GITHUB_STAR_BUTTON, Sl as jsonParse, T as TIME_SAVED_DOCS_URL, Vd as EnterpriseEditionFeature, Xi as WORKFLOW_DESCRIPTION_MODAL_KEY, Yi as WORKFLOW_ACTIVE_MODAL_KEY, aa as WORKFLOW_SETTINGS_MODAL_KEY, bu as getResourcePermissions, di as VIEWS, ea as WORKFLOW_HISTORY_NAME_VERSION_MODAL_KEY, fi as WORKFLOW_HISTORY_PUBLISH_TIMELINE_TAB, h as EVALUATIONS_DOCS_URL, ia as WORKFLOW_PUBLISH_MODAL_KEY, if as WORKFLOW_MENU_ACTIONS, m as ERROR_WORKFLOW_DOCS_URL, oa as WORKFLOW_SHARE_MODAL_KEY, ra as WORKFLOW_HISTORY_VERSION_UNPUBLISH, t as AutoSaveState, ui as MAIN_HEADER_TABS, wi as DUPLICATE_MODAL_KEY, y as N8N_MAIN_GITHUB_REPO_URL } from "./constants-BaNoJas_.js";
import { Cn as ProjectTypes, Gn as getActivatableTriggerNodes, It as useTagsStore, Pt as useWorkflowId, Sn as useSourceControlStore, Ut as injectNDVStoreIfProvided, Xi as getBannerRowHeight, _ as useNodeTypesStore, a as injectWorkflowDocumentStore, b as useEvaluationStore, cn as useWorkflowsStore, gn as ResourceType, r as createWorkflowDocumentId, s as useWorkflowDocumentStore, xn as useProjectsStore } from "./workflowDocument.store-ewdwPGdV.js";
...
import { f as useUIStore, h as telemetry, n as hasPermission, p as useTelemetry, t as useUsersStore } from "./users.store-CHh4wCL_.js";
...
import { a as useWorkflowSaveStore, r as useWorkflowSaving, s as useWorkflowHistoryStore } from "./builder.store-DgovV5vR.js";
...
import { t as router } from "./router-BDUXJky8.js";
import { a as MCP_SETTINGS_VIEW, r as MCP_DOCS_PAGE_URL } from "./mcp.constants-BT39eBzp.js";
import { t as useMoveResourceToProjectToast } from "./useMoveResourceToProjectToast-CxLx52gX.js";
import { i as getLastPublishedVersion, r as generateVersionLabelFromId } from "./utils-BtmmbUiL.js";
...
import { t as usePushConnection } from "./usePushConnection-zoNOovKS.js";
import { t as FolderBreadcrumbs_default } from "./FolderBreadcrumbs-Bn8ohOEJ.js";
import { t as ConnectionTracker_default } from "./ConnectionTracker-Hd43zdPk.js";
import { t as useWorkflowEvaluationState } from "./useWorkflowEvaluationState-RCvHqmJo.js";
import "./usePushConnection-C2SKWHxL.js";
