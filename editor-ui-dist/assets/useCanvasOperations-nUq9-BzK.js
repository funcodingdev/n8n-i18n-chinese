...
import { at as useI18n$1, c as useClipboard, v as useLocalStorage } from "./core-DJhPBFhT.js";
import { Oi as require_markdown_it_link_attributes, ct as useRoute, lt as useRouter } from "./src-DJ-D-s3W.js";
import { t as _plugin_vue_export_helper_default } from "./_plugin-vue_export-helper-Da88TEg1.js";
import { Dt as useWorkflowState, Ea as tryToParseNumber, Et as injectWorkflowState, Fr as isValidNodeConnectionType, Hr as useHistoryStore, Ht as useFocusPanelStore, In as useExternalHooks, Jr as MoveNodeCommand, Jt as CONFIGURABLE_NODE_SIZE, Pn as useToast, Qr as ReplaceNodeParametersCommand, Qt as PUSH_NODES_OFFSET, Tt as useWorkflowHelpers, Ur as AddConnectionCommand, Vr as CanvasNodeRenderType, Wr as AddNodeCommand, Xr as RemoveNodeCommand, Xt as DEFAULT_NODE_SIZE, Yr as RemoveConnectionCommand, Yt as CONFIGURATION_NODE_SIZE, Zr as RenameNodeCommand, Zt as DEFAULT_VIEWPORT_BOUNDARIES, ai as useProjectsStore, b as getExecutionErrorToastConfiguration, cn as getNodesGroupSize, ct as useDataSchema, d as isChatNode, en as doRectsOverlap, fr as useTelemetry, gr as useNDVStore, hr as usePostHog, it as useCredentialsStore, la as pinDataToExecutionData, lr as useNodeHelpers, nr as useTagsStore, oa as useWorkflowDocumentStore, on as getNewNodePosition, qt as useTemplatesStore, r as useUIStore, ra as createWorkflowDocumentId, s as useWorkflowsStore, tn as generateOffsets, ur as useCanvasStore, w as useNodeTypesStore, xa as isPresent, z as removePreviewToken, zr as CanvasConnectionMode } from "./users.store-Cuk0qvvE.js";
import { $s as LOCAL_STORAGE_LOGS_PANEL_DETAILS_PANEL, Ei as require_cloneDeep, Eo as v4, Fa as deepCopy, Ia as isCommunityPackageName, Pi as require__baseUniq, Qc as EnterpriseEditionFeature, Qi as generateNodesGraph, Qo as VIEWS, Uc as NDV_IN_FOCUS_PANEL_EXPERIMENT, ar as STICKY_NODE_TYPE, dr as UPDATE_WEBHOOK_ID_NODE_TYPES, ec as LOCAL_STORAGE_LOGS_PANEL_DETAILS_PANEL_SUB_NODE, eo as NodeConnectionTypes, ia as getNodeParameters, jc as CANVAS_ZOOMED_VIEW_EXPERIMENT, la as getSubworkflowId, na as getNodeInputs, nc as LOCAL_STORAGE_LOGS_SYNC_SELECTION, pa as isHitlToolType, ra as getNodeOutputs, ta as getConnectionTypes, tc as LOCAL_STORAGE_LOGS_PANEL_OPEN, xa as resolveNodeWebhookId } from "./constants-fJx0oi9Z.js";
...
import { a as mapLegacyConnectionToCanvasConnection, c as parseCanvasConnectionHandleString, i as mapCanvasConnectionToLegacyConnection, n as createCanvasConnectionHandleString, o as mapLegacyConnectionsToCanvasConnections } from "./canvas.utils-DZZQGC93.js";
import { n as useNodeCreatorStore, t as canvasEventBus } from "./canvas.eventBus-DUGzZAkM.js";
import { t as core_default } from "./core-CenpuDt9.js";
import { a as bash, i as javascript, n as typescript, r as python, t as xml } from "./xml-BGwQZ1Fo.js";
import { t as VueMarkdown } from "./VueMarkdown-C2pJ_ak5.js";
import { t as useSetupPanelStore } from "./setupPanel.store-C6e1e5LY.js";
import { t as clearAllNodeResourceLocatorValues } from "./templateTransforms-Vsh2XjbS.js";
...
//#endregion
//#region ../../../node_modules/.pnpm/lodash@4.17.23/node_modules/lodash/uniq.js
