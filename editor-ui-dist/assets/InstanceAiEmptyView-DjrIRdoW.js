import { $ as openBlock, A as createTextVNode, C as createBaseVNode, E as createElementBlock, Ft as ref, N as defineComponent, Nt as reactive, S as computed, Sn as toDisplayString, T as createCommentVNode, U as mergeProps, W as nextTick, Wt as unref, X as onMounted, Z as onUnmounted, _ as Fragment, _n as normalizeClass, gt as watch, j as createVNode, n as Transition, q as onBeforeUnmount, rt as renderList, st as resolveDynamicComponent, w as createBlock, yn as normalizeStyle, yt as withCtx } from "./vue.runtime.esm-bundler-C6vn67cX.js";
import { s as useI18n } from "./src-WwCUXbmD.js";
import { Da as N8nText_default, gt as useRouter, ka as N8nIcon_default, ki as AskAssistantIcon_default, zi as N8nTooltip_default } from "./src-DFOx8N22.js";
import { t as _plugin_vue_export_helper_default } from "./_plugin-vue_export-helper-Da88TEg1.js";
import { t as useToast } from "./useToast-Bp2-vBnv.js";
import { $l as INSTANCE_AI_WORKFLOW_PREVIEW_SUGGESTIONS_EXPERIMENT, Gc as v4, Ql as INSTANCE_AI_PROMPT_SUGGESTIONS_V2_EXPERIMENT, Zl as INSTANCE_AI_PROACTIVE_AGENT_EXPERIMENT } from "./constants-BMUE7W6Y.js";
import { D as storeToRefs, t as useRootStore } from "./useRootStore-BOF8LYEF.js";
import { p as useElementSize } from "./core-nZc0i8VB.js";
...
import { n as useInstanceAiStore } from "./instanceAi.store-Bi4lVMTh.js";
import { t as CreditWarningBanner_default } from "./CreditWarningBanner-DOIqDYjI.js";
import { a as INSTANCE_AI_EMPTY_STATE_SUGGESTIONS, i as useCreditWarningBanner, n as InstanceAiInput_default, t as InstanceAiViewHeader_default } from "./InstanceAiViewHeader-D4EB7EwC.js";
	...
	setup(__props) {
		...
		return (_ctx, _cache) => {
			return stage.value !== "waiting" ? (openBlock(), createElementBlock("article", {
				...
				createBaseVNode("span", { class: normalizeClass(_ctx.$style.typingDot) }, null, 2),
				createBaseVNode("span", { class: normalizeClass(_ctx.$style.typingDot) }, null, 2)
			], 10, _hoisted_1$5)) : (openBlock(), createBlock(unref(N8nText_default), {
				key: 1,
				tag: "p",
				size: "large",
...
var avatar$2 = "_avatar_rshub_355";
var bubble$1 = "_bubble_rshub_366";
var message$1 = "_message_rshub_377";
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("div", {
				...
				return openBlock(), createElementBlock("button", {
					...
					size: 12,
					class: normalizeClass(_ctx.$style.suggestionIcon)
				}, null, 8, ["icon", "class"]), createBaseVNode("span", null, toDisplayString(unref(i18n).baseText(suggestion.labelKey)), 1)], 46, _hoisted_1$3);
	...
	setup(__props) {
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("div", {
				...
				}), 128))], 10, _hoisted_1)), createBaseVNode("div", { class: normalizeClass(_ctx.$style.nodesLayer) }, [(openBlock(true), createElementBlock(Fragment, null, renderList(props.workflow.nodes, (node) => {
	...
	setup(__props) {
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("div", { class: normalizeClass(_ctx.$style.chatArea) }, [createVNode(InstanceAiViewHeader_default), createBaseVNode("div", { class: normalizeClass(_ctx.$style.contentArea) }, [showProactiveStarter.value ? (openBlock(), createElementBlock("div", {
				...
				createBaseVNode("div", { class: normalizeClass(_ctx.$style.centeredInput) }, [unref(creditBanner).visible.value ? (openBlock(), createBlock(CreditWarningBanner_default, {
					key: 0,
					"credits-remaining": unref(store).creditsRemaining,
					"credits-quota": unref(store).creditsQuota,
				...
				}), null, 16, ["is-submitting"])], 2),
				createVNode(Transition, { name: "workflow-preview-fade" }, {
					default: withCtx(() => [unref(isWorkflowPreviewSuggestionsExperimentEnabled) && activeWorkflowPreview.value ? (openBlock(), createBlock(unref(WorkflowPreviewCanvas_default), {
						key: 0,
						workflow: activeWorkflowPreview.value,
						class: normalizeClass(_ctx.$style.workflowPreview)
					}, null, 8, ["workflow", "class"])) : createCommentVNode("", true)]),
					_: 1
				})
			], 2))], 2)], 2);
		};
...
var InstanceAiEmptyView_vue_vue_type_style_index_0_lang_module_default = {
	chatArea: "_chatArea_b4a6v_125",
	contentArea: "_contentArea_b4a6v_135",
	emptyLayout: "_emptyLayout_b4a6v_142",
	centeredInput: "_centeredInput_b4a6v_152",
	workflowPreview: "_workflowPreview_b4a6v_157",
	proactiveLayout: "_proactiveLayout_b4a6v_162",
	proactiveMessageList: "_proactiveMessageList_b4a6v_169",
	proactiveInput: "_proactiveInput_b4a6v_180"
};
