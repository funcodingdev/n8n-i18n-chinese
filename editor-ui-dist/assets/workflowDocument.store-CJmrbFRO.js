const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/workers-BebK6FsO.js","assets/comlink-owZQJTZG.js"])))=>i.map(i=>d[i]);
...
import { J as i18n, K as addHeaders, L as throttledWatch, Z as useI18n, j as createEventHook, q as addNodeTranslation, y as useLocalStorage } from "./dist-DOFK-fIm.js";
import { Q as isBinary, jt as useRoute, sa as truncate, v as sanitizeHtml } from "./src-DmQRaDBt.js";
import { a as require_toString, f as __vitePreload, s as require_memoize, t as require_get } from "./get-Ult7GPGC.js";
import { E as getActivePinia, T as defineStore, a as ResponseError, c as makeRestApiRequest, d as request, f as streamRequest, m as axios, s as getFullApiResponse, t as useRootStore } from "./useRootStore-H_HdEClX.js";
import { C as updateCurrentUserSettings, Ft as getProjectSecretProviderConnectionsByProjectId, Vn as STORES, _t as getResourceMapperFields, ct as fetchCommunityNodeAttributes, dt as getNodeParameterActionResult, ft as getNodeParameterOptions, gt as getResourceLocatorResults, ht as getNodesInformation, i as getWorkflowVersion, lt as fetchCommunityNodeTypes, mt as getNodeTypes$1, pt as getNodeTranslationHeaders, s as findWebhook, t as useSettingsStore, ut as getLocalResourceMapperFields } from "./settings.store-CQqpFn-s.js";
import { $n as SCHEDULE_TRIGGER_NODE_TYPE, Ac as EnterpriseEditionFeature, Al as splitExpression, At as AI_TRANSFORM_NODE_TYPE, Au as getNodeInputs, Bs as WorkflowIdKey, Cn as LIST_LIKE_NODE_OPERATIONS, Du as displayParameter, Eu as checkConditions, I as CUSTOM_API_CALL_KEY, Id as UnexpectedError, In as NON_ACTIVATABLE_TRIGGER_NODE_TYPES, Kd as CHAT_TRIGGER_NODE_TYPE, L as DATA_TYPE_ICON_MAP, Mn as MODULE_ENABLED_NODES, Mu as getNodeParameters, N as IN_PROGRESS_EXECUTION_ID, Ns as CanvasRenderDataKey, O as TEMPLATES_NODES_FILTER, Ou as displayParameterPath, P as PLACEHOLDER_FILLED_AT_EXECUTION_TIME, Pd as ExpressionError, Pl as require__baseFindIndex, Pn as NODE_POSITION_CONFLICT_ALLOWLIST, Pu as getNodeWebhookUrl, Sr as WORKFLOW_TRIGGER_NODE_TYPE, Su as mapConnectionsByDestination, Tl as normalizeGroupDescription, U as AI_CATEGORY_AGENTS, Ut as CREDENTIAL_ONLY_NODE_PREFIX, Vu as isHitlToolType, Wc as require_toNumber, Y as AI_CATEGORY_MCP_NODES, Yu as nodeIssuesToString, Z as AI_CATEGORY_OTHER_TOOLS, cf as WAIT_INDEFINITELY, cn as FORM_TRIGGER_NODE_TYPE, dt as CORE_NODES_CATEGORY, ed as isFilterValue, en as ERROR_TRIGGER_NODE_TYPE, fd as traverseNodeParameters, ff as require_isEqual, fi as MAIN_HEADER_TABS, fl as Workflow, fs as getResourcePermissions, gl as require__createCompounder, ht as HUMAN_IN_THE_LOOP_CATEGORY, hu as createRunExecutionData, i as DUPLICATE_POSTFFIX, if as MANUAL_TRIGGER_NODE_TYPE, it as AI_CODE_TOOL_LANGCHAIN_NODE_TYPE, jd as sleep$1, jl as require__baseUniq, ju as getNodeOutputs, kn as MESSAGE_AN_AGENT_NODE_TYPE, kt as AI_MCP_TOOL_NODE_TYPE, ku as getConnectionTypes, ld as NodeConnectionTypes, mf as require_keys, mt as HITL_SUBCATEGORY, mu as createEmptyRunExecutionData, od as isResourceLocatorValue, of as SEND_AND_WAIT_OPERATION, pi as VIEWS, pn as HTTP_REQUEST_NODE_TYPE, q as AI_CATEGORY_HUMAN_IN_THE_LOOP, r as DEFAULT_SETTINGS, rl as require__baseFlatten, rt as AI_CATEGORY_VECTOR_STORES, ru as isTrimmedNodeExecutionData, sd as isResourceMapperValue$1, sl as isAssignmentCollectionValue, tl as require_pick, ud as nodeConnectionTypes, uf as v4, ut as BETA_NODES, vr as WEBHOOK_NODE_TYPE, wd as deepCopy, wu as getChildNodes, xd as isExpression, xu as resolveVariables, yl as require__baseIteratee, yr as WIKIPEDIA_TOOL_NODE_TYPE, yt as RECOMMENDED_NODES, z as MAPPING_PARAMS, zs as WorkflowDocumentStoreKey } from "./constants-BzyjfRY2.js";
import { b as require_isArrayLike, n as require__isIterateeCall, r as require__baseRest, t as require_merge } from "./merge-B4bcFBd8.js";
import { _ as useStorage, f as useUIStore, n as hasPermission, q as CANCELLABLE_EXECUTION_STATUSES, t as useUsersStore, u as hasRole } from "./users.store-CF55TUDI.js";
import { A as isObject$1, E as stringSizeInBytes, S as isPresent, T as shorten, a as getNewWorkflow, i as getLastSuccessfulExecution, k as getObjectSizeInKB, l as getWorkflows, n as useFavoritesStore, r as getExecutionData, t as useWorkflowsListStore, w as omit, x as isJsonKeyObject, y as isEmpty } from "./workflowsList.store-DY3toAy4.js";
import { t as useDocumentTitle } from "./useDocumentTitle-CyUdysBY.js";
import { t as require__baseOrderBy } from "./_baseOrderBy-BW3FBT_P.js";
	...
	const loadNodesInformationFromLocalDb = async (nodeInfos) => {
		try {
			const { getNodeType } = await __vitePreload(async () => {
				const { getNodeType } = await import("./workers-BebK6FsO.js");
				return { getNodeType };
			}, __vite__mapDeps([0,1]));
			const found = [];
			const missing = [];
	...
	const loadNodeTypesFromLocalDb = async () => {
		try {
			const { loadNodeTypes, getAllNodeTypes } = await __vitePreload(async () => {
				const { loadNodeTypes, getAllNodeTypes } = await import("./workers-BebK6FsO.js");
				return {
					loadNodeTypes,
					getAllNodeTypes
				};
...
//#endregion
export { isTemplatesWorkflow as $, CHANGE_ACTION as $i, getAuthTypeForNodeCredential as $n, snapPositionToGridByCenter as $r, displayForm as $t, getAiTemplatesCallout as A, isResourceMapperValue as Ai, addDataTableColumnApi as An, mapLegacyConnectionToCanvasConnection as Ar, shouldConvertToExpression as At, removePreviewToken as B, isWorkflowListItem as Bi, insertDataTableRowApi as Bn, DEFAULT_VIEWPORT_BOUNDARIES as Br, ensureNodePosition as Bt, deleteEvaluationConfig as C, isComponentPublicInstance as Ci, useAvailableProjectSearch as Cn, createCanvasConnectionHandleString as Cr, propertyNameFromExpression as Ct, filterAndSearchNodes as D, isDebouncedFunction as Di, ProjectTypes as Dn, injectCanvasRenderData as Dr, isPairedItemIntermediateNodesError as Dt, extractAiGatewaySection as E, isDateObject as Ei, useSourceControlStore as En, getMaxNodePortsLabelSize as Er, getResolvableState as Et, isAINode as F, isTriggerPanelObject as Fi, downloadDataTableCsvApi as Fn, injectStrict as Fr, useWorkflowHelpers as Ft, subcategorizeItems as G, CanvasNodeDirtiness as Gi, uploadCsvFileApi as Gn, getBounds as Gr, injectNDVStore as Gt, shouldShowCommunityNodeDetails as H, CANVAS_NODE_GROUP_HANDLE_RIGHT as Hi, renameDataTableColumnApi as Hn, calculateNodeSize as Hr, sanitizeConnections as Ht, isNodePreviewKey as I, isValidCredentialResponse as Ii, fetchDataTableGlobalLimitInBytes as In, AGENT_NODE_SIZE as Ir, useRouteWorkflowId as It, getRagStarterWorkflowJson as J, isCanvasGroupNode as Ji, filterTemplateNodes as Jn, getMousePosition as Jr, disposeWorkflowExecutionStateStore as Jt, transformNodeType as K, CanvasNodeRenderType as Ki, executionDataToJson as Kn, getGenericHints as Kr, injectNDVStoreIfProvided as Kt, mapToolSubcategoryIcon as L, isValidNodeConnectionType as Li, fetchDataTablesApi as Ln, CONFIGURABLE_NODE_SIZE as Lr, useWorkflowId as Lt, getRootSearchCallouts as M, isRouteLocationRaw as Mi, deleteDataTableApi as Mn, parseCanvasConnectionHandleString as Mr, unwrapExpression as Mt, getSendAndWaitNodes as N, isSharedResource as Ni, deleteDataTableColumnApi as Nn, resolveCanonicalConnection as Nr, resolveParameter as Nt, finalizeItems as O, isFullExecutionResponse as Oi, moveFolderToProject as On, insertSpacersBetweenEndpoints as Or, isTestableExpression as Ot, groupItemsInSections as P, isString as Pi, deleteDataTableRowsApi as Pn, shouldIgnoreCanvasShortcut as Pr, resolveRequiredParameters as Pt, isFullTemplatesCollection as Q, pinDataToExecutionData as Qi, getAppNameFromNodeName as Qn, getNodesWithNormalizedPosition as Qr, clearPopupWindowState as Qt, nodeTypesToCreateElements as R, isVariableResource as Ri, getDataTableRowsApi as Rn, CONFIGURATION_NODE_SIZE as Rr, useAnnotationTagsStore as Rt, createEvaluationConfig as S, isBinaryLike as Si, splitName as Sn, computeNodeDisplaySize as Sr, getMappedResult as St, updateEvaluationConfig as T, isCredentialsResource as Ti, useProjectsStore as Tn, createEmptyCanvasRenderData as Tr, getExpressionErrorMessage as Tt, showsAiGatewaySection as U, CANVAS_NODE_GROUP_TYPE as Ui, updateDataTableApi as Un, doRectsOverlap as Ur, sortNodesByExecutionOrder as Ut, searchNodes as V, CANVAS_NODE_GROUP_HANDLE_LEFT as Vi, moveDataTableColumnApi as Vn, PUSH_NODES_OFFSET as Vr, removeWorkflowExecutionData as Vt, sortNodeCreateElements as W, CanvasConnectionMode as Wi, updateDataTableRowsApi as Wn, generateOffsets as Wr, disposeNDVStore as Wt, getTutorialTemplates as X, structuralComputed as Xi, getAllNodeCredentialForAuthType as Xn, getNodeViewTab as Xr, useWorkflowExecutionStateStore as Xt, getSampleWorkflowByTemplateId as Y, parseCanvasGroupNodeId as Yi, getActivatableTriggerNodes as Yn, getNewNodePosition as Yr, injectWorkflowExecutionStateStore as Yt, isTutorialTemplateId as Z, getPinDataSize as Zi, getAppNameFromCredType as Zn, getNodesGroupSize as Zr, buildExecutionResponseFromSchema as Zt, isAgentNodeV2 as _, useGetPointerPosition as _i, getPairedItemId as _n, updateNodeAuthType as _r, useAIAssistantHelpers as _t, injectWorkflowDocumentStore as a, _sfc_main as ai, getExecutionErrorToastConfiguration as an, getThemedValue as ar, require_upperFirst as at, useActionsGenerator as b, checkExhaustive as bi, ResourceType as bn, applyOffset as br, escapeMappingString as bt, TOOL_NODE_TYPES_NEED_INPUT as c, _sfc_main$d as ci, openFormPopupWindow as cn, hasOnlyListMode as cr, useCredentialsStore as ct, doesNodeHaveCredentialsToFill as d, getBezierPath as di, parse as dn, isMatchingField as dr, clearBuilderSession as dt, updateViewportToContainNodes as ei, executionFilterToQueryFilter as en, getMainAuthField as er, useAiGatewayStore as et, getNodeTypeDisplayableCredentials as f, getBoundsofRects as fi, useWorkflowsStore as fn, isRequiredCredential as fr, generateCodeForPrompt as ft, require_uniq as g, isMacOs as gi, useExecutionDataStore as gn, parseResourceMapperFieldName as gr, truncateBuilderMessages as gt, serializeNode as h, getSmoothStepPath as hi, hasExecutionDataStore as hn, isValueExpression as hr, replaceCode as ht, disposeWorkflowDocumentStore as i, Position as ii, getExecutionErrorMessage as in, getNodeSubtitle as ir, require_startCase as it, getHumanInTheLoopActions as j, isResourceSortableByDate as ji, createDataTableApi as jn, mapLegacyConnectionsToCanvasConnections as jr, stringifyExpressionResult as jt, flattenCreateElements as k, isProjectRole as ki, setWorkflowSharedWith as kn, mapCanvasConnectionToLegacyConnection as kr, removeExpressionPrefix as kt, assignNodeId as l, _sfc_main$f as li, unflattenExecutionData as ln, hasProxyAuth as lr, chatWithAssistant as lt, needsAgentInput as m, getRectOfNodes as mi, disposeExecutionDataStore as mn, isResourceMapperSchemaIncomplete as mr, getBuilderCredits as mt, createExecutionPreviewDocumentVersion as n, NodeId as ni, findTriggerNodeToAutoSelect as nn, getNodeAuthOptions as nr, capitalCase as nt, provideWorkflowDocumentStore as o, _sfc_main$1 as oi, hasCancellableExecutions as on, getTriggerNodeServiceName as or, require__baseSlice as ot, getParameterDisplayableOptions as p, getConnectedEdges as pi, createExecutionDataId as pn, isResourceMapperFieldListStale as pr, getAiSessions as pt, SampleTemplates as q, createCanvasGroupNodeId as qi, fieldCannotBeDeleted as qn, getMidCanvasPosition as qr, useNDVStore as qt, createWorkflowDocumentId as r, PanelPosition as ri, getDefaultExecutionFilters as rn, getNodeCredentialForSelectedAuthType as rr, sublimeSearch as rt, useWorkflowDocumentStore as s, _sfc_main$3 as si, hasTrimmedRunData as sn, hasExpressionMapping as sr, listenForCredentialChanges as st, createExecutionPreviewDocumentId as t, MarkerType as ti, executionRetryMessage as tn, getNodeAuthFields as tr, require_sortBy as tt, doesNodeHaveAllCredentialsFilled as u, clamp as ui, waitingNodeTooltip as un, isAuthRelatedParameter as ur, chatWithBuilder as ut, useNodeTypesStore as v, useVueFlow as vi, LOCAL_STORAGE_NDV_PANEL_WIDTH as vn, getAllCredentials as vr, useDataSchema as vt, listEvaluationConfigs as w, isCredentialModalState as wi, useRemoteProjectSearch as wn, createCanvasConnectionId as wr, completeExpressionSyntax as wt, useEvaluationStore as x, isBaseTextKey as xi, getTruncatedProjectName as xn, checkOverlap as xr, getMappedExpression as xt, isDataWorkerEnabled as y, wheelDelta as yi, useEnvironmentsStore as yn, isCredentialOnlyNodeType as yr, useFlattenSchema as yt, prepareCommunityNodeDetailsViewStack as z, isVueFlowConnection as zi, importCsvToDataTableApi as zn, DEFAULT_NODE_SIZE as zr, useTagsStore as zt };
