;
(function () {
  System.register(["./vue.runtime.esm-bundler-legacy--Sn1h8On.js", "./_MapCache-legacy-CIWHOywQ.js", "./useTelemetry-legacy-CISk46xo.js", "./useToast-legacy-WoZGemxJ.js", "./constants-legacy-DuqvrHPn.js", "./assistant.store-legacy-ByqXPqKr.js", "./_baseOrderBy-legacy-BoIlqV8l.js", "./useExternalHooks-legacy-DWuo7Sev.js", "./useWorkflowSaving-legacy-CKxn7gAE.js", "./useRunWorkflow-legacy-DX_v8kHy.js", "./banners.store-legacy-WWmkOZsO.js", "./schemaPreview.store-legacy-Bergv6zU.js", "./aiTemplatesStarterCollection.store-legacy-CVj9AvJh.js", "./readyToRun.store-legacy-CCOJOG93.js"], function (_export, _context) {
    "use strict";

    var ref, useI18n, SampleTemplates, useUIStore, useCredentialsStore, isPrebuiltAgentTemplateId, codeNodeEditorEventBus, isTutorialTemplateId, injectWorkflowState, useDocumentTitle, useSettingsStore, clearPopupWindowState, useNodeTypesStore, getTriggerNodeServiceName, getExecutionErrorMessage, globalLinkActionsEventBus, useWorkflowHelpers, useWorkflowsStore, useTelemetry, getExecutionErrorToastConfiguration, parse, isValidNodeConnectionType, useNodeHelpers, sendGetWorkerStatus, useToast, isCommunityPackageName, createRunExecutionData, generateNodesGraph, WORKFLOW_SETTINGS_MODAL_KEY, EVALUATION_TRIGGER_NODE_TYPE, TRIMMED_TASK_DATA_CONNECTIONS_KEY, useBuilderStore, useAssistantStore, defineStore, useRootStore, useExternalHooks, useWorkflowSaving, usePushConnectionStore, useRunWorkflow, useBannersStore, useSchemaPreviewStore, useAITemplatesStarterCollectionStore, useReadyToRunStore, WORKER_HISTORY_LENGTH, STALE_SECONDS, useOrchestrationStore;
