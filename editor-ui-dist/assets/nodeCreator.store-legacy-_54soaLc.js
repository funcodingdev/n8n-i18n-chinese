;
(function () {
  System.register(["./chunk-legacy-Re9CbdfL.js", "./vue.runtime.esm-bundler-legacy--Sn1h8On.js", "./_MapCache-legacy-By9GzIrR.js", "./truncate-legacy-Dvb8sNHI.js", "./useTelemetry-legacy-D11VqDwV.js", "./constants-legacy-CylJU6xq.js", "./merge-legacy-DgmAhl0m.js", "./_baseOrderBy-legacy-gbKt-EDA.js", "./useExternalHooks-legacy-DY4QJM8_.js", "./templates.store-legacy-w55IC_R-.js", "./nodeIcon-legacy-CLMaH24c.js"], function (_export, _context) {
    "use strict";

    var __toESM, __commonJS, computed, nextTick, ref, useI18n, useRouter, require__arrayMap, require_get, require_toString, useRoute, getThemedValue, getSampleWorkflowByTemplateId, require__createCompounder, sortNodeCreateElements, useProjectsStore, SampleTemplates, useUIStore, useCanvasStore, useSettingsStore, updateCurrentUserSettings, isPrebuiltAgentTemplateId, isTutorialTemplateId, getPrebuiltAgents, v4_default, require_upperFirst, CanvasConnectionMode, transformNodeType, isAINode, useNDVStore, useNodeTypesStore, isVueFlowConnection, getAiTemplatesCallout, isValidCanvasConnectionMode, groupItemsInSections, usePostHog, getTutorialTemplates, getRagStarterWorkflowJson, finalizeItems, getPreBuiltAgentsCalloutWithDivider, useUsersStore, useWorkflowsStore, STORES, useEvaluationStore, useTelemetry, flattenCreateElements, isValidNodeConnectionType, subcategorizeItems, searchNodes, prepareCommunityNodeDetailsViewStack, AI_CATEGORY_LANGUAGE_MODELS, getNodeInputs, EDIT_IMAGE_NODE_TYPE, TRANSFORM_DATA_SUBCATEGORY, CHAT_TRIGGER_NODE_TYPE, LIMIT_NODE_TYPE, NODE_CREATOR_OPEN_SOURCES, MARKDOWN_NODE_TYPE, REGULAR_NODE_CREATOR_VIEW, isCommunityPackageName, MANUAL_TRIGGER_NODE_TYPE, CODE_NODE_TYPE, CUSTOM_API_CALL_KEY, AI_TRANSFORM_NODE_TYPE$1, CRYPTO_NODE_TYPE, require__arrayIncludes, AGGREGATE_NODE_TYPE, VIEWS, AI_CODE_NODE_TYPE, AI_CATEGORY_EMBEDDING, SCHEDULE_TRIGGER_NODE_TYPE, HUMAN_IN_THE_LOOP_CATEGORY, COMPRESSION_NODE_TYPE, NodeConnectionTypes, CONVERT_TO_FILE_NODE_TYPE, AI_CATEGORY_CHAINS, AI_TRANSFORM_NODE_TYPE, RSS_READ_NODE_TYPE, DATA_TABLE_NODE_TYPE, AI_CATEGORY_AGENTS, REMOVE_DUPLICATES_NODE_TYPE, AI_CATEGORY_DOCUMENT_LOADERS, DATETIME_NODE_TYPE, IF_NODE_TYPE, CORE_NODES_CATEGORY, AI_CATEGORY_ROOT_NODES, require__SetCache, HELPERS_SUBCATEGORY, require__baseFlatten, EXTRACT_FROM_FILE_NODE_TYPE, AI_CATEGORY_VECTOR_STORES, FORM_TRIGGER_NODE_TYPE, SUMMARIZE_NODE_TYPE, AI_NODE_CREATOR_VIEW, AI_CATEGORY_MCP_NODES, AI_OTHERS_NODE_CREATOR_VIEW, HTTP_REQUEST_NODE_TYPE, AI_WORKFLOW_TOOL_LANGCHAIN_NODE_TYPE, PRE_BUILT_AGENTS_EXPERIMENT, AI_CATEGORY_RETRIEVERS, require__arrayIncludesWith, TRIGGER_NODE_CREATOR_VIEW, MERGE_NODE_TYPE, TEMPLATE_CATEGORY_AI, FILTER_NODE_TYPE, AI_CODE_TOOL_LANGCHAIN_NODE_TYPE, HTML_NODE_TYPE, AI_UNCATEGORIZED_CATEGORY, EMAIL_SEND_NODE_TYPE, SPLIT_IN_BATCHES_NODE_TYPE, AI_CATEGORY_TEXT_SPLITTERS, AI_SUBCATEGORY, NODE_MIN_INPUT_ITEMS_COUNT, PRE_BUILT_AGENTS_MODAL_KEY, AI_CATEGORY_OUTPUTPARSER, EXECUTE_WORKFLOW_TRIGGER_NODE_TYPE, SPLIT_OUT_NODE_TYPE, AI_CATEGORY_TOOLS, EMAIL_IMAP_NODE_TYPE, EVALUATION_TRIGGER_NODE_TYPE, SET_NODE_TYPE, AI_CATEGORY_MEMORY, WEBHOOK_NODE_TYPE, DEFAULT_SUBCATEGORY, XML_NODE_TYPE, OTHER_TRIGGER_NODES_SUBCATEGORY, HITL_SUBCATEGORY, require__cacheHas, FLOWS_CONTROL_SUBCATEGORY, require__baseUnary, require__baseRest, require_isArrayLikeObject, defineStore, useRootStore, useExternalHooks, useTemplatesStore, getNodeIconSource, require__baseDifference, require_difference, require_capitalize, require_camelCase, import_camelCase, KEYBOARD_ID_ATTR, WATCHED_KEYS, useKeyboardNavigation, __virtual_node_popularity_data_default, import_difference, nodePopularityMap, useViewStacks, import_get, useNodeCreatorStore;
    //#endregion
    ...
    */
    ...
    return {
      setters: [function (_chunkLegacy001Js) {
        ...
        updateCurrentUserSettings = _useTelemetryLegacy00HJs.Jo;
        ...
        AI_CATEGORY_LANGUAGE_MODELS = _constantsLegacy00TJs.$;
        getNodeInputs = _constantsLegacy00TJs.$i;
        EDIT_IMAGE_NODE_TYPE = _constantsLegacy00TJs.$t;
        TRANSFORM_DATA_SUBCATEGORY = _constantsLegacy00TJs.At;
        CHAT_TRIGGER_NODE_TYPE = _constantsLegacy00TJs.Bt;
        LIMIT_NODE_TYPE = _constantsLegacy00TJs.Cn;
        NODE_CREATOR_OPEN_SOURCES = _constantsLegacy00TJs.Ct;
        MARKDOWN_NODE_TYPE = _constantsLegacy00TJs.Dn;
        REGULAR_NODE_CREATOR_VIEW = _constantsLegacy00TJs.Dt;
        isCommunityPackageName = _constantsLegacy00TJs.Ea;
        MANUAL_TRIGGER_NODE_TYPE = _constantsLegacy00TJs.En;
        CODE_NODE_TYPE = _constantsLegacy00TJs.Ht;
        CUSTOM_API_CALL_KEY = _constantsLegacy00TJs.I;
        AI_TRANSFORM_NODE_TYPE$1 = _constantsLegacy00TJs.It;
        CRYPTO_NODE_TYPE = _constantsLegacy00TJs.Jt;
        require__arrayIncludes = _constantsLegacy00TJs.Mi;
        AGGREGATE_NODE_TYPE = _constantsLegacy00TJs.Nt;
        VIEWS = _constantsLegacy00TJs.Po;
        AI_CODE_NODE_TYPE = _constantsLegacy00TJs.Pt;
        AI_CATEGORY_EMBEDDING = _constantsLegacy00TJs.Q;
        SCHEDULE_TRIGGER_NODE_TYPE = _constantsLegacy00TJs.Qn;
        HUMAN_IN_THE_LOOP_CATEGORY = _constantsLegacy00TJs.St;
        COMPRESSION_NODE_TYPE = _constantsLegacy00TJs.Ut;
        NodeConnectionTypes = _constantsLegacy00TJs.Wa;
        CONVERT_TO_FILE_NODE_TYPE = _constantsLegacy00TJs.Wt;
        AI_CATEGORY_CHAINS = _constantsLegacy00TJs.X;
        AI_TRANSFORM_NODE_TYPE = _constantsLegacy00TJs.Xa;
        RSS_READ_NODE_TYPE = _constantsLegacy00TJs.Xn;
        DATA_TABLE_NODE_TYPE = _constantsLegacy00TJs.Xt;
        AI_CATEGORY_AGENTS = _constantsLegacy00TJs.Y;
        REMOVE_DUPLICATES_NODE_TYPE = _constantsLegacy00TJs.Yn;
        AI_CATEGORY_DOCUMENT_LOADERS = _constantsLegacy00TJs.Z;
        DATETIME_NODE_TYPE = _constantsLegacy00TJs.Zt;
        IF_NODE_TYPE = _constantsLegacy00TJs._n;
        CORE_NODES_CATEGORY = _constantsLegacy00TJs._t;
        AI_CATEGORY_ROOT_NODES = _constantsLegacy00TJs.at;
        require__SetCache = _constantsLegacy00TJs.bo;
        HELPERS_SUBCATEGORY = _constantsLegacy00TJs.bt;
        require__baseFlatten = _constantsLegacy00TJs.ci;
        EXTRACT_FROM_FILE_NODE_TYPE = _constantsLegacy00TJs.cn;
        AI_CATEGORY_VECTOR_STORES = _constantsLegacy00TJs.ct;
        FORM_TRIGGER_NODE_TYPE = _constantsLegacy00TJs.dn;
        SUMMARIZE_NODE_TYPE = _constantsLegacy00TJs.dr;
        AI_NODE_CREATOR_VIEW = _constantsLegacy00TJs.dt;
        AI_CATEGORY_MCP_NODES = _constantsLegacy00TJs.et;
        AI_OTHERS_NODE_CREATOR_VIEW = _constantsLegacy00TJs.ft;
        HTTP_REQUEST_NODE_TYPE = _constantsLegacy00TJs.hn;
        AI_WORKFLOW_TOOL_LANGCHAIN_NODE_TYPE = _constantsLegacy00TJs.ht;
        PRE_BUILT_AGENTS_EXPERIMENT = _constantsLegacy00TJs.ic;
        AI_CATEGORY_RETRIEVERS = _constantsLegacy00TJs.it;
        require__arrayIncludesWith = _constantsLegacy00TJs.ji;
        TRIGGER_NODE_CREATOR_VIEW = _constantsLegacy00TJs.jt;
        MERGE_NODE_TYPE = _constantsLegacy00TJs.kn;
        TEMPLATE_CATEGORY_AI = _constantsLegacy00TJs.kt;
        FILTER_NODE_TYPE = _constantsLegacy00TJs.ln;
        AI_CODE_TOOL_LANGCHAIN_NODE_TYPE = _constantsLegacy00TJs.lt;
        HTML_NODE_TYPE = _constantsLegacy00TJs.mn;
        AI_UNCATEGORIZED_CATEGORY = _constantsLegacy00TJs.mt;
        EMAIL_SEND_NODE_TYPE = _constantsLegacy00TJs.nn;
        SPLIT_IN_BATCHES_NODE_TYPE = _constantsLegacy00TJs.or;
        AI_CATEGORY_TEXT_SPLITTERS = _constantsLegacy00TJs.ot;
        AI_SUBCATEGORY = _constantsLegacy00TJs.pt;
        NODE_MIN_INPUT_ITEMS_COUNT = _constantsLegacy00TJs.q;
        PRE_BUILT_AGENTS_MODAL_KEY = _constantsLegacy00TJs.rs;
        AI_CATEGORY_OUTPUTPARSER = _constantsLegacy00TJs.rt;
        EXECUTE_WORKFLOW_TRIGGER_NODE_TYPE = _constantsLegacy00TJs.sn;
        SPLIT_OUT_NODE_TYPE = _constantsLegacy00TJs.sr;
        AI_CATEGORY_TOOLS = _constantsLegacy00TJs.st;
        EMAIL_IMAP_NODE_TYPE = _constantsLegacy00TJs.tn;
        EVALUATION_TRIGGER_NODE_TYPE = _constantsLegacy00TJs.to;
        SET_NODE_TYPE = _constantsLegacy00TJs.tr;
        AI_CATEGORY_MEMORY = _constantsLegacy00TJs.tt;
        WEBHOOK_NODE_TYPE = _constantsLegacy00TJs.vr;
        DEFAULT_SUBCATEGORY = _constantsLegacy00TJs.vt;
        XML_NODE_TYPE = _constantsLegacy00TJs.wr;
        OTHER_TRIGGER_NODES_SUBCATEGORY = _constantsLegacy00TJs.wt;
        HITL_SUBCATEGORY = _constantsLegacy00TJs.xt;
        require__cacheHas = _constantsLegacy00TJs.yo;
        FLOWS_CONTROL_SUBCATEGORY = _constantsLegacy00TJs.yt;
