...
import { Di as N8nTooltip_default, Ii as truncateBeforeLast, Kt as ElCollapseTransition, Mt as N8nActionDropdown_default, Qi as N8nIcon_default, Xi as N8nText_default, Zi as N8nButton_default, lt as useRouter, tt as N8nLink_default } from "./src-DJ-D-s3W.js";
import { t as _plugin_vue_export_helper_default } from "./_plugin-vue_export-helper-Da88TEg1.js";
import { Et as injectWorkflowState, Hn as isPlaceholderValue, Hr as useHistoryStore, Pn as useToast, Pt as globalLinkActionsEventBus, Qt as PUSH_NODES_OFFSET, Tt as useWorkflowHelpers, Vn as findPlaceholderDetails, aa as injectWorkflowDocumentStore, cr as useEnvironmentsStore, d as isChatNode, fr as useTelemetry, gr as useNDVStore, ir as sortNodesByExecutionOrder, it as useCredentialsStore, lr as useNodeHelpers, oa as useWorkflowDocumentStore, qi as getTriggerNodeServiceName, qt as useTemplatesStore, r as useUIStore, ra as createWorkflowDocumentId, rt as listenForCredentialChanges, s as useWorkflowsStore, w as useNodeTypesStore } from "./users.store-Cuk0qvvE.js";
import { O as NodeCredentials_default, t as ParameterInputList_default } from "./ParameterInputList-B0I42Abk.js";
import { $i as displayParameter, Ci as extractReferencesInNodeExpressions, Eo as v4, Ms as WORKFLOW_EXTRACTION_NAME_MODAL_KEY, Oo as require_isEqual, Qo as VIEWS, aa as getNodeParametersIssues$1, ba as nodeAcceptsInputType, bc as ExpressionLocalResolveContextSymbol, eo as NodeConnectionTypes, hi as parseExtractableSubgraphSelection, ho as EXECUTE_WORKFLOW_TRIGGER_NODE_TYPE, j as PLACEHOLDER_FILLED_AT_EXECUTION_TIME, ja as isResourceLocatorValue, mi as buildAdjacencyList, na as getNodeInputs, no as isExpression, ra as getNodeOutputs, xn as MANUAL_TRIGGER_NODE_TYPE } from "./constants-fJx0oi9Z.js";
import { t as useClipboard } from "./useClipboard-EmOYKgZi.js";
import { r as useLogsStore, t as useCanvasOperations } from "./useCanvasOperations-nUq9-BzK.js";
import { i as getNodeTypeDisplayableCredentials } from "./nodeTransforms-DwnAFUmw.js";
import { t as NodeIcon_default } from "./NodeIcon-B_kmVGKP.js";
import { r as useNodeExecution } from "./VirtualSchema-C3klJa-m.js";
