...
import { s as useI18n$1 } from "./src-w6tdcvn4.js";
import { Bi as require_markdown_it_link_attributes, gt as useRouter, ht as useRoute } from "./src-BwN8TeVO.js";
import { t as _plugin_vue_export_helper_default } from "./_plugin-vue_export-helper-Da88TEg1.js";
import { t as useToast } from "./useToast-UJviqZPo.js";
import { As as generateNodesGraph, Ca as LOCAL_STORAGE_LOGS_SYNC_SELECTION, Cn as MANUAL_CHAT_TRIGGER_NODE_TYPE, Fs as getNodeOutputs, Gs as isHitlToolType, Is as getNodeParameters, Lt as CHAT_TRIGGER_NODE_TYPE, Ns as getConnectionTypes, Ps as getNodeInputs, Qo as require_cloneDeep, Sa as LOCAL_STORAGE_LOGS_PANEL_OPEN, Vs as getSubworkflowId, ba as LOCAL_STORAGE_LOGS_PANEL_DETAILS_PANEL, bc as isObjectEmpty, bu as NDV_IN_FOCUS_PANEL_EXPERIMENT, ec as resolveNodeWebhookId, hr as UPDATE_WEBHOOK_ID_NODE_TYPES, iu as CANVAS_ZOOMED_VIEW_EXPERIMENT, ju as EnterpriseEditionFeature, ll as v4, lr as STICKY_NODE_TYPE, ns as validateNodeSelectionForGrouping, pc as NodeConnectionTypes, ru as CANVAS_NODES_GROUPING_EXPERIMENT, ts as validateNodeSelectionForExtraction, ui as VIEWS, vc as deepCopy, xa as LOCAL_STORAGE_LOGS_PANEL_DETAILS_PANEL_SUB_NODE, yc as isCommunityPackageName } from "./constants-BiYlbN9Z.js";
import { $t as injectNDVStore, A as serializeNode, Ar as getNewNodePosition, Ci as isValidNodeConnectionType, Gt as useWorkflowHelpers, Jt as ensureNodePosition, M as useNodeTypesStore, Mr as getNodesGroupSize, Ni as CanvasNodeRenderType, Ot as useDataSchema, S as useWorkflowDocumentStore, Sr as PUSH_NODES_OFFSET, Tr as generateOffsets, Xt as sanitizeConnections, Z as removePreviewToken, ar as createCanvasConnectionHandleString, br as DEFAULT_NODE_SIZE, cn as useProjectsStore, dr as mapCanvasConnectionToLegacyConnection, fr as mapLegacyConnectionToCanvasConnection, g as disposeWorkflowExecutionStateStore, j as require_uniq, ji as CanvasConnectionMode, mr as parseCanvasConnectionHandleString, pr as mapLegacyConnectionsToCanvasConnections, qt as useTagsStore, t as useWorkflowsStore, ti as pinDataToExecutionData, u as getExecutionErrorToastConfiguration, v as useWorkflowExecutionStateStore, vr as CONFIGURABLE_NODE_SIZE, vt as useCredentialsStore, wr as doRectsOverlap, x as injectWorkflowDocumentStore, xr as DEFAULT_VIEWPORT_BOUNDARIES, y as createWorkflowDocumentId, yr as CONFIGURATION_NODE_SIZE } from "./workflows.store-DgZ4KSQf.js";
...
import { _ as useLocalStorage, c as useClipboard } from "./core-BemUAWor.js";
import { f as useUIStore, g as usePostHog, p as useTelemetry } from "./users.store-CUZkGc51.js";
import { D as tryToParseNumber, o as getNewWorkflowData, x as isPresent } from "./workflowsList.store-CHLmHbKZ.js";
import { t as useExternalHooks } from "./useExternalHooks-Tca-U0bF.js";
import { t as useBuilderStore } from "./builder.store-CDTOjwn3.js";
import { c as MoveNodeCommand, d as RenameNodeCommand, f as ReplaceNodeParametersCommand, i as AddNodeCommand, l as RemoveConnectionCommand, m as useCanvasStore, n as useHistoryStore, r as AddConnectionCommand, t as useNodeHelpers, u as RemoveNodeCommand } from "./useNodeHelpers-Bs3WVmfe.js";
...
import { t as core_default } from "./core-DSzj01DV.js";
import { a as bash, i as javascript, n as typescript, r as python, t as xml } from "./xml-DSPlQU-O.js";
import { t as VueMarkdown } from "./VueMarkdown-BAFx_zBK.js";
import { t as useSetupPanelStore } from "./setupPanel.store-Uw4c7WDm.js";
import { t as clearAllNodeResourceLocatorValues } from "./templateTransforms--nm_CGaj.js";
