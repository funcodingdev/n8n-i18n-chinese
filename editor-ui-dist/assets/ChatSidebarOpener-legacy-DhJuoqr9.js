;
(function () {
  System.register(["./vue.runtime.esm-bundler-legacy--Sn1h8On.js", "./_MapCache-legacy-Bnay2tPV.js", "./src-legacy-7AvQoEFL.js", "./_plugin-vue_export-helper-legacy-DZMI5HPp.js", "./truncate-legacy-C0REgs6L.js", "./useTelemetry-legacy-DKRvN4mA.js", "./constants-legacy-BbwdWVie.js", "./constants-legacy-DjFSod4r.js", "./chat.store-legacy-hLkLoXGE.js", "./useChatHubSidebarState-legacy-DBYSFRgh.js"], function (_export, _context) {
    "use strict";

    var computed, createElementBlock, createCommentVNode, unref, ref, defineComponent, createBlock, watch, renderSlot, openBlock, normalizeClass, useEventListener, useMediaQuery, useI18n, useLocalStorage, useDeviceSupport, N8nIconButton_default, __plugin_vue_export_helper_default, useRouter, useProjectsStore, useUIStore, useCredentialsStore, useSettingsStore, PROVIDER_CREDENTIAL_TYPE_MAP, nullType, recordType, stringType, chatHubConversationModelSchema, objectType, chatHubProviderSchema, LOCAL_STORAGE_CHAT_HUB_CREDENTIALS, CHAT_VIEW, MOBILE_MEDIA_QUERY, isLlmProvider, isLlmProviderModel, useChatHubSidebarState, __vite_style__, credentialsMapSchema, chatHubConversationModelWithCachedDisplayNameSchema, ChatLayout_vue_vue_type_script_setup_true_lang_default, component, isMobileDevice, ChatLayout_vue_vue_type_style_index_0_lang_module_default, cssModules, ChatLayout_default, ChatSidebarOpener_vue_vue_type_script_setup_true_lang_default, ChatSidebarOpener_default;
    //#endregion
    ...
    */
    ...
    return {
      setters: [function (_vueRuntimeEsmBundlerLegacy003Js) {
        ...
        nullType = _constantsLegacy00TJs.Ao;
        recordType = _constantsLegacy00TJs.Mo;
        stringType = _constantsLegacy00TJs.No;
        chatHubConversationModelSchema = _constantsLegacy00TJs.ei;
        objectType = _constantsLegacy00TJs.jo;
        chatHubProviderSchema = _constantsLegacy00TJs.ni;
        LOCAL_STORAGE_CHAT_HUB_CREDENTIALS = _constantsLegacy00TJs.xs;
