...
import { Jt as ElCollapseTransition, Pt as N8nActionDropdown_default, Ri as truncateBeforeLast, ha as N8nIcon_default, ki as N8nTooltip_default, ma as N8nButton_default, nt as N8nLink_default, pa as N8nText_default, ut as useRouter } from "./src-Dg8CDsvD.js";
import { t as _plugin_vue_export_helper_default } from "./_plugin-vue_export-helper-Da88TEg1.js";
import { D as NodeCredentials_default, t as ParameterInputList_default } from "./ParameterInputList-B-4yT3YP.js";
import { $t as createWorkflowDocumentId, Bt as useEnvironmentsStore, Di as getTriggerNodeServiceName, It as sortNodesByExecutionOrder, Jt as useTelemetry, Ln as useHistoryStore, Mt as useWorkflowHelpers, Qt as useNDVStore, at as useCredentialsStore, d as isChatNode, er as PUSH_NODES_OFFSET, it as listenForCredentialChanges, nn as useWorkflowDocumentStore, r as useUIStore, s as useWorkflowsStore, tn as injectWorkflowDocumentStore, un as useNodeHelpers, w as useNodeTypesStore } from "./users.store-Zd_8U4jS.js";
import { t as useToast } from "./useToast-DG5hVw1V.js";
import { $o as isResourceLocatorValue, Ci as WORKFLOW_EXTRACTION_NAME_MODAL_KEY, Cs as NodeConnectionTypes, Dc as ExpressionLocalResolveContextSymbol, Ga as extractReferencesInNodeExpressions, Ho as nodeAcceptsInputType, Ia as buildAdjacencyList, La as parseExtractableSubgraphSelection, Rs as EXECUTE_WORKFLOW_TRIGGER_NODE_TYPE, To as getNodeOutputs, Ys as v4, Zs as require_isEqual, j as PLACEHOLDER_FILLED_AT_EXECUTION_TIME, wo as getNodeInputs, xn as MANUAL_TRIGGER_NODE_TYPE, xo as displayParameter, zr as VIEWS } from "./constants-c-L9DE1I.js";
import "./builder.store--RObr6z7.js";
import { n as findPlaceholderDetails, o as isPlaceholderValue } from "./dist-HucXAqjn.js";
import { t as useTemplatesStore } from "./templates.store-Cq-z1X6m.js";
import { i as globalLinkActionsEventBus } from "./event-bus-Iqcl1x79.js";
import { t as useClipboard } from "./useClipboard-CiVCWz4e.js";
import { r as useLogsStore, t as useCanvasOperations } from "./useCanvasOperations-t2UW38S6.js";
import { t as NodeIcon_default } from "./NodeIcon-wV2T6osR.js";
import { r as useNodeExecution } from "./VirtualSchema-MJKRJSnU.js";
...
import { a as isCardComplete, i as groupCredentialsByType, l as isNodeSetupComplete, n as getNodeCredentialTypes, o as isCredentialCardComplete, r as getNodeParametersIssues, s as isHttpRequestNodeType, t as buildTriggerSetupState } from "./setupPanel.utils-BZuuX5uZ.js";
...
function useWorkflowExtraction() {
	...
	function checkExtractableSelectionValidity(selection) {
		...
		const isSingleIO = (nodeName, getIOs) => {
			...
			return getIOs({ expression }, node, nodeType).filter((x) => typeof x === "string" ? x === "main" : x.type === "main").length <= 1;
		};
	...
	function tryExtractNodesIntoSubworkflow(nodeIds) {
		const subGraph = nodeIds.map((id) => workflowDocumentStore?.value?.getNodeById(id)).filter((x) => x !== void 0);
