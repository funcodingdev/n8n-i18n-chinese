const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/workers-Cc_Quf7Z.js","assets/comlink-DKLUcSLg.js"])))=>i.map(i=>d[i]);
...
import { _ as addNodeTranslation, g as addHeaders, v as i18n, x as useI18n } from "./_MapCache-DHdz8CdO.js";
import { K as isBinary, Mr as truncate } from "./src-BoizZDiU.js";
import { f as __vitePreload, s as require_memoize, t as require_get } from "./get-BQc30k0X.js";
import { L as throttledWatch, j as createEventHook, y as useLocalStorage } from "./dist-CmlFwYoT.js";
import { c as sanitizeHtml, g as useRoute } from "./htmlUtils-DDeXXqh8.js";
import { a as getActivePinia, i as defineStore } from "./constants-DwjrKqNn.js";
import { t as STORES } from "./constants2-D6qsHKVK.js";
import { $i as v4, Cr as displayParameterPath, Dr as getNodeParameters, Er as getNodeOutputs, Ir as isHitlToolType, Jt as require__baseIteratee, Ki as MANUAL_TRIGGER_NODE_TYPE, Lt as normalizeNodeShape, Mn as isTrimmedNodeExecutionData, Ot as require_pick, Pi as CHAT_TRIGGER_NODE_TYPE, Pt as isAssignmentCollectionValue, Si as ExpressionError, Sr as displayParameter, Tr as getNodeInputs, Un as createEmptyRunExecutionData, Vt as Workflow, Wn as createRunExecutionData, Wr as nodeIssuesToString, Yi as SEND_AND_WAIT_OPERATION, Yr as isFilterValue, Zi as WAIT_INDEFINITELY, _r as mapConnectionsByDestination, ai as NodeConnectionTypes, an as splitExpression, ci as traverseNodeParameters, da as getResourcePermissions, en as normalizeGroupDescription, fi as deepCopy, gr as resolveVariables, kr as getNodeWebhookUrl, li as isExpression, ln as require__baseFindIndex, ni as isResourceLocatorValue, oi as nodeConnectionTypes, on as require__baseUniq, ra as require_keys, ri as isResourceMapperValue$1, ta as require_isEqual, wi as UnexpectedError, wr as getConnectionTypes, xr as checkConditions, yi as sleep$1, yr as getChildNodes } from "./src-UnL6BUww.js";
import { b as require_isArrayLike, t as require_merge } from "./merge-DKetvfsm.js";
import { $n as streamRequest, Ct as getNodeParameterOptions, Dt as getResourceLocatorResults, Et as getNodesInformation, Kt as getProjectSecretProviderConnectionsByProjectId, Ot as getResourceMapperFields, St as getNodeParameterActionResult, Tt as getNodeTypes$1, Xn as makeRestApiRequest, Yn as getFullApiResponse, a as getWorkflowVersion, bt as fetchCommunityNodeTypes, c as findWebhook, qn as ResponseError, t as useRootStore, tr as axios, w as updateCurrentUserSettings, wt as getNodeTranslationHeaders, xt as getLocalResourceMapperFields, yt as fetchCommunityNodeAttributes } from "./useRootStore--KB36t0I.js";
...
import { Da as WorkflowIdKey, Ea as WorkflowDocumentStoreKey, Fn as SCHEDULE_TRIGGER_NODE_TYPE, H as AI_CATEGORY_AGENTS, I as CUSTOM_API_CALL_KEY, J as AI_CATEGORY_MCP_NODES, K as AI_CATEGORY_HUMAN_IN_THE_LOOP, L as DATA_TYPE_ICON_MAP, N as IN_PROGRESS_EXECUTION_ID, O as TEMPLATES_NODES_FILTER, Ot as AI_MCP_TOOL_NODE_TYPE, P as PLACEHOLDER_FILLED_AT_EXECUTION_TIME, Qn as WORKFLOW_TRIGGER_NODE_TYPE, Sn as NON_ACTIVATABLE_TRIGGER_NODE_TYPES, X as AI_CATEGORY_OTHER_TOOLS, Xn as WEBHOOK_NODE_TYPE$1, Yt as ERROR_TRIGGER_NODE_TYPE$1, Zn as WIKIPEDIA_TOOL_NODE_TYPE, ba as CanvasRenderDataKey, bn as NODE_POSITION_CONFLICT_ALLOWLIST, gn as MESSAGE_AN_AGENT_NODE_TYPE, i as DUPLICATE_POSTFFIX, in as HTTP_REQUEST_NODE_TYPE, kt as AI_TRANSFORM_NODE_TYPE, lt as BETA_NODES, mt as HUMAN_IN_THE_LOOP_CATEGORY, nn as FORM_TRIGGER_NODE_TYPE$1, nt as AI_CATEGORY_VECTOR_STORES, po as EnterpriseEditionFeature, pt as HITL_SUBCATEGORY, r as DEFAULT_SETTINGS, rt as AI_CODE_TOOL_LANGCHAIN_NODE_TYPE, un as LIST_LIKE_NODE_OPERATIONS, ut as CORE_NODES_CATEGORY, vn as MODULE_ENABLED_NODES, vt as RECOMMENDED_NODES, z as MAPPING_PARAMS, zr as MAIN_HEADER_TABS, zt as CREDENTIAL_ONLY_NODE_PREFIX } from "./constants-On-mUxgN.js";
import { t as VIEWS } from "./views-4JHVC4Nc.js";
import { in as CANCELLABLE_EXECUTION_STATUSES, ln as useStorage, o as useUIStore } from "./posthog.store-BBCCmZh6.js";
import { i as require_toNumber } from "./useDebounce-b_3g4H4E.js";
import { b as isObject$1, d as isJsonKeyObject, f as isPresent, g as stringSizeInBytes, h as shorten, l as isEmpty, m as omit, y as getObjectSizeInKB } from "./typesUtils-BttZ-Bnv.js";
import { a as getNewWorkflow, i as getLastSuccessfulExecution, l as getWorkflows, n as useFavoritesStore, r as getExecutionData, t as useWorkflowsListStore } from "./workflowsList.store-B-0O8IS3.js";
import { l as hasRole, t as hasPermission } from "./permissions-DACwruZH.js";
import { o as require_startCase, t as useEvaluationStore } from "./evaluation.store-DoZWiJ7L.js";
import { n as noCase } from "./dist-BV4ZDbIp.js";
import { t as require_sortBy } from "./sortBy-Cnj4qj-d.js";
	...
	const loadNodesInformationFromLocalDb = async (nodeInfos) => {
		try {
			const { getNodeType } = await __vitePreload(async () => {
				const { getNodeType } = await import("./workers-Cc_Quf7Z.js");
				return { getNodeType };
			}, __vite__mapDeps([0,1]));
			const found = [];
			const missing = [];
	...
	const loadNodeTypesFromLocalDb = async () => {
		try {
			const { loadNodeTypes, getAllNodeTypes } = await __vitePreload(async () => {
				const { loadNodeTypes, getAllNodeTypes } = await import("./workers-Cc_Quf7Z.js");
				return {
					loadNodeTypes,
					getAllNodeTypes
				};
...
//#endregion
export { prepareCommunityNodeDetailsViewStack as $, isResourceMapperFieldListStale as $n, getBoundsofRects as $r, sortNodesByExecutionOrder as $t, doesNodeHaveCredentialsToFill as A, isTriggerPanelObject as Ai, updateDataTableRowsApi as An, doRectsOverlap as Ar, escapeMappingString as At, extractAiGatewaySection as B, CanvasNodeDirtiness as Bi, getMainAuthField as Bn, snapPositionToGridByCenter as Br, shouldConvertToExpression as Bt, disposeWorkflowDocumentStore as C, isFullExecutionResponse as Ci, fetchDataTablesApi as Cn, CONFIGURABLE_NODE_SIZE as Cr, getAiSessions as Ct, TOOL_NODE_TYPES_NEED_INPUT as D, isRouteLocationRaw as Di, moveDataTableColumnApi as Dn, HORIZONTAL_NODE_STEP as Dr, useAIAssistantHelpers as Dt, useWorkflowDocumentStore as E, isResourceSortableByDate as Ei, insertDataTableRowApi as En, DEFAULT_VIEWPORT_BOUNDARIES as Er, truncateBuilderMessages as Et, require_uniq as F, isWorkflowListItem as Fi, getActivatableTriggerNodes as Fn, getMousePosition as Fr, getExpressionErrorMessage as Ft, getHumanInTheLoopActions as G, structuralComputed as Gi, getThemedValue as Gn, Position as Gr, useWorkflowHelpers as Gt, finalizeItems as H, createCanvasGroupNodeId as Hi, getNodeAuthOptions as Hn, MarkerType as Hr, unwrapExpression as Ht, isAgentNodeV2 as I, CANVAS_NODE_GROUP_HANDLE_LEFT as Ii, getAllNodeCredentialForAuthType as In, getNewNodePosition as Ir, getResolvableState as It, groupItemsInSections as J, hasOnlyListMode as Jn, _sfc_main$3 as Jr, useAnnotationTagsStore as Jt, getRootSearchCallouts as K, getTriggerNodeServiceName as Kn, _sfc_main as Kr, useRouteWorkflowId as Kt, useNodeTypesStore as L, CANVAS_NODE_GROUP_HANDLE_RIGHT as Li, getAppNameFromCredType as Ln, getNodeViewTab as Lr, isPairedItemIntermediateNodesError as Lt, getParameterDisplayableOptions as M, isValidNodeConnectionType as Mi, executionDataToJson as Mn, getBounds as Mr, getMappedResult as Mt, needsAgentInput as N, isVariableResource as Ni, fieldCannotBeDeleted as Nn, getGenericHints as Nr, propertyNameFromExpression as Nt, assignNodeId as O, isSharedResource as Oi, renameDataTableColumnApi as On, PUSH_NODES_OFFSET as Or, useDataSchema as Ot, serializeNode as P, isVueFlowConnection as Pi, filterTemplateNodes as Pn, getMidCanvasPosition as Pr, completeExpressionSyntax as Pt, nodeTypesToCreateElements as Q, isRequiredCredential as Qn, getBezierPath as Qr, sanitizeConnections as Qt, isDataWorkerEnabled as R, CANVAS_NODE_GROUP_TYPE as Ri, getAppNameFromNodeName as Rn, getNodesGroupSize as Rr, isTestableExpression as Rt, createWorkflowDocumentId as S, isDebouncedFunction as Si, fetchDataTableGlobalLimitInBytes as Sn, AGENT_NODE_SIZE as Sr, generateCodeForPrompt as St, provideWorkflowDocumentStore as T, isResourceMapperValue as Ti, importCsvToDataTableApi as Tn, DEFAULT_NODE_SIZE as Tr, replaceCode as Tt, flattenCreateElements as U, isCanvasGroupNode as Ui, getNodeCredentialForSelectedAuthType as Un, NodeId as Ur, resolveParameter as Ut, filterAndSearchNodes as V, CanvasNodeRenderType as Vi, getNodeAuthFields as Vn, updateViewportToContainNodes as Vr, stringifyExpressionResult as Vt, getAiTemplatesCallout as W, parseCanvasGroupNodeId as Wi, getNodeSubtitle as Wn, PanelPosition as Wr, resolveRequiredParameters as Wt, isNodePreviewKey as X, isAuthRelatedParameter as Xn, _sfc_main$f as Xr, ensureNodePosition as Xt, isAINode as Y, hasProxyAuth as Yn, _sfc_main$d as Yr, useTagsStore as Yt, mapToolSubcategoryIcon as Z, isMatchingField as Zn, clamp as Zr, removeWorkflowExecutionData as Zt, disposeWorkflowExecutionStateStore as _, isBinaryLike as _i, createDataTableApi as _n, mapLegacyConnectionsToCanvasConnections as _r, listenForCredentialChanges as _t, executionFilterToQueryFilter as a, useVueFlow as ai, useEnvironmentsStore as an, isCredentialOnlyNodeType as ar, subcategorizeItems as at, createExecutionPreviewDocumentId as b, isCredentialsResource as bi, deleteDataTableRowsApi as bn, shouldIgnoreCanvasShortcut as br, chatWithBuilder as bt, getDefaultExecutionFilters as c, pinDataToExecutionData as ci, splitName as cn, computeNodeDisplaySize as cr, getRagStarterWorkflowJson as ct, hasCancellableExecutions as d, hasExecutionDataStore as di, useProjectsStore as dn, createEmptyCanvasRenderData as dr, isTutorialTemplateId as dt, getConnectedEdges as ei, disposeNDVStore as en, isResourceMapperSchemaIncomplete as er, removePreviewToken as et, hasTrimmedRunData as f, useExecutionDataStore as fi, useSourceControlStore as fn, getMaxNodePortsLabelSize as fr, isFullTemplatesCollection as ft, parse as g, isBaseTextKey as gi, addDataTableColumnApi as gn, mapLegacyConnectionToCanvasConnection as gr, sublimeSearch as gt, waitingNodeTooltip as h, checkExhaustive as hi, setWorkflowSharedWith as hn, mapCanvasConnectionToLegacyConnection as hr, useAiGatewayStore as ht, displayForm as i, useGetPointerPosition as ii, LOCAL_STORAGE_NDV_PANEL_WIDTH as in, getAllCredentials as ir, sortNodeCreateElements as it, getNodeTypeDisplayableCredentials as j, isValidCredentialResponse as ji, uploadCsvFileApi as jn, generateOffsets as jr, getMappedExpression as jt, doesNodeHaveAllCredentialsFilled as k, isString as ki, updateDataTableApi as kn, calculateNodeSize as kr, useFlattenSchema as kt, getExecutionErrorMessage as l, createExecutionDataId as li, useAvailableProjectSearch as ln, createCanvasConnectionHandleString as lr, getSampleWorkflowByTemplateId as lt, unflattenExecutionData as m, getPairedItemId as mi, moveFolderToProject as mn, insertSpacersBetweenEndpoints as mr, stripToolSuffix as mt, buildExecutionResponseFromSchema as n, getSmoothStepPath as ni, injectNDVStoreIfProvided as nn, parseResourceMapperFieldName as nr, shouldShowCommunityNodeDetails as nt, executionRetryMessage as o, wheelDelta as oi, ResourceType as on, applyOffset as or, transformNodeType as ot, openFormPopupWindow as p, CHANGE_ACTION as pi, ProjectTypes as pn, injectCanvasRenderData as pr, isTemplatesWorkflow as pt, getSendAndWaitNodes as q, hasExpressionMapping as qn, _sfc_main$1 as qr, useWorkflowId as qt, clearPopupWindowState as r, isMacOs as ri, useNDVStore as rn, updateNodeAuthType as rr, showsAiGatewaySection as rt, findTriggerNodeToAutoSelect as s, getPinDataSize as si, getTruncatedProjectName as sn, checkOverlap as sr, SampleTemplates as st, useWorkflowsStore as t, getRectOfNodes as ti, injectNDVStore as tn, isValueExpression as tr, searchNodes as tt, getExecutionErrorToastConfiguration as u, disposeExecutionDataStore as ui, useRemoteProjectSearch as un, createCanvasConnectionId as ur, getTutorialTemplates as ut, injectWorkflowExecutionStateStore as v, isComponentPublicInstance as vi, deleteDataTableApi as vn, parseCanvasConnectionHandleString as vr, useCredentialsStore as vt, injectWorkflowDocumentStore as w, isProjectRole as wi, getDataTableRowsApi as wn, CONFIGURATION_NODE_SIZE as wr, getBuilderCredits as wt, createExecutionPreviewDocumentVersion as x, isDateObject as xi, downloadDataTableCsvApi as xn, injectStrict as xr, clearBuilderSession as xt, useWorkflowExecutionStateStore as y, isCredentialModalState as yi, deleteDataTableColumnApi as yn, resolveCanonicalConnection as yr, chatWithAssistant as yt, useActionsGenerator as z, CanvasConnectionMode as zi, getAuthTypeForNodeCredential as zn, getNodesWithNormalizedPosition as zr, removeExpressionPrefix as zt };
