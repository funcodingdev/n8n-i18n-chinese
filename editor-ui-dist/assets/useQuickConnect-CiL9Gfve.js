import { Ft as ref, I as h, S as computed, q as onBeforeUnmount } from "./vue.runtime.esm-bundler-C6vn67cX.js";
...
import { Ui as sanitizeHtml, kt as useCredentialsStore, yn as useProjectsStore } from "./workflows.store-yqufO0kS.js";
...
function useQuickConnect() {
	...
	async function connectToPinecone(quickConnectOption) {
		const { ConnectPopup } = await __vitePreload(async () => {
			const { ConnectPopup } = await import("./dist-CNzI_Tf-.js");
			return { ConnectPopup };
		}, []);
