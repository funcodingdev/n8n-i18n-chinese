...
import { Ft as readonly, It as ref, S as computed, gt as watch } from "./vue.runtime.esm-bundler-Bs4WIMNP.js";
import { x as useI18n } from "./_MapCache-B3VhjNx3.js";
import { Dr as isToolMessage$1, Or as isWorkflowUpdatedMessage$1, d as useMessage } from "./src-TtOAzrsZ.js";
import { u as require_lib } from "./get-BGkeQa0U.js";
import { B as useDebounceFn, y as useLocalStorage } from "./dist-CmlFwYoT.js";
import { _ as useRouter, g as useRoute } from "./htmlUtils-LDunChtE.js";
import { t as useToast } from "./useToast-9MJyC6NG.js";
import { Ct as getAiSessions, Dt as useAIAssistantHelpers, E as useWorkflowDocumentStore, Et as truncateBuilderMessages, Gt as useWorkflowHelpers, Kt as useRouteWorkflowId, L as useNodeTypesStore, S as createWorkflowDocumentId, Si as isDebouncedFunction, bt as chatWithBuilder, fn as useSourceControlStore, qt as useWorkflowId, rn as useNDVStore, t as useWorkflowsStore, w as injectWorkflowDocumentStore, wt as getBuilderCredits, xt as clearBuilderSession, y as useWorkflowExecutionStateStore } from "./workflows.store-YK4BoC2f.js";
import { i as defineStore } from "./constants-Box1qD-P.js";
import { t as STORES } from "./constants2-D6qsHKVK.js";
import { da as getResourcePermissions, di as dedupe, li as isExpression, nn as validateNodeSelectionForGrouping } from "./src-DVvN4F-B.js";
import { a as getWorkflowVersion, i as getWorkflowHistory, o as getWorkflowVersionsByIds, pn as getFirstAdoptionDate, r as getPublishTimeline, s as updateWorkflowHistoryVersion, t as useRootStore, vt as updateNpsSurveyState } from "./useRootStore-Bd5Zf8xA.js";
...
import { Li as LOCAL_STORAGE_BROWSER_NOTIFICATION_METADATA, Na as CODE_WORKFLOW_BUILDER_EXPERIMENT, Wa as FOCUSED_NODES_EXPERIMENT, di as MODAL_CANCEL, eo as MERGE_ASK_BUILD_EXPERIMENT, fi as MODAL_CLOSE, hi as NPS_SURVEY_MODAL_KEY, pi as MODAL_CONFIRM, t as AutoSaveState } from "./constants-CQOOvzhs.js";
import { c as THREE_DAYS_IN_MILLIS, o as SEVEN_DAYS_IN_MILLIS, s as SIX_MONTHS_IN_MILLIS, t as DEBOUNCE_TIME } from "./durations-CNO5pC2_.js";
import { t as VIEWS } from "./views-4JHVC4Nc.js";
import { a as BUILDER_ENABLED_VIEWS, r as useChatPanelStateStore, t as useCodeDiff } from "./useCodeDiff-Bztj_r4N.js";
...
import { g as stringSizeInBytes, v as tryToParseNumber } from "./typesUtils-DuFnSWAt.js";
import { a as getNewWorkflow, t as useWorkflowsListStore } from "./workflowsList.store-_m-V_rgE.js";
...
//#endregion
export { isVersionCardMessage as _, useWorkflowSaveStore as a, extractPlaceholderLabels as c, useFocusedNodesStore as d, createCollapsedGroupMessage as f, isPlanModeUserAnswersMessage as g, isPlanModeQuestionsMessage as h, useBackendConnectionStore as i, findPlaceholderDetails as l, isPlanModePlanMessage as m, useBrowserNotifications as n, useNpsSurveyStore as o, isCollapsedGroupMessage as p, useWorkflowSaving as r, useWorkflowHistoryStore as s, useBuilderStore as t, isPlaceholderValue as u, isWebFetchApprovalCustomMessage as v };
