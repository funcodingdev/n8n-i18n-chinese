...
import { Ft as readonly, It as ref, L as hasInjectionContext, R as inject, S as computed, gt as watch } from "./vue.runtime.esm-bundler-CiTcVoZc.js";
import { s as useI18n } from "./src-w6tdcvn4.js";
import { Fi as isToolMessage$1, Ii as isWorkflowUpdatedMessage$1, gt as useRouter, ht as useRoute } from "./src-BwN8TeVO.js";
import { t as useMessage } from "./useMessage-Bcup5rtW.js";
import { t as useToast } from "./useToast-UJviqZPo.js";
import { Fi as MODAL_CLOSE, Ii as MODAL_CONFIRM, Lu as SEVEN_DAYS_IN_MILLIS, Nu as DEBOUNCE_TIME, Pi as MODAL_CANCEL, Ri as NPS_SURVEY_MODAL_KEY, Ru as SIX_MONTHS_IN_MILLIS, Tl as getResourcePermissions, Vu as getDebounceTime, Zl as WorkflowIdKey, _c as dedupe, hc as isExpression, hu as FOCUSED_NODES_EXPERIMENT, ou as CODE_WORKFLOW_BUILDER_EXPERIMENT, sa as LOCAL_STORAGE_BROWSER_NOTIFICATION_METADATA, t as AutoSaveState, ui as VIEWS, yu as MERGE_ASK_BUILD_EXPERIMENT, zu as THREE_DAYS_IN_MILLIS } from "./constants-BiYlbN9Z.js";
import { Ct as getAiSessions, Dt as useAIAssistantHelpers, Et as truncateBuilderMessages, Gt as useWorkflowHelpers, S as useWorkflowDocumentStore, bt as chatWithBuilder, en as useNDVStore, ln as useSourceControlStore, pi as isDebouncedFunction, t as useWorkflowsStore, wt as getBuilderCredits, x as injectWorkflowDocumentStore, xt as clearBuilderSession, y as createWorkflowDocumentId } from "./workflows.store-DgZ4KSQf.js";
import { T as defineStore, h as assert, t as useRootStore } from "./useRootStore-DbgDMM5M.js";
import { Rn as STORES, a as getWorkflowVersionsByIds, en as getFirstAdoptionDate, i as getWorkflowVersion, n as getPublishTimeline, o as updateWorkflowHistoryVersion, ot as updateNpsSurveyState, r as getWorkflowHistory, t as useSettingsStore } from "./settings.store-DROe9gro.js";
import { G as useDebounceFn, _ as useLocalStorage } from "./core-BemUAWor.js";
import { f as useUIStore, g as usePostHog, p as useTelemetry } from "./users.store-CUZkGc51.js";
import { D as tryToParseNumber, T as stringSizeInBytes, a as getNewWorkflow, t as useWorkflowsListStore } from "./workflowsList.store-CHLmHbKZ.js";
...
import { a as BUILDER_ENABLED_VIEWS, r as useChatPanelStateStore, t as useCodeDiff } from "./useCodeDiff-DzRWpR7i.js";
import { n as findPlaceholderDetails, r as formatPlaceholderPath } from "./dist-C5au1DeO.js";
import { t as require_FileSaver_min } from "./FileSaver.min-CSQj3WGy.js";
import { m as useCanvasStore, t as useNodeHelpers } from "./useNodeHelpers-Bs3WVmfe.js";
...
//#endregion
export { useWorkflowSaveStore as a, useWorkflowHistoryStore as c, isCollapsedGroupMessage as d, isPlanModePlanMessage as f, isWebFetchApprovalCustomMessage as g, isVersionCardMessage as h, useBackendConnectionStore as i, useFocusedNodesStore as l, isPlanModeUserAnswersMessage as m, useBrowserNotifications as n, useWorkflowId as o, isPlanModeQuestionsMessage as p, useWorkflowSaving as r, useNpsSurveyStore as s, useBuilderStore as t, createCollapsedGroupMessage as u };
