const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/pushConnection.store-CLStRt0Q.js","assets/pushConnection.store-DwKNK0D5.js","assets/src-B2jBAc9z.js","assets/chunk-CC9Q-vWm.js","assets/preload-helper-CMc80dNB.js","assets/lib-vJcwukKE.js","assets/merge-DTabss4r.js","assets/isObject-CrVycH1n.js","assets/isSymbol-CYg_e8X3.js","assets/expression-runtime-stub-Bdm2Sgds.js","assets/__vite-browser-external-CTj19RIp.js","assets/vue.runtime.esm-bundler-DYHsQBZB.js","assets/useRootStore-B4L7-X8D.js","assets/lib-CcMDH-kD.js","assets/assert-BgZvUjbv.js","assets/settings.store-CT5GOXKB.js","assets/src-BjbSP7dI.js","assets/useDebounce-C8k0g3s4.js","assets/durations-xVQWCRRO.js"])))=>i.map(i=>d[i]);
...
import { A as useWorkflowDocumentStore, Et as useCredentialsStore, T as createWorkflowDocumentId, Xr as getNodesWithNormalizedPosition, bn as useProjectsStore, n as buildExecutionResponseFromSchema, t as useWorkflowsStore, y as useWorkflowExecutionStateStore } from "./workflows.store-BO9owX3m.js";
...
import { t as isPostMessageOriginAllowed } from "./postMessageUtils-Bw56H_RX.js";
		...
		try {
			...
			if (json && json.command === "openWorkflow") try {
				...
				const { usePushConnectionStore } = await __vitePreload(async () => {
					const { usePushConnectionStore } = await import("./pushConnection.store-CLStRt0Q.js");
