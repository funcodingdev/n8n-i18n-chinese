...
import { $ as openBlock, A as createTextVNode, C as createBaseVNode, Cn as toDisplayString, E as createElementBlock, Gt as unref, I as h, It as ref, N as defineComponent, R as inject, S as computed, T as createCommentVNode, U as mergeProps, W as nextTick, _ as Fragment, bt as withCtx, it as renderSlot, j as createVNode, jt as isRef, rt as renderList, st as resolveDynamicComponent, vn as normalizeClass, w as createBlock, zt as shallowRef } from "./vue.runtime.esm-bundler-CDDUUZhE.js";
import { s as useI18n$1 } from "./src-Dh32dOY5.js";
import { Bi as require_markdown_it_link_attributes, _t as useRouter, gt as useRoute } from "./src-BVC_ZvSs.js";
import { t as _plugin_vue_export_helper_default } from "./_plugin-vue_export-helper-Da88TEg1.js";
import { c as useClipboard, v as useLocalStorage } from "./core-DOUvgShw.js";
import { t as useToast } from "./useToast-CsW2zDDU.js";
import { Bu as NDV_IN_FOCUS_PANEL_EXPERIMENT, Ca as LOCAL_STORAGE_LOGS_PANEL_DETAILS_PANEL_SUB_NODE, Cn as MANUAL_CHAT_TRIGGER_NODE_TYPE, Cu as CANVAS_ZOOMED_VIEW_EXPERIMENT, Ec as NodeConnectionTypes, El as v4, Fc as isObjectEmpty, Js as getNodeOutputs, Ks as getConnectionTypes, Lt as CHAT_TRIGGER_NODE_TYPE, Nc as deepCopy, Pc as isCommunityPackageName, Sa as LOCAL_STORAGE_LOGS_PANEL_DETAILS_PANEL, Su as CANVAS_NODES_GROUPING_EXPERIMENT, Ta as LOCAL_STORAGE_LOGS_SYNC_SELECTION, Us as generateNodesGraph, Ys as getNodeParameters, Zu as EnterpriseEditionFeature, _s as validateNodeSelectionForGrouping, ec as getSubworkflowId, gs as validateNodeSelectionForExtraction, hr as UPDATE_WEBHOOK_ID_NODE_TYPES, ic as isHitlToolType, lr as STICKY_NODE_TYPE, pc as resolveNodeWebhookId, ps as require_cloneDeep, qs as getNodeInputs, ui as VIEWS, wa as LOCAL_STORAGE_LOGS_PANEL_OPEN } from "./constants-DzzWpyjZ.js";
import { Ar as CONFIGURABLE_NODE_SIZE, Cr as mapCanvasConnectionToLegacyConnection, Er as parseCanvasConnectionHandleString, Ft as useTagsStore, Gi as pinDataToExecutionData, Hr as getNewNodePosition, Ir as doRectsOverlap, It as ensureNodePosition, Kt as useWorkflowExecutionStateStore, L as removePreviewToken, Li as CanvasConnectionMode, Lr as generateOffsets, Mr as DEFAULT_NODE_SIZE, Nr as DEFAULT_VIEWPORT_BOUNDARIES, Pr as PUSH_NODES_OFFSET, Rt as sanitizeConnections, Tr as mapLegacyConnectionsToCanvasConnections, Ut as useNDVStore, Wr as getNodesGroupSize, Wt as disposeWorkflowExecutionStateStore, _ as useNodeTypesStore, _r as createCanvasConnectionHandleString, a as injectWorkflowDocumentStore, bn as useProjectsStore, g as require_uniq, h as serializeNode, it as useCredentialsStore, jr as CONFIGURATION_NODE_SIZE, jt as useWorkflowHelpers, ki as isValidNodeConnectionType, mt as useDataSchema, r as createWorkflowDocumentId, s as useWorkflowDocumentStore, sn as useWorkflowsStore, tn as getExecutionErrorToastConfiguration, wr as mapLegacyConnectionToCanvasConnection, zi as CanvasNodeRenderType } from "./workflowDocument.store-BQc6YDGi.js";
...
import { f as useUIStore, g as usePostHog, p as useTelemetry } from "./users.store-CUxYM5yQ.js";
import { O as tryToParseNumber, S as isPresent, o as getNewWorkflowData } from "./workflowsList.store-DBU92DSv.js";
import { t as useExternalHooks } from "./useExternalHooks-CBXTR0kh.js";
import { t as useBuilderStore } from "./builder.store-DR2iv2rX.js";
import { _ as useCanvasStore, a as AddNodeGroupCommand, d as RemoveNodeCommand, f as RemoveNodeGroupCommand, h as UpdateNodeGroupCommand, i as AddNodeCommand, l as MoveNodeCommand, m as ReplaceNodeParametersCommand, n as useHistoryStore, p as RenameNodeCommand, r as AddConnectionCommand, t as useNodeHelpers, u as RemoveConnectionCommand } from "./useNodeHelpers-BmWmEgTM.js";
...
import { t as clearAllNodeResourceLocatorValues } from "./templateTransforms-BmnbHoZ4.js";
