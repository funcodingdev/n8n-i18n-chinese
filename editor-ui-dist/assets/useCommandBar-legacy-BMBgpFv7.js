;
(function () {
  System.register(["./chunk-legacy-Re9CbdfL.js", "./vue.runtime.esm-bundler-legacy--Sn1h8On.js", "./_MapCache-legacy-BlV_W1LO.js", "./src-legacy-B7xKFZYj.js", "./_plugin-vue_export-helper-legacy-DZMI5HPp.js", "./truncate-legacy-DWqu3mV5.js", "./useMessage-legacy-C_GChh01.js", "./useTelemetry-legacy-Dj2fHQys.js", "./useToast-legacy-B2w_7aSU.js", "./constants-legacy-wGNoFUi7.js", "./_baseOrderBy-legacy-DE6my_G3.js", "./useDebounce-legacy-BLTSWKm9.js", "./useWorkflowSaving-legacy-Ce-42Lc-.js", "./executions.store-legacy-B_20xRRf.js", "./useRunWorkflow-legacy-eQxzT9gd.js", "./useCanvasOperations-legacy-g8dW3-x3.js", "./folders.store-legacy-DhCwnoHA.js", "./NodeIcon-legacy-2D3b9ZNP.js", "./dataTable.store-legacy-BZYpzqDG.js", "./useBugReporting-legacy-_kz49vKZ.js", "./uniqBy-legacy-WQNqnNRo.js", "./ProjectIcon-legacy-D3kYlpWu.js", "./CredentialIcon-legacy-AURg1sVE.js", "./FileSaver.min-legacy-D7uxxng5.js", "./useRecentResources-legacy-B34qK0VW.js", "./useWorkflowActivate-legacy-a4zbNRHY.js"], function (_export, _context) {
    "use strict";

    var __toESM, computed, toDisplayString, createElementBlock, createCommentVNode, unref, ref, createVNode, defineComponent, createBlock, openBlock, createTextVNode, normalizeClass, createBaseVNode, useI18n, N8nIcon_default, N8nKeyboardShortcut_default, __plugin_vue_export_helper_default, useRouter, useRoute, useMessage, useSourceControlStore, useProjectsStore, useUIStore, useSettingsStore, useCredentialsStore, nodeViewEventBus, ProjectTypes, executionRetryMessage, useTagsStore, useNodeTypesStore, usePostHog, useWorkflowHelpers, useWorkflowsStore, useActionsGenerator, useTelemetry, useToast, MODAL_CONFIRM, COMMAND_BAR_EXPERIMENT, ABOUT_MODAL_KEY, DATA_TABLE_VIEW, IMPORT_WORKFLOW_URL_MODAL_KEY, PROJECT_DATA_TABLES, VIEWS, getResourcePermissions, DUPLICATE_MODAL_KEY, isResourceLocatorValue, EnterpriseEditionFeature, DATA_TABLE_DETAILS, EXECUTE_WORKFLOW_NODE_TYPE, WORKFLOW_SETTINGS_MODAL_KEY, WHATS_NEW_MODAL_KEY, useRootStore, require_debounce, useWorkflowSaving, useExecutionsStore, useRunWorkflow, canvasEventBus, useCanvasOperations, useFoldersStore, NodeIcon_default, useDataTableStore, EXTERNAL_LINKS, useGlobalEntityCreation, useBugReporting, require_uniqBy, isIconOrEmoji, ProjectIcon_default, CredentialIcon_default, require_FileSaver_min, useRecentResources, useWorkflowActivate, __vite_style__, CommandBarItemTitle_vue_vue_type_script_setup_true_lang_default, container, title, suffix, action, shortcut, CommandBarItemTitle_vue_vue_type_style_index_0_lang_module_default, cssModules, CommandBarItemTitle_default, ITEM_ID$7, import_FileSaver_min, import_uniqBy, ITEM_ID$6, import_debounce$2, ITEM_ID$5, import_debounce$1, ITEM_ID$4, import_debounce, ITEM_ID$3, ITEM_ID$2, ITEM_ID$1, ITEM_ID;
    ...
    return {
      setters: [function (_chunkLegacy001Js) {
        ...
        COMMAND_BAR_EXPERIMENT = _constantsLegacy00TJs.$s;
        ...
        EXECUTE_WORKFLOW_NODE_TYPE = _constantsLegacy00TJs.on;
