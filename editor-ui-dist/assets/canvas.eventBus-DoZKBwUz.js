...
import { Ft as createEventBus } from "./src-C2myqZYv.js";
import { a as require_toString, o as require__arrayMap, t as require_get } from "./get-BXEQ0kDX.js";
import { $ as AI_CATEGORY_OUTPUTPARSER, $l as EVALUATION_TRIGGER_NODE_TYPE, $n as SCHEDULE_TRIGGER_NODE_TYPE, $t as EMAIL_IMAP_NODE_TYPE, At as AI_MCP_TOOL_NODE_TYPE, Bt as CODE_NODE_TYPE, Ct as TEMPLATE_CATEGORY_AI, En as MARKDOWN_NODE_TYPE, G as AI_CATEGORY_CHAINS, Ht as CONVERT_TO_FILE_NODE_TYPE, Jt as DATA_TABLE_NODE_TYPE, K as AI_CATEGORY_DOCUMENT_LOADERS, Kt as CRYPTO_NODE_TYPE, Ol as isCommunityPackageName, On as MERGE_NODE_TYPE, Os as require__createCompounder, Ot as AGGREGATE_NODE_TYPE, Q as AI_CATEGORY_OTHER_TOOLS, Qc as isHitlToolType, Rt as CHAT_TRIGGER_NODE_TYPE, Sn as LIMIT_NODE_TYPE, Tn as MANUAL_TRIGGER_NODE_TYPE, Tt as TRIGGER_NODE_CREATOR_VIEW, Us as require__arrayIncludesWith, Vc as getNodeInputs, Vt as COMPRESSION_NODE_TYPE, W as AI_CATEGORY_AGENTS, Ws as require__arrayIncludes, X as AI_CATEGORY_MCP_NODES, Y as AI_CATEGORY_LANGUAGE_MODELS, Yn as REMOVE_DUPLICATES_NODE_TYPE, Yt as DATETIME_NODE_TYPE, Z as AI_CATEGORY_MEMORY, Zn as RSS_READ_NODE_TYPE, Zt as EDIT_IMAGE_NODE_TYPE, _t as NEW_TOOL_CATEGORIES, an as EXECUTE_WORKFLOW_TRIGGER_NODE_TYPE, at as AI_CODE_TOOL_LANGCHAIN_NODE_TYPE, bl as NodeConnectionTypes, cr as SPLIT_OUT_NODE_TYPE, dr as SUMMARIZE_NODE_TYPE, en as EMAIL_SEND_NODE_TYPE, et as AI_CATEGORY_RETRIEVERS, fn as HTML_NODE_TYPE, ft as CORE_NODES_CATEGORY, fu as v4, gn as IF_NODE_TYPE, gt as HUMAN_IN_THE_LOOP_CATEGORY, hs as require__baseFlatten, ht as HITL_SUBCATEGORY, it as AI_CATEGORY_VECTOR_STORES, jt as AI_TRANSFORM_NODE_TYPE, kn as MESSAGE_AN_AGENT_NODE_TYPE, ln as FORM_TRIGGER_NODE_TYPE, lt as AI_UNCATEGORIZED_CATEGORY, mt as HELPERS_SUBCATEGORY, nr as SET_NODE_TYPE, nt as AI_CATEGORY_TEXT_SPLITTERS, on as EXTRACT_FROM_FILE_NODE_TYPE, pn as HTTP_REQUEST_NODE_TYPE, pt as FLOWS_CONTROL_SUBCATEGORY, q as AI_CATEGORY_EMBEDDING, rt as AI_CATEGORY_TOOLS, sn as FILTER_NODE_TYPE, sr as SPLIT_IN_BATCHES_NODE_TYPE, st as AI_OTHERS_NODE_CREATOR_VIEW, tt as AI_CATEGORY_ROOT_NODES, ut as AI_WORKFLOW_TOOL_LANGCHAIN_NODE_TYPE, vr as WEBHOOK_NODE_TYPE, vt as NODE_CREATOR_OPEN_SOURCES, vu as require__cacheHas, wr as XML_NODE_TYPE, wt as TRANSFORM_DATA_SUBCATEGORY, xt as REGULAR_NODE_CREATOR_VIEW, yt as OTHER_TRIGGER_NODES_SUBCATEGORY, yu as require__SetCache } from "./constants-CSBjw1Ht.js";
import { E as require__baseUnary, d as require_isArrayLikeObject, r as require__baseRest } from "./merge-CFboPyjf.js";
import { $ as useAiGatewayStore, B as searchNodes, Cr as createCanvasConnectionHandleString, D as finalizeItems, Ft as useRouteWorkflowId, G as transformNodeType, H as showsAiGatewaySection, Hi as CanvasConnectionMode, I as mapToolSubcategoryIcon, Kt as useNDVStore, L as nodeTypesToCreateElements, Li as isVueFlowConnection, M as getSendAndWaitNodes, Mr as parseCanvasConnectionHandleString, N as groupItemsInSections, O as flattenCreateElements, P as isAINode, R as prepareCommunityNodeDetailsViewStack, T as extractAiGatewaySection, U as sortNodeCreateElements, W as subcategorizeItems, _ as useNodeTypesStore, a as injectWorkflowDocumentStore, b as useEvaluationStore, ir as getThemedValue, it as require_upperFirst, k as getAiTemplatesCallout, r as createWorkflowDocumentId, s as useWorkflowDocumentStore } from "./workflowDocument.store-COBWkqWz.js";
...
import { n as getNodeIconSource } from "./nodeIcon-D1tODook.js";
import { t as _virtual_node_popularity_data_default } from "./_virtual_node-popularity-data-CPZAcP99.js";
