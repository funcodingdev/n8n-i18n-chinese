const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/workers-B9vbtbmy.js","assets/comlink-DOsuzdet.js"])))=>i.map(i=>d[i]);
...
import { i as i18n, n as addHeaders, r as addNodeTranslation, s as useI18n } from "./src-WRlVBeQs.js";
import { t as __vitePreload } from "./preload-helper-CMc80dNB.js";
import { M as createEventHook, R as throttledWatch, y as useLocalStorage } from "./dist-BKkqSB6h.js";
...
import { Br as getNodeParameters, Ci as isExpression, Cr as getChildNodes, Ea as getResourcePermissions, Ei as deepCopy, Fr as displayParameterPath, Ft as isAssignmentCollectionValue, Gn as createEmptyRunExecutionData, Hr as getNodeWebhookUrl, Ir as getActiveCredentialTypes, Ji as CHAT_TRIGGER_NODE_TYPE, Jt as require__baseIteratee, Kn as createRunExecutionData, Li as ExpressionError, Lr as getConnectionTypes, Nr as checkConditions, Oo as require_get, Pi as sleep$1, Pn as isTrimmedNodeExecutionData, Po as require_memoize, Pr as displayParameter, Rr as getNodeInputs, Rt as normalizeNodeShape, Si as traverseNodeParameters, Vt as Workflow, Yr as isHitlToolType, _i as isResourceMapperValue$1, bi as nodeConnectionTypes, br as resolveVariables, cn as require__baseUniq, dn as require__baseFindIndex, fa as WAIT_INDEFINITELY, ga as require_isEqual, gi as isResourceLocatorValue, kt as require_pick, li as isFilterValue, ma as v4, nn as normalizeGroupDescription, ri as nodeIssuesToString, sa as MANUAL_TRIGGER_NODE_TYPE, sn as splitExpression, ua as SEND_AND_WAIT_OPERATION, va as require_keys, xr as mapConnectionsByDestination, yi as NodeConnectionTypes, zi as UnexpectedError, zr as getNodeOutputs } from "./src-B255AdRt.js";
import { c as sanitizeHtml } from "./htmlUtils-CZzL9YQk.js";
import { Ct as getNodeParameterActionResult, Dt as getNodesInformation, Et as getNodeTypes$1, Ot as getResourceLocatorResults, Qn as makeRestApiRequest, St as getLocalResourceMapperFields, Tt as getNodeTranslationHeaders, Yn as ResponseError, Zn as getFullApiResponse, a as getWorkflowVersion, ar as STORES, bt as fetchCommunityNodeAttributes, c as findWebhook, cr as defineStore, ir as axios, kt as getResourceMapperFields, lr as getActivePinia, nr as streamRequest, qt as getProjectSecretProviderConnectionsByProjectId, t as useRootStore, w as updateCurrentUserSettings, wt as getNodeParameterOptions, xt as fetchCommunityNodeTypes } from "./useRootStore-CLEJA2KF.js";
...
import { D as TEMPLATES_NODES_FILTER, Dt as AI_MCP_TOOL_NODE_TYPE, F as CUSTOM_API_CALL_KEY, G as AI_CATEGORY_HUMAN_IN_THE_LOOP, I as DATA_TYPE_ICON_MAP, Jt as ERROR_TRIGGER_NODE_TYPE$1, M as IN_PROGRESS_EXECUTION_ID, Ma as INLINE_AGENTS_EXPERIMENT, N as PLACEHOLDER_FILLED_AT_EXECUTION_TIME, Ot as AI_TRANSFORM_NODE_TYPE, Pn as SCHEDULE_TRIGGER_NODE_TYPE, R as MAPPING_PARAMS, Rr as MAIN_HEADER_TABS, Rt as CREDENTIAL_ONLY_NODE_PREFIX, V as AI_CATEGORY_AGENTS, Xn as WIKIPEDIA_TOOL_NODE_TYPE, Y as AI_CATEGORY_OTHER_TOOLS, Yn as WEBHOOK_NODE_TYPE$1, Zn as WORKFLOW_TRIGGER_NODE_TYPE, _n as MODULE_ENABLED_NODES, _t as RECOMMENDED_NODES, ct as BETA_NODES, ft as HITL_SUBCATEGORY, ga as WorkflowIdKey, ha as WorkflowDocumentStoreKey, hn as MESSAGE_AN_AGENT_NODE_TYPE, i as DUPLICATE_POSTFFIX, ln as LIST_LIKE_NODE_OPERATIONS, lt as CORE_NODES_CATEGORY, no as EnterpriseEditionFeature, nt as AI_CODE_TOOL_LANGCHAIN_NODE_TYPE, oa as CanvasRenderDataKey, pt as HUMAN_IN_THE_LOOP_CATEGORY, q as AI_CATEGORY_MCP_NODES, r as DEFAULT_SETTINGS, rn as HTTP_REQUEST_NODE_TYPE, tn as FORM_TRIGGER_NODE_TYPE$1, tt as AI_CATEGORY_VECTOR_STORES, xn as NON_ACTIVATABLE_TRIGGER_NODE_TYPES, yn as NODE_POSITION_CONFLICT_ALLOWLIST } from "./constants-CMdL1Kzl.js";
import "./durations-xVQWCRRO.js";
import { i as require_toNumber } from "./useDebounce-BffpVo23.js";
import { c as isEmpty, d as isPresent, h as stringSizeInBytes, m as shorten, p as omit, u as isJsonKeyObject, v as getObjectSizeInKB, y as isObject$1 } from "./typesUtils-XxdBySCt.js";
import { a as getNewWorkflow, i as getLastSuccessfulExecution, l as getWorkflows, n as useFavoritesStore, r as getExecutionData, t as useWorkflowsListStore } from "./workflowsList.store-y-0nsqzo.js";
import { S as CANCELLABLE_EXECUTION_STATUSES, n as useUIStore } from "./ui.store-CxHz_b7L.js";
import { c as hasRole, t as hasPermission } from "./permissions-CiXODvgm.js";
import { o as require_startCase, t as useEvaluationStore } from "./evaluation.store-BxdOio19.js";
	...
	const loadNodesInformationFromLocalDb = async (nodeInfos) => {
		try {
			const { getNodeType } = await __vitePreload(async () => {
				const { getNodeType } = await import("./workers-B9vbtbmy.js");
				return { getNodeType };
			}, __vite__mapDeps([0,1]));
			const found = [];
			const missing = [];
	...
	const loadNodeTypesFromLocalDb = async () => {
		try {
			const { loadNodeTypes, getAllNodeTypes } = await __vitePreload(async () => {
				const { loadNodeTypes, getAllNodeTypes } = await import("./workers-B9vbtbmy.js");
				return {
					loadNodeTypes,
					getAllNodeTypes
				};
...
function useWorkflowDocumentStore(id) {
	return defineStore(getWorkflowDocumentStoreId(id), () => {
		...
		function hydrate(workflow) {
			...
			const homeProject = workflow.homeProject ?? workflow.shared?.find((share) => share.role === "workflow:owner")?.project ?? null;
...
//#endregion
export { isAINode as $, parseCanvasGroupNodeId as $i, getThemedValue as $n, PanelPosition as $r, useRouteWorkflowId as $t, TOOL_NODE_TYPES_NEED_INPUT as A, isDateObject as Ai, fetchDataTablesApi as An, injectStrict as Ar, getBuilderCredits as At, isAgentNodeV2 as B, isValidCredentialResponse as Bi, fieldCannotBeDeleted as Bn, generateOffsets as Br, completeExpressionSyntax as Bt, createExecutionPreviewDocumentId as C, getPairedItemId as Ci, addDataTableColumnApi as Cn, insertSpacersBetweenEndpoints as Cr, listenForCredentialChanges as Ct, injectWorkflowDocumentStore as D, isComponentPublicInstance as Di, deleteDataTableRowsApi as Dn, parseCanvasConnectionHandleString as Dr, clearBuilderSession as Dt, disposeWorkflowDocumentStore as E, isBinaryLike as Ei, deleteDataTableColumnApi as En, mapLegacyConnectionsToCanvasConnections as Er, chatWithBuilder as Et, getParameterDisplayableOptions as F, isResourceSortableByDate as Fi, renameDataTableColumnApi as Fn, DEFAULT_VIEWPORT_BOUNDARIES as Fr, useFlattenSchema as Ft, filterAndSearchNodes as G, CANVAS_NODE_GROUP_HANDLE_LEFT as Gi, getAppNameFromNodeName as Gn, getNewNodePosition as Gr, isTestableExpression as Gt, isDataWorkerEnabled as H, isVariableResource as Hi, getActivatableTriggerNodes as Hn, getGenericHints as Hr, getExternalSecretPreview as Ht, needsAgentInput as I, isRouteLocationRaw as Ii, updateDataTableApi as In, HORIZONTAL_NODE_STEP as Ir, escapeMappingString as It, getAiTemplatesCallout as J, CanvasConnectionMode as Ji, getMainAuthField as Jn, getNodesWithNormalizedPosition as Jr, stringifyExpressionResult as Jt, finalizeItems as K, CANVAS_NODE_GROUP_HANDLE_RIGHT as Ki, getAuthTypeForNodeCredential as Kn, getNodeViewTab as Kr, removeExpressionPrefix as Kt, serializeNode as L, isSharedResource as Li, updateDataTableRowsApi as Ln, PUSH_NODES_OFFSET as Lr, getMappedExpression as Lt, doesNodeHaveAllCredentialsFilled as M, isFullExecutionResponse as Mi, importCsvToDataTableApi as Mn, CONFIGURABLE_NODE_SIZE as Mr, truncateBuilderMessages as Mt, doesNodeHaveCredentialsToFill as N, isProjectRole as Ni, insertDataTableRowApi as Nn, CONFIGURATION_NODE_SIZE as Nr, useAIAssistantHelpers as Nt, provideWorkflowDocumentStore as O, isCredentialModalState as Oi, downloadDataTableCsvApi as On, resolveCanonicalConnection as Or, generateCodeForPrompt as Ot, getNodeTypeDisplayableCredentials as P, isResourceMapperValue as Pi, moveDataTableColumnApi as Pn, DEFAULT_NODE_SIZE as Pr, useDataSchema as Pt, groupItemsInSections as Q, isCanvasGroupNode as Qi, getNodeSubtitle as Qn, NodeId as Qr, useWorkflowHelpers as Qt, useEnvFeatureFlag as R, isString as Ri, uploadCsvFileApi as Rn, calculateNodeSize as Rr, getMappedResult as Rt, toolActivityKey as S, CHANGE_ACTION as Si, setWorkflowSharedWith as Sn, injectCanvasRenderData as Sr, sublimeSearch as St, createWorkflowDocumentId as T, isBaseTextKey as Ti, deleteDataTableApi as Tn, mapLegacyConnectionToCanvasConnection as Tr, chatWithAssistant as Tt, useActionsGenerator as U, isVueFlowConnection as Ui, getAllNodeCredentialForAuthType as Un, getMidCanvasPosition as Ur, getResolvableState as Ut, useNodeTypesStore as V, isValidNodeConnectionType as Vi, filterTemplateNodes as Vn, getBounds as Vr, getExpressionErrorMessage as Vt, extractAiGatewaySection as W, isWorkflowListItem as Wi, getAppNameFromCredType as Wn, getMousePosition as Wr, isPairedItemIntermediateNodesError as Wt, getRootSearchCallouts as X, CanvasNodeRenderType as Xi, getNodeAuthOptions as Xn, updateViewportToContainNodes as Xr, resolveParameter as Xt, getHumanInTheLoopActions as Y, CanvasNodeDirtiness as Yi, getNodeAuthFields as Yn, snapPositionToGridByCenter as Yr, unwrapExpression as Yt, getSendAndWaitNodes as Z, createCanvasGroupNodeId as Zi, getNodeCredentialForSelectedAuthType as Zn, MarkerType as Zr, resolveRequiredParameters as Zt, disposeWorkflowExecutionStateStore as _, pinDataToExecutionData as _i, useRemoteProjectSearch as _n, computeNodeDisplaySize as _r, isTemplatesWorkflow as _t, executionFilterToQueryFilter as a, _sfc_main$f as ai, sanitizeConnections as an, isMatchingField as ar, searchNodes as at, skillIdActivityKey as b, hasExecutionDataStore as bi, ProjectTypes as bn, createEmptyCanvasRenderData as br, stripToolSuffix as bt, getDefaultExecutionFilters as c, getBoundsofRects as ci, injectNDVStore as cn, isResourceMapperSchemaIncomplete as cr, sortNodeCreateElements as ct, hasCancellableExecutions as d, getSmoothStepPath as di, LOCAL_STORAGE_NDV_PANEL_WIDTH as dn, updateNodeAuthType as dr, SampleTemplates as dt, structuralComputed as ea, Position as ei, useWorkflowId as en, getTriggerNodeServiceName as er, isNodePreviewKey as et, hasTrimmedRunData as f, isMacOs as fi, useEnvironmentsStore as fn, getAllCredentials as fr, getRagStarterWorkflowJson as ft, parse as g, getPinDataSize as gi, useAvailableProjectSearch as gn, checkOverlap as gr, isFullTemplatesCollection as gt, waitingNodeTooltip as h, wheelDelta as hi, splitName as hn, applyOffset as hr, isTutorialTemplateId as ht, displayForm as i, _sfc_main$d as ii, removeWorkflowExecutionData as in, isAuthRelatedParameter as ir, removePreviewToken as it, assignNodeId as j, isDebouncedFunction as ji, getDataTableRowsApi as jn, AGENT_NODE_SIZE as jr, replaceCode as jt, useWorkflowDocumentStore as k, isCredentialsResource as ki, fetchDataTableGlobalLimitInBytes as kn, shouldIgnoreCanvasShortcut as kr, getAiSessions as kt, getExecutionErrorMessage as l, getConnectedEdges as li, injectNDVStoreIfProvided as ln, isValueExpression as lr, subcategorizeItems as lt, unflattenExecutionData as m, useVueFlow as mi, getTruncatedProjectName as mn, isCredentialOnlyNodeType as mr, getTutorialTemplates as mt, buildExecutionResponseFromSchema as n, _sfc_main$1 as ni, useTagsStore as nn, hasOnlyListMode as nr, nodeTypesToCreateElements as nt, executionRetryMessage as o, clamp as oi, sortNodesByExecutionOrder as on, isRequiredCredential as or, shouldShowCommunityNodeDetails as ot, openFormPopupWindow as p, useGetPointerPosition as pi, ResourceType as pn, probeCredential as pr, getSampleWorkflowByTemplateId as pt, flattenCreateElements as q, CANVAS_NODE_GROUP_TYPE as qi, getInactiveCredentials as qn, getNodesGroupSize as qr, shouldConvertToExpression as qt, clearPopupWindowState as r, _sfc_main$3 as ri, ensureNodePosition as rn, hasProxyAuth as rr, prepareCommunityNodeDetailsViewStack as rt, findTriggerNodeToAutoSelect as s, getBezierPath as si, disposeNDVStore as sn, isResourceMapperFieldListStale as sr, showsAiGatewaySection as st, useWorkflowsStore as t, isBinary as ta, _sfc_main as ti, useAnnotationTagsStore as tn, hasExpressionMapping as tr, mapToolSubcategoryIcon as tt, getExecutionErrorToastConfiguration as u, getRectOfNodes as ui, useNDVStore as un, parseResourceMapperFieldName as ur, transformNodeType as ut, injectWorkflowExecutionStateStore as v, createExecutionDataId as vi, useProjectsStore as vn, createCanvasConnectionHandleString as vr, getN8nAgentsNodeName as vt, createExecutionPreviewDocumentVersion as w, checkExhaustive as wi, createDataTableApi as wn, mapCanvasConnectionToLegacyConnection as wr, useCredentialsStore as wt, skillNameActivityKey as x, useExecutionDataStore as xi, moveFolderToProject as xn, getMaxNodePortsLabelSize as xr, useAiGatewayStore as xt, useWorkflowExecutionStateStore as y, disposeExecutionDataStore as yi, useSourceControlStore as yn, createCanvasConnectionId as yr, useInlineAgentsExperiment as yt, require_uniq as z, isTriggerPanelObject as zi, executionDataToJson as zn, doRectsOverlap as zr, propertyNameFromExpression as zt };
