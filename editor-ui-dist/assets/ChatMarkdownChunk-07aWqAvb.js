const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/es-D0Qhpysy.js","assets/chunk-CC9Q-vWm.js","assets/core-DettzGq-.js","assets/languageModules-BL_LRfwI.js","assets/xml-AqPLxZQZ.js","assets/json-BTFwBmHt.js"])))=>i.map(i=>d[i]);
	...
	async function loadLanguageModules() {
		...
		try {
			const promise = Promise.all([__vitePreload(async () => {
				const { default: highlight } = await import("./es-D0Qhpysy.js");
				return { default: highlight };
			}, __vite__mapDeps([0,1,2])).then(({ default: highlight }) => highlight), __vitePreload(() => import("./languageModules-BL_LRfwI.js"), __vite__mapDeps([3,4,5]))]);
			asyncImport = {
				status: "inProgress",
				promise
			};
