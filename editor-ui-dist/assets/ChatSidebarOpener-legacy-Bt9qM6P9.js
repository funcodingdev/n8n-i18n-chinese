;
(function () {
  System.register(["./vue.runtime.esm-bundler-legacy--Sn1h8On.js", "./_MapCache-legacy-09dJkOZ7.js", "./src-legacy-kYXKbxwf.js", "./_plugin-vue_export-helper-legacy-DZMI5HPp.js", "./truncate-legacy-SNFKvoUa.js", "./useTelemetry-legacy-CHWpGzCE.js", "./constants-legacy--QTy-QJy.js", "./constants-legacy-DjFSod4r.js", "./chat.store-legacy-BKrwO5Kx.js", "./useChatHubSidebarState-legacy-gqvp5jrb.js"], function (_export, _context) {
    "use strict";

    var computed, createElementBlock, createCommentVNode, unref, ref, defineComponent, createBlock, watch, renderSlot, openBlock, normalizeClass, useEventListener, useMediaQuery, useI18n, useLocalStorage, useDeviceSupport, N8nIconButton_default, __plugin_vue_export_helper_default, useRouter, useProjectsStore, useUIStore, useSettingsStore, useCredentialsStore, chatHubConversationModelSchema, recordType, nullType, PROVIDER_CREDENTIAL_TYPE_MAP, LOCAL_STORAGE_CHAT_HUB_CREDENTIALS, stringType, objectType, chatHubProviderSchema, CHAT_VIEW, MOBILE_MEDIA_QUERY, isLlmProvider, isLlmProviderModel, useChatHubSidebarState, __vite_style__, credentialsMapSchema, chatHubConversationModelWithCachedDisplayNameSchema, ChatLayout_vue_vue_type_script_setup_true_lang_default, component, isMobileDevice, ChatLayout_vue_vue_type_style_index_0_lang_module_default, cssModules, ChatLayout_default, ChatSidebarOpener_vue_vue_type_script_setup_true_lang_default, ChatSidebarOpener_default;
    //#endregion
    ...
    */
    ...
    return {
      setters: [function (_vueRuntimeEsmBundlerLegacy003Js) {
        ...
        chatHubConversationModelSchema = _constantsLegacy00TJs.$r;
        recordType = _constantsLegacy00TJs.Ao;
        nullType = _constantsLegacy00TJs.Oo;
        PROVIDER_CREDENTIAL_TYPE_MAP = _constantsLegacy00TJs.Qr;
        LOCAL_STORAGE_CHAT_HUB_CREDENTIALS = _constantsLegacy00TJs.gs;
        stringType = _constantsLegacy00TJs.jo;
        objectType = _constantsLegacy00TJs.ko;
        chatHubProviderSchema = _constantsLegacy00TJs.ti;
