...
import { C as computed, Cn as toDisplayString, D as createElementBlock, E as createCommentVNode, Gt as unref, It as ref, J as onBeforeUnmount, M as createVNode, Nt as onScopeDispose, P as defineComponent, T as createBlock, Z as onMounted, _ as Fragment, _t as watch, at as renderSlot, bn as normalizeStyle, bt as withCtx, et as openBlock, h as withModifiers, it as renderList, j as createTextVNode, k as createSlots, mt as useTemplateRef, ot as resolveComponent, p as vShow, vn as normalizeClass, w as createBaseVNode, xt as withDirectives } from "./vue.runtime.esm-bundler-XtMkEjzB.js";
import { yt as useI18n } from "./_MapCache-Dai8_t5K.js";
import { At as N8nLink_default, Bi as N8nButton_default, Hi as N8nIcon_default, Ht as N8nTooltip_default, Li as N8nHeading_default, Lt as useRoute, Mi as N8nActionBox_default, O as N8nTags_default, Ri as N8nCallout_default, Rt as useRouter, Tt as N8nBadge_default, Y as N8nInfoTip_default, Yt as createEventBus, at as Checkbox_default, bt as N8nActionToggle_default, dt as N8nOption_default, ht as N8nCard_default, it as N8nInputLabel_default, l as N8nInlineTextEdit_default, ut as N8nSelect_default, x as N8nBreadcrumbs_default, xt as N8nLoading_default, zi as N8nText_default } from "./src-CWDygSR1.js";
import { t as __plugin_vue_export_helper_default } from "./_plugin-vue_export-helper-DltO58Gh.js";
import "./sanitize-html-DjneYy0u.js";
import { C as useNodeTypesStore, Da as FOLDER_NAME_MAX_LENGTH, Ea as FOLDER_NAME_ILLEGAL_CHARACTERS_REGEX, Er as usePostHog, Fa as COMMUNITY_PLUS_ENROLLMENT_MODAL, Ht as ProjectTypes, Mr as useStorage, Nt as useTelemetry, Oa as FOLDER_NAME_ONLY_DOTS_REGEX, Ot as useTagsStore, Ta as FOLDER_LIST_ITEM_ACTIONS, Vt as useProjectsStore, br as useSourceControlStore, cn as useDocumentTitle, fs as useSettingsStore, gn as useTemplatesStore, hi as ResourceType, hr as useToast, ir as useCloudPlanStore, ka as ILLEGAL_FOLDER_CHARACTERS, r as useUIStore, s as useWorkflowsStore, t as useUsersStore, xa as PROJECT_MOVE_RESOURCE_MODAL, xc as STORES, xr as useMessage } from "./users.store-w97vXh5N.js";
import { Bo as getResourcePermissions, La as jsonParse, Mc as EnterpriseEditionFeature, Ps as WORKFLOW_SHARE_MODAL_KEY, Us as LOCAL_STORAGE_EXPERIMENTAL_DISMISSED_SUGGESTED_WORKFLOWS, Xo as VIEWS, as as EXPERIMENT_TEMPLATE_RECO_V2_KEY, hs as MODAL_CONFIRM, i as DEFAULT_WORKFLOW_PAGE_SIZE, is as DUPLICATE_MODAL_KEY, js as WORKFLOW_HISTORY_VERSION_UNPUBLISH, kc as TEMPLATE_ONBOARDING_EXPERIMENT, os as EXPERIMENT_TEMPLATE_RECO_V3_KEY, xo as PROJECT_ROOT } from "./constants-Dqd5rpvc.js";
import "./merge-Bihz6yfm.js";
import { A as defineStore, j as storeToRefs } from "./_baseOrderBy-Docd1orE.js";
import { t as useBannersStore } from "./banners.store-D-G1Axs9.js";
import { t as require_dateformat } from "./dateformat-Bc6vycUF.js";
import { n as require_debounce, t as useDebounce } from "./useDebounce-BDilYlES.js";
import "./uniqBy-BXMUpP6_.js";
import "./nodeIcon-DbPvo_Sy.js";
import { t as useFoldersStore } from "./folders.store-8pwdG93Q.js";
import "./ProjectIcon-B_8J11cA.js";
import { t as ProjectCardBadge_default } from "./ProjectCardBadge-NYJ7NFkV.js";
import { t as useUsageStore } from "./usage.store-BMB0DadX.js";
import { t as useEnvFeatureFlag } from "./useEnvFeatureFlag-MToxrJKc.js";
import { t as Draggable_default } from "./Draggable-hkm6e1l_.js";
...
import "./EnterpriseEdition.ee-DeJIfCtg.js";
import { t as TimeAgo_default } from "./TimeAgo-Dbn7kM6x.js";
import "./orderBy-BR9LR0WH.js";
import "./ProjectSharing-BCQ1-qTa.js";
import "./TagsDropdown-DOQXu645.js";
import { t as WorkflowTagsDropdown_default } from "./WorkflowTagsDropdown-BpXJyKQM.js";
import { t as useInsightsStore } from "./insights.store-B8TAyUfU.js";
import "./insights.constants-Q1hG0DUw.js";
import "./insights.utils-BKd5T93E.js";
import "./templateTransforms-Cpm8OWx5.js";
import { t as useMcp } from "./useMcp-pGYArRAI.js";
import { n as usePersonalizedTemplatesV2Store, t as usePersonalizedTemplatesV3Store } from "./personalizedTemplatesV3.store-CTg-MjdQ.js";
import { t as useWorkflowActivate } from "./useWorkflowActivate-C74sS_dp.js";
import "./values-C4qPxlSq.js";
import { r as useProjectPages, t as useReadyToRunStore } from "./readyToRun.store-D-ZPuUa7.js";
import "./ProjectBreadcrumb-BL8LEODs.js";
import { t as FolderBreadcrumbs_default } from "./FolderBreadcrumbs-D_FZNRvO.js";
...
import { t as EmptySharedSectionActionBox_default } from "./EmptySharedSectionActionBox-PghWHWks.js";
import { t as ResourcesListLayout_default } from "./ResourcesListLayout-Ca-7Vptc.js";
import "./ResourceFiltersDropdown-BDcVah19.js";
import { n as ReadyToRunButton_default, t as ProjectHeader_default } from "./ProjectHeader-BNN7WIoC.js";
import { t as useMCPStore } from "./mcp.store-DRM9hAc-.js";
import { n as NUMBER_OF_TEMPLATES, r as useRecommendedTemplatesStore, t as RecommendedTemplateCard_default } from "./RecommendedTemplateCard-50za3-aQ.js";
import { t as InsightsSummary_default } from "./InsightsSummary-Bgyy_rsg.js";
...
var EmptyStateLayout_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props, { emit: __emit }) {
		...
		const { showRecommendedTemplatesInline, emptyStateHeading, emptyStateDescription, canCreateWorkflow } = useWorkflowsEmptyState();
		const addWorkflow = () => {
			emit("click:add");
		};
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("div", {
				class: normalizeClass([_ctx.$style.emptyStateLayout, { [_ctx.$style.noTemplatesContent]: !unref(showRecommendedTemplatesInline) }]),
				style: normalizeStyle(containerStyle.value)
			}, [createBaseVNode("div", { class: normalizeClass(_ctx.$style.content) }, [createVNode(unref(N8nHeading_default), {
				tag: "h1",
				size: "2xlarge",
				bold: "",
				...
				_: 1
			}, 8, ["class"]), unref(showRecommendedTemplatesInline) ? (openBlock(), createElementBlock("div", {
				key: 0,
				...
				key: 1,
				class: normalizeClass(_ctx.$style.noTemplatesContent)
			}, [createVNode(unref(N8nText_default), {
				tag: "p",
				size: "large",
				color: "text-base"
				...
				_: 1
			}), unref(canCreateWorkflow) && !unref(showRecommendedTemplatesInline) ? (openBlock(), createBlock(unref(N8nCard_default), {
				key: 0,
				...
				_: 1
			}, 8, ["class"])) : createCommentVNode("", true)], 2))], 2)], 6);
		};
	}
});
var EmptyStateLayout_vue_vue_type_style_index_0_lang_module_default = {
	emptyStateLayout: "_emptyStateLayout_l1k75_125",
	noTemplatesContent: "_noTemplatesContent_l1k75_136",
	content: "_content_l1k75_140",
	welcomeTitle: "_welcomeTitle_l1k75_147",
	actionCard: "_actionCard_l1k75_151",
	cardIcon: "_cardIcon_l1k75_165",
	cardContent: "_cardContent_l1k75_169",
	orDivider: "_orDivider_l1k75_185",
	actionButtons: "_actionButtons_l1k75_190"
};
