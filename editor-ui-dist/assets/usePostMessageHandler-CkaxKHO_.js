const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/pushConnection.store-BxIlHAgh.js","assets/pushConnection.store-XBbpRkf_.js","assets/vue.runtime.esm-bundler-C6vn67cX.js","assets/chunk-CC9Q-vWm.js","assets/constants-DIP3enMx.js","assets/get-G8yCCFQ6.js","assets/_MapCache-SPaVAT41.js","assets/empty-CSot38mi.js","assets/merge-Dxq-OM4r.js","assets/expression-runtime-stub-9w2ZHVM3.js","assets/useRootStore-BUCt9XJo.js","assets/settings.store-B-RgkKfn.js"])))=>i.map(i=>d[i]);
...
import { Dr as getNodesWithNormalizedPosition, M as useCanvasStore, k as useNodeHelpers, kt as useCredentialsStore, n as buildExecutionResponseFromSchema, t as useWorkflowsStore, v as createWorkflowDocumentId, x as useWorkflowDocumentStore, yn as useProjectsStore } from "./workflows.store-yqufO0kS.js";
		...
		try {
			...
			if (json && json.command === "openWorkflow") try {
				...
				const { usePushConnectionStore } = await __vitePreload(async () => {
					const { usePushConnectionStore } = await import("./pushConnection.store-BxIlHAgh.js");
