...
import { $t as hasOwn, B as isMemoSame, C as computed, Cn as toDisplayString, D as createElementBlock, Dt as getCurrentScope, E as createCommentVNode, Et as effectScope, F as getCurrentInstance, Ft as readonly, G as nextTick, Gt as unref, Ht as toRefs, It as ref, J as onBeforeUnmount, Jt as NOOP, L as h, M as createVNode, Mt as markRaw, Nt as onScopeDispose, O as createPropsRestProxy, Ot as init_reactivity_esm_bundler, P as defineComponent, Pt as reactive, Q as onUnmounted, T as createBlock, Tt as customRef, Ut as toValue, V as isVNode, Vt as toRef, W as mergeProps, Z as onMounted, _ as Fragment, _t as watch, an as isFunction, at as renderSlot, b as Teleport, bn as normalizeStyle, bt as withCtx, cn as isObject$2, ct as resolveDynamicComponent, en as hyphenate, et as openBlock, h as withModifiers, i as createApp, it as renderList, j as createTextVNode, jt as isRef, m as withKeys, mn as isString$1, n as Transition$1, nt as provide, o as render, ot as resolveComponent, p as vShow, pt as useSlots, q as onBeforeMount, st as resolveDirective, tn as init_shared_esm_bundler, ut as useAttrs, vn as normalizeClass, vt as watchEffect, w as createBaseVNode, wt as computed$1, xt as withDirectives, z as inject, zt as shallowRef } from "./vue.runtime.esm-bundler-XtMkEjzB.js";
import { M as useLocalStorage, N as useMediaQuery, gt as i18n, ht as addNodeTranslation, lt as watchOnce, mt as addHeaders, ot as useDebounceFn, x as useAsyncState, yt as useI18n, z as useStorage$1 } from "./_MapCache-BRoeWkyP.js";
import { Bt as isToolMessage, Cn as useGlobalComponentSettings, Cr as throwError, Di as isClient$1, Fn as PatchFlags, Jn as TypeComponentsMap, Kn as CloseComponents, Ln as isValidComponentSize, Lt as useRoute, Ni as truncate, Oi as useTimeoutFn, On as useId, Or as isElement, P as isBinary, Rt as useRouter, Si as useEventListener$1, Sn as _export_sfc, Sr as debugWarn, Vn as EVENT_CODE, Vt as isWorkflowUpdatedMessage, Wn as withInstallFunction, Xn as buildProps, Yn as iconPropType, Yt as createEventBus, Zn as definePropType, _r as addClass, br as hasClass, f as require_get, g as require_toString, gn as ElInput, gr as getScrollBarWidth, jn as useNamespace, jr as isUndefined, ki as obtainAllFocusableElements, pn as ElFocusTrap, qn as TypeComponents, qt as require_lib, un as ElButton, v as require_memoize, vr as addUnit, xn as ElIcon, xr as removeClass, yr as getStyle } from "./src-BNc_2bHf.js";
import { $a as NodeConnectionTypes, $c as AI_NODES_PACKAGE_NAME, $i as getChildNodes, $o as CHANGE_PASSWORD_MODAL_KEY, As as WORKFLOW_HISTORY_VERSION_RESTORE, Bc as SIX_MONTHS_IN_MILLIS, Bn as NOTION_TRIGGER_NODE_TYPE, Bo as getResourcePermissions, Bt as CALENDLY_TRIGGER_NODE_TYPE, C as TEMPLATES_URLS, Cc as EXTRA_TEMPLATE_LINKS_EXPERIMENT, Cn as JIRA_NODE_TYPE, Cr as WOOCOMMERCE_TRIGGER_NODE_TYPE, Cs as WHATS_NEW_MODAL_KEY, Dn as LIST_LIKE_NODE_OPERATIONS, Do as require_isEqual, Ds as WORKFLOW_DIFF_MODAL_KEY, Eo as WEBHOOK_NODE_TYPE$1, Er as XERO_NODE_TYPE, Es as WORKFLOW_DESCRIPTION_MODAL_KEY, Et as RECOMMENDED_NODES, F as CUSTOM_API_CALL_KEY, Fc as DEBOUNCE_TIME, Fn as MODULE_ENABLED_NODES, G as NODE_MIN_INPUT_ITEMS_COUNT, Gs as LOCAL_STORAGE_FOCUS_PANEL, Gt as CODE_NODE_TYPE, I as DATA_TYPE_ICON_MAP, Ia as isObjectEmpty, Is as LOCAL_STORAGE_BROWSER_NOTIFICATION_METADATA, It as AI_MCP_TOOL_NODE_TYPE, Jo as EDITABLE_CANVAS_VIEWS, Jt as CREDENTIAL_ONLY_HTTP_NODE_VERSION, Kc as MAIN_AUTH_FIELD_NAME, La as jsonParse, Ln as NODE_POSITION_CONFLICT_ALLOWLIST, Lt as AI_TRANSFORM_NODE_TYPE, Mc as EnterpriseEditionFeature, Ms as WORKFLOW_PUBLISH_MODAL_KEY, N as PLACEHOLDER_FILLED_AT_EXECUTION_TIME, Na as dedupe, Nn as MICROSOFT_EXCEL_NODE_TYPE, No as ApplicationError, Ns as WORKFLOW_SETTINGS_MODAL_KEY, O as ALLOWED_HTML_ATTRIBUTES, Oi as extractFromAICalls, On as MANUAL_CHAT_TRIGGER_NODE_TYPE, Or as ZENDESK_NODE_TYPE, Os as WORKFLOW_EXTRACTION_NAME_MODAL_KEY, P as APPEND_ATTRIBUTION_DEFAULT_PATH, Pa as deepCopy, Pc as CLOUD_TRIAL_CHECK_INTERVAL, Pi as splitExpression, Pn as MICROSOFT_TEAMS_NODE_TYPE, Ps as WORKFLOW_SHARE_MODAL_KEY, Qa as DateTime, Qc as AI_ASSISTANT_MAX_CONTENT_LENGTH, Qi as getNodeByName, Qo as BINARY_DATA_VIEW_MODAL_KEY, Qr as ROLE, R as MAPPING_PARAMS, Ri as require__baseFindIndex, Rt as BAMBOO_HR_NODE_TYPE, Sc as EXPERIMENTS_TO_TRACK, Sn as ITEM_LISTS_NODE_TYPE, So as SEND_AND_WAIT_OPERATION, Ss as VERSIONS_MODAL_KEY, St as HUMAN_IN_THE_LOOP_CATEGORY, T as TEMPLATES_NODES_FILTER, Tr as WORKFLOW_TRIGGER_NODE_TYPE, Ts as WORKFLOW_ACTIVE_MODAL_KEY, Uc as getDebounceTime, Ut as CHAT_TRIGGER_NODE_TYPE, V as INSECURE_CONNECTION_WARNING, Va as sleep$1, Vc as THREE_DAYS_IN_MILLIS, Vo as hasScope$1, Ws as LOCAL_STORAGE_EXPERIMENT_OVERRIDES, Wt as CLEARBIT_NODE_TYPE, Xo as VIEWS, Yo as MAIN_HEADER_TABS, Yt as CREDENTIAL_ONLY_NODE_PREFIX, Z as AI_CATEGORY_HUMAN_IN_THE_LOOP, Za as ExpressionError, Zi as mapConnectionsByDestination, Zn as QUICKBOOKS_NODE_TYPE, Zo as ABOUT_MODAL_KEY, _c as AI_BUILDER_TEMPLATE_EXAMPLES_EXPERIMENT, _r as THE_HIVE_TRIGGER_NODE_TYPE, _s as NODE_PINNING_MODAL_KEY, _t as CORE_NODES_CATEGORY, a as DUPLICATE_POSTFFIX, aa as getNodeOutputs, an as EMAIL_SEND_NODE_TYPE, ar as SET_NODE_TYPE, as as EXPERIMENT_TEMPLATE_RECO_V2_KEY, ba as mergeIssues, bn as IF_NODE_TYPE, br as WAIT_NODE_TYPE, bs as SETUP_CREDENTIALS_MODAL_KEY, ca as getNodeWebhookUrl, cn as EXECUTE_COMMAND_NODE_TYPE, cs as FROM_AI_PARAMETERS_MODAL_KEY, di as require_pick, do as EVALUATION_NODE_TYPE, ds as LOG_STREAM_MODAL_KEY, ea as generateNodesGraph, eo as nodeConnectionTypes, es as CHAT_EMBED_MODAL_KEY, fi as require__baseFlatten, fo as EVALUATION_TRIGGER_NODE_TYPE, fr as SPREADSHEET_FILE_NODE_TYPE, fs as MFA_SETUP_MODAL_KEY, gc as WorkflowStateKey, gn as GOOGLE_SHEETS_NODE_TYPE, gr as TELEGRAM_NODE_TYPE, gs as NEW_ASSISTANT_SESSION_MODAL, gt as BETA_NODES, ha as isHitlToolType, hn as GITHUB_TRIGGER_NODE_TYPE, ho as FROM_AI_AUTO_GENERATED_MARKER, hr as SWITCH_NODE_TYPE, hs as MODAL_CONFIRM, i as DEFAULT_WORKFLOW_PAGE_SIZE, ia as getNodeInputs, ir as SERVICENOW_NODE_TYPE, is as DUPLICATE_MODAL_KEY, it as AI_CATEGORY_ROOT_NODES, ja as isResourceLocatorValue, js as WORKFLOW_HISTORY_VERSION_UNPUBLISH, k as ALLOWED_HTML_TAGS, ko as require_keys, kr as ZENDESK_TRIGGER_NODE_TYPE, ks as WORKFLOW_HISTORY_PUBLISH_MODAL_KEY, lo as CHAT_TRIGGER_NODE_TYPE$1, lr as SLACK_NODE_TYPE, ls as IMPORT_CURL_MODAL_KEY, m as DOCS_DOMAIN, mn as FORM_TRIGGER_NODE_TYPE, mo as FORM_TRIGGER_NODE_TYPE$1, ms as MODAL_CLOSE, n as DEFAULT_NEW_WORKFLOW_NAME, na as displayParameterPath, nc as LOCAL_STORAGE_THEME, nr as SCHEDULE_TRIGGER_NODE_TYPE, ns as CONTACT_PROMPT_MODAL_KEY, o as MAX_WORKFLOW_NAME_LENGTH, oa as getNodeParameters, on as ERROR_TRIGGER_NODE_TYPE, oo as BINARY_MODE_COMBINED, or as SIMPLE_MEMORY_NODE_TYPE, os as EXPERIMENT_TEMPLATE_RECO_V3_KEY, ot as AI_CATEGORY_TOOLS, pn as FORM_NODE_TYPE, ps as MODAL_CANCEL, pt as AI_SUBCATEGORY, q as AI_CATEGORY_AGENTS, qi as createEmptyRunExecutionData, qn as PAGERDUTY_NODE_TYPE, r as DEFAULT_NODETYPE_VERSION, ra as getConnectionTypes, rn as ELASTIC_SECURITY_NODE_TYPE, rr as SEGMENT_NODE_TYPE, rs as CREDENTIAL_RESOLVER_EDIT_MODAL_KEY, sa as getNodeParametersIssues, so as BINARY_MODE_SEPARATE, ss as EXTERNAL_SECRETS_PROVIDER_MODAL_KEY, st as AI_CATEGORY_VECTOR_STORES, t as AutoSaveState, tn as DISCORD_NODE_TYPE, tr as SALESFORCE_NODE_TYPE, ts as CONFIRM_PASSWORD_MODAL_KEY, tt as AI_CATEGORY_OTHER_TOOLS, ur as SPLIT_IN_BATCHES_NODE_TYPE, us as IMPORT_WORKFLOW_URL_MODAL_KEY, vn as HTTP_REQUEST_NODE_TYPE, vs as NPS_SURVEY_MODAL_KEY, vt as DEFAULT_SUBCATEGORY, wi as require__baseIteratee, wn as JIRA_TRIGGER_NODE_TYPE, wo as TRIMMED_TASK_DATA_CONNECTIONS_KEY, wr as WORKABLE_TRIGGER_NODE_TYPE, ws as WORKFLOW_ACTIVATION_CONFLICTING_WEBHOOK_MODAL_KEY, xi as Workflow, xr as WEBHOOK_NODE_TYPE, xs as STOP_MANY_EXECUTIONS_MODAL_KEY, ya as makeNodeName, yn as HUBSPOT_TRIGGER_NODE_TYPE, yo as MANUAL_TRIGGER_NODE_TYPE, ys as PROMPT_MFA_CODE_MODAL_KEY, zc as SEVEN_DAYS_IN_MILLIS, zi as isExpression, zn as NON_ACTIVATABLE_TRIGGER_NODE_TYPES } from "./constants-B-_GdCoL.js";
import { n as require__isIterateeCall, o as require_identity, r as require__baseRest, t as require_merge, y as require_isArrayLike } from "./merge-Dbz2MpYT.js";
import { A as defineStore, C as INSTANCE_ID_HEADER, D as N8N_IO_BASE_URL, E as BROWSER_ID_STORAGE_KEY, T as NPM_COMMUNITY_NODE_SEARCH_API_URL, _ as assert, c as ResponseError, d as makeRestApiRequest, f as post, g as axios_default, l as get$3, m as streamRequest, p as request, r as useRootStore, t as require__baseOrderBy, u as getFullApiResponse, w as INSTANCE_VERSION_HEADER } from "./_baseOrderBy-Bs_4IhiB.js";
import { t as require_dateformat } from "./dateformat-Bc6vycUF.js";
import { r as require_toNumber, t as useDebounce } from "./useDebounce-BLKt5VoA.js";
...
var useLockscreen = (trigger, options = {}) => {
	...
	if (!isClient$1 || hasClass(document.body, hiddenCls.value)) return;
...
var createInstance = (el, binding) => {
	...
	const getProp = (name$7) => resolveExpression(getBindingProp(name$7) || el.getAttribute(`element-loading-${hyphenate(name$7)}`));
...
var _sfc_main$10 = defineComponent({
	...
	setup(props, { emit }) {
		...
		watch(() => state.inputValue, async (val) => {
			await nextTick();
			if (props.boxType === "prompt" && val !== null) validate$1();
		}, { immediate: true });
		...
		const handleAction = (action) => {
			var _a;
			if (props.boxType === "prompt" && action === "confirm" && !validate$1()) return;
			state.action = action;
...
var _hoisted_1$12 = ["aria-label", "aria-describedby"];
			...
			default: withCtx(() => [createBaseVNode("div", {
				...
				default: withCtx(() => [createBaseVNode("div", {
					...
					_ctx.title !== null && _ctx.title !== void 0 ? (openBlock(), createElementBlock("div", {
						...
						_: 1
					}, 8, ["class"])], 42, _hoisted_2$5)) : createCommentVNode("v-if", true)], 2)) : createCommentVNode("v-if", true),
					createBaseVNode("div", {
						id: _ctx.contentId,
					...
					}, toDisplayString(_ctx.editorErrorMessage), 7)], 2), [[vShow, _ctx.showInput]])], 10, _hoisted_3$3),
...
var MessageBoxConstructor = /* @__PURE__ */ _export_sfc(_sfc_main$10, [["render", _sfc_render], ["__file", "/home/runner/work/element-plus/element-plus/packages/components/message-box/src/index.vue"]]);
init_shared_esm_bundler();
var messageInstance = /* @__PURE__ */ new Map();
var getAppendToElement = (props) => {
	let appendTo = document.body;
	if (props.appendTo) {
		if (isString$1(props.appendTo)) appendTo = document.querySelector(props.appendTo);
...
function MessageBox(options, appContext = null) {
	...
	let callback;
	if (isString$1(options) || isVNode(options)) options = { message: options };
...
function sanitizeHtml(dirtyHtml) {
	return (0, import_lib.default)(dirtyHtml, {
		onTagAttr: (tag, name$7, value) => {
			if (tag === "img" && name$7 === "src") {
			...
			if (ALLOWED_HTML_ATTRIBUTES.includes(name$7) || name$7.startsWith("data-")) {
				if (name$7 === "href" && !value.match(/^https?:\/\//gm) && !value.startsWith("/")) return "";
				return `${name$7}="${(0, import_lib.escapeAttrValue)(value)}"`;
			}
		},
		onTag: (tag) => {
...
async function installNewPackage(context, name$7, verify, version) {
...
async function uninstallPackage(context, name$7) {
	return await makeRestApiRequest(context, "DELETE", "/community-packages", { name: name$7 });
}
async function updatePackage(context, name$7, version, checksum) {
...
async function updateCurrentUserSettings(context, settings$1) {
	return await makeRestApiRequest(context, "PATCH", "/me/settings", settings$1);
}
async function updateOtherUserSettings(context, userId, settings$1) {
	return await makeRestApiRequest(context, "PATCH", `/users/${userId}/settings`, settings$1);
}
...
async function generateInviteLink(context, { id: id$1 }) {
	return await makeRestApiRequest(context, "POST", `/users/${id$1}/invite-link`);
}
...
const useSettingsStore = defineStore(STORES.SETTINGS, () => {
	...
	const isDocker = computed(() => settings$1.value?.isDocker ?? false);
	const databaseType = computed(() => settings$1.value?.databaseType);
	const planName = computed(() => settings$1.value?.license.planName ?? "Community");
	const consumerId = computed(() => settings$1.value?.license.consumerId);
	const binaryDataMode = computed(() => settings$1.value?.binaryDataMode);
	const pruning = computed(() => settings$1.value?.pruning);
	const security = computed(() => ({
		blockFileAccessToN8nFiles: settings$1.value.security.blockFileAccessToN8nFiles,
		secureCookie: settings$1.value.authCookie.secure
	}));
	const isEnterpriseFeatureEnabled$1 = computed(() => settings$1.value.enterprise ?? {});
	const nodeJsVersion = computed(() => settings$1.value.nodeJsVersion);
	const nodeEnv = computed(() => settings$1.value.nodeEnv);
	const concurrency = computed(() => settings$1.value.concurrency);
	...
	const isPreviewMode = computed(() => settings$1.value.previewMode);
	const publicApiLatestVersion = computed(() => api.value.latestVersion);
	const publicApiPath = computed(() => api.value.path);
	const isAiAssistantEnabled = computed(() => settings$1.value.aiAssistant?.enabled && settings$1.value.aiAssistant?.setup);
	const isAskAiEnabled = computed(() => settings$1.value.askAi?.enabled);
	const isAiBuilderEnabled = computed(() => settings$1.value.aiBuilder?.enabled && settings$1.value.aiBuilder?.setup);
	...
	const deploymentType = computed(() => settings$1.value.deployment?.type || "default");
	const isCloudDeployment = computed(() => settings$1.value.deployment?.type === "cloud");
	const activeModules = computed(() => settings$1.value.activeModules);
	const isModuleActive = (moduleName) => {
		return activeModules.value?.includes(moduleName);
	};
	const isAiCreditsEnabled = computed(() => settings$1.value.aiCredits?.enabled && settings$1.value.aiCredits?.setup);
	const aiCreditsQuota = computed(() => settings$1.value.aiCredits?.credits);
	const isSmtpSetup = computed(() => userManagement.value.smtpSetup);
	const isPersonalizationSurveyEnabled = computed(() => settings$1.value.telemetry?.enabled && settings$1.value.personalizationSurveyEnabled);
	const telemetry$1 = computed(() => settings$1.value.telemetry);
	const logLevel = computed(() => settings$1.value.logLevel);
	const isTelemetryEnabled = computed(() => settings$1.value.telemetry && settings$1.value.telemetry.enabled);
	const isMFAEnforcementLicensed = computed(() => {
		return settings$1.value.enterprise?.mfaEnforcement ?? false;
	});
	...
	const isCustomRolesFeatureEnabled = computed(() => settings$1.value.enterprise?.customRoles ?? false);
	const areTagsEnabled = computed(() => settings$1.value.workflowTagsDisabled !== void 0 ? !settings$1.value.workflowTagsDisabled : true);
	const isHiringBannerEnabled = computed(() => settings$1.value.hiringBannerEnabled);
	const isTemplatesEnabled = computed(() => Boolean(settings$1.value.templates?.enabled));
	const isTemplatesEndpointReachable = computed(() => templatesEndpointHealthy.value);
	const templatesHost = computed(() => settings$1.value.templates?.host ?? "");
	const pushBackend = computed(() => settings$1.value.pushBackend);
	const isCommunityNodesFeatureEnabled = computed(() => settings$1.value.communityNodesEnabled);
	const isUnverifiedPackagesEnabled = computed(() => settings$1.value.unverifiedCommunityNodesEnabled);
	const allowedModules = computed(() => settings$1.value.allowedModules);
	const isQueueModeEnabled = computed(() => settings$1.value.executionMode === "queue");
	const isMultiMain = computed(() => settings$1.value.isMultiMain);
	const isWorkerViewAvailable = computed(() => !!settings$1.value.enterprise?.workerView);
	const workflowCallerPolicyDefaultOption = computed(() => settings$1.value.workflowCallerPolicyDefaultOption);
	const permanentlyDismissedBanners = computed(() => settings$1.value.banners?.dismissed ?? []);
	const isCommunityPlan = computed(() => planName.value.toLowerCase() === "community");
	const isDevRelease = computed(() => settings$1.value.releaseChannel === "dev");
	const setSettings = (newSettings) => {
		settings$1.value = newSettings;
		userManagement.value = newSettings.userManagement;
		if (userManagement.value) userManagement.value.showSetupOnFirstLoad = !!settings$1.value.userManagement.showSetupOnFirstLoad;
		if (settings$1.value.publicApi) api.value = settings$1.value.publicApi;
		mfa.value.enabled = settings$1.value.mfa?.enabled;
		folders.value.enabled = settings$1.value.folders?.enabled;
		if (settings$1.value.versionCli) useRootStore().setVersionCli(settings$1.value.versionCli);
		if (settings$1.value.authCookie.secure) {
	...
	const setAllowedModules = (allowedModules$1) => {
		settings$1.value.allowedModules = allowedModules$1;
	};
	...
	const getSettings$1 = async () => {
		...
		isMFAEnforced.value = settings$1.value.mfa?.enforced ?? false;
		if (fetchedSettings.settingsMode === "public") return;
		settings$1.value.communityNodesEnabled = fetchedSettings.communityNodesEnabled;
		settings$1.value.unverifiedCommunityNodesEnabled = fetchedSettings.unverifiedCommunityNodesEnabled;
...
function getPersonalizationSurveyV1(answers) {
	...
	function isWorkAreaAnswer(name$7) {
		if (Array.isArray(workArea)) return workArea.includes(name$7);
		else return workArea === name$7;
	}
...
async function workflowExists(context, id$1) {
	return await makeRestApiRequest(context, "GET", `/workflows/${id$1}/exists`);
}
	...
	setup(__props) {
		...
		return (_ctx, _cache) => {
			...
			return openBlock(), createElementBlock("div", null, [
				withDirectives(createBaseVNode("span", _hoisted_1$10, null, 512), [[_directive_n8n_html, __props.errorMessage]]),
...
async function getCredentialsNewName(context, name$7) {
	return await makeRestApiRequest(context, "GET", "/credentials/new", name$7 ? { name: name$7 } : {});
}
...
function getAppNameFromCredType(name$7) {
	return name$7.split(" ").filter((word) => !CRED_KEYWORDS_TO_FILTER.includes(word)).join(" ");
}
function getAppNameFromNodeName(name$7) {
	return name$7.split(" ").filter((word) => !NODE_KEYWORDS_TO_FILTER.includes(word)).join(" ");
}
function getTriggerNodeServiceName(nodeType) {
	return nodeType.displayName.replace(/ trigger/i, "");
}
function getActivatableTriggerNodes(nodes$7) {
	return nodes$7.filter((node) => !node.disabled && !NON_ACTIVATABLE_TRIGGER_NODE_TYPES.includes(node.type));
}
function filterTemplateNodes(nodes$7) {
	const notCoreNodes = nodes$7.filter((node) => {
		return !(node.categories || []).some((category) => category.name === CORE_NODES_CATEGORY);
	});
	return (notCoreNodes.length > 0 ? notCoreNodes : nodes$7).filter((elem) => !TEMPLATES_NODES_FILTER.includes(elem.name));
}
...
const isNodeParameterRequired = (nodeType, parameter) => {
	...
	Object.keys(parameter.displayOptions.show).forEach((name$7) => {
...
const splitName = (projectName = "") => {
	const [, name$7, email] = projectName.match(/^(.*?)(?:\s*<([^>]+)>)?$/) ?? [];
	return {
		name: name$7.trim() || void 0,
		email
	};
};
const MAX_NAME_LENGTH = 25;
const getTruncatedProjectName = (projectName) => {
	const { name: name$7, email } = splitName(projectName ?? "");
	return truncate(name$7 ?? email ?? "", 25);
};
...
const isBinaryLike = (obj) => isObj(obj) && "mimeType" in obj && "data" in obj;
...
const usePostHog = defineStore("posthog", () => {
	...
	if (!window.featureFlags) {
		...
		window.featureFlags = {
			override: (name$7, value) => {
				overrides.value[name$7] = value;
				try {
	...
	const trackExperiment = (featFlags, name$7) => {
		const variant = featFlags[name$7];
		if (!variant || trackedDemoExp.value[name$7] === variant) return;
		telemetry$1.track(EVENTS.IS_PART_OF_EXPERIMENT, {
			name: name$7,
			variant
		});
		trackedDemoExp.value[name$7] = variant;
	};
	const trackExperiments = (featFlags) => {
		EXPERIMENTS_TO_TRACK.forEach((name$7) => trackExperiment(featFlags, name$7));
	};
...
async function createBuilderPayload(text, id$1, options = {}) {
	...
	if (options.executionData) {
		...
		if (options.workflow) workflowContext.expressionValues = await assistantHelpers.extractExpressionsFromWorkflow(options.workflow, options.executionData);
	}
...
function extractRevertVersionIds(messages$1) {
	return messages$1.filter(hasRevertVersionId).map((msg) => msg.revertVersionId);
}
...
function enrichMessagesWithRevertVersion(messages$1, versionMap) {
	return messages$1.map((msg) => {
...
function useBuilderMessages() {
	...
	function createUserMessage(content, id$1, revertVersion) {
		return {
			id: id$1,
			role: "user",
			type: "text",
...
var require_FileSaver_min = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	(function(a, b) {
		...
		var f = "object" == typeof window && window.window === window ? window : "object" == typeof self && self.self === self ? self : "object" == typeof global && global.global === global ? global : void 0, a = f.navigator && /Macintosh/.test(navigator.userAgent) && /AppleWebKit/.test(navigator.userAgent) && !/Safari/.test(navigator.userAgent), g = f.saveAs || ("object" != typeof window || window !== f ? function() {} : "download" in HTMLAnchorElement.prototype && !a ? function(b$1, g$1, h$1) {
			var i$1 = f.URL || f.webkitURL, j = document.createElement("a");
			g$1 = g$1 || b$1.name || "download", j.download = g$1, j.rel = "noopener", "string" == typeof b$1 ? (j.href = b$1, j.origin === location.origin ? e(j) : d(j.href) ? c(b$1, g$1, h$1) : e(j, j.target = "_blank")) : (j.href = i$1.createObjectURL(b$1), setTimeout(function() {
				i$1.revokeObjectURL(j.href);
			}, 4e4), setTimeout(function() {
				e(j);
			}, 0));
		} : "msSaveOrOpenBlob" in navigator ? function(f$1, g$1, h$1) {
			if (g$1 = g$1 || f$1.name || "download", "string" != typeof f$1) navigator.msSaveOrOpenBlob(b(f$1, h$1), g$1);
			else if (d(f$1)) c(f$1, g$1, h$1);
			else {
				var i$1 = document.createElement("a");
				i$1.href = f$1, i$1.target = "_blank", setTimeout(function() {
					e(i$1);
				});
			}
			...
			var h$1 = "application/octet-stream" === b$1.type, i$1 = /constructor/i.test(f.HTMLElement) || f.safari, j = /CriOS\/[\d]+/.test(navigator.userAgent);
			if ((j || h$1 && i$1 || a) && "undefined" != typeof FileReader) {
...
const useWorkflowHistoryStore = defineStore("workflowHistory", () => {
	...
	const downloadVersion = async (workflowId, workflowVersionId, data) => {
		...
		const { connections: connections$7, nodes: nodes$7 } = workflowVersion;
	...
	const cloneIntoNewWorkflow = async (workflowId, workflowVersionId, data) => {
		const [workflow, workflowVersion] = await Promise.all([workflowsStore.fetchWorkflow(workflowId), getWorkflowVersion$1(workflowId, workflowVersionId)]);
		const { connections: connections$7, nodes: nodes$7 } = workflowVersion;
		const { name: name$7 } = workflow;
		const newWorkflowData = {
			nodes: nodes$7,
			connections: connections$7,
			name: (await getNewWorkflow(rootStore.restApiContext, { name: `${name$7} (${data.formattedCreatedAt})` })).name
		};
		return await workflowsStore.createNewWorkflow(newWorkflowData);
	};
	const restoreWorkflow = async (workflowId, workflowVersionId) => {
		const { connections: connections$7, nodes: nodes$7 } = await getWorkflowVersion$1(workflowId, workflowVersionId);
		const updateData = {
			connections: connections$7,
			nodes: nodes$7
		};
...
const useNpsSurveyStore = defineStore("npsSurvey", () => {
	...
	function setupNpsSurveyOnLogin(userId, settings$1) {
		currentUserId.value = userId;
		if (settings$1) setShouldShowNpsSurvey(settings$1);
	}
	function setShouldShowNpsSurvey(settings$1) {
		if (!settingsStore.isTelemetryEnabled) {
			shouldShowNpsSurveyNext.value = false;
			return;
		}
		currentSurveyState.value = settings$1.npsSurvey;
		const userActivated = Boolean(settings$1.userActivated);
		const userActivatedAt = settings$1.userActivatedAt;
...
const useCanvasStore = defineStore("canvas", () => {
	...
	const nodes$7 = computed(() => workflowStore.allNodes);
	const aiNodes = computed(() => nodes$7.value.filter((node) => node.type.includes("langchain") || node.type === "n8n-nodes-base.evaluation" && node.parameters?.operation === "setMetrics"));
...
function useToast() {
	...
	function showMessage$1(messageData, track = true) {
...
function convertWorkflowTagsToIds(tags$1) {
	if (!tags$1 || !Array.isArray(tags$1)) return [];
	if (tags$1.length === 0) return tags$1;
	if (typeof tags$1[0] === "object" && "id" in tags$1[0]) return tags$1.map((tag) => tag.id);
	return tags$1;
}
function removeWorkflowExecutionData(workflow) {
	if (!workflow) return workflow;
	const { pinData: pinData$6, ...cleanWorkflow } = workflow;
	return {
		...cleanWorkflow,
		nodes: workflow.nodes.map((node) => {
			const { issues, pinData: pinData$7, ...cleanNode } = node;
			return cleanNode;
		})
	};
}
...
const useCloudPlanStore = defineStore(STORES.CLOUD_PLAN, () => {
	...
	const trialTimeLeft = computed(() => {
		...
		const msLeft = new Date(state.data.expirationDate).valueOf() - now$1.value;
		if (msLeft <= 0) return {
			count: 0,
			unit: "minutes"
		};
	...
	const startPollingInstanceUsageData = () => {
		const interval$1 = setInterval(async () => {
			now$1.value = Date.now();
			try {
...
var isObject$1 = (val) => toString$3.call(val) === "[object Object]";
var noop$3 = () => {};
...
function parseTypenames$1(typenames, types) {
	return typenames.trim().split(/^|\s+/).map(function(t) {
		var name$7 = "", i$1 = t.indexOf(".");
		if (i$1 >= 0) name$7 = t.slice(i$1 + 1), t = t.slice(0, i$1);
...
Dispatch.prototype = dispatch.prototype = {
	...
	on: function(typename, callback) {
		...
		if (arguments.length < 2) {
			while (++i$1 < n) if ((t = (typename = T[i$1]).type) && (t = get$1$1(_[t], typename.name))) return t;
			return;
		}
...
function get$1$1(type, name$7) {
	for (var i$1 = 0, n = type.length, c; i$1 < n; ++i$1) if ((c = type[i$1]).name === name$7) return c.value;
}
function set$1(type, name$7, callback) {
	for (var i$1 = 0, n = type.length; i$1 < n; ++i$1) if (type[i$1].name === name$7) {
...
function namespace(name$7) {
	var prefix = name$7 += "", i$1 = prefix.indexOf(":");
	if (i$1 >= 0 && (prefix = name$7.slice(0, i$1)) !== "xmlns") name$7 = name$7.slice(i$1 + 1);
	return namespaces.hasOwnProperty(prefix) ? {
		space: namespaces[prefix],
		local: name$7
	} : name$7;
}
function creatorInherit(name$7) {
	return function() {
		var document2 = this.ownerDocument, uri = this.namespaceURI;
		return uri === xhtml && document2.documentElement.namespaceURI === xhtml ? document2.createElement(name$7) : document2.createElementNS(uri, name$7);
	};
}
...
function creator(name$7) {
	var fullname = namespace(name$7);
...
function attrRemove$1(name$7) {
	return function() {
		this.removeAttribute(name$7);
	};
}
...
function attrConstant$1(name$7, value) {
	return function() {
		this.setAttribute(name$7, value);
	};
}
...
function attrFunction$1(name$7, value) {
	return function() {
		var v = value.apply(this, arguments);
		if (v == null) this.removeAttribute(name$7);
		else this.setAttribute(name$7, v);
	};
}
...
function selection_attr(name$7, value) {
	var fullname = namespace(name$7);
	if (arguments.length < 2) {
		var node = this.node();
...
function styleRemove$1(name$7) {
	return function() {
		this.style.removeProperty(name$7);
	};
}
function styleConstant$1(name$7, value, priority) {
	return function() {
		this.style.setProperty(name$7, value, priority);
	};
}
function styleFunction$1(name$7, value, priority) {
	return function() {
		var v = value.apply(this, arguments);
		if (v == null) this.style.removeProperty(name$7);
		else this.style.setProperty(name$7, v, priority);
	};
}
function selection_style(name$7, value, priority) {
	return arguments.length > 1 ? this.each((value == null ? styleRemove$1 : typeof value === "function" ? styleFunction$1 : styleConstant$1)(name$7, value, priority == null ? "" : priority)) : styleValue(this.node(), name$7);
}
function styleValue(node, name$7) {
	return node.style.getPropertyValue(name$7) || defaultView(node).getComputedStyle(node, null).getPropertyValue(name$7);
}
function propertyRemove(name$7) {
	return function() {
		delete this[name$7];
	};
}
function propertyConstant(name$7, value) {
	return function() {
		this[name$7] = value;
	};
}
function propertyFunction(name$7, value) {
	return function() {
		var v = value.apply(this, arguments);
		if (v == null) delete this[name$7];
		else this[name$7] = v;
	};
}
function selection_property(name$7, value) {
	return arguments.length > 1 ? this.each((value == null ? propertyRemove : typeof value === "function" ? propertyFunction : propertyConstant)(name$7, value)) : this.node()[name$7];
}
...
ClassList.prototype = {
	add: function(name$7) {
		if (this._names.indexOf(name$7) < 0) {
			this._names.push(name$7);
			this._node.setAttribute("class", this._names.join(" "));
		}
	},
	remove: function(name$7) {
		var i$1 = this._names.indexOf(name$7);
		if (i$1 >= 0) {
			this._names.splice(i$1, 1);
			this._node.setAttribute("class", this._names.join(" "));
		}
	},
	contains: function(name$7) {
		return this._names.indexOf(name$7) >= 0;
	}
};
...
function selection_classed(name$7, value) {
	var names = classArray(name$7 + "");
	if (arguments.length < 2) {
...
function selection_append(name$7) {
	var create2 = typeof name$7 === "function" ? name$7 : creator(name$7);
...
function selection_insert(name$7, before) {
	var create2 = typeof name$7 === "function" ? name$7 : creator(name$7), select2 = before == null ? constantNull : typeof before === "function" ? before : selector(before);
	return this.select(function() {
...
var constant$2 = (x) => () => x;
function DragEvent(type, { sourceEvent: sourceEvent2, subject, target, identifier, active: active$1, x, y, dx, dy, dispatch: dispatch2 }) {
...
function drag() {
	var filter2 = defaultFilter$1, container = defaultContainer, subject = defaultSubject, touchable = defaultTouchable$1, gestures = {}, listeners$1 = dispatch("start", "drag", "end"), active$1 = 0, mousedownx, mousedowny, mousemoving, touchending, clickDistance2 = 0;
	...
	function beforestart(that, container2, event, d, identifier, touch) {
		...
		return function gesture(type, event2, touch2) {
			...
			switch (type) {
				case "start":
					gestures[identifier] = gesture, n = active$1++;
					break;
				case "end": delete gestures[identifier], --active$1;
				case "drag":
					p = pointer(touch2 || event2, container2), n = active$1;
					break;
			}
...
var ENDING = 5;
var ENDED = 6;
function schedule(node, name$7, id2, index, group, timing) {
...
function interrupt(node, name$7) {
	var schedules = node.__transition, schedule2, active$1, empty2 = true, i$1;
	if (!schedules) return;
	name$7 = name$7 == null ? null : name$7 + "";
	for (i$1 in schedules) {
		if ((schedule2 = schedules[i$1]).name !== name$7) {
			empty2 = false;
			continue;
		}
		active$1 = schedule2.state > STARTING && schedule2.state < ENDING;
		schedule2.state = ENDED;
		schedule2.timer.stop();
		schedule2.on.call(active$1 ? "interrupt" : "cancel", node, node.__data__, schedule2.index, schedule2.group);
		delete schedules[i$1];
	}
	if (empty2) delete node.__transition;
}
function selection_interrupt(name$7) {
	return this.each(function() {
		interrupt(this, name$7);
	});
}
function tweenRemove(id2, name$7) {
	var tween0, tween1;
	return function() {
		var schedule2 = set(this, id2), tween = schedule2.tween;
		if (tween !== tween0) {
			tween1 = tween0 = tween;
			for (var i$1 = 0, n = tween1.length; i$1 < n; ++i$1) if (tween1[i$1].name === name$7) {
				tween1 = tween1.slice();
				tween1.splice(i$1, 1);
				break;
			}
...
function tweenFunction(id2, name$7, value) {
	var tween0, tween1;
	...
	return function() {
		...
		if (tween !== tween0) {
			...
			for (var t = {
				name: name$7,
				value
			}, i$1 = 0, n = tween1.length; i$1 < n; ++i$1) if (tween1[i$1].name === name$7) {
				tween1[i$1] = t;
				break;
			}
...
function transition_tween(name$7, value) {
	var id2 = this._id;
	name$7 += "";
	if (arguments.length < 2) {
		var tween = get$2(this.node(), id2).tween;
		for (var i$1 = 0, n = tween.length, t; i$1 < n; ++i$1) if ((t = tween[i$1]).name === name$7) return t.value;
		return null;
	}
	return this.each((value == null ? tweenRemove : tweenFunction)(id2, name$7, value));
}
function tweenValue(transition, name$7, value) {
	var id2 = transition._id;
	transition.each(function() {
		var schedule2 = set(this, id2);
		(schedule2.value || (schedule2.value = {}))[name$7] = value.apply(this, arguments);
	});
	return function(node) {
		return get$2(node, id2).value[name$7];
	};
}
...
function attrConstant(name$7, interpolate2, value1) {
	var string00, string1 = value1 + "", interpolate0;
	return function() {
		var string0 = this.getAttribute(name$7);
...
function attrFunction(name$7, interpolate2, value) {
	var string00, string10, interpolate0;
	return function() {
		var string0, value1 = value(this), string1;
		if (value1 == null) return void this.removeAttribute(name$7);
		string0 = this.getAttribute(name$7);
		string1 = value1 + "";
...
function transition_attr(name$7, value) {
	var fullname = namespace(name$7), i$1 = fullname === "transform" ? interpolateTransformSvg : interpolate;
	return this.attrTween(name$7, typeof value === "function" ? (fullname.local ? attrFunctionNS : attrFunction)(fullname, i$1, tweenValue(this, "attr." + name$7, value)) : value == null ? (fullname.local ? attrRemoveNS : attrRemove)(fullname) : (fullname.local ? attrConstantNS : attrConstant)(fullname, i$1, value));
}
function attrInterpolate(name$7, i$1) {
	return function(t) {
		this.setAttribute(name$7, i$1.call(this, t));
	};
}
...
function attrTween(name$7, value) {
	var t0, i0;
	function tween() {
		var i$1 = value.apply(this, arguments);
		if (i$1 !== i0) t0 = (i0 = i$1) && attrInterpolate(name$7, i$1);
		return t0;
	}
	tween._value = value;
	return tween;
}
function transition_attrTween(name$7, value) {
	var key = "attr." + name$7;
...
function start(name$7) {
	return (name$7 + "").trim().split(/^|\s+/).every(function(t) {
		var i$1 = t.indexOf(".");
		if (i$1 >= 0) t = t.slice(0, i$1);
		return !t || t === "start";
	});
}
function onFunction(id2, name$7, listener) {
	var on0, on1, sit = start(name$7) ? init : set;
	return function() {
		var schedule2 = sit(this, id2), on = schedule2.on;
		if (on !== on0) (on1 = (on0 = on).copy()).on(name$7, listener);
		schedule2.on = on1;
	};
}
function transition_on(name$7, listener) {
	var id2 = this._id;
	return arguments.length < 2 ? get$2(this.node(), id2).on.on(name$7) : this.each(onFunction(id2, name$7, listener));
}
...
function transition_select(select2) {
	var name$7 = this._name, id2 = this._id;
	if (typeof select2 !== "function") select2 = selector(select2);
	for (var groups = this._groups, m = groups.length, subgroups = new Array(m), j = 0; j < m; ++j) for (var group = groups[j], n = group.length, subgroup = subgroups[j] = new Array(n), node, subnode, i$1 = 0; i$1 < n; ++i$1) if ((node = group[i$1]) && (subnode = select2.call(node, node.__data__, i$1, group))) {
		if ("__data__" in node) subnode.__data__ = node.__data__;
		subgroup[i$1] = subnode;
		schedule(subgroup[i$1], name$7, id2, i$1, subgroup, get$2(node, id2));
	}
	return new Transition(subgroups, this._parents, name$7, id2);
}
function transition_selectAll(select2) {
	var name$7 = this._name, id2 = this._id;
	if (typeof select2 !== "function") select2 = selectorAll(select2);
	for (var groups = this._groups, m = groups.length, subgroups = [], parents = [], j = 0; j < m; ++j) for (var group = groups[j], n = group.length, node, i$1 = 0; i$1 < n; ++i$1) if (node = group[i$1]) {
		for (var children2 = select2.call(node, node.__data__, i$1, group), child, inherit2 = get$2(node, id2), k = 0, l = children2.length; k < l; ++k) if (child = children2[k]) schedule(child, name$7, id2, k, children2, inherit2);
		subgroups.push(children2);
		parents.push(node);
	}
	return new Transition(subgroups, parents, name$7, id2);
}
var Selection = selection.prototype.constructor;
function transition_selection() {
	return new Selection(this._groups, this._parents);
}
function styleNull(name$7, interpolate2) {
	var string00, string10, interpolate0;
	return function() {
		var string0 = styleValue(this, name$7), string1 = (this.style.removeProperty(name$7), styleValue(this, name$7));
		return string0 === string1 ? null : string0 === string00 && string1 === string10 ? interpolate0 : interpolate0 = interpolate2(string00 = string0, string10 = string1);
	};
}
function styleRemove(name$7) {
	return function() {
		this.style.removeProperty(name$7);
	};
}
function styleConstant(name$7, interpolate2, value1) {
	var string00, string1 = value1 + "", interpolate0;
	return function() {
		var string0 = styleValue(this, name$7);
		return string0 === string1 ? null : string0 === string00 ? interpolate0 : interpolate0 = interpolate2(string00 = string0, value1);
	};
}
function styleFunction(name$7, interpolate2, value) {
	var string00, string10, interpolate0;
	return function() {
		var string0 = styleValue(this, name$7), value1 = value(this), string1 = value1 + "";
		if (value1 == null) string1 = value1 = (this.style.removeProperty(name$7), styleValue(this, name$7));
		return string0 === string1 ? null : string0 === string00 && string1 === string10 ? interpolate0 : (string10 = string1, interpolate0 = interpolate2(string00 = string0, value1));
	};
}
function styleMaybeRemove(id2, name$7) {
	var on0, on1, listener0, key = "style." + name$7, event = "end." + key, remove2;
	return function() {
		var schedule2 = set(this, id2), on = schedule2.on, listener = schedule2.value[key] == null ? remove2 || (remove2 = styleRemove(name$7)) : void 0;
		if (on !== on0 || listener0 !== listener) (on1 = (on0 = on).copy()).on(event, listener0 = listener);
		schedule2.on = on1;
	};
}
function transition_style(name$7, value, priority) {
	var i$1 = (name$7 += "") === "transform" ? interpolateTransformCss : interpolate;
	return value == null ? this.styleTween(name$7, styleNull(name$7, i$1)).on("end.style." + name$7, styleRemove(name$7)) : typeof value === "function" ? this.styleTween(name$7, styleFunction(name$7, i$1, tweenValue(this, "style." + name$7, value))).each(styleMaybeRemove(this._id, name$7)) : this.styleTween(name$7, styleConstant(name$7, i$1, value), priority).on("end.style." + name$7, null);
}
function styleInterpolate(name$7, i$1, priority) {
	return function(t) {
		this.style.setProperty(name$7, i$1.call(this, t), priority);
	};
}
function styleTween(name$7, value, priority) {
	var t, i0;
	function tween() {
		var i$1 = value.apply(this, arguments);
		if (i$1 !== i0) t = (i0 = i$1) && styleInterpolate(name$7, i$1, priority);
		return t;
	}
	tween._value = value;
	return tween;
}
function transition_styleTween(name$7, value, priority) {
	var key = "style." + (name$7 += "");
	if (arguments.length < 2) return (key = this.tween(key)) && key._value;
	if (value == null) return this.tween(key, null);
	if (typeof value !== "function") throw new Error();
	return this.tween(key, styleTween(name$7, value, priority == null ? "" : priority));
}
...
function transition_transition() {
	var name$7 = this._name, id0 = this._id, id1 = newId();
	for (var groups = this._groups, m = groups.length, j = 0; j < m; ++j) for (var group = groups[j], n = group.length, node, i$1 = 0; i$1 < n; ++i$1) if (node = group[i$1]) {
		...
		schedule(node, name$7, id1, i$1, group, {
	...
	return new Transition(groups, this._parents, name$7, id1);
}
...
var id = 0;
function Transition(groups, parents, name$7, id2) {
	this._groups = groups;
	this._parents = parents;
	this._name = name$7;
	this._id = id2;
...
function selection_transition(name$7) {
	var id2, timing;
	if (name$7 instanceof Transition) id2 = name$7._id, name$7 = name$7._name;
	else id2 = newId(), (timing = defaultTiming).time = now(), name$7 = name$7 == null ? null : name$7 + "";
	for (var groups = this._groups, m = groups.length, j = 0; j < m; ++j) for (var group = groups[j], n = group.length, node, i$1 = 0; i$1 < n; ++i$1) if (node = group[i$1]) schedule(node, name$7, id2, i$1, group, timing || inherit(node, id2));
	return new Transition(groups, this._parents, name$7, id2);
}
...
function getConnectedElements(nodeOrId, nodes$7, edges, dir) {
	...
	return nodes$7.filter((n) => connectedIds.has(n.id));
}
function getOutgoers(...args) {
	if (args.length === 3) {
		const [nodeOrId2, nodes$7, edges] = args;
		return getConnectedElements(nodeOrId2, nodes$7, edges, "target");
	}
...
function getIncomers(...args) {
	if (args.length === 3) {
		const [nodeOrId2, nodes$7, edges] = args;
		return getConnectedElements(nodeOrId2, nodes$7, edges, "source");
	}
	const [nodeOrId, elements] = args;
	const nodeId = typeof nodeOrId === "string" ? nodeOrId : nodeOrId.id;
...
function getRectOfNodes(nodes$7) {
	let box = {
	...
	for (let i$1 = 0; i$1 < nodes$7.length; i$1++) {
		const node = nodes$7[i$1];
...
function getNodesInside(nodes$7, rect, viewport = {
	x: 0,
	y: 0,
	zoom: 1
...
function getNodesWithinDistance(position, nodeLookup, distance2) {
	...
	for (const node of nodeLookup.values()) if (getOverlappingArea(rect, nodeToRect(node)) > 0) nodes$7.push(node);
	return nodes$7;
}
...
function isValidHandle(event, { handle, connectionMode, fromNodeId, fromHandleId, fromType, doc, lib, flowId, isValidConnection = alwaysValid$1 }, edges, nodes$7, findNode, nodeLookup) {
...
function createGraphNodes(nodes$7, findNode, triggerError) {
	const parentNodes = {};
	const nextNodes = [];
	for (let i$1 = 0; i$1 < nodes$7.length; ++i$1) {
		const node = nodes$7[i$1];
...
function createGraphEdges(nextEdges, isValidConnection, findNode, findEdge, onError, defaultEdgeOptions, nodes$7, edges) {
	const validEdges = [];
...
function useDrag(params) {
	...
	const updateNodes = ({ x, y }) => {
		...
		dragging.value = true;
		if (dragEvent) {
			const [currentNode, nodes$7] = getEventHandlerParams({
				id: id2,
				dragItems,
				findNode
			});
	...
	function handlePointerDown(event) {
		...
		if (clickedHandle && (isMouseTriggered && event.button === 0 || !isMouseTriggered)) {
			let onPointerMove = function(event2) {
				...
				}, edges.value, nodes$7.value, findNode, nodeLookup.value);
			...
			scope.run(() => {
				...
				pauseStore = watchPausable([
					...
					if (((_a = models.modelValue) == null ? void 0 : _a.value) && Array.isArray(models.modelValue.value)) {
						pauseModel?.pause();
						models.modelValue.value = [...nodes$7, ...edges];
						nextTick(() => {
							pauseModel?.resume();
						});
					}
		...
		const watchNodesValue = () => {
			scope.run(() => {
				...
				pauseModel = watchPausable([models.nodes, () => {
					...
					if (nodes$7 && Array.isArray(nodes$7)) {
						pauseStore?.pause();
						store.setNodes(nodes$7);
						if (!pauseStore && !immediateStore && nodes$7.length) immediateStore = true;
						else pauseStore?.resume();
					}
				});
				pauseStore = watchPausable([store.nodes, () => store.nodes.value.length], ([nodes$7]) => {
					var _a;
					if (((_a = models.nodes) == null ? void 0 : _a.value) && Array.isArray(models.nodes.value)) {
						pauseModel?.pause();
						models.nodes.value = [...nodes$7];
						nextTick(() => {
							pauseModel?.resume();
						});
					}
...
function useActions(state, nodeLookup, edgeLookup) {
	...
	const addSelectedNodes = (nodes$7) => {
		if (state.multiSelectionActive) {
			const nodeChanges = nodes$7.map((node) => createSelectionChange(node.id, true));
			state.hooks.nodesChange.trigger(nodeChanges);
			return;
		}
		state.hooks.nodesChange.trigger(getSelectionChanges(nodeLookup.value, new Set(nodes$7.map((n) => n.id)), true));
	...
	const removeSelectedNodes = (nodes$7) => {
		const nodeChanges = (nodes$7 || state.nodes).map((n) => {
			n.selected = false;
	...
	const setNodes = (nodes$7) => {
		const nextNodes = nodes$7 instanceof Function ? nodes$7(state.nodes) : nodes$7;
	...
	const addNodes = (nodes$7) => {
		let nextNodes = nodes$7 instanceof Function ? nodes$7(state.nodes) : nodes$7;
	...
	const removeNodes = (nodes$7, removeConnectedEdges = true, removeChildren = false) => {
		const nextNodes = nodes$7 instanceof Function ? nodes$7(state.nodes) : nodes$7;
	...
	const getIntersectingNodes = (nodeOrRect, partially = true, nodes$7 = state.nodes) => {
		const [nodeRect, node, isRect2] = getNodeRect(nodeOrRect);
		if (!nodeRect) return [];
		const intersections = [];
		for (const n of nodes$7 || state.nodes) {
	...
	const fromObject = (obj) => {
		return new Promise((resolve) => {
			const { nodes: nodes$7, edges, position, zoom: zoom2, viewport } = obj;
			if (nodes$7) setNodes(nodes$7);
...
var Storage = class Storage {
	...
	create(id2, preloadedState) {
		...
		for (const [n, h2] of Object.entries(reactiveState.hooks)) {
			const name$7 = `on${n.charAt(0).toUpperCase() + n.slice(1)}`;
			hooksOn[name$7] = h2.on;
		}
		const emits = {};
...
function useVueFlow(idOrOpts) {
	...
	if (!vueFlow || vueFlowId && vueFlow.id !== vueFlowId) {
		const name$7 = id2 ?? storage.getId();
		const state = storage.create(name$7, options);
		vueFlow = state;
...
var _sfc_main$a = /* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		const { vueFlowRef, nodes: nodes$7, viewport, emits, userSelectionActive, removeSelectedElements, userSelectionRect, elementsSelectable, nodesSelectionActive, getSelectedEdges, getSelectedNodes, removeNodes, removeEdges, selectionMode, deleteKeyCode, multiSelectionKeyCode, multiSelectionActive, edgeLookup, nodeLookup, connectionLookup, defaultEdgeOptions, connectionStartHandle } = useVueFlow();
		...
		function onPointerMove(event) {
			...
			selectedNodeIds.value = new Set(getNodesInside(nodes$7.value, nextUserSelectRect, viewport.value, selectionMode.value === SelectionMode.Partial, true).map((node) => node.id));
			...
			for (const nodeId of selectedNodeIds.value) {
				const connections$7 = connectionLookup.value.get(nodeId);
				if (!connections$7) continue;
				for (const { edgeId } of connections$7.values()) {
...
var EdgeWrapper$1 = defineComponent({
	...
	setup(props) {
		...
		const edgeCmp = computed(() => {
			const name$7 = edge.value.type || "default";
			const slot = slots == null ? void 0 : slots[`edge-${name$7}`];
			if (slot) return slot;
			let edgeType = edge.value.template ?? getEdgeTypes.value[name$7];
			if (typeof edgeType === "string") {
				if (instance) {
					const components = Object.keys(instance.appContext.components);
					if (components && components.includes(name$7)) edgeType = resolveComponent(name$7, false);
				}
			}
...
var NodeWrapper$1 = defineComponent({
	...
	setup(props) {
		...
		const nodeCmp = computed(() => {
			const name$7 = node.type || "default";
			const slot = slots == null ? void 0 : slots[`node-${name$7}`];
			if (slot) return slot;
			let nodeType = node.template || getNodeTypes$2.value[name$7];
			if (typeof nodeType === "string") {
				if (instance) {
					const components = Object.keys(instance.appContext.components);
					if (components && components.includes(name$7)) nodeType = resolveComponent(name$7, false);
				}
			}
...
function useNodesInitialized(options = { includeHiddenNodes: false }) {
	const { nodes: nodes$7 } = useVueFlow();
	return computed(() => {
		if (nodes$7.value.length === 0) return false;
		for (const node of nodes$7.value) if (options.includeHiddenNodes || !node.hidden) {
...
const getLeftmostTopNode = (nodes$7) => {
	return nodes$7.reduce((leftmostTop, node) => {
		if (node.position[0] > leftmostTop.position[0] || node.position[1] > leftmostTop.position[1]) return leftmostTop;
		return node;
	}, nodes$7[0]);
};
const getLeftMostNode = (nodes$7) => {
	return nodes$7.reduce((leftmost, node) => {
		if (node.position[0] < leftmost.position[0]) return node;
		return leftmost;
	}, nodes$7[0]);
};
const getTopMostNode = (nodes$7) => {
	return nodes$7.reduce((topmost, node) => {
		if (node.position[1] < topmost.position[1]) return node;
		return topmost;
	}, nodes$7[0]);
};
const getRightMostNode = (nodes$7) => {
	return nodes$7.reduce((rightmost, node) => {
		if (node.position[0] > rightmost.position[0]) return node;
		return rightmost;
	}, nodes$7[0]);
};
const getBottomMostNode = (nodes$7) => {
	return nodes$7.reduce((bottommost, node) => {
		if (node.position[1] > bottommost.position[1]) return node;
		return bottommost;
	}, nodes$7[0]);
};
const getNodesGroupSize = (nodes$7) => {
	const leftMostNode = getLeftMostNode(nodes$7);
	const topMostNode = getTopMostNode(nodes$7);
	const rightMostNode = getRightMostNode(nodes$7);
	const bottomMostNode = getBottomMostNode(nodes$7);
...
const canUsePosition = (position1, position2, size = DEFAULT_NODE_SIZE) => {
...
const getNewNodePosition = (nodes$7, initialPosition, { offset = [DEFAULT_NODE_SIZE[0] / 2, DEFAULT_NODE_SIZE[1] / 2], size = DEFAULT_NODE_SIZE, viewport = DEFAULT_VIEWPORT_BOUNDARIES, normalize = true } = {}) => {
	...
	if (normalize) {
		...
		do {
			conflictFound = false;
			for (i$1 = 0; i$1 < nodes$7.length; i$1++) {
				node = nodes$7[i$1];
...
const getNodesWithNormalizedPosition = (workflowNodes) => {
	const nodes$7 = [...workflowNodes];
	if (nodes$7.length) {
		const leftmostTop = getLeftmostTopNode(nodes$7);
		const diffX = 176 - leftmostTop.position[0];
		const diffY = 240 - leftmostTop.position[1];
		nodes$7.forEach((node) => {
...
function getGenericHints({ workflowNode, node, nodeType, nodeOutputData, hasMultipleInputItems, nodes: nodes$7, connections: connections$7, hasNodeRun }) {
	const nodeHints = [];
	...
	if (hasMultipleInputItems && LIST_LIKE_NODE_OPERATIONS.includes(workflowNode.parameters.operation || "")) {
		if (!getNodeByName(nodes$7, node.name)?.executeOnce) nodeHints.push({
	...
	if (node.type === "n8n-nodes-base.splitInBatches") {
		const firstNodesInLoop = mapConnectionsByDestination(connections$7)[node.name]?.main[1] || [];
		if (!firstNodesInLoop.length) nodeHints.push({
			message: "No nodes connected to the 'loop' output of this node",
			whenToDisplay: "beforeExecution",
			location: "outputPane"
		});
		else for (const nodeInConnection of firstNodesInLoop || []) if (!(getChildNodes(connections$7, nodeInConnection.node) || []).includes(node.name)) nodeHints.push({
...
function updateViewportToContainNodes(viewport, dimensions, nodes$7, padding) {
	...
	if (nodes$7.length === 0) return viewport;
	const zoom$1 = viewport.zoom;
	const rect = addPadding(getRectOfNodes(nodes$7), padding / zoom$1);
...
const useTemplatesStore = defineStore(STORES.TEMPLATES, () => {
	...
	const getWorkflows$2 = async (query) => {
		...
		const apiEndpoint = settingsStore.templatesHost;
		const versionCli = rootStore.versionCli;
		const payload = await getWorkflows$1(apiEndpoint, {
			...query,
			page: 1,
...
const useFocusPanelStore = defineStore(STORES.FOCUS_PANEL, () => {
	...
	const focusedNodeParameters = computed(() => _focusedNodeParameters.value.map((x) => {
		...
		if (!node) return x;
		const value = (0, import_get$1.default)(node?.parameters ?? {}, x.parameterPath.replace(/parameters\./, ""));
...
const RETRY_START_DELAY = 2e3;
const RETRY_MAX_DELAY = 32e3;
...
const useWorkflowAutosaveStore = defineStore("workflowAutosave", () => {
	...
	function setPendingAutoSave(promise) {
...
function useWorkflowSaving({ router, workflowState: providedWorkflowState, onSaved }) {
	const uiStore = useUIStore();
	...
	async function promptSaveUnsavedWorkflowChanges(next, { confirm = async () => true, cancel = async () => {} } = {}) {
		...
		switch (await message.confirm(i18n$1.baseText("generic.unsavedWork.confirmMessage.message"), {
			title: i18n$1.baseText("generic.unsavedWork.confirmMessage.headline"),
			type: "warning",
			confirmButtonText: i18n$1.baseText("generic.unsavedWork.confirmMessage.confirmButtonText"),
			cancelButtonText: i18n$1.baseText("generic.unsavedWork.confirmMessage.cancelButtonText"),
			showClose: true
		})) {
			case MODAL_CONFIRM:
	...
	function getQueryParam$1(query, key) {
		const value = query[key];
		if (Array.isArray(value)) return value[0] ?? void 0;
		if (value === null) return void 0;
		return value;
	}
	async function saveCurrentWorkflow({ id: id$1, name: name$7, tags: tags$1 } = {}, redirect = true, forceSave = false, autosaved = false) {
		if (useSourceControlStore().preferences.branchReadOnly) return false;
		const isLoading = useCanvasStore().isLoading;
		const currentWorkflow = id$1 ?? getQueryParam$1(router.currentRoute.value.params, "name");
		const parentFolderId = getQueryParam$1(router.currentRoute.value.query, "parentFolderId");
		const uiContext = getQueryParam$1(router.currentRoute.value.query, "uiContext");
		if (uiStore.isActionActive.workflowSaving) {
			if (autosaved) return true;
			if (autosaveStore.pendingAutoSave) await autosaveStore.pendingAutoSave;
		}
		...
		try {
			...
			if (name$7) workflowDataRequest.name = name$7.trim();
			if (tags$1) workflowDataRequest.tags = tags$1;
			...
			if (name$7) workflowState.setWorkflowName({
				newName: workflowData.name,
				setStateDirty: false
			});
			if (tags$1) workflowState.setWorkflowTagIds(convertWorkflowTagsToIds(workflowData.tags));
			...
			if (autosaved) {
				...
				toast.showMessage({
					title: i18n$1.baseText("workflowHelpers.showMessage.title"),
					message: i18n$1.baseText("generic.autosave.retrying", { interpolate: {
						error: error.message,
			...
			if (error.errorCode === 100) {
				telemetry$1.track("User attempted to save locked workflow", {
				...
				if (await message.confirm(i18n$1.baseText("workflows.concurrentChanges.confirmMessage.message", { interpolate: { url } }), i18n$1.baseText("workflows.concurrentChanges.confirmMessage.title"), {
					confirmButtonText: i18n$1.baseText("workflows.concurrentChanges.confirmMessage.confirmButtonText"),
					cancelButtonText: i18n$1.baseText("workflows.concurrentChanges.confirmMessage.cancelButtonText")
	...
	async function saveAsNewWorkflow({ name: name$7, tags: tags$1, resetWebhookUrls, resetNodeIds, openInNewWindow, parentFolderId, uiContext, requestNewId, data, autosaved } = {}, redirect = true) {
		try {
			uiStore.addActiveAction("workflowSaving");
			const dirtyCountBeforeSave = uiStore.dirtyStateSetCount;
			...
			if (resetWebhookUrls) workflowDataRequest.nodes = workflowDataRequest.nodes.map((node) => {
				if (node.webhookId) {
					const newId$1 = nodeHelpers.assignWebhookId(node);
					if (!isExpression(node.parameters.path)) node.parameters.path = newId$1;
			...
			if (templateId) telemetry$1.track("User saved new workflow from template", {
	...
	const autoSaveWorkflowDebounced = useDebounceFn(() => {
		if (autosaveStore.autoSaveState === AutoSaveState.Idle) return;
		autosaveStore.setAutoSaveState(AutoSaveState.InProgress);
		const savePromise = (async () => {
			try {
				await saveCurrentWorkflow({}, true, false, true);
			} finally {
				if (autosaveStore.autoSaveState === AutoSaveState.InProgress) autosaveStore.setAutoSaveState(AutoSaveState.Idle);
	...
	const scheduleAutoSave = () => {
		if (autosaveStore.autoSaveState === AutoSaveState.InProgress) return;
		if (autosaveStore.isRetrying) return;
		autosaveStore.setAutoSaveState(AutoSaveState.Scheduled);
		autoSaveWorkflowDebounced();
	};
...
var import_pick$1 = /* @__PURE__ */ __toESM(require_pick(), 1);
...
const useBuilderStore = defineStore(STORES.BUILDER, () => {
	...
	const settings$1 = useSettingsStore();
	const rootStore = useRootStore();
	const workflowsStore = useWorkflowsStore();
	...
	const isAIBuilderEnabled = computed(() => {
		return settings$1.isAiBuilderEnabled;
	});
	...
	function stopStreaming(payload) {
		...
		} else documentTitle.setDocumentTitle(workflowsStore.workflowName, "IDLE");
	}
	...
	function prepareForStreaming(userMessage, messageId, revertVersion) {
	...
	async function sendChatMessage(options) {
		...
		try {
			...
			}, () => stopStreaming(), (e) => handleServiceError(e, userMessageId, retry), revertVersion?.id, streamingAbortController.value?.signal);
		} catch (e) {
	...
	async function loadSessions() {
		...
		try {
			...
			if (sessions.length > 0) {
				...
				const convertedMessages = enrichMessagesWithRevertVersion(latestSession.messages, versionMap).map((msg) => {
					return mapAssistantMessageToUI(msg, "id" in msg && typeof msg.id === "string" ? msg.id : generateMessageId());
	...
	function getWorkflowSnapshot() {
		return JSON.stringify((0, import_pick$1.default)(workflowsStore.workflow, ["nodes", "connections"]));
	}
	...
	async function restoreToVersion(versionId, messageId) {
		const workflowId = workflowsStore.workflowId;
		...
		const messagesBeingReverted = msgIndex !== -1 ? chatMessages.value.slice(msgIndex).filter((msg) => "revertVersion" in msg && msg.revertVersion).length : 0;
		if (msgIndex !== -1) chatMessages.value = chatMessages.value.slice(0, msgIndex);
	...
	function clearDoneIndicatorTitle() {
		if (documentTitle.getDocumentState() === "AI_DONE") documentTitle.setDocumentTitle(workflowsStore.workflowName, "IDLE");
	}
	return {
		chatMessages,
		streaming,
...
const createDataTableApi = async (context, name$7, projectId, columns, fileId, hasHeaders = true) => {
...
const updateDataTableApi = async (context, dataTableId, name$7, projectId) => {
	return await makeRestApiRequest(context, "PATCH", `/projects/${projectId}/data-tables/${dataTableId}`, { name: name$7 });
};
...
const renameDataTableColumnApi = async (context, dataTableId, projectId, columnId, name$7) => {
	return await makeRestApiRequest(context, "PATCH", `/projects/${projectId}/data-tables/${dataTableId}/columns/${columnId}/rename`, { name: name$7 });
};
...
const useProjectsStore = defineStore(STORES.PROJECTS, () => {
	...
	const updateProject$1 = async (id$1, projectData) => {
		const { name: name$7, icon, description } = projectData;
		const payload = {};
		if (name$7 !== void 0) payload.name = name$7;
...
function useWorkflowState() {
	...
	function setWorkflowName(data) {
		if (data.setStateDirty) uiStore.markStateDirty();
		ws.workflow.name = data.newName;
		ws.workflowObject.name = data.newName;
		if (ws.workflow.id && ws.workflowsById[ws.workflow.id]) ws.workflowsById[ws.workflow.id].name = data.newName;
	}
	...
	function setWorkflowTagIds(tags$1) {
		ws.workflow.tags = tags$1;
	}
	function setWorkflowProperty(key, value) {
		ws.workflow[key] = value;
	}
	function setActiveExecutionId(id$1) {
		ws.private.setActiveExecutionId(id$1);
	}
	async function getNewWorkflowData(name$7, projectId, parentFolderId) {
		let workflowData = {
			name: "",
		...
		try {
			...
			workflowData.name = name$7 || "My workflow";
		}
		setWorkflowName({
			newName: workflowData.name,
			setStateDirty: false
	...
	async function getNewWorkflowDataAndMakeShareable(name$7, projectId, parentFolderId) {
		const workflowData = await getNewWorkflowData(name$7, projectId, parentFolderId);
		makeNewWorkflowShareable();
		return workflowData;
	}
	function addWorkflowTagIds(tags$1) {
		ws.workflow.tags = [...new Set([...ws.workflow.tags ?? [], ...tags$1])];
	}
	function removeWorkflowTagId(tagId) {
		const updated = ws.workflow.tags.filter((id$1) => id$1 !== tagId);
		ws.workflow.tags = updated;
	}
	...
	function setNodeParameters(updateInformation, append) {
		...
		const { name: name$7, parameters } = ws.workflow.nodes[nodeIndex];
		if (updateNodeAtIndex(nodeIndex, { parameters: !!append && isObject(updateInformation.value) ? {
			...parameters,
			...updateInformation.value
		} : updateInformation.value })) {
			uiStore.markStateDirty();
			ws.nodeMetadata[name$7].parametersLastUpdatedAt = Date.now();
		}
	}
	...
	function setNodeValue(updateInformation) {
		...
		if (changed) uiStore.markStateDirty();
		if (changed && ![
			"position",
			"notes",
			"notesInFlow"
	...
	function resetParametersLastUpdatedAt(nodeName) {
		if (!ws.nodeMetadata[nodeName]) ws.nodeMetadata[nodeName] = { pristine: true };
	...
	function updateNodeProperties(updateInformation) {
		...
		if (nodeIndex !== -1) for (const key of Object.keys(updateInformation.properties)) {
			...
			if (updateNodeAtIndex(nodeIndex, { [key]: property })) uiStore.markStateDirty();
		}
...
function useNodeHelpers(opts = {}) {
	...
	function updateNodesInputIssues() {
		const nodes$7 = workflowsStore.allNodes;
		for (const node of nodes$7) updateNodeInputIssues(node);
	}
	function updateNodesExecutionIssues() {
		const nodes$7 = workflowsStore.allNodes;
		for (const node of nodes$7) workflowState.setNodeIssue({
			node: node.name,
			type: "execution",
	...
	function updateNodesParameterIssues() {
		const nodes$7 = workflowsStore.allNodes;
		for (const node of nodes$7) updateNodeParameterIssues(node);
	}
	function updateNodeCredentialIssuesByName(name$7) {
		const node = workflowsStore.getNodeByName(name$7);
	...
	function updateNodeParameterIssuesByName(name$7) {
		const node = workflowsStore.getNodeByName(name$7);
	...
	function disableNodes(nodes$7, { trackHistory = false, trackBulk = true } = {}) {
		const telemetry$1 = useTelemetry();
		if (trackHistory && trackBulk) historyStore.startRecordingUndo();
		const newDisabledState = nodes$7.some((node) => !node.disabled);
		for (const node of nodes$7) {
...
var createTagsStore = (id$1) => {
	...
	return defineStore(id$1, () => {
		...
		const create$1 = async (name$7, { incrementExisting } = {}) => {
			let tagName = name$7;
		...
		const rename = async ({ id: id$2, name: name$7 }) => {
			const updatedTag = await tagsApi.updateTag(rootStore.restApiContext, id$2, { name: name$7 });
		...
		const deleteTagById = async (id$2) => {
			...
			if (deleted) {
				deleteTag(id$2);
				workflowState.removeWorkflowTagId(id$2);
			}
			return deleted;
		};
		return {
...
const useWorkflowsEEStore = defineStore(STORES.WORKFLOWS_EE, () => {
	...
	const getWorkflowOwnerName = computed(() => {
		return (workflowId, fallback = i18n.baseText("workflows.shareModal.info.sharee.fallback")) => {
			const { name: name$7, email } = splitName(workflowStore.getWorkflowById(workflowId)?.homeProject?.name ?? "");
			const trimmedName = name$7?.replace(/\s+/g, " ")?.trim();
...
async function resolveParameter(parameter, opts = {}) {
	if ("localResolve" in opts && opts.localResolve) return await resolveParameterImpl(parameter, opts.workflow, opts.connections, opts.envVars, opts.workflow.getNode(opts.nodeName), opts.execution, opts.workflow.pinData, {
	...
	const workflowsStore = useWorkflowsStore();
	return await resolveParameterImpl(parameter, workflowsStore.workflowObject, workflowsStore.connectionsBySourceNode, useEnvironmentsStore().variablesAsObject, useNDVStore().activeNode, workflowsStore.workflowExecutionData, workflowsStore.pinnedWorkflowData, opts);
}
function resolveParameterImpl(parameter, workflowObject, connections$7, envVars, ndvActiveNode, executionData, pinData$6, opts = {}) {
	...
	let _connectionInputData = connectionInputData(connections$7, parentNode, contextNode.name, inputName, runIndexParent, pinData$6, executionData?.data?.resultData.runData ?? null, nodeConnection);
	if (_connectionInputData === null && contextNode && activeNode?.name !== contextNode.name) _connectionInputData = (0, import_get.default)(executeDataImpl(connections$7, [contextNode.name], contextNode.name, inputName, 0, pinData$6, executionData?.data?.resultData.runData ?? null), [
		"data",
		inputName,
		0
	], null);
	...
	let _executeData = executeDataImpl(connections$7, parentNode, contextNode.name, inputName, runIndexCurrent, pinData$6, executionData?.data?.resultData.runData ?? null, runIndexParent);
	if (!_executeData.source) _executeData = executeDataImpl(connections$7, parentNode, contextNode.name, inputName, runIndexParent, pinData$6, executionData?.data?.resultData.runData ?? null);
...
async function resolveRequiredParameters(currentParameter, parameters, opts = {}) {
	const loadOptionsDependsOn = new Set(currentParameter?.typeOptions?.loadOptionsDependsOn ?? []);
	const entries = Object.entries(parameters);
	const resolvedEntries = await Promise.all(entries.map(async ([name$7, parameter]) => {
		if (loadOptionsDependsOn.has(name$7)) return [name$7, await resolveParameter(parameter, opts)];
		else try {
			return [name$7, await resolveParameter(parameter, opts)];
		} catch (error) {
			return [name$7, null];
		}
	}));
...
function connectionInputData(connections$7, parentNode, currentNode, inputName, runIndex, pinData$6, workflowRunData, nodeConnection = {
	sourceIndex: 0,
	destinationIndex: 0
}) {
	let connectionInputData$1 = null;
	const _executeData = executeDataImpl(connections$7, parentNode, currentNode, inputName, runIndex, pinData$6, workflowRunData);
...
function executeData(connections$7, parentNodes, currentNode, inputName, runIndex, parentRunIndex) {
	const workflowsStore = useWorkflowsStore();
	return executeDataImpl(connections$7, parentNodes, currentNode, inputName, runIndex, workflowsStore.pinnedWorkflowData, workflowsStore.getWorkflowRunData, parentRunIndex);
}
function executeDataImpl(connections$7, parentNodes, currentNode, inputName, runIndex, pinData$6, workflowRunData, parentRunIndex) {
	const connectionsByDestinationNode = mapConnectionsByDestination(connections$7);
	const executeData$1 = {
		node: {},
		data: {},
		source: null
	...
	for (const parentNodeName of parentNodes) {
		const parentPinData = pinData$6?.[parentNodeName];
		if (parentPinData) {
...
function useWorkflowHelpers() {
	...
	function getNodeTypesMaxCount() {
		...
		for (const node of nodes$7) if (returnData[node.type] !== void 0) {
	...
	function getNodeTypeCount(nodeType) {
		const nodes$7 = workflowsStore.allNodes;
		let count = 0;
		for (const node of nodes$7) if (node.type === nodeType) count++;
		return count;
	}
	...
	async function updateWorkflow({ workflowId, active: active$1 }, partialData = false) {
		let data = {};
		...
		if (active$1 !== void 0) data.active = active$1;
	...
	async function initState(workflowData, overrideWorkflowState) {
		...
		const tags$1 = workflowData.tags ?? [];
		ws.setWorkflowTagIds(convertWorkflowTagsToIds(tags$1));
		tagsStore.upsertTags(tags$1);
	}
...
function isValidJsIdentifierName(name$7) {
	return validJsIdNameRegex.test(name$7.toString());
}
...
const useFlattenSchema = () => {
	...
	const flattenMultipleSchemas = (nodes$7, additionalInfo, truncateLimit) => {
		return nodes$7.reduce((acc, item) => {
			acc.push({
...
const useAIAssistantHelpers = () => {
	...
	function getReferencedNodes(node) {
		...
		for (const key in node.parameters) {
			...
			if (names.length) names.map((name$7) => unescapeQuotes(name$7)).forEach((name$7) => {
				referencedNodes.add(name$7);
			});
		}
		return referencedNodes.size ? Array.from(referencedNodes) : [];
	}
	async function processNodeForAssistant(node, propsToRemove) {
		const nodeForLLM = deepCopy(node);
		propsToRemove.forEach((key) => {
			delete nodeForLLM[key];
		});
		nodeForLLM.parameters = await workflowHelpers.getNodeParametersWithResolvedExpressions(nodeForLLM.parameters);
		return nodeForLLM;
	}
	...
	async function extractExpressionsFromWorkflow(workflow, executionData) {
		...
		for (const node of workflow.nodes) {
			...
			const extractExpressions = async (params, visited = /* @__PURE__ */ new WeakSet()) => {
				if (typeof params === "string" && params.startsWith("=")) {
					...
					visited.add(params);
					for (const item of params) await extractExpressions(item, visited);
				} else if (typeof params === "object" && params !== null) {
					if (visited.has(params)) return;
					visited.add(params);
					for (const value of Object.values(params)) await extractExpressions(value, visited);
				}
			};
...
async function truncateBuilderMessages(ctx, workflowId, messageId) {
...
const useCredentialsStore = defineStore(STORES.CREDENTIALS, () => {
	...
	const getCredentialOwnerName = computed(() => {
		return (credential) => {
			const { name: name$7, email } = splitName(credential?.homeProject?.name ?? "");
			return name$7 ? email ? `${name$7} (${email})` : name$7 : email ?? i18n.baseText("credentialEdit.credentialSharing.info.sharee.fallback");
		};
	});
...
const listenForCredentialChanges = (opts) => {
	...
	return store.$onAction((result) => {
		const { name: name$7, after, args } = result;
		after(async (returnValue) => {
			if (!listeningForActions.includes(name$7)) return;
			switch (name$7) {
...
var require_deburr = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var deburrLetter = require__deburrLetter(), toString$2 = require_toString();
...
var require_words = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var asciiWords = require__asciiWords(), hasUnicodeWord = require__hasUnicodeWord(), toString$1 = require_toString(), unicodeWords = require__unicodeWords();
...
function sortNodeCreateElements(nodes$7) {
	return nodes$7.sort((a, b) => {
...
const formatTriggerActionName = (actionPropertyName) => {
	let name$7 = actionPropertyName;
	if (actionPropertyName.includes(".")) name$7 = actionPropertyName.split(".").join(" ");
	return noCase(name$7);
};
...
function getHumanInTheLoopActions(nodeActions) {
	...
	if (actions.length) {
		const name$7 = actions[0].name;
		if (name$7 === "n8n-nodes-base.discord") actions[0].values = {
			...actions[0].values,
			resource: "message",
			operation: SEND_AND_WAIT_OPERATION
		};
		if (name$7 === "n8n-nodes-base.microsoftTeams") actions[0].values = {
			...actions[0].values,
...
function useActionsGenerator() {
	...
	function getSimplifiedNodeType(node) {
		const { displayName, defaults: defaults$1, description, name: name$7, group, icon, iconUrl, iconColor, badgeIconUrl, outputs, codex } = node;
		return {
			displayName,
			defaults: defaults$1,
			description,
...
async function displayForm({ nodes: nodes$7, runData, pinData: pinData$6, destinationNode, triggerNode, directParentNodes, source, getTestUrl }) {
	for (const node of nodes$7) {
		if (triggerNode !== void 0 && triggerNode !== node.name) continue;
		if (runData?.hasOwnProperty(node.name) && node.type !== "n8n-nodes-base.formTrigger" || pinData$6[node.name]) continue;
...
const useWorkflowsStore = defineStore(STORES.WORKFLOWS, () => {
	...
	const isNewWorkflow = computed(() => {
		...
		return !workflowsById.value[workflow.value.id]?.id;
	});
	const isWorkflowSaved = computed(() => {
		return Object.keys(workflowsById.value).reduce((acc, workflowId$1) => {
			acc[workflowId$1] = true;
			return acc;
		}, {});
	});
	...
	const workflowExecutionTriggerNodeName = computed(() => {
		...
		return Object.keys(workflowExecutionData.value?.data?.resultData.runData ?? {}).find((name$7) => workflowTriggerNodes.value.some((node) => node.name === name$7));
	});
	...
	function isNodeInOutgoingNodeConnections(rootNodeName, searchNodeName, depth = -1) {
		...
		const connections$7 = firstNodeConnections.main[0];
		if (connections$7.some((node) => node.node === searchNodeName)) return true;
		return connections$7.some((node) => isNodeInOutgoingNodeConnections(node.node, searchNodeName, depth - 1));
	}
	...
	function getPinDataSize(pinData$7 = {}) {
		return Object.values(pinData$7).reduce((acc, value) => {
	...
	function createWorkflowObject(nodes$7, connections$7, copyData) {
		const nodeTypes = getNodeTypes$2();
		let id$1 = workflow.value.id;
		if (id$1 && !workflowsById.value[id$1]?.id) id$1 = void 0;
		return new Workflow({
			id: id$1,
			name: workflow.value.name,
			nodes: copyData ? deepCopy(nodes$7) : nodes$7,
			connections: copyData ? deepCopy(connections$7) : connections$7,
			active: false,
			nodeTypes,
	...
	function cloneWorkflowObject() {
		const nodes$7 = getNodes();
		const connections$7 = allConnections.value;
		return createWorkflowObject(nodes$7, connections$7);
	}
	...
	async function fetchLastSuccessfulExecution() {
		...
		try {
			if (isNewWorkflow.value || sourceControlStore.preferences.branchReadOnly || uiStore.isReadOnlyView || !workflowPermissions.update || workflow.value.isArchived) return;
			lastSuccessfulExecution.value = await getLastSuccessfulExecution(rootStore.restApiContext, workflowId.value);
		} catch (e) {}
	}
	...
	async function searchWorkflows({ projectId, query, nodeTypes, tags: tags$1, select: select$1, isArchived, triggerNodeTypes }) {
		const filter$1 = {
			projectId,
			query,
			nodeTypes,
	...
	async function checkWorkflowExists(id$1) {
		return (await workflowExists(rootStore.restApiContext, id$1)).exists;
	}
	...
	function setWorkflowActive(targetWorkflowId, activeVersion, clearDirtyState) {
		...
		if (targetWorkflowId === workflow.value.id) {
			if (clearDirtyState) uiStore.markStateClean();
	...
	function setWorkflow(value) {
		const tags$1 = convertWorkflowTagsToIds(value.tags);
		workflow.value = {
			...value,
			...tags$1.length > 0 ? { tags: tags$1 } : {},
	...
	function unpinData(payload) {
		const nodeName = payload.node.name;
		if (!workflow.value.pinData) workflow.value.pinData = {};
		const { [nodeName]: _, ...pinData$7 } = workflow.value.pinData;
		workflow.value.pinData = pinData$7;
		workflowObject.value.setPinData(pinData$7);
	...
	function addConnection(data) {
		...
		if (!connectionExists$1) {
			...
			const connections$7 = nodeConnections[sourceData.index];
			if (connections$7) connections$7.push(destinationData);
		}
	...
	function removeConnection(data) {
		...
		uiStore.markStateDirty();
		const connections$7 = workflow.value.connections[sourceData.node][sourceData.type][sourceData.index];
		if (!connections$7) return;
		for (const index in connections$7) if (connections$7[index].node === destinationData.node && connections$7[index].type === destinationData.type && connections$7[index].index === destinationData.index) connections$7.splice(Number.parseInt(index, 10), 1);
		workflowObject.value.setConnections(workflow.value.connections);
	}
	...
	function setNodes(nodes$7) {
		...
		workflow.value.nodes = nodes$7;
		workflowObject.value.setNodes(nodes$7);
	}
	...
	async function deactivateWorkflow(id$1) {
	...
	async function getWebhookUrl(nodeId, webhookType) {
		const node = getNodeById(nodeId);
		if (!node) return;
		const nodeType = nodeTypesStore.getNodeType(node.type, node.typeVersion);
...
const useUIStore = defineStore(STORES.UI, () => {
	...
	const isModalActiveById = computed(() => Object.keys(modalsById.value).reduce((acc, name$7) => {
		acc[name$7] = name$7 === modalStack.value[0];
		return acc;
	}, {}));
	...
	const setMode = (name$7, mode) => {
		modalsById.value[name$7] = {
			...modalsById.value[name$7],
			mode
		};
	};
	const setActiveId = (name$7, activeId) => {
		modalsById.value[name$7] = {
			...modalsById.value[name$7],
			activeId
		};
	};
	const setShowAuthSelector = (name$7, showAuthSelector) => {
		modalsById.value[name$7] = {
			...modalsById.value[name$7],
			showAuthSelector
		};
	...
	const openModal = (name$7) => {
		modalsById.value[name$7] = {
			...modalsById.value[name$7],
			open: true
		};
		modalStack.value = [name$7].concat(modalStack.value);
	};
	const openModalWithData = (payload) => {
		setModalData(payload);
		openModal(payload.name);
	};
	const closeModal = (name$7) => {
		modalsById.value[name$7] = {
			...modalsById.value[name$7],
			open: false
		};
		modalStack.value = modalStack.value.filter((openModalName) => name$7 !== openModalName);
	};
...
async function acceptInvitation(context, params) {
	if (params.token) return await makeRestApiRequest(context, "POST", "/invitations/accept", params);
	if (!params.inviteeId) throw new Error("inviteeId is required when not using token");
	const { inviteeId, ...props } = params;
	return await makeRestApiRequest(context, "POST", `/invitations/${inviteeId}/accept`, props);
}
...
const useUsersStore = defineStore(STORES.USERS, () => {
	...
	const updateUserSettings = async (settings$1) => {
		const updatedSettings = await updateCurrentUserSettings(rootStore.restApiContext, settings$1);
		if (currentUser.value) {
			currentUser.value.settings = updatedSettings;
			addUsers([currentUser.value]);
		}
	};
	const updateOtherUserSettings$1 = async (userId, settings$1) => {
		await updateOtherUserSettings(rootStore.restApiContext, userId, settings$1);
	};
...
export { require_upperFirst as $, DELETE_USER_MODAL_KEY as $a, shorten as $i, useVueFlow as $n, ROLE_DATA_SCIENCE as $o, CanvasConnectionMode as $r, getEventNamesFromBackend as $s, insertDataTableRowApi as $t, getHumanInTheLoopActions as A, MOVE_FOLDER_MODAL_KEY as Aa, ElOverlay as Ac, getThemedValue as Ai, getMousePosition as An, MSP_INDUSTRY as Ao, validate_default as Ar, testSamlConfig as As, environments_store_default as At, shouldShowCommunityNodeDetails as B, AUTOMATION_BENEFICIARY_KEY as Ba, updateNodeAuthType as Bi, _sfc_main as Bn, REPORTED_SOURCE_EVENT as Bo, isProjectRole as Br, getLdapSynchronizations as Bs, require_toInteger as Bt, useNodeTypesStore as C, SOURCE_CONTROL_PUSH_MODAL_KEY as Ca, getBannerRowHeight as Cc, getAppNameFromCredType as Ci, PUSH_NODES_OFFSET as Cn, MARKETING_AUTOMATION_DATA_SYNCHING as Co, useWorkflowHistoryStore as Cr, getThirdPartyLicenses as Cs, resolveParameter as Ct, finalizeItems as D, FOLDER_NAME_MAX_LENGTH as Da, sanitizeHtml as Dc, getNodeAuthFields as Di, getBounds as Dn, MARKETING_AUTOMATION_REPORTING as Do, ASSISTANT_ENABLED_VIEWS as Dr, initSSO as Ds, useAnnotationTagsStore as Dt, filterAndSearchNodes as E, FOLDER_NAME_ILLEGAL_CHARACTERS_REGEX as Ea, isOutsideSelected as Ec, getMainAuthField as Ei, generateOffsets as En, MARKETING_AUTOMATION_OTHER as Eo, usePostHog as Er, getSamlMetadata as Es, useWorkflowsEEStore as Et, mapToolSubcategoryIcon as F, COMMUNITY_PLUS_ENROLLMENT_MODAL as Fa, isMatchingField as Fi, updateViewportToContainNodes as Fn, OTHER_MARKETING_AUTOMATION_GOAL_KEY as Fo, isComponentPublicInstance as Fr, updateProjectRole as Fs, telemetry as Ft, getRagStarterWorkflowJson as G, COMPANY_SIZE_1000_OR_MORE as Ga, convertToDisplayDate as Gi, clamp as Gn, REPORTED_SOURCE_LLM as Go, isString as Gr, getExternalSecrets as Gs, createDataTableApi as Gt, subcategorizeItems as H, AUTOMATION_BENEFICIARY_OTHER_TEAMS as Ha, abbreviateNumber as Hi, _sfc_main$3 as Hn, REPORTED_SOURCE_GOOGLE as Ho, isResourceSortableByDate as Hr, testLdapConnection as Hs, ProjectTypes as Ht, nodeTypesToCreateElements as I, DEBUG_PAYWALL_MODAL_KEY as Ia, isRequiredCredential as Ii, MarkerType as In, PERSONALIZATION_MODAL_KEY as Io, isCredentialModalState as Ir, getProvisioningConfig as Is, useNDVStore as It, isTutorialTemplateId as J, COMPANY_SIZE_20_OR_LESS as Ja, isBlurrableEl as Ji, getConnectedEdges as Jn, REPORTED_SOURCE_PODCAST as Jo, isValidCredentialResponse as Jr, reloadProvider as Js, deleteDataTableRowsApi as Jt, getSampleWorkflowByTemplateId as K, COMPANY_SIZE_100_499 as Ka, convertToHumanReadableDate as Ki, getBezierPath as Kn, REPORTED_SOURCE_OTHER as Ko, isTriggerPanelObject as Kr, getExternalSecretsProvider as Ks, deleteDataTableApi as Kt, prepareCommunityNodeDetailsViewStack as L, ANNOTATION_TAGS_MANAGER_MODAL_KEY as La, isResourceMapperFieldListStale as Li, NodeId as Ln, PERSONAL_COMPANY_TYPE as Lo, isCredentialsResource as Lr, saveProvisioningConfig as Ls, injectWorkflowState as Lt, groupItemsInSections as M, CREDENTIAL_SELECT_MODAL_KEY as Ma, useLockscreen as Mc, hasExpressionMapping as Mi, getNodeViewTab as Mn, OTHER_COMPANY_INDUSTRY_EXTENDED_KEY as Mo, useStorage as Mr, deleteProjectRole as Ms, useNodeHelpers as Mt, isAINode as N, VARIABLE_MODAL_KEY as Na, useDraggable as Nc, hasOnlyListMode as Ni, getNodesGroupSize as Nn, OTHER_COMPANY_TYPE as No, isBaseTextKey as Nr, getRoleBySlug as Ns, useTelemetry as Nt, flattenCreateElements as O, FOLDER_NAME_ONLY_DOTS_REGEX as Oa, ElMessageBox as Oc, getNodeAuthOptions as Oi, getGenericHints as On, MARKETING_INDUSTRY as Oo, BUILDER_ENABLED_VIEWS as Or, saveOidcConfig as Os, useTagsStore as Ot, isNodePreviewKey as P, COMMUNITY_PLUS_DOCS_URL as Pa, isAuthRelatedParameter as Pi, getNodesWithNormalizedPosition as Pn, OTHER_INDUSTRY_OPTION as Po, isBinaryLike as Pr, getRoles as Ps, TelemetryPlugin as Pt, capitalCase as Q, COMPANY_TYPE_KEY as Qa, isSelectableEl as Qi, useGetPointerPosition as Qn, ROLE_CUSTOMER_SUPPORT as Qo, isWorkflowListItem as Qr, getDestinationsFromBackend as Qs, getDataTableRowsApi as Qt, removePreviewToken as R, MAX_TAG_NAME_LENGTH as Ra, isValueExpression as Ri, PanelPosition as Rn, PHYSICAL_RETAIL_OR_SERVICES as Ro, isDateObject as Rr, sendGetWorkerStatus as Rs, useWorkflowState as Rt, waitingNodeTooltip as S, SOURCE_CONTROL_PULL_MODAL_KEY as Sa, capitalizeFirstLetter as Sc, getAllNodeCredentialForAuthType as Si, GRID_SIZE as Sn, MARKETING_AUTOMATION_CUSTOMER_COMMUNICATION as So, useNpsSurveyStore as Sr, dismissBannerPermanently as Ss, unwrapExpression as St, useEvaluationStore as T, FOLDER_LIST_ITEM_ACTIONS as Ta, isEventTargetContainedBy as Tc, getAuthTypeForNodeCredential as Ti, doRectsOverlap as Tn, MARKETING_AUTOMATION_LEAD_GENERATION_GOAL as To, isPlaceholderValue as Tr, getSamlConfig as Ts, useWorkflowHelpers as Tt, transformNodeType as U, AUTOMATION_BENEFICIARY_SELF as Ua, clearJsonKey as Ui, _sfc_main$d as Un, REPORTED_SOURCE_KEY as Uo, isRouteLocationRaw as Ur, updateLdapConfig as Us, moveFolderToProject as Ut, sortNodeCreateElements as V, AUTOMATION_BENEFICIARY_MY_TEAM as Va, parse as Vi, _sfc_main$1 as Vn, REPORTED_SOURCE_FRIEND as Vo, isResourceMapperValue as Vr, runLdapSync as Vs, useProjectsStore as Vt, SampleTemplates as W, COMPANY_INDUSTRY_EXTENDED_KEY as Wa, convertPath as Wi, _sfc_main$f as Wn, REPORTED_SOURCE_LINKEDIN as Wo, isSharedResource as Wr, connectProvider as Ws, addDataTableColumnApi as Wt, isTemplatesWorkflow as X, COMPANY_SIZE_KEY as Xa, isFocusableEl as Xi, getSmoothStepPath as Xn, REPORTED_SOURCE_YOUTUBE as Xo, isVariableResource as Xr, updateProvider as Xs, fetchDataTableGlobalLimitInBytes as Xt, isFullTemplatesCollection as Y, COMPANY_SIZE_500_999 as Ya, isEmpty as Yi, getRectOfNodes as Yn, REPORTED_SOURCE_TWITTER as Yo, isValidNodeConnectionType as Yr, testExternalSecretsProviderConnection as Ys, downloadDataTableCsvApi as Yt, require_sortBy as Z, COMPANY_SIZE_PERSONAL_USE as Za, isPresent as Zi, isMacOs as Zn, ROLE_BUSINESS_OWNER as Zo, isVueFlowConnection as Zr, deleteDestinationFromDb as Zs, fetchDataTablesApi as Zt, getDefaultExecutionFilters as _, COMMUNITY_PACKAGE_CONFIRM_MODAL_KEY as _a, getApiKeyScopes as _c, splitName as _i, CONFIGURABLE_NODE_SIZE as _n, IT_INDUSTRY as _o, useExternalHooks as _r, activateLicenseKey as _s, isPairedItemIntermediateNodesError as _t, register as a, nodeViewEventBus as aa, getCredentialResolver as ac, BulkCommand as ai, getPairedItemId as an, DEVOPS_AUTOMATION_OTHER as ao, hasPermission as ar, ROLE_OTHER_KEY as as, generateCodeForPrompt as at, hasTrimmedRunData as b, NPM_KEYWORD_SEARCH_URL as ba, UserManagementAuthenticationMethod as bc, filterTemplateNodes as bi, DEFAULT_NODE_SIZE as bn, MARKETING_AUTOMATION_ACTIONS as bo, useSourceControlStore as br, renewLicense as bs, shouldConvertToExpression as bt, addTokenUsageData as c, globalLinkActionsEventBus as ca, updateCredentialResolver as cc, MoveNodeCommand as ci, useDocumentTitle as cn, DEVOPS_REPORTING_GOAL as co, isDefaultUser as cr, SAAS_COMPANY_TYPE as cs, useDataSchema as ct, isChatNode as d, getNewWorkflow as da, installNewPackage as dc, RenameNodeCommand as di, useFocusPanelStore as dn, ECOMMERCE_COMPANY_TYPE as do, hasScope as dr, TELECOMS_INDUSTRY as ds, getMappedExpression as dt, stringSizeInBytes as ea, hasDestinationId as ec, CanvasNodeDirtiness as ei, moveDataTableColumnApi as en, DEVOPS_AUTOMATION_CI_CD_GOAL as eo, wheelDelta as er, ROLE_DEVOPS as es, require__baseSlice as et, parseAiContent as f, getWorkflowWriteLock as fa, uninstallPackage as fc, ReplaceNodeParametersCommand as fi, buildValueFromOverride as fn, EDUCATION_TYPE as fo, useRBACStore as fr, useSettingsStore as fs, getMappedResult as ft, executionRetryMessage as g, COMMUNITY_NODES_RISKS_DOCS_URL as ga, deleteApiKey as gc, getTruncatedProjectName as gi, useTemplatesStore as gn, INVITE_USER_MODAL_KEY as go, useStyles as gr, updateCurrentUserSettings as gs, getResolvableState as gt, executionFilterToQueryFilter as h, COMMUNITY_NODES_INSTALLATION_DOCS_URL as ha, createApiKey as hc, ResourceType as hi, updateFromAIOverrideValues as hn, HEALTHCARE_INDUSTRY as ho, useToast as hr, getUsers as hs, getExpressionErrorMessage as ht, getAll as i, searchInObject as ia, deleteCredentialResolver as ic, AddNodeCommand as ii, uploadCsvFileApi as in, DEVOPS_AUTOMATION_GOAL_OTHER_KEY as io, useCloudPlanStore as ir, ROLE_OTHER as is, chatWithAssistant as it, getRootSearchCallouts as j, CREDENTIAL_EDIT_MODAL_KEY as ja, useSameTarget as jc, getTriggerNodeServiceName as ji, getNewNodePosition as jn, OTHER_AUTOMATION_GOAL as jo, LOCAL_STORAGE_NDV_PANEL_WIDTH as jr, createProjectRole as js, useEnvironmentsStore as jt, getAiTemplatesCallout as k, ILLEGAL_FOLDER_CHARACTERS as ka, ElLoading as kc, getNodeCredentialForSelectedAuthType as ki, getMidCanvasPosition as kn, MEDIA_INDUSTRY as ko, v4_default as kr, saveSamlConfig as ks, isCredentialOnlyNodeType as kt, emptyTokenUsageData as l, dataPinningEventBus as la, getAvailableCommunityPackageCount as lc, RemoveConnectionCommand as li, useWorkflowSaving as ln, DEVOPS_TICKETING_SYSTEMS_INTEGRATIONS_GOAL as lo, isAuthenticated as lr, SECURITY_INDUSTRY as ls, useFlattenSchema as lt, displayForm as m, API_KEY_CREATE_OR_EDIT_MODAL_KEY as ma, sendUserEvent as mc, MAX_NAME_LENGTH as mi, makeOverrideValue as mn, GOVERNMENT_INDUSTRY as mo, removeWorkflowExecutionData as mr, getWhatsNewSection as ms, completeExpressionSyntax as mt, listenForModalChanges as n, tryToParseNumber as na, sendTestMessageToDestination as nc, useHistoryStore as ni, updateDataTableApi as nn, DEVOPS_AUTOMATION_DATA_SYNCING_GOAL as no, isExtraTemplateLinksExperimentEnabled as nr, ROLE_IT as ns, listenForCredentialChanges as nt, subscribe as o, importCurlEventBus as oa, getCredentialResolverTypes as oc, Command as oi, useBuilderStore as on, DEVOPS_INCIDENT_RESPONSE_GOAL as oo, isGuest as or, ROLE_SALES_AND_MARKETING as os, replaceCode as ot, clearPopupWindowState as p, getWorkflowsAndFolders as pa, updatePackage as pc, historyBus as pi, isFromAIOverrideValue as pn, FINANCE_INSURANCE_INDUSTRY as po, hasRole as pr, getNextVersions as ps, propertyNameFromExpression as pt, getTutorialTemplates as q, COMPANY_SIZE_20_99 as qa, hasFocusOnInput as qi, getBoundsofRects as qn, REPORTED_SOURCE_OTHER_KEY as qo, isValidCanvasConnectionMode as qr, getExternalSecretsProviders as qs, deleteDataTableColumnApi as qt, useUIStore as r, omitKey as ra, createCredentialResolver as rc, AddConnectionCommand as ri, updateDataTableRowsApi as rn, DEVOPS_AUTOMATION_GOAL_KEY as ro, trackTemplatesClick as rr, ROLE_KEY as rs, useCredentialsStore as rt, useWorkflowsStore as s, htmlEditorEventBus as sa, getCredentialResolvers as sc, EnableNodeToggleCommand as si, useBrowserNotifications as sn, DEVOPS_MONITORING_AND_ALERTING_GOAL as so, isEnterpriseFeatureEnabled as sr, ROLE_SECURITY as ss, useAIAssistantHelpers as st, useUsersStore as t, toMegaBytes as ta, saveDestinationToDb as tc, CanvasNodeRenderType as ti, renameDataTableColumnApi as tn, DEVOPS_AUTOMATION_CLOUD_INFRASTRUCTURE_ORCHESTRATION_GOAL as to, TemplateClickSource as tr, ROLE_ENGINEERING as ts, require__createCompounder as tt, formatTokenUsageCount as u, codeNodeEditorEventBus as ua, getInstalledCommunityNodes as uc, RemoveNodeCommand as ui, useWorkflowAutosaveStore as un, DIGITAL_AGENCY_COMPANY_TYPE as uo, shouldEnableMfa as ur, SYSTEMS_INTEGRATOR_COMPANY_TYPE as us, escapeMappingString as ut, getExecutionErrorMessage as v, COMMUNITY_PACKAGE_INSTALL_MODAL_KEY as va, getApiKeys as vc, executionDataToJson as vi, CONFIGURATION_NODE_RADIUS as vn, LEGAL_INDUSTRY as vo, useCanvasStore as vr, getLicense as vs, isTestableExpression as vt, useActionsGenerator as w, DELETE_FOLDER_MODAL_KEY as wa, getScrollbarWidth as wc, getAppNameFromNodeName as wi, calculateNodeSize as wn, MARKETING_AUTOMATION_GOAL_KEY as wo, require_FileSaver_min as wr, getOidcConfig as ws, resolveRequiredParameters as wt, unflattenExecutionData as x, PROJECT_MOVE_RESOURCE_MODAL as xa, STORES as xc, getActivatableTriggerNodes as xi, DEFAULT_VIEWPORT_BOUNDARIES as xn, MARKETING_AUTOMATION_AD_CAMPAIGN as xo, useMessage as xr, requestLicenseTrial as xs, stringifyExpressionResult as xt, getExecutionErrorToastConfiguration as y, COMMUNITY_PACKAGE_MANAGE_ACTIONS as ya, updateApiKey as yc, fieldCannotBeDeleted as yi, CONFIGURATION_NODE_SIZE as yn, MANUFACTURING_INDUSTRY as yo, useLoadingService as yr, registerCommunityEdition as ys, removeExpressionPrefix as yt, searchNodes as z, TAGS_MANAGER_MODAL_KEY as za, parseResourceMapperFieldName as zi, Position as zn, REAL_ESTATE_OR_CONSTRUCTION as zo, isFullExecutionResponse as zr, getLdapConfig as zs, workflowStateEventBus as zt };
