;
(function () {
  System.register(["./vue.runtime.esm-bundler-legacy--Sn1h8On.js", "./useTelemetry-legacy-CMfwYwVY.js", "./useToast-legacy-DHnOnoVM.js", "./constants-legacy-8iZaMHMx.js", "./_baseOrderBy-legacy-Bls-fMH1.js", "./retry-legacy-CTwsGM7o.js", "./constants-legacy-DjFSod4r.js", "./fileUtils-legacy-BbiGYBne.js"], function (_export, _context) {
    "use strict";

    var computed, ref, v4_default, useTelemetry, useToast, deepCopy, chatHubProviderSchema, emptyChatModelsResponse, defineStore, streamRequest, useRootStore, makeRestApiRequest, retry, CHAT_STORE, CHAT_VIEW, convertFileToBinaryData, STREAM_SEPARATOR, fetchChatModelsApi, stopGenerationApi, fetchConversationsApi, updateConversationApi, updateConversationTitleApi, deleteConversationApi, fetchSingleConversationApi, fetchAgentApi, createAgentApi, updateAgentApi, deleteAgentApi, fetchChatSettingsApi, fetchChatProviderSettingsApi, updateChatSettingsApi, useChatStore;
    ...
    return {
      setters: [function (_vueRuntimeEsmBundlerLegacy003Js) {
        ...
        emptyChatModelsResponse = _constantsLegacy00TJs.ri;
      }, function (_baseOrderByLegacy00ZJs) {
        defineStore = _baseOrderByLegacy00ZJs.k;
        streamRequest = _baseOrderByLegacy00ZJs.p;
        ...
        CHAT_STORE = _constantsLegacy03lJs.c;
