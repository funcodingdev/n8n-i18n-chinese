;
(function () {
  System.register(["./chunk-legacy-Re9CbdfL.js", "./vue.runtime.esm-bundler-legacy--Sn1h8On.js", "./_MapCache-legacy-09dJkOZ7.js", "./src-legacy-kYXKbxwf.js", "./_plugin-vue_export-helper-legacy-DZMI5HPp.js", "./truncate-legacy-SNFKvoUa.js", "./useTelemetry-legacy-CHWpGzCE.js", "./useToast-legacy-rWrlaA1J.js", "./constants-legacy--QTy-QJy.js", "./_baseOrderBy-legacy-RZOTlo45.js", "./useRunWorkflow-legacy-D-CxQD83.js", "./NodeIcon-legacy-LmfWtolT.js", "./isEmpty-legacy-BM_ajdzK.js", "./dateFormatter-legacy-DQrVTeTf.js", "./AnimatedSpinner-legacy-jmjQlQzV.js"], function (_export, _context) {
    "use strict";

    var __toESM, computed, toDisplayString, createElementBlock, createCommentVNode, nextTick, unref, ref, createVNode, defineComponent, createBlock, toRef, mergeProps, Fragment, watch, normalizeStyle, withCtx, openBlock, withModifiers, renderList, createTextVNode, useTemplateRef, normalizeClass, createBaseVNode, shallowRef, useVirtualList, I18nT, useI18n, useThrottleFn, useTimestamp, N8nButton_default, N8nText_default, N8nIcon_default, N8nTooltip_default, N8nIconButton_default, __plugin_vue_export_helper_default, useRouter, require_get, emptyTokenUsageData, formatTokenUsageCount, v4_default, require_upperFirst, injectWorkflowState, addTokenUsageData, useNodeTypesStore, useWorkflowsStore, isChatNode, parse, useNodeHelpers, useToast, CHAT_TRIGGER_NODE_TYPE, createEmptyRunExecutionData, MANUAL_CHAT_TRIGGER_NODE_TYPE, createRunExecutionData, NodeConnectionTypes, parseErrorMetadata, Workflow, LOGS_EXECUTION_DATA_THROTTLE_DURATION, AGENT_LANGCHAIN_NODE_TYPE, PLACEHOLDER_EMPTY_WORKFLOW_ID, TOOL_EXECUTOR_NODE_NAME, useRunWorkflow, NodeIcon_default, require_isEmpty, toTime, toDayMonth, AnimatedSpinner_default, __vite_style__, import_get, import_isEmpty, ConsumedTokensDetails_vue_vue_type_script_setup_true_lang_default, ConsumedTokensDetails_default, LogsViewConsumedTokenCountText_vue_vue_type_script_setup_true_lang_default, LogsViewConsumedTokenCountText_default, _hoisted_1$1, LogsViewNodeName_vue_vue_type_script_setup_true_lang_default, name$1, LogsViewNodeName_vue_vue_type_style_index_0_lang_module_default, cssModules$2, LogsViewNodeName_default, import_upperFirst, _hoisted_1, LogsOverviewRow_vue_vue_type_script_setup_true_lang_default, container$1, background, selected, error, indent, connectorCurved, connectorStraight, icon, name, timeTook, statusTextIcon, startedAt, consumedTokens, compactErrorIcon, partialExecutionButton, openNdvButton, compact, unavailable, toggleButton, statusIcon, placeholder, LogsOverviewRow_vue_vue_type_style_index_0_lang_module_default, cssModules$1, LogsOverviewRow_default, LogsOverviewRows_vue_vue_type_script_setup_true_lang_default, tree, container, staticScrollBar, LogsOverviewRows_vue_vue_type_style_index_0_lang_module_default, cssModules, LogsOverviewRows_default;
    ...
    */
    ...
    return {
      setters: [function (_chunkLegacy001Js) {
        ...
        createEmptyRunExecutionData = _constantsLegacy00TJs.Hi;
        MANUAL_CHAT_TRIGGER_NODE_TYPE = _constantsLegacy00TJs.Tn;
        createRunExecutionData = _constantsLegacy00TJs.Ui;
        NodeConnectionTypes = _constantsLegacy00TJs.Wa;
        parseErrorMetadata = _constantsLegacy00TJs._i;
        Workflow = _constantsLegacy00TJs.gi;
        LOGS_EXECUTION_DATA_THROTTLE_DURATION = _constantsLegacy00TJs.hc;
        AGENT_LANGCHAIN_NODE_TYPE = _constantsLegacy00TJs.qa;
