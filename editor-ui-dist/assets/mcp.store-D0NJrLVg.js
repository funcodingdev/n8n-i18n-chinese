...
import { cr as useWorkflowsListStore, ia as createWorkflowDocumentId, s as useWorkflowsStore, sa as useWorkflowDocumentStore, zr as isWorkflowListItem } from "./users.store-CP49qwNg.js";
import { T as defineStore, c as makeRestApiRequest, s as getFullApiResponse, t as useRootStore } from "./useRootStore-3wVnX35v.js";
...
var useMCPStore = defineStore("mcp", () => {
	...
	async function toggleWorkflowMcpAccess(workflowId, availableInMCP) {
		...
		if (id === workflowsStore.workflowId) {
			...
			if (settings) workflowDocumentStore.mergeSettings(settings);
		}
