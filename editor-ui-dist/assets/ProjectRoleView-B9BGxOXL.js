...
import { Bi as N8nText_default, Ci as useRouter, Di as N8nTooltip_default, Ri as N8nHeading_default, Si as useRoute, Tt as N8nLoading_default, Vi as N8nButton_default, it as N8nFormInput_default } from "./src-DNuWeQoI.js";
import { t as __plugin_vue_export_helper_default } from "./_plugin-vue_export-helper-DltO58Gh.js";
import "./sanitize-html-JHjOJhXQ.js";
import { Er as useMessage, It as useTelemetry, Q as require_sortBy, br as useToast } from "./users.store-CgsgTstk.js";
import { Fo as require_isEqual, is as VIEWS, ws as MODAL_CONFIRM } from "./constants-DEPRN4fc.js";
...
import { n as SCOPE_TYPES, t as SCOPES } from "./projectRoleScopes-bCpjOiDl.js";
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("div", { class: normalizeClass(["pb-xl", _ctx.$style.container]) }, [
				...
				createBaseVNode("div", { class: normalizeClass(["mb-xl", _ctx.$style.headerContainer]) }, [createVNode(unref(N8nHeading_default), {
					...
					_: 1
				}), initialState.value && !isReadOnly.value ? (openBlock(), createElementBlock("div", _hoisted_1, [createVNode(unref(N8nButton_default), {
					variant: "subtle",
					...
					_: 1
				}, 8, ["disabled"])])) : !initialState.value ? (openBlock(), createBlock(unref(N8nButton_default), {
					key: 1,
					onClick: handleSubmit
				}, {
				...
				createBaseVNode("div", { class: normalizeClass(["mb-l", _ctx.$style.formContainer]) }, [createVNode(unref(N8nFormInput_default), {
					...
					"onUpdate:modelValue": _cache[2] || (_cache[2] = ($event) => unref(form).description = $event),
				...
				!isReadOnly.value ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [createVNode(unref(N8nText_default), {
					...
					createVNode(unref(N8nButton_default), {
						variant: "subtle",
						onClick: _cache[3] || (_cache[3] = ($event) => setPreset("project:admin"))
					}, {
					...
					createVNode(unref(N8nButton_default), {
						variant: "subtle",
						onClick: _cache[4] || (_cache[4] = ($event) => setPreset("project:editor"))
					}, {
					...
					createVNode(unref(N8nButton_default), {
						variant: "subtle",
						onClick: _cache[5] || (_cache[5] = ($event) => setPreset("project:viewer"))
					}, {
						default: withCtx(() => [createTextVNode(toDisplayString(unref(i18n).baseText("projectRoles.viewer")), 1)]),
						_: 1
					})
				], 2)], 64)) : createCommentVNode("", true),
				createBaseVNode("div", { class: normalizeClass(_ctx.$style.cardContainer) }, [(openBlock(true), createElementBlock(Fragment, null, renderList(unref(scopeTypes), (type) => {
