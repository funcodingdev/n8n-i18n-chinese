...
import { D as useElementSize, M as useLocalStorage, N as useMediaQuery, O as useEventListener, b as useActiveElement, bt as useI18n, xt as I18nT } from "./_MapCache-COzuLMdL.js";
...
import { Ln as useToast, Lo as INVITE_USER_MODAL_KEY, Ns as useSettingsStore, _i as hasRole, li as hasPermission, pr as useTelemetry, r as useUIStore, t as useUsersStore, zt as useDocumentTitle } from "./users.store-Qyayth1w.js";
import { Wo as v4_default, ai as ROLE, hs as VIEWS, ml as EnterpriseEditionFeature, oc as LOCAL_STORAGE_CHAT_HUB_HAD_CONVERSATION_BEFORE, pi as chatHubConversationModelSchema, sc as LOCAL_STORAGE_CHAT_HUB_SELECTED_MODEL, ui as PROVIDER_CREDENTIAL_TYPE_MAP } from "./constants-CbM6Kczw.js";
...
import { l as shouldIgnoreCanvasShortcut } from "./canvas.utils-wNLuSy5w.js";
...
import { A as revokeDynamicCredential, C as unflattenModel, T as authorizeDynamicCredential, a as collectChatArtifacts, g as isLlmProvider, k as fetchWorkflowExecutionStatus, l as findOneFromModelsResponse, t as useChatStore, u as flattenModel } from "./chat.store-D97GD5BY.js";
import "./ChatAgentAvatar-CnOWBRFC.js";
import { t as useResizablePanel } from "./useResizablePanel-BMxfX1YK.js";
import { a as useChatSession, i as ChatMarkdownChunk_default, n as ChatPrompt_default, r as ChatMessage_default, t as ChatGreetings_default } from "./ChatGreetings-Brch4eI1.js";
import { n as useFileDrop } from "./ToolsSelector-IijzovF3.js";
import { n as useChatCredentials, r as chatHubConversationModelWithCachedDisplayNameSchema, t as ChatLayout_default } from "./ChatLayout-BpxarY-n.js";
import { n as ModelSelector_default, t as useCustomAgent } from "./useCustomAgent-BNKEAiJ9.js";
