;
(function () {
  System.register(["./chunk-legacy-Re9CbdfL.js", "./vue.runtime.esm-bundler-legacy--Sn1h8On.js", "./_MapCache-legacy-BlV_W1LO.js", "./src-legacy-B7xKFZYj.js", "./truncate-legacy-DWqu3mV5.js", "./useTelemetry-legacy-Dj2fHQys.js", "./useToast-legacy-B2w_7aSU.js", "./constants-legacy-wGNoFUi7.js", "./_baseOrderBy-legacy-DE6my_G3.js"], function (_export, _context) {
    "use strict";

    var __toESM, computed, toDisplayString, createElementBlock, unref, ref, h, defineComponent, watch, openBlock, createTextVNode, createBaseVNode, useI18n, isToolMessage, isWorkflowUpdatedMessage, createEventBus, useRoute, stringSizeInBytes, CREDENTIAL_EDIT_MODAL_KEY, useUIStore, useSettingsStore, useCredentialsStore, getAuthTypeForNodeCredential, getSessionsMetadata, getAiSessions, codeNodeEditorEventBus, injectWorkflowState, chatWithAssistant, chatWithBuilder, useAIAssistantHelpers, getMainAuthField, replaceCode, useNDVStore, useNodeTypesStore, usePostHog, useUsersStore, useWorkflowsStore, STORES, getBuilderCredits, useTelemetry, useToast, EDITABLE_CANVAS_VIEWS, jsonParse, VIEWS, deepCopy, AI_BUILDER_TEMPLATE_EXAMPLES_EXPERIMENT, AI_BUILDER_MULTI_AGENT_EXPERIMENT, PLACEHOLDER_EMPTY_WORKFLOW_ID, require_pick, DEFAULT_NEW_WORKFLOW_NAME, assert, defineStore, useRootStore, ASSISTANT_ENABLED_VIEWS, BUILDER_ENABLED_VIEWS, import_pick, INFINITE_CREDITS, useBuilderStore, DEFAULT_CHAT_WIDTH, useChatPanelStateStore, ndvEventBus, _hoisted_1, AiUpdatedCodeMessage_vue_vue_type_script_setup_true_lang_default, AiUpdatedCodeMessage_default, READABLE_TYPES, useAssistantStore;
    //#endregion
    ...
    return {
      setters: [function (_chunkLegacy001Js) {
        ...
        AI_BUILDER_TEMPLATE_EXAMPLES_EXPERIMENT = _constantsLegacy00TJs.Xs;
        AI_BUILDER_MULTI_AGENT_EXPERIMENT = _constantsLegacy00TJs.Ys;
