const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/pushConnection.store-CgvPhmO4.js","assets/pushConnection.store-Yi-lPmAk.js","assets/vue.runtime.esm-bundler-DYHsQBZB.js","assets/chunk-CC9Q-vWm.js","assets/src-JwBmTNgK.js","assets/preload-helper-CMc80dNB.js","assets/lib-vJcwukKE.js","assets/merge-I1kuvuLK.js","assets/isObject-CUkREaNL.js","assets/isSymbol-DAI9oII0.js","assets/expression-runtime-stub-BpyU35mw.js","assets/__vite-browser-external-CTj19RIp.js","assets/useRootStore-BxA0rNgc.js","assets/lib-BNZ9usf7.js","assets/assert-0w9Y4iRZ.js","assets/settings.store-BA62mVzQ.js","assets/src-a4RL4cTS.js","assets/useDebounce-Bcd_ZnT1.js","assets/durations-nXrTS7zD.js"])))=>i.map(i=>d[i]);
...
import { E as useWorkflowDocumentStore, S as createWorkflowDocumentId, Wr as getNodesWithNormalizedPosition, hn as useProjectsStore, n as buildExecutionResponseFromSchema, t as useWorkflowsStore, xt as useCredentialsStore, y as useWorkflowExecutionStateStore } from "./workflows.store-DHQ2sN1t.js";
...
import { t as isPostMessageOriginAllowed } from "./postMessageUtils-D0K-j6oG.js";
		...
		try {
			...
			if (json && json.command === "openWorkflow") try {
				...
				const { usePushConnectionStore } = await __vitePreload(async () => {
					const { usePushConnectionStore } = await import("./pushConnection.store-CgvPhmO4.js");
