...
import { $i as v4, Ma as isSafeObjectKey, Oa as INSTANCE_AI_THREAD_SOURCE_FALLBACK, _ as reduceEvent, g as findAgent, h as createInitialState, ja as instanceAiEventSchema, ka as buildRunWorkflowSessionGrantKey, v as stateFromAgentTree, wa as INSTANCE_AI_EPHEMERAL_EVENT_TYPES, y as toAgentTree } from "./src-Bd4giLF5.js";
...
import { p as isInstanceAiThreadSource, r as INSTANCE_AI_AGENT_BUILDER_TARGET_METADATA_KEY } from "./constants-CWL-tKUi.js";
import { a as postCancelTask, c as postMessage, i as postCancel, n as ensureThread, o as postConfirmation, r as getInstanceAiCredits, s as postFeedback, t as useInstanceAiSettingsStore } from "./instanceAiSettings.store-xQnrZmcP.js";
...
function enrichAgentFromBuilderTarget(col, target) {
	...
	const eventName = existing && existing.name !== "Untitled" ? existing.name : void 0;
	recordProduced(col, {
		type: "agent",
		id: target.agentId,
...
*/
function useResourceRegistry(messages, workflowNameLookup, archivedWorkflowIds, agentBuilderTarget) {
...
//#endregion
export { fetchThreadDebugRuns as _, getLatestAgentBuilderTarget as a, getLatestBuilderTarget as c, getLatestWorkflowSetupResult as d, getLatestWorkflowUpdateResult as f, fetchRunDebug as g, isRecord as h, getExecutionResultsByWorkflow as i, getLatestDataTableResult as l, isAgentEditingWorkflow as m, useInstanceAiStore as n, getLatestAgentConfigMutation as o, isAgentEditingAgent as p, useThread as r, getLatestBuildResult as s, provideThread as t, getLatestDeletedDataTableId as u, fetchThreadMessages as v, fetchThreads as y };
