...
import { M as useLocalStorage, S as useClipboard, yt as useI18n } from "./_MapCache-BRSIFZ-8.js";
import { Di as useRouter, Ei as useRoute, Mi as require_markdown_it_link_attributes } from "./src-CKCAtrpy.js";
import { t as __plugin_vue_export_helper_default } from "./_plugin-vue_export-helper-DltO58Gh.js";
import { $t as useNodeHelpers, An as CONFIGURATION_NODE_SIZE, Di as AddNodeCommand, Dn as useTemplatesStore, Dr as useExternalHooks, Ea as tryToParseNumber, Ei as AddConnectionCommand, Et as useWorkflowHelpers, Fi as ReplaceNodeParametersCommand, Ft as useProjectsStore, Gr as createWorkflowDocumentId, Hn as getNewNodePosition, In as doRectsOverlap, Jr as useWorkflowDocumentStore, Ln as generateOffsets, Mi as RemoveConnectionCommand, Mn as DEFAULT_VIEWPORT_BOUNDARIES, Ni as RemoveNodeCommand, Nn as GRID_SIZE, On as CONFIGURABLE_NODE_SIZE, Or as useCanvasStore, Pi as RenameNodeCommand, Pn as PUSH_NODES_OFFSET, Qr as v4_default, Si as CanvasConnectionMode, Sn as useFocusPanelStore, Ti as useHistoryStore, Tr as useToast, Vr as usePostHog, Wn as getNodesGroupSize, Zr as pinDataToExecutionData, an as useWorkflowState, at as useCredentialsStore, b as getExecutionErrorToastConfiguration, d as isChatNode, en as useTelemetry, in as injectWorkflowState, ji as MoveNodeCommand, jn as DEFAULT_NODE_SIZE, js as useSettingsStore, kt as useTagsStore, lt as useDataSchema, r as useUIStore, rn as useNDVStore, s as useWorkflowsStore, vi as isValidNodeConnectionType, w as useNodeTypesStore, wi as CanvasNodeRenderType, xa as isPresent, z as removePreviewToken } from "./users.store-D86YL4LK.js";
import { Bc as CANVAS_ZOOMED_VIEW_EXPERIMENT, Oa as isHitlToolType, Pn as MCP_TRIGGER_NODE_TYPE, Sr as UPDATE_WEBHOOK_ID_NODE_TYPES, Vi as require_cloneDeep, Xa as isCommunityPackageName, Ya as deepCopy, Yi as require__baseUniq, Zc as NDV_IN_FOCUS_PANEL_EXPERIMENT, _a as getNodeInputs, cl as EnterpriseEditionFeature, dc as LOCAL_STORAGE_LOGS_PANEL_OPEN, fc as LOCAL_STORAGE_LOGS_SYNC_SELECTION, ga as getConnectionTypes, gn as FORM_TRIGGER_NODE_TYPE, gr as STICKY_NODE_TYPE, lc as LOCAL_STORAGE_LOGS_PANEL_DETAILS_PANEL, mo as NodeConnectionTypes, pa as generateNodesGraph, uc as LOCAL_STORAGE_LOGS_PANEL_DETAILS_PANEL_SUB_NODE, us as VIEWS, va as getNodeOutputs, wa as getSubworkflowId, wr as WEBHOOK_NODE_TYPE, ya as getNodeParameters } from "./constants-bR1gDMyV.js";
import { j as defineStore, r as useRootStore } from "./_baseOrderBy-Bnq6lF9G.js";
import { t as useExecutionsStore } from "./executions.store-M_BkPQP7.js";
import { t as usePinnedData } from "./usePinnedData-Nwk6oEMR.js";
import { a as mapLegacyConnectionToCanvasConnection, c as parseCanvasConnectionHandleString, i as mapCanvasConnectionToLegacyConnection, n as createCanvasConnectionHandleString, o as mapLegacyConnectionsToCanvasConnections } from "./canvas.utils-BFvfHyWG.js";
