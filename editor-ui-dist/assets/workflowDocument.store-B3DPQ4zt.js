const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/workers-OPuLqOzq.js","assets/comlink-DseSdP9Z.js"])))=>i.map(i=>d[i]);
...
import { $ as watchThrottled, A as createEventHook, nt as addNodeTranslation, ot as useI18n, rt as i18n, tt as addHeaders, v as useLocalStorage } from "./core-DZRmok64.js";
import { Ct as useRoute, W as isBinary, na as truncate } from "./src-BiIlKUZj.js";
...
import { b as require_isArrayLike, n as require__isIterateeCall, r as require__baseRest, t as require_merge } from "./merge-BBGSZMVU.js";
import { E as getActivePinia, T as defineStore, a as ResponseError, c as makeRestApiRequest, d as request, f as streamRequest, m as axios, s as getFullApiResponse, t as useRootStore } from "./useRootStore-e_Vi8Kjn.js";
import { C as updateCurrentUserSettings, Ft as getProjectSecretProviderConnectionsByProjectId, Vn as STORES, _t as getResourceMapperFields, ct as fetchCommunityNodeAttributes, dt as getNodeParameterActionResult, ft as getNodeParameterOptions, gt as getResourceLocatorResults, ht as getNodesInformation, i as getWorkflowVersion, lt as fetchCommunityNodeTypes, mt as getNodeTypes$1, pt as getNodeTranslationHeaders, s as findWebhook, t as useSettingsStore, ut as getLocalResourceMapperFields } from "./settings.store-BzvY0ZlK.js";
import { _ as useStorage, f as useUIStore, n as hasPermission, q as CANCELLABLE_EXECUTION_STATUSES, t as useUsersStore, u as hasRole } from "./users.store-ZJJ-bnnb.js";
import { r as require_toNumber } from "./useDebounce-C7_-fIDl.js";
import { A as isObject$1, E as stringSizeInBytes, S as isPresent, T as shorten, a as getNewWorkflow, i as getLastSuccessfulExecution, k as getObjectSizeInKB, l as getWorkflows, n as useFavoritesStore, r as getExecutionData, t as useWorkflowsListStore, w as omit, x as isJsonKeyObject, y as isEmpty } from "./workflowsList.store-BLdfruFZ.js";
import { t as useDocumentTitle } from "./useDocumentTitle-e1I0lyo_.js";
import { t as require__baseOrderBy } from "./_baseOrderBy-yxmTmSGO.js";
	...
	const loadNodesInformationFromLocalDb = async (nodeInfos) => {
		try {
			const { getNodeType } = await __vitePreload(async () => {
				const { getNodeType } = await import("./workers-OPuLqOzq.js");
				return { getNodeType };
			}, __vite__mapDeps([0,1]));
			const found = [];
			const missing = [];
	...
	const loadNodeTypesFromLocalDb = async () => {
		try {
			const { loadNodeTypes, getAllNodeTypes } = await __vitePreload(async () => {
				const { loadNodeTypes, getAllNodeTypes } = await import("./workers-OPuLqOzq.js");
				return {
					loadNodeTypes,
					getAllNodeTypes
				};
