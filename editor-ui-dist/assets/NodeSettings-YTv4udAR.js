...
import { Bt as useNDVStore, C as useNodeTypesStore, Ea as COMMUNITY_NODES_INSTALLATION_DOCS_URL, It as useNodeHelpers, Kt as ProjectTypes, Lt as useTelemetry, R as removePreviewToken, Rr as useWorkflowsListStore, Tt as useWorkflowHelpers, Vt as injectWorkflowState, _a as importCurlEventBus, fi as useHistoryStore, ka as COMMUNITY_PACKAGE_INSTALL_MODAL_KEY, r as useUIStore, rt as useCredentialsStore, s as useWorkflowsStore, t as useUsersStore, w as useActionsGenerator, ws as useSettingsStore, xi as RenameNodeCommand, xr as useExternalHooks, yr as useToast } from "./users.store-V01ymwEk.js";
import { O as NodeCredentials_default, d as useNodeSettingsParameters, f as collectParametersByTab, g as getNodeSettingsInitialValues, j as TitledList_default, k as useNodeCredentialOptions, m as createCommonNodeSettings, p as collectSettings, t as ParameterInputList_default, y as nameIsParameter } from "./ParameterInputList-lt67ER1H.js";
import { n as ElRow, t as ElCol } from "./col-D8VfRuXS.js";
import { Gt as CHAT_TRIGGER_NODE_TYPE, Ha as deepCopy, I as CUSTOM_API_CALL_KEY, Jn as OPEN_URL_PANEL_TRIGGER_NODE_TYPES, Nn as MCP_TRIGGER_NODE_TYPE, Oo as OPEN_AI_API_CREDENTIAL_TYPE, Ua as isCommunityPackageName, Zn as PRODUCTION_ONLY_TRIGGER_NODE_TYPES, d as CUSTOM_NODES_DOCS_URL, en as DATA_TABLE_NODES, fa as getNodeParameters, gn as FORM_TRIGGER_NODE_TYPE, l as BUILTIN_NODES_DOCS_URL, rs as VIEWS, s as BASE_NODE_SURVEY_URL, so as NodeConnectionTypes, ua as getNodeInputs, x as NPM_PACKAGE_DOCS_BASE_URL } from "./constants-dxedTdnr.js";
import { t as useDebounce } from "./useDebounce-DRfCRtqt.js";
import { t as useDataTableStore } from "./dataTable.store-B9-b9Mqo.js";
import { t as useClipboard } from "./useClipboard-C5Le13oQ.js";
import { n as ndvEventBus } from "./assistant.store-1WQmSFts.js";
...
import { a as useInstalledCommunityPackage, i as ContactAdministratorToInstall_default, n as CommunityNodeUpdateInfo_default, o as useInstallNode, r as CommunityNodeFooter_default, t as QuickConnectBanner_default } from "./QuickConnectBanner-BktC-DWn.js";
import { t as useQuickConnect } from "./useQuickConnect-gukndEC6.js";
import { t as NodeIcon_default } from "./NodeIcon-BRciE0jp.js";
import { n as NodeExecuteButton_default } from "./VirtualSchema-C5q88Ax_.js";
