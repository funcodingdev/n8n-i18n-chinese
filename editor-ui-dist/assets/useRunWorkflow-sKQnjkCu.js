...
import { v as require_get } from "./src-CKCAtrpy.js";
import { $t as useNodeHelpers, Ai as EnableNodeToggleCommand, Ci as CanvasNodeDirtiness, Di as AddNodeCommand, Dr as useExternalHooks, Ei as AddConnectionCommand, Et as useWorkflowHelpers, Mi as RemoveConnectionCommand, Ni as RemoveNodeCommand, Oi as BulkCommand, Ti as useHistoryStore, Tr as useToast, en as useTelemetry, h as displayForm, in as injectWorkflowState, js as useSettingsStore, r as useUIStore, s as useWorkflowsStore, vn as useDocumentTitle, ya as isEmpty, yn as useWorkflowSaving } from "./users.store-D86YL4LK.js";
import { Fi as createResultError, Gt as CHAT_TRIGGER_NODE_TYPE, Ht as CHAT_HITL_TOOL_NODE_TYPE, Ii as createResultOk, N as IN_PROGRESS_EXECUTION_ID, So as BINARY_MODE_COMBINED, Ut as CHAT_NODE_TYPE, Wt as CHAT_TOOL_NODE_TYPE, mo as NodeConnectionTypes, nr as RESPOND_TO_WEBHOOK_NODE_TYPE, pa as generateNodesGraph, sa as createRunExecutionData } from "./constants-bR1gDMyV.js";
import { j as defineStore, m as request, r as useRootStore } from "./_baseOrderBy-Bnq6lF9G.js";
...
function useRunWorkflow(useRunWorkflowOpts) {
	...
	async function runWorkflow(options) {
		...
		try {
			...
			if (options.destinationNode && (workflowsStore.checkIfNodeHasChatParent(options.destinationNode.nodeName) || destinationNodeType === "@n8n/n8n-nodes-langchain.chatTrigger") && options.source !== "RunData.ManualChatMessage" && options.source !== "RunData.ManualChatTrigger") {
