...
import { P as getCurrentInstance, Pt as reactive, S as computed, Ut as toValue } from "./vue.runtime.esm-bundler-CiTcVoZc.js";
...
import { As as generateNodesGraph, Go as createResultOk, Lt as CHAT_TRIGGER_NODE_TYPE, N as IN_PROGRESS_EXECUTION_ID, Ss as createRunExecutionData, Wo as createResultError, pc as NodeConnectionTypes } from "./constants-BiYlbN9Z.js";
import { Gt as useWorkflowHelpers, Mi as CanvasNodeDirtiness, S as useWorkflowDocumentStore, i as displayForm, t as useWorkflowsStore, v as useWorkflowExecutionStateStore, x as injectWorkflowDocumentStore } from "./workflows.store-DgZ4KSQf.js";
import { T as defineStore, d as request, t as useRootStore } from "./useRootStore-DbgDMM5M.js";
...
import { a as BulkCommand, i as AddNodeCommand, l as RemoveConnectionCommand, n as useHistoryStore, r as AddConnectionCommand, s as EnableNodeToggleCommand, t as useNodeHelpers, u as RemoveNodeCommand } from "./useNodeHelpers-Bs3WVmfe.js";
import { t as useExecutionsStore } from "./executions.store-DI64k0V1.js";
import { O as useChat, h as chatEventBus, t as useCanvasOperations } from "./useCanvasOperations-CvDbJgaF.js";
...
function useRunWorkflow(useRunWorkflowOpts) {
	...
	async function runWorkflow(options) {
		...
		try {
			...
			if (!workflowsStore.isWorkflowSaved[workflowDocumentStore.value.workflowId] || uiStore.stateIsDirty && settingsStore.isAutosaveEnabled) await workflowSaving.saveCurrentWorkflow({ id: workflowDocumentStore.value.workflowId });
