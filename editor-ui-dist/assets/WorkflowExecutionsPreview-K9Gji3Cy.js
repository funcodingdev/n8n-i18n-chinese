...
import { $ as openBlock, A as createTextVNode, C as createBaseVNode, E as createElementBlock, Ft as ref, N as defineComponent, S as computed, Sn as toDisplayString, T as createCommentVNode, Wt as unref, _ as Fragment, _n as normalizeClass, at as resolveComponent, bt as withDirectives, gt as watch, j as createVNode, ot as resolveDirective, rt as renderList, w as createBlock, yt as withCtx } from "./vue.runtime.esm-bundler-dg1EVmSK.js";
import { bt as useI18n } from "./_MapCache-COzuLMdL.js";
import { At as createEventBus, Ii as N8nIconButton_default, Mi as N8nTooltip_default, Qi as N8nButton_default, Qt as ElDropdownMenu, R as N8nSpinner_default, Ut as N8nBadge_default, Xt as ElDropdown, Yi as N8nHeading_default, Zi as N8nText_default, Zt as ElDropdownItem, gt as useRoute, tn as ElTag } from "./src-BvUzUaLE.js";
import { t as __plugin_vue_export_helper_default } from "./_plugin-vue_export-helper-DltO58Gh.js";
import "./sanitize-html-JHjOJhXQ.js";
import { Bn as useMessage, Hn as useWorkflowHistoryStore, Ln as useToast, Ns as useSettingsStore, pr as useTelemetry, sr as useWorkflowsListStore } from "./users.store-Qyayth1w.js";
import { Fs as MODAL_CONFIRM, as as getResourcePermissions, hs as VIEWS, ml as EnterpriseEditionFeature } from "./constants-CbM6Kczw.js";
...
import { t as convertToDisplayDate } from "./dateFormatter-Bej0iQ6f.js";
import { t as useExecutionHelpers } from "./useExecutionHelpers-DWnDw3K7.js";
import "./TagsDropdown-CbD2Knum.js";
import { t as useExecutionDebugging } from "./useExecutionDebugging-zsR14r_G.js";
import { t as AnnotationTagsDropdown_ee_default } from "./AnnotationTagsDropdown.ee-Bkdn5JcP.js";
import { t as WorkflowPreview_default } from "./WorkflowPreview-BHcUROZS.js";
			...
			return executionUIDetails.value?.name === "new" ? (openBlock(), createElementBlock("div", {
				...
				createBaseVNode("div", { class: normalizeClass(_ctx.$style.executionDetailsInfo) }, [
					...
					executionUIDetails.value?.showTimestamp === false ? (openBlock(), createBlock(unref(N8nText_default), {
						...
						default: withCtx(() => [createTextVNode(" | ID#" + toDisplayString(__props.execution.id) + " ", 1), workflowVersionLabel.value && workflowVersionRoute.value ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [_cache[1] || (_cache[1] = createTextVNode(" | ", -1)), createVNode(unref(N8nText_default), { color: "text-light" }, {
						...
						default: withCtx(() => [createTextVNode(toDisplayString(executionMetaText.value) + " | ID#" + toDisplayString(__props.execution.id) + " ", 1), workflowVersionLabel.value && workflowVersionRoute.value ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [_cache[2] || (_cache[2] = createTextVNode(" | ", -1)), createVNode(unref(N8nText_default), { color: "text-light" }, {
							default: withCtx(() => [createVNode(unref(N8nTooltip_default), {
								content: workflowVersionTooltip.value,
								placement: "bottom"
							}, {
...
var WorkflowExecutionsPreview_vue_vue_type_style_index_0_lang_module_default = {
	previewContainer: "_previewContainer_qc8ai_125",
	executionDetails: "_executionDetails_qc8ai_131",
	executionDetailsLeft: "_executionDetailsLeft_qc8ai_149",
	executionTitle: "_executionTitle_qc8ai_155",
	voteButtons: "_voteButtons_qc8ai_161",
	spinner: "_spinner_qc8ai_165",
	running: "_running_qc8ai_171",
	waiting: "_waiting_qc8ai_176",
	success: "_success_qc8ai_180",
	error: "_error_qc8ai_184",
	newInfo: "_newInfo_qc8ai_188",
	runningInfo: "_runningInfo_qc8ai_189",
	newMessage: "_newMessage_qc8ai_196",
	runningMessage: "_runningMessage_qc8ai_197",
	debugLink: "_debugLink_qc8ai_203",
	actions: "_actions_qc8ai_208",
	highlightDataButton: "_highlightDataButton_qc8ai_213",
	highlightDataButtonActive: "_highlightDataButtonActive_qc8ai_218",
	highlightDataButtonOpen: "_highlightDataButtonOpen_qc8ai_222",
	versionLink: "_versionLink_qc8ai_228",
	badge: "_badge_qc8ai_236"
};
