const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/pushConnection.store-9qqSOQh5.js","assets/pushConnection.store-Wf16uPOf.js","assets/vue.runtime.esm-bundler-Bs4WIMNP.js","assets/chunk-CC9Q-vWm.js","assets/src-D3mf01t5.js","assets/get-BCBMNeAK.js","assets/_MapCache-CEAOc3R8.js","assets/merge-CcI6jmTK.js","assets/expression-runtime-stub-D0JX5CsF.js","assets/__vite-browser-external-DLY6DjNi.js","assets/useRootStore-BZ6J9jMu.js","assets/lib-D10cRSie.js","assets/assert-Cfjx80o8.js","assets/settings.store-g-g2FkkM.js","assets/useDebounce-CubbwCqu.js","assets/constants2-C4Gtqhrx.js","assets/durations-CAil8xsz.js","assets/settings.store-wQLyP2Tj.js"])))=>i.map(i=>d[i]);
...
import { E as useWorkflowDocumentStore, S as createWorkflowDocumentId, Ur as getNodesWithNormalizedPosition, mn as useProjectsStore, n as buildExecutionResponseFromSchema, t as useWorkflowsStore, xt as useCredentialsStore, y as useWorkflowExecutionStateStore } from "./workflows.store-CEslMXyQ.js";
...
import { t as useNotificationsStore } from "./notifications.store-DkN7A0to.js";
import { t as isPostMessageOriginAllowed } from "./postMessageUtils-BaMnFzKl.js";
		...
		try {
			...
			if (json && json.command === "openWorkflow") try {
				...
				const { usePushConnectionStore } = await __vitePreload(async () => {
					const { usePushConnectionStore } = await import("./pushConnection.store-9qqSOQh5.js");
