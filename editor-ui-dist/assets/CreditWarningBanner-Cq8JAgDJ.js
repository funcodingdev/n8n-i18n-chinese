...
import { at as useI18n, n as onClickOutside } from "./core-DJhPBFhT.js";
import { Di as N8nTooltip_default, Qi as N8nIcon_default, Zi as N8nButton_default } from "./src-DJ-D-s3W.js";
import { t as _plugin_vue_export_helper_default } from "./_plugin-vue_export-helper-Da88TEg1.js";
import { Pn as useToast, fr as useTelemetry, sr as useWorkflowsListStore } from "./users.store-Cuk0qvvE.js";
import { Br as toAgentTree, Eo as v4, Go as isSafeObjectKey, Lr as createInitialState, Rr as findAgent, Wo as instanceAiEventSchema, zr as reduceEvent } from "./constants-fJx0oi9Z.js";
import { T as defineStore, a as ResponseError, c as makeRestApiRequest, t as useRootStore } from "./useRootStore-udEbvQrW.js";
...
import { i as NEW_CONVERSATION_TITLE } from "./constants-C6zHJmRD.js";
import { a as postCancelTask, i as postCancel, n as ensureThread, o as postConfirmation, r as getInstanceAiCredits, s as postMessage, t as useInstanceAiSettingsStore } from "./instanceAiSettings.store-TRpfWAsK.js";
//#region src/features/ai/instanceAi/instanceAi.memory.api.ts
async function fetchMemory(context, threadId) {
	return await makeRestApiRequest(context, "GET", `/instance-ai/memory/${threadId}`);
}
async function updateMemory(context, threadId, content) {
...
async function fetchThreadContext(context, threadId) {
...
var useInstanceAiStore = defineStore("instanceAi", () => {
	...
	const isLocalGatewayEnabled = computed(() => settingsStore.moduleSettings?.["instance-ai"]?.localGateway === true);
	...
	const localGatewayFallbackDirectory = computed(() => settingsStore.moduleSettings?.["instance-ai"]?.localGatewayFallbackDirectory ?? null);
	const activeDirectory = computed(() => gatewayDirectory.value ?? localGatewayFallbackDirectory.value);
	...
	*/
	...
	function switchThread(threadId) {
		...
		loadHistoricalMessages(threadId).then(() => {
	...
	async function loadHistoricalMessages(threadId) {
		try {
...
//#endregion
export { fetchThreadContext as a, updateMemory as c, fetchMemory as i, CreditsSettingsDropdown_default as n, fetchThreadMessages as o, useInstanceAiStore as r, fetchThreads as s, CreditWarningBanner_default as t };
