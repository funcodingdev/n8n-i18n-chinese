...
import { D as injectWorkflowDocumentStore, vn as useProjectsStore, wt as useCredentialsStore } from "./workflows.store-JWtScvRR.js";
import { c as sanitizeHtml } from "./htmlUtils-CZzL9YQk.js";
import { Qn as makeRestApiRequest, t as useRootStore } from "./useRootStore-CLEJA2KF.js";
...
import { T as listAgentsPage, d as getAgent } from "./useAgentApi-WsNtzw6u.js";
...
function useQuickConnect() {
	...
	async function connectToPinecone(quickConnectOption) {
		const { ConnectPopup } = await __vitePreload(async () => {
			const { ConnectPopup } = await import("./dist-DEnKtHGC.js");
			return { ConnectPopup };
		}, []);
