;
(function () {
  System.register(["./vue.runtime.esm-bundler-legacy--Sn1h8On.js", "./useTelemetry-legacy-yLgrtxmH.js", "./useToast-legacy-BOts9kyk.js", "./constants-legacy-e6rCvq4v.js", "./_baseOrderBy-legacy-Dt_IoFJy.js"], function (_export, _context) {
    "use strict";

    var computed, ref, useUIStore, getWhatsNewSection, useStorage, useSettingsStore, STORES, useUsersStore, getNextVersions, useTelemetry, useToast, LOCAL_STORAGE_DISMISSED_WHATS_NEW_CALLOUT, LOCAL_STORAGE_READ_WHATS_NEW_ARTICLES, jsonParse, VERSIONS_MODAL_KEY, WHATS_NEW_MODAL_KEY, defineStore, useRootStore, SEMVER_REGEX, useVersionsStore;
    return {
      setters: [function (_vueRuntimeEsmBundlerLegacy003Js) {
        ...
        LOCAL_STORAGE_DISMISSED_WHATS_NEW_CALLOUT = _constantsLegacy00TJs.Es;
        LOCAL_STORAGE_READ_WHATS_NEW_ARTICLES = _constantsLegacy00TJs.Rs;
        jsonParse = _constantsLegacy00TJs.ka;
        VERSIONS_MODAL_KEY = _constantsLegacy00TJs.ls;
