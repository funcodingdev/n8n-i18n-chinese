import { Ft as ref, I as h, S as computed, q as onBeforeUnmount } from "./vue.runtime.esm-bundler-Bw8GKr4Y.js";
...
import { Gr as useProjectsStore, da as sanitizeHtml, nt as useCredentialsStore, t as useWorkflowsStore } from "./workflows.store-DQQfIwKi.js";
import { t as useToast } from "./useToast-DMjrW7lG.js";
import { Eo as createResultOk, To as createResultError } from "./constants-Brs44Mbc.js";
...
function useCredentialOAuth() {
	...
	*/
	...
	function getManuallyConfigurableProperties(credentialType) {
		return credentialType.properties.filter((prop) => prop.type !== "hidden" && prop.type !== "notice");
	}
...
function useQuickConnect() {
	...
	async function connectToPinecone(quickConnectOption) {
		const { ConnectPopup } = await __vitePreload(async () => {
			const { ConnectPopup } = await import("./dist-BDV9B57G.js");
			return { ConnectPopup };
		}, []);
		return await new Promise((resolve) => {
