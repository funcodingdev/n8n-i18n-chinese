...
import { _ as onKeyDown, lt as watchOnce, st as useThrottleFn, ut as watchThrottled, y as onKeyUp, yt as useI18n } from "./_MapCache-Dai8_t5K.js";
import { Ai as N8nIconButton_default, At as N8nLink_default, Bi as N8nButton_default, Hi as N8nIcon_default, Ht as N8nTooltip_default, Lt as useRoute, M as N8nSticky_default, R as N8nPopover_default, Rt as useRouter, St as N8nActionDropdown_default, Yt as createEventBus, wt as useDeviceSupport, zi as N8nText_default } from "./src-CWDygSR1.js";
import { t as __plugin_vue_export_helper_default } from "./_plugin-vue_export-helper-DltO58Gh.js";
import { $n as useVueFlow, $r as CanvasConnectionMode, An as getMousePosition, At as environments_store_default, Bn as _sfc_main$5, C as useNodeTypesStore, Dc as sanitizeHtml, Ec as isOutsideSelected, Fn as updateViewportToContainNodes, Gn as clamp, Hn as _sfc_main$3, In as MarkerType, It as useNDVStore, Jn as getConnectedEdges, Kn as getBezierPath, Ln as NodeId, Lt as injectWorkflowState, Mt as useNodeHelpers, Qn as useGetPointerPosition, Rn as PanelPosition, Sn as GRID_SIZE, Un as _sfc_main$d, Vn as _sfc_main$1, Wn as _sfc_main$f, Xn as getSmoothStepPath, Yn as getRectOfNodes, Yr as isValidNodeConnectionType, Zi as isPresent, Zn as isMacOs, aa as nodeViewEventBus, bn as DEFAULT_NODE_SIZE, br as useSourceControlStore, ei as CanvasNodeDirtiness, er as wheelDelta, fs as useSettingsStore, gn as useTemplatesStore, gr as useStyles, ji as getTriggerNodeServiceName, nr as isExtraTemplateLinksExperimentEnabled, qn as getBoundsofRects, r as useUIStore, rr as trackTemplatesClick, rt as useCredentialsStore, s as useWorkflowsStore, ti as CanvasNodeRenderType, tr as TemplateClickSource, vn as CONFIGURATION_NODE_RADIUS, wn as calculateNodeSize, zn as Position } from "./users.store-w97vXh5N.js";
import { A as TitledList_default } from "./ParameterInputList-CzVhwkzE.js";
import { $a as NodeConnectionTypes, Bo as getResourcePermissions, Do as require_isEqual, Eo as WEBHOOK_NODE_TYPE, F as CUSTOM_API_CALL_KEY, Fa as isCommunityPackageName, Mt as AGENT_NODE_TYPE, Nc as CANVAS_EXECUTION_DATA_THROTTLE_DURATION, Nt as AGENT_TOOL_NODE_TYPE, So as SEND_AND_WAIT_OPERATION, To as WAIT_INDEFINITELY, Ut as CHAT_TRIGGER_NODE_TYPE, Vn as NOT_DUPLICATABLE_NODE_TYPES, Xo as VIEWS, Yn as PRODUCTION_ONLY_TRIGGER_NODE_TYPES, Zi as mapConnectionsByDestination, aa as getNodeOutputs, br as WAIT_NODE_TYPE, cr as SIMULATE_TRIGGER_NODE_TYPE, da as getSubworkflowId, dc as CanvasNodeHandleKey, fc as CanvasNodeKey, ga as isNodeWithWorkflowSelector, ha as isHitlToolType, ia as getNodeInputs, ma as isExecutable, pc as ExpressionLocalResolveContextSymbol, pn as FORM_NODE_TYPE, pr as STICKY_NODE_TYPE, sr as SIMULATE_NODE_TYPE, uc as CanvasKey, wt as NODE_CREATOR_OPEN_SOURCES } from "./constants-Dqd5rpvc.js";
...
import { t as usePinnedData } from "./usePinnedData-CPnFoeXO.js";
import { t as getNodeIconSource } from "./nodeIcon-DbPvo_Sy.js";
import { c as parseCanvasConnectionHandleString, n as createCanvasConnectionHandleString, o as mapLegacyConnectionsToCanvasConnections, r as insertSpacersBetweenEndpoints, s as mapLegacyEndpointsToCanvasConnectionPort, t as checkOverlap } from "./canvas.utils-DY0w3_Dr.js";
import { t as useNodeCreatorStore } from "./nodeCreator.store-BB96RZCn.js";
import { a as useLogsStore, i as useExperimentalNdvStore, t as useCanvasOperations } from "./useCanvasOperations-CCnJByHp.js";
...
import { r as useNodeDirtiness, t as useRunWorkflow } from "./useRunWorkflow-DKqT5wox.js";
import { t as useCollaborationStore } from "./collaboration.store-C1szTD9s.js";
import { t as NodeSettings_default } from "./NodeSettings-ZRoX0iZ9.js";
	...
	setup(__props) {
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("div", { class: normalizeClass(_ctx.$style.settingsIcons) }, [
				...
				isDynamicCredentialsEnabled.value && hasDynamicCredentials.value ? (openBlock(), createBlock(unref(N8nTooltip_default), { key: 4 }, {
					content: withCtx(() => [createBaseVNode("div", { class: normalizeClass(_ctx.$style.tooltipHeader) }, [createVNode(unref(N8nIcon_default), {
						icon: "key-round",
						size
...
function drag() {
	var filter2 = defaultFilter, container$1 = defaultContainer, subject = defaultSubject, touchable = defaultTouchable, gestures = {}, listeners = dispatch("start", "drag", "end"), active = 0, mousedownx, mousedowny, mousemoving, touchending, clickDistance2 = 0;
	...
	drag2.container = function(_) {
		return arguments.length ? (container$1 = typeof _ === "function" ? _ : constant(_), drag2) : container$1;
	};
...
var CanvasHandlePlus_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props, { emit: __emit }) {
		...
		return (_ctx, _cache) => {
			...
			}, null, -1))], 10, _hoisted_3)], 14, _hoisted_1$1);
		};
	}
});
var CanvasHandlePlus_vue_vue_type_style_index_0_lang_module_default = {
	wrapper: "_wrapper_etxy2_125",
	right: "_right_etxy2_130",
	bottom: "_bottom_etxy2_133",
	line: "_line_etxy2_136",
	success: "_success_etxy2_139",
	plus: "_plus_etxy2_142"
};
