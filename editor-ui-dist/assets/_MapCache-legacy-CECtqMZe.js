      ...
      execute: function () {
        ...
        */
        ...
        zh_CN_default = {
          ...
          "settings.mcp.actionBox.button.label": "启用 MCP 服务器",
          "settings.mcp.emptyState.docs.part1": "阅读我们的文档以",
          "settings.mcp.toggle.disabled.notice": "让像Claude、Lovable和其他AI工具的MCP客户端发现并执行你的n8n工作流程。",
          ...
          "workflowActivator.showMessage.activeChangedNodesIssuesExistTrue.title": "{count} 个节点存在问题，请在发布之前修复： | {count} 个节点存在问题，请在发布之前修复：",
