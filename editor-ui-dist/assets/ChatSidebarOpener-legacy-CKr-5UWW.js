;
(function () {
  System.register(["./vue.runtime.esm-bundler-legacy--Sn1h8On.js", "./_MapCache-legacy-gleHKmVW.js", "./src-legacy-Camt-rlz.js", "./_plugin-vue_export-helper-legacy-DZMI5HPp.js", "./truncate-legacy-Dz2LFabB.js", "./useTelemetry-legacy-DnSAoKz5.js", "./constants-legacy-BWxkEIkt.js", "./constants-legacy-DjFSod4r.js", "./chat.store-legacy-CgXRpY4e.js", "./useChatHubSidebarState-legacy-_PDgWm7D.js"], function (_export, _context) {
    "use strict";

    var computed, createElementBlock, createCommentVNode, unref, ref, defineComponent, createBlock, watch, renderSlot, openBlock, normalizeClass, useEventListener, useMediaQuery, useI18n, useLocalStorage, useDeviceSupport, N8nIconButton_default, __plugin_vue_export_helper_default, useRouter, useProjectsStore, useUIStore, useCredentialsStore, useSettingsStore, PROVIDER_CREDENTIAL_TYPE_MAP, LOCAL_STORAGE_CHAT_HUB_CREDENTIALS, stringType, nullType, objectType, recordType, chatHubConversationModelSchema, chatHubProviderSchema, CHAT_VIEW, MOBILE_MEDIA_QUERY, isLlmProvider, isLlmProviderModel, useChatHubSidebarState, __vite_style__, credentialsMapSchema, chatHubConversationModelWithCachedDisplayNameSchema, ChatLayout_vue_vue_type_script_setup_true_lang_default, component, isMobileDevice, ChatLayout_vue_vue_type_style_index_0_lang_module_default, cssModules, ChatLayout_default, ChatSidebarOpener_vue_vue_type_script_setup_true_lang_default, ChatSidebarOpener_default;
    //#endregion
    ...
    */
    ...
    return {
      setters: [function (_vueRuntimeEsmBundlerLegacy003Js) {
        ...
        LOCAL_STORAGE_CHAT_HUB_CREDENTIALS = _constantsLegacy00TJs.Cs;
        stringType = _constantsLegacy00TJs.Fo;
        nullType = _constantsLegacy00TJs.Mo;
        objectType = _constantsLegacy00TJs.No;
        recordType = _constantsLegacy00TJs.Po;
        chatHubConversationModelSchema = _constantsLegacy00TJs.ei;
        chatHubProviderSchema = _constantsLegacy00TJs.ni;
