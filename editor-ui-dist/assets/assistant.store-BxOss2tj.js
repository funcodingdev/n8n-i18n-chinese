...
import { ft as isToolMessage, pt as isWorkflowUpdatedMessage } from "./src-Dq1PgKJG.js";
import { x as createEventBus, y as useRoute } from "./truncate-C0ZrWWly.js";
import { Ci as stringSizeInBytes, Do as CREDENTIAL_EDIT_MODAL_KEY, Fi as useUIStore, Ho as useSettingsStore, Ht as useCredentialsStore, Jr as getAuthTypeForNodeCredential, Jt as getSessionsMetadata, Kt as getAiSessions, Ni as codeNodeEditorEventBus, Sn as injectWorkflowState, Ut as chatWithAssistant, Wt as chatWithBuilder, Xt as useAIAssistantHelpers, Yr as getMainAuthField, Yt as replaceCode, a as useNDVStore, at as useNodeTypesStore, i as usePostHog, nr as useUsersStore, o as useWorkflowsStore, oc as STORES, qt as getBuilderCredits, t as useTelemetry } from "./useTelemetry-CoXPwd1O.js";
import { t as useToast } from "./useToast-CiTWVxuS.js";
import { Mo as EDITABLE_CANVAS_VIEWS, Oa as jsonParse, Po as VIEWS, Ta as deepCopy, Ys as AI_BUILDER_TEMPLATE_EXAMPLES_EXPERIMENT, s as PLACEHOLDER_EMPTY_WORKFLOW_ID, si as require_pick, t as DEFAULT_NEW_WORKFLOW_NAME } from "./constants-KkYd5iUv.js";
import { g as assert, k as defineStore, r as useRootStore } from "./_baseOrderBy-CqDCB2Jl.js";
