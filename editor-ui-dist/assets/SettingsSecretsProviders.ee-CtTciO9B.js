...
import { Et as N8nBadge_default, Ii as N8nHeading_default, Ri as N8nText_default, St as N8nLoading_default, Vi as N8nIcon_default, fi as N8nLink_default, gt as N8nCard_default, ji as N8nActionBox_default, xt as N8nActionToggle_default, zi as N8nButton_default } from "./src-y1U2VbqR.js";
import { t as __plugin_vue_export_helper_default } from "./_plugin-vue_export-helper-DltO58Gh.js";
import "./sanitize-html-DjneYy0u.js";
import { Br as isDateObject, Xs as getSecretProviderTypes, Ys as getSecretProviderConnections, cn as useDocumentTitle, gr as useToast, hs as useSettingsStore, pr as useRBACStore, r as useUIStore } from "./users.store-ACeMu33y.js";
import { Bc as EnterpriseEditionFeature, ro as DateTime, ws as SECRETS_PROVIDER_CONNECTION_MODAL_KEY } from "./constants-Cf-1GDJg.js";
...
import { i as mockGetSecretProviderTypes, r as mockGetSecretProviderConnections, s as SecretsProviderImage_ee_default } from "./useSecretsProviders.mock-CGiS2Uqy.js";
function useSecretsProvidersList(options) {
	...
	async function fetchProviderTypes() {
		...
		try {
			if (USE_MOCK_API) providerTypes.value = await mockGetSecretProviderTypes();
			else providerTypes.value = await getSecretProviderTypes(rootStore.restApiContext);
		} finally {
	...
	async function fetchActiveConnections() {
		...
		try {
			if (USE_MOCK_API) activeConnections.value = await mockGetSecretProviderConnections();
			else activeConnections.value = await getSecretProviderConnections(rootStore.restApiContext);
		} catch {
			...
			return openBlock(), createBlock(unref(N8nCard_default), {
				...
				default: withCtx(() => [createVNode(unref(N8nText_default), {
					...
					default: withCtx(() => [
						...
						createBaseVNode("span", _hoisted_2$1, toDisplayString(provider.value.secretsCount === 1 ? unref(i18n).baseText("settings.externalSecrets.card.secretCount", { interpolate: { count: `${provider.value.secretsCount}` } }) : unref(i18n).baseText("settings.externalSecrets.card.secretsCount", { interpolate: { count: `${provider.value.secretsCount}` } })), 1),
...
var SettingsSecretsProviders_ee_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		...
		function openConnectionModal(providerKey) {
