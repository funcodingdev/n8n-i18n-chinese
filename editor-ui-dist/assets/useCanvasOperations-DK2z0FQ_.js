...
import { M as useLocalStorage, S as useClipboard, bt as useI18n } from "./_MapCache-COzuLMdL.js";
import { Ni as require_markdown_it_link_attributes, _t as useRouter, gt as useRoute } from "./src-BvUzUaLE.js";
import { t as __plugin_vue_export_helper_default } from "./_plugin-vue_export-helper-DltO58Gh.js";
import { $r as ReplaceNodeParametersCommand, $t as DEFAULT_VIEWPORT_BOUNDARIES, Br as CanvasConnectionMode, Ca as isPresent, Dt as injectWorkflowState, Et as useWorkflowHelpers, Gr as AddNodeCommand, Hr as CanvasNodeRenderType, Ir as isValidNodeConnectionType, Jt as useTemplatesStore, Ln as useToast, Ns as useSettingsStore, Oa as tryToParseNumber, Ot as useWorkflowState, Qr as RenameNodeCommand, Qt as DEFAULT_NODE_SIZE, Ur as useHistoryStore, Ut as useFocusPanelStore, Wr as AddConnectionCommand, Xr as RemoveConnectionCommand, Yr as MoveNodeCommand, Yt as CONFIGURABLE_NODE_SIZE, Zr as RemoveNodeCommand, Zt as CONFIGURATION_NODE_SIZE, _r as useNDVStore, aa as createWorkflowDocumentId, at as useCredentialsStore, b as getExecutionErrorToastConfiguration, ca as useWorkflowDocumentStore, d as isChatNode, da as pinDataToExecutionData, dn as getNodesGroupSize, dr as useCanvasStore, en as GRID_SIZE, gr as usePostHog, in as generateOffsets, ln as getNewNodePosition, lt as useDataSchema, nr as useTagsStore, pr as useTelemetry, r as useUIStore, rn as doRectsOverlap, s as useWorkflowsStore, si as useProjectsStore, tn as PUSH_NODES_OFFSET, ur as useNodeHelpers, w as useNodeTypesStore, z as removePreviewToken, zn as useExternalHooks } from "./users.store-Qyayth1w.js";
import { Hi as require_cloneDeep, La as resolveNodeWebhookId, Pn as MCP_TRIGGER_NODE_TYPE, Qa as isCommunityPackageName, Sr as UPDATE_WEBHOOK_ID_NODE_TYPES, Ta as getSubworkflowId, Wo as v4_default, Xi as require__baseUniq, Za as deepCopy, _a as getConnectionTypes, _c as LOCAL_STORAGE_LOGS_PANEL_OPEN, al as NDV_IN_FOCUS_PANEL_EXPERIMENT, ba as getNodeParameters, gc as LOCAL_STORAGE_LOGS_PANEL_DETAILS_PANEL_SUB_NODE, gn as FORM_TRIGGER_NODE_TYPE, go as NodeConnectionTypes, gr as STICKY_NODE_TYPE, hc as LOCAL_STORAGE_LOGS_PANEL_DETAILS_PANEL, hs as VIEWS, ka as isHitlToolType, ma as generateNodesGraph, ml as EnterpriseEditionFeature, qc as CANVAS_ZOOMED_VIEW_EXPERIMENT, va as getNodeInputs, vc as LOCAL_STORAGE_LOGS_SYNC_SELECTION, wr as WEBHOOK_NODE_TYPE, ya as getNodeOutputs } from "./constants-CbM6Kczw.js";
import { j as defineStore, r as useRootStore } from "./_baseOrderBy-DWejZi4o.js";
import { t as useExecutionsStore } from "./executions.store-CZVSqgkG.js";
import { t as usePinnedData } from "./usePinnedData-D0I3IPdg.js";
import { a as mapLegacyConnectionToCanvasConnection, c as parseCanvasConnectionHandleString, i as mapCanvasConnectionToLegacyConnection, n as createCanvasConnectionHandleString, o as mapLegacyConnectionsToCanvasConnections } from "./canvas.utils-wNLuSy5w.js";
import { n as useNodeCreatorStore, t as canvasEventBus } from "./canvas.eventBus-BeMGLVv1.js";
import { t as core_default } from "./core-C1clOi7s.js";
import { a as bash, i as javascript, n as typescript, r as python, t as xml } from "./xml-DVAe-TOk.js";
...
import { t as clearAllNodeResourceLocatorValues } from "./templateTransforms-D_S2oYHe.js";
