...
import { Bi as N8nSpinner_default, Ct as N8nActionDropdown_default, D as N8nTags_default, Ii as N8nHeading_default, Ri as N8nText_default, St as N8nLoading_default, Vi as N8nIcon_default, bi as useRouter, rt as Checkbox_default, vi as onBeforeRouteLeave, wi as N8nTooltip_default, yi as useRoute } from "./src-wu1DeT-q.js";
import { t as __plugin_vue_export_helper_default } from "./_plugin-vue_export-helper-DltO58Gh.js";
import "./sanitize-html-DjneYy0u.js";
import "./date-picker-DBgXY_RJ.js";
import { Ar as useWorkflowsListStore, C as useNodeTypesStore, Lr as isComponentPublicInstance, Nn as getNodeViewTab, Nt as useTelemetry, Vt as useProjectsStore, g as executionRetryMessage, gr as useToast, hs as useSettingsStore, ln as useWorkflowSaving, s as useWorkflowsStore } from "./users.store-3JSNDD0x.js";
import { Bc as EnterpriseEditionFeature, Go as getResourcePermissions, es as MAIN_HEADER_TABS, ts as VIEWS, xc as WorkflowIdKey } from "./constants-BxuLnwsr.js";
import "./merge-DfoBmFWu.js";
import { s as NO_NETWORK_ERROR_CODE } from "./_baseOrderBy-Bum33Aot.js";
...
import { a as toTime, i as toDayMonth } from "./dateFormatter-CgSkNeCX.js";
import { t as useExecutionHelpers } from "./useExecutionHelpers-zDCKOjN_.js";
import "./TagsDropdown-DGei5sW1.js";
import "./WorkflowTagsDropdown-DUIc4DEF.js";
import { t as injectStrict } from "./injectStrict-B3go-zcs.js";
import { t as WorkflowExecutionsInfoAccordion_default } from "./WorkflowExecutionsInfoAccordion-BOVHaUt-.js";
import "./AnnotationTagsDropdown.ee-CA9XXJeI.js";
import { i as ConcurrentExecutionsHeader_default, n as ExecutionStopAllText_default, r as ExecutionsFilter_default, t as ExecutionsTime_default } from "./ExecutionsTime-B13ryzC6.js";
import { t as useIntersectionObserver } from "./useIntersectionObserver-DIH6kyPg.js";
...
var WorkflowExecutionsView_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		...
		async function fetchWorkflow() {
			...
			if (workflowId.value) if (!workflowsListStore.workflowsById[workflowId.value]) {
				try {
					await workflowsListStore.fetchActiveWorkflows();
					await initializeWorkspace(await workflowsListStore.fetchWorkflow(workflowId.value));
				} catch (error$1) {
			...
			} else workflow.value = workflowsListStore.workflowsById[workflowId.value];
		}
