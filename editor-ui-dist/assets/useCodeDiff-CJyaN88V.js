import { $ as openBlock, A as createTextVNode, C as createBaseVNode, Cn as toDisplayString, E as createElementBlock, Gt as unref, I as h, It as ref, N as defineComponent, S as computed } from "./vue.runtime.esm-bundler-Bs4WIMNP.js";
...
import { di as VIEWS, li as EDITABLE_CANVAS_VIEWS, yl as deepCopy } from "./constants-DDbk7QLF.js";
import { Wt as useNDVStore, a as injectWorkflowDocumentStore, ft as replaceCode, r as createWorkflowDocumentId, s as useWorkflowDocumentStore } from "./workflowDocument.store-nzq6GHzt.js";
...
import { o as codeNodeEditorEventBus } from "./event-bus-WRQ7xfvX.js";
...
function useCodeDiff(options) {
	...
	function updateParameters(workflowId, nodeName, parameters) {
		if (ndvStore.value.activeNodeName === nodeName) Object.keys(parameters).forEach((key) => {
			const update = {
				node: nodeName,
				name: `parameters.${key}`,
	...
	function showCodeUpdateToastIfNeeded(errorNodeName) {
		if (errorNodeName !== ndvStore.value.activeNodeName) useToast().showMessage({
			type: "success",
