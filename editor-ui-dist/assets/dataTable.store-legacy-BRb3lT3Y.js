;
(function () {
  System.register(["./vue.runtime.esm-bundler-legacy--Sn1h8On.js", "./useTelemetry-legacy-CMfwYwVY.js", "./constants-legacy-8iZaMHMx.js", "./_baseOrderBy-legacy-Bls-fMH1.js"], function (_export, _context) {
    "use strict";

    var computed, ref, addDataTableColumnApi, moveDataTableColumnApi, useProjectsStore, downloadDataTableCsvApi, updateDataTableRowsApi, fetchDataTableGlobalLimitInBytes, fetchDataTablesApi, deleteDataTableApi, deleteDataTableColumnApi, deleteDataTableRowsApi, getDataTableRowsApi, uploadCsvFileApi, updateDataTableApi, useSettingsStore, createDataTableApi, insertDataTableRowApi, DATA_TABLE_STORE, getResourcePermissions, defineStore, useRootStore, reorderItem, useDataTableStore;
    return {
