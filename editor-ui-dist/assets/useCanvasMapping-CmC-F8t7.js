...
import { _ as onKeyDown, lt as watchOnce, st as useThrottleFn, ut as watchThrottled, y as onKeyUp, yt as useI18n } from "./_MapCache-BhiJVBN1.js";
...
import { $n as getConnectedEdges, Ar as useFocusedNodesStore, Bn as updateViewportToContainNodes, Bt as useNDVStore, C as useNodeTypesStore, Cn as CONFIGURATION_NODE_RADIUS, Dn as GRID_SIZE, Fn as getMousePosition, Gn as _sfc_main$5, Hn as NodeId, It as useNodeHelpers, Jn as _sfc_main$d, Kn as _sfc_main$1, Pt as environments_store_default, Qn as getBoundsofRects, Tn as DEFAULT_NODE_SIZE, Un as PanelPosition, Vi as getTriggerNodeServiceName, Vn as MarkerType, Vt as injectWorkflowState, Wn as Position, Xc as sanitizeHtml, Xn as clamp, Yc as isOutsideSelected, Yn as _sfc_main$f, Zn as getBezierPath, ai as isValidNodeConnectionType, ar as wheelDelta, br as useStyles, ca as isPresent, cr as trackTemplatesClick, di as CanvasNodeRenderType, er as getRectOfNodes, ga as nodeViewEventBus, ir as useVueFlow, jr as useChatPanelStateStore, kn as calculateNodeSize, li as CanvasConnectionMode, nr as isMacOs, or as TemplateClickSource, qn as _sfc_main$3, r as useUIStore, rr as useGetPointerPosition, rt as useCredentialsStore, s as useWorkflowsStore, sr as isExtraTemplateLinksExperimentEnabled, tr as getSmoothStepPath, ui as CanvasNodeDirtiness, wr as useSourceControlStore, ws as useSettingsStore, xn as useTemplatesStore } from "./users.store-DNFsxBs3.js";
import { j as TitledList_default } from "./ParameterInputList-BC--Knmm.js";
import { Ao as SEND_AND_WAIT_OPERATION, Gt as CHAT_TRIGGER_NODE_TYPE, I as CUSTOM_API_CALL_KEY, Mo as WAIT_INDEFINITELY, No as WEBHOOK_NODE_TYPE, Nt as AGENT_NODE_TYPE, Po as require_isEqual, Pt as AGENT_TOOL_NODE_TYPE, Sa as isNodeWithWorkflowSelector, Sr as WAIT_NODE_TYPE, Tt as NODE_CREATOR_OPEN_SOURCES, Ua as isCommunityPackageName, Un as NOT_DUPLICATABLE_NODE_TYPES, Xc as CANVAS_EXECUTION_DATA_THROTTLE_DURATION, Zn as PRODUCTION_ONLY_TRIGGER_NODE_TYPES, _a as getSubworkflowId, _c as CanvasKey, ba as isExecutable, da as getNodeOutputs, hn as FORM_NODE_TYPE, hr as STICKY_NODE_TYPE, lr as SIMULATE_NODE_TYPE, qo as getResourcePermissions, ra as mapConnectionsByDestination, rs as VIEWS, so as NodeConnectionTypes, ua as getNodeInputs, ur as SIMULATE_TRIGGER_NODE_TYPE, vc as CanvasNodeHandleKey, xa as isHitlToolType, xc as ExpressionLocalResolveContextSymbol, yc as CanvasNodeKey } from "./constants-B69HgT-U.js";
import { t as useAssistantStore } from "./assistant.store-BzAvwlAU.js";
import { t as useChatPanelStore } from "./chatPanel.store-iPbty1hv.js";
import { t as usePinnedData } from "./usePinnedData-DsohccEA.js";
import { t as getNodeIconSource } from "./nodeIcon-BcpIPds6.js";
import { c as parseCanvasConnectionHandleString, n as createCanvasConnectionHandleString, o as mapLegacyConnectionsToCanvasConnections, r as insertSpacersBetweenEndpoints, s as mapLegacyEndpointsToCanvasConnectionPort, t as checkOverlap } from "./canvas.utils-BDUvA23o.js";
import { t as useNodeCreatorStore } from "./nodeCreator.store-BnureRr3.js";
import { a as useLogsStore, i as useExperimentalNdvStore, t as useCanvasOperations } from "./useCanvasOperations-G8rwRmFs.js";
...
import { t as useTelemetryContext } from "./useTelemetryContext-BOSg3DtS.js";
import { r as useNodeDirtiness, t as useRunWorkflow } from "./useRunWorkflow-CboG-y2C.js";
import { t as useCollaborationStore } from "./collaboration.store-BXIFY4WE.js";
import { t as NodeSettings_default } from "./NodeSettings-DI8NH3mb.js";
import { t as KeyboardShortcutTooltip_default } from "./KeyboardShortcutTooltip-ChSOtraR.js";
import { t as useKeybindings } from "./useKeybindings-nBCpcOQo.js";
