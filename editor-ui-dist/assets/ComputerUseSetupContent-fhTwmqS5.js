import { $ as openBlock, A as createTextVNode, C as createBaseVNode, Cn as toDisplayString, E as createElementBlock, Gt as unref, It as ref, N as defineComponent, S as computed, T as createCommentVNode, X as onMounted, _ as Fragment, bt as withCtx, gt as watch, j as createVNode, ot as resolveDirective, q as onBeforeUnmount, rt as renderList, st as resolveDynamicComponent, vn as normalizeClass, w as createBlock, xt as withDirectives } from "./vue.runtime.esm-bundler-DYHsQBZB.js";
...
import { t as useInstanceAiComputerUseTelemetry } from "./instanceAiComputerUse.telemetry-CmzLKweg.js";
...
//#endregion
//#region src/features/ai/instanceAi/components/modals/ComputerUseSetupContent.vue?vue&type=script&setup=true&lang.ts
var _hoisted_1 = ["onClick"];
var ComputerUseSetupContent_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	__name: "ComputerUseSetupContent",
	props: { embedded: {
		type: Boolean,
		default: false
	} },
	setup(__props) {
		...
		const tokenExpiresInSeconds = computed(() => {
			if (store.setupCommandTtlSeconds !== null && store.setupCommandFetchedAt !== null) {
				const elapsedSeconds = Math.floor((nowMs.value - store.setupCommandFetchedAt) / 1e3);
		...
		const tokenExpiryText = computed(() => {
			...
			if (tokenExpiresInSeconds.value === 0) return i18n.baseText("instanceAi.welcomeModal.gateway.tokenExpired");
			const minutes = Math.max(1, Math.ceil(tokenExpiresInSeconds.value / 60));
			return i18n.baseText("instanceAi.welcomeModal.gateway.tokenExpiresIn", { interpolate: { minutes: String(minutes) } });
		});
		...
		async function copyCommand() {
			try {
				if (tokenExpiresInSeconds.value === 0) await store.fetchSetupCommand();
		...
		async function prepareSetupCommand() {
			if (!store.isLocalGatewayDisabledByAdmin && store.isLocalGatewayDisabled) await store.persistLocalGatewayPreference(false);
			await store.fetchSetupCommand();
		}
		onMounted(() => {
			prepareSetupCommand();
		});
		watch(() => [store.setupCommandFetchedAt, store.setupCommandTtlSeconds], ([fetchedAt, ttlSeconds]) => {
			if (expiryTimer) {
		...
		return (_ctx, _cache) => {
			...
			return openBlock(), createElementBlock("div", { class: normalizeClass([_ctx.$style.body, props.embedded && _ctx.$style.bodyEmbedded]) }, [!props.embedded ? (openBlock(), createElementBlock("div", {
				...
				_: 1
			}, 8, ["class"])], 2)) : createCommentVNode("", true), unref(store).isGatewayConnected ? (openBlock(), createElementBlock("div", {
				key: 1,
				class: normalizeClass(_ctx.$style.connectedBlock)
			}, [
				createBaseVNode("div", { class: normalizeClass(_ctx.$style.statusRow) }, [createBaseVNode("span", { class: normalizeClass([_ctx.$style.statusDot, _ctx.$style.statusDotConnected]) }, null, 2), createVNode(unref(N8nText_default), {
					size: "small",
					bold: true
				}, {
				...
				withDirectives(createBaseVNode("div", { class: normalizeClass(_ctx.$style.textBlock) }, null, 2), [[_directive_n8n_html, unref(i18n).baseText("instanceAi.welcomeModal.gateway.description")]]),
				createVNode(unref(N8nCallout_default), { theme: "warning" }, {
					default: withCtx(() => [createTextVNode(toDisplayString(unref(i18n).baseText("instanceAi.welcomeModal.gateway.warning")), 1)]),
					_: 1
				}),
				...
				createVNode(unref(N8nText_default), { class: normalizeClass(_ctx.$style.instructions) }, {
				...
				createBaseVNode("div", { class: normalizeClass(_ctx.$style.commandCard) }, [createBaseVNode("div", { class: normalizeClass(_ctx.$style.commandRow) }, [createBaseVNode("code", {
					...
					"aria-label",
					"disabled"
				])], 2), createBaseVNode("div", { class: normalizeClass(_ctx.$style.waitingRow) }, [createBaseVNode("div", { class: normalizeClass(_ctx.$style.waitingStatus) }, [createVNode(unref(N8nIcon_default), {
					icon: "spinner",
					color: "primary",
					spin: "",
					size: "small"
				}), createBaseVNode("span", null, toDisplayString(unref(i18n).baseText("instanceAi.welcomeModal.gateway.waiting")), 1)], 2), tokenExpiryText.value ? (openBlock(), createBlock(unref(N8nText_default), {
					key: 0,
					size: "small",
					color: "warning"
				}, {
					default: withCtx(() => [createTextVNode(toDisplayString(tokenExpiryText.value), 1)]),
					_: 1
...
//#endregion
//#region src/features/ai/instanceAi/components/modals/ComputerUseSetupContent.vue?vue&type=style&index=0&lang.module.scss
var body = "_body_pfxar_388";
var bodyEmbedded = "_bodyEmbedded_pfxar_395";
var header = "_header_pfxar_399";
var title = "_title_pfxar_406";
var textBlock = "_textBlock_pfxar_411";
var osTabs = "_osTabs_pfxar_420";
var osTab = "_osTab_pfxar_420";
var osTabActive = "_osTabActive_pfxar_445";
var osTabIcon = "_osTabIcon_pfxar_451";
var commandCard = "_commandCard_pfxar_456";
var commandRow = "_commandRow_pfxar_462";
var commandText = "_commandText_pfxar_471";
var commandTextFaded = "_commandTextFaded_pfxar_486";
var copyButton = "_copyButton_pfxar_490";
var connectedBlock = "_connectedBlock_pfxar_495";
var statusRow = "_statusRow_pfxar_504";
var statusDot = "_statusDot_pfxar_510";
var statusDotConnected = "_statusDotConnected_pfxar_517";
var directoryRow = "_directoryRow_pfxar_521";
var toolCategories = "_toolCategories_pfxar_525";
var categoryPill = "_categoryPill_pfxar_532";
var categoryPillDisabled = "_categoryPillDisabled_pfxar_544";
var categorySublabel = "_categorySublabel_pfxar_548";
var waitingRow = "_waitingRow_pfxar_552";
var waitingStatus = "_waitingStatus_pfxar_563";
var instructions = "_instructions_pfxar_569";
var shimmer = "_shimmer_pfxar_1";
var spin = "_spin_pfxar_1";
var opacityPulse = "_opacityPulse_pfxar_1";
var popoverIn = "_popoverIn_pfxar_1";
var fadeIn = "_fadeIn_pfxar_1";
var collapsibleSlideDown = "_collapsibleSlideDown_pfxar_1";
var collapsibleSlideUp = "_collapsibleSlideUp_pfxar_1";
var collapsibleSlideDownBlurred = "_collapsibleSlideDownBlurred_pfxar_1";
var collapsibleSlideUpBlurred = "_collapsibleSlideUpBlurred_pfxar_1";
var blurSwapIn = "_blurSwapIn_pfxar_1";
var blurSwapOut = "_blurSwapOut_pfxar_1";
var pulseGlow = "_pulseGlow_pfxar_1";
var pulseGlowDelayed = "_pulseGlowDelayed_pfxar_1";
var fade = "_fade_pfxar_1";
var fadeInUp = "_fadeInUp_pfxar_1";
var fadeInDown = "_fadeInDown_pfxar_1";
var fadeInLeft = "_fadeInLeft_pfxar_1";
var fadeInRight = "_fadeInRight_pfxar_1";
var fadeOut = "_fadeOut_pfxar_1";
var fadeOutDown = "_fadeOutDown_pfxar_1";
var fadeOutUp = "_fadeOutUp_pfxar_1";
var fadeOutLeft = "_fadeOutLeft_pfxar_1";
var fadeOutRight = "_fadeOutRight_pfxar_1";
var ping = "_ping_pfxar_1";
var blinkBackground = "_blinkBackground_pfxar_1";
var typingBlink = "_typingBlink_pfxar_1";
var ComputerUseSetupContent_vue_vue_type_style_index_0_lang_module_default = {
	body,
	bodyEmbedded,
	header,
	title,
	...
	shimmer,
	spin,
	"skeleton-pulse": "_skeleton-pulse_pfxar_1",
	opacityPulse,
	popoverIn,
	fadeIn,
...
var ComputerUseSetupContent_default = /* @__PURE__ */ _plugin_vue_export_helper_default(ComputerUseSetupContent_vue_vue_type_script_setup_true_lang_default, [["__cssModules", { "$style": ComputerUseSetupContent_vue_vue_type_style_index_0_lang_module_default }]]);
//#endregion
export { ComputerUseSetupContent_default as t };
