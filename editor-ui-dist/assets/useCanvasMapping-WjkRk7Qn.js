...
import { $ as openBlock, A as createTextVNode, Bt as toRef, C as createBaseVNode, E as createElementBlock, F as guardReactiveProps, Ft as ref, H as mergeModels, I as h, N as defineComponent, O as createSlots, R as inject, S as computed, Sn as toDisplayString, T as createCommentVNode, U as mergeProps, W as nextTick, Wt as unref, X as onMounted, Z as onUnmounted, _ as Fragment, _n as normalizeClass, _t as watchEffect, bt as withDirectives, c as useCssModule, dt as useModel, ft as useSlots, gt as watch, h as withModifiers, it as renderSlot, j as createVNode, lt as useAttrs, n as Transition, p as vShow, q as onBeforeUnmount, rt as renderList, st as resolveDynamicComponent, tt as provide, v as Suspense, vn as normalizeProps, w as createBlock, y as Teleport, yn as normalizeStyle, yt as withCtx } from "./vue.runtime.esm-bundler-dg1EVmSK.js";
import { _ as onKeyDown, bt as useI18n, ct as useThrottleFn, dt as watchThrottled, ut as watchOnce, y as onKeyUp } from "./_MapCache-COzuLMdL.js";
import { $i as N8nIcon_default, At as createEventBus, Bt as N8nActionDropdown_default, Ht as useDeviceSupport, Ii as N8nIconButton_default, L as N8nSticky_default, Mi as N8nTooltip_default, Qi as N8nButton_default, W as N8nPopover_default, Zi as N8nText_default, _t as useRouter, gt as useRoute, lt as N8nLink_default } from "./src-BvUzUaLE.js";
import { t as __plugin_vue_export_helper_default } from "./_plugin-vue_export-helper-DltO58Gh.js";
import { An as useGetPointerPosition, Br as CanvasConnectionMode, Ca as isPresent, Cn as clamp, Dn as getRectOfNodes, Dt as injectWorkflowState, En as getConnectedEdges, Fn as trackTemplatesClick, Hr as CanvasNodeRenderType, Ir as isValidNodeConnectionType, Jt as useTemplatesStore, Kn as useFocusedNodesStore, Mn as wheelDelta, Mt as nodeViewEventBus, Nn as TemplateClickSource, Ns as useSettingsStore, On as getSmoothStepPath, Pn as isExtraTemplateLinksExperimentEnabled, Qt as DEFAULT_NODE_SIZE, Rn as useStyles, Sn as _sfc_main$f, Tn as getBoundsofRects, Vr as CanvasNodeDirtiness, Xt as CONFIGURATION_NODE_RADIUS, Yi as getTriggerNodeServiceName, _l as sanitizeHtml, _n as Position, _r as useNDVStore, aa as createWorkflowDocumentId, at as useCredentialsStore, bn as _sfc_main$3, ca as useWorkflowDocumentStore, ci as useSourceControlStore, cn as getMousePosition, cr as environments_store_default, en as GRID_SIZE, gl as isOutsideSelected, gn as PanelPosition, hn as NodeId, jn as useVueFlow, kn as isMacOs, mn as MarkerType, nn as calculateNodeSize, pn as updateViewportToContainNodes, r as useUIStore, s as useWorkflowsStore, sa as injectWorkflowDocumentStore, t as useUsersStore, ur as useNodeHelpers, vn as _sfc_main$5, w as useNodeTypesStore, wn as getBezierPath, xn as _sfc_main$d, yn as _sfc_main$1 } from "./users.store-Qyayth1w.js";
import { M as TitledList_default } from "./ParameterInputList-brxFRKkw.js";
import { Aa as isNodeWithWorkflowSelector, Bo as SEND_AND_WAIT_OPERATION, Cr as WAIT_NODE_TYPE, Gt as CHAT_TRIGGER_NODE_TYPE, Ho as WAIT_INDEFINITELY, I as CUSTOM_API_CALL_KEY, Ic as ExpressionLocalResolveContextSymbol, Ko as require_isEqual, Mc as CanvasKey, Nc as CanvasNodeHandleKey, Nt as AGENT_NODE_TYPE, Oa as isExecutable, Pc as CanvasNodeKey, Pt as AGENT_TOOL_NODE_TYPE, Qa as isCommunityPackageName, Qn as PRODUCTION_ONLY_TRIGGER_NODE_TYPES, Ta as getSubworkflowId, Tt as NODE_CREATOR_OPEN_SOURCES, Uo as WEBHOOK_NODE_TYPE, Wn as NOT_DUPLICATABLE_NODE_TYPES, as as getResourcePermissions, da as mapConnectionsByDestination, dr as SIMULATE_TRIGGER_NODE_TYPE, go as NodeConnectionTypes, gr as STICKY_NODE_TYPE, hl as CANVAS_EXECUTION_DATA_THROTTLE_DURATION, hn as FORM_NODE_TYPE, hs as VIEWS, ka as isHitlToolType, ur as SIMULATE_NODE_TYPE, va as getNodeInputs, ya as getNodeOutputs } from "./constants-CbM6Kczw.js";
import { t as useAssistantStore } from "./assistant.store-n7YbUFsH.js";
import { t as useChatPanelStore } from "./chatPanel.store-CeY6_pL_.js";
import { t as usePinnedData } from "./usePinnedData-D0I3IPdg.js";
import { t as getNodeIconSource } from "./nodeIcon-B4FMjHPj.js";
import { c as parseCanvasConnectionHandleString, n as createCanvasConnectionHandleString, o as mapLegacyConnectionsToCanvasConnections, r as insertSpacersBetweenEndpoints, s as mapLegacyEndpointsToCanvasConnectionPort, t as checkOverlap } from "./canvas.utils-wNLuSy5w.js";
import { n as useNodeCreatorStore } from "./canvas.eventBus-BeMGLVv1.js";
...
import { r as useNodeDirtiness, t as useRunWorkflow } from "./useRunWorkflow-CeRLv-a6.js";
import { n as injectStrict } from "./useInjectWorkflowId-6V-7POG9.js";
import { t as useCollaborationStore } from "./collaboration.store-slU7leRI.js";
import { t as NodeSettings_default } from "./NodeSettings-DfQuMilK.js";
...
import { t as NODE_CREATOR_SHORTCUT_COACHMARK_KEY } from "./useNodeCreatorShortcutCoachmark-BzY7m91_.js";
...
function useContextMenuItems(targetNodeIds) {
	...
	const hasPinData = (node$1) => {
		return !!workflowDocumentStore?.value?.pinData?.[node$1.name];
	};
				...
				default: withCtx(() => [
					...
					isToggleZoomVisible.value ? (openBlock(), createBlock(KeyboardShortcutTooltip_default, {
						...
						default: withCtx(() => [createVNode(unref(N8nIconButton_default), {
							...
							"aria-label": unref(i18n).baseText(isExperimentalNdvActive$3.value ? "nodeView.leaveZoomMode" : "nodeView.enterZoomMode"),
...
var CanvasEdge_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props, { emit: __emit }) {
		...
		return (_ctx, _cache) => {
			...
			}), 128))], 16, _hoisted_1$5), createVNode(unref(_sfc_main$3), null, {
...
const popover = "_popover_6do86_125";
const content$1 = "_content_6do86_130";
const color = "_color_6do86_137";
const selected$2 = "_selected_6do86_149";
const option$1 = "_option_6do86_174";
const customColorButton = "_customColorButton_6do86_186";
const plusIcon = "_plusIcon_6do86_194";
const hiddenColorInput = "_hiddenColorInput_6do86_203";
...
var CanvasNodeToolbar_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props, { emit: __emit }) {
		...
		const experimentalNdvStore = useExperimentalNdvStore();
		const focusedNodesStore = useFocusedNodesStore();
		const node$1 = computed(() => name.value ? workflowDocumentStore?.value?.getNodeByName(name.value) : null);
		...
		function onAddToAi() {
			if (node$1.value) emit("add:ai", node$1.value.id);
		}
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("div", {
...
var ExperimentalEmbeddedNodeDetails_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		...
		const node$1 = computed(() => workflowDocumentStore?.value?.getNodeById(__props.nodeId) ?? null);
...
const node = "_node_1mgys_125";
const trigger$1 = "_trigger_1mgys_148";
const running = "_running_1mgys_151";
const waiting = "_waiting_1mgys_151";
const configuration = "_configuration_1mgys_154";
const statusIcons = "_statusIcons_1mgys_160";
const configurable = "_configurable_1mgys_163";
const icon = "_icon_1mgys_163";
const description = "_description_1mgys_166";
const label$6 = "_label_1mgys_179";
const subtitle = "_subtitle_1mgys_182";
const selected$1 = "_selected_1mgys_195";
const success$1 = "_success_1mgys_199";
const warning = "_warning_1mgys_206";
const error = "_error_1mgys_210";
const pinned = "_pinned_1mgys_213";
const disabled = "_disabled_1mgys_220";
const placeholder = "_placeholder_1mgys_236";
const disabledLabel = "_disabledLabel_1mgys_291";
var CanvasNodeDefault_vue_vue_type_style_index_0_lang_module_default = {
	...
	disabled,
	placeholder,
	"border-rotate": "_border-rotate_1mgys_1",
	disabledLabel
};
...
var CanvasNodeTrigger_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		...
		const chatTriggerNode = computed(() => workflowsStore.allNodes.find((node$1) => node$1.type === CHAT_TRIGGER_NODE_TYPE));
...
var CanvasNodeTrigger_vue_vue_type_style_index_0_lang_module_default = {
	container: "_container_kdrux_125",
	interactive: "_interactive_kdrux_153",
	hovered: "_hovered_kdrux_153",
	isExperimentalNdvActive: "_isExperimentalNdvActive_kdrux_158",
	bolt: "_bolt_kdrux_162"
};
...
var CanvasNode_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props, { emit: __emit }) {
		...
		function onReplaceNode(id$2) {
			emit("replace:node", id$2);
		}
		function onAddToAi(id$2) {
			emit("add:ai", id$2);
		}
...
var Canvas_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props, { expose: __expose, emit: __emit }) {
		...
		function onNodeClick({ event, node: node$1 }) {
			if (chatPanelStore.isOpen && focusedNodesStore.isFeatureEnabled) focusedNodesStore.setUnconfirmedFromCanvasSelection([node$1.id]);
		...
		function onReplaceNode(id$1) {
			emit("replace:node", id$1);
		}
		function onAddToAi(id$1) {
			focusedNodesStore.confirmNodes([id$1], "context_menu");
...
var Canvas_default = /* @__PURE__ */ __plugin_vue_export_helper_default(Canvas_vue_vue_type_script_setup_true_lang_default, [["__cssModules", { "$style": Canvas_vue_vue_type_style_index_0_lang_module_default }], ["__scopeId", "data-v-924ac7a3"]]);
function useCanvasMapping({ nodes, connections, workflowObject }) {
	...
	function createDefaultNodeRenderType(node$1) {
		...
		const icon$2 = getNodeIconSource(simulatedNodeTypeDescriptionByNodeId.value[node$1.id] ?? nodeType ?? node$1.type, node$1);
		return {
			type: CanvasNodeRenderType.Default,
			options: {
				...
				icon: icon$2,
				placeholder: node$1.placeholder
			}
		};
	}
	...
	const nodePinnedDataById = computed(() => nodes.value.reduce((acc, node$1) => {
		acc[node$1.id] = workflowDocumentStore.value?.getNodePinData(node$1.name);
		return acc;
	}, {}));
	...
	const simulatedNodeTypeDescriptionByNodeId = computed(() => {
		return nodes.value.reduce((acc, node$1) => {
			if (["n8n-nodes-base.simulate", "n8n-nodes-base.simulateTrigger"].includes(node$1.type)) {
				const icon$2 = node$1.parameters?.icon;
				const iconValue = workflowObject.value.expression.getSimpleParameterValue(node$1, icon$2, "internal", {});
